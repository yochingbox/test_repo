...
typedef union {
	struct {
		uint8_t DFE_RES_F0A_HIGH_THRES_INIT_56G_SLOPE_LANE_7_0 : 8;	/*  [7:0]     r/w 8'h0*/
		uint8_t DFE_RES_F0A_HIGH_THRES_INIT_PAM2_SLOPE_LANE_7_0 : 8;	/* [15:8]     r/w 8'h0*/
		uint8_t RESERVED_16                              : 7;	/*[22:16]     r/w   0*/
		uint8_t DFE_RES_F0A_HIGH_THRES_INIT_FORCE_LANE   : 1;	/*     23     r/w   0*/
...
#define lnx_DFE_RES_F0A_HIGH_THRES_INIT_56G_SLOPE_LANE_7_0  TRAIN_PARA_1.BF.DFE_RES_F0A_HIGH_THRES_INIT_56G_SLOPE_LANE_7_0
#define lnx_DFE_RES_F0A_HIGH_THRES_INIT_PAM2_SLOPE_LANE_7_0  TRAIN_PARA_1.BF.DFE_RES_F0A_HIGH_THRES_INIT_PAM2_SLOPE_LANE_7_0
#define lnx_DFE_RES_F0A_HIGH_THRES_INIT_FORCE_LANE  TRAIN_PARA_1.BF.DFE_RES_F0A_HIGH_THRES_INIT_FORCE_LANE
#define lnx_DFE_FX_SUM_SAT_THRES_LANE_7_0  TRAIN_PARA_1.BF.DFE_FX_SUM_SAT_THRES_LANE_7_0

// 0x00fc	TRAIN_PARA_0		
typedef union {
	struct {
		uint8_t VREF_RES_HIGH_THRES_LANE_7_0             : 8;	/*  [7:0]     r/w 8'h37*/
...
// 0x0194	TS_PLL_VCO_AMP		
typedef union {
	struct {
		uint8_t RESERVED_0                               : 8;	/*  [7:0]     r/w   0*/
		uint8_t TS_VCOAMP_VTH_NORMAL_LANE_7_0            : 8;	/* [15:8]     r/w 8'h05*/
		uint8_t TS_VCOAMP_VTH_AMP_LANE_7_0               : 8;	/*[23:16]     r/w 8'h05*/
		uint8_t TS_VCOAMP_VTH_FREQ_LANE_7_0              : 8;	/*[31:24]     r/w 8'h0e*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TS_PLL_VCO_AMP_t;
__xdata __at( 0x6194 ) volatile TS_PLL_VCO_AMP_t TS_PLL_VCO_AMP;
#define lnx_TS_VCOAMP_VTH_NORMAL_LANE_7_0  TS_PLL_VCO_AMP.BF.TS_VCOAMP_VTH_NORMAL_LANE_7_0
#define lnx_TS_VCOAMP_VTH_AMP_LANE_7_0  TS_PLL_VCO_AMP.BF.TS_VCOAMP_VTH_AMP_LANE_7_0
#define lnx_TS_VCOAMP_VTH_FREQ_LANE_7_0  TS_PLL_VCO_AMP.BF.TS_VCOAMP_VTH_FREQ_LANE_7_0

// 0x0198	RS_PLL_VCO_AMP		
typedef union {
	struct {
		uint8_t RESERVED_0                               : 8;	/*  [7:0]     r/w   0*/
		uint8_t RS_VCOAMP_VTH_NORMAL_LANE_7_0            : 8;	/* [15:8]     r/w 8'h05*/
		uint8_t RS_VCOAMP_VTH_AMP_LANE_7_0               : 8;	/*[23:16]     r/w 8'h05*/
		uint8_t RS_VCOAMP_VTH_FREQ_LANE_7_0              : 8;	/*[31:24]     r/w 8'h0e*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} RS_PLL_VCO_AMP_t;
__xdata __at( 0x6198 ) volatile RS_PLL_VCO_AMP_t RS_PLL_VCO_AMP;
#define lnx_RS_VCOAMP_VTH_NORMAL_LANE_7_0  RS_PLL_VCO_AMP.BF.RS_VCOAMP_VTH_NORMAL_LANE_7_0
#define lnx_RS_VCOAMP_VTH_AMP_LANE_7_0  RS_PLL_VCO_AMP.BF.RS_VCOAMP_VTH_AMP_LANE_7_0
#define lnx_RS_VCOAMP_VTH_FREQ_LANE_7_0  RS_PLL_VCO_AMP.BF.RS_VCOAMP_VTH_FREQ_LANE_7_0
...
typedef union {
	struct {
		uint8_t FORCE_CTLE_R_INDEX_TRAIN_LANE_7_0        : 8;	/*  [7:0]     r/w   0*/
		uint8_t CTLE_ADAPT_EN_LANE                       : 1;	/*      8     r/w   0*/
		uint8_t DC_VREF_ADJ_EN_LANE                      : 1;	/*      9     r/w   1*/
		uint8_t CTLE_C1_ADAPT_EN_LANE                    : 1;	/*     10     r/w   0*/
		uint8_t FORCE_CTLE_R_INDEX_EN_LANE               : 1;	/*     11     r/w   0*/
		uint8_t FORCE_PHASE_EN_LANE                      : 1;	/*     12     r/w   0*/
...
#define lnx_FORCE_CTLE_R_INDEX_TRAIN_LANE_7_0  TRAIN_PARA_3.BF.FORCE_CTLE_R_INDEX_TRAIN_LANE_7_0
#define lnx_CTLE_ADAPT_EN_LANE  TRAIN_PARA_3.BF.CTLE_ADAPT_EN_LANE
...
#define lnx_FORCE_CTLE_R_INDEX_EN_LANE  TRAIN_PARA_3.BF.FORCE_CTLE_R_INDEX_EN_LANE
#define lnx_FORCE_PHASE_EN_LANE  TRAIN_PARA_3.BF.FORCE_PHASE_EN_LANE
...
typedef union {
	struct {
		...
		uint8_t TRACK_CTLE_F0B_THRS_LANE_7_0             : 8;	/* [15:8]     r/w 8'h1*/
...
typedef union {
	struct {
		uint8_t FORCE_PHASE_OFFSET_TRAIN_LANE_7_0        : 8;	/*  [7:0]     r/w 8'h0*/
...
#define lnx_FORCE_PHASE_OFFSET_TRAIN_LANE_7_0  TRAIN_PARA_5.BF.FORCE_PHASE_OFFSET_TRAIN_LANE_7_0
...
typedef union {
	struct {
		...
		uint8_t OPT_F0_DATA_LANE_7_0                     : 8;	/*[31:24]     r/w 8'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TRAIN_SAVE_2_t;
...
#define lnx_OPT_F0_DATA_LANE_7_0  TRAIN_SAVE_2.BF.OPT_F0_DATA_LANE_7_0
