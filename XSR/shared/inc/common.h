...
// phy register list
//#include "c_XSRPHY_112G_N5_Marvell_software_rx_v00_49.h"
//#include "c_XSRPHY_112G_N5_Marvell_software_tx_v00_49.h"
#include "c_XSRPHY_112G_N5_software_common_v00_49_2bytes_reg_midas.h"
...
#define PowerUp_Seq_Simple() PowerUp_Seq_Cal()
	...
	//int16_t combine_splr_tap_f(const dfe_2c_t *dfe_2c, uint8_t tap_id) BANKING_CTRL ;
	//int16_t combine_tmb_tap_f(const dfe_2c_t *dfe_2c, uint8_t tap_id)  BANKING_CTRL ;
	//int16_t combine_ml_tap_f(const dfe_2c_t *dfe_2c, uint8_t tap_id) BANKING_CTRL ;
	...
	#define get_ctle_tune() 		reg_CTLE_CURRENT2_SEL_LANE_3_0
