...
* \purpose main top
* \History
*	3/15/2019 Heejeong Ryu		Initial, copied some logic from 56G 
      PMEM: 128GKB
	  XDAT_CMN: 2KB
	  XDAT_LANE 4KB
...
void main(void) {
	...
	DBG_Printf("\tBuilt: %s-%s\n\r",__DATE__, __TIME__);
        ...
        reg_LMSK_15_0_b0 = 0x55;
        reg_LMSK_15_0_b1 = 0xaa;
	while(1) {		
    
        reg_LMSK_15_0_b0 = 0x22;
        reg_LMSK_15_0_b1 = 0xee;
            //reg_MCU_DEBUG1_LANE_7_0 = 0x55; 
            //reg_MCU_DEBUG1_LANE_7_0 = 0xaa; 
	//	scheduler();		
