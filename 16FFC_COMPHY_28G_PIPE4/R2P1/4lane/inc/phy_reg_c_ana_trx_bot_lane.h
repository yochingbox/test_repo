...
typedef union {
	struct {
		...
		uint8_t RESERVED_4                               : 1;	/*      4     r/w   1*/
		uint8_t RESERVED_5                               : 1;	/*      5     r/w   1*/
		uint8_t RESERVED_6                               : 1;	/*      6     r/w   1*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   1*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
typedef union {
	struct {
		...
		uint8_t IPP_SLLP_CUR_SEL_LANE_2_0                : 3;	/*  [6:4]     r/w 3'h7*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   1*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
typedef union {
	struct {
		...
		uint8_t IPTAT_SLLP_CUR_SEL_LANE_1_0              : 2;	/*  [2:1]     r/w 2'h0*/
		uint8_t IPTAT_FFE_CUR_SEL_LANE_2_0               : 3;	/*  [5:3]     r/w 3'h6*/
