...
typedef union {
	struct {
		...
		uint8_t MCU_READY_HOLD_LANE                      : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} MCU_COMMAND0_t;
...
#define reg_MCU_READY_HOLD_LANE  MCU_COMMAND0.BF.MCU_READY_HOLD_LANE

// 0x00e8	MCU_FW_SWITCH		MCU Firmware Switch Register 0
typedef union {
	struct {
		uint8_t MCU_FW_SWITCH_EN_LANE_31_0_b0            : 8;	/* [31:0]     r/w   0*/
		uint8_t MCU_FW_SWITCH_EN_LANE_31_0_b1            : 8;	/* [31:0]     r/w   0*/
		uint8_t MCU_FW_SWITCH_EN_LANE_31_0_b2            : 8;	/* [31:0]     r/w   0*/
		uint8_t MCU_FW_SWITCH_EN_LANE_31_0_b3            : 8;	/* [31:0]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} MCU_FW_SWITCH_t;
__xdata __at( 0x22e8 ) volatile MCU_FW_SWITCH_t MCU_FW_SWITCH;
#define reg_MCU_FW_SWITCH_EN_LANE_31_0_b0  MCU_FW_SWITCH.BF.MCU_FW_SWITCH_EN_LANE_31_0_b0
#define reg_MCU_FW_SWITCH_EN_LANE_31_0_b1  MCU_FW_SWITCH.BF.MCU_FW_SWITCH_EN_LANE_31_0_b1
#define reg_MCU_FW_SWITCH_EN_LANE_31_0_b2  MCU_FW_SWITCH.BF.MCU_FW_SWITCH_EN_LANE_31_0_b2
#define reg_MCU_FW_SWITCH_EN_LANE_31_0_b3  MCU_FW_SWITCH.BF.MCU_FW_SWITCH_EN_LANE_31_0_b3

// 0x00f4	MEM_ECC_ERR_ADDRESS0		MEMORY LANE ECC ERROR ADDR
typedef union {
	struct {
		uint8_t XDATA_ECC_ERR_ADDR_LANE_8_0_b0           : 8;	/*  [8:0]       r   0*/
		uint8_t XDATA_ECC_ERR_ADDR_LANE_8_0_b1           : 1;	/*  [8:0]       r   0*/
		uint8_t IRAM_ECC_ERR_ADDR_LANE_7_0_b0            : 7;	/* [16:9]       r   0*/
		uint8_t IRAM_ECC_ERR_ADDR_LANE_7_0_b1            : 1;	/* [16:9]       r   0*/
		uint8_t CACHE_ECC_ERR_ADDR_LANE_7_0_b0           : 7;	/*[24:17]       r   0*/
		uint8_t CACHE_ECC_ERR_ADDR_LANE_7_0_b1           : 1;	/*[24:17]       r   0*/
		uint8_t RESERVED_25                              : 7;	/*[31:25]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_XDATA_ECC_ERR_ADDR_LANE_8_0_b0  MEM_ECC_ERR_ADDRESS0.BF.XDATA_ECC_ERR_ADDR_LANE_8_0_b0
#define reg_XDATA_ECC_ERR_ADDR_LANE_8_0_b1  MEM_ECC_ERR_ADDRESS0.BF.XDATA_ECC_ERR_ADDR_LANE_8_0_b1
