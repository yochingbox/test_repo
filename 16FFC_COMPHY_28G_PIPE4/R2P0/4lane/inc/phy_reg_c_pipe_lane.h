...
typedef union {
	struct {
		...
		uint8_t CFG_GEN2_TXDATA_DLY_LANE_1_0             : 2;	/*[20:19]     r/w 2'h2*/
...
typedef union {
	struct {
		...
		uint8_t PM_TX_RATE_SEL_LANE_1_0                  : 2;	/*  [5:4]       r   0*/
		uint8_t PM_RX_RATE_SEL_LANE_1_0                  : 2;	/*  [7:6]       r   0*/
		uint8_t PM_RX_INIT_LANE                          : 1;	/*      8       r   0*/
		uint8_t PM_TX_IDLE_LOZ_LANE                      : 1;	/*      9       r   0*/
		uint8_t PM_TX_IDLE_HIZ_LANE                      : 1;	/*     10       r   0*/
		uint8_t PM_TXDETECTRX_EN_LANE                    : 1;	/*     11       r   0*/
		uint8_t PM_PU_IVREF_LANE                         : 1;	/*     12       r   0*/
		uint8_t PM_BEACON_TX_EN_LANE                     : 1;	/*     13       r   0*/
		uint8_t PM_BEACON_RX_EN_LANE                     : 1;	/*     14       r   0*/
		uint8_t PM_TX_VCMHOLD_EN_LANE                    : 1;	/*     15       r   0*/
		uint8_t PM_TXDCLK_PCLK_EN_LANE                   : 1;	/*     16       r   0*/
		uint8_t PM_PCLK_DPCLK_EN_LANE                    : 1;	/*     17       r   0*/
		uint8_t PM_OSCCLK_PCLK_EN_LANE                   : 1;	/*     18       r   0*/
		uint8_t PM_OSCCLK_AUX_CLK_EN_LANE                : 1;	/*     19       r   0*/
		uint8_t PM_DP_RST_N_LANE                         : 1;	/*     20       r   0*/
		uint8_t PM_ASYNC_RST_N_LANE                      : 1;	/*     21       r   0*/
		uint8_t PM_PIPE_8B_LANE                          : 1;	/*     22       r   0*/
		uint8_t PM_PIPE_32B_LANE                         : 1;	/*     23       r   0*/
		uint8_t PM_DPCLK_125_LANE                        : 1;	/*     24       r   0*/
		uint8_t PM_CLK_REQ_N_LANE                        : 1;	/*     25       r   0*/
		uint8_t PM_STATE_LANE_5_0                        : 6;	/*[31:26]       r   0*/
	} BF;
	uint16_t VAL;
} LANE_STATUS0_t;
__xdata __at( 0x4008 ) volatile LANE_STATUS0_t LANE_STATUS0;
...
#define reg_PM_TX_RATE_SEL_LANE_1_0  LANE_STATUS0.BF.PM_TX_RATE_SEL_LANE_1_0
#define reg_PM_RX_RATE_SEL_LANE_1_0  LANE_STATUS0.BF.PM_RX_RATE_SEL_LANE_1_0
...
#define reg_PM_PIPE_8B_LANE  LANE_STATUS0.BF.PM_PIPE_8B_LANE
#define reg_PM_PIPE_32B_LANE  LANE_STATUS0.BF.PM_PIPE_32B_LANE
#define reg_PM_DPCLK_125_LANE  LANE_STATUS0.BF.PM_DPCLK_125_LANE
...
typedef union {
	struct {
		...
		uint8_t PHY_MAC_PHYSTATUS_LANE                   : 1;	/*      9       r   0*/
		uint8_t MAC_PHY_RATE_LANE_1_0                    : 2;	/*[11:10]       r   0*/
...
__xdata __at( 0x4010 ) volatile LANE_CFG_STATUS2_LANE_t LANE_CFG_STATUS2_LANE;
...
#define reg_PHY_MAC_PHYSTATUS_LANE  LANE_CFG_STATUS2_LANE.BF.PHY_MAC_PHYSTATUS_LANE
#define reg_MAC_PHY_RATE_LANE_1_0  LANE_CFG_STATUS2_LANE.BF.MAC_PHY_RATE_LANE_1_0
...
typedef union {
	struct {
		...
		uint8_t CFG_BAL_IGNORE_HDR_LANE                  : 1;	/*      9     r/w   0*/
		uint8_t SPARE_REG_186_10_LANE                    : 1;	/*     10     r/w   0*/
		...
		uint8_t CFG_ELB_THRESHOLD_LANE_3_0               : 4;	/*[19:16]     r/w 4'h8*/
		uint8_t CFG_LOW_WATER_MARK_LANE_3_0              : 4;	/*[23:20]     r/w 4'h2*/
		uint8_t CFG_HIGH_WATER_MARK_LANE_3_0             : 4;	/*[27:24]     r/w 4'he*/
		uint8_t EBUF_THRESHOLD_WIDE_LANE                 : 1;	/*     28     r/w   0*/
...
__xdata __at( 0x4018 ) volatile LANE_CFG2_LANE_t LANE_CFG2_LANE;
...
#define reg_CFG_BAL_IGNORE_HDR_LANE  LANE_CFG2_LANE.BF.CFG_BAL_IGNORE_HDR_LANE
#define reg_SPARE_REG_186_10_LANE  LANE_CFG2_LANE.BF.SPARE_REG_186_10_LANE
...
#define reg_CFG_ELB_THRESHOLD_LANE_3_0  LANE_CFG2_LANE.BF.CFG_ELB_THRESHOLD_LANE_3_0
#define reg_CFG_LOW_WATER_MARK_LANE_3_0  LANE_CFG2_LANE.BF.CFG_LOW_WATER_MARK_LANE_3_0
#define reg_CFG_HIGH_WATER_MARK_LANE_3_0  LANE_CFG2_LANE.BF.CFG_HIGH_WATER_MARK_LANE_3_0
...
__xdata __at( 0x4020 ) volatile LANE_CFG4_t LANE_CFG4;
...
typedef union {
	struct {
		...
		uint8_t CFG_HIZ_CAL_WAIT_LANE_3_0                : 4;	/*[27:24]     r/w 4'h4*/
...
__xdata __at( 0x4028 ) volatile LANE_CFG_STATUS3_LANE_t LANE_CFG_STATUS3_LANE;
...
__xdata __at( 0x4030 ) volatile LANE_DP_PIE8_CFG0_LANE_t LANE_DP_PIE8_CFG0_LANE;
...
__xdata __at( 0x4038 ) volatile LANE_USB_DP_CFG1_LANE_t LANE_USB_DP_CFG1_LANE;
...
__xdata __at( 0x4040 ) volatile LANE_USB_DP_CFG2_LANE_t LANE_USB_DP_CFG2_LANE;
...
__xdata __at( 0x4048 ) volatile LANE_EQ_CFG0_LANE_t LANE_EQ_CFG0_LANE;
...
__xdata __at( 0x4050 ) volatile LANE_EQ_CFG1_LANE_t LANE_EQ_CFG1_LANE;
...
__xdata __at( 0x4058 ) volatile LANE_PRESET_CFG0_LANE_t LANE_PRESET_CFG0_LANE;
...
__xdata __at( 0x4060 ) volatile LANE_PRESET_CFG2_LANE_t LANE_PRESET_CFG2_LANE;
...
__xdata __at( 0x4068 ) volatile LANE_PRESET_CFG4_LANE_t LANE_PRESET_CFG4_LANE;
...
__xdata __at( 0x4070 ) volatile LANE_PRESET_CFG6_LANE_t LANE_PRESET_CFG6_LANE;
...
__xdata __at( 0x4078 ) volatile LANE_PRESET_CFG8_LANE_t LANE_PRESET_CFG8_LANE;
...
__xdata __at( 0x4080 ) volatile LANE_PRESET_CFG10_LANE_t LANE_PRESET_CFG10_LANE;
...
__xdata __at( 0x4088 ) volatile LANE_PRESET_CFG12_LANE_t LANE_PRESET_CFG12_LANE;
...
__xdata __at( 0x4090 ) volatile LANE_PRESET_CFG14_LANE_t LANE_PRESET_CFG14_LANE;
...
__xdata __at( 0x4098 ) volatile LANE_PRESET_CFG16_LANE_t LANE_PRESET_CFG16_LANE;
...
__xdata __at( 0x40a0 ) volatile LANE_COEFF_MAX0_LANE_t LANE_COEFF_MAX0_LANE;
...
__xdata __at( 0x40a8 ) volatile LANE_REMOTE_SET_LANE_t LANE_REMOTE_SET_LANE;
...
typedef union {
	struct {
		...
		uint8_t CFG_PRESET_INDEX_SEL_LANE                : 1;	/*     12     r/w   0*/
...
__xdata __at( 0x40b0 ) volatile LANE_EQ_16G_CFG0_LANE_t LANE_EQ_16G_CFG0_LANE;
...
__xdata __at( 0x40b8 ) volatile LANE_16G_PRESET_CFG0_LANE_t LANE_16G_PRESET_CFG0_LANE;
...
__xdata __at( 0x40c0 ) volatile LANE_16G_PRESET_CFG2_LANE_t LANE_16G_PRESET_CFG2_LANE;
...
__xdata __at( 0x40c8 ) volatile LANE_16G_PRESET_CFG4_LANE_t LANE_16G_PRESET_CFG4_LANE;
...
__xdata __at( 0x40d0 ) volatile LANE_16G_PRESET_CFG6_LANE_t LANE_16G_PRESET_CFG6_LANE;
...
__xdata __at( 0x40d8 ) volatile LANE_16G_PRESET_CFG8_LANE_t LANE_16G_PRESET_CFG8_LANE;
...
__xdata __at( 0x40e0 ) volatile LANE_16G_PRESET_CFG10_LANE_t LANE_16G_PRESET_CFG10_LANE;
...
__xdata __at( 0x40e8 ) volatile LANE_16G_PRESET_CFG12_LANE_t LANE_16G_PRESET_CFG12_LANE;
...
__xdata __at( 0x40f0 ) volatile LANE_16G_PRESET_CFG14_LANE_t LANE_16G_PRESET_CFG14_LANE;
...
__xdata __at( 0x40f8 ) volatile LANE_16G_PRESET_CFG16_LANE_t LANE_16G_PRESET_CFG16_LANE;
