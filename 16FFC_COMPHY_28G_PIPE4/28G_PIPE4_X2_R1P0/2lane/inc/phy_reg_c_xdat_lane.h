...
typedef union {
	struct {
		...
		uint8_t BYPASS_TXFFE_TRAIN_LANE                  : 1;	/*     25     r/w   0*/
...
#define lnx_BYPASS_TXFFE_TRAIN_LANE  DFE_CONTROL_3.BF.BYPASS_TXFFE_TRAIN_LANE
...
typedef union {
	struct {
		uint8_t DFE_ADAPT_LP_NUM_F0D_LANE_7_0            : 8;	/*  [7:0]     r/w 8'h6*/
		uint8_t DFE_ADAPT_LP_NUM_F0B_LANE_7_0            : 8;	/* [15:8]     r/w 8'h2*/
