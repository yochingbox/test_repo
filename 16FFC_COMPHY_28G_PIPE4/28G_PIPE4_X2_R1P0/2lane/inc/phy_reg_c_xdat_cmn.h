...
typedef union {
	struct {
		...
		uint8_t ETHERNET_TRAIN_32BIT_OUTPUT_DISABLE      : 1;	/*     28     r/w   0*/
		uint8_t PT_OUT_TRAIN_COMP                        : 1;	/*     29     r/w   0*/
		uint8_t RESERVED_30                              : 1;	/*     30     r/w   0*/
		uint8_t RESERVED_31                              : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
...
#define cmx_ETHERNET_TRAIN_32BIT_OUTPUT_DISABLE  CONTROL_CONFIG3.BF.ETHERNET_TRAIN_32BIT_OUTPUT_DISABLE
#define cmx_PT_OUT_TRAIN_COMP  CONTROL_CONFIG3.BF.PT_OUT_TRAIN_COMP
...
typedef union {
	struct {
		...
		uint8_t LOCAL_TX_PRESET_INDEX_3_0                : 4;	/*[27:24]     r/w 4'h2*/
