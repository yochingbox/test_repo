...
extern __xdata uint8_t gen_pll_rate, pre_gen_pll_rate;
...
extern __xdata bool ofst_sat, half_ui_code;
extern __xdata uint8_t save_dfe_dis;
extern __xdata int8_t train_ofst_save;
//extern __xdata int8_t train_ofst;
...
// cannot change speed table, manually added
...
//new cds memory
 ...
 __xdata __at(0x6180) Status_dfe_sm_t dfe_sm;
 __xdata __at(0x6180+sizeof(Status_dfe_sm_t)) Status_dfe_sm_dc_t dfe_sm_dc;
#endif //GLOBAL_H
