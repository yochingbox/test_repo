...
#define tag_CDR_MAXF0P_EN 	1//(lnx_SKIP_CDR_MAXF0P_LANE==0)  //1
#define tag_CDR_MIDPOINT_EN   1//(lnx_SKIP_CDR_MIDPOINT_LANE==0)//1
#define tag_CDR_MIDPOINT_STEP_NUM	0//lnx_CDR_STEP_NUM_LANE_7_0 //5
...
#define tag_ringpll_ind_en	1 //cmx_RINGPLL_IND_EN
