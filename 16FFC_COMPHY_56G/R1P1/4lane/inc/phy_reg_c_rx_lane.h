...
typedef union {
	struct {
		...
		uint8_t RXD_GRAY_EN_LANE                         : 1;	/*     28     r/w   0*/
...
#define reg_RXD_GRAY_EN_LANE  RX_DATA_PATH_REG.BF.RXD_GRAY_EN_LANE
...
typedef union {
	struct {
		...
		uint8_t DTL_FL_FINE_LANE                         : 1;	/*     18     r/w   0*/
...
#define reg_DTL_FL_FINE_LANE  DTL_REG2.BF.DTL_FL_FINE_LANE
