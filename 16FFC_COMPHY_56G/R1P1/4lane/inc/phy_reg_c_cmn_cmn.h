...
typedef union {
	struct {
		...
		uint8_t ANA_CMN_PLL_LOCK_FM_REG                  : 1;	/*      1     r/w   0*/
		uint8_t ANA_CMN_PLL_LOCK                         : 1;	/*      2     r/w   0*/
		uint8_t ANA_CMN_PLL_LOCK_RING_FM_REG             : 1;	/*      3     r/w   0*/
		uint8_t ANA_CMN_PLL_LOCK_RING                    : 1;	/*      4     r/w   0*/
		...
		uint8_t ANA_CMN_TEMPC_LEVEL_TODIG_FM_REG         : 1;	/*     12     r/w   0*/
		uint8_t ANA_CMN_TEMPC_LEVEL_TODIG_1_0            : 2;	/*[14:13]     r/w 2'h0*/
...
#define reg_ANA_CMN_PLL_LOCK_FM_REG  INPUT_CMN_PIN_REG2.BF.ANA_CMN_PLL_LOCK_FM_REG
#define reg_ANA_CMN_PLL_LOCK  INPUT_CMN_PIN_REG2.BF.ANA_CMN_PLL_LOCK
#define reg_ANA_CMN_PLL_LOCK_RING_FM_REG  INPUT_CMN_PIN_REG2.BF.ANA_CMN_PLL_LOCK_RING_FM_REG
#define reg_ANA_CMN_PLL_LOCK_RING  INPUT_CMN_PIN_REG2.BF.ANA_CMN_PLL_LOCK_RING
#define reg_IDDQ_FM_REG  INPUT_CMN_PIN_REG2.BF.IDDQ_FM_REG
#define reg_IDDQ  INPUT_CMN_PIN_REG2.BF.IDDQ
#define reg_ANA_CMN_TEMPC_LEVEL_TODIG_FM_REG  INPUT_CMN_PIN_REG2.BF.ANA_CMN_TEMPC_LEVEL_TODIG_FM_REG
#define reg_ANA_CMN_TEMPC_LEVEL_TODIG_1_0  INPUT_CMN_PIN_REG2.BF.ANA_CMN_TEMPC_LEVEL_TODIG_1_0
...
typedef union {
	struct {
		...
		uint8_t ANA_CMN_VCOAMP_HI_FM_REG                 : 1;	/*     19     r/w   0*/
		uint8_t ANA_CMN_VCOAMP_HI                        : 1;	/*     20     r/w   0*/
...
#define reg_ANA_CMN_VCOAMP_HI_FM_REG  ANA_TSEN_CONTROL.BF.ANA_CMN_VCOAMP_HI_FM_REG
#define reg_ANA_CMN_VCOAMP_HI  ANA_TSEN_CONTROL.BF.ANA_CMN_VCOAMP_HI
...
typedef union {
	struct {
		...
		uint8_t ANA_CMN_PLL_VDDVCO_OVERTH_RING_FM_REG    : 1;	/*     28     r/w   0*/
		uint8_t ANA_CMN_PLL_VDDVCO_OVERTH_RING           : 1;	/*     29     r/w   0*/
		uint8_t ANA_CMN_PLL_VCON_OVERTH_RING_FM_REG      : 1;	/*     30     r/w   0*/
		uint8_t ANA_CMN_PLL_VCON_OVERTH_RING             : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} PLLCAL_REG1_t;
...
#define reg_ANA_CMN_PLL_VDDVCO_OVERTH_RING_FM_REG  PLLCAL_REG1.BF.ANA_CMN_PLL_VDDVCO_OVERTH_RING_FM_REG
#define reg_ANA_CMN_PLL_VDDVCO_OVERTH_RING  PLLCAL_REG1.BF.ANA_CMN_PLL_VDDVCO_OVERTH_RING
#define reg_ANA_CMN_PLL_VCON_OVERTH_RING_FM_REG  PLLCAL_REG1.BF.ANA_CMN_PLL_VCON_OVERTH_RING_FM_REG
#define reg_ANA_CMN_PLL_VCON_OVERTH_RING  PLLCAL_REG1.BF.ANA_CMN_PLL_VCON_OVERTH_RING
...
typedef union {
	struct {
		...
		uint8_t REF1M_GEN_DIV_7_0                        : 8;	/* [15:8]     r/w 8'h18*/
...
#define reg_REF1M_GEN_DIV_7_0  CLKGEN_CMN_REG1.BF.REF1M_GEN_DIV_7_0
...
// 0x0084	CMN_ISR		MCU ISR Register 1
typedef union {
	struct {
...
__xdata __at( 0xa384 ) volatile CMN_ISR_t CMN_ISR;
#define reg_LANE0_INT_ISR  CMN_ISR.BF.LANE0_INT_ISR
#define reg_LANE1_INT_ISR  CMN_ISR.BF.LANE1_INT_ISR
#define reg_LANE2_INT_ISR  CMN_ISR.BF.LANE2_INT_ISR
#define reg_LANE3_INT_ISR  CMN_ISR.BF.LANE3_INT_ISR

// 0x0088	CMN_ISR_MASK		MCU ISR Register 2
typedef union {
	struct {
...
__xdata __at( 0xa388 ) volatile CMN_ISR_MASK_t CMN_ISR_MASK;
#define reg_LANE0_INT_MASK  CMN_ISR_MASK.BF.LANE0_INT_MASK
#define reg_LANE1_INT_MASK  CMN_ISR_MASK.BF.LANE1_INT_MASK
#define reg_LANE2_INT_MASK  CMN_ISR_MASK.BF.LANE2_INT_MASK
#define reg_LANE3_INT_MASK  CMN_ISR_MASK.BF.LANE3_INT_MASK

// 0x008c	CMN_ISR_CLEAR		MCU ISR Register 3
typedef union {
	struct {
...
__xdata __at( 0xa38c ) volatile CMN_ISR_CLEAR_t CMN_ISR_CLEAR;
#define reg_LANE0_INT_ISR_CLEAR  CMN_ISR_CLEAR.BF.LANE0_INT_ISR_CLEAR
#define reg_LANE1_INT_ISR_CLEAR  CMN_ISR_CLEAR.BF.LANE1_INT_ISR_CLEAR
#define reg_LANE2_INT_ISR_CLEAR  CMN_ISR_CLEAR.BF.LANE2_INT_ISR_CLEAR
#define reg_LANE3_INT_ISR_CLEAR  CMN_ISR_CLEAR.BF.LANE3_INT_ISR_CLEAR

// 0x0090	SET_LANE_ISR		MCU ISR Register 4
typedef union {
	struct {
...
typedef union {
	struct {
		...
		uint8_t INT2_ENABLE_CMN                          : 1;	/*     27     r/w   1*/
		uint8_t INT3_ENABLE_CMN                          : 1;	/*     28     r/w   1*/
		uint8_t INT4_ENABLE_CMN                          : 1;	/*     29     r/w   1*/
		uint8_t INT5_ENABLE_CMN                          : 1;	/*     30     r/w   1*/
		uint8_t INT0_ENABLE_CMN                          : 1;	/*     31     r/w   1*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CMN_CACHE_DEBUG0_t;
