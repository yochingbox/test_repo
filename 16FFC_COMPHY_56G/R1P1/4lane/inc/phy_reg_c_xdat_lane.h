...
// 0x0068	CLI_REG0		Command Line Interface
typedef union {
	struct {
...
__xdata __at( 0x6068 ) volatile CLI_REG0_t CLI_REG0;
#define lnx_CLI_CMD_LANE_7_0  CLI_REG0.BF.CLI_CMD_LANE_7_0
#define lnx_CLI_START_LANE  CLI_REG0.BF.CLI_START_LANE
#define lnx_FORCE_CDS_CTRL_EN_LANE  CLI_REG0.BF.FORCE_CDS_CTRL_EN_LANE
#define lnx_FORCE_CDS_STATE_LANE  CLI_REG0.BF.FORCE_CDS_STATE_LANE
#define lnx_TRAIN_PH_OS_ESM_2C_LANE_7_0  CLI_REG0.BF.TRAIN_PH_OS_ESM_2C_LANE_7_0
#define lnx_TRAIN_PH_OS_DATA_2C_LANE_7_0  CLI_REG0.BF.TRAIN_PH_OS_DATA_2C_LANE_7_0
...
__xdata __at( 0x6070 ) volatile ESM_REG0_t ESM_REG0;
...
// 0x0074	TRAIN_CONTROL_3		
typedef union {
	struct {
		uint8_t TRAIN_F2_SLICER_LANE_7_0                 : 8;	/*  [7:0]     r/w 8'h0*/
		uint8_t TRAIN_F2_DATA_LANE_7_0                   : 8;	/* [15:8]     r/w 8'h0*/
		uint8_t TRAIN_F1_SLICER_LANE_7_0                 : 8;	/*[23:16]     r/w 8'h0*/
		uint8_t TRAIN_F1_DATA_LANE_7_0                   : 8;	/*[31:24]     r/w 8'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TRAIN_CONTROL_3_t;
__xdata __at( 0x6074 ) volatile TRAIN_CONTROL_3_t TRAIN_CONTROL_3;
#define lnx_TRAIN_F2_SLICER_LANE_7_0  TRAIN_CONTROL_3.BF.TRAIN_F2_SLICER_LANE_7_0
#define lnx_TRAIN_F2_DATA_LANE_7_0  TRAIN_CONTROL_3.BF.TRAIN_F2_DATA_LANE_7_0
#define lnx_TRAIN_F1_SLICER_LANE_7_0  TRAIN_CONTROL_3.BF.TRAIN_F1_SLICER_LANE_7_0
#define lnx_TRAIN_F1_DATA_LANE_7_0  TRAIN_CONTROL_3.BF.TRAIN_F1_DATA_LANE_7_0

// 0x0078	TRAIN_CONTROL_4		
typedef union {
	struct {
...
__xdata __at( 0x6078 ) volatile TRAIN_CONTROL_4_t TRAIN_CONTROL_4;
...
__xdata __at( 0x607c ) volatile TRAIN_CONTROL_5_t TRAIN_CONTROL_5;
...
__xdata __at( 0x6080 ) volatile TRAIN_CONTROL_6_t TRAIN_CONTROL_6;
...
__xdata __at( 0x6084 ) volatile TRAIN_CONTROL_7_t TRAIN_CONTROL_7;
...
#define lnx_TRAIN_BOOST_LANE_15_0  TRAIN_CONTROL_7.WT.W1
