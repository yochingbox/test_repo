...
void reset_core_tx_down(void) BANKING_CTRL {
	...
	if(reg_RX_SFT_RST_CHG_FALLING_ISR_LANE == 1) {
		...
		wait_for((reg_PIN_PU_RX_RD_LANE && !reg_SFT_RST_NO_REG_RX_RD_LANE) || (reg_PIN_PU_TX_RD_LANE && !reg_SFT_RST_NO_REG_TX_RD_LANE), 0);   //TRX SFT_RST wakeup needs to wait at least one PU and RESET_CORE level to be asserted
				
		reg_MCU_DEBUG0_LANE_7_0 = 0x00;

		if((reg_PIN_PU_RX_RD_LANE && !reg_SFT_RST_NO_REG_RX_RD_LANE) && (reg_PIN_PU_TX_RD_LANE && !reg_SFT_RST_NO_REG_TX_RD_LANE)) {
		...
		else if(reg_PIN_PU_TX_RD_LANE && !reg_SFT_RST_NO_REG_TX_RD_LANE){
			//clear all lower ISRs and SFT_RST fall/rise after PU starts
			reg_TX_SFT_RST_CHG_RISING_ISR_CLEAR_LANE = 1;
			reg_TX_SFT_RST_CHG_RISING_ISR_CLEAR_LANE = 0;	
		...
		else if(reg_PIN_PU_RX_RD_LANE && !reg_SFT_RST_NO_REG_RX_RD_LANE){  //Only RX PU
			//clear all lower ISRs and SFT_RST fall/rise after PU starts
			reg_RX_SFT_RST_CHG_RISING_ISR_CLEAR_LANE = 1;
			reg_RX_SFT_RST_CHG_RISING_ISR_CLEAR_LANE = 0;
	...
	//Only TX release
		...
		wait_for(reg_PIN_PU_TX_RD_LANE && !reg_SFT_RST_NO_REG_TX_RD_LANE, 0); //SFT_RST wakeup needs to wait PU & RESET_CORE signals	
		
		reg_MCU_DEBUG0_LANE_7_0 = 0x00;

		if(reg_PIN_PU_TX_RD_LANE && !reg_SFT_RST_NO_REG_TX_RD_LANE){
			//clear all lower ISRs and SFT_RST fall/rise after PU starts
			reg_TX_SFT_RST_CHG_RISING_ISR_CLEAR_LANE = 1;
			reg_TX_SFT_RST_CHG_RISING_ISR_CLEAR_LANE = 0;	
...
void reset_core_rx_down(void) BANKING_CTRL {
	...
	//Only RX release
		...
		wait_for(reg_PIN_PU_RX_RD_LANE && !reg_SFT_RST_NO_REG_RX_RD_LANE, 0); //SFT_RST wakeup needs to wait PU & RESET_CORE signals	
		
		reg_MCU_DEBUG0_LANE_7_0 = 0x00;

		if(reg_PIN_PU_RX_RD_LANE && !reg_SFT_RST_NO_REG_RX_RD_LANE){  //Only RX PU
			//clear all lower ISRs and SFT_RST fall/rise after PU starts
			reg_RX_SFT_RST_CHG_RISING_ISR_CLEAR_LANE = 1;
			reg_RX_SFT_RST_CHG_RISING_ISR_CLEAR_LANE = 0;	
