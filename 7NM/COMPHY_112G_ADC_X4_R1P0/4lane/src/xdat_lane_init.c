...
//TRX_TRAINING_TOP_CTRL_0.BT.B0 = 0x0; //00000000, trx_train_final_tuning_bypass_en_lane, trx_train_opt_bypass_en_lane, tx_train_txffe_set_pre_bypass_en_lane, trx_train_sweep_coarse_ctle_bypass_en_lane, trx_train_lock_cdr_bypass_en_lane, tx_train_ffe_det_pre_bypass_en_lane, rx_train_blind_bypass_en_lane, trx_train_sat_check_bypass_en_lane
  TRX_TRAINING_TOP_CTRL_0.BT.B1 = 0x80; //10000000, tx_train_shape_based_train_en_lane, tx_train_shape_based_train_bypass_en_lane, trx_train_opt_fine_bypass_en_lane, trx_train_mini_scheduler_bypass_en_lane, trx_train_adc_cal_bypass_en_lane, trx_train_exit_bypass_en_lane, trx_final_tune_bypass_en_lane, trx_train_init_bypass_en_lane
  TRX_TRAINING_TOP_CTRL_0.BT.B2 = 0xFF; //11111111, trx_train_trx_opt_en_lane, trx_train_dfe_opt_en_lane, trx_train_flt_opt_en_lane, trx_train_agc_en_lane, trx_train_adc_cal_gao_en_lane, trx_train_adc_cal_skew_en_lane, tx_train_p2p_hold_lane, trx_train_trx_opt_fine_en_lane
  TRX_TRAINING_TOP_CTRL_0.BT.B3 = 0xC6; //11000110, trx_train_dp_pst1_fz_dfe_en_lane, trx_train_dtl_phase_opt_en_lane, trx_train_txffe_preset_ext_en_lane, trx_train_tx_train_en_lane, trx_train_txffe_preset_ext_lane[2:0], tx_train_only_start_lane
...
//TRX_TRAINING_TOP_CTRL_2.BT.B1 = 0x0; //00000000, rx_train_ctle_tune_cur2_en_lane, rx_train_ctle_tune_rl1_extra_en_lane, trx_train_dfe_start_val_lane[5:0]
...
//TRX_TRAINING_TOP_CTRL_3.BT.B3 = 0x0; //00000000, trx_train_debug_en_lane[7:0]
  ...
  TRAIN_INITIALIZATION.BT.B3 = 0x18; //00011000, trx_train_ffe_len_opt_en_lane, train_cont_mode_dtl_ph_opt_en_lane, rx_train_coarse_gain_tune_step_lane[1:0], rx_train_ctle_tune_rl1_step_dn_lane[3:0]
...
//TRAIN_CONTROL_2.BT.B3 = 0x0; //00000000, rx_rxffe_r_ini_lane[3:0], rxffe_r_gain_train_lane[3:0]
  CTLE_TUNE_CONTROL.BT.B0 = 0x8; //00001000, rx_train_ctle_tune_rc_snr_th_lane[7:0]
  CTLE_TUNE_CONTROL.BT.B1 = 0x24; //00100100, rx_train_ctle_tune_r_step_up_lane[3:0], rx_train_ctle_tune_timer_lane[3:0]
  CTLE_TUNE_CONTROL.BT.B2 = 0x10; //00010000, rx_train_ctle_tune_cur_snr_th_lane[7:0]
  CTLE_TUNE_CONTROL.BT.B3 = 0x8; //00001000, rx_train_ctle_tune_snr_th_lane[7:0]
...
//RX_TRAIN_SAT_CHK_CTRL_2.BT.B1 = 0x0; //###00000, rx_train_adc_sat_check_large_signal_coarse_gain_lane[4:0]
  RX_TRAIN_SAT_CHK_CTRL_2.BT.B2 = 0x32; //00110010, rx_train_adc_sat_check_large_signal_r_lane[3:0], rx_train_ctle_tune_r_step_dn_lane[3:0]
  ...
  RX_BLIND_TRAIN_CTRL_0.BT.B3 = 0x1E; //00011110, rx_train_blind_max_trial_lane[7:0]
...
//TX_FFE_GRADIENT_BASED_ADAPTATION_CTRL_1.BT.B1 = 0x0; //00000000, tx_train_opt_adc_sat_th_lane[15:0]
  ...
  TX_FFE_PRESET_SELECTION_CTRL.BT.B1 = 0x80; //10000000, trx_train_dtl_hl_ratio_th_lane[7:0]
  TX_FFE_PRESET_SELECTION_CTRL.BT.B2 = 0x8; //00001000, trx_train_fine_ctle_tune_rc_snr_th_lane[7:0]
  TX_FFE_PRESET_SELECTION_CTRL.BT.B3 = 0x6; //00000110, trx_train_fine_ctle_tune_c_step_lane[7:0]
...
//RX_TRAIN_SAT_CHK_CTRL_4.BT.B3 = 0x0; //00000000, rx_train_adc_in_th1_lane[15:0]
  ...
  RX_BLIND_TRAIN_CTRL_3.BT.B0 = 0x7; //00000111, rx_train_blind_adc_sat_th2_lane[15:0]
//RX_BLIND_TRAIN_CTRL_3.BT.B1 = 0x0; //00000000, rx_train_blind_adc_sat_th2_lane[15:0]
  RX_BLIND_TRAIN_CTRL_3.BT.B2 = 0x28; //##101000, rx_train_blind_adc_th2_lane[5:0]
  TRX_TRAINING_TOP_CTRL_4.BT.B0 = 0x38; //00111000, trx_train_dtl_snr_af_cds_th_lane[7:0]
//TRX_TRAINING_TOP_CTRL_4.BT.B1 = 0x0; //#######0, cds_fault_triggered_lane
...
//CAL_CTRL1.BT.B1 = 0x0; //00000000, rs_tempc_dbg_step_lane[7:0]
  TX_FFE_PRESET_SELECTION_CTRL1.BT.B0 = 0x30; //##110000, tx_train_det_preset_phase_scan_en_lane, tx_train_det_preset_hp_multiplier_lane[4:0]
  TX_FFE_PRESET_SELECTION_CTRL1.BT.B1 = 0xF; //###01111, tx_train_det_preset_lp_multiplier_lane[4:0]
//TX_FFE_PRESET_SELECTION_CTRL1.BT.B2 = 0x0; //00000000, tx_train_det_preset_scan_ppm_lane[15:0]
  TX_FFE_PRESET_SELECTION_CTRL1.BT.B3 = 0x80; //10000000, tx_train_det_preset_scan_ppm_lane[15:0]
