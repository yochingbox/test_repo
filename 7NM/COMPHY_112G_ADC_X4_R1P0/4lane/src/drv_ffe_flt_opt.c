...
uint8_t drv_ffe_flt_pwr () BANKING_CTRL 
{
    ...
    ffe_flt_coe[0] = (int8_t)(reg_RX_DP_LMS_FFE_FLT1_COE_LANE_2_0 << 5) >> 5;
    ffe_flt_coe[1] = (int8_t)(reg_RX_DP_LMS_FFE_FLT2_COE_LANE_2_0 << 5) >> 5;
    ffe_flt_coe[2] = (int8_t)(reg_RX_DP_LMS_FFE_FLT3_COE_LANE_2_0 << 5) >> 5;
    ffe_flt_coe[3] = (int8_t)(reg_RX_DP_LMS_FFE_FLT4_COE_LANE_2_0 << 5) >> 5;
    ffe_flt_coe[4] = (int8_t)(reg_RX_DP_LMS_FFE_FLT5_COE_LANE_2_0 << 5) >> 5;
    ffe_flt_coe[5] = (int8_t)(reg_RX_DP_LMS_FFE_FLT6_COE_LANE_2_0 << 5) >> 5;
    ffe_flt_coe[6] = (int8_t)(reg_RX_DP_LMS_FFE_FLT7_COE_LANE_2_0 << 5) >> 5;
    ffe_flt_coe[7] = (int8_t)(reg_RX_DP_LMS_FFE_FLT8_COE_LANE_2_0 << 5) >> 5;
...
void drv_ffe_flt_opt () BANKING_CTRL 
{
    ...
    max_snr_pos = reg_RX_DP_FFE_FLT_SEL_LANE_5_0;
    max_pwr_pos = 0;
    ...
    {
      //set position
      reg_RX_DP_FFE_FLT_SEL_LANE_5_0 = i;
    ...
    reg_RX_DP_FFE_FLT_SEL_LANE_5_0 = best_pos;
    reg_RX_DP_LMS_TOP_EN_LANE = 1;
    wait_converge (reg_FFE_FLT_OPT_TIMER_LANE_15_0);
