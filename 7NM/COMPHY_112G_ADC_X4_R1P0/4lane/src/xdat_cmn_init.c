...
//FW_REV.BT.B3 = 0x0; //00000000, fw_major_ver[7:0]
  CONTROL_CONFIG0.BT.B0 = 0x4; //00#00100, rx_cal_done, tx_cal_done, ana_clk100m_125m_sel, ana_clk100m_125m_en, avdd_vol_sel, spd_cfg_sel[1:0]
//CONTROL_CONFIG0.BT.B1 = 0x0; //000000#0, common_config_update_done, hw_drv_spd_up, train_sim_en, fast_dfe_timer_en, ext_force_cal_done, fast_power_on_en, cal_done
//CONTROL_CONFIG0.BT.B2 = 0x0; //00000000, bypass_speed_table_load, bypass_xdat_init, bypass_power_on_delay, bypass_delay[2:0], power_up_simple_en, common_config_update_needed_lane0
...
//CONTROL_CONFIG1.BT.B3 = 0x0; //00000000, rx_clk_cal_ext_en, txalign90_cal_ext_en, tx_pll_cal_ext_en, rx_pll_cal_ext_en, sq_cal_ext_en, process_cal_ext_en, txdcc_cal_ext_en, txdcc_pdiv_cal_ext_en
  ...
  CONTROL_CONFIG2.BT.B1 = 0xC0; //110000##, rxdcc_dll_cal_cont_en, pll_temp_cal_cont_en, tx_pllamp_cal_cont_en, rx_pllamp_cal_cont_en, adc_cal_cont_en, pll_temp_cal_cont_fw_en
...
//CONTROL_CONFIG3.BT.B3 = 0x0; //###000##, common_config_update_needed_lane3, cal_process_result_sel, pllamp_cal_speedup_disable
  CONTROL_CONFIG4.BT.B0 = 0x2; //00000010, fbc_ratio[7:0]
  CONTROL_CONFIG4.BT.B1 = 0x5; //00000101, vcoamp_vth_normal[7:0]
  CONTROL_CONFIG4.BT.B2 = 0x5; //00000101, vcoamp_vth_amp[7:0]
...
//CAL_DATA0.BT.B1 = 0x0; //00000000, cal_tempc_dac_sel[7:0]
  ...
  CONTROL_CONFIG8.BT.B0 = 0x7; //00000111, ref_freq_sel_fw[7:0]
//CONTROL_CONFIG8.BT.B1 = 0x0; //###0####, common_config_update_needed_lane1
//CONTROL_CONFIG8.BT.B2 = 0x0; //######00, common_config_update_needed_lane2, auto_rx_init_en
...
//TSEN_INFO.BT.B0 = 0x0; //00000000, tsen_data[15:0]
//TSEN_INFO.BT.B1 = 0x0; //00000000, tsen_data[15:0]
//TSEN_INFO.BT.B2 = 0x0; //#######0, tsen_sel
