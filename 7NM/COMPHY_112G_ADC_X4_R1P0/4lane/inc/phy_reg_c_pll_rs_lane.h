...
__xdata __at( 0x4100 ) volatile PLL_RS_LANE_REG0_t PLL_RS_LANE_REG0;
...
typedef union {
	struct {
		...
		uint8_t ANA_PLL_RS_TEMPC_LEVEL_TODIG_RD_LANE_1_0 : 2;	/*[17:16]       r   0*/
		uint8_t ANA_PLL_RS_TEMPC_LEVEL_TODIG_RD_REQ_LANE : 1;	/*     18     r/w   1*/
		uint8_t ANA_PLL_RS_TEMPC_LEVEL_TODIG_FM_REG_LANE : 1;	/*     19     r/w   0*/
		uint8_t ANA_PLL_RS_TEMPC_LEVEL_TODIG_LANE_1_0    : 2;	/*[21:20]     r/w 2'h0*/
...
__xdata __at( 0x4104 ) volatile PLL_RS_LANE_REG1_t PLL_RS_LANE_REG1;
...
#define reg_ANA_PLL_RS_TEMPC_LEVEL_TODIG_RD_LANE_1_0  PLL_RS_LANE_REG1.BF.ANA_PLL_RS_TEMPC_LEVEL_TODIG_RD_LANE_1_0
#define reg_ANA_PLL_RS_TEMPC_LEVEL_TODIG_RD_REQ_LANE  PLL_RS_LANE_REG1.BF.ANA_PLL_RS_TEMPC_LEVEL_TODIG_RD_REQ_LANE
#define reg_ANA_PLL_RS_TEMPC_LEVEL_TODIG_FM_REG_LANE  PLL_RS_LANE_REG1.BF.ANA_PLL_RS_TEMPC_LEVEL_TODIG_FM_REG_LANE
#define reg_ANA_PLL_RS_TEMPC_LEVEL_TODIG_LANE_1_0  PLL_RS_LANE_REG1.BF.ANA_PLL_RS_TEMPC_LEVEL_TODIG_LANE_1_0
...
__xdata __at( 0x4108 ) volatile PLL_RS_LANE_REG2_t PLL_RS_LANE_REG2;
...
__xdata __at( 0x410c ) volatile PLL_RS_LANE_REG3_t PLL_RS_LANE_REG3;
...
__xdata __at( 0x4110 ) volatile PLL_RS_LANE_REG4_t PLL_RS_LANE_REG4;
...
__xdata __at( 0x4114 ) volatile PLL_RS_LANE_REG5_t PLL_RS_LANE_REG5;
...
__xdata __at( 0x4118 ) volatile PLL_RS_DTX_REG0_t PLL_RS_DTX_REG0;
...
__xdata __at( 0x411c ) volatile PLL_RS_DTX_REG1_t PLL_RS_DTX_REG1;
...
typedef union {
	struct {
		...
		uint8_t ANA_PLL_RS_LOCK_RD_LANE                  : 1;	/*      9       r   0*/
		uint8_t ANA_PLL_RS_LOCK_FM_REG_LANE              : 1;	/*     10     r/w   0*/
		uint8_t ANA_PLL_RS_LOCK_LANE                     : 1;	/*     11     r/w   0*/
		uint8_t ANA_PLL_RS_RSVD0_LANE_3_0                : 4;	/*[15:12]     r/w 4'hc*/
		uint8_t RESERVED_16                              : 7;	/*[22:16]     r/w   0*/
		uint8_t ANA_PLL_RS_RSVD_PLL_OUT_FM_REG_LANE      : 1;	/*     23     r/w   0*/
		uint8_t ANA_PLL_RS_RSVD_PLL_OUT_LANE_3_0         : 4;	/*[27:24]     r/w 4'h0*/
		uint8_t PLL_RS_RSVD_PLL_OUT_RD_LANE_3_0          : 4;	/*[31:28]       r   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} PLL_RS_LANE_REG8_t;
__xdata __at( 0x4120 ) volatile PLL_RS_LANE_REG8_t PLL_RS_LANE_REG8;
...
#define reg_ANA_PLL_RS_LOCK_RD_LANE  PLL_RS_LANE_REG8.BF.ANA_PLL_RS_LOCK_RD_LANE
#define reg_ANA_PLL_RS_LOCK_FM_REG_LANE  PLL_RS_LANE_REG8.BF.ANA_PLL_RS_LOCK_FM_REG_LANE
#define reg_ANA_PLL_RS_LOCK_LANE  PLL_RS_LANE_REG8.BF.ANA_PLL_RS_LOCK_LANE
#define reg_ANA_PLL_RS_RSVD0_LANE_3_0  PLL_RS_LANE_REG8.BF.ANA_PLL_RS_RSVD0_LANE_3_0
#define reg_ANA_PLL_RS_RSVD_PLL_OUT_FM_REG_LANE  PLL_RS_LANE_REG8.BF.ANA_PLL_RS_RSVD_PLL_OUT_FM_REG_LANE
#define reg_ANA_PLL_RS_RSVD_PLL_OUT_LANE_3_0  PLL_RS_LANE_REG8.BF.ANA_PLL_RS_RSVD_PLL_OUT_LANE_3_0
#define reg_PLL_RS_RSVD_PLL_OUT_RD_LANE_3_0  PLL_RS_LANE_REG8.BF.PLL_RS_RSVD_PLL_OUT_RD_LANE_3_0
...
__xdata __at( 0x4124 ) volatile PLL_RS_DTX_REG2_t PLL_RS_DTX_REG2;
...
typedef union {
	struct {
		...
		uint8_t PLL_RS_SFT_RST_NO_REG_LANE               : 1;	/*     11     r/w   0*/
		uint8_t PLL_RS_SFT_RST_NO_REG_FM_REG_LANE        : 1;	/*     12     r/w   0*/
...
__xdata __at( 0x4128 ) volatile PLL_RS_LANE_REG9_t PLL_RS_LANE_REG9;
...
#define reg_PLL_RS_SFT_RST_NO_REG_LANE  PLL_RS_LANE_REG9.BF.PLL_RS_SFT_RST_NO_REG_LANE
#define reg_PLL_RS_SFT_RST_NO_REG_FM_REG_LANE  PLL_RS_LANE_REG9.BF.PLL_RS_SFT_RST_NO_REG_FM_REG_LANE
...
__xdata __at( 0x412c ) volatile PLL_RS_LANE_REG6_t PLL_RS_LANE_REG6;
...
__xdata __at( 0x4130 ) volatile PLL_RS_LANE_REG10_t PLL_RS_LANE_REG10;
...
__xdata __at( 0x4134 ) volatile PLL_RS_LANE_REG11_t PLL_RS_LANE_REG11;
...
// 0x0038	PLL_RS_LANE_REG12		Rx Side PLL Lane Register 12
typedef union {
	struct {
...
__xdata __at( 0x4138 ) volatile PLL_RS_LANE_REG12_t PLL_RS_LANE_REG12;
