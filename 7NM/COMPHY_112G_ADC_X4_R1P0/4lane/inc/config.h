...
#define DRV_CDS_V0
#define DRV_EOM_V0
#define DRV_RX_FUNC_CFG_V0
#define DRV_TX_FUNC_CFG_V0
#define DRV_ADC_CAL_V0
#define DRV_PWR_V0

#define PALLADIUM_SIM   0 
#define DRV_SPD_CFG_DEC_V0

// HW Workaround
#define IPCE_COMPHY_1630_WA
#define IPCE_COMPHY_1672_WA // Rx clk cal top continuous mode setting change
#define IPCE_COMPHY_1684_WA // TX configuration at 106G
