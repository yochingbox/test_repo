...
typedef union {
	struct {
		...
		uint8_t COMMON_CONFIG_UPDATE_DONE                : 1;	/*     15       r   0*/
		uint8_t COMMON_CONFIG_UPDATE_NEEDED_LANE0        : 1;	/*     16       r   0*/
...
#define cmx_COMMON_CONFIG_UPDATE_DONE  CONTROL_CONFIG0.BF.COMMON_CONFIG_UPDATE_DONE
#define cmx_COMMON_CONFIG_UPDATE_NEEDED_LANE0  CONTROL_CONFIG0.BF.COMMON_CONFIG_UPDATE_NEEDED_LANE0
...
typedef union {
	struct {
		...
		uint8_t RESERVED_9                               : 1;	/*      9     r/w   0*/
		uint8_t PLL_TEMP_CAL_CONT_FW_EN                  : 1;	/*     10     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t COMMON_CONFIG_UPDATE_NEEDED_LANE3        : 1;	/*     28       r   0*/
...
#define cmx_COMMON_CONFIG_UPDATE_NEEDED_LANE3  CONTROL_CONFIG3.BF.COMMON_CONFIG_UPDATE_NEEDED_LANE3

// 0x0614	CONTROL_CONFIG4		Calibration Configuration 3
typedef union {
	struct {
		uint8_t FBC_RATIO_7_0                            : 8;	/*  [7:0]     r/w 8'h2*/
		uint8_t VCOAMP_VTH_NORMAL_7_0                    : 8;	/* [15:8]     r/w 8'h05*/
		uint8_t VCOAMP_VTH_AMP_7_0                       : 8;	/*[23:16]     r/w 8'h05*/
...
typedef union {
	struct {
		...
		uint8_t COMMON_CONFIG_UPDATE_NEEDED_LANE1        : 1;	/*     12       r   0*/
		...
		uint8_t COMMON_CONFIG_UPDATE_NEEDED_LANE2        : 1;	/*     17       r   0*/
...
#define cmx_REF_FREQ_SEL_FW_7_0  CONTROL_CONFIG8.BF.REF_FREQ_SEL_FW_7_0
#define cmx_COMMON_CONFIG_UPDATE_NEEDED_LANE1  CONTROL_CONFIG8.BF.COMMON_CONFIG_UPDATE_NEEDED_LANE1
#define cmx_AUTO_RX_INIT_EN  CONTROL_CONFIG8.BF.AUTO_RX_INIT_EN
#define cmx_COMMON_CONFIG_UPDATE_NEEDED_LANE2  CONTROL_CONFIG8.BF.COMMON_CONFIG_UPDATE_NEEDED_LANE2
...
typedef union {
	struct {
		uint8_t TSEN_DATA_15_0_b0                        : 8;	/* [15:0]     r/w 16'h0*/
		uint8_t TSEN_DATA_15_0_b1                        : 8;	/* [15:0]     r/w 16'h0*/
		uint8_t TSEN_SEL                                 : 1;	/*     16     r/w   0*/
...
__xdata __at( 0xe688 ) volatile TSEN_INFO_t TSEN_INFO;
#define cmx_TSEN_DATA_15_0_b0  TSEN_INFO.BF.TSEN_DATA_15_0_b0
#define cmx_TSEN_DATA_15_0_b1  TSEN_INFO.BF.TSEN_DATA_15_0_b1
#define cmx_TSEN_SEL  TSEN_INFO.BF.TSEN_SEL
#define cmx_TSEN_DATA_15_0  TSEN_INFO.WT.W0
