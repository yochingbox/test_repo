...
typedef union {
	struct {
		...
		uint8_t ANA_TX_TXDETRX_OUT_RD_LANE               : 1;	/*     29       r   0*/
...
typedef union {
	struct {
		...
		uint8_t PHY_GEN_MAX_TX_LANE_5_0                  : 6;	/*[15:10]     r/w 6'h9*/
		uint8_t RESERVED_16                              : 1;	/*     16     r/w   0*/
...
__xdata __at( 0x2034 ) volatile TX_SYSTEM_LANE0_t TX_SYSTEM_LANE0;
...
__xdata __at( 0x203c ) volatile TX_SYSTEM_LANE1_t TX_SYSTEM_LANE1;
...
__xdata __at( 0x204c ) volatile ID_LANE_REG1_t ID_LANE_REG1;
...
__xdata __at( 0x2098 ) volatile PHYTEST_TX0_t PHYTEST_TX0;
...
__xdata __at( 0x209c ) volatile PHYTEST_TX1_t PHYTEST_TX1;
...
__xdata __at( 0x20a0 ) volatile PHYTEST_TX2_t PHYTEST_TX2;
...
__xdata __at( 0x20a4 ) volatile PHYTEST_TX3_t PHYTEST_TX3;
...
__xdata __at( 0x20a8 ) volatile PHYTEST_TX4_t PHYTEST_TX4;
...
__xdata __at( 0x20ac ) volatile INPUT_TX_PIN_REG4_LANE_t INPUT_TX_PIN_REG4_LANE;
...
__xdata __at( 0x20b0 ) volatile INPUT_TX_PIN_REG5_LANE_t INPUT_TX_PIN_REG5_LANE;
