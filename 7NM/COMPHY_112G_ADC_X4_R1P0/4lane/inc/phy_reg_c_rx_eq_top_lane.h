...
typedef union {
	struct {
		...
		uint8_t RX_DTL_PIPELINE_MODE_LANE                : 1;	/*      5     r/w   1*/
...
__xdata __at( 0x2400 ) volatile RX_EQ_REG0_t RX_EQ_REG0;
...
#define reg_RX_DTL_PIPELINE_MODE_LANE  RX_EQ_REG0.BF.RX_DTL_PIPELINE_MODE_LANE
...
__xdata __at( 0x2404 ) volatile RX_EQ_REG1_t RX_EQ_REG1;
...
__xdata __at( 0x2408 ) volatile RX_EQ_REG2_t RX_EQ_REG2;
...
__xdata __at( 0x240c ) volatile RX_EQ_REG3_t RX_EQ_REG3;
...
__xdata __at( 0x241c ) volatile RX_ADC_CLK_REG0_t RX_ADC_CLK_REG0;
