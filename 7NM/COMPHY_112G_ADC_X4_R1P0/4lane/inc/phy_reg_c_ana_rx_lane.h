...
__xdata __at( 0x200 ) volatile RX_TOP_ANA_REG_0_t RX_TOP_ANA_REG_0;
...
__xdata __at( 0x204 ) volatile RX_TOP_ANA_REG_1_t RX_TOP_ANA_REG_1;
...
__xdata __at( 0x208 ) volatile RX_TOP_ANA_REG_2_t RX_TOP_ANA_REG_2;
...
__xdata __at( 0x20c ) volatile RX_TOP_ANA_REG_3_t RX_TOP_ANA_REG_3;
...
__xdata __at( 0x210 ) volatile RX_TOP_ANA_REG_4_t RX_TOP_ANA_REG_4;
...
__xdata __at( 0x214 ) volatile RX_TOP_ANA_REG_5_t RX_TOP_ANA_REG_5;
...
__xdata __at( 0x218 ) volatile RX_TOP_ANA_REG_6_t RX_TOP_ANA_REG_6;
...
__xdata __at( 0x21c ) volatile RX_TOP_ANA_REG_7_t RX_TOP_ANA_REG_7;
...
__xdata __at( 0x220 ) volatile RX_TOP_ANA_REG_8_t RX_TOP_ANA_REG_8;
...
__xdata __at( 0x224 ) volatile RX_TOP_ANA_REG_9_t RX_TOP_ANA_REG_9;
...
typedef union {
	struct {
		uint8_t RESERVED_0                               : 1;	/*      0     r/w 1'h0*/
		uint8_t RX_CTLE_VICM1_SEL_LANE_2_0               : 3;	/*  [3:1]     r/w 3'h3*/
		uint8_t RX_CTLE_IPTAT_SEL_LANE_1_0               : 2;	/*  [5:4]     r/w 2'h2*/
		uint8_t RX_CTLE_GBIAS_SEL_LANE_1_0               : 2;	/*  [7:6]     r/w 2'h2*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} RX_TOP_ANA_REG_10_t;
__xdata __at( 0x228 ) volatile RX_TOP_ANA_REG_10_t RX_TOP_ANA_REG_10;
#define reg_RX_CTLE_VICM1_SEL_LANE_2_0  RX_TOP_ANA_REG_10.BF.RX_CTLE_VICM1_SEL_LANE_2_0
#define reg_RX_CTLE_IPTAT_SEL_LANE_1_0  RX_TOP_ANA_REG_10.BF.RX_CTLE_IPTAT_SEL_LANE_1_0
...
__xdata __at( 0x22c ) volatile RX_TOP_ANA_REG_11_t RX_TOP_ANA_REG_11;
...
__xdata __at( 0x230 ) volatile RX_TOP_ANA_REG_12_t RX_TOP_ANA_REG_12;
...
__xdata __at( 0x234 ) volatile RX_TOP_ANA_REG_13_t RX_TOP_ANA_REG_13;
...
__xdata __at( 0x238 ) volatile RX_TOP_ANA_REG_14_t RX_TOP_ANA_REG_14;
...
__xdata __at( 0x23c ) volatile RX_TOP_ANA_REG_15_t RX_TOP_ANA_REG_15;
...
__xdata __at( 0x240 ) volatile RX_TOP_ANA_REG_16_t RX_TOP_ANA_REG_16;
...
__xdata __at( 0x244 ) volatile RX_TOP_ANA_REG_17_t RX_TOP_ANA_REG_17;
...
__xdata __at( 0x248 ) volatile RX_TOP_ANA_REG_18_t RX_TOP_ANA_REG_18;
...
__xdata __at( 0x24c ) volatile RX_TOP_ANA_REG_19_t RX_TOP_ANA_REG_19;
...
__xdata __at( 0x250 ) volatile RX_TOP_ANA_REG_20_t RX_TOP_ANA_REG_20;
...
__xdata __at( 0x254 ) volatile RX_TOP_ANA_REG_21_t RX_TOP_ANA_REG_21;
...
__xdata __at( 0x258 ) volatile RX_TOP_ANA_REG_22_t RX_TOP_ANA_REG_22;
...
__xdata __at( 0x25c ) volatile RX_TOP_ANA_REG_23_t RX_TOP_ANA_REG_23;
...
typedef union {
	struct {
		uint8_t RESERVED_0                               : 1;	/*      0     r/w 1'h0*/
		uint8_t RESERVED_1                               : 1;	/*      1     r/w 1'h0*/
		uint8_t RX_PU_DLL_CMP_LANE                       : 1;	/*      2     r/w 1'h1*/
		uint8_t RX_DLL_RESSHORT_BWFLT_LANE               : 1;	/*      3     r/w 1'h0*/
		uint8_t RX_DLL_CLATCH_ST_LANE_1_0                : 2;	/*  [5:4]     r/w 2'h2*/
		uint8_t RX_DLL_CLATCH_EN_LANE                    : 1;	/*      6     r/w 1'h1*/
		uint8_t RX_E2C_DCC_HG_LANE                       : 1;	/*      7     r/w 1'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} RX_TOP_ANA_REG_24_t;
__xdata __at( 0x260 ) volatile RX_TOP_ANA_REG_24_t RX_TOP_ANA_REG_24;
...
#define reg_RX_DLL_CLATCH_ST_LANE_1_0  RX_TOP_ANA_REG_24.BF.RX_DLL_CLATCH_ST_LANE_1_0
#define reg_RX_DLL_CLATCH_EN_LANE  RX_TOP_ANA_REG_24.BF.RX_DLL_CLATCH_EN_LANE
...
__xdata __at( 0x264 ) volatile RX_TOP_ANA_REG_25_t RX_TOP_ANA_REG_25;
...
typedef union {
	struct {
		uint8_t RX_CLKTOP_CONFIG_LANE_10_3               : 8;	/*  [7:0]     r/w 8'h4*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} RX_TOP_ANA_REG_26_t;
__xdata __at( 0x268 ) volatile RX_TOP_ANA_REG_26_t RX_TOP_ANA_REG_26;
...
typedef union {
	struct {
		...
		uint8_t RX_CLKTOP_CONFIG_LANE_2_0                : 3;	/*  [7:5]     r/w 3'h1*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} RX_TOP_ANA_REG_27_t;
__xdata __at( 0x26c ) volatile RX_TOP_ANA_REG_27_t RX_TOP_ANA_REG_27;
...
typedef union {
	struct {
		uint8_t RX_RXCLKNT_INTDIV_EN_LANE                : 1;	/*      0     r/w 1'h0*/
		uint8_t RX_RXCLKNT_DIV_RESET_LANE                : 1;	/*      1     r/w 1'h0*/
		uint8_t RX_RXCLKNT_DIV_SEL_LANE_4_0              : 5;	/*  [6:2]     r/w 5'h10*/
		uint8_t RX_RXCLKNT_EN_LANE                       : 1;	/*      7     r/w 1'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} RX_TOP_ANA_REG_28_t;
__xdata __at( 0x270 ) volatile RX_TOP_ANA_REG_28_t RX_TOP_ANA_REG_28;
...
#define reg_RX_RXCLKNT_EN_LANE  RX_TOP_ANA_REG_28.BF.RX_RXCLKNT_EN_LANE

// 0x1d	RX_TOP_ANA_REG_29		Analog Register 29
typedef union {
	struct {
		uint8_t RX_RXPLL_CLK_EN_LANE                     : 1;	/*      0     r/w 1'h0*/
		uint8_t RX_RXCLK4X_EN_LANE                       : 1;	/*      1     r/w 1'h0*/
		uint8_t RX_RXCLK_EN_LANE                         : 1;	/*      2     r/w 1'h0*/
...
__xdata __at( 0x274 ) volatile RX_TOP_ANA_REG_29_t RX_TOP_ANA_REG_29;
#define reg_RX_RXPLL_CLK_EN_LANE  RX_TOP_ANA_REG_29.BF.RX_RXPLL_CLK_EN_LANE
#define reg_RX_RXCLK4X_EN_LANE  RX_TOP_ANA_REG_29.BF.RX_RXCLK4X_EN_LANE
#define reg_RX_RXCLK_EN_LANE  RX_TOP_ANA_REG_29.BF.RX_RXCLK_EN_LANE
...
__xdata __at( 0x278 ) volatile RX_TOP_ANA_REG_30_t RX_TOP_ANA_REG_30;
...
__xdata __at( 0x27c ) volatile RX_TOP_ANA_REG_31_t RX_TOP_ANA_REG_31;
...
typedef union {
	struct {
		uint8_t RESERVED_0                               : 1;	/*      0     r/w 1'h0*/
		uint8_t RESERVED_1                               : 1;	/*      1     r/w 1'h0*/
		uint8_t RX_CTLE_RL1_CTRL_LANE_3_0                : 4;	/*  [5:2]     r/w 4'hF*/
		uint8_t RX_INNET_TCOIL_CL_LANE_1_0               : 2;	/*  [7:6]     r/w 2'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} RX_TOP_ANA_REG_32_t;
__xdata __at( 0x280 ) volatile RX_TOP_ANA_REG_32_t RX_TOP_ANA_REG_32;
#define reg_RX_CTLE_RL1_CTRL_LANE_3_0  RX_TOP_ANA_REG_32.BF.RX_CTLE_RL1_CTRL_LANE_3_0
#define reg_RX_INNET_TCOIL_CL_LANE_1_0  RX_TOP_ANA_REG_32.BF.RX_INNET_TCOIL_CL_LANE_1_0
...
typedef union {
	struct {
		uint8_t RESERVED_0                               : 1;	/*      0     r/w 1'h0*/
		uint8_t RESERVED_1                               : 1;	/*      1     r/w 1'h0*/
		uint8_t RX_CTLE_CS1_CTRL_LANE_5_0                : 6;	/*  [7:2]     r/w 6'h3F*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} RX_TOP_ANA_REG_33_t;
__xdata __at( 0x284 ) volatile RX_TOP_ANA_REG_33_t RX_TOP_ANA_REG_33;
#define reg_RX_CTLE_CS1_CTRL_LANE_5_0  RX_TOP_ANA_REG_33.BF.RX_CTLE_CS1_CTRL_LANE_5_0
...
__xdata __at( 0x288 ) volatile RX_TOP_ANA_REG_34_t RX_TOP_ANA_REG_34;
...
typedef union {
	struct {
		...
		uint8_t RESERVED_1                               : 1;	/*      1     r/w 1'h0*/
		uint8_t RESERVED_2                               : 1;	/*      2     r/w 1'h0*/
		uint8_t RX_CTLE_CS2_CTRL_LANE_4_0                : 5;	/*  [7:3]     r/w 5'h1F*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} RX_TOP_ANA_REG_35_t;
__xdata __at( 0x28c ) volatile RX_TOP_ANA_REG_35_t RX_TOP_ANA_REG_35;
#define reg_RX_CTLE_CS2_CTRL_LANE_4_0  RX_TOP_ANA_REG_35.BF.RX_CTLE_CS2_CTRL_LANE_4_0

// 0x24	RX_TOP_ANA_REG_36		Analog Register 36
typedef union {
	struct {
		uint8_t RESERVED_0                               : 1;	/*      0     r/w 1'h0*/
		uint8_t RX_CTLE_RS2_SEL_LANE_1_0                 : 2;	/*  [2:1]     r/w 2'h3*/
		uint8_t RX_CTLE_RS2_CTRL_LANE_4_0                : 5;	/*  [7:3]     r/w 5'h10*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} RX_TOP_ANA_REG_36_t;
__xdata __at( 0x290 ) volatile RX_TOP_ANA_REG_36_t RX_TOP_ANA_REG_36;
#define reg_RX_CTLE_RS2_SEL_LANE_1_0  RX_TOP_ANA_REG_36.BF.RX_CTLE_RS2_SEL_LANE_1_0
#define reg_RX_CTLE_RS2_CTRL_LANE_4_0  RX_TOP_ANA_REG_36.BF.RX_CTLE_RS2_CTRL_LANE_4_0

// 0x25	RX_TOP_ANA_REG_37		Analog Register 37
typedef union {
	struct {
		uint8_t RX_CTLE_CUR_TIA_SEL_LANE_3_0             : 4;	/*  [3:0]     r/w 4'hF*/
		uint8_t RX_CTLE_CUR2_SEL_LANE_3_0                : 4;	/*  [7:4]     r/w 4'hF*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} RX_TOP_ANA_REG_37_t;
__xdata __at( 0x294 ) volatile RX_TOP_ANA_REG_37_t RX_TOP_ANA_REG_37;
#define reg_RX_CTLE_CUR_TIA_SEL_LANE_3_0  RX_TOP_ANA_REG_37.BF.RX_CTLE_CUR_TIA_SEL_LANE_3_0
#define reg_RX_CTLE_CUR2_SEL_LANE_3_0  RX_TOP_ANA_REG_37.BF.RX_CTLE_CUR2_SEL_LANE_3_0

// 0x26	RX_TOP_ANA_REG_38		Analog Register 38
typedef union {
	struct {
		uint8_t RX_PI_RSEL_LANE_1_0                      : 2;	/*  [1:0]     r/w 2'h0*/
		uint8_t RX_CTLE_RFB_SEL_LANE_1_0                 : 2;	/*  [3:2]     r/w 2'h3*/
		uint8_t RX_CTLE_GAIN_COARSE_LANE_3_0             : 4;	/*  [7:4]     r/w 4'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} RX_TOP_ANA_REG_38_t;
__xdata __at( 0x298 ) volatile RX_TOP_ANA_REG_38_t RX_TOP_ANA_REG_38;
...
#define reg_RX_CTLE_GAIN_COARSE_LANE_3_0  RX_TOP_ANA_REG_38.BF.RX_CTLE_GAIN_COARSE_LANE_3_0
...
typedef union {
	struct {
		...
		uint8_t RX_ADC_VDD_SEL_LANE_2_0                  : 3;	/*  [5:3]     r/w 3'h4*/
		uint8_t RX_ADC_ICC_SEL_LANE_1_0                  : 2;	/*  [7:6]     r/w 2'h1*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} RX_TOP_ANA_REG_39_t;
__xdata __at( 0x29c ) volatile RX_TOP_ANA_REG_39_t RX_TOP_ANA_REG_39;
