...
__xdata __at( 0x4200 ) volatile PLL_TS_LANE_REG0_t PLL_TS_LANE_REG0;
...
typedef union {
	struct {
		...
		uint8_t ANA_PLL_TS_TEMPC_LEVEL_TODIG_RD_LANE_1_0 : 2;	/*[17:16]       r   0*/
		uint8_t ANA_PLL_TS_TEMPC_LEVEL_TODIG_RD_REQ_LANE : 1;	/*     18     r/w   1*/
		uint8_t ANA_PLL_TS_TEMPC_LEVEL_TODIG_FM_REG_LANE : 1;	/*     19     r/w   0*/
		uint8_t ANA_PLL_TS_TEMPC_LEVEL_TODIG_LANE_1_0    : 2;	/*[21:20]     r/w 2'h0*/
...
__xdata __at( 0x4204 ) volatile PLL_TS_LANE_REG1_t PLL_TS_LANE_REG1;
...
#define reg_ANA_PLL_TS_TEMPC_LEVEL_TODIG_RD_LANE_1_0  PLL_TS_LANE_REG1.BF.ANA_PLL_TS_TEMPC_LEVEL_TODIG_RD_LANE_1_0
#define reg_ANA_PLL_TS_TEMPC_LEVEL_TODIG_RD_REQ_LANE  PLL_TS_LANE_REG1.BF.ANA_PLL_TS_TEMPC_LEVEL_TODIG_RD_REQ_LANE
#define reg_ANA_PLL_TS_TEMPC_LEVEL_TODIG_FM_REG_LANE  PLL_TS_LANE_REG1.BF.ANA_PLL_TS_TEMPC_LEVEL_TODIG_FM_REG_LANE
#define reg_ANA_PLL_TS_TEMPC_LEVEL_TODIG_LANE_1_0  PLL_TS_LANE_REG1.BF.ANA_PLL_TS_TEMPC_LEVEL_TODIG_LANE_1_0
...
__xdata __at( 0x4208 ) volatile PLL_TS_LANE_REG2_t PLL_TS_LANE_REG2;
...
__xdata __at( 0x420c ) volatile PLL_TS_LANE_REG3_t PLL_TS_LANE_REG3;
...
__xdata __at( 0x4210 ) volatile PLL_TS_LANE_REG4_t PLL_TS_LANE_REG4;
...
__xdata __at( 0x4214 ) volatile PLL_TS_LANE_REG5_t PLL_TS_LANE_REG5;
...
__xdata __at( 0x4218 ) volatile PLL_TS_DTX_REG0_t PLL_TS_DTX_REG0;
...
__xdata __at( 0x421c ) volatile PLL_TS_DTX_REG1_t PLL_TS_DTX_REG1;
...
typedef union {
	struct {
		...
		uint8_t ANA_PLL_TS_LOCK_RD_LANE                  : 1;	/*      9       r   0*/
		uint8_t ANA_PLL_TS_LOCK_FM_REG_LANE              : 1;	/*     10     r/w   0*/
		uint8_t ANA_PLL_TS_LOCK_LANE                     : 1;	/*     11     r/w   0*/
		uint8_t ANA_PLL_TS_RSVD0_LANE_3_0                : 4;	/*[15:12]     r/w 4'hc*/
		uint8_t RESERVED_16                              : 7;	/*[22:16]     r/w   0*/
		uint8_t ANA_PLL_TS_RSVD_PLL_OUT_FM_REG_LANE      : 1;	/*     23     r/w   0*/
		uint8_t ANA_PLL_TS_RSVD_PLL_OUT_LANE_3_0         : 4;	/*[27:24]     r/w 4'h0*/
		uint8_t PLL_TS_RSVD_PLL_OUT_RD_LANE_3_0          : 4;	/*[31:28]       r   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} PLL_TS_LANE_REG8_t;
__xdata __at( 0x4220 ) volatile PLL_TS_LANE_REG8_t PLL_TS_LANE_REG8;
...
#define reg_ANA_PLL_TS_LOCK_RD_LANE  PLL_TS_LANE_REG8.BF.ANA_PLL_TS_LOCK_RD_LANE
#define reg_ANA_PLL_TS_LOCK_FM_REG_LANE  PLL_TS_LANE_REG8.BF.ANA_PLL_TS_LOCK_FM_REG_LANE
#define reg_ANA_PLL_TS_LOCK_LANE  PLL_TS_LANE_REG8.BF.ANA_PLL_TS_LOCK_LANE
#define reg_ANA_PLL_TS_RSVD0_LANE_3_0  PLL_TS_LANE_REG8.BF.ANA_PLL_TS_RSVD0_LANE_3_0
#define reg_ANA_PLL_TS_RSVD_PLL_OUT_FM_REG_LANE  PLL_TS_LANE_REG8.BF.ANA_PLL_TS_RSVD_PLL_OUT_FM_REG_LANE
#define reg_ANA_PLL_TS_RSVD_PLL_OUT_LANE_3_0  PLL_TS_LANE_REG8.BF.ANA_PLL_TS_RSVD_PLL_OUT_LANE_3_0
#define reg_PLL_TS_RSVD_PLL_OUT_RD_LANE_3_0  PLL_TS_LANE_REG8.BF.PLL_TS_RSVD_PLL_OUT_RD_LANE_3_0
...
__xdata __at( 0x4224 ) volatile PLL_TS_DTX_REG2_t PLL_TS_DTX_REG2;
...
typedef union {
	struct {
		...
		uint8_t PLL_TS_SFT_RST_NO_REG_LANE               : 1;	/*     11     r/w   0*/
		uint8_t PLL_TS_SFT_RST_NO_REG_FM_REG_LANE        : 1;	/*     12     r/w   0*/
...
__xdata __at( 0x4228 ) volatile PLL_TS_LANE_REG9_t PLL_TS_LANE_REG9;
...
#define reg_PLL_TS_SFT_RST_NO_REG_LANE  PLL_TS_LANE_REG9.BF.PLL_TS_SFT_RST_NO_REG_LANE
#define reg_PLL_TS_SFT_RST_NO_REG_FM_REG_LANE  PLL_TS_LANE_REG9.BF.PLL_TS_SFT_RST_NO_REG_FM_REG_LANE
...
__xdata __at( 0x422c ) volatile PLL_TS_LANE_REG6_t PLL_TS_LANE_REG6;
...
__xdata __at( 0x4230 ) volatile PLL_TS_LANE_REG10_t PLL_TS_LANE_REG10;
...
__xdata __at( 0x4234 ) volatile PLL_TS_LANE_REG11_t PLL_TS_LANE_REG11;
...
// 0x0038	PLL_TS_LANE_REG12		Tx Side PLL Lane Register 12
typedef union {
	struct {
		...
		uint8_t TX_PLL_RATE_SEL_LANE_4_0                 : 5;	/*[20:16]     r/w 5'h0*/
...
__xdata __at( 0x4238 ) volatile PLL_TS_LANE_REG12_t PLL_TS_LANE_REG12;
...
#define reg_TX_PLL_RATE_SEL_LANE_4_0  PLL_TS_LANE_REG12.BF.TX_PLL_RATE_SEL_LANE_4_0
