...
typedef union {
	struct {
		...
		uint8_t ANA_PLL_TS_RSVD0_LANE_3_0                : 4;	/*[15:12]     r/w 4'b1100*/
...
typedef union {
	struct {
		uint8_t PLL_TS_PHASE_OFFS_VALID_LANE             : 1;	/*      0     r/w   0*/
		uint8_t PLL_TS_PHASE_OFFS_VALID_FM_REG_LANE      : 1;	/*      1     r/w   0*/
		uint8_t PLL_TS_PHASE_OFFS_LANE_7_0_b0            : 6;	/*  [9:2]     r/w 8'h0*/
		uint8_t PLL_TS_PHASE_OFFS_LANE_7_0_b1            : 2;	/*  [9:2]     r/w 8'h0*/
...
#define reg_PLL_TS_PHASE_OFFS_LANE_7_0_b0  PLL_TS_LANE_REG7.BF.PLL_TS_PHASE_OFFS_LANE_7_0_b0
#define reg_PLL_TS_PHASE_OFFS_LANE_7_0_b1  PLL_TS_LANE_REG7.BF.PLL_TS_PHASE_OFFS_LANE_7_0_b1
