...
#define drv_PH_MODE         lnx_PH_CONTROL_MODE_LANE_7_0
#define drv_ADAPT_DATA_EN   reg_ADAPT_DATA_ENABLE_LANE
#define drv_ADAPT_SLICER_EN reg_ADAPT_SLICER_ENABLE_LANE
#define drv_ADAPT_EVEN_EN   reg_ADAPT_EVEN_ENABLE_LANE
#define drv_ADAPT_ODD_EN    reg_ADAPT_ODD_ENABLE_LANE
...
//void cdr_dfe_scheme_new(uint32_t cds_en) BANKING_CTRL; // TODO rename to drv_cdr_dfe_scheme()
