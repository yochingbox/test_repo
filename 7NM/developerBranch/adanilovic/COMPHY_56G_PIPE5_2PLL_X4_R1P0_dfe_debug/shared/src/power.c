...
void PowerUp_Seq(void) BANKING_CTRL {
    ...
    reg_MCU_DEBUG4_LANE_7_0 = reg_DFE_CLK_OFF_LANE;
    reg_MCU_DEBUG5_LANE_7_0 = reg_DFE_CLK_ON_LANE;
    reg_MCU_DEBUG6_LANE_7_0 = reg_DFE_MCU_CLK_EN_LANE;
    ...
    if (mcuid != MCU_CMN) {
		...
		if(reg_SET_MCU_COMMAND_LANE0_31_0_b0 & 0x01) {
			CONTROL_CONFIG0.BT.B1 |= 0x10; // ext_force_cal_done=0, fast_dfe_timer_en=1 
    ...
    reg_MCU_DEBUGD_LANE_7_0 = reg_DFE_CLK_OFF_LANE;
    reg_MCU_DEBUGE_LANE_7_0 = reg_DFE_CLK_ON_LANE;
    reg_MCU_DEBUGF_LANE_7_0 = reg_DFE_MCU_CLK_EN_LANE;
}
