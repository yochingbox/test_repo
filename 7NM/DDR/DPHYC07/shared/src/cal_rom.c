...
#ifdef _LANE_RPLL
	lnx_cal_pll_speed_ring[no][PLL_RATE_SEL_RING] = (reg_PLL_SPEED_RING_LANE_4_0 & 0x1f) | 0x00;
	lnx_cal_pll_sllp_dac_coarse_ring[no][PLL_RATE_SEL_RING] = (reg_PLL_SLLP_DAC_COARSE_RING_LANE_3_0 & 0x0f) | 0x00;
	lnx_cal_sllp_dac_fine_ring[no][PLL_RATE_SEL_RING] = ringpll_dac_fine;
#else
...
#ifdef _LANE_RPLL
	reg_PLL_SPEED_RING_LANE_4_0 = lnx_cal_pll_speed_ring[no][PLL_RATE_SEL_RING];
	reg_PLL_SLLP_DAC_COARSE_RING_LANE_3_0 = lnx_cal_pll_sllp_dac_coarse_ring[no][PLL_RATE_SEL_RING];
	ringpll_dac_fine = lnx_cal_sllp_dac_fine_ring[no][PLL_RATE_SEL_RING]; 
...
void ringpll_dac_fine_output(void) BANKING_CTRL {
	...
	reg_PLL_SLLP_DAC_FINE_RING_LANE_10_8 = (uint8_t)(ringpll_dac_fine>>8); 
	reg_PLL_SLLP_DAC_FINE_RING_LANE_7_0 = (uint8_t)ringpll_dac_fine;
	reg_PLL_SLLP_DAC_VALID_RING_LANE = 1;  reg_PLL_SLLP_DAC_VALID_RING_LANE = 0;
#else // CMN_RPLL
	reg_PLL_SLLP_DAC_FINE_RING_10_8 = (uint8_t)(ringpll_dac_fine>>8); 
	reg_PLL_SLLP_DAC_FINE_RING_7_0 = (uint8_t)ringpll_dac_fine;
