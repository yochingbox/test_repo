...
void tsen_on(void) {
	...
	// initial ANA_TSEN_ADC_RDY time is 2~6mS/12mS.
	reg_ANA_TSEN_ADC_CLK_EN = 0;

	//Lisa commented: analog tsen can only support 1M. 
	//MCU_FREQ>>5=400/32=12.5, 400/12.5=32M, 32M/32(Tsensor default divider)=1MHz
	reg_ANA_TSEN_ADC_CLK_CNT_15_0 = (cmx_MCU_FREQ_15_0>>6)-1;
	reg_ANA_TSEN_ADC_CLK_EN = 1;
