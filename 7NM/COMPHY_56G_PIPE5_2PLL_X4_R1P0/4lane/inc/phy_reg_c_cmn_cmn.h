...
typedef union {
	struct {
		...
		uint8_t RESERVED_14                              : 2;	/*[19:14]     r/w   0*/
		uint8_t RESERVED_16                              : 4;	/*[19:14]     r/w   0*/
		uint8_t TESTBUS_LANE_SEL1_2_0                    : 3;	/*[22:20]     r/w   0*/
		uint8_t RESERVED_23                              : 1;	/*[28:23]     r/w   0*/
		uint8_t RESERVED_24                              : 5;	/*[28:23]     r/w   0*/
...
// 0x0014	TEST5		Common Test Registers 5
typedef union {
	struct {
		uint8_t TESTBUS_SEL_HI1_CMN_5_0                  : 6;	/*  [5:0]     r/w 6'h0*/
		uint8_t RESERVED_6                               : 2;	/*  [7:6]     r/w   0*/
		uint8_t TESTBUS_SEL_HI0_CMN_5_0                  : 6;	/* [13:8]     r/w 6'h0*/
...
__xdata __at( 0xa314 ) volatile TEST5_t TEST5;
#define reg_TESTBUS_SEL_HI1_CMN_5_0  TEST5.BF.TESTBUS_SEL_HI1_CMN_5_0
#define reg_TESTBUS_SEL_HI0_CMN_5_0  TEST5.BF.TESTBUS_SEL_HI0_CMN_5_0

// 0x0018	SYSTEM		Common System Registers
typedef union {
	struct {
		uint8_t RST_REG_CLK_CMN                          : 1;	/*      0     r/w   0*/
		uint8_t PIN_SPD_CFG_RD_3_0                       : 4;	/*  [4:1]       r 4'h0*/
		uint8_t RESERVED_5                               : 3;	/*  [7:5]     r/w   0*/
		uint8_t SPD_CFG_3_0                              : 4;	/* [11:8]     r/w 4'h0*/
		uint8_t SPD_CFG_FM_REG                           : 1;	/*     12     r/w   0*/
...
__xdata __at( 0xa318 ) volatile SYSTEM_t SYSTEM;
#define reg_RST_REG_CLK_CMN  SYSTEM.BF.RST_REG_CLK_CMN
#define reg_PIN_SPD_CFG_RD_3_0  SYSTEM.BF.PIN_SPD_CFG_RD_3_0
#define reg_SPD_CFG_3_0  SYSTEM.BF.SPD_CFG_3_0
#define reg_SPD_CFG_FM_REG  SYSTEM.BF.SPD_CFG_FM_REG
...
// 0x001c	PM_CMN_REG1		Power Control Common Register 1
typedef union {
	struct {
		...
		uint8_t PU_BG_RDY_RD                             : 1;	/*      7       r   0*/
		uint8_t CNT_INI_7_0                              : 8;	/* [15:8]     r/w 8'h95*/
		...
		uint8_t BEACON_DIVIDER_1_0                       : 2;	/*[27:26]     r/w 2'h2*/
...
__xdata __at( 0xa31c ) volatile PM_CMN_REG1_t PM_CMN_REG1;
...
#define reg_CNT_INI_7_0  PM_CMN_REG1.BF.CNT_INI_7_0
...
#define reg_BEACON_DIVIDER_1_0  PM_CMN_REG1.BF.BEACON_DIVIDER_1_0
...
// 0x0020	INPUT_CMN_PIN_REG0		Input Interface Register0
typedef union {
	struct {
...
__xdata __at( 0xa320 ) volatile INPUT_CMN_PIN_REG0_t INPUT_CMN_PIN_REG0;
...
// 0x0024	INPUT_CMN_PIN_REG1		Input Interface Register1
typedef union {
	struct {
...
__xdata __at( 0xa324 ) volatile INPUT_CMN_PIN_REG1_t INPUT_CMN_PIN_REG1;
...
// 0x0028	INPUT_CMN_PIN_REG2		Input Interface Register2
typedef union {
	struct {
...
__xdata __at( 0xa328 ) volatile INPUT_CMN_PIN_REG2_t INPUT_CMN_PIN_REG2;
...
// 0x002c	ANA_TSEN_CONTROL		Input Interface Register3
typedef union {
	struct {
		uint8_t TSEN_ADC_DATA_15_0_b0                    : 8;	/* [15:0]       r 16'h0*/
		uint8_t TSEN_ADC_DATA_15_0_b1                    : 8;	/* [15:0]       r 16'h0*/
		uint8_t TSEN_ADC_RDY                             : 1;	/*     16       r   0*/
		uint8_t TSEN_ADC_RD_REQ                          : 1;	/*     17     r/w   1*/
		uint8_t BURN_IN_TEST_FM_REG                      : 1;	/*     18     r/w   0*/
		uint8_t BURN_IN_TEST                             : 1;	/*     19     r/w   0*/
...
__xdata __at( 0xa32c ) volatile ANA_TSEN_CONTROL_t ANA_TSEN_CONTROL;
#define reg_TSEN_ADC_DATA_15_0_b0  ANA_TSEN_CONTROL.BF.TSEN_ADC_DATA_15_0_b0
#define reg_TSEN_ADC_DATA_15_0_b1  ANA_TSEN_CONTROL.BF.TSEN_ADC_DATA_15_0_b1
...
#define reg_TSEN_ADC_DATA_15_0  ANA_TSEN_CONTROL.WT.W0

// 0x0030	PROCESSMON_REG0		Process Calibration Related Register 0
typedef union {
	struct {
...
__xdata __at( 0xa330 ) volatile PROCESSMON_REG0_t PROCESSMON_REG0;
...
// 0x0034	PROCESSMON_REG1		Process Calibration Related Register 1
typedef union {
	struct {
...
__xdata __at( 0xa334 ) volatile PROCESSMON_REG1_t PROCESSMON_REG1;
...
// 0x0038	CLKGEN_CMN_REG1		Clock gen cmn reg1
typedef union {
	struct {
		uint8_t EN_CMN                                   : 1;	/*      0     r/w   1*/
		uint8_t RESERVED_1                               : 7;	/*  [7:1]     r/w   0*/
		uint8_t PU_LANE0                                 : 1;	/*      8     r/w   1*/
		uint8_t PU_LANE1                                 : 1;	/*      9     r/w   1*/
		uint8_t PU_LANE2                                 : 1;	/*     10     r/w   1*/
		uint8_t PU_LANE3                                 : 1;	/*     11     r/w   1*/
		uint8_t PU_FM_REG_LANE0                          : 1;	/*     12     r/w   0*/
		uint8_t PU_FM_REG_LANE1                          : 1;	/*     13     r/w   0*/
		uint8_t PU_FM_REG_LANE2                          : 1;	/*     14     r/w   0*/
		uint8_t PU_FM_REG_LANE3                          : 1;	/*     15     r/w   0*/
...
__xdata __at( 0xa338 ) volatile CLKGEN_CMN_REG1_t CLKGEN_CMN_REG1;
#define reg_EN_CMN  CLKGEN_CMN_REG1.BF.EN_CMN
#define reg_PU_LANE0  CLKGEN_CMN_REG1.BF.PU_LANE0
#define reg_PU_LANE1  CLKGEN_CMN_REG1.BF.PU_LANE1
#define reg_PU_LANE2  CLKGEN_CMN_REG1.BF.PU_LANE2
#define reg_PU_LANE3  CLKGEN_CMN_REG1.BF.PU_LANE3
#define reg_PU_FM_REG_LANE0  CLKGEN_CMN_REG1.BF.PU_FM_REG_LANE0
#define reg_PU_FM_REG_LANE1  CLKGEN_CMN_REG1.BF.PU_FM_REG_LANE1
#define reg_PU_FM_REG_LANE2  CLKGEN_CMN_REG1.BF.PU_FM_REG_LANE2
#define reg_PU_FM_REG_LANE3  CLKGEN_CMN_REG1.BF.PU_FM_REG_LANE3
...
// 0x003c	CMN_REG1		common register 1
typedef union {
	struct {
...
__xdata __at( 0xa33c ) volatile CMN_REG1_t CMN_REG1;
...
typedef union {
	struct {
		uint8_t ANA_CMN_TSEN_ADC_DATA_15_0_b0            : 8;	/* [15:0]     r/w 16'h0*/
		uint8_t ANA_CMN_TSEN_ADC_DATA_15_0_b1            : 8;	/* [15:0]     r/w 16'h0*/
		uint8_t ANA_CMN_TSEN_ADC_DATA_FM_REG             : 1;	/*     16     r/w   0*/
...
#define reg_ANA_CMN_TSEN_ADC_DATA_15_0_b0  INPUT_CMN_PIN_REG3.BF.ANA_CMN_TSEN_ADC_DATA_15_0_b0
#define reg_ANA_CMN_TSEN_ADC_DATA_15_0_b1  INPUT_CMN_PIN_REG3.BF.ANA_CMN_TSEN_ADC_DATA_15_0_b1
#define reg_ANA_CMN_TSEN_ADC_DATA_FM_REG  INPUT_CMN_PIN_REG3.BF.ANA_CMN_TSEN_ADC_DATA_FM_REG
#define reg_ANA_CMN_TSEN_ADC_DATA_15_0  INPUT_CMN_PIN_REG3.WT.W0
...
// 0x0050	CMN_REGISTER0		CMN Register 0
typedef union {
	struct {
		uint8_t PIN_PU_TX_RD_LANE0                       : 1;	/*      0       r   0*/
		uint8_t PIN_PU_TX_RD_LANE1                       : 1;	/*      1       r   0*/
		uint8_t PIN_PU_TX_RD_LANE2                       : 1;	/*      2       r   0*/
		uint8_t PIN_PU_TX_RD_LANE3                       : 1;	/*      3       r   0*/
		uint8_t PIN_PU_RX_RD_LANE0                       : 1;	/*      4       r   0*/
		uint8_t PIN_PU_RX_RD_LANE1                       : 1;	/*      5       r   0*/
		uint8_t PIN_PU_RX_RD_LANE2                       : 1;	/*      6       r   0*/
		uint8_t PIN_PU_RX_RD_LANE3                       : 1;	/*      7       r   0*/
		uint8_t PIN_PU_PLL_RD_LANE0                      : 1;	/*      8       r   0*/
		uint8_t PIN_PU_PLL_RD_LANE1                      : 1;	/*      9       r   0*/
		uint8_t PIN_PU_PLL_RD_LANE2                      : 1;	/*     10       r   0*/
		uint8_t PIN_PU_PLL_RD_LANE3                      : 1;	/*     11       r   0*/
		uint8_t PIN_PU_RD_LANE0                          : 1;	/*     12       r   0*/
		uint8_t PIN_PU_RD_LANE1                          : 1;	/*     13       r   0*/
		uint8_t PIN_PU_RD_LANE2                          : 1;	/*     14       r   0*/
		uint8_t PIN_PU_RD_LANE3                          : 1;	/*     15       r   0*/
		uint8_t SFT_RST_NO_REG_RX_RD_LANE0               : 1;	/*     16       r   0*/
		uint8_t SFT_RST_NO_REG_RX_RD_LANE1               : 1;	/*     17       r   0*/
		uint8_t SFT_RST_NO_REG_RX_RD_LANE2               : 1;	/*     18       r   0*/
		uint8_t SFT_RST_NO_REG_RX_RD_LANE3               : 1;	/*     19       r   0*/
		uint8_t SFT_RST_NO_REG_TX_RD_LANE0               : 1;	/*     20       r   0*/
		uint8_t SFT_RST_NO_REG_TX_RD_LANE1               : 1;	/*     21       r   0*/
		uint8_t SFT_RST_NO_REG_TX_RD_LANE2               : 1;	/*     22       r   0*/
		uint8_t SFT_RST_NO_REG_TX_RD_LANE3               : 1;	/*     23       r   0*/
		uint8_t RESERVED_24                              : 8;	/*[31:24]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CMN_REGISTER0_t;
__xdata __at( 0xa350 ) volatile CMN_REGISTER0_t CMN_REGISTER0;
#define reg_PIN_PU_TX_RD_LANE0  CMN_REGISTER0.BF.PIN_PU_TX_RD_LANE0
#define reg_PIN_PU_TX_RD_LANE1  CMN_REGISTER0.BF.PIN_PU_TX_RD_LANE1
#define reg_PIN_PU_TX_RD_LANE2  CMN_REGISTER0.BF.PIN_PU_TX_RD_LANE2
#define reg_PIN_PU_TX_RD_LANE3  CMN_REGISTER0.BF.PIN_PU_TX_RD_LANE3
#define reg_PIN_PU_RX_RD_LANE0  CMN_REGISTER0.BF.PIN_PU_RX_RD_LANE0
#define reg_PIN_PU_RX_RD_LANE1  CMN_REGISTER0.BF.PIN_PU_RX_RD_LANE1
#define reg_PIN_PU_RX_RD_LANE2  CMN_REGISTER0.BF.PIN_PU_RX_RD_LANE2
#define reg_PIN_PU_RX_RD_LANE3  CMN_REGISTER0.BF.PIN_PU_RX_RD_LANE3
#define reg_PIN_PU_PLL_RD_LANE0  CMN_REGISTER0.BF.PIN_PU_PLL_RD_LANE0
#define reg_PIN_PU_PLL_RD_LANE1  CMN_REGISTER0.BF.PIN_PU_PLL_RD_LANE1
#define reg_PIN_PU_PLL_RD_LANE2  CMN_REGISTER0.BF.PIN_PU_PLL_RD_LANE2
#define reg_PIN_PU_PLL_RD_LANE3  CMN_REGISTER0.BF.PIN_PU_PLL_RD_LANE3
#define reg_PIN_PU_RD_LANE0  CMN_REGISTER0.BF.PIN_PU_RD_LANE0
#define reg_PIN_PU_RD_LANE1  CMN_REGISTER0.BF.PIN_PU_RD_LANE1
#define reg_PIN_PU_RD_LANE2  CMN_REGISTER0.BF.PIN_PU_RD_LANE2
#define reg_PIN_PU_RD_LANE3  CMN_REGISTER0.BF.PIN_PU_RD_LANE3
#define reg_SFT_RST_NO_REG_RX_RD_LANE0  CMN_REGISTER0.BF.SFT_RST_NO_REG_RX_RD_LANE0
#define reg_SFT_RST_NO_REG_RX_RD_LANE1  CMN_REGISTER0.BF.SFT_RST_NO_REG_RX_RD_LANE1
#define reg_SFT_RST_NO_REG_RX_RD_LANE2  CMN_REGISTER0.BF.SFT_RST_NO_REG_RX_RD_LANE2
#define reg_SFT_RST_NO_REG_RX_RD_LANE3  CMN_REGISTER0.BF.SFT_RST_NO_REG_RX_RD_LANE3
#define reg_SFT_RST_NO_REG_TX_RD_LANE0  CMN_REGISTER0.BF.SFT_RST_NO_REG_TX_RD_LANE0
#define reg_SFT_RST_NO_REG_TX_RD_LANE1  CMN_REGISTER0.BF.SFT_RST_NO_REG_TX_RD_LANE1
#define reg_SFT_RST_NO_REG_TX_RD_LANE2  CMN_REGISTER0.BF.SFT_RST_NO_REG_TX_RD_LANE2
#define reg_SFT_RST_NO_REG_TX_RD_LANE3  CMN_REGISTER0.BF.SFT_RST_NO_REG_TX_RD_LANE3

// 0x0054	TEST6		_field description_
typedef union {
	struct {
...
__xdata __at( 0xa354 ) volatile TEST6_t TEST6;
#define reg_TESTBUS_DBG_15_0_b0  TEST6.BF.TESTBUS_DBG_15_0_b0
#define reg_TESTBUS_DBG_15_0_b1  TEST6.BF.TESTBUS_DBG_15_0_b1
#define reg_TESTBUS_DBG_15_0  TEST6.WT.W1
...
#define reg_PIN_RESERVED_INPUT_RD_15_0_b0  CMN_RESERVED_REG1.BF.PIN_RESERVED_INPUT_RD_15_0_b0
#define reg_PIN_RESERVED_INPUT_RD_15_0_b1  CMN_RESERVED_REG1.BF.PIN_RESERVED_INPUT_RD_15_0_b1
...
#define reg_PIN_RESERVED_INPUT_RD_15_0  CMN_RESERVED_REG1.WT.W0
...
typedef union {
	struct {
		...
		uint8_t INT0_ENABLE_CMN                          : 1;	/*     19     r/w   1*/
		uint8_t INT1_ENABLE_CMN                          : 1;	/*     20     r/w   1*/
		uint8_t INT2_ENABLE_CMN                          : 1;	/*     21     r/w   1*/
		uint8_t INT3_ENABLE_CMN                          : 1;	/*     22     r/w   1*/
		uint8_t INT4_ENABLE_CMN                          : 1;	/*     23     r/w   1*/
		uint8_t INT5_ENABLE_CMN                          : 1;	/*     24     r/w   1*/
		uint8_t INT6_ENABLE_CMN                          : 1;	/*     25     r/w   1*/
		uint8_t INT7_ENABLE_CMN                          : 1;	/*     26     r/w   1*/
		uint8_t INT8_ENABLE_CMN                          : 1;	/*     27     r/w   1*/
		uint8_t INT9_ENABLE_CMN                          : 1;	/*     28     r/w   1*/
		uint8_t INT10_ENABLE_CMN                         : 1;	/*     29     r/w   1*/
		uint8_t INT11_ENABLE_CMN                         : 1;	/*     30     r/w   1*/
		uint8_t INT12_ENABLE_CMN                         : 1;	/*     31     r/w   1*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
...
#define reg_INT0_ENABLE_CMN  CMN_RESERVED_REG2.BF.INT0_ENABLE_CMN
#define reg_INT1_ENABLE_CMN  CMN_RESERVED_REG2.BF.INT1_ENABLE_CMN
#define reg_INT2_ENABLE_CMN  CMN_RESERVED_REG2.BF.INT2_ENABLE_CMN
#define reg_INT3_ENABLE_CMN  CMN_RESERVED_REG2.BF.INT3_ENABLE_CMN
#define reg_INT4_ENABLE_CMN  CMN_RESERVED_REG2.BF.INT4_ENABLE_CMN
#define reg_INT5_ENABLE_CMN  CMN_RESERVED_REG2.BF.INT5_ENABLE_CMN
#define reg_INT6_ENABLE_CMN  CMN_RESERVED_REG2.BF.INT6_ENABLE_CMN
#define reg_INT7_ENABLE_CMN  CMN_RESERVED_REG2.BF.INT7_ENABLE_CMN
#define reg_INT8_ENABLE_CMN  CMN_RESERVED_REG2.BF.INT8_ENABLE_CMN
#define reg_INT9_ENABLE_CMN  CMN_RESERVED_REG2.BF.INT9_ENABLE_CMN
#define reg_INT10_ENABLE_CMN  CMN_RESERVED_REG2.BF.INT10_ENABLE_CMN
#define reg_INT11_ENABLE_CMN  CMN_RESERVED_REG2.BF.INT11_ENABLE_CMN
#define reg_INT12_ENABLE_CMN  CMN_RESERVED_REG2.BF.INT12_ENABLE_CMN
...
typedef union {
	struct {
		...
		uint8_t MEM_LINE_SEL1_CMN_4_0                    : 5;	/*[20:16]     r/w 5'h0*/
...
typedef union {
	struct {
		...
		uint8_t RESERVED_5                               : 3;	/*  [7:5]     r/w   0*/
		uint8_t MISS_LINE_SEL1_CMN_4_0                   : 5;	/* [12:8]     r/w 5'h0*/
		uint8_t RESERVED_13                              : 3;	/*[15:13]     r/w   0*/
		uint8_t GPI_CMN_7_0                              : 8;	/*[23:16]     r/w 8'h0*/
		uint8_t MEM_LINE_SEL0_CMN_4_0                    : 5;	/*[28:24]     r/w 5'h0*/
		uint8_t RESERVED_29                              : 3;	/*[31:29]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_MISS_LINE_SEL1_CMN_4_0  CMN_CACHE_DEBUG1.BF.MISS_LINE_SEL1_CMN_4_0
#define reg_GPI_CMN_7_0  CMN_CACHE_DEBUG1.BF.GPI_CMN_7_0
#define reg_MEM_LINE_SEL0_CMN_4_0  CMN_CACHE_DEBUG1.BF.MEM_LINE_SEL0_CMN_4_0
...
// 0x00bc	PLL_CTRL_REG0		Pll Control Register 0
typedef union {
	struct {
		uint8_t PLL_RS_MCU_CTRL_SEL0                     : 1;	/*      0     r/w   0*/
		uint8_t RESERVED_1                               : 7;	/*  [7:1]     r/w   0*/
		uint8_t PLL_RS_MCU_CTRL_SEL1                     : 1;	/*      8     r/w   0*/
		uint8_t RESERVED_9                               : 7;	/* [15:9]     r/w   0*/
		uint8_t PLL_RS_MCU_CTRL_SEL2                     : 1;	/*     16     r/w   0*/
		uint8_t RESERVED_17                              : 7;	/*[23:17]     r/w   0*/
		uint8_t PLL_RS_MCU_CTRL_SEL3                     : 1;	/*     24     r/w   0*/
		uint8_t RESERVED_25                              : 7;	/*[31:25]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} PLL_CTRL_REG0_t;
__xdata __at( 0xa3bc ) volatile PLL_CTRL_REG0_t PLL_CTRL_REG0;
#define reg_PLL_RS_MCU_CTRL_SEL0  PLL_CTRL_REG0.BF.PLL_RS_MCU_CTRL_SEL0
#define reg_PLL_RS_MCU_CTRL_SEL1  PLL_CTRL_REG0.BF.PLL_RS_MCU_CTRL_SEL1
#define reg_PLL_RS_MCU_CTRL_SEL2  PLL_CTRL_REG0.BF.PLL_RS_MCU_CTRL_SEL2
#define reg_PLL_RS_MCU_CTRL_SEL3  PLL_CTRL_REG0.BF.PLL_RS_MCU_CTRL_SEL3

// 0x00c0	PLL_CTRL_REG1		Pll Control Register 1
typedef union {
	struct {
		uint8_t PLL_TS_MCU_CTRL_SEL0                     : 1;	/*      0     r/w   0*/
		uint8_t RESERVED_1                               : 7;	/*  [7:1]     r/w   0*/
		uint8_t PLL_TS_MCU_CTRL_SEL1                     : 1;	/*      8     r/w   0*/
		uint8_t RESERVED_9                               : 7;	/* [15:9]     r/w   0*/
		uint8_t PLL_TS_MCU_CTRL_SEL2                     : 1;	/*     16     r/w   0*/
		uint8_t RESERVED_17                              : 7;	/*[23:17]     r/w   0*/
		uint8_t PLL_TS_MCU_CTRL_SEL3                     : 1;	/*     24     r/w   0*/
		uint8_t RESERVED_25                              : 7;	/*[31:25]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} PLL_CTRL_REG1_t;
__xdata __at( 0xa3c0 ) volatile PLL_CTRL_REG1_t PLL_CTRL_REG1;
#define reg_PLL_TS_MCU_CTRL_SEL0  PLL_CTRL_REG1.BF.PLL_TS_MCU_CTRL_SEL0
#define reg_PLL_TS_MCU_CTRL_SEL1  PLL_CTRL_REG1.BF.PLL_TS_MCU_CTRL_SEL1
#define reg_PLL_TS_MCU_CTRL_SEL2  PLL_CTRL_REG1.BF.PLL_TS_MCU_CTRL_SEL2
#define reg_PLL_TS_MCU_CTRL_SEL3  PLL_CTRL_REG1.BF.PLL_TS_MCU_CTRL_SEL3

// 0x00c4	PLL_CTRL_REG2		Pll Control Register 2
typedef union {
	struct {
		uint8_t PLL_TSRS_SWITCH_LANE0                    : 1;	/*      0     r/w   0*/
		uint8_t RESERVED_1                               : 7;	/*  [7:1]     r/w   0*/
		uint8_t PLL_TSRS_SWITCH_LANE1                    : 1;	/*      8     r/w   0*/
		uint8_t RESERVED_9                               : 7;	/* [15:9]     r/w   0*/
		uint8_t PLL_TSRS_SWITCH_LANE2                    : 1;	/*     16     r/w   0*/
		uint8_t RESERVED_17                              : 7;	/*[23:17]     r/w   0*/
		uint8_t PLL_TSRS_SWITCH_LANE3                    : 1;	/*     24     r/w   0*/
		uint8_t RESERVED_25                              : 7;	/*[31:25]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} PLL_CTRL_REG2_t;
__xdata __at( 0xa3c4 ) volatile PLL_CTRL_REG2_t PLL_CTRL_REG2;
#define reg_PLL_TSRS_SWITCH_LANE0  PLL_CTRL_REG2.BF.PLL_TSRS_SWITCH_LANE0
#define reg_PLL_TSRS_SWITCH_LANE1  PLL_CTRL_REG2.BF.PLL_TSRS_SWITCH_LANE1
#define reg_PLL_TSRS_SWITCH_LANE2  PLL_CTRL_REG2.BF.PLL_TSRS_SWITCH_LANE2
#define reg_PLL_TSRS_SWITCH_LANE3  PLL_CTRL_REG2.BF.PLL_TSRS_SWITCH_LANE3
