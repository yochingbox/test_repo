...
#define SUPPORT_CTLE_C1_ADAPT
#define SUPPORT_PHASE_ADAPT
#define SUPPORT_RL2_ADAPT
#endif //SERDES_BUILD
//#define SUPPORT_TEMP_SINGLE_SHOT_MODE
...
#define _DBG_PRINT_CDS_TAP 0
#define _DBG_CTLE_ADAPT    1
#define PLL_DUMP_DEBUG   0
#define _DBG_PLL_VDDA    0
#define _DBG_PLL_TEMPC   0
#endif
...
#define _DBG_PHASE		0
#define _DBG_CDS_PHASE 0
#define _TRAIN_CAP_DEBUG 	1	
#define _NO_GAINTRAIN_SHORT_CREDIT	0
//#define NO_CAL_LOOP
