...
void loadspeedtbl_rx() BANKING_CTRL {
  ...
  uint8_t tmp12 = 0xE0; //TRAIN_PARA_3.BT.B0 , align90_vref_max_lane[7:0]
  uint8_t tmp13 = 0x4; //ANA_SMPLR_REG1.BT.B0 , reg_selmupf_lane[2:0]
  uint8_t tmp14 = 0xA; //ANA_RXREG_REG0.BT.B0 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
  uint8_t tmp15 = 0x0; //ANA_EOM_REG3.BT.B0 , rxpll_hi_speed_lane
  uint8_t tmp16 = 0x75; //ANA_INTPI_REG0.BT.B0 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
  uint8_t tmp17 = 0x0; //DTL_REG1.BT.B0 , init_rxfoffs_lane[12:0]
  uint8_t tmp18 = 0x0; //DTL_REG1.BT.B1 , init_rxfoffs_lane[12:0]
  uint8_t tmp19 = 0xF; //ANA_CTLE_REG1.BT.B0 , ctle_cap1_sel_lane[3:0]
  uint8_t tmp20 = 0xF; //ANA_CTLE_REG4.BT.B0 , ctle_current2_sel_lane[3:0]
  uint8_t tmp21 = 0x3; //ANA_CTLE_REG6.BT.B0 , ctle_res2_sel_lane[3:0]
  uint8_t tmp22 = 0x3; //RX_SYSTEM_LANE.BT.B0 , rx_data_width_lane[1:0], rx_pam2_en_lane
  uint8_t tmp23 = 0xF; //ANA_CTLE_REG7.BT.B0 , ctle_rl1_sel_lane[3:0]
  uint8_t tmp24 = 0x0; //ANA_DTL_REG3.BT.B0 , dtl_clk_speedup_lane[2:0]
  uint8_t tmp25 = 0x42; //TX_TRAIN_PATTERN_REG1.BT.B2 , train_pat_num_rx_lane[9:0]
  uint8_t tmp26 = 0x0; //TX_TRAIN_PATTERN_REG1.BT.B3 , train_pat_num_rx_lane[9:0]
  uint8_t tmp27 = 0x12; //ANA_SMPLR_REG0.BT.B0 , pu_smplr_d_e_lane[2:0], pu_smplr_d_o_lane[2:0]
  uint8_t tmp28 = 0xF; //ANA_CTLE_REG2.BT.B0 , ctle_cap2_sel_lane[3:0]
  uint8_t tmp29 = 0x3; //ANA_SMPLR_REG3.BT.B0 , reg_selmupi_lane[2:0]
  uint8_t tmp30 = 0xF; //ANA_CTLE_REG3.BT.B0 , ctle_current1_sel_lane[3:0]
  uint8_t tmp31 = 0xF; //ANA_CTLE_REG8.BT.B0 , ctle_rl2_sel_lane[3:0]
  uint8_t tmp32 = 0xD2; //ANA_SMPLR_REG2.BT.B0 , pu_ctle_even_lane, pu_ctle_odd_lane, pu_smplr_s_e_lane[2:0], pu_smplr_s_o_lane[2:0]
  if (gen_rx==47){
    ...
    tmp12 = 0xC0;// TRAIN_PARA_3.BT.B0 = 11000000 , align90_vref_max_lane[7:0]
    tmp16 = 0x42;// ANA_INTPI_REG0.BT.B0 = 01000010 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp20 = 0xE;// ANA_CTLE_REG4.BT.B0 = ####1110 , ctle_current2_sel_lane[3:0]
    tmp21 = 0x4;// ANA_CTLE_REG6.BT.B0 = ####0100 , ctle_res2_sel_lane[3:0]
    tmp23 = 0xA;// ANA_CTLE_REG7.BT.B0 = ####1010 , ctle_rl1_sel_lane[3:0]
    tmp24 = 0x4;// ANA_DTL_REG3.BT.B0 = #####100 , dtl_clk_speedup_lane[2:0]
    tmp30 = 0xA;// ANA_CTLE_REG3.BT.B0 = ####1010 , ctle_current1_sel_lane[3:0]
    tmp31 = 0xE;// ANA_CTLE_REG8.BT.B0 = ####1110 , ctle_rl2_sel_lane[3:0]
  }
  else if (gen_rx==46){
    ...
    tmp19 = 0x5;// ANA_CTLE_REG1.BT.B0 = ####0101 , ctle_cap1_sel_lane[3:0]
    tmp20 = 0x1;// ANA_CTLE_REG4.BT.B0 = ####0001 , ctle_current2_sel_lane[3:0]
    tmp21 = 0xF;// ANA_CTLE_REG6.BT.B0 = ####1111 , ctle_res2_sel_lane[3:0]
    tmp23 = 0x0;// ANA_CTLE_REG7.BT.B0 = ####0000 , ctle_rl1_sel_lane[3:0]
    tmp27 = 0x10;// ANA_SMPLR_REG0.BT.B0 = ##010000 , pu_smplr_d_e_lane[2:0], pu_smplr_d_o_lane[2:0]
    tmp28 = 0x5;// ANA_CTLE_REG2.BT.B0 = ####0101 , ctle_cap2_sel_lane[3:0]
    tmp30 = 0x0;// ANA_CTLE_REG3.BT.B0 = ####0000 , ctle_current1_sel_lane[3:0]
    tmp31 = 0x1;// ANA_CTLE_REG8.BT.B0 = ####0001 , ctle_rl2_sel_lane[3:0]
    tmp32 = 0x80;// ANA_SMPLR_REG2.BT.B0 = 10000000 , pu_ctle_even_lane, pu_ctle_odd_lane, pu_smplr_s_e_lane[2:0], pu_smplr_s_o_lane[2:0]
  }
  else if (gen_rx==42){
    ...
    tmp12 = 0xDA;// TRAIN_PARA_3.BT.B0 = 11011010 , align90_vref_max_lane[7:0]
    tmp14 = 0x6;// ANA_RXREG_REG0.BT.B0 = ####0110 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    tmp15 = 0x1;// ANA_EOM_REG3.BT.B0 = #######1 , rxpll_hi_speed_lane
    tmp16 = 0xBB;// ANA_INTPI_REG0.BT.B0 = 10111011 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp22 = 0x4;// RX_SYSTEM_LANE.BT.B0 = #####100 , rx_data_width_lane[1:0], rx_pam2_en_lane
    tmp24 = 0x4;// ANA_DTL_REG3.BT.B0 = #####100 , dtl_clk_speedup_lane[2:0]
    tmp27 = 0x3F;// ANA_SMPLR_REG0.BT.B0 = ##111111 , pu_smplr_d_e_lane[2:0], pu_smplr_d_o_lane[2:0]
    tmp32 = 0xFF;// ANA_SMPLR_REG2.BT.B0 = 11111111 , pu_ctle_even_lane, pu_ctle_odd_lane, pu_smplr_s_e_lane[2:0], pu_smplr_s_o_lane[2:0]
  }
  else if (gen_rx==38){
    tmp0 = 0x2;// ANA_RSVD_REG9.BT.B0 = ####0010 , ctle_cl2_sel_lane[1:0], ctle_cl1_sel_lane[1:0]
    tmp1 = 0x0;// ANA_CTLE_REG0.BT.B0 = ##00#### , ctle_bypass1_en_lane, ctle_bypass2_en_lane
    ...
    tmp10 = 0x8;// TX_TRAIN_PATTTERN_REG0.BT.B0 = 00001000 , train_pat_num_lane[9:0]
    tmp11 = 0xA;// TX_TRAIN_PATTTERN_REG0.BT.B1 = ####1010 , ethernet_mode_lane[1:0], train_pat_num_lane[9:0]
    tmp12 = 0xDD;// TRAIN_PARA_3.BT.B0 = 11011101 , align90_vref_max_lane[7:0]
    tmp14 = 0x3;// ANA_RXREG_REG0.BT.B0 = ####0011 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    tmp16 = 0xBB;// ANA_INTPI_REG0.BT.B0 = 10111011 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp22 = 0x4;// RX_SYSTEM_LANE.BT.B0 = #####100 , rx_data_width_lane[1:0], rx_pam2_en_lane
    tmp24 = 0x4;// ANA_DTL_REG3.BT.B0 = #####100 , dtl_clk_speedup_lane[2:0]
    tmp27 = 0x3F;// ANA_SMPLR_REG0.BT.B0 = ##111111 , pu_smplr_d_e_lane[2:0], pu_smplr_d_o_lane[2:0]
    ...
    tmp10 = 0x8;// TX_TRAIN_PATTTERN_REG0.BT.B0 = 00001000 , train_pat_num_lane[9:0]
    tmp11 = 0xA;// TX_TRAIN_PATTTERN_REG0.BT.B1 = ####1010 , ethernet_mode_lane[1:0], train_pat_num_lane[9:0]
    tmp12 = 0xDC;// TRAIN_PARA_3.BT.B0 = 11011100 , align90_vref_max_lane[7:0]
    tmp14 = 0x3;// ANA_RXREG_REG0.BT.B0 = ####0011 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    tmp16 = 0xBB;// ANA_INTPI_REG0.BT.B0 = 10111011 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp22 = 0x4;// RX_SYSTEM_LANE.BT.B0 = #####100 , rx_data_width_lane[1:0], rx_pam2_en_lane
    tmp24 = 0x4;// ANA_DTL_REG3.BT.B0 = #####100 , dtl_clk_speedup_lane[2:0]
    ...
    tmp10 = 0x8;// TX_TRAIN_PATTTERN_REG0.BT.B0 = 00001000 , train_pat_num_lane[9:0]
    tmp11 = 0xA;// TX_TRAIN_PATTTERN_REG0.BT.B1 = ####1010 , ethernet_mode_lane[1:0], train_pat_num_lane[9:0]
    tmp12 = 0xD0;// TRAIN_PARA_3.BT.B0 = 11010000 , align90_vref_max_lane[7:0]
    tmp14 = 0x2;// ANA_RXREG_REG0.BT.B0 = ####0010 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    tmp16 = 0x98;// ANA_INTPI_REG0.BT.B0 = 10011000 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp22 = 0x4;// RX_SYSTEM_LANE.BT.B0 = #####100 , rx_data_width_lane[1:0], rx_pam2_en_lane
    tmp24 = 0x4;// ANA_DTL_REG3.BT.B0 = #####100 , dtl_clk_speedup_lane[2:0]
    tmp27 = 0x3F;// ANA_SMPLR_REG0.BT.B0 = ##111111 , pu_smplr_d_e_lane[2:0], pu_smplr_d_o_lane[2:0]
    tmp32 = 0xFF;// ANA_SMPLR_REG2.BT.B0 = 11111111 , pu_ctle_even_lane, pu_ctle_odd_lane, pu_smplr_s_e_lane[2:0], pu_smplr_s_o_lane[2:0]
    ...
    tmp12 = 0xDD;// TRAIN_PARA_3.BT.B0 = 11011101 , align90_vref_max_lane[7:0]
    tmp14 = 0x5;// ANA_RXREG_REG0.BT.B0 = ####0101 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    tmp16 = 0xBB;// ANA_INTPI_REG0.BT.B0 = 10111011 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp24 = 0x4;// ANA_DTL_REG3.BT.B0 = #####100 , dtl_clk_speedup_lane[2:0]
  }
  else if (gen_rx==27){
    ...
    tmp12 = 0xC9;// TRAIN_PARA_3.BT.B0 = 11001001 , align90_vref_max_lane[7:0]
    tmp14 = 0x2;// ANA_RXREG_REG0.BT.B0 = ####0010 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    tmp24 = 0x4;// ANA_DTL_REG3.BT.B0 = #####100 , dtl_clk_speedup_lane[2:0]
  }
  else if (gen_rx==23){
    ...
    tmp7 = 0x83;// DTL_REG2.BT.B0 = 10000011 , rx_foffset_extra_m_lane[13:0]
    tmp8 = 0x9D;// DTL_REG2.BT.B1 = 10011101 , dtl_clk_mode_lane[1:0], rx_foffset_extra_m_lane[13:0]
    tmp14 = 0xE;// ANA_RXREG_REG0.BT.B0 = ####1110 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    tmp15 = 0x1;// ANA_EOM_REG3.BT.B0 = #######1 , rxpll_hi_speed_lane
    tmp16 = 0xBB;// ANA_INTPI_REG0.BT.B0 = 10111011 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp19 = 0xC;// ANA_CTLE_REG1.BT.B0 = ####1100 , ctle_cap1_sel_lane[3:0]
    tmp20 = 0xE;// ANA_CTLE_REG4.BT.B0 = ####1110 , ctle_current2_sel_lane[3:0]
    tmp21 = 0x4;// ANA_CTLE_REG6.BT.B0 = ####0100 , ctle_res2_sel_lane[3:0]
    tmp23 = 0x9;// ANA_CTLE_REG7.BT.B0 = ####1001 , ctle_rl1_sel_lane[3:0]
    tmp30 = 0x9;// ANA_CTLE_REG3.BT.B0 = ####1001 , ctle_current1_sel_lane[3:0]
    tmp31 = 0xE;// ANA_CTLE_REG8.BT.B0 = ####1110 , ctle_rl2_sel_lane[3:0]
  }
  else if (gen_rx==22){
    ...
    tmp7 = 0x20;// DTL_REG2.BT.B0 = 00100000 , rx_foffset_extra_m_lane[13:0]
    tmp8 = 0x9B;// DTL_REG2.BT.B1 = 10011011 , dtl_clk_mode_lane[1:0], rx_foffset_extra_m_lane[13:0]
    tmp14 = 0xB;// ANA_RXREG_REG0.BT.B0 = ####1011 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    tmp16 = 0xBB;// ANA_INTPI_REG0.BT.B0 = 10111011 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp19 = 0xA;// ANA_CTLE_REG1.BT.B0 = ####1010 , ctle_cap1_sel_lane[3:0]
    tmp20 = 0xC;// ANA_CTLE_REG4.BT.B0 = ####1100 , ctle_current2_sel_lane[3:0]
    tmp21 = 0x5;// ANA_CTLE_REG6.BT.B0 = ####0101 , ctle_res2_sel_lane[3:0]
    tmp23 = 0x8;// ANA_CTLE_REG7.BT.B0 = ####1000 , ctle_rl1_sel_lane[3:0]
    tmp30 = 0x8;// ANA_CTLE_REG3.BT.B0 = ####1000 , ctle_current1_sel_lane[3:0]
    tmp31 = 0xC;// ANA_CTLE_REG8.BT.B0 = ####1100 , ctle_rl2_sel_lane[3:0]
  }
  else if (gen_rx==21){
    tmp2 = 0x9;// ANA_CTLE_REG5.BT.B0 = ####1001 , ctle_res1_sel_lane[3:0]
    ...
    tmp9 = 0x2;// ANA_IMPCAL_REG0.BT.B0 = #####010 , path_disable_edge_lane, intpr_lane[1:0]
    tmp19 = 0xA;// ANA_CTLE_REG1.BT.B0 = ####1010 , ctle_cap1_sel_lane[3:0]
    tmp20 = 0xA;// ANA_CTLE_REG4.BT.B0 = ####1010 , ctle_current2_sel_lane[3:0]
    tmp21 = 0x7;// ANA_CTLE_REG6.BT.B0 = ####0111 , ctle_res2_sel_lane[3:0]
    tmp23 = 0x7;// ANA_CTLE_REG7.BT.B0 = ####0111 , ctle_rl1_sel_lane[3:0]
    tmp28 = 0xA;// ANA_CTLE_REG2.BT.B0 = ####1010 , ctle_cap2_sel_lane[3:0]
    tmp30 = 0x7;// ANA_CTLE_REG3.BT.B0 = ####0111 , ctle_current1_sel_lane[3:0]
    tmp31 = 0xA;// ANA_CTLE_REG8.BT.B0 = ####1010 , ctle_rl2_sel_lane[3:0]
  }
  else if (gen_rx==17){
    tmp2 = 0xA;// ANA_CTLE_REG5.BT.B0 = ####1010 , ctle_res1_sel_lane[3:0]
    tmp4 = 0x6;// PLL_RS_LANE_REG12.BT.B2 = ###00110 , rx_pll_rate_sel_lane[4:0]
    ...
    tmp9 = 0x2;// ANA_IMPCAL_REG0.BT.B0 = #####010 , path_disable_edge_lane, intpr_lane[1:0]
    tmp12 = 0xD0;// TRAIN_PARA_3.BT.B0 = 11010000 , align90_vref_max_lane[7:0]
    tmp19 = 0x7;// ANA_CTLE_REG1.BT.B0 = ####0111 , ctle_cap1_sel_lane[3:0]
    tmp20 = 0x7;// ANA_CTLE_REG4.BT.B0 = ####0111 , ctle_current2_sel_lane[3:0]
    tmp21 = 0xA;// ANA_CTLE_REG6.BT.B0 = ####1010 , ctle_res2_sel_lane[3:0]
    tmp23 = 0x5;// ANA_CTLE_REG7.BT.B0 = ####0101 , ctle_rl1_sel_lane[3:0]
    tmp28 = 0x7;// ANA_CTLE_REG2.BT.B0 = ####0111 , ctle_cap2_sel_lane[3:0]
    tmp30 = 0x5;// ANA_CTLE_REG3.BT.B0 = ####0101 , ctle_current1_sel_lane[3:0]
    tmp31 = 0x7;// ANA_CTLE_REG8.BT.B0 = ####0111 , ctle_rl2_sel_lane[3:0]
  }
  else if (gen_rx==13){
    ...
    tmp16 = 0x42;// ANA_INTPI_REG0.BT.B0 = 01000010 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp19 = 0x7;// ANA_CTLE_REG1.BT.B0 = ####0111 , ctle_cap1_sel_lane[3:0]
    tmp20 = 0x6;// ANA_CTLE_REG4.BT.B0 = ####0110 , ctle_current2_sel_lane[3:0]
    tmp21 = 0xB;// ANA_CTLE_REG6.BT.B0 = ####1011 , ctle_res2_sel_lane[3:0]
    tmp23 = 0x4;// ANA_CTLE_REG7.BT.B0 = ####0100 , ctle_rl1_sel_lane[3:0]
    tmp28 = 0x7;// ANA_CTLE_REG2.BT.B0 = ####0111 , ctle_cap2_sel_lane[3:0]
    tmp30 = 0x4;// ANA_CTLE_REG3.BT.B0 = ####0100 , ctle_current1_sel_lane[3:0]
    tmp31 = 0x6;// ANA_CTLE_REG8.BT.B0 = ####0110 , ctle_rl2_sel_lane[3:0]
  }
  else if (gen_rx==12){
    tmp2 = 0xD;// ANA_CTLE_REG5.BT.B0 = ####1101 , ctle_res1_sel_lane[3:0]
    tmp4 = 0xC;// PLL_RS_LANE_REG12.BT.B2 = ###01100 , rx_pll_rate_sel_lane[4:0]
    ...
    tmp16 = 0x98;// ANA_INTPI_REG0.BT.B0 = 10011000 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp19 = 0x7;// ANA_CTLE_REG1.BT.B0 = ####0111 , ctle_cap1_sel_lane[3:0]
    tmp20 = 0x5;// ANA_CTLE_REG4.BT.B0 = ####0101 , ctle_current2_sel_lane[3:0]
    tmp21 = 0xC;// ANA_CTLE_REG6.BT.B0 = ####1100 , ctle_res2_sel_lane[3:0]
    tmp23 = 0x3;// ANA_CTLE_REG7.BT.B0 = ####0011 , ctle_rl1_sel_lane[3:0]
    tmp28 = 0x7;// ANA_CTLE_REG2.BT.B0 = ####0111 , ctle_cap2_sel_lane[3:0]
    tmp30 = 0x3;// ANA_CTLE_REG3.BT.B0 = ####0011 , ctle_current1_sel_lane[3:0]
    tmp31 = 0x5;// ANA_CTLE_REG8.BT.B0 = ####0101 , ctle_rl2_sel_lane[3:0]
    tmp32 = 0xC2;// ANA_SMPLR_REG2.BT.B0 = 11000010 , pu_ctle_even_lane, pu_ctle_odd_lane, pu_smplr_s_e_lane[2:0], pu_smplr_s_o_lane[2:0]
  }
  else if (gen_rx==11){
    tmp2 = 0xD;// ANA_CTLE_REG5.BT.B0 = ####1101 , ctle_res1_sel_lane[3:0]
    ...
    tmp12 = 0xD0;// TRAIN_PARA_3.BT.B0 = 11010000 , align90_vref_max_lane[7:0]
    tmp19 = 0x7;// ANA_CTLE_REG1.BT.B0 = ####0111 , ctle_cap1_sel_lane[3:0]
    tmp20 = 0x3;// ANA_CTLE_REG4.BT.B0 = ####0011 , ctle_current2_sel_lane[3:0]
    tmp21 = 0xD;// ANA_CTLE_REG6.BT.B0 = ####1101 , ctle_res2_sel_lane[3:0]
    tmp23 = 0x2;// ANA_CTLE_REG7.BT.B0 = ####0010 , ctle_rl1_sel_lane[3:0]
    tmp28 = 0x7;// ANA_CTLE_REG2.BT.B0 = ####0111 , ctle_cap2_sel_lane[3:0]
    tmp30 = 0x2;// ANA_CTLE_REG3.BT.B0 = ####0010 , ctle_current1_sel_lane[3:0]
    tmp31 = 0x3;// ANA_CTLE_REG8.BT.B0 = ####0011 , ctle_rl2_sel_lane[3:0]
    tmp32 = 0xC2;// ANA_SMPLR_REG2.BT.B0 = 11000010 , pu_ctle_even_lane, pu_ctle_odd_lane, pu_smplr_s_e_lane[2:0], pu_smplr_s_o_lane[2:0]
  }
  else if (gen_rx==7){
    tmp2 = 0xE;// ANA_CTLE_REG5.BT.B0 = ####1110 , ctle_res1_sel_lane[3:0]
    ...
    tmp16 = 0x98;// ANA_INTPI_REG0.BT.B0 = 10011000 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp19 = 0x7;// ANA_CTLE_REG1.BT.B0 = ####0111 , ctle_cap1_sel_lane[3:0]
    tmp20 = 0x2;// ANA_CTLE_REG4.BT.B0 = ####0010 , ctle_current2_sel_lane[3:0]
    tmp21 = 0xD;// ANA_CTLE_REG6.BT.B0 = ####1101 , ctle_res2_sel_lane[3:0]
    tmp23 = 0x1;// ANA_CTLE_REG7.BT.B0 = ####0001 , ctle_rl1_sel_lane[3:0]
    tmp27 = 0x10;// ANA_SMPLR_REG0.BT.B0 = ##010000 , pu_smplr_d_e_lane[2:0], pu_smplr_d_o_lane[2:0]
    tmp28 = 0x7;// ANA_CTLE_REG2.BT.B0 = ####0111 , ctle_cap2_sel_lane[3:0]
    tmp30 = 0x1;// ANA_CTLE_REG3.BT.B0 = ####0001 , ctle_current1_sel_lane[3:0]
    tmp31 = 0x2;// ANA_CTLE_REG8.BT.B0 = ####0010 , ctle_rl2_sel_lane[3:0]
    tmp32 = 0x80;// ANA_SMPLR_REG2.BT.B0 = 10000000 , pu_ctle_even_lane, pu_ctle_odd_lane, pu_smplr_s_e_lane[2:0], pu_smplr_s_o_lane[2:0]
  }
  else if (gen_rx==5){
    tmp2 = 0xF;// ANA_CTLE_REG5.BT.B0 = ####1111 , ctle_res1_sel_lane[3:0]
    ...
    tmp9 = 0x6;// ANA_IMPCAL_REG0.BT.B0 = #####110 , path_disable_edge_lane, intpr_lane[1:0]
    tmp19 = 0x5;// ANA_CTLE_REG1.BT.B0 = ####0101 , ctle_cap1_sel_lane[3:0]
    tmp20 = 0x0;// ANA_CTLE_REG4.BT.B0 = ####0000 , ctle_current2_sel_lane[3:0]
    tmp21 = 0xF;// ANA_CTLE_REG6.BT.B0 = ####1111 , ctle_res2_sel_lane[3:0]
    tmp23 = 0x0;// ANA_CTLE_REG7.BT.B0 = ####0000 , ctle_rl1_sel_lane[3:0]
    tmp27 = 0x2;// ANA_SMPLR_REG0.BT.B0 = ##000010 , pu_smplr_d_e_lane[2:0], pu_smplr_d_o_lane[2:0]
    tmp28 = 0x5;// ANA_CTLE_REG2.BT.B0 = ####0101 , ctle_cap2_sel_lane[3:0]
    tmp30 = 0x0;// ANA_CTLE_REG3.BT.B0 = ####0000 , ctle_current1_sel_lane[3:0]
    tmp31 = 0x0;// ANA_CTLE_REG8.BT.B0 = ####0000 , ctle_rl2_sel_lane[3:0]
    tmp32 = 0x40;// ANA_SMPLR_REG2.BT.B0 = 01000000 , pu_ctle_even_lane, pu_ctle_odd_lane, pu_smplr_s_e_lane[2:0], pu_smplr_s_o_lane[2:0]
  }
  else if (gen_rx==1){
    tmp0 = 0xF;// ANA_RSVD_REG9.BT.B0 = ####1111 , ctle_cl2_sel_lane[1:0], ctle_cl1_sel_lane[1:0]
    tmp2 = 0xF;// ANA_CTLE_REG5.BT.B0 = ####1111 , ctle_res1_sel_lane[3:0]
  ...
  TRAIN_PARA_3.BT.B0 = tmp12;
  ANA_SMPLR_REG1.BT.B0 = tmp13;
  ANA_RXREG_REG0.BT.B0 = tmp14;
  ANA_EOM_REG3.BT.B0 = tmp15;
  ANA_INTPI_REG0.BT.B0 = tmp16;
  DTL_REG1.BT.B0 = tmp17;
  DTL_REG1.BT.B1 = tmp18;
  ANA_CTLE_REG1.BT.B0 = tmp19;
  ANA_CTLE_REG4.BT.B0 = tmp20;
  ANA_CTLE_REG6.BT.B0 = tmp21;
  RX_SYSTEM_LANE.BT.B0 = tmp22;
  ANA_CTLE_REG7.BT.B0 = tmp23;
  ANA_DTL_REG3.BT.B0 = tmp24;
  TX_TRAIN_PATTERN_REG1.BT.B2 = tmp25;
  TX_TRAIN_PATTERN_REG1.BT.B3 = tmp26;
  ANA_SMPLR_REG0.BT.B0 = tmp27;
  ANA_CTLE_REG2.BT.B0 = tmp28;
  ANA_SMPLR_REG3.BT.B0 = tmp29;
  ANA_CTLE_REG3.BT.B0 = tmp30;
  ANA_CTLE_REG8.BT.B0 = tmp31;
  ANA_SMPLR_REG2.BT.B0 = tmp32;
}
void loadspeedtbl_lc_pll (uint8_t pll_rate_sel, uint8_t ref_clk_sel, int tsrs_sel) BANKING_CTRL {
  ...
  uint8_t tmp11 = 0x78; //PLL_TS_CAL_CTRL_LANE.BT.B2 , pll_ts_vco_amp_vth_mid_lane[3:0], pll_ts_vco_amp_vth_low_lane[3:0]
  uint8_t tmp12 = 0x6; //PLL_TS_CAL_CTRL_LANE.BT.B3 , pll_ts_vco_amp_vth_high_lane[3:0]
  ...
  if (pll_rate_sel==20){
    ...
    tmp9 = 0x4E; //PLL_TS_CAL_CTRL_LANE.BT.B0 , pll_ts_speed_thresh_lane[15:0]
    tmp11 = 0x9A; //PLL_TS_CAL_CTRL_LANE.BT.B2 , pll_ts_vco_amp_vth_mid_lane[3:0], pll_ts_vco_amp_vth_low_lane[3:0]
    tmp12 = 0x8; //PLL_TS_CAL_CTRL_LANE.BT.B3 , pll_ts_vco_amp_vth_high_lane[3:0]
    tmp13 = 0xB3; //PLL_TS_LANE_REG1.BT.B0 , pll_ts_init_foffs_lane[15:0]
    tmp14 = 0xF8; //PLL_TS_LANE_REG1.BT.B1 , pll_ts_init_foffs_lane[15:0]
