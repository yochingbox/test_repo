...
void loadspeedtbl_rx() BANKING_CTRL {
  ...
  uint8_t tmp19 = 0x7; //ANA_CTLE_REG1.BT.B0 , ctle_cap1_sel_lane[3:0]
  ...
  uint8_t tmp23 = 0x5; //ANA_CTLE_REG7.BT.B0 , ctle_rl1_sel_lane[3:0]
  ...
  uint8_t tmp28 = 0x7; //ANA_CTLE_REG2.BT.B0 , ctle_cap2_sel_lane[3:0]
  uint8_t tmp29 = 0x3; //ANA_SMPLR_REG3.BT.B0 , reg_selmupi_lane[2:0]
  uint8_t tmp30 = 0x5; //ANA_CTLE_REG3.BT.B0 , ctle_current1_sel_lane[3:0]
  ...
  if (gen_rx==4){
    ...
    tmp12 = 0xDE;// TRAIN_PARA_3.BT.B0 = 11011110 , align90_vref_max_lane[7:0]
    tmp14 = 0x7;// ANA_RXREG_REG0.BT.B0 = ####0111 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    ...
    tmp19 = 0xF;// ANA_CTLE_REG1.BT.B0 = ####1111 , ctle_cap1_sel_lane[3:0]
    tmp23 = 0xF;// ANA_CTLE_REG7.BT.B0 = ####1111 , ctle_rl1_sel_lane[3:0]
    tmp24 = 0x4;// ANA_DTL_REG3.BT.B0 = #####100 , dtl_clk_speedup_lane[2:0]
    tmp28 = 0xF;// ANA_CTLE_REG2.BT.B0 = ####1111 , ctle_cap2_sel_lane[3:0]
    tmp30 = 0xF;// ANA_CTLE_REG3.BT.B0 = ####1111 , ctle_current1_sel_lane[3:0]
  }
  else if (gen_rx==3){
    ...
    tmp12 = 0xC3;// TRAIN_PARA_3.BT.B0 = 11000011 , align90_vref_max_lane[7:0]
    tmp16 = 0x42;// ANA_INTPI_REG0.BT.B0 = 01000010 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp19 = 0xF;// ANA_CTLE_REG1.BT.B0 = ####1111 , ctle_cap1_sel_lane[3:0]
    tmp23 = 0xB;// ANA_CTLE_REG7.BT.B0 = ####1011 , ctle_rl1_sel_lane[3:0]
    tmp24 = 0x4;// ANA_DTL_REG3.BT.B0 = #####100 , dtl_clk_speedup_lane[2:0]
    tmp28 = 0xF;// ANA_CTLE_REG2.BT.B0 = ####1111 , ctle_cap2_sel_lane[3:0]
    tmp30 = 0xB;// ANA_CTLE_REG3.BT.B0 = ####1011 , ctle_current1_sel_lane[3:0]
  }
  else if (gen_rx==2){
...
void loadspeedtbl_lc_pll (uint8_t pll_rate_sel, uint8_t ref_clk_sel, int tsrs_sel) BANKING_CTRL {
  ...
  uint8_t tmp2 = 0x3A; //PLL_TS_UPHY14_CMN_ANAREG_TOP_002.BT.B0 , pll_ts_fbdiv_lane[7:0]
  uint8_t tmp3 = 0xB; //PLL_TS_DTX_REG2.BT.B0 , pll_ts_ssc_m_lane[12:0]
  ...
  uint8_t tmp12 = 0x7; //PLL_TS_CAL_CTRL_LANE.BT.B3 , pll_ts_vco_amp_vth_high_lane[3:0]
  ...
  if (pll_rate_sel==25){
    ...
    tmp2 = 0x91; //PLL_TS_UPHY14_CMN_ANAREG_TOP_002.BT.B0 , pll_ts_fbdiv_lane[7:0]
    ...
    if (ref_clk_sel==7){
      tmp2 = 0x5D;// PLL_TS_UPHY14_CMN_ANAREG_TOP_002.BT.B0 = 01011101 , pll_ts_fbdiv_lane[7:0]
      tmp8 = 0x44;// PLL_TS_UPHY14_CMN_ANAREG_TOP_003.BT.B0 = 010001## , pll_ts_refdiv_lane[3:0], pll_ts_pll_lpfc_lane[1:0]
      tmp13 = 0xD4;// PLL_TS_LANE_REG1.BT.B0 = 11010100 , pll_ts_init_foffs_lane[15:0]
      ...
      tmp2 = 0x6D;// PLL_TS_UPHY14_CMN_ANAREG_TOP_002.BT.B0 = 01101101 , pll_ts_fbdiv_lane[7:0]
      tmp8 = 0x34;// PLL_TS_UPHY14_CMN_ANAREG_TOP_003.BT.B0 = 001101## , pll_ts_refdiv_lane[3:0], pll_ts_pll_lpfc_lane[1:0]
      tmp13 = 0x6B;// PLL_TS_LANE_REG1.BT.B0 = 01101011 , pll_ts_init_foffs_lane[15:0]
      ...
      tmp2 = 0xB5;// PLL_TS_UPHY14_CMN_ANAREG_TOP_002.BT.B0 = 10110101 , pll_ts_fbdiv_lane[7:0]
      ...
      tmp8 = 0x24;// PLL_TS_UPHY14_CMN_ANAREG_TOP_003.BT.B0 = 001001## , pll_ts_refdiv_lane[3:0], pll_ts_pll_lpfc_lane[1:0]
      tmp13 = 0x5A;// PLL_TS_LANE_REG1.BT.B0 = 01011010 , pll_ts_init_foffs_lane[15:0]
      tmp14 = 0xFA;// PLL_TS_LANE_REG1.BT.B1 = 11111010 , pll_ts_init_foffs_lane[15:0]
      ...
      tmp2 = 0x79;// PLL_TS_UPHY14_CMN_ANAREG_TOP_002.BT.B0 = 01111001 , pll_ts_fbdiv_lane[7:0]
      tmp7 = 0x84;// PLL_TS_UPHY14_CMN_ANAREG_TOP_000.BT.B0 = 10000100 , pll_ts_vind_band_sel_lane, pll_ts_fbdiv_lane[9:8], pll_ts_pll_lpfr_lane[2:0], pll_ts_tx_intpr_lane[1:0]
      tmp13 = 0xA6;// PLL_TS_LANE_REG1.BT.B0 = 10100110 , pll_ts_init_foffs_lane[15:0]
    ...
    tmp3 = 0x9F; //PLL_TS_DTX_REG2.BT.B0 , pll_ts_ssc_m_lane[12:0]
    ...
    tmp11 = 0x8A; //PLL_TS_CAL_CTRL_LANE.BT.B2 , pll_ts_vco_amp_vth_mid_lane[3:0], pll_ts_vco_amp_vth_low_lane[3:0]
