...
void loadspeedtbl_rx() BANKING_CTRL {
  ...
  uint8_t tmp20 = 0x5; //ANA_CTLE_REG4.BT.B0 , ctle_current2_sel_lane[3:0]
  uint8_t tmp21 = 0x7; //ANA_CTLE_REG6.BT.B0 , ctle_res2_sel_lane[3:0]
  uint8_t tmp22 = 0x3; //RX_SYSTEM_LANE.BT.B0 , rx_data_width_lane[1:0], rx_pam2_en_lane
  uint8_t tmp23 = 0x7; //ANA_CTLE_REG7.BT.B0 , ctle_rl1_sel_lane[3:0]
  ...
  uint8_t tmp30 = 0x7; //ANA_CTLE_REG3.BT.B0 , ctle_current1_sel_lane[3:0]
  uint8_t tmp31 = 0x5; //ANA_CTLE_REG8.BT.B0 , ctle_rl2_sel_lane[3:0]
  uint8_t tmp32 = 0xC2; //ANA_SMPLR_REG2.BT.B0 , pu_ctle_even_lane, pu_ctle_odd_lane, pu_smplr_s_e_lane[2:0], pu_smplr_s_o_lane[2:0]
  if (gen_rx==2){
    ...
    tmp32 = 0xD2;// ANA_SMPLR_REG2.BT.B0 = 11010010 , pu_ctle_even_lane, pu_ctle_odd_lane, pu_smplr_s_e_lane[2:0], pu_smplr_s_o_lane[2:0]
  }
  else if (gen_rx==1){
