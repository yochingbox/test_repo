...
void PowerUp_Seq_Cal(void) BANKING_CTRL {
   ...
   //initial speed load
	...
	gen_tx = min(gen_tx, cmx_PHY_GEN_MAX_4_0);
	gen_rx = reg_PIN_PHY_GEN_RX_RD_LANE_4_0;
	gen_rx = min(gen_rx, cmx_PHY_GEN_MAX_4_0);
...
void PowerUp_Seq(void) BANKING_CTRL {
...
#ifndef DEVELOP_TEMP
		if(mcuid== cmx_MASTER_MCU_SEL_7_0) reg_INT_PU_PLL_OR_CHG_MASK_LANE = 0; //PU_PLL_OR
#else
		reg_INT_PU_PLL_OR_CHG_MASK_LANE = 0;
#endif
	...
	//int9
	reg_INT9_PM_CHG_INT_EN_LANE = 1;
	if(mcuid== cmx_MASTER_MCU_SEL_7_0) reg_INT9_INT_PU_PLL_OR_CHG_INT_EN_LANE = 1;
	reg_INT1_INT_POWER_STATE_VALID_RISE_INT_EN_LANE = 0;
	//int8
	...
	//-----------
    //initial speed load
	gen_tx = reg_PIN_PHY_GEN_TX_RD_LANE_3_0; gen_tx = min(gen_tx, cmx_PHY_GEN_MAX_4_0);
	gen_rx = reg_PIN_PHY_GEN_RX_RD_LANE_3_0; gen_rx = min(gen_rx, cmx_PHY_GEN_MAX_4_0);
