...
typedef union {
	struct {
		...
		uint8_t TX_TRAIN_POLY_SEL_FM_PIN_LANE            : 1;	/*      2     r/w   0*/
		uint8_t TX_TRAIN_PAT_FORCE_LANE                  : 1;	/*      3     r/w   0*/
		uint8_t TX_TRAIN_PAT_SEL_LANE_1_0                : 2;	/*  [5:4]     r/w   0*/
		uint8_t PT_START_RD_LANE                         : 1;	/*      6     r/w   0*/
		uint8_t PT_CNT_RST_LANE                          : 1;	/*      7     r/w   0*/
		uint8_t PT_LOCK_CNT_LANE_7_0                     : 8;	/* [15:8]     r/w 8'h20*/
...
typedef union {
	struct {
		...
		uint8_t PT_LOCK_MODE_LANE                        : 1;	/*     25     r/w   1*/
...
#define reg_PT_CNT_LANE_15_0  PT_COUNTER1.WT.W1
