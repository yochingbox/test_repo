...
typedef union {
	struct {
		...
		uint8_t RXINIT_CONT_CAL_LOOP_CNT_7_0             : 8;	/* [15:8]     r/w 8'h28*/
...
typedef union {
	struct {
		...
		uint8_t DFE_DC_INTERVAL_EQ_DURATION_SEL_1_0      : 2;	/*  [1:0]     r/w 2'h0*/
		uint8_t DFE_DC_INTERVAL_EQ_SLICE_ONLY            : 1;	/*      2     r/w   0*/
		...
		uint8_t DFE_DC_INTERVAL_WA_START_DELAY_3_0       : 4;	/*[19:16]     r/w   0*/
...
#define cmx_DFE_DC_INTERVAL_EQ_DURATION_SEL_1_0 	LOCAL_TX_PRESET_TB3.BF.DFE_DC_INTERVAL_EQ_DURATION_SEL_1_0
#define cmx_DFE_DC_INTERVAL_EQ_SLICE_ONLY 	LOCAL_TX_PRESET_TB3.BF.DFE_DC_INTERVAL_EQ_SLICE_ONLY
#define cmx_DFE_DC_INTERVAL_EQ_EN 	LOCAL_TX_PRESET_TB3.BF.DFE_DC_INTERVAL_EQ_EN
...
#define cmx_DFE_DC_INTERVAL_WA_START_DELAY_3_0  LOCAL_TX_PRESET_TB3.BF.DFE_DC_INTERVAL_WA_START_DELAY_3_0
...
typedef union {
	struct {
		...
		uint8_t RINGPLL_TFINEDAC_7_0                        : 8;	/*[31:16]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
...
#define cmx_RINGPLL_TFINEDAC_7_0  LOCAL_TX_PRESET_TB5.BF.RINGPLL_TFINEDAC_7_0

// 0x06d0	END_XDAT_CMN		
typedef union {
	struct {
		uint8_t END_XDAT_CMN_7_0                         : 8;	/*  [7:0]     r/w 8'haa*/
		uint8_t RINGPLL_DAC_MIN_STEP_NUM_7_0             : 8;	/* [31:8]     r/w   0*/
		uint8_t RINGPLL_FDIFF_7_0                        : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/* [31:8]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} END_XDAT_CMN_t;
__xdata __at( 0xe6d0 ) volatile END_XDAT_CMN_t END_XDAT_CMN;
#define cmx_END_XDAT_CMN_7_0  END_XDAT_CMN.BF.END_XDAT_CMN_7_0
#define cmx_RINGPLL_DAC_MIN_STEP_NUM_7_0  END_XDAT_CMN.BF.RINGPLL_DAC_MIN_STEP_NUM_7_0
#define cmx_RINGPLL_FDIFF_7_0  END_XDAT_CMN.BF.RINGPLL_FDIFF_7_0
