...
void Power_P0s_P1( void ) BANKING_CTRL {
	...
	reg_INIT_RXFOFFS_LANE_9_0_b0 = 0xfb; reg_INIT_RXFOFFS_LANE_9_0_b1 = 3; //-150ppm
	#endif 
	...
	//txloz2hiz();
	if(reg_PIN_TX_IDLE_HIZ_RD_LANE/* && cmx_BYPASS_PU_RX_P1==0*/) {
	...
	if( reg_PIN_PU_PLL_RD_LANE == 0) {
		...
		else if(cmx_PLL_CONT_CAL_EN_L1) { //should be along with bypass_pu_rx_p1=1
