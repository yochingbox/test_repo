...
void PowerUp_Seq(void) BANKING_CTRL {
	...
	//Voltron ringpll unlock debug
	reg_MCU_DEBUGA_LANE_7_0 = 0; //spd interrupt cnt
	reg_MCU_DEBUG6_LANE_7_0 = 0; //ringpll enter cnt
	reg_MCU_DEBUG7_LANE_7_0 = 0; //ringpll done cnt
	reg_MCU_DEBUG8_LANE_7_0 = 0; //pll_ready=1 at spd_chg
	reg_MCU_DEBUG9_LANE_7_0 = 0; //pll_ready=1 at slumber wake up
	reg_MCU_DEBUGA_LANE_7_0 = 0; //pll_ready=1 at pslumber wakeup
