...
typedef union {
	struct {
		...
		uint8_t XDATA_ECC_ERR_LANE                       : 1;	/*      4       r   0*/
		uint8_t CACHE_ECC_ERR_LANE                       : 1;	/*      5       r   0*/
		uint8_t IRAM_ECC_ERR_LANE                        : 1;	/*      6       r   0*/
		uint8_t XDATA_MEM_CHECKSUM_RESET_LANE            : 1;	/*      7     r/w   0*/
		uint8_t XDATA_MEM_CHECKSUM_PASS_LANE             : 1;	/*      8       r   0*/
		uint8_t RESERVED_9                               : 7;	/* [30:9]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/* [30:9]     r/w   0*/
		uint8_t RESERVED_24                              : 7;	/* [30:9]     r/w   0*/
...
#define reg_XDATA_ECC_ERR_LANE  MCU_MEM_REG2_LANE.BF.XDATA_ECC_ERR_LANE
#define reg_CACHE_ECC_ERR_LANE  MCU_MEM_REG2_LANE.BF.CACHE_ECC_ERR_LANE
#define reg_IRAM_ECC_ERR_LANE  MCU_MEM_REG2_LANE.BF.IRAM_ECC_ERR_LANE
...
typedef union {
	struct {
		...
		uint8_t IDATA_ECC_ERR_ADDR_LANE_7_0_b0           : 7;	/* [16:9]       r   0*/
		uint8_t IDATA_ECC_ERR_ADDR_LANE_7_0_b1           : 1;	/* [16:9]       r   0*/
...
typedef union {
	struct {
		uint8_t XDATA_MEM_CHECKSUM_EXP_LANE_31_0_b0      : 8;	/* [31:0]     r/w 32'h0*/
		uint8_t XDATA_MEM_CHECKSUM_EXP_LANE_31_0_b1      : 8;	/* [31:0]     r/w 32'h0*/
		uint8_t XDATA_MEM_CHECKSUM_EXP_LANE_31_0_b2      : 8;	/* [31:0]     r/w 32'h0*/
		uint8_t XDATA_MEM_CHECKSUM_EXP_LANE_31_0_b3      : 8;	/* [31:0]     r/w 32'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
