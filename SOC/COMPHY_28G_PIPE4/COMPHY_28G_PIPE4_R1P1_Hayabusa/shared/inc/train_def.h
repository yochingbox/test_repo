...
#define ctrl_trx_train_done		lnx_TRX_TRAIN_DONE_INT_LANE
...
#define tag_CDR_MIN_PHASE_OS_MODE01 ((int8_t)cmx_CDR_PHASE_MIN_PHASE_OS_MODE01_2C_7_0) //-28 //-20  //+/-10
#define tag_CDR_MAX_PHASE_OS_MODE01 ((int8_t)cmx_CDR_PHASE_MAX_PHASE_OS_MODE01_2C_7_0) //18 //1 //20   
#define tag_CDR_MIN_PHASE_OS_MODE23 ((int8_t)cmx_CDR_PHASE_MIN_PHASE_OS_MODE23_2C_7_0) //-60 //-50 //32 //a range around -0.5UI to 0.5UI
#define tag_CDR_MAX_PHASE_OS_MODE23 ((int8_t)cmx_CDR_PHASE_MAX_PHASE_OS_MODE23_2C_7_0) //60 //50 //32   
#define tag_CDR_MIN_PHASE_OS_MODE01_LIMIT  -28 //-20  //+/-10
#define tag_CDR_MAX_PHASE_OS_MODE01_LIMIT  18 //1 //20   
...
#define tag_PHASE_OFFSET_USER	((int8_t)cmx_MIDPOINT_USER_PHASE_OFFSET_7_0)
...
#define tag_SUMFTAP_EN_0 	lnx_SUMFTAP_EN_0_LANE //0
#define tag_SUMFTAP_EN_1 	lnx_SUMFTAP_EN_1_LANE //Other:0, PCIe:1
#define tag_SUMFTAP_EN_2 	lnx_SUMFTAP_EN_2_LANE //1 
#define tag_SUMFTAP_EN_3 	lnx_SUMFTAP_EN_3_LANE //1
#define tag_SUMFTAP_EN_4 	lnx_SUMFTAP_EN_4_LANE //1
#define tag_SUMFTAP_EN_5 	lnx_SUMFTAP_EN_5_LANE //1
#define tag_SUMFTAP_EN_6 	lnx_SUMFTAP_EN_6_LANE //0
#define tag_SUMFTAP_EN_7 	lnx_SUMFTAP_EN_7_LANE //0
#define tag_SUMFTAP_SIGN_0 	lnx_SUMFTAP_SIGN_0_LANE //0
#define tag_SUMFTAP_SIGN_1 	lnx_SUMFTAP_SIGN_1_LANE //1
#define tag_SUMFTAP_SIGN_2 	lnx_SUMFTAP_SIGN_2_LANE //1
#define tag_SUMFTAP_SIGN_3 	lnx_SUMFTAP_SIGN_3_LANE //1
#define tag_SUMFTAP_SIGN_4 	lnx_SUMFTAP_SIGN_4_LANE //1
#define tag_SUMFTAP_SIGN_5 	lnx_SUMFTAP_SIGN_5_LANE //1
#define tag_SUMFTAP_SIGN_6 	lnx_SUMFTAP_SIGN_6_LANE //1
#define tag_SUMFTAP_SIGN_7 	lnx_SUMFTAP_SIGN_7_LANE //1
...
#define tag_TX_STOP_THRES cmx_TX_G1N1_STOP_THRESHOLD_7_0 //10 //5
#define tag_TX_EO_STOP_THRES	cmx_TX_EO_STOP_THRES_7_0 //0 //6?/
...
#define tag_TX_GN1_MIDPOINT_INDEX_OS ((int8_t)cmx_TX_GN1_MIDPOINT_INDEX_OS_7_0) //-4 //-8 //-4 //0
...
#define tag_TX_GN1_OVERBOOST_THRES cmx_TX_GN1_OVERBOOST_THRES_7_0//3
#define tag_TX_GN1_OVERBOOST_UPDATE_THRES 4
#define tag_TX_G1_OVERBOOST_EN 1
#define tag_TX_G1_OVERBOOST_THRES cmx_TX_G1_OVERBOOST_THRES_7_0//3
