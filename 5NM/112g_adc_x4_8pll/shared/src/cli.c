...
void cli_monitor(void) {
	...
	case 0x0e: drv_adc_res_cfg(lnx_CLI_ARGS_LANE_15_0_b0, lnx_CLI_ARGS_LANE_15_0_b1); break;
	//case 0x0f: break;
	...
	case 0x15: tsen_adc_ctrl_run(); break;
	case 0x16: set_ctle(lnx_CLI_ARGS_LANE_15_0_b0, lnx_CLI_ARGS_LANE_15_0_b1); break;
	case 0x17: set_gain_coarse(lnx_CLI_ARGS_LANE_15_0_b0); break;
        case 0x18: lnx_CLI_RETURN_LANE_15_0 = snr_approx(lnx_CLI_ARGS_LANE_15_0); break;
	case 0x19: {
				   reg_MCU_DEBUGA_LANE_7_0=0x11;
					drv_rs_pll_cfg(); break;
			   }
	case 0x1a: drv_ts_pll_cfg(); break;
    ...
    case 0x41: drv_iso_trx_pu_down();
               break;
    case 0x42: drv_iso_trx_pu_up();
               break;
    case 0x43: drv_iso_trx_sft_rst_up();
               break;
    case 0x44: drv_iso_trx_sft_rst_down();
               break;
    case 0x45: drv_iso_trx_phy_gen_chg();
               break;		
