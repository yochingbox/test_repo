...
#ifdef _5FF_COMPHY_112G_ADC_X4_8PLL_R1P1
    uint16_t mcu_freq = ((uint16_t)(reg_PIN_MCU_FREQ_RD_15_0_b1 << 8) | reg_PIN_MCU_FREQ_RD_15_0_b0);
#endif
...
#ifdef _5FF_COMPHY_112G_ADC_X4_8PLL_R1P1
    reg_ANA_TSEN_ADC_CLK_CNT_15_0 = (mcu_freq >> 1) -1;
    reg_CMN_DIG_CAL2M_DIV_7_0 = (mcu_freq >>1) -1;
#endif
#ifdef _5FF_COMPHY_112G_ADC_X4_8PLL_R1P0
	reg_ANA_TSEN_ADC_CLK_CNT_15_0 = (cmx_MCU_FREQ_15_0 >> 1) -1;
	reg_CMN_DIG_CAL2M_DIV_7_0 = (cmx_MCU_FREQ_15_0 >>1) -1;
#endif
	reg_BRCH_CHGPUMP_SEL_3_0 = 0x0f;
	reg_VREF_TRX_0P6V_SEL_2_0 = 0x04;
}
...
//For 1.1 and above, Added code to handle reg_PIN_RESET_CORE_TX/RX_RD_LANE and ack at first time power-up
//https://ceproject.marvell.com/index.html#/task/2299/subtask/45968
#ifndef _5FF_COMPHY_112G_ADC_X4_8PLL_R1P0
static void rx_soft_reset__clear_isr() BANKING_CTRL {
...
static void tx_soft_reset__clear_isr() BANKING_CTRL {
...
void drv_pll_tx_cal_clear() BANKING_CTRL {
    bool PLL_TS_DCC_CAL_SINGLE_EN_temp_save;
	bool PLL_TS_DIV_DCC_CAL_SINGLE_EN_temp_save; 
	bool PLL_TS_VDDA_FBDIV_CAL_SINGLE_EN_temp_save;
    bool PLL_TS_VDDA_INTP_CAL_SINGLE_EN_temp_save;
    bool PLL_TS_VDDA_PFD_CAL_SINGLE_EN_temp_save;

    PLL_TS_DCC_CAL_SINGLE_EN_temp_save = reg_PLL_TS_DCC_CAL_SINGLE_EN_LANE;
    PLL_TS_DIV_DCC_CAL_SINGLE_EN_temp_save = reg_PLL_TS_DIV_DCC_CAL_SINGLE_EN_LANE;
    PLL_TS_VDDA_FBDIV_CAL_SINGLE_EN_temp_save = reg_PLL_TS_VDDA_FBDIV_CAL_SINGLE_EN_LANE;
    PLL_TS_VDDA_INTP_CAL_SINGLE_EN_temp_save = reg_PLL_TS_VDDA_INTP_CAL_SINGLE_EN_LANE;
    PLL_TS_VDDA_PFD_CAL_SINGLE_EN_temp_save = reg_PLL_TS_VDDA_PFD_CAL_SINGLE_EN_LANE;
    ...
    reg_PLL_TS_DIV_DCC_CAL_SINGLE_EN_LANE = 0;
    ...
    reg_PLL_TS_DCC_CAL_SINGLE_EN_LANE = PLL_TS_DCC_CAL_SINGLE_EN_temp_save;
    reg_PLL_TS_DIV_DCC_CAL_SINGLE_EN_LANE = PLL_TS_DIV_DCC_CAL_SINGLE_EN_temp_save;
    reg_PLL_TS_VDDA_FBDIV_CAL_SINGLE_EN_LANE = PLL_TS_VDDA_FBDIV_CAL_SINGLE_EN_temp_save;
    reg_PLL_TS_VDDA_INTP_CAL_SINGLE_EN_LANE = PLL_TS_VDDA_INTP_CAL_SINGLE_EN_temp_save;
    reg_PLL_TS_VDDA_PFD_CAL_SINGLE_EN_LANE = PLL_TS_VDDA_PFD_CAL_SINGLE_EN_temp_save;
}
void drv_pll_rx_cal_clear() BANKING_CTRL {
    bool PLL_RS_DCC_CAL_SINGLE_EN_temp_save;
	bool PLL_RS_DIV_DCC_CAL_SINGLE_EN_temp_save; 
	bool PLL_RS_VDDA_FBDIV_CAL_SINGLE_EN_temp_save;
    bool PLL_RS_VDDA_INTP_CAL_SINGLE_EN_temp_save;
    bool PLL_RS_VDDA_PFD_CAL_SINGLE_EN_temp_save;

    PLL_RS_DCC_CAL_SINGLE_EN_temp_save = reg_PLL_RS_DCC_CAL_SINGLE_EN_LANE;
    PLL_RS_DIV_DCC_CAL_SINGLE_EN_temp_save = reg_PLL_RS_DIV_DCC_CAL_SINGLE_EN_LANE;
    PLL_RS_VDDA_FBDIV_CAL_SINGLE_EN_temp_save = reg_PLL_RS_VDDA_FBDIV_CAL_SINGLE_EN_LANE;
    PLL_RS_VDDA_INTP_CAL_SINGLE_EN_temp_save = reg_PLL_RS_VDDA_INTP_CAL_SINGLE_EN_LANE;
    PLL_RS_VDDA_PFD_CAL_SINGLE_EN_temp_save = reg_PLL_RS_VDDA_PFD_CAL_SINGLE_EN_LANE;
    ...
    reg_PLL_RS_DIV_DCC_CAL_SINGLE_EN_LANE = 0;
    ...
    reg_PLL_RS_DCC_CAL_SINGLE_EN_LANE = PLL_RS_DCC_CAL_SINGLE_EN_temp_save;
    reg_PLL_RS_DIV_DCC_CAL_SINGLE_EN_LANE = PLL_RS_DIV_DCC_CAL_SINGLE_EN_temp_save;
    reg_PLL_RS_VDDA_FBDIV_CAL_SINGLE_EN_LANE = PLL_RS_VDDA_FBDIV_CAL_SINGLE_EN_temp_save;
    reg_PLL_RS_VDDA_INTP_CAL_SINGLE_EN_LANE = PLL_RS_VDDA_INTP_CAL_SINGLE_EN_temp_save;
    reg_PLL_RS_VDDA_PFD_CAL_SINGLE_EN_LANE = PLL_RS_VDDA_PFD_CAL_SINGLE_EN_temp_save;
}

static void voltage_setup(void){
    //reg_PIN_AVDD_SEL_RD_2_0 decoder:
    //0 - Reserved
    //1 - Reserved
    //2 - 0.95V
    //3 - 1.0V
	...
	if(mcuid == MCU_CMN) {
		if(reg_PIN_AVDD_SEL_RD_2_0 < 0x4) {
		    //use 1.1V setting from PLL pseudo code
		    reg_VREF_0P6V_VDDVCO_RXPLL_CH0_3_0 = 0x8;
		    reg_VREF_0P6V_VDDVCO_RXPLL_CH1_3_0 = 0x8;
		    reg_VREF_0P6V_VDDVCO_RXPLL_CH2_3_0 = 0x8;
		    reg_VREF_0P6V_VDDVCO_RXPLL_CH3_3_0 = 0x8;
		    reg_VREF_0P6V_VDDVCO_TXPLL_CH0_3_0 = 0x8;
		    reg_VREF_0P6V_VDDVCO_TXPLL_CH1_3_0 = 0x8;
		    reg_VREF_0P6V_VDDVCO_TXPLL_CH2_3_0 = 0x8;
		    reg_VREF_0P6V_VDDVCO_TXPLL_CH3_3_0 = 0x8;
		    reg_VREF_VDDACAL_PLL_PFD_SEL_3_0 = 0xa;
		}
		else if(reg_PIN_AVDD_SEL_RD_2_0 > 0x5){
		    //use 1.2V setting from PLL pseudo code
		    reg_VREF_0P6V_VDDVCO_RXPLL_CH0_3_0 = 0x9;
		    reg_VREF_0P6V_VDDVCO_RXPLL_CH1_3_0 = 0x9;
		    reg_VREF_0P6V_VDDVCO_RXPLL_CH2_3_0 = 0x9;
		    reg_VREF_0P6V_VDDVCO_RXPLL_CH3_3_0 = 0x9;
		    reg_VREF_0P6V_VDDVCO_TXPLL_CH0_3_0 = 0x9;
		    reg_VREF_0P6V_VDDVCO_TXPLL_CH1_3_0 = 0x9;
		    reg_VREF_0P6V_VDDVCO_TXPLL_CH2_3_0 = 0x9;
		    reg_VREF_0P6V_VDDVCO_TXPLL_CH3_3_0 = 0x9;
		    reg_VREF_VDDACAL_PLL_PFD_SEL_3_0 = 0xc;
		}
		else {
		    //use 1.0V setting from PLL pseudo code
		    reg_VREF_0P6V_VDDVCO_RXPLL_CH0_3_0 = 0xC;
		    reg_VREF_0P6V_VDDVCO_RXPLL_CH1_3_0 = 0xC;
		    reg_VREF_0P6V_VDDVCO_RXPLL_CH2_3_0 = 0xC;
		    reg_VREF_0P6V_VDDVCO_RXPLL_CH3_3_0 = 0xC;
		    reg_VREF_0P6V_VDDVCO_TXPLL_CH0_3_0 = 0xC;
		    reg_VREF_0P6V_VDDVCO_TXPLL_CH1_3_0 = 0xC;
		    reg_VREF_0P6V_VDDVCO_TXPLL_CH2_3_0 = 0xC;
		    reg_VREF_0P6V_VDDVCO_TXPLL_CH3_3_0 = 0xC;
		    reg_VREF_VDDACAL_PLL_PFD_SEL_3_0 = 0xa;
		}
	        reg_VREF_VDDACAL_PLL_CLK_SEL_3_0 = 0x7;
		reg_VBG_SEL_3_0 = 0x0E;
	}
	else{
		if(reg_PIN_AVDD_SEL_RD_2_0 <= 0x5) {
		    //use 1.0V setting from PLL pseudo code
		    reg_PLL_RS_LCPLLREG_SEL_3P5K_TO_3K_RATIO_LANE = 0;


		    reg_PLL_RS_VDDA_INTP_CAL_RESULT_EXT_LANE_3_0 = 0x6;
//		    reg_PLL_RS_VDDA_INTP_CAL_CAL_EN_EXT_LANE = 1;
//		    reg_PLL_RS_VDDA_INTP_CAL_CAL_EN_EXT_LANE = 0;

		    reg_PLL_RS_VDDA_FBDIV_CAL_RESULT_EXT_LANE_3_0 = 0x3;
//		    reg_PLL_RS_VDDA_FBDIV_CAL_CAL_EN_EXT_LANE = 1;
//		    reg_PLL_RS_VDDA_FBDIV_CAL_CAL_EN_EXT_LANE = 0;

		    reg_PLL_RS_VDDA_PFD_CAL_RESULT_EXT_LANE_3_0 = 0x3;
//		    reg_PLL_RS_VDDA_PFD_CAL_CAL_EN_EXT_LANE = 1;
//		    reg_PLL_RS_VDDA_PFD_CAL_CAL_EN_EXT_LANE = 0;

		}
		else {
		    //use 1.2V setting from PLL pseudo code
		    reg_PLL_RS_LCPLLREG_SEL_3P5K_TO_3K_RATIO_LANE = 1;
...
//		    reg_PLL_RS_VDDA_FBDIV_CAL_CAL_EN_EXT_LANE = 0;
		    ...
		    reg_PLL_RS_VDDA_PFD_CAL_RESULT_EXT_LANE_3_0 = 0xB;
//		    reg_PLL_RS_VDDA_PFD_CAL_CAL_EN_EXT_LANE = 1;
//		    reg_PLL_RS_VDDA_PFD_CAL_CAL_EN_EXT_LANE = 0;

		}

		reg_PLL_RS_VCO_SLAVE_ADJ_LANE_2_0 = 3;
		reg_PLL_RS_VDDR_DAC_ADJ_LANE_2_0 = 3;
		reg_PLL_RS_LCPLL_DEADZONE_TUNE_LANE_1_0 = 0x0;
		reg_PLL_RS_ENLARGE_OP_GM_LANE = 0x1;
		reg_PLL_RS_ANA_RSVDB_LANE_7_0 = 0x1f;
		reg_PLL_RS_TX_SYNC_BYPASS_LANE = 0x01;
		reg_PLL_RS_VCON_REF_SEL_LANE_3_0 = 7;
		reg_PLL_RS_SELHV_LCPLL_CP_LANE_3_0 = 0x0f;
		reg_PLL_RS_VARAC_BIAS_SEL_LANE_2_0 = 0x07;

		if(reg_PIN_AVDD_SEL_RD_2_0 <= 0x5) {
		    //use 1.0V setting from PLL pseudo code
		    reg_PLL_TS_LCPLLREG_SEL_3P5K_TO_3K_RATIO_LANE = 0;

		    reg_PLL_TS_VDDA_INTP_CAL_RESULT_EXT_LANE_3_0 = 0x6;
//		    reg_PLL_TS_VDDA_INTP_CAL_CAL_EN_EXT_LANE = 1;
//		    reg_PLL_TS_VDDA_INTP_CAL_CAL_EN_EXT_LANE = 0;

		    reg_PLL_TS_VDDA_FBDIV_CAL_RESULT_EXT_LANE_3_0 = 0x3;
//		    reg_PLL_TS_VDDA_FBDIV_CAL_CAL_EN_EXT_LANE = 1;
//		    reg_PLL_TS_VDDA_FBDIV_CAL_CAL_EN_EXT_LANE = 0;

		    reg_PLL_TS_VDDA_PFD_CAL_RESULT_EXT_LANE_3_0 = 0x3;
//		    reg_PLL_TS_VDDA_PFD_CAL_CAL_EN_EXT_LANE = 1;
//		    reg_PLL_TS_VDDA_PFD_CAL_CAL_EN_EXT_LANE = 0;

		}
		else {
		    //use 1.2V setting from PLL pseudo code
		    reg_PLL_TS_LCPLLREG_SEL_3P5K_TO_3K_RATIO_LANE = 1;
...
//		    reg_PLL_TS_VDDA_FBDIV_CAL_CAL_EN_EXT_LANE = 0;
		    ...
		    reg_PLL_TS_VDDA_PFD_CAL_RESULT_EXT_LANE_3_0 = 0xb;
//		    reg_PLL_TS_VDDA_PFD_CAL_CAL_EN_EXT_LANE = 1;
//		    reg_PLL_TS_VDDA_PFD_CAL_CAL_EN_EXT_LANE = 0;

		}

		reg_PLL_TS_SELHV_LCPLL_CP_LANE_3_0 = 0x0f;
		    reg_PLL_TS_VCO_SLAVE_ADJ_LANE_2_0 = 3;
		    reg_PLL_TS_VDDR_DAC_ADJ_LANE_2_0 = 3;
		reg_PLL_TS_LCPLL_DEADZONE_TUNE_LANE_1_0 = 0x0;
		reg_PLL_TS_ENLARGE_OP_GM_LANE = 0x1;
		reg_PLL_TS_ANA_RSVDB_LANE_7_0 = 0x1f;
		reg_PLL_TS_TX_SYNC_BYPASS_LANE = 0x01;
		reg_PLL_TS_VCON_REF_SEL_LANE_3_0 = 7;
		drv_pll_tx_cal_clear();
		drv_pll_rx_cal_clear();
		reg_VDDR_TXCLK_VREF_SEL_LANE_2_0 = 0x04;
		reg_TRXIVREF_RSVD0_LANE_7_0 = 0x0f;
		reg_PLL_TS_VARAC_BIAS_SEL_LANE_2_0 = 0x07;
		reg_TXDCC_A90_SEL_LANE_1_0 = 0x01;
		reg_VDDR_TXDATA_VREF_SEL_LANE_2_0 = 0x04;
		reg_PLL_RS_VCOAMP_VTH_SEL_LANE_3_0 = 0x08;
		reg_PLL_TS_VCOAMP_VTH_SEL_LANE_3_0 = 0x08;
		reg_PLL_RS_VCON_MIN_SEL_LANE_2_0 = 2; 
		reg_PLL_TS_VCON_MIN_SEL_LANE_2_0 = 2;
		reg_PLL_RS_VCON_MAX_SEL_LANE_2_0 = 5;
		reg_PLL_TS_VCON_MAX_SEL_LANE_2_0 = 5;
	    }
}
...
//	drv_spd_cfg_dec();
	...
	if (mcuid != MCU_CMN) {
...
#else 
		reg_ANA_REFCLK_SEL = reg_PIN_REFCLK_SEL_TX_RD_LANE; //TODO how to select cmn
		reg_ANA_PLL_RS_REFCLK_SEL_LANE = reg_PIN_REFCLK_SEL_RX_RD_LANE; //TODO to support TS/RS swap
		...
		wait_for(reg_PIN_PU_PLL_RD_LANE,0);
#endif
//https://ceproject.marvell.com/index.html#/task/2292
		set_mcu_en();
		init_interrupt_cfg();
#ifdef _5FF_COMPHY_112G_ADC_X4_8PLL_R1P0
		voltage_setup();
...
//REFCLK_DIS is removed from design for R1P1
...
#ifdef _5FF_COMPHY_112G_ADC_X4_8PLL_R1P1
	if(mcu_freq==0) {reg_PIN_MCU_FREQ_RD_15_0_b0 = 0x90;reg_PIN_MCU_FREQ_RD_15_0_b1=0x1;}
#endif
#ifdef _5FF_COMPHY_112G_ADC_X4_8PLL_R1P0
...
#else //DRV_PWR_V2
	i = reg_PIN_REF_FREF_SEL_RX_RD_LANE_4_0; // TODO - need to support CMN MCU?
#endif
...
#else	
//https://ceproject.marvell.com/index.html#/task/2259
		mcuclk_mc = (uint8_t)((mcu_freq+8)/15);

		//1u unit pwm timer1, timer2
		//reg_TIMER1_CLK_SEL_LANE_1_0 = 0; //refclk
		reg_TIMER_1_SEL_LANE_1_0 = 0x01; //PWM1
		reg_TIMER_2_SEL_LANE_1_0 = 0x01; //PWM1
		reg_PWM1_CLK_SEL_LANE_1_0 = 0x01; //MCU clock
		reg_PWM1_EN_LANE = 1;
		temp = mcu_freq>>1;
		reg_PWM1_COUNTER_LANE_30_0_b0 = (uint8_t)temp;
		reg_PWM1_COUNTER_LANE_30_0_b1 = (uint8_t)(temp >> 8);
...
#else
//https://ceproject.marvell.com/index.html#/task/2259
		cmx_MCUCLK_MC_7_0 = (uint8_t)((mcu_freq+8)/15);

		//1u unit pwm timer1
		//reg_TIMER1_CLK_SEL_CMN_1_0 = 0; //refclk
		reg_TIMER_1_SEL_CMN_1_0 = 0x01; //PWM1
		reg_PWM1_CLK_SEL_CMN_1_0 = 0x01; //MCU clock
		reg_PWM1_EN_CMN = 1;
		temp = mcu_freq>>1;
		reg_PWM1_COUNTER_CMN_30_0_b0 = (uint8_t)temp;
		reg_PWM1_COUNTER_CMN_30_0_b1 = (uint8_t)(temp >> 8);
