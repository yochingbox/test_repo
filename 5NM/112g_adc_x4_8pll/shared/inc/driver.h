...
//
#define drv_TXTRAIN_PATTERN_LOCK_LOST_EN reg_TXTRAIN_PATTERN_LOCK_LOST_EN_LANE
...
#define drv_TXTRAIN_CTRL_CN3     reg_TXTRAIN_CTRL_CN3_LANE_1_0
...
#define drv_TXTRAIN_STATUS_CN3   reg_TXTRAIN_STATUS_CN3_LANE_2_0
...
void drv_shared_sigmnt_init(void) BANKING_CTRL;
bool drv_shared_sigmnt(void) BANKING_CTRL;
void drv_adc_to_dp_sigmnt_init(void) BANKING_CTRL;
bool drv_adc_to_dp_sigmnt(void) BANKING_CTRL;
