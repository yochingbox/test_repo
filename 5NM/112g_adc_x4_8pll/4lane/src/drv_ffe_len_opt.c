...
void drv_ffe_len_opt () BANKING_CTRL
{
    ...
    ffe_pst_coe[3]  = (int8_t)(reg_RX_DP_LMS_FFE_PST4_COE_LANE_4_0  << 3) >> 3;
    ffe_pst_coe[4]  = (int8_t)(reg_RX_DP_LMS_FFE_PST5_COE_LANE_4_0  << 3) >> 3;
    ffe_pst_coe[5]  = (int8_t)(reg_RX_DP_LMS_FFE_PST6_COE_LANE_4_0  << 3) >> 3;
    ffe_pst_coe[6]  = (int8_t)(reg_RX_DP_LMS_FFE_PST7_COE_LANE_3_0  << 4) >> 4;
    ffe_pst_coe[7]  = (int8_t)(reg_RX_DP_LMS_FFE_PST8_COE_LANE_3_0  << 4) >> 4;
    ...
    if(reg_FFE_LEN_OPT_FFE_LD_ZERO_LANE)
    {
      ...
      if(ffe_pst_dis[3] ) {reg_RX_DP_LMS_FFE_PST4_EXT_LANE_4_0  = 0;}
      if(ffe_pst_dis[4] ) {reg_RX_DP_LMS_FFE_PST5_EXT_LANE_4_0  = 0;}
      if(ffe_pst_dis[5] ) {reg_RX_DP_LMS_FFE_PST6_EXT_LANE_4_0  = 0;}
      if(ffe_pst_dis[6] ) {reg_RX_DP_LMS_FFE_PST7_EXT_LANE_3_0  = 0;}
      if(ffe_pst_dis[7] ) {reg_RX_DP_LMS_FFE_PST8_EXT_LANE_3_0  = 0;}
