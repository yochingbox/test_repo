...
void drv_adc_cal (uint16_t adc_cal_en) BANKING_CTRL
{
    ...
    uint8_t sav_RX_CTLE_CS2_CTRL_LANE_3_0;
    uint8_t sav_RX_CTLE_RS2_CTRL_LANE_3_0;
    ...
    ADC_CAL_ST_JUMP(PT_SET);
        ...
        sav_RX_CTLE_CS2_CTRL_LANE_3_0 = reg_RX_CTLE_CS2_CTRL_LANE_3_0;
        sav_RX_CTLE_RS2_CTRL_LANE_3_0 = reg_RX_CTLE_RS2_CTRL_LANE_3_0;
    ...
    ADC_CAL_ST_JUMP(PT_CLR);
        ...
        reg_RX_CTLE_CS2_CTRL_LANE_3_0 = sav_RX_CTLE_CS2_CTRL_LANE_3_0;
        reg_RX_CTLE_RS2_CTRL_LANE_3_0 = sav_RX_CTLE_RS2_CTRL_LANE_3_0;
