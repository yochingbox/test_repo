...
typedef union {
	struct {
		uint8_t TXDRVREG_TEMPC_IPTAT_ISINK_LANE_2_0      : 3;	/*  [2:0]     r/w 3'h2*/
		uint8_t TXDRVREG_TEMPC_IPTAT_EN_LANE             : 1;	/*      3     r/w   0*/
		uint8_t RESERVED_4                               : 1;	/*      4     r/w   0*/
		uint8_t RESERVED_5                               : 1;	/*      5     r/w   0*/
		uint8_t RESERVED_6                               : 1;	/*      6     r/w   0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
...
#define reg_TXDRVREG_TEMPC_IPTAT_ISINK_LANE_2_0  TRX_MIS_REG.BF.TXDRVREG_TEMPC_IPTAT_ISINK_LANE_2_0
#define reg_TXDRVREG_TEMPC_IPTAT_EN_LANE  TRX_MIS_REG.BF.TXDRVREG_TEMPC_IPTAT_EN_LANE
