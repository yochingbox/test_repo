...
typedef union {
	struct {
		...
		uint8_t PIN_RESET_CORE_ACK_TX_LANE               : 1;	/*      2     r/w   0*/
		uint8_t PIN_RESET_CORE_ACK_TX_PROT_EN_LANE       : 1;	/*      3     r/w   1*/
		uint8_t RESET_CORE_ACK_TX_LANE                   : 1;	/*      4       r   0*/
...
#define reg_PIN_RESET_CORE_ACK_TX_LANE  PM_CTRL_TX_LANE_REG1_LANE.BF.PIN_RESET_CORE_ACK_TX_LANE
#define reg_PIN_RESET_CORE_ACK_TX_PROT_EN_LANE  PM_CTRL_TX_LANE_REG1_LANE.BF.PIN_RESET_CORE_ACK_TX_PROT_EN_LANE
#define reg_RESET_CORE_ACK_TX_LANE  PM_CTRL_TX_LANE_REG1_LANE.BF.RESET_CORE_ACK_TX_LANE
...
typedef union {
	struct {
		uint8_t ANA_TX_TXCLK_NT_EN_LANE                  : 1;	/*      0     r/w   0*/
		uint8_t ANA_TX_TXCLK_4X_EN_LANE                  : 1;	/*      1     r/w   0*/
		uint8_t RESERVED_2                               : 1;	/*      2     r/w   0*/
		uint8_t RESERVED_3                               : 1;	/*      3     r/w   0*/
		uint8_t RESERVED_4                               : 1;	/*      4     r/w   0*/
		uint8_t RESERVED_5                               : 1;	/*      5     r/w   0*/
...
#define reg_ANA_TX_TXCLK_NT_EN_LANE  SPD_CTRL_TX_LANE_REG1_LANE.BF.ANA_TX_TXCLK_NT_EN_LANE
#define reg_ANA_TX_TXCLK_4X_EN_LANE  SPD_CTRL_TX_LANE_REG1_LANE.BF.ANA_TX_TXCLK_4X_EN_LANE
...
typedef union {
	struct {
		...
		uint8_t DTX_INPUT_FROM_REMOTE_LANE               : 1;	/*      4     r/w   0*/
...
#define reg_DTX_INPUT_FROM_REMOTE_LANE  TX_SYSTEM_LANE0.BF.DTX_INPUT_FROM_REMOTE_LANE
...
typedef union {
	struct {
		...
		uint8_t DIG_ID_TRX_LANE_7_0                      : 8;	/*[23:16]       r 8'h11*/
		uint8_t RESERVED_24                              : 1;	/*     24     r/w   0*/
		uint8_t RESERVED_25                              : 1;	/*     25     r/w   0*/
		uint8_t RESERVED_26                              : 1;	/*     26     r/w   0*/
		uint8_t RESERVED_27                              : 1;	/*     27     r/w   0*/
...
#define reg_DIG_ID_TRX_LANE_7_0  ID_LANE_REG1.BF.DIG_ID_TRX_LANE_7_0
...
typedef union {
	struct {
		...
		uint8_t RESERVED_3                               : 1;	/*      3     r/w   0*/
		uint8_t RESERVED_4                               : 1;	/*      4     r/w   0*/
		uint8_t PWRON_SEQ_TX_LANE                        : 1;	/*      5     r/w   1*/
		uint8_t RESERVED_6                               : 1;	/*      6     r/w   0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
		uint8_t RESERVED_8                               : 1;	/*      8     r/w   0*/
		uint8_t RESERVED_9                               : 1;	/*      9     r/w   0*/
...
#define reg_PWRON_SEQ_TX_LANE  PM_PLL_REG1_LANE.BF.PWRON_SEQ_TX_LANE
...
typedef union {
	struct {
		uint8_t RESERVED_0                               : 1;	/*      0     r/w   0*/
		uint8_t RESERVED_1                               : 7;	/* [11:1]     r/w   0*/
		uint8_t RESERVED_8                               : 4;	/* [11:1]     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t FM_TRAIN_TX_MODULATION_FORCE_EN_LANE     : 1;	/*     28     r/w   0*/
		uint8_t FM_TRAIN_TX_MODULATION_FORCE_SEL_LANE_1_0 : 2;	/*[30:29]     r/w 2'b00*/
		uint8_t RESERVED_31                              : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_FM_TRAIN_TX_MODULATION_FORCE_EN_LANE  TX_TRAINING_IF_REG2.BF.FM_TRAIN_TX_MODULATION_FORCE_EN_LANE
#define reg_FM_TRAIN_TX_MODULATION_FORCE_SEL_LANE_1_0  TX_TRAINING_IF_REG2.BF.FM_TRAIN_TX_MODULATION_FORCE_SEL_LANE_1_0
...
typedef union {
	struct {
		...
		uint8_t TX_MUX_DATA_CLK_EN_LANE                  : 1;	/*     18     r/w   0*/
		uint8_t TX_MUX_DATA_CLK_EN_FORCE_LANE            : 1;	/*     19     r/w   0*/
		uint8_t TX_MUX_TRAIN_CLK_EN_LANE                 : 1;	/*     20     r/w   0*/
		uint8_t TX_MUX_TRAIN_CLK_EN_FORCE_LANE           : 1;	/*     21     r/w   0*/
...
#define reg_TX_MUX_DATA_CLK_EN_LANE  TX_GEAR_BOX_REG0.BF.TX_MUX_DATA_CLK_EN_LANE
#define reg_TX_MUX_DATA_CLK_EN_FORCE_LANE  TX_GEAR_BOX_REG0.BF.TX_MUX_DATA_CLK_EN_FORCE_LANE
#define reg_TX_MUX_TRAIN_CLK_EN_LANE  TX_GEAR_BOX_REG0.BF.TX_MUX_TRAIN_CLK_EN_LANE
#define reg_TX_MUX_TRAIN_CLK_EN_FORCE_LANE  TX_GEAR_BOX_REG0.BF.TX_MUX_TRAIN_CLK_EN_FORCE_LANE

// 0x00c4	TX_GEAR_BOX_REG1		
typedef union {
	struct {
		uint8_t TO_ANA_TX_TXCLK_TRAIN_EN_LANE            : 1;	/*      0     r/w   0*/
		uint8_t TX_GB_IDLE_LANE                          : 1;	/*      1     r/w   1*/
		uint8_t TX_DIG_TRAIN_CLK_EN_LANE                 : 1;	/*      2     r/w   0*/
		uint8_t TX_SEL_BITS_SWITCH_LANE                  : 1;	/*      3     r/w   0*/
		uint8_t TX_SEL_BITS_SWITCH_FORCE_LANE            : 1;	/*      4     r/w   0*/
		uint8_t TO_ANA_TX_TXCLK_TRAIN_EN_FORCE_LANE      : 1;	/*      5     r/w   0*/
		uint8_t TX_GB_IDLE_FORCE_LANE                    : 1;	/*      6     r/w   0*/
		uint8_t TX_DIG_TRAIN_CLK_EN_FORCE_LANE           : 1;	/*      7     r/w   0*/
...
#define reg_TX_GB_IDLE_LANE  TX_GEAR_BOX_REG1.BF.TX_GB_IDLE_LANE
#define reg_TX_DIG_TRAIN_CLK_EN_LANE  TX_GEAR_BOX_REG1.BF.TX_DIG_TRAIN_CLK_EN_LANE
#define reg_TX_SEL_BITS_SWITCH_LANE  TX_GEAR_BOX_REG1.BF.TX_SEL_BITS_SWITCH_LANE
#define reg_TX_SEL_BITS_SWITCH_FORCE_LANE  TX_GEAR_BOX_REG1.BF.TX_SEL_BITS_SWITCH_FORCE_LANE
#define reg_TO_ANA_TX_TXCLK_TRAIN_EN_FORCE_LANE  TX_GEAR_BOX_REG1.BF.TO_ANA_TX_TXCLK_TRAIN_EN_FORCE_LANE
#define reg_TX_GB_IDLE_FORCE_LANE  TX_GEAR_BOX_REG1.BF.TX_GB_IDLE_FORCE_LANE
#define reg_TX_DIG_TRAIN_CLK_EN_FORCE_LANE  TX_GEAR_BOX_REG1.BF.TX_DIG_TRAIN_CLK_EN_FORCE_LANE
...
typedef union {
	struct {
		...
		uint8_t TX_TRAIN_CODING_MODE_TX_LANE             : 1;	/*      9     r/w   0*/
		uint8_t TX_TRAIN_CODING_MODE_HW_RST_TX_LANE      : 1;	/*     10     r/w   0*/
		uint8_t RESERVED_11                              : 5;	/*[16:11]     r/w   0*/
		uint8_t RESERVED_16                              : 1;	/*[16:11]     r/w   0*/
...
#define reg_TX_TRAIN_CODING_MODE_TX_LANE  TX_TRAINING_IF_REG5.BF.TX_TRAIN_CODING_MODE_TX_LANE
#define reg_TX_TRAIN_CODING_MODE_HW_RST_TX_LANE  TX_TRAINING_IF_REG5.BF.TX_TRAIN_CODING_MODE_HW_RST_TX_LANE
...
typedef union {
	struct {
		...
		uint8_t FM_TRAIN_TX_PRE_CODE_EN_RD_LANE          : 1;	/*     30       r   0*/
		uint8_t FM_TRAIN_TX_GRAY_CODE_EN_RD_LANE         : 1;	/*     31       r   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_FM_TRAIN_TX_PRE_CODE_EN_RD_LANE  TX_TRAINING_IF_REG6.BF.FM_TRAIN_TX_PRE_CODE_EN_RD_LANE
#define reg_FM_TRAIN_TX_GRAY_CODE_EN_RD_LANE  TX_TRAINING_IF_REG6.BF.FM_TRAIN_TX_GRAY_CODE_EN_RD_LANE
...
__xdata __at( 0x30dc ) volatile TX_PCIE_TRAIN_REG0_t TX_PCIE_TRAIN_REG0;
...
__xdata __at( 0x30e0 ) volatile TX_PCIE_TRAIN_REG1_t TX_PCIE_TRAIN_REG1;
...
// 0x00e4	TRX_SCAN_TEST_FORCE_REGISTER		
typedef union {
	struct {
		uint8_t TRX_SCNTEST_LANE                         : 1;	/*      0     r/w 1'b0*/
	...
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TRX_SCAN_TEST_FORCE_REGISTER_t;
__xdata __at( 0x30e4 ) volatile TRX_SCAN_TEST_FORCE_REGISTER_t TRX_SCAN_TEST_FORCE_REGISTER;
#define reg_TRX_SCNTEST_LANE  TRX_SCAN_TEST_FORCE_REGISTER.BF.TRX_SCNTEST_LANE
