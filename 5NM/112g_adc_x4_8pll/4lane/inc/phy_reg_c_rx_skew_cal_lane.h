...
typedef union {
	struct {
		...
		uint8_t RX_SKEW_CAL_PAUSE_DONE_LANE              : 1;	/*     30       r   0*/
		uint8_t RX_SKEW_CAL_PAUSE_EN_LANE                : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_RX_SKEW_CAL_PAUSE_DONE_LANE  RX_SKEW_CAL_CTRL_2.BF.RX_SKEW_CAL_PAUSE_DONE_LANE
#define reg_RX_SKEW_CAL_PAUSE_EN_LANE  RX_SKEW_CAL_CTRL_2.BF.RX_SKEW_CAL_PAUSE_EN_LANE
...
// 0x0070	RX_SKEW_CAL_CTRL_22		RX Skew Calibration Conbtrol 22
typedef union {
	struct {
		uint8_t RX_SKEW_SKCTRL_DMCLK_TH0_LANE            : 1;	/*      0       r   0*/
		uint8_t RX_SKEW_SKCTRL_DMCLK_TH1_LANE            : 1;	/*      1       r   0*/
		uint8_t RX_SKEW_SKCTRL_DMCLK_TH2_LANE            : 1;	/*      2       r   0*/
		uint8_t RX_SKEW_SKCTRL_DMCLK_TH3_LANE            : 1;	/*      3       r   0*/
		uint8_t RX_SKEW_SKCTRL_DMCLK_TH4_LANE            : 1;	/*      4       r   0*/
		uint8_t RX_SKEW_SKCTRL_DMCLK_TH5_LANE            : 1;	/*      5       r   0*/
		uint8_t RX_SKEW_SKCTRL_DMCLK_TH6_LANE            : 1;	/*      6       r   0*/
		uint8_t RX_SKEW_SKCTRL_DMCLK_TH7_LANE            : 1;	/*      7       r   0*/
		uint8_t RX_SKEW_SKCTRL_DMCLK_EOM_LANE            : 1;	/*      8       r   0*/
		uint8_t RX_SKEW_RD_REQ_LANE                      : 1;	/*      9     r/w   0*/
		uint8_t RESERVED_10                              : 6;	/*[31:10]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/*[31:10]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/*[31:10]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} RX_SKEW_CAL_CTRL_22_t;
__xdata __at( 0x4470 ) volatile RX_SKEW_CAL_CTRL_22_t RX_SKEW_CAL_CTRL_22;
#define reg_RX_SKEW_SKCTRL_DMCLK_TH0_LANE  RX_SKEW_CAL_CTRL_22.BF.RX_SKEW_SKCTRL_DMCLK_TH0_LANE
#define reg_RX_SKEW_SKCTRL_DMCLK_TH1_LANE  RX_SKEW_CAL_CTRL_22.BF.RX_SKEW_SKCTRL_DMCLK_TH1_LANE
#define reg_RX_SKEW_SKCTRL_DMCLK_TH2_LANE  RX_SKEW_CAL_CTRL_22.BF.RX_SKEW_SKCTRL_DMCLK_TH2_LANE
#define reg_RX_SKEW_SKCTRL_DMCLK_TH3_LANE  RX_SKEW_CAL_CTRL_22.BF.RX_SKEW_SKCTRL_DMCLK_TH3_LANE
#define reg_RX_SKEW_SKCTRL_DMCLK_TH4_LANE  RX_SKEW_CAL_CTRL_22.BF.RX_SKEW_SKCTRL_DMCLK_TH4_LANE
#define reg_RX_SKEW_SKCTRL_DMCLK_TH5_LANE  RX_SKEW_CAL_CTRL_22.BF.RX_SKEW_SKCTRL_DMCLK_TH5_LANE
#define reg_RX_SKEW_SKCTRL_DMCLK_TH6_LANE  RX_SKEW_CAL_CTRL_22.BF.RX_SKEW_SKCTRL_DMCLK_TH6_LANE
#define reg_RX_SKEW_SKCTRL_DMCLK_TH7_LANE  RX_SKEW_CAL_CTRL_22.BF.RX_SKEW_SKCTRL_DMCLK_TH7_LANE
#define reg_RX_SKEW_SKCTRL_DMCLK_EOM_LANE  RX_SKEW_CAL_CTRL_22.BF.RX_SKEW_SKCTRL_DMCLK_EOM_LANE
#define reg_RX_SKEW_RD_REQ_LANE  RX_SKEW_CAL_CTRL_22.BF.RX_SKEW_RD_REQ_LANE
