...
typedef union {
	struct {
		...
		uint8_t TXTEMPC_CAL_PASS_LANE                    : 1;	/*     24       r   0*/
...
#define lnx_TXTEMPC_CAL_PASS_LANE  CAL_CTRL3_LANE.BF.TXTEMPC_CAL_PASS_LANE
...
typedef union {
	struct {
		...
		uint8_t RX_TRAIN_BW_GAIN_BYPASS_EN_LANE          : 1;	/*     15     r/w   0*/
...
#define lnx_RX_TRAIN_BW_GAIN_BYPASS_EN_LANE  TRX_TRAINING_TOP_CTRL_0.BF.RX_TRAIN_BW_GAIN_BYPASS_EN_LANE
...
// 0x0048	TRX_TRAINING_TOP_CTRL_4		
typedef union {
	struct {
		uint8_t TRAIN_ABORT_REASON_LANE_1_0              : 2;	/*  [1:0]     r/w 2'h0*/
		uint8_t RESERVED_2                               : 6;	/*  [8:2]     r/w   0*/
		uint8_t RESERVED_8                               : 1;	/*  [8:2]     r/w   0*/
		uint8_t CUR_CONTROLLED_TRIGGERED_LANE            : 1;	/*      9     r/w   0*/
		uint8_t TRX_TRAIN_GAO_BG_EN_LANE                 : 1;	/*     10     r/w   1*/
		uint8_t TRX_TRAIN_END_DTL_PRE1_PST1_FRZ_LANE     : 1;	/*     11     r/w   0*/
		uint8_t DTL_PST1_ZERO_TRIGGERED_LANE             : 1;	/*     12     r/w   0*/
		uint8_t TRX_TRAIN_END_DTL_PST1_SKIP_EN_LANE      : 1;	/*     13     r/w   1*/
		uint8_t RX_TRAIN_GB_FIFO_CLK_TOGGLE_EN_LANE      : 1;	/*     14     r/w   1*/
		uint8_t TRX_TRAIN_CUR_TIA_GC_MAP_FORCE_SPEED_EN_LANE : 1;	/*     15     r/w   0*/
		uint8_t TX_TRAIN_SHAPE_BASED_TRAIN_EN_LANE       : 1;	/*     16     r/w 1'h1*/
		uint8_t TRX_TRAIN_TRX_OPT_FINE_EN_LANE           : 1;	/*     17     r/w 1'h1*/
		uint8_t TRX_TRAIN_DTL_PHASE_OPT_EN_LANE          : 1;	/*     18     r/w 1'b1*/
		uint8_t TRX_TRAIN_DP_PST1_FZ_DFE_EN_LANE         : 1;	/*     19     r/w 1'b1*/
		...
		uint8_t TRX_TRAIN_ADC_CAL_SKEW_EN_LANE           : 1;	/*     30     r/w 1'b1*/
		uint8_t TRX_TRAIN_ADC_CAL_GAO_EN_LANE            : 1;	/*     31     r/w 1'b1*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TRX_TRAINING_TOP_CTRL_4_t;
__xdata __at( 0x6048 ) volatile TRX_TRAINING_TOP_CTRL_4_t TRX_TRAINING_TOP_CTRL_4;
#define lnx_TRAIN_ABORT_REASON_LANE_1_0  TRX_TRAINING_TOP_CTRL_4.BF.TRAIN_ABORT_REASON_LANE_1_0
#define lnx_CUR_CONTROLLED_TRIGGERED_LANE  TRX_TRAINING_TOP_CTRL_4.BF.CUR_CONTROLLED_TRIGGERED_LANE
#define lnx_TRX_TRAIN_GAO_BG_EN_LANE  TRX_TRAINING_TOP_CTRL_4.BF.TRX_TRAIN_GAO_BG_EN_LANE
#define lnx_TRX_TRAIN_END_DTL_PRE1_PST1_FRZ_LANE  TRX_TRAINING_TOP_CTRL_4.BF.TRX_TRAIN_END_DTL_PRE1_PST1_FRZ_LANE
#define lnx_DTL_PST1_ZERO_TRIGGERED_LANE  TRX_TRAINING_TOP_CTRL_4.BF.DTL_PST1_ZERO_TRIGGERED_LANE
#define lnx_TRX_TRAIN_END_DTL_PST1_SKIP_EN_LANE  TRX_TRAINING_TOP_CTRL_4.BF.TRX_TRAIN_END_DTL_PST1_SKIP_EN_LANE
#define lnx_RX_TRAIN_GB_FIFO_CLK_TOGGLE_EN_LANE  TRX_TRAINING_TOP_CTRL_4.BF.RX_TRAIN_GB_FIFO_CLK_TOGGLE_EN_LANE
#define lnx_TRX_TRAIN_CUR_TIA_GC_MAP_FORCE_SPEED_EN_LANE  TRX_TRAINING_TOP_CTRL_4.BF.TRX_TRAIN_CUR_TIA_GC_MAP_FORCE_SPEED_EN_LANE
#define lnx_TX_TRAIN_SHAPE_BASED_TRAIN_EN_LANE  TRX_TRAINING_TOP_CTRL_4.BF.TX_TRAIN_SHAPE_BASED_TRAIN_EN_LANE
#define lnx_TRX_TRAIN_TRX_OPT_FINE_EN_LANE  TRX_TRAINING_TOP_CTRL_4.BF.TRX_TRAIN_TRX_OPT_FINE_EN_LANE
#define lnx_TRX_TRAIN_DTL_PHASE_OPT_EN_LANE  TRX_TRAINING_TOP_CTRL_4.BF.TRX_TRAIN_DTL_PHASE_OPT_EN_LANE
#define lnx_TRX_TRAIN_DP_PST1_FZ_DFE_EN_LANE  TRX_TRAINING_TOP_CTRL_4.BF.TRX_TRAIN_DP_PST1_FZ_DFE_EN_LANE
#define lnx_TRX_TRAIN_AGC_EN_LANE  TRX_TRAINING_TOP_CTRL_4.BF.TRX_TRAIN_AGC_EN_LANE
#define lnx_TRX_TRAIN_FLT_OPT_EN_LANE  TRX_TRAINING_TOP_CTRL_4.BF.TRX_TRAIN_FLT_OPT_EN_LANE
#define lnx_TRX_TRAIN_DFE_OPT_EN_LANE  TRX_TRAINING_TOP_CTRL_4.BF.TRX_TRAIN_DFE_OPT_EN_LANE
#define lnx_TRX_TRAIN_TRX_OPT_EN_LANE  TRX_TRAINING_TOP_CTRL_4.BF.TRX_TRAIN_TRX_OPT_EN_LANE
#define lnx_TX_TRAIN_ONLY_START_LANE  TRX_TRAINING_TOP_CTRL_4.BF.TX_TRAIN_ONLY_START_LANE
#define lnx_TRX_TRAIN_TXFFE_PRESET_EXT_LANE_2_0  TRX_TRAINING_TOP_CTRL_4.BF.TRX_TRAIN_TXFFE_PRESET_EXT_LANE_2_0
#define lnx_TRX_TRAIN_TX_TRAIN_EN_LANE  TRX_TRAINING_TOP_CTRL_4.BF.TRX_TRAIN_TX_TRAIN_EN_LANE
#define lnx_TRX_TRAIN_TXFFE_PRESET_EXT_EN_LANE  TRX_TRAINING_TOP_CTRL_4.BF.TRX_TRAIN_TXFFE_PRESET_EXT_EN_LANE
#define lnx_TRX_TRAIN_ADC_CAL_SKEW_EN_LANE  TRX_TRAINING_TOP_CTRL_4.BF.TRX_TRAIN_ADC_CAL_SKEW_EN_LANE
#define lnx_TRX_TRAIN_ADC_CAL_GAO_EN_LANE  TRX_TRAINING_TOP_CTRL_4.BF.TRX_TRAIN_ADC_CAL_GAO_EN_LANE

// 0x004c	TRAIN_INITIALIZATION		
typedef union {
	struct {
...
__xdata __at( 0x604c ) volatile TRAIN_INITIALIZATION_t TRAIN_INITIALIZATION;
...
typedef union {
	struct {
		...
		uint8_t TX_TRAIN_P2P_HOLD_LANE                   : 1;	/*     21     r/w 1'b1*/
...
__xdata __at( 0x6050 ) volatile TRAIN_CONTROL_t TRAIN_CONTROL;
#define lnx_ESM_PHASE_LANE_9_0_b0  TRAIN_CONTROL.BF.ESM_PHASE_LANE_9_0_b0
#define lnx_ESM_PHASE_LANE_9_0_b1  TRAIN_CONTROL.BF.ESM_PHASE_LANE_9_0_b1
#define lnx_ESM_DFE_ADAPT_SPLR_EN_LANE_3_0  TRAIN_CONTROL.BF.ESM_DFE_ADAPT_SPLR_EN_LANE_3_0
#define lnx_TX_TRAIN_COMPLETE_INT_LANE  TRAIN_CONTROL.BF.TX_TRAIN_COMPLETE_INT_LANE
#define lnx_TX_TRAIN_FAIL_INT_LANE  TRAIN_CONTROL.BF.TX_TRAIN_FAIL_INT_LANE
#define lnx_ESM_PATH_SEL_LANE  TRAIN_CONTROL.BF.ESM_PATH_SEL_LANE
#define lnx_TX_TRAIN_FRAME_LOCK_DET_FAIL_INT_LANE  TRAIN_CONTROL.BF.TX_TRAIN_FRAME_LOCK_DET_FAIL_INT_LANE
#define lnx_ESM_EN_LANE  TRAIN_CONTROL.BF.ESM_EN_LANE
#define lnx_TX_TRAIN_REMOTE_PATTERN_ERROR_INT_LANE  TRAIN_CONTROL.BF.TX_TRAIN_REMOTE_PATTERN_ERROR_INT_LANE
#define lnx_REMOTE_MULTI_RSV_COE_REQ_ERR_INT_LANE  TRAIN_CONTROL.BF.REMOTE_MULTI_RSV_COE_REQ_ERR_INT_LANE
#define lnx_TX_TRAIN_P2P_HOLD_LANE  TRAIN_CONTROL.BF.TX_TRAIN_P2P_HOLD_LANE

// 0x0054	CTLE_TUNE_CONTROL_0		CTLE Tune Control Register 0
typedef union {
	struct {
	...
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CTLE_TUNE_CONTROL_0_t;
__xdata __at( 0x6054 ) volatile CTLE_TUNE_CONTROL_0_t CTLE_TUNE_CONTROL_0;
#define lnx_RX_TRAIN_CTLE_TUNE_RC_SNR_TH_LANE_7_0  CTLE_TUNE_CONTROL_0.BF.RX_TRAIN_CTLE_TUNE_RC_SNR_TH_LANE_7_0
#define lnx_RX_TRAIN_CTLE_TUNE_TIMER_LANE_3_0  CTLE_TUNE_CONTROL_0.BF.RX_TRAIN_CTLE_TUNE_TIMER_LANE_3_0
#define lnx_RX_TRAIN_CTLE_TUNE_R_STEP_UP_LANE_3_0  CTLE_TUNE_CONTROL_0.BF.RX_TRAIN_CTLE_TUNE_R_STEP_UP_LANE_3_0
#define lnx_RX_TRAIN_CTLE_TUNE_CUR_SNR_TH_LANE_7_0  CTLE_TUNE_CONTROL_0.BF.RX_TRAIN_CTLE_TUNE_CUR_SNR_TH_LANE_7_0
#define lnx_RX_TRAIN_CTLE_TUNE_SNR_TH_LANE_7_0  CTLE_TUNE_CONTROL_0.BF.RX_TRAIN_CTLE_TUNE_SNR_TH_LANE_7_0

// 0x0058	CTLE_TUNE_CONTROL_1		CTLE Tune Control Register 1
typedef union {
	struct {
		uint8_t RX_TRAIN_CTLE_TUNE_R_STEP_DN_LANE_3_0    : 4;	/*  [3:0]     r/w 4'h2*/
		uint8_t RESERVED_4                               : 4;	/*  [7:4]     r/w   0*/
		uint8_t RX_TRAIN_CTLE_TUNE_RL1_EXTRA_EN_LANE     : 1;	/*      8     r/w 1'b0*/
		uint8_t RX_TRAIN_CTLE_TUNE_CUR2_EN_LANE          : 1;	/*      9     r/w 1'b0*/
	...
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CTLE_TUNE_CONTROL_1_t;
__xdata __at( 0x6058 ) volatile CTLE_TUNE_CONTROL_1_t CTLE_TUNE_CONTROL_1;
#define lnx_RX_TRAIN_CTLE_TUNE_R_STEP_DN_LANE_3_0  CTLE_TUNE_CONTROL_1.BF.RX_TRAIN_CTLE_TUNE_R_STEP_DN_LANE_3_0
#define lnx_RX_TRAIN_CTLE_TUNE_RL1_EXTRA_EN_LANE  CTLE_TUNE_CONTROL_1.BF.RX_TRAIN_CTLE_TUNE_RL1_EXTRA_EN_LANE
#define lnx_RX_TRAIN_CTLE_TUNE_CUR2_EN_LANE  CTLE_TUNE_CONTROL_1.BF.RX_TRAIN_CTLE_TUNE_CUR2_EN_LANE
...
typedef union {
	struct {
		...
		uint8_t RX_TRAIN_BLIND_MAX_TRIAL_LANE_7_0        : 8;	/*[31:24]     r/w 8'h28*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
// 0x00e0	TX_FFE_PRESET_SELECTION_CTRL_0		
typedef union {
	struct {
		...
		uint8_t TX_TRAIN_DET_PRESET_PHASE_SCAN_EN_LANE   : 1;	/*      7     r/w   1*/
	...
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TX_FFE_PRESET_SELECTION_CTRL_0_t;
__xdata __at( 0x60e0 ) volatile TX_FFE_PRESET_SELECTION_CTRL_0_t TX_FFE_PRESET_SELECTION_CTRL_0;
#define lnx_TX_TRAIN_PRESET_CTLE_COMP_R_STEP_LANE_1_0  TX_FFE_PRESET_SELECTION_CTRL_0.BF.TX_TRAIN_PRESET_CTLE_COMP_R_STEP_LANE_1_0
#define lnx_TX_TRAIN_PRESET_CTLE_COMP_ITER_MAX_LANE_3_0  TX_FFE_PRESET_SELECTION_CTRL_0.BF.TX_TRAIN_PRESET_CTLE_COMP_ITER_MAX_LANE_3_0
#define lnx_TX_TRAIN_PRESET_CTLE_COMP_EN_LANE  TX_FFE_PRESET_SELECTION_CTRL_0.BF.TX_TRAIN_PRESET_CTLE_COMP_EN_LANE
#define lnx_TX_TRAIN_DET_PRESET_PHASE_SCAN_EN_LANE  TX_FFE_PRESET_SELECTION_CTRL_0.BF.TX_TRAIN_DET_PRESET_PHASE_SCAN_EN_LANE
#define lnx_TRX_TRAIN_DTL_HL_RATIO_TH_LANE_7_0  TX_FFE_PRESET_SELECTION_CTRL_0.BF.TRX_TRAIN_DTL_HL_RATIO_TH_LANE_7_0
#define lnx_TRX_TRAIN_FINE_CTLE_TUNE_RC_SNR_TH_LANE_7_0  TX_FFE_PRESET_SELECTION_CTRL_0.BF.TRX_TRAIN_FINE_CTLE_TUNE_RC_SNR_TH_LANE_7_0
#define lnx_TRX_TRAIN_FINE_CTLE_TUNE_C_STEP_LANE_7_0  TX_FFE_PRESET_SELECTION_CTRL_0.BF.TRX_TRAIN_FINE_CTLE_TUNE_C_STEP_LANE_7_0
...
__xdata __at( 0x60fc ) volatile TS_PLL_VCO_AMP_t TS_PLL_VCO_AMP;
...
__xdata __at( 0x6100 ) volatile RS_PLL_VCO_AMP_t RS_PLL_VCO_AMP;
...
// 0x0104	RX_TRAIN_SAT_CHK_CTRL_4		
typedef union {
	struct {
...
__xdata __at( 0x6104 ) volatile RX_TRAIN_SAT_CHK_CTRL_4_t RX_TRAIN_SAT_CHK_CTRL_4;
...
// 0x0108	RX_BLIND_TRAIN_CTRL_2		RX Blind Training Control Register 2
typedef union {
	struct {
		...
		uint8_t RX_TRAIN_BLIND_ADC_SAT_TH2_LANE_15_0_b0  : 8;	/*[31:16]     r/w 16'h7*/
		uint8_t RX_TRAIN_BLIND_ADC_SAT_TH2_LANE_15_0_b1  : 8;	/*[31:16]     r/w 16'h7*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
} RX_BLIND_TRAIN_CTRL_2_t;
__xdata __at( 0x6108 ) volatile RX_BLIND_TRAIN_CTRL_2_t RX_BLIND_TRAIN_CTRL_2;
...
#define lnx_RX_TRAIN_BLIND_ADC_SAT_TH2_LANE_15_0_b0  RX_BLIND_TRAIN_CTRL_2.BF.RX_TRAIN_BLIND_ADC_SAT_TH2_LANE_15_0_b0
#define lnx_RX_TRAIN_BLIND_ADC_SAT_TH2_LANE_15_0_b1  RX_BLIND_TRAIN_CTRL_2.BF.RX_TRAIN_BLIND_ADC_SAT_TH2_LANE_15_0_b1
#define lnx_RX_TRAIN_BLIND_ADC_OVERFLOW_SAT_TH_LANE_15_0  RX_BLIND_TRAIN_CTRL_2.WT.W0
#define lnx_RX_TRAIN_BLIND_ADC_SAT_TH2_LANE_15_0  RX_BLIND_TRAIN_CTRL_2.WT.W1

// 0x010c	RX_BLIND_TRAIN_CTRL_3		RX Blind Training Control Register 3
typedef union {
	struct {
		uint8_t RX_TRAIN_BLIND_ADC_TH2_LANE_5_0          : 6;	/*  [5:0]     r/w 6'h28*/
		uint8_t RESERVED_6                               : 2;	/*  [7:6]     r/w   0*/
		uint8_t RX_TRAIN_BLIND_BEST_CONFIG_EN_LANE       : 1;	/*      8     r/w   1*/
		uint8_t RX_TRAIN_BLIND_ALT_REDUC_ROUTE_EN_LANE   : 1;	/*      9     r/w   0*/
		uint8_t RESERVED_10                              : 6;	/*[31:10]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/*[31:10]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/*[31:10]     r/w   0*/
	} BF;
...
__xdata __at( 0x610c ) volatile RX_BLIND_TRAIN_CTRL_3_t RX_BLIND_TRAIN_CTRL_3;
#define lnx_RX_TRAIN_BLIND_ADC_TH2_LANE_5_0  RX_BLIND_TRAIN_CTRL_3.BF.RX_TRAIN_BLIND_ADC_TH2_LANE_5_0
#define lnx_RX_TRAIN_BLIND_BEST_CONFIG_EN_LANE  RX_BLIND_TRAIN_CTRL_3.BF.RX_TRAIN_BLIND_BEST_CONFIG_EN_LANE
#define lnx_RX_TRAIN_BLIND_ALT_REDUC_ROUTE_EN_LANE  RX_BLIND_TRAIN_CTRL_3.BF.RX_TRAIN_BLIND_ALT_REDUC_ROUTE_EN_LANE

// 0x0110	TRX_TRAINING_TOP_CTRL_5		
typedef union {
	struct {
		uint8_t TRX_TRAIN_DTL_SNR_AF_CDS_TH_LANE_7_0     : 8;	/*  [7:0]     r/w 8'h38*/
		uint8_t CDS_FAULT_TRIGGERED_LANE                 : 1;	/*      8     r/w   0*/
		uint8_t TRX_TRAIN_BLIND_AFTER_BW_GAIN_EN_LANE    : 1;	/*      9     r/w   1*/
		uint8_t RESERVED_10                              : 6;	/*[15:10]     r/w   0*/
		uint8_t TRX_TRAIN_CTLE_RS1_MAX_LANE_3_0          : 4;	/*[19:16]     r/w 4'h8*/
		uint8_t TRX_TRAIN_LR_SR_BW_GAIN_TRAIN_EN_LANE    : 1;	/*     20     r/w   0*/
		uint8_t TRX_TRAIN_FFE_LEN_OPT_EN_LANE            : 1;	/*     21     r/w   0*/
		uint8_t RESERVED_22                              : 2;	/*[31:22]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/*[31:22]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TRX_TRAINING_TOP_CTRL_5_t;
__xdata __at( 0x6110 ) volatile TRX_TRAINING_TOP_CTRL_5_t TRX_TRAINING_TOP_CTRL_5;
#define lnx_TRX_TRAIN_DTL_SNR_AF_CDS_TH_LANE_7_0  TRX_TRAINING_TOP_CTRL_5.BF.TRX_TRAIN_DTL_SNR_AF_CDS_TH_LANE_7_0
#define lnx_CDS_FAULT_TRIGGERED_LANE  TRX_TRAINING_TOP_CTRL_5.BF.CDS_FAULT_TRIGGERED_LANE
#define lnx_TRX_TRAIN_BLIND_AFTER_BW_GAIN_EN_LANE  TRX_TRAINING_TOP_CTRL_5.BF.TRX_TRAIN_BLIND_AFTER_BW_GAIN_EN_LANE
#define lnx_TRX_TRAIN_CTLE_RS1_MAX_LANE_3_0  TRX_TRAINING_TOP_CTRL_5.BF.TRX_TRAIN_CTLE_RS1_MAX_LANE_3_0
#define lnx_TRX_TRAIN_LR_SR_BW_GAIN_TRAIN_EN_LANE  TRX_TRAINING_TOP_CTRL_5.BF.TRX_TRAIN_LR_SR_BW_GAIN_TRAIN_EN_LANE
#define lnx_TRX_TRAIN_FFE_LEN_OPT_EN_LANE  TRX_TRAINING_TOP_CTRL_5.BF.TRX_TRAIN_FFE_LEN_OPT_EN_LANE

// 0x0114	SKEW_PROTECTION_CTRL		Skew Protection Control Registers
typedef union {
	struct {
		uint8_t TRX_TRAIN_DTL_SNR_AF_CAL_TH_LANE_7_0     : 8;	/*  [7:0]     r/w 8'h3c*/
		uint8_t SKEW_PROT_TRIGGERED_LANE_1_0             : 2;	/*  [9:8]     r/w   0*/
		uint8_t RESERVED_10                              : 6;	/*[15:10]     r/w   0*/
		uint8_t TRX_TRAIN_SKEW_PROT_TIMER_LANE_15_0_b0   : 8;	/*[31:16]     r/w 16'h64*/
		uint8_t TRX_TRAIN_SKEW_PROT_TIMER_LANE_15_0_b1   : 8;	/*[31:16]     r/w 16'h64*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
} SKEW_PROTECTION_CTRL_t;
__xdata __at( 0x6114 ) volatile SKEW_PROTECTION_CTRL_t SKEW_PROTECTION_CTRL;
...
#define lnx_TRX_TRAIN_SKEW_PROT_TIMER_LANE_15_0_b0  SKEW_PROTECTION_CTRL.BF.TRX_TRAIN_SKEW_PROT_TIMER_LANE_15_0_b0
#define lnx_TRX_TRAIN_SKEW_PROT_TIMER_LANE_15_0_b1  SKEW_PROTECTION_CTRL.BF.TRX_TRAIN_SKEW_PROT_TIMER_LANE_15_0_b1
#define lnx_TRX_TRAIN_SKEW_PROT_TIMER_LANE_15_0  SKEW_PROTECTION_CTRL.WT.W1

// 0x0118	CAL_CTRL0		Calibration Control
typedef union {
	struct {
...
__xdata __at( 0x6118 ) volatile CAL_CTRL0_t CAL_CTRL0;
...
// 0x011c	CAL_CTRL1		Calibration Control
typedef union {
	struct {
...
__xdata __at( 0x611c ) volatile CAL_CTRL1_t CAL_CTRL1;
...
// 0x0120	TX_FFE_PRESET_SELECTION_CTRL_1		
typedef union {
	struct {
	...
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
} TX_FFE_PRESET_SELECTION_CTRL_1_t;
__xdata __at( 0x6120 ) volatile TX_FFE_PRESET_SELECTION_CTRL_1_t TX_FFE_PRESET_SELECTION_CTRL_1;
#define lnx_TX_TRAIN_DET_PRESET_HP_MULTIPLIER_LANE_4_0  TX_FFE_PRESET_SELECTION_CTRL_1.BF.TX_TRAIN_DET_PRESET_HP_MULTIPLIER_LANE_4_0
#define lnx_TX_TRAIN_DET_PRESET_LP_MULTIPLIER_LANE_4_0  TX_FFE_PRESET_SELECTION_CTRL_1.BF.TX_TRAIN_DET_PRESET_LP_MULTIPLIER_LANE_4_0
#define lnx_TX_TRAIN_DET_PRESET_SCAN_PPM_LANE_15_0_b0  TX_FFE_PRESET_SELECTION_CTRL_1.BF.TX_TRAIN_DET_PRESET_SCAN_PPM_LANE_15_0_b0
#define lnx_TX_TRAIN_DET_PRESET_SCAN_PPM_LANE_15_0_b1  TX_FFE_PRESET_SELECTION_CTRL_1.BF.TX_TRAIN_DET_PRESET_SCAN_PPM_LANE_15_0_b1
#define lnx_TX_TRAIN_DET_PRESET_SCAN_PPM_LANE_15_0  TX_FFE_PRESET_SELECTION_CTRL_1.WT.W1

// 0x0124	TRX_TP_SNR_DTL0		TRX Test Point SNR DTL Register
typedef union {
	struct {
...
__xdata __at( 0x6124 ) volatile TRX_TP_SNR_DTL0_t TRX_TP_SNR_DTL0;
...
// 0x0128	TRX_TP_SNR_DTL1		TRX Test Point SNR DTL Register
typedef union {
	struct {
...
__xdata __at( 0x6128 ) volatile TRX_TP_SNR_DTL1_t TRX_TP_SNR_DTL1;
...
// 0x012c	TRX_TP_SNR_DTL2		TRX Test Point SNR DTL Register
typedef union {
	struct {
...
__xdata __at( 0x612c ) volatile TRX_TP_SNR_DTL2_t TRX_TP_SNR_DTL2;
...
// 0x0130	TRX_TP_SNR_DTL3		TRX Test Point SNR DTL Register
typedef union {
	struct {
...
__xdata __at( 0x6130 ) volatile TRX_TP_SNR_DTL3_t TRX_TP_SNR_DTL3;
...
// 0x0134	TX_TP_DET_PRESET		TRX Test Point Preset Register
typedef union {
	struct {
		uint8_t TX_TRAIN_TP_DET_PRESET_LP_LANE_15_0_b0   : 8;	/* [15:0]     r/w 16'h0*/
		uint8_t TX_TRAIN_TP_DET_PRESET_LP_LANE_15_0_b1   : 8;	/* [15:0]     r/w 16'h0*/
		uint8_t TX_TRAIN_TP_DET_PRESET_HP_LANE_15_0_b0   : 8;	/*[31:16]     r/w 16'h0*/
		uint8_t TX_TRAIN_TP_DET_PRESET_HP_LANE_15_0_b1   : 8;	/*[31:16]     r/w 16'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
} TX_TP_DET_PRESET_t;
__xdata __at( 0x6134 ) volatile TX_TP_DET_PRESET_t TX_TP_DET_PRESET;
#define lnx_TX_TRAIN_TP_DET_PRESET_LP_LANE_15_0_b0  TX_TP_DET_PRESET.BF.TX_TRAIN_TP_DET_PRESET_LP_LANE_15_0_b0
#define lnx_TX_TRAIN_TP_DET_PRESET_LP_LANE_15_0_b1  TX_TP_DET_PRESET.BF.TX_TRAIN_TP_DET_PRESET_LP_LANE_15_0_b1
#define lnx_TX_TRAIN_TP_DET_PRESET_HP_LANE_15_0_b0  TX_TP_DET_PRESET.BF.TX_TRAIN_TP_DET_PRESET_HP_LANE_15_0_b0
#define lnx_TX_TRAIN_TP_DET_PRESET_HP_LANE_15_0_b1  TX_TP_DET_PRESET.BF.TX_TRAIN_TP_DET_PRESET_HP_LANE_15_0_b1
#define lnx_TX_TRAIN_TP_DET_PRESET_LP_LANE_15_0  TX_TP_DET_PRESET.WT.W0
#define lnx_TX_TRAIN_TP_DET_PRESET_HP_LANE_15_0  TX_TP_DET_PRESET.WT.W1

// 0x0138	TRX_TP_TRX_OPT		TRX Test Point Preset Register
typedef union {
	struct {
		uint8_t TRX_TRAIN_TP_TRX_OPT_LP0_LANE_15_0_b0    : 8;	/* [15:0]     r/w 16'h0*/
		uint8_t TRX_TRAIN_TP_TRX_OPT_LP0_LANE_15_0_b1    : 8;	/* [15:0]     r/w 16'h0*/
		uint8_t TRX_TRAIN_TP_TRX_OPT_HP0_LANE_15_0_b0    : 8;	/*[31:16]     r/w 16'h0*/
		uint8_t TRX_TRAIN_TP_TRX_OPT_HP0_LANE_15_0_b1    : 8;	/*[31:16]     r/w 16'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
} TRX_TP_TRX_OPT_t;
__xdata __at( 0x6138 ) volatile TRX_TP_TRX_OPT_t TRX_TP_TRX_OPT;
#define lnx_TRX_TRAIN_TP_TRX_OPT_LP0_LANE_15_0_b0  TRX_TP_TRX_OPT.BF.TRX_TRAIN_TP_TRX_OPT_LP0_LANE_15_0_b0
#define lnx_TRX_TRAIN_TP_TRX_OPT_LP0_LANE_15_0_b1  TRX_TP_TRX_OPT.BF.TRX_TRAIN_TP_TRX_OPT_LP0_LANE_15_0_b1
#define lnx_TRX_TRAIN_TP_TRX_OPT_HP0_LANE_15_0_b0  TRX_TP_TRX_OPT.BF.TRX_TRAIN_TP_TRX_OPT_HP0_LANE_15_0_b0
#define lnx_TRX_TRAIN_TP_TRX_OPT_HP0_LANE_15_0_b1  TRX_TP_TRX_OPT.BF.TRX_TRAIN_TP_TRX_OPT_HP0_LANE_15_0_b1
#define lnx_TRX_TRAIN_TP_TRX_OPT_LP0_LANE_15_0  TRX_TP_TRX_OPT.WT.W0
#define lnx_TRX_TRAIN_TP_TRX_OPT_HP0_LANE_15_0  TRX_TP_TRX_OPT.WT.W1

// 0x013c	TRX_TP_DET_PRESET_TRX_OPT		TRX Test Point  Register
typedef union {
	struct {
		...
		uint8_t TRX_TRAIN_TP_TRX_OPT_TRIGGERED_LANE      : 1;	/*     27     r/w   0*/
		uint8_t TX_TRAIN_TP_DET_PRESET_NUM_LANE_3_0      : 4;	/*[31:28]     r/w 4'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TRX_TP_DET_PRESET_TRX_OPT_t;
__xdata __at( 0x613c ) volatile TRX_TP_DET_PRESET_TRX_OPT_t TRX_TP_DET_PRESET_TRX_OPT;
#define lnx_TRX_TRAIN_TP_TRX_OPT_TRIGGERED_LANE  TRX_TP_DET_PRESET_TRX_OPT.BF.TRX_TRAIN_TP_TRX_OPT_TRIGGERED_LANE
#define lnx_TX_TRAIN_TP_DET_PRESET_NUM_LANE_3_0  TRX_TP_DET_PRESET_TRX_OPT.BF.TX_TRAIN_TP_DET_PRESET_NUM_LANE_3_0

// 0x0140	RX_BW_GAIN_CTRL_0		RX Gain And BW Training Control Register 0
typedef union {
	struct {
		uint8_t RX_TRAIN_SR_BW_GAIN_ADC_SAT_TH_LANE_15_0_b0 : 8;	/* [15:0]     r/w 16'ha28*/
		uint8_t RX_TRAIN_SR_BW_GAIN_ADC_SAT_TH_LANE_15_0_b1 : 8;	/* [15:0]     r/w 16'ha28*/
		uint8_t RX_TRAIN_LR_BW_GAIN_ADC_SAT_TH_LANE_15_0_b0 : 8;	/*[31:16]     r/w 16'h28f*/
		uint8_t RX_TRAIN_LR_BW_GAIN_ADC_SAT_TH_LANE_15_0_b1 : 8;	/*[31:16]     r/w 16'h28f*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
} RX_BW_GAIN_CTRL_0_t;
__xdata __at( 0x6140 ) volatile RX_BW_GAIN_CTRL_0_t RX_BW_GAIN_CTRL_0;
#define lnx_RX_TRAIN_SR_BW_GAIN_ADC_SAT_TH_LANE_15_0_b0  RX_BW_GAIN_CTRL_0.BF.RX_TRAIN_SR_BW_GAIN_ADC_SAT_TH_LANE_15_0_b0
#define lnx_RX_TRAIN_SR_BW_GAIN_ADC_SAT_TH_LANE_15_0_b1  RX_BW_GAIN_CTRL_0.BF.RX_TRAIN_SR_BW_GAIN_ADC_SAT_TH_LANE_15_0_b1
#define lnx_RX_TRAIN_LR_BW_GAIN_ADC_SAT_TH_LANE_15_0_b0  RX_BW_GAIN_CTRL_0.BF.RX_TRAIN_LR_BW_GAIN_ADC_SAT_TH_LANE_15_0_b0
#define lnx_RX_TRAIN_LR_BW_GAIN_ADC_SAT_TH_LANE_15_0_b1  RX_BW_GAIN_CTRL_0.BF.RX_TRAIN_LR_BW_GAIN_ADC_SAT_TH_LANE_15_0_b1
#define lnx_RX_TRAIN_SR_BW_GAIN_ADC_SAT_TH_LANE_15_0  RX_BW_GAIN_CTRL_0.WT.W0
#define lnx_RX_TRAIN_LR_BW_GAIN_ADC_SAT_TH_LANE_15_0  RX_BW_GAIN_CTRL_0.WT.W1

// 0x0144	RX_BW_GAIN_CTRL_1		RX Gain And BW Training Control Register 1
typedef union {
	struct {
		uint8_t RX_TRAIN_LR_SR_BW_GAIN_PHASE_SCAN_PPM_LANE_15_0_b0 : 8;	/* [15:0]     r/w 16'h8000*/
		uint8_t RX_TRAIN_LR_SR_BW_GAIN_PHASE_SCAN_PPM_LANE_15_0_b1 : 8;	/* [15:0]     r/w 16'h8000*/
		uint8_t RX_TRAIN_LR_SR_BW_GAIN_ADC_TH2_LANE_5_0  : 6;	/*[21:16]     r/w 6'h28*/
		uint8_t RESERVED_22                              : 2;	/*[23:22]     r/w   0*/
		uint8_t RX_TRAIN_LR_SR_BW_GAIN_ADC_TH1_LANE_5_0  : 6;	/*[29:24]     r/w 6'h36*/
		uint8_t RESERVED_30                              : 2;	/*[31:30]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
...
__xdata __at( 0x6144 ) volatile RX_BW_GAIN_CTRL_1_t RX_BW_GAIN_CTRL_1;
#define lnx_RX_TRAIN_LR_SR_BW_GAIN_PHASE_SCAN_PPM_LANE_15_0_b0  RX_BW_GAIN_CTRL_1.BF.RX_TRAIN_LR_SR_BW_GAIN_PHASE_SCAN_PPM_LANE_15_0_b0
#define lnx_RX_TRAIN_LR_SR_BW_GAIN_PHASE_SCAN_PPM_LANE_15_0_b1  RX_BW_GAIN_CTRL_1.BF.RX_TRAIN_LR_SR_BW_GAIN_PHASE_SCAN_PPM_LANE_15_0_b1
#define lnx_RX_TRAIN_LR_SR_BW_GAIN_ADC_TH2_LANE_5_0  RX_BW_GAIN_CTRL_1.BF.RX_TRAIN_LR_SR_BW_GAIN_ADC_TH2_LANE_5_0
#define lnx_RX_TRAIN_LR_SR_BW_GAIN_ADC_TH1_LANE_5_0  RX_BW_GAIN_CTRL_1.BF.RX_TRAIN_LR_SR_BW_GAIN_ADC_TH1_LANE_5_0
#define lnx_RX_TRAIN_LR_SR_BW_GAIN_PHASE_SCAN_PPM_LANE_15_0  RX_BW_GAIN_CTRL_1.WT.W0

// 0x0148	RX_BW_GAIN_CTRL_2		RX Gain And BW Training Control Register 2
typedef union {
	struct {
		uint8_t RX_TRAIN_LR_HP_LP_RATION_STEP_LANE_7_0   : 8;	/*  [7:0]     r/w 8'h0d*/
		uint8_t RX_TRAIN_LR_HP_LP_RATION_MAX_LANE_7_0    : 8;	/* [15:8]     r/w 8'he8*/
		uint8_t RX_TRAIN_LR_HP_LP_RATION_MIN_LANE_7_0    : 8;	/*[23:16]     r/w 8'h80*/
		uint8_t RX_TRAIN_SR_BW_CUR2_RED_DELTA_3_0        : 4;	/*[27:24]     r/w 4'h2*/
		uint8_t RX_TRAIN_SR_BW_CUR1_RED_DELTA_3_0        : 4;	/*[31:28]     r/w 4'h2*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} RX_BW_GAIN_CTRL_2_t;
__xdata __at( 0x6148 ) volatile RX_BW_GAIN_CTRL_2_t RX_BW_GAIN_CTRL_2;
#define lnx_RX_TRAIN_LR_HP_LP_RATION_STEP_LANE_7_0  RX_BW_GAIN_CTRL_2.BF.RX_TRAIN_LR_HP_LP_RATION_STEP_LANE_7_0
#define lnx_RX_TRAIN_LR_HP_LP_RATION_MAX_LANE_7_0  RX_BW_GAIN_CTRL_2.BF.RX_TRAIN_LR_HP_LP_RATION_MAX_LANE_7_0
#define lnx_RX_TRAIN_LR_HP_LP_RATION_MIN_LANE_7_0  RX_BW_GAIN_CTRL_2.BF.RX_TRAIN_LR_HP_LP_RATION_MIN_LANE_7_0
#define lnx_RX_TRAIN_SR_BW_CUR2_RED_DELTA_3_0  RX_BW_GAIN_CTRL_2.BF.RX_TRAIN_SR_BW_CUR2_RED_DELTA_3_0
#define lnx_RX_TRAIN_SR_BW_CUR1_RED_DELTA_3_0  RX_BW_GAIN_CTRL_2.BF.RX_TRAIN_SR_BW_CUR1_RED_DELTA_3_0

// 0x014c	RX_BW_GAIN_CTRL_3		RX Gain And BW Training Control Register 3
typedef union {
	struct {
		uint8_t RX_TRAIN_SR_BW_CUR_TIA_RED_DELTA_LANE_3_0 : 4;	/*  [3:0]     r/w 4'h3*/
		uint8_t RX_TRAIN_LR_FORCE_SPEED_EN_LANE          : 1;	/*      4     r/w   0*/
		uint8_t RX_TRAIN_SR_BW_GAIN_TRAIN_EN_LANE        : 1;	/*      5     r/w   1*/
		uint8_t RX_TRAIN_LR_BW_GAIN_TRAIN_EN_LANE        : 1;	/*      6     r/w   1*/
		uint8_t RX_TRAIN_LR_SR_BW_GAIN_PHASE_SCAN_EN_LANE : 1;	/*      7     r/w   1*/
		uint8_t RX_TRAIN_SR_BW_CUR_RED_METHOD_LANE       : 1;	/*      8     r/w   0*/
...
__xdata __at( 0x614c ) volatile RX_BW_GAIN_CTRL_3_t RX_BW_GAIN_CTRL_3;
#define lnx_RX_TRAIN_SR_BW_CUR_TIA_RED_DELTA_LANE_3_0  RX_BW_GAIN_CTRL_3.BF.RX_TRAIN_SR_BW_CUR_TIA_RED_DELTA_LANE_3_0
#define lnx_RX_TRAIN_LR_FORCE_SPEED_EN_LANE  RX_BW_GAIN_CTRL_3.BF.RX_TRAIN_LR_FORCE_SPEED_EN_LANE
#define lnx_RX_TRAIN_SR_BW_GAIN_TRAIN_EN_LANE  RX_BW_GAIN_CTRL_3.BF.RX_TRAIN_SR_BW_GAIN_TRAIN_EN_LANE
#define lnx_RX_TRAIN_LR_BW_GAIN_TRAIN_EN_LANE  RX_BW_GAIN_CTRL_3.BF.RX_TRAIN_LR_BW_GAIN_TRAIN_EN_LANE
#define lnx_RX_TRAIN_LR_SR_BW_GAIN_PHASE_SCAN_EN_LANE  RX_BW_GAIN_CTRL_3.BF.RX_TRAIN_LR_SR_BW_GAIN_PHASE_SCAN_EN_LANE
#define lnx_RX_TRAIN_SR_BW_CUR_RED_METHOD_LANE  RX_BW_GAIN_CTRL_3.BF.RX_TRAIN_SR_BW_CUR_RED_METHOD_LANE

// 0x0150	RX_TP_BW_GAIN		RX Gain And BW Training Debug Register
typedef union {
	struct {
		uint8_t RX_TRAIN_TP_LR_SR_BW_GAIN_LP_LANE_15_0_b0 : 8;	/* [15:0]     r/w 16'h0*/
		uint8_t RX_TRAIN_TP_LR_SR_BW_GAIN_LP_LANE_15_0_b1 : 8;	/* [15:0]     r/w 16'h0*/
		uint8_t RX_TRAIN_TP_LR_SR_BW_GAIN_HP_LANE_15_0_b0 : 8;	/*[31:16]     r/w 16'h0*/
		uint8_t RX_TRAIN_TP_LR_SR_BW_GAIN_HP_LANE_15_0_b1 : 8;	/*[31:16]     r/w 16'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
} RX_TP_BW_GAIN_t;
__xdata __at( 0x6150 ) volatile RX_TP_BW_GAIN_t RX_TP_BW_GAIN;
#define lnx_RX_TRAIN_TP_LR_SR_BW_GAIN_LP_LANE_15_0_b0  RX_TP_BW_GAIN.BF.RX_TRAIN_TP_LR_SR_BW_GAIN_LP_LANE_15_0_b0
#define lnx_RX_TRAIN_TP_LR_SR_BW_GAIN_LP_LANE_15_0_b1  RX_TP_BW_GAIN.BF.RX_TRAIN_TP_LR_SR_BW_GAIN_LP_LANE_15_0_b1
#define lnx_RX_TRAIN_TP_LR_SR_BW_GAIN_HP_LANE_15_0_b0  RX_TP_BW_GAIN.BF.RX_TRAIN_TP_LR_SR_BW_GAIN_HP_LANE_15_0_b0
#define lnx_RX_TRAIN_TP_LR_SR_BW_GAIN_HP_LANE_15_0_b1  RX_TP_BW_GAIN.BF.RX_TRAIN_TP_LR_SR_BW_GAIN_HP_LANE_15_0_b1
#define lnx_RX_TRAIN_TP_LR_SR_BW_GAIN_LP_LANE_15_0  RX_TP_BW_GAIN.WT.W0
#define lnx_RX_TRAIN_TP_LR_SR_BW_GAIN_HP_LANE_15_0  RX_TP_BW_GAIN.WT.W1

// 0x0154	RX_TP_BLIND_BEST_0		RX Blind Training Best Config Pick Debug Register
typedef union {
	struct {
		uint8_t RX_TRAIN_TP_BLIND_BEST_SFT_DCS_LP0_RMS_LANE_15_0_b0 : 8;	/* [15:0]     r/w 16'h0*/
		uint8_t RX_TRAIN_TP_BLIND_BEST_SFT_DCS_LP0_RMS_LANE_15_0_b1 : 8;	/* [15:0]     r/w 16'h0*/
		uint8_t RX_TRAIN_TP_BLIND_BEST_SFT_DCS_HP0_RMS_LANE_15_0_b0 : 8;	/*[31:16]     r/w 16'h0*/
		uint8_t RX_TRAIN_TP_BLIND_BEST_SFT_DCS_HP0_RMS_LANE_15_0_b1 : 8;	/*[31:16]     r/w 16'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
} RX_TP_BLIND_BEST_0_t;
__xdata __at( 0x6154 ) volatile RX_TP_BLIND_BEST_0_t RX_TP_BLIND_BEST_0;
#define lnx_RX_TRAIN_TP_BLIND_BEST_SFT_DCS_LP0_RMS_LANE_15_0_b0  RX_TP_BLIND_BEST_0.BF.RX_TRAIN_TP_BLIND_BEST_SFT_DCS_LP0_RMS_LANE_15_0_b0
#define lnx_RX_TRAIN_TP_BLIND_BEST_SFT_DCS_LP0_RMS_LANE_15_0_b1  RX_TP_BLIND_BEST_0.BF.RX_TRAIN_TP_BLIND_BEST_SFT_DCS_LP0_RMS_LANE_15_0_b1
#define lnx_RX_TRAIN_TP_BLIND_BEST_SFT_DCS_HP0_RMS_LANE_15_0_b0  RX_TP_BLIND_BEST_0.BF.RX_TRAIN_TP_BLIND_BEST_SFT_DCS_HP0_RMS_LANE_15_0_b0
#define lnx_RX_TRAIN_TP_BLIND_BEST_SFT_DCS_HP0_RMS_LANE_15_0_b1  RX_TP_BLIND_BEST_0.BF.RX_TRAIN_TP_BLIND_BEST_SFT_DCS_HP0_RMS_LANE_15_0_b1
#define lnx_RX_TRAIN_TP_BLIND_BEST_SFT_DCS_LP0_RMS_LANE_15_0  RX_TP_BLIND_BEST_0.WT.W0
#define lnx_RX_TRAIN_TP_BLIND_BEST_SFT_DCS_HP0_RMS_LANE_15_0  RX_TP_BLIND_BEST_0.WT.W1

// 0x0158	RX_TP_BLIND_BEST_1		RX Blind Training Best Config Pick Debug Register
typedef union {
	struct {
		uint8_t RX_TRAIN_TP_BLIND_BEST_R_LANE_7_0        : 8;	/*  [7:0]     r/w 8'h0*/
		uint8_t RX_TRAIN_TP_BLIND_BEST_C_LANE_7_0        : 8;	/* [15:8]     r/w 8'h0*/
		uint8_t RX_TRAIN_TP_BLIND_BEST_GC_LANE_7_0       : 8;	/*[23:16]     r/w 8'h0*/
		uint8_t RX_TRAIN_TP_BLIND_BEST_CONFIG_UPDATED_FLAG_LANE : 1;	/*     24     r/w   0*/
		uint8_t RESERVED_25                              : 7;	/*[31:25]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} RX_TP_BLIND_BEST_1_t;
__xdata __at( 0x6158 ) volatile RX_TP_BLIND_BEST_1_t RX_TP_BLIND_BEST_1;
#define lnx_RX_TRAIN_TP_BLIND_BEST_R_LANE_7_0  RX_TP_BLIND_BEST_1.BF.RX_TRAIN_TP_BLIND_BEST_R_LANE_7_0
#define lnx_RX_TRAIN_TP_BLIND_BEST_C_LANE_7_0  RX_TP_BLIND_BEST_1.BF.RX_TRAIN_TP_BLIND_BEST_C_LANE_7_0
#define lnx_RX_TRAIN_TP_BLIND_BEST_GC_LANE_7_0  RX_TP_BLIND_BEST_1.BF.RX_TRAIN_TP_BLIND_BEST_GC_LANE_7_0
#define lnx_RX_TRAIN_TP_BLIND_BEST_CONFIG_UPDATED_FLAG_LANE  RX_TP_BLIND_BEST_1.BF.RX_TRAIN_TP_BLIND_BEST_CONFIG_UPDATED_FLAG_LANE

// 0x015c	TRAIN_INITIALIZATION_1		
typedef union {
	struct {
		uint8_t TRX_TRAIN_BG_AGC_GAIN_INIT_125_LANE_4_0  : 5;	/*  [4:0]     r/w 5'h10*/
		uint8_t RESERVED_5                               : 3;	/*  [7:5]     r/w   0*/
		uint8_t TRX_TRAIN_BG_AGC_GAIN_INIT_M40_LANE_4_0  : 5;	/* [12:8]     r/w 5'h10*/
	...
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TRAIN_INITIALIZATION_1_t;
__xdata __at( 0x615c ) volatile TRAIN_INITIALIZATION_1_t TRAIN_INITIALIZATION_1;
#define lnx_TRX_TRAIN_BG_AGC_GAIN_INIT_125_LANE_4_0  TRAIN_INITIALIZATION_1.BF.TRX_TRAIN_BG_AGC_GAIN_INIT_125_LANE_4_0
#define lnx_TRX_TRAIN_BG_AGC_GAIN_INIT_M40_LANE_4_0  TRAIN_INITIALIZATION_1.BF.TRX_TRAIN_BG_AGC_GAIN_INIT_M40_LANE_4_0

// 0x0160	TRX_PLL_CTRL_LANE		TRX PLL Control Lane
typedef union {
	struct {
...
__xdata __at( 0x6160 ) volatile TRX_PLL_CTRL_LANE_t TRX_PLL_CTRL_LANE;
#define lnx_RX_PLL_RATE_SEL_LANE_4_0  TRX_PLL_CTRL_LANE.BF.RX_PLL_RATE_SEL_LANE_4_0
#define lnx_TX_PLL_RATE_SEL_LANE_4_0  TRX_PLL_CTRL_LANE.BF.TX_PLL_RATE_SEL_LANE_4_0

// 0x0164	TXTRAIN_IF_REG1		
typedef union {
	struct {
		uint8_t TXTRAIN_CTRL_CN3_LANE_1_0                : 2;	/*  [1:0]     r/w 2'h0*/
		uint8_t TXTRAIN_STATUS_CN3_LANE_2_0              : 3;	/*  [4:2]     r/w 3'h0*/
...
__xdata __at( 0x6164 ) volatile TXTRAIN_IF_REG1_t TXTRAIN_IF_REG1;
#define lnx_TXTRAIN_CTRL_CN3_LANE_1_0  TXTRAIN_IF_REG1.BF.TXTRAIN_CTRL_CN3_LANE_1_0
#define lnx_TXTRAIN_STATUS_CN3_LANE_2_0  TXTRAIN_IF_REG1.BF.TXTRAIN_STATUS_CN3_LANE_2_0

// 0x0168	END_XDAT_LANE		
typedef union {
	struct {
...
__xdata __at( 0x6168 ) volatile END_XDAT_LANE_t END_XDAT_LANE;
