...
typedef union {
	struct {
		...
		uint8_t PIN_RESET_CORE_ACK_RX_LANE               : 1;	/*      8     r/w   0*/
		uint8_t PIN_RESET_CORE_ACK_RX_PROT_EN_LANE       : 1;	/*      9     r/w   1*/
		uint8_t RESET_CORE_ACK_RX_LANE                   : 1;	/*     10       r   0*/
		...
		uint8_t PWRON_SEQ_RX_LANE                        : 1;	/*     18     r/w   1*/
...
#define reg_PIN_RESET_CORE_ACK_RX_LANE  PM_CTRL_RX_LANE_REG1_LANE.BF.PIN_RESET_CORE_ACK_RX_LANE
#define reg_PIN_RESET_CORE_ACK_RX_PROT_EN_LANE  PM_CTRL_RX_LANE_REG1_LANE.BF.PIN_RESET_CORE_ACK_RX_PROT_EN_LANE
#define reg_RESET_CORE_ACK_RX_LANE  PM_CTRL_RX_LANE_REG1_LANE.BF.RESET_CORE_ACK_RX_LANE
...
#define reg_PWRON_SEQ_RX_LANE  PM_CTRL_RX_LANE_REG1_LANE.BF.PWRON_SEQ_RX_LANE
...
typedef union {
	struct {
		...
		uint8_t RX_SEL_BITS_RD_LANE_2_0                  : 3;	/*  [6:4]       r   0*/
		uint8_t RESERVED_7                               : 1;	/* [27:7]     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [27:7]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/* [27:7]     r/w   0*/
		uint8_t RESERVED_24                              : 4;	/* [27:7]     r/w   0*/
...
#define reg_RX_SEL_BITS_RD_LANE_2_0  RX_SYSTEM_LANE.BF.RX_SEL_BITS_RD_LANE_2_0
...
#define reg_RX_PAM2_EN_LANE  INPUT_RX_PIN_REG0_LANE.BF.RX_PAM2_EN_LANE
...
typedef union {
	struct {
		uint8_t ANA_RX_RXCLK_NT_EN_LANE                  : 1;	/*      0     r/w   0*/
		uint8_t ANA_RX_RXCLK_4X_EN_LANE                  : 1;	/*      1     r/w   0*/
		uint8_t ANA_RX_RXPLL_CLK_EN_LANE                 : 1;	/*      2     r/w   0*/
...
#define reg_ANA_RX_RXCLK_NT_EN_LANE  SPD_CTRL_RX_LANE_REG1_LANE.BF.ANA_RX_RXCLK_NT_EN_LANE
#define reg_ANA_RX_RXCLK_4X_EN_LANE  SPD_CTRL_RX_LANE_REG1_LANE.BF.ANA_RX_RXCLK_4X_EN_LANE
#define reg_ANA_RX_RXPLL_CLK_EN_LANE  SPD_CTRL_RX_LANE_REG1_LANE.BF.ANA_RX_RXPLL_CLK_EN_LANE
...
typedef union {
	struct {
		...
		uint8_t ANA_ADCCLK_DIV_INV_LANE                  : 1;	/*     28     r/w   1*/
...
#define reg_ANA_ADCCLK_DIV_INV_LANE  CLKGEN_RX_LANE_REG1_LANE.BF.ANA_ADCCLK_DIV_INV_LANE
...
__xdata __at( 0x3234 ) volatile FRAME_SYNC_DET_REG5_t FRAME_SYNC_DET_REG5;
...
__xdata __at( 0x3238 ) volatile FRAME_SYNC_DET_REG6_t FRAME_SYNC_DET_REG6;
...
// 0x003c	RX_SPD_TABLE_LANE		Rx Speed Table Reg
typedef union {
	struct {
		uint8_t RXDATA_LATENCY_REDUCE_EN_LANE            : 1;	/*      0     r/w   0*/
		uint8_t RX_DATA_WIDTH_LANE_1_0                   : 2;	/*  [2:1]     r/w   0*/
		uint8_t RESERVED_3                               : 1;	/*      3     r/w   0*/
		uint8_t RX_ADCCLK_DIV_RATIO_LANE_2_0             : 3;	/*  [6:4]     r/w   0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
		uint8_t RX_RXCLK_DIV_RATIO_LANE_2_0              : 3;	/* [10:8]     r/w   0*/
		uint8_t RESERVED_11                              : 1;	/*     11     r/w   0*/
		uint8_t RX_RXCLK_2X_DIV_RATIO_LANE_2_0           : 3;	/*[14:12]     r/w   0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
		uint8_t RX_RXCLK_4X_DIV_RATIO_LANE_2_0           : 3;	/*[18:16]     r/w   0*/
...
__xdata __at( 0x323c ) volatile RX_SPD_TABLE_LANE_t RX_SPD_TABLE_LANE;
#define reg_RXDATA_LATENCY_REDUCE_EN_LANE  RX_SPD_TABLE_LANE.BF.RXDATA_LATENCY_REDUCE_EN_LANE
#define reg_RX_DATA_WIDTH_LANE_1_0  RX_SPD_TABLE_LANE.BF.RX_DATA_WIDTH_LANE_1_0
#define reg_RX_ADCCLK_DIV_RATIO_LANE_2_0  RX_SPD_TABLE_LANE.BF.RX_ADCCLK_DIV_RATIO_LANE_2_0
#define reg_RX_RXCLK_DIV_RATIO_LANE_2_0  RX_SPD_TABLE_LANE.BF.RX_RXCLK_DIV_RATIO_LANE_2_0
#define reg_RX_RXCLK_2X_DIV_RATIO_LANE_2_0  RX_SPD_TABLE_LANE.BF.RX_RXCLK_2X_DIV_RATIO_LANE_2_0
#define reg_RX_RXCLK_4X_DIV_RATIO_LANE_2_0  RX_SPD_TABLE_LANE.BF.RX_RXCLK_4X_DIV_RATIO_LANE_2_0
...
__xdata __at( 0x3250 ) volatile RX2PLL_REG_t RX2PLL_REG;
...
// 0x0054	RX_LANE_INTERRUPT_REG1		RX Lane Interrupt Clear Register1
typedef union {
	struct {
		uint8_t RESERVED_0                               : 8;	/* [27:0]     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [27:0]     r/w   0*/
...
__xdata __at( 0x3254 ) volatile RX_LANE_INTERRUPT_REG1_t RX_LANE_INTERRUPT_REG1;
...
// 0x0058	INPUT_RX_PIN_REG3_LANE		Input Interface Register For Rx Lane3
typedef union {
	struct {
...
__xdata __at( 0x3258 ) volatile INPUT_RX_PIN_REG3_LANE_t INPUT_RX_PIN_REG3_LANE;

// 0x005c	RX_ANA_RSVD_REG0		Rx Analog Reserved Register0
typedef union {
	struct {
...
__xdata __at( 0x325c ) volatile RX_ANA_RSVD_REG0_t RX_ANA_RSVD_REG0;
...
// 0x0060	SQ_REG0		squelch glitch filter control0
typedef union {
	struct {
...
__xdata __at( 0x3260 ) volatile SQ_REG0_t SQ_REG0;
...
// 0x0064	PHYTEST_RX0		PHYtest Rx Control Register 0
typedef union {
	struct {
...
__xdata __at( 0x3264 ) volatile PHYTEST_RX0_t PHYTEST_RX0;
...
// 0x0068	PHYTEST_RX1		PHYtest Rx Control Register 1
typedef union {
	struct {
...
__xdata __at( 0x3268 ) volatile PHYTEST_RX1_t PHYTEST_RX1;
...
// 0x006c	PHYTEST_RX2		PHYtest Rx Control Register 2
typedef union {
	struct {
...
__xdata __at( 0x326c ) volatile PHYTEST_RX2_t PHYTEST_RX2;
...
// 0x0070	PHYTEST_RX3		PHYtest Rx Control Register 3
typedef union {
	struct {
...
__xdata __at( 0x3270 ) volatile PHYTEST_RX3_t PHYTEST_RX3;
...
// 0x0074	PHYTEST_RX4		PHYtest Rx Control Register 4
typedef union {
	struct {
		uint8_t RESERVED_0                               : 8;	/* [15:0]     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [15:0]     r/w   0*/
...
__xdata __at( 0x3274 ) volatile PHYTEST_RX4_t PHYTEST_RX4;
...
// 0x0078	PHYTEST_RX5		PHYtest Rx Control Register 5
typedef union {
	struct {
...
__xdata __at( 0x3278 ) volatile PHYTEST_RX5_t PHYTEST_RX5;
...
// 0x007c	PHYTEST_RX6		PHYtest Rx Control Register 6
typedef union {
	struct {
		uint8_t RESERVED_0                               : 8;	/* [15:0]     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [15:0]     r/w   0*/
...
__xdata __at( 0x327c ) volatile PHYTEST_RX6_t PHYTEST_RX6;
...
// 0x0080	PHYTEST_RX7		PHYtest Rx Control Register 7
typedef union {
	struct {
...
__xdata __at( 0x3280 ) volatile PHYTEST_RX7_t PHYTEST_RX7;
...
// 0x0084	PHYTEST_RX8		PHYtest Rx Control Register 8
typedef union {
	struct {
		uint8_t RESERVED_0                               : 8;	/* [15:0]     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [15:0]     r/w   0*/
...
__xdata __at( 0x3284 ) volatile PHYTEST_RX8_t PHYTEST_RX8;
...
// 0x0088	PHYTEST_RX9		PHYtest Rx Control Register 9
typedef union {
	struct {
...
__xdata __at( 0x3288 ) volatile PHYTEST_RX9_t PHYTEST_RX9;
...
// 0x008c	SQ_REG1		squelch glitch filter control1
typedef union {
	struct {
		...
		uint8_t PIN_SQ_DET_LPF_FORCE_LANE                : 1;	/*     26     r/w   1*/
		uint8_t PIN_SQ_DET_LPF_SEL_LANE_1_0              : 2;	/*[28:27]     r/w   0*/
		uint8_t PIN_SQ_DET_FORCE_LANE                    : 1;	/*     29     r/w   1*/
		uint8_t PIN_SQ_DET_SEL_LANE_1_0                  : 2;	/*[31:30]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} SQ_REG1_t;
__xdata __at( 0x328c ) volatile SQ_REG1_t SQ_REG1;
#define reg_PIN_SQ_DET_LPF_FORCE_LANE  SQ_REG1.BF.PIN_SQ_DET_LPF_FORCE_LANE
#define reg_PIN_SQ_DET_LPF_SEL_LANE_1_0  SQ_REG1.BF.PIN_SQ_DET_LPF_SEL_LANE_1_0
#define reg_PIN_SQ_DET_FORCE_LANE  SQ_REG1.BF.PIN_SQ_DET_FORCE_LANE
#define reg_PIN_SQ_DET_SEL_LANE_1_0  SQ_REG1.BF.PIN_SQ_DET_SEL_LANE_1_0

// 0x0090	RX_DP_GB_CTRL_REG0		Rx Data Path Gearbox Control Register 0
typedef union {
	struct {
		uint8_t ANA_RX_SEL_BITS_LANE                     : 1;	/*      0     r/w   0*/
		uint8_t ANA_RX_SEL_BITS_FORCE_LANE               : 1;	/*      1     r/w   0*/
		uint8_t ANA_RX_RXCLK_EN_LANE                     : 1;	/*      2     r/w   0*/
		uint8_t ANA_RX_RXCLK_EN_FORCE_LANE               : 1;	/*      3     r/w   0*/
		uint8_t RX_GB_IDLE_LANE                          : 1;	/*      4     r/w   1*/
		uint8_t RX_GB_IDLE_FORCE_LANE                    : 1;	/*      5     r/w   0*/
		uint8_t RX_MUX_CLK_SEL_LANE                      : 1;	/*      6     r/w   0*/
		uint8_t RX_MUX_CLK_SEL_FORCE_LANE                : 1;	/*      7     r/w   0*/
		uint8_t RX_DIG_TRAIN_CLK_EN_LANE                 : 1;	/*      8     r/w   0*/
		uint8_t RX_DIG_TRAIN_CLK_EN_FORCE_LANE           : 1;	/*      9     r/w   0*/
		...
		uint8_t RX_GB1_FIFO_PTR_VALID_LANE               : 1;	/*     21     r/w   0*/
		...
		uint8_t GB1_FIFO_EN_LANE                         : 1;	/*     27     r/w   0*/
		uint8_t GB1_FIFO_EN_FORCE_LANE                   : 1;	/*     28     r/w   0*/
		uint8_t ADCCLK_DIV_SEL_LANE                      : 1;	/*     29     r/w   0*/
		uint8_t ADCCLK_DIV_SEL_FORCE_LANE                : 1;	/*     30     r/w   0*/
		uint8_t TRAIN_RXCLK_SWITCH_EN_LANE               : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} RX_DP_GB_CTRL_REG0_t;
__xdata __at( 0x3290 ) volatile RX_DP_GB_CTRL_REG0_t RX_DP_GB_CTRL_REG0;
...
#define reg_ANA_RX_RXCLK_EN_LANE  RX_DP_GB_CTRL_REG0.BF.ANA_RX_RXCLK_EN_LANE
#define reg_ANA_RX_RXCLK_EN_FORCE_LANE  RX_DP_GB_CTRL_REG0.BF.ANA_RX_RXCLK_EN_FORCE_LANE
#define reg_RX_GB_IDLE_LANE  RX_DP_GB_CTRL_REG0.BF.RX_GB_IDLE_LANE
#define reg_RX_GB_IDLE_FORCE_LANE  RX_DP_GB_CTRL_REG0.BF.RX_GB_IDLE_FORCE_LANE
...
#define reg_RX_DIG_TRAIN_CLK_EN_LANE  RX_DP_GB_CTRL_REG0.BF.RX_DIG_TRAIN_CLK_EN_LANE
#define reg_RX_DIG_TRAIN_CLK_EN_FORCE_LANE  RX_DP_GB_CTRL_REG0.BF.RX_DIG_TRAIN_CLK_EN_FORCE_LANE
...
#define reg_RX_GB1_FIFO_PTR_VALID_LANE  RX_DP_GB_CTRL_REG0.BF.RX_GB1_FIFO_PTR_VALID_LANE
...
#define reg_GB1_FIFO_EN_LANE  RX_DP_GB_CTRL_REG0.BF.GB1_FIFO_EN_LANE
#define reg_GB1_FIFO_EN_FORCE_LANE  RX_DP_GB_CTRL_REG0.BF.GB1_FIFO_EN_FORCE_LANE
#define reg_ADCCLK_DIV_SEL_LANE  RX_DP_GB_CTRL_REG0.BF.ADCCLK_DIV_SEL_LANE
#define reg_ADCCLK_DIV_SEL_FORCE_LANE  RX_DP_GB_CTRL_REG0.BF.ADCCLK_DIV_SEL_FORCE_LANE
#define reg_TRAIN_RXCLK_SWITCH_EN_LANE  RX_DP_GB_CTRL_REG0.BF.TRAIN_RXCLK_SWITCH_EN_LANE

// 0x0094	RX_DP_GB_CTRL_REG1		Rx Data Path Gearbox Control Register 1
typedef union {
	struct {
		uint8_t RESERVED_0                               : 3;	/*  [2:0]     r/w   0*/
		uint8_t RX_SEL_BITS_SWITCH_LANE                  : 1;	/*      3     r/w   0*/
		uint8_t RX_SEL_BITS_SWITCH_FORCE_LANE            : 1;	/*      4     r/w   0*/
		uint8_t RX_MUX_DATA_CLK_EN_LANE                  : 1;	/*      5     r/w   0*/
		uint8_t RX_MUX_DATA_CLK_EN_FORCE_LANE            : 1;	/*      6     r/w   0*/
		uint8_t RX_MUX_TRAIN_CLK_EN_LANE                 : 1;	/*      7     r/w   0*/
		uint8_t RX_MUX_TRAIN_CLK_EN_FORCE_LANE           : 1;	/*      8     r/w   0*/
		uint8_t RX_GB1_FIFO_WR_PTR_LANE_6_0              : 7;	/* [15:9]       r   0*/
		uint8_t RESERVED_16                              : 2;	/*[17:16]     r/w   0*/
		uint8_t RX_GB1_FIFO_RD_PTR_LANE_2_0              : 3;	/*[20:18]       r   0*/
		...
		uint8_t RX_GB_DIV_ADCCLK_EN_LANE                 : 1;	/*     25     r/w   1*/
		uint8_t RX_GB_DIV_ADCCLK_ON_LANE                 : 1;	/*     26     r/w   0*/
...
__xdata __at( 0x3294 ) volatile RX_DP_GB_CTRL_REG1_t RX_DP_GB_CTRL_REG1;
#define reg_RX_SEL_BITS_SWITCH_LANE  RX_DP_GB_CTRL_REG1.BF.RX_SEL_BITS_SWITCH_LANE
#define reg_RX_SEL_BITS_SWITCH_FORCE_LANE  RX_DP_GB_CTRL_REG1.BF.RX_SEL_BITS_SWITCH_FORCE_LANE
#define reg_RX_MUX_DATA_CLK_EN_LANE  RX_DP_GB_CTRL_REG1.BF.RX_MUX_DATA_CLK_EN_LANE
#define reg_RX_MUX_DATA_CLK_EN_FORCE_LANE  RX_DP_GB_CTRL_REG1.BF.RX_MUX_DATA_CLK_EN_FORCE_LANE
#define reg_RX_MUX_TRAIN_CLK_EN_LANE  RX_DP_GB_CTRL_REG1.BF.RX_MUX_TRAIN_CLK_EN_LANE
#define reg_RX_MUX_TRAIN_CLK_EN_FORCE_LANE  RX_DP_GB_CTRL_REG1.BF.RX_MUX_TRAIN_CLK_EN_FORCE_LANE
#define reg_RX_GB1_FIFO_WR_PTR_LANE_6_0  RX_DP_GB_CTRL_REG1.BF.RX_GB1_FIFO_WR_PTR_LANE_6_0
#define reg_RX_GB1_FIFO_RD_PTR_LANE_2_0  RX_DP_GB_CTRL_REG1.BF.RX_GB1_FIFO_RD_PTR_LANE_2_0
...
#define reg_RX_GB_DIV_ADCCLK_EN_LANE  RX_DP_GB_CTRL_REG1.BF.RX_GB_DIV_ADCCLK_EN_LANE
#define reg_RX_GB_DIV_ADCCLK_ON_LANE  RX_DP_GB_CTRL_REG1.BF.RX_GB_DIV_ADCCLK_ON_LANE
...
// 0x0098	RX_FEC_HIST_CTRL_REG0		Rx FEC Corrupted Symbol Histogram Control Register 0
typedef union {
	struct {
...
__xdata __at( 0x3298 ) volatile RX_FEC_HIST_CTRL_REG0_t RX_FEC_HIST_CTRL_REG0;
...
// 0x009c	RX_FEC_HIST_RSLT_REG0		Rx FEC Corrupted Symbol Histogram Results Register 0
typedef union {
	struct {
...
__xdata __at( 0x329c ) volatile RX_FEC_HIST_RSLT_REG0_t RX_FEC_HIST_RSLT_REG0;
...
// 0x00a0	RX_FEC_HIST_RSLT_REG1		Rx FEC Corrupted Symbol Histogram Results Register 1
typedef union {
	struct {
...
__xdata __at( 0x32a0 ) volatile RX_FEC_HIST_RSLT_REG1_t RX_FEC_HIST_RSLT_REG1;
...
// 0x00a4	RX_FEC_HIST_RSLT_REG2		Rx FEC Corrupted Symbol Histogram Results Register 2
typedef union {
	struct {
...
__xdata __at( 0x32a4 ) volatile RX_FEC_HIST_RSLT_REG2_t RX_FEC_HIST_RSLT_REG2;
...
// 0x00a8	RX_FEC_HIST_RSLT_REG3		Rx FEC Corrupted Symbol Histogram Results Register 3
typedef union {
	struct {
...
__xdata __at( 0x32a8 ) volatile RX_FEC_HIST_RSLT_REG3_t RX_FEC_HIST_RSLT_REG3;
...
// 0x00ac	RX_FEC_HIST_RSLT_REG4		Rx FEC Corrupted Symbol Histogram Results Register 4
typedef union {
	struct {
...
__xdata __at( 0x32ac ) volatile RX_FEC_HIST_RSLT_REG4_t RX_FEC_HIST_RSLT_REG4;
...
// 0x00b0	RX_FEC_HIST_RSLT_REG5		Rx FEC Corrupted Symbol Histogram Results Register 5
typedef union {
	struct {
...
__xdata __at( 0x32b0 ) volatile RX_FEC_HIST_RSLT_REG5_t RX_FEC_HIST_RSLT_REG5;
...
// 0x00b4	RX_FEC_HIST_RSLT_REG6		Rx FEC Corrupted Symbol Histogram Results Register 6
typedef union {
	struct {
...
__xdata __at( 0x32b4 ) volatile RX_FEC_HIST_RSLT_REG6_t RX_FEC_HIST_RSLT_REG6;
...
// 0x00b8	RX_FEC_HIST_RSLT_REG7		Rx FEC Corrupted Symbol Histogram Results Register 7
typedef union {
	struct {
...
__xdata __at( 0x32b8 ) volatile RX_FEC_HIST_RSLT_REG7_t RX_FEC_HIST_RSLT_REG7;
...
// 0x00bc	RX_FEC_HIST_RSLT_REG8		Rx FEC Corrupted Symbol Histogram Results Register 8
typedef union {
	struct {
...
__xdata __at( 0x32bc ) volatile RX_FEC_HIST_RSLT_REG8_t RX_FEC_HIST_RSLT_REG8;
...
// 0x00c0	RX_FEC_HIST_RSLT_REG9		Rx FEC Corrupted Symbol Histogram Results Register 9
typedef union {
	struct {
...
__xdata __at( 0x32c0 ) volatile RX_FEC_HIST_RSLT_REG9_t RX_FEC_HIST_RSLT_REG9;
...
// 0x00c4	RX_FEC_HIST_RSLT_REG10		Rx FEC Corrupted Symbol Histogram Results Register 10
typedef union {
	struct {
...
__xdata __at( 0x32c4 ) volatile RX_FEC_HIST_RSLT_REG10_t RX_FEC_HIST_RSLT_REG10;
...
// 0x00c8	RX_FEC_HIST_RSLT_REG11		Rx FEC Corrupted Symbol Histogram Results Register 11
typedef union {
	struct {
...
__xdata __at( 0x32c8 ) volatile RX_FEC_HIST_RSLT_REG11_t RX_FEC_HIST_RSLT_REG11;
...
// 0x00cc	RX_FEC_HIST_RSLT_REG12		Rx FEC Corrupted Symbol Histogram Results Register 12
typedef union {
	struct {
...
__xdata __at( 0x32cc ) volatile RX_FEC_HIST_RSLT_REG12_t RX_FEC_HIST_RSLT_REG12;
...
// 0x00d0	RX_FEC_HIST_RSLT_REG13		Rx FEC Corrupted Symbol Histogram Results Register 13
typedef union {
	struct {
...
__xdata __at( 0x32d0 ) volatile RX_FEC_HIST_RSLT_REG13_t RX_FEC_HIST_RSLT_REG13;
...
// 0x00d4	RX_FEC_HIST_RSLT_REG14		Rx FEC Corrupted Symbol Histogram Results Register 14
typedef union {
	struct {
...
__xdata __at( 0x32d4 ) volatile RX_FEC_HIST_RSLT_REG14_t RX_FEC_HIST_RSLT_REG14;
...
// 0x00d8	RX_FEC_HIST_RSLT_REG15		Rx FEC Corrupted Symbol Histogram Results Register 15
typedef union {
	struct {
...
__xdata __at( 0x32d8 ) volatile RX_FEC_HIST_RSLT_REG15_t RX_FEC_HIST_RSLT_REG15;
...
// 0x00dc	RX_FEC_HIST_RSLT_REG16		Rx FEC Corrupted Symbol Histogram Results Register 16
typedef union {
	struct {
...
__xdata __at( 0x32dc ) volatile RX_FEC_HIST_RSLT_REG16_t RX_FEC_HIST_RSLT_REG16;
...
// 0x00e0	RX_FEC_HIST_RSLT_REG17		Rx FEC Corrupted Symbol Histogram Results Register 17
typedef union {
	struct {
...
__xdata __at( 0x32e0 ) volatile RX_FEC_HIST_RSLT_REG17_t RX_FEC_HIST_RSLT_REG17;
...
// 0x00e4	RX_FEC_HIST_RSLT_REG18		Rx FEC Corrupted Symbol Histogram Results Register 18
typedef union {
	struct {
...
__xdata __at( 0x32e4 ) volatile RX_FEC_HIST_RSLT_REG18_t RX_FEC_HIST_RSLT_REG18;
...
// 0x00e8	RX_FEC_HIST_RSLT_REG19		Rx FEC Corrupted Symbol Histogram Results Register 19
typedef union {
	struct {
...
__xdata __at( 0x32e8 ) volatile RX_FEC_HIST_RSLT_REG19_t RX_FEC_HIST_RSLT_REG19;
...
// 0x00ec	RX_FEC_HIST_RSLT_REG20		Rx FEC Corrupted Symbol Histogram Results Register 20
typedef union {
	struct {
...
__xdata __at( 0x32ec ) volatile RX_FEC_HIST_RSLT_REG20_t RX_FEC_HIST_RSLT_REG20;
...
// 0x00f0	RX_FEC_HIST_RSLT_REG21		Rx FEC Corrupted Symbol Histogram Results Register 21
typedef union {
	struct {
...
__xdata __at( 0x32f0 ) volatile RX_FEC_HIST_RSLT_REG21_t RX_FEC_HIST_RSLT_REG21;
...
// 0x00f4	RX_FEC_HIST_RSLT_REG22		Rx FEC Corrupted Symbol Histogram Results Register 22
typedef union {
	struct {
...
__xdata __at( 0x32f4 ) volatile RX_FEC_HIST_RSLT_REG22_t RX_FEC_HIST_RSLT_REG22;
...
// 0x00f8	RX_FEC_HIST_RSLT_REG23		Rx FEC Corrupted Symbol Histogram Results Register 23
typedef union {
	struct {
...
__xdata __at( 0x32f8 ) volatile RX_FEC_HIST_RSLT_REG23_t RX_FEC_HIST_RSLT_REG23;
...
// 0x00fc	RX_FEC_HIST_RSLT_REG24		Rx FEC Corrupted Symbol Histogram Results Register 24
typedef union {
	struct {
...
__xdata __at( 0x32fc ) volatile RX_FEC_HIST_RSLT_REG24_t RX_FEC_HIST_RSLT_REG24;
...
// 0x0100	RX_FEC_HIST_RSLT_REG25		Rx FEC Corrupted Symbol Histogram Results Register 25
typedef union {
	struct {
...
__xdata __at( 0x3300 ) volatile RX_FEC_HIST_RSLT_REG25_t RX_FEC_HIST_RSLT_REG25;
...
// 0x0104	RX_FEC_HIST_RSLT_REG26		Rx FEC Corrupted Symbol Histogram Results Register 26
typedef union {
	struct {
...
__xdata __at( 0x3304 ) volatile RX_FEC_HIST_RSLT_REG26_t RX_FEC_HIST_RSLT_REG26;
...
// 0x0108	RX_FEC_HIST_RSLT_REG27		Rx FEC Corrupted Symbol Histogram Results Register 27
typedef union {
	struct {
...
__xdata __at( 0x3308 ) volatile RX_FEC_HIST_RSLT_REG27_t RX_FEC_HIST_RSLT_REG27;
...
// 0x010c	RX_FEC_HIST_RSLT_REG28		Rx FEC Corrupted Symbol Histogram Results Register 28
typedef union {
	struct {
...
__xdata __at( 0x330c ) volatile RX_FEC_HIST_RSLT_REG28_t RX_FEC_HIST_RSLT_REG28;
...
// 0x0110	RX_FEC_HIST_RSLT_REG29		Rx FEC Corrupted Symbol Histogram Results Register 29
typedef union {
	struct {
...
__xdata __at( 0x3310 ) volatile RX_FEC_HIST_RSLT_REG29_t RX_FEC_HIST_RSLT_REG29;
...
// 0x0114	RX_FEC_HIST_RSLT_REG30		Rx FEC Corrupted Symbol Histogram Results Register 30
typedef union {
	struct {
...
__xdata __at( 0x3314 ) volatile RX_FEC_HIST_RSLT_REG30_t RX_FEC_HIST_RSLT_REG30;
...
// 0x0118	RX_FEC_HIST_RSLT_REG31		Rx FEC Corrupted Symbol Histogram Results Register 31
typedef union {
	struct {
...
__xdata __at( 0x3318 ) volatile RX_FEC_HIST_RSLT_REG31_t RX_FEC_HIST_RSLT_REG31;
...
// 0x011c	RX_FEC_HIST_RSLT_REG32		Rx FEC Corrupted Symbol Histogram Results Register 32
typedef union {
	struct {
...
__xdata __at( 0x331c ) volatile RX_FEC_HIST_RSLT_REG32_t RX_FEC_HIST_RSLT_REG32;
...
// 0x0120	RX_FEC_HIST_RSLT_REG33		Rx FEC Corrupted Symbol Histogram Results Register 33
typedef union {
	struct {
...
__xdata __at( 0x3320 ) volatile RX_FEC_HIST_RSLT_REG33_t RX_FEC_HIST_RSLT_REG33;
...
// 0x0124	RX_FEC_HIST_RSLT_REG34		Rx FEC Corrupted Symbol Histogram Results Register 34
typedef union {
	struct {
...
__xdata __at( 0x3324 ) volatile RX_FEC_HIST_RSLT_REG34_t RX_FEC_HIST_RSLT_REG34;
