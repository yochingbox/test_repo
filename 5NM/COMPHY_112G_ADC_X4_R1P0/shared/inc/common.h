...
#define TRAIN_INIT_EN           0x0001
#define INIT_ADC_SAT_CHECK_EN   0x0002
#define SET_TX_MOD_EN           0x0004
#define RX_BLIND_TRAIN_EN1      0x0008
#define TXFFE_DET_PRESET_EN     0x0010
#define LOCK_CDR_EN1            0x0020
#define ADC_CAL_EN              0x0040
#define SWEEP_COARSE_CTLE_EN    0x0080
#define TXFFE_SET_PRESET_EN     0x0100
#define RX_BLIND_TRAIN_EN2      0x0200
#define LOCK_CDR_EN2            0x0400
#define TXFFE_SHAPE_BASE_EN     0x0800
#define TRX_OPT_EN              0x1000
#define TRX_OPT_FINE_EN         0x2000
#define RX_CTLE_TUNE            0x4000
#define TRX_FINAL_TUNE          0x8000
#define TRAIN_EXIT              0x10000 
#define MAX_TRAIN_MODULE 17

#define TX_TRAIN_OPS 0x1ff7f //0000 0000 0000 0001 1111 1111 0111 1111
#define RX_TRAIN_OPS 0x1d06b //0000 0000 0000 0001 1101 0000 0110 1011
