...
typedef union {
	struct {
		...
		uint8_t RESERVED_29                              : 1;	/*     29     r/w   0*/
		uint8_t RESERVED_30                              : 1;	/*     30     r/w   0*/
		uint8_t TRAIN_PIN_FORCE_ERR_EN_LANE              : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TX_TRAIN_IF_REG1_t;
...
#define reg_TRAIN_PIN_FORCE_ERR_EN_LANE  TX_TRAIN_IF_REG1.BF.TRAIN_PIN_FORCE_ERR_EN_LANE
...
typedef union {
	struct {
		...
		uint8_t PCIE_MODE_LANE                           : 1;	/*      5     r/w   0*/
