...
typedef union {
	struct {
		...
		uint8_t TX_IMP_N_CAL_CMP_CTRL_LANE_3_0           : 4;	/*  [5:2]     r/w 4'h8*/
...
typedef union {
	struct {
		...
		uint8_t TX_IMP_P_CAL_CMP_CTRL_LANE_3_0           : 4;	/*  [5:2]     r/w 4'h8*/
...
typedef union {
	struct {
		...
		uint8_t TX_IMP_ICCP_CAL_CMP_CTRL_LANE_3_0        : 4;	/*  [5:2]     r/w 4'h8*/
...
typedef union {
	struct {
		...
		uint8_t TX_IMP_ICCN_CAL_CMP_CTRL_LANE_3_0        : 4;	/*  [5:2]     r/w 4'h8*/
...
typedef union {
	struct {
		...
		uint8_t TX_IMP_TEMPC_PCAL_CMP_CTRL_LANE_3_0      : 4;	/*  [7:4]     r/w 4'h8*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
typedef union {
	struct {
		...
		uint8_t TX_IMP_TEMPC_NCAL_CMP_CTRL_LANE_3_0      : 4;	/*  [7:4]     r/w 4'h8*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
