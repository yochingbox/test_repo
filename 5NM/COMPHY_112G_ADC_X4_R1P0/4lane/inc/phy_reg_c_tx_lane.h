...
typedef union {
	struct {
		...
		uint8_t TX_RESET_ANA_LANE                        : 1;	/*     23     r/w   1*/
...
#define reg_TX_RESET_ANA_LANE  PM_CTRL_TX_LANE_REG1_LANE.BF.TX_RESET_ANA_LANE
...
typedef union {
	struct {
		...
		uint8_t TX_MAIN_CLK_RST_LANE                     : 1;	/*     18     r/w   0*/
		uint8_t TX_MAIN_CLK_EN_LANE                      : 1;	/*     19     r/w   1*/
		uint8_t TX_MAIN_CLK_ON_LANE                      : 1;	/*     20     r/w   0*/
		uint8_t TX_CLK_EN_LANE                           : 1;	/*     21     r/w   0*/
		uint8_t ANA_TX_TXCLK_SYNC_EN_LANE                : 1;	/*     22     r/w   0*/
		uint8_t ANA_TX_TXCLK_SYNC_EN_FORCE_LANE          : 1;	/*     23     r/w   0*/
		uint8_t ALIGN_FM_INT_LANE                        : 1;	/*     24     r/w   1*/
		uint8_t ALIGN_EXT_FM_SIDE_A_LANE                 : 1;	/*     25     r/w   0*/
...
#define reg_TX_MAIN_CLK_RST_LANE  PM_CTRL_TX_LANE_REG2_LANE.BF.TX_MAIN_CLK_RST_LANE
#define reg_TX_MAIN_CLK_EN_LANE  PM_CTRL_TX_LANE_REG2_LANE.BF.TX_MAIN_CLK_EN_LANE
#define reg_TX_MAIN_CLK_ON_LANE  PM_CTRL_TX_LANE_REG2_LANE.BF.TX_MAIN_CLK_ON_LANE
#define reg_TX_CLK_EN_LANE  PM_CTRL_TX_LANE_REG2_LANE.BF.TX_CLK_EN_LANE
#define reg_ANA_TX_TXCLK_SYNC_EN_LANE  PM_CTRL_TX_LANE_REG2_LANE.BF.ANA_TX_TXCLK_SYNC_EN_LANE
#define reg_ANA_TX_TXCLK_SYNC_EN_FORCE_LANE  PM_CTRL_TX_LANE_REG2_LANE.BF.ANA_TX_TXCLK_SYNC_EN_FORCE_LANE
#define reg_ALIGN_FM_INT_LANE  PM_CTRL_TX_LANE_REG2_LANE.BF.ALIGN_FM_INT_LANE
#define reg_ALIGN_EXT_FM_SIDE_A_LANE  PM_CTRL_TX_LANE_REG2_LANE.BF.ALIGN_EXT_FM_SIDE_A_LANE
...
typedef union {
	struct {
		...
		uint8_t RESERVED_14                              : 1;	/*     14     r/w   0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
		uint8_t INT_TX_IDLE_CHG_ISR_LANE                 : 1;	/*     16     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t RESERVED_14                              : 1;	/*     14     r/w   0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
		uint8_t INT_TX_IDLE_CHG_MASK_LANE                : 1;	/*     16     r/w   1*/
...
typedef union {
	struct {
		...
		uint8_t TX_DATA_WIDTH_LANE_1_0                   : 2;	/*  [9:8]     r/w   0*/
		uint8_t RESERVED_10                              : 6;	/*[16:10]     r/w   0*/
		uint8_t RESERVED_16                              : 1;	/*[16:10]     r/w   0*/
...
__xdata __at( 0x304c ) volatile ID_LANE_REG1_t ID_LANE_REG1;
#define reg_ANA_TX_ANA_RSVD_IN_LANE_15_0_b0  ID_LANE_REG1.BF.ANA_TX_ANA_RSVD_IN_LANE_15_0_b0
#define reg_ANA_TX_ANA_RSVD_IN_LANE_15_0_b1  ID_LANE_REG1.BF.ANA_TX_ANA_RSVD_IN_LANE_15_0_b1
#define reg_DIG_ID_LANE_7_0  ID_LANE_REG1.BF.DIG_ID_LANE_7_0
#define reg_ANA_TX_ANA_RSVD_IN_LANE_15_0  ID_LANE_REG1.WT.W0
...
typedef union {
	struct {
		...
		uint8_t RESERVED_26                              : 1;	/*     26     r/w   0*/
		uint8_t RESERVED_27                              : 1;	/*     27     r/w   0*/
		uint8_t TX_VREF_TXDRV_SEL_LANE_3_0               : 4;	/*[31:28]     r/w 4'h7*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
...
#define reg_TX_VREF_TXDRV_SEL_LANE_3_0  TX_RESERVED_REG2.BF.TX_VREF_TXDRV_SEL_LANE_3_0
...
typedef union {
	struct {
		...
		uint8_t RESERVED_14                              : 1;	/*     14     r/w   0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
		uint8_t INT_TX_IDLE_CHG_ISR_CLEAR_LANE           : 1;	/*     16     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t ANA_TX_PLL_TXCLK_SYNC_EN_LANE            : 1;	/*      6     r/w   0*/
		uint8_t ANA_TX_PLL_TXCLK_SYNC_EN_FORCE_LANE      : 1;	/*      7     r/w   0*/
		uint8_t RESERVED_8                               : 1;	/*      8     r/w   0*/
...
__xdata __at( 0x3080 ) volatile DTX_REG3_t DTX_REG3;
#define reg_ANA_TX_PLL_TXCLK_SYNC_EN_LANE  DTX_REG3.BF.ANA_TX_PLL_TXCLK_SYNC_EN_LANE
#define reg_ANA_TX_PLL_TXCLK_SYNC_EN_FORCE_LANE  DTX_REG3.BF.ANA_TX_PLL_TXCLK_SYNC_EN_FORCE_LANE
...
typedef union {
	struct {
		...
		uint8_t TX_TRAIN_PAT_SEL_LANE_2_0                : 3;	/*[23:21]     r/w   0*/
...
#define reg_TX_TRAIN_PAT_SEL_LANE_2_0  PHYTEST_TX0.BF.TX_TRAIN_PAT_SEL_LANE_2_0
...
typedef union {
	struct {
		uint8_t RESERVED_0                               : 1;	/*      0     r/w   0*/
		uint8_t RESERVED_1                               : 7;	/*  [9:1]     r/w   0*/
		uint8_t RESERVED_8                               : 2;	/*  [9:1]     r/w   0*/
...
// 0x00b4	TX_TRAINING_IF_REG1		Tx_Training_IF_reg1
typedef union {
	struct {
...
__xdata __at( 0x30b4 ) volatile TX_TRAINING_IF_REG1_t TX_TRAINING_IF_REG1;
...
// 0x00b8	TX_TRAINING_IF_REG2		Tx_Training_IF_reg2
typedef union {
	struct {
		...
		uint8_t TX_VREF_TXDRV_SEL_FM_MARGIN_PCIE_EN_LANE : 1;	/*     14     r/w   1*/
		uint8_t TX_TRAIN_DIS_CLK_TX_EN_LANE              : 1;	/*     15     r/w   1*/
		uint8_t TX_VREF_TX_SEL_LANE_3_0                  : 4;	/*[19:16]     r/w 4'h4*/
		uint8_t TX_TRAIN_IF_CLK_EN_LANE                  : 1;	/*     20     r/w   1*/
		uint8_t TX_TRAIN_IF_CLK_ON_LANE                  : 1;	/*     21     r/w   0*/
		uint8_t RST_TX_TRAIN_IF_CLK_LANE                 : 1;	/*     22     r/w   0*/
		uint8_t DME_ENC_CLK_EN_LANE                      : 1;	/*     23     r/w   1*/
		uint8_t DME_ENC_CLK_ON_LANE                      : 1;	/*     24     r/w   0*/
		uint8_t RST_DME_ENC_CLK_LANE                     : 1;	/*     25     r/w   0*/
		uint8_t TX_TRAIN_PRE_CODE_MSB_LSB_SWAP_LANE      : 1;	/*     26     r/w   0*/
		uint8_t TX_TRAIN_MSB_LSB_SWAP_LANE               : 1;	/*     27     r/w   0*/
		uint8_t RESERVED_28                              : 4;	/*[31:28]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TX_TRAINING_IF_REG2_t;
__xdata __at( 0x30b8 ) volatile TX_TRAINING_IF_REG2_t TX_TRAINING_IF_REG2;
...
#define reg_TX_TRAIN_IF_CLK_EN_LANE  TX_TRAINING_IF_REG2.BF.TX_TRAIN_IF_CLK_EN_LANE
#define reg_TX_TRAIN_IF_CLK_ON_LANE  TX_TRAINING_IF_REG2.BF.TX_TRAIN_IF_CLK_ON_LANE
#define reg_RST_TX_TRAIN_IF_CLK_LANE  TX_TRAINING_IF_REG2.BF.RST_TX_TRAIN_IF_CLK_LANE
...
__xdata __at( 0x30bc ) volatile TX_TRAINING_IF_REG3_t TX_TRAINING_IF_REG3;
...
// 0x00c0	TX_GEAR_BOX_REG0		
typedef union {
	struct {
		uint8_t TX_GB_CLK_RST_LANE                       : 1;	/*      0     r/w   0*/
		uint8_t TX_GB_CLK_EN_LANE                        : 1;	/*      1     r/w   1*/
		uint8_t TX_GB_CLK_ON_LANE                        : 1;	/*      2     r/w   0*/
		uint8_t TRAIN_TXCLK_SWITCH_EN_LANE               : 1;	/*      3     r/w   0*/
		uint8_t EXT_TX_GB_FIFO_EN_LANE                   : 1;	/*      4     r/w   0*/
		uint8_t FORCE_EXT_TX_GB_FIFO_EN_LANE             : 1;	/*      5     r/w   0*/
		uint8_t EXT_TX_MUX_CLK_SEL_LANE                  : 1;	/*      6     r/w   0*/
		uint8_t FORCE_EXT_TX_MUX_CLK_SEL_LANE            : 1;	/*      7     r/w   0*/
		uint8_t TX_TRAIN_SEL_BITS_LANE_2_0               : 3;	/* [10:8]       r 3'h0*/
		uint8_t TX_GB_FIFO_PTR_VALID_LANE                : 1;	/*     11     r/w   0*/
		uint8_t TX_DP_SEL_BITS_LANE_2_0                  : 3;	/*[14:12]       r 3'h0*/
		uint8_t EXT_TX_GB_OUT_SEL_LANE                   : 1;	/*     15     r/w   0*/
...
__xdata __at( 0x30c0 ) volatile TX_GEAR_BOX_REG0_t TX_GEAR_BOX_REG0;
#define reg_TX_GB_CLK_RST_LANE  TX_GEAR_BOX_REG0.BF.TX_GB_CLK_RST_LANE
#define reg_TX_GB_CLK_EN_LANE  TX_GEAR_BOX_REG0.BF.TX_GB_CLK_EN_LANE
#define reg_TX_GB_CLK_ON_LANE  TX_GEAR_BOX_REG0.BF.TX_GB_CLK_ON_LANE
#define reg_TRAIN_TXCLK_SWITCH_EN_LANE  TX_GEAR_BOX_REG0.BF.TRAIN_TXCLK_SWITCH_EN_LANE
#define reg_EXT_TX_GB_FIFO_EN_LANE  TX_GEAR_BOX_REG0.BF.EXT_TX_GB_FIFO_EN_LANE
#define reg_FORCE_EXT_TX_GB_FIFO_EN_LANE  TX_GEAR_BOX_REG0.BF.FORCE_EXT_TX_GB_FIFO_EN_LANE
#define reg_EXT_TX_MUX_CLK_SEL_LANE  TX_GEAR_BOX_REG0.BF.EXT_TX_MUX_CLK_SEL_LANE
#define reg_FORCE_EXT_TX_MUX_CLK_SEL_LANE  TX_GEAR_BOX_REG0.BF.FORCE_EXT_TX_MUX_CLK_SEL_LANE
#define reg_TX_TRAIN_SEL_BITS_LANE_2_0  TX_GEAR_BOX_REG0.BF.TX_TRAIN_SEL_BITS_LANE_2_0
#define reg_TX_GB_FIFO_PTR_VALID_LANE  TX_GEAR_BOX_REG0.BF.TX_GB_FIFO_PTR_VALID_LANE
#define reg_TX_DP_SEL_BITS_LANE_2_0  TX_GEAR_BOX_REG0.BF.TX_DP_SEL_BITS_LANE_2_0
#define reg_EXT_TX_GB_OUT_SEL_LANE  TX_GEAR_BOX_REG0.BF.EXT_TX_GB_OUT_SEL_LANE

// 0x00c4	TX_GEAR_BOX_REG1		
typedef union {
	struct {
		uint8_t EXT_TO_ANA_TX_TXCLK_TRAIN_EN_LANE        : 1;	/*      0     r/w   0*/
		uint8_t EXT_INT_TX_TRAIN_GB_DONE_LANE            : 1;	/*      1     r/w   0*/
		uint8_t EXT_INT_TRX_TRAIN_CLK_DIS_LANE           : 1;	/*      2     r/w   0*/
		uint8_t RESERVED_3                               : 1;	/*      3     r/w   0*/
		uint8_t FORCE_EXT_TO_ANA_TX_TXCLK_TRAIN_EN_LANE  : 1;	/*      4     r/w   0*/
		uint8_t FORCE_EXT_INT_TX_TRAIN_GB_DONE_LANE      : 1;	/*      5     r/w   0*/
		uint8_t FORCE_EXT_INT_TRX_TRAIN_CLK_DIS_LANE     : 1;	/*      6     r/w   0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
		uint8_t FORCE_EXT_TO_ANA_TX_TRAIN_SEL_BITS_LANE  : 1;	/*      8     r/w   0*/
		uint8_t FORCE_EXT_TO_ANA_TX_SEL_BITS_LANE        : 1;	/*      9     r/w   0*/
		uint8_t EXT_TO_ANA_TX_TRAIN_SEL_BITS_LANE        : 1;	/*     10     r/w   0*/
		uint8_t EXT_TO_ANA_TX_SEL_BITS_LANE              : 1;	/*     11     r/w   0*/
		uint8_t EXT_TX_TRAIN_SEL_BITS_LANE_2_0           : 3;	/*[14:12]     r/w 3'h0*/
		uint8_t FORCE_EXT_TX_TRAIN_SEL_BITS_LANE         : 1;	/*     15     r/w   0*/
		uint8_t EXT_TX_PT_SEL_BITS_LANE_2_0              : 3;	/*[18:16]     r/w 3'h0*/
		uint8_t FORCE_EXT_TX_PT_SEL_BITS_LANE            : 1;	/*     19     r/w   0*/
		uint8_t EXT_TX_DP_SEL_BITS_LANE_2_0              : 3;	/*[22:20]     r/w 3'h0*/
		uint8_t FORCE_EXT_TX_DP_SEL_BITS_LANE            : 1;	/*     23     r/w   0*/
...
__xdata __at( 0x30c4 ) volatile TX_GEAR_BOX_REG1_t TX_GEAR_BOX_REG1;
#define reg_EXT_TO_ANA_TX_TXCLK_TRAIN_EN_LANE  TX_GEAR_BOX_REG1.BF.EXT_TO_ANA_TX_TXCLK_TRAIN_EN_LANE
#define reg_EXT_INT_TX_TRAIN_GB_DONE_LANE  TX_GEAR_BOX_REG1.BF.EXT_INT_TX_TRAIN_GB_DONE_LANE
#define reg_EXT_INT_TRX_TRAIN_CLK_DIS_LANE  TX_GEAR_BOX_REG1.BF.EXT_INT_TRX_TRAIN_CLK_DIS_LANE
#define reg_FORCE_EXT_TO_ANA_TX_TXCLK_TRAIN_EN_LANE  TX_GEAR_BOX_REG1.BF.FORCE_EXT_TO_ANA_TX_TXCLK_TRAIN_EN_LANE
#define reg_FORCE_EXT_INT_TX_TRAIN_GB_DONE_LANE  TX_GEAR_BOX_REG1.BF.FORCE_EXT_INT_TX_TRAIN_GB_DONE_LANE
#define reg_FORCE_EXT_INT_TRX_TRAIN_CLK_DIS_LANE  TX_GEAR_BOX_REG1.BF.FORCE_EXT_INT_TRX_TRAIN_CLK_DIS_LANE
#define reg_FORCE_EXT_TO_ANA_TX_TRAIN_SEL_BITS_LANE  TX_GEAR_BOX_REG1.BF.FORCE_EXT_TO_ANA_TX_TRAIN_SEL_BITS_LANE
#define reg_FORCE_EXT_TO_ANA_TX_SEL_BITS_LANE  TX_GEAR_BOX_REG1.BF.FORCE_EXT_TO_ANA_TX_SEL_BITS_LANE
#define reg_EXT_TO_ANA_TX_TRAIN_SEL_BITS_LANE  TX_GEAR_BOX_REG1.BF.EXT_TO_ANA_TX_TRAIN_SEL_BITS_LANE
#define reg_EXT_TO_ANA_TX_SEL_BITS_LANE  TX_GEAR_BOX_REG1.BF.EXT_TO_ANA_TX_SEL_BITS_LANE
#define reg_EXT_TX_TRAIN_SEL_BITS_LANE_2_0  TX_GEAR_BOX_REG1.BF.EXT_TX_TRAIN_SEL_BITS_LANE_2_0
#define reg_FORCE_EXT_TX_TRAIN_SEL_BITS_LANE  TX_GEAR_BOX_REG1.BF.FORCE_EXT_TX_TRAIN_SEL_BITS_LANE
#define reg_EXT_TX_PT_SEL_BITS_LANE_2_0  TX_GEAR_BOX_REG1.BF.EXT_TX_PT_SEL_BITS_LANE_2_0
#define reg_FORCE_EXT_TX_PT_SEL_BITS_LANE  TX_GEAR_BOX_REG1.BF.FORCE_EXT_TX_PT_SEL_BITS_LANE
#define reg_EXT_TX_DP_SEL_BITS_LANE_2_0  TX_GEAR_BOX_REG1.BF.EXT_TX_DP_SEL_BITS_LANE_2_0
#define reg_FORCE_EXT_TX_DP_SEL_BITS_LANE  TX_GEAR_BOX_REG1.BF.FORCE_EXT_TX_DP_SEL_BITS_LANE
...
__xdata __at( 0x30c8 ) volatile TX_TRAINING_IF_REG4_t TX_TRAINING_IF_REG4;
...
__xdata __at( 0x30cc ) volatile TX_TRAINING_IF_REG5_t TX_TRAINING_IF_REG5;
...
__xdata __at( 0x30d0 ) volatile TX_TRAINING_IF_REG6_t TX_TRAINING_IF_REG6;
...
__xdata __at( 0x30d4 ) volatile TX_TRAINING_IF_REG7_t TX_TRAINING_IF_REG7;
...
__xdata __at( 0x30d8 ) volatile TX_TRAINING_IF_REG8_t TX_TRAINING_IF_REG8;
