...
typedef union {
	struct {
		...
		uint8_t BG_RES_TRIM_SEL_4_0                      : 5;	/*  [7:3]     r/w 5'hC*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CMN_REG_3_t;
...
typedef union {
	struct {
		...
		uint8_t EN_CHGPUMP_BGREF                         : 1;	/*      3     r/w 1'h0*/
		uint8_t EN_CHGPUMP2VDDRS                         : 1;	/*      4     r/w 1'h1*/
...
typedef union {
	struct {
		uint8_t RESERVED_0                               : 1;	/*      0     r/w 1'h0*/
		uint8_t IOSC_CHGPUMP_SEL_3_0                     : 4;	/*  [4:1]     r/w 4'h0*/
		uint8_t IOP_CHGPUMP_SEL_2_0                      : 3;	/*  [7:5]     r/w 3'h3*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CMN_REG_5_t;
...
typedef union {
	struct {
		uint8_t RESERVED_0                               : 1;	/*      0     r/w 1'h0*/
		uint8_t BRCH_CHGPUMP_SEL_3_0                     : 4;	/*  [4:1]     r/w 4'h4*/
		uint8_t OSC_CHGPUMP_CTUNE_2_0                    : 3;	/*  [7:5]     r/w 3'h3*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CMN_REG_6_t;
...
typedef union {
	struct {
		uint8_t RESERVED_0                               : 2;	/*  [1:0]     r/w 2'h0*/
		uint8_t ANA_TMON_1_0                             : 2;	/*  [3:2]     r/w 2'h2*/
		uint8_t SEL_DIV_CLKANA                           : 1;	/*      4     r/w 1'h1*/
		uint8_t EN_ANA_TST                               : 1;	/*      5     r/w 1'h1*/
...
typedef union {
	struct {
		uint8_t VREF_0P6V_VDDVCO_RXPLL_CH0_3_0           : 4;	/*  [3:0]     r/w 4'h4*/
...
typedef union {
	struct {
		uint8_t VREF_0P6V_VDDVCO_RXPLL_CH1_3_0           : 4;	/*  [3:0]     r/w 4'h4*/
...
typedef union {
	struct {
		uint8_t VREF_0P6V_VDDVCO_RXPLL_CH3_3_0           : 4;	/*  [3:0]     r/w 4'h4*/
		uint8_t VREF_0P6V_VDDVCO_RXPLL_CH2_3_0           : 4;	/*  [7:4]     r/w 4'h4*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CMN_REG_47_t;
...
typedef union {
	struct {
		uint8_t VREF_0P6V_VDDVCO_TXPLL_CH1_3_0           : 4;	/*  [3:0]     r/w 4'h4*/
		uint8_t VREF_0P6V_VDDVCO_TXPLL_CH0_3_0           : 4;	/*  [7:4]     r/w 4'h4*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CMN_REG_48_t;
...
typedef union {
	struct {
		...
		uint8_t IVREF_MASTREG_CUR_SEL_2_0                : 3;	/*  [7:5]     r/w 3'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CMN_REG_49_t;
...
typedef union {
	struct {
		uint8_t VREF_0P6V_VDDVCO_TXPLL_CH3_3_0           : 4;	/*  [3:0]     r/w 4'h4*/
		uint8_t VREF_0P6V_VDDVCO_TXPLL_CH2_3_0           : 4;	/*  [7:4]     r/w 4'h4*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CMN_REG_50_t;
...
typedef union {
	struct {
		uint8_t RESERVED_0                               : 1;	/*      0     r/w 1'h0*/
		uint8_t TSEN_ADC_OSR_1_0                         : 2;	/*  [2:1]     r/w 2'h2*/
		uint8_t TSEN_ADC_MODE_1_0                        : 2;	/*  [4:3]     r/w 2'h2*/
...
typedef union {
	struct {
		uint8_t RESERVED_0                               : 2;	/*  [1:0]     r/w 2'h0*/
		uint8_t BG_TRIM_3_0                              : 4;	/*  [5:2]     r/w 4'h4*/
		uint8_t TSEN_ADC_CHOP_EN_1_0                     : 2;	/*  [7:6]     r/w 2'h2*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CMN_REG_77_t;
...
typedef union {
	struct {
		uint8_t CAPSWP_EN                                : 1;	/*      0     r/w 1'h0*/
		uint8_t BG_RPC_EN                                : 1;	/*      1     r/w 1'h1*/
		uint8_t TSEN_ADC_CAL_1_0                         : 2;	/*  [3:2]     r/w 2'h2*/
		uint8_t TSEN_ADC_AVERAGE_BYPASS                  : 1;	/*      4     r/w 1'h1*/
...
#define reg_TSEN_ADC_AVERAGE_BYPASS  CMN_REG_78.BF.TSEN_ADC_AVERAGE_BYPASS
...
typedef union {
	struct {
		...
		uint8_t TSEN_BIAS                                : 1;	/*      3     r/w 1'h1*/
		uint8_t TSEN_ADC_CHOP_SEL_1_0                    : 2;	/*  [5:4]     r/w 2'h2*/
		uint8_t ADC_CH_SEL_1_0                           : 2;	/*  [7:6]     r/w 2'h2*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CMN_REG_79_t;
...
typedef union {
	struct {
		uint8_t PCM_CTRL_4_0                             : 5;	/*  [4:0]     r/w 5'h5*/
		uint8_t VREF_PROCESSMON_SEL_2_0                  : 3;	/*  [7:5]     r/w 3'h3*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CMN_REG_85_t;
...
typedef union {
	struct {
		...
		uint8_t DRO_SEL_3_0                              : 4;	/*  [6:3]     r/w 4'h4*/
...
typedef union {
	struct {
		uint8_t RESERVED_0                               : 4;	/*  [3:0]     r/w 4'h0*/
		uint8_t RESERVED_4                               : 1;	/*      4     r/w 1'h0*/
		uint8_t PCM_SEL_VREF_2_0                         : 3;	/*  [7:5]     r/w 3'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CMN_REG_87_t;
...
typedef union {
	struct {
		uint8_t ANA_RSVDA_7_0                            : 8;	/*  [7:0]     r/w 8'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CMN_REG_95_t;
...
typedef union {
	struct {
		...
		uint8_t SEL_AVDD_0P9V                            : 1;	/*      5     r/w 1'h1*/
...
typedef union {
	struct {
		uint8_t VTH_TXIMPCAL_NMOS_2_0                    : 3;	/*  [2:0]     r/w 3'h4*/
		uint8_t VTH_TXIMPCAL_PMOS_2_0                    : 3;	/*  [5:3]     r/w 3'h4*/
...
#define reg_VTH_TXIMPCAL_NMOS_2_0  CMN_REG_103.BF.VTH_TXIMPCAL_NMOS_2_0
#define reg_VTH_TXIMPCAL_PMOS_2_0  CMN_REG_103.BF.VTH_TXIMPCAL_PMOS_2_0
