...
typedef union {
	struct {
		uint8_t VDDA_CAL_SEL_LANE_3_0                    : 4;	/*  [3:0]     r/w 4'h0*/
		uint8_t RESERVED_4                               : 1;	/*      4     r/w   0*/
...
#define reg_VDDA_CAL_SEL_LANE_3_0  VDDA_CAL_SEL_REG.BF.VDDA_CAL_SEL_LANE_3_0
#define reg_VDDA_CAL_EN_TRX_LANE  VDDA_CAL_SEL_REG.BF.VDDA_CAL_EN_TRX_LANE

// 0x4	TRX_SELV_REG0		
typedef union {
	struct {
		uint8_t SELLV_RXA90_LANE_4_0                     : 5;	/*  [4:0]     r/w 5'h14*/
...
#define reg_SELLV_RXA90_LANE_4_0  TRX_SELV_REG0.BF.SELLV_RXA90_LANE_4_0

// 0x5	TRX_SELV_REG1		
typedef union {
	struct {
		uint8_t SELLV_RXDLL_LANE_4_0                     : 5;	/*  [4:0]     r/w 5'h14*/
		uint8_t RESERVED_5                               : 3;	/*  [7:5]     r/w 3'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_SELLV_RXDLL_LANE_4_0  TRX_SELV_REG1.BF.SELLV_RXDLL_LANE_4_0

// 0x6	TRX_SELV_REG2		
typedef union {
	struct {
		uint8_t SELLV_RXINTP_LANE_4_0                    : 5;	/*  [4:0]     r/w 5'h14*/
		uint8_t RESERVED_5                               : 3;	/*  [7:5]     r/w 3'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_SELLV_RXINTP_LANE_4_0  TRX_SELV_REG2.BF.SELLV_RXINTP_LANE_4_0

// 0x7	TRX_SELV_REG3		
typedef union {
	struct {
		uint8_t SELLV_RXINTP_EOM_LANE_4_0                : 5;	/*  [4:0]     r/w 5'h14*/
		uint8_t RESERVED_5                               : 3;	/*  [7:5]     r/w 3'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_SELLV_RXINTP_EOM_LANE_4_0  TRX_SELV_REG3.BF.SELLV_RXINTP_EOM_LANE_4_0

// 0x8	TRX_SELV_REG4		
typedef union {
	struct {
		uint8_t SELLV_RXSKEW_LANE_4_0                    : 5;	/*  [4:0]     r/w 5'h14*/
		uint8_t RESERVED_5                               : 3;	/*  [7:5]     r/w 3'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_SELLV_RXSKEW_LANE_4_0  TRX_SELV_REG4.BF.SELLV_RXSKEW_LANE_4_0

// 0x9	TRX_SELV_REG5		
typedef union {
	struct {
		uint8_t SELLV_RXTHCLK_LANE_4_0                   : 5;	/*  [4:0]     r/w 5'h14*/
		uint8_t RESERVED_5                               : 3;	/*  [7:5]     r/w 3'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_SELLV_RXTHCLK_LANE_4_0  TRX_SELV_REG5.BF.SELLV_RXTHCLK_LANE_4_0

// 0xa	TRX_SELV_REG6		
typedef union {
	struct {
		uint8_t SELLV_RXTHDRV_LANE_4_0                   : 5;	/*  [4:0]     r/w 5'h14*/
		uint8_t RESERVED_5                               : 3;	/*  [7:5]     r/w 3'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_SELLV_RXTHDRV_LANE_4_0  TRX_SELV_REG6.BF.SELLV_RXTHDRV_LANE_4_0

// 0xb	TRX_SELV_REG7		
typedef union {
	struct {
		uint8_t SELLV_RX_CLKTOP_LANE_4_0                 : 5;	/*  [4:0]     r/w 5'h14*/
		uint8_t RESERVED_5                               : 3;	/*  [7:5]     r/w 3'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_SELLV_RX_CLKTOP_LANE_4_0  TRX_SELV_REG7.BF.SELLV_RX_CLKTOP_LANE_4_0

// 0xc	TRX_SELV_REG8		
typedef union {
	struct {
		uint8_t SELLV_RX_CTLE_LANE_4_0                   : 5;	/*  [4:0]     r/w 5'h14*/
		uint8_t RESERVED_5                               : 3;	/*  [7:5]     r/w 3'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_SELLV_RX_CTLE_LANE_4_0  TRX_SELV_REG8.BF.SELLV_RX_CTLE_LANE_4_0

// 0xd	TRX_SELV_REG9		
typedef union {
	struct {
		uint8_t SELLV_RX_DIV2_LANE_4_0                   : 5;	/*  [4:0]     r/w 5'h14*/
		uint8_t RESERVED_5                               : 3;	/*  [7:5]     r/w 3'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_SELLV_RX_DIV2_LANE_4_0  TRX_SELV_REG9.BF.SELLV_RX_DIV2_LANE_4_0

// 0xe	TRX_SELV_REG10		
typedef union {
	struct {
		uint8_t SELLV_TXCLK_LANE_4_0                     : 5;	/*  [4:0]     r/w 5'h14*/
		uint8_t RESERVED_5                               : 3;	/*  [7:5]     r/w 3'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_SELLV_TXCLK_LANE_4_0  TRX_SELV_REG10.BF.SELLV_TXCLK_LANE_4_0

// 0xf	TRX_SELV_REG11		
typedef union {
	struct {
		uint8_t SELLV_TXDATA_LANE_4_0                    : 5;	/*  [4:0]     r/w 5'h14*/
		uint8_t RESERVED_5                               : 3;	/*  [7:5]     r/w 3'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_SELLV_TXDATA_LANE_4_0  TRX_SELV_REG11.BF.SELLV_TXDATA_LANE_4_0
...
typedef union {
	struct {
		uint8_t SELLV_TXPRE_LANE_4_0                     : 5;	/*  [4:0]     r/w 5'h14*/
		uint8_t RESERVED_5                               : 3;	/*  [7:5]     r/w 3'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_SELLV_TXPRE_LANE_4_0  TRX_SELV_REG14.BF.SELLV_TXPRE_LANE_4_0
...
typedef union {
	struct {
		...
		uint8_t TS_PD_REG_LANE_1_0                       : 2;	/*  [5:4]     r/w 2'h0*/
		uint8_t RS_PD_REG_LANE_1_0                       : 2;	/*  [7:6]     r/w 2'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TRX_PD_REG_t;
