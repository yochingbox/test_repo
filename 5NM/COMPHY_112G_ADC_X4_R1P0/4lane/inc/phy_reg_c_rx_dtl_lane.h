...
typedef union {
	struct {
		...
		uint8_t RX_DTL_DCO_MAX_JUMP_VALID_LANE           : 1;	/*      6     r/w   0*/
		uint8_t RX_DTL_DPHER_MAX_JUMP_LANE               : 1;	/*      7     r/w   1*/
		uint8_t RX_DTL_DCO_MAX_JUMP_LANE_1_0             : 2;	/*  [9:8]     r/w 2'h2*/
...
typedef union {
	struct {
		...
		uint8_t RX_DTL_LMS_PRE_RUN_TIME_LANE_3_0         : 4;	/* [11:8]     r/w 4'h1*/
