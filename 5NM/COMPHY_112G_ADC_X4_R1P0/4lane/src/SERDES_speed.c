...
void loadspeedtbl_rx() BANKING_CTRL {
  ...
  uint8_t tmp14 = 0x20; //SYSTEM_CONFIG_0.BT.B3 , rx_rate_2_pll_ratio_x8_lane[7:0]
  uint8_t tmp15 = 0x23; //RX_SPD_TABLE_LANE.BT.B0 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
  uint8_t tmp16 = 0x1; //RX_SPD_TABLE_LANE.BT.B1 , rx_rxclk_div_ratio_lane[2:0]
  if (gen_rx==48){
    ...
    tmp15 = 0x15;// RX_SPD_TABLE_LANE.BT.B0 = #001#101 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
  }
  else if (gen_rx==47){
    ...
    tmp14 = 0x10;// SYSTEM_CONFIG_0.BT.B3 = 00010000 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp15 = 0x12;// RX_SPD_TABLE_LANE.BT.B0 = #001#010 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
  }
  else if (gen_rx==46){
    ...
    tmp14 = 0x2;// SYSTEM_CONFIG_0.BT.B3 = 00000010 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp15 = 0x43;// RX_SPD_TABLE_LANE.BT.B0 = #100#011 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
    tmp16 = 0x4;// RX_SPD_TABLE_LANE.BT.B1 = #####100 , rx_rxclk_div_ratio_lane[2:0]
  }
  else if (gen_rx==45){
    ...
    tmp14 = 0x40;// SYSTEM_CONFIG_0.BT.B3 = 01000000 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp15 = 0x4;// RX_SPD_TABLE_LANE.BT.B0 = #000#100 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
    tmp16 = 0x0;// RX_SPD_TABLE_LANE.BT.B1 = #####000 , rx_rxclk_div_ratio_lane[2:0]
  }
  else if (gen_rx==44){
    tmp0 = 0x86;// RX_TOP_ANA_REG_37.BT.B0 = 10000110 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    ...
    tmp12 = 0xA0;// RX_TOP_ANA_REG_36.BT.B0 = 101000## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp13 = 0x88;// RX_TOP_ANA_REG_34.BT.B0 = 10001000 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    tmp15 = 0x2;// RX_SPD_TABLE_LANE.BT.B0 = #000#010 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
    tmp16 = 0x0;// RX_SPD_TABLE_LANE.BT.B1 = #####000 , rx_rxclk_div_ratio_lane[2:0]
  }
  else if (gen_rx==42){
    tmp0 = 0x86;// RX_TOP_ANA_REG_37.BT.B0 = 10000110 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    ...
    tmp14 = 0x40;// SYSTEM_CONFIG_0.BT.B3 = 01000000 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp15 = 0x16;// RX_SPD_TABLE_LANE.BT.B0 = #001#110 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
  }
  else if (gen_rx==40){
    tmp0 = 0xF6;// RX_TOP_ANA_REG_37.BT.B0 = 11110110 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    ...
    tmp12 = 0xA0;// RX_TOP_ANA_REG_36.BT.B0 = 101000## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp13 = 0x88;// RX_TOP_ANA_REG_34.BT.B0 = 10001000 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    tmp15 = 0x14;// RX_SPD_TABLE_LANE.BT.B0 = #001#100 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
  }
  else if (gen_rx==37){
    tmp0 = 0x86;// RX_TOP_ANA_REG_37.BT.B0 = 10000110 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    ...
    tmp12 = 0xC;// RX_TOP_ANA_REG_36.BT.B0 = 000011## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp13 = 0x93;// RX_TOP_ANA_REG_34.BT.B0 = 10010011 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    tmp14 = 0x8;// SYSTEM_CONFIG_0.BT.B3 = 00001000 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp16 = 0x2;// RX_SPD_TABLE_LANE.BT.B1 = #####010 , rx_rxclk_div_ratio_lane[2:0]
  }
  else if (gen_rx==21){
    tmp0 = 0x35;// RX_TOP_ANA_REG_37.BT.B0 = 00110101 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0xC;// PLL_RS_LANE_REG12.BT.B2 = ###01100 , rx_pll_rate_sel_lane[4:0]
    ...
    tmp12 = 0x4;// RX_TOP_ANA_REG_36.BT.B0 = 000001## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp13 = 0xA1;// RX_TOP_ANA_REG_34.BT.B0 = 10100001 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    tmp14 = 0x4;// SYSTEM_CONFIG_0.BT.B3 = 00000100 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp15 = 0x33;// RX_SPD_TABLE_LANE.BT.B0 = #011#011 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
    tmp16 = 0x3;// RX_SPD_TABLE_LANE.BT.B1 = #####011 , rx_rxclk_div_ratio_lane[2:0]
  }
  else if (gen_rx==11){
    tmp0 = 0x15;// RX_TOP_ANA_REG_37.BT.B0 = 00010101 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    ...
    tmp14 = 0x1;// SYSTEM_CONFIG_0.BT.B3 = 00000001 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp15 = 0x53;// RX_SPD_TABLE_LANE.BT.B0 = #101#011 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
    tmp16 = 0x5;// RX_SPD_TABLE_LANE.BT.B1 = #####101 , rx_rxclk_div_ratio_lane[2:0]
  }
  else if (gen_rx==1){
    tmp2 = 0x28;// RX_TOP_ANA_REG_40.BT.B0 = 00101### , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
    tmp3 = 0xA;// RX_TOP_ANA_REG_35.BT.B0 = 00001010 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
  ...
  SYSTEM_CONFIG_0.BT.B3 = tmp14;
  RX_SPD_TABLE_LANE.BT.B0 = tmp15;
  RX_SPD_TABLE_LANE.BT.B1 = tmp16;
}
