...
void all_cal_ext(void) BANKING_CTRL {
    ...
    pll_drv_pll_rs_reset();
    pll_drv_pll_ts_reset();
    ...
    pll_drv_pll_spd_chg_clr_reset_pll_ts();
    //TODO Handle RS case
...
void turn_on_tx_cont_cal(void) BANKING_CTRL {
    ...
    pll_turn_on_tx_cont_cal_ts_pll();
...
void turn_on_rx_cont_cal(void) BANKING_CTRL {
    ...
    pll_turn_on_rx_cont_cal_rs_pll();
...
void turn_off_tx_cont_cal(void) BANKING_CTRL
{
	...
	pll_turn_off_tx_cont_cal_ts_pll();
...
void turn_off_rx_cont_cal(void) BANKING_CTRL 
{
    ...
    pll_turn_off_rx_cont_cal_rs_pll();
