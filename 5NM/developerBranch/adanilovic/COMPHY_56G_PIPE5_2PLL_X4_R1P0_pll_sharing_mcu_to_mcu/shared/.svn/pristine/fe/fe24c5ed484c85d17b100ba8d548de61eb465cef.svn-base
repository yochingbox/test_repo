...
void prbs_checker_init (void) BANKING_CTRL {
    ...
    */
    ...
    reg_PT_RX_CNT_MAX_LANE_31_0  = 0L;

    switch(sel_bit) {
    case 0x0 :  //40 bit
        reg_PT_RX_CNT_MAX_LANE_31_0 = total_bits/40L;
        break;
    case 0x1 : //32 bit 
        reg_PT_RX_CNT_MAX_LANE_31_0 = total_bits/32L;
        break;
    case 0x2 : //80 bit 
        reg_PT_RX_CNT_MAX_LANE_31_0 = total_bits/80L;
        break;
    case 0x3 : //64 bit 
        reg_PT_RX_CNT_MAX_LANE_31_0 = total_bits/64L;
        break;
    case 0x6 : //160 bit 
        reg_PT_RX_CNT_MAX_LANE_31_0 = total_bits/160L;
        break;
    case 0x7 : //128 bit 
        reg_PT_RX_CNT_MAX_LANE_31_0 = total_bits/128L;
        break;
    default : break;
    } //end of switch(sel_bit)
    reg_PT_RX_CNT_MAX_LANE_31_0 *= scaling_factor;
