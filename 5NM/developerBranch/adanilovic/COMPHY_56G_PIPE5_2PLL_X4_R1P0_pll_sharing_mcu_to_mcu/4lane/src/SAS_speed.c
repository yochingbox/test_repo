...
void loadspeedtbl_rx() BANKING_CTRL {
  ...
  uint8_t tmp13 = 0x97; //ANA_INTPI_REG0.BT.B0 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
...
void loadspeedtbl_tx() BANKING_CTRL {
  ...
  uint8_t tmp13 = 0x1; //ANA_TXREG_REG0.BT.B0 , txreg_speedtrk_clk_lane[3:0]
  uint8_t tmp14 = 0x1; //ANA_TXREG_REG1.BT.B0 , txreg_speedtrk_data_lane[3:0]
  ...
  if (gen_tx==4){
    ...
    tmp11 = 0x0;// ANA_TXSPEED_REG0.BT.B0 = #####000 , txspeed_div_lane[2:0]
