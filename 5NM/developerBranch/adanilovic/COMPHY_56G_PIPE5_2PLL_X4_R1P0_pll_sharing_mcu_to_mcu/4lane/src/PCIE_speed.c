...
void loadspeedtbl_rx() BANKING_CTRL {
  uint8_t tmp0 = 0x7; //ANA_DLL_REG1.BT.B0 , eom_dll_cap_sel_lane[2:0]
  ...
  uint8_t tmp3 = 0xAB; //DTL_REG2.BT.B0 , rx_foffset_extra_m_lane[13:0]
  ...
  uint8_t tmp13 = 0xCA; //ANA_INTPI_REG0.BT.B0 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
  ...
  uint8_t tmp17 = 0x2; //ANA_ALIGN90_REG1.BT.B0 , align90_vcap_lane[1:0], align90_ref_filt_bw_lane
  ...
  uint8_t tmp27 = 0x7; //ANA_DLL_REG.BT.B0 , dll_cap_sel_lane[2:0]
  ...
  if (gen_rx==5){
    ...
    tmp17 = 0x0;// ANA_ALIGN90_REG1.BT.B0 = #####00# , align90_vcap_lane[1:0], align90_ref_filt_bw_lane
    ...
    tmp0 = 0x6;// ANA_DLL_REG1.BT.B0 = #####110 , eom_dll_cap_sel_lane[2:0]
    ...
    tmp13 = 0x74;// ANA_INTPI_REG0.BT.B0 = 01110100 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp14 = 0x4;// ANA_CTLE_REG1.BT.B0 = ####0100 , ctle_cap1_sel_g_lane[3:0]
    ...
    tmp27 = 0x6;// ANA_DLL_REG.BT.B0 = #####110 , dll_cap_sel_lane[2:0]
...
void loadspeedtbl_tx() BANKING_CTRL {
  ...
  uint8_t tmp13 = 0x2; //ANA_TXREG_REG0.BT.B0 , txreg_speedtrk_clk_lane[3:0]
  uint8_t tmp14 = 0x2; //ANA_TXREG_REG1.BT.B0 , txreg_speedtrk_data_lane[3:0]
  uint8_t tmp15 = 0x2; //CLKGEN_TX_LANE_REG1_LANE.BT.B0 , tx_train_pat_sel_lane[2:0], tx_data_width_lane[1:0], txdata_latency_reduce_en_lane
  ...
  if (gen_tx==5){
    ...
    tmp13 = 0x7;// ANA_TXREG_REG0.BT.B0 = ####0111 , txreg_speedtrk_clk_lane[3:0]
    tmp14 = 0x7;// ANA_TXREG_REG1.BT.B0 = ####0111 , txreg_speedtrk_data_lane[3:0]
    tmp15 = 0x4;// CLKGEN_TX_LANE_REG1_LANE.BT.B0 = ##000100 , tx_train_pat_sel_lane[2:0], tx_data_width_lane[1:0], txdata_latency_reduce_en_lane
