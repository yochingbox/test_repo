...
void loadspeedtbl_rx() BANKING_CTRL {
  ...
  uint8_t tmp2 = 0x1A; //PLL_RS_LANE_REG12.BT.B2 , rx_pll_rate_sel_lane[4:0]
  ...
  uint8_t tmp5 = 0x2; //ANA_IMPCAL_REG0.BT.B0 , path_disable_edge_lane, intpr_lane[1:0]
  ...
  uint8_t tmp8 = 0x20; //ANA_SMPLR_REG4.BT.B0 , rxspeed_div_2x_lane[1:0], rxtsen_sel_lane, rxterm_extra_lane[1:0], rxtest_lane[8]
  ...
  uint8_t tmp23 = 0xC2; //ANA_SMPLR_REG2.BT.B0 , pu_ctle_even_lane, pu_ctle_odd_lane, pu_smplr_s_e_lane[2:0], pu_smplr_s_o_lane[2:0]
  uint8_t tmp24 = 0x0; //ANA_RSVD_REG9.BT.B0 , ctle_cl2_sel_lane[1:0], ctle_cl1_sel_lane[1:0]
  uint8_t tmp25 = 0xB; //ANA_CTLE_REG5.BT.B0 , ctle_res1_sel_lane[3:0]
  ...
  uint8_t tmp32 = 0x7; //ANA_CTLE_REG6.BT.B0 , ctle_res2_sel_lane[3:0]
  ...
  if (gen_rx==2){
    ...
    tmp23 = 0xD2;// ANA_SMPLR_REG2.BT.B0 = 11010010 , pu_ctle_even_lane, pu_ctle_odd_lane, pu_smplr_s_e_lane[2:0], pu_smplr_s_o_lane[2:0]
...
void loadspeedtbl_lc_pll (uint8_t pll_rate_sel, uint8_t ref_clk_sel, int tsrs_sel) BANKING_CTRL {
  ...
  uint8_t tmp6 = 0x48; //PLL_TS_UPHY14_CMN_ANAREG_TOP_027.BT.B0 , pll_ts_lcpll_postdiv_dcc_cap_en_lane[4:0]
...
void loadspeedtbl_tx() BANKING_CTRL {
  ...
  uint8_t tmp3 = 0x1A; //PLL_TS_LANE_REG12.BT.B2 , tx_pll_rate_sel_lane[4:0]
  ...
  uint8_t tmp11 = 0x2; //ANA_TXSPEED_REG0.BT.B0 , txspeed_div_lane[2:0]
