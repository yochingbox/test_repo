...
void loadspeedtbl_rx() BANKING_CTRL {
  ...
  uint8_t tmp2 = 0x3; //PLL_RS_LANE_REG12.BT.B2 , rx_pll_rate_sel_lane[4:0]
  ...
  uint8_t tmp13 = 0x74; //ANA_INTPI_REG0.BT.B0 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
  ...
  if (gen_rx==47){
    ...
    tmp13 = 0x40;// ANA_INTPI_REG0.BT.B0 = 01000000 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    ...
    tmp26 = 0x0;// ANA_RXREG_REG1.BT.B0 = #000#000 , rxspeed_div_lane[2:0], rxreg_speedtrk_data_lane[2:0]
    ...
    tmp13 = 0xCA;// ANA_INTPI_REG0.BT.B0 = 11001010 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp14 = 0xF;// ANA_CTLE_REG1.BT.B0 = ####1111 , ctle_cap1_sel_g_lane[3:0]
    tmp18 = 0x4;// ANA_DTL_REG3.BT.B0 = #####100 , dtl_clk_speedup_lane[2:0]
    ...
    tmp6 = 0x8;// TX_TRAIN_PAT_NUM1.BT.B0 = 00001000 , train_pat_num_lane[9:0]
    tmp7 = 0x2;// TX_TRAIN_PAT_NUM1.BT.B1 = ######10 , train_pat_num_lane[9:0]
    tmp13 = 0x97;// ANA_INTPI_REG0.BT.B0 = 10010111 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp14 = 0xF;// ANA_CTLE_REG1.BT.B0 = ####1111 , ctle_cap1_sel_g_lane[3:0]
    tmp18 = 0x4;// ANA_DTL_REG3.BT.B0 = #####100 , dtl_clk_speedup_lane[2:0]
    tmp23 = 0xFF;// ANA_SMPLR_REG2.BT.B0 = 11111111 , pu_ctle_even_lane, pu_ctle_odd_lane, pu_smplr_s_e_lane[2:0], pu_smplr_s_o_lane[2:0]
    tmp24 = 0x2;// ANA_RSVD_REG9.BT.B0 = ####0010 , ctle_cl2_sel_lane[1:0], ctle_cl1_sel_lane[1:0]
    ...
    tmp2 = 0x4;// PLL_RS_LANE_REG12.BT.B2 = ###00100 , rx_pll_rate_sel_lane[4:0]
...
void loadspeedtbl_tx() BANKING_CTRL {
  ...
  uint8_t tmp3 = 0x3; //PLL_TS_LANE_REG12.BT.B2 , tx_pll_rate_sel_lane[4:0]
  uint8_t tmp4 = 0x0; //ANA_EOM_REG4.BT.B0 , txpll_hi_speed_lane
  uint8_t tmp5 = 0x40; //TX_SYSTEM_LANE1.BT.B3 , tx_pam2_en_lane
  uint8_t tmp6 = 0xF; //TX_TRAIN_DRIVER_REG1.BT.B0 , tx_emph0_max_lane[4:0]
  uint8_t tmp7 = 0xF; //TX_TRAIN_DRIVER_REG1.BT.B2 , tx_emph1_max_lane[4:0]
  uint8_t tmp8 = 0x0; //TX_TRAIN_DEFAULT4.BT.B0 , tx_emph2_default1_lane[4:0]
  uint8_t tmp9 = 0x0; //TX_TRAIN_DEFAULT4.BT.B1 , tx_emph2_default2_lane[4:0]
  uint8_t tmp10 = 0x0; //TX_TRAIN_DEFAULT4.BT.B2 , tx_emph2_default3_lane[4:0]
  uint8_t tmp11 = 0x0; //ANA_TXSPEED_REG0.BT.B0 , txspeed_div_lane[2:0]
  uint8_t tmp12 = 0xF; //TX_TRAIN_DRIVER_REG2.BT.B0 , tx_emph2_max_lane[4:0]
  uint8_t tmp13 = 0x6; //ANA_TXREG_REG0.BT.B0 , txreg_speedtrk_clk_lane[3:0]
  uint8_t tmp14 = 0x6; //ANA_TXREG_REG1.BT.B0 , txreg_speedtrk_data_lane[3:0]
  uint8_t tmp15 = 0xA; //CLKGEN_TX_LANE_REG1_LANE.BT.B0 , tx_train_pat_sel_lane[2:0], tx_data_width_lane[1:0], txdata_latency_reduce_en_lane
  uint8_t tmp16 = 0x0; //TX_TRAIN_DEFAULT3.BT.B0 , tx_emph1_default1_lane[4:0]
  uint8_t tmp17 = 0x6; //TX_TRAIN_DEFAULT3.BT.B1 , tx_emph1_default2_lane[4:0]
  uint8_t tmp18 = 0x0; //TX_TRAIN_DEFAULT3.BT.B2 , tx_emph1_default3_lane[4:0]
  uint8_t tmp19 = 0x1; //ANA_TX_FIR_SPD_REG0.BT.B0 , txfir_bypass_l1_delay_lane, txfir_bypass_l2_delay_lane, txfir_bypass_l3_delay_lane, txfir_2_dig_clk_div_lane
  uint8_t tmp20 = 0x0; //TX_TRAIN_DEFAULT2.BT.B0 , tx_emph0_default1_lane[4:0]
  uint8_t tmp21 = 0x9; //TX_TRAIN_DEFAULT2.BT.B1 , tx_emph0_default2_lane[4:0]
  uint8_t tmp22 = 0xF; //TX_TRAIN_DEFAULT2.BT.B2 , tx_emph0_default3_lane[4:0]
  uint8_t tmp23 = 0x1; //TX_TRAINING_IF_REG3.BT.B0 , ethernet_mode_tx_lane[1:0]
  uint8_t tmp24 = 0x0; //TX_TRAINING_IF_REG3.BT.B3 , tx_train_pat_two_zero_lane
  if (gen_tx==47){
    tmp3 = 0x0;// PLL_TS_LANE_REG12.BT.B2 = ###00000 , tx_pll_rate_sel_lane[4:0]
    tmp13 = 0x4;// ANA_TXREG_REG0.BT.B0 = ####0100 , txreg_speedtrk_clk_lane[3:0]
    tmp14 = 0x4;// ANA_TXREG_REG1.BT.B0 = ####0100 , txreg_speedtrk_data_lane[3:0]
    tmp15 = 0xB;// CLKGEN_TX_LANE_REG1_LANE.BT.B0 = ##001011 , tx_train_pat_sel_lane[2:0], tx_data_width_lane[1:0], txdata_latency_reduce_en_lane
  }
  else if (gen_tx==46){
    tmp3 = 0x6;// PLL_TS_LANE_REG12.BT.B2 = ###00110 , tx_pll_rate_sel_lane[4:0]
    tmp11 = 0x3;// ANA_TXSPEED_REG0.BT.B0 = #####011 , txspeed_div_lane[2:0]
    tmp13 = 0x1;// ANA_TXREG_REG0.BT.B0 = ####0001 , txreg_speedtrk_clk_lane[3:0]
    tmp14 = 0x1;// ANA_TXREG_REG1.BT.B0 = ####0001 , txreg_speedtrk_data_lane[3:0]
    tmp15 = 0xB;// CLKGEN_TX_LANE_REG1_LANE.BT.B0 = ##001011 , tx_train_pat_sel_lane[2:0], tx_data_width_lane[1:0], txdata_latency_reduce_en_lane
  }
  else if (gen_tx==42){
    tmp3 = 0x12;// PLL_TS_LANE_REG12.BT.B2 = ###10010 , tx_pll_rate_sel_lane[4:0]
    tmp4 = 0x1;// ANA_EOM_REG4.BT.B0 = #######1 , txpll_hi_speed_lane
    tmp5 = 0x0;// TX_SYSTEM_LANE1.BT.B3 = #0###### , tx_pam2_en_lane
    tmp15 = 0x1C;// CLKGEN_TX_LANE_REG1_LANE.BT.B0 = ##011100 , tx_train_pat_sel_lane[2:0], tx_data_width_lane[1:0], txdata_latency_reduce_en_lane
    tmp23 = 0x2;// TX_TRAINING_IF_REG3.BT.B0 = ######10 , ethernet_mode_tx_lane[1:0]
  }
  else if (gen_tx==38){
    ...
    tmp5 = 0x0;// TX_SYSTEM_LANE1.BT.B3 = #0###### , tx_pam2_en_lane
    tmp13 = 0x5;// ANA_TXREG_REG0.BT.B0 = ####0101 , txreg_speedtrk_clk_lane[3:0]
    tmp14 = 0x5;// ANA_TXREG_REG1.BT.B0 = ####0101 , txreg_speedtrk_data_lane[3:0]
    tmp15 = 0x1C;// CLKGEN_TX_LANE_REG1_LANE.BT.B0 = ##011100 , tx_train_pat_sel_lane[2:0], tx_data_width_lane[1:0], txdata_latency_reduce_en_lane
    tmp23 = 0x2;// TX_TRAINING_IF_REG3.BT.B0 = ######10 , ethernet_mode_tx_lane[1:0]
  }
  else if (gen_tx==30){
    tmp3 = 0x14;// PLL_TS_LANE_REG12.BT.B2 = ###10100 , tx_pll_rate_sel_lane[4:0]
    tmp4 = 0x1;// ANA_EOM_REG4.BT.B0 = #######1 , txpll_hi_speed_lane
    tmp15 = 0x12;// CLKGEN_TX_LANE_REG1_LANE.BT.B0 = ##010010 , tx_train_pat_sel_lane[2:0], tx_data_width_lane[1:0], txdata_latency_reduce_en_lane
  }
  else if (gen_tx==29){
    tmp3 = 0x13;// PLL_TS_LANE_REG12.BT.B2 = ###10011 , tx_pll_rate_sel_lane[4:0]
    tmp4 = 0x1;// ANA_EOM_REG4.BT.B0 = #######1 , txpll_hi_speed_lane
    ...
    tmp3 = 0x13;// PLL_TS_LANE_REG12.BT.B2 = ###10011 , tx_pll_rate_sel_lane[4:0]
    tmp4 = 0x1;// ANA_EOM_REG4.BT.B0 = #######1 , txpll_hi_speed_lane
    tmp11 = 0x1;// ANA_TXSPEED_REG0.BT.B0 = #####001 , txspeed_div_lane[2:0]
    tmp13 = 0x3;// ANA_TXREG_REG0.BT.B0 = ####0011 , txreg_speedtrk_clk_lane[3:0]
    tmp14 = 0x3;// ANA_TXREG_REG1.BT.B0 = ####0011 , txreg_speedtrk_data_lane[3:0]
  }
  else if (gen_tx==22){
    ...
    tmp11 = 0x1;// ANA_TXSPEED_REG0.BT.B0 = #####001 , txspeed_div_lane[2:0]
    tmp13 = 0x2;// ANA_TXREG_REG0.BT.B0 = ####0010 , txreg_speedtrk_clk_lane[3:0]
    tmp14 = 0x2;// ANA_TXREG_REG1.BT.B0 = ####0010 , txreg_speedtrk_data_lane[3:0]
  }
  else if (gen_tx==13){
    tmp3 = 0x0;// PLL_TS_LANE_REG12.BT.B2 = ###00000 , tx_pll_rate_sel_lane[4:0]
    tmp11 = 0x1;// ANA_TXSPEED_REG0.BT.B0 = #####001 , txspeed_div_lane[2:0]
    ...
    tmp3 = 0xC;// PLL_TS_LANE_REG12.BT.B2 = ###01100 , tx_pll_rate_sel_lane[4:0]
    tmp11 = 0x2;// ANA_TXSPEED_REG0.BT.B0 = #####010 , txspeed_div_lane[2:0]
    tmp13 = 0x2;// ANA_TXREG_REG0.BT.B0 = ####0010 , txreg_speedtrk_clk_lane[3:0]
    tmp14 = 0x2;// ANA_TXREG_REG1.BT.B0 = ####0010 , txreg_speedtrk_data_lane[3:0]
  }
  else if (gen_tx==11){
    ...
    tmp3 = 0x4;// PLL_TS_LANE_REG12.BT.B2 = ###00100 , tx_pll_rate_sel_lane[4:0]
    tmp11 = 0x2;// ANA_TXSPEED_REG0.BT.B0 = #####010 , txspeed_div_lane[2:0]
    tmp13 = 0x2;// ANA_TXREG_REG0.BT.B0 = ####0010 , txreg_speedtrk_clk_lane[3:0]
    tmp14 = 0x2;// ANA_TXREG_REG1.BT.B0 = ####0010 , txreg_speedtrk_data_lane[3:0]
  }
    ...
    tmp3 = 0x4;// PLL_TS_LANE_REG12.BT.B2 = ###00100 , tx_pll_rate_sel_lane[4:0]
    tmp11 = 0x4;// ANA_TXSPEED_REG0.BT.B0 = #####100 , txspeed_div_lane[2:0]
    tmp13 = 0x1;// ANA_TXREG_REG0.BT.B0 = ####0001 , txreg_speedtrk_clk_lane[3:0]
    tmp14 = 0x1;// ANA_TXREG_REG1.BT.B0 = ####0001 , txreg_speedtrk_data_lane[3:0]
  }
  else if (gen_tx==1){
    ...
    tmp14 = 0x1;// ANA_TXREG_REG1.BT.B0 = ####0001 , txreg_speedtrk_data_lane[3:0]
    tmp15 = 0xB;// CLKGEN_TX_LANE_REG1_LANE.BT.B0 = ##001011 , tx_train_pat_sel_lane[2:0], tx_data_width_lane[1:0], txdata_latency_reduce_en_lane
    tmp24 = 0x80;// TX_TRAINING_IF_REG3.BT.B3 = 1####### , tx_train_pat_two_zero_lane
  }
  TX_TRAIN_DEFAULT1.BT.B0 = tmp0;
  TX_TRAIN_DEFAULT1.BT.B1 = tmp1;
  TX_TRAIN_DEFAULT1.BT.B2 = tmp2;
  PLL_TS_LANE_REG12.BT.B2 = tmp3;
  ANA_EOM_REG4.BT.B0 = tmp4;
  TX_SYSTEM_LANE1.BT.B3 = tmp5;
  TX_TRAIN_DRIVER_REG1.BT.B0 = tmp6;
  TX_TRAIN_DRIVER_REG1.BT.B2 = tmp7;
  TX_TRAIN_DEFAULT4.BT.B0 = tmp8;
  TX_TRAIN_DEFAULT4.BT.B1 = tmp9;
  TX_TRAIN_DEFAULT4.BT.B2 = tmp10;
  ANA_TXSPEED_REG0.BT.B0 = tmp11;
  TX_TRAIN_DRIVER_REG2.BT.B0 = tmp12;
  ANA_TXREG_REG0.BT.B0 = tmp13;
  ANA_TXREG_REG1.BT.B0 = tmp14;
  CLKGEN_TX_LANE_REG1_LANE.BT.B0 = tmp15;
  TX_TRAIN_DEFAULT3.BT.B0 = tmp16;
  TX_TRAIN_DEFAULT3.BT.B1 = tmp17;
  TX_TRAIN_DEFAULT3.BT.B2 = tmp18;
  ANA_TX_FIR_SPD_REG0.BT.B0 = tmp19;
  TX_TRAIN_DEFAULT2.BT.B0 = tmp20;
  TX_TRAIN_DEFAULT2.BT.B1 = tmp21;
  TX_TRAIN_DEFAULT2.BT.B2 = tmp22;
  TX_TRAINING_IF_REG3.BT.B0 = tmp23;
  TX_TRAINING_IF_REG3.BT.B3 = tmp24;
}
#endif //_SERDES_BUILD
