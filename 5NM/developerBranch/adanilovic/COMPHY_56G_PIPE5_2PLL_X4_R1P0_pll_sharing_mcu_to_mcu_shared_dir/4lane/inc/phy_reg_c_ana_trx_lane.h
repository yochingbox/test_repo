...
typedef union {
	struct {
		uint8_t CLATCH_ST_LANE_1_0                       : 2;	/*  [1:0]     r/w 2'h2*/
		uint8_t CLATCH_EN_LANE                           : 1;	/*      2     r/w   1*/
		uint8_t RESERVED_3                               : 1;	/*      3     r/w   0*/
		uint8_t RESERVED_4                               : 1;	/*      4     r/w   0*/
		uint8_t RESERVED_5                               : 1;	/*      5     r/w   0*/
		uint8_t RESERVED_6                               : 1;	/*      6     r/w   0*/
...
#define reg_CLATCH_ST_LANE_1_0  ANA_DLL_REG.BF.CLATCH_ST_LANE_1_0
#define reg_CLATCH_EN_LANE  ANA_DLL_REG.BF.CLATCH_EN_LANE
...
typedef union {
	struct {
		uint8_t CTLE_RL1_EXTRA_LANE_1_0                  : 2;	/*  [1:0]     r/w 2'h0*/
		uint8_t CTLE_HPF_RSEL_LANE_1_0                   : 2;	/*  [3:2]     r/w 2'h0*/
		uint8_t RESERVED_4                               : 1;	/*      4     r/w   0*/
		uint8_t RESERVED_5                               : 1;	/*      5     r/w   0*/
		uint8_t RESERVED_6                               : 1;	/*      6     r/w   0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t EOM_CLATCH_ST_LANE_1_0                   : 2;	/*  [7:6]     r/w 2'h1*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} ANA_EOM_REG0_t;
...
#define reg_EOM_CLATCH_ST_LANE_1_0  ANA_EOM_REG0.BF.EOM_CLATCH_ST_LANE_1_0
...
typedef union {
	struct {
		...
		uint8_t EOM_CLATCH_EN_LANE                       : 1;	/*      2     r/w   1*/
...
#define reg_EOM_CLATCH_EN_LANE  ANA_EOM_REG1.BF.EOM_CLATCH_EN_LANE
...
typedef union {
	struct {
		...
		uint8_t TXCLK_DIV_DIG_LANE_2_0                   : 3;	/*  [5:3]     r/w 3'h0*/
		uint8_t RESERVED_6                               : 1;	/*      6     r/w   0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
...
#define reg_TXCLK_DIV_DIG_LANE_2_0  ANA_TXSPEED_REG0.BF.TXCLK_DIV_DIG_LANE_2_0
...
// 0x52	ANA_CLKCTRL_REG0		
typedef union {
	struct {
		uint8_t TXFIR_BYPASS_DOUT_LATCH_LANE             : 1;	/*      0     r/w   0*/
		uint8_t TXFIR_BYPASS_DIN_LATCH_LANE              : 1;	/*      1     r/w   0*/
		uint8_t RESERVED_2                               : 1;	/*      2     r/w   0*/
		uint8_t RESERVED_3                               : 1;	/*      3     r/w   0*/
		uint8_t RESERVED_4                               : 1;	/*      4     r/w   0*/
		uint8_t RESERVED_5                               : 1;	/*      5     r/w   0*/
...
__xdata __at( 0x1148 ) volatile ANA_CLKCTRL_REG0_t ANA_CLKCTRL_REG0;
#define reg_TXFIR_BYPASS_DOUT_LATCH_LANE  ANA_CLKCTRL_REG0.BF.TXFIR_BYPASS_DOUT_LATCH_LANE
#define reg_TXFIR_BYPASS_DIN_LATCH_LANE  ANA_CLKCTRL_REG0.BF.TXFIR_BYPASS_DIN_LATCH_LANE

// 0x53	ANA_TXINTP_REG0		
typedef union {
	struct {
		uint8_t RESERVED_0                               : 1;	/*      0     r/w   0*/
		uint8_t RESERVED_1                               : 1;	/*      1     r/w   0*/
...
__xdata __at( 0x114c ) volatile ANA_TXINTP_REG0_t ANA_TXINTP_REG0;
...
typedef union {
	struct {
		uint8_t TXRSVD0_LANE_7_0                         : 8;	/*  [7:0]     r/w 8'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TX_RSVD_REG0_t;
__xdata __at( 0x1174 ) volatile TX_RSVD_REG0_t TX_RSVD_REG0;
#define reg_TXRSVD0_LANE_7_0  TX_RSVD_REG0.BF.TXRSVD0_LANE_7_0
...
typedef union {
	struct {
		uint8_t RESERVED_0                               : 2;	/*  [1:0]     r/w   0*/
		uint8_t TXCKRET_DLY_LANE_2_0                     : 3;	/*  [4:2]     r/w 3'h0*/
		uint8_t TXCKPOM_DLY_LANE_2_0                     : 3;	/*  [7:5]     r/w 3'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} ANA_TXCLK_DLY0_t;
__xdata __at( 0x119c ) volatile ANA_TXCLK_DLY0_t ANA_TXCLK_DLY0;
#define reg_TXCKRET_DLY_LANE_2_0  ANA_TXCLK_DLY0.BF.TXCKRET_DLY_LANE_2_0
#define reg_TXCKPOM_DLY_LANE_2_0  ANA_TXCLK_DLY0.BF.TXCKPOM_DLY_LANE_2_0
...
typedef union {
	struct {
		...
		uint8_t TXCKDRV_DLY_LANE_2_0                     : 3;	/*  [7:5]     r/w 3'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} ANA_TXCLK_DLY1_t;
...
#define reg_TXCKDRV_DLY_LANE_2_0  ANA_TXCLK_DLY1.BF.TXCKDRV_DLY_LANE_2_0
