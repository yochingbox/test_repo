...
__xdata __at(0xe68C) volatile uint8_t mcu_data_payload_channel0[4];
__xdata __at(0xe690) volatile uint8_t mcu_data_payload_channel1[4];
__xdata __at(0xe694) volatile uint8_t mcu_data_payload_channel2[4];
__xdata __at(0xe698) volatile uint8_t pll_s_current_state_g[4];
__xdata __at(0xe69C) volatile uint8_t pll_s__lane_seq__current_sequence[4];
// to 0x6f77
// Next available: 0x6f78
