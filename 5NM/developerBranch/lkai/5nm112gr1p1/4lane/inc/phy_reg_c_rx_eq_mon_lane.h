...
__xdata __at( 0x4518 ) volatile SIGMNT_REG0_t SIGMNT_REG0;
...
__xdata __at( 0x451c ) volatile SIGMNT_REG1_t SIGMNT_REG1;
...
__xdata __at( 0x4520 ) volatile SIGMNT_REG2_t SIGMNT_REG2;
...
__xdata __at( 0x4524 ) volatile SIGMNT_REG3_t SIGMNT_REG3;
...
__xdata __at( 0x4528 ) volatile SIGMNT_REG4_t SIGMNT_REG4;
...
__xdata __at( 0x452c ) volatile SIGMNT_REG5_t SIGMNT_REG5;
...
__xdata __at( 0x4530 ) volatile SIGMNT_REG6_t SIGMNT_REG6;
...
typedef union {
	struct {
		...
		uint8_t CHEST_DONE_LANE                          : 1;	/*      6       r   0*/
...
__xdata __at( 0x4534 ) volatile CHEST_REG0_t CHEST_REG0;
#define reg_CHEST_DONE_LANE  CHEST_REG0.BF.CHEST_DONE_LANE
...
typedef union {
	struct {
		uint8_t CHEST_VAL_LANE_29_0_b0                   : 8;	/* [29:0]       r 30'h0*/
		uint8_t CHEST_VAL_LANE_29_0_b1                   : 8;	/* [29:0]       r 30'h0*/
		uint8_t CHEST_VAL_LANE_29_0_b2                   : 8;	/* [29:0]       r 30'h0*/
		uint8_t CHEST_VAL_LANE_29_0_b3                   : 6;	/* [29:0]       r 30'h0*/
		uint8_t RESERVED_30                              : 2;	/*[31:30]     r/w 2'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CHEST_REG1_t;
__xdata __at( 0x4538 ) volatile CHEST_REG1_t CHEST_REG1;
#define reg_CHEST_VAL_LANE_29_0_b0  CHEST_REG1.BF.CHEST_VAL_LANE_29_0_b0
#define reg_CHEST_VAL_LANE_29_0_b1  CHEST_REG1.BF.CHEST_VAL_LANE_29_0_b1
#define reg_CHEST_VAL_LANE_29_0_b2  CHEST_REG1.BF.CHEST_VAL_LANE_29_0_b2
#define reg_CHEST_VAL_LANE_29_0_b3  CHEST_REG1.BF.CHEST_VAL_LANE_29_0_b3
...
__xdata __at( 0x453c ) volatile CHEST_REG2_t CHEST_REG2;
...
typedef union {
	struct {
		...
		uint8_t OCM_RTSEL_LANE_1_0                       : 2;	/*[29:28]     r/w 2'h0*/
		uint8_t OCM_WTSEL_LANE_1_0                       : 2;	/*[31:30]     r/w 2'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} OCM_REG_t;
__xdata __at( 0x4540 ) volatile OCM_REG_t OCM_REG;
...
__xdata __at( 0x4550 ) volatile EOM_REG0_t EOM_REG0;
...
__xdata __at( 0x4554 ) volatile EOM_REG1_t EOM_REG1;
...
__xdata __at( 0x4558 ) volatile EOM_REG2_t EOM_REG2;
...
__xdata __at( 0x455c ) volatile EOM_REG3_t EOM_REG3;
...
__xdata __at( 0x4560 ) volatile EOM_REG4_t EOM_REG4;
...
__xdata __at( 0x4564 ) volatile EOM_REG5_t EOM_REG5;
...
__xdata __at( 0x4568 ) volatile EOM_REG6_t EOM_REG6;
...
__xdata __at( 0x456c ) volatile EOM_REG7_t EOM_REG7;
...
__xdata __at( 0x4570 ) volatile EOM_REG8_t EOM_REG8;
...
__xdata __at( 0x4574 ) volatile EOM_REG9_t EOM_REG9;
...
__xdata __at( 0x4578 ) volatile EOM_REG10_t EOM_REG10;
...
__xdata __at( 0x457c ) volatile EOM_REG11_t EOM_REG11;
...
__xdata __at( 0x4580 ) volatile EOM_REG12_t EOM_REG12;
...
__xdata __at( 0x4584 ) volatile EOM_REG13_t EOM_REG13;
...
__xdata __at( 0x4588 ) volatile EOM_REG14_t EOM_REG14;
...
__xdata __at( 0x458c ) volatile EOM_REG15_t EOM_REG15;
...
__xdata __at( 0x4590 ) volatile EOM_REG16_t EOM_REG16;
...
__xdata __at( 0x4594 ) volatile MSE_REG0_t MSE_REG0;
...
__xdata __at( 0x4598 ) volatile MSE_REG1_t MSE_REG1;
...
__xdata __at( 0x459c ) volatile MSE_REG2_t MSE_REG2;
...
__xdata __at( 0x45a0 ) volatile MSE_REG3_t MSE_REG3;
...
__xdata __at( 0x45a4 ) volatile MSE_REG4_t MSE_REG4;
...
__xdata __at( 0x45a8 ) volatile MSE_REG5_t MSE_REG5;
...
// 0x00ac	PLM_REG0		PLM Register 0
typedef union {
	struct {
		uint8_t RESERVED_0                               : 8;	/*  [9:0]     r/w   0*/
		uint8_t RESERVED_8                               : 2;	/*  [9:0]     r/w   0*/
		uint8_t PLM_PATH_OVR_LANE_5_0                    : 6;	/*[15:10]     r/w   0*/
		uint8_t PLM_RD_REQ_LANE                          : 1;	/*     16     r/w   0*/
		uint8_t PLM_PATH_OVR_EN_LANE                     : 1;	/*     17     r/w   0*/
		uint8_t PLM_INDEX_OVR_LANE_1_0                   : 2;	/*[19:18]     r/w   0*/
		uint8_t PLM_INDEX_OVR_EN_LANE                    : 1;	/*     20     r/w   0*/
		uint8_t PLM_BETA_LANE_2_0                        : 3;	/*[23:21]     r/w 3'h4*/
		uint8_t PLM_ALPHA_LANE_2_0                       : 3;	/*[26:24]     r/w 3'h4*/
		uint8_t PLM_SIZE_M_LANE_1_0                      : 2;	/*[28:27]     r/w 2'h3*/
		uint8_t PLM_CONFIG_READY_LANE                    : 1;	/*     29     r/w   0*/
		uint8_t PLM_START_LANE                           : 1;	/*     30     r/w   0*/
		uint8_t PLM_EN_LANE                              : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} PLM_REG0_t;
__xdata __at( 0x45ac ) volatile PLM_REG0_t PLM_REG0;
#define reg_PLM_PATH_OVR_LANE_5_0  PLM_REG0.BF.PLM_PATH_OVR_LANE_5_0
#define reg_PLM_RD_REQ_LANE  PLM_REG0.BF.PLM_RD_REQ_LANE
#define reg_PLM_PATH_OVR_EN_LANE  PLM_REG0.BF.PLM_PATH_OVR_EN_LANE
#define reg_PLM_INDEX_OVR_LANE_1_0  PLM_REG0.BF.PLM_INDEX_OVR_LANE_1_0
#define reg_PLM_INDEX_OVR_EN_LANE  PLM_REG0.BF.PLM_INDEX_OVR_EN_LANE
#define reg_PLM_BETA_LANE_2_0  PLM_REG0.BF.PLM_BETA_LANE_2_0
#define reg_PLM_ALPHA_LANE_2_0  PLM_REG0.BF.PLM_ALPHA_LANE_2_0
#define reg_PLM_SIZE_M_LANE_1_0  PLM_REG0.BF.PLM_SIZE_M_LANE_1_0
#define reg_PLM_CONFIG_READY_LANE  PLM_REG0.BF.PLM_CONFIG_READY_LANE
#define reg_PLM_START_LANE  PLM_REG0.BF.PLM_START_LANE
#define reg_PLM_EN_LANE  PLM_REG0.BF.PLM_EN_LANE

// 0x00b0	PLM_REG1		PLM Register 1
typedef union {
	struct {
		uint8_t RX_PLM_MON_VAL_LANE_15_0_b0              : 8;	/* [15:0]       r   0*/
		uint8_t RX_PLM_MON_VAL_LANE_15_0_b1              : 8;	/* [15:0]       r   0*/
		uint8_t RESERVED_16                              : 8;	/*[29:16]     r/w   0*/
		uint8_t RESERVED_24                              : 6;	/*[29:16]     r/w   0*/
		uint8_t PLM_RD_ACK_LANE                          : 1;	/*     30       r   0*/
		uint8_t PLM_DONE_LANE                            : 1;	/*     31       r   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
} PLM_REG1_t;
__xdata __at( 0x45b0 ) volatile PLM_REG1_t PLM_REG1;
#define reg_RX_PLM_MON_VAL_LANE_15_0_b0  PLM_REG1.BF.RX_PLM_MON_VAL_LANE_15_0_b0
#define reg_RX_PLM_MON_VAL_LANE_15_0_b1  PLM_REG1.BF.RX_PLM_MON_VAL_LANE_15_0_b1
#define reg_PLM_RD_ACK_LANE  PLM_REG1.BF.PLM_RD_ACK_LANE
#define reg_PLM_DONE_LANE  PLM_REG1.BF.PLM_DONE_LANE
#define reg_RX_PLM_MON_VAL_LANE_15_0  PLM_REG1.WT.W0

// 0x00b4	PLM_REG2		PLM Register 2
typedef union {
	struct {
		uint8_t PLM_MEAN0_LANE_25_0_b0                   : 8;	/* [25:0]       r   0*/
		uint8_t PLM_MEAN0_LANE_25_0_b1                   : 8;	/* [25:0]       r   0*/
		uint8_t PLM_MEAN0_LANE_25_0_b2                   : 8;	/* [25:0]       r   0*/
		uint8_t PLM_MEAN0_LANE_25_0_b3                   : 2;	/* [25:0]       r   0*/
		uint8_t RESERVED_26                              : 6;	/*[31:26]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} PLM_REG2_t;
__xdata __at( 0x45b4 ) volatile PLM_REG2_t PLM_REG2;
#define reg_PLM_MEAN0_LANE_25_0_b0  PLM_REG2.BF.PLM_MEAN0_LANE_25_0_b0
#define reg_PLM_MEAN0_LANE_25_0_b1  PLM_REG2.BF.PLM_MEAN0_LANE_25_0_b1
#define reg_PLM_MEAN0_LANE_25_0_b2  PLM_REG2.BF.PLM_MEAN0_LANE_25_0_b2
#define reg_PLM_MEAN0_LANE_25_0_b3  PLM_REG2.BF.PLM_MEAN0_LANE_25_0_b3

// 0x00b8	PLM_REG3		PLM Register 3
typedef union {
	struct {
		uint8_t PLM_MEAN1_LANE_25_0_b0                   : 8;	/* [25:0]       r   0*/
		uint8_t PLM_MEAN1_LANE_25_0_b1                   : 8;	/* [25:0]       r   0*/
		uint8_t PLM_MEAN1_LANE_25_0_b2                   : 8;	/* [25:0]       r   0*/
		uint8_t PLM_MEAN1_LANE_25_0_b3                   : 2;	/* [25:0]       r   0*/
		uint8_t RESERVED_26                              : 6;	/*[31:26]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} PLM_REG3_t;
__xdata __at( 0x45b8 ) volatile PLM_REG3_t PLM_REG3;
#define reg_PLM_MEAN1_LANE_25_0_b0  PLM_REG3.BF.PLM_MEAN1_LANE_25_0_b0
#define reg_PLM_MEAN1_LANE_25_0_b1  PLM_REG3.BF.PLM_MEAN1_LANE_25_0_b1
#define reg_PLM_MEAN1_LANE_25_0_b2  PLM_REG3.BF.PLM_MEAN1_LANE_25_0_b2
#define reg_PLM_MEAN1_LANE_25_0_b3  PLM_REG3.BF.PLM_MEAN1_LANE_25_0_b3

// 0x00bc	PLM_REG4		PLM Register 4
typedef union {
	struct {
		uint8_t PLM_MEAN2_LANE_25_0_b0                   : 8;	/* [25:0]       r   0*/
		uint8_t PLM_MEAN2_LANE_25_0_b1                   : 8;	/* [25:0]       r   0*/
		uint8_t PLM_MEAN2_LANE_25_0_b2                   : 8;	/* [25:0]       r   0*/
		uint8_t PLM_MEAN2_LANE_25_0_b3                   : 2;	/* [25:0]       r   0*/
		uint8_t RESERVED_26                              : 6;	/*[31:26]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} PLM_REG4_t;
__xdata __at( 0x45bc ) volatile PLM_REG4_t PLM_REG4;
#define reg_PLM_MEAN2_LANE_25_0_b0  PLM_REG4.BF.PLM_MEAN2_LANE_25_0_b0
#define reg_PLM_MEAN2_LANE_25_0_b1  PLM_REG4.BF.PLM_MEAN2_LANE_25_0_b1
#define reg_PLM_MEAN2_LANE_25_0_b2  PLM_REG4.BF.PLM_MEAN2_LANE_25_0_b2
#define reg_PLM_MEAN2_LANE_25_0_b3  PLM_REG4.BF.PLM_MEAN2_LANE_25_0_b3

// 0x00c0	PLM_REG5		PLM Register 5
typedef union {
	struct {
		uint8_t PLM_MEAN3_LANE_25_0_b0                   : 8;	/* [25:0]       r   0*/
		uint8_t PLM_MEAN3_LANE_25_0_b1                   : 8;	/* [25:0]       r   0*/
		uint8_t PLM_MEAN3_LANE_25_0_b2                   : 8;	/* [25:0]       r   0*/
		uint8_t PLM_MEAN3_LANE_25_0_b3                   : 2;	/* [25:0]       r   0*/
		uint8_t RESERVED_26                              : 6;	/*[31:26]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} PLM_REG5_t;
__xdata __at( 0x45c0 ) volatile PLM_REG5_t PLM_REG5;
#define reg_PLM_MEAN3_LANE_25_0_b0  PLM_REG5.BF.PLM_MEAN3_LANE_25_0_b0
#define reg_PLM_MEAN3_LANE_25_0_b1  PLM_REG5.BF.PLM_MEAN3_LANE_25_0_b1
#define reg_PLM_MEAN3_LANE_25_0_b2  PLM_REG5.BF.PLM_MEAN3_LANE_25_0_b2
#define reg_PLM_MEAN3_LANE_25_0_b3  PLM_REG5.BF.PLM_MEAN3_LANE_25_0_b3

// 0x00c4	PLM_REG6		PLM Register 6
typedef union {
	struct {
		uint8_t PLM_MSE0_LANE_31_0_b0                    : 8;	/* [31:0]       r   0*/
		uint8_t PLM_MSE0_LANE_31_0_b1                    : 8;	/* [31:0]       r   0*/
		uint8_t PLM_MSE0_LANE_31_0_b2                    : 8;	/* [31:0]       r   0*/
		uint8_t PLM_MSE0_LANE_31_0_b3                    : 8;	/* [31:0]       r   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} PLM_REG6_t;
__xdata __at( 0x45c4 ) volatile PLM_REG6_t PLM_REG6;
#define reg_PLM_MSE0_LANE_31_0_b0  PLM_REG6.BF.PLM_MSE0_LANE_31_0_b0
#define reg_PLM_MSE0_LANE_31_0_b1  PLM_REG6.BF.PLM_MSE0_LANE_31_0_b1
#define reg_PLM_MSE0_LANE_31_0_b2  PLM_REG6.BF.PLM_MSE0_LANE_31_0_b2
#define reg_PLM_MSE0_LANE_31_0_b3  PLM_REG6.BF.PLM_MSE0_LANE_31_0_b3

// 0x00c8	PLM_REG7		PLM Register 7
typedef union {
	struct {
		uint8_t PLM_MSE1_LANE_31_0_b0                    : 8;	/* [31:0]       r   0*/
		uint8_t PLM_MSE1_LANE_31_0_b1                    : 8;	/* [31:0]       r   0*/
		uint8_t PLM_MSE1_LANE_31_0_b2                    : 8;	/* [31:0]       r   0*/
		uint8_t PLM_MSE1_LANE_31_0_b3                    : 8;	/* [31:0]       r   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} PLM_REG7_t;
__xdata __at( 0x45c8 ) volatile PLM_REG7_t PLM_REG7;
#define reg_PLM_MSE1_LANE_31_0_b0  PLM_REG7.BF.PLM_MSE1_LANE_31_0_b0
#define reg_PLM_MSE1_LANE_31_0_b1  PLM_REG7.BF.PLM_MSE1_LANE_31_0_b1
#define reg_PLM_MSE1_LANE_31_0_b2  PLM_REG7.BF.PLM_MSE1_LANE_31_0_b2
#define reg_PLM_MSE1_LANE_31_0_b3  PLM_REG7.BF.PLM_MSE1_LANE_31_0_b3

// 0x00cc	PLM_REG8		PLM Register 8
typedef union {
	struct {
		uint8_t PLM_MSE2_LANE_31_0_b0                    : 8;	/* [31:0]       r   0*/
		uint8_t PLM_MSE2_LANE_31_0_b1                    : 8;	/* [31:0]       r   0*/
		uint8_t PLM_MSE2_LANE_31_0_b2                    : 8;	/* [31:0]       r   0*/
		uint8_t PLM_MSE2_LANE_31_0_b3                    : 8;	/* [31:0]       r   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} PLM_REG8_t;
__xdata __at( 0x45cc ) volatile PLM_REG8_t PLM_REG8;
#define reg_PLM_MSE2_LANE_31_0_b0  PLM_REG8.BF.PLM_MSE2_LANE_31_0_b0
#define reg_PLM_MSE2_LANE_31_0_b1  PLM_REG8.BF.PLM_MSE2_LANE_31_0_b1
#define reg_PLM_MSE2_LANE_31_0_b2  PLM_REG8.BF.PLM_MSE2_LANE_31_0_b2
#define reg_PLM_MSE2_LANE_31_0_b3  PLM_REG8.BF.PLM_MSE2_LANE_31_0_b3

// 0x00d0	PLM_REG9		PLM Register 9
typedef union {
	struct {
		uint8_t PLM_MSE3_LANE_31_0_b0                    : 8;	/* [31:0]       r   0*/
		uint8_t PLM_MSE3_LANE_31_0_b1                    : 8;	/* [31:0]       r   0*/
		uint8_t PLM_MSE3_LANE_31_0_b2                    : 8;	/* [31:0]       r   0*/
		uint8_t PLM_MSE3_LANE_31_0_b3                    : 8;	/* [31:0]       r   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} PLM_REG9_t;
__xdata __at( 0x45d0 ) volatile PLM_REG9_t PLM_REG9;
#define reg_PLM_MSE3_LANE_31_0_b0  PLM_REG9.BF.PLM_MSE3_LANE_31_0_b0
#define reg_PLM_MSE3_LANE_31_0_b1  PLM_REG9.BF.PLM_MSE3_LANE_31_0_b1
#define reg_PLM_MSE3_LANE_31_0_b2  PLM_REG9.BF.PLM_MSE3_LANE_31_0_b2
#define reg_PLM_MSE3_LANE_31_0_b3  PLM_REG9.BF.PLM_MSE3_LANE_31_0_b3
