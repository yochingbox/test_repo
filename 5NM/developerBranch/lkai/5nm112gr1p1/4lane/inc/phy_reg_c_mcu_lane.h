...
typedef union {
	struct {
		...
		uint8_t MCU_XDATA_IN_SYNC_EN_LANE                : 1;	/*      9     r/w   0*/
...
#define reg_MCU_XDATA_IN_SYNC_EN_LANE  MCU_CONTROL_LANE.BF.MCU_XDATA_IN_SYNC_EN_LANE
...
typedef union {
	struct {
		...
		uint8_t RESERVED_11                              : 3;	/*[13:11]     r/w   0*/
		uint8_t PLL_RS_MCU_CTRL_SEL_LANE                 : 1;	/*     14     r/w   0*/
		uint8_t PLL_TS_MCU_CTRL_SEL_LANE                 : 1;	/*     15     r/w   0*/
...
#define reg_PLL_RS_MCU_CTRL_SEL_LANE  LANE_SYSTEM0.BF.PLL_RS_MCU_CTRL_SEL_LANE
#define reg_PLL_TS_MCU_CTRL_SEL_LANE  LANE_SYSTEM0.BF.PLL_TS_MCU_CTRL_SEL_LANE
...
// 0x0020	REG_SFT_RST_CTL0		Register Soft Reset Control 0
typedef union {
	struct {
		...
		uint8_t SFT_RST_RX_EQ_MON_MASK_EN_LANE           : 1;	/*      4     r/w   1*/
		uint8_t SFT_RST_RX_SKEW_CAL_MASK_EN_LANE         : 1;	/*      5     r/w   1*/
		uint8_t SFT_RST_RX_ADC_IF_MASK_EN_LANE           : 1;	/*      6     r/w   1*/
		uint8_t SFT_RST_RX_DP_MASK_EN_LANE               : 1;	/*      7     r/w   1*/
		uint8_t SFT_RST_RX_DTL_MASK_EN_LANE              : 1;	/*      8     r/w   1*/
...
__xdata __at( 0x3420 ) volatile REG_SFT_RST_CTL0_t REG_SFT_RST_CTL0;
...
#define reg_SFT_RST_RX_EQ_MON_MASK_EN_LANE  REG_SFT_RST_CTL0.BF.SFT_RST_RX_EQ_MON_MASK_EN_LANE
#define reg_SFT_RST_RX_SKEW_CAL_MASK_EN_LANE  REG_SFT_RST_CTL0.BF.SFT_RST_RX_SKEW_CAL_MASK_EN_LANE
#define reg_SFT_RST_RX_ADC_IF_MASK_EN_LANE  REG_SFT_RST_CTL0.BF.SFT_RST_RX_ADC_IF_MASK_EN_LANE
#define reg_SFT_RST_RX_DP_MASK_EN_LANE  REG_SFT_RST_CTL0.BF.SFT_RST_RX_DP_MASK_EN_LANE
#define reg_SFT_RST_RX_DTL_MASK_EN_LANE  REG_SFT_RST_CTL0.BF.SFT_RST_RX_DTL_MASK_EN_LANE
...
// 0x0024	REG_SFT_RST_CTL1		Register Soft Reset Control 1
typedef union {
	struct {
		...
		uint8_t SFT_RST_RX_EQ_MON_LANE                   : 1;	/*      4     r/w   0*/
		uint8_t SFT_RST_RX_SKEW_CAL_LANE                 : 1;	/*      5     r/w   0*/
		uint8_t SFT_RST_RX_ADC_IF_LANE                   : 1;	/*      6     r/w   0*/
		uint8_t SFT_RST_RX_DP_LANE                       : 1;	/*      7     r/w   0*/
		uint8_t SFT_RST_RX_DTL_LANE                      : 1;	/*      8     r/w   0*/
		...
		uint8_t RESERVED_27                              : 2;	/*[28:27]     r/w   0*/
...
__xdata __at( 0x3424 ) volatile REG_SFT_RST_CTL1_t REG_SFT_RST_CTL1;
...
#define reg_SFT_RST_RX_EQ_MON_LANE  REG_SFT_RST_CTL1.BF.SFT_RST_RX_EQ_MON_LANE
#define reg_SFT_RST_RX_SKEW_CAL_LANE  REG_SFT_RST_CTL1.BF.SFT_RST_RX_SKEW_CAL_LANE
#define reg_SFT_RST_RX_ADC_IF_LANE  REG_SFT_RST_CTL1.BF.SFT_RST_RX_ADC_IF_LANE
#define reg_SFT_RST_RX_DP_LANE  REG_SFT_RST_CTL1.BF.SFT_RST_RX_DP_LANE
#define reg_SFT_RST_RX_DTL_LANE  REG_SFT_RST_CTL1.BF.SFT_RST_RX_DTL_LANE
...
typedef union {
	struct {
		...
		uint8_t INT0_MCU_REMOTE_REQ_INT_EN_LANE          : 1;	/*      6     r/w   0*/
		uint8_t INT0_MCU_REMOTE_ACK_INT_EN_LANE          : 1;	/*      7     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t INT1_MCU_REMOTE_REQ_INT_EN_LANE          : 1;	/*      6     r/w   0*/
		uint8_t INT1_MCU_REMOTE_ACK_INT_EN_LANE          : 1;	/*      7     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/* [31:8]     r/w   0*/
	} BF;
...
typedef union {
	struct {
		...
		uint8_t INT2_MCU_REMOTE_REQ_INT_EN_LANE          : 1;	/*      6     r/w   0*/
		uint8_t INT2_MCU_REMOTE_ACK_INT_EN_LANE          : 1;	/*      7     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/* [31:8]     r/w   0*/
	} BF;
...
typedef union {
	struct {
		...
		uint8_t INT3_MCU_REMOTE_REQ_INT_EN_LANE          : 1;	/*      6     r/w   0*/
		uint8_t INT3_MCU_REMOTE_ACK_INT_EN_LANE          : 1;	/*      7     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/* [31:8]     r/w   0*/
	} BF;
...
typedef union {
	struct {
		...
		uint8_t INT4_MCU_REMOTE_REQ_INT_EN_LANE          : 1;	/*      6     r/w   0*/
		uint8_t INT4_MCU_REMOTE_ACK_INT_EN_LANE          : 1;	/*      7     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/* [31:8]     r/w   0*/
	} BF;
...
typedef union {
	struct {
		...
		uint8_t INT5_MCU_REMOTE_REQ_INT_EN_LANE          : 1;	/*      6     r/w   0*/
		uint8_t INT5_MCU_REMOTE_ACK_INT_EN_LANE          : 1;	/*      7     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/* [31:8]     r/w   0*/
	} BF;
...
typedef union {
	struct {
		...
		uint8_t INT6_MCU_REMOTE_REQ_INT_EN_LANE          : 1;	/*      6     r/w   0*/
		uint8_t INT6_MCU_REMOTE_ACK_INT_EN_LANE          : 1;	/*      7     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/* [31:8]     r/w   0*/
	} BF;
...
typedef union {
	struct {
		...
		uint8_t INT7_MCU_REMOTE_REQ_INT_EN_LANE          : 1;	/*      6     r/w   0*/
		uint8_t INT7_MCU_REMOTE_ACK_INT_EN_LANE          : 1;	/*      7     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/* [31:8]     r/w   0*/
	} BF;
...
typedef union {
	struct {
		...
		uint8_t INT8_MCU_REMOTE_REQ_INT_EN_LANE          : 1;	/*      6     r/w   0*/
		uint8_t INT8_MCU_REMOTE_ACK_INT_EN_LANE          : 1;	/*      7     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/* [31:8]     r/w   0*/
	} BF;
...
typedef union {
	struct {
		...
		uint8_t INT9_MCU_REMOTE_REQ_INT_EN_LANE          : 1;	/*      6     r/w   0*/
		uint8_t INT9_MCU_REMOTE_ACK_INT_EN_LANE          : 1;	/*      7     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/* [31:8]     r/w   0*/
	} BF;
...
typedef union {
	struct {
		...
		uint8_t INT10_MCU_REMOTE_REQ_INT_EN_LANE         : 1;	/*      6     r/w   0*/
		uint8_t INT10_MCU_REMOTE_ACK_INT_EN_LANE         : 1;	/*      7     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/* [31:8]     r/w   0*/
	} BF;
...
typedef union {
	struct {
		...
		uint8_t INT11_MCU_REMOTE_REQ_INT_EN_LANE         : 1;	/*      6     r/w   0*/
		uint8_t INT11_MCU_REMOTE_ACK_INT_EN_LANE         : 1;	/*      7     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/* [31:8]     r/w   0*/
	} BF;
...
typedef union {
	struct {
		...
		uint8_t INT12_MCU_REMOTE_REQ_INT_EN_LANE         : 1;	/*      6     r/w   0*/
		uint8_t INT12_MCU_REMOTE_ACK_INT_EN_LANE         : 1;	/*      7     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/* [31:8]     r/w   0*/
	} BF;
...
typedef union {
	struct {
		...
		uint8_t EXTINT_MCU_REMOTE_REQ_INT_EN_LANE        : 1;	/*      6     r/w   0*/
		uint8_t EXTINT_MCU_REMOTE_ACK_INT_EN_LANE        : 1;	/*      7     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/* [31:8]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/* [31:8]     r/w   0*/
	} BF;
...
typedef union {
	struct {
		...
		uint8_t IRAM_ECC_ERR_ADDR_LANE_7_0               : 8;	/*[23:16]       r   0*/
		uint8_t CACHE_ECC_ERR_ADDR_LANE_7_0              : 8;	/*[31:24]       r   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_IRAM_ECC_ERR_ADDR_LANE_7_0  MEM_ECC_ERR_ADDRESS0.BF.IRAM_ECC_ERR_ADDR_LANE_7_0
#define reg_CACHE_ECC_ERR_ADDR_LANE_7_0  MEM_ECC_ERR_ADDRESS0.BF.CACHE_ECC_ERR_ADDR_LANE_7_0
...
// 0x0128	MCU_COMMAND_INTERFACE1		mcu command interface register1
typedef union {
	struct {
	...
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} MCU_COMMAND_INTERFACE1_t;
__xdata __at( 0x3528 ) volatile MCU_COMMAND_INTERFACE1_t MCU_COMMAND_INTERFACE1;
#define reg_MCU_LOCAL_REQ_LANE  MCU_COMMAND_INTERFACE1.BF.MCU_LOCAL_REQ_LANE
#define reg_MCU_LOCAL_ACK_LANE  MCU_COMMAND_INTERFACE1.BF.MCU_LOCAL_ACK_LANE

// 0x012c	MCU_COMMAND_INTERFACE2		mcu command interface register2
typedef union {
	struct {
...
__xdata __at( 0x352c ) volatile MCU_COMMAND_INTERFACE2_t MCU_COMMAND_INTERFACE2;
#define reg_MCU_LOCAL_STATUS_LANE_31_0_b0  MCU_COMMAND_INTERFACE2.BF.MCU_LOCAL_STATUS_LANE_31_0_b0
#define reg_MCU_LOCAL_STATUS_LANE_31_0_b1  MCU_COMMAND_INTERFACE2.BF.MCU_LOCAL_STATUS_LANE_31_0_b1
#define reg_MCU_LOCAL_STATUS_LANE_31_0_b2  MCU_COMMAND_INTERFACE2.BF.MCU_LOCAL_STATUS_LANE_31_0_b2
#define reg_MCU_LOCAL_STATUS_LANE_31_0_b3  MCU_COMMAND_INTERFACE2.BF.MCU_LOCAL_STATUS_LANE_31_0_b3

// 0x0130	MCU_COMMAND_INTERFACE3		mcu command interface register3
typedef union {
	struct {
...
__xdata __at( 0x3530 ) volatile MCU_COMMAND_INTERFACE3_t MCU_COMMAND_INTERFACE3;
#define reg_MCU_LOCAL_COMMAND_LANE_31_0_b0  MCU_COMMAND_INTERFACE3.BF.MCU_LOCAL_COMMAND_LANE_31_0_b0
#define reg_MCU_LOCAL_COMMAND_LANE_31_0_b1  MCU_COMMAND_INTERFACE3.BF.MCU_LOCAL_COMMAND_LANE_31_0_b1
#define reg_MCU_LOCAL_COMMAND_LANE_31_0_b2  MCU_COMMAND_INTERFACE3.BF.MCU_LOCAL_COMMAND_LANE_31_0_b2
#define reg_MCU_LOCAL_COMMAND_LANE_31_0_b3  MCU_COMMAND_INTERFACE3.BF.MCU_LOCAL_COMMAND_LANE_31_0_b3

// 0x0134	ANA_IF_TRX_REG1		Analog Interface Register 1
typedef union {
	struct {
		uint8_t RESERVED_0                               : 8;	/* [20:0]     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [20:0]     r/w   0*/
		uint8_t RESERVED_16                              : 5;	/* [20:0]     r/w   0*/
		uint8_t TRX_CAL_CTRL_SEL_LANE                    : 1;	/*     21     r/w   0*/
		uint8_t ANA_REG_TRX_CAL_RST_LANE                 : 1;	/*     22     r/w   0*/
		uint8_t ANA_REG_TRX_CAL_FORCE_LANE               : 1;	/*     23     r/w   0*/
		uint8_t ANA_REG_RX_CAL_RST_LANE                  : 1;	/*     24     r/w   0*/
		uint8_t ANA_REG_RX_CAL_FORCE_LANE                : 1;	/*     25     r/w   0*/
		uint8_t ANA_REG_TX_CAL_RST_LANE                  : 1;	/*     26     r/w   0*/
		uint8_t ANA_REG_TX_CAL_FORCE_LANE                : 1;	/*     27     r/w   0*/
		uint8_t ANA_REG_RX_RST_LANE                      : 1;	/*     28     r/w   0*/
		uint8_t ANA_REG_RX_FORCE_LANE                    : 1;	/*     29     r/w   0*/
		uint8_t ANA_REG_TX_RST_LANE                      : 1;	/*     30     r/w   0*/
		uint8_t ANA_REG_TX_FORCE_LANE                    : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} ANA_IF_TRX_REG1_t;
__xdata __at( 0x3534 ) volatile ANA_IF_TRX_REG1_t ANA_IF_TRX_REG1;
#define reg_TRX_CAL_CTRL_SEL_LANE  ANA_IF_TRX_REG1.BF.TRX_CAL_CTRL_SEL_LANE
#define reg_ANA_REG_TRX_CAL_RST_LANE  ANA_IF_TRX_REG1.BF.ANA_REG_TRX_CAL_RST_LANE
#define reg_ANA_REG_TRX_CAL_FORCE_LANE  ANA_IF_TRX_REG1.BF.ANA_REG_TRX_CAL_FORCE_LANE
#define reg_ANA_REG_RX_CAL_RST_LANE  ANA_IF_TRX_REG1.BF.ANA_REG_RX_CAL_RST_LANE
#define reg_ANA_REG_RX_CAL_FORCE_LANE  ANA_IF_TRX_REG1.BF.ANA_REG_RX_CAL_FORCE_LANE
#define reg_ANA_REG_TX_CAL_RST_LANE  ANA_IF_TRX_REG1.BF.ANA_REG_TX_CAL_RST_LANE
#define reg_ANA_REG_TX_CAL_FORCE_LANE  ANA_IF_TRX_REG1.BF.ANA_REG_TX_CAL_FORCE_LANE
#define reg_ANA_REG_RX_RST_LANE  ANA_IF_TRX_REG1.BF.ANA_REG_RX_RST_LANE
#define reg_ANA_REG_RX_FORCE_LANE  ANA_IF_TRX_REG1.BF.ANA_REG_RX_FORCE_LANE
#define reg_ANA_REG_TX_RST_LANE  ANA_IF_TRX_REG1.BF.ANA_REG_TX_RST_LANE
#define reg_ANA_REG_TX_FORCE_LANE  ANA_IF_TRX_REG1.BF.ANA_REG_TX_FORCE_LANE
