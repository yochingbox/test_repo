...
typedef union {
	struct {
		...
		uint8_t PIN_SSC_EN_RD_LANE                       : 1;	/*     10       r   0*/
...
typedef union {
	struct {
		uint8_t PIN_STRX_TRAIN_CMD_IN_RD_LANE_31_16_b0   : 8;	/* [15:0]       r   0*/
		uint8_t PIN_STRX_TRAIN_CMD_IN_RD_LANE_31_16_b1   : 8;	/* [15:0]       r   0*/
		uint8_t PIN_TXDATA_PRE_CODE_EN_RD_LANE           : 1;	/*     16       r   0*/
		uint8_t PIN_TXDATA_GRAY_CODE_EN_RD_LANE          : 1;	/*     17       r   0*/
		uint8_t PIN_REFCLK_SEL_TX_RD_LANE                : 1;	/*     18       r   0*/
		uint8_t PIN_REF_FREF_SEL_TX_RD_LANE_4_0          : 5;	/*[23:19]       r   0*/
...
#define reg_PIN_STRX_TRAIN_CMD_IN_RD_LANE_31_16_b0  INPUT_PIN_DEBUG_TX_REG7.BF.PIN_STRX_TRAIN_CMD_IN_RD_LANE_31_16_b0
#define reg_PIN_STRX_TRAIN_CMD_IN_RD_LANE_31_16_b1  INPUT_PIN_DEBUG_TX_REG7.BF.PIN_STRX_TRAIN_CMD_IN_RD_LANE_31_16_b1
...
#define reg_PIN_REFCLK_SEL_TX_RD_LANE  INPUT_PIN_DEBUG_TX_REG7.BF.PIN_REFCLK_SEL_TX_RD_LANE
#define reg_PIN_REF_FREF_SEL_TX_RD_LANE_4_0  INPUT_PIN_DEBUG_TX_REG7.BF.PIN_REF_FREF_SEL_TX_RD_LANE_4_0
...
#define reg_PIN_STRX_TRAIN_CMD_IN_RD_LANE_31_16  INPUT_PIN_DEBUG_TX_REG7.WT.W0

// 0x0020	INPUT_PIN_DEBUG_TX_REG8		PHY Isolation Debug Register8
typedef union {
	struct {
		uint8_t PIN_STRX_TRAIN_COE_IN_RD_LANE_47_32_b0   : 8;	/* [15:0]       r   0*/
		uint8_t PIN_STRX_TRAIN_COE_IN_RD_LANE_47_32_b1   : 8;	/* [15:0]       r   0*/
		uint8_t PIN_STRX_TRAIN_CMD_IN_RD_LANE_15_0_b0    : 8;	/*[31:16]       r   0*/
		uint8_t PIN_STRX_TRAIN_CMD_IN_RD_LANE_15_0_b1    : 8;	/*[31:16]       r   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
...
#define reg_PIN_STRX_TRAIN_COE_IN_RD_LANE_47_32_b0  INPUT_PIN_DEBUG_TX_REG8.BF.PIN_STRX_TRAIN_COE_IN_RD_LANE_47_32_b0
#define reg_PIN_STRX_TRAIN_COE_IN_RD_LANE_47_32_b1  INPUT_PIN_DEBUG_TX_REG8.BF.PIN_STRX_TRAIN_COE_IN_RD_LANE_47_32_b1
#define reg_PIN_STRX_TRAIN_CMD_IN_RD_LANE_15_0_b0  INPUT_PIN_DEBUG_TX_REG8.BF.PIN_STRX_TRAIN_CMD_IN_RD_LANE_15_0_b0
#define reg_PIN_STRX_TRAIN_CMD_IN_RD_LANE_15_0_b1  INPUT_PIN_DEBUG_TX_REG8.BF.PIN_STRX_TRAIN_CMD_IN_RD_LANE_15_0_b1
#define reg_PIN_STRX_TRAIN_COE_IN_RD_LANE_47_32  INPUT_PIN_DEBUG_TX_REG8.WT.W0
#define reg_PIN_STRX_TRAIN_CMD_IN_RD_LANE_15_0  INPUT_PIN_DEBUG_TX_REG8.WT.W1

// 0x0024	INPUT_PIN_DEBUG_TX_REG9		PHY Isolation Debug Register9
typedef union {
	struct {
		uint8_t PIN_STRX_TRAIN_COE_IN_RD_LANE_31_0_b0    : 8;	/* [31:0]       r   0*/
		uint8_t PIN_STRX_TRAIN_COE_IN_RD_LANE_31_0_b1    : 8;	/* [31:0]       r   0*/
		uint8_t PIN_STRX_TRAIN_COE_IN_RD_LANE_31_0_b2    : 8;	/* [31:0]       r   0*/
		uint8_t PIN_STRX_TRAIN_COE_IN_RD_LANE_31_0_b3    : 8;	/* [31:0]       r   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} INPUT_PIN_DEBUG_TX_REG9_t;
__xdata __at( 0x5524 ) volatile INPUT_PIN_DEBUG_TX_REG9_t INPUT_PIN_DEBUG_TX_REG9;
#define reg_PIN_STRX_TRAIN_COE_IN_RD_LANE_31_0_b0  INPUT_PIN_DEBUG_TX_REG9.BF.PIN_STRX_TRAIN_COE_IN_RD_LANE_31_0_b0
#define reg_PIN_STRX_TRAIN_COE_IN_RD_LANE_31_0_b1  INPUT_PIN_DEBUG_TX_REG9.BF.PIN_STRX_TRAIN_COE_IN_RD_LANE_31_0_b1
#define reg_PIN_STRX_TRAIN_COE_IN_RD_LANE_31_0_b2  INPUT_PIN_DEBUG_TX_REG9.BF.PIN_STRX_TRAIN_COE_IN_RD_LANE_31_0_b2
#define reg_PIN_STRX_TRAIN_COE_IN_RD_LANE_31_0_b3  INPUT_PIN_DEBUG_TX_REG9.BF.PIN_STRX_TRAIN_COE_IN_RD_LANE_31_0_b3
...
typedef union {
	struct {
		...
		uint8_t COUPLE_MODE_EN_FM_REG_LANE               : 1;	/*     22     r/w   0*/
		uint8_t COUPLE_MODE_EN_LANE                      : 1;	/*     23     r/w   0*/
		uint8_t PIN_TXDCLK_2X_SEL_RD_LANE                : 1;	/*     24       r   0*/
		uint8_t PIN_TXDCLK_NT_EN_RD_LANE                 : 1;	/*     25       r   0*/
		uint8_t PIN_TXDCLK_4X_EN_RD_LANE                 : 1;	/*     26       r   0*/
		uint8_t PIN_STRX_TRAIN_EN_IN_RD_LANE             : 1;	/*     27       r   0*/
		uint8_t PIN_STRX_TRAIN_PAT_EN_IN_RD_LANE         : 1;	/*     28       r   0*/
		uint8_t PIN_STRX_TRAIN_PAT_CODE_SEL_IN_RD_LANE_1_0 : 2;	/*[30:29]       r   0*/
		uint8_t PIN_STRX_TRAIN_COE_VALID_IN_RD_LANE      : 1;	/*     31       r   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_PIN_TXDCLK_2X_SEL_RD_LANE  INPUT_PIN_DEBUG_TX_REG10.BF.PIN_TXDCLK_2X_SEL_RD_LANE
#define reg_PIN_TXDCLK_NT_EN_RD_LANE  INPUT_PIN_DEBUG_TX_REG10.BF.PIN_TXDCLK_NT_EN_RD_LANE
#define reg_PIN_TXDCLK_4X_EN_RD_LANE  INPUT_PIN_DEBUG_TX_REG10.BF.PIN_TXDCLK_4X_EN_RD_LANE
...
typedef union {
	struct {
		uint8_t TX_ACJTAG_IN_LANE                        : 1;	/*      0     r/w   0*/
		uint8_t TX_ACJTAG_EN_FM_REG_LANE                 : 1;	/*      1     r/w   0*/
		uint8_t TX_ACJTAG_EN_LANE                        : 1;	/*      2     r/w   0*/
		uint8_t SSC_EN_FM_REG_LANE                       : 1;	/*      3     r/w   0*/
		uint8_t SSC_EN_LANE                              : 1;	/*      4     r/w   0*/
		uint8_t REPEAT_MODE_EN_FM_REG_LANE               : 1;	/*      5     r/w   0*/
		uint8_t REPEAT_MODE_EN_LANE                      : 1;	/*      6     r/w   0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [23:8]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/* [23:8]     r/w   0*/
		uint8_t RESERVED_24                              : 4;	/*[27:24]     r/w   0*/
		uint8_t PU_TX_FM_REG_LANE                        : 1;	/*     28     r/w   0*/
		uint8_t PU_TX_LANE                               : 1;	/*     29     r/w   0*/
		uint8_t PU_PLL_FM_REG_LANE                       : 1;	/*     30     r/w   0*/
		uint8_t PU_PLL_LANE                              : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
...
#define reg_TX_ACJTAG_IN_LANE  INPUT_PIN_DEBUG_TX_REG11.BF.TX_ACJTAG_IN_LANE
#define reg_TX_ACJTAG_EN_FM_REG_LANE  INPUT_PIN_DEBUG_TX_REG11.BF.TX_ACJTAG_EN_FM_REG_LANE
#define reg_TX_ACJTAG_EN_LANE  INPUT_PIN_DEBUG_TX_REG11.BF.TX_ACJTAG_EN_LANE
#define reg_SSC_EN_FM_REG_LANE  INPUT_PIN_DEBUG_TX_REG11.BF.SSC_EN_FM_REG_LANE
#define reg_SSC_EN_LANE  INPUT_PIN_DEBUG_TX_REG11.BF.SSC_EN_LANE
#define reg_REPEAT_MODE_EN_FM_REG_LANE  INPUT_PIN_DEBUG_TX_REG11.BF.REPEAT_MODE_EN_FM_REG_LANE
#define reg_REPEAT_MODE_EN_LANE  INPUT_PIN_DEBUG_TX_REG11.BF.REPEAT_MODE_EN_LANE
...
typedef union {
	struct {
		...
		uint8_t TXDCLK_2X_SEL_FM_REG_LANE                : 1;	/*      6     r/w   0*/
		uint8_t TXDCLK_2X_SEL_LANE                       : 1;	/*      7     r/w   0*/
		uint8_t TXDCLK_NT_EN_FM_REG_LANE                 : 1;	/*      8     r/w   0*/
		uint8_t TXDCLK_NT_EN_LANE                        : 1;	/*      9     r/w   0*/
		uint8_t TXDCLK_4X_EN_FM_REG_LANE                 : 1;	/*     10     r/w   0*/
		uint8_t TXDCLK_4X_EN_LANE                        : 1;	/*     11     r/w   0*/
		...
		uint8_t RESET_CORE_TX_FM_REG_LANE                : 1;	/*     25     r/w   0*/
		uint8_t RESET_CORE_TX_LANE                       : 1;	/*     26     r/w   0*/
		uint8_t TXDCLK_NT_SEL_FM_REG_LANE                : 1;	/*     27     r/w   0*/
		uint8_t TXDCLK_NT_SEL_LANE_2_0                   : 3;	/*[30:28]     r/w   0*/
		uint8_t TX_ACJTAG_IN_FM_REG_LANE                 : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} INPUT_PIN_DEBUG_TX_REG12_t;
__xdata __at( 0x5530 ) volatile INPUT_PIN_DEBUG_TX_REG12_t INPUT_PIN_DEBUG_TX_REG12;
#define reg_TXDCLK_2X_SEL_FM_REG_LANE  INPUT_PIN_DEBUG_TX_REG12.BF.TXDCLK_2X_SEL_FM_REG_LANE
#define reg_TXDCLK_2X_SEL_LANE  INPUT_PIN_DEBUG_TX_REG12.BF.TXDCLK_2X_SEL_LANE
#define reg_TXDCLK_NT_EN_FM_REG_LANE  INPUT_PIN_DEBUG_TX_REG12.BF.TXDCLK_NT_EN_FM_REG_LANE
#define reg_TXDCLK_NT_EN_LANE  INPUT_PIN_DEBUG_TX_REG12.BF.TXDCLK_NT_EN_LANE
#define reg_TXDCLK_4X_EN_FM_REG_LANE  INPUT_PIN_DEBUG_TX_REG12.BF.TXDCLK_4X_EN_FM_REG_LANE
#define reg_TXDCLK_4X_EN_LANE  INPUT_PIN_DEBUG_TX_REG12.BF.TXDCLK_4X_EN_LANE
...
#define reg_REFCLK_SEL_TX_FM_REG_LANE  INPUT_PIN_DEBUG_TX_REG12.BF.REFCLK_SEL_TX_FM_REG_LANE
#define reg_REFCLK_SEL_TX_LANE  INPUT_PIN_DEBUG_TX_REG12.BF.REFCLK_SEL_TX_LANE
#define reg_REF_FREF_SEL_TX_FM_REG_LANE  INPUT_PIN_DEBUG_TX_REG12.BF.REF_FREF_SEL_TX_FM_REG_LANE
#define reg_REF_FREF_SEL_TX_LANE_4_0  INPUT_PIN_DEBUG_TX_REG12.BF.REF_FREF_SEL_TX_LANE_4_0
...
typedef union {
	struct {
		uint8_t ANA_TX_ANA_RSVD_OUT_RD_LANE_15_0_b0      : 8;	/* [15:0]       r   0*/
		uint8_t ANA_TX_ANA_RSVD_OUT_RD_LANE_15_0_b1      : 8;	/* [15:0]       r   0*/
		uint8_t ANA_TX_FIR_MON_VAL_RD_LANE_15_0_b0       : 8;	/*[31:16]       r   0*/
		uint8_t ANA_TX_FIR_MON_VAL_RD_LANE_15_0_b1       : 8;	/*[31:16]       r   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
...
#define reg_ANA_TX_ANA_RSVD_OUT_RD_LANE_15_0_b0  INPUT_PIN_DEBUG_TX_REG13.BF.ANA_TX_ANA_RSVD_OUT_RD_LANE_15_0_b0
#define reg_ANA_TX_ANA_RSVD_OUT_RD_LANE_15_0_b1  INPUT_PIN_DEBUG_TX_REG13.BF.ANA_TX_ANA_RSVD_OUT_RD_LANE_15_0_b1
#define reg_ANA_TX_FIR_MON_VAL_RD_LANE_15_0_b0  INPUT_PIN_DEBUG_TX_REG13.BF.ANA_TX_FIR_MON_VAL_RD_LANE_15_0_b0
#define reg_ANA_TX_FIR_MON_VAL_RD_LANE_15_0_b1  INPUT_PIN_DEBUG_TX_REG13.BF.ANA_TX_FIR_MON_VAL_RD_LANE_15_0_b1
#define reg_ANA_TX_ANA_RSVD_OUT_RD_LANE_15_0  INPUT_PIN_DEBUG_TX_REG13.WT.W0
#define reg_ANA_TX_FIR_MON_VAL_RD_LANE_15_0  INPUT_PIN_DEBUG_TX_REG13.WT.W1

// 0x0038	INPUT_PIN_DEBUG_TX_REG14		PHY Isolation Debug Register14
typedef union {
	struct {
		uint8_t RESERVED_0                               : 7;	/*  [6:0]     r/w   0*/
		uint8_t ANA_TX_FIR_MON_VAL_FM_REG_LANE           : 1;	/*      7     r/w   0*/
		uint8_t ANA_TX_FIR_MON_VAL_LANE_15_0_b0          : 8;	/* [23:8]     r/w   0*/
		uint8_t ANA_TX_FIR_MON_VAL_LANE_15_0_b1          : 8;	/* [23:8]     r/w   0*/
		uint8_t RESERVED_24                              : 6;	/*[29:24]     r/w   0*/
		uint8_t ANA_TX_TXCLK_DIV_RD_LANE                 : 1;	/*     30       r   0*/
...
#define reg_ANA_TX_FIR_MON_VAL_FM_REG_LANE  INPUT_PIN_DEBUG_TX_REG14.BF.ANA_TX_FIR_MON_VAL_FM_REG_LANE
#define reg_ANA_TX_FIR_MON_VAL_LANE_15_0_b0  INPUT_PIN_DEBUG_TX_REG14.BF.ANA_TX_FIR_MON_VAL_LANE_15_0_b0
#define reg_ANA_TX_FIR_MON_VAL_LANE_15_0_b1  INPUT_PIN_DEBUG_TX_REG14.BF.ANA_TX_FIR_MON_VAL_LANE_15_0_b1
#define reg_ANA_TX_TXCLK_DIV_RD_LANE  INPUT_PIN_DEBUG_TX_REG14.BF.ANA_TX_TXCLK_DIV_RD_LANE
#define reg_ANA_TX_TXDETRX_OUT_RD_LANE  INPUT_PIN_DEBUG_TX_REG14.BF.ANA_TX_TXDETRX_OUT_RD_LANE
#define reg_ANA_TX_FIR_MON_VAL_LANE_15_0  INPUT_PIN_DEBUG_TX_REG14.WT.W1
...
typedef union {
	struct {
		...
		uint8_t ANA_TX_TXCLK_DIV_FM_REG_LANE             : 1;	/*     13     r/w   0*/
		uint8_t ANA_TX_TXCLK_DIV_LANE                    : 1;	/*     14     r/w   0*/
...
#define reg_ANA_TX_TXCLK_DIV_FM_REG_LANE  INPUT_PIN_DEBUG_TX_REG15.BF.ANA_TX_TXCLK_DIV_FM_REG_LANE
#define reg_ANA_TX_TXCLK_DIV_LANE  INPUT_PIN_DEBUG_TX_REG15.BF.ANA_TX_TXCLK_DIV_LANE
#define reg_ANA_TX_ANA_RSVD_OUT_FM_REG_LANE  INPUT_PIN_DEBUG_TX_REG15.BF.ANA_TX_ANA_RSVD_OUT_FM_REG_LANE
#define reg_ANA_TX_ANA_RSVD_OUT_LANE_15_0_b0  INPUT_PIN_DEBUG_TX_REG15.BF.ANA_TX_ANA_RSVD_OUT_LANE_15_0_b0
#define reg_ANA_TX_ANA_RSVD_OUT_LANE_15_0_b1  INPUT_PIN_DEBUG_TX_REG15.BF.ANA_TX_ANA_RSVD_OUT_LANE_15_0_b1
#define reg_ANA_TX_ANA_RSVD_OUT_LANE_15_0  INPUT_PIN_DEBUG_TX_REG15.WT.W1
