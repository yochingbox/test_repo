...
int16_t drv_eom_chest_wa(void) BANKING_CTRL {
    ...
    chest_val0 = ((uint32_t)reg_CHEST_VAL_LANE_29_0_b3 << 27) |
                 ((uint32_t)reg_CHEST_VAL_LANE_29_0_b2 << 19) |
                 ((uint32_t)reg_CHEST_VAL_LANE_29_0_b1 << 11) |
                 ((uint32_t)reg_CHEST_VAL_LANE_29_0_b0 <<  3);
    ...
    chest_val1 = ((uint32_t)reg_CHEST_VAL_LANE_29_0_b3 << 27) |
                 ((uint32_t)reg_CHEST_VAL_LANE_29_0_b2 << 19) |
                 ((uint32_t)reg_CHEST_VAL_LANE_29_0_b1 << 11) |
                 ((uint32_t)reg_CHEST_VAL_LANE_29_0_b0 <<  3);
...
int16_t drv_eom_chest(void) BANKING_CTRL {
    ...
    chest_val = ((uint32_t)reg_CHEST_VAL_LANE_29_0_b3 << 27) |
                ((uint32_t)reg_CHEST_VAL_LANE_29_0_b2 << 19) |
                ((uint32_t)reg_CHEST_VAL_LANE_29_0_b1 << 11) |
                ((uint32_t)reg_CHEST_VAL_LANE_29_0_b0 <<  3);
