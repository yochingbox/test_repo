...
void drv_dtl_ph_opt (uint8_t cont_en) BANKING_CTRL 
{
    ...
    uint8_t sav_RX_DTL_LMS_FFE_PRE_EN_LANE_2_0;
    uint8_t sav_RX_DTL_LMS_FFE_PST_EN_LANE_2_0;
    ...
    sav_RX_DTL_LMS_FFE_PRE_EN_LANE_2_0 = reg_RX_DTL_LMS_FFE_PRE_EN_LANE_2_0;
    sav_RX_DTL_LMS_FFE_PST_EN_LANE_2_0 = reg_RX_DTL_LMS_FFE_PST_EN_LANE_2_0;

    //set LMS enable
    reg_RX_DP_LMS_TOP_EN_LANE = 0; //turn off LMS
    reg_RX_DTL_LMS_TOP_EN_LANE = 0;
    reg_RX_DTL_LMS_FFE_PRE_EN_LANE_2_0 = sav_RX_DTL_LMS_FFE_PRE_EN_LANE_2_0 & 0x6; //turn off PRE1
    reg_RX_DTL_LMS_FFE_PST_EN_LANE_2_0 = sav_RX_DTL_LMS_FFE_PST_EN_LANE_2_0 | 0x1; //turn on PST1
    ...
    reg_RX_DTL_LMS_FFE_PRE_LD_LANE_2_0 = 0x1;
    ...
    reg_RX_DTL_LMS_FFE_PRE_EN_LANE_2_0 = sav_RX_DTL_LMS_FFE_PRE_EN_LANE_2_0;
    reg_RX_DTL_LMS_FFE_PST_EN_LANE_2_0 = sav_RX_DTL_LMS_FFE_PST_EN_LANE_2_0;
