...
uint8_t saved_rx_eq_mon_clk_en;

//mse init, run before starting mse calculation
void drv_mse_init() {
        saved_rx_eq_mon_clk_en = reg_RX_EQ_MON_CLK_EN_LANE;
        reg_MSE_START_LANE = 0;
        reg_RX_EQ_MON_CLK_EN_LANE = 1;
        reg_MSE_EN_LANE = 1;
...
void drv_mse_exit() {
        reg_MSE_START_LANE = 0;
        reg_MSE_EN_LANE = 0;
        reg_RX_EQ_MON_CLK_EN_LANE = saved_rx_eq_mon_clk_en;
}
