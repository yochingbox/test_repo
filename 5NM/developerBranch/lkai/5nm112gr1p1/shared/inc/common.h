...
#define RX_BLIND_TRAIN_EN       0x0004
#define TXFFE_DET_PRESET_EN     0x0008
#define LOCK_CDR_EN             0x0010
#define ADC_CAL_EN              0x0020
#define SWEEP_COARSE_CTLE_EN    0x0040
#define TXFFE_SET_PRESET_EN     0x0080
#define TRX_OPT_EN              0x0100
#define TRX_FINAL_TUNE          0x0200
#define TRAIN_EXIT              0x0400
#define MAX_TRAIN_MODULE 11

#define TX_TRAIN_OPS 0x07bf //0111 1011 1111
#define RX_TRAIN_OPS 0x0737 //0111 0011 0111
...
#define PowerUp_Seq_Simple() PowerUp_Seq_Cal()
	...
	void is_pause(void) BANKING_CTRL;
