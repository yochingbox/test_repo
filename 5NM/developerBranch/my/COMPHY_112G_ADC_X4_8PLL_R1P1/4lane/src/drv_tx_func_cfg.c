...
// SAS pkt
       ...
       if ((phy_mode == PCIE) && (reg_PHY_GEN_TX_LANE_5_0 == 0x0 || reg_PHY_GEN_TX_LANE_5_0 == 0x1))
                reg_PCIE_GEN12_SEL_LANE = 0x1;
        else
                reg_PCIE_GEN12_SEL_LANE = 0x0;

        reg_TX_TRAIN_CODING_MODE_HW_RST_TX_LANE = 0x1;
        reg_TX_TRAIN_CODING_MODE_HW_RST_TX_LANE = 0x0;
