...
void loadspeedtbl_rx() BANKING_CTRL {
  ...
  uint8_t tmp2 = 0xC8; //RX_TOP_ANA_REG_35.BT.B0 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
  uint8_t tmp3 = 0x68; //RX_TOP_ANA_REG_33.BT.B0 , rx_ctle_cs1_ctrl_lane[4:0]
  ...
  uint8_t tmp8 = 0x3; //PLL_RS_CAL_CTRL_LANE.BT.B2 , rx_pll_rate_sel_lane[4:0]
  ...
  uint8_t tmp11 = 0x14; //RX_TOP_ANA_REG_38.BT.B0 , rx_ctle_rfb_sel_lane[1:0], rx_ctle_iptat_sel_lane[2:0], rx_pi_rsel_lane[1:0]
  uint8_t tmp12 = 0x8; //RX_TOP_ANA_REG_32.BT.B0 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
  uint8_t tmp13 = 0x0; //RX_TOP_ANA_REG_36.BT.B0 , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
  uint8_t tmp14 = 0xA0; //RX_TOP_ANA_REG_34.BT.B0 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
  ...
  uint8_t tmp17 = 0x33; //RX_SPD_TABLE_LANE.BT.B0 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
  ...
  if (gen_rx==47){
    ...
    tmp2 = 0x69;// RX_TOP_ANA_REG_35.BT.B0 = 01101001 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
    tmp3 = 0x38;// RX_TOP_ANA_REG_33.BT.B0 = 00111### , rx_ctle_cs1_ctrl_lane[4:0]
    tmp6 = 0x2A;// RX_TOP_ANA_REG_39.BT.B0 = 0010101# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp8 = 0x0;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###00000 , rx_pll_rate_sel_lane[4:0]
    ...
    tmp13 = 0x50;// RX_TOP_ANA_REG_36.BT.B0 = 010100## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    ...
    tmp17 = 0x22;// RX_SPD_TABLE_LANE.BT.B0 = #010#010 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
  }
  else if (gen_rx==46){
    tmp1 = 0xD8;// RX_TOP_ANA_REG_40.BT.B0 = 11011### , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
    tmp2 = 0xA;// RX_TOP_ANA_REG_35.BT.B0 = 00001010 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
    ...
    tmp8 = 0x6;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###00110 , rx_pll_rate_sel_lane[4:0]
    tmp12 = 0x70;// RX_TOP_ANA_REG_32.BT.B0 = 01110000 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    ...
    tmp8 = 0x16;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###10110 , rx_pll_rate_sel_lane[4:0]
    tmp9 = 0x4;// ANA_RX_PI_REG0.BT.B0 = ####0100 , rx_pi_icclow_ctrl_lane[3:0]
    tmp10 = 0x2;// ANA_RX_PI_REG1.BT.B0 = ####0010 , rx_pi_icc_ctrl_lane[3:0]
    tmp11 = 0x5E;// RX_TOP_ANA_REG_38.BT.B0 = 0101111# , rx_ctle_rfb_sel_lane[1:0], rx_ctle_iptat_sel_lane[2:0], rx_pi_rsel_lane[1:0]
    tmp13 = 0xA0;// RX_TOP_ANA_REG_36.BT.B0 = 101000## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp14 = 0x88;// RX_TOP_ANA_REG_34.BT.B0 = 10001000 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    ...
    tmp6 = 0x28;// RX_TOP_ANA_REG_39.BT.B0 = 0010100# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp7 = 0x0;// INPUT_RX_PIN_REG0_LANE.BT.B0 = #######0 , rx_pam2_en_lane
    tmp8 = 0x15;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###10101 , rx_pll_rate_sel_lane[4:0]
    tmp9 = 0x4;// ANA_RX_PI_REG0.BT.B0 = ####0100 , rx_pi_icclow_ctrl_lane[3:0]
    tmp10 = 0x2;// ANA_RX_PI_REG1.BT.B0 = ####0010 , rx_pi_icc_ctrl_lane[3:0]
    tmp11 = 0x5E;// RX_TOP_ANA_REG_38.BT.B0 = 0101111# , rx_ctle_rfb_sel_lane[1:0], rx_ctle_iptat_sel_lane[2:0], rx_pi_rsel_lane[1:0]
    tmp13 = 0xA0;// RX_TOP_ANA_REG_36.BT.B0 = 101000## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    ...
    tmp1 = 0x30;// RX_TOP_ANA_REG_40.BT.B0 = 00110### , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
    tmp2 = 0xC4;// RX_TOP_ANA_REG_35.BT.B0 = 11000100 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
    tmp4 = 0x3;// RX_EQ_REG0.BT.B0 = ####0011 , rx_eq_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp5 = 0xC;// TX_TRAIN_PATTTERN_REG0.BT.B1 = ####11## , ethernet_mode_lane[1:0]
    tmp7 = 0x0;// INPUT_RX_PIN_REG0_LANE.BT.B0 = #######0 , rx_pam2_en_lane
    tmp8 = 0x14;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###10100 , rx_pll_rate_sel_lane[4:0]
    tmp9 = 0xB;// ANA_RX_PI_REG0.BT.B0 = ####1011 , rx_pi_icclow_ctrl_lane[3:0]
    tmp10 = 0xB;// ANA_RX_PI_REG1.BT.B0 = ####1011 , rx_pi_icc_ctrl_lane[3:0]
    tmp11 = 0xE0;// RX_TOP_ANA_REG_38.BT.B0 = 1110000# , rx_ctle_rfb_sel_lane[1:0], rx_ctle_iptat_sel_lane[2:0], rx_pi_rsel_lane[1:0]
    tmp12 = 0xF;// RX_TOP_ANA_REG_32.BT.B0 = 00001111 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp13 = 0xFC;// RX_TOP_ANA_REG_36.BT.B0 = 111111## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp14 = 0x6F;// RX_TOP_ANA_REG_34.BT.B0 = 01101111 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    ...
    tmp5 = 0xC;// TX_TRAIN_PATTTERN_REG0.BT.B1 = ####11## , ethernet_mode_lane[1:0]
    tmp7 = 0x0;// INPUT_RX_PIN_REG0_LANE.BT.B0 = #######0 , rx_pam2_en_lane
    tmp8 = 0x12;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###10010 , rx_pll_rate_sel_lane[4:0]
    tmp9 = 0xB;// ANA_RX_PI_REG0.BT.B0 = ####1011 , rx_pi_icclow_ctrl_lane[3:0]
    tmp10 = 0xB;// ANA_RX_PI_REG1.BT.B0 = ####1011 , rx_pi_icc_ctrl_lane[3:0]
    tmp11 = 0xE0;// RX_TOP_ANA_REG_38.BT.B0 = 1110000# , rx_ctle_rfb_sel_lane[1:0], rx_ctle_iptat_sel_lane[2:0], rx_pi_rsel_lane[1:0]
    tmp12 = 0xF;// RX_TOP_ANA_REG_32.BT.B0 = 00001111 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    ...
    tmp5 = 0xC;// TX_TRAIN_PATTTERN_REG0.BT.B1 = ####11## , ethernet_mode_lane[1:0]
    tmp7 = 0x0;// INPUT_RX_PIN_REG0_LANE.BT.B0 = #######0 , rx_pam2_en_lane
    tmp8 = 0x10;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###10000 , rx_pll_rate_sel_lane[4:0]
    tmp9 = 0xB;// ANA_RX_PI_REG0.BT.B0 = ####1011 , rx_pi_icclow_ctrl_lane[3:0]
    tmp10 = 0xB;// ANA_RX_PI_REG1.BT.B0 = ####1011 , rx_pi_icc_ctrl_lane[3:0]
    tmp11 = 0xE0;// RX_TOP_ANA_REG_38.BT.B0 = 1110000# , rx_ctle_rfb_sel_lane[1:0], rx_ctle_iptat_sel_lane[2:0], rx_pi_rsel_lane[1:0]
    tmp12 = 0xF;// RX_TOP_ANA_REG_32.BT.B0 = 00001111 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    ...
    tmp5 = 0x8;// TX_TRAIN_PATTTERN_REG0.BT.B1 = ####10## , ethernet_mode_lane[1:0]
    tmp7 = 0x0;// INPUT_RX_PIN_REG0_LANE.BT.B0 = #######0 , rx_pam2_en_lane
    tmp8 = 0x13;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###10011 , rx_pll_rate_sel_lane[4:0]
    tmp9 = 0xB;// ANA_RX_PI_REG0.BT.B0 = ####1011 , rx_pi_icclow_ctrl_lane[3:0]
    tmp10 = 0xB;// ANA_RX_PI_REG1.BT.B0 = ####1011 , rx_pi_icc_ctrl_lane[3:0]
    tmp11 = 0x58;// RX_TOP_ANA_REG_38.BT.B0 = 0101100# , rx_ctle_rfb_sel_lane[1:0], rx_ctle_iptat_sel_lane[2:0], rx_pi_rsel_lane[1:0]
    tmp13 = 0xA0;// RX_TOP_ANA_REG_36.BT.B0 = 101000## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    ...
    tmp13 = 0x5C;// RX_TOP_ANA_REG_36.BT.B0 = 010111## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    ...
    tmp5 = 0x8;// TX_TRAIN_PATTTERN_REG0.BT.B1 = ####10## , ethernet_mode_lane[1:0]
    tmp7 = 0x0;// INPUT_RX_PIN_REG0_LANE.BT.B0 = #######0 , rx_pam2_en_lane
    tmp8 = 0xE;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###01110 , rx_pll_rate_sel_lane[4:0]
    tmp9 = 0xB;// ANA_RX_PI_REG0.BT.B0 = ####1011 , rx_pi_icclow_ctrl_lane[3:0]
    tmp10 = 0xB;// ANA_RX_PI_REG1.BT.B0 = ####1011 , rx_pi_icc_ctrl_lane[3:0]
    tmp11 = 0x58;// RX_TOP_ANA_REG_38.BT.B0 = 0101100# , rx_ctle_rfb_sel_lane[1:0], rx_ctle_iptat_sel_lane[2:0], rx_pi_rsel_lane[1:0]
    tmp12 = 0x7;// RX_TOP_ANA_REG_32.BT.B0 = 00000111 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    ...
    tmp8 = 0xC;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###01100 , rx_pll_rate_sel_lane[4:0]
    tmp9 = 0x9;// ANA_RX_PI_REG0.BT.B0 = ####1001 , rx_pi_icclow_ctrl_lane[3:0]
    tmp10 = 0x8;// ANA_RX_PI_REG1.BT.B0 = ####1000 , rx_pi_icc_ctrl_lane[3:0]
    tmp11 = 0xE2;// RX_TOP_ANA_REG_38.BT.B0 = 1110001# , rx_ctle_rfb_sel_lane[1:0], rx_ctle_iptat_sel_lane[2:0], rx_pi_rsel_lane[1:0]
    tmp12 = 0xE;// RX_TOP_ANA_REG_32.BT.B0 = 00001110 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp13 = 0xF8;// RX_TOP_ANA_REG_36.BT.B0 = 111110## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp14 = 0x6E;// RX_TOP_ANA_REG_34.BT.B0 = 01101110 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    tmp15 = 0x20;// SYSTEM_CONFIG_0.BT.B2 = #01##### , rx_nt_mul_lane[1:0], pll_tsrs_switch_xdat_lane, pll_sel_lane[1:0], mcu_ctrl_pll_lane[1:0]
    tmp17 = 0x24;// RX_SPD_TABLE_LANE.BT.B0 = #010#100 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
  }
  else if (gen_rx==32){
    ...
    tmp6 = 0x60;// RX_TOP_ANA_REG_39.BT.B0 = 0110000# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp7 = 0x0;// INPUT_RX_PIN_REG0_LANE.BT.B0 = #######0 , rx_pam2_en_lane
    tmp8 = 0x8;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###01000 , rx_pll_rate_sel_lane[4:0]
    tmp9 = 0x9;// ANA_RX_PI_REG0.BT.B0 = ####1001 , rx_pi_icclow_ctrl_lane[3:0]
    tmp10 = 0x8;// ANA_RX_PI_REG1.BT.B0 = ####1000 , rx_pi_icc_ctrl_lane[3:0]
    ...
    tmp13 = 0x58;// RX_TOP_ANA_REG_36.BT.B0 = 010110## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    ...
    tmp7 = 0x0;// INPUT_RX_PIN_REG0_LANE.BT.B0 = #######0 , rx_pam2_en_lane
    tmp8 = 0x1;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###00001 , rx_pll_rate_sel_lane[4:0]
    tmp9 = 0x4;// ANA_RX_PI_REG0.BT.B0 = ####0100 , rx_pi_icclow_ctrl_lane[3:0]
    tmp10 = 0x2;// ANA_RX_PI_REG1.BT.B0 = ####0010 , rx_pi_icc_ctrl_lane[3:0]
    tmp11 = 0x5E;// RX_TOP_ANA_REG_38.BT.B0 = 0101111# , rx_ctle_rfb_sel_lane[1:0], rx_ctle_iptat_sel_lane[2:0], rx_pi_rsel_lane[1:0]
    tmp12 = 0x4;// RX_TOP_ANA_REG_32.BT.B0 = 00000100 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    ...
    tmp0 = 0x77;// RX_TOP_ANA_REG_37.BT.B0 = 01110111 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0x50;// RX_TOP_ANA_REG_40.BT.B0 = 01010### , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
    tmp8 = 0x11;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###10001 , rx_pll_rate_sel_lane[4:0]
    tmp9 = 0xB;// ANA_RX_PI_REG0.BT.B0 = ####1011 , rx_pi_icclow_ctrl_lane[3:0]
    tmp10 = 0xB;// ANA_RX_PI_REG1.BT.B0 = ####1011 , rx_pi_icc_ctrl_lane[3:0]
    tmp11 = 0x58;// RX_TOP_ANA_REG_38.BT.B0 = 0101100# , rx_ctle_rfb_sel_lane[1:0], rx_ctle_iptat_sel_lane[2:0], rx_pi_rsel_lane[1:0]
    tmp12 = 0x7;// RX_TOP_ANA_REG_32.BT.B0 = 00000111 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    ...
    tmp0 = 0x68;// RX_TOP_ANA_REG_37.BT.B0 = 01101000 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp6 = 0x60;// RX_TOP_ANA_REG_39.BT.B0 = 0110000# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp8 = 0x9;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###01001 , rx_pll_rate_sel_lane[4:0]
    tmp9 = 0x9;// ANA_RX_PI_REG0.BT.B0 = ####1001 , rx_pi_icclow_ctrl_lane[3:0]
    tmp10 = 0x8;// ANA_RX_PI_REG1.BT.B0 = ####1000 , rx_pi_icc_ctrl_lane[3:0]
    tmp11 = 0x5A;// RX_TOP_ANA_REG_38.BT.B0 = 0101101# , rx_ctle_rfb_sel_lane[1:0], rx_ctle_iptat_sel_lane[2:0], rx_pi_rsel_lane[1:0]
    tmp12 = 0x6;// RX_TOP_ANA_REG_32.BT.B0 = 00000110 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    ...
    tmp6 = 0x60;// RX_TOP_ANA_REG_39.BT.B0 = 0110000# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp8 = 0x6;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###00110 , rx_pll_rate_sel_lane[4:0]
    tmp11 = 0x5C;// RX_TOP_ANA_REG_38.BT.B0 = 0101110# , rx_ctle_rfb_sel_lane[1:0], rx_ctle_iptat_sel_lane[2:0], rx_pi_rsel_lane[1:0]
    tmp12 = 0x5;// RX_TOP_ANA_REG_32.BT.B0 = 00000101 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp13 = 0x54;// RX_TOP_ANA_REG_36.BT.B0 = 010101## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    ...
    tmp8 = 0xD;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###01101 , rx_pll_rate_sel_lane[4:0]
    tmp9 = 0xB;// ANA_RX_PI_REG0.BT.B0 = ####1011 , rx_pi_icclow_ctrl_lane[3:0]
    tmp10 = 0xB;// ANA_RX_PI_REG1.BT.B0 = ####1011 , rx_pi_icc_ctrl_lane[3:0]
    tmp11 = 0x10;// RX_TOP_ANA_REG_38.BT.B0 = 0001000# , rx_ctle_rfb_sel_lane[1:0], rx_ctle_iptat_sel_lane[2:0], rx_pi_rsel_lane[1:0]
    ...
    tmp14 = 0x93;// RX_TOP_ANA_REG_34.BT.B0 = 10010011 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    ...
    tmp9 = 0x9;// ANA_RX_PI_REG0.BT.B0 = ####1001 , rx_pi_icclow_ctrl_lane[3:0]
    tmp10 = 0x8;// ANA_RX_PI_REG1.BT.B0 = ####1000 , rx_pi_icc_ctrl_lane[3:0]
    tmp11 = 0x12;// RX_TOP_ANA_REG_38.BT.B0 = 0001001# , rx_ctle_rfb_sel_lane[1:0], rx_ctle_iptat_sel_lane[2:0], rx_pi_rsel_lane[1:0]
    tmp12 = 0x3;// RX_TOP_ANA_REG_32.BT.B0 = 00000011 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp13 = 0xC;// RX_TOP_ANA_REG_36.BT.B0 = 000011## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp14 = 0x93;// RX_TOP_ANA_REG_34.BT.B0 = 10010011 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    tmp16 = 0x8;// SYSTEM_CONFIG_0.BT.B3 = 00001000 , rx_rate_2_pll_ratio_x8_lane[7:0]
    ...
    tmp4 = 0x1;// RX_EQ_REG0.BT.B0 = ####0001 , rx_eq_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp6 = 0x62;// RX_TOP_ANA_REG_39.BT.B0 = 0110001# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp8 = 0xA;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###01010 , rx_pll_rate_sel_lane[4:0]
    tmp9 = 0x9;// ANA_RX_PI_REG0.BT.B0 = ####1001 , rx_pi_icclow_ctrl_lane[3:0]
    tmp10 = 0x8;// ANA_RX_PI_REG1.BT.B0 = ####1000 , rx_pi_icc_ctrl_lane[3:0]
    tmp11 = 0x12;// RX_TOP_ANA_REG_38.BT.B0 = 0001001# , rx_ctle_rfb_sel_lane[1:0], rx_ctle_iptat_sel_lane[2:0], rx_pi_rsel_lane[1:0]
    tmp12 = 0x3;// RX_TOP_ANA_REG_32.BT.B0 = 00000011 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    ...
    tmp4 = 0x1;// RX_EQ_REG0.BT.B0 = ####0001 , rx_eq_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp6 = 0x62;// RX_TOP_ANA_REG_39.BT.B0 = 0110001# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp8 = 0x7;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###00111 , rx_pll_rate_sel_lane[4:0]
    tmp12 = 0x3;// RX_TOP_ANA_REG_32.BT.B0 = 00000011 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp13 = 0xC;// RX_TOP_ANA_REG_36.BT.B0 = 000011## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp14 = 0x93;// RX_TOP_ANA_REG_34.BT.B0 = 10010011 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    tmp16 = 0x8;// SYSTEM_CONFIG_0.BT.B3 = 00001000 , rx_rate_2_pll_ratio_x8_lane[7:0]
    ...
    tmp1 = 0xD8;// RX_TOP_ANA_REG_40.BT.B0 = 11011### , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
    tmp2 = 0x39;// RX_TOP_ANA_REG_35.BT.B0 = 00111001 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
    tmp3 = 0x10;// RX_TOP_ANA_REG_33.BT.B0 = 00010### , rx_ctle_cs1_ctrl_lane[4:0]
    tmp4 = 0x1;// RX_EQ_REG0.BT.B0 = ####0001 , rx_eq_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp6 = 0x62;// RX_TOP_ANA_REG_39.BT.B0 = 0110001# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp8 = 0x6;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###00110 , rx_pll_rate_sel_lane[4:0]
    ...
    tmp4 = 0x1;// RX_EQ_REG0.BT.B0 = ####0001 , rx_eq_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp6 = 0x62;// RX_TOP_ANA_REG_39.BT.B0 = 0110001# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp8 = 0x5;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###00101 , rx_pll_rate_sel_lane[4:0]
    tmp12 = 0x2;// RX_TOP_ANA_REG_32.BT.B0 = 00000010 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp13 = 0x8;// RX_TOP_ANA_REG_36.BT.B0 = 000010## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp14 = 0xA2;// RX_TOP_ANA_REG_34.BT.B0 = 10100010 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    tmp16 = 0x8;// SYSTEM_CONFIG_0.BT.B3 = 00001000 , rx_rate_2_pll_ratio_x8_lane[7:0]
    ...
    tmp2 = 0x3A;// RX_TOP_ANA_REG_35.BT.B0 = 00111010 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
    tmp3 = 0x10;// RX_TOP_ANA_REG_33.BT.B0 = 00010### , rx_ctle_cs1_ctrl_lane[4:0]
    tmp4 = 0x1;// RX_EQ_REG0.BT.B0 = ####0001 , rx_eq_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp6 = 0x6C;// RX_TOP_ANA_REG_39.BT.B0 = 0110110# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp8 = 0x2;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###00010 , rx_pll_rate_sel_lane[4:0]
    ...
    tmp14 = 0xA1;// RX_TOP_ANA_REG_34.BT.B0 = 10100001 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    tmp16 = 0x8;// SYSTEM_CONFIG_0.BT.B3 = 00001000 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp18 = 0x23;// RX_SPD_TABLE_LANE.BT.B1 = #010#011 , rx_rxclk_2x_div_ratio_lane[2:0], rx_rxclk_div_ratio_lane[2:0]
    tmp19 = 0x1;// RX_SPD_TABLE_LANE.BT.B2 = #####001 , rx_rxclk_4x_div_ratio_lane[2:0]
  }
    ...
    tmp9 = 0x4;// ANA_RX_PI_REG0.BT.B0 = ####0100 , rx_pi_icclow_ctrl_lane[3:0]
    tmp10 = 0x2;// ANA_RX_PI_REG1.BT.B0 = ####0010 , rx_pi_icc_ctrl_lane[3:0]
    tmp11 = 0x16;// RX_TOP_ANA_REG_38.BT.B0 = 0001011# , rx_ctle_rfb_sel_lane[1:0], rx_ctle_iptat_sel_lane[2:0], rx_pi_rsel_lane[1:0]
    tmp12 = 0x1;// RX_TOP_ANA_REG_32.BT.B0 = 00000001 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp13 = 0x4;// RX_TOP_ANA_REG_36.BT.B0 = 000001## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp14 = 0xA1;// RX_TOP_ANA_REG_34.BT.B0 = 10100001 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    tmp16 = 0x8;// SYSTEM_CONFIG_0.BT.B3 = 00001000 , rx_rate_2_pll_ratio_x8_lane[7:0]
    ...
    tmp4 = 0x0;// RX_EQ_REG0.BT.B0 = ####0000 , rx_eq_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp6 = 0x64;// RX_TOP_ANA_REG_39.BT.B0 = 0110010# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp8 = 0xB;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###01011 , rx_pll_rate_sel_lane[4:0]
    tmp9 = 0x9;// ANA_RX_PI_REG0.BT.B0 = ####1001 , rx_pi_icclow_ctrl_lane[3:0]
    tmp10 = 0x8;// ANA_RX_PI_REG1.BT.B0 = ####1000 , rx_pi_icc_ctrl_lane[3:0]
    tmp11 = 0x12;// RX_TOP_ANA_REG_38.BT.B0 = 0001001# , rx_ctle_rfb_sel_lane[1:0], rx_ctle_iptat_sel_lane[2:0], rx_pi_rsel_lane[1:0]
    tmp12 = 0x1;// RX_TOP_ANA_REG_32.BT.B0 = 00000001 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    ...
    tmp4 = 0x0;// RX_EQ_REG0.BT.B0 = ####0000 , rx_eq_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp6 = 0x64;// RX_TOP_ANA_REG_39.BT.B0 = 0110010# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp8 = 0x4;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###00100 , rx_pll_rate_sel_lane[4:0]
    tmp12 = 0x0;// RX_TOP_ANA_REG_32.BT.B0 = 00000000 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp16 = 0x4;// SYSTEM_CONFIG_0.BT.B3 = 00000100 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp17 = 0x43;// RX_SPD_TABLE_LANE.BT.B0 = #100#011 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
    tmp18 = 0x34;// RX_SPD_TABLE_LANE.BT.B1 = #011#100 , rx_rxclk_2x_div_ratio_lane[2:0], rx_rxclk_div_ratio_lane[2:0]
    ...
    tmp6 = 0x6C;// RX_TOP_ANA_REG_39.BT.B0 = 0110110# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp8 = 0x2;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###00010 , rx_pll_rate_sel_lane[4:0]
    tmp12 = 0x20;// RX_TOP_ANA_REG_32.BT.B0 = 00100000 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp16 = 0x4;// SYSTEM_CONFIG_0.BT.B3 = 00000100 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp17 = 0x43;// RX_SPD_TABLE_LANE.BT.B0 = #100#011 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
    tmp18 = 0x34;// RX_SPD_TABLE_LANE.BT.B1 = #011#100 , rx_rxclk_2x_div_ratio_lane[2:0], rx_rxclk_div_ratio_lane[2:0]
    tmp19 = 0x2;// RX_SPD_TABLE_LANE.BT.B2 = #####010 , rx_rxclk_4x_div_ratio_lane[2:0]
    ...
    tmp10 = 0x8;// ANA_RX_PI_REG1.BT.B0 = ####1000 , rx_pi_icc_ctrl_lane[3:0]
    tmp11 = 0x12;// RX_TOP_ANA_REG_38.BT.B0 = 0001001# , rx_ctle_rfb_sel_lane[1:0], rx_ctle_iptat_sel_lane[2:0], rx_pi_rsel_lane[1:0]
    tmp12 = 0x50;// RX_TOP_ANA_REG_32.BT.B0 = 01010000 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp16 = 0x2;// SYSTEM_CONFIG_0.BT.B3 = 00000010 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp17 = 0x53;// RX_SPD_TABLE_LANE.BT.B0 = #101#011 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
    tmp18 = 0x45;// RX_SPD_TABLE_LANE.BT.B1 = #100#101 , rx_rxclk_2x_div_ratio_lane[2:0], rx_rxclk_div_ratio_lane[2:0]
    tmp19 = 0x3;// RX_SPD_TABLE_LANE.BT.B2 = #####011 , rx_rxclk_4x_div_ratio_lane[2:0]
    ...
    tmp6 = 0x6C;// RX_TOP_ANA_REG_39.BT.B0 = 0110110# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp8 = 0x2;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###00010 , rx_pll_rate_sel_lane[4:0]
    tmp12 = 0x80;// RX_TOP_ANA_REG_32.BT.B0 = 10000000 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp16 = 0x2;// SYSTEM_CONFIG_0.BT.B3 = 00000010 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp17 = 0x53;// RX_SPD_TABLE_LANE.BT.B0 = #101#011 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
    tmp18 = 0x45;// RX_SPD_TABLE_LANE.BT.B1 = #100#101 , rx_rxclk_2x_div_ratio_lane[2:0], rx_rxclk_div_ratio_lane[2:0]
    tmp19 = 0x3;// RX_SPD_TABLE_LANE.BT.B2 = #####011 , rx_rxclk_4x_div_ratio_lane[2:0]
    ...
    tmp6 = 0x64;// RX_TOP_ANA_REG_39.BT.B0 = 0110010# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp8 = 0x4;// PLL_RS_CAL_CTRL_LANE.BT.B2 = ###00100 , rx_pll_rate_sel_lane[4:0]
    tmp12 = 0xB0;// RX_TOP_ANA_REG_32.BT.B0 = 10110000 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
  ...
  PLL_RS_CAL_CTRL_LANE.BT.B2 = tmp8;
...
void loadspeedtbl_tx() BANKING_CTRL {
  ...
  uint8_t tmp5 = 0x3; //PLL_RS_CAL_CTRL_LANE.BT.B3 , tx_pll_rate_sel_lane[4:0]
  uint8_t tmp6 = 0x2; //ANA_TXSPEED_REG0.BT.B0 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
  ...
  if (gen_tx==47){
    ...
    tmp5 = 0x0;// PLL_RS_CAL_CTRL_LANE.BT.B3 = ###00000 , tx_pll_rate_sel_lane[4:0]
    tmp6 = 0x1;// ANA_TXSPEED_REG0.BT.B0 = 000##001 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
  }
  else if (gen_tx==46){
    ...
    tmp5 = 0x6;// PLL_RS_CAL_CTRL_LANE.BT.B3 = ###00110 , tx_pll_rate_sel_lane[4:0]
    ...
    tmp5 = 0x16;// PLL_RS_CAL_CTRL_LANE.BT.B3 = ###10110 , tx_pll_rate_sel_lane[4:0]
    ...
    tmp1 = 0x60;// PHYTEST_TX0.BT.B2 = 011##### , tx_train_pat_sel_lane[2:0]
    tmp2 = 0x12;// TX_TRAINING_IF_REG3.BT.B0 = ###1##10 , tx_train_pat_two_zero_lane, ethernet_mode_tx_lane[1:0]
    tmp5 = 0x15;// PLL_RS_CAL_CTRL_LANE.BT.B3 = ###10101 , tx_pll_rate_sel_lane[4:0]
    tmp6 = 0x60;// ANA_TXSPEED_REG0.BT.B0 = 011##000 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
    tmp7 = 0x2;// TX_SYSTEM_LANE0.BT.B1 = ######10 , tx_data_width_lane[1:0]
  }
  else if (gen_tx==43){
    ...
    tmp5 = 0x14;// PLL_RS_CAL_CTRL_LANE.BT.B3 = ###10100 , tx_pll_rate_sel_lane[4:0]
    ...
    tmp2 = 0x13;// TX_TRAINING_IF_REG3.BT.B0 = ###1##11 , tx_train_pat_two_zero_lane, ethernet_mode_tx_lane[1:0]
    tmp3 = 0xCC;// ANA_TXREG_REG0.BT.B0 = 11001100 , txreg_speedtrk_data_lane[3:0], txreg_speedtrk_clk_lane[3:0]
    tmp5 = 0x12;// PLL_RS_CAL_CTRL_LANE.BT.B3 = ###10010 , tx_pll_rate_sel_lane[4:0]
    ...
    tmp2 = 0x13;// TX_TRAINING_IF_REG3.BT.B0 = ###1##11 , tx_train_pat_two_zero_lane, ethernet_mode_tx_lane[1:0]
    tmp3 = 0xCC;// ANA_TXREG_REG0.BT.B0 = 11001100 , txreg_speedtrk_data_lane[3:0], txreg_speedtrk_clk_lane[3:0]
    tmp5 = 0x10;// PLL_RS_CAL_CTRL_LANE.BT.B3 = ###10000 , tx_pll_rate_sel_lane[4:0]
    tmp6 = 0x40;// ANA_TXSPEED_REG0.BT.B0 = 010##000 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
    tmp7 = 0x3;// TX_SYSTEM_LANE0.BT.B1 = ######11 , tx_data_width_lane[1:0]
    tmp8 = 0x10;// ANA_TX_FIR_REG0.BT.B0 = 0001#### , tx_fir_bypass_l1_delay_lane, tx_fir_bypass_l2_delay_lane, tx_fir_bypass_l3_delay_lane, tx_fir_2_dig_clk_div_lane
  }
    ...
    tmp1 = 0x60;// PHYTEST_TX0.BT.B2 = 011##### , tx_train_pat_sel_lane[2:0]
    tmp2 = 0x12;// TX_TRAINING_IF_REG3.BT.B0 = ###1##10 , tx_train_pat_two_zero_lane, ethernet_mode_tx_lane[1:0]
    tmp5 = 0x13;// PLL_RS_CAL_CTRL_LANE.BT.B3 = ###10011 , tx_pll_rate_sel_lane[4:0]
    tmp6 = 0xE0;// ANA_TXSPEED_REG0.BT.B0 = 111##000 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
    tmp7 = 0x2;// TX_SYSTEM_LANE0.BT.B1 = ######10 , tx_data_width_lane[1:0]
  }
  else if (gen_tx==36){
    ...
    tmp1 = 0x60;// PHYTEST_TX0.BT.B2 = 011##### , tx_train_pat_sel_lane[2:0]
    tmp2 = 0x12;// TX_TRAINING_IF_REG3.BT.B0 = ###1##10 , tx_train_pat_two_zero_lane, ethernet_mode_tx_lane[1:0]
    tmp5 = 0xE;// PLL_RS_CAL_CTRL_LANE.BT.B3 = ###01110 , tx_pll_rate_sel_lane[4:0]
    tmp6 = 0x1;// ANA_TXSPEED_REG0.BT.B0 = 000##001 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
    tmp7 = 0x2;// TX_SYSTEM_LANE0.BT.B1 = ######10 , tx_data_width_lane[1:0]
  }
  else if (gen_tx==33){
    ...
    tmp5 = 0xC;// PLL_RS_CAL_CTRL_LANE.BT.B3 = ###01100 , tx_pll_rate_sel_lane[4:0]
    tmp6 = 0x40;// ANA_TXSPEED_REG0.BT.B0 = 010##000 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
    tmp7 = 0x2;// TX_SYSTEM_LANE0.BT.B1 = ######10 , tx_data_width_lane[1:0]
    tmp8 = 0x10;// ANA_TX_FIR_REG0.BT.B0 = 0001#### , tx_fir_bypass_l1_delay_lane, tx_fir_bypass_l2_delay_lane, tx_fir_bypass_l3_delay_lane, tx_fir_2_dig_clk_div_lane
  }
    ...
    tmp5 = 0x8;// PLL_RS_CAL_CTRL_LANE.BT.B3 = ###01000 , tx_pll_rate_sel_lane[4:0]
    tmp6 = 0x1;// ANA_TXSPEED_REG0.BT.B0 = 000##001 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
    tmp7 = 0x2;// TX_SYSTEM_LANE0.BT.B1 = ######10 , tx_data_width_lane[1:0]
  }
  else if (gen_tx==31){
    ...
    tmp2 = 0x12;// TX_TRAINING_IF_REG3.BT.B0 = ###1##10 , tx_train_pat_two_zero_lane, ethernet_mode_tx_lane[1:0]
    tmp3 = 0x44;// ANA_TXREG_REG0.BT.B0 = 01000100 , txreg_speedtrk_data_lane[3:0], txreg_speedtrk_clk_lane[3:0]
    tmp5 = 0x1;// PLL_RS_CAL_CTRL_LANE.BT.B3 = ###00001 , tx_pll_rate_sel_lane[4:0]
    tmp6 = 0x1;// ANA_TXSPEED_REG0.BT.B0 = 000##001 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
    tmp7 = 0x2;// TX_SYSTEM_LANE0.BT.B1 = ######10 , tx_data_width_lane[1:0]
  }
  else if (gen_tx==30){
    ...
    tmp1 = 0x40;// PHYTEST_TX0.BT.B2 = 010##### , tx_train_pat_sel_lane[2:0]
    tmp5 = 0x11;// PLL_RS_CAL_CTRL_LANE.BT.B3 = ###10001 , tx_pll_rate_sel_lane[4:0]
    tmp6 = 0xE0;// ANA_TXSPEED_REG0.BT.B0 = 111##000 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
  }
  else if (gen_tx==27){
    tmp1 = 0x40;// PHYTEST_TX0.BT.B2 = 010##### , tx_train_pat_sel_lane[2:0]
    ...
    tmp1 = 0x40;// PHYTEST_TX0.BT.B2 = 010##### , tx_train_pat_sel_lane[2:0]
    tmp5 = 0x9;// PLL_RS_CAL_CTRL_LANE.BT.B3 = ###01001 , tx_pll_rate_sel_lane[4:0]
    tmp6 = 0x1;// ANA_TXSPEED_REG0.BT.B0 = 000##001 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
  }
  else if (gen_tx==24){
    tmp1 = 0x40;// PHYTEST_TX0.BT.B2 = 010##### , tx_train_pat_sel_lane[2:0]
    ...
    tmp3 = 0x33;// ANA_TXREG_REG0.BT.B0 = 00110011 , txreg_speedtrk_data_lane[3:0], txreg_speedtrk_clk_lane[3:0]
    tmp5 = 0xD;// PLL_RS_CAL_CTRL_LANE.BT.B3 = ###01101 , tx_pll_rate_sel_lane[4:0]
  }
  else if (gen_tx==21){
    tmp3 = 0x33;// ANA_TXREG_REG0.BT.B0 = 00110011 , txreg_speedtrk_data_lane[3:0], txreg_speedtrk_clk_lane[3:0]
    tmp5 = 0xC;// PLL_RS_CAL_CTRL_LANE.BT.B3 = ###01100 , tx_pll_rate_sel_lane[4:0]
    ...
    tmp3 = 0x33;// ANA_TXREG_REG0.BT.B0 = 00110011 , txreg_speedtrk_data_lane[3:0], txreg_speedtrk_clk_lane[3:0]
    tmp5 = 0xA;// PLL_RS_CAL_CTRL_LANE.BT.B3 = ###01010 , tx_pll_rate_sel_lane[4:0]
    tmp8 = 0x60;// ANA_TX_FIR_REG0.BT.B0 = 0110#### , tx_fir_bypass_l1_delay_lane, tx_fir_bypass_l2_delay_lane, tx_fir_bypass_l3_delay_lane, tx_fir_2_dig_clk_div_lane
  }
  else if (gen_tx==19){
    tmp3 = 0x33;// ANA_TXREG_REG0.BT.B0 = 00110011 , txreg_speedtrk_data_lane[3:0], txreg_speedtrk_clk_lane[3:0]
    ...
    tmp3 = 0x33;// ANA_TXREG_REG0.BT.B0 = 00110011 , txreg_speedtrk_data_lane[3:0], txreg_speedtrk_clk_lane[3:0]
    tmp5 = 0x7;// PLL_RS_CAL_CTRL_LANE.BT.B3 = ###00111 , tx_pll_rate_sel_lane[4:0]
    tmp8 = 0x60;// ANA_TX_FIR_REG0.BT.B0 = 0110#### , tx_fir_bypass_l1_delay_lane, tx_fir_bypass_l2_delay_lane, tx_fir_bypass_l3_delay_lane, tx_fir_2_dig_clk_div_lane
  }
  else if (gen_tx==17){
    tmp3 = 0x33;// ANA_TXREG_REG0.BT.B0 = 00110011 , txreg_speedtrk_data_lane[3:0], txreg_speedtrk_clk_lane[3:0]
    ...
    tmp3 = 0x33;// ANA_TXREG_REG0.BT.B0 = 00110011 , txreg_speedtrk_data_lane[3:0], txreg_speedtrk_clk_lane[3:0]
    tmp5 = 0x5;// PLL_RS_CAL_CTRL_LANE.BT.B3 = ###00101 , tx_pll_rate_sel_lane[4:0]
    tmp8 = 0x60;// ANA_TX_FIR_REG0.BT.B0 = 0110#### , tx_fir_bypass_l1_delay_lane, tx_fir_bypass_l2_delay_lane, tx_fir_bypass_l3_delay_lane, tx_fir_2_dig_clk_div_lane
  }
  else if (gen_tx==15){
    tmp3 = 0x33;// ANA_TXREG_REG0.BT.B0 = 00110011 , txreg_speedtrk_data_lane[3:0], txreg_speedtrk_clk_lane[3:0]
    ...
    tmp5 = 0x2;// PLL_RS_CAL_CTRL_LANE.BT.B3 = ###00010 , tx_pll_rate_sel_lane[4:0]
    tmp8 = 0x60;// ANA_TX_FIR_REG0.BT.B0 = 0110#### , tx_fir_bypass_l1_delay_lane, tx_fir_bypass_l2_delay_lane, tx_fir_bypass_l3_delay_lane, tx_fir_2_dig_clk_div_lane
  }
  else if (gen_tx==13){
    tmp3 = 0x22;// ANA_TXREG_REG0.BT.B0 = 00100010 , txreg_speedtrk_data_lane[3:0], txreg_speedtrk_clk_lane[3:0]
    ...
    tmp3 = 0x22;// ANA_TXREG_REG0.BT.B0 = 00100010 , txreg_speedtrk_data_lane[3:0], txreg_speedtrk_clk_lane[3:0]
    tmp4 = 0x1;// CLKGEN_TX_LANE_REG1_LANE.BT.B0 = #######1 , txdata_latency_reduce_en_lane
    tmp5 = 0xB;// PLL_RS_CAL_CTRL_LANE.BT.B3 = ###01011 , tx_pll_rate_sel_lane[4:0]
    tmp6 = 0x3;// ANA_TXSPEED_REG0.BT.B0 = 000##011 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
    tmp8 = 0x60;// ANA_TX_FIR_REG0.BT.B0 = 0110#### , tx_fir_bypass_l1_delay_lane, tx_fir_bypass_l2_delay_lane, tx_fir_bypass_l3_delay_lane, tx_fir_2_dig_clk_div_lane
  }
  else if (gen_tx==10){
    ...
    tmp3 = 0x22;// ANA_TXREG_REG0.BT.B0 = 00100010 , txreg_speedtrk_data_lane[3:0], txreg_speedtrk_clk_lane[3:0]
    tmp4 = 0x1;// CLKGEN_TX_LANE_REG1_LANE.BT.B0 = #######1 , txdata_latency_reduce_en_lane
    tmp5 = 0x4;// PLL_RS_CAL_CTRL_LANE.BT.B3 = ###00100 , tx_pll_rate_sel_lane[4:0]
    tmp6 = 0x3;// ANA_TXSPEED_REG0.BT.B0 = 000##011 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
    tmp8 = 0x60;// ANA_TX_FIR_REG0.BT.B0 = 0110#### , tx_fir_bypass_l1_delay_lane, tx_fir_bypass_l2_delay_lane, tx_fir_bypass_l3_delay_lane, tx_fir_2_dig_clk_div_lane
  }
  else if (gen_tx==8){
  ...
  PLL_RS_CAL_CTRL_LANE.BT.B3 = tmp5;
