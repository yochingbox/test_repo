...
typedef union {
	struct {
		uint8_t RX_DP_FFE_MAIN_SHIFT_LANE_1_0            : 2;	/*  [1:0]     r/w 2'h0*/
		uint8_t RX_DP_DAT_OUT_SEL_LANE                   : 1;	/*      2     r/w   0*/
...
__xdata __at( 0x4804 ) volatile RX_DP_REG1_t RX_DP_REG1;
#define reg_RX_DP_FFE_MAIN_SHIFT_LANE_1_0  RX_DP_REG1.BF.RX_DP_FFE_MAIN_SHIFT_LANE_1_0
#define reg_RX_DP_DAT_OUT_SEL_LANE  RX_DP_REG1.BF.RX_DP_DAT_OUT_SEL_LANE
...
typedef union {
	struct {
		uint8_t RX_DP_LMS_FFE_PST4_COE_LANE_4_0          : 5;	/*  [4:0]       r 5'h0*/
		uint8_t RESERVED_5                               : 3;	/* [15:5]     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [15:5]     r/w   0*/
		uint8_t RX_DP_LMS_FFE_PST4_EXT_LANE_4_0          : 5;	/*[20:16]     r/w 5'h0*/
		uint8_t RESERVED_21                              : 3;	/*[31:21]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/*[31:21]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
...
#define reg_RX_DP_LMS_FFE_PST4_COE_LANE_4_0  RX_DP_LMS_FFE_REG14.BF.RX_DP_LMS_FFE_PST4_COE_LANE_4_0
#define reg_RX_DP_LMS_FFE_PST4_EXT_LANE_4_0  RX_DP_LMS_FFE_REG14.BF.RX_DP_LMS_FFE_PST4_EXT_LANE_4_0

// 0x007c	RX_DP_LMS_FFE_REG15		RX DP LMS FFE Register
typedef union {
	struct {
		uint8_t RX_DP_LMS_FFE_PST5_COE_LANE_4_0          : 5;	/*  [4:0]       r 5'h0*/
		uint8_t RESERVED_5                               : 3;	/* [15:5]     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [15:5]     r/w   0*/
		uint8_t RX_DP_LMS_FFE_PST5_EXT_LANE_4_0          : 5;	/*[20:16]     r/w 5'h0*/
		uint8_t RESERVED_21                              : 3;	/*[31:21]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/*[31:21]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
...
#define reg_RX_DP_LMS_FFE_PST5_COE_LANE_4_0  RX_DP_LMS_FFE_REG15.BF.RX_DP_LMS_FFE_PST5_COE_LANE_4_0
#define reg_RX_DP_LMS_FFE_PST5_EXT_LANE_4_0  RX_DP_LMS_FFE_REG15.BF.RX_DP_LMS_FFE_PST5_EXT_LANE_4_0

// 0x0080	RX_DP_LMS_FFE_REG16		RX DP LMS FFE Register
typedef union {
	struct {
		uint8_t RX_DP_LMS_FFE_PST6_COE_LANE_4_0          : 5;	/*  [4:0]       r 5'h0*/
		uint8_t RESERVED_5                               : 3;	/* [15:5]     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [15:5]     r/w   0*/
		uint8_t RX_DP_LMS_FFE_PST6_EXT_LANE_4_0          : 5;	/*[20:16]     r/w 5'h0*/
		uint8_t RESERVED_21                              : 3;	/*[31:21]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/*[31:21]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
...
#define reg_RX_DP_LMS_FFE_PST6_COE_LANE_4_0  RX_DP_LMS_FFE_REG16.BF.RX_DP_LMS_FFE_PST6_COE_LANE_4_0
#define reg_RX_DP_LMS_FFE_PST6_EXT_LANE_4_0  RX_DP_LMS_FFE_REG16.BF.RX_DP_LMS_FFE_PST6_EXT_LANE_4_0

// 0x0084	RX_DP_LMS_FFE_REG17		RX DP LMS FFE Register
typedef union {
	struct {
		uint8_t RX_DP_LMS_FFE_PST7_COE_LANE_3_0          : 4;	/*  [3:0]       r 4'h0*/
		uint8_t RESERVED_4                               : 4;	/* [15:4]     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [15:4]     r/w   0*/
		uint8_t RX_DP_LMS_FFE_PST7_EXT_LANE_3_0          : 4;	/*[19:16]     r/w 4'h0*/
		uint8_t RESERVED_20                              : 4;	/*[31:20]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/*[31:20]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
...
#define reg_RX_DP_LMS_FFE_PST7_COE_LANE_3_0  RX_DP_LMS_FFE_REG17.BF.RX_DP_LMS_FFE_PST7_COE_LANE_3_0
#define reg_RX_DP_LMS_FFE_PST7_EXT_LANE_3_0  RX_DP_LMS_FFE_REG17.BF.RX_DP_LMS_FFE_PST7_EXT_LANE_3_0

// 0x0088	RX_DP_LMS_FFE_REG18		RX DP LMS FFE Register
typedef union {
	struct {
		uint8_t RX_DP_LMS_FFE_PST8_COE_LANE_3_0          : 4;	/*  [3:0]       r 4'h0*/
		uint8_t RESERVED_4                               : 4;	/* [15:4]     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [15:4]     r/w   0*/
		uint8_t RX_DP_LMS_FFE_PST8_EXT_LANE_3_0          : 4;	/*[19:16]     r/w 4'h0*/
		uint8_t RESERVED_20                              : 4;	/*[31:20]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/*[31:20]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
...
#define reg_RX_DP_LMS_FFE_PST8_COE_LANE_3_0  RX_DP_LMS_FFE_REG18.BF.RX_DP_LMS_FFE_PST8_COE_LANE_3_0
#define reg_RX_DP_LMS_FFE_PST8_EXT_LANE_3_0  RX_DP_LMS_FFE_REG18.BF.RX_DP_LMS_FFE_PST8_EXT_LANE_3_0
