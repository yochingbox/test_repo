...
typedef union {
	struct {
		...
		uint8_t TESTBUS_LANE_SEL1_3_0                    : 4;	/*[23:20]     r/w   0*/
		uint8_t RESERVED_24                              : 4;	/*[27:24]     r/w   0*/
		uint8_t TESTBUS_LANE_SEL0_3_0                    : 4;	/*[31:28]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TEST3_t;
...
#define reg_TESTBUS_LANE_SEL1_3_0  TEST3.BF.TESTBUS_LANE_SEL1_3_0
#define reg_TESTBUS_LANE_SEL0_3_0  TEST3.BF.TESTBUS_LANE_SEL0_3_0
...
#define reg_TSEN_ADC_RD_LANE_REQ_CH0  INPUT_CMN_PIN_REG0.BF.TSEN_ADC_RD_LANE_REQ_CH0
#define reg_TSEN_ADC_RD_LANE_REQ_CH1  INPUT_CMN_PIN_REG0.BF.TSEN_ADC_RD_LANE_REQ_CH1
#define reg_TSEN_ADC_RD_LANE_REQ_CH2  INPUT_CMN_PIN_REG0.BF.TSEN_ADC_RD_LANE_REQ_CH2
#define reg_TSEN_ADC_RD_LANE_REQ_CH3  INPUT_CMN_PIN_REG0.BF.TSEN_ADC_RD_LANE_REQ_CH3
...
typedef union {
	struct {
		...
		uint8_t CMN_SCNTEST                              : 1;	/*      2     r/w 1'b0*/
...
#define reg_CMN_SCNTEST  CMN_REG1.BF.CMN_SCNTEST
