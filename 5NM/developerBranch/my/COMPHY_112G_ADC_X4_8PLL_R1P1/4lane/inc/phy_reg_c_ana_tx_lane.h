...
typedef union {
	struct {
		...
		uint8_t TXREG_SPEEDTRK_DATA_LANE_3_0             : 4;	/*  [7:4]     r/w 4'hF*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} ANA_TXREG_REG0_t;
...
#define reg_TXREG_SPEEDTRK_DATA_LANE_3_0  ANA_TXREG_REG0.BF.TXREG_SPEEDTRK_DATA_LANE_3_0

// 0x2	ANA_TXREG_REG1		
typedef union {
	struct {
		uint8_t TXDRVREG_TEMPC_RES_LANE_1_0              : 2;	/*  [1:0]     r/w 2'h2*/
...
#define reg_TXDRVREG_TEMPC_RES_LANE_1_0  ANA_TXREG_REG1.BF.TXDRVREG_TEMPC_RES_LANE_1_0
...
typedef union {
	struct {
		...
		uint8_t TXCLK_2X_SEL_LANE                        : 1;	/*      5     r/w   0*/
		uint8_t RESERVED_6                               : 1;	/*      6     r/w   0*/
...
#define reg_TXCLK_2X_SEL_LANE  ANA_CK_REG0.BF.TXCLK_2X_SEL_LANE
...
typedef union {
	struct {
		uint8_t TX_RESET_FIR_LANE                        : 1;	/*      0     r/w   1*/
		uint8_t TX_FIR_CLK_OFF_LANE                      : 1;	/*      1     r/w   1*/
...
typedef union {
	struct {
		...
		uint8_t TXLB_ANA_GAIN_SEL_LANE_1_0               : 2;	/*  [3:2]     r/w 2'h3*/
		uint8_t TXLB_ANA_IMP_SEL_LANE_1_0                : 2;	/*  [5:4]     r/w 2'h0*/
		uint8_t TXLB_ANA_EN_LANE                         : 1;	/*      6     r/w   0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} ANA_MISC_REG0_t;
__xdata __at( 0x1040 ) volatile ANA_MISC_REG0_t ANA_MISC_REG0;
#define reg_TX_CLK500M_DIV_LANE_1_0  ANA_MISC_REG0.BF.TX_CLK500M_DIV_LANE_1_0
#define reg_TXLB_ANA_GAIN_SEL_LANE_1_0  ANA_MISC_REG0.BF.TXLB_ANA_GAIN_SEL_LANE_1_0
#define reg_TXLB_ANA_IMP_SEL_LANE_1_0  ANA_MISC_REG0.BF.TXLB_ANA_IMP_SEL_LANE_1_0
#define reg_TXLB_ANA_EN_LANE  ANA_MISC_REG0.BF.TXLB_ANA_EN_LANE
...
__xdata __at( 0x1044 ) volatile ANA_MISC_REG1_t ANA_MISC_REG1;
#define reg_TX_TEST_LANE_9_8  ANA_MISC_REG1.BF.TX_TEST_LANE_9_8
#define reg_TX_TXCLK_ALIGN_EN_LANE  ANA_MISC_REG1.BF.TX_TXCLK_ALIGN_EN_LANE
#define reg_TX_TSEN_SEL_LANE  ANA_MISC_REG1.BF.TX_TSEN_SEL_LANE
#define reg_TXALIGN90_REF_FILT_BW_LANE  ANA_MISC_REG1.BF.TXALIGN90_REF_FILT_BW_LANE
#define reg_TX_FIR_OPT_MAP_LANE  ANA_MISC_REG1.BF.TX_FIR_OPT_MAP_LANE
#define reg_TXPAM2_EN_DUM_LANE  ANA_MISC_REG1.BF.TXPAM2_EN_DUM_LANE
#define reg_TXAVDD09_SEL_LANE  ANA_MISC_REG1.BF.TXAVDD09_SEL_LANE
