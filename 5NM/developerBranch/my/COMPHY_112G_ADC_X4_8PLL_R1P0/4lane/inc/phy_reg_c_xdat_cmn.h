...
// 0x0688	COMMON_CONFIG_UPDATE_NEEDED		Common Config Update Needed power up handshake flag
typedef union {
	struct {
...
__xdata __at( 0xe688 ) volatile COMMON_CONFIG_UPDATE_NEEDED_t COMMON_CONFIG_UPDATE_NEEDED;
...
// 0x068c	COMMON_CONFIG_UPDATE_DONE		Common Config Update Done power up handshake flag
typedef union {
	struct {
...
__xdata __at( 0xe68c ) volatile COMMON_CONFIG_UPDATE_DONE_t COMMON_CONFIG_UPDATE_DONE;
...
__xdata __at( 0xe690 ) volatile END_XDAT_CMN_t END_XDAT_CMN;
