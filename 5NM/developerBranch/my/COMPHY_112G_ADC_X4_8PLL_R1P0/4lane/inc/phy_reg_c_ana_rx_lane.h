...
typedef union {
	struct {
		uint8_t RX_CLKTOP_CONFIG_LANE_10_3               : 8;	/*  [7:0]     r/w 8'h30*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} RX_TOP_ANA_REG_26_t;
...
typedef union {
	struct {
		uint8_t RESERVED_0                               : 1;	/*      0     r/w 1'h0*/
		uint8_t RX_RXPLL_CLK_EN_LANE                     : 1;	/*      1     r/w 1'h0*/
		uint8_t RX_RXCLK4X_EN_LANE                       : 1;	/*      2     r/w 1'h0*/
...
typedef union {
	struct {
		...
		uint8_t RESERVED_2                               : 1;	/*      2     r/w 1'h0*/
		uint8_t RESERVED_3                               : 1;	/*      3     r/w 1'h0*/
		uint8_t RX_PI_RSEL_LANE_1_0                      : 2;	/*  [5:4]     r/w 2'h0*/
...
// 0x2c	RX_CAL_REG0		Digital rx Calibration Register 0
typedef union {
	struct {
		uint8_t RESERVED_0                               : 1;	/*      0     r/w 1'h0*/
		uint8_t RESERVED_1                               : 1;	/*      1     r/w 1'h0*/
...
__xdata __at( 0x12b0 ) volatile RX_CAL_REG0_t RX_CAL_REG0;
...
// 0x2d	RX_CAL_REG1		Digital rx Calibration Register 1
typedef union {
	struct {
...
__xdata __at( 0x12b4 ) volatile RX_CAL_REG1_t RX_CAL_REG1;
#define reg_RX_DIG_CAL2M_DIV_TOP_LANE_7_0  RX_CAL_REG1.BF.RX_DIG_CAL2M_DIV_TOP_LANE_7_0

// 0x2e	RX_CAL_REG2		Digital rx Calibration Register 2
typedef union {
	struct {
...
__xdata __at( 0x12b8 ) volatile RX_CAL_REG2_t RX_CAL_REG2;
#define reg_RX_DIG_CAL2M_DIV_BOT_LANE_7_0  RX_CAL_REG2.BF.RX_DIG_CAL2M_DIV_BOT_LANE_7_0

// 0x2f	RX_CAL_REG3		Digital RX Calibration Register 3
typedef union {
	struct {
...
__xdata __at( 0x12bc ) volatile RX_CAL_REG3_t RX_CAL_REG3;
