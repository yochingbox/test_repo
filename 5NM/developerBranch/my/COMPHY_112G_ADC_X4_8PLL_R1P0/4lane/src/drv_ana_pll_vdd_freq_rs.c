...
// Auto generated by IPDOC
  ...
  void pll_vdd_freq_rs(void) BANKING_CTRL {
    ...
    reg_PLL_DCC_VDD_RS_TOP_START_LANE = 0;
    if(reg_PLL_RS_VDDA_FBDIV_CAL_TIMEOUT_RD_LANE || reg_PLL_RS_VDDA_INTP_CAL_TIMEOUT_RD_LANE  == 1){
    ...
    reg_PLL_RS_VDDA_FBDIV_CAL_RESULT_EXT_LANE_3_0 = reg_PLL_TS_VDDA_FBDIV_CAL_RESULT_RD_LANE_3_0;
    reg_PLL_RS_VDDA_INTP_CAL_RESULT_EXT_LANE_3_0 = reg_PLL_TS_VDDA_INTP_CAL_RESULT_RD_LANE_3_0;
  }
