...
// Auto generated by IPDOC
  ...
  void trx_ivref_vddr_tx(void) BANKING_CTRL {
    ...
    reg_TRX_VDDR_CLKTOP_PI_EOM_CAL_VAL_MAX_LANE_4_0
 = 31;
    ...
    reg_TRX_VDDR_CLKTOP_DLL_CAL_BYPASS_EN_LANE = 1;
    ...
    reg_TRX_VDDR_TXDATA_CAL_BYPASS_EN_LANE = 0;
    reg_TRX_VDDR_TXCLK_CAL_BYPASS_EN_LANE = 0;
    reg_TRX_VDDR_TXPRE_CAL_BYPASS_EN_LANE = 0;
