...
void drv_set_dp_lms_ext (uint8_t set) BANKING_CTRL
{
	...
	RX_DP_LMS_FFE_REG14.BT.B2 = (set == 7) ? reg_CDS_DP_LMS_FFE_PST4_EXT_LANE_3_0  : ffe[set][ 5];
	RX_DP_LMS_FFE_REG15.BT.B2 = (set == 7) ? reg_CDS_DP_LMS_FFE_PST5_EXT_LANE_3_0  : ffe[set][ 6];
	RX_DP_LMS_FFE_REG16.BT.B2 = (set == 7) ? reg_CDS_DP_LMS_FFE_PST6_EXT_LANE_3_0  : ffe[set][ 7];
	RX_DP_LMS_FFE_REG17.BT.B2 = (set == 7) ? reg_CDS_DP_LMS_FFE_PST7_EXT_LANE_2_0  : ffe[set][ 8];
	RX_DP_LMS_FFE_REG18.BT.B2 = (set == 7) ? reg_CDS_DP_LMS_FFE_PST8_EXT_LANE_2_0  : ffe[set][ 9];
...
void drv_sav_dp_lms (void) BANKING_CTRL
{
	...
	CDS_DP_LMS_REG2.BT.B3 = reg_RX_DP_LMS_FFE_PST4_COE_LANE_3_0;
	CDS_DP_LMS_REG2.BT.B2 = reg_RX_DP_LMS_FFE_PST5_COE_LANE_3_0;
	CDS_DP_LMS_REG2.BT.B1 = reg_RX_DP_LMS_FFE_PST6_COE_LANE_3_0;
	CDS_DP_LMS_REG2.BT.B0 = ((reg_RX_DP_LMS_FFE_PST7_COE_LANE_2_0  << 4) & 0xf0) | reg_RX_DP_LMS_FFE_PST8_COE_LANE_2_0;
