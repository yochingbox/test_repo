...
void loadspeedtbl_rx() BANKING_CTRL {
  uint8_t tmp0 = 0x3; //RX_TOP_ANA_REG_37.BT.B0 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
  uint8_t tmp1 = 0x3; //PLL_RS_LANE_REG12.BT.B2 , rx_pll_rate_sel_lane[4:0]
  uint8_t tmp2 = 0x70; //RX_TOP_ANA_REG_40.BT.B0 , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
  uint8_t tmp3 = 0xC8; //RX_TOP_ANA_REG_35.BT.B0 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
  uint8_t tmp4 = 0x68; //RX_TOP_ANA_REG_33.BT.B0 , rx_ctle_cs1_ctrl_lane[4:0]
  uint8_t tmp5 = 0x11; //RX_EQ_REG0.BT.B0 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
  uint8_t tmp6 = 0x4; //TX_TRAIN_PATTTERN_REG0.BT.B1 , ethernet_mode_lane[1:0]
  uint8_t tmp7 = 0x58; //RX_TOP_ANA_REG_39.BT.B0 , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
  uint8_t tmp8 = 0x7; //ANA_RX_PI_REG0.BT.B0 , rx_pi_icclow_ctrl_lane[3:0]
  uint8_t tmp9 = 0x5; //ANA_RX_PI_REG1.BT.B0 , rx_pi_icc_ctrl_lane[3:0]
  uint8_t tmp10 = 0x20; //RX_TOP_ANA_REG_38.BT.B0 , rx_ctle_rfb_sel_lane[1:0], rx_pi_rsel_lane[1:0]
  uint8_t tmp11 = 0x8; //RX_TOP_ANA_REG_32.BT.B0 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
  uint8_t tmp12 = 0x0; //RX_TOP_ANA_REG_36.BT.B0 , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
  uint8_t tmp13 = 0xA0; //RX_TOP_ANA_REG_34.BT.B0 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
  uint8_t tmp14 = 0x0; //SYSTEM_CONFIG_0.BT.B2 , rx_nt_mul_lane[1:0], pll_tsrs_switch_xdat_lane, pll_sel_lane[1:0], mcu_ctrl_pll_lane[1:0]
  uint8_t tmp15 = 0x20; //SYSTEM_CONFIG_0.BT.B3 , rx_rate_2_pll_ratio_x8_lane[7:0]
  uint8_t tmp16 = 0x23; //RX_SPD_TABLE_LANE.BT.B0 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
  uint8_t tmp17 = 0x1; //RX_SPD_TABLE_LANE.BT.B1 , rx_rxclk_div_ratio_lane[2:0]
  if (gen_rx==48){
    tmp0 = 0x35;// RX_TOP_ANA_REG_37.BT.B0 = 00110101 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0x18;// PLL_RS_LANE_REG12.BT.B2 = ###11000 , rx_pll_rate_sel_lane[4:0]
    tmp2 = 0x50;// RX_TOP_ANA_REG_40.BT.B0 = 01010### , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
    tmp3 = 0x69;// RX_TOP_ANA_REG_35.BT.B0 = 01101001 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
    tmp4 = 0x38;// RX_TOP_ANA_REG_33.BT.B0 = 00111### , rx_ctle_cs1_ctrl_lane[4:0]
    tmp5 = 0x2;// RX_EQ_REG0.BT.B0 = ###00010 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp6 = 0x8;// TX_TRAIN_PATTTERN_REG0.BT.B1 = ####10## , ethernet_mode_lane[1:0]
    tmp7 = 0x2A;// RX_TOP_ANA_REG_39.BT.B0 = 0010101# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp8 = 0x4;// ANA_RX_PI_REG0.BT.B0 = ####0100 , rx_pi_icclow_ctrl_lane[3:0]
    tmp9 = 0x2;// ANA_RX_PI_REG1.BT.B0 = ####0010 , rx_pi_icc_ctrl_lane[3:0]
    tmp10 = 0x30;// RX_TOP_ANA_REG_38.BT.B0 = 0011#### , rx_ctle_rfb_sel_lane[1:0], rx_pi_rsel_lane[1:0]
    tmp11 = 0x3;// RX_TOP_ANA_REG_32.BT.B0 = 00000011 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp12 = 0xC;// RX_TOP_ANA_REG_36.BT.B0 = 000011## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp13 = 0x93;// RX_TOP_ANA_REG_34.BT.B0 = 10010011 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    tmp16 = 0x15;// RX_SPD_TABLE_LANE.BT.B0 = #001#101 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
  }
  else if (gen_rx==47){
    tmp0 = 0x4A;// RX_TOP_ANA_REG_37.BT.B0 = 01001010 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0x0;// PLL_RS_LANE_REG12.BT.B2 = ###00000 , rx_pll_rate_sel_lane[4:0]
    tmp2 = 0x98;// RX_TOP_ANA_REG_40.BT.B0 = 10011### , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
    tmp3 = 0x69;// RX_TOP_ANA_REG_35.BT.B0 = 01101001 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
    tmp4 = 0x38;// RX_TOP_ANA_REG_33.BT.B0 = 00111### , rx_ctle_cs1_ctrl_lane[4:0]
    tmp5 = 0x12;// RX_EQ_REG0.BT.B0 = ###10010 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp7 = 0x2A;// RX_TOP_ANA_REG_39.BT.B0 = 0010101# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp8 = 0x4;// ANA_RX_PI_REG0.BT.B0 = ####0100 , rx_pi_icclow_ctrl_lane[3:0]
    tmp9 = 0x2;// ANA_RX_PI_REG1.BT.B0 = ####0010 , rx_pi_icc_ctrl_lane[3:0]
    tmp10 = 0x70;// RX_TOP_ANA_REG_38.BT.B0 = 0111#### , rx_ctle_rfb_sel_lane[1:0], rx_pi_rsel_lane[1:0]
    tmp11 = 0x4;// RX_TOP_ANA_REG_32.BT.B0 = 00000100 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp12 = 0x50;// RX_TOP_ANA_REG_36.BT.B0 = 010100## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp13 = 0x94;// RX_TOP_ANA_REG_34.BT.B0 = 10010100 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    tmp15 = 0x10;// SYSTEM_CONFIG_0.BT.B3 = 00010000 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp16 = 0x12;// RX_SPD_TABLE_LANE.BT.B0 = #001#010 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
  }
  else if (gen_rx==46){
    tmp1 = 0x6;// PLL_RS_LANE_REG12.BT.B2 = ###00110 , rx_pll_rate_sel_lane[4:0]
    tmp2 = 0xD8;// RX_TOP_ANA_REG_40.BT.B0 = 11011### , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
    tmp3 = 0xA;// RX_TOP_ANA_REG_35.BT.B0 = 00001010 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
    tmp4 = 0x0;// RX_TOP_ANA_REG_33.BT.B0 = 00000### , rx_ctle_cs1_ctrl_lane[4:0]
    tmp5 = 0x14;// RX_EQ_REG0.BT.B0 = ###10100 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp7 = 0x64;// RX_TOP_ANA_REG_39.BT.B0 = 0110010# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp11 = 0x70;// RX_TOP_ANA_REG_32.BT.B0 = 01110000 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp15 = 0x2;// SYSTEM_CONFIG_0.BT.B3 = 00000010 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp16 = 0x43;// RX_SPD_TABLE_LANE.BT.B0 = #100#011 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
    tmp17 = 0x4;// RX_SPD_TABLE_LANE.BT.B1 = #####100 , rx_rxclk_div_ratio_lane[2:0]
  }
  else if (gen_rx==45){
    tmp0 = 0x86;// RX_TOP_ANA_REG_37.BT.B0 = 10000110 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0x16;// PLL_RS_LANE_REG12.BT.B2 = ###10110 , rx_pll_rate_sel_lane[4:0]
    tmp2 = 0x30;// RX_TOP_ANA_REG_40.BT.B0 = 00110### , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
    tmp5 = 0x3;// RX_EQ_REG0.BT.B0 = ###00011 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp6 = 0x8;// TX_TRAIN_PATTTERN_REG0.BT.B1 = ####10## , ethernet_mode_lane[1:0]
    tmp7 = 0x28;// RX_TOP_ANA_REG_39.BT.B0 = 0010100# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp8 = 0x4;// ANA_RX_PI_REG0.BT.B0 = ####0100 , rx_pi_icclow_ctrl_lane[3:0]
    tmp9 = 0x2;// ANA_RX_PI_REG1.BT.B0 = ####0010 , rx_pi_icc_ctrl_lane[3:0]
    tmp10 = 0x70;// RX_TOP_ANA_REG_38.BT.B0 = 0111#### , rx_ctle_rfb_sel_lane[1:0], rx_pi_rsel_lane[1:0]
    tmp12 = 0xA0;// RX_TOP_ANA_REG_36.BT.B0 = 101000## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp13 = 0x88;// RX_TOP_ANA_REG_34.BT.B0 = 10001000 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    tmp14 = 0x20;// SYSTEM_CONFIG_0.BT.B2 = #01##### , rx_nt_mul_lane[1:0], pll_tsrs_switch_xdat_lane, pll_sel_lane[1:0], mcu_ctrl_pll_lane[1:0]
    tmp15 = 0x40;// SYSTEM_CONFIG_0.BT.B3 = 01000000 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp16 = 0x4;// RX_SPD_TABLE_LANE.BT.B0 = #000#100 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
    tmp17 = 0x0;// RX_SPD_TABLE_LANE.BT.B1 = #####000 , rx_rxclk_div_ratio_lane[2:0]
  }
  else if (gen_rx==44){
    tmp0 = 0x86;// RX_TOP_ANA_REG_37.BT.B0 = 10000110 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0x15;// PLL_RS_LANE_REG12.BT.B2 = ###10101 , rx_pll_rate_sel_lane[4:0]
    tmp2 = 0x30;// RX_TOP_ANA_REG_40.BT.B0 = 00110### , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
    tmp5 = 0x3;// RX_EQ_REG0.BT.B0 = ###00011 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp6 = 0x8;// TX_TRAIN_PATTTERN_REG0.BT.B1 = ####10## , ethernet_mode_lane[1:0]
    tmp7 = 0x28;// RX_TOP_ANA_REG_39.BT.B0 = 0010100# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    ...
    tmp1 = 0x16;// PLL_RS_LANE_REG12.BT.B2 = ###10110 , rx_pll_rate_sel_lane[4:0]
    tmp2 = 0x30;// RX_TOP_ANA_REG_40.BT.B0 = 00110### , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
    tmp5 = 0x13;// RX_EQ_REG0.BT.B0 = ###10011 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp7 = 0x28;// RX_TOP_ANA_REG_39.BT.B0 = 0010100# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp8 = 0x4;// ANA_RX_PI_REG0.BT.B0 = ####0100 , rx_pi_icclow_ctrl_lane[3:0]
    tmp9 = 0x2;// ANA_RX_PI_REG1.BT.B0 = ####0010 , rx_pi_icc_ctrl_lane[3:0]
    tmp10 = 0x70;// RX_TOP_ANA_REG_38.BT.B0 = 0111#### , rx_ctle_rfb_sel_lane[1:0], rx_pi_rsel_lane[1:0]
    tmp12 = 0xA0;// RX_TOP_ANA_REG_36.BT.B0 = 101000## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp13 = 0x88;// RX_TOP_ANA_REG_34.BT.B0 = 10001000 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    tmp16 = 0x2;// RX_SPD_TABLE_LANE.BT.B0 = #000#010 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
    tmp17 = 0x0;// RX_SPD_TABLE_LANE.BT.B1 = #####000 , rx_rxclk_div_ratio_lane[2:0]
  }
  else if (gen_rx==42){
    tmp0 = 0x86;// RX_TOP_ANA_REG_37.BT.B0 = 10000110 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    ...
    tmp0 = 0xF6;// RX_TOP_ANA_REG_37.BT.B0 = 11110110 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0x14;// PLL_RS_LANE_REG12.BT.B2 = ###10100 , rx_pll_rate_sel_lane[4:0]
    tmp2 = 0x30;// RX_TOP_ANA_REG_40.BT.B0 = 00110### , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
    tmp3 = 0xC4;// RX_TOP_ANA_REG_35.BT.B0 = 11000100 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
    tmp5 = 0x3;// RX_EQ_REG0.BT.B0 = ###00011 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp6 = 0xC;// TX_TRAIN_PATTTERN_REG0.BT.B1 = ####11## , ethernet_mode_lane[1:0]
    tmp8 = 0xB;// ANA_RX_PI_REG0.BT.B0 = ####1011 , rx_pi_icclow_ctrl_lane[3:0]
    tmp9 = 0xB;// ANA_RX_PI_REG1.BT.B0 = ####1011 , rx_pi_icc_ctrl_lane[3:0]
    tmp10 = 0xC0;// RX_TOP_ANA_REG_38.BT.B0 = 1100#### , rx_ctle_rfb_sel_lane[1:0], rx_pi_rsel_lane[1:0]
    tmp11 = 0xF;// RX_TOP_ANA_REG_32.BT.B0 = 00001111 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp12 = 0xFC;// RX_TOP_ANA_REG_36.BT.B0 = 111111## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp13 = 0x6F;// RX_TOP_ANA_REG_34.BT.B0 = 01101111 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    tmp14 = 0x40;// SYSTEM_CONFIG_0.BT.B2 = #10##### , rx_nt_mul_lane[1:0], pll_tsrs_switch_xdat_lane, pll_sel_lane[1:0], mcu_ctrl_pll_lane[1:0]
    tmp15 = 0x40;// SYSTEM_CONFIG_0.BT.B3 = 01000000 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp16 = 0x16;// RX_SPD_TABLE_LANE.BT.B0 = #001#110 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
  }
  else if (gen_rx==40){
    tmp0 = 0xF6;// RX_TOP_ANA_REG_37.BT.B0 = 11110110 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0x12;// PLL_RS_LANE_REG12.BT.B2 = ###10010 , rx_pll_rate_sel_lane[4:0]
    tmp2 = 0x30;// RX_TOP_ANA_REG_40.BT.B0 = 00110### , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
    tmp3 = 0xC4;// RX_TOP_ANA_REG_35.BT.B0 = 11000100 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
    tmp5 = 0x3;// RX_EQ_REG0.BT.B0 = ###00011 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp6 = 0xC;// TX_TRAIN_PATTTERN_REG0.BT.B1 = ####11## , ethernet_mode_lane[1:0]
    ...
    tmp0 = 0xF6;// RX_TOP_ANA_REG_37.BT.B0 = 11110110 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0x10;// PLL_RS_LANE_REG12.BT.B2 = ###10000 , rx_pll_rate_sel_lane[4:0]
    tmp2 = 0x50;// RX_TOP_ANA_REG_40.BT.B0 = 01010### , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
    tmp3 = 0xC4;// RX_TOP_ANA_REG_35.BT.B0 = 11000100 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
    tmp5 = 0x3;// RX_EQ_REG0.BT.B0 = ###00011 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp6 = 0xC;// TX_TRAIN_PATTTERN_REG0.BT.B1 = ####11## , ethernet_mode_lane[1:0]
    ...
    tmp8 = 0xB;// ANA_RX_PI_REG0.BT.B0 = ####1011 , rx_pi_icclow_ctrl_lane[3:0]
    tmp9 = 0xB;// ANA_RX_PI_REG1.BT.B0 = ####1011 , rx_pi_icc_ctrl_lane[3:0]
    tmp10 = 0x40;// RX_TOP_ANA_REG_38.BT.B0 = 0100#### , rx_ctle_rfb_sel_lane[1:0], rx_pi_rsel_lane[1:0]
    tmp12 = 0xA0;// RX_TOP_ANA_REG_36.BT.B0 = 101000## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp13 = 0x88;// RX_TOP_ANA_REG_34.BT.B0 = 10001000 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    tmp14 = 0x20;// SYSTEM_CONFIG_0.BT.B2 = #01##### , rx_nt_mul_lane[1:0], pll_tsrs_switch_xdat_lane, pll_sel_lane[1:0], mcu_ctrl_pll_lane[1:0]
    tmp16 = 0x14;// RX_SPD_TABLE_LANE.BT.B0 = #001#100 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
  }
  else if (gen_rx==37){
    tmp0 = 0x86;// RX_TOP_ANA_REG_37.BT.B0 = 10000110 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0x13;// PLL_RS_LANE_REG12.BT.B2 = ###10011 , rx_pll_rate_sel_lane[4:0]
    tmp2 = 0x30;// RX_TOP_ANA_REG_40.BT.B0 = 00110### , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
    tmp5 = 0x2;// RX_EQ_REG0.BT.B0 = ###00010 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp6 = 0x8;// TX_TRAIN_PATTTERN_REG0.BT.B1 = ####10## , ethernet_mode_lane[1:0]
    tmp8 = 0xB;// ANA_RX_PI_REG0.BT.B0 = ####1011 , rx_pi_icclow_ctrl_lane[3:0]
    ...
    tmp0 = 0x77;// RX_TOP_ANA_REG_37.BT.B0 = 01110111 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0x10;// PLL_RS_LANE_REG12.BT.B2 = ###10000 , rx_pll_rate_sel_lane[4:0]
    tmp2 = 0x50;// RX_TOP_ANA_REG_40.BT.B0 = 01010### , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
    tmp5 = 0x2;// RX_EQ_REG0.BT.B0 = ###00010 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp6 = 0x8;// TX_TRAIN_PATTTERN_REG0.BT.B1 = ####10## , ethernet_mode_lane[1:0]
    ...
    tmp9 = 0xB;// ANA_RX_PI_REG1.BT.B0 = ####1011 , rx_pi_icc_ctrl_lane[3:0]
    tmp10 = 0x40;// RX_TOP_ANA_REG_38.BT.B0 = 0100#### , rx_ctle_rfb_sel_lane[1:0], rx_pi_rsel_lane[1:0]
    tmp11 = 0x7;// RX_TOP_ANA_REG_32.BT.B0 = 00000111 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp12 = 0x5C;// RX_TOP_ANA_REG_36.BT.B0 = 010111## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp13 = 0x87;// RX_TOP_ANA_REG_34.BT.B0 = 10000111 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    tmp14 = 0x20;// SYSTEM_CONFIG_0.BT.B2 = #01##### , rx_nt_mul_lane[1:0], pll_tsrs_switch_xdat_lane, pll_sel_lane[1:0], mcu_ctrl_pll_lane[1:0]
    tmp16 = 0x14;// RX_SPD_TABLE_LANE.BT.B0 = #001#100 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
  }
  else if (gen_rx==34){
    tmp0 = 0x77;// RX_TOP_ANA_REG_37.BT.B0 = 01110111 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0xE;// PLL_RS_LANE_REG12.BT.B2 = ###01110 , rx_pll_rate_sel_lane[4:0]
    tmp5 = 0x2;// RX_EQ_REG0.BT.B0 = ###00010 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp6 = 0x8;// TX_TRAIN_PATTTERN_REG0.BT.B1 = ####10## , ethernet_mode_lane[1:0]
    tmp8 = 0xB;// ANA_RX_PI_REG0.BT.B0 = ####1011 , rx_pi_icclow_ctrl_lane[3:0]
    tmp9 = 0xB;// ANA_RX_PI_REG1.BT.B0 = ####1011 , rx_pi_icc_ctrl_lane[3:0]
    ...
    tmp0 = 0xE6;// RX_TOP_ANA_REG_37.BT.B0 = 11100110 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0xC;// PLL_RS_LANE_REG12.BT.B2 = ###01100 , rx_pll_rate_sel_lane[4:0]
    tmp3 = 0xC4;// RX_TOP_ANA_REG_35.BT.B0 = 11000100 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
    tmp5 = 0x13;// RX_EQ_REG0.BT.B0 = ###10011 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp7 = 0x60;// RX_TOP_ANA_REG_39.BT.B0 = 0110000# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp8 = 0x9;// ANA_RX_PI_REG0.BT.B0 = ####1001 , rx_pi_icclow_ctrl_lane[3:0]
    tmp9 = 0x8;// ANA_RX_PI_REG1.BT.B0 = ####1000 , rx_pi_icc_ctrl_lane[3:0]
    tmp10 = 0xD0;// RX_TOP_ANA_REG_38.BT.B0 = 1101#### , rx_ctle_rfb_sel_lane[1:0], rx_pi_rsel_lane[1:0]
    tmp11 = 0xE;// RX_TOP_ANA_REG_32.BT.B0 = 00001110 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp12 = 0xF8;// RX_TOP_ANA_REG_36.BT.B0 = 111110## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp13 = 0x6E;// RX_TOP_ANA_REG_34.BT.B0 = 01101110 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    tmp14 = 0x20;// SYSTEM_CONFIG_0.BT.B2 = #01##### , rx_nt_mul_lane[1:0], pll_tsrs_switch_xdat_lane, pll_sel_lane[1:0], mcu_ctrl_pll_lane[1:0]
    tmp16 = 0x14;// RX_SPD_TABLE_LANE.BT.B0 = #001#100 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
  }
  else if (gen_rx==32){
    tmp0 = 0x68;// RX_TOP_ANA_REG_37.BT.B0 = 01101000 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0x8;// PLL_RS_LANE_REG12.BT.B2 = ###01000 , rx_pll_rate_sel_lane[4:0]
    tmp2 = 0x98;// RX_TOP_ANA_REG_40.BT.B0 = 10011### , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
    tmp5 = 0x2;// RX_EQ_REG0.BT.B0 = ###00010 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp6 = 0x8;// TX_TRAIN_PATTTERN_REG0.BT.B1 = ####10## , ethernet_mode_lane[1:0]
    tmp7 = 0x60;// RX_TOP_ANA_REG_39.BT.B0 = 0110000# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp8 = 0x9;// ANA_RX_PI_REG0.BT.B0 = ####1001 , rx_pi_icclow_ctrl_lane[3:0]
    tmp9 = 0x8;// ANA_RX_PI_REG1.BT.B0 = ####1000 , rx_pi_icc_ctrl_lane[3:0]
    tmp10 = 0x50;// RX_TOP_ANA_REG_38.BT.B0 = 0101#### , rx_ctle_rfb_sel_lane[1:0], rx_pi_rsel_lane[1:0]
    tmp11 = 0x6;// RX_TOP_ANA_REG_32.BT.B0 = 00000110 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp12 = 0x58;// RX_TOP_ANA_REG_36.BT.B0 = 010110## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp13 = 0x86;// RX_TOP_ANA_REG_34.BT.B0 = 10000110 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    tmp14 = 0x20;// SYSTEM_CONFIG_0.BT.B2 = #01##### , rx_nt_mul_lane[1:0], pll_tsrs_switch_xdat_lane, pll_sel_lane[1:0], mcu_ctrl_pll_lane[1:0]
    tmp16 = 0x14;// RX_SPD_TABLE_LANE.BT.B0 = #001#100 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
  }
  else if (gen_rx==31){
    tmp0 = 0x4A;// RX_TOP_ANA_REG_37.BT.B0 = 01001010 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0x1;// PLL_RS_LANE_REG12.BT.B2 = ###00001 , rx_pll_rate_sel_lane[4:0]
    tmp3 = 0x69;// RX_TOP_ANA_REG_35.BT.B0 = 01101001 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
    tmp4 = 0x38;// RX_TOP_ANA_REG_33.BT.B0 = 00111### , rx_ctle_cs1_ctrl_lane[4:0]
    tmp5 = 0x2;// RX_EQ_REG0.BT.B0 = ###00010 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp6 = 0x8;// TX_TRAIN_PATTTERN_REG0.BT.B1 = ####10## , ethernet_mode_lane[1:0]
    ...
    tmp0 = 0x77;// RX_TOP_ANA_REG_37.BT.B0 = 01110111 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0x11;// PLL_RS_LANE_REG12.BT.B2 = ###10001 , rx_pll_rate_sel_lane[4:0]
    tmp2 = 0x50;// RX_TOP_ANA_REG_40.BT.B0 = 01010### , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
    tmp5 = 0x12;// RX_EQ_REG0.BT.B0 = ###10010 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp8 = 0xB;// ANA_RX_PI_REG0.BT.B0 = ####1011 , rx_pi_icclow_ctrl_lane[3:0]
    tmp9 = 0xB;// ANA_RX_PI_REG1.BT.B0 = ####1011 , rx_pi_icc_ctrl_lane[3:0]
    ...
    tmp0 = 0x68;// RX_TOP_ANA_REG_37.BT.B0 = 01101000 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0x9;// PLL_RS_LANE_REG12.BT.B2 = ###01001 , rx_pll_rate_sel_lane[4:0]
    tmp5 = 0x12;// RX_EQ_REG0.BT.B0 = ###10010 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp7 = 0x60;// RX_TOP_ANA_REG_39.BT.B0 = 0110000# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp8 = 0x9;// ANA_RX_PI_REG0.BT.B0 = ####1001 , rx_pi_icclow_ctrl_lane[3:0]
    tmp9 = 0x8;// ANA_RX_PI_REG1.BT.B0 = ####1000 , rx_pi_icc_ctrl_lane[3:0]
    ...
    tmp0 = 0x59;// RX_TOP_ANA_REG_37.BT.B0 = 01011001 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0x6;// PLL_RS_LANE_REG12.BT.B2 = ###00110 , rx_pll_rate_sel_lane[4:0]
    tmp2 = 0xD8;// RX_TOP_ANA_REG_40.BT.B0 = 11011### , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
    tmp5 = 0x12;// RX_EQ_REG0.BT.B0 = ###10010 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp7 = 0x60;// RX_TOP_ANA_REG_39.BT.B0 = 0110000# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp10 = 0x60;// RX_TOP_ANA_REG_38.BT.B0 = 0110#### , rx_ctle_rfb_sel_lane[1:0], rx_pi_rsel_lane[1:0]
    tmp11 = 0x5;// RX_TOP_ANA_REG_32.BT.B0 = 00000101 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp12 = 0x54;// RX_TOP_ANA_REG_36.BT.B0 = 010101## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp13 = 0x95;// RX_TOP_ANA_REG_34.BT.B0 = 10010101 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    tmp15 = 0x10;// SYSTEM_CONFIG_0.BT.B3 = 00010000 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp16 = 0x12;// RX_SPD_TABLE_LANE.BT.B0 = #001#010 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
  }
  else if (gen_rx==23){
    ...
    tmp0 = 0x35;// RX_TOP_ANA_REG_37.BT.B0 = 00110101 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0xD;// PLL_RS_LANE_REG12.BT.B2 = ###01101 , rx_pll_rate_sel_lane[4:0]
    tmp3 = 0x69;// RX_TOP_ANA_REG_35.BT.B0 = 01101001 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
    tmp4 = 0x38;// RX_TOP_ANA_REG_33.BT.B0 = 00111### , rx_ctle_cs1_ctrl_lane[4:0]
    tmp7 = 0x5A;// RX_TOP_ANA_REG_39.BT.B0 = 0101101# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp8 = 0xB;// ANA_RX_PI_REG0.BT.B0 = ####1011 , rx_pi_icclow_ctrl_lane[3:0]
    tmp9 = 0xB;// ANA_RX_PI_REG1.BT.B0 = ####1011 , rx_pi_icc_ctrl_lane[3:0]
    tmp10 = 0x0;// RX_TOP_ANA_REG_38.BT.B0 = 0000#### , rx_ctle_rfb_sel_lane[1:0], rx_pi_rsel_lane[1:0]
    tmp11 = 0x3;// RX_TOP_ANA_REG_32.BT.B0 = 00000011 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp12 = 0xC;// RX_TOP_ANA_REG_36.BT.B0 = 000011## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp13 = 0x93;// RX_TOP_ANA_REG_34.BT.B0 = 10010011 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    tmp15 = 0x8;// SYSTEM_CONFIG_0.BT.B3 = 00001000 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp17 = 0x2;// RX_SPD_TABLE_LANE.BT.B1 = #####010 , rx_rxclk_div_ratio_lane[2:0]
  }
  else if (gen_rx==21){
    tmp0 = 0x35;// RX_TOP_ANA_REG_37.BT.B0 = 00110101 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0xC;// PLL_RS_LANE_REG12.BT.B2 = ###01100 , rx_pll_rate_sel_lane[4:0]
    ...
    tmp8 = 0x9;// ANA_RX_PI_REG0.BT.B0 = ####1001 , rx_pi_icclow_ctrl_lane[3:0]
    tmp9 = 0x8;// ANA_RX_PI_REG1.BT.B0 = ####1000 , rx_pi_icc_ctrl_lane[3:0]
    tmp10 = 0x10;// RX_TOP_ANA_REG_38.BT.B0 = 0001#### , rx_ctle_rfb_sel_lane[1:0], rx_pi_rsel_lane[1:0]
    tmp11 = 0x3;// RX_TOP_ANA_REG_32.BT.B0 = 00000011 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp12 = 0xC;// RX_TOP_ANA_REG_36.BT.B0 = 000011## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp13 = 0x93;// RX_TOP_ANA_REG_34.BT.B0 = 10010011 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    tmp15 = 0x8;// SYSTEM_CONFIG_0.BT.B3 = 00001000 , rx_rate_2_pll_ratio_x8_lane[7:0]
    ...
    tmp0 = 0x35;// RX_TOP_ANA_REG_37.BT.B0 = 00110101 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0xA;// PLL_RS_LANE_REG12.BT.B2 = ###01010 , rx_pll_rate_sel_lane[4:0]
    tmp3 = 0x69;// RX_TOP_ANA_REG_35.BT.B0 = 01101001 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
    tmp4 = 0x38;// RX_TOP_ANA_REG_33.BT.B0 = 00111### , rx_ctle_cs1_ctrl_lane[4:0]
    tmp7 = 0x62;// RX_TOP_ANA_REG_39.BT.B0 = 0110001# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp8 = 0x9;// ANA_RX_PI_REG0.BT.B0 = ####1001 , rx_pi_icclow_ctrl_lane[3:0]
    ...
    tmp0 = 0x35;// RX_TOP_ANA_REG_37.BT.B0 = 00110101 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0x7;// PLL_RS_LANE_REG12.BT.B2 = ###00111 , rx_pll_rate_sel_lane[4:0]
    tmp2 = 0xB8;// RX_TOP_ANA_REG_40.BT.B0 = 10111### , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
    tmp3 = 0x69;// RX_TOP_ANA_REG_35.BT.B0 = 01101001 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
    tmp4 = 0x38;// RX_TOP_ANA_REG_33.BT.B0 = 00111### , rx_ctle_cs1_ctrl_lane[4:0]
    tmp7 = 0x62;// RX_TOP_ANA_REG_39.BT.B0 = 0110001# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp11 = 0x3;// RX_TOP_ANA_REG_32.BT.B0 = 00000011 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    ...
    tmp0 = 0x25;// RX_TOP_ANA_REG_37.BT.B0 = 00100101 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0x6;// PLL_RS_LANE_REG12.BT.B2 = ###00110 , rx_pll_rate_sel_lane[4:0]
    tmp2 = 0xD8;// RX_TOP_ANA_REG_40.BT.B0 = 11011### , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
    tmp3 = 0x39;// RX_TOP_ANA_REG_35.BT.B0 = 00111001 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
    tmp4 = 0x10;// RX_TOP_ANA_REG_33.BT.B0 = 00010### , rx_ctle_cs1_ctrl_lane[4:0]
    tmp7 = 0x62;// RX_TOP_ANA_REG_39.BT.B0 = 0110001# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp11 = 0x2;// RX_TOP_ANA_REG_32.BT.B0 = 00000010 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp12 = 0x8;// RX_TOP_ANA_REG_36.BT.B0 = 000010## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp13 = 0xA2;// RX_TOP_ANA_REG_34.BT.B0 = 10100010 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    tmp15 = 0x8;// SYSTEM_CONFIG_0.BT.B3 = 00001000 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp17 = 0x2;// RX_SPD_TABLE_LANE.BT.B1 = #####010 , rx_rxclk_div_ratio_lane[2:0]
  }
  else if (gen_rx==16){
    tmp0 = 0x25;// RX_TOP_ANA_REG_37.BT.B0 = 00100101 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0x5;// PLL_RS_LANE_REG12.BT.B2 = ###00101 , rx_pll_rate_sel_lane[4:0]
    tmp2 = 0xD8;// RX_TOP_ANA_REG_40.BT.B0 = 11011### , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
    tmp3 = 0x39;// RX_TOP_ANA_REG_35.BT.B0 = 00111001 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
    tmp4 = 0x10;// RX_TOP_ANA_REG_33.BT.B0 = 00010### , rx_ctle_cs1_ctrl_lane[4:0]
    tmp7 = 0x62;// RX_TOP_ANA_REG_39.BT.B0 = 0110001# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    ...
    tmp0 = 0x25;// RX_TOP_ANA_REG_37.BT.B0 = 00100101 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp2 = 0x28;// RX_TOP_ANA_REG_40.BT.B0 = 00101### , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
    tmp3 = 0x39;// RX_TOP_ANA_REG_35.BT.B0 = 00111001 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
    tmp4 = 0x10;// RX_TOP_ANA_REG_33.BT.B0 = 00010### , rx_ctle_cs1_ctrl_lane[4:0]
    tmp7 = 0x64;// RX_TOP_ANA_REG_39.BT.B0 = 0110010# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp11 = 0x2;// RX_TOP_ANA_REG_32.BT.B0 = 00000010 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    ...
    tmp0 = 0x15;// RX_TOP_ANA_REG_37.BT.B0 = 00010101 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0x2;// PLL_RS_LANE_REG12.BT.B2 = ###00010 , rx_pll_rate_sel_lane[4:0]
    tmp3 = 0x3A;// RX_TOP_ANA_REG_35.BT.B0 = 00111010 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
    tmp4 = 0x10;// RX_TOP_ANA_REG_33.BT.B0 = 00010### , rx_ctle_cs1_ctrl_lane[4:0]
    tmp7 = 0x6C;// RX_TOP_ANA_REG_39.BT.B0 = 0110110# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp11 = 0x1;// RX_TOP_ANA_REG_32.BT.B0 = 00000001 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp12 = 0x4;// RX_TOP_ANA_REG_36.BT.B0 = 000001## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp13 = 0xA1;// RX_TOP_ANA_REG_34.BT.B0 = 10100001 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    tmp15 = 0x8;// SYSTEM_CONFIG_0.BT.B3 = 00001000 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp17 = 0x2;// RX_SPD_TABLE_LANE.BT.B1 = #####010 , rx_rxclk_div_ratio_lane[2:0]
  }
  else if (gen_rx==13){
    ...
    tmp3 = 0x3A;// RX_TOP_ANA_REG_35.BT.B0 = 00111010 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
    tmp4 = 0x10;// RX_TOP_ANA_REG_33.BT.B0 = 00010### , rx_ctle_cs1_ctrl_lane[4:0]
    tmp5 = 0x10;// RX_EQ_REG0.BT.B0 = ###10000 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp7 = 0x64;// RX_TOP_ANA_REG_39.BT.B0 = 0110010# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp8 = 0x9;// ANA_RX_PI_REG0.BT.B0 = ####1001 , rx_pi_icclow_ctrl_lane[3:0]
    tmp9 = 0x8;// ANA_RX_PI_REG1.BT.B0 = ####1000 , rx_pi_icc_ctrl_lane[3:0]
    tmp10 = 0x10;// RX_TOP_ANA_REG_38.BT.B0 = 0001#### , rx_ctle_rfb_sel_lane[1:0], rx_pi_rsel_lane[1:0]
    ...
    tmp12 = 0x4;// RX_TOP_ANA_REG_36.BT.B0 = 000001## , rx_ctle_rs2_sel_lane[1:0], rx_ctle_cur2_sel_lane[3:0]
    tmp13 = 0xA1;// RX_TOP_ANA_REG_34.BT.B0 = 10100001 , rx_ctle_rs1_ctrl_lane[3:0], rx_ctle_cur1_sel_lane[3:0]
    tmp15 = 0x4;// SYSTEM_CONFIG_0.BT.B3 = 00000100 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp16 = 0x33;// RX_SPD_TABLE_LANE.BT.B0 = #011#011 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
    tmp17 = 0x3;// RX_SPD_TABLE_LANE.BT.B1 = #####011 , rx_rxclk_div_ratio_lane[2:0]
  }
  else if (gen_rx==11){
    tmp0 = 0x15;// RX_TOP_ANA_REG_37.BT.B0 = 00010101 , rx_ctle_cur_tia_sel_lane[3:0], rx_ctle_gain_coarse_lane[3:0]
    tmp1 = 0xB;// PLL_RS_LANE_REG12.BT.B2 = ###01011 , rx_pll_rate_sel_lane[4:0]
    tmp3 = 0x3A;// RX_TOP_ANA_REG_35.BT.B0 = 00111010 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
    tmp4 = 0x10;// RX_TOP_ANA_REG_33.BT.B0 = 00010### , rx_ctle_cs1_ctrl_lane[4:0]
    tmp5 = 0x10;// RX_EQ_REG0.BT.B0 = ###10000 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp7 = 0x64;// RX_TOP_ANA_REG_39.BT.B0 = 0110010# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    ...
    tmp5 = 0x10;// RX_EQ_REG0.BT.B0 = ###10000 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp7 = 0x64;// RX_TOP_ANA_REG_39.BT.B0 = 0110010# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp11 = 0x0;// RX_TOP_ANA_REG_32.BT.B0 = 00000000 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp15 = 0x4;// SYSTEM_CONFIG_0.BT.B3 = 00000100 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp16 = 0x33;// RX_SPD_TABLE_LANE.BT.B0 = #011#011 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
    tmp17 = 0x3;// RX_SPD_TABLE_LANE.BT.B1 = #####011 , rx_rxclk_div_ratio_lane[2:0]
  }
  else if (gen_rx==9){
    tmp1 = 0x4;// PLL_RS_LANE_REG12.BT.B2 = ###00100 , rx_pll_rate_sel_lane[4:0]
    tmp2 = 0xD8;// RX_TOP_ANA_REG_40.BT.B0 = 11011### , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
    tmp3 = 0xA;// RX_TOP_ANA_REG_35.BT.B0 = 00001010 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
    tmp4 = 0x0;// RX_TOP_ANA_REG_33.BT.B0 = 00000### , rx_ctle_cs1_ctrl_lane[4:0]
    tmp5 = 0x10;// RX_EQ_REG0.BT.B0 = ###10000 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    ...
    tmp5 = 0x10;// RX_EQ_REG0.BT.B0 = ###10000 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp7 = 0x6C;// RX_TOP_ANA_REG_39.BT.B0 = 0110110# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp11 = 0x20;// RX_TOP_ANA_REG_32.BT.B0 = 00100000 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp15 = 0x4;// SYSTEM_CONFIG_0.BT.B3 = 00000100 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp16 = 0x33;// RX_SPD_TABLE_LANE.BT.B0 = #011#011 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
    tmp17 = 0x3;// RX_SPD_TABLE_LANE.BT.B1 = #####011 , rx_rxclk_div_ratio_lane[2:0]
  }
    ...
    tmp9 = 0x8;// ANA_RX_PI_REG1.BT.B0 = ####1000 , rx_pi_icc_ctrl_lane[3:0]
    tmp10 = 0x10;// RX_TOP_ANA_REG_38.BT.B0 = 0001#### , rx_ctle_rfb_sel_lane[1:0], rx_pi_rsel_lane[1:0]
    tmp11 = 0x50;// RX_TOP_ANA_REG_32.BT.B0 = 01010000 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp15 = 0x2;// SYSTEM_CONFIG_0.BT.B3 = 00000010 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp16 = 0x43;// RX_SPD_TABLE_LANE.BT.B0 = #100#011 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
    tmp17 = 0x4;// RX_SPD_TABLE_LANE.BT.B1 = #####100 , rx_rxclk_div_ratio_lane[2:0]
  }
    ...
    tmp5 = 0x14;// RX_EQ_REG0.BT.B0 = ###10100 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp7 = 0x6C;// RX_TOP_ANA_REG_39.BT.B0 = 0110110# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp11 = 0x80;// RX_TOP_ANA_REG_32.BT.B0 = 10000000 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp15 = 0x2;// SYSTEM_CONFIG_0.BT.B3 = 00000010 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp16 = 0x43;// RX_SPD_TABLE_LANE.BT.B0 = #100#011 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
    tmp17 = 0x4;// RX_SPD_TABLE_LANE.BT.B1 = #####100 , rx_rxclk_div_ratio_lane[2:0]
  }
    ...
    tmp3 = 0xA;// RX_TOP_ANA_REG_35.BT.B0 = 00001010 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
    tmp4 = 0x0;// RX_TOP_ANA_REG_33.BT.B0 = 00000### , rx_ctle_cs1_ctrl_lane[4:0]
    tmp5 = 0x18;// RX_EQ_REG0.BT.B0 = ###11000 , rx_pam2_en_lane, rx_rate_mode_lane[1:0], rx_th_sel_lane[1:0]
    tmp7 = 0x64;// RX_TOP_ANA_REG_39.BT.B0 = 0110010# , rx_adc_icc_sel_lane[1:0], rx_adc_vdd_sel_lane[2:0], rx_adc_res_sel_lane[1:0]
    tmp11 = 0xB0;// RX_TOP_ANA_REG_32.BT.B0 = 10110000 , rx_innet_tcoil_cl_lane[3:0], rx_ctle_rl1_ctrl_lane[3:0]
    tmp15 = 0x1;// SYSTEM_CONFIG_0.BT.B3 = 00000001 , rx_rate_2_pll_ratio_x8_lane[7:0]
    tmp16 = 0x53;// RX_SPD_TABLE_LANE.BT.B0 = #101#011 , rx_adcclk_div_ratio_lane[2:0], rx_data_width_lane[1:0], rxdata_latency_reduce_en_lane
    tmp17 = 0x5;// RX_SPD_TABLE_LANE.BT.B1 = #####101 , rx_rxclk_div_ratio_lane[2:0]
  }
  else if (gen_rx==1){
    tmp2 = 0x28;// RX_TOP_ANA_REG_40.BT.B0 = 00101### , rx_dll_cap_sel_lane[2:0], rx_a90_cap_sel_lane[1:0]
    tmp3 = 0xA;// RX_TOP_ANA_REG_35.BT.B0 = 00001010 , rx_ctle_cs2_ctrl_lane[3:0], rx_ctle_rs2_ctrl_lane[3:0]
  ...
  PLL_RS_LANE_REG12.BT.B2 = tmp1;
  RX_TOP_ANA_REG_40.BT.B0 = tmp2;
  RX_TOP_ANA_REG_35.BT.B0 = tmp3;
  RX_TOP_ANA_REG_33.BT.B0 = tmp4;
  RX_EQ_REG0.BT.B0 = tmp5;
  TX_TRAIN_PATTTERN_REG0.BT.B1 = tmp6;
  RX_TOP_ANA_REG_39.BT.B0 = tmp7;
  ANA_RX_PI_REG0.BT.B0 = tmp8;
  ANA_RX_PI_REG1.BT.B0 = tmp9;
  RX_TOP_ANA_REG_38.BT.B0 = tmp10;
  RX_TOP_ANA_REG_32.BT.B0 = tmp11;
  RX_TOP_ANA_REG_36.BT.B0 = tmp12;
  RX_TOP_ANA_REG_34.BT.B0 = tmp13;
  SYSTEM_CONFIG_0.BT.B2 = (SYSTEM_CONFIG_0.BT.B2 & 0x1f) | (tmp14 & 0xe0); // (SYSTEM_CONFIG_0.BT.B2 & 00011111) | (tmp14 & 11100000)
  SYSTEM_CONFIG_0.BT.B3 = tmp15;
  RX_SPD_TABLE_LANE.BT.B0 = tmp16;
  RX_SPD_TABLE_LANE.BT.B1 = tmp17;
}
void loadspeedtbl_lc_pll (uint8_t pll_rate_sel, uint8_t ref_clk_sel, int tsrs_sel) BANKING_CTRL {
  ...
  uint8_t tmp8 = 0xD; //PLL_TS_UPHY14_CMN_ANAREG_TOP_000.BT.B0 , pll_ts_vind_band_sel_lane, pll_ts_fbdiv_lane[9:8], pll_ts_pll_lpfr_lane[2:0], pll_ts_tx_intpr_lane[1:0]
  ...
  uint8_t tmp16 = 0xAC; //PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
  if (pll_rate_sel==24){
    ...
    tmp8 = 0xC; //PLL_TS_UPHY14_CMN_ANAREG_TOP_000.BT.B0 , pll_ts_vind_band_sel_lane, pll_ts_fbdiv_lane[9:8], pll_ts_pll_lpfr_lane[2:0], pll_ts_tx_intpr_lane[1:0]
    ...
    if (ref_clk_sel==7){
      ...
      tmp8 = 0x0;// PLL_TS_UPHY14_CMN_ANAREG_TOP_000.BT.B0 = 00000000 , pll_ts_vind_band_sel_lane, pll_ts_fbdiv_lane[9:8], pll_ts_pll_lpfr_lane[2:0], pll_ts_tx_intpr_lane[1:0]
      ...
      tmp16 = 0x64;// PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 = 01100100 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    }
    ...
    if (ref_clk_sel==7){
      ...
      tmp13 = 0xF4;// PLL_TS_LANE_REG1.BT.B0 = 11110100 , pll_ts_init_foffs_lane[15:0]
      tmp14 = 0xA;// PLL_TS_LANE_REG1.BT.B1 = 00001010 , pll_ts_init_foffs_lane[15:0]
      tmp16 = 0x1C;// PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 = 00011100 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    }
    else if (ref_clk_sel==6){
      tmp2 = 0x1C;// PLL_TS_UPHY14_CMN_ANAREG_TOP_002.BT.B0 = 00011100 , pll_ts_fbdiv_lane[7:0]
      tmp16 = 0xC;// PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 = 00001100 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    }
    else if (ref_clk_sel==5){
      tmp2 = 0x23;// PLL_TS_UPHY14_CMN_ANAREG_TOP_002.BT.B0 = 00100011 , pll_ts_fbdiv_lane[7:0]
      tmp16 = 0x14;// PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 = 00010100 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    }
    else if (ref_clk_sel==4){
      tmp2 = 0x38;// PLL_TS_UPHY14_CMN_ANAREG_TOP_002.BT.B0 = 00111000 , pll_ts_fbdiv_lane[7:0]
      ...
      tmp2 = 0x46;// PLL_TS_UPHY14_CMN_ANAREG_TOP_002.BT.B0 = 01000110 , pll_ts_fbdiv_lane[7:0]
      tmp16 = 0x2C;// PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 = 00101100 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    }
    else if (ref_clk_sel==2){
      tmp13 = 0x10;// PLL_TS_LANE_REG1.BT.B0 = 00010000 , pll_ts_init_foffs_lane[15:0]
      tmp14 = 0x10;// PLL_TS_LANE_REG1.BT.B1 = 00010000 , pll_ts_init_foffs_lane[15:0]
      ...
      tmp13 = 0x61;// PLL_TS_LANE_REG1.BT.B0 = 01100001 , pll_ts_init_foffs_lane[15:0]
      tmp14 = 0x4;// PLL_TS_LANE_REG1.BT.B1 = 00000100 , pll_ts_init_foffs_lane[15:0]
      tmp16 = 0x4C;// PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 = 01001100 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    }
    else if (ref_clk_sel==0){
      tmp2 = 0x8C;// PLL_TS_UPHY14_CMN_ANAREG_TOP_002.BT.B0 = 10001100 , pll_ts_fbdiv_lane[7:0]
    }
    ...
    tmp16 = 0xA4; //PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    if (ref_clk_sel==7){
      tmp2 = 0x55;// PLL_TS_UPHY14_CMN_ANAREG_TOP_002.BT.B0 = 01010101 , pll_ts_fbdiv_lane[7:0]
      tmp12 = 0x22;// PLL_TS_UPHY14_CMN_ANAREG_TOP_003.BT.B0 = 0010001# , pll_ts_refdiv_lane[4:0], pll_ts_pll_lpfc_lane[1:0]
      tmp13 = 0x0;// PLL_TS_LANE_REG1.BT.B0 = 00000000 , pll_ts_init_foffs_lane[15:0]
    ...
    tmp16 = 0x74; //PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    if (ref_clk_sel==7){
      tmp2 = 0x55;// PLL_TS_UPHY14_CMN_ANAREG_TOP_002.BT.B0 = 01010101 , pll_ts_fbdiv_lane[7:0]
      tmp12 = 0x22;// PLL_TS_UPHY14_CMN_ANAREG_TOP_003.BT.B0 = 0010001# , pll_ts_refdiv_lane[4:0], pll_ts_pll_lpfc_lane[1:0]
    ...
    tmp16 = 0xA3; //PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    if (ref_clk_sel==7){
      ...
      tmp16 = 0x73;// PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 = 01110011 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    }
    else if (ref_clk_sel==5){
    ...
    tmp14 = 0x2; //PLL_TS_LANE_REG1.BT.B1 , pll_ts_init_foffs_lane[15:0]
    tmp16 = 0x73; //PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    if (ref_clk_sel==7){
      tmp2 = 0x3E;// PLL_TS_UPHY14_CMN_ANAREG_TOP_002.BT.B0 = 00111110 , pll_ts_fbdiv_lane[7:0]
      ...
      tmp14 = 0x8;// PLL_TS_LANE_REG1.BT.B1 = 00001000 , pll_ts_init_foffs_lane[15:0]
      tmp16 = 0x33;// PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 = 00110011 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    }
    else if (ref_clk_sel==6){
    ...
    tmp4 = 0xC; //PLL_TS_DTX_REG2.BT.B1 , pll_ts_ssc_m_lane[12:0]
    tmp9 = 0x40; //PLL_TS_CAL_CTRL_LANE.BT.B0 , pll_ts_speed_thresh_lane[15:0]
    tmp16 = 0xDB; //PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    if (ref_clk_sel==7){
    ...
    if (ref_clk_sel==7){
      ...
      tmp14 = 0xFD;// PLL_TS_LANE_REG1.BT.B1 = 11111101 , pll_ts_init_foffs_lane[15:0]
      tmp16 = 0xFB;// PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 = 11111011 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    }
    else if (ref_clk_sel==0){
      tmp2 = 0x7A;// PLL_TS_UPHY14_CMN_ANAREG_TOP_002.BT.B0 = 01111010 , pll_ts_fbdiv_lane[7:0]
      tmp12 = 0xA;// PLL_TS_UPHY14_CMN_ANAREG_TOP_003.BT.B0 = 0000101# , pll_ts_refdiv_lane[4:0], pll_ts_pll_lpfc_lane[1:0]
    ...
    if (ref_clk_sel==7){
      ...
      tmp16 = 0x2B;// PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 = 00101011 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    }
    else if (ref_clk_sel==6){
    ...
    tmp16 = 0x91; //PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    if (ref_clk_sel==7){
      tmp2 = 0x25;// PLL_TS_UPHY14_CMN_ANAREG_TOP_002.BT.B0 = 00100101 , pll_ts_fbdiv_lane[7:0]
      tmp12 = 0x12;// PLL_TS_UPHY14_CMN_ANAREG_TOP_003.BT.B0 = 0001001# , pll_ts_refdiv_lane[4:0], pll_ts_pll_lpfc_lane[1:0]
      tmp13 = 0x0;// PLL_TS_LANE_REG1.BT.B0 = 00000000 , pll_ts_init_foffs_lane[15:0]
      tmp14 = 0x0;// PLL_TS_LANE_REG1.BT.B1 = 00000000 , pll_ts_init_foffs_lane[15:0]
      tmp16 = 0x29;// PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 = 00101001 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    }
    else if (ref_clk_sel==6){
      tmp12 = 0x2A;// PLL_TS_UPHY14_CMN_ANAREG_TOP_003.BT.B0 = 0010101# , pll_ts_refdiv_lane[4:0], pll_ts_pll_lpfc_lane[1:0]
    }
      ...
      tmp16 = 0x19;// PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 = 00011001 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    }
    else if (ref_clk_sel==4){
      ...
      tmp16 = 0x41;// PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 = 01000001 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    }
    else if (ref_clk_sel==2){
      ...
      tmp13 = 0xF2;// PLL_TS_LANE_REG1.BT.B0 = 11110010 , pll_ts_init_foffs_lane[15:0]
      tmp14 = 0xF0;// PLL_TS_LANE_REG1.BT.B1 = 11110000 , pll_ts_init_foffs_lane[15:0]
      tmp16 = 0x71;// PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 = 01110001 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    }
    else if (ref_clk_sel==0){
    }
  }
    ...
    tmp13 = 0xB3; //PLL_TS_LANE_REG1.BT.B0 , pll_ts_init_foffs_lane[15:0]
    tmp14 = 0xF8; //PLL_TS_LANE_REG1.BT.B1 , pll_ts_init_foffs_lane[15:0]
    tmp16 = 0xD8; //PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    if (ref_clk_sel==7){
      tmp2 = 0x54;// PLL_TS_UPHY14_CMN_ANAREG_TOP_002.BT.B0 = 01010100 , pll_ts_fbdiv_lane[7:0]
      tmp12 = 0x2A;// PLL_TS_UPHY14_CMN_ANAREG_TOP_003.BT.B0 = 0010101# , pll_ts_refdiv_lane[4:0], pll_ts_pll_lpfc_lane[1:0]
      tmp16 = 0xA8;// PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 = 10101000 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    }
    else if (ref_clk_sel==6){
      tmp2 = 0x15;// PLL_TS_UPHY14_CMN_ANAREG_TOP_002.BT.B0 = 00010101 , pll_ts_fbdiv_lane[7:0]
      tmp16 = 0x20;// PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 = 00100000 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    }
    else if (ref_clk_sel==5){
      tmp12 = 0x22;// PLL_TS_UPHY14_CMN_ANAREG_TOP_003.BT.B0 = 0010001# , pll_ts_refdiv_lane[4:0], pll_ts_pll_lpfc_lane[1:0]
    }
      ...
      tmp13 = 0x10;// PLL_TS_LANE_REG1.BT.B0 = 00010000 , pll_ts_init_foffs_lane[15:0]
      tmp14 = 0x10;// PLL_TS_LANE_REG1.BT.B1 = 00010000 , pll_ts_init_foffs_lane[15:0]
      tmp16 = 0x88;// PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 = 10001000 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    }
    else if (ref_clk_sel==1){
      tmp2 = 0x58;// PLL_TS_UPHY14_CMN_ANAREG_TOP_002.BT.B0 = 01011000 , pll_ts_fbdiv_lane[7:0]
      tmp13 = 0x10;// PLL_TS_LANE_REG1.BT.B0 = 00010000 , pll_ts_init_foffs_lane[15:0]
      tmp14 = 0x10;// PLL_TS_LANE_REG1.BT.B1 = 00010000 , pll_ts_init_foffs_lane[15:0]
      tmp16 = 0xB8;// PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 = 10111000 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    }
    else if (ref_clk_sel==0){
    }
  }
    ...
    if (ref_clk_sel==7){
      ...
      tmp13 = 0x0;// PLL_TS_LANE_REG1.BT.B0 = 00000000 , pll_ts_init_foffs_lane[15:0]
      tmp14 = 0x0;// PLL_TS_LANE_REG1.BT.B1 = 00000000 , pll_ts_init_foffs_lane[15:0]
      tmp16 = 0x40;// PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 = 01000000 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    }
    else if (ref_clk_sel==6){
      tmp2 = 0x3E;// PLL_TS_UPHY14_CMN_ANAREG_TOP_002.BT.B0 = 00111110 , pll_ts_fbdiv_lane[7:0]
      tmp12 = 0x1A;// PLL_TS_UPHY14_CMN_ANAREG_TOP_003.BT.B0 = 0001101# , pll_ts_refdiv_lane[4:0], pll_ts_pll_lpfc_lane[1:0]
      ...
      tmp13 = 0x0;// PLL_TS_LANE_REG1.BT.B0 = 00000000 , pll_ts_init_foffs_lane[15:0]
      tmp14 = 0x0;// PLL_TS_LANE_REG1.BT.B1 = 00000000 , pll_ts_init_foffs_lane[15:0]
      tmp16 = 0xF8;// PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 = 11111000 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    }
    else if (ref_clk_sel==3){
    }
    else if (ref_clk_sel==2){
    ...
    tmp14 = 0xFB; //PLL_TS_LANE_REG1.BT.B1 , pll_ts_init_foffs_lane[15:0]
    tmp16 = 0xA8; //PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    if (ref_clk_sel==7){
      tmp12 = 0x2A;// PLL_TS_UPHY14_CMN_ANAREG_TOP_003.BT.B0 = 0010101# , pll_ts_refdiv_lane[4:0], pll_ts_pll_lpfc_lane[1:0]
    }
    else if (ref_clk_sel==6){
    ...
    tmp9 = 0x40; //PLL_TS_CAL_CTRL_LANE.BT.B0 , pll_ts_speed_thresh_lane[15:0]
    tmp12 = 0x12; //PLL_TS_UPHY14_CMN_ANAREG_TOP_003.BT.B0 , pll_ts_refdiv_lane[4:0], pll_ts_pll_lpfc_lane[1:0]
    tmp16 = 0xF8; //PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    if (ref_clk_sel==7){
      tmp2 = 0x20;// PLL_TS_UPHY14_CMN_ANAREG_TOP_002.BT.B0 = 00100000 , pll_ts_fbdiv_lane[7:0]
      tmp16 = 0x38;// PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 = 00111000 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    }
    else if (ref_clk_sel==6){
    ...
    tmp6 = 0x48; //PLL_TS_UPHY14_CMN_ANAREG_TOP_027.BT.B0 , pll_ts_lcpll_postdiv_dcc_cap_en_lane[4:0]
    tmp7 = 0xA5; //PLL_TS_UPHY14_CMN_ANAREG_TOP_012.BT.B0 , pll_ts_txclk_pi_icc_ctrl_lane[3:0], pll_ts_txclk_pi_icclow_ctrl_lane[3:0]
    tmp8 = 0x8C; //PLL_TS_UPHY14_CMN_ANAREG_TOP_000.BT.B0 , pll_ts_vind_band_sel_lane, pll_ts_fbdiv_lane[9:8], pll_ts_pll_lpfr_lane[2:0], pll_ts_tx_intpr_lane[1:0]
    ...
    tmp16 = 0x24; //PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    if (ref_clk_sel==7){
    ...
    tmp15 = 0x3; //PLL_TS_UPHY14_CMN_ANAREG_TOP_018.BT.B0 , pll_ts_ck500m_div_lane[1:0], pll_ts_lcpll_postdiv_en_lane, pll_ts_lcpll_postdiv_1p5or2_en_lane
    tmp16 = 0x23; //PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    if (ref_clk_sel==7){
      tmp2 = 0x66;// PLL_TS_UPHY14_CMN_ANAREG_TOP_002.BT.B0 = 01100110 , pll_ts_fbdiv_lane[7:0]
      tmp12 = 0x2A;// PLL_TS_UPHY14_CMN_ANAREG_TOP_003.BT.B0 = 0010101# , pll_ts_refdiv_lane[4:0], pll_ts_pll_lpfc_lane[1:0]
      tmp13 = 0x0;// PLL_TS_LANE_REG1.BT.B0 = 00000000 , pll_ts_init_foffs_lane[15:0]
      ...
      tmp2 = 0x20;// PLL_TS_UPHY14_CMN_ANAREG_TOP_002.BT.B0 = 00100000 , pll_ts_fbdiv_lane[7:0]
      tmp16 = 0x13;// PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 = 00010011 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    }
    else if (ref_clk_sel==4){
      tmp13 = 0x0;// PLL_TS_LANE_REG1.BT.B0 = 00000000 , pll_ts_init_foffs_lane[15:0]
      tmp14 = 0x0;// PLL_TS_LANE_REG1.BT.B1 = 00000000 , pll_ts_init_foffs_lane[15:0]
    ...
    tmp10 = 0x1E; //PLL_TS_CAL_CTRL_LANE.BT.B1 , pll_ts_speed_thresh_lane[15:0]
    tmp15 = 0x3; //PLL_TS_UPHY14_CMN_ANAREG_TOP_018.BT.B0 , pll_ts_ck500m_div_lane[1:0], pll_ts_lcpll_postdiv_en_lane, pll_ts_lcpll_postdiv_1p5or2_en_lane
    tmp16 = 0x31; //PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    if (ref_clk_sel==7){
      ...
      tmp14 = 0x12;// PLL_TS_LANE_REG1.BT.B1 = 00010010 , pll_ts_init_foffs_lane[15:0]
      tmp16 = 0x89;// PLL_TS_UPHY14_CMN_ANAREG_TOP_004.BT.B0 = 10001001 , pll_ts_icp_lane[4:0], pll_ts_pll_reg_sel_lane[2:0]
    }
  }
  if (tsrs_sel==0){
...
void loadspeedtbl_tx() BANKING_CTRL {
  uint8_t tmp0 = 0x3; //PLL_TS_LANE_REG12.BT.B2 , tx_pll_rate_sel_lane[4:0]
  uint8_t tmp1 = 0x40; //TX_SYSTEM_LANE1.BT.B3 , tx_pam2_en_lane
  uint8_t tmp2 = 0x20; //PHYTEST_TX0.BT.B2 , tx_train_pat_sel_lane[2:0]
  uint8_t tmp3 = 0x11; //TX_TRAINING_IF_REG3.BT.B0 , tx_train_pat_two_zero_lane, ethernet_mode_tx_lane[1:0]
  uint8_t tmp4 = 0x6; //ANA_TXREG_REG1.BT.B0 , txreg_speedtrk_data_lane[3:0]
  uint8_t tmp5 = 0x6; //ANA_TXREG_REG0.BT.B0 , txreg_speedtrk_clk_lane[3:0]
  uint8_t tmp6 = 0x0; //CLKGEN_TX_LANE_REG1_LANE.BT.B0 , txdata_latency_reduce_en_lane
  uint8_t tmp7 = 0x2; //ANA_TXSPEED_REG0.BT.B0 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
  uint8_t tmp8 = 0x1; //TX_SYSTEM_LANE0.BT.B1 , tx_data_width_lane[1:0]
  uint8_t tmp9 = 0x0; //ANA_TX_FIR_REG0.BT.B0 , tx_fir_bypass_l1_delay_lane, tx_fir_bypass_l2_delay_lane, tx_fir_bypass_l3_delay_lane, tx_fir_2_dig_clk_div_lane
  if (gen_tx==48){
    tmp0 = 0x18;// PLL_TS_LANE_REG12.BT.B2 = ###11000 , tx_pll_rate_sel_lane[4:0]
    tmp1 = 0x0;// TX_SYSTEM_LANE1.BT.B3 = #0###### , tx_pam2_en_lane
    tmp2 = 0x60;// PHYTEST_TX0.BT.B2 = 011##### , tx_train_pat_sel_lane[2:0]
    tmp3 = 0x12;// TX_TRAINING_IF_REG3.BT.B0 = ###1##10 , tx_train_pat_two_zero_lane, ethernet_mode_tx_lane[1:0]
    tmp4 = 0x3;// ANA_TXREG_REG1.BT.B0 = ####0011 , txreg_speedtrk_data_lane[3:0]
    tmp5 = 0x3;// ANA_TXREG_REG0.BT.B0 = ####0011 , txreg_speedtrk_clk_lane[3:0]
    tmp7 = 0x1;// ANA_TXSPEED_REG0.BT.B0 = 000##001 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
    tmp8 = 0x2;// TX_SYSTEM_LANE0.BT.B1 = ######10 , tx_data_width_lane[1:0]
  }
  else if (gen_tx==47){
    tmp0 = 0x0;// PLL_TS_LANE_REG12.BT.B2 = ###00000 , tx_pll_rate_sel_lane[4:0]
    tmp4 = 0x4;// ANA_TXREG_REG1.BT.B0 = ####0100 , txreg_speedtrk_data_lane[3:0]
    tmp5 = 0x4;// ANA_TXREG_REG0.BT.B0 = ####0100 , txreg_speedtrk_clk_lane[3:0]
    tmp7 = 0x1;// ANA_TXSPEED_REG0.BT.B0 = 000##001 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
  }
  else if (gen_tx==46){
    tmp0 = 0x6;// PLL_TS_LANE_REG12.BT.B2 = ###00110 , tx_pll_rate_sel_lane[4:0]
    tmp4 = 0x1;// ANA_TXREG_REG1.BT.B0 = ####0001 , txreg_speedtrk_data_lane[3:0]
    tmp5 = 0x1;// ANA_TXREG_REG0.BT.B0 = ####0001 , txreg_speedtrk_clk_lane[3:0]
    tmp6 = 0x1;// CLKGEN_TX_LANE_REG1_LANE.BT.B0 = #######1 , txdata_latency_reduce_en_lane
    tmp7 = 0x4;// ANA_TXSPEED_REG0.BT.B0 = 000##100 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
    tmp9 = 0xE0;// ANA_TX_FIR_REG0.BT.B0 = 1110#### , tx_fir_bypass_l1_delay_lane, tx_fir_bypass_l2_delay_lane, tx_fir_bypass_l3_delay_lane, tx_fir_2_dig_clk_div_lane
  }
  else if (gen_tx==45){
    tmp0 = 0x16;// PLL_TS_LANE_REG12.BT.B2 = ###10110 , tx_pll_rate_sel_lane[4:0]
    tmp1 = 0x0;// TX_SYSTEM_LANE1.BT.B3 = #0###### , tx_pam2_en_lane
    tmp2 = 0x60;// PHYTEST_TX0.BT.B2 = 011##### , tx_train_pat_sel_lane[2:0]
    tmp3 = 0x12;// TX_TRAINING_IF_REG3.BT.B0 = ###1##10 , tx_train_pat_two_zero_lane, ethernet_mode_tx_lane[1:0]
    tmp7 = 0x60;// ANA_TXSPEED_REG0.BT.B0 = 011##000 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
    tmp8 = 0x2;// TX_SYSTEM_LANE0.BT.B1 = ######10 , tx_data_width_lane[1:0]
  }
  else if (gen_tx==44){
    tmp0 = 0x15;// PLL_TS_LANE_REG12.BT.B2 = ###10101 , tx_pll_rate_sel_lane[4:0]
    tmp1 = 0x0;// TX_SYSTEM_LANE1.BT.B3 = #0###### , tx_pam2_en_lane
    tmp2 = 0x60;// PHYTEST_TX0.BT.B2 = 011##### , tx_train_pat_sel_lane[2:0]
    tmp3 = 0x12;// TX_TRAINING_IF_REG3.BT.B0 = ###1##10 , tx_train_pat_two_zero_lane, ethernet_mode_tx_lane[1:0]
    tmp7 = 0x60;// ANA_TXSPEED_REG0.BT.B0 = 011##000 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
    ...
    tmp0 = 0x16;// PLL_TS_LANE_REG12.BT.B2 = ###10110 , tx_pll_rate_sel_lane[4:0]
    tmp2 = 0x40;// PHYTEST_TX0.BT.B2 = 010##### , tx_train_pat_sel_lane[2:0]
    tmp7 = 0x60;// ANA_TXSPEED_REG0.BT.B0 = 011##000 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
  }
  else if (gen_tx==42){
    tmp0 = 0x15;// PLL_TS_LANE_REG12.BT.B2 = ###10101 , tx_pll_rate_sel_lane[4:0]
    ...
    tmp0 = 0x14;// PLL_TS_LANE_REG12.BT.B2 = ###10100 , tx_pll_rate_sel_lane[4:0]
    tmp1 = 0x0;// TX_SYSTEM_LANE1.BT.B3 = #0###### , tx_pam2_en_lane
    tmp2 = 0x60;// PHYTEST_TX0.BT.B2 = 011##### , tx_train_pat_sel_lane[2:0]
    tmp3 = 0x13;// TX_TRAINING_IF_REG3.BT.B0 = ###1##11 , tx_train_pat_two_zero_lane, ethernet_mode_tx_lane[1:0]
    tmp4 = 0xC;// ANA_TXREG_REG1.BT.B0 = ####1100 , txreg_speedtrk_data_lane[3:0]
    tmp5 = 0xC;// ANA_TXREG_REG0.BT.B0 = ####1100 , txreg_speedtrk_clk_lane[3:0]
    tmp7 = 0x20;// ANA_TXSPEED_REG0.BT.B0 = 001##000 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
    tmp8 = 0x3;// TX_SYSTEM_LANE0.BT.B1 = ######11 , tx_data_width_lane[1:0]
    tmp9 = 0x10;// ANA_TX_FIR_REG0.BT.B0 = 0001#### , tx_fir_bypass_l1_delay_lane, tx_fir_bypass_l2_delay_lane, tx_fir_bypass_l3_delay_lane, tx_fir_2_dig_clk_div_lane
  }
  else if (gen_tx==40){
    tmp0 = 0x12;// PLL_TS_LANE_REG12.BT.B2 = ###10010 , tx_pll_rate_sel_lane[4:0]
    tmp1 = 0x0;// TX_SYSTEM_LANE1.BT.B3 = #0###### , tx_pam2_en_lane
    tmp2 = 0x60;// PHYTEST_TX0.BT.B2 = 011##### , tx_train_pat_sel_lane[2:0]
    tmp3 = 0x13;// TX_TRAINING_IF_REG3.BT.B0 = ###1##11 , tx_train_pat_two_zero_lane, ethernet_mode_tx_lane[1:0]
    tmp4 = 0xC;// ANA_TXREG_REG1.BT.B0 = ####1100 , txreg_speedtrk_data_lane[3:0]
    tmp5 = 0xC;// ANA_TXREG_REG0.BT.B0 = ####1100 , txreg_speedtrk_clk_lane[3:0]
    tmp7 = 0x40;// ANA_TXSPEED_REG0.BT.B0 = 010##000 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
    tmp8 = 0x3;// TX_SYSTEM_LANE0.BT.B1 = ######11 , tx_data_width_lane[1:0]
    tmp9 = 0x10;// ANA_TX_FIR_REG0.BT.B0 = 0001#### , tx_fir_bypass_l1_delay_lane, tx_fir_bypass_l2_delay_lane, tx_fir_bypass_l3_delay_lane, tx_fir_2_dig_clk_div_lane
  }
  else if (gen_tx==39){
    tmp0 = 0x10;// PLL_TS_LANE_REG12.BT.B2 = ###10000 , tx_pll_rate_sel_lane[4:0]
    tmp1 = 0x0;// TX_SYSTEM_LANE1.BT.B3 = #0###### , tx_pam2_en_lane
    tmp2 = 0x60;// PHYTEST_TX0.BT.B2 = 011##### , tx_train_pat_sel_lane[2:0]
    tmp3 = 0x13;// TX_TRAINING_IF_REG3.BT.B0 = ###1##11 , tx_train_pat_two_zero_lane, ethernet_mode_tx_lane[1:0]
    tmp4 = 0xC;// ANA_TXREG_REG1.BT.B0 = ####1100 , txreg_speedtrk_data_lane[3:0]
    ...
    tmp2 = 0x60;// PHYTEST_TX0.BT.B2 = 011##### , tx_train_pat_sel_lane[2:0]
    tmp3 = 0x12;// TX_TRAINING_IF_REG3.BT.B0 = ###1##10 , tx_train_pat_two_zero_lane, ethernet_mode_tx_lane[1:0]
    tmp7 = 0xE0;// ANA_TXSPEED_REG0.BT.B0 = 111##000 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
    tmp8 = 0x2;// TX_SYSTEM_LANE0.BT.B1 = ######10 , tx_data_width_lane[1:0]
  }
  else if (gen_tx==37){
    tmp0 = 0x13;// PLL_TS_LANE_REG12.BT.B2 = ###10011 , tx_pll_rate_sel_lane[4:0]
    tmp1 = 0x0;// TX_SYSTEM_LANE1.BT.B3 = #0###### , tx_pam2_en_lane
    tmp2 = 0x60;// PHYTEST_TX0.BT.B2 = 011##### , tx_train_pat_sel_lane[2:0]
    tmp3 = 0x12;// TX_TRAINING_IF_REG3.BT.B0 = ###1##10 , tx_train_pat_two_zero_lane, ethernet_mode_tx_lane[1:0]
    tmp7 = 0xE0;// ANA_TXSPEED_REG0.BT.B0 = 111##000 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
    ...
    tmp0 = 0xE;// PLL_TS_LANE_REG12.BT.B2 = ###01110 , tx_pll_rate_sel_lane[4:0]
    tmp1 = 0x0;// TX_SYSTEM_LANE1.BT.B3 = #0###### , tx_pam2_en_lane
    tmp2 = 0x60;// PHYTEST_TX0.BT.B2 = 011##### , tx_train_pat_sel_lane[2:0]
    tmp3 = 0x12;// TX_TRAINING_IF_REG3.BT.B0 = ###1##10 , tx_train_pat_two_zero_lane, ethernet_mode_tx_lane[1:0]
    tmp7 = 0x1;// ANA_TXSPEED_REG0.BT.B0 = 000##001 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
    ...
    tmp0 = 0xC;// PLL_TS_LANE_REG12.BT.B2 = ###01100 , tx_pll_rate_sel_lane[4:0]
    tmp2 = 0x40;// PHYTEST_TX0.BT.B2 = 010##### , tx_train_pat_sel_lane[2:0]
    tmp4 = 0xB;// ANA_TXREG_REG1.BT.B0 = ####1011 , txreg_speedtrk_data_lane[3:0]
    tmp5 = 0xB;// ANA_TXREG_REG0.BT.B0 = ####1011 , txreg_speedtrk_clk_lane[3:0]
    tmp7 = 0x40;// ANA_TXSPEED_REG0.BT.B0 = 010##000 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
    tmp8 = 0x2;// TX_SYSTEM_LANE0.BT.B1 = ######10 , tx_data_width_lane[1:0]
    tmp9 = 0x10;// ANA_TX_FIR_REG0.BT.B0 = 0001#### , tx_fir_bypass_l1_delay_lane, tx_fir_bypass_l2_delay_lane, tx_fir_bypass_l3_delay_lane, tx_fir_2_dig_clk_div_lane
  }
  else if (gen_tx==32){
    tmp0 = 0x8;// PLL_TS_LANE_REG12.BT.B2 = ###01000 , tx_pll_rate_sel_lane[4:0]
    tmp1 = 0x0;// TX_SYSTEM_LANE1.BT.B3 = #0###### , tx_pam2_en_lane
    tmp2 = 0x60;// PHYTEST_TX0.BT.B2 = 011##### , tx_train_pat_sel_lane[2:0]
    tmp3 = 0x12;// TX_TRAINING_IF_REG3.BT.B0 = ###1##10 , tx_train_pat_two_zero_lane, ethernet_mode_tx_lane[1:0]
    tmp4 = 0x5;// ANA_TXREG_REG1.BT.B0 = ####0101 , txreg_speedtrk_data_lane[3:0]
    tmp5 = 0x5;// ANA_TXREG_REG0.BT.B0 = ####0101 , txreg_speedtrk_clk_lane[3:0]
    tmp7 = 0x1;// ANA_TXSPEED_REG0.BT.B0 = 000##001 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
    tmp8 = 0x2;// TX_SYSTEM_LANE0.BT.B1 = ######10 , tx_data_width_lane[1:0]
  }
  else if (gen_tx==31){
    tmp0 = 0x1;// PLL_TS_LANE_REG12.BT.B2 = ###00001 , tx_pll_rate_sel_lane[4:0]
    tmp1 = 0x0;// TX_SYSTEM_LANE1.BT.B3 = #0###### , tx_pam2_en_lane
    tmp2 = 0x60;// PHYTEST_TX0.BT.B2 = 011##### , tx_train_pat_sel_lane[2:0]
    tmp3 = 0x12;// TX_TRAINING_IF_REG3.BT.B0 = ###1##10 , tx_train_pat_two_zero_lane, ethernet_mode_tx_lane[1:0]
    tmp4 = 0x4;// ANA_TXREG_REG1.BT.B0 = ####0100 , txreg_speedtrk_data_lane[3:0]
    ...
    tmp0 = 0x11;// PLL_TS_LANE_REG12.BT.B2 = ###10001 , tx_pll_rate_sel_lane[4:0]
    tmp2 = 0x40;// PHYTEST_TX0.BT.B2 = 010##### , tx_train_pat_sel_lane[2:0]
    tmp7 = 0xE0;// ANA_TXSPEED_REG0.BT.B0 = 111##000 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
  }
  else if (gen_tx==27){
    ...
    tmp0 = 0x9;// PLL_TS_LANE_REG12.BT.B2 = ###01001 , tx_pll_rate_sel_lane[4:0]
    tmp2 = 0x40;// PHYTEST_TX0.BT.B2 = 010##### , tx_train_pat_sel_lane[2:0]
    tmp7 = 0x1;// ANA_TXSPEED_REG0.BT.B0 = 000##001 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
  }
  else if (gen_tx==24){
    ...
    tmp0 = 0xD;// PLL_TS_LANE_REG12.BT.B2 = ###01101 , tx_pll_rate_sel_lane[4:0]
    tmp4 = 0x3;// ANA_TXREG_REG1.BT.B0 = ####0011 , txreg_speedtrk_data_lane[3:0]
    tmp5 = 0x3;// ANA_TXREG_REG0.BT.B0 = ####0011 , txreg_speedtrk_clk_lane[3:0]
  }
  else if (gen_tx==21){
    ...
    tmp4 = 0x3;// ANA_TXREG_REG1.BT.B0 = ####0011 , txreg_speedtrk_data_lane[3:0]
    tmp5 = 0x3;// ANA_TXREG_REG0.BT.B0 = ####0011 , txreg_speedtrk_clk_lane[3:0]
    tmp9 = 0x60;// ANA_TX_FIR_REG0.BT.B0 = 0110#### , tx_fir_bypass_l1_delay_lane, tx_fir_bypass_l2_delay_lane, tx_fir_bypass_l3_delay_lane, tx_fir_2_dig_clk_div_lane
  }
  else if (gen_tx==20){
    tmp0 = 0xA;// PLL_TS_LANE_REG12.BT.B2 = ###01010 , tx_pll_rate_sel_lane[4:0]
    tmp4 = 0x3;// ANA_TXREG_REG1.BT.B0 = ####0011 , txreg_speedtrk_data_lane[3:0]
    tmp5 = 0x3;// ANA_TXREG_REG0.BT.B0 = ####0011 , txreg_speedtrk_clk_lane[3:0]
    tmp9 = 0x60;// ANA_TX_FIR_REG0.BT.B0 = 0110#### , tx_fir_bypass_l1_delay_lane, tx_fir_bypass_l2_delay_lane, tx_fir_bypass_l3_delay_lane, tx_fir_2_dig_clk_div_lane
  }
    ...
    tmp0 = 0x7;// PLL_TS_LANE_REG12.BT.B2 = ###00111 , tx_pll_rate_sel_lane[4:0]
    tmp4 = 0x3;// ANA_TXREG_REG1.BT.B0 = ####0011 , txreg_speedtrk_data_lane[3:0]
    tmp5 = 0x3;// ANA_TXREG_REG0.BT.B0 = ####0011 , txreg_speedtrk_clk_lane[3:0]
    tmp9 = 0x60;// ANA_TX_FIR_REG0.BT.B0 = 0110#### , tx_fir_bypass_l1_delay_lane, tx_fir_bypass_l2_delay_lane, tx_fir_bypass_l3_delay_lane, tx_fir_2_dig_clk_div_lane
  }
    ...
    tmp0 = 0x5;// PLL_TS_LANE_REG12.BT.B2 = ###00101 , tx_pll_rate_sel_lane[4:0]
    tmp4 = 0x3;// ANA_TXREG_REG1.BT.B0 = ####0011 , txreg_speedtrk_data_lane[3:0]
    tmp5 = 0x3;// ANA_TXREG_REG0.BT.B0 = ####0011 , txreg_speedtrk_clk_lane[3:0]
    tmp9 = 0x60;// ANA_TX_FIR_REG0.BT.B0 = 0110#### , tx_fir_bypass_l1_delay_lane, tx_fir_bypass_l2_delay_lane, tx_fir_bypass_l3_delay_lane, tx_fir_2_dig_clk_div_lane
  }
    ...
    tmp0 = 0x2;// PLL_TS_LANE_REG12.BT.B2 = ###00010 , tx_pll_rate_sel_lane[4:0]
    tmp4 = 0x2;// ANA_TXREG_REG1.BT.B0 = ####0010 , txreg_speedtrk_data_lane[3:0]
    tmp5 = 0x2;// ANA_TXREG_REG0.BT.B0 = ####0010 , txreg_speedtrk_clk_lane[3:0]
    tmp9 = 0x60;// ANA_TX_FIR_REG0.BT.B0 = 0110#### , tx_fir_bypass_l1_delay_lane, tx_fir_bypass_l2_delay_lane, tx_fir_bypass_l3_delay_lane, tx_fir_2_dig_clk_div_lane
  }
  else if (gen_tx==13){
    tmp0 = 0x0;// PLL_TS_LANE_REG12.BT.B2 = ###00000 , tx_pll_rate_sel_lane[4:0]
    ...
    tmp5 = 0x2;// ANA_TXREG_REG0.BT.B0 = ####0010 , txreg_speedtrk_clk_lane[3:0]
    tmp6 = 0x1;// CLKGEN_TX_LANE_REG1_LANE.BT.B0 = #######1 , txdata_latency_reduce_en_lane
    tmp7 = 0x3;// ANA_TXSPEED_REG0.BT.B0 = 000##011 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
    tmp9 = 0x60;// ANA_TX_FIR_REG0.BT.B0 = 0110#### , tx_fir_bypass_l1_delay_lane, tx_fir_bypass_l2_delay_lane, tx_fir_bypass_l3_delay_lane, tx_fir_2_dig_clk_div_lane
  }
  else if (gen_tx==11){
    tmp0 = 0xB;// PLL_TS_LANE_REG12.BT.B2 = ###01011 , tx_pll_rate_sel_lane[4:0]
    tmp4 = 0x2;// ANA_TXREG_REG1.BT.B0 = ####0010 , txreg_speedtrk_data_lane[3:0]
    tmp5 = 0x2;// ANA_TXREG_REG0.BT.B0 = ####0010 , txreg_speedtrk_clk_lane[3:0]
    tmp6 = 0x1;// CLKGEN_TX_LANE_REG1_LANE.BT.B0 = #######1 , txdata_latency_reduce_en_lane
    tmp7 = 0x3;// ANA_TXSPEED_REG0.BT.B0 = 000##011 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
    ...
    tmp0 = 0x4;// PLL_TS_LANE_REG12.BT.B2 = ###00100 , tx_pll_rate_sel_lane[4:0]
    tmp4 = 0x2;// ANA_TXREG_REG1.BT.B0 = ####0010 , txreg_speedtrk_data_lane[3:0]
    tmp5 = 0x2;// ANA_TXREG_REG0.BT.B0 = ####0010 , txreg_speedtrk_clk_lane[3:0]
    tmp6 = 0x1;// CLKGEN_TX_LANE_REG1_LANE.BT.B0 = #######1 , txdata_latency_reduce_en_lane
    tmp7 = 0x3;// ANA_TXSPEED_REG0.BT.B0 = 000##011 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
    ...
    tmp5 = 0x1;// ANA_TXREG_REG0.BT.B0 = ####0001 , txreg_speedtrk_clk_lane[3:0]
    tmp6 = 0x1;// CLKGEN_TX_LANE_REG1_LANE.BT.B0 = #######1 , txdata_latency_reduce_en_lane
    tmp7 = 0x5;// ANA_TXSPEED_REG0.BT.B0 = 000##101 , tx_hs_div2_sel_lane, tx_a90_vcap_lane[1:0], txspeed_div_lane[2:0]
    tmp9 = 0xE0;// ANA_TX_FIR_REG0.BT.B0 = 1110#### , tx_fir_bypass_l1_delay_lane, tx_fir_bypass_l2_delay_lane, tx_fir_bypass_l3_delay_lane, tx_fir_2_dig_clk_div_lane
  }
  else if (gen_tx==1){
    tmp4 = 0x1;// ANA_TXREG_REG1.BT.B0 = ####0001 , txreg_speedtrk_data_lane[3:0]
  ...
  PLL_TS_LANE_REG12.BT.B2 = tmp0;
  TX_SYSTEM_LANE1.BT.B3 = tmp1;
  PHYTEST_TX0.BT.B2 = tmp2;
  TX_TRAINING_IF_REG3.BT.B0 = tmp3;
  ANA_TXREG_REG1.BT.B0 = tmp4;
  ANA_TXREG_REG0.BT.B0 = tmp5;
  CLKGEN_TX_LANE_REG1_LANE.BT.B0 = tmp6;
  ANA_TXSPEED_REG0.BT.B0 = tmp7;
  TX_SYSTEM_LANE0.BT.B1 = tmp8;
  ANA_TX_FIR_REG0.BT.B0 = tmp9;
}
#endif //_SERDES_BUILD
