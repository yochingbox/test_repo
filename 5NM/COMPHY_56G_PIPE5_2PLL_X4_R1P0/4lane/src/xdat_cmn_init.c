...
//CONTROL_CONFIG0.BT.B3 = 0x0; //##000000, apta_train_sim_en, bypass_ctle_tune, bypass_ctle_ctrl, bypass_ph_ctrl, skip_cdr_dfe_scheme, force_cont_cal_skip
...
//CONTROL_CONFIG1.BT.B3 = 0x0; //#000000#, txalign90_cal_ext_en, tx_pll_cal_ext_en, rx_pll_cal_ext_en, sq_cal_ext_en, process_cal_ext_en, txdcc_cal_ext_en
  CONTROL_CONFIG2.BT.B1 = 0xC0; //1100####, rxdcc_dll_cal_cont_en, pll_temp_cal_cont_en, tx_pllamp_cal_cont_en, rx_pllamp_cal_cont_en
...
//CONTROL_CONFIG5.BT.B2 = 0x0; //000000#0, tpllfreq1[1:0], tpllfreq0[1:0], tpllamp0[1:0], temp_rdy
  CONTROL_CONFIG5.BT.B3 = 0xC0; //11000000, pll_txvco_sf_icptat_sel[2:0], tpllfreq4, tpllfreq3[1:0], tpllfreq2[1:0]
