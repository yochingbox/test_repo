...
// 0x59	RX_DLL_CAL_5		TBD
typedef union {
	struct {
		uint8_t RX_DLL_CAL_SAMPLE_PULSE_DIV_LANE_7_0     : 8;	/*  [7:0]     r/w 8'h40*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} RX_DLL_CAL_5_t;
...
// 0x6e	RX_ALIGN90_CAL_2		TBD
typedef union {
	struct {
		uint8_t RX_ALIGN90_CAL_SETTING_LANE_7_0          : 8;	/*  [7:0]     r/w 8'hc0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} RX_ALIGN90_CAL_2_t;
...
// 0x94	RX_EOM_DLL_CAL_3		TBD
typedef union {
	struct {
		uint8_t RX_EOM_DLL_CAL_SAMPLE_PULSE_DIV_LANE_7_0 : 8;	/*  [7:0]     r/w 8'h40*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} RX_EOM_DLL_CAL_3_t;
...
// 0xa6	RX_EOM_PI_CAL_7		TBD
typedef union {
	struct {
		uint8_t RX_EOM_PI_CAL_SETTING_LANE_7_0           : 8;	/*  [7:0]     r/w 8'hc0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} RX_EOM_PI_CAL_7_t;
