...
typedef union {
	struct {
		...
		uint8_t PLL_TS_SELHV_LCPLL_CP_LANE_3_0           : 4;	/*  [7:4]     r/w 4'h3*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
// 0x25	PLL_TS_UPHY14_CMN_ANAREG_TOP_037		Analog Register 036
typedef union {
	struct {
...
#define reg_PLL_TS_ANA_RSVDA_LANE_7_0  PLL_TS_UPHY14_CMN_ANAREG_TOP_037.BF.PLL_TS_ANA_RSVDA_LANE_7_0
...
#define reg_PLL_TS_ANA_RSVDB_LANE_7_0  PLL_TS_UPHY14_CMN_ANAREG_TOP_038.BF.PLL_TS_ANA_RSVDB_LANE_7_0
...
#define reg_PLL_TS_ANA_RSVDC_LANE_7_0  PLL_TS_UPHY14_CMN_ANAREG_TOP_039.BF.PLL_TS_ANA_RSVDC_LANE_7_0
...
#define reg_PLL_TS_ANA_RSVDD_LANE_7_0  PLL_TS_UPHY14_CMN_ANAREG_TOP_040.BF.PLL_TS_ANA_RSVDD_LANE_7_0

// 0x29	PLL_TS_PLL_CAL_REG0		Digital PLL Calibration Register 0
typedef union {
	struct {
...
__xdata __at( 0x20a4 ) volatile PLL_TS_PLL_CAL_REG0_t PLL_TS_PLL_CAL_REG0;
...
// 0x2a	PLL_TS_PLL_CAL_REG1		Digital PLL Calibration Register1
typedef union {
	struct {
...
__xdata __at( 0x20a8 ) volatile PLL_TS_PLL_CAL_REG1_t PLL_TS_PLL_CAL_REG1;
#define reg_PLL_TS_DIG_CAL2M_DIV_LANE_7_0  PLL_TS_PLL_CAL_REG1.BF.PLL_TS_DIG_CAL2M_DIV_LANE_7_0

// 0x2b	PLL_TS_UPHY14_CMN_ANAREG_TOP_041		Digital PLL Calibration Register2
typedef union {
	struct {
...
__xdata __at( 0x20ac ) volatile PLL_TS_UPHY14_CMN_ANAREG_TOP_041_t PLL_TS_UPHY14_CMN_ANAREG_TOP_041;
#define reg_PLL_TS_ANA_TEST_LANE_7_0  PLL_TS_UPHY14_CMN_ANAREG_TOP_041.BF.PLL_TS_ANA_TEST_LANE_7_0

// 0x2c	PLL_DIG_SCN_REG		Digital PLL Calibration Register 3
typedef union {
	struct {
...
__xdata __at( 0x20b0 ) volatile PLL_DIG_SCN_REG_t PLL_DIG_SCN_REG;
