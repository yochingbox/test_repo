...
//#define tag_CTLE_THRES (tag_CTLE_CONFIG_EN?(1<<max(lnx_TRAIN_DEBUG2_LANE_7_0,7)):64)
#define tag_CTLE_THRES (tag_CTLE_CONFIG_EN?min(lnx_CTLE_DEBUG1_LANE_7_0,127):64)
