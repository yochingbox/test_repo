...
#define train_st	lnx_TRAIN_ST_LANE_7_0
#define TRAIN_STEP 	TRAIN_STEP_0.VAL

#define TRAIN_RESET		0x0001
#define TRAIN_INIT      	0x0002
#define GAINTRAIN_INIT      	0x0004
#define INIT_PHASETRAIN1    	0x0008
#define DFERES_F0_TRAIN     	0x0010
#define FIRST_PHASETRAIN    	0x0020
#define RSWEEP      		0x0040
#define R2_ADJ      		0x0080
#define DFE_RES_F0_VREF_TRAIN   0x0100
#define PHASE_TRAIN      	0x0200
#define RL2_TUNE_ADJ      	0x0400
#define FINAL_PHASE_TRAIN   	0x0800
#define RX_TRAIN_DONE		0x1000
#define TX_TRAIN_ST	    	0x2000
#define TX_TRAIN_DONE		0x4000
#define VREF_ISI_RES_TRAIN  	0x8000
#define TRAIN_FINALIZE   	0x10000
#define TRX_TRAIN_DONE		0x20000

enum {
ST_TRAIN_RESET,    //0				
ST_TRAIN_INIT,     //1 		
ST_GAINTRAIN_INIT, //2     	
ST_INIT_PHASETRAIN1,//3    	
ST_DFERES_F0_TRAIN, //4    	
ST_FIRST_PHASETRAIN,//5    	
ST_RSWEEP,          //6			
ST_R2_ADJ,          //7			
ST_DFE_RES_F0_VREF_TRAIN, //8  
ST_PHASE_TRAIN,     //9 		
ST_RL2_TUNE_ADJ,    //10  		
ST_FINAL_PHASE_TRAIN,//11   	
ST_RX_TRAIN_DONE,   //12
ST_TRX_TRAIN_ST,    //13
ST_TX_TRAIN_DONE,   //14	    	
ST_VREF_ISI_RES_TRAIN, //15 	
ST_TRAIN_FINALIZE,  //16 		
ST_TRXTRAIN_DONE,   //17
ST_TRAIN_MAX
};


//#define RX_CAP_FINAL_ADJ			0x40000

#define rate_mode reg_DFE_RATE_MODE_LANE_1_0

#define tx_pam2_en 	reg_TX_PAM2_EN_LANE
#define pam2_en 	reg_RX_PAM2_EN_LANE
...
#define tag_RXFFE_R_GAIN_TRAIN lnx_RXFFE_R_GAIN_TRAIN_LANE_3_0 //3 //4 //3
...
#define tag_DFE_F1_SAT_THRES 50
#define tag_DFE_F2_SAT_THRES 21 //25 

#define tag_GAIN_TRAIN_INIT_EN lnx_GAIN_TRAIN_INIT_EN_LANE //1
#define tag_GAIN_TRAIN_END_EN lnx_GAIN_TRAIN_END_EN_LANE // 0
...
#define tag_DFE_FX_SUM_SAT_THRES (2*lnx_DFE_FX_SUM_SAT_THRES_LANE_7_0*tag_DFE_RES_MULTIPLIER) //reg_MCU_DEBUGD_LANE_7_0=0x3a is one half of tag_DFE_RES_MULTIPLIER
#define tag_DFE_OUTER_EYE_THRES (4*cmx_DFE_OUTER_EYE_THRES_7_0)
...
#define tag_DFE_F1_MAX	63
#define tag_DFE_F1_MIN	-64
...
#define tag_DFE_F8TO10_RES_SEL_MAX 	1
#define tag_DFE_F11TO15_RES_SEL_MAX 1
#define tag_DFE_FFLOAT_RES_SEL_MAX 	1
#define tag_DFE_OFST_RES_SEL_MAX 	3

//vref train
#define tag_VREF_TBL_SIZE			4
#define tag_VREF_RES_INI			lnx_DFE_RES_VREF_INI_LANE_1_0 //3
#define tag_VREF_RES_LOW_THRES		lnx_VREF_RES_LOW_THRES_LANE_7_0 //40//32
#define tag_VREF_RES_HIGH_THRES		lnx_VREF_RES_HIGH_THRES_LANE_7_0 //55//60

//gain train

#define tag_DFE_RES_F0A_LOW_THRES_01_INIT  30
#define tag_DFE_RES_F0A_LOW_THRES_0_INIT   lnx_DFE_RES_F0A_LOW_THRES_0_INIT_LANE_7_0 //30
#define tag_DFE_RES_F0A_LOW_THRES_1_INIT   lnx_DFE_RES_F0A_LOW_THRES_1_INIT_LANE_7_0 //11
#define tag_DFE_RES_F0A_LOW_THRES_2_INIT   lnx_DFE_RES_F0A_LOW_THRES_2_INIT_LANE_7_0 // 10
#define tag_DFE_RES_F0A_LOW_THRES_3_INIT   lnx_DFE_RES_F0A_LOW_THRES_3_INIT_LANE_7_0 //6
#define tag_DFE_RES_F0A_HIGH_THRES_INIT    lnx_DFE_RES_F0A_HIGH_THRES_INIT_LANE_7_0 //50
...
#define dfe_res_f0b_high_thres		lnx_DFE_RES_F0B_HIGH_THRES_INIT_LANE_7_0
#define dfe_res_f0b_low_thres		6

// [PU]: Resolution Adjustment (56G in COMPHY_112G)
#define tag_DFE_RES_VREF_LOW_THRES	25
#define tag_DFE_RES_VREF_HIGH				40 //TODO: register 50
...
#define tag_DFE_RES_F1_LOW_01 			19
#define tag_DFE_RES_F1_LOW_2				26
#define tag_DFE_RES_F1_LOW_3				35
#define tag_DFE_RES_F1_HIGH					50

#define tag_DFE_RES_F2_LOW_01		13
#define tag_DFE_RES_F2_LOW_2			15
#define tag_DFE_RES_F2_LOW_3			19
#define tag_DFE_RES_F2_HIGH			21 //25

#define tag_DFE_RES_F3TO4_LOW			25
#define tag_DFE_RES_F3TO4_HIGH			44 //50


#define tag_DFE_RES_F5TO7_LOW			16
#define tag_DFE_RES_F5TO7_HIGH			21 //25

//#define tag_DFE_RES_F11TO15_LOW		7
//#define tag_DFE_RES_F11TO15_HIGH	13	
//
//#define tag_DFE_RES_FF1TO5_LOW		7	
//#define tag_DFE_RES_FF1TO5_HIGH		4
...
#define tag_CDR_MIN_PHASE_OS 0 
//#define tag_CDR_MAX_PHASE_OS 96 
#define tag_CDR_MIN_PHASE_OS_MODE01  ((int8_t)(cal_phase-(lnx_ALIGN90_VREF_MAX_LANE_7_0&0x7f))) //-75 //cal_ph-max_align90 = 21-96 //-162 
#define tag_CDR_MAX_PHASE_OS_MODE01 ((int8_t)(cal_phase-tag_CDR_MIN_PHASE_OS )) // = 21-0=21 //30 
...
#define tag_CDR_PHASE_STEP_SIZE 2 //4
...
#define tag_CDR_MIDPOINT_EN lnx_CDR_MIDPOINT_EN_LANE//0
...
#define tag_CDR_MIDPOINT_SMALL_THRES_K lnx_MIDPOINT_SMALL_THRES_K_LANE_7_0 //12 // //8 
#define tag_CDR_MIDPOINT_SMALL_THRES_C lnx_MIDPOINT_SMALL_THRES_C_LANE_7_0 //0 // //0 
#define tag_CDR_MIDPOINT_LARGE_THRES_K lnx_MIDPOINT_LARGE_THRES_K_LANE_7_0 //12 // //9 //8 
#define tag_CDR_MIDPOINT_LARGE_THRES_C lnx_MIDPOINT_LARGE_THRES_C_LANE_7_0 //0 // //2 //0 
...
#define tag_SUMF_BOOST_TARGET_K	(int8_t)lnx_SUMF_BOOST_TARGET_K_LANE_7_0 //0 //1 //0
#define tag_SUMF_BOOST_TARGET_K_SCALE 6 // 6-bit fractional part
#define tag_SUMF_BOOST_TARGET_C	(int8_t)lnx_SUMF_BOOST_TARGET_C_LANE_7_0 //-60 //-44 //-22 //-30 //-2 //0x1e //LJ 0
...
#define tag_TX_EO_STOP_THRES	lnx_TX_EO_STOP_THRES_LANE_7_0
...
//Tracking
#define tag_CTLE_TIMER_HR		lnx_CTLE_ADAPT_TIME_LANE_7_0 //'d50
#define tag_DC_VREF_ADJ_EN		lnx_DC_VREF_ADJ_EN_LANE //1
#define tag_DC_VREF_ADJ_DFE_LPNUM	 lnx_DC_VREF_ADJ_DFE_LPNUM_LANE_15_0 //f07
#define tag_DC_VREF_ADJ_TRANS_LPNUM	 lnx_DC_VREF_ADJ_TRANS_LPNUM_LANE_7_0 //'d50

#define tag_CTLE_C1_ADAPT_EN		lnx_CTLE_C1_ADAPT_EN_LANE
#define tag_CTLE_C1_R2P0_ADAPT_EN		lnx_CTLE_ADAPT_R2P0_EN_LANE
#define tag_CTLE_C1_TIMER		lnx_CTLE_C1_ADAPT_TIME_LANE_7_0
#define tag_TRACK_CTLE_F0B_THRS		lnx_TRACK_CTLE_F0B_THRS_LANE_7_0
#define norm_c1 			lnx_ADAPT_C1_INX_LANE_7_0
#define norm_f0b			lnx_NORM_F0B_LANE_7_0
#define opt_f0b				lnx_OPT_F0B_LANE_7_0
#define tag_ADAPT_F0B_VOTE_NUM		lnx_ADAPT_F0B_VOTE_NUM_LANE_7_0 //63
#define CTLE_C1_INX_MAX			18
#define CTLE_C1_INX_MIN			0

#define tag_PHASE_ADAPT_TIME 	lnx_PHASE_ADAPT_TIME_LANE_7_0
#define tag_PHASE_ADAPT_EN 		lnx_PHASE_ADAPT_ENABLE_LANE
#define tag_PHASE_ADAPT_LPNUM 	lnx_PHASE_ADAPT_LPNUM_LANE_7_0
#define tag_F1_THRS3		lnx_PHASE_F1_THRES3_LANE_7_0
#define tag_F1_THRS1		lnx_PHASE_F1_THRES1_LANE_7_0
#define tag_FN1_THRS		lnx_PHASE_FN1_THRES_LANE_7_0
#define tag_F0B_HYST_HIGH	lnx_PHASE_F0B_HYST_HIGH_LANE_7_0
#define tag_F0B_HYST_LOW	lnx_PHASE_F0B_HYST_LOW_LANE_7_0


#define tag_RL2_ADAPT_EN	lnx_RL2_ADAPT_EN_LANE
#define tag_RL2_ADAPT_TIME	lnx_RL2_ADAPT_TIME_LANE_15_0
#define tag_RL2_TEMP_DELTA_THRS	lnx_RL2_TEMP_DELTA_THRS_LANE_7_0
#define train_rl2_tune		lnx_TRAIN_RL2_TUNE_LANE_2_0
#define norm_rl2_tune		lnx_NORM_RL2_TUNE_LANE_2_0

#define tag_st_to_en		lnx_TX_TRAIN_STATUS_DET_TIMER_ENABLE_LANE
