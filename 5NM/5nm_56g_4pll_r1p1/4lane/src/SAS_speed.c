...
void loadspeedtbl_rx() BANKING_CTRL {
  ...
  uint8_t tmp28 = 0x0; //TX_TRAIN_PATTTERN_REG0.BT.B1 , ethernet_mode_lane[1:0]
  ...
  uint8_t tmp31 = 0x15; //CAL_CTRL4_LANE.BT.B2 , rx_pll_rate_lane[7:0]
  uint8_t tmp32 = 0x4B; //ANA_RXREG_REG0.BT.B0 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_data_lane[2:0], rxreg_speedtrk_clk_lane[2:0]
  uint8_t tmp33 = 0xE; //ANA_CTLE_REG6.BT.B0 , ctle_res2_sel_lane[3:0]
  ...
  if (gen_rx==4){
    ...
    tmp19 = 0xE9;// TX_TRAIN_PATTERN_REG1.BT.B2 = 11101001 , train_pat_num_rx_lane[9:0]
    ...
    tmp26 = 0x0;// ANA_RXREG_REG1.BT.B0 = ###00000 , rxspeed_div_lane[2:0], rxspeed_div_2x_lane[1:0]
    ...
    tmp31 = 0x16;// CAL_CTRL4_LANE.BT.B2 = 00010110 , rx_pll_rate_lane[7:0]
    ...
    tmp33 = 0x3;// ANA_CTLE_REG6.BT.B0 = ####0011 , ctle_res2_sel_lane[3:0]
    tmp36 = 0xF;// ANA_CTLE_REG3.BT.B0 = ####1111 , ctle_current1_sel_lane[3:0]
    tmp37 = 0x0;// ANA_RSVD_REG1.BT.B0 = 00000000 , ana_rsvd1_lane[7:0]
    tmp38 = 0xF;// ANA_CTLE_REG8.BT.B0 = ####1111 , ctle_rl2_sel_lane[3:0]
  }
  else if (gen_rx==3){
    tmp6 = 0x1;// ANA_IMPCAL_REG0.BT.B0 = #####001 , path_disable_edge_lane, intpr_lane[1:0]
...
void loadspeedtbl_tx() BANKING_CTRL {
  ...
  if (gen_tx==4){
    tmp3 = 0x0;// ANA_TXSPEED_REG0.BT.B0 = #####000 , txls_sel_lane, txspeed_div_lane[2:0]
