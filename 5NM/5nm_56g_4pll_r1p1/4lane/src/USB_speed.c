...
void loadspeedtbl_rx() BANKING_CTRL {
  ...
  uint8_t tmp26 = 0x16; //ANA_RXREG_REG1.BT.B0 , rxspeed_div_lane[2:0], rxspeed_div_2x_lane[1:0]
  ...
  uint8_t tmp31 = 0x1A; //CAL_CTRL4_LANE.BT.B2 , rx_pll_rate_lane[7:0]
  ...
  uint8_t tmp33 = 0x7; //ANA_CTLE_REG6.BT.B0 , ctle_res2_sel_lane[3:0]
  ...
  uint8_t tmp36 = 0x7; //ANA_CTLE_REG3.BT.B0 , ctle_current1_sel_lane[3:0]
  uint8_t tmp37 = 0x7; //ANA_RSVD_REG1.BT.B0 , ana_rsvd1_lane[7:0]
  uint8_t tmp38 = 0x5; //ANA_CTLE_REG8.BT.B0 , ctle_rl2_sel_lane[3:0]
  if (gen_rx==2){
...
void loadspeedtbl_tx() BANKING_CTRL {
  ...
  uint8_t tmp3 = 0x2; //ANA_TXSPEED_REG0.BT.B0 , txls_sel_lane, txspeed_div_lane[2:0]
