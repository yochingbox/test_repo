...
// 0x0020	LANE_CMN_TSEN_CRTL		LANE MCU TSEN Control Register 0
typedef union {
	struct {
	...
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} LANE_CMN_TSEN_CRTL_t;
__xdata __at( 0xa320 ) volatile LANE_CMN_TSEN_CRTL_t LANE_CMN_TSEN_CRTL;
#define reg_TSEN_ADC_RD_LANE_REQ_CH0  LANE_CMN_TSEN_CRTL.BF.TSEN_ADC_RD_LANE_REQ_CH0
#define reg_TSEN_ADC_RD_LANE_REQ_CH1  LANE_CMN_TSEN_CRTL.BF.TSEN_ADC_RD_LANE_REQ_CH1
#define reg_TSEN_ADC_RD_LANE_REQ_CH2  LANE_CMN_TSEN_CRTL.BF.TSEN_ADC_RD_LANE_REQ_CH2
#define reg_TSEN_ADC_RD_LANE_REQ_CH3  LANE_CMN_TSEN_CRTL.BF.TSEN_ADC_RD_LANE_REQ_CH3
