...
typedef union {
	struct {
		...
		uint8_t TRX_RXCLK_SEL_LANE                       : 1;	/*     16     r/w   0*/
		uint8_t RESERVED_17                              : 7;	/*[27:17]     r/w   0*/
		uint8_t RESERVED_24                              : 4;	/*[27:17]     r/w   0*/
		uint8_t RX_ANA_PAM2_EN_LANE                      : 1;	/*     28     r/w   0*/
		uint8_t RX_EQ_PAM2_EN_LANE                       : 1;	/*     29     r/w   0*/
		uint8_t TRAIN_RX_SEL_BITS_LANE                   : 1;	/*     30     r/w   1*/
...
#define reg_RX_ANA_PAM2_EN_LANE  RX_SYSTEM_LANE.BF.RX_ANA_PAM2_EN_LANE
#define reg_RX_EQ_PAM2_EN_LANE  RX_SYSTEM_LANE.BF.RX_EQ_PAM2_EN_LANE
...
// 0x0008	DTL_REG6		DTL related register 6
typedef union {
	struct {
		uint8_t TIMER_CLK_FREQ_LANE_9_0_b0               : 8;	/*  [9:0]     r/w 10'h1f4*/
		uint8_t TIMER_CLK_FREQ_LANE_9_0_b1               : 2;	/*  [9:0]     r/w 10'h1f4*/
		uint8_t RX_SPEED_DIV_4_DATASYNC_LANE_2_0         : 3;	/*[12:10]     r/w 3'h4*/
		uint8_t RESERVED_13                              : 1;	/*     13     r/w   0*/
		uint8_t RX_DATASYNC_DONE_LANE                    : 1;	/*     14       r   0*/
		uint8_t RX_DATASYNC_START_LANE                   : 1;	/*     15     r/w   0*/
		uint8_t RX_DTL_PLOOP_OFF_FALL_DELAY_LANE_1_0     : 2;	/*[17:16]     r/w 2'h0*/
		uint8_t RX_DATASYNC_INPH_JUMP_DELAY_LANE_1_0     : 2;	/*[19:18]     r/w 2'h0*/
		uint8_t RESERVED_20                              : 4;	/*[23:20]     r/w   0*/
		uint8_t RX_DATASYNC_ST_JUMP_STEP_SIZE_LANE_1_0   : 2;	/*[25:24]     r/w 2'h3*/
		uint8_t RX_DATASYNC_ST_ENF_TIMER_SEL_LANE_2_0    : 3;	/*[28:26]     r/w 3'h3*/
		uint8_t RX_DATASYNC_ST_ENP_TIMER_SEL_LANE_2_0    : 3;	/*[31:29]     r/w 3'h3*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} DTL_REG6_t;
__xdata __at( 0x3208 ) volatile DTL_REG6_t DTL_REG6;
#define reg_TIMER_CLK_FREQ_LANE_9_0_b0  DTL_REG6.BF.TIMER_CLK_FREQ_LANE_9_0_b0
#define reg_TIMER_CLK_FREQ_LANE_9_0_b1  DTL_REG6.BF.TIMER_CLK_FREQ_LANE_9_0_b1
#define reg_RX_SPEED_DIV_4_DATASYNC_LANE_2_0  DTL_REG6.BF.RX_SPEED_DIV_4_DATASYNC_LANE_2_0
#define reg_RX_DATASYNC_DONE_LANE  DTL_REG6.BF.RX_DATASYNC_DONE_LANE
#define reg_RX_DATASYNC_START_LANE  DTL_REG6.BF.RX_DATASYNC_START_LANE
#define reg_RX_DTL_PLOOP_OFF_FALL_DELAY_LANE_1_0  DTL_REG6.BF.RX_DTL_PLOOP_OFF_FALL_DELAY_LANE_1_0
#define reg_RX_DATASYNC_INPH_JUMP_DELAY_LANE_1_0  DTL_REG6.BF.RX_DATASYNC_INPH_JUMP_DELAY_LANE_1_0
#define reg_RX_DATASYNC_ST_JUMP_STEP_SIZE_LANE_1_0  DTL_REG6.BF.RX_DATASYNC_ST_JUMP_STEP_SIZE_LANE_1_0
#define reg_RX_DATASYNC_ST_ENF_TIMER_SEL_LANE_2_0  DTL_REG6.BF.RX_DATASYNC_ST_ENF_TIMER_SEL_LANE_2_0
#define reg_RX_DATASYNC_ST_ENP_TIMER_SEL_LANE_2_0  DTL_REG6.BF.RX_DATASYNC_ST_ENP_TIMER_SEL_LANE_2_0

// 0x000c	DTL_REG7		DTL related register 7
typedef union {
	struct {
		uint8_t RX_DATASYNC_TOTAL_JUMP_LANE_11_0_b0      : 8;	/* [11:0]     r/w 12'b0*/
		uint8_t RX_DATASYNC_TOTAL_JUMP_LANE_11_0_b1      : 4;	/* [11:0]     r/w 12'b0*/
		uint8_t RX_DATASYNC_TOTAL_JUMP_FORCE_LANE        : 1;	/*     12     r/w   0*/
...
__xdata __at( 0x320c ) volatile DTL_REG7_t DTL_REG7;
#define reg_RX_DATASYNC_TOTAL_JUMP_LANE_11_0_b0  DTL_REG7.BF.RX_DATASYNC_TOTAL_JUMP_LANE_11_0_b0
#define reg_RX_DATASYNC_TOTAL_JUMP_LANE_11_0_b1  DTL_REG7.BF.RX_DATASYNC_TOTAL_JUMP_LANE_11_0_b1
#define reg_RX_DATASYNC_TOTAL_JUMP_FORCE_LANE  DTL_REG7.BF.RX_DATASYNC_TOTAL_JUMP_FORCE_LANE

// 0x0010	DTL_REG8		DTL related register 8
typedef union {
	struct {
		uint8_t FOFFSET_21D15_STORED_LANE_20_0_b0        : 8;	/* [20:0]     r/w   0*/
		uint8_t FOFFSET_21D15_STORED_LANE_20_0_b1        : 8;	/* [20:0]     r/w   0*/
		uint8_t FOFFSET_21D15_STORED_LANE_20_0_b2        : 5;	/* [20:0]     r/w   0*/
		uint8_t FOFFSET_21D15_STORED_FORCE_LANE          : 1;	/*     21     r/w   0*/
		uint8_t RESERVED_22                              : 2;	/*[30:22]     r/w   0*/
		uint8_t RESERVED_24                              : 7;	/*[30:22]     r/w   0*/
		uint8_t FOFFSET_21D15_RESTORE_SEL_LANE           : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} DTL_REG8_t;
__xdata __at( 0x3210 ) volatile DTL_REG8_t DTL_REG8;
#define reg_FOFFSET_21D15_STORED_LANE_20_0_b0  DTL_REG8.BF.FOFFSET_21D15_STORED_LANE_20_0_b0
#define reg_FOFFSET_21D15_STORED_LANE_20_0_b1  DTL_REG8.BF.FOFFSET_21D15_STORED_LANE_20_0_b1
#define reg_FOFFSET_21D15_STORED_LANE_20_0_b2  DTL_REG8.BF.FOFFSET_21D15_STORED_LANE_20_0_b2
#define reg_FOFFSET_21D15_STORED_FORCE_LANE  DTL_REG8.BF.FOFFSET_21D15_STORED_FORCE_LANE
#define reg_FOFFSET_21D15_RESTORE_SEL_LANE  DTL_REG8.BF.FOFFSET_21D15_RESTORE_SEL_LANE

// 0x0014	DTL_REG9		DTL related register 9
typedef union {
	struct {
		uint8_t FOFFSET_21D15_STORED_RD_LANE_20_0_b0     : 8;	/* [20:0]       r   0*/
		uint8_t FOFFSET_21D15_STORED_RD_LANE_20_0_b1     : 8;	/* [20:0]       r   0*/
		uint8_t FOFFSET_21D15_STORED_RD_LANE_20_0_b2     : 5;	/* [20:0]       r   0*/
...
__xdata __at( 0x3214 ) volatile DTL_REG9_t DTL_REG9;
#define reg_FOFFSET_21D15_STORED_RD_LANE_20_0_b0  DTL_REG9.BF.FOFFSET_21D15_STORED_RD_LANE_20_0_b0
#define reg_FOFFSET_21D15_STORED_RD_LANE_20_0_b1  DTL_REG9.BF.FOFFSET_21D15_STORED_RD_LANE_20_0_b1
#define reg_FOFFSET_21D15_STORED_RD_LANE_20_0_b2  DTL_REG9.BF.FOFFSET_21D15_STORED_RD_LANE_20_0_b2
...
typedef union {
	struct {
		uint8_t PIN_RESET_CORE_ACK_RX_LANE               : 1;	/*      0     r/w   0*/
		uint8_t PIN_RESET_CORE_ACK_RX_PROT_EN_LANE       : 1;	/*      1     r/w   1*/
		uint8_t RESET_CORE_ACK_RX_LANE                   : 1;	/*      2       r   0*/
		uint8_t RESERVED_3                               : 3;	/*  [5:3]     r/w   0*/
		uint8_t RESERVED_6                               : 1;	/*      6     r/w   0*/
		uint8_t PWRON_SEQ_RX_LANE                        : 1;	/*      7     r/w   1*/
		...
		uint8_t ANA_RX_RXCLK_NT_EN_LANE                  : 1;	/*     23     r/w   0*/
		uint8_t ANA_RX_RXCLK_4X_EN_LANE                  : 1;	/*     24     r/w   0*/
...
#define reg_PIN_RESET_CORE_ACK_RX_LANE  CLKGEN_RX_LANE_REG1_LANE.BF.PIN_RESET_CORE_ACK_RX_LANE
#define reg_PIN_RESET_CORE_ACK_RX_PROT_EN_LANE  CLKGEN_RX_LANE_REG1_LANE.BF.PIN_RESET_CORE_ACK_RX_PROT_EN_LANE
#define reg_RESET_CORE_ACK_RX_LANE  CLKGEN_RX_LANE_REG1_LANE.BF.RESET_CORE_ACK_RX_LANE
#define reg_PWRON_SEQ_RX_LANE  CLKGEN_RX_LANE_REG1_LANE.BF.PWRON_SEQ_RX_LANE
...
#define reg_ANA_RX_RXCLK_NT_EN_LANE  CLKGEN_RX_LANE_REG1_LANE.BF.ANA_RX_RXCLK_NT_EN_LANE
#define reg_ANA_RX_RXCLK_4X_EN_LANE  CLKGEN_RX_LANE_REG1_LANE.BF.ANA_RX_RXCLK_4X_EN_LANE
...
typedef union {
	struct {
		...
		uint8_t RX_SEL_BITS_SWITCH_LANE                  : 1;	/*     15     r/w   0*/
		uint8_t RX_SEL_BITS_SWITCH_FORCE_LANE            : 1;	/*     16     r/w   0*/
		uint8_t RX_MUX_DATA_CLK_EN_LANE                  : 1;	/*     17     r/w   0*/
		uint8_t RX_MUX_DATA_CLK_EN_FORCE_LANE            : 1;	/*     18     r/w   0*/
		uint8_t RX_MUX_TRAIN_CLK_EN_LANE                 : 1;	/*     19     r/w   0*/
		uint8_t RX_MUX_TRAIN_CLK_EN_FORCE_LANE           : 1;	/*     20     r/w   0*/
