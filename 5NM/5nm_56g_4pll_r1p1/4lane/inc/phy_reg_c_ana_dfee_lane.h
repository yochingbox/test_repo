...
typedef union {
	struct {
		uint8_t DFE_F1_D_BOT_E_LANE_6_0                  : 7;	/*  [6:0]     r/w 7'h0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_DFE_F1_D_BOT_E_LANE_6_0  DFEE_REG6.BF.DFE_F1_D_BOT_E_LANE_6_0

// 0x7	DFEE_REG7		
typedef union {
	struct {
		uint8_t DFE_F1_D_MID_E_LANE_6_0                  : 7;	/*  [6:0]     r/w 7'h0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_DFE_F1_D_MID_E_LANE_6_0  DFEE_REG7.BF.DFE_F1_D_MID_E_LANE_6_0

// 0x8	DFEE_REG8		
typedef union {
	struct {
		uint8_t DFE_F1_D_TOP_E_LANE_6_0                  : 7;	/*  [6:0]     r/w 7'h0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_DFE_F1_D_TOP_E_LANE_6_0  DFEE_REG8.BF.DFE_F1_D_TOP_E_LANE_6_0

// 0x9	DFEE_REG9		
typedef union {
	struct {
		uint8_t DFE_F1_S_BOT_E_LANE_6_0                  : 7;	/*  [6:0]     r/w 7'h0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_DFE_F1_S_BOT_E_LANE_6_0  DFEE_REG9.BF.DFE_F1_S_BOT_E_LANE_6_0

// 0xa	DFEE_REG10		
typedef union {
	struct {
		uint8_t DFE_F1_S_MID_E_LANE_6_0                  : 7;	/*  [6:0]     r/w 7'h0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_DFE_F1_S_MID_E_LANE_6_0  DFEE_REG10.BF.DFE_F1_S_MID_E_LANE_6_0

// 0xb	DFEE_REG11		
typedef union {
	struct {
		uint8_t DFE_F1_S_TOP_E_LANE_6_0                  : 7;	/*  [6:0]     r/w 7'h0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_DFE_F1_S_TOP_E_LANE_6_0  DFEE_REG11.BF.DFE_F1_S_TOP_E_LANE_6_0
...
typedef union {
	struct {
		uint8_t OFST_D_BOT_E_LANE_6_0                    : 7;	/*  [6:0]     r/w 7'h00*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_OFST_D_BOT_E_LANE_6_0  DFEE_REG56.BF.OFST_D_BOT_E_LANE_6_0

// 0x39	DFEE_REG57		
typedef union {
	struct {
		uint8_t OFST_D_MID_E_LANE_6_0                    : 7;	/*  [6:0]     r/w 7'h00*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_OFST_D_MID_E_LANE_6_0  DFEE_REG57.BF.OFST_D_MID_E_LANE_6_0

// 0x3a	DFEE_REG58		
typedef union {
	struct {
		uint8_t OFST_D_TOP_E_LANE_6_0                    : 7;	/*  [6:0]     r/w 7'h00*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_OFST_D_TOP_E_LANE_6_0  DFEE_REG58.BF.OFST_D_TOP_E_LANE_6_0

// 0x3b	DFEE_REG59		
typedef union {
	struct {
		uint8_t OFST_S_BOT_E_LANE_6_0                    : 7;	/*  [6:0]     r/w 7'h00*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_OFST_S_BOT_E_LANE_6_0  DFEE_REG59.BF.OFST_S_BOT_E_LANE_6_0

// 0x3c	DFEE_REG60		
typedef union {
	struct {
		uint8_t OFST_S_MID_E_LANE_6_0                    : 7;	/*  [6:0]     r/w 7'h00*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_OFST_S_MID_E_LANE_6_0  DFEE_REG60.BF.OFST_S_MID_E_LANE_6_0

// 0x3d	DFEE_REG61		
typedef union {
	struct {
		uint8_t OFST_S_TOP_E_LANE_6_0                    : 7;	/*  [6:0]     r/w 7'h00*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_OFST_S_TOP_E_LANE_6_0  DFEE_REG61.BF.OFST_S_TOP_E_LANE_6_0
