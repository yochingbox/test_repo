...
typedef union {
	struct {
		...
		uint8_t TXDRVREG_TEMPC_IPTAT_SINK_LANE_2_0       : 3;	/*  [5:3]     r/w 3'h2*/
		uint8_t TXDRVREG_TEMPC_IPTAT_EN_LANE             : 1;	/*      6     r/w   1*/
...
#define reg_TXDRVREG_TEMPC_IPTAT_SINK_LANE_2_0  ANA_TRX_MISC1.BF.TXDRVREG_TEMPC_IPTAT_SINK_LANE_2_0
#define reg_TXDRVREG_TEMPC_IPTAT_EN_LANE  ANA_TRX_MISC1.BF.TXDRVREG_TEMPC_IPTAT_EN_LANE
...
typedef union {
	struct {
		...
		uint8_t CTLE_COMP_DIG_EN_LANE                    : 1;	/*      6     r/w   1*/
...
typedef union {
	struct {
		...
		uint8_t CTLE_RL2_TUNE_G2_LANE_2_0                : 3;	/*  [7:5]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} ANA_CTLE_REG13_t;
...
#define reg_CTLE_RL2_TUNE_G2_LANE_2_0  ANA_CTLE_REG13.BF.CTLE_RL2_TUNE_G2_LANE_2_0
...
typedef union {
	struct {
		...
		uint8_t CTLE_CS1_MID_LANE_1_0                    : 2;	/*  [5:4]     r/w 2'h3*/
		uint8_t CTLE_RS1_MID_LANE_1_0                    : 2;	/*  [7:6]     r/w 2'h3*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} ANA_CLK_CTRL_REG1_t;
...
typedef union {
	struct {
		...
		uint8_t EN_CTLE_MID_FREQ_LANE                    : 1;	/*      4     r/w   1*/
...
typedef union {
	struct {
		...
		uint8_t ALIGN90_REF_FILT_BW_LANE                 : 1;	/*      5     r/w   0*/
...
#define reg_ALIGN90_REF_FILT_BW_LANE  ANA_MISC_REG1.BF.ALIGN90_REF_FILT_BW_LANE
...
typedef union {
	struct {
		...
		uint8_t RXREG_SPEEDTRK_DATA_LANE_2_0             : 3;	/*  [5:3]     r/w 3'h7*/
		uint8_t RXREG_SPEEDTRK_CLK_HALF_LANE             : 1;	/*      6     r/w   0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_RXREG_SPEEDTRK_DATA_LANE_2_0  ANA_RXREG_REG0.BF.RXREG_SPEEDTRK_DATA_LANE_2_0
#define reg_RXREG_SPEEDTRK_CLK_HALF_LANE  ANA_RXREG_REG0.BF.RXREG_SPEEDTRK_CLK_HALF_LANE

// 0x39	ANA_RXREG_REG1		
typedef union {
	struct {
		uint8_t RXSPEED_DIV_2X_LANE_1_0                  : 2;	/*  [1:0]     r/w 2'h0*/
		uint8_t RXSPEED_DIV_LANE_2_0                     : 3;	/*  [4:2]     r/w 3'h4*/
		uint8_t RESERVED_5                               : 1;	/*      5     r/w   0*/
		uint8_t RESERVED_6                               : 1;	/*      6     r/w   0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
	} BF;
...
#define reg_RXSPEED_DIV_2X_LANE_1_0  ANA_RXREG_REG1.BF.RXSPEED_DIV_2X_LANE_1_0
...
typedef union {
	struct {
		...
		uint8_t TXLS_SEL_LANE                            : 1;	/*      6     r/w 1'h0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_TXLS_SEL_LANE  ANA_TXSPEED_REG0.BF.TXLS_SEL_LANE
...
typedef union {
	struct {
		...
		uint8_t TXDRVREG_TEMPC_RES_LANE_1_0              : 2;	/*  [5:4]     r/w 2'h2*/
		uint8_t RESERVED_6                               : 1;	/*      6     r/w   0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
...
#define reg_TXDRVREG_TEMPC_RES_LANE_1_0  ANA_MISC_REG0.BF.TXDRVREG_TEMPC_RES_LANE_1_0
...
typedef union {
	struct {
		uint8_t TXRSVD0_LANE_0                           : 1;	/*      0     r/w   0*/
