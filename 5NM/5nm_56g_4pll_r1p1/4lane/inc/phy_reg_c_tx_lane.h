...
typedef union {
	struct {
		...
		uint8_t ANA_TX_TXCLK_NT_EN_LANE                  : 1;	/*      3     r/w   0*/
		uint8_t ANA_TX_TXCLK_4X_EN_LANE                  : 1;	/*      4     r/w   0*/
		uint8_t REFCLK_DIS_FM_PM_LANE                    : 1;	/*      5     r/w   0*/
		uint8_t PIN_RESET_CORE_ACK_TX_LANE               : 1;	/*      6     r/w   0*/
		uint8_t PIN_RESET_CORE_ACK_TX_PROT_EN_LANE       : 1;	/*      7     r/w   1*/
		...
		uint8_t RESET_CORE_ACK_TX_LANE                   : 1;	/*     21       r   0*/
...
#define reg_ANA_TX_TXCLK_NT_EN_LANE  PM_CTRL_TX_LANE_REG1_LANE.BF.ANA_TX_TXCLK_NT_EN_LANE
#define reg_ANA_TX_TXCLK_4X_EN_LANE  PM_CTRL_TX_LANE_REG1_LANE.BF.ANA_TX_TXCLK_4X_EN_LANE
...
// 0x0040	TX_SYSTEM_LANE2		Tx System Register2
typedef union {
	struct {
		uint8_t SSC_AMP_20UNIT_LANE_10_0_b0              : 8;	/* [10:0]     r/w   0*/
		uint8_t SSC_AMP_20UNIT_LANE_10_0_b1              : 3;	/* [10:0]     r/w   0*/
		uint8_t SSC_AMP_UNIT_SEL_LANE                    : 1;	/*     11     r/w   0*/
...
__xdata __at( 0x3040 ) volatile TX_SYSTEM_LANE2_t TX_SYSTEM_LANE2;
#define reg_SSC_AMP_20UNIT_LANE_10_0_b0  TX_SYSTEM_LANE2.BF.SSC_AMP_20UNIT_LANE_10_0_b0
#define reg_SSC_AMP_20UNIT_LANE_10_0_b1  TX_SYSTEM_LANE2.BF.SSC_AMP_20UNIT_LANE_10_0_b1
#define reg_SSC_AMP_UNIT_SEL_LANE  TX_SYSTEM_LANE2.BF.SSC_AMP_UNIT_SEL_LANE
...
typedef union {
	struct {
		...
		uint8_t FM_TRAIN_TX_PRE_CODE_EN_RD_LANE          : 1;	/*     14       r   0*/
		uint8_t FM_TRAIN_TX_GRAY_CODE_EN_RD_LANE         : 1;	/*     15       r   0*/
		uint8_t TO_ANA_TX_FIR_C1_LANE_5_0                : 6;	/*[21:16]       r   0*/
		uint8_t RESERVED_22                              : 1;	/*     22     r/w   0*/
		uint8_t RESERVED_23                              : 1;	/*     23     r/w   0*/
		uint8_t TO_ANA_TX_FIR_C0_LANE_5_0                : 6;	/*[29:24]       r   0*/
		uint8_t TX_TRAIN_CODING_MODE_TX_LANE             : 1;	/*     30     r/w   0*/
		uint8_t TX_TRAIN_CODING_MODE_HW_RST_TX_LANE      : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_TX_TRAIN_CODING_MODE_TX_LANE  TX_TRAINING_IF_REG6.BF.TX_TRAIN_CODING_MODE_TX_LANE
#define reg_TX_TRAIN_CODING_MODE_HW_RST_TX_LANE  TX_TRAINING_IF_REG6.BF.TX_TRAIN_CODING_MODE_HW_RST_TX_LANE
...
// 0x0100	TRX_SCAN_TEST_FORCE_REGISTER		
typedef union {
	struct {
...
__xdata __at( 0x3100 ) volatile TRX_SCAN_TEST_FORCE_REGISTER_t TRX_SCAN_TEST_FORCE_REGISTER;
