...
typedef union {
	struct {
		...
		uint8_t DFE_HRPT_MODE_LANE_1_0                   : 2;	/*[22:21]     r/w   0*/
		uint8_t DFE_RESET_AUTO_UPDATE_DISABLE_LANE       : 1;	/*     23     r/w   0*/
...
#define reg_DFE_HRPT_MODE_LANE_1_0  DFE_CTRL_REG0.BF.DFE_HRPT_MODE_LANE_1_0
#define reg_DFE_RESET_AUTO_UPDATE_DISABLE_LANE  DFE_CTRL_REG0.BF.DFE_RESET_AUTO_UPDATE_DISABLE_LANE
...
typedef union {
	struct {
		...
		uint8_t DFE_F1_SIGNED_EN_LANE                    : 1;	/*     22     r/w   0*/
		uint8_t DFE_VREF_TOP_BOT_FLIP_SIGN_EN_LANE       : 1;	/*     23     r/w   0*/
		uint8_t DFE_VREF_ABS_MIN_LANE_5_0                : 6;	/*[29:24]     r/w 6'h2*/
...
#define reg_DFE_F1_SIGNED_EN_LANE  DFE_CTRL_REG2.BF.DFE_F1_SIGNED_EN_LANE
#define reg_DFE_VREF_TOP_BOT_FLIP_SIGN_EN_LANE  DFE_CTRL_REG2.BF.DFE_VREF_TOP_BOT_FLIP_SIGN_EN_LANE
#define reg_DFE_VREF_ABS_MIN_LANE_5_0  DFE_CTRL_REG2.BF.DFE_VREF_ABS_MIN_LANE_5_0
...
typedef union {
	struct {
		...
		uint8_t DFE_DATA_F0_SEL_LANE_2_0                 : 3;	/*[31:29]     r/w 3'h1*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} DFE_CTRL_REG3_t;
...
typedef union {
	struct {
		...
		uint8_t MAIN_DFE_MCU_CLK_EN_LANE                 : 1;	/*      5     r/w   0*/
		uint8_t RESERVED_6                               : 1;	/*      6     r/w   0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
...
#define reg_MAIN_DFE_MCU_CLK_EN_LANE  RX_EQ_CLK_CTRL.BF.MAIN_DFE_MCU_CLK_EN_LANE
...
typedef union {
	struct {
		...
		uint8_t DFE_ANA_SETTLE_F0TO2_LANE_1_0            : 2;	/*  [9:8]     r/w 2'h2*/
		uint8_t DFE_ANA_SETTLE_PATHSWITCH_LANE_3_0       : 4;	/*[13:10]     r/w 4'h8*/
		uint8_t RESERVED_14                              : 1;	/*     14     r/w   0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
		uint8_t DFE_ANA_SETTLE_PATHOFF_LANE_6_0          : 7;	/*[22:16]     r/w 7'h8*/
		uint8_t RESERVED_23                              : 1;	/*     23     r/w   0*/
...
#define reg_DFE_ANA_SETTLE_PATHOFF_LANE_6_0  DFE_STATIC_REG1.BF.DFE_ANA_SETTLE_PATHOFF_LANE_6_0
...
typedef union {
	struct {
		uint8_t DFE_FEXT1_D_BOT_E_LANE_6_0               : 7;	/*  [6:0]     r/w 7'h0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
		uint8_t DFE_FEXT1_D_MID_E_LANE_6_0               : 7;	/* [14:8]     r/w 7'h0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
		uint8_t DFE_FEXT1_D_TOP_E_LANE_6_0               : 7;	/*[22:16]     r/w 7'h0*/
		uint8_t RESERVED_23                              : 1;	/*     23     r/w   0*/
		uint8_t DFE_FEXT1_S_BOT_E_LANE_6_0               : 7;	/*[30:24]     r/w 7'h0*/
		uint8_t RESERVED_31                              : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_DFE_FEXT1_D_BOT_E_LANE_6_0  DFE_FEXT_REG_EVEN4.BF.DFE_FEXT1_D_BOT_E_LANE_6_0
#define reg_DFE_FEXT1_D_MID_E_LANE_6_0  DFE_FEXT_REG_EVEN4.BF.DFE_FEXT1_D_MID_E_LANE_6_0
#define reg_DFE_FEXT1_D_TOP_E_LANE_6_0  DFE_FEXT_REG_EVEN4.BF.DFE_FEXT1_D_TOP_E_LANE_6_0
#define reg_DFE_FEXT1_S_BOT_E_LANE_6_0  DFE_FEXT_REG_EVEN4.BF.DFE_FEXT1_S_BOT_E_LANE_6_0

// 0x00a4	DFE_FEXT_REG_EVEN5		DFE TAP SIGN_MAGNITUDE READ BACK REG EVEN5
typedef union {
	struct {
		uint8_t DFE_FEXT1_S_MID_E_LANE_6_0               : 7;	/*  [6:0]     r/w 7'h0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
		uint8_t DFE_FEXT1_S_TOP_E_LANE_6_0               : 7;	/* [14:8]     r/w 7'h0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
...
#define reg_DFE_FEXT1_S_MID_E_LANE_6_0  DFE_FEXT_REG_EVEN5.BF.DFE_FEXT1_S_MID_E_LANE_6_0
#define reg_DFE_FEXT1_S_TOP_E_LANE_6_0  DFE_FEXT_REG_EVEN5.BF.DFE_FEXT1_S_TOP_E_LANE_6_0
...
typedef union {
	struct {
		uint8_t DFE_FEXT1_D_BOT_O_LANE_6_0               : 7;	/*  [6:0]     r/w 7'h0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
		uint8_t DFE_FEXT1_D_MID_O_LANE_6_0               : 7;	/* [14:8]     r/w 7'h0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
		uint8_t DFE_FEXT1_D_TOP_O_LANE_6_0               : 7;	/*[22:16]     r/w 7'h0*/
		uint8_t RESERVED_23                              : 1;	/*     23     r/w   0*/
		uint8_t DFE_FEXT1_S_BOT_O_LANE_6_0               : 7;	/*[30:24]     r/w 7'h0*/
		uint8_t RESERVED_31                              : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_DFE_FEXT1_D_BOT_O_LANE_6_0  DFE_FEXT_REG_ODD4.BF.DFE_FEXT1_D_BOT_O_LANE_6_0
#define reg_DFE_FEXT1_D_MID_O_LANE_6_0  DFE_FEXT_REG_ODD4.BF.DFE_FEXT1_D_MID_O_LANE_6_0
#define reg_DFE_FEXT1_D_TOP_O_LANE_6_0  DFE_FEXT_REG_ODD4.BF.DFE_FEXT1_D_TOP_O_LANE_6_0
#define reg_DFE_FEXT1_S_BOT_O_LANE_6_0  DFE_FEXT_REG_ODD4.BF.DFE_FEXT1_S_BOT_O_LANE_6_0

// 0x00e0	DFE_FEXT_REG_ODD5		DFE TAP SIGN_MAGNITUDE READ BACK REG ODD5
typedef union {
	struct {
		uint8_t DFE_FEXT1_S_MID_O_LANE_6_0               : 7;	/*  [6:0]     r/w 7'h0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
		uint8_t DFE_FEXT1_S_TOP_O_LANE_6_0               : 7;	/* [14:8]     r/w 7'h0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
...
#define reg_DFE_FEXT1_S_MID_O_LANE_6_0  DFE_FEXT_REG_ODD5.BF.DFE_FEXT1_S_MID_O_LANE_6_0
#define reg_DFE_FEXT1_S_TOP_O_LANE_6_0  DFE_FEXT_REG_ODD5.BF.DFE_FEXT1_S_TOP_O_LANE_6_0
...
typedef union {
	struct {
		uint8_t DFE_F1_D_BOT_E_SM_LANE_6_0               : 7;	/*  [6:0]       r 7'h0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
		uint8_t DFE_F1_D_MID_E_SM_LANE_6_0               : 7;	/* [14:8]       r 7'h0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
		uint8_t DFE_F1_D_TOP_E_SM_LANE_6_0               : 7;	/*[22:16]       r 7'h0*/
		uint8_t RESERVED_23                              : 1;	/*     23     r/w   0*/
		uint8_t DFE_F1_S_BOT_E_SM_LANE_6_0               : 7;	/*[30:24]       r 7'h0*/
		uint8_t RESERVED_31                              : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_DFE_F1_D_BOT_E_SM_LANE_6_0  DFE_READ_SM_REG_EVEN4.BF.DFE_F1_D_BOT_E_SM_LANE_6_0
#define reg_DFE_F1_D_MID_E_SM_LANE_6_0  DFE_READ_SM_REG_EVEN4.BF.DFE_F1_D_MID_E_SM_LANE_6_0
#define reg_DFE_F1_D_TOP_E_SM_LANE_6_0  DFE_READ_SM_REG_EVEN4.BF.DFE_F1_D_TOP_E_SM_LANE_6_0
#define reg_DFE_F1_S_BOT_E_SM_LANE_6_0  DFE_READ_SM_REG_EVEN4.BF.DFE_F1_S_BOT_E_SM_LANE_6_0

// 0x011c	DFE_READ_SM_REG_EVEN5		DFE TAP SIGN_MAGNITUDE READ BACK REG EVEN5
typedef union {
	struct {
		uint8_t DFE_F1_S_MID_E_SM_LANE_6_0               : 7;	/*  [6:0]       r 7'h0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
		uint8_t DFE_F1_S_TOP_E_SM_LANE_6_0               : 7;	/* [14:8]       r 7'h0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
...
#define reg_DFE_F1_S_MID_E_SM_LANE_6_0  DFE_READ_SM_REG_EVEN5.BF.DFE_F1_S_MID_E_SM_LANE_6_0
#define reg_DFE_F1_S_TOP_E_SM_LANE_6_0  DFE_READ_SM_REG_EVEN5.BF.DFE_F1_S_TOP_E_SM_LANE_6_0
...
typedef union {
	struct {
		uint8_t DFE_F1_D_BOT_O_SM_LANE_6_0               : 7;	/*  [6:0]       r 7'h0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
		uint8_t DFE_F1_D_MID_O_SM_LANE_6_0               : 7;	/* [14:8]       r 7'h0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
		uint8_t DFE_F1_D_TOP_O_SM_LANE_6_0               : 7;	/*[22:16]       r 7'h0*/
		uint8_t RESERVED_23                              : 1;	/*     23     r/w   0*/
		uint8_t DFE_F1_S_BOT_O_SM_LANE_6_0               : 7;	/*[30:24]       r 7'h0*/
		uint8_t RESERVED_31                              : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_DFE_F1_D_BOT_O_SM_LANE_6_0  DFE_READ_SM_REG_ODD4.BF.DFE_F1_D_BOT_O_SM_LANE_6_0
#define reg_DFE_F1_D_MID_O_SM_LANE_6_0  DFE_READ_SM_REG_ODD4.BF.DFE_F1_D_MID_O_SM_LANE_6_0
#define reg_DFE_F1_D_TOP_O_SM_LANE_6_0  DFE_READ_SM_REG_ODD4.BF.DFE_F1_D_TOP_O_SM_LANE_6_0
#define reg_DFE_F1_S_BOT_O_SM_LANE_6_0  DFE_READ_SM_REG_ODD4.BF.DFE_F1_S_BOT_O_SM_LANE_6_0

// 0x0158	DFE_READ_SM_REG_ODD5		DFE TAP SIGN_MAGNITUDE READ BACK REG ODD5
typedef union {
	struct {
		uint8_t DFE_F1_S_MID_O_SM_LANE_6_0               : 7;	/*  [6:0]       r 7'h0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
		uint8_t DFE_F1_S_TOP_O_SM_LANE_6_0               : 7;	/* [14:8]       r 7'h0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
...
#define reg_DFE_F1_S_MID_O_SM_LANE_6_0  DFE_READ_SM_REG_ODD5.BF.DFE_F1_S_MID_O_SM_LANE_6_0
#define reg_DFE_F1_S_TOP_O_SM_LANE_6_0  DFE_READ_SM_REG_ODD5.BF.DFE_F1_S_TOP_O_SM_LANE_6_0
