...
enum PLL_SEQUENCE__SEQUENCES {
     ...
     PLL_SEQUENCE__Trx_Soft_Reset              = 0x16,  //PLL powered off
     PLL_SEQUENCE__Trx_Soft_Reset_Release      = 0x17,  //PLL powered on
...
enum PLL_SLAVE_LANE_STATE__STATES {
     ...
     PLL_SLAVE_LANE_STATE__Initialized_State          = 0x1,
     PLL_SLAVE_LANE_STATE__WillNeverNeedMaster        = 0x2,
     PLL_SLAVE_LANE_STATE__RequestingPLLAccess        = 0x3,
     PLL_SLAVE_LANE_STATE__InUseSendPLLAccessCommands = 0x4,
     PLL_SLAVE_LANE_STATE__InUseSyncPLLAccess         = 0x5,
     PLL_SLAVE_LANE_STATE__InUseSkipPLLAccess         = 0x6,
     PLL_SLAVE_LANE_STATE__InUse                      = 0x7,
     PLL_SLAVE_LANE_STATE__Free                       = 0x8,
...
enum PLL_MASTER_LANE_STATE__STATES {
     ...
     //Slave will skip PLL access
     PLL_MASTER_LANE_STATE__InUseSlaveSkipPLLAccess            = 0x6,

     //Master will skip PLL access
     PLL_MASTER_LANE_STATE__InUseMasterSkipPLLAccess           = 0x7,

     //Master is using the PLL
     PLL_MASTER_LANE_STATE__InUse                              = 0x8,

     //Master is not using the PLL (e.g. the lane is fully powered down)
     PLL_MASTER_LANE_STATE__Free                               = 0x9,
...
enum PLL_REQUEST_ACCESS_RETURN_CODES {
     ...
     //Slave will skip PLL access since some other lane is already using the PLL.
     //Slave will still send free command to Master when done
     PLL_REQUEST_RETURN_CODE__SlaveSkipPLLAccess          = 0x6,

     //Master will skip PLL access since some other lane is already using the PLL.
     PLL_REQUEST_RETURN_CODE__MasterSkipPLLAccess         = 0x7,
