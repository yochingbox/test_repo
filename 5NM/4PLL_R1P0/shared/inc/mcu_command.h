...
enum MCU_COMMAND__COMMANDS {
    ...
    MCU_LOADSPEEDTBL_RX_PLL         = 0x07,
    MCU_LOADSPEEDTBL_TX_PLL         = 0x08,
    ...
    MCU_SYNC                        = 0x36,
    MCU_SPD_CHG_PLL_CAL_TX_AND_FREE = 0x37,
    MCU_SPD_CHG_PLL_CAL_RX_AND_FREE = 0x38,
    MCU_PLL_POWER_OFF_AND_FREE      = 0x39,
    MCU_PLL_POWER_ON_TX_AND_FREE    = 0x40,
    MCU_PLL_POWER_ON_AND_FREE       = 0x41,
    MCU_WAIT_FOR_PLL_LOCK           = 0x42,
    MCU_WAIT_FOR_RX_PLL_LOCK        = 0x43,
    MCU_WAIT_FOR_TX_PLL_LOCK        = 0x44,
    MCU_CHECK_FOR_RX_PLL_LOCK       = 0x45,
    MCU_CHECK_FOR_TX_PLL_LOCK       = 0x46,
    MCU_CHECK_FOR_RX_TX_BOTH_PLL_LOCK= 0x47,
};
