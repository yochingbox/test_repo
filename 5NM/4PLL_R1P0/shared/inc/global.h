...
extern __xdata uint8_t adapted_phase;
extern __xdata Status_Train_t train;
extern __xdata int8_t train_vref_top, train_vref_bot;
...
extern __xdata uint8_t traintb_inx;
...
#else
#define ctrl_max_dfe_adapt_shift 0
#define half_shift	0
#endif
...
extern __xdata int8_t train_cds;
...
extern __xdata uint8_t dfe_cnt, dfe_max_cnt, dfe_err_loop_cnt, remote_status_time_out;
...
extern __xdata Timeout2_Timer_t timeout2_timers[];

extern __xdata int8_t rx_pi_dcc_max_2c, rx_pi_dcc_min_2c, rx_pi_dcc_timer_step; 

extern uint16_t tick; //us
extern uint16_t tick_1ms; //ms 
extern uint8_t tsec; 
extern uint8_t st_p1off_wk_flag;
...
extern __code TRAIN_FNC_t train_fnc_tb[];

//#if _DEBUG
//extern __code char str_train_step[ST_TRAIN_MAX][40];
//#endif
...
#define caloft_ts_lccap_usb_rate0					(caloft_ts_lccap_ulsb_rate0 + 3)
#define caloft_ts_pllamp_rate0						(caloft_ts_lccap_usb_rate0 + 3)
...
#define caloft_rs_lccap_usb_rate0					(caloft_rs_lccap_ulsb_rate0 + 3)
#define caloft_rs_pllamp_rate0						(caloft_rs_lccap_usb_rate0 + 3)
...
__xdata __at(PHY_CAL_SAVE_BASE_LANE + caloft_ts_lccap_usb_rate0) 	 		uint8_t lnx_cal_ts_lccap_usb[3];
...
__xdata __at(PHY_CAL_SAVE_BASE_LANE + caloft_rs_lccap_usb_rate0) 	 		uint8_t lnx_cal_rs_lccap_usb[3];
...
// -- 
__xdata __at(0xe6a4)   			uint32_t cmx_train_cds_tb[20];
...
//__xdata __at(0x6f24) volatile Timeout2_Timer_t timeout2_timers[MAX_TIMERS];// 8*11=88
// to 6f64
