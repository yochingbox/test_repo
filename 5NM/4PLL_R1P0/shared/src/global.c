...
//--------------------------------------
// -- Train
// HR: Note! Do not change order. it is mapped with xdat_lane midas for train.
__xdata Status_Train_t train; 
__xdata int8_t train_vref_top, train_vref_bot;
...
__xdata int8_t rx_pi_dcc_max_2c, rx_pi_dcc_min_2c, rx_pi_dcc_timer_step; 
...
__xdata Timeout2_Timer_t timeout2_timers[MAX_TIMERS];
