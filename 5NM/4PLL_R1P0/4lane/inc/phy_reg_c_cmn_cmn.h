...
typedef union {
	struct {
		...
		uint8_t SHARE_PLL_MODE_CMN_1_0                   : 2;	/*  [2:1]     r/w 2'h0*/
		...
		uint8_t LANE_SEL_3_0                             : 4;	/*[31:28]     r/w 4'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} SYSTEM_t;
...
#define reg_SHARE_PLL_MODE_CMN_1_0  SYSTEM.BF.SHARE_PLL_MODE_CMN_1_0
...
#define reg_LANE_SEL_3_0  SYSTEM.BF.LANE_SEL_3_0
...
// 0x0020	LANE_CMN_TSEN_CTRL		LANE MCU TSEN Control Register 0
typedef union {
	struct {
		uint8_t TSEN_ADC_RD_LANE_REQ_CH0                 : 1;	/*      0     r/w   1*/
		uint8_t RESERVED_1                               : 7;	/*  [7:1]     r/w 7'h0*/
		uint8_t TSEN_ADC_RD_LANE_REQ_CH1                 : 1;	/*      8     r/w   1*/
		uint8_t RESERVED_9                               : 7;	/* [15:9]     r/w 7'h0*/
		uint8_t TSEN_ADC_RD_LANE_REQ_CH2                 : 1;	/*     16     r/w   1*/
		uint8_t RESERVED_17                              : 7;	/*[23:17]     r/w 7'h0*/
		uint8_t TSEN_ADC_RD_LANE_REQ_CH3                 : 1;	/*     24     r/w   1*/
		uint8_t RESERVED_25                              : 7;	/*[31:25]     r/w 7'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} LANE_CMN_TSEN_CTRL_t;
__xdata __at( 0xa320 ) volatile LANE_CMN_TSEN_CTRL_t LANE_CMN_TSEN_CTRL;
#define reg_TSEN_ADC_RD_LANE_REQ_CH0  LANE_CMN_TSEN_CTRL.BF.TSEN_ADC_RD_LANE_REQ_CH0
#define reg_TSEN_ADC_RD_LANE_REQ_CH1  LANE_CMN_TSEN_CTRL.BF.TSEN_ADC_RD_LANE_REQ_CH1
#define reg_TSEN_ADC_RD_LANE_REQ_CH2  LANE_CMN_TSEN_CTRL.BF.TSEN_ADC_RD_LANE_REQ_CH2
#define reg_TSEN_ADC_RD_LANE_REQ_CH3  LANE_CMN_TSEN_CTRL.BF.TSEN_ADC_RD_LANE_REQ_CH3
...
typedef union {
	struct {
		...
		uint8_t RESERVED_8                               : 8;	/* [22:8]     r/w   0*/
		uint8_t RESERVED_16                              : 7;	/* [22:8]     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t ANA_PU_MASREG                            : 1;	/*     20     r/w   0*/
		uint8_t RESERVED_21                              : 1;	/*     21     r/w   0*/
		uint8_t RESERVED_22                              : 1;	/*     22     r/w   0*/
		uint8_t RESERVED_23                              : 1;	/*     23     r/w   0*/
		uint8_t RESERVED_24                              : 1;	/*     24     r/w   0*/
...
#define reg_ANA_PU_MASREG  PM_CMN_REG2.BF.ANA_PU_MASREG
...
typedef union {
	struct {
		uint8_t PLL_TS_CLK_READY_RD_LANE0                : 1;	/*      0       r   0*/
		uint8_t PLL_TS_CLK_READY_RD_LANE1                : 1;	/*      1       r   0*/
		uint8_t PLL_TS_CLK_READY_RD_LANE2                : 1;	/*      2       r   0*/
		uint8_t PLL_TS_CLK_READY_RD_LANE3                : 1;	/*      3       r   0*/
		uint8_t PLL_RS_CLK_READY_RD_LANE0                : 1;	/*      4       r   0*/
		uint8_t PLL_RS_CLK_READY_RD_LANE1                : 1;	/*      5       r   0*/
		uint8_t PLL_RS_CLK_READY_RD_LANE2                : 1;	/*      6       r   0*/
		uint8_t PLL_RS_CLK_READY_RD_LANE3                : 1;	/*      7       r   0*/
		...
		uint8_t PLL_TS_LOCK_RD_LANE0                     : 1;	/*     24       r   0*/
		uint8_t PLL_TS_LOCK_RD_LANE1                     : 1;	/*     25       r   0*/
		uint8_t PLL_TS_LOCK_RD_LANE2                     : 1;	/*     26       r   0*/
		uint8_t PLL_TS_LOCK_RD_LANE3                     : 1;	/*     27       r   0*/
		uint8_t PLL_RS_LOCK_RD_LANE0                     : 1;	/*     28       r   0*/
		uint8_t PLL_RS_LOCK_RD_LANE1                     : 1;	/*     29       r   0*/
		uint8_t PLL_RS_LOCK_RD_LANE2                     : 1;	/*     30       r   0*/
		uint8_t PLL_RS_LOCK_RD_LANE3                     : 1;	/*     31       r   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CMN_REGISTER0_t;
__xdata __at( 0xa350 ) volatile CMN_REGISTER0_t CMN_REGISTER0;
#define reg_PLL_TS_CLK_READY_RD_LANE0  CMN_REGISTER0.BF.PLL_TS_CLK_READY_RD_LANE0
#define reg_PLL_TS_CLK_READY_RD_LANE1  CMN_REGISTER0.BF.PLL_TS_CLK_READY_RD_LANE1
#define reg_PLL_TS_CLK_READY_RD_LANE2  CMN_REGISTER0.BF.PLL_TS_CLK_READY_RD_LANE2
#define reg_PLL_TS_CLK_READY_RD_LANE3  CMN_REGISTER0.BF.PLL_TS_CLK_READY_RD_LANE3
#define reg_PLL_RS_CLK_READY_RD_LANE0  CMN_REGISTER0.BF.PLL_RS_CLK_READY_RD_LANE0
#define reg_PLL_RS_CLK_READY_RD_LANE1  CMN_REGISTER0.BF.PLL_RS_CLK_READY_RD_LANE1
#define reg_PLL_RS_CLK_READY_RD_LANE2  CMN_REGISTER0.BF.PLL_RS_CLK_READY_RD_LANE2
#define reg_PLL_RS_CLK_READY_RD_LANE3  CMN_REGISTER0.BF.PLL_RS_CLK_READY_RD_LANE3
...
#define reg_PLL_TS_LOCK_RD_LANE0  CMN_REGISTER0.BF.PLL_TS_LOCK_RD_LANE0
#define reg_PLL_TS_LOCK_RD_LANE1  CMN_REGISTER0.BF.PLL_TS_LOCK_RD_LANE1
#define reg_PLL_TS_LOCK_RD_LANE2  CMN_REGISTER0.BF.PLL_TS_LOCK_RD_LANE2
#define reg_PLL_TS_LOCK_RD_LANE3  CMN_REGISTER0.BF.PLL_TS_LOCK_RD_LANE3
#define reg_PLL_RS_LOCK_RD_LANE0  CMN_REGISTER0.BF.PLL_RS_LOCK_RD_LANE0
#define reg_PLL_RS_LOCK_RD_LANE1  CMN_REGISTER0.BF.PLL_RS_LOCK_RD_LANE1
#define reg_PLL_RS_LOCK_RD_LANE2  CMN_REGISTER0.BF.PLL_RS_LOCK_RD_LANE2
#define reg_PLL_RS_LOCK_RD_LANE3  CMN_REGISTER0.BF.PLL_RS_LOCK_RD_LANE3
...
typedef union {
	struct {
		...
		uint8_t CID3_7_6                                 : 2;	/*[15:14]       r 2'h2*/
		uint8_t CID1_3_0                                 : 4;	/*[19:16]       r   0*/
		uint8_t CID1_7_4                                 : 4;	/*[23:20]       r   0*/
		uint8_t CID0_3_0                                 : 4;	/*[27:24]       r 4'h4*/
		uint8_t CID0_7_4                                 : 4;	/*[31:28]       r 4'h7*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CID_REG0_t;
