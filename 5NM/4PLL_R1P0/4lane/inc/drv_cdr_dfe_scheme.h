...
// DFE Structure:
#define NUM_PATH 2 //0:ODD 1:EVEN
#define NUM_DS 2 //0:DATA, 1:SLICE
#define NUM_TMB 3 //0:BOT, 1:MID, 2:TOP
#define NUM_ML 2 //0:LSB  1:MSB
// **************************************************
...
typedef struct {
    ...
    // -- e 
    uint8_t dc_d_bot_e,     dc_d_mid_e,     dc_d_top_e,     dc_s_bot_e;
    uint8_t dc_s_mid_e,     dc_s_top_e,     dc_e_e,         vref_bot_e;
    uint8_t vref_mid_e,     vref_top_e,     f0_d_bot_e,     f0_d_mid_e;
    uint8_t f0_d_top_e,     f0_s_bot_e,     f0_s_mid_e,     f0_s_top_e;
    uint8_t f1_d_bot_e,     f1_d_mid_e,     f1_d_top_e,     f1_s_bot_e;
    uint8_t f1_s_mid_e,     f1_s_top_e,     f2_d_bot_e,     f2_d_mid_e;
    uint8_t f2_d_top_e,     f2_s_bot_e,     f2_s_mid_e,     f2_s_top_e;
    uint8_t f3_bot_e,       f3_mid_e,       f3_top_e,       f4_bot_e;
    uint8_t f4_mid_e,       f4_top_e,       f5_lsb_e,       f5_msb_e;
    uint8_t f6_lsb_e,       f6_msb_e,       f7_lsb_e,       f7_msb_e;
    uint8_t ff0_e,          f8_lsb_e,       f8_msb_e,       ff1_e;
    uint8_t f9_lsb_e,       f9_msb_e,       ff2_e,          f10_lsb_e;
    uint8_t f10_msb_e,      ff3_e,          f11_e,          ff4_e;
    uint8_t f12_e,          ff5_e,          f13_e,          f14_e;
    uint8_t f15_e,          f1p5_e,         f1_tune_bot_sd_e, f1_tune_top_sd_e;

    // -- o 
    uint8_t dc_d_bot_o,     dc_d_mid_o,     dc_d_top_o,     dc_s_bot_o;
    uint8_t dc_s_mid_o,     dc_s_top_o,     dc_e_o,         vref_bot_o;
    uint8_t vref_mid_o,     vref_top_o,     f0_d_bot_o,     f0_d_mid_o;
    uint8_t f0_d_top_o,     f0_s_bot_o,     f0_s_mid_o,     f0_s_top_o;
    uint8_t f1_d_bot_o,     f1_d_mid_o,     f1_d_top_o,     f1_s_bot_o;
    uint8_t f1_s_mid_o,     f1_s_top_o,     f2_d_bot_o,     f2_d_mid_o;
    uint8_t f2_d_top_o,     f2_s_bot_o,     f2_s_mid_o,     f2_s_top_o;
    uint8_t f3_bot_o,       f3_mid_o,       f3_top_o,       f4_bot_o;
    uint8_t f4_mid_o,       f4_top_o,       f5_lsb_o,       f5_msb_o;
    uint8_t f6_lsb_o,       f6_msb_o,       f7_lsb_o,       f7_msb_o;
    uint8_t ff0_o,          f8_lsb_o,       f8_msb_o,       ff1_o;
    uint8_t f9_lsb_o,       f9_msb_o,       ff2_o,          f10_lsb_o;
    uint8_t f10_msb_o,      ff3_o,          f11_o,          ff4_o;
    uint8_t f12_o,          ff5_o,          f13_o,          f14_o;
    uint8_t f15_o,          f1p5_o,         f1_tune_bot_sd_o, f1_tune_top_sd_o;
...
typedef struct {
    ...
    // -- e 
    int8_t dc_d_bot_e, dc_d_mid_e, dc_d_top_e, dc_s_bot_e;
    int8_t dc_s_mid_e, dc_s_top_e, dc_e_e,     vref_bot_e;
    int8_t vref_mid_e, vref_top_e, f0_d_bot_e, f0_d_mid_e;
    int8_t f0_d_top_e, f0_s_bot_e, f0_s_mid_e, f0_s_top_e;
    int8_t f1_d_bot_e, f1_d_mid_e, f1_d_top_e, f1_s_bot_e;
    int8_t f1_s_mid_e, f1_s_top_e, f2_d_bot_e, f2_d_mid_e;
    int8_t f2_d_top_e, f2_s_bot_e, f2_s_mid_e, f2_s_top_e;
    int8_t f3_bot_e,   f3_mid_e,   f3_top_e,   f4_bot_e;
    int8_t f4_mid_e,   f4_top_e,   f5_lsb_e,   f5_msb_e;
    int8_t f6_lsb_e,   f6_msb_e,   f7_lsb_e,   f7_msb_e;
    int8_t ff0_e,      f8_lsb_e,   f8_msb_e,   ff1_e;
    int8_t f9_lsb_e,   f9_msb_e,   ff2_e,      f10_lsb_e;
    int8_t f10_msb_e,  ff3_e,      f11_e,      ff4_e;
    int8_t f12_e,      ff5_e,      f13_e,      f14_e;
    int8_t f15_e,      f1p5_e,     rsvd382,    rsvd383;

    // -- o 
    int8_t dc_d_bot_o, dc_d_mid_o, dc_d_top_o, dc_s_bot_o;
    int8_t dc_s_mid_o, dc_s_top_o, dc_e_o,     vref_bot_o;
    int8_t vref_mid_o, vref_top_o, f0_d_bot_o, f0_d_mid_o;
    int8_t f0_d_top_o, f0_s_bot_o, f0_s_mid_o, f0_s_top_o;
    int8_t f1_d_bot_o, f1_d_mid_o, f1_d_top_o, f1_s_bot_o;
    int8_t f1_s_mid_o, f1_s_top_o, f2_d_bot_o, f2_d_mid_o;
    int8_t f2_d_top_o, f2_s_bot_o, f2_s_mid_o, f2_s_top_o;
    int8_t f3_bot_o,   f3_mid_o,   f3_top_o,   f4_bot_o;
    int8_t f4_mid_o,   f4_top_o,   f5_lsb_o,   f5_msb_o;
    int8_t f6_lsb_o,   f6_msb_o,   f7_lsb_o,   f7_msb_o;
    int8_t ff0_o,      f8_lsb_o,   f8_msb_o,   ff1_o;
    int8_t f9_lsb_o,   f9_msb_o,   ff2_o,      f10_lsb_o;
    int8_t f10_msb_o,  ff3_o,      f11_o,      ff4_o;
    int8_t f12_o,      ff5_o,      f13_o,      f14_o;
    int8_t f15_o,      f1p5_o,     rsvd380,    rsvd381;
