...
typedef union {
	struct {
		...
		uint8_t CDS_DFE_FINE_FB_ALL_EN_LANE              : 1;	/*      6     r/w   0*/
		uint8_t CDS_DFE_ACCU_FB_ALL_EN_LANE              : 1;	/*      7     r/w   0*/
		...
		uint8_t CDS_F1_VAL_LANE_5_0                      : 6;	/*[31:26]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CDS_CTRL_REG1_t;
...
#define reg_CDS_DFE_FINE_FB_ALL_EN_LANE  CDS_CTRL_REG1.BF.CDS_DFE_FINE_FB_ALL_EN_LANE
#define reg_CDS_DFE_ACCU_FB_ALL_EN_LANE  CDS_CTRL_REG1.BF.CDS_DFE_ACCU_FB_ALL_EN_LANE
...
#define reg_CDS_F1_VAL_LANE_5_0  CDS_CTRL_REG1.BF.CDS_F1_VAL_LANE_5_0
...
typedef union {
	struct {
		...
		uint8_t TXTRAIN_8MS_TIMEOUT_LANE                 : 1;	/*     22     r/w   0*/
		uint8_t TXTRAIN_COMPLETE_LANE                    : 1;	/*     23     r/w   0*/
...
#define reg_TXTRAIN_8MS_TIMEOUT_LANE  TXTRAIN_IF_REG0.BF.TXTRAIN_8MS_TIMEOUT_LANE
#define reg_TXTRAIN_COMPLETE_LANE  TXTRAIN_IF_REG0.BF.TXTRAIN_COMPLETE_LANE
...
#define reg_TXTRAIN_PATTERN_LOCK_LOST_EN_LANE  TXTRAIN_IF_REG0.BF.TXTRAIN_PATTERN_LOCK_LOST_EN_LANE
...
// 0x0220	TX_TRAIN_IF_TIMER		
typedef union {
	struct {
		uint8_t TXTRAIN_RESP_TIMER_LANE_15_0_b0          : 8;	/* [15:0]     r/w 16'h1f40*/
		uint8_t TXTRAIN_RESP_TIMER_LANE_15_0_b1          : 8;	/* [15:0]     r/w 16'h1f40*/
		uint8_t RESERVED_16                              : 8;	/*[31:16]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/*[31:16]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
...
__xdata __at( 0x6420 ) volatile TX_TRAIN_IF_TIMER_t TX_TRAIN_IF_TIMER;
#define reg_TXTRAIN_RESP_TIMER_LANE_15_0_b0  TX_TRAIN_IF_TIMER.BF.TXTRAIN_RESP_TIMER_LANE_15_0_b0
#define reg_TXTRAIN_RESP_TIMER_LANE_15_0_b1  TX_TRAIN_IF_TIMER.BF.TXTRAIN_RESP_TIMER_LANE_15_0_b1
#define reg_TXTRAIN_RESP_TIMER_LANE_15_0  TX_TRAIN_IF_TIMER.WT.W0
