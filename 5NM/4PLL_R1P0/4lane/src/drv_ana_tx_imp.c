...
// Auto generated by IPDOC
  ...
  void tx_imp(void) BANKING_CTRL {
    ...
    reg_TXIMPCAL_NMOS_LANE = 1;
    reg_TXIMPCAL_2ND_EN_LANE = 0;
    reg_TXIMPCAL_NSIDE_LANE = 0;
    ...
    reg_TX_IMP_N_CAL_RESULT_EXT_LANE_6_0 = (VAR_TXIMP_N_1+VAR_TXIMP_N_2+VAR_TXIMP_N_3+VAR_TXIMP_N_4)/4;
    ...
    reg_TX_IMP_N_CAL_RESULT_EXT_LANE_6_0 = (VAR_TXIMP_P_1+VAR_TXIMP_P_2+VAR_TXIMP_P_3+VAR_TXIMP_P_4)/4;
    reg_TX_IMP_N_CAL_INDV_EXT_EN_LANE = 1;
    reg_TXIMPCAL_EN_LANE = 0;
  }
