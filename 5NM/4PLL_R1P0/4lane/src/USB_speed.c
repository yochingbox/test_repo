...
void loadspeedtbl_rx() BANKING_CTRL {
  ...
  uint8_t tmp6 = 0x2; //ANA_IMPCAL_REG0.BT.B0 , path_disable_edge_lane, intpr_lane[1:0]
  ...
  uint8_t tmp9 = 0x20; //ANA_SMPLR_REG4.BT.B0 , rxspeed_div_2x_lane[1:0], rxtsen_sel_lane, rxterm_extra_lane[1:0], rxtest_lane[8]
  ...
  uint8_t tmp24 = 0xC2; //ANA_SMPLR_REG2.BT.B0 , pu_ctle_even_lane, pu_ctle_odd_lane, pu_smplr_s_e_lane[2:0], pu_smplr_s_o_lane[2:0]
  uint8_t tmp25 = 0x0; //ANA_RSVD_REG9.BT.B0 , ctle_cl2_sel_lane[1:0], ctle_cl1_sel_lane[1:0]
  uint8_t tmp26 = 0xB; //ANA_CTLE_REG5.BT.B0 , ctle_res1_sel_lane[3:0]
  ...
  uint8_t tmp32 = 0x1A; //CAL_CTRL4_LANE.BT.B2 , rx_pll_rate_lane[7:0]
  uint8_t tmp33 = 0xA; //ANA_RXREG_REG0.BT.B0 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
  uint8_t tmp34 = 0x7; //ANA_CTLE_REG6.BT.B0 , ctle_res2_sel_lane[3:0]
  ...
  if (gen_rx==2){
    ...
    tmp24 = 0xD2;// ANA_SMPLR_REG2.BT.B0 = 11010010 , pu_ctle_even_lane, pu_ctle_odd_lane, pu_smplr_s_e_lane[2:0], pu_smplr_s_o_lane[2:0]
...
void loadspeedtbl_tx() BANKING_CTRL {
  ...
  uint8_t tmp4 = 0x4; //ANA_TXREG_REG0.BT.B0 , txreg_speedtrk_clk_lane[3:0]
  uint8_t tmp5 = 0x4; //ANA_TXREG_REG1.BT.B0 , txreg_speedtrk_data_lane[3:0]
  ...
  uint8_t tmp7 = 0x1A; //CAL_CTRL4_LANE.BT.B3 , tx_pll_rate_lane[7:0]
