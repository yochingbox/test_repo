...
//CONTROL_CONFIG8.BT.B1 = 0x0; //00000000, dfe_outer_eye_thres[7:0]
  CONTROL_CONFIG8.BT.B2 = 0x82; //10000010, bypass_p4_jump_g1_train_gen3, bypass_p4_jump_gn1_train_gen3, bypass_p4_jump_g1_train_gen4, bypass_p4_jump_gn1_train_gen4, pcie_g1_opt_train_en_gen4, pcie_g1_opt_train_en_gen3, tsen_adc_single_diff_user_sel, auto_rx_init_en
...
//TRAIN_CDS_0.BT.B3 = 0x0; //00000000, cds_tx_train_preset[31:0]
  TRAIN_CDS_1.BT.B0 = 0xF7; //11110111, cds_gaintrain_init[31:0]
...
//TRAIN_CDS_1.BT.B3 = 0x0; //00000000, cds_gaintrain_init[31:0]
  TRAIN_CDS_2.BT.B0 = 0xB7; //10110111, cds_gaintrain_init1[31:0]
...
//TRAIN_CDS_2.BT.B3 = 0x0; //00000000, cds_gaintrain_init1[31:0]
  TRAIN_CDS_3.BT.B0 = 0xB7; //10110111, cds_gaintrain_init2[31:0]
...
//TRAIN_CDS_3.BT.B3 = 0x0; //00000000, cds_gaintrain_init2[31:0]
  TRAIN_CDS_4.BT.B0 = 0x70; //01110000, cds_init_phase_train[31:0]
...
//TRAIN_CDS_4.BT.B3 = 0x0; //00000000, cds_init_phase_train[31:0]
  TRAIN_CDS_5.BT.B0 = 0xB7; //10110111, cds_res_f0_start[31:0]
...
//TRAIN_CDS_6.BT.B3 = 0x0; //00000000, cds_res_f0[31:0]
  TRAIN_CDS_7.BT.B0 = 0x70; //01110000, cds_init_phase_train2[31:0]
...
//TRAIN_CDS_7.BT.B3 = 0x0; //00000000, cds_init_phase_train2[31:0]
  TRAIN_CDS_8.BT.B0 = 0xB7; //10110111, cds_rsweep[31:0]
...
//TRAIN_CDS_11.BT.B3 = 0x0; //00000000, cds_res_vref[31:0]
  TRAIN_CDS_12.BT.B0 = 0x70; //01110000, cds_phase_train[31:0]
...
//TRAIN_CDS_12.BT.B3 = 0x0; //00000000, cds_phase_train[31:0]
  TRAIN_CDS_13.BT.B0 = 0x70; //01110000, cds_rl2_tune_adj[31:0]
...
//TRAIN_CDS_13.BT.B3 = 0x0; //00000000, cds_rl2_tune_adj[31:0]
  TRAIN_CDS_14.BT.B0 = 0x70; //01110000, cds_phase_train_final[31:0]
...
//TRAIN_CDS_17.BT.B3 = 0x0; //00000000, cds_final_measure[31:0]
  TRAIN_CDS_18.BT.B0 = 0x40; //01000000, cds_trx_train[31:0]
...
//TRAIN_CDS_18.BT.B3 = 0x0; //00000000, cds_trx_train[31:0]
  TRAIN_CDS_19.BT.B0 = 0x3; //00000011, cds_pcie_train[31:0]
  TRAIN_CDS_19.BT.B1 = 0x1D; //00011101, cds_pcie_train[31:0]
  TRAIN_CDS_19.BT.B2 = 0x82; //10000010, cds_pcie_train[31:0]
//TRAIN_CDS_19.BT.B3 = 0x0; //00000000, cds_pcie_train[31:0]
  TRAIN_CDS_20.BT.B0 = 0x3; //00000011, cds_pcie_train_f0b[31:0]
  TRAIN_CDS_20.BT.B1 = 0x5D; //01011101, cds_pcie_train_f0b[31:0]
  TRAIN_CDS_20.BT.B2 = 0x80; //10000000, cds_pcie_train_f0b[31:0]
