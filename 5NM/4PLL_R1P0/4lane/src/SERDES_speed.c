...
void loadspeedtbl_rx() BANKING_CTRL {
  ...
  uint8_t tmp9 = 0x0; //ANA_SMPLR_REG4.BT.B0 , rxspeed_div_2x_lane[1:0], rxtsen_sel_lane, rxterm_extra_lane[1:0], rxtest_lane[8]
  ...
  uint8_t tmp14 = 0x76; //ANA_INTPI_REG0.BT.B0 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
  uint8_t tmp15 = 0x4; //ANA_CTLE_REG1.BT.B0 , ctle_cap1_sel_g_lane[3:0]
  uint8_t tmp16 = 0xF; //ANA_CTLE_REG4.BT.B0 , ctle_current2_sel_lane[3:0]
  uint8_t tmp17 = 0xF; //ANA_CTLE_REG7.BT.B0 , ctle_rl1_sel_lane[3:0]
  ...
  uint8_t tmp20 = 0x88; //TX_TRAIN_PATTERN_REG1.BT.B2 , train_pat_num_rx_lane[9:0]
  uint8_t tmp21 = 0x0; //TX_TRAIN_PATTERN_REG1.BT.B3 , train_pat_num_rx_lane[9:0]
  uint8_t tmp22 = 0xF; //ANA_CTLE_REG2.BT.B0 , ctle_cap2_sel_lane[3:0]
  ...
  uint8_t tmp27 = 0x40; //ANA_RXREG_REG1.BT.B0 , rxspeed_div_lane[2:0], rxreg_speedtrk_data_lane[2:0]
  uint8_t tmp28 = 0x6; //ANA_DLL_REG.BT.B0 , dll_cap_sel_lane[2:0]
  uint8_t tmp29 = 0x4; //TX_TRAIN_PATTTERN_REG0.BT.B1 , ethernet_mode_lane[1:0]
  ...
  uint8_t tmp32 = 0x4; //CAL_CTRL4_LANE.BT.B2 , rx_pll_rate_lane[7:0]
  uint8_t tmp33 = 0xA; //ANA_RXREG_REG0.BT.B0 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
  uint8_t tmp34 = 0x3; //ANA_CTLE_REG6.BT.B0 , ctle_res2_sel_lane[3:0]
  ...
  uint8_t tmp37 = 0xF; //ANA_CTLE_REG3.BT.B0 , ctle_current1_sel_lane[3:0]
  uint8_t tmp38 = 0x7; //ANA_RSVD_REG1.BT.B0 , ana_rsvd1_lane[7:0]
  uint8_t tmp39 = 0xF; //ANA_CTLE_REG8.BT.B0 , ctle_rl2_sel_lane[3:0]
  if (gen_rx==56){
    ...
    tmp11 = 0x1;// ANA_EOM_REG3.BT.B0 = #######1 , rxpll_hi_speed_lane
    tmp14 = 0xBC;// ANA_INTPI_REG0.BT.B0 = 10111100 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp15 = 0xF;// ANA_CTLE_REG1.BT.B0 = ####1111 , ctle_cap1_sel_g_lane[3:0]
    tmp19 = 0x4;// ANA_DTL_REG3.BT.B0 = #####100 , dtl_clk_speedup_lane[2:0]
    tmp20 = 0x8;// TX_TRAIN_PATTERN_REG1.BT.B2 = 00001000 , train_pat_num_rx_lane[9:0]
    tmp21 = 0x2;// TX_TRAIN_PATTERN_REG1.BT.B3 = ######10 , train_pat_num_rx_lane[9:0]
    tmp23 = 0x3;// ANA_SMPLR_REG3.BT.B0 = #####011 , reg_selmupi_lane[2:0]
    tmp24 = 0xFF;// ANA_SMPLR_REG2.BT.B0 = 11111111 , pu_ctle_even_lane, pu_ctle_odd_lane, pu_smplr_s_e_lane[2:0], pu_smplr_s_o_lane[2:0]
    tmp27 = 0x7;// ANA_RXREG_REG1.BT.B0 = #000#111 , rxspeed_div_lane[2:0], rxreg_speedtrk_data_lane[2:0]
    tmp28 = 0x0;// ANA_DLL_REG.BT.B0 = #####000 , dll_cap_sel_lane[2:0]
    tmp29 = 0x8;// TX_TRAIN_PATTTERN_REG0.BT.B1 = ####10## , ethernet_mode_lane[1:0]
    ...
    tmp32 = 0x1C;// CAL_CTRL4_LANE.BT.B2 = 00011100 , rx_pll_rate_lane[7:0]
    tmp33 = 0x7;// ANA_RXREG_REG0.BT.B0 = ####0111 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    tmp35 = 0x4;// RX_SYSTEM_LANE.BT.B0 = #####100 , rx_data_width_lane[1:0], rx_pam2_en_lane
    tmp36 = 0x3F;// ANA_SMPLR_REG0.BT.B0 = ##111111 , pu_smplr_d_e_lane[2:0], pu_smplr_d_o_lane[2:0]
    ...
    tmp14 = 0x42;// ANA_INTPI_REG0.BT.B0 = 01000010 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp15 = 0xF;// ANA_CTLE_REG1.BT.B0 = ####1111 , ctle_cap1_sel_g_lane[3:0]
    tmp17 = 0xB;// ANA_CTLE_REG7.BT.B0 = ####1011 , ctle_rl1_sel_lane[3:0]
    tmp18 = 0x2;// ANA_ALIGN90_REG1.BT.B0 = #####01# , align90_vcap_lane[1:0], align90_ref_filt_bw_lane
    tmp19 = 0x4;// ANA_DTL_REG3.BT.B0 = #####100 , dtl_clk_speedup_lane[2:0]
    tmp23 = 0x2;// ANA_SMPLR_REG3.BT.B0 = #####010 , reg_selmupi_lane[2:0]
    tmp26 = 0x6;// ANA_CTLE_REG5.BT.B0 = ####0110 , ctle_res1_sel_lane[3:0]
    tmp27 = 0x3;// ANA_RXREG_REG1.BT.B0 = #000#011 , rxspeed_div_lane[2:0], rxreg_speedtrk_data_lane[2:0]
    tmp28 = 0x7;// ANA_DLL_REG.BT.B0 = #####111 , dll_cap_sel_lane[2:0]
    tmp30 = 0x54;// PM_CTRL_RX_LANE_REG1_LANE.BT.B0 = 01010100 , rx_selmuff_lane[3:0], rx_selmufi_lane[3:0]
    tmp31 = 0x3;// ANA_SMPLR_REG1.BT.B0 = #####011 , reg_selmupf_lane[2:0]
    tmp32 = 0x1E;// CAL_CTRL4_LANE.BT.B2 = 00011110 , rx_pll_rate_lane[7:0]
    tmp33 = 0x2;// ANA_RXREG_REG0.BT.B0 = ####0010 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    tmp37 = 0xB;// ANA_CTLE_REG3.BT.B0 = ####1011 , ctle_current1_sel_lane[3:0]
  }
  else if (gen_rx==54){
    tmp0 = 0x7;// ANA_DLL_REG1.BT.B0 = #####111 , eom_dll_cap_sel_lane[2:0]
    ...
    tmp14 = 0x42;// ANA_INTPI_REG0.BT.B0 = 01000010 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp15 = 0xF;// ANA_CTLE_REG1.BT.B0 = ####1111 , ctle_cap1_sel_g_lane[3:0]
    tmp16 = 0xE;// ANA_CTLE_REG4.BT.B0 = ####1110 , ctle_current2_sel_lane[3:0]
    tmp17 = 0xA;// ANA_CTLE_REG7.BT.B0 = ####1010 , ctle_rl1_sel_lane[3:0]
    tmp18 = 0x2;// ANA_ALIGN90_REG1.BT.B0 = #####01# , align90_vcap_lane[1:0], align90_ref_filt_bw_lane
    tmp19 = 0x4;// ANA_DTL_REG3.BT.B0 = #####100 , dtl_clk_speedup_lane[2:0]
    tmp23 = 0x2;// ANA_SMPLR_REG3.BT.B0 = #####010 , reg_selmupi_lane[2:0]
    tmp26 = 0x7;// ANA_CTLE_REG5.BT.B0 = ####0111 , ctle_res1_sel_lane[3:0]
    tmp27 = 0x3;// ANA_RXREG_REG1.BT.B0 = #000#011 , rxspeed_div_lane[2:0], rxreg_speedtrk_data_lane[2:0]
    tmp28 = 0x7;// ANA_DLL_REG.BT.B0 = #####111 , dll_cap_sel_lane[2:0]
    tmp30 = 0x54;// PM_CTRL_RX_LANE_REG1_LANE.BT.B0 = 01010100 , rx_selmuff_lane[3:0], rx_selmufi_lane[3:0]
    tmp31 = 0x3;// ANA_SMPLR_REG1.BT.B0 = #####011 , reg_selmupf_lane[2:0]
    tmp32 = 0x20;// CAL_CTRL4_LANE.BT.B2 = 00100000 , rx_pll_rate_lane[7:0]
    tmp33 = 0x2;// ANA_RXREG_REG0.BT.B0 = ####0010 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    tmp34 = 0x4;// ANA_CTLE_REG6.BT.B0 = ####0100 , ctle_res2_sel_lane[3:0]
    tmp37 = 0xA;// ANA_CTLE_REG3.BT.B0 = ####1010 , ctle_current1_sel_lane[3:0]
    tmp39 = 0xE;// ANA_CTLE_REG8.BT.B0 = ####1110 , ctle_rl2_sel_lane[3:0]
  }
  else if (gen_rx==53){
    tmp0 = 0x7;// ANA_DLL_REG1.BT.B0 = #####111 , eom_dll_cap_sel_lane[2:0]
    tmp2 = 0xFA;// RX_DETERMINISTIC_LATENCY.BT.B0 = 11111010 , ck2floop_freq_lane[9:0]
    ...
    tmp14 = 0x42;// ANA_INTPI_REG0.BT.B0 = 01000010 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp16 = 0x7;// ANA_CTLE_REG4.BT.B0 = ####0111 , ctle_current2_sel_lane[3:0]
    tmp17 = 0x5;// ANA_CTLE_REG7.BT.B0 = ####0101 , ctle_rl1_sel_lane[3:0]
    tmp22 = 0x7;// ANA_CTLE_REG2.BT.B0 = ####0111 , ctle_cap2_sel_lane[3:0]
    tmp26 = 0x9;// ANA_CTLE_REG5.BT.B0 = ####1001 , ctle_res1_sel_lane[3:0]
    tmp28 = 0x7;// ANA_DLL_REG.BT.B0 = #####111 , dll_cap_sel_lane[2:0]
    tmp32 = 0x1E;// CAL_CTRL4_LANE.BT.B2 = 00011110 , rx_pll_rate_lane[7:0]
    tmp34 = 0xA;// ANA_CTLE_REG6.BT.B0 = ####1010 , ctle_res2_sel_lane[3:0]
    tmp37 = 0x5;// ANA_CTLE_REG3.BT.B0 = ####0101 , ctle_current1_sel_lane[3:0]
    tmp39 = 0x7;// ANA_CTLE_REG8.BT.B0 = ####0111 , ctle_rl2_sel_lane[3:0]
  }
  else if (gen_rx==52){
    tmp0 = 0x7;// ANA_DLL_REG1.BT.B0 = #####111 , eom_dll_cap_sel_lane[2:0]
    tmp2 = 0xCC;// RX_DETERMINISTIC_LATENCY.BT.B0 = 11001100 , ck2floop_freq_lane[9:0]
    ...
    tmp9 = 0x10;// ANA_SMPLR_REG4.BT.B0 = ##01#### , rxspeed_div_2x_lane[1:0], rxtsen_sel_lane, rxterm_extra_lane[1:0], rxtest_lane[8]
    tmp14 = 0x42;// ANA_INTPI_REG0.BT.B0 = 01000010 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp16 = 0x6;// ANA_CTLE_REG4.BT.B0 = ####0110 , ctle_current2_sel_lane[3:0]
    tmp17 = 0x4;// ANA_CTLE_REG7.BT.B0 = ####0100 , ctle_rl1_sel_lane[3:0]
    tmp22 = 0x7;// ANA_CTLE_REG2.BT.B0 = ####0111 , ctle_cap2_sel_lane[3:0]
    tmp26 = 0xB;// ANA_CTLE_REG5.BT.B0 = ####1011 , ctle_res1_sel_lane[3:0]
    tmp28 = 0x7;// ANA_DLL_REG.BT.B0 = #####111 , dll_cap_sel_lane[2:0]
    tmp32 = 0x20;// CAL_CTRL4_LANE.BT.B2 = 00100000 , rx_pll_rate_lane[7:0]
    tmp34 = 0xB;// ANA_CTLE_REG6.BT.B0 = ####1011 , ctle_res2_sel_lane[3:0]
    tmp37 = 0x4;// ANA_CTLE_REG3.BT.B0 = ####0100 , ctle_current1_sel_lane[3:0]
    tmp39 = 0x6;// ANA_CTLE_REG8.BT.B0 = ####0110 , ctle_rl2_sel_lane[3:0]
  }
  else if (gen_rx==51){
    tmp0 = 0x7;// ANA_DLL_REG1.BT.B0 = #####111 , eom_dll_cap_sel_lane[2:0]
    ...
    tmp14 = 0x42;// ANA_INTPI_REG0.BT.B0 = 01000010 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp16 = 0x3;// ANA_CTLE_REG4.BT.B0 = ####0011 , ctle_current2_sel_lane[3:0]
    tmp17 = 0x2;// ANA_CTLE_REG7.BT.B0 = ####0010 , ctle_rl1_sel_lane[3:0]
    tmp22 = 0x7;// ANA_CTLE_REG2.BT.B0 = ####0111 , ctle_cap2_sel_lane[3:0]
    tmp24 = 0xC2;// ANA_SMPLR_REG2.BT.B0 = 11000010 , pu_ctle_even_lane, pu_ctle_odd_lane, pu_smplr_s_e_lane[2:0], pu_smplr_s_o_lane[2:0]
    tmp26 = 0xC;// ANA_CTLE_REG5.BT.B0 = ####1100 , ctle_res1_sel_lane[3:0]
    tmp27 = 0x50;// ANA_RXREG_REG1.BT.B0 = #101#000 , rxspeed_div_lane[2:0], rxreg_speedtrk_data_lane[2:0]
    tmp28 = 0x7;// ANA_DLL_REG.BT.B0 = #####111 , dll_cap_sel_lane[2:0]
    tmp32 = 0x1F;// CAL_CTRL4_LANE.BT.B2 = 00011111 , rx_pll_rate_lane[7:0]
    tmp34 = 0xD;// ANA_CTLE_REG6.BT.B0 = ####1101 , ctle_res2_sel_lane[3:0]
    tmp37 = 0x2;// ANA_CTLE_REG3.BT.B0 = ####0010 , ctle_current1_sel_lane[3:0]
    tmp39 = 0x3;// ANA_CTLE_REG8.BT.B0 = ####0011 , ctle_rl2_sel_lane[3:0]
  }
  else if (gen_rx==50){
    tmp0 = 0x7;// ANA_DLL_REG1.BT.B0 = #####111 , eom_dll_cap_sel_lane[2:0]
    tmp2 = 0xFA;// RX_DETERMINISTIC_LATENCY.BT.B0 = 11111010 , ck2floop_freq_lane[9:0]
    ...
    tmp5 = 0x91;// DTL_REG2.BT.B1 = 10010001 , dtl_clk_mode_lane[1:0], rx_foffset_extra_m_lane[13:0]
    tmp6 = 0x7;// ANA_IMPCAL_REG0.BT.B0 = #####111 , path_disable_edge_lane, intpr_lane[1:0]
    tmp9 = 0x30;// ANA_SMPLR_REG4.BT.B0 = ##11#### , rxspeed_div_2x_lane[1:0], rxtsen_sel_lane, rxterm_extra_lane[1:0], rxtest_lane[8]
    ...
    tmp27 = 0x60;// ANA_RXREG_REG1.BT.B0 = #110#000 , rxspeed_div_lane[2:0], rxreg_speedtrk_data_lane[2:0]
    tmp28 = 0x7;// ANA_DLL_REG.BT.B0 = #####111 , dll_cap_sel_lane[2:0]
    ...
    tmp17 = 0x7;// ANA_CTLE_REG7.BT.B0 = ####0111 , ctle_rl1_sel_lane[3:0]
    ...
    tmp37 = 0x7;// ANA_CTLE_REG3.BT.B0 = ####0111 , ctle_current1_sel_lane[3:0]
    ...
    tmp30 = 0x54;// PM_CTRL_RX_LANE_REG1_LANE.BT.B0 = 01010100 , rx_selmuff_lane[3:0], rx_selmufi_lane[3:0]
    tmp31 = 0x3;// ANA_SMPLR_REG1.BT.B0 = #####011 , reg_selmupf_lane[2:0]
    tmp32 = 0x0;// CAL_CTRL4_LANE.BT.B2 = 00000000 , rx_pll_rate_lane[7:0]
    tmp33 = 0x2;// ANA_RXREG_REG0.BT.B0 = ####0010 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    tmp34 = 0x4;// ANA_CTLE_REG6.BT.B0 = ####0100 , ctle_res2_sel_lane[3:0]
    tmp37 = 0xA;// ANA_CTLE_REG3.BT.B0 = ####1010 , ctle_current1_sel_lane[3:0]
    tmp39 = 0xE;// ANA_CTLE_REG8.BT.B0 = ####1110 , ctle_rl2_sel_lane[3:0]
    ...
    tmp27 = 0x60;// ANA_RXREG_REG1.BT.B0 = #110#000 , rxspeed_div_lane[2:0], rxreg_speedtrk_data_lane[2:0]
    tmp31 = 0x1;// ANA_SMPLR_REG1.BT.B0 = #####001 , reg_selmupf_lane[2:0]
    tmp32 = 0x6;// CAL_CTRL4_LANE.BT.B2 = 00000110 , rx_pll_rate_lane[7:0]
    tmp34 = 0xD;// ANA_CTLE_REG6.BT.B0 = ####1101 , ctle_res2_sel_lane[3:0]
    tmp36 = 0x10;// ANA_SMPLR_REG0.BT.B0 = ##010000 , pu_smplr_d_e_lane[2:0], pu_smplr_d_o_lane[2:0]
    tmp37 = 0x0;// ANA_CTLE_REG3.BT.B0 = ####0000 , ctle_current1_sel_lane[3:0]
    tmp39 = 0x2;// ANA_CTLE_REG8.BT.B0 = ####0010 , ctle_rl2_sel_lane[3:0]
    ...
    tmp27 = 0x6;// ANA_RXREG_REG1.BT.B0 = #000#110 , rxspeed_div_lane[2:0], rxreg_speedtrk_data_lane[2:0]
    tmp28 = 0x1;// ANA_DLL_REG.BT.B0 = #####001 , dll_cap_sel_lane[2:0]
    tmp29 = 0x8;// TX_TRAIN_PATTTERN_REG0.BT.B1 = ####10## , ethernet_mode_lane[1:0]
    tmp30 = 0x54;// PM_CTRL_RX_LANE_REG1_LANE.BT.B0 = 01010100 , rx_selmuff_lane[3:0], rx_selmufi_lane[3:0]
    tmp31 = 0x4;// ANA_SMPLR_REG1.BT.B0 = #####100 , reg_selmupf_lane[2:0]
    tmp32 = 0x12;// CAL_CTRL4_LANE.BT.B2 = 00010010 , rx_pll_rate_lane[7:0]
    tmp33 = 0x6;// ANA_RXREG_REG0.BT.B0 = ####0110 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    tmp35 = 0x4;// RX_SYSTEM_LANE.BT.B0 = #####100 , rx_data_width_lane[1:0], rx_pam2_en_lane
    tmp36 = 0x3F;// ANA_SMPLR_REG0.BT.B0 = ##111111 , pu_smplr_d_e_lane[2:0], pu_smplr_d_o_lane[2:0]
    tmp38 = 0x0;// ANA_RSVD_REG1.BT.B0 = 00000000 , ana_rsvd1_lane[7:0]
  }
    ...
    tmp30 = 0x54;// PM_CTRL_RX_LANE_REG1_LANE.BT.B0 = 01010100 , rx_selmuff_lane[3:0], rx_selmufi_lane[3:0]
    tmp31 = 0x4;// ANA_SMPLR_REG1.BT.B0 = #####100 , reg_selmupf_lane[2:0]
    tmp32 = 0x14;// CAL_CTRL4_LANE.BT.B2 = 00010100 , rx_pll_rate_lane[7:0]
    tmp33 = 0x6;// ANA_RXREG_REG0.BT.B0 = ####0110 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    tmp35 = 0x4;// RX_SYSTEM_LANE.BT.B0 = #####100 , rx_data_width_lane[1:0], rx_pam2_en_lane
    tmp36 = 0x3F;// ANA_SMPLR_REG0.BT.B0 = ##111111 , pu_smplr_d_e_lane[2:0], pu_smplr_d_o_lane[2:0]
    tmp38 = 0x0;// ANA_RSVD_REG1.BT.B0 = 00000000 , ana_rsvd1_lane[7:0]
    ...
    tmp30 = 0x54;// PM_CTRL_RX_LANE_REG1_LANE.BT.B0 = 01010100 , rx_selmuff_lane[3:0], rx_selmufi_lane[3:0]
    tmp31 = 0x4;// ANA_SMPLR_REG1.BT.B0 = #####100 , reg_selmupf_lane[2:0]
    tmp32 = 0x13;// CAL_CTRL4_LANE.BT.B2 = 00010011 , rx_pll_rate_lane[7:0]
    tmp33 = 0x6;// ANA_RXREG_REG0.BT.B0 = ####0110 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    tmp35 = 0x4;// RX_SYSTEM_LANE.BT.B0 = #####100 , rx_data_width_lane[1:0], rx_pam2_en_lane
    tmp36 = 0x3F;// ANA_SMPLR_REG0.BT.B0 = ##111111 , pu_smplr_d_e_lane[2:0], pu_smplr_d_o_lane[2:0]
    tmp38 = 0x0;// ANA_RSVD_REG1.BT.B0 = 00000000 , ana_rsvd1_lane[7:0]
    ...
    tmp24 = 0xFF;// ANA_SMPLR_REG2.BT.B0 = 11111111 , pu_ctle_even_lane, pu_ctle_odd_lane, pu_smplr_s_e_lane[2:0], pu_smplr_s_o_lane[2:0]
    tmp25 = 0x2;// ANA_RSVD_REG9.BT.B0 = ####0010 , ctle_cl2_sel_lane[1:0], ctle_cl1_sel_lane[1:0]
    tmp27 = 0x4;// ANA_RXREG_REG1.BT.B0 = #000#100 , rxspeed_div_lane[2:0], rxreg_speedtrk_data_lane[2:0]
    tmp28 = 0x2;// ANA_DLL_REG.BT.B0 = #####010 , dll_cap_sel_lane[2:0]
    tmp29 = 0x8;// TX_TRAIN_PATTTERN_REG0.BT.B1 = ####10## , ethernet_mode_lane[1:0]
    tmp30 = 0x54;// PM_CTRL_RX_LANE_REG1_LANE.BT.B0 = 01010100 , rx_selmuff_lane[3:0], rx_selmufi_lane[3:0]
    tmp31 = 0x4;// ANA_SMPLR_REG1.BT.B0 = #####100 , reg_selmupf_lane[2:0]
    tmp32 = 0x10;// CAL_CTRL4_LANE.BT.B2 = 00010000 , rx_pll_rate_lane[7:0]
    tmp33 = 0x3;// ANA_RXREG_REG0.BT.B0 = ####0011 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    tmp35 = 0x4;// RX_SYSTEM_LANE.BT.B0 = #####100 , rx_data_width_lane[1:0], rx_pam2_en_lane
    tmp36 = 0x3F;// ANA_SMPLR_REG0.BT.B0 = ##111111 , pu_smplr_d_e_lane[2:0], pu_smplr_d_o_lane[2:0]
    tmp38 = 0x0;// ANA_RSVD_REG1.BT.B0 = 00000000 , ana_rsvd1_lane[7:0]
  }
    ...
    tmp25 = 0x2;// ANA_RSVD_REG9.BT.B0 = ####0010 , ctle_cl2_sel_lane[1:0], ctle_cl1_sel_lane[1:0]
    tmp27 = 0x4;// ANA_RXREG_REG1.BT.B0 = #000#100 , rxspeed_div_lane[2:0], rxreg_speedtrk_data_lane[2:0]
    tmp28 = 0x3;// ANA_DLL_REG.BT.B0 = #####011 , dll_cap_sel_lane[2:0]
    tmp29 = 0x8;// TX_TRAIN_PATTTERN_REG0.BT.B1 = ####10## , ethernet_mode_lane[1:0]
    tmp30 = 0x54;// PM_CTRL_RX_LANE_REG1_LANE.BT.B0 = 01010100 , rx_selmuff_lane[3:0], rx_selmufi_lane[3:0]
    tmp31 = 0x4;// ANA_SMPLR_REG1.BT.B0 = #####100 , reg_selmupf_lane[2:0]
    tmp32 = 0xE;// CAL_CTRL4_LANE.BT.B2 = 00001110 , rx_pll_rate_lane[7:0]
    tmp33 = 0x3;// ANA_RXREG_REG0.BT.B0 = ####0011 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    tmp35 = 0x4;// RX_SYSTEM_LANE.BT.B0 = #####100 , rx_data_width_lane[1:0], rx_pam2_en_lane
    tmp36 = 0x3F;// ANA_SMPLR_REG0.BT.B0 = ##111111 , pu_smplr_d_e_lane[2:0], pu_smplr_d_o_lane[2:0]
    tmp38 = 0x0;// ANA_RSVD_REG1.BT.B0 = 00000000 , ana_rsvd1_lane[7:0]
    ...
    tmp7 = 0x8;// TX_TRAIN_PAT_NUM1.BT.B0 = 00001000 , train_pat_num_lane[9:0]
    tmp8 = 0x2;// TX_TRAIN_PAT_NUM1.BT.B1 = ######10 , train_pat_num_lane[9:0]
    tmp14 = 0x99;// ANA_INTPI_REG0.BT.B0 = 10011001 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp15 = 0xF;// ANA_CTLE_REG1.BT.B0 = ####1111 , ctle_cap1_sel_g_lane[3:0]
    tmp19 = 0x4;// ANA_DTL_REG3.BT.B0 = #####100 , dtl_clk_speedup_lane[2:0]
    tmp20 = 0x8;// TX_TRAIN_PATTERN_REG1.BT.B2 = 00001000 , train_pat_num_rx_lane[9:0]
    tmp21 = 0x2;// TX_TRAIN_PATTERN_REG1.BT.B3 = ######10 , train_pat_num_rx_lane[9:0]
    ...
    tmp30 = 0x54;// PM_CTRL_RX_LANE_REG1_LANE.BT.B0 = 01010100 , rx_selmuff_lane[3:0], rx_selmufi_lane[3:0]
    tmp31 = 0x4;// ANA_SMPLR_REG1.BT.B0 = #####100 , reg_selmupf_lane[2:0]
    tmp32 = 0x8;// CAL_CTRL4_LANE.BT.B2 = 00001000 , rx_pll_rate_lane[7:0]
    tmp33 = 0x2;// ANA_RXREG_REG0.BT.B0 = ####0010 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    tmp35 = 0x4;// RX_SYSTEM_LANE.BT.B0 = #####100 , rx_data_width_lane[1:0], rx_pam2_en_lane
    tmp36 = 0x3F;// ANA_SMPLR_REG0.BT.B0 = ##111111 , pu_smplr_d_e_lane[2:0], pu_smplr_d_o_lane[2:0]
    tmp38 = 0x0;// ANA_RSVD_REG1.BT.B0 = 00000000 , ana_rsvd1_lane[7:0]
    ...
    tmp23 = 0x3;// ANA_SMPLR_REG3.BT.B0 = #####011 , reg_selmupi_lane[2:0]
    tmp25 = 0x2;// ANA_RSVD_REG9.BT.B0 = ####0010 , ctle_cl2_sel_lane[1:0], ctle_cl1_sel_lane[1:0]
    tmp27 = 0x5;// ANA_RXREG_REG1.BT.B0 = #000#101 , rxspeed_div_lane[2:0], rxreg_speedtrk_data_lane[2:0]
    tmp28 = 0x2;// ANA_DLL_REG.BT.B0 = #####010 , dll_cap_sel_lane[2:0]
    tmp30 = 0x54;// PM_CTRL_RX_LANE_REG1_LANE.BT.B0 = 01010100 , rx_selmuff_lane[3:0], rx_selmufi_lane[3:0]
    tmp31 = 0x4;// ANA_SMPLR_REG1.BT.B0 = #####100 , reg_selmupf_lane[2:0]
    tmp32 = 0x11;// CAL_CTRL4_LANE.BT.B2 = 00010001 , rx_pll_rate_lane[7:0]
    tmp33 = 0x5;// ANA_RXREG_REG0.BT.B0 = ####0101 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    tmp38 = 0x0;// ANA_RSVD_REG1.BT.B0 = 00000000 , ana_rsvd1_lane[7:0]
  }
  else if (gen_rx==27){
    tmp0 = 0x2;// ANA_DLL_REG1.BT.B0 = #####010 , eom_dll_cap_sel_lane[2:0]
    ...
    tmp30 = 0x54;// PM_CTRL_RX_LANE_REG1_LANE.BT.B0 = 01010100 , rx_selmuff_lane[3:0], rx_selmufi_lane[3:0]
    tmp31 = 0x4;// ANA_SMPLR_REG1.BT.B0 = #####100 , reg_selmupf_lane[2:0]
    tmp32 = 0x9;// CAL_CTRL4_LANE.BT.B2 = 00001001 , rx_pll_rate_lane[7:0]
    tmp33 = 0x3;// ANA_RXREG_REG0.BT.B0 = ####0011 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    tmp38 = 0x0;// ANA_RSVD_REG1.BT.B0 = 00000000 , ana_rsvd1_lane[7:0]
  }
  else if (gen_rx==24){
    ...
    tmp14 = 0xBC;// ANA_INTPI_REG0.BT.B0 = 10111100 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp16 = 0xE;// ANA_CTLE_REG4.BT.B0 = ####1110 , ctle_current2_sel_lane[3:0]
    tmp17 = 0x9;// ANA_CTLE_REG7.BT.B0 = ####1001 , ctle_rl1_sel_lane[3:0]
    tmp26 = 0x7;// ANA_CTLE_REG5.BT.B0 = ####0111 , ctle_res1_sel_lane[3:0]
    tmp27 = 0x41;// ANA_RXREG_REG1.BT.B0 = #100#001 , rxspeed_div_lane[2:0], rxreg_speedtrk_data_lane[2:0]
    tmp28 = 0x1;// ANA_DLL_REG.BT.B0 = #####001 , dll_cap_sel_lane[2:0]
    tmp32 = 0x13;// CAL_CTRL4_LANE.BT.B2 = 00010011 , rx_pll_rate_lane[7:0]
    tmp33 = 0xE;// ANA_RXREG_REG0.BT.B0 = ####1110 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    tmp34 = 0x4;// ANA_CTLE_REG6.BT.B0 = ####0100 , ctle_res2_sel_lane[3:0]
    tmp37 = 0x9;// ANA_CTLE_REG3.BT.B0 = ####1001 , ctle_current1_sel_lane[3:0]
    tmp39 = 0xE;// ANA_CTLE_REG8.BT.B0 = ####1110 , ctle_rl2_sel_lane[3:0]
  }
  else if (gen_rx==22){
    tmp0 = 0x3;// ANA_DLL_REG1.BT.B0 = #####011 , eom_dll_cap_sel_lane[2:0]
    ...
    tmp9 = 0x10;// ANA_SMPLR_REG4.BT.B0 = ##01#### , rxspeed_div_2x_lane[1:0], rxtsen_sel_lane, rxterm_extra_lane[1:0], rxtest_lane[8]
    tmp14 = 0xBC;// ANA_INTPI_REG0.BT.B0 = 10111100 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp16 = 0xC;// ANA_CTLE_REG4.BT.B0 = ####1100 , ctle_current2_sel_lane[3:0]
    tmp17 = 0x8;// ANA_CTLE_REG7.BT.B0 = ####1000 , ctle_rl1_sel_lane[3:0]
    tmp26 = 0x8;// ANA_CTLE_REG5.BT.B0 = ####1000 , ctle_res1_sel_lane[3:0]
    tmp27 = 0x41;// ANA_RXREG_REG1.BT.B0 = #100#001 , rxspeed_div_lane[2:0], rxreg_speedtrk_data_lane[2:0]
    tmp28 = 0x3;// ANA_DLL_REG.BT.B0 = #####011 , dll_cap_sel_lane[2:0]
    tmp32 = 0xD;// CAL_CTRL4_LANE.BT.B2 = 00001101 , rx_pll_rate_lane[7:0]
    tmp33 = 0xB;// ANA_RXREG_REG0.BT.B0 = ####1011 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    tmp34 = 0x5;// ANA_CTLE_REG6.BT.B0 = ####0101 , ctle_res2_sel_lane[3:0]
    tmp37 = 0x8;// ANA_CTLE_REG3.BT.B0 = ####1000 , ctle_current1_sel_lane[3:0]
    tmp39 = 0xC;// ANA_CTLE_REG8.BT.B0 = ####1100 , ctle_rl2_sel_lane[3:0]
  }
  else if (gen_rx==21){
    tmp0 = 0x3;// ANA_DLL_REG1.BT.B0 = #####011 , eom_dll_cap_sel_lane[2:0]
    ...
    tmp27 = 0x41;// ANA_RXREG_REG1.BT.B0 = #100#001 , rxspeed_div_lane[2:0], rxreg_speedtrk_data_lane[2:0]
    tmp28 = 0x3;// ANA_DLL_REG.BT.B0 = #####011 , dll_cap_sel_lane[2:0]
    tmp32 = 0xC;// CAL_CTRL4_LANE.BT.B2 = 00001100 , rx_pll_rate_lane[7:0]
    tmp33 = 0xB;// ANA_RXREG_REG0.BT.B0 = ####1011 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    tmp34 = 0x5;// ANA_CTLE_REG6.BT.B0 = ####0101 , ctle_res2_sel_lane[3:0]
    tmp37 = 0x8;// ANA_CTLE_REG3.BT.B0 = ####1000 , ctle_current1_sel_lane[3:0]
    tmp39 = 0xC;// ANA_CTLE_REG8.BT.B0 = ####1100 , ctle_rl2_sel_lane[3:0]
    ...
    tmp27 = 0x41;// ANA_RXREG_REG1.BT.B0 = #100#001 , rxspeed_div_lane[2:0], rxreg_speedtrk_data_lane[2:0]
    tmp28 = 0x3;// ANA_DLL_REG.BT.B0 = #####011 , dll_cap_sel_lane[2:0]
    tmp32 = 0xA;// CAL_CTRL4_LANE.BT.B2 = 00001010 , rx_pll_rate_lane[7:0]
    tmp33 = 0xB;// ANA_RXREG_REG0.BT.B0 = ####1011 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    tmp34 = 0x5;// ANA_CTLE_REG6.BT.B0 = ####0101 , ctle_res2_sel_lane[3:0]
    tmp37 = 0x8;// ANA_CTLE_REG3.BT.B0 = ####1000 , ctle_current1_sel_lane[3:0]
    tmp39 = 0xC;// ANA_CTLE_REG8.BT.B0 = ####1100 , ctle_rl2_sel_lane[3:0]
    ...
    tmp22 = 0xA;// ANA_CTLE_REG2.BT.B0 = ####1010 , ctle_cap2_sel_lane[3:0]
    tmp26 = 0x8;// ANA_CTLE_REG5.BT.B0 = ####1000 , ctle_res1_sel_lane[3:0]
    tmp28 = 0x5;// ANA_DLL_REG.BT.B0 = #####101 , dll_cap_sel_lane[2:0]
    tmp32 = 0x7;// CAL_CTRL4_LANE.BT.B2 = 00000111 , rx_pll_rate_lane[7:0]
    tmp34 = 0x7;// ANA_CTLE_REG6.BT.B0 = ####0111 , ctle_res2_sel_lane[3:0]
    tmp37 = 0x7;// ANA_CTLE_REG3.BT.B0 = ####0111 , ctle_current1_sel_lane[3:0]
    tmp39 = 0xA;// ANA_CTLE_REG8.BT.B0 = ####1010 , ctle_rl2_sel_lane[3:0]
  }
    ...
    tmp22 = 0xA;// ANA_CTLE_REG2.BT.B0 = ####1010 , ctle_cap2_sel_lane[3:0]
    tmp26 = 0x8;// ANA_CTLE_REG5.BT.B0 = ####1000 , ctle_res1_sel_lane[3:0]
    tmp32 = 0x5;// CAL_CTRL4_LANE.BT.B2 = 00000101 , rx_pll_rate_lane[7:0]
    tmp34 = 0x7;// ANA_CTLE_REG6.BT.B0 = ####0111 , ctle_res2_sel_lane[3:0]
    tmp37 = 0x7;// ANA_CTLE_REG3.BT.B0 = ####0111 , ctle_current1_sel_lane[3:0]
    tmp39 = 0xA;// ANA_CTLE_REG8.BT.B0 = ####1010 , ctle_rl2_sel_lane[3:0]
  }
    ...
    tmp22 = 0xA;// ANA_CTLE_REG2.BT.B0 = ####1010 , ctle_cap2_sel_lane[3:0]
    tmp26 = 0x8;// ANA_CTLE_REG5.BT.B0 = ####1000 , ctle_res1_sel_lane[3:0]
    tmp32 = 0x3;// CAL_CTRL4_LANE.BT.B2 = 00000011 , rx_pll_rate_lane[7:0]
    tmp34 = 0x7;// ANA_CTLE_REG6.BT.B0 = ####0111 , ctle_res2_sel_lane[3:0]
    tmp37 = 0x7;// ANA_CTLE_REG3.BT.B0 = ####0111 , ctle_current1_sel_lane[3:0]
    tmp39 = 0xA;// ANA_CTLE_REG8.BT.B0 = ####1010 , ctle_rl2_sel_lane[3:0]
  }
    ...
    tmp26 = 0x9;// ANA_CTLE_REG5.BT.B0 = ####1001 , ctle_res1_sel_lane[3:0]
    tmp28 = 0x7;// ANA_DLL_REG.BT.B0 = #####111 , dll_cap_sel_lane[2:0]
    tmp32 = 0x2;// CAL_CTRL4_LANE.BT.B2 = 00000010 , rx_pll_rate_lane[7:0]
    tmp34 = 0xA;// ANA_CTLE_REG6.BT.B0 = ####1010 , ctle_res2_sel_lane[3:0]
    tmp37 = 0x5;// ANA_CTLE_REG3.BT.B0 = ####0101 , ctle_current1_sel_lane[3:0]
    tmp39 = 0x7;// ANA_CTLE_REG8.BT.B0 = ####0111 , ctle_rl2_sel_lane[3:0]
  }
    ...
    tmp9 = 0x20;// ANA_SMPLR_REG4.BT.B0 = ##10#### , rxspeed_div_2x_lane[1:0], rxtsen_sel_lane, rxterm_extra_lane[1:0], rxtest_lane[8]
    tmp14 = 0x99;// ANA_INTPI_REG0.BT.B0 = 10011001 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp16 = 0x5;// ANA_CTLE_REG4.BT.B0 = ####0101 , ctle_current2_sel_lane[3:0]
    ...
    tmp39 = 0x5;// ANA_CTLE_REG8.BT.B0 = ####0101 , ctle_rl2_sel_lane[3:0]
  }
  else if (gen_rx==11){
    tmp0 = 0x3;// ANA_DLL_REG1.BT.B0 = #####011 , eom_dll_cap_sel_lane[2:0]
    ...
    tmp27 = 0x51;// ANA_RXREG_REG1.BT.B0 = #101#001 , rxspeed_div_lane[2:0], rxreg_speedtrk_data_lane[2:0]
    tmp28 = 0x3;// ANA_DLL_REG.BT.B0 = #####011 , dll_cap_sel_lane[2:0]
    tmp32 = 0xB;// CAL_CTRL4_LANE.BT.B2 = 00001011 , rx_pll_rate_lane[7:0]
    tmp33 = 0xB;// ANA_RXREG_REG0.BT.B0 = ####1011 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    tmp34 = 0xC;// ANA_CTLE_REG6.BT.B0 = ####1100 , ctle_res2_sel_lane[3:0]
    tmp37 = 0x3;// ANA_CTLE_REG3.BT.B0 = ####0011 , ctle_current1_sel_lane[3:0]
    tmp39 = 0x5;// ANA_CTLE_REG8.BT.B0 = ####0101 , ctle_rl2_sel_lane[3:0]
    ...
    tmp26 = 0xF;// ANA_CTLE_REG5.BT.B0 = ####1111 , ctle_res1_sel_lane[3:0]
    tmp27 = 0x70;// ANA_RXREG_REG1.BT.B0 = #111#000 , rxspeed_div_lane[2:0], rxreg_speedtrk_data_lane[2:0]
    tmp31 = 0x1;// ANA_SMPLR_REG1.BT.B0 = #####001 , reg_selmupf_lane[2:0]
    tmp34 = 0xE;// ANA_CTLE_REG6.BT.B0 = ####1110 , ctle_res2_sel_lane[3:0]
...
void loadspeedtbl_tx() BANKING_CTRL {
  ...
  uint8_t tmp3 = 0x0; //ANA_TXSPEED_REG0.BT.B0 , txspeed_div_lane[2:0]
  ...
  if (gen_tx==56){
    ...
    tmp3 = 0x2;// ANA_TXSPEED_REG0.BT.B0 = #####010 , txspeed_div_lane[2:0]
