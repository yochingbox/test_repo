...
void proc_cal(void) BANKING_CTRL {
    ...
    #if defined(CONFIG_5NM_56G_X4_4PLL_R1P1) || defined(CONFIG_5NM_56G_X1_2PLL)
	reg_PROCESSMON_CNT_TIMER_15_0 = pin_mcu_freq_temp -1;//should use MCU_CLK for timer source
    #endif
	...
	DRO_EN = 1;
    #ifndef _56G_5NM
	reg_CMN_ANA_RSVDA_7_0 = (reg_CMN_ANA_RSVDA_7_0 & 0x1f)|0x80;
    #else
	/*reg_CMN_ANA_RSVDA_7_0 = (reg_CMN_ANA_RSVDA_7_0 & 0x1f)|0x80;*/
    #endif
