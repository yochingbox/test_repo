...
void drv_tx_train_if_cfg(void) BANKING_CTRL {
	...
	if(reg_TX_TRAIN_PAT_SEL_LANE_1_0 == 0x1 || reg_TX_TRAIN_PAT_SEL_LANE_1_0 == 0x2) {
        ...
        if ((phy_mode == PCIE) && (reg_PIN_PHY_GEN_TX_RD_LANE_5_0 == 0x0 || reg_PIN_PHY_GEN_TX_RD_LANE_5_0 == 0x1))
                reg_PCIE_GEN12_SEL_LANE = 0x1;
        else
                reg_PCIE_GEN12_SEL_LANE = 0x0; 
...
// SAS dword
         else if((reg_ETHERNET_MODE_TX_LANE_1_0 == 0x0) & (reg_TX_TRAIN_PAT_SEL_LANE_2_0 == 0x0)) {              
                reg_TRAIN_TX_SEL_BITS_LANE = 0x0;
                reg_TX_TRAIN_PAT_NUM_LANE_9_0_b0 = 0x42;
                reg_TX_TRAIN_PAT_NUM_LANE_9_0_b1 = 0x0;
                reg_TX_TRAIN_PAT_TWO_ZERO_LANE = 0x0;
                reg_TX_TRAIN_PAT_MODE_LANE = 0x1;               
                reg_TX_TRAIN_PAT_TOGGLE_LANE = 0x0;
       }
//SAS pkt
         else if((reg_ETHERNET_MODE_TX_LANE_1_0 == 0x0) & (reg_TX_TRAIN_PAT_SEL_LANE_2_0 == 0x4)) {
                reg_TRAIN_TX_SEL_BITS_LANE = 0x0;
                reg_TX_TRAIN_PAT_NUM_LANE_9_0_b0 = 0xE9;
                reg_TX_TRAIN_PAT_NUM_LANE_9_0_b1 = 0x0;
                reg_TX_TRAIN_PAT_TWO_ZERO_LANE = 0x0;
                reg_TX_TRAIN_PAT_MODE_LANE = 0x1;
                reg_TX_TRAIN_PAT_TOGGLE_LANE = 0x0;
...
//Set TX_FIR L4 bypass value in TX_FIR_RESERVED[0] according to TXSPEED_DIV value
		...
		reg_TXFIR_RESERVED_LANE_3_0 = 0x1;
	}
	else {	
		reg_TXFIR_RESERVED_LANE_3_0 = 0x0;
	}
