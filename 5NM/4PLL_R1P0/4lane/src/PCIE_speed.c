...
void loadspeedtbl_rx() BANKING_CTRL {
  ...
  uint8_t tmp15 = 0xF; //ANA_CTLE_REG1.BT.B0 , ctle_cap1_sel_g_lane[3:0]
  ...
  uint8_t tmp19 = 0x4; //ANA_DTL_REG3.BT.B0 , dtl_clk_speedup_lane[2:0]
  ...
  uint8_t tmp23 = 0x3; //ANA_SMPLR_REG3.BT.B0 , reg_selmupi_lane[2:0]
  ...
  uint8_t tmp27 = 0x7; //ANA_RXREG_REG1.BT.B0 , rxspeed_div_lane[2:0], rxreg_speedtrk_data_lane[2:0]
  ...
  uint8_t tmp30 = 0x54; //PM_CTRL_RX_LANE_REG1_LANE.BT.B0 , rx_selmuff_lane[3:0], rx_selmufi_lane[3:0]
  uint8_t tmp31 = 0x4; //ANA_SMPLR_REG1.BT.B0 , reg_selmupf_lane[2:0]
  uint8_t tmp32 = 0x17; //CAL_CTRL4_LANE.BT.B2 , rx_pll_rate_lane[7:0]
  ...
  if (gen_rx==9){
    ...
    tmp32 = 0x1B;// CAL_CTRL4_LANE.BT.B2 = 00011011 , rx_pll_rate_lane[7:0]
    ...
    tmp32 = 0x19;// CAL_CTRL4_LANE.BT.B2 = 00011001 , rx_pll_rate_lane[7:0]
    ...
    tmp32 = 0x18;// CAL_CTRL4_LANE.BT.B2 = 00011000 , rx_pll_rate_lane[7:0]
    tmp33 = 0x2;// ANA_RXREG_REG0.BT.B0 = ####0010 , rxreg_speedtrk_clk_half_lane, rxreg_speedtrk_clk_lane[2:0]
    ...
    tmp14 = 0x42;// ANA_INTPI_REG0.BT.B0 = 01000010 , rxintpi_low_lane[3:0], rxintpi_lane[3:0]
    tmp15 = 0x4;// ANA_CTLE_REG1.BT.B0 = ####0100 , ctle_cap1_sel_g_lane[3:0]
    tmp16 = 0x7;// ANA_CTLE_REG4.BT.B0 = ####0111 , ctle_current2_sel_lane[3:0]
    tmp17 = 0x5;// ANA_CTLE_REG7.BT.B0 = ####0101 , ctle_rl1_sel_lane[3:0]
    tmp19 = 0x0;// ANA_DTL_REG3.BT.B0 = #####000 , dtl_clk_speedup_lane[2:0]
    tmp22 = 0x7;// ANA_CTLE_REG2.BT.B0 = ####0111 , ctle_cap2_sel_lane[3:0]
    tmp23 = 0x1;// ANA_SMPLR_REG3.BT.B0 = #####001 , reg_selmupi_lane[2:0]
    tmp26 = 0x9;// ANA_CTLE_REG5.BT.B0 = ####1001 , ctle_res1_sel_lane[3:0]
    tmp27 = 0x40;// ANA_RXREG_REG1.BT.B0 = #100#000 , rxspeed_div_lane[2:0], rxreg_speedtrk_data_lane[2:0]
    tmp28 = 0x7;// ANA_DLL_REG.BT.B0 = #####111 , dll_cap_sel_lane[2:0]
    tmp30 = 0x43;// PM_CTRL_RX_LANE_REG1_LANE.BT.B0 = 01000011 , rx_selmuff_lane[3:0], rx_selmufi_lane[3:0]
    tmp31 = 0x2;// ANA_SMPLR_REG1.BT.B0 = #####010 , reg_selmupf_lane[2:0]
    tmp32 = 0x18;// CAL_CTRL4_LANE.BT.B2 = 00011000 , rx_pll_rate_lane[7:0]
