...
#define reg_ANA_TX_RPLL_ANA_RSVD_OUT_LANE_15_0  DTX_RING_LANE_REG5.WT.W0
...
typedef union {
	struct {
		...
		uint8_t TXCLK_SYNC_EN_RPLL_IN_LANE               : 1;	/*      5     r/w   0*/
		uint8_t TXCLK_SYNC_EN_RPLL_IN_FM_REG_LANE        : 1;	/*      6     r/w   0*/
		...
		uint8_t RESERVED_10                              : 1;	/*     10     r/w   0*/
		uint8_t REFCLK_DIS_LANE                          : 1;	/*     11     r/w   0*/
		uint8_t REFCLK_DIS_LANE_FM_REG_LANE              : 1;	/*     12     r/w   0*/
...
#define reg_TXCLK_SYNC_EN_RPLL_IN_LANE  TX_RING_CTRL2.BF.TXCLK_SYNC_EN_RPLL_IN_LANE
#define reg_TXCLK_SYNC_EN_RPLL_IN_FM_REG_LANE  TX_RING_CTRL2.BF.TXCLK_SYNC_EN_RPLL_IN_FM_REG_LANE
...
#define reg_REFCLK_DIS_LANE  TX_RING_CTRL2.BF.REFCLK_DIS_LANE
#define reg_REFCLK_DIS_LANE_FM_REG_LANE  TX_RING_CTRL2.BF.REFCLK_DIS_LANE_FM_REG_LANE
...
#define reg_RPLL_FBC_CNT_TIMER_LANE_15_0  TX_RING_CTRL2.WT.W0
