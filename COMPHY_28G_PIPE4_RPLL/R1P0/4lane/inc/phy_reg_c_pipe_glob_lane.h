...
typedef union {
	struct {
		...
		uint8_t MODE_FIXED_PCLK_LANE                     : 1;	/*     18     r/w   0*/
...
__xdata __at( 0x4200 ) volatile GLOB_RST_CLK_CTRL_t GLOB_RST_CLK_CTRL;
...
#define reg_MODE_FIXED_PCLK_LANE  GLOB_RST_CLK_CTRL.BF.MODE_FIXED_PCLK_LANE
...
typedef union {
	struct {
		...
		uint8_t CFG_CLK_SRC_MASK_LANE                    : 1;	/*     30     r/w   0*/
		uint8_t CFG_USE_ASYNC_CLKREQN_LANE               : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} GLOB_CLK_SRC_LO_t;
__xdata __at( 0x4204 ) volatile GLOB_CLK_SRC_LO_t GLOB_CLK_SRC_LO;
...
typedef union {
	struct {
		...
		uint8_t CLKREQ_BUNDLE_CTRL_LANE                  : 1;	/*     13     r/w   0*/
		...
		uint8_t BIST_START_LANE                          : 1;	/*     25     r/w   0*/
		uint8_t COUNTER_SAMPLE_LANE                      : 1;	/*     26     r/w   0*/
		uint8_t COUNTER_SAMPLE_CLEAR_LANE                : 1;	/*     27     r/w   0*/
...
__xdata __at( 0x4208 ) volatile GLOB_CLK_SRC_HI_t GLOB_CLK_SRC_HI;
...
#define reg_CLKREQ_BUNDLE_CTRL_LANE  GLOB_CLK_SRC_HI.BF.CLKREQ_BUNDLE_CTRL_LANE
...
#define reg_BIST_START_LANE  GLOB_CLK_SRC_HI.BF.BIST_START_LANE
#define reg_COUNTER_SAMPLE_LANE  GLOB_CLK_SRC_HI.BF.COUNTER_SAMPLE_LANE
#define reg_COUNTER_SAMPLE_CLEAR_LANE  GLOB_CLK_SRC_HI.BF.COUNTER_SAMPLE_CLEAR_LANE
...
typedef union {
	struct {
		...
		uint8_t MODE_PCLK_CTRL_LANE                      : 1;	/*      2     r/w   0*/
...
__xdata __at( 0x420c ) volatile GLOB_MISC_CTRL_t GLOB_MISC_CTRL;
...
typedef union {
	struct {
		...
		uint8_t CFG_TXELECIDLE_ASSERT_LANE               : 1;	/*     12     r/w   0*/
...
__xdata __at( 0x4210 ) volatile GLOB_DP_SAL_CFG_t GLOB_DP_SAL_CFG;
...
__xdata __at( 0x4214 ) volatile GLOB_DP_SAL_CFG1_t GLOB_DP_SAL_CFG1;
...
__xdata __at( 0x4218 ) volatile GLOB_DP_SAL_CFG3_t GLOB_DP_SAL_CFG3;
...
typedef union {
	struct {
		...
		uint8_t CFG_PCIE4_V7_SUPPORT_LANE                : 1;	/*     16     r/w   1*/
		uint8_t CFG_PIPE_MSG_BUS_PROTOCOL_SEL_LANE       : 1;	/*     17     r/w   0*/
...
__xdata __at( 0x421c ) volatile GLOB_DP_SAL_CFG5_t GLOB_DP_SAL_CFG5;
#define reg_CFG_SAL_COM_LANE_9_0_b0  GLOB_DP_SAL_CFG5.BF.CFG_SAL_COM_LANE_9_0_b0
#define reg_CFG_SAL_COM_LANE_9_0_b1  GLOB_DP_SAL_CFG5.BF.CFG_SAL_COM_LANE_9_0_b1
#define reg_G3_ALIGN_COUNT_MAX_LANE_5_0  GLOB_DP_SAL_CFG5.BF.G3_ALIGN_COUNT_MAX_LANE_5_0
#define reg_CFG_PCIE4_V7_SUPPORT_LANE  GLOB_DP_SAL_CFG5.BF.CFG_PCIE4_V7_SUPPORT_LANE
#define reg_CFG_PIPE_MSG_BUS_PROTOCOL_SEL_LANE  GLOB_DP_SAL_CFG5.BF.CFG_PIPE_MSG_BUS_PROTOCOL_SEL_LANE
#define reg_CFG_P2_STAY_TIMER_EN_LANE  GLOB_DP_SAL_CFG5.BF.CFG_P2_STAY_TIMER_EN_LANE
#define reg_CFG_LANE_ENABLE_CTRL_LANE  GLOB_DP_SAL_CFG5.BF.CFG_LANE_ENABLE_CTRL_LANE
...
__xdata __at( 0x4220 ) volatile GLOB_PM_CFG0_t GLOB_PM_CFG0;
...
typedef union {
	struct {
		uint8_t COUNTER_LANE_SEL_LANE_4_0                : 5;	/*  [4:0]     r/w 5'h0*/
		uint8_t SPARE_REG_1D2_5_LANE                     : 1;	/*      5     r/w   0*/
		uint8_t SPARE_REG_1D2_6_LANE                     : 1;	/*      6     r/w   0*/
		uint8_t SPARE_REG_1D2_7_LANE                     : 1;	/*      7     r/w   0*/
...
__xdata __at( 0x4224 ) volatile GLOB_COUNTER_CTRL_t GLOB_COUNTER_CTRL;
#define reg_COUNTER_LANE_SEL_LANE_4_0  GLOB_COUNTER_CTRL.BF.COUNTER_LANE_SEL_LANE_4_0
#define reg_SPARE_REG_1D2_5_LANE  GLOB_COUNTER_CTRL.BF.SPARE_REG_1D2_5_LANE
#define reg_SPARE_REG_1D2_6_LANE  GLOB_COUNTER_CTRL.BF.SPARE_REG_1D2_6_LANE
#define reg_SPARE_REG_1D2_7_LANE  GLOB_COUNTER_CTRL.BF.SPARE_REG_1D2_7_LANE
...
#define reg_COUNTER_SAMPLED_LANE_15_0  GLOB_COUNTER_CTRL.WT.W0
...
typedef union {
	struct {
		...
		uint8_t PMO_RESET_LANE                           : 1;	/*     16     r/w   1*/
		uint8_t PMO_PU_PLL_LANE                          : 1;	/*     17     r/w   0*/
		uint8_t PMO_PU_TX_LANE                           : 1;	/*     18     r/w   0*/
		uint8_t PMO_PU_RX_LANE                           : 1;	/*     19     r/w   0*/
		uint8_t PMO_TX_RATE_SEL_LANE_1_0                 : 2;	/*[21:20]     r/w   0*/
		uint8_t PMO_RX_RATE_SEL_LANE_1_0                 : 2;	/*[23:22]     r/w   0*/
		uint8_t PMO_RX_INIT_LANE                         : 1;	/*     24     r/w   0*/
		uint8_t PMO_TX_IDLE_LOZ_LANE                     : 1;	/*     25     r/w   0*/
		uint8_t PMO_TX_IDLE_HIZ_LANE                     : 1;	/*     26     r/w   0*/
		uint8_t PMO_TXDETECTRX_EN_LANE                   : 1;	/*     27     r/w   0*/
		uint8_t PMO_PU_IVREF_LANE                        : 1;	/*     28     r/w   0*/
		uint8_t PMO_TX_VCMHOLD_EN_LANE                   : 1;	/*     29     r/w   0*/
		uint8_t PMO_BEACON_TX_EN_LANE                    : 1;	/*     30     r/w   0*/
		uint8_t PMO_CTRL_FROM_PIN_LANE                   : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
} GLOB_COUNTER_HI_t;
__xdata __at( 0x4228 ) volatile GLOB_COUNTER_HI_t GLOB_COUNTER_HI;
...
#define reg_PMO_RESET_LANE  GLOB_COUNTER_HI.BF.PMO_RESET_LANE
...
#define reg_PMO_TX_RATE_SEL_LANE_1_0  GLOB_COUNTER_HI.BF.PMO_TX_RATE_SEL_LANE_1_0
#define reg_PMO_RX_RATE_SEL_LANE_1_0  GLOB_COUNTER_HI.BF.PMO_RX_RATE_SEL_LANE_1_0
...
#define reg_PMO_CTRL_FROM_PIN_LANE  GLOB_COUNTER_HI.BF.PMO_CTRL_FROM_PIN_LANE
...
typedef union {
	struct {
		...
		uint8_t PMO_PIPE_8B_LANE                         : 1;	/*      6     r/w   0*/
		uint8_t PMO_PIPE_32B_LANE                        : 1;	/*      7     r/w   0*/
...
__xdata __at( 0x422c ) volatile GLOB_PM_DP_CTRL_t GLOB_PM_DP_CTRL;
...
#define reg_PMO_PIPE_8B_LANE  GLOB_PM_DP_CTRL.BF.PMO_PIPE_8B_LANE
#define reg_PMO_PIPE_32B_LANE  GLOB_PM_DP_CTRL.BF.PMO_PIPE_32B_LANE
...
__xdata __at( 0x4230 ) volatile GLOB_DP_BAL_CFG0_t GLOB_DP_BAL_CFG0;
...
__xdata __at( 0x4234 ) volatile GLOB_DP_BAL_CFG2_t GLOB_DP_BAL_CFG2;
...
__xdata __at( 0x4238 ) volatile GLOB_DP_BAL_CFG4_t GLOB_DP_BAL_CFG4;
...
typedef union {
	struct {
		...
		uint8_t BIST_RATE_LANE_1_0                       : 2;	/*  [3:2]     r/w 2'h0*/
		uint8_t BIST_TXDETECTRX_LOOPBACK_LANE            : 1;	/*      4     r/w   0*/
		uint8_t BIST_TXELECIDLE_LANE                     : 1;	/*      5     r/w   1*/
		uint8_t BIST_TXCOMPLIANCE_LANE                   : 1;	/*      6     r/w   0*/
		uint8_t BIST_RXPOLARITY_LANE                     : 1;	/*      7     r/w   0*/
		uint8_t BIST_RXEIDETECT_DIS_LANE                 : 1;	/*      8     r/w   0*/
		uint8_t BIST_TXCMN_MODE_DIS_LANE                 : 1;	/*      9     r/w   0*/
		uint8_t BIST_CLK_REQ_N_LANE                      : 1;	/*     10     r/w   0*/
		uint8_t BIST_RXEQTRAINING_LANE                   : 1;	/*     11     r/w   0*/
...
__xdata __at( 0x423c ) volatile GLOB_BIST_CTRL_t GLOB_BIST_CTRL;
#define reg_BIST_POWERDOWN_LANE_1_0  GLOB_BIST_CTRL.BF.BIST_POWERDOWN_LANE_1_0
#define reg_BIST_RATE_LANE_1_0  GLOB_BIST_CTRL.BF.BIST_RATE_LANE_1_0
...
typedef union {
	struct {
		...
		uint8_t RESERVED_22                              : 1;	/*     22     r/w   0*/
		uint8_t RESERVED_23                              : 1;	/*     23     r/w   0*/
		uint8_t BIST_LANE_SEL_LANE_4_0                   : 5;	/*[28:24]     r/w 5'h0*/
		uint8_t RESERVED_29                              : 1;	/*     29     r/w   0*/
...
__xdata __at( 0x4240 ) volatile GLOB_BIST_LANE_TYPE_t GLOB_BIST_LANE_TYPE;
...
#define reg_BIST_LANE_SEL_LANE_4_0  GLOB_BIST_LANE_TYPE.BF.BIST_LANE_SEL_LANE_4_0
...
__xdata __at( 0x4244 ) volatile GLOB_BIST_START_t GLOB_BIST_START;
...
__xdata __at( 0x4248 ) volatile GLOB_BIST_MASK_t GLOB_BIST_MASK;
...
__xdata __at( 0x424c ) volatile GLOB_BIST_RESULT_t GLOB_BIST_RESULT;
...
typedef union {
	struct {
		...
		uint8_t BIST_LFSR_SEED_LANE_7_0                  : 8;	/*[23:16]     r/w   0*/
...
__xdata __at( 0x4250 ) volatile GLOB_BIST_SEQR_CFG_t GLOB_BIST_SEQR_CFG;
...
#define reg_BIST_LFSR_SEED_LANE_7_0  GLOB_BIST_SEQR_CFG.BF.BIST_LFSR_SEED_LANE_7_0
...
__xdata __at( 0x4254 ) volatile GLOB_BIST_DATA_HI_t GLOB_BIST_DATA_HI;
...
#define reg_DEBUG_BUS_OUT_LANE_15_0_b0  GLOB_BIST_DATA_HI.BF.DEBUG_BUS_OUT_LANE_15_0_b0
#define reg_DEBUG_BUS_OUT_LANE_15_0_b1  GLOB_BIST_DATA_HI.BF.DEBUG_BUS_OUT_LANE_15_0_b1
#define reg_BIST_TXDATA_LANE_31_16  GLOB_BIST_DATA_HI.WT.W0
#define reg_DEBUG_BUS_OUT_LANE_15_0  GLOB_BIST_DATA_HI.WT.W1
...
__xdata __at( 0x4258 ) volatile GLOB_PIPE_REVISION_t GLOB_PIPE_REVISION;
