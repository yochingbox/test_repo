...
typedef union {
	struct {
		...
		uint8_t EN_LANE2                                 : 1;	/*      2     r/w   0*/
		uint8_t EN_LANE3                                 : 1;	/*      3     r/w   0*/
...
#define reg_ROM_ERR_ADDR_15_0  MCU_SDT_CMN.WT.W0
...
#define reg_PRAM_ECC_ERR_ADDR_15_0  CMN_MCU_REG.WT.W0
