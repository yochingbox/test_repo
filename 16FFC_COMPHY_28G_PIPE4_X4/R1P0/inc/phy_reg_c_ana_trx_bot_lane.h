...
typedef union {
	struct {
		...
		uint8_t RESERVED_1                               : 1;	/*      1     r/w   0*/
		uint8_t RESERVED_2                               : 1;	/*      2     r/w   0*/
		uint8_t DLL_GMSEL_LANE_2_0                       : 3;	/*  [5:3]     r/w 3'h4*/
...
#define reg_DLL_GMSEL_LANE_2_0  UPHY14_TRX_ANAREG_BOT_7.BF.DLL_GMSEL_LANE_2_0
...
typedef union {
	struct {
		...
		uint8_t DLL_PD_SEL_LANE_1_0                      : 2;	/*  [3:2]     r/w 2'h0*/
		uint8_t DLL_CMP_OFFSET_LANE_3_0                  : 4;	/*  [7:4]     r/w 4'h8*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_DLL_PD_SEL_LANE_1_0  UPHY14_TRX_ANAREG_BOT_8.BF.DLL_PD_SEL_LANE_1_0
#define reg_DLL_CMP_OFFSET_LANE_3_0  UPHY14_TRX_ANAREG_BOT_8.BF.DLL_CMP_OFFSET_LANE_3_0
...
typedef union {
	struct {
		...
		uint8_t EOM_DLL_GMSEL_LANE_2_0                   : 3;	/*  [7:5]     r/w 3'h4*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_EOM_DLL_GMSEL_LANE_2_0  UPHY14_TRX_ANAREG_BOT_9.BF.EOM_DLL_GMSEL_LANE_2_0
...
typedef union {
	struct {
		uint8_t RESERVED_0                               : 1;	/*      0     r/w   0*/
		uint8_t ALIGN90_GM_LANE_2_0                      : 3;	/*  [3:1]     r/w 3'h3*/
		uint8_t ALIGN90_CMP_OFFSET_LANE_3_0              : 4;	/*  [7:4]     r/w 4'h8*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} UPHY14_TRX_ANAREG_BOT_12_t;
__xdata __at( 0x30 ) volatile UPHY14_TRX_ANAREG_BOT_12_t UPHY14_TRX_ANAREG_BOT_12;
#define reg_ALIGN90_GM_LANE_2_0  UPHY14_TRX_ANAREG_BOT_12.BF.ALIGN90_GM_LANE_2_0
#define reg_ALIGN90_CMP_OFFSET_LANE_3_0  UPHY14_TRX_ANAREG_BOT_12.BF.ALIGN90_CMP_OFFSET_LANE_3_0

// 0xd	UPHY14_TRX_ANAREG_BOT_13		Analog Register 13
typedef union {
	struct {
		uint8_t ALIGN90_SYN_CLK_LANE                     : 1;	/*      0     r/w   0*/
		uint8_t ALIGN90_DUMMY_CLK_LANE                   : 1;	/*      1     r/w   1*/
		uint8_t ALIGN90_DAC_LANE_5_0                     : 6;	/*  [7:2]     r/w 6'h31*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} UPHY14_TRX_ANAREG_BOT_13_t;
__xdata __at( 0x34 ) volatile UPHY14_TRX_ANAREG_BOT_13_t UPHY14_TRX_ANAREG_BOT_13;
#define reg_ALIGN90_SYN_CLK_LANE  UPHY14_TRX_ANAREG_BOT_13.BF.ALIGN90_SYN_CLK_LANE
#define reg_ALIGN90_DUMMY_CLK_LANE  UPHY14_TRX_ANAREG_BOT_13.BF.ALIGN90_DUMMY_CLK_LANE
#define reg_ALIGN90_DAC_LANE_5_0  UPHY14_TRX_ANAREG_BOT_13.BF.ALIGN90_DAC_LANE_5_0
...
typedef union {
	struct {
		...
		uint8_t RXDCC_EOMCLK_LANE_5_0                    : 6;	/*  [7:2]     r/w 6'h20*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_RXDCC_EOMCLK_LANE_5_0  UPHY14_TRX_ANAREG_BOT_16.BF.RXDCC_EOMCLK_LANE_5_0
...
typedef union {
	struct {
		...
		uint8_t TRXDCCIN_SEL_LANE_2_0                    : 3;	/*  [7:5]     r/w 3'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_TRXDCCIN_SEL_LANE_2_0  UPHY14_TRX_ANAREG_BOT_17.BF.TRXDCCIN_SEL_LANE_2_0
