...
// [dfeReg]
#define tag_DFE_F0_SAT_THRES 61 //63
...
#define tag_DFE_F0_SAT_PROTECT_THRES 61
#define tag_DFE_FX_SUM_SAT_THRES 0
#define tag_OFST_SAT_THRES	62
#define tag_F1_ADJUST_THRESH_1 4 //0,2,4,…,14
#define tag_F1_ADJUST_THRESH_2 2 //0,2,4,…,30
...
#define tag_DFE_RES_F0A_LOW_THRES_01_INIT  20 
#define tag_DFE_RES_F0A_LOW_THRES_2_INIT   20 
#define tag_DFE_RES_F0A_LOW_THRES_3_INIT   20 
#define tag_DFE_RES_F0A_HIGH_THRES_INIT    40
...
#define tag_CDR_MAXF0P_EN 	(lnx_SKIP_CDR_MAXF0P_LANE==0)  //1
#define tag_CDR_MIDPOINT_EN   (lnx_SKIP_CDR_MIDPOINT_LANE==0)//1
#define tag_CDR_MIDPOINT_STEP_NUM	lnx_CDR_STEP_NUM_LANE_7_0 //5
...
#define tag_TX_GN1_STEP_NUM 16 //8 //6
#define tag_TX_G1_STEP_NUM 8 //6
...
#define tag_TX_GN1_MIDPOINT_THRES_K 15 //16
#define tag_TX_GN1_MIDPOINT_THRES_C -3 //-4 //-5
...
#define tag_TX_G1_MIDPOINT_THRES_K 15 //16
#define tag_TX_G1_MIDPOINT_THRES_C -4
...
#define tag_PHASE_MOVE_WITH_DFE_EN	1
#define tag_DFE_ADAPT_F0A_EN 0
...
#define tag_CLOCK_ALIGN_RUN3_NUM	128 //32 //64 //32//512 //32,64,128,256,512,1024,2048,4096
#define tag_CLOCK_ALIGN_PHASE_STEP_SIZE2		1//0 //1 //4 // 1/2^4
...
#define tag_f1_align_skip_en 0

#define tag_AVERAGE_EO_MODE	1
...
//-----------
//final
#define tag_dfe_adapt_lp_num_dtl		  1//16 //lnx_DFE_ADAPT_LP_NUM_DTL_LANE_7_0		//16
#define tag_dfe_adapt_lp_num_f0a          1//16 //lnx_DFE_ADAPT_LP_NUM_F0A_LANE_7_0      //16
#define tag_dfe_adapt_lp_num_corase       4//16 //lnx_DFE_ADAPT_LP_NUM_CORASE_LANE_7_0   //16
#define tag_dfe_adapt_lp_num_fine         2//16 //lnx_DFE_ADAPT_LP_NUM_FINE_LANE_7_0     //16
#define tag_dfe_adapt_lp_num_accu         2//16 //lnx_DFE_ADAPT_LP_NUM_ACCU_LANE_7_0     //16
#define tag_dfe_adapt_lp_num_ofst         1//16 //lnx_DFE_ADAPT_LP_NUM_OFST_LANE_7_0     //16
#define tag_dfe_adapt_lp_num_f0b          1//16 //lnx_DFE_ADAPT_LP_NUM_F0B_LANE_7_0      //16
#define tag_dfe_adapt_lp_num_f0d	      4//16 //lnx_DFE_ADAPT_LP_NUM_F0D_LANE_7_0	    //16
#define tag_pol_tb_lp_num_dtl             1 //1 //lnx_POL_TB_LP_NUM_DTL_LANE_7_0         //1
#define tag_pol_tb_lp_num_f0a             1 //8 //lnx_POL_TB_LP_NUM_F0A_LANE_7_0         //8
#define tag_pol_tb_lp_num_corase          1 //1 //lnx_POL_TB_LP_NUM_CORASE_LANE_7_0      //1
#define tag_pol_tb_lp_num_fine            1 //1 //lnx_POL_TB_LP_NUM_FINE_LANE_7_0        //1
#define tag_pol_tb_lp_num_accu            1 //1 //lnx_POL_TB_LP_NUM_ACCU_LANE_7_0        //1
#define tag_pol_tb_lp_num_ofst            1 //2 //lnx_POL_TB_LP_NUM_OFST_LANE_7_0        //2
#define tag_pol_tb_lp_num_f0b             1 //1 //lnx_POL_TB_LP_NUM_F0B_LANE_7_0         //1
#define tag_pol_tb_lp_num_f0d             2 //2 //lnx_POL_TB_LP_NUM_F0D_LANE_7_0         //2

*/
#define tag_dfe_test_on					1
#define tag_dfe_adapt_lp_num_dtl		  lnx_DFE_ADAPT_LP_NUM_DTL_LANE_7_0		//16
#define tag_dfe_adapt_lp_num_f0a          lnx_DFE_ADAPT_LP_NUM_F0A_LANE_7_0      //16
#define tag_dfe_adapt_lp_num_corase       lnx_DFE_ADAPT_LP_NUM_CORASE_LANE_7_0   //16
#define tag_dfe_adapt_lp_num_fine         lnx_DFE_ADAPT_LP_NUM_FINE_LANE_7_0     //16
#define tag_dfe_adapt_lp_num_accu         lnx_DFE_ADAPT_LP_NUM_ACCU_LANE_7_0     //16
#define tag_dfe_adapt_lp_num_ofst         lnx_DFE_ADAPT_LP_NUM_OFST_LANE_7_0     //16
#define tag_dfe_adapt_lp_num_f0b_fine     lnx_DFE_ADAPT_LP_NUM_F0B_FINE_LANE_7_0      //16
#define tag_dfe_adapt_lp_num_f0b_accu     lnx_DFE_ADAPT_LP_NUM_F0B_ACCU_LANE_7_0      //16
#define tag_dfe_adapt_lp_num_f0d_fine     lnx_DFE_ADAPT_LP_NUM_F0D_FINE_LANE_7_0	    //16
#define tag_dfe_adapt_lp_num_f0d_coarse   lnx_DFE_ADAPT_LP_NUM_F0D_COARSE_LANE_7_0	    //16
#define tag_pol_tb_lp_num_dtl             lnx_POL_TB_LP_NUM_DTL_LANE_7_0         //1
#define tag_pol_tb_lp_num_f0a             lnx_POL_TB_LP_NUM_F0A_LANE_7_0         //8
#define tag_pol_tb_lp_num_corase          lnx_POL_TB_LP_NUM_CORASE_LANE_7_0      //1
#define tag_pol_tb_lp_num_fine            lnx_POL_TB_LP_NUM_FINE_LANE_7_0        //1
#define tag_pol_tb_lp_num_accu            lnx_POL_TB_LP_NUM_ACCU_LANE_7_0        //1
#define tag_pol_tb_lp_num_ofst            lnx_POL_TB_LP_NUM_OFST_LANE_7_0        //2
#define tag_pol_tb_lp_num_f0b_fine        lnx_POL_TB_LP_NUM_F0B_FINE_LANE_7_0         //1
#define tag_pol_tb_lp_num_f0b_accu        lnx_POL_TB_LP_NUM_F0B_ACCU_LANE_7_0         //1
#define tag_pol_tb_lp_num_f0d_fine        lnx_POL_TB_LP_NUM_F0D_FINE_LANE_7_0         //2
#define tag_pol_tb_lp_num_f0d_coarse      lnx_POL_TB_LP_NUM_F0D_COARSE_LANE_7_0         //2
