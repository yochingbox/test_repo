...
typedef union {
	struct {
		...
		uint8_t REF_CLK_RING_SEL                         : 1;	/*      8     r/w   0*/
		...
		uint8_t BYPASS_MCU_STOP                          : 1;	/*     25     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t VDD_CAL_DONE_LANE3_RD                    : 1;	/*      2       r   0*/
		uint8_t VDD_CAL_DONE_LANE2_RD                    : 1;	/*      3       r   0*/
		uint8_t VDD_CAL_DONE_LANE1_RD                    : 1;	/*      4       r   0*/
		uint8_t VDD_CAL_DONE_LANE0_RD                    : 1;	/*      5       r   0*/
		uint8_t RXIMP_CAL_DONE_LANE3_RD                  : 1;	/*      6       r   0*/
		uint8_t RXIMP_CAL_DONE_LANE2_RD                  : 1;	/*      7       r   0*/
		uint8_t RXIMP_CAL_DONE_LANE1_RD                  : 1;	/*      8       r   0*/
		uint8_t RXIMP_CAL_DONE_LANE0_RD                  : 1;	/*      9       r   0*/
		uint8_t TXIMP_CAL_DONE_LANE3_RD                  : 1;	/*     10       r   0*/
		uint8_t TXIMP_CAL_DONE_LANE2_RD                  : 1;	/*     11       r   0*/
		uint8_t TXIMP_CAL_DONE_LANE1_RD                  : 1;	/*     12       r   0*/
		uint8_t TXIMP_CAL_DONE_LANE0_RD                  : 1;	/*     13       r   0*/
...
#define cmx_VDD_CAL_DONE_LANE3_RD  CONTROL_CONFIG1.BF.VDD_CAL_DONE_LANE3_RD
#define cmx_VDD_CAL_DONE_LANE2_RD  CONTROL_CONFIG1.BF.VDD_CAL_DONE_LANE2_RD
#define cmx_VDD_CAL_DONE_LANE1_RD  CONTROL_CONFIG1.BF.VDD_CAL_DONE_LANE1_RD
#define cmx_VDD_CAL_DONE_LANE0_RD  CONTROL_CONFIG1.BF.VDD_CAL_DONE_LANE0_RD
#define cmx_RXIMP_CAL_DONE_LANE3_RD  CONTROL_CONFIG1.BF.RXIMP_CAL_DONE_LANE3_RD
#define cmx_RXIMP_CAL_DONE_LANE2_RD  CONTROL_CONFIG1.BF.RXIMP_CAL_DONE_LANE2_RD
#define cmx_RXIMP_CAL_DONE_LANE1_RD  CONTROL_CONFIG1.BF.RXIMP_CAL_DONE_LANE1_RD
#define cmx_RXIMP_CAL_DONE_LANE0_RD  CONTROL_CONFIG1.BF.RXIMP_CAL_DONE_LANE0_RD
#define cmx_TXIMP_CAL_DONE_LANE3_RD  CONTROL_CONFIG1.BF.TXIMP_CAL_DONE_LANE3_RD
#define cmx_TXIMP_CAL_DONE_LANE2_RD  CONTROL_CONFIG1.BF.TXIMP_CAL_DONE_LANE2_RD
#define cmx_TXIMP_CAL_DONE_LANE1_RD  CONTROL_CONFIG1.BF.TXIMP_CAL_DONE_LANE1_RD
#define cmx_TXIMP_CAL_DONE_LANE0_RD  CONTROL_CONFIG1.BF.TXIMP_CAL_DONE_LANE0_RD
...
typedef union {
	struct {
		...
		uint8_t RESERVED_6                               : 1;	/*      6     r/w   0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
		uint8_t TXDETECT_CAL_DONE_LANE3_RD               : 1;	/*      8     r/w   0*/
		uint8_t TXDETECT_CAL_DONE_LANE2_RD               : 1;	/*      9     r/w   0*/
		uint8_t TXDETECT_CAL_DONE_LANE1_RD               : 1;	/*     10     r/w   0*/
		uint8_t TXDETECT_CAL_DONE_LANE0_RD               : 1;	/*     11     r/w   0*/
		uint8_t RESERVED_12                              : 1;	/*     12     r/w   0*/
		uint8_t RESERVED_13                              : 1;	/*     13     r/w   0*/
		uint8_t RESERVED_14                              : 1;	/*     14     r/w   0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
...
#define cmx_TXDETECT_CAL_DONE_LANE3_RD  CONTROL_CONFIG6.BF.TXDETECT_CAL_DONE_LANE3_RD
#define cmx_TXDETECT_CAL_DONE_LANE2_RD  CONTROL_CONFIG6.BF.TXDETECT_CAL_DONE_LANE2_RD
#define cmx_TXDETECT_CAL_DONE_LANE1_RD  CONTROL_CONFIG6.BF.TXDETECT_CAL_DONE_LANE1_RD
#define cmx_TXDETECT_CAL_DONE_LANE0_RD  CONTROL_CONFIG6.BF.TXDETECT_CAL_DONE_LANE0_RD
...
// 0x0448	CAL_TIME_OUT_AND_DIS		Calibration Configuration 
typedef union {
	struct {
...
__xdata __at( 0xe448 ) volatile CAL_TIME_OUT_AND_DIS_t CAL_TIME_OUT_AND_DIS;
...
// 0x044c	CAL_STATUS_READ		Calibration Status
typedef union {
	struct {
...
__xdata __at( 0xe44c ) volatile CAL_STATUS_READ_t CAL_STATUS_READ;
...
// 0x0450	MCU_CONFIG		MCU Configuration 
typedef union {
	struct {
...
__xdata __at( 0xe450 ) volatile MCU_CONFIG_t MCU_CONFIG;
#define cmx_MASTER_MCU_SEL_7_0  MCU_CONFIG.BF.MASTER_MCU_SEL_7_0

// 0x0454	MCU_CONTROL		
typedef union {
	struct {
		uint8_t PHY_FM_RST                               : 1;	/*      0     r/w   0*/
...
__xdata __at( 0xe454 ) volatile MCU_CONTROL_t MCU_CONTROL;
#define cmx_PHY_FM_RST  MCU_CONTROL.BF.PHY_FM_RST
...
__xdata __at( 0xe458 ) volatile MCU_CONFIG1_t MCU_CONFIG1;
