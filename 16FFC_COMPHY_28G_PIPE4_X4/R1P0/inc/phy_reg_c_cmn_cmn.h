...
typedef union {
	struct {
		...
		uint8_t BUS_CLK_RESET_EN                         : 1;	/*      1     r/w   0*/
...
#define reg_BUS_CLK_RESET_EN  SYSTEM.BF.BUS_CLK_RESET_EN
...
typedef union {
	struct {
		...
		uint8_t ISOLATION_ENB                            : 1;	/*     30     r/w   1*/
		uint8_t ISOLATION_ENB_FORCE                      : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
...
#define reg_ISOLATION_ENB  INPUT_CMN_PIN_REG0.BF.ISOLATION_ENB
#define reg_ISOLATION_ENB_FORCE  INPUT_CMN_PIN_REG0.BF.ISOLATION_ENB_FORCE
...
typedef union {
	struct {
		...
		uint8_t RESERVED_6                               : 2;	/* [10:6]     r/w   0*/
		uint8_t RESERVED_8                               : 3;	/* [10:6]     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t ANA_DIG_REF_CLK_FM_REG                   : 1;	/*      5     r/w   0*/
		uint8_t ANA_DIG_REF_CLK                          : 1;	/*      6     r/w   0*/
...
#define reg_ANA_DIG_REF_CLK_FM_REG  INPUT_CMN_PIN_REG2.BF.ANA_DIG_REF_CLK_FM_REG
#define reg_ANA_DIG_REF_CLK  INPUT_CMN_PIN_REG2.BF.ANA_DIG_REF_CLK
...
typedef union {
	struct {
		...
		uint8_t RESERVED_10                              : 6;	/*[26:10]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/*[26:10]     r/w   0*/
		uint8_t RESERVED_24                              : 3;	/*[26:10]     r/w   0*/
