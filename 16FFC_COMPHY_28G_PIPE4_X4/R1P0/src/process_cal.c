...
#define ISOLATION_ENB_FORCE		reg_ISOLATION_ENB_FORCE
...
void proc_cal(void){
	...
	PROCESS_VALUE = (proc_sum_ulvt + 2)/5;
	

	cmx_CAL_PROCESS_VALUE_ULVT_7_0 = (proc_sum_ulvt + 2)/5;
	cmx_CAL_PROCESS_VALUE_LVT_7_0 = (proc_sum_lvt + 2)/5;	//this is for VDD calibration later
