...
__xdata __at( 0xc008 ) volatile GLOB_CLK_SRC_LO_t GLOB_CLK_SRC_LO;
...
typedef union {
	struct {
		...
		uint8_t SPARE_REG_1C4_13                         : 1;	/*     13     r/w   0*/
...
__xdata __at( 0xc010 ) volatile GLOB_CLK_SRC_HI_t GLOB_CLK_SRC_HI;
...
#define reg_SPARE_REG_1C4_13  GLOB_CLK_SRC_HI.BF.SPARE_REG_1C4_13
...
__xdata __at( 0xc018 ) volatile GLOB_MISC_CTRL_t GLOB_MISC_CTRL;
...
__xdata __at( 0xc020 ) volatile GLOB_DP_SAL_CFG_t GLOB_DP_SAL_CFG;
...
__xdata __at( 0xc028 ) volatile GLOB_DP_SAL_CFG1_t GLOB_DP_SAL_CFG1;
...
typedef union {
	struct {
		...
		uint8_t CFG_SAL_39_35                            : 5;	/* [12:8]     r/w 5'h10*/
		uint8_t RESERVED_13                              : 1;	/*     13     r/w   0*/
		uint8_t RESERVED_14                              : 1;	/*     14     r/w   0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
...
__xdata __at( 0xc030 ) volatile GLOB_DP_SAL_CFG3_t GLOB_DP_SAL_CFG3;
...
__xdata __at( 0xc038 ) volatile GLOB_DP_SAL_CFG5_t GLOB_DP_SAL_CFG5;
...
__xdata __at( 0xc040 ) volatile GLOB_PM_CFG0_t GLOB_PM_CFG0;
...
__xdata __at( 0xc048 ) volatile GLOB_COUNTER_CTRL_t GLOB_COUNTER_CTRL;
...
__xdata __at( 0xc050 ) volatile GLOB_COUNTER_HI_t GLOB_COUNTER_HI;
...
__xdata __at( 0xc058 ) volatile GLOB_PM_DP_CTRL_t GLOB_PM_DP_CTRL;
...
__xdata __at( 0xc060 ) volatile GLOB_DP_BAL_CFG0_t GLOB_DP_BAL_CFG0;
...
typedef union {
	struct {
		...
		uint8_t CFG_BAL_WEIGHT_47_42                     : 6;	/*[29:24]     r/w 6'h10*/
		uint8_t RESERVED_30                              : 1;	/*     30     r/w   0*/
		uint8_t RESERVED_31                              : 1;	/*     31     r/w   0*/
	} BF;
	uint16_t VAL;
} GLOB_DP_BAL_CFG2_t;
__xdata __at( 0xc068 ) volatile GLOB_DP_BAL_CFG2_t GLOB_DP_BAL_CFG2;
...
typedef union {
	struct {
		uint8_t CFG_BAL_WEIGHT_50_48                     : 3;	/*  [2:0]     r/w 3'h2*/
...
__xdata __at( 0xc070 ) volatile GLOB_DP_BAL_CFG4_t GLOB_DP_BAL_CFG4;
...
__xdata __at( 0xc078 ) volatile GLOB_BIST_CTRL_t GLOB_BIST_CTRL;
...
__xdata __at( 0xc080 ) volatile GLOB_BIST_LANE_TYPE_t GLOB_BIST_LANE_TYPE;
...
// 0x0044	GLOB_BIST_START		BIST Loggin Window Start Cycle
typedef union {
	struct {
...
__xdata __at( 0xc088 ) volatile GLOB_BIST_START_t GLOB_BIST_START;
...
__xdata __at( 0xc090 ) volatile GLOB_BIST_MASK_t GLOB_BIST_MASK;
...
__xdata __at( 0xc098 ) volatile GLOB_BIST_RESULT_t GLOB_BIST_RESULT;
...
__xdata __at( 0xc0a0 ) volatile GLOB_BIST_SEQR_CFG_t GLOB_BIST_SEQR_CFG;
...
__xdata __at( 0xc0a8 ) volatile GLOB_BIST_DATA_HI_t GLOB_BIST_DATA_HI;
...
typedef union {
	struct {
		uint8_t PIPE_REVISION_7_0                        : 8;	/*  [7:0]       r 8'h10*/
...
__xdata __at( 0xc0b0 ) volatile GLOB_PIPE_REVISION_t GLOB_PIPE_REVISION;
