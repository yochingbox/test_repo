...
typedef union {
	struct {
		...
		uint8_t TX_TRAIN_PAT_FORCE_LANE                  : 1;	/*      7     r/w   0*/
		uint8_t TX_TRAIN_PAT_SEL_LANE_1_0                : 2;	/*  [9:8]     r/w   0*/
		uint8_t PT_START_RD_LANE                         : 1;	/*     10     r/w   0*/
		uint8_t PT_CNT_RST_LANE                          : 1;	/*     11     r/w   0*/
		uint8_t PT_LOCK_CNT_LANE_3_0                     : 4;	/*[15:12]     r/w 4'h7*/
		uint8_t PT_RX_PATTERN_SEL_LANE_5_0               : 6;	/*[21:16]     r/w 6'h09*/
		uint8_t PT_TX_PATTERN_SEL_LANE_5_0_b0            : 2;	/*[27:22]     r/w 6'h09*/
		uint8_t PT_TX_PATTERN_SEL_LANE_5_0_b1            : 4;	/*[27:22]     r/w 6'h09*/
...
#define reg_PT_START_RD_LANE  PT_CONTROL0.BF.PT_START_RD_LANE
#define reg_PT_CNT_RST_LANE  PT_CONTROL0.BF.PT_CNT_RST_LANE
#define reg_PT_LOCK_CNT_LANE_3_0  PT_CONTROL0.BF.PT_LOCK_CNT_LANE_3_0
...
// 0x0004	PT_CONTROL1		Detail Control Register
typedef union {
	struct {
		uint8_t PT_OOB_BURST_LEN_LANE_7_0                : 8;	/*  [7:0]     r/w 8'h10*/
		uint8_t PT_OOB_IDLE_LEN_LANE_7_0                 : 8;	/* [15:8]     r/w 8'h30*/
		uint8_t PT_OOB_PAT_SEL_LANE_1_0                  : 2;	/*[17:16]     r/w 2'h0*/
		uint8_t PT_OOB_SPEED_LANE_1_0                    : 2;	/*[19:18]     r/w 2'h0*/
		uint8_t PT_OOB_EN_LANE                           : 1;	/*     20     r/w   0*/
		uint8_t RESERVED_21                              : 1;	/*     21     r/w   0*/
		uint8_t PT_SATA_LONG_LANE                        : 1;	/*     22     r/w   0*/
		uint8_t PT_PRBS_ENC_EN_LANE                      : 1;	/*     23     r/w   0*/
		uint8_t PT_PRBS_INV_LANE                         : 1;	/*     24     r/w   0*/
		uint8_t PT_PRBS_LOCK_MODE_LANE                   : 1;	/*     25     r/w   0*/
		uint8_t PT_PRBS_LOAD_LANE                        : 1;	/*     26     r/w   0*/
		uint8_t PT_PRBS_SEED_SEL_LANE_2_0                : 3;	/*[29:27]     r/w 3'h0*/
...
#define reg_PT_OOB_BURST_LEN_LANE_7_0  PT_CONTROL1.BF.PT_OOB_BURST_LEN_LANE_7_0
#define reg_PT_OOB_IDLE_LEN_LANE_7_0  PT_CONTROL1.BF.PT_OOB_IDLE_LEN_LANE_7_0
#define reg_PT_OOB_PAT_SEL_LANE_1_0  PT_CONTROL1.BF.PT_OOB_PAT_SEL_LANE_1_0
#define reg_PT_OOB_SPEED_LANE_1_0  PT_CONTROL1.BF.PT_OOB_SPEED_LANE_1_0
#define reg_PT_OOB_EN_LANE  PT_CONTROL1.BF.PT_OOB_EN_LANE
#define reg_PT_SATA_LONG_LANE  PT_CONTROL1.BF.PT_SATA_LONG_LANE
#define reg_PT_PRBS_ENC_EN_LANE  PT_CONTROL1.BF.PT_PRBS_ENC_EN_LANE
#define reg_PT_PRBS_INV_LANE  PT_CONTROL1.BF.PT_PRBS_INV_LANE
#define reg_PT_PRBS_LOCK_MODE_LANE  PT_CONTROL1.BF.PT_PRBS_LOCK_MODE_LANE
#define reg_PT_PRBS_LOAD_LANE  PT_CONTROL1.BF.PT_PRBS_LOAD_LANE
#define reg_PT_PRBS_SEED_SEL_LANE_2_0  PT_CONTROL1.BF.PT_PRBS_SEED_SEL_LANE_2_0
...
typedef union {
	struct {
		...
		uint8_t PT_USER_K_CHAR_LANE_7_0                  : 8;	/* [15:8]     r/w 8'h0*/
...
#define reg_PT_USER_K_CHAR_LANE_7_0  PT_USER_PATTERN2.BF.PT_USER_K_CHAR_LANE_7_0
