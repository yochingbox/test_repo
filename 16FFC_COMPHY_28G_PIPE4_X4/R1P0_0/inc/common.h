...
enum STAGE_SET {
	...
	EYE_WIDTH_MEASURE_STATE, //d
	EYEWIDTH_MEASURE_INIT_STATE, //e
	EYEWIDTH_LEFT_MEASURE_STATE, //f
	EYEWIDTH_RIGHT_MEASURE_STATE, //10
	PHASE_FINE_ADAPT_PER_EYEWIDTH_STATE,//11
	PHASE_ACCU_ADAPT_PER_EYEWIDTH_STATE,//12
	EYE_HEIGHT_MEASURE_STATE, //13
	EYE_HEIGHT_RESULT_STATE, //14
	EYE_DIAGRAM_CAPTURE_STATE, //15
	EYE_DIAGRAM_RESULT_STATE, //16
	OFST_ADAPT_STATE, //17
	DEFAULT_STATE //18
};
