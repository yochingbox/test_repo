...
typedef union {
	struct {
		uint8_t LINE_TAG_LANE_6_0                        : 7;	/*  [6:0]     r/w 7'h0*/
		uint8_t LINE_TAG_SEL_LANE_4_0_b0                 : 1;	/* [11:7]     r/w 5'h0*/
		uint8_t LINE_TAG_SEL_LANE_4_0_b1                 : 4;	/* [11:7]     r/w 5'h0*/
		uint8_t MEM_LINE_SEL0_LANE_4_0_b0                : 4;	/*[16:12]     r/w 5'h0*/
		uint8_t MEM_LINE_SEL0_LANE_4_0_b1                : 1;	/*[16:12]     r/w 5'h0*/
		uint8_t MEM_LINE_SEL1_LANE_4_0                   : 5;	/*[21:17]     r/w 5'h0*/
...
#define reg_LINE_TAG_LANE_6_0  CACHE_DEBUG0.BF.LINE_TAG_LANE_6_0
#define reg_LINE_TAG_SEL_LANE_4_0_b0  CACHE_DEBUG0.BF.LINE_TAG_SEL_LANE_4_0_b0
#define reg_LINE_TAG_SEL_LANE_4_0_b1  CACHE_DEBUG0.BF.LINE_TAG_SEL_LANE_4_0_b1
...
typedef union {
	struct {
		uint8_t MCU_COMMAND_ALL_LANE_31_0_b0             : 8;	/* [31:0]       r 32'h0*/
		uint8_t MCU_COMMAND_ALL_LANE_31_0_b1             : 8;	/* [31:0]       r 32'h0*/
		uint8_t MCU_COMMAND_ALL_LANE_31_0_b2             : 8;	/* [31:0]       r 32'h0*/
		uint8_t MCU_COMMAND_ALL_LANE_31_0_b3             : 8;	/* [31:0]       r 32'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} MCU_INFO2_LANE_t;
__xdata __at( 0x2218 ) volatile MCU_INFO2_LANE_t MCU_INFO2_LANE;
#define reg_MCU_COMMAND_ALL_LANE_31_0_b0  MCU_INFO2_LANE.BF.MCU_COMMAND_ALL_LANE_31_0_b0
#define reg_MCU_COMMAND_ALL_LANE_31_0_b1  MCU_INFO2_LANE.BF.MCU_COMMAND_ALL_LANE_31_0_b1
#define reg_MCU_COMMAND_ALL_LANE_31_0_b2  MCU_INFO2_LANE.BF.MCU_COMMAND_ALL_LANE_31_0_b2
#define reg_MCU_COMMAND_ALL_LANE_31_0_b3  MCU_INFO2_LANE.BF.MCU_COMMAND_ALL_LANE_31_0_b3

// 0x001c	MCU_STATUS0_LANE		Lane MCU Status Register 0
typedef union {
	struct {
...
__xdata __at( 0x221c ) volatile MCU_STATUS0_LANE_t MCU_STATUS0_LANE;
...
// 0x0020	MCU_STATUS1_LANE		Lane MCU Status Register 1
typedef union {
	struct {
...
__xdata __at( 0x2220 ) volatile MCU_STATUS1_LANE_t MCU_STATUS1_LANE;
...
// 0x0024	MCU_INT0_CONTROL		MCU INT Control Register 0
typedef union {
	struct {
...
__xdata __at( 0x2224 ) volatile MCU_INT0_CONTROL_t MCU_INT0_CONTROL;
...
// 0x0028	MCU_INT1_CONTROL		MCU INT Control Register 1
typedef union {
	struct {
...
__xdata __at( 0x2228 ) volatile MCU_INT1_CONTROL_t MCU_INT1_CONTROL;
...
// 0x002c	MCU_INT2_CONTROL		MCU INT Control Register 2
typedef union {
	struct {
...
__xdata __at( 0x222c ) volatile MCU_INT2_CONTROL_t MCU_INT2_CONTROL;
...
// 0x0030	MCU_INT3_CONTROL		MCU INT Control Register 3
typedef union {
	struct {
...
__xdata __at( 0x2230 ) volatile MCU_INT3_CONTROL_t MCU_INT3_CONTROL;
...
// 0x0034	MCU_INT4_CONTROL		MCU INT Control Register 4
typedef union {
	struct {
...
__xdata __at( 0x2234 ) volatile MCU_INT4_CONTROL_t MCU_INT4_CONTROL;
...
// 0x0038	MCU_INT5_CONTROL		MCU INT Control Register 5
typedef union {
	struct {
...
__xdata __at( 0x2238 ) volatile MCU_INT5_CONTROL_t MCU_INT5_CONTROL;
...
// 0x003c	MCU_INT6_CONTROL		MCU INT Control Register 6
typedef union {
	struct {
...
__xdata __at( 0x223c ) volatile MCU_INT6_CONTROL_t MCU_INT6_CONTROL;
...
// 0x0040	MCU_INT7_CONTROL		MCU INT Control Register 7
typedef union {
	struct {
...
__xdata __at( 0x2240 ) volatile MCU_INT7_CONTROL_t MCU_INT7_CONTROL;
...
// 0x0044	MCU_INT8_CONTROL		MCU INT Control Register 8
typedef union {
	struct {
...
__xdata __at( 0x2244 ) volatile MCU_INT8_CONTROL_t MCU_INT8_CONTROL;
...
// 0x0048	MCU_INT9_CONTROL		MCU INT Control Register 9
typedef union {
	struct {
...
__xdata __at( 0x2248 ) volatile MCU_INT9_CONTROL_t MCU_INT9_CONTROL;
...
// 0x004c	MCU_INT10_CONTROL		MCU INT Control Register 10
typedef union {
	struct {
...
__xdata __at( 0x224c ) volatile MCU_INT10_CONTROL_t MCU_INT10_CONTROL;
...
// 0x0050	MCU_INT11_CONTROL		MCU INT Control Register 11
typedef union {
	struct {
...
__xdata __at( 0x2250 ) volatile MCU_INT11_CONTROL_t MCU_INT11_CONTROL;
...
// 0x0054	MCU_INT12_CONTROL		MCU INT Control Register 12
typedef union {
	struct {
...
__xdata __at( 0x2254 ) volatile MCU_INT12_CONTROL_t MCU_INT12_CONTROL;
...
// 0x0058	MCU_TIMER_CONTROL		MCU Ext Timer Control Register 0
typedef union {
	struct {
...
__xdata __at( 0x2258 ) volatile MCU_TIMER_CONTROL_t MCU_TIMER_CONTROL;
...
// 0x005c	MCU_TIMER0_CONTROL		MCU Ext Timer Control Register 1
typedef union {
	struct {
...
__xdata __at( 0x225c ) volatile MCU_TIMER0_CONTROL_t MCU_TIMER0_CONTROL;
...
// 0x0060	MCU_TIMER1_CONTROL		MCU Ext Timer Control Register 2
typedef union {
	struct {
...
__xdata __at( 0x2260 ) volatile MCU_TIMER1_CONTROL_t MCU_TIMER1_CONTROL;
...
// 0x0064	MCU_TIMER2_CONTROL		MCU Ext Timer Control Register 3
typedef union {
	struct {
...
__xdata __at( 0x2264 ) volatile MCU_TIMER2_CONTROL_t MCU_TIMER2_CONTROL;
...
// 0x0068	MCU_TIMER3_CONTROL		MCU Ext Timer Control Register 4
typedef union {
	struct {
...
__xdata __at( 0x2268 ) volatile MCU_TIMER3_CONTROL_t MCU_TIMER3_CONTROL;
...
// 0x006c	MCU_IRQ_LANE		MCU Ext Timer Control Register 5
typedef union {
	struct {
...
__xdata __at( 0x226c ) volatile MCU_IRQ_LANE_t MCU_IRQ_LANE;
...
// 0x0070	MCU_IRQ_MASK_LANE		MCU Ext Timer Control Register 6
typedef union {
	struct {
...
__xdata __at( 0x2270 ) volatile MCU_IRQ_MASK_LANE_t MCU_IRQ_MASK_LANE;
...
// 0x0074	MCU_MEM_REG1_LANE		Lane Memory Control Register 0
typedef union {
	struct {
		uint8_t XRAM_WTC_LANE_2_0                        : 3;	/*  [2:0]     r/w 3'h1*/
		uint8_t XRAM_RTC_LANE_2_0                        : 3;	/*  [5:3]     r/w 3'h1*/
		uint8_t XRAM_PDFVSSM_LANE                        : 1;	/*      6     r/w   0*/
		uint8_t XRAM_PDLVMC_LANE                         : 1;	/*      7     r/w   0*/
		uint8_t XRAM_PDWN_LANE                           : 1;	/*      8     r/w   0*/
		uint8_t RESERVED_9                               : 7;	/* [15:9]     r/w   0*/
		uint8_t IRAM_WTC_LANE_2_0                        : 3;	/*[18:16]     r/w 3'h1*/
		uint8_t IRAM_RTC_LANE_2_0                        : 3;	/*[21:19]     r/w 3'h1*/
		uint8_t IRAM_PDFVSSM_LANE                        : 1;	/*     22     r/w   0*/
		uint8_t IRAM_PDLVMC_LANE                         : 1;	/*     23     r/w   0*/
		uint8_t IRAM_PDWN_LANE                           : 1;	/*     24     r/w   0*/
		uint8_t RESERVED_25                              : 7;	/*[31:25]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} MCU_MEM_REG1_LANE_t;
__xdata __at( 0x2274 ) volatile MCU_MEM_REG1_LANE_t MCU_MEM_REG1_LANE;
#define reg_XRAM_WTC_LANE_2_0  MCU_MEM_REG1_LANE.BF.XRAM_WTC_LANE_2_0
#define reg_XRAM_RTC_LANE_2_0  MCU_MEM_REG1_LANE.BF.XRAM_RTC_LANE_2_0
#define reg_XRAM_PDFVSSM_LANE  MCU_MEM_REG1_LANE.BF.XRAM_PDFVSSM_LANE
#define reg_XRAM_PDLVMC_LANE  MCU_MEM_REG1_LANE.BF.XRAM_PDLVMC_LANE
#define reg_XRAM_PDWN_LANE  MCU_MEM_REG1_LANE.BF.XRAM_PDWN_LANE
#define reg_IRAM_WTC_LANE_2_0  MCU_MEM_REG1_LANE.BF.IRAM_WTC_LANE_2_0
#define reg_IRAM_RTC_LANE_2_0  MCU_MEM_REG1_LANE.BF.IRAM_RTC_LANE_2_0
#define reg_IRAM_PDFVSSM_LANE  MCU_MEM_REG1_LANE.BF.IRAM_PDFVSSM_LANE
#define reg_IRAM_PDLVMC_LANE  MCU_MEM_REG1_LANE.BF.IRAM_PDLVMC_LANE
#define reg_IRAM_PDWN_LANE  MCU_MEM_REG1_LANE.BF.IRAM_PDWN_LANE

// 0x0078	MCU_MEM_REG2_LANE		Lane Memory Control Register 1
typedef union {
	struct {
		uint8_t CACHE_WTC_LANE_2_0                       : 3;	/*  [2:0]     r/w 3'h1*/
		uint8_t CACHE_RTC_LANE_2_0                       : 3;	/*  [5:3]     r/w 3'h1*/
		uint8_t CACHE_PDFVSSM_LANE                       : 1;	/*      6     r/w   0*/
		uint8_t CACHE_PDLVMC_LANE                        : 1;	/*      7     r/w   0*/
		uint8_t CACHE_PDWN_LANE                          : 1;	/*      8     r/w   0*/
...
__xdata __at( 0x2278 ) volatile MCU_MEM_REG2_LANE_t MCU_MEM_REG2_LANE;
#define reg_CACHE_WTC_LANE_2_0  MCU_MEM_REG2_LANE.BF.CACHE_WTC_LANE_2_0
#define reg_CACHE_RTC_LANE_2_0  MCU_MEM_REG2_LANE.BF.CACHE_RTC_LANE_2_0
#define reg_CACHE_PDFVSSM_LANE  MCU_MEM_REG2_LANE.BF.CACHE_PDFVSSM_LANE
#define reg_CACHE_PDLVMC_LANE  MCU_MEM_REG2_LANE.BF.CACHE_PDLVMC_LANE
#define reg_CACHE_PDWN_LANE  MCU_MEM_REG2_LANE.BF.CACHE_PDWN_LANE

// 0x007c	MCU_TIMER_CTRL_1_LANE		MCU Ext Timer Control Register 7
typedef union {
	struct {
...
__xdata __at( 0x227c ) volatile MCU_TIMER_CTRL_1_LANE_t MCU_TIMER_CTRL_1_LANE;
...
// 0x0080	MCU_TIMER_CTRL_2_LANE		MCU Ext Timer Control Register 8
typedef union {
	struct {
...
__xdata __at( 0x2280 ) volatile MCU_TIMER_CTRL_2_LANE_t MCU_TIMER_CTRL_2_LANE;
...
// 0x0084	MCU_TIMER_CTRL_3_LANE		MCU Ext Timer Control Register 9
typedef union {
	struct {
...
__xdata __at( 0x2284 ) volatile MCU_TIMER_CTRL_3_LANE_t MCU_TIMER_CTRL_3_LANE;
...
// 0x0088	MCU_TIMER_CTRL_4_LANE		MCU Ext Timer Control Register 10
typedef union {
	struct {
...
__xdata __at( 0x2288 ) volatile MCU_TIMER_CTRL_4_LANE_t MCU_TIMER_CTRL_4_LANE;
...
// 0x008c	MCU_TIMER_CTRL_5_LANE		MCU Ext Timer Control Register 11
typedef union {
	struct {
...
__xdata __at( 0x228c ) volatile MCU_TIMER_CTRL_5_LANE_t MCU_TIMER_CTRL_5_LANE;
...
// 0x0090	MCU_TIMER_CTRL_6_LANE		MCU Ext Timer Control Register 12
typedef union {
	struct {
...
__xdata __at( 0x2290 ) volatile MCU_TIMER_CTRL_6_LANE_t MCU_TIMER_CTRL_6_LANE;
...
// 0x0094	MCU_TIMER_CTRL_7_LANE		MCU Ext Timer Control Register 13
typedef union {
	struct {
...
__xdata __at( 0x2294 ) volatile MCU_TIMER_CTRL_7_LANE_t MCU_TIMER_CTRL_7_LANE;
...
// 0x0098	MCU_DEBUG0_LANE		Lane MCU Debug Register 0
typedef union {
	struct {
...
__xdata __at( 0x2298 ) volatile MCU_DEBUG0_LANE_t MCU_DEBUG0_LANE;
...
// 0x009c	MCU_DEBUG1_LANE		Lane MCU Debug Register 1
typedef union {
	struct {
...
__xdata __at( 0x229c ) volatile MCU_DEBUG1_LANE_t MCU_DEBUG1_LANE;
...
// 0x00a0	MCU_DEBUG2_LANE		Lane MCU Debug Register 2
typedef union {
	struct {
...
__xdata __at( 0x22a0 ) volatile MCU_DEBUG2_LANE_t MCU_DEBUG2_LANE;
...
// 0x00a4	MCU_DEBUG3_LANE		Lane MCU Debug Register 3
typedef union {
	struct {
...
__xdata __at( 0x22a4 ) volatile MCU_DEBUG3_LANE_t MCU_DEBUG3_LANE;
...
// 0x00a8	MCU_DEBUG_LANE		Lane MCU Debug Register 4
typedef union {
	struct {
...
__xdata __at( 0x22a8 ) volatile MCU_DEBUG_LANE_t MCU_DEBUG_LANE;
...
// 0x00ac	EXT_INT_CONTROL		Ext INT Control
typedef union {
	struct {
...
__xdata __at( 0x22ac ) volatile EXT_INT_CONTROL_t EXT_INT_CONTROL;
...
// 0x00b0	ANA_IF_TRX_REG0		Analog Interface Register 0
typedef union {
	struct {
...
__xdata __at( 0x22b0 ) volatile ANA_IF_TRX_REG0_t ANA_IF_TRX_REG0;
...
// 0x00b4	ANA_IF_DFEE_REG0		Analog Interface Register 0
typedef union {
	struct {
		uint8_t RESERVED_0                               : 4;	/*  [3:0]     r/w   0*/
...
__xdata __at( 0x22b4 ) volatile ANA_IF_DFEE_REG0_t ANA_IF_DFEE_REG0;
...
// 0x00b8	ANA_IF_DFEO_REG0		Analog Interface Register 0
typedef union {
	struct {
		uint8_t RESERVED_0                               : 4;	/*  [3:0]     r/w   0*/
...
__xdata __at( 0x22b8 ) volatile ANA_IF_DFEO_REG0_t ANA_IF_DFEO_REG0;
