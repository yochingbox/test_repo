...
typedef union {
	struct {
		...
		uint8_t RESERVED_6                               : 2;	/* [25:6]     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [25:6]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/* [25:6]     r/w   0*/
		uint8_t RESERVED_24                              : 2;	/* [25:6]     r/w   0*/
		uint8_t REMOTE_STATUS_G1_LANE_1_0                : 2;	/*[27:26]       r   0*/
		uint8_t REMOTE_STATUS_G0_LANE_1_0                : 2;	/*[29:28]       r   0*/
		uint8_t REMOTE_STATUS_GN1_LANE_1_0               : 2;	/*[31:30]       r   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
typedef union {
	struct {
		...
		uint8_t ANA_TX_EM_PO_EN_LANE                     : 1;	/*     22     r/w   0*/
		uint8_t ANA_TX_EM_PRE_EN_LANE                    : 1;	/*     23     r/w   0*/
		uint8_t ANA_TX_EM_PEAK_EN_LANE                   : 1;	/*     24     r/w   0*/
		uint8_t PIN_RX_PRESET_HINT_RD_LANE_2_0           : 3;	/*[27:25]       r   0*/
...
#define reg_PIN_RX_PRESET_HINT_RD_LANE_2_0  LINK_TRAIN_MODE0.BF.PIN_RX_PRESET_HINT_RD_LANE_2_0
