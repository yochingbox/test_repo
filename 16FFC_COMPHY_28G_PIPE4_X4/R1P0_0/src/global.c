...
BIT pll_rate, use_ring_pll, ring_pll_enabled; 
BIT cont_cal_on;
...
__xdata uint8_t *SIGN_POS, *NEG, *RESULT; //sampler cal
...
// -------------- Add new xdata from here because we need to protect xdata address for bitmatch :
...
__xdata uint8_t ring_mid_point; //ring_pll
__xdata uint8_t ring_max_point; //ring_pll
