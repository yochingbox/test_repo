...
void trainif_init(void)
{
	...
	//else if( /*(tx_init_bit == 1) &&*/ (phy_mode == SERDES)) { //Ethernet
	//	
	//    //preset 
	//	/*tx_emph1_index = c1_default[5];  
	//	tx_amp_index = c0_default[5]; 
	//	tx_emph0_index = cn1_default[5];		
	//	check_min_max();
	//	
	...
	//	
	//	request_local_status(stat);  //READY 
	//	*/
	//}
