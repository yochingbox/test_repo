...
__code uint16_t cds_table[]   = { 
	...
	0x4fd0, //CDS_DEFAULT //skip_cdr=0 ofst_adapt_en=1
		  //0 = reset_bypass
		  //0 = coarse_dtl_bypass  
	...
	0x2253, //cds_status_dataadapt
		  ...
		  //0 = ofst_adapt_en
		  //0 = lock_dfe_on = skip_cdr&&reg_skip_cdr_freeze_dfe_mode  
	0x4ff4, //CDS_DEFAULT_PHASE_MOVE_DFE_EN //skip_cdr=0 ofst_adapt_en=1 phase_move_with_dfe_en=1
		  //0 = reset_bypass
		  //0 = coarse_dtl_bypass  
		  ...
		  //1 = ofst_adapt_en
		  //0 = lock_dfe_on = skip_cdr&&reg_skip_cdr_freeze_dfe_mode
	0x2fd0, //CDS_DEFAULT_PCIE //skip_cdr=0 ofst_adapt_en=1 phase_move_with_dfe_en=0
		  //0 = reset_bypass
		  //0 = coarse_dtl_bypass  
		  //0 = phase_move_with_dfe_en = !skip_cdr &&reg_phase_move_with_DFE_en
		  //0 = ee_os_adapt_en		  
