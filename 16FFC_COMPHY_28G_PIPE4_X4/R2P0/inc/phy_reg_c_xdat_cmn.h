...
typedef union {
	struct {
		...
		uint8_t MASTER_IP_SEL                            : 1;	/*      6     r/w   0*/
...
#define cmx_MASTER_IP_SEL  CONTROL_CONFIG0.BF.MASTER_IP_SEL
...
typedef union {
	struct {
		...
		uint8_t CAL_TEMPC_MUX_SEL_R1_7_0                 : 8;	/* [15:8]     r/w 8'h5*/
		uint8_t CAL_TEMPC_MUX_HOLD_SEL_R1_7_0            : 8;	/*[23:16]     r/w 8'h6*/
		uint8_t RESERVED_24                              : 8;	/*[31:24]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
