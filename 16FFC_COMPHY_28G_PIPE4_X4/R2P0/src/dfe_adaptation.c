...
void debug_print(void) BANKING_CTRL {
	...
	Printf("=rd(%d,", ((reg_ANA_TX_EM_PEAK_CTRL_RD_LANE_3_0_b1<<2)+reg_ANA_TX_EM_PEAK_CTRL_RD_LANE_3_0_b0));
...
/*
void print_train(void) BANKING_CTRL {
...
*/
/*
void print_cds(void) BANKING_CTRL {
