...
void load_init_temp_table(uint8_t pll_rate)
{
	...
	{
		tempc_mux_sel = 0;
		tempc_mux_hold_sel = 0;
	}
	else if (tsen_dat >= -20 && tsen_dat < 0)
	{
		tempc_mux_sel = 0;
		tempc_mux_hold_sel = 1;
	}
	else if (tsen_dat >= 0 && tsen_dat < 20)
	{
		tempc_mux_sel = 1;
		tempc_mux_hold_sel = 2;
	}
	else if (tsen_dat >= 20 && tsen_dat < 40)
	{
		tempc_mux_sel = 2;
		tempc_mux_hold_sel = 3;
	}
	else if (tsen_dat >= 40 && tsen_dat < 60)
	{
		tempc_mux_sel = 3;
		tempc_mux_hold_sel = 4;
	}
	else if (tsen_dat >= 60 && tsen_dat < 80)
	{
		tempc_mux_sel = 4;
		tempc_mux_hold_sel = 5;
	}
	else if (tsen_dat >= 80 && tsen_dat < 100)
	{
		tempc_mux_sel = 5;
		tempc_mux_hold_sel = 6;
	}
	else if (tsen_dat >= 100)
	{
		tempc_mux_sel = 6;
