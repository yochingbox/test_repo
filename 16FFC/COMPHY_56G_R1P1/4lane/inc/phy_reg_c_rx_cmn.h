...
typedef union {
	struct {
		...
		uint8_t DFE_ADAPT_ADJ_VREF_DC_SWAP_1_0           : 2;	/*[15:14]     r/w 2'h0*/
		uint8_t DFE_ADAPT_ADJ_VREF_DC_THRESH_2_5_0       : 6;	/*[21:16]     r/w 6'h12*/
		uint8_t DFE_COUPLE_TAP_MODE                      : 1;	/*     22     r/w   0*/
		uint8_t DFE_SAT_HOLD                             : 1;	/*     23     r/w   0*/
		uint8_t DFE_ADAPT_ADJ_VREF_DC_THRESH_1_4_0       : 5;	/*[28:24]     r/w 5'h6*/
		uint8_t DFE_SQ_EN                                : 1;	/*     29     r/w   1*/
		uint8_t DFE_SAT_EN_1_0                           : 2;	/*[31:30]     r/w 2'h3*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} DFE_STATIC_REG0_t;
...
#define reg_DFE_ADAPT_ADJ_VREF_DC_SWAP_1_0  DFE_STATIC_REG0.BF.DFE_ADAPT_ADJ_VREF_DC_SWAP_1_0
#define reg_DFE_ADAPT_ADJ_VREF_DC_THRESH_2_5_0  DFE_STATIC_REG0.BF.DFE_ADAPT_ADJ_VREF_DC_THRESH_2_5_0
#define reg_DFE_COUPLE_TAP_MODE  DFE_STATIC_REG0.BF.DFE_COUPLE_TAP_MODE
#define reg_DFE_SAT_HOLD  DFE_STATIC_REG0.BF.DFE_SAT_HOLD
#define reg_DFE_ADAPT_ADJ_VREF_DC_THRESH_1_4_0  DFE_STATIC_REG0.BF.DFE_ADAPT_ADJ_VREF_DC_THRESH_1_4_0
#define reg_DFE_SQ_EN  DFE_STATIC_REG0.BF.DFE_SQ_EN
#define reg_DFE_SAT_EN_1_0  DFE_STATIC_REG0.BF.DFE_SAT_EN_1_0
