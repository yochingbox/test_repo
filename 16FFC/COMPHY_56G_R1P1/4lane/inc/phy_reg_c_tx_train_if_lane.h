...
__xdata __at( 0x2800 ) volatile DME_ENC_REG0_t DME_ENC_REG0;
...
__xdata __at( 0x2804 ) volatile DME_ENC_REG1_t DME_ENC_REG1;
...
__xdata __at( 0x2808 ) volatile DME_ENC_REG2_t DME_ENC_REG2;
...
__xdata __at( 0x280c ) volatile DME_DEC_REG0_t DME_DEC_REG0;
...
__xdata __at( 0x2810 ) volatile DME_DEC_REG1_t DME_DEC_REG1;
...
typedef union {
	struct {
		uint8_t TRX_TRAIN_TIMER_LANE_9_0_b0              : 8;	/*  [9:0]     r/w 10'h1f3*/
		uint8_t TRX_TRAIN_TIMER_LANE_9_0_b1              : 2;	/*  [9:0]     r/w 10'h1f3*/
		uint8_t TRX_TRAIN_TIMEOUT_EN_LANE                : 1;	/*     10     r/w   1*/
		uint8_t TX_TRAIN_START_WAIT_TIME_LANE_1_0        : 2;	/*[12:11]     r/w 2'h0*/
		uint8_t TX_TRAIN_COMP_WAIT_FRAME_LANE_2_0        : 3;	/*[15:13]     r/w 3'h3*/
...
__xdata __at( 0x2814 ) volatile TX_TRAIN_IF_REG0_t TX_TRAIN_IF_REG0;
#define reg_TRX_TRAIN_TIMER_LANE_9_0_b0  TX_TRAIN_IF_REG0.BF.TRX_TRAIN_TIMER_LANE_9_0_b0
#define reg_TRX_TRAIN_TIMER_LANE_9_0_b1  TX_TRAIN_IF_REG0.BF.TRX_TRAIN_TIMER_LANE_9_0_b1
...
#define reg_TX_TRAIN_COMP_WAIT_FRAME_LANE_2_0  TX_TRAIN_IF_REG0.BF.TX_TRAIN_COMP_WAIT_FRAME_LANE_2_0
...
typedef union {
	struct {
		uint8_t RX_TRAIN_TIMER_LANE_9_0_b0               : 8;	/*  [9:0]     r/w 10'h013*/
		uint8_t RX_TRAIN_TIMER_LANE_9_0_b1               : 2;	/*  [9:0]     r/w 10'h013*/
		uint8_t TX_TRAIN_START_WAIT_TIME_DONE_LANE       : 1;	/*     10       r   0*/
		uint8_t RESERVED_11                              : 1;	/*     11     r/w   0*/
		uint8_t RESERVED_12                              : 1;	/*     12     r/w   0*/
		uint8_t RESERVED_13                              : 1;	/*     13     r/w   0*/
		uint8_t RESERVED_14                              : 1;	/*     14     r/w   0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
		uint8_t STATUS_DET_TIMEOUT_LANE_7_0              : 8;	/*[23:16]     r/w 8'h03*/
		uint8_t STATUS_DET_TIMEOUT_EN_LANE               : 1;	/*     24     r/w   1*/
...
__xdata __at( 0x2818 ) volatile TX_TRAIN_IF_REG1_t TX_TRAIN_IF_REG1;
#define reg_RX_TRAIN_TIMER_LANE_9_0_b0  TX_TRAIN_IF_REG1.BF.RX_TRAIN_TIMER_LANE_9_0_b0
#define reg_RX_TRAIN_TIMER_LANE_9_0_b1  TX_TRAIN_IF_REG1.BF.RX_TRAIN_TIMER_LANE_9_0_b1
#define reg_TX_TRAIN_START_WAIT_TIME_DONE_LANE  TX_TRAIN_IF_REG1.BF.TX_TRAIN_START_WAIT_TIME_DONE_LANE
#define reg_STATUS_DET_TIMEOUT_LANE_7_0  TX_TRAIN_IF_REG1.BF.STATUS_DET_TIMEOUT_LANE_7_0
#define reg_STATUS_DET_TIMEOUT_EN_LANE  TX_TRAIN_IF_REG1.BF.STATUS_DET_TIMEOUT_EN_LANE
...
typedef union {
	struct {
		...
		uint8_t LOCAL_CTRL_FIELD_RESET_LANE_3_0_b0       : 1;	/*[26:23]     r/w 4'h0*/
		uint8_t LOCAL_CTRL_FIELD_RESET_LANE_3_0_b1       : 3;	/*[26:23]     r/w 4'h0*/
		uint8_t LOCAL_CTRL_FIELD_PAT_LANE_1_0            : 2;	/*[28:27]     r/w 2'h0*/
		uint8_t RESERVED_29                              : 1;	/*     29     r/w   0*/
		uint8_t RESERVED_30                              : 1;	/*     30     r/w   0*/
...
__xdata __at( 0x281c ) volatile TX_TRAIN_IF_REG2_t TX_TRAIN_IF_REG2;
...
#define reg_LOCAL_CTRL_FIELD_RESET_LANE_3_0_b0  TX_TRAIN_IF_REG2.BF.LOCAL_CTRL_FIELD_RESET_LANE_3_0_b0
#define reg_LOCAL_CTRL_FIELD_RESET_LANE_3_0_b1  TX_TRAIN_IF_REG2.BF.LOCAL_CTRL_FIELD_RESET_LANE_3_0_b1
...
typedef union {
	struct {
		...
		uint8_t REMOTE_TRAIN_COMP_LANE                   : 1;	/*     17     r/w   0*/
...
__xdata __at( 0x2820 ) volatile TX_TRAIN_IF_REG3_t TX_TRAIN_IF_REG3;
...
typedef union {
	struct {
		...
		uint8_t TX_TRAIN_PAT_MSB_LSB_SWAP_LANE           : 1;	/*     15     r/w   0*/
...
__xdata __at( 0x2824 ) volatile TX_TRAIN_PATTTERN_REG0_t TX_TRAIN_PATTTERN_REG0;
...
#define reg_TX_TRAIN_PAT_MSB_LSB_SWAP_LANE  TX_TRAIN_PATTTERN_REG0.BF.TX_TRAIN_PAT_MSB_LSB_SWAP_LANE
...
typedef union {
	struct {
		uint8_t TX_AMP_MAX_LANE_6_0                      : 7;	/*  [6:0]     r/w 7'h0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
		uint8_t TX_AMP_MIN_LANE_6_0                      : 7;	/* [14:8]     r/w 7'h0*/
		uint8_t DUAL_ARG_PROTECT_EN_LANE                 : 1;	/*     15     r/w   1*/
		uint8_t TX_P2P_VMAX_LANE_6_0                     : 7;	/*[22:16]     r/w 7'h40*/
		uint8_t TX_AMP_CLAMP_EN_LANE                     : 1;	/*     23     r/w   0*/
		uint8_t TX_POWER_MAX_LANE_6_0                    : 7;	/*[30:24]     r/w 7'h40*/
		uint8_t TX_POWER_PROTECT_EN_LANE                 : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TX_TRAIN_DRIVER_REG0_t;
__xdata __at( 0x2828 ) volatile TX_TRAIN_DRIVER_REG0_t TX_TRAIN_DRIVER_REG0;
...
typedef union {
	struct {
		uint8_t TX_EMPH0_MAX_LANE_4_0                    : 5;	/*  [4:0]     r/w 5'h13*/
		uint8_t RESERVED_5                               : 1;	/*      5     r/w   0*/
		uint8_t RESERVED_6                               : 1;	/*      6     r/w   0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
		...
		uint8_t RESERVED_14                              : 1;	/*     14     r/w   0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
		uint8_t TX_EMPH1_MAX_LANE_4_0                    : 5;	/*[20:16]     r/w 5'h13*/
		uint8_t RESERVED_21                              : 1;	/*     21     r/w   0*/
		uint8_t RESERVED_22                              : 1;	/*     22     r/w   0*/
		uint8_t RESERVED_23                              : 1;	/*     23     r/w   0*/
...
__xdata __at( 0x282c ) volatile TX_TRAIN_DRIVER_REG1_t TX_TRAIN_DRIVER_REG1;
...
typedef union {
	struct {
		uint8_t TX_EMPH2_MAX_LANE_4_0                    : 5;	/*  [4:0]     r/w 5'h7*/
		uint8_t RESERVED_5                               : 1;	/*      5     r/w   0*/
		uint8_t RESERVED_6                               : 1;	/*      6     r/w   0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
		...
		uint8_t TX_VMA_MODE0_PROTECT_EN_LANE             : 1;	/*     21     r/w   0*/
		uint8_t TX_VMA_MODE1_PROTECT_EN_LANE             : 1;	/*     22     r/w   1*/
...
__xdata __at( 0x2830 ) volatile TX_TRAIN_DRIVER_REG2_t TX_TRAIN_DRIVER_REG2;
...
#define reg_TX_VMA_MODE0_PROTECT_EN_LANE  TX_TRAIN_DRIVER_REG2.BF.TX_VMA_MODE0_PROTECT_EN_LANE
#define reg_TX_VMA_MODE1_PROTECT_EN_LANE  TX_TRAIN_DRIVER_REG2.BF.TX_VMA_MODE1_PROTECT_EN_LANE
...
__xdata __at( 0x2834 ) volatile TX_TRAIN_DRIVER_REG3_t TX_TRAIN_DRIVER_REG3;
...
__xdata __at( 0x2838 ) volatile TX_TRAIN_DRIVER_REG4_t TX_TRAIN_DRIVER_REG4;
...
typedef union {
	struct {
		uint8_t TX_AMP_DEFAULT1_LANE_6_0                 : 7;	/*  [6:0]     r/w 7'h0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
		uint8_t TX_AMP_DEFAULT2_LANE_6_0                 : 7;	/* [14:8]     r/w 7'h0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
		uint8_t TX_AMP_DEFAULT3_LANE_6_0                 : 7;	/*[22:16]     r/w 7'h0*/
		uint8_t RESERVED_23                              : 1;	/*[31:23]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/*[31:23]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
...
__xdata __at( 0x283c ) volatile TX_TRAIN_DEFAULT1_t TX_TRAIN_DEFAULT1;
...
typedef union {
	struct {
		...
		uint8_t RESERVED_6                               : 1;	/*      6     r/w   0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
		uint8_t TX_EMPH0_DEFAULT2_LANE_4_0               : 5;	/* [12:8]     r/w 5'h0*/
		uint8_t RESERVED_13                              : 1;	/*     13     r/w   0*/
		uint8_t RESERVED_14                              : 1;	/*     14     r/w   0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
		uint8_t TX_EMPH0_DEFAULT3_LANE_4_0               : 5;	/*[20:16]     r/w 5'h10*/
...
__xdata __at( 0x2840 ) volatile TX_TRAIN_DEFAULT2_t TX_TRAIN_DEFAULT2;
...
typedef union {
	struct {
		...
		uint8_t RESERVED_6                               : 1;	/*      6     r/w   0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
		uint8_t TX_EMPH1_DEFAULT2_LANE_4_0               : 5;	/* [12:8]     r/w 5'h10*/
		uint8_t RESERVED_13                              : 1;	/*     13     r/w   0*/
		uint8_t RESERVED_14                              : 1;	/*     14     r/w   0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
...
__xdata __at( 0x2844 ) volatile TX_TRAIN_DEFAULT3_t TX_TRAIN_DEFAULT3;
...
__xdata __at( 0x2848 ) volatile TX_TRAIN_DEFAULT4_t TX_TRAIN_DEFAULT4;
...
__xdata __at( 0x2854 ) volatile TRX_TRAIN0_t TRX_TRAIN0;
...
__xdata __at( 0x2858 ) volatile TRX_TRAIN1_t TRX_TRAIN1;
...
__xdata __at( 0x285c ) volatile CLK_GEN_t CLK_GEN;
...
__xdata __at( 0x2860 ) volatile INTERRUPT_REG0_t INTERRUPT_REG0;
...
__xdata __at( 0x2864 ) volatile INTERRUPT_REG1_t INTERRUPT_REG1;
...
__xdata __at( 0x2868 ) volatile TRX_TRAIN_IF_INTERRUPT_CLEAR_LANE_t TRX_TRAIN_IF_INTERRUPT_CLEAR_LANE;
