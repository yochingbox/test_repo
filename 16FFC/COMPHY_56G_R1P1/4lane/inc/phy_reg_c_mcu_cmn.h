...
typedef union {
	struct {
		...
		uint8_t BYPASS_ARBITER_CMN                       : 1;	/*     17     r/w   0*/
		uint8_t BYPASS_CACHE_CMN                         : 1;	/*     18     r/w   0*/
		uint8_t RESERVED_19                              : 5;	/*[30:19]     r/w   0*/
		uint8_t RESERVED_24                              : 7;	/*[30:19]     r/w   0*/
...
#define reg_BYPASS_ARBITER_CMN  MCU_CONTROL_1.BF.BYPASS_ARBITER_CMN
#define reg_BYPASS_CACHE_CMN  MCU_CONTROL_1.BF.BYPASS_CACHE_CMN
...
typedef union {
	struct {
		...
		uint8_t XDATA_ECC_ERR_CMN                        : 1;	/*      5       r   0*/
		uint8_t PRAM_ECC_ERR                             : 1;	/*      6       r   0*/
		uint8_t CACHE_ECC_ERR_CMN                        : 1;	/*      7       r   0*/
		uint8_t IRAM_ECC_ERR_CMN                         : 1;	/*      8       r   0*/
		uint8_t RESERVED_9                               : 7;	/* [31:9]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/* [31:9]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/* [31:9]     r/w   0*/
	} BF;
...
#define reg_XDATA_ECC_ERR_CMN  MEMORY_CONTROL_4.BF.XDATA_ECC_ERR_CMN
#define reg_PRAM_ECC_ERR  MEMORY_CONTROL_4.BF.PRAM_ECC_ERR
#define reg_CACHE_ECC_ERR_CMN  MEMORY_CONTROL_4.BF.CACHE_ECC_ERR_CMN
#define reg_IRAM_ECC_ERR_CMN  MEMORY_CONTROL_4.BF.IRAM_ECC_ERR_CMN
