...
void set_ph_dat(int8_t phase)
{
    ...
    {
        case 0:
            ph_align90_ref = CAL_ALIGN90_REF - (int8_t)cur_ph_dat;
        ...
        case 1:
            ...
            break;
        case 2:
            ph_eom_dpher = CAL_EOM_DPHER - (int8_t)cur_ph_dat - (int16_t)reg_EOM_DPHER_LANE_6_0;
            move_eom_phase(ph_eom_dpher);
            break;
        case 3:
            ph_eom_dpher = CAL_EOM_DPHER + (int8_t)cur_ph_dat + tag_CDR_HALF_UI_PI_CODE - (int16_t)reg_EOM_DPHER_LANE_6_0;
            move_eom_phase(ph_eom_dpher);
            break;
    }
...
void set_ph_esm(int8_t phase)
{
    ...
    switch(cur_ph_mode)
    {
        case 0:
            ...
            break;
        case 1:
            //ph_eom_dpher = CAL_EOM_DPHER - (int8_t)cur_ph_esm - (int16_t)reg_EOM_DPHER_LANE_6_0;
...
//   reg_MCU_DEBUGE_LANE_7_0 = 2;
  ...
  //reg_MCU_DEBUGF_LANE_7_0 = ph_eom_dpher >> 8;
            ...
            break;
        case 2:
            ph_eom_dpher = CAL_EOM_DPHER - (int8_t)cur_ph_dat - (int8_t)cur_ph_esm - (int16_t)reg_EOM_DPHER_LANE_6_0;
            move_eom_phase(ph_eom_dpher);
            break;
        case 3:
            ph_eom_dpher = CAL_EOM_DPHER + (int8_t)cur_ph_dat + (int8_t)cur_ph_esm + tag_CDR_HALF_UI_PI_CODE - (int16_t)reg_EOM_DPHER_LANE_6_0;
            move_eom_phase(ph_eom_dpher);
            break;
    }
