...
typedef union {
	struct {
		...
		uint8_t PLL_CAL_RING_DONE_LANE                   : 1;	/*     25       r   0*/
...
#define lnx_PLL_CAL_RING_DONE_LANE  CAL_CTRL1_LANE.BF.PLL_CAL_RING_DONE_LANE
...
typedef union {
	struct {
		...
		uint8_t PLL_CAL_RING_PASS_LANE                   : 1;	/*     30       r   0*/
...
#define lnx_PLL_CAL_RING_PASS_LANE  CAL_CTRL2_LANE.BF.PLL_CAL_RING_PASS_LANE
...
typedef union {
	struct {
		...
		uint8_t MIDPOINT_SMALL_THRES_K_LANE_3_0          : 4;	/*[23:20]     r/w 4'h8*/
...
typedef union {
	struct {
		...
		uint8_t SUMF_BOOST_TARGET_C_LANE_7_0             : 8;	/*[23:16]     r/w 8'hb4*/
...
typedef union {
	struct {
		...
		uint8_t TRAIN_PT_EN_LANE                         : 1;	/*     19     r/w   0*/
...
#define lnx_TRAIN_PT_EN_LANE  TRAIN_PARA_3.BF.TRAIN_PT_EN_LANE
...
typedef union {
	struct {
		...
		uint8_t SUMFTAP_SIGN_6_LANE                      : 1;	/*     14     r/w   1*/
		uint8_t SUMFTAP_SIGN_7_LANE                      : 1;	/*     15     r/w   1*/
		uint8_t RESERVED_16                              : 8;	/*[23:16]     r/w 8'h0*/
		uint8_t RESERVED_24                              : 8;	/*[31:24]     r/w 8'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
...
typedef union {
	struct {
		...
		uint8_t DIS_SPEED_CHANGE_TX_IDLE_LANE            : 1;	/*      1     r/w   0*/
		uint8_t TX_TRAIN_END_PATTERN_DIS_LANE            : 1;	/*      2     r/w   0*/
...
#define lnx_DIS_SPEED_CHANGE_TX_IDLE_LANE  DFE_CONTROL_7.BF.DIS_SPEED_CHANGE_TX_IDLE_LANE
#define lnx_TX_TRAIN_END_PATTERN_DIS_LANE  DFE_CONTROL_7.BF.TX_TRAIN_END_PATTERN_DIS_LANE
...
typedef union {
	struct {
		...
		uint8_t RX_TRAIN_FAIL_INT_LANE                   : 1;	/*      5     r/w   0*/
...
#define lnx_RX_TRAIN_FAIL_INT_LANE  CDS_CTRL_REG0.BF.RX_TRAIN_FAIL_INT_LANE
...
typedef union {
	struct {
		...
		uint8_t RX_TRAIN_COMPLETE_INT_LANE               : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CDS_CTRL_REG1_t;
...
#define lnx_RX_TRAIN_COMPLETE_INT_LANE  CDS_CTRL_REG1.BF.RX_TRAIN_COMPLETE_INT_LANE
...
typedef union {
	struct {
		uint8_t RXFFE_RES_SAVE_G0_LANE_3_0               : 4;	/*  [3:0]       r 4'h0*/
		uint8_t RXFFE_CAP_SAVE_G0_LANE_3_0               : 4;	/*  [7:4]       r 4'h0*/
		uint8_t RXFFE_RES_SAVE_G1_LANE_3_0               : 4;	/* [11:8]       r 4'h0*/
		uint8_t RXFFE_CAP_SAVE_G1_LANE_3_0               : 4;	/*[15:12]       r 4'h0*/
		uint8_t RXFFE_RES_SAVE_G2_LANE_3_0               : 4;	/*[19:16]       r 4'h0*/
		uint8_t RXFFE_CAP_SAVE_G2_LANE_3_0               : 4;	/*[23:20]       r 4'h0*/
		uint8_t RXFFE_RES_SAVE_G3_LANE_3_0               : 4;	/*[27:24]       r 4'h0*/
		uint8_t RXFFE_CAP_SAVE_G3_LANE_3_0               : 4;	/*[31:28]       r 4'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TRAIN_CONTROL_8_t;
__xdata __at( 0x60c8 ) volatile TRAIN_CONTROL_8_t TRAIN_CONTROL_8;
#define lnx_RXFFE_RES_SAVE_G0_LANE_3_0  TRAIN_CONTROL_8.BF.RXFFE_RES_SAVE_G0_LANE_3_0
#define lnx_RXFFE_CAP_SAVE_G0_LANE_3_0  TRAIN_CONTROL_8.BF.RXFFE_CAP_SAVE_G0_LANE_3_0
#define lnx_RXFFE_RES_SAVE_G1_LANE_3_0  TRAIN_CONTROL_8.BF.RXFFE_RES_SAVE_G1_LANE_3_0
#define lnx_RXFFE_CAP_SAVE_G1_LANE_3_0  TRAIN_CONTROL_8.BF.RXFFE_CAP_SAVE_G1_LANE_3_0
#define lnx_RXFFE_RES_SAVE_G2_LANE_3_0  TRAIN_CONTROL_8.BF.RXFFE_RES_SAVE_G2_LANE_3_0
#define lnx_RXFFE_CAP_SAVE_G2_LANE_3_0  TRAIN_CONTROL_8.BF.RXFFE_CAP_SAVE_G2_LANE_3_0
#define lnx_RXFFE_RES_SAVE_G3_LANE_3_0  TRAIN_CONTROL_8.BF.RXFFE_RES_SAVE_G3_LANE_3_0
#define lnx_RXFFE_CAP_SAVE_G3_LANE_3_0  TRAIN_CONTROL_8.BF.RXFFE_CAP_SAVE_G3_LANE_3_0
...
typedef union {
	struct {
		...
		uint8_t TX_TRAIN_TIMEOUT_LANE                    : 1;	/*     21       r   0*/
		uint8_t TX_TRAIN_FRAME_UNLOCK_FAILED_TIMEOUT_INT_LANE : 1;	/*     22       r   0*/
...
#define lnx_TX_TRAIN_TIMEOUT_LANE  TRAIN_CONTROL_9.BF.TX_TRAIN_TIMEOUT_LANE
#define lnx_TX_TRAIN_FRAME_UNLOCK_FAILED_TIMEOUT_INT_LANE  TRAIN_CONTROL_9.BF.TX_TRAIN_FRAME_UNLOCK_FAILED_TIMEOUT_INT_LANE
...
// 0x00f8	CAL_CTRL5_LANE		Calibration Control Lane 5
typedef union {
	struct {
		uint8_t PLL_SPEED_THRESH_RING_LANE_15_0_b0       : 8;	/* [15:0]     r/w 16'h0*/
		uint8_t PLL_SPEED_THRESH_RING_LANE_15_0_b1       : 8;	/* [15:0]     r/w 16'h0*/
...
__xdata __at( 0x60f8 ) volatile CAL_CTRL5_LANE_t CAL_CTRL5_LANE;
#define lnx_PLL_SPEED_THRESH_RING_LANE_15_0_b0  CAL_CTRL5_LANE.BF.PLL_SPEED_THRESH_RING_LANE_15_0_b0
#define lnx_PLL_SPEED_THRESH_RING_LANE_15_0_b1  CAL_CTRL5_LANE.BF.PLL_SPEED_THRESH_RING_LANE_15_0_b1
#define lnx_PLL_SPEED_THRESH_RING_LANE_15_0  CAL_CTRL5_LANE.WT.W0
