...
uint8_t get_gen_memory_index(uint8_t gen) {
	...
	uint8_t serdes_gen_tb1[] = { 0, 1, 2, 0, 3, 0, 0, 4, 0, 0, 0, 0, 0, 0, 0, 0, 0};
...
//    if(reg_PIN_PHY_GEN_TX_RD_LANE_3_0 == 7 || reg_PIN_PHY_GEN_RX_RD_LANE_3_0 == 7 || reg_PIN_PHY_GEN_TX_RD_LANE_3_0 == 4 || reg_PIN_PHY_GEN_RX_RD_LANE_3_0 == 4)      
//    {
//        if(reg_PIN_PHY_GEN_TX_RD_LANE_3_0 == 4 || reg_PIN_PHY_GEN_RX_RD_LANE_3_0 == 4)
//            reg_REG_SELMUPI_LANE_3_0 = 0x3;
//        else
//            reg_REG_SELMUPI_LANE_3_0 = 0x2;
//        reg_REG_SELMUPF_LANE_3_0 = 0x3;
//        reg_RX_SELMUFF_LANE_2_0 = 0x2;
//        reg_RX_SELMUFI_LANE_2_0 = 0x2;
//    }
