...
void debug_print_train_result(void) BANKING_CTRL{
	...
	Printf("rxffe(%d,%d,%d-%d,%d,%d),",reg_FFE_RES1_SEL_LANE_3_0,reg_FFE_RES2_SEL_E_LANE_3_0, reg_FFE_RES2_SEL_O_LANE_3_0,reg_FFE_CAP1_SEL_LANE_3_0,reg_FFE_CAP2_SEL_E_LANE_3_0,reg_FFE_CAP2_SEL_O_LANE_3_0);
