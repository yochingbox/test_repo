...
typedef union {
	struct {
		...
		uint8_t SUMFTAP_SIGN_0_LANE                      : 1;	/*     16     r/w   0*/
		uint8_t SUMFTAP_SIGN_1_LANE                      : 1;	/*     17     r/w   1*/
		uint8_t SUMFTAP_SIGN_2_LANE                      : 1;	/*     18     r/w   1*/
		uint8_t SUMFTAP_SIGN_3_LANE                      : 1;	/*     19     r/w   1*/
		uint8_t SUMFTAP_SIGN_4_LANE                      : 1;	/*     20     r/w   1*/
		uint8_t SUMFTAP_SIGN_5_LANE                      : 1;	/*     21     r/w   1*/
		uint8_t SUMFTAP_SIGN_6_LANE                      : 1;	/*     22     r/w   0*/
		uint8_t SUMFTAP_SIGN_7_LANE                      : 1;	/*     23     r/w   0*/
...
#define lnx_SUMFTAP_SIGN_0_LANE  CAL_SAVE_DATA2_LANE.BF.SUMFTAP_SIGN_0_LANE
#define lnx_SUMFTAP_SIGN_1_LANE  CAL_SAVE_DATA2_LANE.BF.SUMFTAP_SIGN_1_LANE
#define lnx_SUMFTAP_SIGN_2_LANE  CAL_SAVE_DATA2_LANE.BF.SUMFTAP_SIGN_2_LANE
#define lnx_SUMFTAP_SIGN_3_LANE  CAL_SAVE_DATA2_LANE.BF.SUMFTAP_SIGN_3_LANE
#define lnx_SUMFTAP_SIGN_4_LANE  CAL_SAVE_DATA2_LANE.BF.SUMFTAP_SIGN_4_LANE
#define lnx_SUMFTAP_SIGN_5_LANE  CAL_SAVE_DATA2_LANE.BF.SUMFTAP_SIGN_5_LANE
#define lnx_SUMFTAP_SIGN_6_LANE  CAL_SAVE_DATA2_LANE.BF.SUMFTAP_SIGN_6_LANE
#define lnx_SUMFTAP_SIGN_7_LANE  CAL_SAVE_DATA2_LANE.BF.SUMFTAP_SIGN_7_LANE
...
typedef union {
	struct {
		...
		uint8_t CAL_OFST_F1P_S_E_LANE_7_0                : 8;	/*[23:16]     r/w 8'h0*/
		uint8_t CAL_OFST_F1N_S_E_LANE_7_0                : 8;	/*[31:24]     r/w 8'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define lnx_CAL_OFST_F1P_S_E_LANE_7_0  CAL_SAVE_DATA4_LANE.BF.CAL_OFST_F1P_S_E_LANE_7_0
#define lnx_CAL_OFST_F1N_S_E_LANE_7_0  CAL_SAVE_DATA4_LANE.BF.CAL_OFST_F1N_S_E_LANE_7_0

// 0x0020	CAL_SAVE_DATA5_LANE		Calibration Result 7
typedef union {
	struct {
		uint8_t CAL_OFST_F1P_D_O_LANE_7_0                : 8;	/*  [7:0]     r/w 8'h0*/
		uint8_t CAL_OFST_F1N_D_O_LANE_7_0                : 8;	/* [15:8]     r/w 8'h0*/
...
#define lnx_CAL_OFST_F1P_D_O_LANE_7_0  CAL_SAVE_DATA5_LANE.BF.CAL_OFST_F1P_D_O_LANE_7_0
#define lnx_CAL_OFST_F1N_D_O_LANE_7_0  CAL_SAVE_DATA5_LANE.BF.CAL_OFST_F1N_D_O_LANE_7_0
...
typedef union {
	struct {
		...
		uint8_t SUMFTAP_EN_0_LANE                        : 1;	/*     24     r/w   0*/
		uint8_t SUMFTAP_EN_1_LANE                        : 1;	/*     25     r/w   1*/
		uint8_t SUMFTAP_EN_2_LANE                        : 1;	/*     26     r/w   1*/
		uint8_t SUMFTAP_EN_3_LANE                        : 1;	/*     27     r/w   1*/
		uint8_t SUMFTAP_EN_4_LANE                        : 1;	/*     28     r/w   1*/
		uint8_t SUMFTAP_EN_5_LANE                        : 1;	/*     29     r/w   1*/
		uint8_t SUMFTAP_EN_6_LANE                        : 1;	/*     30     r/w   0*/
		uint8_t SUMFTAP_EN_7_LANE                        : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define lnx_SUMFTAP_EN_0_LANE  CAL_SAVE_DATA6_LANE.BF.SUMFTAP_EN_0_LANE
#define lnx_SUMFTAP_EN_1_LANE  CAL_SAVE_DATA6_LANE.BF.SUMFTAP_EN_1_LANE
#define lnx_SUMFTAP_EN_2_LANE  CAL_SAVE_DATA6_LANE.BF.SUMFTAP_EN_2_LANE
#define lnx_SUMFTAP_EN_3_LANE  CAL_SAVE_DATA6_LANE.BF.SUMFTAP_EN_3_LANE
#define lnx_SUMFTAP_EN_4_LANE  CAL_SAVE_DATA6_LANE.BF.SUMFTAP_EN_4_LANE
#define lnx_SUMFTAP_EN_5_LANE  CAL_SAVE_DATA6_LANE.BF.SUMFTAP_EN_5_LANE
#define lnx_SUMFTAP_EN_6_LANE  CAL_SAVE_DATA6_LANE.BF.SUMFTAP_EN_6_LANE
#define lnx_SUMFTAP_EN_7_LANE  CAL_SAVE_DATA6_LANE.BF.SUMFTAP_EN_7_LANE
...
typedef union {
	struct {
		...
		uint8_t PHY_LOCAL_STATUS_LANE_7_0                : 8;	/*[23:16]       r   0*/
		uint8_t DFE_RES_F0A_HIGH_THRES_INIT_LANE_7_0     : 8;	/*[31:24]     r/w 8'h28*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
...
typedef union {
	struct {
		...
		uint8_t PCIE_RXTRAIN_ON_BEFORE_DIR_LANE          : 1;	/*     24     r/w   0*/
...
#define lnx_PCIE_RXTRAIN_ON_BEFORE_DIR_LANE  TRX_TRAIN_IF_TIMERS_ENABLE_LANE.BF.PCIE_RXTRAIN_ON_BEFORE_DIR_LANE
...
typedef union {
	struct {
		...
		uint8_t SUMF_BOOST_TARGET_C_LANE_7_0             : 8;	/*[23:16]     r/w 8'h50*/
...
typedef union {
	struct {
		...
		uint8_t PHY_MCU_LOCAL_ACK_LANE                   : 1;	/*      4     r/w   0*/
		uint8_t SUMF_BOOST_TARGET_C_FORCE_EN_LANE        : 1;	/*      5     r/w   0*/
...
#define lnx_PHY_MCU_LOCAL_ACK_LANE  TRAIN_PARA_2.BF.PHY_MCU_LOCAL_ACK_LANE
...
typedef union {
	struct {
		...
		uint8_t BYPASS_FFE_R_CTRL_LANE                   : 1;	/*     19     r/w   0*/
		uint8_t BYPASS_FFE_C_CTRL_LANE                   : 1;	/*     20     r/w   0*/
...
#define lnx_DFE_RES_F0A_LOW_THRES_2_END_LANE_7_0  TRAIN_SAVE_DATA3_LANE.BF.DFE_RES_F0A_LOW_THRES_2_END_LANE_7_0
#define lnx_DFE_RES_F0A_LOW_THRES_3_END_LANE_7_0  TRAIN_SAVE_DATA3_LANE.BF.DFE_RES_F0A_LOW_THRES_3_END_LANE_7_0
#define lnx_CDR_MIDPOINT_STEP_NUM_LANE_2_0  TRAIN_SAVE_DATA3_LANE.BF.CDR_MIDPOINT_STEP_NUM_LANE_2_0
#define lnx_BYPASS_FFE_R_CTRL_LANE  TRAIN_SAVE_DATA3_LANE.BF.BYPASS_FFE_R_CTRL_LANE
#define lnx_BYPASS_FFE_C_CTRL_LANE  TRAIN_SAVE_DATA3_LANE.BF.BYPASS_FFE_C_CTRL_LANE
...
typedef union {
	struct {
		...
		uint8_t DFE_F_TAP_EN_G0_LANE                     : 1;	/*      8     r/w   1*/
		uint8_t DFE_F_TAP_EN_G1_LANE                     : 1;	/*      9     r/w   1*/
		uint8_t DFE_F_TAP_EN_G2_LANE                     : 1;	/*     10     r/w   1*/
		uint8_t DFE_F_TAP_EN_G3_LANE                     : 1;	/*     11     r/w   1*/
		uint8_t DFE_F_TAP_EN_G4_LANE                     : 1;	/*     12     r/w   1*/
		uint8_t RESERVED_13                              : 3;	/*[15:13]     r/w   0*/
		uint8_t TX_G1_MIDPOINT_THRES_C_LANE_7_0          : 8;	/*[23:16]     r/w 8'hfc*/
		uint8_t TX_G1_MIDPOINT_THRES_K_LANE_7_0          : 8;	/*[31:24]     r/w 8'hf*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} DFE_TEST_1_t;
...
#define lnx_DFE_F_TAP_EN_G0_LANE  DFE_TEST_1.BF.DFE_F_TAP_EN_G0_LANE
#define lnx_DFE_F_TAP_EN_G1_LANE  DFE_TEST_1.BF.DFE_F_TAP_EN_G1_LANE
#define lnx_DFE_F_TAP_EN_G2_LANE  DFE_TEST_1.BF.DFE_F_TAP_EN_G2_LANE
#define lnx_DFE_F_TAP_EN_G3_LANE  DFE_TEST_1.BF.DFE_F_TAP_EN_G3_LANE
#define lnx_DFE_F_TAP_EN_G4_LANE  DFE_TEST_1.BF.DFE_F_TAP_EN_G4_LANE
#define lnx_TX_G1_MIDPOINT_THRES_C_LANE_7_0  DFE_TEST_1.BF.TX_G1_MIDPOINT_THRES_C_LANE_7_0
#define lnx_TX_G1_MIDPOINT_THRES_K_LANE_7_0  DFE_TEST_1.BF.TX_G1_MIDPOINT_THRES_K_LANE_7_0
...
#define lnx_PHY_REMOTE_CTRL_COMMAND_CODE_LANE_15_0_b0  DFE_TEST_4.BF.PHY_REMOTE_CTRL_COMMAND_CODE_LANE_15_0_b0
#define lnx_PHY_REMOTE_CTRL_COMMAND_CODE_LANE_15_0_b1  DFE_TEST_4.BF.PHY_REMOTE_CTRL_COMMAND_CODE_LANE_15_0_b1
#define lnx_GAIN_TRAIN_INDEX_RD_LANE_7_0  DFE_TEST_4.BF.GAIN_TRAIN_INDEX_RD_LANE_7_0
#define lnx_PHY_REMOTE_CTRL_COMMAND_TYPE_LANE_7_0  DFE_TEST_4.BF.PHY_REMOTE_CTRL_COMMAND_TYPE_LANE_7_0
#define lnx_PHY_REMOTE_CTRL_COMMAND_CODE_LANE_15_0  DFE_TEST_4.WT.W0

// 0x0088	PHY_LOCAL_VALUE_LANE		
typedef union {
	struct {
...
__xdata __at( 0x6088 ) volatile PHY_LOCAL_VALUE_LANE_t PHY_LOCAL_VALUE_LANE;
...
typedef union {
	struct {
		...
		uint8_t DIS_BYPASS_RXTRAIN_IN_FOM_LANE           : 1;	/*      1     r/w   0*/
		...
		uint8_t RXFFE_C_GAIN_TRAIN_LANE_3_0              : 4;	/*[27:24]     r/w 4'hf*/
...
#define lnx_PHY_MCU_REMOTE_REQ_LANE  DFE_CONTROL_7.BF.PHY_MCU_REMOTE_REQ_LANE
...
typedef union {
	struct {
		...
		uint8_t BYPASS_RXTRAIN_IN_FOM_LANE               : 1;	/*      6     r/w   0*/
		uint8_t BYPASS_CTLE_TRAIN_LANE                   : 1;	/*      7     r/w   0*/
...
#define lnx_BYPASS_RXTRAIN_IN_FOM_LANE  DFE_CONTROL_10.BF.BYPASS_RXTRAIN_IN_FOM_LANE
#define lnx_BYPASS_CTLE_TRAIN_LANE  DFE_CONTROL_10.BF.BYPASS_CTLE_TRAIN_LANE
...
// 0x00c8	PHY_REMOTE_CTRL_VALUE_LANE		
typedef union {
	struct {
...
__xdata __at( 0x60c8 ) volatile PHY_REMOTE_CTRL_VALUE_LANE_t PHY_REMOTE_CTRL_VALUE_LANE;
...
typedef union {
	struct {
		uint8_t RXFFE_RES_SAVE_G4_LANE_3_0               : 4;	/*  [3:0]       r 4'h0*/
		uint8_t RXFFE_CAP_SAVE_G4_LANE_3_0               : 4;	/*  [7:4]       r 4'h0*/
		...
		uint8_t RX_TRAIN_TIMEOUT_LANE                    : 1;	/*     23       r   0*/
...
#define lnx_RXFFE_RES_SAVE_G4_LANE_3_0  TRAIN_CONTROL_9.BF.RXFFE_RES_SAVE_G4_LANE_3_0
#define lnx_RXFFE_CAP_SAVE_G4_LANE_3_0  TRAIN_CONTROL_9.BF.RXFFE_CAP_SAVE_G4_LANE_3_0
...
#define lnx_RX_TRAIN_TIMEOUT_LANE  TRAIN_CONTROL_9.BF.RX_TRAIN_TIMEOUT_LANE
