...
#define CMD_BANK __banked
#define EOM_BANK __banked
#define RXTRAIN_BANK __banked
...
typedef struct Status_dfe_sm_struct{ //size 62+2+8 bytes
...
typedef struct Status_dfe_sm_dc_struct{ //8
...
/*
typedef struct Status_dfe_struct{ // 64 byte //72 bytes
...
#define PowerUp_Seq_Simple() PowerUp_Seq_Test()
	...
	void eom_align_cal_01(void) BANKING_CTRL;
	...
	void squelch_cal_0(void) BANKING_CTRL;
