...
void loadspeedtbl_gen(void) {
	...
	//HR: force to dfe_dis=0 for debug L1 failure
	if(phy_mode == PCIE && gen==1) dfe_dis = 1; //TODO: remove after speed table update
