...
void main_repl() BANKING_CTRL {
    ...
    while(1){
		...
		switch(PHY_STATUS){
			#ifdef SUPPORT_SHRTR_PATCH
            case ST_SPDCHG: SpeedChange_ram();		
			#else
            case ST_SPDCHG: SpeedChange();	rx_init_done = 0;  PHY_STATUS = ST_DTL; 
			#endif
                        ...
                        if( phy_mode==PCIE ) {             
                            ...
                            {                                         
                                ...
                                {                                                          
                                    reg_SELLV_RXSAMPELR_CH1_3_0 = 0x8;                                  
                                    reg_SELLV_RXSAMPELR_CH2_3_0 = 0x8;                                                                        
                                }                                                    
                            }                    
                            else {                                  
                                reg_SELLV_RXSAMPELR_CH1_3_0 = 0x8;                                       
