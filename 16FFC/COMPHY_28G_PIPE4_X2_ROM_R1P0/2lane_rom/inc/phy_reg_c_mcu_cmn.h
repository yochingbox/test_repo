...
typedef union {
	struct {
		...
		uint8_t XDATA_ECC_1ERR                           : 1;	/*      5       r   0*/
		uint8_t PRAM_ECC_1ERR                            : 1;	/*      6       r   0*/
		uint8_t ROM_PARITY_ERR                           : 1;	/*      7       r   0*/
		uint8_t XDATA_ECC_2ERR                           : 1;	/*      8       r   0*/
...
#define reg_XDATA_ECC_1ERR  MEMORY_CONTROL_4.BF.XDATA_ECC_1ERR
#define reg_PRAM_ECC_1ERR  MEMORY_CONTROL_4.BF.PRAM_ECC_1ERR
#define reg_ROM_PARITY_ERR  MEMORY_CONTROL_4.BF.ROM_PARITY_ERR
#define reg_XDATA_ECC_2ERR  MEMORY_CONTROL_4.BF.XDATA_ECC_2ERR
...
#define reg_XDATA_ECC_1ERR_CLEAR  MEMORY_CONTROL_4.BF.XDATA_ECC_1ERR_CLEAR
...
#define reg_XDATA_ECC_2ERR_CLEAR  MEMORY_CONTROL_4.BF.XDATA_ECC_2ERR_CLEAR
#define reg_PRAM_ECC_2ERR_CLEAR  MEMORY_CONTROL_4.BF.PRAM_ECC_2ERR_CLEAR
#define reg_XDATA_ECC_1ERR_SET  MEMORY_CONTROL_4.BF.XDATA_ECC_1ERR_SET
...
#define reg_XDATA_ECC_2ERR_SET  MEMORY_CONTROL_4.BF.XDATA_ECC_2ERR_SET
