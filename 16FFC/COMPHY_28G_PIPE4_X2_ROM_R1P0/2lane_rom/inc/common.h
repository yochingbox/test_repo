...
#define LDO_SETTING_EN                          (reg_MCU_DEBUG_CMN_6_7_0 & 0x01)
...
#define req_local_ctrl_ram(s,a,b,c) 	Send_ctrl_to_tx_ram((s)|((a)<<4)|((b)<<2)|(c))
...
#define PowerUp_Seq_Simple() PowerUp_Seq_Test()
	...
	void pu_pll_on_ram(void) BANKING_CTRL ;
	...
	void pll_cal_ram(void) BANKING_CTRL;
	...
	// -- lane margin
		...
		void lane_margin_start_ram(void) BANKING_CTRL ;
		void lane_margin_dfe_run_ram(void) BANKING_CTRL ;
...
#ifdef _28G_X2_ROM
	void main_repl() BANKING_CTRL; // main function for crash mode
