...
#ifdef _LANE_RPLL
	cmx_cal_pll_speed_ring[no][PLL_RATE_SEL_RING] = (reg_PLL_SPEED_RING_LANE_4_0 & 0x1f) | 0x00;
	cmx_cal_pll_sllp_dac_coarse_ring[no][PLL_RATE_SEL_RING] = (reg_PLL_SLLP_DAC_COARSE_RING_LANE_3_0 & 0x0f) | 0x00;
#else
...
#ifdef _LANE_RPLL
	reg_PLL_SPEED_RING_LANE_4_0 = cmx_cal_pll_speed_ring[no][PLL_RATE_SEL_RING];
	reg_PLL_SLLP_DAC_COARSE_RING_LANE_3_0 = cmx_cal_pll_sllp_dac_coarse_ring[no][PLL_RATE_SEL_RING];
#else  // CMN_RPLL
