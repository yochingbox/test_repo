...
typedef union {
	struct {
		...
		uint8_t MODE_MIXED_DW_DF_LANE                    : 1;	/*     18     r/w   1*/
		uint8_t MODE_PIPE_WIDTH_32_LANE                  : 1;	/*     19     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t CFG_STICKY_REG_RST_LANE                  : 1;	/*     29     r/w   0*/
		uint8_t RESERVED_30                              : 1;	/*     30     r/w   0*/
...
#define reg_CFG_STICKY_REG_RST_LANE  GLOB_CLK_SRC_HI.BF.CFG_STICKY_REG_RST_LANE
...
typedef union {
	struct {
		...
		uint8_t MODE_PIPE4X_L1SUB_LANE                   : 1;	/*     12     r/w   0*/
