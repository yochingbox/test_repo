...
typedef union {
	struct {
		...
		uint8_t APTA_TERMINATE_REASON_LANE_7_0           : 8;	/* [15:8]     r/w 8'h0*/
		uint8_t ERROR_TTIU_DETECTED_LANE                 : 1;	/*     16     r/w   0*/
...
#define lnx_ERROR_TTIU_DETECTED_LANE  CAL_CTRL3_LANE.BF.ERROR_TTIU_DETECTED_LANE
