   ...
   7A8F 90 26 7B           2045 	mov	dptr,#(_TX_TRAIN_CTRL_LANE + 0x0003)
   7A92 E0                 2046 	movx	a,@dptr
   7A93 54 EF              2047 	anl	a,#0xef
   7A95 F0                 2048 	movx	@dptr,a
                           2049 ;	../../shared/src/tx_train_if.c:9: reg_INT_TX_TRAIN_FAILED_LANE = 0;
   7A96 90 26 7B           2050 	mov	dptr,#(_TX_TRAIN_CTRL_LANE + 0x0003)
   7A99 E0                 2051 	movx	a,@dptr
   7A9A 54 F7              2052 	anl	a,#0xf7
   7A9C F0                 2053 	movx	@dptr,a
                           2054 ;	../../shared/src/tx_train_if.c:10: reg_INT_LOCAL_CTRL_REQ_LANE = 0;
   7A9D 90 26 76           2055 	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
   7AA0 E0                 2056 	movx	a,@dptr
   7AA1 54 FE              2057 	anl	a,#0xfe
   7AA3 F0                 2058 	movx	@dptr,a
                           2059 ;	../../shared/src/tx_train_if.c:11: reg_INT_LOCAL_CTRL_RESET_LANE = 0;
   7AA4 90 26 76           2060 	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
   7AA7 E0                 2061 	movx	a,@dptr
   7AA8 54 7F              2062 	anl	a,#0x7f
   7AAA F0                 2063 	movx	@dptr,a
                           2064 ;	../../shared/src/tx_train_if.c:12: reg_INT_TX_PRESET_INDEX_LANE_3_0 = 0;
   7AAB 90 26 74           2065 	mov	dptr,#_TX_TRAIN_IF_REG7
   7AAE E0                 2066 	movx	a,@dptr
   7AAF 54 0F              2067 	anl	a,#0x0f
   7AB1 F0                 2068 	movx	@dptr,a
                           2069 ;	../../shared/src/tx_train_if.c:13: reg_INT_LOCAL_CTRL_G0_LANE_1_0 = 0;
   7AB2 90 26 76           2070 	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
   7AB5 E0                 2071 	movx	a,@dptr
   7AB6 54 F9              2072 	anl	a,#0xf9
   7AB8 F0                 2073 	movx	@dptr,a
                           2074 ;	../../shared/src/tx_train_if.c:14: reg_INT_LOCAL_CTRL_G1_LANE_1_0 = 0;
   7AB9 90 26 76           2075 	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
   7ABC E0                 2076 	movx	a,@dptr
   7ABD 54 E7              2077 	anl	a,#0xe7
   7ABF F0                 2078 	movx	@dptr,a
                           2079 ;	../../shared/src/tx_train_if.c:15: reg_INT_LOCAL_CTRL_GN1_LANE_1_0 = 0;
   7AC0 90 26 76           2080 	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
   7AC3 E0                 2081 	movx	a,@dptr
   7AC4 54 9F              2082 	anl	a,#0x9f
   7AC6 F0                 2083 	movx	@dptr,a
                           2084 ;	../../shared/src/tx_train_if.c:19: reg_STATUS_DET_TIMEOUT_ISR_CLEAR_LANE = 0;
   7AC7 90 26 65           2085 	mov	dptr,#(_TRX_TRAIN_IF_INTERRUPT_CLEAR_LANE + 0x0001)
   7ACA E0                 2086 	movx	a,@dptr
   7ACB 54 DF              2087 	anl	a,#0xdf
   7ACD F0                 2088 	movx	@dptr,a
                           2089 ;	../../shared/src/tx_train_if.c:20: drv_TXTRAIN_STATUS_C0 = 0;
   7ACE 90 62 17           2090 	mov	dptr,#(_TXTRAIN_IF_REG0 + 0x0003)
   7AD1 E0                 2091 	movx	a,@dptr
   7AD2 54 F8              2092 	anl	a,#0xf8
   7AD4 F0                 2093 	movx	@dptr,a
                           2094 ;	../../shared/src/tx_train_if.c:21: drv_TXTRAIN_STATUS_C1 = 0;
   7AD5 90 62 17           2095 	mov	dptr,#(_TXTRAIN_IF_REG0 + 0x0003)
   7AD8 E0                 2096 	movx	a,@dptr
   7AD9 54 C7              2097 	anl	a,#0xc7
   7ADB F0                 2098 	movx	@dptr,a
                           2099 ;	../../shared/src/tx_train_if.c:22: drv_TXTRAIN_STATUS_CN1 = 0;
   7ADC 90 62 16           2100 	mov	dptr,#(_TXTRAIN_IF_REG0 + 0x0002)
   7ADF E0                 2101 	movx	a,@dptr
   7AE0 54 C7              2102 	anl	a,#0xc7
   7AE2 F0                 2103 	movx	@dptr,a
   7AE3 22                 2104 	ret
                           2105 ;------------------------------------------------------------
                           ...
                           2112 ;	-----------------------------------------
   7AE4                    2113 _set_train_comp:
                           2114 ;	../../shared/src/tx_train_if.c:30: if(drv_TXTRAIN_FAIL) {
   7AE4 90 62 15           2115 	mov	dptr,#(_TXTRAIN_IF_REG0 + 0x0001)
   7AE7 E0                 2116 	movx	a,@dptr
   7AE8 30 E6 07           2117 	jnb	acc.6,00102$
                           2118 ;	../../shared/src/tx_train_if.c:31: reg_INT_TX_TRAIN_FAILED_LANE = 1;
   7AEB 90 26 7B           2119 	mov	dptr,#(_TX_TRAIN_CTRL_LANE + 0x0003)
   7AEE E0                 2120 	movx	a,@dptr
   7AEF 44 08              2121 	orl	a,#0x08
   7AF1 F0                 2122 	movx	@dptr,a
   7AF2                    2123 00102$:
                           2124 ;	../../shared/src/tx_train_if.c:33: reg_INT_TX_TRAIN_COMPLETE_LANE = 1;
   7AF2 90 26 7B           2125 	mov	dptr,#(_TX_TRAIN_CTRL_LANE + 0x0003)
   7AF5 E0                 2126 	movx	a,@dptr
   7AF6 44 10              2127 	orl	a,#0x10
   7AF8 F0                 2128 	movx	@dptr,a
   7AF9 22                 2129 	ret
                           2130 ;------------------------------------------------------------
                           ...
                           2137 ;	-----------------------------------------
   7AFA                    2138 _set_remote_tx_pam2:
                           2139 ;	../../shared/src/tx_train_if.c:41: if(drv_TXTRAIN_CTRL_PRESET) {
   7AFA 90 62 15           2140 	mov	dptr,#(_TXTRAIN_IF_REG0 + 0x0001)
   7AFD E0                 2141 	movx	a,@dptr
   7AFE 54 3C              2142 	anl	a,#0x3c
   7B00 60 35              2143 	jz	00102$
                           2144 ;	../../shared/src/tx_train_if.c:42: reg_INT_LOCAL_CTRL_RESET_LANE = 1;
   7B02 90 26 76           2145 	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
   7B05 E0                 2146 	movx	a,@dptr
   7B06 44 80              2147 	orl	a,#0x80
   7B08 F0                 2148 	movx	@dptr,a
                           2149 ;	../../shared/src/tx_train_if.c:43: reg_INT_TX_PRESET_INDEX_LANE_3_0 = drv_TXTRAIN_CTRL_PRESET;
   7B09 90 62 15           2150 	mov	dptr,#(_TXTRAIN_IF_REG0 + 0x0001)
   7B0C E0                 2151 	movx	a,@dptr
   7B0D 03                 2152 	rr	a
   7B0E 03                 2153 	rr	a
   7B0F 54 0F              2154 	anl	a,#0x0f
   7B11 FA                 2155 	mov	r2,a
   7B12 90 26 74           2156 	mov	dptr,#_TX_TRAIN_IF_REG7
   7B15 C4                 2157 	swap	a
   7B16 54 F0              2158 	anl	a,#(0xf0&0xf0)
   7B18 F5 F0              2159 	mov	b,a
   7B1A E0                 2160 	movx	a,@dptr
   7B1B 54 0F              2161 	anl	a,#0x0f
   7B1D 45 F0              2162 	orl	a,b
   7B1F F0                 2163 	movx	@dptr,a
                           2164 ;	../../shared/src/tx_train_if.c:44: reg_INT_LOCAL_CTRL_G0_LANE_1_0 = 0;
   7B20 90 26 76           2165 	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
   7B23 E0                 2166 	movx	a,@dptr
   7B24 54 F9              2167 	anl	a,#0xf9
   7B26 F0                 2168 	movx	@dptr,a
                           2169 ;	../../shared/src/tx_train_if.c:45: reg_INT_LOCAL_CTRL_G1_LANE_1_0 = 0;
   7B27 90 26 76           2170 	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
   7B2A E0                 2171 	movx	a,@dptr
   7B2B 54 E7              2172 	anl	a,#0xe7
   7B2D F0                 2173 	movx	@dptr,a
                           2174 ;	../../shared/src/tx_train_if.c:46: reg_INT_LOCAL_CTRL_GN1_LANE_1_0 = 0;
   7B2E 90 26 76           2175 	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
   7B31 E0                 2176 	movx	a,@dptr
   7B32 54 9F              2177 	anl	a,#0x9f
   7B34 F0                 2178 	movx	@dptr,a
   7B35 80 51              2179 	sjmp	00103$
   7B37                    2180 00102$:
                           2181 ;	../../shared/src/tx_train_if.c:48: reg_INT_LOCAL_CTRL_RESET_LANE = 0;
   7B37 90 26 76           2182 	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
   7B3A E0                 2183 	movx	a,@dptr
   7B3B 54 7F              2184 	anl	a,#0x7f
   7B3D F0                 2185 	movx	@dptr,a
                           2186 ;	../../shared/src/tx_train_if.c:49: reg_INT_TX_PRESET_INDEX_LANE_3_0 = 0;
   7B3E 90 26 74           2187 	mov	dptr,#_TX_TRAIN_IF_REG7
   7B41 E0                 2188 	movx	a,@dptr
   7B42 54 0F              2189 	anl	a,#0x0f
   7B44 F0                 2190 	movx	@dptr,a
                           2191 ;	../../shared/src/tx_train_if.c:50: reg_INT_LOCAL_CTRL_G0_LANE_1_0 = drv_TXTRAIN_CTRL_C0;
   7B45 90 62 14           2192 	mov	dptr,#_TXTRAIN_IF_REG0
   7B48 E0                 2193 	movx	a,@dptr
   7B49 23                 2194 	rl	a
   7B4A 23                 2195 	rl	a
   7B4B 54 03              2196 	anl	a,#0x03
   7B4D 90 26 76           2197 	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
   7B50 25 E0              2198 	add	a,acc
   7B52 54 06              2199 	anl	a,#0x06
   7B54 F5 F0              2200 	mov	b,a
   7B56 E0                 2201 	movx	a,@dptr
   7B57 54 F9              2202 	anl	a,#0xf9
   7B59 45 F0              2203 	orl	a,b
   7B5B F0                 2204 	movx	@dptr,a
                           2205 ;	../../shared/src/tx_train_if.c:51: reg_INT_LOCAL_CTRL_G1_LANE_1_0 = drv_TXTRAIN_CTRL_C1;
   7B5C 90 62 15           2206 	mov	dptr,#(_TXTRAIN_IF_REG0 + 0x0001)
   7B5F E0                 2207 	movx	a,@dptr
   7B60 54 03              2208 	anl	a,#0x03
   7B62 90 26 76           2209 	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
   7B65 C4                 2210 	swap	a
   7B66 03                 2211 	rr	a
   7B67 54 18              2212 	anl	a,#(0xf8&0x18)
   7B69 F5 F0              2213 	mov	b,a
   7B6B E0                 2214 	movx	a,@dptr
   7B6C 54 E7              2215 	anl	a,#0xe7
   7B6E 45 F0              2216 	orl	a,b
   7B70 F0                 2217 	movx	@dptr,a
                           2218 ;	../../shared/src/tx_train_if.c:52: reg_INT_LOCAL_CTRL_GN1_LANE_1_0 = drv_TXTRAIN_CTRL_CN1;
   7B71 90 62 14           2219 	mov	dptr,#_TXTRAIN_IF_REG0
   7B74 E0                 2220 	movx	a,@dptr
   7B75 C4                 2221 	swap	a
   7B76 54 03              2222 	anl	a,#0x03
   7B78 FA                 2223 	mov	r2,a
   7B79 90 26 76           2224 	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
   7B7C C4                 2225 	swap	a
   7B7D 23                 2226 	rl	a
   7B7E 54 60              2227 	anl	a,#(0xe0&0x60)
   7B80 F5 F0              2228 	mov	b,a
   7B82 E0                 2229 	movx	a,@dptr
   7B83 54 9F              2230 	anl	a,#0x9f
   7B85 45 F0              2231 	orl	a,b
   7B87 F0                 2232 	movx	@dptr,a
   7B88                    2233 00103$:
                           2234 ;	../../shared/src/tx_train_if.c:55: reg_INT_LOCAL_CTRL_REQ_LANE = 1;
   7B88 90 26 76           2235 	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
   7B8B E0                 2236 	movx	a,@dptr
   7B8C 44 01              2237 	orl	a,#0x01
   7B8E F0                 2238 	movx	@dptr,a
   ...
   7B8F                    2240 00106$:
   7B8F 90 26 6C           2241 	mov	dptr,#_TX_TRAIN_IF_REG5
   7B92 E0                 2242 	movx	a,@dptr
   7B93 20 E0 0E           2243 	jb	acc.0,00108$
   7B96 90 26 7B           2244 	mov	dptr,#(_TX_TRAIN_CTRL_LANE + 0x0003)
   7B99 E0                 2245 	movx	a,@dptr
   7B9A 20 E3 07           2246 	jb	acc.3,00108$
   7B9D 90 26 79           2247 	mov	dptr,#(_TX_TRAIN_CTRL_LANE + 0x0001)
   7BA0 E0                 2248 	movx	a,@dptr
   7BA1 20 E6 EB           2249 	jb	acc.6,00106$
   7BA4                    2250 00108$:
                           2251 ;	../../shared/src/tx_train_if.c:60: drv_TXTRAIN_STATUS_C0 = reg_INT_REMOTE_STATUS_G0_LANE_1_0;
   7BA4 90 26 6C           2252 	mov	dptr,#_TX_TRAIN_IF_REG5
   7BA7 E0                 2253 	movx	a,@dptr
   7BA8 03                 2254 	rr	a
   7BA9 54 03              2255 	anl	a,#0x03
   7BAB 90 62 17           2256 	mov	dptr,#(_TXTRAIN_IF_REG0 + 0x0003)
   7BAE 54 07              2257 	anl	a,#0x07
   7BB0 F5 F0              2258 	mov	b,a
   7BB2 E0                 2259 	movx	a,@dptr
   7BB3 54 F8              2260 	anl	a,#0xf8
   7BB5 45 F0              2261 	orl	a,b
   7BB7 F0                 2262 	movx	@dptr,a
                           2263 ;	../../shared/src/tx_train_if.c:61: drv_TXTRAIN_STATUS_C1 = reg_INT_REMOTE_STATUS_G1_LANE_1_0;
   7BB8 90 26 6C           2264 	mov	dptr,#_TX_TRAIN_IF_REG5
   7BBB E0                 2265 	movx	a,@dptr
   7BBC C4                 2266 	swap	a
   7BBD 23                 2267 	rl	a
   7BBE 54 03              2268 	anl	a,#0x03
   7BC0 90 62 17           2269 	mov	dptr,#(_TXTRAIN_IF_REG0 + 0x0003)
   7BC3 C4                 2270 	swap	a
   7BC4 03                 2271 	rr	a
   7BC5 54 38              2272 	anl	a,#(0xf8&0x38)
   7BC7 F5 F0              2273 	mov	b,a
   7BC9 E0                 2274 	movx	a,@dptr
   7BCA 54 C7              2275 	anl	a,#0xc7
   7BCC 45 F0              2276 	orl	a,b
   7BCE F0                 2277 	movx	@dptr,a
                           2278 ;	../../shared/src/tx_train_if.c:62: drv_TXTRAIN_STATUS_CN1 = reg_INT_REMOTE_STATUS_GN1_LANE_1_0;
   7BCF 90 26 6C           2279 	mov	dptr,#_TX_TRAIN_IF_REG5
   7BD2 E0                 2280 	movx	a,@dptr
   7BD3 C4                 2281 	swap	a
   7BD4 03                 2282 	rr	a
   7BD5 54 03              2283 	anl	a,#0x03
   7BD7 90 62 16           2284 	mov	dptr,#(_TXTRAIN_IF_REG0 + 0x0002)
   7BDA C4                 2285 	swap	a
   7BDB 03                 2286 	rr	a
   7BDC 54 38              2287 	anl	a,#(0xf8&0x38)
   7BDE F5 F0              2288 	mov	b,a
   7BE0 E0                 2289 	movx	a,@dptr
   7BE1 54 C7              2290 	anl	a,#0xc7
   7BE3 45 F0              2291 	orl	a,b
   7BE5 F0                 2292 	movx	@dptr,a
   7BE6 22                 2293 	ret
                           2294 ;------------------------------------------------------------
                           ...
                           2301 ;	-----------------------------------------
   7BE7                    2302 _set_remote_tx:
                           2303 ;	../../shared/src/tx_train_if.c:132: while(reg_INT_REMOTE_STATUS_ACK_LANE);
   7BE7                    2304 00101$:
   7BE7 90 26 6C           2305 	mov	dptr,#_TX_TRAIN_IF_REG5
   7BEA E0                 2306 	movx	a,@dptr
   7BEB 20 E0 F9           2307 	jb	acc.0,00101$
                           2308 ;	../../shared/src/tx_train_if.c:137: set_remote_tx_pam2();
   7BEE 12 7A FA           2309 	lcall	_set_remote_tx_pam2
                           2310 ;	../../shared/src/tx_train_if.c:141: reg_INT_LOCAL_CTRL_REQ_LANE = 0;
   7BF1 90 26 76           2311 	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
   7BF4 E0                 2312 	movx	a,@dptr
   7BF5 54 FE              2313 	anl	a,#0xfe
   7BF7 F0                 2314 	movx	@dptr,a
                           2315 ;	../../shared/src/tx_train_if.c:144: reg_STATUS_DET_TIMEOUT_ISR_CLEAR_LANE = 0;
   7BF8 90 26 65           2316 	mov	dptr,#(_TRX_TRAIN_IF_INTERRUPT_CLEAR_LANE + 0x0001)
   7BFB E0                 2317 	movx	a,@dptr
   7BFC 54 DF              2318 	anl	a,#0xdf
   7BFE F0                 2319 	movx	@dptr,a
                           2320 ;	../../shared/src/tx_train_if.c:147: if(reg_STATUS_DET_TIMEOUT_ISR_LANE || reg_TX_TRAIN_FAILED_LANE) {
   7BFF 90 26 5D           2321 	mov	dptr,#(_TRX_TRAIN_IF_INTERRUPT_LANE + 0x0001)
   7C02 E0                 2322 	movx	a,@dptr
   7C03 20 E5 07           2323 	jb	acc.5,00104$
   7C06 90 26 7B           2324 	mov	dptr,#(_TX_TRAIN_CTRL_LANE + 0x0003)
   7C09 E0                 2325 	movx	a,@dptr
   7C0A 30 E3 09           2326 	jnb	acc.3,00105$
   7C0D                    2327 00104$:
                           2328 ;	../../shared/src/tx_train_if.c:148: drv_TXTRAIN_STATUS_VALID = 0;
   7C0D 90 62 17           2329 	mov	dptr,#(_TXTRAIN_IF_REG0 + 0x0003)
   7C10 E0                 2330 	movx	a,@dptr
   7C11 54 BF              2331 	anl	a,#0xbf
   7C13 F0                 2332 	movx	@dptr,a
   7C14 80 07              2333 	sjmp	00106$
   7C16                    2334 00105$:
                           2335 ;	../../shared/src/tx_train_if.c:150: drv_TXTRAIN_STATUS_VALID = 1;
   7C16 90 62 17           2336 	mov	dptr,#(_TXTRAIN_IF_REG0 + 0x0003)
   7C19 E0                 2337 	movx	a,@dptr
   7C1A 44 40              2338 	orl	a,#0x40
   7C1C F0                 2339 	movx	@dptr,a
   7C1D                    2340 00106$:
                           2341 ;	../../shared/src/tx_train_if.c:153: reg_STATUS_DET_TIMEOUT_ISR_CLEAR_LANE = 1;
   7C1D 90 26 65           2342 	mov	dptr,#(_TRX_TRAIN_IF_INTERRUPT_CLEAR_LANE + 0x0001)
   7C20 E0                 2343 	movx	a,@dptr
   7C21 44 20              2344 	orl	a,#0x20
   7C23 F0                 2345 	movx	@dptr,a
   7C24 22                 2346 	ret
                           2347 	.area CSEG    (CODE)
