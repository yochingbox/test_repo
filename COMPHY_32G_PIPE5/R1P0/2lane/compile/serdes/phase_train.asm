...
;--------------------------------------------------------
	...
	.globl _cdr_phase_opt
	.globl _cdr_phase_opt_init
	.globl _cdr_phase_maxf0p
	.globl _cdr_phase_midpoint
	.globl _cdr_phase_opt_final_processing
	.globl _calculatef0p
	.globl _advanced_clk_align
	.globl _dfe_adapt_align
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area BANK1   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'cdr_phase_opt'
;------------------------------------------------------------
;cdr_num                   Allocated to registers r2 
;------------------------------------------------------------
;	../../shared/src/phase_train.c:27: void cdr_phase_opt(void) BANKING_CTRL
;	-----------------------------------------
;	 function cdr_phase_opt
;	-----------------------------------------
_cdr_phase_opt:
	ar2 = 0x02
	ar3 = 0x03
	...
	ar0 = 0x00
	ar1 = 0x01
;	../../shared/src/phase_train.c:35: if (train.level >= 5 || train.eo > tag_CDR_EO_BYPASS_THRES) //tag_CDR_EO_BYPASS_THRES=63
...
00124$:
	jnc	00102$
00101$:
;	../../shared/src/phase_train.c:36: return; 
	sjmp	00113$
00102$:
;	../../shared/src/phase_train.c:40: cdr_phase_opt_init();
	mov	r0,#_cdr_phase_opt_init
	mov	r1,#(_cdr_phase_opt_init >> 8)
	mov	r2,#(_cdr_phase_opt_init >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_train.c:42: if (tag_CDR_MAXF0P_EN)  //1
	mov	dptr,#_CDS_CTRL_REG0
	movx	a,@dptr
	jnb	acc.6,00105$
;	../../shared/src/phase_train.c:43: cdr_phase_maxf0p(); 	
	mov	r0,#_cdr_phase_maxf0p
	mov	r1,#(_cdr_phase_maxf0p >> 8)
	mov	r2,#(_cdr_phase_maxf0p >> 16)
	lcall	__sdcc_banked_call
00105$:
;	../../shared/src/phase_train.c:45: if (tag_CDR_MIDPOINT_EN) { //1
	mov	dptr,#_DFE_CONTROL_1
	movx	a,@dptr
	jnb	acc.0,00110$
;	../../shared/src/phase_train.c:48: while(cdr_num-->0) {
	mov	r2,#0x01
00106$:
	mov	ar3,r2
	dec	r2
	...
	subb	a,b
	jnc	00110$
;	../../shared/src/phase_train.c:49: cdr_phase_midpoint(); 
	push	ar2
	mov	r0,#_cdr_phase_midpoint
	mov	r1,#(_cdr_phase_midpoint >> 8)
	mov	r2,#(_cdr_phase_midpoint >> 16)
	lcall	__sdcc_banked_call
	pop	ar2
	sjmp	00106$
00110$:
;	../../shared/src/phase_train.c:53: cdr_phase_opt_final_processing();
	mov	r0,#_cdr_phase_opt_final_processing
	mov	r1,#(_cdr_phase_opt_final_processing >> 8)
	mov	r2,#(_cdr_phase_opt_final_processing >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_train.c:55: if(lnx_FORCE_PHASE_TRAIN_OFFSET_EN_LANE) {
	mov	dptr,#(_DFE_CONTROL_3 + 0x0003)
	movx	a,@dptr
	jnb	acc.0,00113$
;	../../shared/src/phase_train.c:56: train.phase_offset_data = (int8_t)lnx_FORCE_PHASE_TRAIN_OFFSET_2C_LANE_7_0;
	mov	dptr,#_DFE_CONTROL_8
	movx	a,@dptr
	mov	dptr,#(_train + 0x0021)
	movx	@dptr,a
;	../../shared/src/phase_train.c:57: phase_control_func();
	lcall	_phase_control_func
;	../../shared/src/phase_train.c:58: dfe_adaptation();
...
;------------------------------------------------------------
;Allocation info for local variables in function 'cdr_phase_opt_init'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/phase_train.c:72: void cdr_phase_opt_init(void) BANKING_CTRL
;	-----------------------------------------
;	 function cdr_phase_opt_init
;	-----------------------------------------
_cdr_phase_opt_init:
;	../../shared/src/phase_train.c:75: calculatef0p();
	mov	r0,#_calculatef0p
	mov	r1,#(_calculatef0p >> 8)
	mov	r2,#(_calculatef0p >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_train.c:76: cdr.num_count = 0;
	mov	dptr,#_cdr
;	../../shared/src/phase_train.c:77: cdr.direction = 0; // go left in the beginning
;	../../shared/src/phase_train.c:78: cdr.become_worse = 0;
	clr	a
	movx	@dptr,a
	mov	dptr,#(_cdr + 0x0001)
	movx	@dptr,a
	mov	dptr,#(_cdr + 0x000b)
	movx	@dptr,a
;	../../shared/src/phase_train.c:79: cdr.ini_phase_offset = train.phase_offset_data; 
	mov	dptr,#(_train + 0x0021)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#(_cdr + 0x0006)
	movx	@dptr,a
;	../../shared/src/phase_train.c:80: cdr.ini_f0p = cdr.train_f0p;
	mov	dptr,#(_cdr + 0x0002)
	movx	a,@dptr
	mov	r3,a
	mov	dptr,#(_cdr + 0x0008)
	movx	@dptr,a
;	../../shared/src/phase_train.c:81: cdr.ini_level = train.level;
	mov	dptr,#(_train + 0x0023)
	movx	a,@dptr
	mov	r4,a
	mov	dptr,#(_cdr + 0x0007)
	movx	@dptr,a
;	../../shared/src/phase_train.c:82: cdr.opt_phase_offset = cdr.ini_phase_offset;
	mov	dptr,#(_cdr + 0x0005)
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/phase_train.c:83: cdr.opt_f0p = cdr.train_f0p;
	mov	dptr,#(_cdr + 0x0004)
	mov	a,r3
	movx	@dptr,a
;	../../shared/src/phase_train.c:84: cdr.opt_level = train.level;
	mov	dptr,#(_cdr + 0x0003)
	mov	a,r4
	movx	@dptr,a
;	../../shared/src/phase_train.c:85: cdr.min_phase_os = (ph_control_mode == 0 || ph_control_mode == 1)? tag_CDR_MIN_PHASE_OS_MODE01:tag_CDR_MIN_PHASE_OS_MODE23;
...
00103$:
	mov	r4,#0xC4
00104$:
	mov	dptr,#(_cdr + 0x0009)
	mov	a,r4
	movx	@dptr,a
;	../../shared/src/phase_train.c:86: cdr.max_phase_os = (ph_control_mode == 0 || ph_control_mode == 1)? tag_CDR_MAX_PHASE_OS_MODE01:tag_CDR_MAX_PHASE_OS_MODE23;
	mov	a,r3
	jnz	00111$
	cjne	r2,#0x01,00124$
	sjmp	00111$
...
00108$:
	mov	r2,#0x3C
00109$:
	mov	dptr,#(_cdr + 0x000a)
	mov	a,r2
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'cdr_phase_maxf0p'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/phase_train.c:105: void cdr_phase_maxf0p(void) BANKING_CTRL
;	-----------------------------------------
;	 function cdr_phase_maxf0p
;	-----------------------------------------
_cdr_phase_maxf0p:
;	../../shared/src/phase_train.c:112: while (1)
00120$:
;	../../shared/src/phase_train.c:118: (cdr.direction == 0) && //-1
	mov	dptr,#(_cdr + 0x0001)
	movx	a,@dptr
	jnz	00102$
;	../../shared/src/phase_train.c:119: ((cdr.num_count >= tag_CDR_STEP_NUM) || //8
	mov	dptr,#_cdr
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#(_CDS_CTRL_REG1 + 0x0001)
	movx	a,@dptr
	swap	a
	anl	a,#0x0f
	mov	r3,a
	...
	subb	a,b
	jnc	00101$
;	../../shared/src/phase_train.c:120: ((train.phase_offset_data) <= cdr.min_phase_os) || //??
	mov	dptr,#(_train + 0x0021)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#(_cdr + 0x0009)
	...
	subb	a,b
	jnc	00101$
;	../../shared/src/phase_train.c:121: (cdr.become_worse==1))
	mov	dptr,#(_cdr + 0x000b)
	movx	a,@dptr
	mov	r2,a
	cjne	r2,#0x01,00102$
00101$:
;	../../shared/src/phase_train.c:124: cdr.direction = 1;
	mov	dptr,#(_cdr + 0x0001)
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/phase_train.c:125: cdr.num_count = 0;
	mov	dptr,#_cdr
;	../../shared/src/phase_train.c:126: cdr.become_worse = 0;
	clr	a
	movx	@dptr,a
	mov	dptr,#(_cdr + 0x000b)
	movx	@dptr,a
;	../../shared/src/phase_train.c:127: train.phase_offset_data = cdr.ini_phase_offset;
	mov	dptr,#(_cdr + 0x0006)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#(_train + 0x0021)
	movx	@dptr,a
00102$:
;	../../shared/src/phase_train.c:131: if ((  ( cdr.num_count >= tag_CDR_STEP_NUM ) //8
	mov	dptr,#_cdr
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#(_CDS_CTRL_REG1 + 0x0001)
	...
	subb	a,b
	jnc	00118$
;	../../shared/src/phase_train.c:132: || ( (train.phase_offset_data) >= cdr.max_phase_os ) //31
	mov	dptr,#(_train + 0x0021)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#(_cdr + 0x000a)
	...
	subb	a,b
	jnc	00118$
;	../../shared/src/phase_train.c:133: || cdr.become_worse) && (cdr.direction == 1 ))			
	mov	dptr,#(_cdr + 0x000b)
	movx	a,@dptr
	jz	00114$
00118$:
	...
	ljmp	00122$
00145$:
;	../../shared/src/phase_train.c:135: break;//CGR Phase Maxf0p State End
00114$:
;	../../shared/src/phase_train.c:139: if( cdr.direction == 0)	train.phase_offset_data -= tag_CDR_PHASE_STEP_SIZE; //2 compute the phase offset
	mov	dptr,#(_cdr + 0x0001)
	movx	a,@dptr
	jnz	00107$
	mov	dptr,#(_train + 0x0021)
	...
	sjmp	00108$
00107$:
;	../../shared/src/phase_train.c:140: else		train.phase_offset_data += tag_CDR_PHASE_STEP_SIZE; 
	mov	dptr,#(_train + 0x0021)
	movx	a,@dptr
	mov	r2,a
	inc	r2
	...
	movx	@dptr,a
00108$:
;	../../shared/src/phase_train.c:141: train.phase_offset_data = clamp(train.phase_offset_data,cdr.max_phase_os,cdr.min_phase_os);
	mov	dptr,#(_cdr + 0x0009)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#(_cdr + 0x000a)
	...
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/phase_train.c:143: cdr.num_count ++; //update number of rounds
	mov	dptr,#_cdr
	movx	a,@dptr
	mov	r2,a
	inc	r2
	...
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/phase_train.c:146: dfe_adaptation();
	mov	r0,#_dfe_adaptation
	mov	r1,#(_dfe_adaptation >> 8)
	mov	r2,#(_dfe_adaptation >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_train.c:147: calculatef0p();
	mov	r0,#_calculatef0p
	mov	r1,#(_calculatef0p >> 8)
	mov	r2,#(_calculatef0p >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_train.c:152: cdr.become_worse = (tag_CDR_STOP_IF_WORSE && (cdr.train_f0p < (cdr.opt_f0p - tag_CDR_STOPPING_THRE)));
	mov	dptr,#(_cdr + 0x0002)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#(_cdr + 0x0004)
...
00126$:
	...
	mov	a,r5
	movx	@dptr,a
;	../../shared/src/phase_train.c:157: if ( (train.level > cdr.opt_level) ||                              //0
	mov	dptr,#(_train + 0x0023)
	movx	a,@dptr
	mov	r5,a
	mov	dptr,#(_cdr + 0x0003)
...
00148$:
	jc	00109$
;	../../shared/src/phase_train.c:158: ((train.level == cdr.opt_level) && (cdr.train_f0p > (cdr.opt_f0p + tag_CDR_F0P_PHASEUPDATE_THRES)) )) // if the current train sampling phase has a larger f0p, update
	mov	a,r5
	cjne	a,ar6,00150$
	sjmp	00151$
00150$:
...
00152$:
00109$:
;	../../shared/src/phase_train.c:160: cdr.opt_phase_offset = train.phase_offset_data; // update the phase offset
	mov	dptr,#(_train + 0x0021)
	movx	a,@dptr
	mov	r3,a
	mov	dptr,#(_cdr + 0x0005)
	movx	@dptr,a
;	../../shared/src/phase_train.c:161: cdr.opt_f0p = cdr.train_f0p; //update f0p
	mov	dptr,#(_cdr + 0x0004)
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/phase_train.c:162: cdr.opt_level = train.level;
	mov	dptr,#(_cdr + 0x0003)
	mov	a,r5
	movx	@dptr,a
	ljmp	00120$
00122$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'cdr_phase_midpoint'
;------------------------------------------------------------
;thres_large               Allocated to registers r2 
;thres_small               Allocated to registers r3 
;------------------------------------------------------------
;	../../shared/src/phase_train.c:208: void cdr_phase_midpoint(void) BANKING_CTRL
;	-----------------------------------------
;	 function cdr_phase_midpoint
;	-----------------------------------------
_cdr_phase_midpoint:
;	../../shared/src/phase_train.c:215: cdr.direction = 0; //-1
	mov	dptr,#(_cdr + 0x0001)
;	../../shared/src/phase_train.c:216: cdr.become_worse = 0;
	clr	a
	movx	@dptr,a
	mov	dptr,#(_cdr + 0x000b)
	movx	@dptr,a
;	../../shared/src/phase_train.c:217: train.phase_offset_data = cdr.opt_phase_offset;
	mov	dptr,#(_cdr + 0x0005)
	movx	a,@dptr
	mov	dptr,#(_train + 0x0021)
	movx	@dptr,a
;	../../shared/src/phase_train.c:219: dfe_adaptation();
	mov	r0,#_dfe_adaptation
	mov	r1,#(_dfe_adaptation >> 8)
	mov	r2,#(_dfe_adaptation >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_train.c:220: calculatef0p();
	mov	r0,#_calculatef0p
	mov	r1,#(_calculatef0p >> 8)
	mov	r2,#(_calculatef0p >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_train.c:221: cdr.opt_f0p = cdr.train_f0p; 
	mov	dptr,#(_cdr + 0x0002)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#(_cdr + 0x0004)
	movx	@dptr,a
;	../../shared/src/phase_train.c:222: cdr.opt_level = train.level;
	mov	dptr,#(_train + 0x0023)
	movx	a,@dptr
	mov	r3,a
	mov	dptr,#(_cdr + 0x0003)
	movx	@dptr,a
;	../../shared/src/phase_train.c:224: cdr.ini_phase_offset = cdr.opt_phase_offset;
	mov	dptr,#(_cdr + 0x0005)
	movx	a,@dptr
	mov	r4,a
	mov	dptr,#(_cdr + 0x0006)
	movx	@dptr,a
;	../../shared/src/phase_train.c:225: cdr.ini_level = cdr.opt_level;
	mov	dptr,#(_cdr + 0x0007)
	mov	a,r3
	movx	@dptr,a
;	../../shared/src/phase_train.c:226: cdr.ini_f0p = cdr.opt_f0p;
	mov	dptr,#(_cdr + 0x0008)
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/phase_train.c:227: cdr.phase_small = cdr.ini_phase_offset ;
	mov	dptr,#(_cdr + 0x000c)
	mov	a,r4
	movx	@dptr,a
;	../../shared/src/phase_train.c:228: cdr.phase_large = cdr.ini_phase_offset ;
	mov	dptr,#(_cdr + 0x000d)
	mov	a,r4
	movx	@dptr,a
;	../../shared/src/phase_train.c:235: if(lnx_SKIP_DFE_ADAPT_CDR_MIDPOINT_LANE) {	
	mov	dptr,#_DFE_CONTROL_10
	movx	a,@dptr
	jnb	acc.5,00156$
;	../../shared/src/phase_train.c:236: skip_dfe_adapt_cdr_midpoint = 1;
	mov	dptr,#_skip_dfe_adapt_cdr_midpoint
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/phase_train.c:239: while (1)
00156$:
00125$:
;	../../shared/src/phase_train.c:244: if ((cdr.become_worse || ((train.phase_offset_data) <= cdr.min_phase_os)) 
	mov	dptr,#(_cdr + 0x000b)
	movx	a,@dptr
	jnz	00108$
	mov	dptr,#(_train + 0x0021)
	...
	jc	00106$
00108$:
;	../../shared/src/phase_train.c:245: && (cdr.direction == 0)) //-1
	mov	dptr,#(_cdr + 0x0001)
	movx	a,@dptr
	jnz	00106$
;	../../shared/src/phase_train.c:250: cdr.direction = 1;
	mov	dptr,#(_cdr + 0x0001)
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/phase_train.c:251: cdr.num_count = 0;
	mov	dptr,#_cdr
;	../../shared/src/phase_train.c:252: cdr.become_worse = 0;
	clr	a
	movx	@dptr,a
	mov	dptr,#(_cdr + 0x000b)
	movx	@dptr,a
;	../../shared/src/phase_train.c:253: train.phase_offset_data = cdr.ini_phase_offset;
	mov	dptr,#(_cdr + 0x0006)
	movx	a,@dptr
	mov	dptr,#(_train + 0x0021)
	movx	@dptr,a
;	../../shared/src/phase_train.c:259: skip_dfe_adapt_cdr_midpoint = 0;
	mov	dptr,#_skip_dfe_adapt_cdr_midpoint
	clr	a
	movx	@dptr,a
;	../../shared/src/phase_train.c:260: dfe_adaptation();
	mov	r0,#_dfe_adaptation
	mov	r1,#(_dfe_adaptation >> 8)
	mov	r2,#(_dfe_adaptation >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_train.c:262: if(lnx_SKIP_DFE_ADAPT_CDR_MIDPOINT_LANE) {	
	mov	dptr,#_DFE_CONTROL_10
	movx	a,@dptr
	jnb	acc.5,00106$
;	../../shared/src/phase_train.c:263: skip_dfe_adapt_cdr_midpoint = 1;
	mov	dptr,#_skip_dfe_adapt_cdr_midpoint
	mov	a,#0x01
	movx	@dptr,a
00106$:
;	../../shared/src/phase_train.c:268: if ((cdr.become_worse || ((train.phase_offset_data) >= cdr.max_phase_os)) 
	mov	dptr,#(_cdr + 0x000b)
	movx	a,@dptr
	jnz	00123$
	mov	dptr,#(_train + 0x0021)
	...
	jc	00120$
00123$:
;	../../shared/src/phase_train.c:269: && (cdr.direction == 1))	{ 
	mov	dptr,#(_cdr + 0x0001)
	movx	a,@dptr
	mov	r2,a
	cjne	r2,#0x01,00166$
	ljmp	00127$
00166$:
;	../../shared/src/phase_train.c:273: break;
00120$:
;	../../shared/src/phase_train.c:279: if( cdr.direction == 1)
	mov	dptr,#(_cdr + 0x0001)
	movx	a,@dptr
	mov	r2,a
	cjne	r2,#0x01,00110$
;	../../shared/src/phase_train.c:280: train.phase_offset_data += tag_CDR_PHASE_STEP_SIZE; 
	mov	dptr,#(_train + 0x0021)
	movx	a,@dptr
	mov	r2,a
	inc	r2
	...
	sjmp	00111$
00110$:
;	../../shared/src/phase_train.c:282: train.phase_offset_data -= tag_CDR_PHASE_STEP_SIZE; 			
	mov	dptr,#(_train + 0x0021)
	movx	a,@dptr
	mov	r2,a
	dec	r2
	...
	movx	@dptr,a
00111$:
;	../../shared/src/phase_train.c:283: train.phase_offset_data = clamp(train.phase_offset_data, cdr.max_phase_os, cdr.min_phase_os);
	mov	dptr,#(_cdr + 0x0009)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#(_cdr + 0x000a)
	...
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/phase_train.c:292: dfe_adaptation();
	mov	r0,#_dfe_adaptation
	mov	r1,#(_dfe_adaptation >> 8)
	mov	r2,#(_dfe_adaptation >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_train.c:293: calculatef0p();
	mov	r0,#_calculatef0p
	mov	r1,#(_calculatef0p >> 8)
	mov	r2,#(_calculatef0p >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_train.c:298: thres_small = ((cdr.opt_f0p*tag_CDR_MIDPOINT_SMALL_THRES_K)>>tag_THRES_K_BASE) + tag_CDR_MIDPOINT_SMALL_THRES_C; //8 0
	mov	dptr,#(_cdr + 0x0004)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#(_TRAIN_CONTROL_0 + 0x0002)
	movx	a,@dptr
	swap	a
	anl	a,#0x0f
	mov	r3,a
...
00169$:
	...
	add	a,r3
	mov	r3,a
;	../../shared/src/phase_train.c:299: thres_large = ((cdr.opt_f0p*tag_CDR_MIDPOINT_LARGE_THRES_K)>>tag_THRES_K_BASE) + tag_CDR_MIDPOINT_LARGE_THRES_C; //9 2
	mov	dptr,#(_TRAIN_CONTROL_0 + 0x0003)
	movx	a,@dptr
	swap	a
	anl	a,#0x0f
	mov	r5,a
...
00170$:
	...
	add	a,r2
	mov	r2,a
;	../../shared/src/phase_train.c:300: cdr.become_worse = 
;	../../shared/src/phase_train.c:301: ( ( (cdr.direction == 0) && (cdr.train_f0p < thres_small) ) 
	mov	dptr,#(_cdr + 0x0001)
	movx	a,@dptr
	mov	r4,a
	jz	00172$
...
00138$:
	mov	a,r3
	jnz	00134$
;	../../shared/src/phase_train.c:302: || ( cdr.direction == 1 && (cdr.train_f0p < thres_large) )
	cjne	r4,#0x01,00139$
	mov	dptr,#(_cdr + 0x0002)
	movx	a,@dptr
	mov	r3,a
...
00135$:
	mov	a,r2
	jnz	00131$
;	../../shared/src/phase_train.c:303: || (cdr.train_f0p == 0)
	mov	dptr,#(_cdr + 0x0002)
	movx	a,@dptr
	mov	r2,a
	jz	00131$
...
00131$:
	mov	r2,#0x01
00132$:
;	../../shared/src/phase_train.c:309: if (!cdr.become_worse && cdr.direction == 0) // update phase_small and phase_large
	mov	dptr,#(_cdr + 0x000b)
	mov	a,r2
	movx	@dptr,a
	movx	a,@dptr
	...
	mov	a,r4
	jnz	00116$
;	../../shared/src/phase_train.c:311: cdr.phase_small = train.phase_offset_data;
	mov	dptr,#(_train + 0x0021)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#(_cdr + 0x000c)
	...
	ljmp	00125$
00116$:
;	../../shared/src/phase_train.c:316: else if (!cdr.become_worse && cdr.direction == 1)
	mov	dptr,#(_cdr + 0x000b)
	movx	a,@dptr
	jz	00183$
	ljmp	00125$
...
00184$:
	ljmp	00125$
00185$:
;	../../shared/src/phase_train.c:318: cdr.phase_large = train.phase_offset_data;
	mov	dptr,#(_train + 0x0021)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#(_cdr + 0x000d)
	movx	@dptr,a
	ljmp	00125$
;	../../shared/src/phase_train.c:326: End_State:
00127$:
;	../../shared/src/phase_train.c:327: cdr.opt_phase_offset = ((cdr.phase_small + cdr.phase_large) >> 1);// + cdr_midpoint_phase_os; //tag_CDR_MIDPOINT_PHASE_OS=0
	mov	dptr,#(_cdr + 0x000c)
	movx	a,@dptr
	mov	r2,a
	rlc	a
	...
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/phase_train.c:328: cdr.opt_phase_offset = clamp(cdr.opt_phase_offset, cdr.max_phase_os, cdr.min_phase_os);
	mov	dptr,#(_cdr + 0x0009)
	movx	a,@dptr
	mov	r3,a
	mov	dptr,#(_cdr + 0x000a)
	...
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/phase_train.c:330: lnx_EYE_LEFT_2C_LANE_7_0 = (uint8_t)cdr.phase_small;
	mov	dptr,#(_cdr + 0x000c)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#(_TRAIN_PARA_2 + 0x0003)
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/phase_train.c:331: lnx_EYE_RIGHT_2C_LANE_7_0 = (uint8_t)cdr.phase_large;	
	mov	dptr,#(_cdr + 0x000d)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#(_TRAIN_PARA_2 + 0x0002)
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/phase_train.c:332: lnx_EYE_MID_2C_LANE_7_0 = (uint8_t)cdr.opt_phase_offset;	
	mov	dptr,#(_cdr + 0x0005)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_DFE_CONTROL_9
	mov	a,r2
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'cdr_phase_opt_final_processing'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/phase_train.c:349: void cdr_phase_opt_final_processing(void) BANKING_CTRL
;	-----------------------------------------
;	 function cdr_phase_opt_final_processing
;	-----------------------------------------
_cdr_phase_opt_final_processing:
;	../../shared/src/phase_train.c:355: train.phase_offset_data = cdr.opt_phase_offset + cdr_midpoint_phase_os; 
	mov	dptr,#(_cdr + 0x0005)
	movx	a,@dptr
	mov	r2,a
	...
	mov	dptr,#(_train + 0x0021)
	movx	@dptr,a
;	../../shared/src/phase_train.c:357: dfe_adaptation();
	mov	r0,#_dfe_adaptation
	mov	r1,#(_dfe_adaptation >> 8)
	mov	r2,#(_dfe_adaptation >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_train.c:358: calculatef0p();
	mov	r0,#_calculatef0p
	mov	r1,#(_calculatef0p >> 8)
	mov	r2,#(_calculatef0p >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_train.c:368: if (( (train.level < cdr.ini_level && tag_CDR_PHASE_LEVEL_PROTECT_EN) || 
	mov	dptr,#(_train + 0x0023)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#(_cdr + 0x0007)
...
00116$:
	jc	00104$
;	../../shared/src/phase_train.c:369: ((train.level == cdr.ini_level) && (cdr.train_f0p < (cdr.ini_f0p - tag_CDR_F0P_REJECT_THRES))) || //8
	mov	a,r2
	cjne	a,ar3,00110$
	mov	dptr,#(_cdr + 0x0002)
	movx	a,@dptr
	...
	jc	00104$
00110$:
;	../../shared/src/phase_train.c:370: (train.level == 0 && tag_CDR_PHASE_EO_PROTECT_EN) ))
	mov	a,r2
	jnz	00111$
00104$:
;	../../shared/src/phase_train.c:384: train.phase_offset_data = cdr.ini_phase_offset; 
	mov	dptr,#(_cdr + 0x0006)
	movx	a,@dptr
	mov	dptr,#(_train + 0x0021)
	movx	@dptr,a
;	../../shared/src/phase_train.c:386: dfe_adaptation(); 
	mov	r0,#_dfe_adaptation
	mov	r1,#(_dfe_adaptation >> 8)
	mov	r2,#(_dfe_adaptation >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_train.c:388: if (tag_SAME_SET_NO_UPDATE || cdr.ini_level > train.level) //tag_SAME_SET_NO_UPDATE=1
	mov	dptr,#(_DFE_CONTROL_3 + 0x0003)
	movx	a,@dptr
	jb	acc.2,00101$
	mov	dptr,#(_cdr + 0x0007)
...
00123$:
	jnc	00111$
00101$:
;	../../shared/src/phase_train.c:390: train.level = cdr.ini_level;
	mov	dptr,#(_cdr + 0x0007)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#(_train + 0x0023)
...
00111$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'calculatef0p'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/phase_train.c:419: void calculatef0p(void) BANKING_CTRL
;	-----------------------------------------
;	 function calculatef0p
;	-----------------------------------------
_calculatef0p:
;	../../shared/src/phase_train.c:431: if(train.eye_check_pass) {
	mov	dptr,#(_train + 0x0015)
	movx	a,@dptr
	jz	00102$
;	../../shared/src/phase_train.c:433: cdr.train_f0p = train.eo;
	mov	dptr,#(_train + 0x001f)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#(_cdr + 0x0002)
	...
	sjmp	00104$
00102$:
;	../../shared/src/phase_train.c:438: else cdr.train_f0p = 0;		
	mov	dptr,#(_cdr + 0x0002)
	clr	a
	movx	@dptr,a
00104$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'advanced_clk_align'
;------------------------------------------------------------
;sum                       Allocated to registers r2 r3 
;align_ref                 Allocated to registers r2 
;align_tap                 Allocated to registers r5 
;clock_align_run1_index    Allocated to stack - offset 1
;clk_sum                   Allocated to stack - offset 2
;clk_step                  Allocated to registers r7 r6 
;------------------------------------------------------------
;	../../shared/src/phase_train.c:449: void advanced_clk_align(void) BANKING_CTRL {
;	-----------------------------------------
;	 function advanced_clk_align
;	-----------------------------------------
_advanced_clk_align:
	push	_bp
	mov	_bp,sp
	...
	inc	sp
	inc	sp
;	../../shared/src/phase_train.c:463: if(TRAIN_SIM_EN) return;
	mov	dptr,#(_CONTROL_CONFIG0 + 0x0003)
	movx	a,@dptr
	jnb	acc.2,00102$
	ljmp	00142$
00102$:
;	../../shared/src/phase_train.c:465: if(lnx_OFST_ALIGN_ADV_CLK_ALIGN_EN_LANE) {
	mov	dptr,#(_DFE_CONTROL_7 + 0x0002)
	movx	a,@dptr
	jnb	acc.0,00104$
;	../../shared/src/phase_train.c:466: cds_dfe_ofst = 1;
	mov	dptr,#_cds_dfe_ofst
	mov	a,#0x01
	movx	@dptr,a
00104$:
;	../../shared/src/phase_train.c:469: sum = 0;
	mov	r2,#0x00
	mov	r3,#0x00
;	../../shared/src/phase_train.c:472: do {
	mov	r4,#0x01
00105$:
;	../../shared/src/phase_train.c:473: align_tap = dfe_adapt_align();
	push	ar2
	push	ar3
	push	ar4
	mov	r0,#_dfe_adapt_align
	mov	r1,#(_dfe_adapt_align >> 8)
	mov	r2,#(_dfe_adapt_align >> 16)
	lcall	__sdcc_banked_call
	mov	r5,dpl
	pop	ar4
	pop	ar3
	pop	ar2
;	../../shared/src/phase_train.c:474: sum += align_tap;
	mov	a,r5
	mov	r6,a
	rlc	a
	subb	a,acc
	...
	addc	a,r3
	mov	r3,a
;	../../shared/src/phase_train.c:481: } while (clock_align_run1_index++<(1<<tag_CLOCK_ALIGN_RUN1_NUM));
	mov	ar6,r4
	inc	r4
	cjne	r6,#0x10,00184$
00184$:
	jc	00105$
;	../../shared/src/phase_train.c:483: align_ref = (int8_t)(sum>>tag_CLOCK_ALIGN_RUN1_NUM);
	mov	a,r3
	swap	a
	xch	a,r2
	swap	a
	...
	orl	a,#0xf0
00186$:
;	../../shared/src/phase_train.c:493: ph_control_mode = 0;
	mov	dptr,#_ph_control_mode
	clr	a
	movx	@dptr,a
;	../../shared/src/phase_train.c:494: cdr.min_phase_os = (ph_control_mode == 0 || ph_control_mode == 1)? tag_CDR_MIN_PHASE_OS_MODE01:tag_CDR_MIN_PHASE_OS_MODE23;
	mov	dptr,#(_cdr + 0x0009)
	mov	a,#0xE4
	movx	@dptr,a
;	../../shared/src/phase_train.c:495: cdr.max_phase_os = (ph_control_mode == 0 || ph_control_mode == 1)? tag_CDR_MAX_PHASE_OS_MODE01:tag_CDR_MAX_PHASE_OS_MODE23;
	mov	dptr,#(_cdr + 0x000a)
	mov	a,#0x12
	movx	@dptr,a
;	../../shared/src/phase_train.c:496: set_ph_mode();
	push	ar2
	mov	r0,#_set_ph_mode
	mov	r1,#(_set_ph_mode >> 8)
	mov	r2,#(_set_ph_mode >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_train.c:498: adapt_data_en = 1; //??
	setb	_adapt_data_en
;	../../shared/src/phase_train.c:499: adapt_slicer_en = 1;
	setb	_adapt_slicer_en
;	../../shared/src/phase_train.c:501: cdr.ini_phase_offset = train.phase_offset_data;
	mov	dptr,#(_train + 0x0021)
	movx	a,@dptr
	mov	r3,a
	mov	dptr,#(_cdr + 0x0006)
	movx	@dptr,a
;	../../shared/src/phase_train.c:502: adapted_phase = clamp( train.phase_offset_data, cdr.max_phase_os, cdr.min_phase_os);
	mov	dptr,#(_cdr + 0x0009)
	movx	a,@dptr
	mov	r4,a
	mov	dptr,#(_cdr + 0x000a)
	...
	dec	sp
	dec	sp
	mov	dptr,#_adapted_phase
	mov	a,r3
	movx	@dptr,a
;	../../shared/src/phase_train.c:503: train.phase_offset_esm = 0;
	mov	dptr,#(_train + 0x0022)
	clr	a
	movx	@dptr,a
;	../../shared/src/phase_train.c:504: phase_control_func();
	lcall	_phase_control_func
	pop	ar2
;	../../shared/src/phase_train.c:512: clk_sum = 0; clk_step = 0;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x00
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/phase_train.c:513: do {
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x00
00121$:
;	../../shared/src/phase_train.c:514: align_tap = dfe_adapt_align();
	push	ar2
	mov	r0,#_dfe_adapt_align
	mov	r1,#(_dfe_adapt_align >> 8)
	mov	r2,#(_dfe_adapt_align >> 16)
	...
	pop	ar2
	mov	ar5,r7
;	../../shared/src/phase_train.c:517: if(align_tap<align_ref) 
	clr	c
	mov	a,r5
	xrl	a,#0x80
	mov	b,r2
	...
	subb	a,b
	jnc	00111$
;	../../shared/src/phase_train.c:518: clk_sum--;
	mov	r0,_bp
	inc	r0
	inc	r0
	dec	@r0
...
00188$:
	sjmp	00112$
00111$:
;	../../shared/src/phase_train.c:519: else if(align_tap>align_ref)	
	clr	c
	mov	a,r2
	xrl	a,#0x80
	mov	b,r5
	...
	subb	a,b
	jnc	00112$
;	../../shared/src/phase_train.c:520: clk_sum++;
	mov	r0,_bp
	inc	r0
	inc	r0
	inc	@r0
...
00190$:
00112$:
;	../../shared/src/phase_train.c:522: if( clk_sum > 0)
	mov	r0,_bp
	inc	r0
	inc	r0
	clr	c
	...
	subb	a,b
	jnc	00117$
;	../../shared/src/phase_train.c:523: clk_step = clk_sum>>tag_CLOCK_ALIGN_PHASE_STEP_SIZE2;	 ////(1,1/2,1/4,1/8,1/16,1/32,1/64,1/128)
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	ar7,@r0
	...
	sjmp	00118$
00117$:
;	../../shared/src/phase_train.c:524: else if( clk_sum < 0)
	mov	r0,_bp
	inc	r0
	inc	r0
	inc	r0
	mov	a,@r0
	jnb	acc.7,00114$
;	../../shared/src/phase_train.c:525: clk_step = -(~(clk_sum)>>tag_CLOCK_ALIGN_PHASE_STEP_SIZE2);
	push	ar2
	mov	r0,_bp
	inc	r0
	inc	r0
	...
	sjmp	00118$
00114$:
;	../../shared/src/phase_train.c:526: else clk_step = 0;	
	mov	r7,#0x00
	mov	r6,#0x00
00118$:
;	../../shared/src/phase_train.c:532: if(clk_step!=0)  {
	mov	a,r7
	orl	a,r6
	jz	00122$
;	../../shared/src/phase_train.c:533: adapted_phase = adapted_phase + clk_step;
	push	ar2
	mov	ar3,r7
	mov	dptr,#_adapted_phase
	movx	a,@dptr
	...
	add	a,r4
	movx	@dptr,a
;	../../shared/src/phase_train.c:534: train.phase_offset_data = adapted_phase;
	mov	dptr,#_adapted_phase
	movx	a,@dptr
	mov	dptr,#(_train + 0x0021)
	movx	@dptr,a
;	../../shared/src/phase_train.c:535: train.phase_offset_data = clamp( train.phase_offset_data, cdr.max_phase_os, cdr.min_phase_os);
	mov	dptr,#(_cdr + 0x0009)
	movx	a,@dptr
	mov	r3,a
	mov	dptr,#(_cdr + 0x000a)
	...
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/phase_train.c:536: phase_control_func();
	push	ar2
	lcall	_phase_control_func
	pop	ar2
;	../../shared/src/phase_train.c:537: clk_sum = 0;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x00
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/phase_train.c:586: cds_dfe_ofst = 0;
	pop	ar2
;	../../shared/src/phase_train.c:537: clk_sum = 0;
00122$:
;	../../shared/src/phase_train.c:540: } while( clock_align_run1_index++ < tag_CLOCK_ALIGN_RUN2_NUM);
	mov	r0,_bp
	inc	r0
	mov	ar3,@r0
	mov	r0,_bp
...
00194$:
	...
	ljmp	00121$
00195$:
;	../../shared/src/phase_train.c:545: clk_sum = 0; clk_step = 0;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x00
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/phase_train.c:546: do {
	mov	r3,#0x00
00137$:
;	../../shared/src/phase_train.c:547: align_tap = dfe_adapt_align();
	push	ar2
	push	ar3
	mov	r0,#_dfe_adapt_align
	mov	r1,#(_dfe_adapt_align >> 8)
	...
	pop	ar2
	mov	ar5,r4
;	../../shared/src/phase_train.c:550: if(align_tap<align_ref) 
	clr	c
	mov	a,r5
	xrl	a,#0x80
	mov	b,r2
	...
	subb	a,b
	jnc	00127$
;	../../shared/src/phase_train.c:551: clk_sum--;
	mov	r0,_bp
	inc	r0
	inc	r0
	dec	@r0
...
00197$:
	sjmp	00128$
00127$:
;	../../shared/src/phase_train.c:552: else if(align_tap>align_ref)	
	clr	c
	mov	a,r2
	xrl	a,#0x80
	mov	b,r5
	...
	subb	a,b
	jnc	00128$
;	../../shared/src/phase_train.c:553: clk_sum++;	
	mov	r0,_bp
	inc	r0
	inc	r0
	inc	@r0
...
00199$:
00128$:
;	../../shared/src/phase_train.c:555: if( clk_sum > 0)
	mov	r0,_bp
	inc	r0
	inc	r0
	clr	c
	...
	subb	a,b
	jnc	00133$
;	../../shared/src/phase_train.c:556: clk_step = clk_sum>>tag_CLOCK_ALIGN_PHASE_STEP_SIZE3;	 ////(1,1/2,1/4,1/8,1/16,1/32,1/64,1/128)
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	ar7,@r0
...
00201$:
	...
	sjmp	00134$
00133$:
;	../../shared/src/phase_train.c:557: else if( clk_sum < 0)
	mov	r0,_bp
	inc	r0
	inc	r0
	inc	r0
	mov	a,@r0
	jnb	acc.7,00130$
;	../../shared/src/phase_train.c:558: clk_step = -(~(clk_sum)>>tag_CLOCK_ALIGN_PHASE_STEP_SIZE3);
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	a,@r0
...
00203$:
	...
	sjmp	00134$
00130$:
;	../../shared/src/phase_train.c:559: else clk_step = 0;	
	mov	r7,#0x00
	mov	r6,#0x00
00134$:
;	../../shared/src/phase_train.c:566: if(clk_step!=0)  {
	mov	a,r7
	orl	a,r6
	jz	00138$
;	../../shared/src/phase_train.c:567: adapted_phase = adapted_phase + clk_step;
	mov	dptr,#_adapted_phase
	movx	a,@dptr
	mov	r4,a
	mov	dptr,#_adapted_phase
	...
	add	a,r4
	movx	@dptr,a
;	../../shared/src/phase_train.c:568: train.phase_offset_data = adapted_phase;
	mov	dptr,#_adapted_phase
	movx	a,@dptr
	mov	dptr,#(_train + 0x0021)
	movx	@dptr,a
;	../../shared/src/phase_train.c:569: train.phase_offset_data = clamp( train.phase_offset_data, cdr.max_phase_os, cdr.min_phase_os);
	mov	dptr,#(_cdr + 0x0009)
	movx	a,@dptr
	mov	r4,a
	mov	dptr,#(_cdr + 0x000a)
	...
	mov	a,r4
	movx	@dptr,a
;	../../shared/src/phase_train.c:570: phase_control_func();
	lcall	_phase_control_func
	pop	ar3
	pop	ar2
;	../../shared/src/phase_train.c:571: clk_sum = 0;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x00
	...
	mov	@r0,#0x00
00138$:
;	../../shared/src/phase_train.c:574: } while( clock_align_run1_index++ < tag_CLOCK_ALIGN_RUN3_NUM);
	mov	ar4,r3
	inc	r3
	cjne	r4,#0x80,00205$
00205$:
	...
	ljmp	00137$
00206$:
;	../../shared/src/phase_train.c:585: if(cds_dfe_ofst==0) lnx_AVG_F1_LANE_7_0 = (uint8_t)align_ref;		
	mov	dptr,#_cds_dfe_ofst
	movx	a,@dptr
	mov	r3,a
	jnz	00141$
	mov	dptr,#(_TRAIN_PARA_0 + 0x0001)
	mov	a,r2
	movx	@dptr,a
00141$:
;	../../shared/src/phase_train.c:586: cds_dfe_ofst = 0;
...
00142$:
	...
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'dfe_adapt_align'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/phase_train.c:590: int8_t dfe_adapt_align(void) BANKING_CTRL {
;	-----------------------------------------
;	 function dfe_adapt_align
;	-----------------------------------------
_dfe_adapt_align:
;	../../shared/src/phase_train.c:591: dfe_adaptation();
	mov	r0,#_dfe_adaptation
	mov	r1,#(_dfe_adaptation >> 8)
	mov	r2,#(_dfe_adaptation >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_train.c:592: if(cds_dfe_ofst) {
	mov	dptr,#_cds_dfe_ofst
	movx	a,@dptr
	mov	r2,a
	jz	00102$
;	../../shared/src/phase_train.c:594: return (train.ofst_slicer);	
	...
	sjmp	00104$
00102$:
;	../../shared/src/phase_train.c:597: return train.f1;
