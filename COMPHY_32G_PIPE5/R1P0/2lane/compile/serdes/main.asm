...
00115$:
	lcall	_SpeedChange
;	../../shared/src/main.c:177: case ST_SLUMBER: Power_Slumber();	 	break;
	sjmp	00132$
00116$:
	mov	r0,#_Power_Slumber
	mov	r1,#(_Power_Slumber >> 8)
	mov	r2,#(_Power_Slumber >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/main.c:178: case ST_SLUMBER_WK: Power_Slumber_Wakeup(); break;
	sjmp	00132$
00117$:
	mov	r0,#_Power_Slumber_Wakeup
	mov	r1,#(_Power_Slumber_Wakeup >> 8)
	mov	r2,#(_Power_Slumber_Wakeup >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/main.c:180: case ST_PSLUMBER_RX:Power_Patial_Slumber(); break;
	sjmp	00132$
00118$:
	mov	r0,#_Power_Patial_Slumber
	mov	r1,#(_Power_Patial_Slumber >> 8)
	mov	r2,#(_Power_Patial_Slumber >> 16)
	lcall	__sdcc_banked_call
...
00122$:
	...
	mov	r2,#(_RX_Init >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/main.c:188: case ST_APTA_TXTRAIN: 
	sjmp	00132$
00124$:
;	../../shared/src/main.c:189: if(cmx_APTA_TRAIN_SIM_EN || PHY_MCU_REMOTE_REQ_LANE) 
	...
	jnb	acc.0,00132$
00125$:
;	../../shared/src/main.c:190: apta_txtrain(); break;	
	mov	r0,#_apta_txtrain
	mov	r1,#(_apta_txtrain >> 8)
	mov	r2,#(_apta_txtrain >> 16)
	lcall	__sdcc_banked_call
...
;	../../shared/src/main.c:201: RxFFE_ACCap(); //dfe cont run
	...
	lcall	__sdcc_banked_call
;	../../shared/src/main.c:204: Phase_Adaptation();
	mov	r0,#_Phase_Adaptation
	mov	r1,#(_Phase_Adaptation >> 8)
	mov	r2,#(_Phase_Adaptation >> 16)
	lcall	__sdcc_banked_call
...
;	../../shared/src/main.c:235: EA = 1;
	...
	sjmp	00158$
00146$:
;	../../shared/src/main.c:238: else if(do_rx_apta) { PHY_STATUS = ST_APTA_TXTRAIN; }
	jnb	_do_rx_apta,00143$
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x38
	movx	@dptr,a
	sjmp	00158$
