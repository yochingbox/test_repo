...
;--------------------------------------------------------
	.globl _tximp_thermo_tb
	.globl _toggle_impcal_out_req
	.globl _TF2
	.globl _TI
	.globl _RI
	.globl _EX12
...
;--------------------------------------------------------
	.area BANK2   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'toggle_impcal_out_req'
;------------------------------------------------------------
;comp_out                  Allocated to registers r2 
;------------------------------------------------------------
;	../../shared/src/imp_cal.c:66: uint8_t  toggle_impcal_out_req( void ) BANKING_CTRL {
;	-----------------------------------------
;	 function toggle_impcal_out_req
;	-----------------------------------------
_toggle_impcal_out_req:
	ar2 = 0x02
	ar3 = 0x03
	ar4 = 0x04
	ar5 = 0x05
	...
	ar0 = 0x00
	ar1 = 0x01
;	../../shared/src/imp_cal.c:69: comp_out = 0;
	mov	r2,#0x00
;	../../shared/src/imp_cal.c:70: TXRXIMP_CKCAL = 1;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_139
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/imp_cal.c:71: delay01(50); //resets analog comparator
	mov	dptr,#0x0032
	push	ar2
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
...
;	../../shared/src/imp_cal.c:72: TXRXIMP_CKCAL = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_139
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/imp_cal.c:73: delay01(20); //analog settling time
	mov	dptr,#0x0014
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
	pop	ar2
;	../../shared/src/imp_cal.c:75: IMPCAL_OUT_REQ = 1;
;	../../shared/src/imp_cal.c:76: IMPCAL_OUT_REQ = 0;
	...
	anl	a,#0xef
	movx	@dptr,a
;	../../shared/src/imp_cal.c:78: if(TXRX_IMPCALOUT) comp_out = 1;
	mov	dptr,#_CMN_CALIBRATION
	movx	a,@dptr
	jnb	acc.3,00102$
	mov	r2,#0x01
00102$:
;	../../shared/src/imp_cal.c:80: return comp_out;
	mov	dpl,r2
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'tximp_cal'
;------------------------------------------------------------
;i                         Allocated to stack - offset 1
;cnt                       Allocated to registers r5 
;dir                       Allocated to registers r2 
;min_reached_n             Allocated to registers r4 
;max_reached_n             Allocated to registers r2 
;min_reached_p             Allocated to registers r2 
;max_reached_p             Allocated to registers r3 
;tximp_h                   Allocated to stack - offset 2
;tximp_l                   Allocated to registers r6 
;sum                       Allocated to stack - offset 3
;ave                       Allocated to registers r2 r4 
;ave_0                     Allocated to stack - offset 5
;ana_tximpcal_out          Allocated to registers r7 
;pre_val                   Allocated to stack - offset 7
;------------------------------------------------------------
;	../../shared/src/imp_cal.c:84: void tximp_cal( void ) BANKING_CTRL {
;	-----------------------------------------
;	 function tximp_cal
;	-----------------------------------------
_tximp_cal:
	...
	add	a,#0x07
	mov	sp,a
;	../../shared/src/imp_cal.c:91: lnx_TXIMP_CAL_DONE_LANE = 0;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/imp_cal.c:93: if( cmx_TXIMP_CAL_EXT_EN == 1 ) {
	...
	mov	r2,a
	cjne	r2,#0x01,00102$
;	../../shared/src/imp_cal.c:94: TXIMP_TUNEN = lnx_CAL_TXIMP_TUNEN_LANE_7_0;
	mov	dptr,#_CAL_SAVE_DATA3_LANE
	movx	a,@dptr
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_144
	anl	a,#0x0f
	mov	b,a
	movx	a,@dptr
	anl	a,#0xf0
	orl	a,b
	movx	@dptr,a
;	../../shared/src/imp_cal.c:95: TXIMP_TUNEN0 = lnx_CAL_TXIMP_TUNEN0_LANE_7_0;
	mov	dptr,#(_CAL_SAVE_DATA3_LANE + 0x0001)
	movx	a,@dptr
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_149
	anl	a,#0x07
	mov	b,a
	movx	a,@dptr
	anl	a,#0xf8
	orl	a,b
	movx	@dptr,a
;	../../shared/src/imp_cal.c:96: TXIMP_TUNEP = lnx_CAL_TXIMP_TUNEP_LANE_7_0;
	mov	dptr,#(_CAL_SAVE_DATA3_LANE + 0x0002)
	movx	a,@dptr
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_144
	swap	a
	anl	a,#(0xf0&0xf0)
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/imp_cal.c:97: TXIMP_TUNEP0 = lnx_CAL_TXIMP_TUNEP0_LANE_7_0;
	mov	dptr,#(_CAL_SAVE_DATA3_LANE + 0x0003)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_149
	swap	a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/imp_cal.c:99: lnx_TXIMP_CAL_DONE_LANE = 1;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/imp_cal.c:100: return;
	ljmp	00212$
00102$:
;	../../shared/src/imp_cal.c:103: PHY_STATUS = ST_TXIMP_CAL;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x18
	movx	@dptr,a
;	../../shared/src/imp_cal.c:105: lnx_TXIMP_CAL_PASS_LANE = 0;
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/imp_cal.c:106: lnx_TXIMP_CAL_TIMEOUT_LANE = 0;
	mov	dptr,#(_CAL_CTRL3_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/imp_cal.c:109: set_test_pattern(1);
	mov	dpl,#0x01
	mov	r0,#_set_test_pattern
	mov	r1,#(_set_test_pattern >> 8)
	mov	r2,#(_set_test_pattern >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/imp_cal.c:111: TXIMPCAL_DRVAMP_2_0 = TX_VREF_TXDRV_SEL;
	mov	dptr,#(_TX_AMP_CTRL_REG0 + 0x0003)
	movx	a,@dptr
	swap	a
	rl	a
	anl	a,#0x07
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_129
	swap	a
	rl	a
	anl	a,#(0xe0&0xe0)
	mov	b,a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/imp_cal.c:113: delay01(100); //10us delay between reg_TXIMPCAL_EN and reg_TX_IMPCAL_EN_LANE
	mov	dptr,#0x0064
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/imp_cal.c:115: TX_IMPCAL_EN = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_149
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/imp_cal.c:118: TX_IMPCAL_BOT = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_147
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/imp_cal.c:120: sum = 0;
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	@r0,#0x00
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/imp_cal.c:122: for(i=0; i<2; i++) {
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x00
00204$:
...
00273$:
	...
	ljmp	00207$
00274$:
;	../../shared/src/imp_cal.c:123: if(i==1) TX_IMPCAL_SIDE = 1;
	mov	r0,_bp
	inc	r0
	cjne	@r0,#0x01,00104$
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_149
	...
	sjmp	00105$
00104$:
;	../../shared/src/imp_cal.c:124: else TX_IMPCAL_SIDE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_149
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
00105$:
;	../../shared/src/imp_cal.c:126: TXIMP_TUNEN = 0x8; // 4'b1000	
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_144
	movx	a,@dptr
	anl	a,#0xf0
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/imp_cal.c:127: TXIMP_TUNEN0 = 0x7; // 3'b111 (1/6LSB of TXIMP_TUNEN)
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_149
	movx	a,@dptr
	orl	a,#0x07
	movx	@dptr,a
;	../../shared/src/imp_cal.c:129: tximp_h = 8; tximp_l = 3;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x08
	mov	r6,#0x03
;	../../shared/src/imp_cal.c:133: pre_val = toggle_impcal_out_req();
	push	ar6
	mov	r0,#_toggle_impcal_out_req
	mov	r1,#(_toggle_impcal_out_req >> 8)
	mov	r2,#(_toggle_impcal_out_req >> 16)
	lcall	__sdcc_banked_call
	mov	r7,dpl
	pop	ar6
	mov	a,_bp
	...
	mov	r0,a
	mov	@r0,ar7
;	../../shared/src/imp_cal.c:135: min_reached_n = 0;
	mov	r4,#0x00
;	../../shared/src/imp_cal.c:136: max_reached_n = 0;
	mov	r2,#0x00
;	../../shared/src/imp_cal.c:138: do {
	mov	r5,#0x00
00126$:
;	../../shared/src/imp_cal.c:139: ana_tximpcal_out = toggle_impcal_out_req();
	push	ar2
	push	ar4
	push	ar5
	push	ar6
	...
	pop	ar2
	mov	ar7,r3
;	../../shared/src/imp_cal.c:141: if ( ana_tximpcal_out != pre_val ) break; //exit at first toggle
	mov	a,_bp
	add	a,#0x07
	mov	r0,a
	mov	a,@r0
	cjne	a,ar7,00128$
;	../../shared/src/imp_cal.c:143: if( tximp_h == 0x0) min_reached_n += 1;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	a,@r0
	...
	sjmp	00112$
00111$:
;	../../shared/src/imp_cal.c:144: else if( tximp_h == 0xf) max_reached_n += 1;
	mov	r0,_bp
	inc	r0
	inc	r0
	cjne	@r0,#0x0F,00112$
	inc	r2
00112$:
;	../../shared/src/imp_cal.c:146: if( ana_tximpcal_out == 0 ) {
	mov	a,r7
;	../../shared/src/imp_cal.c:147: max_reached_n = 0;
	jnz	00124$
	mov	r2,a
;	../../shared/src/imp_cal.c:148: if( min_reached_n == 0) tximp_h--; //decrement DAC value with underflow protection
	mov	a,r4
	jnz	00116$
	mov	r0,_bp
	inc	r0
	...
	sjmp	00125$
00116$:
;	../../shared/src/imp_cal.c:149: else if ( min_reached_n == 2 ) break; //exit calibration when DAC value is 0x0 with analog result at 0 for 2 consecutive samples
	cjne	r4,#0x02,00125$
	sjmp	00128$
00124$:
;	../../shared/src/imp_cal.c:152: min_reached_n = 0;
	mov	r4,#0x00
;	../../shared/src/imp_cal.c:153: if( max_reached_n == 0) tximp_h++; //increment DAC value with overflow protection
	mov	a,r2
	jnz	00121$
	mov	r0,_bp
	inc	r0
	...
	sjmp	00125$
00121$:
;	../../shared/src/imp_cal.c:154: else if ( max_reached_n == 2 ) break; //exit calibration when DAC value is 0xf with analog result at 1 for 2 consecutive samples	
	cjne	r2,#0x02,00286$
	sjmp	00128$
00286$:
00125$:
;	../../shared/src/imp_cal.c:157: TXIMP_TUNEN = tximp_h;
	push	ar4
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_144
	mov	r0,_bp
	inc	r0
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/imp_cal.c:159: } while( (cnt++<16) | (cmx_TXIMP_CAL_TIMEOUT_DIS == 1) ); //timeout after 16 steps
	mov	ar4,r5
	inc	r5
	cjne	r4,#0x10,00287$
00287$:
...
00290$:
00128$:
;	../../shared/src/imp_cal.c:161: if( cnt >= 16 ) {
	cjne	r5,#0x10,00291$
00291$:
	jc	00133$
;	../../shared/src/imp_cal.c:162: lnx_TXIMP_CAL_TIMEOUT_LANE = 1;
	mov	dptr,#(_CAL_CTRL3_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
	sjmp	00134$
00133$:
;	../../shared/src/imp_cal.c:164: else if( ana_tximpcal_out == 1 && max_reached_n == 0 ) { //previously toggled from 0->1
	cjne	r7,#0x01,00134$
	mov	a,r2
	jnz	00134$
;	../../shared/src/imp_cal.c:165: tximp_h++;
	mov	r0,_bp
	inc	r0
	inc	r0
	inc	@r0
;	../../shared/src/imp_cal.c:166: TXIMP_TUNEN = tximp_h;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_144
	mov	r0,_bp
	inc	r0
	inc	r0
	...
	movx	@dptr,a
00134$:
;	../../shared/src/imp_cal.c:170: dir = 0;
	mov	r2,#0x00
;	../../shared/src/imp_cal.c:172: do {
	mov	r4,#0x00
00146$:
;	../../shared/src/imp_cal.c:173: if( tximp_l == 0x0 ) break; //exit once thermal code reaches 000
	mov	a,r6
	jnz	00296$
	ljmp	00148$
00296$:
;	../../shared/src/imp_cal.c:175: ana_tximpcal_out = toggle_impcal_out_req();
	push	ar4
	push	ar2
	push	ar4
	push	ar6
	...
	pop	ar2
	mov	ar7,r3
;	../../shared/src/imp_cal.c:177: if( ana_tximpcal_out == 0 ) {
	pop	ar4
	mov	a,r7
	jnz	00142$
;	../../shared/src/imp_cal.c:178: if( tximp_l > 0 ) tximp_l--;
	mov	a,r6
	jz	00143$
	dec	r6
	sjmp	00143$
00142$:
;	../../shared/src/imp_cal.c:181: if( tximp_l < 3 ) tximp_l++;
	cjne	r6,#0x03,00299$
00299$:
	jnc	00143$
	inc	r6
00143$:
;	../../shared/src/imp_cal.c:184: TXIMP_TUNEN0 = tximp_thermo_tb[tximp_l];
	mov	a,r6
	mov	dptr,#_tximp_thermo_tb
	movc	a,@a+dptr
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_149
	anl	a,#0x07
	mov	b,a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/imp_cal.c:186: dir = (dir << 1 ) | ana_tximpcal_out;
	mov	a,r2
	add	a,r2
	mov	r5,a
	mov	a,r7
	orl	ar5,a
	mov	ar2,r5
;	../../shared/src/imp_cal.c:187: if ( is_toggle_pat( dir, cnt + 1 ) ) break;
	mov	a,r4
	inc	a
	mov	r5,a
	push	ar2
	...
	mov	b0,c
	jc	00148$
;	../../shared/src/imp_cal.c:189: } while( (cnt++<16) | (cmx_TXIMP_CAL_TIMEOUT_DIS == 1) ); //timeout after 16 steps
	push	ar2
	mov	ar2,r4
	inc	r4
	cjne	r2,#0x10,00302$
...
00305$:
00148$:
;	../../shared/src/imp_cal.c:191: if( cnt >= 16 ) {
	cjne	r4,#0x10,00306$
00306$:
	jc	00150$
;	../../shared/src/imp_cal.c:192: lnx_TXIMP_CAL_TIMEOUT_LANE = 1;
	mov	dptr,#(_CAL_CTRL3_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
00150$:
;	../../shared/src/imp_cal.c:195: sum += tximp_h * 6;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	a,@r0
	...
	addc	a,@r0
	mov	@r0,a
;	../../shared/src/imp_cal.c:196: sum += tximp_l;
	mov	ar3,r6
	mov	r5,#0x00
	mov	a,_bp
	add	a,#0x03
...
;	../../shared/src/imp_cal.c:122: for(i=0; i<2; i++) {
	...
	ljmp	00204$
00207$:
;	../../shared/src/imp_cal.c:202: ave = u16div( sum >> 1,  6); //ave = (sum / 2) / 6
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	ar3,@r0
	...
	mov	ar2,r3
	mov	ar4,r5
;	../../shared/src/imp_cal.c:203: ave_0 = (uint16_t)((sum - u16mul(ave, 12)) >> 1);
	push	ar2
	push	ar4
	mov	a,#0x0C
	push	acc
	...
	inc	r0
	mov	@r0,a
;	../../shared/src/imp_cal.c:204: lnx_CAL_TXIMP_TUNEN_LANE_7_0 = (uint8_t)(ave & 0x0f);	
	mov	a,#0x0F
	anl	a,r2
	mov	r3,a
	mov	r5,#0x00
	...
	mov	a,r3
	movx	@dptr,a
;	../../shared/src/imp_cal.c:206: tximp_l = ave_0 > 2 ? 3 : ave_0;  //how about 5/6, 4/6 ??
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
	clr	c
...
00214$:
	...
	mov	ar5,@r0
00215$:
;	../../shared/src/imp_cal.c:207: lnx_CAL_TXIMP_TUNEN0_LANE_7_0 = tximp_thermo_tb[ tximp_l ];
	mov	a,r3
	mov	r6,a
	mov	dptr,#_tximp_thermo_tb
	movc	a,@a+dptr
;	../../shared/src/imp_cal.c:209: TXIMP_TUNEN0 = lnx_CAL_TXIMP_TUNEN0_LANE_7_0;
	mov	dptr,#(_CAL_SAVE_DATA3_LANE + 0x0001)
	movx	@dptr,a
	movx	a,@dptr
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_149
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/imp_cal.c:210: TXIMP_TUNEN = lnx_CAL_TXIMP_TUNEN_LANE_7_0;
	mov	dptr,#_CAL_SAVE_DATA3_LANE
	movx	a,@dptr
	mov	r3,a
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_144
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/imp_cal.c:213: TX_IMPCAL_BOT = 0;		
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_147
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/imp_cal.c:215: sum = 0;
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	@r0,#0x00
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/imp_cal.c:217: for(i=0; i<4; i++) {
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x00
00208$:
...
00309$:
	...
	ljmp	00211$
00310$:
;	../../shared/src/imp_cal.c:218: if(i==1|i==3) TX_IMPCAL_SIDE = 1; //1'b1 during iteration i = 1, 3
	mov	r0,_bp
	inc	r0
	clr	a
	cjne	@r0,#0x01,00311$
...
00313$:
	...
	sjmp	00153$
00152$:
;	../../shared/src/imp_cal.c:219: else TX_IMPCAL_SIDE = 0; //1'b0 during iteration i = 0, 2
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_149
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
00153$:
;	../../shared/src/imp_cal.c:221: if(i==2|i==3) RCALP_2ND_EN = 1; //1'b1 during iteration i = 2, 3
	mov	r0,_bp
	inc	r0
	clr	a
	cjne	@r0,#0x02,00316$
...
00318$:
	...
	sjmp	00156$
00155$:
;	../../shared/src/imp_cal.c:222: else RCALP_2ND_EN = 0; //1'b0 during iteration i = 0, 1
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_148
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
00156$:
;	../../shared/src/imp_cal.c:224: TXIMP_TUNEP = 0x8; // 4'b1000
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_144
	movx	a,@dptr
	anl	a,#0x0f
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/imp_cal.c:225: TXIMP_TUNEP0 = 0x0; // 3'b000 (1/6LSB of TXIMP_TUNEP)
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_149
	movx	a,@dptr
	anl	a,#0xc7
	movx	@dptr,a
;	../../shared/src/imp_cal.c:227: tximp_h = 8; tximp_l = 0;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x08
	mov	r6,#0x00
;	../../shared/src/imp_cal.c:231: pre_val = toggle_impcal_out_req();
	push	ar6
	mov	r0,#_toggle_impcal_out_req
	mov	r1,#(_toggle_impcal_out_req >> 8)
	mov	r2,#(_toggle_impcal_out_req >> 16)
	...
	mov	r0,a
	mov	@r0,ar5
;	../../shared/src/imp_cal.c:233: min_reached_p = 0;
	mov	r2,#0x00
;	../../shared/src/imp_cal.c:234: max_reached_p = 0;
	mov	r3,#0x00
;	../../shared/src/imp_cal.c:236: do {
	mov	r4,#0x00
00177$:
;	../../shared/src/imp_cal.c:237: ana_tximpcal_out = toggle_impcal_out_req();
	push	ar3
	push	ar2
	push	ar4
	push	ar6
	...
	pop	ar2
	mov	ar7,r3
;	../../shared/src/imp_cal.c:239: if ( ana_tximpcal_out != pre_val ) break; //exit at first toggle
	mov	a,_bp
	add	a,#0x07
	mov	r0,a
	mov	a,@r0
...
00322$:
	pop	ar3
;	../../shared/src/imp_cal.c:241: if( tximp_h == 0x0) min_reached_p += 1;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	a,@r0
	...
	sjmp	00163$
00162$:
;	../../shared/src/imp_cal.c:242: else if( tximp_h == 0xf) max_reached_p += 1;
	mov	r0,_bp
	inc	r0
	inc	r0
	cjne	@r0,#0x0F,00163$
	inc	r3
00163$:
;	../../shared/src/imp_cal.c:244: if( ana_tximpcal_out == 0 ) {
	mov	a,r7
;	../../shared/src/imp_cal.c:245: max_reached_p = 0;
	jnz	00175$
	mov	r3,a
;	../../shared/src/imp_cal.c:246: if( min_reached_p == 0) tximp_h--; //decrement DAC value with underflow protection
	mov	a,r2
	jnz	00167$
	mov	r0,_bp
	inc	r0
	...
	sjmp	00176$
00167$:
;	../../shared/src/imp_cal.c:247: else if ( min_reached_p == 2 ) break; //exit calibration when DAC value is 0x0 with analog result at 0 for 2 consecutive samples
	cjne	r2,#0x02,00176$
	sjmp	00179$
00175$:
;	../../shared/src/imp_cal.c:250: min_reached_p = 0;
	mov	r2,#0x00
;	../../shared/src/imp_cal.c:251: if( max_reached_p == 0) tximp_h++; //increment DAC value with overflow protection
	mov	a,r3
	jnz	00172$
	mov	r0,_bp
	inc	r0
	...
	sjmp	00176$
00172$:
;	../../shared/src/imp_cal.c:252: else if ( max_reached_p == 2 ) break; //exit calibration when DAC value is 0xf with analog result at 1 for 2 consecutive samples	
	cjne	r3,#0x02,00330$
	sjmp	00179$
00330$:
00176$:
;	../../shared/src/imp_cal.c:255: TXIMP_TUNEP = tximp_h;
	push	ar3
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_144
	mov	r0,_bp
	inc	r0
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/imp_cal.c:257: } while( (cnt++<16) | (cmx_TXIMP_CAL_TIMEOUT_DIS == 1) ); //timeout after 16 steps
	mov	ar3,r4
	inc	r4
	cjne	r3,#0x10,00331$
00331$:
...
00334$:
00179$:
;	../../shared/src/imp_cal.c:259: if( cnt >= 16 ) {
	cjne	r4,#0x10,00335$
00335$:
	jc	00184$
;	../../shared/src/imp_cal.c:260: lnx_TXIMP_CAL_TIMEOUT_LANE = 1;
	mov	dptr,#(_CAL_CTRL3_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
	sjmp	00185$
00184$:
;	../../shared/src/imp_cal.c:262: else if( ana_tximpcal_out == 0 && min_reached_p == 0 ) { //previously toggled from 1->0
	mov	a,r7
	jnz	00185$
	mov	a,r2
	jnz	00185$
;	../../shared/src/imp_cal.c:263: tximp_h--;
	mov	r0,_bp
	inc	r0
	inc	r0
	dec	@r0
;	../../shared/src/imp_cal.c:264: TXIMP_TUNEP = tximp_h;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_144
	mov	r0,_bp
	inc	r0
	inc	r0
	...
	movx	@dptr,a
00185$:
;	../../shared/src/imp_cal.c:268: dir = 0;
	mov	r2,#0x00
;	../../shared/src/imp_cal.c:270: do {
	mov	r5,#0x00
00197$:
;	../../shared/src/imp_cal.c:271: if( tximp_l == 3 ) break; //exit once thermal code reaches 111
	cjne	r6,#0x03,00339$
	ljmp	00199$
00339$:
;	../../shared/src/imp_cal.c:273: ana_tximpcal_out = toggle_impcal_out_req();
	push	ar5
	push	ar2
	push	ar6
	mov	r0,#_toggle_impcal_out_req
	...
	pop	ar2
	mov	ar7,r5
;	../../shared/src/imp_cal.c:275: if( ana_tximpcal_out == 0 ) {
	pop	ar5
	mov	a,r7
	jnz	00193$
;	../../shared/src/imp_cal.c:276: if( tximp_l > 0 ) tximp_l--;
	mov	a,r6
	jz	00194$
	dec	r6
	sjmp	00194$
00193$:
;	../../shared/src/imp_cal.c:279: if( tximp_l < 3 ) tximp_l++;
	cjne	r6,#0x03,00342$
00342$:
	jnc	00194$
	inc	r6
00194$:
;	../../shared/src/imp_cal.c:282: TXIMP_TUNEP0 = tximp_thermo_tb[tximp_l];
	mov	a,r6
	add	a,#_tximp_thermo_tb
	mov	dpl,a
	clr	a
	addc	a,#(_tximp_thermo_tb >> 8)
	mov	dph,a
	push	ar6
	clr	a
	movc	a,@a+dptr
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/imp_cal.c:284: dir = (dir << 1 ) | ana_tximpcal_out;
	mov	a,r2
	add	a,r2
	orl	ar7,a
	mov	ar2,r7
;	../../shared/src/imp_cal.c:285: if ( is_toggle_pat( dir, cnt + 1 ) ) break;
	mov	a,r5
	inc	a
	mov	r6,a
	push	ar2
	...
	pop	ar6
	jb	b0,00199$
;	../../shared/src/imp_cal.c:287: } while( (cnt++<16) | (cmx_TXIMP_CAL_TIMEOUT_DIS == 1) ); //timeout after 16 steps
	push	ar2
	mov	ar7,r5
	inc	r5
	cjne	r7,#0x10,00345$
...
00348$:
00199$:
;	../../shared/src/imp_cal.c:289: if( cnt >= 16 ) {
	cjne	r5,#0x10,00349$
00349$:
	jc	00201$
;	../../shared/src/imp_cal.c:290: lnx_TXIMP_CAL_TIMEOUT_LANE = 1;
	mov	dptr,#(_CAL_CTRL3_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
00201$:
;	../../shared/src/imp_cal.c:293: sum += tximp_h* 6;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	a,@r0
	...
	addc	a,@r0
	mov	@r0,a
;	../../shared/src/imp_cal.c:294: sum += tximp_l;
	mov	ar5,r6
	mov	r7,#0x00
	mov	a,_bp
	add	a,#0x03
...
;	../../shared/src/imp_cal.c:217: for(i=0; i<4; i++) {
	...
	ljmp	00208$
00211$:
;	../../shared/src/imp_cal.c:300: ave = u16div( sum >> 2, 6 ); //ave = (sum / 2) / 6
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	ar5,@r0
	...
	mov	ar2,r5
	mov	ar4,r7
;	../../shared/src/imp_cal.c:301: ave_0 = (uint16_t)((sum - u16mul(ave, 24)) >> 2);
	push	ar2
	push	ar4
	mov	a,#0x18
	push	acc
	...
	inc	r0
	mov	@r0,a
;	../../shared/src/imp_cal.c:302: lnx_CAL_TXIMP_TUNEP_LANE_7_0 =(uint8_t)(ave & 0x0f);
	mov	a,#0x0F
	anl	a,r2
	mov	r5,a
	mov	r7,#0x00
	...
	mov	a,r5
	movx	@dptr,a
;	../../shared/src/imp_cal.c:304: tximp_l = ave_0 > 2 ? 3 : ave_0;
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
	clr	c
...
00216$:
	...
	mov	ar7,@r0
00217$:
;	../../shared/src/imp_cal.c:305: lnx_CAL_TXIMP_TUNEP0_LANE_7_0 = tximp_thermo_tb[ tximp_l ];
	mov	a,r5
	mov	r6,a
	mov	dptr,#_tximp_thermo_tb
	movc	a,@a+dptr
	mov	dptr,#(_CAL_SAVE_DATA3_LANE + 0x0003)
	movx	@dptr,a
;	../../shared/src/imp_cal.c:307: TXIMP_TUNEP = lnx_CAL_TXIMP_TUNEP_LANE_7_0;
	mov	dptr,#(_CAL_SAVE_DATA3_LANE + 0x0002)
	movx	a,@dptr
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_144
	swap	a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/imp_cal.c:308: TXIMP_TUNEP0 = lnx_CAL_TXIMP_TUNEP0_LANE_7_0;
	mov	dptr,#(_CAL_SAVE_DATA3_LANE + 0x0003)
	movx	a,@dptr
	mov	r5,a
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_149
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/imp_cal.c:310: if( lnx_TXIMP_CAL_TIMEOUT_LANE == 0 ) {
	mov	dptr,#(_CAL_CTRL3_LANE + 0x0002)
	movx	a,@dptr
	jb	acc.6,00203$
;	../../shared/src/imp_cal.c:311: lnx_TXIMP_CAL_PASS_LANE = 1;
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
00203$:
;	../../shared/src/imp_cal.c:314: TX_IMPCAL_BOT = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_147
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/imp_cal.c:315: TX_IMPCAL_SIDE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_149
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/imp_cal.c:316: RCALP_2ND_EN = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_148
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/imp_cal.c:317: TX_IMPCAL_EN = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_149
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/imp_cal.c:319: recover_test_pattern();
	mov	r0,#_recover_test_pattern
	mov	r1,#(_recover_test_pattern >> 8)
	mov	r2,#(_recover_test_pattern >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/imp_cal.c:321: lnx_TXIMP_CAL_DONE_LANE = 1;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
00212$:
	...
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'rximp_cal'
;------------------------------------------------------------
;cnt                       Allocated to registers r3 
;rximp                     Allocated to registers r2 
;min_reached               Allocated to registers r4 
;max_reached               Allocated to stack - offset 1
;dir                       Allocated to registers r6 
;ana_rximpcal_out          Allocated to registers r5 
;------------------------------------------------------------
;	../../shared/src/imp_cal.c:335: void rximp_cal( void ) BANKING_CTRL {
;	-----------------------------------------
;	 function rximp_cal
;	-----------------------------------------
_rximp_cal:
	...
	mov	_bp,sp
	inc	sp
;	../../shared/src/imp_cal.c:339: lnx_RXIMP_CAL_DONE_LANE = 0;	
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/imp_cal.c:341: if( cmx_RXIMP_CAL_EXT_EN == 1) {
	mov	dptr,#(_CONTROL_CONFIG1 + 0x0002)
	movx	a,@dptr
	rl	a
	rl	a
	...
	mov	r2,a
	cjne	r2,#0x01,00102$
;	../../shared/src/imp_cal.c:342: IMPCAL_RX_LANE = lnx_CAL_RX_IMP_LANE_7_0;
	mov	dptr,#(_CAL_SAVE_DATA2_LANE + 0x0001)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_2
	add	a,acc
	add	a,acc
	anl	a,#0x7c
	mov	b,a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/imp_cal.c:344: lnx_RXIMP_CAL_DONE_LANE = 1;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/imp_cal.c:345: return;
	ljmp	00131$
00102$:
;	../../shared/src/imp_cal.c:348: PHY_STATUS = ST_RXIMP_CAL;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x17
	movx	@dptr,a
;	../../shared/src/imp_cal.c:350: lnx_RXIMP_CAL_PASS_LANE = 0;
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/imp_cal.c:351: lnx_RXIMP_CAL_TIMEOUT_LANE = 0;
	mov	dptr,#(_CAL_CTRL3_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/imp_cal.c:353: delay01(100); //10us delay between reg_RXIMPCAL_EN and reg_RX_IMPCAL_EN_LANE
	mov	dptr,#0x0064
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/imp_cal.c:354: RX_IMPCAL_EN = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_2
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/imp_cal.c:356: RXIMP_IVREF = 0x0c;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_130
	movx	a,@dptr
	anl	a,#0x07
	orl	a,#0x60
	movx	@dptr,a
;	../../shared/src/imp_cal.c:357: rximp = 0x0c;
	mov	r2,#0x0C
;	../../shared/src/imp_cal.c:359: cnt = 0;
	mov	r3,#0x00
;	../../shared/src/imp_cal.c:361: min_reached = 0;
	mov	r4,#0x00
;	../../shared/src/imp_cal.c:362: max_reached = 0;
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/imp_cal.c:363: dir = 0;
	mov	r6,#0x00
;	../../shared/src/imp_cal.c:365: do {
	mov	r7,#0x00
00125$:
;	../../shared/src/imp_cal.c:366: ana_rximpcal_out = toggle_impcal_out_req();
	push	ar3
	push	ar2
	push	ar4
	push	ar6
	...
	pop	ar2
	mov	ar5,r3
;	../../shared/src/imp_cal.c:368: if( rximp == 0x00) min_reached += 1;
	pop	ar3
	mov	a,r2
	jnz	00106$
	inc	r4
	sjmp	00107$
00106$:
;	../../shared/src/imp_cal.c:369: else if( rximp == 0x1f) max_reached += 1;
	cjne	r2,#0x1F,00107$
	mov	r0,_bp
	inc	r0
	inc	@r0
00107$:
;	../../shared/src/imp_cal.c:371: if( ana_rximpcal_out == 0 ) {
	mov	a,r5
	jnz	00119$
;	../../shared/src/imp_cal.c:372: max_reached = 0;
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/imp_cal.c:373: if( min_reached == 0) rximp--; //decrement DAC value with underflow protection
	mov	a,r4
	jnz	00111$
	dec	r2
	sjmp	00120$
00111$:
;	../../shared/src/imp_cal.c:374: else if ( min_reached == 2 ) break; //exit calibration when DAC value is 0x00 with analog result at 0 for 2 consecutive samples
	cjne	r4,#0x02,00151$
	ljmp	00127$
00151$:
	sjmp	00120$
00119$:
;	../../shared/src/imp_cal.c:377: min_reached = 0;
	mov	r4,#0x00
;	../../shared/src/imp_cal.c:378: if( max_reached == 0) rximp++; //increment DAC value with overflow protection
	mov	r0,_bp
	inc	r0
	mov	a,@r0
	jnz	00116$
	...
	sjmp	00120$
00116$:
;	../../shared/src/imp_cal.c:379: else if ( max_reached == 2 ) break; //exit calibration when DAC value is 0x1f with analog result at 1 for 2 consecutive samples	
	mov	r0,_bp
	inc	r0
	cjne	@r0,#0x02,00153$
	sjmp	00127$
00153$:
00120$:
;	../../shared/src/imp_cal.c:382: dir = (dir << 1 ) | ana_rximpcal_out;
	push	ar3
	mov	a,r6
	add	a,r6
	mov	r3,a
	...
	orl	ar3,a
	mov	ar6,r3
;	../../shared/src/imp_cal.c:383: if ( is_toggle_pat( dir, cnt + 1 ) ) {
	mov	a,r7
	inc	a
	mov	r3,a
	push	ar2
	...
	pop	ar3
	jnb	b0,00124$
;	../../shared/src/imp_cal.c:384: if( ana_rximpcal_out == 0 ) rximp++; //result will be the bigger value of the toggling values
	mov	a,r5
	jnz	00127$
	inc	r2
;	../../shared/src/imp_cal.c:385: break;
	sjmp	00127$
00124$:
;	../../shared/src/imp_cal.c:388: RXIMP_IVREF = rximp;
	push	ar6
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_130
	mov	a,r2
	swap	a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/imp_cal.c:390: } while ( (cnt++ < 40) | (cmx_RXIMP_CAL_TIMEOUT_DIS == 1) ); //timeout after 40 steps
	mov	ar6,r7
	inc	r7
	mov	ar3,r7
	cjne	r6,#0x28,00156$
...
00159$:
00127$:
;	../../shared/src/imp_cal.c:392: if( cnt >= 40 ) {
	cjne	r3,#0x28,00160$
00160$:
	jc	00129$
;	../../shared/src/imp_cal.c:393: lnx_RXIMP_CAL_TIMEOUT_LANE = 1;
	mov	dptr,#(_CAL_CTRL3_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
	sjmp	00130$
00129$:
;	../../shared/src/imp_cal.c:396: lnx_RXIMP_CAL_PASS_LANE = 1;
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
00130$:
;	../../shared/src/imp_cal.c:398: lnx_CAL_RX_IMP_LANE_7_0 = rximp; 
	mov	dptr,#(_CAL_SAVE_DATA2_LANE + 0x0001)
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/imp_cal.c:399: IMPCAL_RX_LANE = rximp; 
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_2
	mov	a,r2
	add	a,r2
	add	a,acc
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/imp_cal.c:401: RX_IMPCAL_EN = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_2
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/imp_cal.c:403: lnx_RXIMP_CAL_DONE_LANE = 1;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
