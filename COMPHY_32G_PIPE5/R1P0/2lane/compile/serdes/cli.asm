...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'cli_monitor'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/cli.c:13: void cli_monitor(void) {
;	-----------------------------------------
;	 function cli_monitor
;	-----------------------------------------
_cli_monitor:
	ar2 = 0x02
	ar3 = 0x03
	...
	ar0 = 0x00
	ar1 = 0x01
;	../../shared/src/cli.c:26: switch(lnx_CLI_CMD_LANE_7_0) {
	mov	dptr,#(_DFE_CONTROL_10 + 0x0001)
	movx	a,@dptr
	mov	r2,a
	cjne	r2,#0x17,00109$
	sjmp	00101$
00109$:
;	../../shared/src/cli.c:36: case 0x17:  
	cjne	r2,#0x23,00104$
	sjmp	00102$
00101$:
;	../../shared/src/cli.c:38: eom_align_cal(); 
	mov	r0,#_eom_align_cal
	mov	r1,#(_eom_align_cal >> 8)
	mov	r2,#(_eom_align_cal >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cli.c:42: break;		
;	../../shared/src/cli.c:47: case 0x23: set_remote_tx(); break;
	sjmp	00104$
00102$:
	lcall	_set_remote_tx
;	../../shared/src/cli.c:50: }
00104$:
;	../../shared/src/cli.c:52: lnx_CLI_START_LANE = 0;
