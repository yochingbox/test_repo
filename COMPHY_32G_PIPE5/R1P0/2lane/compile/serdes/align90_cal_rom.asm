...
;--------------------------------------------------------
	...
	.globl _align90_comp_cal
	.globl _align90_read_pd
	.globl _align90_cal_update
	.globl _get_dac_inc
	.globl _get_dac_dec
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area BANK2   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'align90_comp_cal'
;------------------------------------------------------------
;dir                       Allocated to registers r2 
;loop_cnt                  Allocated to registers r4 
;pd                        Allocated to registers r5 
;output_cnt                Allocated to registers r3 
;------------------------------------------------------------
;	../../shared/src/align90_cal_rom.c:36: void align90_comp_cal(void) BANKING_CTRL {
;	-----------------------------------------
;	 function align90_comp_cal
;	-----------------------------------------
_align90_comp_cal:
	ar2 = 0x02
	ar3 = 0x03
	...
	ar0 = 0x00
	ar1 = 0x01
;	../../shared/src/align90_cal_rom.c:39: reg_PU_ALIGN90_LANE = 1;	
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_134
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/align90_cal_rom.c:41: if( cmx_RXALIGN90_CAL_EXT_EN ) {
	mov	dptr,#(_CONTROL_CONFIG1 + 0x0002)
	movx	a,@dptr
	jnb	acc.2,00102$
;	../../shared/src/align90_cal_rom.c:42: ALIGN90_CMP_OFFSET = lnx_CAL_ALIGN90_CMP_OFFSET_LANE_7_0;
	mov	dptr,#_CAL_SAVE_DATA2_LANE
	movx	a,@dptr
	mov	r2,a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/align90_cal_rom.c:43: return; 
	ljmp	00116$
00102$:
;	../../shared/src/align90_cal_rom.c:46: PHY_STATUS = ST_RXALIGN90CMP_CAL;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x10
	movx	@dptr,a
;	../../shared/src/align90_cal_rom.c:48: lnx_ALIGN90_COMP_PASS_LANE = 0;
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/align90_cal_rom.c:49: lnx_ALIGN90_COMP_CAL_DONE_LANE = 0;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/align90_cal_rom.c:50: dir = 0;
	mov	r2,#0x00
;	../../shared/src/align90_cal_rom.c:51: reg_ALIGN90_CMP_CAL_EN_LANE = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_11
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/align90_cal_rom.c:52: ALIGN90_CMP_OFFSET = 0x08;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_12
	movx	a,@dptr
	anl	a,#0x0f
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/align90_cal_rom.c:53: delay01(10);		
	mov	dptr,#0x000A
	push	ar2
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	...
	pop	ar2
;	../../shared/src/align90_cal_rom.c:58: do {
	mov	r3,#0x00
	mov	r4,#0x30
00113$:
;	../../shared/src/align90_cal_rom.c:60: pd = align90_read_pd();
	push	ar2
	push	ar3
	push	ar4
	...
	pop	ar3
	pop	ar2
;	../../shared/src/align90_cal_rom.c:61: if(pd == 1) {
	cjne	r5,#0x01,00104$
;	../../shared/src/align90_cal_rom.c:62: ALIGN90_CMP_OFFSET++;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_12
	movx	a,@dptr
	swap	a
	anl	a,#0x0f
	...
	sjmp	00105$
00104$:
;	../../shared/src/align90_cal_rom.c:65: ALIGN90_CMP_OFFSET--;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_12
	movx	a,@dptr
	swap	a
	anl	a,#0x0f
	...
	movx	@dptr,a
00105$:
;	../../shared/src/align90_cal_rom.c:67: delay01(10);		
	mov	dptr,#0x000A
	push	ar2
	push	ar3
	push	ar4
	...
	pop	ar3
	pop	ar2
;	../../shared/src/align90_cal_rom.c:69: dir<<=1;
	mov	a,r2
	add	a,r2
	mov	r2,a
;	../../shared/src/align90_cal_rom.c:70: dir |= pd;
	mov	a,r5
	orl	ar2,a
;	../../shared/src/align90_cal_rom.c:71: ++output_cnt;
	inc	r3
;	../../shared/src/align90_cal_rom.c:73: if (is_toggle_pat(dir, output_cnt )) {
	push	ar2
	push	ar3
	push	ar4
	push	ar3
	...
	mov	b0,c
	jnc	00107$
;	../../shared/src/align90_cal_rom.c:74: lnx_ALIGN90_COMP_PASS_LANE = 1;
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/align90_cal_rom.c:75: break;
	sjmp	00115$
00107$:
;	../../shared/src/align90_cal_rom.c:78: if(	ALIGN90_CMP_OFFSET==0xf || ALIGN90_CMP_OFFSET==0 ) {
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_12
	movx	a,@dptr
	swap	a
	anl	a,#0x0f
...
00129$:
	...
	anl	a,#0xf0
	jz	00115$
;	../../shared/src/align90_cal_rom.c:83: if(cmx_ALIGN90_CAL_TIMEOUT_DIS == 0)	//for test bench
	mov	dptr,#(_CAL_TIME_OUT_AND_DIS + 0x0001)
	movx	a,@dptr
	jb	acc.0,00114$
;	../../shared/src/align90_cal_rom.c:84: loop_cnt--;
	dec	r4
00114$:
;	../../shared/src/align90_cal_rom.c:85: } while(loop_cnt>0);
	mov	a,r4
	jz	00132$
	ljmp	00113$
00132$:
00115$:
;	../../shared/src/align90_cal_rom.c:87: reg_ALIGN90_CMP_CAL_EN_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_11
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/align90_cal_rom.c:88: lnx_CAL_ALIGN90_CMP_OFFSET_LANE_7_0 = ALIGN90_CMP_OFFSET;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_12
	movx	a,@dptr
	swap	a
	anl	a,#0x0f
	...
	mov	dptr,#_CAL_SAVE_DATA2_LANE
	movx	@dptr,a
;	../../shared/src/align90_cal_rom.c:89: lnx_ALIGN90_COMP_CAL_DONE_LANE = 1;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
...
;------------------------------------------------------------
;Allocation info for local variables in function 'align90_read_pd'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/align90_cal_rom.c:93: uint8_t align90_read_pd(void) BANKING_CTRL
;	-----------------------------------------
;	 function align90_read_pd
;	-----------------------------------------
_align90_read_pd:
;	../../shared/src/align90_cal_rom.c:95: reg_RX_ALIGN90_PD_OUT_RD_REQ_LANE = 0;
;	../../shared/src/align90_cal_rom.c:96: reg_RX_ALIGN90_PD_OUT_RD_REQ_LANE = 1; 
;	../../shared/src/align90_cal_rom.c:97: reg_RX_ALIGN90_PD_OUT_RD_REQ_LANE = 0;
	...
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/align90_cal_rom.c:99: return reg_ANA_RX_ALIGN90_PD_OUT_RD_LANE;
	...
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'align90_cal_update'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/align90_cal_rom.c:102: void align90_cal_update(void) BANKING_CTRL
;	-----------------------------------------
;	 function align90_cal_update
;	-----------------------------------------
_align90_cal_update:
;	../../shared/src/align90_cal_rom.c:104: reg_ALIGN90_DAC_LANE_5_0 = dac;
	mov	dptr,#_dac
	movx	a,@dptr
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/align90_cal_rom.c:105: reg_ALIGN90_DUMMY_CLK_LANE = dm;
	mov	dptr,#_dm
	movx	a,@dptr
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_13
	rrc	a
	...
	mov	acc.1,c
	movx	@dptr,a
;	../../shared/src/align90_cal_rom.c:106: reg_ALIGN90_GM_LANE_2_0 = gm_bin ^ (gm_bin>>1);
	mov	dptr,#_gm_bin
	movx	a,@dptr
	mov	r2,a
	clr	c
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/align90_cal_rom.c:107: ALIGN90_SYN_CLK	= 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_13
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/align90_cal_rom.c:108: delay01(2);
	mov	dptr,#0x0002
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/align90_cal_rom.c:109: ALIGN90_SYN_CLK	= 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_13
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'get_dac_inc'
;------------------------------------------------------------
;hit_boundary              Allocated to registers r2 
;------------------------------------------------------------
;	../../shared/src/align90_cal_rom.c:112: bool get_dac_inc(void) BANKING_CTRL
;	-----------------------------------------
;	 function get_dac_inc
;	-----------------------------------------
_get_dac_inc:
;	../../shared/src/align90_cal_rom.c:114: bool hit_boundary = 0;
	mov	r2,#0x00
;	../../shared/src/align90_cal_rom.c:116: do {
00123$:
;	../../shared/src/align90_cal_rom.c:117: if(dac==49)	{
	mov	dptr,#_dac
	movx	a,@dptr
	mov	r3,a
	cjne	r3,#0x31,00121$
;	../../shared/src/align90_cal_rom.c:118: if(gm_bin==6) {	dac = 51; dm = 0; }
	mov	dptr,#_gm_bin
	movx	a,@dptr
	mov	r4,a
	cjne	r4,#0x06,00105$
	...
	ljmp	00124$
00105$:
;	../../shared/src/align90_cal_rom.c:119: else if(gm_bin==7) { dac = 48; }					
	cjne	r4,#0x07,00102$
	mov	dptr,#_dac
	mov	a,#0x30
	movx	@dptr,a
	sjmp	00124$
00102$:
;	../../shared/src/align90_cal_rom.c:120: else { dac = 50; dm = 0; } 
	mov	dptr,#_dac
	mov	a,#0x32
	movx	@dptr,a
	mov	dptr,#_dm
	...
	sjmp	00124$
00121$:
;	../../shared/src/align90_cal_rom.c:123: if(dac==50 || dac==51) { 
	cjne	r3,#0x32,00142$
	sjmp	00116$
00142$:
	cjne	r3,#0x33,00117$
00116$:
;	../../shared/src/align90_cal_rom.c:124: if(gm_bin == 6) { dac = 49; gm_bin = 7; dm = 1; }
	mov	dptr,#_gm_bin
	movx	a,@dptr
	mov	r4,a
	cjne	r4,#0x06,00108$
	...
	sjmp	00124$
00108$:
;	../../shared/src/align90_cal_rom.c:125: else { dac = 0; gm_bin++; dm = 1; }}
	mov	dptr,#_dac
	clr	a
	movx	@dptr,a
	mov	dptr,#_gm_bin
	...
	sjmp	00124$
00117$:
;	../../shared/src/align90_cal_rom.c:127: if(gm_bin==7) {
	mov	dptr,#_gm_bin
	movx	a,@dptr
	mov	r4,a
	cjne	r4,#0x07,00114$
;	../../shared/src/align90_cal_rom.c:128: if(dac==0) { hit_boundary=1; break; }
	mov	a,r3
	jnz	00111$
	mov	r2,#0x01
	sjmp	00125$
00111$:
;	../../shared/src/align90_cal_rom.c:129: else dac--; 
	mov	a,r3
	dec	a
	mov	dptr,#_dac
	movx	@dptr,a
	sjmp	00124$
00114$:
;	../../shared/src/align90_cal_rom.c:131: else { dac++; }}				
	mov	dptr,#_dac
	mov	a,r3
	inc	a
	movx	@dptr,a
00124$:
;	../../shared/src/align90_cal_rom.c:134: } while (align90_step-->1);
...
00151$:
00125$:
;	../../shared/src/align90_cal_rom.c:136: return hit_boundary;
	mov	dpl,r2
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'get_dac_dec'
;------------------------------------------------------------
;hit_boundary              Allocated to registers r2 
;------------------------------------------------------------
;	../../shared/src/align90_cal_rom.c:139: bool get_dac_dec(void) BANKING_CTRL
;	-----------------------------------------
;	 function get_dac_dec
;	-----------------------------------------
_get_dac_dec:
;	../../shared/src/align90_cal_rom.c:141: bool hit_boundary = 0;
	mov	r2,#0x00
;	../../shared/src/align90_cal_rom.c:143: do {
00117$:
;	../../shared/src/align90_cal_rom.c:144: if(gm_bin==7) { 
	mov	dptr,#_gm_bin
	movx	a,@dptr
	mov	r3,a
	cjne	r3,#0x07,00115$
;	../../shared/src/align90_cal_rom.c:145: if(dac==49) { dac = 51; gm_bin = 6; dm = 0; }
	mov	dptr,#_dac
	movx	a,@dptr
	mov	r4,a
	cjne	r4,#0x31,00102$
	...
	sjmp	00118$
00102$:
;	../../shared/src/align90_cal_rom.c:146: else { dac++;}
	mov	dptr,#_dac
	mov	a,r4
	inc	a
	movx	@dptr,a
	sjmp	00118$
00115$:
;	../../shared/src/align90_cal_rom.c:149: if(dac==50 || dac==51) { dac = 49; dm = 1; }
	mov	dptr,#_dac
	movx	a,@dptr
	mov	r4,a
	cjne	r4,#0x32,00132$
...
00110$:
	...
	sjmp	00118$
00111$:
;	../../shared/src/align90_cal_rom.c:150: else if(dac==0){ 
	mov	a,r4
	jnz	00108$
;	../../shared/src/align90_cal_rom.c:151: if(gm_bin>1) {gm_bin--; dac = 51; dm = 0;}	
	mov	a,#0x01
	cjne	a,ar3,00136$
00136$:
	jnc	00105$
	...
	sjmp	00118$
00105$:
;	../../shared/src/align90_cal_rom.c:152: else { hit_boundary=1; break; }
	mov	r2,#0x01
	sjmp	00119$
00108$:
;	../../shared/src/align90_cal_rom.c:154: else { dac--; }
	mov	a,r4
	dec	a
	mov	dptr,#_dac
	movx	@dptr,a
00118$:
;	../../shared/src/align90_cal_rom.c:156: } while (align90_step--> 1);
	mov	dptr,#(_MCU_DEBUG0_LANE + 0x0001)
	movx	a,@dptr
	mov	r3,a
	mov	r4,a
...
00139$:
00119$:
;	../../shared/src/align90_cal_rom.c:158: return hit_boundary;
	mov	dpl,r2
	ljmp	__sdcc_banked_ret
	.area CSEG    (CODE)
	.area CSEG    (CODE)
