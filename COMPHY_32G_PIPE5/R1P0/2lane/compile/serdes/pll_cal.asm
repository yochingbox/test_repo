...
;--------------------------------------------------------
	.area BANK1   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'pll_cal'
;------------------------------------------------------------
;save_FBCK_SEL             Allocated to registers r4 
;save_FBDIV_h              Allocated to registers r2 
;save_FBDIV_l              Allocated to registers r3 
;------------------------------------------------------------
;	../../shared/src/pll_cal.c:78: void pll_cal( void ) BANKING_CTRL {
;	-----------------------------------------
;	 function pll_cal
;	-----------------------------------------
_pll_cal:
	...
	ar0 = 0x00
	ar1 = 0x01
;	../../shared/src/pll_cal.c:81: PHY_STATUS =  ST_PLL_CAL;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x05
	movx	@dptr,a
;	../../shared/src/pll_cal.c:84: if(phy_mode == SERDES) {
	mov	dptr,#(_SYSTEM + 0x0002)
	movx	a,@dptr
	anl	a,#0x07
	mov	r2,a
	cjne	r2,#0x04,00110$
;	../../shared/src/pll_cal.c:85: while(1) {
00107$:
;	../../shared/src/pll_cal.c:93: if(cmx_PLL_CAL_RING_DONE == 1) {
	mov	dptr,#(_CAL_STATUS_READ + 0x0003)
	movx	a,@dptr
	anl	a,#0x01
	mov	r2,a
	cjne	r2,#0x01,00107$
;	../../shared/src/pll_cal.c:94: delay01(10);
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/pll_cal.c:95: if(cmx_PLL_CAL_RING_DONE==1 && reg_PLL_CAL_EN_RING==0)
	mov	dptr,#(_CAL_STATUS_READ + 0x0003)
	movx	a,@dptr
	anl	a,#0x01
	mov	r2,a
	...
	movx	a,@dptr
	jb	acc.7,00107$
;	../../shared/src/pll_cal.c:96: break; //wait for RINGPLL calibration done
00110$:
;	../../shared/src/pll_cal.c:114: cmx_PLL_CAL_DONE = 0;
	mov	dptr,#(_CAL_STATUS_READ + 0x0002)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/pll_cal.c:116: if( cmx_PLL_CAL_EXT_EN /*|| (phy_mode==PCIE && cmx_PLL_CAL_PASS)*/) { //PCIe Link enable/disable test patch
	mov	dptr,#(_CONTROL_CONFIG1 + 0x0001)
	movx	a,@dptr
	jnb	acc.2,00114$
;	../../shared/src/pll_cal.c:117: pllcal_load(PWR);		
	mov	dpl,#0x00
	mov	r0,#_pllcal_load
	mov	r1,#(_pllcal_load >> 8)
	mov	r2,#(_pllcal_load >> 16)
	lcall	__sdcc_banked_call
	ljmp	00115$
00114$:
;	../../shared/src/pll_cal.c:120: save_FBDIV_h = reg_FBDIV_9_8;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_168
	movx	a,@dptr
	swap	a
	anl	a,#0x03
	mov	r2,a
;	../../shared/src/pll_cal.c:121: save_FBDIV_l = reg_FBDIV_7_0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_169
	movx	a,@dptr
	mov	r3,a
;	../../shared/src/pll_cal.c:122: save_FBCK_SEL = reg_ANA_FBCK_SEL;
	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
	movx	a,@dptr
	rr	a
	anl	a,#0x01
	mov	r4,a
;	../../shared/src/pll_cal.c:124: PLLCAL_EN = 1;	
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_168
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/pll_cal.c:125: reg_FBC_CNT_START = 0;
	mov	dptr,#_PLLCAL_REG1
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/pll_cal.c:126: loadSpdtbl_4_fcnt();
	push	ar2
	push	ar3
	push	ar4
	lcall	_loadSpdtbl_4_fcnt
;	../../shared/src/pll_cal.c:128: pll_cal_loop();
	mov	r0,#_pll_cal_loop
	mov	r1,#(_pll_cal_loop >> 8)
	mov	r2,#(_pll_cal_loop >> 16)
	lcall	__sdcc_banked_call
	pop	ar4
	pop	ar3
	pop	ar2
;	../../shared/src/pll_cal.c:130: reg_FBDIV_9_8 = save_FBDIV_h;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_168
	mov	a,r2
	swap	a
	anl	a,#(0xf0&0x30)
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/pll_cal.c:131: reg_FBDIV_7_0 = save_FBDIV_l;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_169
	mov	a,r3
	movx	@dptr,a
;	../../shared/src/pll_cal.c:132: reg_ANA_FBCK_SEL = save_FBCK_SEL;
	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
	mov	a,r4
	rrc	a
	movx	a,@dptr
	mov	acc.1,c
	movx	@dptr,a
;	../../shared/src/pll_cal.c:134: VCOAMP_VTH_SEL = TH_NORMAL;
	mov	dptr,#(_CONTROL_CONFIG4 + 0x0001)
	movx	a,@dptr
	mov	r2,a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/pll_cal.c:135: PLLCAL_EN = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_168
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/pll_cal.c:136: PLLAMPCAL_EN = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_168
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/pll_cal.c:137: reg_LCVCOCAL_BUF_EN = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_180
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/pll_cal.c:141: if(timeout) {
	jnb	_timeout,00115$
;	../../shared/src/pll_cal.c:142: cmx_PLL_CAL_PASS = 0;
	mov	dptr,#_CAL_STATUS_READ
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/pll_cal.c:143: pllcal_load(PWR);
	mov	dpl,#0x00
	mov	r0,#_pllcal_load
	mov	r1,#(_pllcal_load >> 8)
	mov	r2,#(_pllcal_load >> 16)
	lcall	__sdcc_banked_call
00115$:
;	../../shared/src/pll_cal.c:147: cmx_PLL_CAL_TIMEOUT_DIS = pll_cal_timeout_dis_save;
	...
	mov	acc.1,c
	movx	@dptr,a
;	../../shared/src/pll_cal.c:148: pllamp_step_cnt = cmx_PLLAMP_CAL_STEP_SIZE_7_0;
	mov	dptr,#(_CON_CAL_STEP_SIZE3 + 0x0001)
	movx	a,@dptr
	mov	dptr,#_pllamp_step_cnt
	movx	@dptr,a
;	../../shared/src/pll_cal.c:149: pllcal_save(CONT);
	mov	dpl,#0x01
	mov	r0,#_pllcal_save
	mov	r1,#(_pllcal_save >> 8)
	mov	r2,#(_pllcal_save >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/pll_cal.c:150: cmx_PLL_CAL_DONE = 1;
	mov	dptr,#(_CAL_STATUS_READ + 0x0002)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
...
;------------------------------------------------------------
;Allocation info for local variables in function 'pll_fast_cal'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/pll_cal.c:236: void pll_fast_cal(void) BANKING_CTRL {
;	-----------------------------------------
;	 function pll_fast_cal
;	-----------------------------------------
_pll_fast_cal:
;	../../shared/src/pll_cal.c:246: pllcal_load(CONT);
	mov	dpl,#0x01
	mov	r0,#_pllcal_load
	mov	r1,#(_pllcal_load >> 8)
	mov	r2,#(_pllcal_load >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/pll_cal.c:248: reg_ANA_PU_PLL  = 1;
	mov	dptr,#(_PM_CMN_REG1 + 0x0003)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/pll_cal.c:250: PULUP = 1;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_139
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/pll_cal.c:251: LD_CAL_DATA = 1;
	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/pll_cal.c:252: reg_LCVCOCAL_BUF_EN = 1; //need to align with SHRTR. Mengjie requested.
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_180
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/pll_cal.c:253: SHRTR = 1;	
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_139
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/pll_cal.c:255: delay01(5);
	mov	dptr,#0x0005
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/pll_cal.c:256: reg_ANA_PU_PLL_DLY = 1;
	mov	dptr,#(_PM_CMN_REG1 + 0x0003)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/pll_cal.c:257: reg_RESET_ANA = 0;
	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
	movx	a,@dptr
	anl	a,#0xef
	movx	@dptr,a
;	../../shared/src/pll_cal.c:259: delay01(Tpulup);
	mov	dptr,#(_TIMER_SEL3 + 0x0003)
	movx	a,@dptr
	mov	r2,a
	mov	r3,#0x00
	mov	dpl,r2
	...
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/pll_cal.c:260: PULUP = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_139
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/pll_cal.c:262: delay01(Tshrtr);
	mov	dptr,#_CONTROL_CONFIG3
	movx	a,@dptr
	mov	r2,a
	mov	r3,#0x00
	mov	dpl,r2
	...
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/pll_cal.c:263: SHRTR = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_139
	movx	a,@dptr
	anl	a,#0xef
	movx	@dptr,a
;	../../shared/src/pll_cal.c:264: reg_LCVCOCAL_BUF_EN = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_180
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/pll_cal.c:265: LD_CAL_DATA = 0;
	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/pll_cal.c:268: pll_tempc_speed_adj();
	mov	r0,#_pll_tempc_speed_adj
	mov	r1,#(_pll_tempc_speed_adj >> 8)
	mov	r2,#(_pll_tempc_speed_adj >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/pll_cal.c:282: pll_clk_ready_1();
	...
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'spdchg_pll_fast_cal'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/pll_cal.c:286: void spdchg_pll_fast_cal(void) BANKING_CTRL {
;	-----------------------------------------
;	 function spdchg_pll_fast_cal
;	-----------------------------------------
_spdchg_pll_fast_cal:
;	../../shared/src/pll_cal.c:295: pllcal_load(CONT);
	mov	dpl,#0x01
	mov	r0,#_pllcal_load
	mov	r1,#(_pllcal_load >> 8)
	mov	r2,#(_pllcal_load >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/pll_cal.c:297: LD_CAL_DATA = 1;
	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/pll_cal.c:298: reg_LCVCOCAL_BUF_EN = 1;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_180
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/pll_cal.c:299: SHRTR = 1;	
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_139
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/pll_cal.c:300: delay01(Tshrtr); 
	mov	dptr,#_CONTROL_CONFIG3
	movx	a,@dptr
	mov	r2,a
	mov	r3,#0x00
	...
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/pll_cal.c:301: SHRTR = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_139
	movx	a,@dptr
	anl	a,#0xef
	movx	@dptr,a
;	../../shared/src/pll_cal.c:302: reg_LCVCOCAL_BUF_EN = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_180
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/pll_cal.c:303: LD_CAL_DATA = 0;
	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/pll_cal.c:311: pll_tempc_speed_adj();	
	mov	r0,#_pll_tempc_speed_adj
	mov	r1,#(_pll_tempc_speed_adj >> 8)
	mov	r2,#(_pll_tempc_speed_adj >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/pll_cal.c:345: pll_clk_ready_1();
	mov	r0,#_pll_clk_ready_1
	mov	r1,#(_pll_clk_ready_1 >> 8)
	mov	r2,#(_pll_clk_ready_1 >> 16)
	lcall	__sdcc_banked_call
