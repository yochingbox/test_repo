   ...
   C93D 90 00 0A           2057 	mov	dptr,#0x000A
   C940 78 16              2058 	mov	r0,#_delay01
   C942 79 BC              2059 	mov	r1,#(_delay01 >> 8)
   C944 7A 02              2060 	mov	r2,#(_delay01 >> 16)
   C946 12 00 B3           2061 	lcall	__sdcc_banked_call
                           2062 ;	../../shared/src/pll_dcc_cal.c:39: PLLDCC_CLK = 1;
   C949 90 82 D8           2063 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_182
   C94C E0                 2064 	movx	a,@dptr
   C94D 44 01              2065 	orl	a,#0x01
   C94F F0                 2066 	movx	@dptr,a
                           2067 ;	../../shared/src/pll_dcc_cal.c:40: TXRXIMP_CKCAL = 1;
   C950 90 82 2C           2068 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_139
   C953 E0                 2069 	movx	a,@dptr
   C954 44 80              2070 	orl	a,#0x80
   C956 F0                 2071 	movx	@dptr,a
                           2072 ;	../../shared/src/pll_dcc_cal.c:41: delay01(10);
   C957 90 00 0A           2073 	mov	dptr,#0x000A
   C95A 78 16              2074 	mov	r0,#_delay01
   C95C 79 BC              2075 	mov	r1,#(_delay01 >> 8)
   C95E 7A 02              2076 	mov	r2,#(_delay01 >> 16)
   C960 12 00 B3           2077 	lcall	__sdcc_banked_call
                           2078 ;	../../shared/src/pll_dcc_cal.c:42: PLLDCC_CLK = 0;
   C963 90 82 D8           2079 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_182
   C966 E0                 2080 	movx	a,@dptr
   C967 54 FE              2081 	anl	a,#0xfe
   C969 F0                 2082 	movx	@dptr,a
                           2083 ;	../../shared/src/pll_dcc_cal.c:43: TXRXIMP_CKCAL = 0;
   C96A 90 82 2C           2084 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_139
   C96D E0                 2085 	movx	a,@dptr
   C96E 54 7F              2086 	anl	a,#0x7f
   C970 F0                 2087 	movx	@dptr,a
   C971 02 00 C5           2088 	ljmp	__sdcc_banked_ret
                           2089 ;------------------------------------------------------------
                           ...
                           2104 ;	-----------------------------------------
   C974                    2105 _plldcc_cal:
   C974 C0 18              2106 	push	_bp
   C976 E5 81              2107 	mov	a,sp
   C978 F5 18              2108 	mov	_bp,a
   C97A 24 04              2109 	add	a,#0x04
   C97C F5 81              2110 	mov	sp,a
                           2111 ;	../../shared/src/pll_dcc_cal.c:56: PHY_STATUS = ST_PLLDCC_CAL;
   C97E 90 22 30           2112 	mov	dptr,#_MCU_STATUS0_LANE
   C981 74 06              2113 	mov	a,#0x06
   C983 F0                 2114 	movx	@dptr,a
                           2115 ;	../../shared/src/pll_dcc_cal.c:58: cmx_PLLDCC_CAL_DONE = 0;
   C984 90 E6 4C           2116 	mov	dptr,#_CAL_STATUS_READ
   C987 E0                 2117 	movx	a,@dptr
   C988 54 FD              2118 	anl	a,#0xfd
   C98A F0                 2119 	movx	@dptr,a
                           2120 ;	../../shared/src/pll_dcc_cal.c:60: in_cont_mode = 0;
   C98B 7A 00              2121 	mov	r2,#0x00
                           2122 ;	../../shared/src/pll_dcc_cal.c:62: dir = 0;
   C98D E5 18              2123 	mov	a,_bp
   C98F 24 04              2124 	add	a,#0x04
   C991 F8                 2125 	mov	r0,a
   C992 76 00              2126 	mov	@r0,#0x00
                           2127 ;	../../shared/src/pll_dcc_cal.c:63: reg_ANA_CMN_IMPCAL_OUT_REQ = 1;
   C994 90 A3 40           2128 	mov	dptr,#_CMN_CALIBRATION
   C997 E0                 2129 	movx	a,@dptr
   C998 44 10              2130 	orl	a,#0x10
   C99A F0                 2131 	movx	@dptr,a
                           2132 ;	../../shared/src/pll_dcc_cal.c:66: if (lnx_CAL_DONE_LANE == 0) {                        //power-on calibration
   C99B 90 60 03           2133 	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
   C99E E0                 2134 	movx	a,@dptr
   C99F 20 E0 45           2135 	jb	acc.0,00111$
                           2136 ;	../../shared/src/pll_dcc_cal.c:67: ext_en = cmx_PLLDCC_CAL_EXT_EN;
   C9A2 90 E6 09           2137 	mov	dptr,#(_CONTROL_CONFIG1 + 0x0001)
   C9A5 E0                 2138 	movx	a,@dptr
   C9A6 03                 2139 	rr	a
   C9A7 54 01              2140 	anl	a,#0x01
                           2141 ;	../../shared/src/pll_dcc_cal.c:68: if (ext_en)                                     //use ext value for power-on, bypass calibration
   C9A9 FC                 2142 	mov	r4,a
   C9AA 60 16              2143 	jz	00102$
                           2144 ;	../../shared/src/pll_dcc_cal.c:69: dcc_cnt = cmx_cal_plldcc[PWR][PLL_RATE_SEL];
   C9AC 90 E6 1E           2145 	mov	dptr,#(_CONTROL_CONFIG6 + 0x0002)
   C9AF E0                 2146 	movx	a,@dptr
   C9B0 24 CC              2147 	add	a,#_cmx_cal_plldcc
   C9B2 F5 82              2148 	mov	dpl,a
   C9B4 E4                 2149 	clr	a
   C9B5 34 E5              2150 	addc	a,#(_cmx_cal_plldcc >> 8)
   C9B7 F5 83              2151 	mov	dph,a
   C9B9 E0                 2152 	movx	a,@dptr
   C9BA FC                 2153 	mov	r4,a
   C9BB A8 18              2154 	mov	r0,_bp
   C9BD 08                 2155 	inc	r0
   C9BE A6 04              2156 	mov	@r0,ar4
   C9C0 80 13              2157 	sjmp	00103$
   C9C2                    2158 00102$:
                           2159 ;	../../shared/src/pll_dcc_cal.c:71: cmx_PLLDCC_CAL_PASS = 0;
   C9C2 90 E6 4D           2160 	mov	dptr,#(_CAL_STATUS_READ + 0x0001)
   C9C5 E0                 2161 	movx	a,@dptr
   C9C6 54 FB              2162 	anl	a,#0xfb
   C9C8 F0                 2163 	movx	@dptr,a
                           2164 ;	../../shared/src/pll_dcc_cal.c:72: PLLDCCCAL_EN = 1;
   C9C9 90 82 DC           2165 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_183
   C9CC E0                 2166 	movx	a,@dptr
   C9CD 44 80              2167 	orl	a,#0x80
   C9CF F0                 2168 	movx	@dptr,a
                           2169 ;	../../shared/src/pll_dcc_cal.c:73: dcc_cnt = 0;
   C9D0 A8 18              2170 	mov	r0,_bp
   C9D2 08                 2171 	inc	r0
   C9D3 76 00              2172 	mov	@r0,#0x00
   C9D5                    2173 00103$:
                           2174 ;	../../shared/src/pll_dcc_cal.c:75: PLLDCC_EN = 1;                                  //enable PLLDCC_EN during power-on, never deassert
   C9D5 90 82 D4           2175 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_181
   C9D8 E0                 2176 	movx	a,@dptr
   C9D9 44 20              2177 	orl	a,#0x20
   C9DB F0                 2178 	movx	@dptr,a
   ...
   C9DC 90 E6 3C           2180 	mov	dptr,#_CON_CAL_STEP_SIZE3
   C9DF E0                 2181 	movx	a,@dptr
   C9E0 FD                 2182 	mov	r5,a
   C9E1 90 66 0D           2183 	mov	dptr,#_plldcc_step_cnt
   C9E4 F0                 2184 	movx	@dptr,a
   C9E5 80 64              2185 	sjmp	00167$
   C9E7                    2186 00111$:
                           2187 ;	../../shared/src/pll_dcc_cal.c:78: else if (LOAD_CAL_ON) {                         //not power-on. Speed-change, load result for current rate
   C9E7 90 60 08           2188 	mov	dptr,#_CAL_CTRL3_LANE
   C9EA E0                 2189 	movx	a,@dptr
   C9EB 60 2E              2190 	jz	00108$
                           2191 ;	../../shared/src/pll_dcc_cal.c:80: dcc_cnt = cmx_cal_plldcc[PWR + cmx_PLLDCC_CAL_CONT_CUR_LOAD_EN][PLL_RATE_SEL];
   C9ED 90 E6 32           2192 	mov	dptr,#(_CONTROL_CONFIG9 + 0x0002)
   C9F0 E0                 2193 	movx	a,@dptr
   C9F1 C4                 2194 	swap	a
   C9F2 54 01              2195 	anl	a,#0x01
   C9F4 25 E0              2196 	add	a,acc
   C9F6 24 CC              2197 	add	a,#_cmx_cal_plldcc
   C9F8 FD                 2198 	mov	r5,a
   C9F9 E4                 2199 	clr	a
   C9FA 34 E5              2200 	addc	a,#(_cmx_cal_plldcc >> 8)
   C9FC FE                 2201 	mov	r6,a
   C9FD 90 E6 1E           2202 	mov	dptr,#(_CONTROL_CONFIG6 + 0x0002)
   CA00 E0                 2203 	movx	a,@dptr
   CA01 FF                 2204 	mov	r7,a
   CA02 2D                 2205 	add	a,r5
   CA03 F5 82              2206 	mov	dpl,a
   CA05 E4                 2207 	clr	a
   CA06 3E                 2208 	addc	a,r6
   CA07 F5 83              2209 	mov	dph,a
   CA09 E0                 2210 	movx	a,@dptr
   CA0A FD                 2211 	mov	r5,a
   CA0B A8 18              2212 	mov	r0,_bp
   CA0D 08                 2213 	inc	r0
   CA0E A6 05              2214 	mov	@r0,ar5
   ...
   CA10 90 E6 3C           2216 	mov	dptr,#_CON_CAL_STEP_SIZE3
   CA13 E0                 2217 	movx	a,@dptr
   CA14 FD                 2218 	mov	r5,a
   CA15 90 66 0D           2219 	mov	dptr,#_plldcc_step_cnt
   CA18 F0                 2220 	movx	@dptr,a
   CA19 80 30              2221 	sjmp	00167$
   CA1B                    2222 00108$:
                           2223 ;	../../shared/src/pll_dcc_cal.c:83: else if (cmx_PLLDCC_CAL_CONT_EN) {              //not power-on. Continious mode.
   CA1B 90 E6 0E           2224 	mov	dptr,#(_CONTROL_CONFIG2 + 0x0002)
   CA1E E0                 2225 	movx	a,@dptr
   CA1F 30 E4 1F           2226 	jnb	acc.4,00105$
                           2227 ;	../../shared/src/pll_dcc_cal.c:84: PLLDCCCAL_EN = 1;
   CA22 90 82 DC           2228 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_183
   CA25 E0                 2229 	movx	a,@dptr
   CA26 44 80              2230 	orl	a,#0x80
   CA28 F0                 2231 	movx	@dptr,a
                           2232 ;	../../shared/src/pll_dcc_cal.c:85: dcc_cnt = cmx_cal_plldcc[CONT][PLL_RATE_SEL];    //always load cont result
   CA29 90 E6 1E           2233 	mov	dptr,#(_CONTROL_CONFIG6 + 0x0002)
   CA2C E0                 2234 	movx	a,@dptr
   CA2D 24 CE              2235 	add	a,#(_cmx_cal_plldcc + 0x0002)
   CA2F F5 82              2236 	mov	dpl,a
   CA31 E4                 2237 	clr	a
   CA32 34 E5              2238 	addc	a,#((_cmx_cal_plldcc + 0x0002) >> 8)
   CA34 F5 83              2239 	mov	dph,a
   CA36 E0                 2240 	movx	a,@dptr
   CA37 FD                 2241 	mov	r5,a
   CA38 A8 18              2242 	mov	r0,_bp
   CA3A 08                 2243 	inc	r0
   CA3B A6 05              2244 	mov	@r0,ar5
                           2245 ;	../../shared/src/pll_dcc_cal.c:86: in_cont_mode = 1;
   CA3D 7A 01              2246 	mov	r2,#0x01
   CA3F 80 0A              2247 	sjmp	00167$
   CA41                    2248 00105$:
                           2249 ;	../../shared/src/pll_dcc_cal.c:89: cmx_PLLDCC_CAL_DONE = 1;
   CA41 90 E6 4C           2250 	mov	dptr,#_CAL_STATUS_READ
   CA44 E0                 2251 	movx	a,@dptr
   CA45 44 02              2252 	orl	a,#0x02
   CA47 F0                 2253 	movx	@dptr,a
                           2254 ;	../../shared/src/pll_dcc_cal.c:90: return;
   CA48 02 CC 2B           2255 	ljmp	00149$
                           2256 ;	../../shared/src/pll_dcc_cal.c:94: do {
   CA4B                    2257 00167$:
   CA4B 7D 00              2258 	mov	r5,#0x00
   CA4D                    2259 00144$:
                           2260 ;	../../shared/src/pll_dcc_cal.c:95: PLLDCC_CNT = dcc_cnt;
   CA4D A8 18              2261 	mov	r0,_bp
   CA4F 08                 2262 	inc	r0
   CA50 86 06              2263 	mov	ar6,@r0
   CA52 90 82 D8           2264 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_182
   CA55 EE                 2265 	mov	a,r6
   CA56 2E                 2266 	add	a,r6
   CA57 25 E0              2267 	add	a,acc
   CA59 54 FC              2268 	anl	a,#0xfc
   CA5B F5 F0              2269 	mov	b,a
   CA5D E0                 2270 	movx	a,@dptr
   CA5E 54 03              2271 	anl	a,#0x03
   CA60 45 F0              2272 	orl	a,b
   CA62 F0                 2273 	movx	@dptr,a
                           2274 ;	../../shared/src/pll_dcc_cal.c:96: plldcc_clk_toggle();
   CA63 C0 02              2275 	push	ar2
   CA65 C0 05              2276 	push	ar5
   CA67 78 3D              2277 	mov	r0,#_plldcc_clk_toggle
   CA69 79 C9              2278 	mov	r1,#(_plldcc_clk_toggle >> 8)
   CA6B 7A 02              2279 	mov	r2,#(_plldcc_clk_toggle >> 16)
   CA6D 12 00 B3           2280 	lcall	__sdcc_banked_call
   CA70 D0 05              2281 	pop	ar5
   CA72 D0 02              2282 	pop	ar2
   ...
   CA75 90 82 DC           2286 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_183
   CA78 E0                 2287 	movx	a,@dptr
   CA79 20 E7 03           2288 	jb	acc.7,00174$
   CA7C 02 CB F0           2289 	ljmp	00146$
   CA7F                    2290 00174$:
                           2291 ;	../../shared/src/pll_dcc_cal.c:100: if( lnx_CAL_DONE_LANE == 1 && time_out_cnt > 1) break;                    //continious mode, has ran 1 round
   CA7F 90 60 03           2292 	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
   CA82 E0                 2293 	movx	a,@dptr
   CA83 54 01              2294 	anl	a,#0x01
   CA85 FE                 2295 	mov	r6,a
   CA86 BE 01 0A           2296 	cjne	r6,#0x01,00116$
   CA89 74 01              2297 	mov	a,#0x01
   CA8B B5 05 00           2298 	cjne	a,ar5,00177$
   CA8E                    2299 00177$:
   CA8E 50 03              2300 	jnc	00178$
   CA90 02 CB F0           2301 	ljmp	00146$
   CA93                    2302 00178$:
   CA93                    2303 00116$:
   ...
   CA93 90 60 03           2305 	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
   CA96 E0                 2306 	movx	a,@dptr
   CA97 20 E0 2D           2307 	jb	acc.0,00119$
   CA9A ED                 2308 	mov	a,r5
   CA9B 14                 2309 	dec	a
   CA9C FE                 2310 	mov	r6,a
   CA9D C0 02              2311 	push	ar2
   CA9F C0 05              2312 	push	ar5
   CAA1 C0 06              2313 	push	ar6
   CAA3 E5 18              2314 	mov	a,_bp
   CAA5 24 04              2315 	add	a,#0x04
   CAA7 F8                 2316 	mov	r0,a
   CAA8 86 82              2317 	mov	dpl,@r0
   CAAA 78 CD              2318 	mov	r0,#_is_toggle_pat
   CAAC 79 BD              2319 	mov	r1,#(_is_toggle_pat >> 8)
   CAAE 7A 02              2320 	mov	r2,#(_is_toggle_pat >> 16)
   CAB0 12 00 B3           2321 	lcall	__sdcc_banked_call
   CAB3 15 81              2322 	dec	sp
   CAB5 D0 05              2323 	pop	ar5
   CAB7 D0 02              2324 	pop	ar2
   CAB9 92 28              2325 	mov	b0,c
   CABB 50 0A              2326 	jnc	00119$
   CABD 90 E6 4D           2327 	mov	dptr,#(_CAL_STATUS_READ + 0x0001)
   CAC0 E0                 2328 	movx	a,@dptr
   CAC1 44 04              2329 	orl	a,#0x04
   CAC3 F0                 2330 	movx	@dptr,a
   CAC4 02 CB F0           2331 	ljmp	00146$
   CAC7                    2332 00119$:
   ...
   CAC7 90 60 03           2334 	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
   CACA E0                 2335 	movx	a,@dptr
   CACB 20 E0 0F           2336 	jb	acc.0,00122$
   CACE BD 40 00           2337 	cjne	r5,#0x40,00182$
   CAD1                    2338 00182$:
   CAD1 40 0A              2339 	jc	00122$
   CAD3 90 E6 48           2340 	mov	dptr,#_CAL_TIME_OUT_AND_DIS
   CAD6 E0                 2341 	movx	a,@dptr
   CAD7 20 E5 03           2342 	jb	acc.5,00184$
   CADA 02 CB F0           2343 	ljmp	00146$
   CADD                    2344 00184$:
   CADD                    2345 00122$:
                           2346 ;	../../shared/src/pll_dcc_cal.c:104: latched_PLLDCC_DN = PLLDCC_DN;
   CADD 90 A3 40           2347 	mov	dptr,#_CMN_CALIBRATION
   CAE0 E0                 2348 	movx	a,@dptr
   CAE1 C4                 2349 	swap	a
   CAE2 23                 2350 	rl	a
   CAE3 54 01              2351 	anl	a,#0x01
   CAE5 FE                 2352 	mov	r6,a
                           2353 ;	../../shared/src/pll_dcc_cal.c:105: reg_MCU_DEBUG_CMN_2_7_0 = latched_PLLDCC_DN; //for testbench
   CAE6 90 A2 16           2354 	mov	dptr,#(_MCU_DEBUG0 + 0x0002)
   CAE9 EE                 2355 	mov	a,r6
   CAEA F0                 2356 	movx	@dptr,a
                           2357 ;	../../shared/src/pll_dcc_cal.c:106: int_up = 0;
   CAEB E5 18              2358 	mov	a,_bp
   CAED 24 03              2359 	add	a,#0x03
   CAEF F8                 2360 	mov	r0,a
   CAF0 76 00              2361 	mov	@r0,#0x00
                           2362 ;	../../shared/src/pll_dcc_cal.c:107: int_dn = 0;
   CAF2 A8 18              2363 	mov	r0,_bp
   CAF4 08                 2364 	inc	r0
   CAF5 08                 2365 	inc	r0
   CAF6 76 00              2366 	mov	@r0,#0x00
                           2367 ;	../../shared/src/pll_dcc_cal.c:109: if (in_cont_mode) { //continious calibration
   CAF8 EA                 2368 	mov	a,r2
   CAF9 60 70              2369 	jz	00137$
                           2370 ;	../../shared/src/pll_dcc_cal.c:110: if (latched_PLLDCC_DN) {plldcc_step_cnt--;}
   CAFB EE                 2371 	mov	a,r6
   CAFC 60 0B              2372 	jz	00126$
   CAFE 90 66 0D           2373 	mov	dptr,#_plldcc_step_cnt
   CB01 E0                 2374 	movx	a,@dptr
   CB02 14                 2375 	dec	a
   CB03 90 66 0D           2376 	mov	dptr,#_plldcc_step_cnt
   CB06 F0                 2377 	movx	@dptr,a
   CB07 80 07              2378 	sjmp	00127$
   CB09                    2379 00126$:
                           2380 ;	../../shared/src/pll_dcc_cal.c:111: else                   {plldcc_step_cnt++;}
   CB09 90 66 0D           2381 	mov	dptr,#_plldcc_step_cnt
   CB0C E0                 2382 	movx	a,@dptr
   CB0D 24 01              2383 	add	a,#0x01
   CB0F F0                 2384 	movx	@dptr,a
   CB10                    2385 00127$:
                           2386 ;	../../shared/src/pll_dcc_cal.c:113: if( plldcc_step_cnt == 0) {
   CB10 90 66 0D           2387 	mov	dptr,#_plldcc_step_cnt
   CB13 E0                 2388 	movx	a,@dptr
   CB14 FF                 2389 	mov	r7,a
   CB15 70 1B              2390 	jnz	00131$
                           2391 ;	../../shared/src/pll_dcc_cal.c:114: int_up = 0;
   CB17 C0 02              2392 	push	ar2
   CB19 E5 18              2393 	mov	a,_bp
   CB1B 24 03              2394 	add	a,#0x03
   CB1D F8                 2395 	mov	r0,a
   CB1E 76 00              2396 	mov	@r0,#0x00
                           2397 ;	../../shared/src/pll_dcc_cal.c:115: int_dn = 1;
   CB20 A8 18              2398 	mov	r0,_bp
   CB22 08                 2399 	inc	r0
   CB23 08                 2400 	inc	r0
   CB24 76 01              2401 	mov	@r0,#0x01
   ...
   CB26 90 E6 3C           2403 	mov	dptr,#_CON_CAL_STEP_SIZE3
   CB29 E0                 2404 	movx	a,@dptr
   CB2A 90 66 0D           2405 	mov	dptr,#_plldcc_step_cnt
   CB2D F0                 2406 	movx	@dptr,a
   CB2E D0 02              2407 	pop	ar2
   CB30 80 58              2408 	sjmp	00138$
   CB32                    2409 00131$:
                           2410 ;	../../shared/src/pll_dcc_cal.c:118: else if(plldcc_step_cnt>=(PLLDCC_CAL_STEP_SIZE<<1)) {
   CB32 C0 02              2411 	push	ar2
   CB34 90 E6 3C           2412 	mov	dptr,#_CON_CAL_STEP_SIZE3
   CB37 E0                 2413 	movx	a,@dptr
   CB38 FA                 2414 	mov	r2,a
   CB39 E4                 2415 	clr	a
   CB3A CA                 2416 	xch	a,r2
   CB3B 25 E0              2417 	add	a,acc
   CB3D CA                 2418 	xch	a,r2
   CB3E 33                 2419 	rlc	a
   CB3F FB                 2420 	mov	r3,a
   CB40 7C 00              2421 	mov	r4,#0x00
   CB42 C3                 2422 	clr	c
   CB43 EF                 2423 	mov	a,r7
   CB44 9A                 2424 	subb	a,r2
   CB45 EC                 2425 	mov	a,r4
   CB46 64 80              2426 	xrl	a,#0x80
   CB48 8B F0              2427 	mov	b,r3
   CB4A 63 F0 80           2428 	xrl	b,#0x80
   CB4D 95 F0              2429 	subb	a,b
   CB4F D0 02              2430 	pop	ar2
   CB51 40 37              2431 	jc	00138$
                           2432 ;	../../shared/src/pll_dcc_cal.c:119: int_up = 1;
   CB53 E5 18              2433 	mov	a,_bp
   CB55 24 03              2434 	add	a,#0x03
   CB57 F8                 2435 	mov	r0,a
   CB58 76 01              2436 	mov	@r0,#0x01
                           2437 ;	../../shared/src/pll_dcc_cal.c:120: int_dn = 0;
   CB5A A8 18              2438 	mov	r0,_bp
   CB5C 08                 2439 	inc	r0
   CB5D 08                 2440 	inc	r0
   CB5E 76 00              2441 	mov	@r0,#0x00
   ...
   CB60 90 E6 3C           2443 	mov	dptr,#_CON_CAL_STEP_SIZE3
   CB63 E0                 2444 	movx	a,@dptr
   CB64 FB                 2445 	mov	r3,a
   CB65 90 66 0D           2446 	mov	dptr,#_plldcc_step_cnt
   CB68 F0                 2447 	movx	@dptr,a
   CB69 80 1F              2448 	sjmp	00138$
   CB6B                    2449 00137$:
                           2450 ;	../../shared/src/pll_dcc_cal.c:125: if (latched_PLLDCC_DN) {int_up = 0; int_dn = 1;}
   CB6B EE                 2451 	mov	a,r6
   CB6C 60 0F              2452 	jz	00134$
   CB6E E5 18              2453 	mov	a,_bp
   CB70 24 03              2454 	add	a,#0x03
   CB72 F8                 2455 	mov	r0,a
   CB73 76 00              2456 	mov	@r0,#0x00
   CB75 A8 18              2457 	mov	r0,_bp
   CB77 08                 2458 	inc	r0
   CB78 08                 2459 	inc	r0
   CB79 76 01              2460 	mov	@r0,#0x01
   CB7B 80 0D              2461 	sjmp	00138$
   CB7D                    2462 00134$:
                           2463 ;	../../shared/src/pll_dcc_cal.c:126: else                   {int_up = 1; int_dn = 0;}
   CB7D E5 18              2464 	mov	a,_bp
   CB7F 24 03              2465 	add	a,#0x03
   CB81 F8                 2466 	mov	r0,a
   CB82 76 01              2467 	mov	@r0,#0x01
   CB84 A8 18              2468 	mov	r0,_bp
   CB86 08                 2469 	inc	r0
   CB87 08                 2470 	inc	r0
   CB88 76 00              2471 	mov	@r0,#0x00
   CB8A                    2472 00138$:
                           2473 ;	../../shared/src/pll_dcc_cal.c:129: dir<<=1;
   CB8A E5 18              2474 	mov	a,_bp
   CB8C 24 04              2475 	add	a,#0x04
   CB8E F8                 2476 	mov	r0,a
   CB8F E6                 2477 	mov	a,@r0
   CB90 25 E0              2478 	add	a,acc
   CB92 F6                 2479 	mov	@r0,a
                           2480 ;	../../shared/src/pll_dcc_cal.c:130: if (int_dn == 1) {
   CB93 A8 18              2481 	mov	r0,_bp
   CB95 08                 2482 	inc	r0
   CB96 08                 2483 	inc	r0
   CB97 B6 01 20           2484 	cjne	@r0,#0x01,00142$
                           2485 ;	../../shared/src/pll_dcc_cal.c:131: dcc_cnt = sign_abs_dn(dcc_cnt);
   CB9A A8 18              2486 	mov	r0,_bp
   CB9C 08                 2487 	inc	r0
   CB9D 86 82              2488 	mov	dpl,@r0
   CB9F C0 02              2489 	push	ar2
   CBA1 C0 05              2490 	push	ar5
   CBA3 78 55              2491 	mov	r0,#_sign_abs_dn
   CBA5 79 BD              2492 	mov	r1,#(_sign_abs_dn >> 8)
   CBA7 7A 02              2493 	mov	r2,#(_sign_abs_dn >> 16)
   CBA9 12 00 B3           2494 	lcall	__sdcc_banked_call
   CBAC AB 82              2495 	mov	r3,dpl
   CBAE D0 05              2496 	pop	ar5
   CBB0 D0 02              2497 	pop	ar2
   CBB2 A8 18              2498 	mov	r0,_bp
   CBB4 08                 2499 	inc	r0
   CBB5 A6 03              2500 	mov	@r0,ar3
   CBB7 02 CA 4D           2501 	ljmp	00144$
   CBBA                    2502 00142$:
                           2503 ;	../../shared/src/pll_dcc_cal.c:133: else if (int_up == 1) {
   CBBA E5 18              2504 	mov	a,_bp
   CBBC 24 03              2505 	add	a,#0x03
   CBBE F8                 2506 	mov	r0,a
   CBBF B6 01 02           2507 	cjne	@r0,#0x01,00192$
   CBC2 80 03              2508 	sjmp	00193$
   CBC4                    2509 00192$:
   CBC4 02 CA 4D           2510 	ljmp	00144$
   CBC7                    2511 00193$:
                           2512 ;	../../shared/src/pll_dcc_cal.c:134: dir |= 1;
   CBC7 E5 18              2513 	mov	a,_bp
   CBC9 24 04              2514 	add	a,#0x04
   CBCB F8                 2515 	mov	r0,a
   CBCC E6                 2516 	mov	a,@r0
   CBCD 44 01              2517 	orl	a,#0x01
   CBCF F6                 2518 	mov	@r0,a
                           2519 ;	../../shared/src/pll_dcc_cal.c:135: dcc_cnt = sign_abs_up(dcc_cnt);
   CBD0 A8 18              2520 	mov	r0,_bp
   CBD2 08                 2521 	inc	r0
   CBD3 86 82              2522 	mov	dpl,@r0
   CBD5 C0 02              2523 	push	ar2
   CBD7 C0 05              2524 	push	ar5
   CBD9 78 33              2525 	mov	r0,#_sign_abs_up
   CBDB 79 BD              2526 	mov	r1,#(_sign_abs_up >> 8)
   CBDD 7A 02              2527 	mov	r2,#(_sign_abs_up >> 16)
   CBDF 12 00 B3           2528 	lcall	__sdcc_banked_call
   CBE2 AB 82              2529 	mov	r3,dpl
   CBE4 D0 05              2530 	pop	ar5
   CBE6 D0 02              2531 	pop	ar2
   CBE8 A8 18              2532 	mov	r0,_bp
   CBEA 08                 2533 	inc	r0
   CBEB A6 03              2534 	mov	@r0,ar3
                           2535 ;	../../shared/src/pll_dcc_cal.c:138: } while (1);
   CBED 02 CA 4D           2536 	ljmp	00144$
   CBF0                    2537 00146$:
                           2538 ;	../../shared/src/pll_dcc_cal.c:141: if (lnx_CAL_DONE_LANE == 0) {                        //if power-on calibration
   CBF0 90 60 03           2539 	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
   CBF3 E0                 2540 	movx	a,@dptr
   CBF4 20 E0 13           2541 	jb	acc.0,00148$
                           2542 ;	../../shared/src/pll_dcc_cal.c:142: cmx_cal_plldcc[PWR][PLL_RATE_SEL] = dcc_cnt;   //save to power-on result
   CBF7 90 E6 1E           2543 	mov	dptr,#(_CONTROL_CONFIG6 + 0x0002)
   CBFA E0                 2544 	movx	a,@dptr
   CBFB FA                 2545 	mov	r2,a
   CBFC 24 CC              2546 	add	a,#_cmx_cal_plldcc
   CBFE F5 82              2547 	mov	dpl,a
   CC00 E4                 2548 	clr	a
   CC01 34 E5              2549 	addc	a,#(_cmx_cal_plldcc >> 8)
   CC03 F5 83              2550 	mov	dph,a
   CC05 A8 18              2551 	mov	r0,_bp
   CC07 08                 2552 	inc	r0
   CC08 E6                 2553 	mov	a,@r0
   CC09 F0                 2554 	movx	@dptr,a
   CC0A                    2555 00148$:
   ...
   CC0A 90 E6 1E           2557 	mov	dptr,#(_CONTROL_CONFIG6 + 0x0002)
   CC0D E0                 2558 	movx	a,@dptr
   CC0E FA                 2559 	mov	r2,a
   CC0F 24 CE              2560 	add	a,#(_cmx_cal_plldcc + 0x0002)
   CC11 F5 82              2561 	mov	dpl,a
   CC13 E4                 2562 	clr	a
   CC14 34 E5              2563 	addc	a,#((_cmx_cal_plldcc + 0x0002) >> 8)
   CC16 F5 83              2564 	mov	dph,a
   CC18 A8 18              2565 	mov	r0,_bp
   CC1A 08                 2566 	inc	r0
   CC1B E6                 2567 	mov	a,@r0
   CC1C F0                 2568 	movx	@dptr,a
                           2569 ;	../../shared/src/pll_dcc_cal.c:146: PLLDCCCAL_EN = 0;
   CC1D 90 82 DC           2570 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_183
   CC20 E0                 2571 	movx	a,@dptr
   CC21 54 7F              2572 	anl	a,#0x7f
   CC23 F0                 2573 	movx	@dptr,a
                           2574 ;	../../shared/src/pll_dcc_cal.c:147: cmx_PLLDCC_CAL_DONE = 1;
   CC24 90 E6 4C           2575 	mov	dptr,#_CAL_STATUS_READ
   CC27 E0                 2576 	movx	a,@dptr
   CC28 44 02              2577 	orl	a,#0x02
   CC2A F0                 2578 	movx	@dptr,a
   CC2B                    2579 00149$:
   CC2B 85 18 81           2580 	mov	sp,_bp
   CC2E D0 18              2581 	pop	_bp
   CC30 02 00 C5           2582 	ljmp	__sdcc_banked_ret
                           2583 	.area CSEG    (CODE)
