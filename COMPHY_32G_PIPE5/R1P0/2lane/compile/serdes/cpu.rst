                              ...
                              4 ; This file was generated Thu Oct 18 21:21:55 2018
                              5 ;--------------------------------------------------------
                              6 	.module cpu
   ...
   0000                    1115 	.ds 8
                    ...
                    607C   1990 _sq_thrs_ratio_tb	=	0x607c
                           ...
                           2023 	.area CSEG    (CODE)
                           2024 ;------------------------------------------------------------
                           2025 ;Allocation info for local variables in function 'cpu_init'
                           2026 ;------------------------------------------------------------
                           2027 ;------------------------------------------------------------
                           2028 ;	../../shared/src/cpu.c:11: void cpu_init(void) {
                           2029 ;	-----------------------------------------
                           2030 ;	 function cpu_init
                           2031 ;	-----------------------------------------
   0FEE                    2032 _cpu_init:
                    0002   2033 	ar2 = 0x02
                    0003   2034 	ar3 = 0x03
                    ...
                    0000   2039 	ar0 = 0x00
                    0001   2040 	ar1 = 0x01
                           2041 ;	../../shared/src/cpu.c:13: TCON  = 0x05; //EX0/EX1=FALL
   0FEE 75 88 05           2042 	mov	_TCON,#0x05
                           2043 ;	../../shared/src/cpu.c:14: TMOD  = 0x51; //mode1, ct1 
   0FF1 75 89 51           2044 	mov	_TMOD,#0x51
                           2045 ;	../../shared/src/cpu.c:33: IP0   = 0x1c; 
   0FF4 75 A9 1C           2046 	mov	_IP0,#0x1C
                           2047 ;	../../shared/src/cpu.c:34: IP1   = 0x06;
   0FF7 75 B9 06           2048 	mov	_IP1,#0x06
                           2049 ;	../../shared/src/cpu.c:35: ET1   = 1;
   0FFA D2 AB              2050 	setb	_ET1
                           2051 ;	../../shared/src/cpu.c:36: ET2   = 1;
   0FFC D2 AD              2052 	setb	_ET2
                           2053 ;	../../shared/src/cpu.c:37: EX0   = 1;
   0FFE D2 A8              2054 	setb	_EX0
                           2055 ;	../../shared/src/cpu.c:38: EX1   = 1;
   1000 D2 AA              2056 	setb	_EX1
                           2057 ;	../../shared/src/cpu.c:39: ET0   = 0;
   1002 C2 A9              2058 	clr	_ET0
                           2059 ;	../../shared/src/cpu.c:42: IEN1  = 0x3f; //EX6|5|4|3|2|7=1
   1004 75 B8 3F           2060 	mov	_IEN1,#0x3F
                           2061 ;	../../shared/src/cpu.c:43: T2CON = 0x78;//x60; //EX2/EX3:RISE, (Timer2)
   1007 75 C8 78           2062 	mov	_T2CON,#0x78
                           2063 ;	../../shared/src/cpu.c:44: IEN2  = 0x3e; //EX12|11|10|9|8=1
   100A 75 9A 3E           2064 	mov	_IEN2,#0x3E
                           2065 ;	../../shared/src/cpu.c:54: do_wake = 0;
   100D C2 05              2066 	clr	_do_wake
                           2067 ;	../../shared/src/cpu.c:55: do_train = 0;
   100F C2 06              2068 	clr	_do_train
                           2069 ;	../../shared/src/cpu.c:56: do_rxtrain = 0;
   1011 C2 07              2070 	clr	_do_rxtrain
                           2071 ;	../../shared/src/cpu.c:57: do_rxinit = 0;
   1013 C2 08              2072 	clr	_do_rxinit
                           2073 ;	../../shared/src/cpu.c:59: train_comp = 0; 
   1015 90 67 11           2074 	mov	dptr,#_train_comp
   1018 E4                 2075 	clr	a
   1019 F0                 2076 	movx	@dptr,a
                           2077 ;	../../shared/src/cpu.c:60: do_rx_apta = 0; do_tx_apta = 0;
   101A C2 09              2078 	clr	_do_rx_apta
   101C C2 0A              2079 	clr	_do_tx_apta
                           2080 ;	../../shared/src/cpu.c:61: timeout = 1;
   101E D2 03              2081 	setb	_timeout
                           2082 ;	../../shared/src/cpu.c:62: timeout2 = 1;
   1020 D2 04              2083 	setb	_timeout2
                           2084 ;	../../shared/src/cpu.c:63: tx_remote_ctrl_on = 0;
   1022 C2 1D              2085 	clr	_tx_remote_ctrl_on
                           2086 ;	../../shared/src/cpu.c:65: ctrl_cdr_phase_on = 0;
   1024 C2 1E              2087 	clr	_ctrl_cdr_phase_on
                           2088 ;	../../shared/src/cpu.c:66: g_fw_flags = 0;
   1026 90 67 A5           2089 	mov	dptr,#_g_fw_flags
   1029 E4                 2090 	clr	a
   102A F0                 2091 	movx	@dptr,a
   102B 22                 2092 	ret
                           2093 	.area CSEG    (CODE)
                           2094 	.area CSEG    (CODE)
                           2095 	.area CABS    (ABS,CODE)
