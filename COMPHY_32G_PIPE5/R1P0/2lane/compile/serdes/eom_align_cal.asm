...
;--------------------------------------------------------
	...
	.globl _eom_align_cal
	.globl _eom_comp_out_rd
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area BANK2   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'eom_align_cal'
;------------------------------------------------------------
;dir                       Allocated to registers r3 
;eom_dpher                 Allocated to registers 
;loop_cnt                  Allocated to registers r5 
;coarse_max                Allocated to registers r2 
;align_max                 Allocated to registers 
;output_cnt                Allocated to registers 
;comp_max                  Allocated to registers 
;save_pre_dac              Allocated to registers r4 
;toggle_cntr               Allocated to registers r2 
;eom_align_comp_out        Allocated to registers r6 
;------------------------------------------------------------
;	../../shared/src/eom_align_cal.c:34: void eom_align_cal(void) BANKING_CTRL{
;	-----------------------------------------
;	 function eom_align_cal
;	-----------------------------------------
_eom_align_cal:
	ar2 = 0x02
	ar3 = 0x03
	...
	ar0 = 0x00
	ar1 = 0x01
;	../../shared/src/eom_align_cal.c:47: if(reg_EOM_CLK_EN_LANE==0) return;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_134
	movx	a,@dptr
	jb	acc.2,00102$
	ljmp	00152$
00102$:
;	../../shared/src/eom_align_cal.c:49: lnx_EOM_ALIGN_CAL_DONE_LANE = 0;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:51: if( cmx_EOM_ALIGN_CAL_EXT_EN || cmx_EXT_FORCE_CAL_DONE ) {
	...
	jnb	acc.1,00104$
00103$:
;	../../shared/src/eom_align_cal.c:52: EOM_DPHER = lnx_cal_eom_dpher[rate]; 
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	add	a,#_lnx_cal_eom_dpher
	mov	dpl,a
	clr	a
	addc	a,#(_lnx_cal_eom_dpher >> 8)
	mov	dph,a
	movx	a,@dptr
	mov	r2,a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:53: reg_EOM_DPHERCK_LANE = 1;
;	../../shared/src/eom_align_cal.c:54: reg_EOM_DPHERCK_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_10
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
	...
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:55: lnx_EOM_ALIGN_CAL_DONE_LANE = 1;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:56: return; 
	ljmp	00152$
00104$:
;	../../shared/src/eom_align_cal.c:59: PHY_STATUS = ST_EOM_ALIGN_CAL;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x12
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:65: lnx_EOM_EOMEDG_COARSE_CAL_PASS_LANE = 0;
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:66: lnx_EOM_EOMEDG_FINE_CAL_PASS_LANE = 0;
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0xef
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:67: lnx_EOM_EOMDAT_CAL_PASS_LANE = 0;
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:76: if(reg_RX_SPEED_DIV_LANE_2_0 == 0)
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_138
	movx	a,@dptr
	anl	a,#0x1c
	jnz	00107$
;	../../shared/src/eom_align_cal.c:78: coarse_max = 21;
	mov	r2,#0x15
	sjmp	00108$
00107$:
;	../../shared/src/eom_align_cal.c:82: coarse_max = 37;
	mov	r2,#0x25
00108$:
;	../../shared/src/eom_align_cal.c:87: EOM_ALIGN_EN = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_14
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:92: lnx_EOM_DAC_CAL_PASS_LANE = 0;
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:93: EOM_ALIGN_COMP_OFSTDAC = 0x8;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_15
	movx	a,@dptr
	anl	a,#0xc3
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:94: EOM_ALIGN_COMP_CAL_EN = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_15
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:96: dir = eom_comp_out_rd();
	push	ar2
	mov	r0,#_eom_comp_out_rd
	mov	r1,#(_eom_comp_out_rd >> 8)
	mov	r2,#(_eom_comp_out_rd >> 16)
	lcall	__sdcc_banked_call
	mov	r3,dpl
	pop	ar2
;	../../shared/src/eom_align_cal.c:97: save_pre_dac = EOM_ALIGN_COMP_OFSTDAC;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_15
	movx	a,@dptr
	rr	a
	rr	a
	anl	a,#0x0f
	mov	r4,a
;	../../shared/src/eom_align_cal.c:100: do {
	mov	r5,#0x00
00120$:
;	../../shared/src/eom_align_cal.c:101: delay01(10);
	mov	dptr,#0x000A
	push	ar2
	push	ar3
	push	ar4
	...
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/eom_align_cal.c:102: eom_align_comp_out = eom_comp_out_rd();
	mov	r0,#_eom_comp_out_rd
	mov	r1,#(_eom_comp_out_rd >> 8)
	mov	r2,#(_eom_comp_out_rd >> 16)
	lcall	__sdcc_banked_call
	...
	pop	ar3
	pop	ar2
;	../../shared/src/eom_align_cal.c:103: if (dir != eom_align_comp_out) {
	mov	a,r3
	cjne	a,ar6,00179$
	sjmp	00110$
00179$:
;	../../shared/src/eom_align_cal.c:104: EOM_ALIGN_COMP_OFSTDAC = save_pre_dac;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_15
	mov	a,r4
	add	a,r4
	add	a,acc
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:105: lnx_EOM_DAC_CAL_PASS_LANE = 1;
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:106: break;
	ljmp	00122$
00110$:
;	../../shared/src/eom_align_cal.c:108: dir = eom_align_comp_out;
	mov	ar3,r6
;	../../shared/src/eom_align_cal.c:109: if(eom_align_comp_out == 1) {
	cjne	r6,#0x01,00116$
;	../../shared/src/eom_align_cal.c:110: if (EOM_ALIGN_COMP_OFSTDAC == 0xf){
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_15
	movx	a,@dptr
	rr	a
	rr	a
	...
	mov	r7,a
	cjne	r7,#0x0F,00112$
;	../../shared/src/eom_align_cal.c:111: lnx_EOM_DAC_CAL_PASS_LANE = 1;
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:112: break;
	sjmp	00122$
00112$:
;	../../shared/src/eom_align_cal.c:114: save_pre_dac = EOM_ALIGN_COMP_OFSTDAC;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_15
	movx	a,@dptr
	rr	a
	rr	a
	anl	a,#0x0f
	mov	r4,a
;	../../shared/src/eom_align_cal.c:115: EOM_ALIGN_COMP_OFSTDAC++;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_15
	movx	a,@dptr
	rr	a
	rr	a
	...
	sjmp	00117$
00116$:
;	../../shared/src/eom_align_cal.c:118: if (EOM_ALIGN_COMP_OFSTDAC ==0x0){
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_15
	movx	a,@dptr
	anl	a,#0x3c
	jnz	00114$
;	../../shared/src/eom_align_cal.c:119: lnx_EOM_DAC_CAL_PASS_LANE = 1;
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:120: break;
	sjmp	00122$
00114$:
;	../../shared/src/eom_align_cal.c:122: save_pre_dac = EOM_ALIGN_COMP_OFSTDAC;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_15
	movx	a,@dptr
	rr	a
	rr	a
	anl	a,#0x0f
	mov	r4,a
;	../../shared/src/eom_align_cal.c:123: EOM_ALIGN_COMP_OFSTDAC--;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_15
	movx	a,@dptr
	rr	a
	rr	a
	...
	movx	@dptr,a
00117$:
;	../../shared/src/eom_align_cal.c:132: if(cmx_EOM_ALIGN_CAL_TIMEOUT_DIS == 0)
	mov	dptr,#(_CAL_TIME_OUT_AND_DIS + 0x0001)
	movx	a,@dptr
	jb	acc.3,00121$
;	../../shared/src/eom_align_cal.c:133: loop_cnt ++;
	inc	r5
00121$:
;	../../shared/src/eom_align_cal.c:135: } while (loop_cnt < comp_max);
	cjne	r5,#0x20,00186$
00186$:
	jnc	00187$
	ljmp	00120$
00187$:
00122$:
;	../../shared/src/eom_align_cal.c:137: delay01(10);
	mov	dptr,#0x000A
	push	ar2
	push	ar4
	mov	r0,#_delay01
	...
	pop	ar4
	pop	ar2
;	../../shared/src/eom_align_cal.c:139: lnx_CAL_EOM_ALIGN_COMP_OFSTDAC_LANE_7_0 = EOM_ALIGN_COMP_OFSTDAC; 
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_15
	movx	a,@dptr
	rr	a
	rr	a
	anl	a,#0x0f
	mov	dptr,#(_CAL_SAVE_DATA1_LANE + 0x0001)
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:140: EOM_ALIGN_COMP_CAL_EN = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_15
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:146: EOM_DPHER = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_10
	movx	a,@dptr
	anl	a,#0x01
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:147: EOM_ALIGN_PD_SEL = 0; // CLK_EDGE_P/N and CLK_EOM_P/N 
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_15
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:148: dir = 0x3f;
	mov	r3,#0x3F
;	../../shared/src/eom_align_cal.c:150: do {
	mov	r5,#0x00
	mov	r7,#0x00
00128$:
;	../../shared/src/eom_align_cal.c:151: delay01(10);
	mov	dptr,#0x000A
	push	ar2
	push	ar3
	push	ar4
	...
	pop	ar3
	pop	ar2
;	../../shared/src/eom_align_cal.c:152: if(cmx_EOM_ALIGN_CAL_TIMEOUT_DIS == 0)
	mov	dptr,#(_CAL_TIME_OUT_AND_DIS + 0x0001)
	movx	a,@dptr
	jb	acc.3,00125$
;	../../shared/src/eom_align_cal.c:153: loop_cnt ++;
	inc	r5
00125$:
;	../../shared/src/eom_align_cal.c:154: dir <<= 1;
	push	ar4
	mov	a,r3
	add	a,r3
	mov	r3,a
;	../../shared/src/eom_align_cal.c:155: dir |= eom_comp_out_rd();
	push	ar2
	push	ar3
	push	ar5
	push	ar7
	...
	mov	a,r4
	orl	ar3,a
;	../../shared/src/eom_align_cal.c:156: if((dir & 0x33) == 0x03)
	mov	a,#0x33
	anl	a,r3
	mov	r4,a
	cjne	r4,#0x03,00189$
...
00190$:
	pop	ar4
;	../../shared/src/eom_align_cal.c:158: EOM_DPHER = save_pre_dac;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_10
	mov	a,r4
	add	a,r4
	anl	a,#0xfe
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:159: reg_EOM_DPHERCK_LANE = 1;
;	../../shared/src/eom_align_cal.c:160: reg_EOM_DPHERCK_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_10
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
	...
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:161: lnx_EOM_EOMEDG_COARSE_CAL_PASS_LANE = 1;
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:162: break;
	sjmp	00130$
00127$:
;	../../shared/src/eom_align_cal.c:164: save_pre_dac = eom_dpher;
	mov	ar4,r7
;	../../shared/src/eom_align_cal.c:165: eom_dpher += eom_coarse_step_size;
	mov	a,#0x08
	add	a,r7
;	../../shared/src/eom_align_cal.c:166: EOM_DPHER = eom_dpher;
	mov	r7,a
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_10
	add	a,acc
	anl	a,#0xfe
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:167: reg_EOM_DPHERCK_LANE = 1;
;	../../shared/src/eom_align_cal.c:168: reg_EOM_DPHERCK_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_10
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
	...
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:169: } while ( loop_cnt < coarse_max );
	mov	a,r5
	cjne	a,ar2,00191$
00191$:
	jnc	00192$
...
00192$:
00130$:
;	../../shared/src/eom_align_cal.c:174: if (lnx_EOM_EOMEDG_COARSE_CAL_PASS_LANE ==0) goto err_skip;
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0001)
	movx	a,@dptr
	jb	acc.3,00193$
	ljmp	00151$
00193$:
;	../../shared/src/eom_align_cal.c:176: EOM_ALIGN_PD_SEL = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_15
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:178: dir = eom_comp_out_rd();
	mov	r0,#_eom_comp_out_rd
	mov	r1,#(_eom_comp_out_rd >> 8)
	mov	r2,#(_eom_comp_out_rd >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/eom_align_cal.c:181: while (loop_cnt < align_max){
	mov	r3,dpl
	mov	r2,#0x00
	mov	r4,#0x00
00148$:
...
00194$:
	...
	ljmp	00151$
00195$:
;	../../shared/src/eom_align_cal.c:182: delay01(10);
	mov	dptr,#0x000A
	push	ar2
	push	ar3
	push	ar4
	...
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/eom_align_cal.c:183: eom_align_comp_out = eom_comp_out_rd();
	mov	r0,#_eom_comp_out_rd
	mov	r1,#(_eom_comp_out_rd >> 8)
	mov	r2,#(_eom_comp_out_rd >> 16)
	lcall	__sdcc_banked_call
	...
	pop	ar2
	mov	ar6,r5
;	../../shared/src/eom_align_cal.c:184: if(dir != eom_align_comp_out)
	mov	a,r3
	cjne	a,ar6,00196$
	sjmp	00134$
00196$:
;	../../shared/src/eom_align_cal.c:186: toggle_cntr ++;
	inc	r2
;	../../shared/src/eom_align_cal.c:187: dir = eom_align_comp_out;
	mov	ar3,r6
00134$:
;	../../shared/src/eom_align_cal.c:189: if (toggle_cntr >= 3)
	cjne	r2,#0x03,00197$
00197$:
	jc	00136$
;	../../shared/src/eom_align_cal.c:191: lnx_EOM_EOMDAT_CAL_PASS_LANE = 1;
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:192: break;
	sjmp	00151$
00136$:
;	../../shared/src/eom_align_cal.c:195: if(eom_align_comp_out == 0) {
	mov	a,r6
	jnz	00144$
;	../../shared/src/eom_align_cal.c:196: if (EOM_DPHER < 127)
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_10
	movx	a,@dptr
	rr	a
	anl	a,#0x7f
	...
	subb	a,#0xff
	jnc	00138$
;	../../shared/src/eom_align_cal.c:197: EOM_DPHER++;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_10
	movx	a,@dptr
	rr	a
	anl	a,#0x7f
	...
	sjmp	00145$
00138$:
;	../../shared/src/eom_align_cal.c:199: EOM_DPHER = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_10
	movx	a,@dptr
	anl	a,#0x01
	movx	@dptr,a
	sjmp	00145$
00144$:
;	../../shared/src/eom_align_cal.c:202: if (EOM_DPHER > 0)
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_10
	movx	a,@dptr
	anl	a,#0xfe
	jz	00141$
;	../../shared/src/eom_align_cal.c:203: EOM_DPHER--;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_10
	movx	a,@dptr
	rr	a
	anl	a,#0x7f
	...
	sjmp	00145$
00141$:
;	../../shared/src/eom_align_cal.c:205: EOM_DPHER = 127;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_10
	movx	a,@dptr
	orl	a,#0xfe
	movx	@dptr,a
00145$:
;	../../shared/src/eom_align_cal.c:207: reg_EOM_DPHERCK_LANE = 1;
;	../../shared/src/eom_align_cal.c:208: reg_EOM_DPHERCK_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_10
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
	...
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:210: if(cmx_EOM_ALIGN_CAL_TIMEOUT_DIS == 0)
	mov	dptr,#(_CAL_TIME_OUT_AND_DIS + 0x0001)
	movx	a,@dptr
	jnb	acc.3,00202$
	ljmp	00148$
00202$:
;	../../shared/src/eom_align_cal.c:211: loop_cnt++;
	inc	r4
	ljmp	00148$
;	../../shared/src/eom_align_cal.c:218: err_skip:
00151$:
;	../../shared/src/eom_align_cal.c:220: cal_eom_dpher = reg_EOM_DPHER_LANE_6_0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_10
	movx	a,@dptr
	rr	a
	anl	a,#0x7f
	...
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:221: lnx_cal_eom_dpher[rate] = cal_eom_dpher; 
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	add	a,#_lnx_cal_eom_dpher
	...
	mov	dph,r3
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:224: EOM_ALIGN_PD_SEL = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_15
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:225: lnx_EOM_ALIGN_CAL_DONE_LANE = 1;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
...
;------------------------------------------------------------
;Allocation info for local variables in function 'eom_comp_out_rd'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/eom_align_cal.c:235: bool eom_comp_out_rd(void) BANKING_CTRL
;	-----------------------------------------
;	 function eom_comp_out_rd
;	-----------------------------------------
_eom_comp_out_rd:
;	../../shared/src/eom_align_cal.c:237: reg_RX_EOM_ALIGN_CMP_OUT_RD_REQ_LANE = 1;
;	../../shared/src/eom_align_cal.c:238: reg_RX_EOM_ALIGN_CMP_OUT_RD_REQ_LANE = 0;
	mov	dptr,#(_RX_CALIBRATION_REG + 0x0002)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/eom_align_cal.c:240: return EOM_ALIGN_CMP_OUT;
