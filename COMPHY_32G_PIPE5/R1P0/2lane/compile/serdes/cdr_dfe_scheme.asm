...
;--------------------------------------------------------
	...
	.globl _cdr_dfe_scheme
	.globl _dfe_load_all
	.globl _get_ec_voltage
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area BANK1   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'cdr_dfe_scheme'
;------------------------------------------------------------
;f0d_dir                   Allocated to registers r2 
;f0d_updated               Allocated to registers r3 
;phase_offset_data         Allocated to registers r2 
;sloc0                     Allocated to stack - offset 1
;------------------------------------------------------------
;	../../shared/src/cdr_dfe_scheme.c:152: void cdr_dfe_scheme(void) BANKING_CTRL{
;	-----------------------------------------
;	 function cdr_dfe_scheme
;	-----------------------------------------
_cdr_dfe_scheme:
	ar2 = 0x02
	ar3 = 0x03
	...
	inc	sp
	inc	sp
;	../../shared/src/cdr_dfe_scheme.c:159: cds28.eye_check_pass = 1;
	mov	dptr,#(_cds28 + 0x0070)
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:161: if((dfe_dis == 1 || cmx_SKIP_CDR_DFE_SCHEME==1 ) && !do_rxinit) {
	mov	dptr,#_dfe_dis
	movx	a,@dptr
	mov	r2,a
	cjne	r2,#0x01,00236$
...
00104$:
	jb	_do_rxinit,00102$
;	../../shared/src/cdr_dfe_scheme.c:162: return;
	ljmp	00194$
00102$:
;	../../shared/src/cdr_dfe_scheme.c:165: CDS_ST_JUMP(INIT);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
;	../../shared/src/cdr_dfe_scheme.c:166: lnx_CDS_ERR_CODE_LANE_7_0 = 0;
	clr	a
	movx	@dptr,a
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0003)
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:167: phase_offset_data = cur_phase_offset_data;
	mov	dptr,#_cur_phase_offset_data
	movx	a,@dptr
	mov	r2,a
;	../../shared/src/cdr_dfe_scheme.c:169: if(cds_tb & reset_en)
	...
	ljmp	00108$
00240$:
;	../../shared/src/cdr_dfe_scheme.c:171: CDS_ST_JUMP(RESET);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:174: reg_SEL_MU_F_LANE = 0; 
	mov	dptr,#(_DTL_REG0 + 0x0003)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:175: reg_ANA_RX_SEL_MU_F_LANE = 0; 
	mov	dptr,#_DFE_CTRL_REG3
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:184: reg_RESET_DTL_SYNC_LANE = 1; 
;	../../shared/src/cdr_dfe_scheme.c:185: reg_RESET_DTL_SYNC_LANE = 0; 
	...
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:186: short_delay();
	push	ar2
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	mov	r2,#(_short_delay >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cdr_dfe_scheme.c:190: reg_DFE_INIT_SEL_LANE = 0; //default/cal
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0003)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:192: CKCON = 0x07 ; //MCU WAIT time the slowest
	mov	_CKCON,#0x07
;	../../shared/src/cdr_dfe_scheme.c:193: reg_RESET_DFE_LANE = 1;
;	../../shared/src/cdr_dfe_scheme.c:194: reg_RESET_DFE_LANE = 0;
	...
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:195: CKCON = 0x00 ; //MCU WAIT time setting back to normal.
	mov	_CKCON,#0x00
;	../../shared/src/cdr_dfe_scheme.c:196: reg_ANA_REG_DFEE_RST_LANE = 1;
	mov	dptr,#_ANA_IF_DFEE_REG0
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:197: reg_ANA_REG_DFEO_RST_LANE = 1;
	mov	dptr,#_ANA_IF_DFEO_REG0
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:198: reg_ANA_REG_DFEE_RST_LANE = 0;
	mov	dptr,#_ANA_IF_DFEE_REG0
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:199: reg_ANA_REG_DFEO_RST_LANE = 0;
	mov	dptr,#_ANA_IF_DFEO_REG0
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:202: dfe_load_all();
	mov	r0,#_dfe_load_all
	mov	r1,#(_dfe_load_all >> 8)
	mov	r2,#(_dfe_load_all >> 16)
	lcall	__sdcc_banked_call
	pop	ar2
;	../../shared/src/cdr_dfe_scheme.c:218: CDS_ST_JUMP(SAVE_RESET);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x02
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:219: if(lnx_DFE_SAVE_EN_LANE) {
	mov	dptr,#_CDS_CTRL_REG0
	movx	a,@dptr
	jnb	acc.1,00108$
;	../../shared/src/cdr_dfe_scheme.c:220: dfe_save();
	push	ar2
	mov	r0,#_dfe_save
	mov	r1,#(_dfe_save >> 8)
	mov	r2,#(_dfe_save >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cdr_dfe_scheme.c:221: cds_save(Savf0a);
	mov	dpl,#0x00
	mov	r0,#_cds_save
	mov	r1,#(_cds_save >> 8)
	mov	r2,#(_cds_save >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cdr_dfe_scheme.c:222: cds_save(Savdfe);
	mov	dpl,#0x10
	mov	r0,#_cds_save
	mov	r1,#(_cds_save >> 8)
	mov	r2,#(_cds_save >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cdr_dfe_scheme.c:223: cds_save(Savdc);
	mov	dpl,#0x12
	mov	r0,#_cds_save
	mov	r1,#(_cds_save >> 8)
	mov	r2,#(_cds_save >> 16)
	...
	pop	ar2
00108$:
;	../../shared/src/cdr_dfe_scheme.c:226: if(cds_tb & coarse_dtl_en)  
	mov	dptr,#_CDS_READ_MISC1
	movx	a,@dptr
	mov	r3,a
	inc	dptr
	...
	mov	a,r3
	jnb	acc.1,00110$
;	../../shared/src/cdr_dfe_scheme.c:228: CDS_ST_JUMP(TIMEACQ);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x03
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:231: dfe_fsm(Tacq,Updateoff);
	push	ar2
	mov	a,#0xFF
	push	acc
	mov	dptr,#0x0000
	...
	dec	sp
	pop	ar2
;	../../shared/src/cdr_dfe_scheme.c:232: reg_SEL_MU_F_LANE = 1;
	mov	dptr,#(_DTL_REG0 + 0x0003)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:233: reg_ANA_RX_SEL_MU_F_LANE = 1;
	mov	dptr,#_DFE_CTRL_REG3
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
00110$:
;	../../shared/src/cdr_dfe_scheme.c:235: if(cds_tb & phase_move_with_dfe_en)
	mov	dptr,#_CDS_READ_MISC1
	movx	a,@dptr
	mov	r3,a
	inc	dptr
	...
	ljmp	00127$
00243$:
;	../../shared/src/cdr_dfe_scheme.c:237: CDS_ST_JUMP(DFE_PM0);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x04
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:239: set_slicer_data_sampler_adapt(SLICER_SMPL_ONLY);
	mov	dpl,#0x01
	push	ar2
	...
	lcall	__sdcc_banked_call
;	../../shared/src/cdr_dfe_scheme.c:240: set_dfe_fbmd(FBall);
	mov	dpl,#0x00
	mov	r0,#_set_dfe_fbmd
	mov	r1,#(_set_dfe_fbmd >> 8)
	mov	r2,#(_set_dfe_fbmd >> 16)
	lcall	__sdcc_banked_call
	pop	ar2
;	../../shared/src/cdr_dfe_scheme.c:242: if(cds_tb & f0a_coarse_en) {
	mov	dptr,#_CDS_READ_MISC1
	movx	a,@dptr
	mov	r3,a
	inc	dptr
	...
	mov	a,r3
	jnb	acc.5,00112$
;	../../shared/src/cdr_dfe_scheme.c:243: CDS_ST_JUMP(DFE_PM1);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x05
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:244: dfe_fsm(Tf0_coarse_pm,Update0);
	push	ar2
	clr	a
	push	acc
	mov	dptr,#0x0A01
	...
	pop	ar2
00112$:
;	../../shared/src/cdr_dfe_scheme.c:251: timeout_start((uint16_t)1000);
	mov	_TMR1,#0x18
	mov	(_TMR1 >> 8),#0xFC
	setb	_TR1
	clr	_timeout
;	../../shared/src/cdr_dfe_scheme.c:252: do {
00121$:
;	../../shared/src/cdr_dfe_scheme.c:253: CDS_ST_JUMP(DFE_PM2); 
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x06
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:254: dfe_fsm(Tdfe_coarse,Updatefixed);
	push	ar2
	mov	a,#0x01
	push	acc
	mov	dptr,#0x0A01
	...
	dec	sp
	pop	ar2
;	../../shared/src/cdr_dfe_scheme.c:255: if(train.phase_offset_data == phase_offset_data) break;
	...
	sjmp	00123$
00245$:
;	../../shared/src/cdr_dfe_scheme.c:256: CDS_ST_JUMP(DFE_PM3); 
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x08
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:257: if(phase_offset_data < (train.phase_offset_data - tag_PM_PH_ADJ_THRESH))
	mov	a,r3
	mov	r4,a
	rlc	a
	subb	a,acc
	...
	subb	a,b
	jnc	00119$
;	../../shared/src/cdr_dfe_scheme.c:258: phase_offset_data += tag_PM_PH_ADJ_THRESH;
	inc	r2
	inc	r2
	sjmp	00120$
00119$:
;	../../shared/src/cdr_dfe_scheme.c:259: else if(phase_offset_data > (train.phase_offset_data + tag_PM_PH_ADJ_THRESH))
	mov	a,#0x02
	add	a,r4
	mov	r4,a
	clr	a
	...
	subb	a,b
	jnc	00116$
;	../../shared/src/cdr_dfe_scheme.c:260: phase_offset_data -= tag_PM_PH_ADJ_THRESH;
	dec	r2
	dec	r2
	sjmp	00120$
00116$:
;	../../shared/src/cdr_dfe_scheme.c:262: phase_offset_data = train.phase_offset_data;
	mov	ar2,r3
00120$:
;	../../shared/src/cdr_dfe_scheme.c:264: phase_control_func_0(phase_offset_data, train.phase_offset_esm); //set_ph_dat(phase_offset_data);
	...
	dec	sp
	pop	ar2
;	../../shared/src/cdr_dfe_scheme.c:270: } while (!timeout);
	jb	_timeout,00248$
	ljmp	00121$
00248$:
00123$:
;	../../shared/src/cdr_dfe_scheme.c:271: if(timeout) {
	jnb	_timeout,00125$
;	../../shared/src/cdr_dfe_scheme.c:272: lnx_CDS_ERR_CODE_LANE_7_0 |= 0x2;
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0003)
	movx	a,@dptr
	mov	r2,a
	orl	ar2,#0x02
	...
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:273: timeout = 0;
	clr	_timeout
00125$:
;	../../shared/src/cdr_dfe_scheme.c:274: } timeout_stop;
	clr	_TR1
	clr	_TF1
;	../../shared/src/cdr_dfe_scheme.c:275: cds_save(Savf0a);
	mov	dpl,#0x00
	mov	r0,#_cds_save
	mov	r1,#(_cds_save >> 8)
	mov	r2,#(_cds_save >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cdr_dfe_scheme.c:276: cds_save(Savdfe);
	mov	dpl,#0x10
	mov	r0,#_cds_save
	mov	r1,#(_cds_save >> 8)
	mov	r2,#(_cds_save >> 16)
	lcall	__sdcc_banked_call
00127$:
;	../../shared/src/cdr_dfe_scheme.c:291: if(cds_tb & dfe_adapt_en)
	mov	dptr,#_CDS_READ_MISC1
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	ljmp	00149$
00250$:
;	../../shared/src/cdr_dfe_scheme.c:293: CDS_ST_JUMP(DFE_CONV0);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x0A
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:295: reg_DFE_F0B_MODE_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0001)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:296: reg_DFE_F0D_MODE_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0001)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:297: if(cds_tb & f0a_coarse_en) 
	mov	dptr,#_CDS_READ_MISC1
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	mov	a,r2
	jnb	acc.5,00129$
;	../../shared/src/cdr_dfe_scheme.c:299: CDS_ST_JUMP(DFE_F0A1);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x0B
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:300: set_slicer_data_sampler_adapt(SLICER_SMPL_ONLY);
	mov	dpl,#0x01
	mov	r0,#_set_slicer_data_sampler_adapt
	mov	r1,#(_set_slicer_data_sampler_adapt >> 8)
	mov	r2,#(_set_slicer_data_sampler_adapt >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cdr_dfe_scheme.c:301: set_dfe_fbmd(FBall);
	mov	dpl,#0x00
	mov	r0,#_set_dfe_fbmd
	mov	r1,#(_set_dfe_fbmd >> 8)
	mov	r2,#(_set_dfe_fbmd >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cdr_dfe_scheme.c:302: reg_DFE_F0_COARSE_STEP_EN_LANE = 1;
;	../../shared/src/cdr_dfe_scheme.c:303: reg_DFE_F0_FINE_STEP_EN_LANE = 0;
	...
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:304: dfe_fsm(Tf0_coarse,Update0);
	clr	a
	push	acc
	mov	dptr,#0x0A01
	mov	r0,#_dfe_fsm
	...
	dec	sp
00129$:
;	../../shared/src/cdr_dfe_scheme.c:306: if(cds_tb & dfe_coarse_en)
	mov	dptr,#_CDS_READ_MISC1
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	mov	a,r2
	jnb	acc.6,00133$
;	../../shared/src/cdr_dfe_scheme.c:308: CDS_ST_JUMP(DFE_CONV1);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x0C
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:309: if(!tx_status_pcie_mode) {
	jb	_tx_status_pcie_mode,00131$
;	../../shared/src/cdr_dfe_scheme.c:310: set_slicer_data_sampler_adapt(SLICER_SMPL_ONLY);
	mov	dpl,#0x01
	mov	r0,#_set_slicer_data_sampler_adapt
	mov	r1,#(_set_slicer_data_sampler_adapt >> 8)
	mov	r2,#(_set_slicer_data_sampler_adapt >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cdr_dfe_scheme.c:311: set_dfe_fbmd(FBall);
	mov	dpl,#0x00
	mov	r0,#_set_dfe_fbmd
	mov	r1,#(_set_dfe_fbmd >> 8)
	mov	r2,#(_set_dfe_fbmd >> 16)
	lcall	__sdcc_banked_call
00131$:
;	../../shared/src/cdr_dfe_scheme.c:313: reg_DFE_F0_COARSE_STEP_EN_LANE = 1;
;	../../shared/src/cdr_dfe_scheme.c:314: reg_DFE_F0_FINE_STEP_EN_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG2 + 0x0003)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
	...
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:315: reg_DFE_COARSE_STEP_EN_LANE = 1;
;	../../shared/src/cdr_dfe_scheme.c:316: reg_DFE_FINE_STEP_EN_LANE = 0;
	...
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:317: dfe_fsm(Tdfe_coarse,Updatedfe);
	mov	a,#0x02
	push	acc
	mov	dptr,#0x0A01
	mov	r0,#_dfe_fsm
	...
	dec	sp
00133$:
;	../../shared/src/cdr_dfe_scheme.c:354: if(cds_tb & dfe_fine_en)
	mov	dptr,#_CDS_READ_MISC1
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	mov	a,r2
	jnb	acc.7,00140$
;	../../shared/src/cdr_dfe_scheme.c:356: CDS_ST_JUMP(DFE_CONV2);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x0D
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:357: if(!tx_status_pcie_mode) {
	jb	_tx_status_pcie_mode,00135$
;	../../shared/src/cdr_dfe_scheme.c:358: set_slicer_data_sampler_adapt(BOTH_SMPL);
	mov	dpl,#0x00
	mov	r0,#_set_slicer_data_sampler_adapt
	mov	r1,#(_set_slicer_data_sampler_adapt >> 8)
	mov	r2,#(_set_slicer_data_sampler_adapt >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cdr_dfe_scheme.c:359: set_dfe_fbmd(FBself);
	mov	dpl,#0x02
	mov	r0,#_set_dfe_fbmd
	mov	r1,#(_set_dfe_fbmd >> 8)
	mov	r2,#(_set_dfe_fbmd >> 16)
	lcall	__sdcc_banked_call
00135$:
;	../../shared/src/cdr_dfe_scheme.c:361: reg_DFE_F0_COARSE_STEP_EN_LANE = 1;
;	../../shared/src/cdr_dfe_scheme.c:362: reg_DFE_F0_FINE_STEP_EN_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG2 + 0x0003)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
	...
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:363: reg_DFE_COARSE_STEP_EN_LANE = 1;
;	../../shared/src/cdr_dfe_scheme.c:364: reg_DFE_FINE_STEP_EN_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0002)
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
	...
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:365: if(do_rxinit)
	jnb	_do_rxinit,00137$
;	../../shared/src/cdr_dfe_scheme.c:366: dfe_fsm(Tacq,Updatedfe);
	mov	a,#0x02
	push	acc
	mov	dptr,#0x0000
	mov	r0,#_dfe_fsm
	...
	sjmp	00140$
00137$:
;	../../shared/src/cdr_dfe_scheme.c:368: dfe_fsm(Tdfe_fine,Updatedfe);
	mov	a,#0x02
	push	acc
	mov	dptr,#0x0302
	mov	r0,#_dfe_fsm
	...
	dec	sp
00140$:
;	../../shared/src/cdr_dfe_scheme.c:373: if(cds_tb & dfe_accu_en)
	mov	dptr,#_CDS_READ_MISC1
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	ljmp	00149$
00257$:
;	../../shared/src/cdr_dfe_scheme.c:375: CDS_ST_JUMP(DFE_CONV3); 
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x0E
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:376: if(!tx_status_pcie_mode) {
	jb	_tx_status_pcie_mode,00142$
;	../../shared/src/cdr_dfe_scheme.c:377: set_slicer_data_sampler_adapt(BOTH_SMPL);
	mov	dpl,#0x00
	mov	r0,#_set_slicer_data_sampler_adapt
	mov	r1,#(_set_slicer_data_sampler_adapt >> 8)
	mov	r2,#(_set_slicer_data_sampler_adapt >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cdr_dfe_scheme.c:378: set_dfe_fbmd(FBself);
	mov	dpl,#0x02
	mov	r0,#_set_dfe_fbmd
	mov	r1,#(_set_dfe_fbmd >> 8)
	mov	r2,#(_set_dfe_fbmd >> 16)
	lcall	__sdcc_banked_call
00142$:
;	../../shared/src/cdr_dfe_scheme.c:380: reg_DFE_F0_COARSE_STEP_EN_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG2 + 0x0003)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:381: reg_DFE_F0_FINE_STEP_EN_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG2 + 0x0003)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:382: reg_DFE_COARSE_STEP_EN_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0002)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:383: reg_DFE_FINE_STEP_EN_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0002)
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:384: if(do_phase_adapt)
	mov	dptr,#_do_phase_adapt
	movx	a,@dptr
	mov	r2,a
	jz	00144$
;	../../shared/src/cdr_dfe_scheme.c:385: dfe_fsm(Tdfe_accu,Updatedfe_wof1);
	mov	a,#0x04
	push	acc
	mov	dptr,#0x0204
	mov	r0,#_dfe_fsm
	...
	sjmp	00145$
00144$:
;	../../shared/src/cdr_dfe_scheme.c:387: dfe_fsm(Tdfe_accu,Updatedfe);
	mov	a,#0x02
	push	acc
	mov	dptr,#0x0204
	mov	r0,#_dfe_fsm
	...
	dec	sp
00145$:
;	../../shared/src/cdr_dfe_scheme.c:389: dfe_save();
	mov	r0,#_dfe_save
	mov	r1,#(_dfe_save >> 8)
	mov	r2,#(_dfe_save >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cdr_dfe_scheme.c:390: cds_save(Savdfe);
	mov	dpl,#0x10
	mov	r0,#_cds_save
	mov	r1,#(_cds_save >> 8)
	mov	r2,#(_cds_save >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cdr_dfe_scheme.c:391: cds_save(Savf0a);
	mov	dpl,#0x00
	mov	r0,#_cds_save
	mov	r1,#(_cds_save >> 8)
	mov	r2,#(_cds_save >> 16)
	lcall	__sdcc_banked_call
00149$:
;	../../shared/src/cdr_dfe_scheme.c:398: if(cds_tb & dc_adapt_en)
	mov	dptr,#_CDS_READ_MISC1
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	ljmp	00151$
00260$:
;	../../shared/src/cdr_dfe_scheme.c:400: CDS_ST_JUMP(DFE_DC0);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x10
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:402: reg_DFE_F0B_MODE_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0001)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:403: reg_DFE_F0D_MODE_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0001)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:404: CDS_ST_JUMP(DFE_DC2);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x11
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:405: reg_DFE_F0_COARSE_STEP_EN_LANE = 0;
;	../../shared/src/cdr_dfe_scheme.c:406: reg_DFE_F0_FINE_STEP_EN_LANE = 1;
	mov	dptr,#(_DFE_CTRL_REG2 + 0x0003)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
	...
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:407: reg_DFE_COARSE_STEP_EN_LANE = 0;
;	../../shared/src/cdr_dfe_scheme.c:408: reg_DFE_FINE_STEP_EN_LANE = 1;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0002)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
	...
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:409: dfe_fsm(Tdc_fine,Updatedc);
	mov	a,#0x03
	push	acc
	mov	dptr,#0x0A01
	mov	r0,#_dfe_fsm
	...
	lcall	__sdcc_banked_call
	dec	sp
;	../../shared/src/cdr_dfe_scheme.c:410: CDS_ST_JUMP(DFE_DC3);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x12
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:411: reg_DFE_F0_COARSE_STEP_EN_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG2 + 0x0003)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:412: reg_DFE_F0_FINE_STEP_EN_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG2 + 0x0003)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:413: reg_DFE_COARSE_STEP_EN_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0002)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:414: reg_DFE_FINE_STEP_EN_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0002)
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:415: dfe_fsm(Tdc_accu,Updatedc);
	mov	a,#0x03
	push	acc
	mov	dptr,#0x0302
	mov	r0,#_dfe_fsm
	...
	lcall	__sdcc_banked_call
	dec	sp
;	../../shared/src/cdr_dfe_scheme.c:416: CDS_ST_JUMP(SAVE_DC);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x13
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:420: cds_save(Savdc);
	mov	dpl,#0x12
	mov	r0,#_cds_save
	mov	r1,#(_cds_save >> 8)
	mov	r2,#(_cds_save >> 16)
	lcall	__sdcc_banked_call
00151$:
;	../../shared/src/cdr_dfe_scheme.c:422: if(cds_tb & f0b_adapt_en)
	mov	dptr,#_CDS_READ_MISC1
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	ljmp	00153$
00261$:
;	../../shared/src/cdr_dfe_scheme.c:424: CDS_ST_JUMP(DFE_F0B0);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x14
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:425: set_slicer_data_sampler_adapt(BOTH_SMPL);
	mov	dpl,#0x00
	mov	r0,#_set_slicer_data_sampler_adapt
	mov	r1,#(_set_slicer_data_sampler_adapt >> 8)
	mov	r2,#(_set_slicer_data_sampler_adapt >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cdr_dfe_scheme.c:426: set_dfe_fbmd(FBself);
	mov	dpl,#0x02
	mov	r0,#_set_dfe_fbmd
	mov	r1,#(_set_dfe_fbmd >> 8)
	mov	r2,#(_set_dfe_fbmd >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cdr_dfe_scheme.c:427: CDS_ST_JUMP(DFE_F0B2);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x15
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:428: reg_DFE_F0B_MODE_LANE = 1;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0001)
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:429: reg_DFE_F0_COARSE_STEP_EN_LANE = 1;
;	../../shared/src/cdr_dfe_scheme.c:430: reg_DFE_F0_FINE_STEP_EN_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG2 + 0x0003)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
	...
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:431: dfe_fsm(Tf0b_fine,Update0);
	clr	a
	push	acc
	mov	dptr,#0x0802
	mov	r0,#_dfe_fsm
	...
	lcall	__sdcc_banked_call
	dec	sp
;	../../shared/src/cdr_dfe_scheme.c:433: CDS_ST_JUMP(DFE_F0B3);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x16
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:434: reg_DFE_F0_COARSE_STEP_EN_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG2 + 0x0003)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:435: reg_DFE_F0_FINE_STEP_EN_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG2 + 0x0003)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:436: dfe_fsm(Tf0b_accu,Update0);
	clr	a
	push	acc
	mov	dptr,#0x0404
	mov	r0,#_dfe_fsm
	...
	lcall	__sdcc_banked_call
	dec	sp
;	../../shared/src/cdr_dfe_scheme.c:438: cds_save(Savf0b);
	mov	dpl,#0x01
	mov	r0,#_cds_save
	mov	r1,#(_cds_save >> 8)
	mov	r2,#(_cds_save >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cdr_dfe_scheme.c:439: reg_DFE_F0B_MODE_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0001)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
00153$:
;	../../shared/src/cdr_dfe_scheme.c:441: if(cds_tb & f0d_adapt_en)
	mov	dptr,#_CDS_READ_MISC1
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	ljmp	00181$
00262$:
;	../../shared/src/cdr_dfe_scheme.c:443: CDS_ST_JUMP(DFE_F0D0);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x18
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:444: if(!tx_status_pcie_mode) {
	jb	_tx_status_pcie_mode,00155$
;	../../shared/src/cdr_dfe_scheme.c:445: set_slicer_data_sampler_adapt(BOTH_SMPL);
	mov	dpl,#0x00
	mov	r0,#_set_slicer_data_sampler_adapt
	mov	r1,#(_set_slicer_data_sampler_adapt >> 8)
	mov	r2,#(_set_slicer_data_sampler_adapt >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cdr_dfe_scheme.c:446: set_dfe_fbmd(FBself);
	mov	dpl,#0x02
	mov	r0,#_set_dfe_fbmd
	mov	r1,#(_set_dfe_fbmd >> 8)
	mov	r2,#(_set_dfe_fbmd >> 16)
	lcall	__sdcc_banked_call
00155$:
;	../../shared/src/cdr_dfe_scheme.c:448: reg_DFE_CLR_FRAC_EN_LANE = 0;
	mov	dptr,#_DFE_CTRL_REG1
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:449: reg_DFE_F0D_MODE_LANE = 1;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0001)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:450: f0d_dir = 0;
	mov	r2,#0x00
;	../../shared/src/cdr_dfe_scheme.c:451: f0d_updated = 0;
	mov	r3,#0x00
;	../../shared/src/cdr_dfe_scheme.c:453: do {
00177$:
;	../../shared/src/cdr_dfe_scheme.c:454: dfe_load_type(2);
	mov	dpl,#0x02
	push	ar2
	push	ar3
	...
	pop	ar3
	pop	ar2
;	../../shared/src/cdr_dfe_scheme.c:455: CDS_ST_JUMP(DFE_F0D1);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x19
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:456: reg_DFE_F0_COARSE_STEP_EN_LANE = 1;
;	../../shared/src/cdr_dfe_scheme.c:457: reg_DFE_F0_FINE_STEP_EN_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG2 + 0x0003)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
	...
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:458: if(!tx_status_pcie_mode)
	jb	_tx_status_pcie_mode,00157$
;	../../shared/src/cdr_dfe_scheme.c:459: dfe_fsm(Tf0d_coarse,Update0);
	push	ar2
	push	ar3
	clr	a
	push	acc
	...
	sjmp	00158$
00157$:
;	../../shared/src/cdr_dfe_scheme.c:461: dfe_fsm(Tf0d_coarse_pcie,Update0);
	push	ar2
	push	ar3
	clr	a
	push	acc
	...
	pop	ar2
00158$:
;	../../shared/src/cdr_dfe_scheme.c:463: CDS_ST_JUMP(DFE_F0D2);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x1A
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:464: reg_DFE_F0_COARSE_STEP_EN_LANE = 0;
;	../../shared/src/cdr_dfe_scheme.c:465: reg_DFE_F0_FINE_STEP_EN_LANE = 1;
	mov	dptr,#(_DFE_CTRL_REG2 + 0x0003)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
	...
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:466: if(!tx_status_pcie_mode)
	jb	_tx_status_pcie_mode,00160$
;	../../shared/src/cdr_dfe_scheme.c:467: dfe_fsm(Tf0d_fine,Update0);
	push	ar2
	push	ar3
	clr	a
	push	acc
	...
	sjmp	00161$
00160$:
;	../../shared/src/cdr_dfe_scheme.c:469: dfe_fsm(Tf0d_fine_pcie,Update0);
	push	ar2
	push	ar3
	clr	a
	push	acc
	...
	pop	ar2
00161$:
;	../../shared/src/cdr_dfe_scheme.c:471: CDS_ST_JUMP(SAVE_F0D);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x1C
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:473: if( !f0d_updated )
	mov	a,r3
	jnz	00166$
;	../../shared/src/cdr_dfe_scheme.c:474: cds_save(Savf0d);
	mov	dpl,#0x02
	push	ar2
	push	ar3
	mov	r0,#_cds_save
	...
	sjmp	00167$
00166$:
;	../../shared/src/cdr_dfe_scheme.c:475: else if( f0d_dir == 0 )
	mov	a,r2
	jnz	00163$
;	../../shared/src/cdr_dfe_scheme.c:476: cds_save(Savf0d_l);
	mov	dpl,#0x03
	push	ar2
	push	ar3
	mov	r0,#_cds_save
	...
	sjmp	00167$
00163$:
;	../../shared/src/cdr_dfe_scheme.c:478: cds_save(Savf0d_r);
	mov	dpl,#0x04
	push	ar2
	push	ar3
	mov	r0,#_cds_save
	...
	pop	ar2
00167$:
;	../../shared/src/cdr_dfe_scheme.c:480: CDS_ST_JUMP(DFE_F0D_PM);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x1B
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:481: if(tag_VH_EO_MODE)
	mov	dptr,#_CDS_CTRL_REG0
	movx	a,@dptr
	jnb	acc.3,00179$
;	../../shared/src/cdr_dfe_scheme.c:483: if(!f0d_updated){
	mov	a,r3
	jnz	00172$
;	../../shared/src/cdr_dfe_scheme.c:484: f0d_updated = 1;
	mov	r3,#0x01
;	../../shared/src/cdr_dfe_scheme.c:486: phase_control_func_0(train.phase_offset_data, norm_eom_ph_os_l);
	mov	dptr,#(_train + 0x0021)
	movx	a,@dptr
	mov	r4,a
	push	ar2
	...
	ljmp	00177$
00172$:
;	../../shared/src/cdr_dfe_scheme.c:487: }else if(f0d_dir == 0)
	mov	a,r2
	jnz	00169$
;	../../shared/src/cdr_dfe_scheme.c:489: f0d_dir = 1;
	mov	r2,#0x01
;	../../shared/src/cdr_dfe_scheme.c:491: phase_control_func_0(train.phase_offset_data, norm_eom_ph_os_r);
	mov	dptr,#(_train + 0x0021)
	movx	a,@dptr
	mov	r4,a
	push	ar2
	...
	ljmp	00177$
00169$:
;	../../shared/src/cdr_dfe_scheme.c:496: train.phase_offset_esm = norm_eom_ph_os_c; 
	mov	dptr,#_norm_eom_ph_os_c
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#(_train + 0x0022)
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:497: phase_control_func_0(train.phase_offset_data, norm_eom_ph_os_c);
	mov	dptr,#(_train + 0x0021)
	movx	a,@dptr
	mov	r3,a
	push	ar2
	...
	lcall	_phase_control_func_0
	dec	sp
;	../../shared/src/cdr_dfe_scheme.c:501: } while(1);
00179$:
;	../../shared/src/cdr_dfe_scheme.c:503: reg_DFE_F0D_MODE_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0001)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:504: reg_DFE_CLR_FRAC_EN_LANE = 1;
	mov	dptr,#_DFE_CTRL_REG1
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
00181$:
;	../../shared/src/cdr_dfe_scheme.c:540: if((cds_tb & eye_chk_en) && (lnx_EYE_CHECK_BYPASS_LANE==0))
	mov	dptr,#_CDS_READ_MISC1
	movx	a,@dptr
	mov	r2,a
	inc	dptr
...
00271$:
	...
	ljmp	00189$
00272$:
;	../../shared/src/cdr_dfe_scheme.c:542: CDS_ST_JUMP(EYECHK0);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x21
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:543: reg_EOM_EN_LANE = 1;
	mov	dptr,#_EOM_REG0
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:544: if(lnx_ESM_EN_LANE==0) {
	mov	dptr,#(_TRAIN_CONTROL_2 + 0x0002)
	movx	a,@dptr
	jb	acc.2,00183$
;	../../shared/src/cdr_dfe_scheme.c:545: dfe_load_type(1);
	mov	dpl,#0x01
	mov	r0,#_dfe_load_type
	mov	r1,#(_dfe_load_type >> 8)
	mov	r2,#(_dfe_load_type >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cdr_dfe_scheme.c:546: set_esm_voltage(get_ec_voltage());
	mov	r0,#_get_ec_voltage
	mov	r1,#(_get_ec_voltage >> 8)
	mov	r2,#(_get_ec_voltage >> 16)
	lcall	__sdcc_banked_call
	mov	r0,#_set_esm_voltage
	mov	r1,#(_set_esm_voltage >> 8)
	mov	r2,#(_set_esm_voltage >> 16)
	lcall	__sdcc_banked_call
	sjmp	00184$
00183$:
;	../../shared/src/cdr_dfe_scheme.c:549: set_esm_voltage(lnx_ESM_VOLTAGE_LANE_7_0);
	mov	dptr,#(_DFE_CONTROL_1 + 0x0001)
	movx	a,@dptr
	mov	dpl,a
	mov	r0,#_set_esm_voltage
	mov	r1,#(_set_esm_voltage >> 8)
	...
	lcall	__sdcc_banked_call
00184$:
;	../../shared/src/cdr_dfe_scheme.c:550: CDS_ST_JUMP(EYECHK);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x22
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:551: reg_EOM_CNT_CLR_LANE = 1;
;	../../shared/src/cdr_dfe_scheme.c:552: reg_EOM_CNT_CLR_LANE = 0;
	mov	dptr,#_EOM_REG0
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
	...
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:553: if(lnx_ESM_EN_LANE)
	mov	dptr,#(_TRAIN_CONTROL_2 + 0x0002)
	movx	a,@dptr
	jnb	acc.2,00186$
;	../../shared/src/cdr_dfe_scheme.c:554: dfe_fsm(Tesm,Updateoff);
	mov	a,#0xFF
	push	acc
	mov	dptr,#0x2008
	mov	r0,#_dfe_fsm
	...
	sjmp	00187$
00186$:
;	../../shared/src/cdr_dfe_scheme.c:556: dfe_fsm(Teyechk,Updateoff);
	mov	a,#0xFF
	push	acc
	mov	dptr,#0x0A05
	mov	r0,#_dfe_fsm
	...
	dec	sp
00187$:
;	../../shared/src/cdr_dfe_scheme.c:557: CDS_ST_JUMP(SAVE_EYECHK);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x23
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:559: cds28.eye_check_pass = check_eye();
	mov	r0,#_check_eye
	mov	r1,#(_check_eye >> 8)
	mov	r2,#(_check_eye >> 16)
	lcall	__sdcc_banked_call
	mov	r2,dpl
	mov	dptr,#(_cds28 + 0x0070)
	mov	a,r2
	movx	@dptr,a
00189$:
;	../../shared/src/cdr_dfe_scheme.c:562: if(lnx_ESM_EN_LANE==0 && !do_rxinit) {
	mov	dptr,#(_TRAIN_CONTROL_2 + 0x0002)
	movx	a,@dptr
	jb	acc.2,00192$
	jb	_do_rxinit,00192$
;	../../shared/src/cdr_dfe_scheme.c:563: CDS_ST_JUMP(SAVE_LAST);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x24
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:564: dfe_load_type(1);
	mov	dpl,#0x01
	mov	r0,#_dfe_load_type
	mov	r1,#(_dfe_load_type >> 8)
	mov	r2,#(_dfe_load_type >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cdr_dfe_scheme.c:565: reg_EOM_EN_LANE = 0;
	mov	dptr,#_EOM_REG0
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
00192$:
;	../../shared/src/cdr_dfe_scheme.c:567: CDS_ST_JUMP(DONE);
	mov	dptr,#(_CDS_CTRL_REG0 + 0x0002)
	mov	a,#0x25
	movx	@dptr,a
00194$:
...
;------------------------------------------------------------
;Allocation info for local variables in function 'dfe_load_all'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/cdr_dfe_scheme.c:641: void dfe_load_all(void) BANKING_CTRL {
;	-----------------------------------------
;	 function dfe_load_all
;	-----------------------------------------
_dfe_load_all:
;	../../shared/src/cdr_dfe_scheme.c:642: reg_DFE_DC_LOAD_LANE = 1; 
;	../../shared/src/cdr_dfe_scheme.c:643: reg_DFE_DC_LOAD_LANE = 0;
;	../../shared/src/cdr_dfe_scheme.c:644: reg_DFE_TAP_REFRESH_E_LANE = 1;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0003)
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
	...
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:645: reg_DFE_TAP_REFRESH_E_LANE = 0;
;	../../shared/src/cdr_dfe_scheme.c:646: reg_DFE_TAP_REFRESH_O_LANE = 1;
;	../../shared/src/cdr_dfe_scheme.c:647: reg_DFE_TAP_REFRESH_O_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0003)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
	...
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/cdr_dfe_scheme.c:649: timeout_start(100);
	mov	_TMR1,#0x9C
	mov	(_TMR1 >> 8),#0xFF
	setb	_TR1
	clr	_timeout
;	../../shared/src/cdr_dfe_scheme.c:650: while(1) {
00108$:
;	../../shared/src/cdr_dfe_scheme.c:651: if(timeout) break;
	jb	_timeout,00110$
;	../../shared/src/cdr_dfe_scheme.c:652: if(reg_DFE_UPDATED_LANE) {
	mov	dptr,#(_DFE_CTRL_REG2 + 0x0003)
	movx	a,@dptr
	jnb	acc.5,00108$
;	../../shared/src/cdr_dfe_scheme.c:653: short_delay();
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	mov	r2,#(_short_delay >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cdr_dfe_scheme.c:654: if(reg_DFE_UPDATED_LANE ) break;
	mov	dptr,#(_DFE_CTRL_REG2 + 0x0003)
	movx	a,@dptr
	jnb	acc.5,00108$
00110$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'get_ec_voltage'
;------------------------------------------------------------
;f0                        Allocated to registers 
;f0_min                    Allocated to registers r2 
;------------------------------------------------------------
;	../../shared/src/cdr_dfe_scheme.c:673: uint8_t get_ec_voltage() BANKING_CTRL {
;	-----------------------------------------
;	 function get_ec_voltage
;	-----------------------------------------
_get_ec_voltage:
;	../../shared/src/cdr_dfe_scheme.c:678: f0_min =            cds28.f0d.d_p_e;
	mov	dptr,#(_cds28 + 0x0058)
	movx	a,@dptr
	mov	r2,a
;	../../shared/src/cdr_dfe_scheme.c:679: f0_min = min(f0_min,cds28.f0d.d_n_e);
	...
	dec	sp
	mov	ar2,r3
;	../../shared/src/cdr_dfe_scheme.c:680: f0_min = min(f0_min,cds28.f0d.s_p_e);
	...
	dec	sp
	mov	ar2,r3
;	../../shared/src/cdr_dfe_scheme.c:681: f0_min = min(f0_min,cds28.f0d.s_n_e);
	...
	dec	sp
	mov	ar2,r3
;	../../shared/src/cdr_dfe_scheme.c:682: f0_min = min(f0_min,cds28.f0d.d_p_o);
	...
	dec	sp
	mov	ar2,r3
;	../../shared/src/cdr_dfe_scheme.c:683: f0_min = min(f0_min,cds28.f0d.d_n_o);
	...
	dec	sp
	mov	ar2,r3
;	../../shared/src/cdr_dfe_scheme.c:684: f0_min = min(f0_min,cds28.f0d.s_p_o);
	...
	dec	sp
	mov	ar2,r3
;	../../shared/src/cdr_dfe_scheme.c:685: f0_min = min(f0_min,cds28.f0d.s_n_o);
	...
	dec	sp
	mov	ar2,r3
;	../../shared/src/cdr_dfe_scheme.c:698: f0 = (f0_min >> tag_EYE_CHK_THRESH_K) + tag_EYE_CHK_THRESH_C;
	mov	dptr,#(_CDS_EYE_CLK_THR + 0x0003)
	movx	a,@dptr
	swap	a
	anl	a,#0x0f
	mov	r3,a
...
00104$:
	...
	mov	r2,a
	mov	dpl,a
;	../../shared/src/cdr_dfe_scheme.c:699: return f0;
	ljmp	__sdcc_banked_ret
	.area CSEG    (CODE)
	.area CSEG    (CODE)
_cds_table:
	...
	.byte #0xD3,#0x11	; 4563
	.byte #0x10,#0x03	; 784
	.byte #0xD7,#0x75	; 30167
	.byte #0x90,#0x55	; 21904
