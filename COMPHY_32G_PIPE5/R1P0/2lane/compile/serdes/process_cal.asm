...
;--------------------------------------------------------
	.area BANK2   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'proc_cal'
;------------------------------------------------------------
;process_val_cal           Allocated to registers r5 r7 
;process_val_raw           Allocated to stack - offset 1
;subss                     Allocated to stack - offset 3
;ss2tt                     Allocated to stack - offset 5
;tt2ff                     Allocated to stack - offset 7
;proc_value                Allocated to registers r3 
;proc_sum_lvt              Allocated to stack - offset 9
;proc_sum_ulvt             Allocated to stack - offset 10
;cnt                       Allocated to stack - offset 11
;i                         Allocated to registers r2 
;sloc0                     Allocated to stack - offset 16
;sloc1                     Allocated to stack - offset 12
;------------------------------------------------------------
;	../../shared/src/process_cal.c:42: void proc_cal(void) BANKING_CTRL {
;	-----------------------------------------
;	 function proc_cal
;	-----------------------------------------
_proc_cal:
	...
	add	a,#0x0d
	mov	sp,a
;	../../shared/src/process_cal.c:48: cmx_PROCESS_CAL_DONE = 0;
	mov	dptr,#_CAL_STATUS_READ
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/process_cal.c:50: if(cmx_PROCESS_CAL_EXT_EN ) {
	mov	dptr,#(_CONTROL_CONFIG1 + 0x0003)
	movx	a,@dptr
	jnb	acc.2,00105$
;	../../shared/src/process_cal.c:51: if(cmx_CAL_PROCESS_RESULT_SEL == 0)
	mov	dptr,#(_CONTROL_CONFIG3 + 0x0003)
	movx	a,@dptr
	jb	acc.3,00102$
;	../../shared/src/process_cal.c:52: PROCESS_VALUE = cmx_CAL_PROCESS_VALUE_ULVT_7_0;
	mov	dptr,#_CAL_DATA1
	movx	a,@dptr
	mov	r2,a
	...
	ljmp	00141$
00102$:
;	../../shared/src/process_cal.c:54: PROCESS_VALUE = cmx_CAL_PROCESS_VALUE_LVT_7_0;
	mov	dptr,#_CAL_DATA0
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_PLLCAL_REG1
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/process_cal.c:55: goto ext_cal; 
	ljmp	00141$
00105$:
;	../../shared/src/process_cal.c:58: PHY_STATUS = ST_PROCESS_CAL;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x04
	movx	@dptr,a
;	../../shared/src/process_cal.c:60: reg_FBC_CNT_TIMER_15_0_b0 = cmx_REFCLK_FREQ_7_0 - 1;
	...
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/process_cal.c:61: reg_FBC_CNT_TIMER_15_0_b1 = 0;
	mov	dptr,#(_PLLCAL_REG0 + 0x0001)
	clr	a
	movx	@dptr,a
;	../../shared/src/process_cal.c:63: PCM_EN = 1;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_201
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/process_cal.c:67: FBC_CNT_SELECT = 	1;
	mov	dptr,#_PLLCAL_REG1
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/process_cal.c:68: PROCESSMON_SWITCH =	1; //clock enable
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_202
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/process_cal.c:69: delay01(20);	
	mov	dptr,#0x0014
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/process_cal.c:72: proc_sum_lvt = 0;	//rings 1-5
	mov	a,_bp
	add	a,#0x09
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/process_cal.c:73: proc_sum_ulvt = 0;	//rings 6-10
	mov	a,_bp
	add	a,#0x0a
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/process_cal.c:75: do {
	mov	a,_bp
	add	a,#0x0b
	mov	r0,a
	mov	@r0,#0x01
00135$:
;	../../shared/src/process_cal.c:76: subss = (int16_t)cmx_CAL_PROC_SUBSS_7_0; 
	mov	dptr,#(_CONTROL_CONFIG7 + 0x0002)
	movx	a,@dptr
	mov	r5,a
	mov	a,_bp
	add	a,#0x03
	...
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/process_cal.c:77: ss2tt = (int16_t)cmx_CAL_PROC_SS2TT_7_0; 
	mov	dptr,#(_CONTROL_CONFIG7 + 0x0001)
	movx	a,@dptr
	mov	r7,a
	mov	a,_bp
	add	a,#0x05
	...
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/process_cal.c:78: tt2ff = (int16_t)cmx_CAL_PROC_TT2FF_7_0; 
	mov	dptr,#_CONTROL_CONFIG7
	movx	a,@dptr
	mov	r6,a
	mov	a,_bp
	add	a,#0x07
	...
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/process_cal.c:79: reg_DRO_SEL_3_0 = cnt;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_202
	mov	a,_bp
	add	a,#0x0b
	mov	r0,a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/process_cal.c:80: delay01(20);	
	mov	dptr,#0x0014
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/process_cal.c:81: FBC_CNT_START =	1;
	mov	dptr,#_PLLCAL_REG1
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/process_cal.c:82: timeout_start((uint16_t)10);	//10uS timeout
	mov	_TMR1,#0xF6
	mov	(_TMR1 >> 8),#0xFF
	setb	_TR1
	clr	_timeout
;	../../shared/src/process_cal.c:83: while (!FBC_PLLCAL_CNT_READY && !timeout);
00107$:
	mov	dptr,#_PLLCAL_REG1
	movx	a,@dptr
	jb	acc.1,00109$
	jnb	_timeout,00107$
00109$:
;	../../shared/src/process_cal.c:84: timeout_stop;
	clr	_TR1
	clr	_TF1
;	../../shared/src/process_cal.c:85: FBC_CNT_START =	0;
	mov	dptr,#_PLLCAL_REG1
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/process_cal.c:87: process_val_raw = ((FBC_PLLCAL_CNT_RD_b1 << 8) + FBC_PLLCAL_CNT_RD_b0);
	mov	dptr,#(_PLLCAL_REG0 + 0x0003)
	movx	a,@dptr
	mov	r4,a
	mov	r2,#0x00
	...
	inc	r0
	mov	@r0,ar4
;	../../shared/src/process_cal.c:89: if (process_val_raw <= (subss<<4)) {
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	ar4,@r0
	...
	subb	a,b
	jc	00130$
;	../../shared/src/process_cal.c:90: proc_value =	0;
	mov	r3,#0x00
	ljmp	00131$
00130$:
;	../../shared/src/process_cal.c:93: if(process_val_raw <= ((subss<<4) + (ss2tt<<3))) 
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
	mov	a,_bp
	...
	subb	a,b
	jc	00127$
;	../../shared/src/process_cal.c:95: process_val_cal = process_val_raw - (subss<<4);
	mov	r0,_bp
	inc	r0
	mov	a,@r0
	clr	c
	...
	subb	a,r3
	mov	r7,a
;	../../shared/src/process_cal.c:97: i = 0;
	mov	r2,#0x00
;	../../shared/src/process_cal.c:98: if(ss2tt!=0) {
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
	mov	a,@r0
	...
	orl	a,@r0
	jz	00114$
;	../../shared/src/process_cal.c:99: while (process_val_cal > ss2tt){
	mov	r3,#0x00
00110$:
	mov	a,_bp
	add	a,#0x05
	...
	subb	a,b
	jnc	00160$
;	../../shared/src/process_cal.c:100: process_val_cal =	process_val_cal - ss2tt;
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
	mov	a,r5
	...
	subb	a,@r0
	mov	r7,a
;	../../shared/src/process_cal.c:101: i++;
	inc	r3
	sjmp	00110$
00160$:
	mov	ar2,r3
00114$:
;	../../shared/src/process_cal.c:104: if (i <= 8) proc_value = i;
	mov	a,#0x08
	cjne	a,ar2,00171$
00171$:
	jc	00116$
	...
	sjmp	00131$
00116$:
;	../../shared/src/process_cal.c:105: else proc_value = 8;
	mov	r3,#0x08
	sjmp	00131$
00127$:
;	../../shared/src/process_cal.c:108: process_val_cal = (process_val_raw - (subss<<4) - (ss2tt<<3));
	mov	r0,_bp
	inc	r0
	mov	a,@r0
	clr	c
	...
	mov	ar5,r4
	mov	ar7,r6
;	../../shared/src/process_cal.c:109: i = 0;
	mov	r2,#0x00
;	../../shared/src/process_cal.c:110: if(tt2ff!=0) {
	mov	a,_bp
	add	a,#0x07
	mov	r0,a
	mov	a,@r0
	...
	orl	a,@r0
	jz	00122$
;	../../shared/src/process_cal.c:111: while (process_val_cal > tt2ff){
	mov	r4,#0x00
00118$:
	mov	a,_bp
	add	a,#0x07
	...
	subb	a,b
	jnc	00161$
;	../../shared/src/process_cal.c:112: process_val_cal =	process_val_cal - tt2ff;
	mov	a,_bp
	add	a,#0x07
	mov	r0,a
	mov	a,r5
	...
	subb	a,@r0
	mov	r7,a
;	../../shared/src/process_cal.c:113: i++;
	inc	r4
	sjmp	00118$
00161$:
	mov	ar2,r4
00122$:
;	../../shared/src/process_cal.c:116: if (i <= 7) proc_value = 8 + i;
	mov	a,#0x07
	cjne	a,ar2,00175$
00175$:
	jc	00124$
	...
	sjmp	00131$
00124$:
;	../../shared/src/process_cal.c:117: else proc_value = 15;
	mov	r3,#0x0F
00131$:
;	../../shared/src/process_cal.c:121: PROCESS_VALUE = proc_value;
	mov	dptr,#_PLLCAL_REG1
	mov	a,r3
	swap	a
	anl	a,#(0xf0&0xf0)
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/process_cal.c:123: if (cnt <=5)
	mov	a,_bp
	add	a,#0x0b
	mov	r0,a
	mov	a,@r0
	add	a,#0xff - 0x05
	jc	00133$
;	../../shared/src/process_cal.c:124: proc_sum_ulvt += proc_value;
	mov	a,_bp
	add	a,#0x0a
	mov	r0,a
	mov	a,r3
	...
	sjmp	00136$
00133$:
;	../../shared/src/process_cal.c:126: proc_sum_lvt += proc_value;
	mov	a,_bp
	add	a,#0x09
	mov	r0,a
	mov	a,r3
	...
	mov	@r0,a
00136$:
;	../../shared/src/process_cal.c:128: } while(cnt++<10);
	mov	a,_bp
	add	a,#0x0b
	mov	r0,a
	mov	ar2,@r0
...
00178$:
	...
	ljmp	00135$
00179$:
;	../../shared/src/process_cal.c:130: cmx_CAL_PROCESS_VALUE_ULVT_7_0 = (uint8_t)(proc_sum_ulvt + 2)/5;
	mov	a,_bp
	add	a,#0x0a
	mov	r0,a
	mov	a,#0x02
	...
	mov	dptr,#_CAL_DATA1
	movx	@dptr,a
;	../../shared/src/process_cal.c:131: cmx_CAL_PROCESS_VALUE_LVT_7_0 = (uint8_t)(proc_sum_lvt + 2)/5;	//this is for VDD calibration later
	mov	a,_bp
	add	a,#0x09
	mov	r0,a
	mov	a,#0x02
	...
	mov	dptr,#_CAL_DATA0
	movx	@dptr,a
;	../../shared/src/process_cal.c:132: if(cmx_CAL_PROCESS_RESULT_SEL == 0)
	mov	dptr,#(_CONTROL_CONFIG3 + 0x0003)
	movx	a,@dptr
	jb	acc.3,00139$
;	../../shared/src/process_cal.c:133: PROCESS_VALUE = cmx_CAL_PROCESS_VALUE_ULVT_7_0;
	mov	dptr,#_CAL_DATA1
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_PLLCAL_REG1
	...
	sjmp	00140$
00139$:
;	../../shared/src/process_cal.c:135: PROCESS_VALUE = cmx_CAL_PROCESS_VALUE_LVT_7_0;
	mov	dptr,#_CAL_DATA0
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_PLLCAL_REG1
	...
	movx	@dptr,a
00140$:
;	../../shared/src/process_cal.c:137: PROCESSMON_SWITCH =	0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_202
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/process_cal.c:138: FBC_CNT_SELECT = 0;
	mov	dptr,#_PLLCAL_REG1
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/process_cal.c:139: cmx_PROCESS_CAL_PASS = timeout==0;
	mov	c,_timeout
	cpl	c
	mov  b0,c
	clr	a
	...
	mov	acc.1,c
	movx	@dptr,a
;	../../shared/src/process_cal.c:141: PCM_EN = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_201
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/process_cal.c:145: ext_cal:	
00141$:
;	../../shared/src/process_cal.c:147: cmx_PROCESS_CAL_DONE = 1;
	mov	dptr,#_CAL_STATUS_READ
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
