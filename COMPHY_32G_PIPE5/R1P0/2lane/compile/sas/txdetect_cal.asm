...
;--------------------------------------------------------
	.area BANK2   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'set_txdata'
;------------------------------------------------------------
;val                       Allocated to registers r2 
;------------------------------------------------------------
;	../../shared/src/txdetect_cal.c:74: void set_txdata(uint8_t val) BANKING_CTRL {
;	-----------------------------------------
;	 function set_txdata
;	-----------------------------------------
_set_txdata:
	...
	ar1 = 0x01
	mov	r2,dpl
;	../../shared/src/txdetect_cal.c:76: switch(mcuid) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r3,a
	jz	00101$
;	../../shared/src/txdetect_cal.c:77: case MCU_LANE0: 
	cjne	r3,#0x01,00103$
	sjmp	00102$
00101$:
;	../../shared/src/txdetect_cal.c:78: SELLV_TXDATA_CH0 = val; break;	
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/txdetect_cal.c:79: case MCU_LANE1: 
	sjmp	00103$
00102$:
;	../../shared/src/txdetect_cal.c:80: SELLV_TXDATA_CH1 = val; break;		
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_158
	mov	a,r2
	anl	a,#0x0f
	mov	b,a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/txdetect_cal.c:87: }
00103$:
;	../../shared/src/txdetect_cal.c:89: TXDCC_CLK = 1;	delay01(20);
...
;	../../shared/src/txdetect_cal.c:90: TXDCC_CLK = 0;	delay01(20);
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_136
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
...
;------------------------------------------------------------
;Allocation info for local variables in function 'get_txdata'
;------------------------------------------------------------
;val                       Allocated to stack - offset 1
;------------------------------------------------------------
;	../../shared/src/txdetect_cal.c:93: uint8_t get_txdata(void) BANKING_CTRL {
;	-----------------------------------------
;	 function get_txdata
;	-----------------------------------------
_get_txdata:
	...
	mov	_bp,sp
	inc	sp
;	../../shared/src/txdetect_cal.c:96: switch(mcuid) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r2,a
	jz	00101$
;	../../shared/src/txdetect_cal.c:97: case MCU_LANE0: 
	cjne	r2,#0x01,00103$
	sjmp	00102$
00101$:
;	../../shared/src/txdetect_cal.c:98: val = SELLV_TXDATA_CH0; break;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_158
	movx	a,@dptr
	swap	a
	anl	a,#0x0f
	mov	r2,a
;	../../shared/src/txdetect_cal.c:99: case MCU_LANE1: 
	sjmp	00103$
00102$:
;	../../shared/src/txdetect_cal.c:100: val = SELLV_TXDATA_CH1; break;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_158
	movx	a,@dptr
	anl	a,#0x0f
	mov	r3,a
	mov	r2,a
;	../../shared/src/txdetect_cal.c:107: }				
00103$:
;	../../shared/src/txdetect_cal.c:108: return val;
	mov	dpl,r2
	mov	sp,_bp
	pop	_bp
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'txdetect_cal'
;------------------------------------------------------------
;txtd_loopcnt              Allocated to registers r4 
;sellv_txdata              Allocated to registers r3 
;save_tx_speed_div         Allocated to registers r2 
;------------------------------------------------------------
;	../../shared/src/txdetect_cal.c:112: void txdetect_cal(void) BANKING_CTRL {
;	-----------------------------------------
;	 function txdetect_cal
;	-----------------------------------------
_txdetect_cal:
;	../../shared/src/txdetect_cal.c:117: if( cmx_TXDETECT_CAL_EXT_EN ) return; //TODO
	mov	dptr,#(_CONTROL_CONFIG1 + 0x0001)
	movx	a,@dptr
	jnb	acc.6,00102$
	ljmp	00133$
00102$:
;	../../shared/src/txdetect_cal.c:119: save_tx_speed_div = reg_TX_SPEED_DIV_LANE_2_0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_150
	movx	a,@dptr
	anl	a,#0x07
	mov	r2,a
;	../../shared/src/txdetect_cal.c:121: set_test_pattern(1); //4T
	mov	dpl,#0x01
	push	ar2
	...
	lcall	__sdcc_banked_call
	pop	ar2
;	../../shared/src/txdetect_cal.c:123: PHY_STATUS = ST_TXDETECT_CAL;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x16
	movx	@dptr,a
;	../../shared/src/txdetect_cal.c:125: reg_TX_TDCAL_EN_LANE = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_24
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/txdetect_cal.c:126: TRXDCCIN_SEL = 0x6;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_17
	movx	a,@dptr
	anl	a,#0x1f
	orl	a,#0xc0
	movx	@dptr,a
;	../../shared/src/txdetect_cal.c:127: reg_SLC_EN_LANE_6_0 = 0x7f;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_146
	movx	a,@dptr
	orl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/txdetect_cal.c:130: lnx_TXDETECT_CAL_PASS_LANE = 0;
	mov	dptr,#_CAL_CTRL2_LANE
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/txdetect_cal.c:131: lnx_TXDETECT_CAL_DONE_LANE = 0;
	mov	dptr,#_CAL_CTRL1_LANE
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/txdetect_cal.c:133: if (TXTD_TAP_SEL) sellv_txdata = get_txdata();
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_145
	movx	a,@dptr
	jnb	acc.7,00104$
	push	ar2
	mov	r0,#_get_txdata
	mov	r1,#(_get_txdata >> 8)
	mov	r2,#(_get_txdata >> 16)
	lcall	__sdcc_banked_call
	mov	r3,dpl
	pop	ar2
	sjmp	00145$
00104$:
;	../../shared/src/txdetect_cal.c:135: sellv_txdata =0x8;
	mov	r3,#0x08
;	../../shared/src/txdetect_cal.c:136: set_txdata(sellv_txdata);
	mov	dpl,#0x08
	push	ar2
	push	ar3
	mov	r0,#_set_txdata
	mov	r1,#(_set_txdata >> 8)
	mov	r2,#(_set_txdata >> 16)
	lcall	__sdcc_banked_call
	pop	ar3
	pop	ar2
;	../../shared/src/txdetect_cal.c:139: do {
00145$:
	mov	r4,#0x00
00125$:
;	../../shared/src/txdetect_cal.c:140: if (TXDCC_DN==0) {
	mov	dptr,#_TX_CALIBRATION_LANE
	movx	a,@dptr
	jb	acc.0,00121$
;	../../shared/src/txdetect_cal.c:141: if (TXTD_TAP_SEL)
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_145
	movx	a,@dptr
	jnb	acc.7,00111$
;	../../shared/src/txdetect_cal.c:143: if (sellv_txdata > 0x4)
	mov	a,#0x04
	cjne	a,ar3,00153$
00153$:
	jnc	00122$
;	../../shared/src/txdetect_cal.c:144: sellv_txdata--;
	dec	r3
	sjmp	00122$
00111$:
;	../../shared/src/txdetect_cal.c:148: if (sellv_txdata < 0xc) 
	cjne	r3,#0x0C,00155$
00155$:
	jnc	00122$
;	../../shared/src/txdetect_cal.c:149: sellv_txdata++;
	inc	r3
	sjmp	00122$
00121$:
;	../../shared/src/txdetect_cal.c:153: if (TXTD_TAP_SEL)
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_145
	movx	a,@dptr
	jnb	acc.7,00118$
;	../../shared/src/txdetect_cal.c:155: if (sellv_txdata < 0xc)
	cjne	r3,#0x0C,00158$
00158$:
	jnc	00122$
;	../../shared/src/txdetect_cal.c:156: sellv_txdata++;
	inc	r3
	sjmp	00122$
00118$:
;	../../shared/src/txdetect_cal.c:160: if (sellv_txdata > 0x4) 
	mov	a,#0x04
	cjne	a,ar3,00160$
00160$:
	jnc	00122$
;	../../shared/src/txdetect_cal.c:161: sellv_txdata--;
	dec	r3
00122$:
;	../../shared/src/txdetect_cal.c:165: set_txdata(sellv_txdata);
	mov	dpl,r3
	push	ar2
	push	ar3
	push	ar4
	...
	pop	ar3
	pop	ar2
;	../../shared/src/txdetect_cal.c:167: if (TXTD_TAP_SEL) break; 	
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_145
	movx	a,@dptr
	jb	acc.7,00127$
;	../../shared/src/txdetect_cal.c:169: } while (txtd_loopcnt++ <= TXTD_MAX_LOOP);
	mov	ar5,r4
	inc	r4
	mov	a,#0x10
	cjne	a,ar5,00163$
00163$:
	jnc	00125$
00127$:
;	../../shared/src/txdetect_cal.c:171: if (rate == 1){
	jnb	_tx_pll_rate,00129$
;	../../shared/src/txdetect_cal.c:172: lnx_CAL_SELLV_TXDATA_R1_LANE_7_0 = sellv_txdata;
	mov	dptr,#(_phy_mode_lane_table + 0x0057)
	mov	a,r3
	movx	@dptr,a
	sjmp	00130$
00129$:
;	../../shared/src/txdetect_cal.c:175: lnx_CAL_SELLV_TXDATA_R0_LANE_7_0 = sellv_txdata;
	mov	dptr,#(_phy_mode_lane_table + 0x0056)
	mov	a,r3
	movx	@dptr,a
00130$:
;	../../shared/src/txdetect_cal.c:178: reg_TX_TDCAL_EN_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_24
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/txdetect_cal.c:180: if(TXTD_TAP_SEL==0) {
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_145
	movx	a,@dptr
	jb	acc.7,00132$
;	../../shared/src/txdetect_cal.c:181: reg_SLC_EN_LANE_6_0 = 0x3f; //for continuous mode, just leave 0x7f for tx_emph* share.
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_146
	movx	a,@dptr
	anl	a,#0x01
	orl	a,#0x7e
	movx	@dptr,a
00132$:
;	../../shared/src/txdetect_cal.c:184: reg_TX_SPEED_DIV_LANE_2_0 = save_tx_speed_div;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_150
	mov	a,r2
	anl	a,#0x07
	mov	b,a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/txdetect_cal.c:186: recover_test_pattern();
	mov	r0,#_recover_test_pattern
	mov	r1,#(_recover_test_pattern >> 8)
	mov	r2,#(_recover_test_pattern >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/txdetect_cal.c:188: lnx_TXDETECT_CAL_PASS_LANE = 1;
	mov	dptr,#_CAL_CTRL2_LANE
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/txdetect_cal.c:189: lnx_TXDETECT_CAL_DONE_LANE = 1;
	mov	dptr,#_CAL_CTRL1_LANE
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
