                            ...
                            979 	.globl _tx_train_control
                            980 	.globl _tx_ffe_train
                            981 ;--------------------------------------------------------
   ...
   0000                    1116 	.ds 8
                    ...
                    607C   1991 _sq_thrs_ratio_tb	=	0x607c
                           ...
                           2024 	.area CSEG    (CODE)
                           2025 ;------------------------------------------------------------
                           2026 ;Allocation info for local variables in function 'tx_train_control'
                           2027 ;------------------------------------------------------------
                           2028 ;------------------------------------------------------------
                           2029 ;	../../shared/src/tx_train_sas.c:36: void tx_train_control(void)
                           2030 ;	-----------------------------------------
                           2031 ;	 function tx_train_control
                           2032 ;	-----------------------------------------
   7C25                    2033 _tx_train_control:
                    0002   2034 	ar2 = 0x02
                    0003   2035 	ar3 = 0x03
                    0004   2036 	ar4 = 0x04
                    0005   2037 	ar5 = 0x05
                    ...
                    0000   2040 	ar0 = 0x00
                    0001   2041 	ar1 = 0x01
                           2042 ;	../../shared/src/tx_train_sas.c:39: if ( (tx.num_tx_loop >= tag_TX_MAX_LOOP) || //1
   7C25 90 66 A0           2043 	mov	dptr,#(_tx + 0x0002)
   7C28 E0                 2044 	movx	a,@dptr
   7C29 FA                 2045 	mov	r2,a
   7C2A BA 01 00           2046 	cjne	r2,#0x01,00111$
   7C2D                    2047 00111$:
   7C2D 50 1A              2048 	jnc	00101$
                           2049 ;	../../shared/src/tx_train_sas.c:40: ( (train.eo >= tag_TX_EO_BYPASS_THRES) && train.saturated==0) || //tag_TX_EO_BYPASS_THRES=60 //15
   7C2F 90 66 5F           2050 	mov	dptr,#(_train + 0x001f)
   7C32 E0                 2051 	movx	a,@dptr
   7C33 FB                 2052 	mov	r3,a
   7C34 BB 3C 00           2053 	cjne	r3,#0x3C,00113$
   7C37                    2054 00113$:
   7C37 40 06              2055 	jc	00106$
   7C39 90 66 68           2056 	mov	dptr,#(_train + 0x0028)
   7C3C E0                 2057 	movx	a,@dptr
   7C3D 60 0A              2058 	jz	00101$
   7C3F                    2059 00106$:
                           2060 ;	../../shared/src/tx_train_sas.c:41: (train.level >= 5))
   7C3F 90 66 63           2061 	mov	dptr,#(_train + 0x0023)
   7C42 E0                 2062 	movx	a,@dptr
   7C43 FB                 2063 	mov	r3,a
   7C44 BB 05 00           2064 	cjne	r3,#0x05,00116$
   7C47                    2065 00116$:
   7C47 40 09              2066 	jc	00102$
   7C49                    2067 00101$:
                           2068 ;	../../shared/src/tx_train_sas.c:44: ctrl_tx_train_done = 1;
   7C49 D2 22              2069 	setb	_ctrl_tx_train_done
                           2070 ;	../../shared/src/tx_train_sas.c:45: tx.num_tx_loop = 0;
   7C4B 90 66 A0           2071 	mov	dptr,#(_tx + 0x0002)
   7C4E E4                 2072 	clr	a
   7C4F F0                 2073 	movx	@dptr,a
   7C50 80 08              2074 	sjmp	00103$
   7C52                    2075 00102$:
                           2076 ;	../../shared/src/tx_train_sas.c:48: ctrl_tx_train_done = 0;
   7C52 C2 22              2077 	clr	_ctrl_tx_train_done
                           2078 ;	../../shared/src/tx_train_sas.c:49: tx.num_tx_loop ++; // update counter of Number of TX loop by adding one
   7C54 0A                 2079 	inc	r2
   7C55 90 66 A0           2080 	mov	dptr,#(_tx + 0x0002)
   7C58 EA                 2081 	mov	a,r2
   7C59 F0                 2082 	movx	@dptr,a
   7C5A                    2083 00103$:
                           2084 ;	../../shared/src/tx_train_sas.c:51: tx.blind_training = 0;//(tag_BLIND_TRAIN_EN && !opt.eye_check_pass); //tag_BLIND_TRAIN_EN=0
   7C5A 90 66 9E           2085 	mov	dptr,#_tx
   7C5D E4                 2086 	clr	a
   7C5E F0                 2087 	movx	@dptr,a
   7C5F 22                 2088 	ret
                           2089 ;------------------------------------------------------------
                           2090 ;Allocation info for local variables in function 'tx_ffe_train'
                           2091 ;------------------------------------------------------------
                           2092 ;------------------------------------------------------------
                           2093 ;	../../shared/src/tx_train_sas.c:69: void tx_ffe_train(void)
                           2094 ;	-----------------------------------------
                           2095 ;	 function tx_ffe_train
                           2096 ;	-----------------------------------------
   7C60                    2097 _tx_ffe_train:
                           2098 ;	../../shared/src/tx_train_sas.c:76: if( (train.level < 5) &&
   7C60 90 66 63           2099 	mov	dptr,#(_train + 0x0023)
   7C63 E0                 2100 	movx	a,@dptr
   7C64 FA                 2101 	mov	r2,a
   7C65 BA 05 00           2102 	cjne	r2,#0x05,00118$
   7C68                    2103 00118$:
   7C68 50 2E              2104 	jnc	00111$
                           2105 ;	../../shared/src/tx_train_sas.c:77: ((train.eo < tag_TX_EO_BYPASS_THRES) || train.saturated))
   7C6A 90 66 5F           2106 	mov	dptr,#(_train + 0x001f)
   7C6D E0                 2107 	movx	a,@dptr
   7C6E FA                 2108 	mov	r2,a
   7C6F BA 3C 00           2109 	cjne	r2,#0x3C,00120$
   7C72                    2110 00120$:
   7C72 40 06              2111 	jc	00107$
   7C74 90 66 68           2112 	mov	dptr,#(_train + 0x0028)
   7C77 E0                 2113 	movx	a,@dptr
   7C78 60 1E              2114 	jz	00111$
   7C7A                    2115 00107$:
                           2116 ;	../../shared/src/tx_train_sas.c:82: if(tx_adapt_g0_en)      tx_g0_train();     //tag_TX_ADAPT_G0_EN=1
   7C7A 90 60 5A           2117 	mov	dptr,#(_TRAIN_CONTROL_2 + 0x0002)
   7C7D E0                 2118 	movx	a,@dptr
   7C7E 30 E7 03           2119 	jnb	acc.7,00102$
   7C81 12 67 14           2120 	lcall	_tx_g0_train
   7C84                    2121 00102$:
                           2122 ;	../../shared/src/tx_train_sas.c:83: if(tx_adapt_gn1_en)     tx_gn1_train();    //tag_TX_ADAPT_GN1_EN=1
   7C84 90 60 5A           2123 	mov	dptr,#(_TRAIN_CONTROL_2 + 0x0002)
   7C87 E0                 2124 	movx	a,@dptr
   7C88 30 E6 03           2125 	jnb	acc.6,00104$
   7C8B 12 68 11           2126 	lcall	_tx_gn1_train
   7C8E                    2127 00104$:
                           2128 ;	../../shared/src/tx_train_sas.c:84: if(tx_adapt_g1_en)      tx_g1_train();     //tag_TX_ADAPT_G1_EN=0
   7C8E 90 60 5A           2129 	mov	dptr,#(_TRAIN_CONTROL_2 + 0x0002)
   7C91 E0                 2130 	movx	a,@dptr
   7C92 30 E5 03           2131 	jnb	acc.5,00111$
   7C95 02 68 98           2132 	ljmp	_tx_g1_train
   7C98                    2133 00111$:
   7C98 22                 2134 	ret
                           2135 	.area CSEG    (CODE)
