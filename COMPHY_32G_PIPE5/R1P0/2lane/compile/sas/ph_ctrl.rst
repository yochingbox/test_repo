   ...
   2DF3 90 66 62           2048 	mov	dptr,#(_train + 0x0022)
   2DF6 E0                 2049 	movx	a,@dptr
   2DF7 FA                 2050 	mov	r2,a
   2DF8 90 66 61           2051 	mov	dptr,#(_train + 0x0021)
   2DFB E0                 2052 	movx	a,@dptr
   2DFC FB                 2053 	mov	r3,a
   2DFD C0 02              2054 	push	ar2
   2DFF 8B 82              2055 	mov	dpl,r3
   2E01 12 2E 07           2056 	lcall	_phase_control_func_0
   2E04 15 81              2057 	dec	sp
   2E06 22                 2058 	ret
                           2059 ;------------------------------------------------------------
                           ...
                           2070 ;	-----------------------------------------
   2E07                    2071 _phase_control_func_0:
   2E07 C0 18              2072 	push	_bp
   2E09 85 81 18           2073 	mov	_bp,sp
   2E0C 05 81              2074 	inc	sp
   2E0E 05 81              2075 	inc	sp
   2E10 AA 82              2076 	mov	r2,dpl
                           2077 ;	../../shared/src/ph_ctrl.c:30: if(lnx_FAST_DFE_TIMER_EN_LANE) return;
   2E12 90 60 4F           2078 	mov	dptr,#(_DFE_CONTROL_5 + 0x0003)
   2E15 E0                 2079 	movx	a,@dptr
   2E16 30 E7 03           2080 	jnb	acc.7,00102$
   2E19 02 2F A2           2081 	ljmp	00125$
   2E1C                    2082 00102$:
                           2083 ;	../../shared/src/ph_ctrl.c:32: cur_phase_offset_data = ph_dat;
   2E1C 90 67 97           2084 	mov	dptr,#_cur_phase_offset_data
   2E1F EA                 2085 	mov	a,r2
   2E20 F0                 2086 	movx	@dptr,a
                           2087 ;	../../shared/src/ph_ctrl.c:33: cur_phase_offset_esm = ph_esm;
   2E21 E5 18              2088 	mov	a,_bp
   2E23 24 FD              2089 	add	a,#0xfd
   2E25 F8                 2090 	mov	r0,a
   2E26 86 03              2091 	mov	ar3,@r0
   2E28 90 67 98           2092 	mov	dptr,#_cur_phase_offset_esm
   2E2B EB                 2093 	mov	a,r3
   2E2C F0                 2094 	movx	@dptr,a
                           2095 ;	../../shared/src/ph_ctrl.c:39: lnx_DLL_VDDA_TRACKING_ON_LANE = 0; 
   2E2D 90 60 0A           2096 	mov	dptr,#(_CAL_CTRL3_LANE + 0x0002)
   2E30 E0                 2097 	movx	a,@dptr
   2E31 54 DF              2098 	anl	a,#0xdf
   2E33 F0                 2099 	movx	@dptr,a
                           2100 ;	../../shared/src/ph_ctrl.c:41: if(ph_control_mode==0 ) {			
   2E34 90 66 F8           2101 	mov	dptr,#_ph_control_mode
   2E37 E0                 2102 	movx	a,@dptr
   2E38 FC                 2103 	mov	r4,a
   2E39 70 27              2104 	jnz	00116$
                           2105 ;	../../shared/src/ph_ctrl.c:43: dat = cal_phase - ph_dat - ph_esm;
   2E3B 90 60 46           2106 	mov	dptr,#(_DFE_CONTROL_3 + 0x0002)
   2E3E E0                 2107 	movx	a,@dptr
   2E3F C3                 2108 	clr	c
   2E40 9A                 2109 	subb	a,r2
   2E41 C3                 2110 	clr	c
   2E42 9B                 2111 	subb	a,r3
   2E43 FD                 2112 	mov	r5,a
   2E44 A8 18              2113 	mov	r0,_bp
   2E46 08                 2114 	inc	r0
   2E47 A6 05              2115 	mov	@r0,ar5
                           2116 ;	../../shared/src/ph_ctrl.c:48: esm = (int16_t)cal_eom_dpher - (int16_t)reg_EOM_DPHER_LANE_6_0;		
   2E49 90 60 45           2117 	mov	dptr,#(_DFE_CONTROL_3 + 0x0001)
   2E4C E0                 2118 	movx	a,@dptr
   2E4D FE                 2119 	mov	r6,a
   2E4E 90 00 28           2120 	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_10
   2E51 E0                 2121 	movx	a,@dptr
   2E52 03                 2122 	rr	a
   2E53 54 7F              2123 	anl	a,#0x7f
   2E55 FF                 2124 	mov	r7,a
   2E56 C0 03              2125 	push	ar3
   2E58 EE                 2126 	mov	a,r6
   2E59 C3                 2127 	clr	c
   2E5A 9F                 2128 	subb	a,r7
   2E5B FE                 2129 	mov	r6,a
   2E5C FD                 2130 	mov	r5,a
   2E5D D0 03              2131 	pop	ar3
   2E5F 02 2F 3D           2132 	ljmp	00117$
   2E62                    2133 00116$:
                           2134 ;	../../shared/src/ph_ctrl.c:50: else if( ph_control_mode==1 ) {
   2E62 BC 01 6B           2135 	cjne	r4,#0x01,00113$
                           2136 ;	../../shared/src/ph_ctrl.c:53: if ( ( 0 == ( g_fw_flags & 1 ) ) && ( EOM_EN_D!=EOM_EN_S ) && ( do_phase_adapt==0 ) )
   2E65 90 67 A5           2137 	mov	dptr,#_g_fw_flags
   2E68 E0                 2138 	movx	a,@dptr
   2E69 FE                 2139 	mov	r6,a
   2E6A 53 06 01           2140 	anl	ar6,#0x01
   2E6D BE 00 30           2141 	cjne	r6,#0x00,00104$
   2E70 90 00 58           2142 	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_22
   2E73 E0                 2143 	movx	a,@dptr
   2E74 C4                 2144 	swap	a
   2E75 03                 2145 	rr	a
   2E76 54 01              2146 	anl	a,#0x01
   2E78 FE                 2147 	mov	r6,a
   2E79 90 00 58           2148 	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_22
   2E7C E0                 2149 	movx	a,@dptr
   2E7D 23                 2150 	rl	a
   2E7E 23                 2151 	rl	a
   2E7F 54 01              2152 	anl	a,#0x01
   2E81 FF                 2153 	mov	r7,a
   2E82 EE                 2154 	mov	a,r6
   2E83 B5 07 02           2155 	cjne	a,ar7,00144$
   2E86 80 18              2156 	sjmp	00104$
   2E88                    2157 00144$:
   2E88 90 67 15           2158 	mov	dptr,#_do_phase_adapt
   2E8B E0                 2159 	movx	a,@dptr
   2E8C FE                 2160 	mov	r6,a
   2E8D 70 11              2161 	jnz	00104$
                           2162 ;	../../shared/src/ph_ctrl.c:54: eom_ui_align();
   2E8F C0 02              2163 	push	ar2
   2E91 C0 03              2164 	push	ar3
   2E93 78 46              2165 	mov	r0,#_EOM_clock_analog_align
   2E95 79 B9              2166 	mov	r1,#(_EOM_clock_analog_align >> 8)
   2E97 7A 01              2167 	mov	r2,#(_EOM_clock_analog_align >> 16)
   2E99 12 00 B3           2168 	lcall	__sdcc_banked_call
   2E9C D0 03              2169 	pop	ar3
   2E9E D0 02              2170 	pop	ar2
   2EA0                    2171 00104$:
                           2172 ;	../../shared/src/ph_ctrl.c:56: dat = cal_phase - ph_dat;
   2EA0 90 60 46           2173 	mov	dptr,#(_DFE_CONTROL_3 + 0x0002)
   2EA3 E0                 2174 	movx	a,@dptr
   2EA4 C3                 2175 	clr	c
   2EA5 9A                 2176 	subb	a,r2
   2EA6 FE                 2177 	mov	r6,a
   2EA7 A8 18              2178 	mov	r0,_bp
   2EA9 08                 2179 	inc	r0
   2EAA A6 06              2180 	mov	@r0,ar6
                           2181 ;	../../shared/src/ph_ctrl.c:66: esm = (int16_t)(cal_eom_dpher - ph_esm) - (int16_t)reg_EOM_DPHER_LANE_6_0;
   2EAC 90 60 45           2182 	mov	dptr,#(_DFE_CONTROL_3 + 0x0001)
   2EAF E0                 2183 	movx	a,@dptr
   2EB0 FE                 2184 	mov	r6,a
   2EB1 C0 02              2185 	push	ar2
   2EB3 EB                 2186 	mov	a,r3
   2EB4 FF                 2187 	mov	r7,a
   2EB5 33                 2188 	rlc	a
   2EB6 95 E0              2189 	subb	a,acc
   2EB8 EE                 2190 	mov	a,r6
   2EB9 C3                 2191 	clr	c
   2EBA 9F                 2192 	subb	a,r7
   2EBB FE                 2193 	mov	r6,a
   2EBC 90 00 28           2194 	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_10
   2EBF E0                 2195 	movx	a,@dptr
   2EC0 03                 2196 	rr	a
   2EC1 54 7F              2197 	anl	a,#0x7f
   2EC3 FA                 2198 	mov	r2,a
   2EC4 7F 00              2199 	mov	r7,#0x00
   2EC6 EE                 2200 	mov	a,r6
   2EC7 C3                 2201 	clr	c
   2EC8 9A                 2202 	subb	a,r2
   2EC9 FE                 2203 	mov	r6,a
   2ECA FD                 2204 	mov	r5,a
   2ECB D0 02              2205 	pop	ar2
   2ECD 02 2F 3D           2206 	ljmp	00117$
   2ED0                    2207 00113$:
                           2208 ;	../../shared/src/ph_ctrl.c:70: else if( ph_control_mode==2 ) {
   2ED0 BC 02 32           2209 	cjne	r4,#0x02,00110$
                           2210 ;	../../shared/src/ph_ctrl.c:77: dat = cal_phase;
   2ED3 90 60 46           2211 	mov	dptr,#(_DFE_CONTROL_3 + 0x0002)
   2ED6 E0                 2212 	movx	a,@dptr
   2ED7 FE                 2213 	mov	r6,a
   2ED8 A8 18              2214 	mov	r0,_bp
   2EDA 08                 2215 	inc	r0
   2EDB A6 06              2216 	mov	@r0,ar6
                           2217 ;	../../shared/src/ph_ctrl.c:83: esm =  (int16_t)(cal_eom_dpher - ph_dat - ph_esm) - (int16_t)reg_EOM_DPHER_LANE_6_0;
   2EDD 90 60 45           2218 	mov	dptr,#(_DFE_CONTROL_3 + 0x0001)
   2EE0 E0                 2219 	movx	a,@dptr
   2EE1 FE                 2220 	mov	r6,a
   2EE2 EA                 2221 	mov	a,r2
   2EE3 FF                 2222 	mov	r7,a
   2EE4 33                 2223 	rlc	a
   2EE5 95 E0              2224 	subb	a,acc
   2EE7 EE                 2225 	mov	a,r6
   2EE8 C3                 2226 	clr	c
   2EE9 9F                 2227 	subb	a,r7
   2EEA FE                 2228 	mov	r6,a
   2EEB EB                 2229 	mov	a,r3
   2EEC FD                 2230 	mov	r5,a
   2EED 33                 2231 	rlc	a
   2EEE 95 E0              2232 	subb	a,acc
   2EF0 EE                 2233 	mov	a,r6
   2EF1 C3                 2234 	clr	c
   2EF2 9D                 2235 	subb	a,r5
   2EF3 FE                 2236 	mov	r6,a
   2EF4 90 00 28           2237 	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_10
   2EF7 E0                 2238 	movx	a,@dptr
   2EF8 03                 2239 	rr	a
   2EF9 54 7F              2240 	anl	a,#0x7f
   2EFB FD                 2241 	mov	r5,a
   2EFC 7F 00              2242 	mov	r7,#0x00
   2EFE EE                 2243 	mov	a,r6
   2EFF C3                 2244 	clr	c
   2F00 9D                 2245 	subb	a,r5
   2F01 FE                 2246 	mov	r6,a
   2F02 FD                 2247 	mov	r5,a
   2F03 80 38              2248 	sjmp	00117$
   2F05                    2249 00110$:
                           2250 ;	../../shared/src/ph_ctrl.c:86: else if( ph_control_mode==3 ){				
   2F05 BC 03 35           2251 	cjne	r4,#0x03,00117$
                           2252 ;	../../shared/src/ph_ctrl.c:88: dat = cal_phase;
   2F08 90 60 46           2253 	mov	dptr,#(_DFE_CONTROL_3 + 0x0002)
   2F0B E0                 2254 	movx	a,@dptr
   2F0C FC                 2255 	mov	r4,a
   2F0D A8 18              2256 	mov	r0,_bp
   2F0F 08                 2257 	inc	r0
   2F10 A6 04              2258 	mov	@r0,ar4
                           2259 ;	../../shared/src/ph_ctrl.c:94: esm = (int16_t)(cal_eom_dpher +(half_ui_code + ph_dat + ph_esm))- (int16_t)reg_EOM_DPHER_LANE_6_0;
   2F12 90 60 45           2260 	mov	dptr,#(_DFE_CONTROL_3 + 0x0001)
   2F15 E0                 2261 	movx	a,@dptr
   2F16 FC                 2262 	mov	r4,a
   2F17 90 67 94           2263 	mov	dptr,#_half_ui_code
   2F1A E0                 2264 	movx	a,@dptr
   2F1B FD                 2265 	mov	r5,a
   2F1C EA                 2266 	mov	a,r2
   2F1D FE                 2267 	mov	r6,a
   2F1E 33                 2268 	rlc	a
   2F1F 95 E0              2269 	subb	a,acc
   2F21 EE                 2270 	mov	a,r6
   2F22 2D                 2271 	add	a,r5
   2F23 FD                 2272 	mov	r5,a
   2F24 EB                 2273 	mov	a,r3
   2F25 FE                 2274 	mov	r6,a
   2F26 33                 2275 	rlc	a
   2F27 95 E0              2276 	subb	a,acc
   2F29 FF                 2277 	mov	r7,a
   2F2A EE                 2278 	mov	a,r6
   2F2B 2D                 2279 	add	a,r5
   2F2C 2C                 2280 	add	a,r4
   2F2D FC                 2281 	mov	r4,a
   2F2E 90 00 28           2282 	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_10
   2F31 E0                 2283 	movx	a,@dptr
   2F32 03                 2284 	rr	a
   2F33 54 7F              2285 	anl	a,#0x7f
   2F35 FD                 2286 	mov	r5,a
   2F36 7E 00              2287 	mov	r6,#0x00
   2F38 EC                 2288 	mov	a,r4
   2F39 C3                 2289 	clr	c
   2F3A 9D                 2290 	subb	a,r5
   2F3B FC                 2291 	mov	r4,a
   2F3C FD                 2292 	mov	r5,a
   2F3D                    2293 00117$:
                           2294 ;	../../shared/src/ph_ctrl.c:98: if(dat>=64) dat-=64;
   2F3D A8 18              2295 	mov	r0,_bp
   2F3F 08                 2296 	inc	r0
   2F40 C3                 2297 	clr	c
   2F41 E6                 2298 	mov	a,@r0
   2F42 64 80              2299 	xrl	a,#0x80
   2F44 94 C0              2300 	subb	a,#0xc0
   2F46 40 07              2301 	jc	00119$
   2F48 A8 18              2302 	mov	r0,_bp
   2F4A 08                 2303 	inc	r0
   2F4B E6                 2304 	mov	a,@r0
   2F4C 24 C0              2305 	add	a,#0xc0
   2F4E F6                 2306 	mov	@r0,a
   2F4F                    2307 00119$:
                           2308 ;	../../shared/src/ph_ctrl.c:99: cdr_phase_update(dat);
   2F4F A8 18              2309 	mov	r0,_bp
   2F51 08                 2310 	inc	r0
   2F52 86 82              2311 	mov	dpl,@r0
   2F54 C0 02              2312 	push	ar2
   2F56 C0 03              2313 	push	ar3
   2F58 C0 05              2314 	push	ar5
   2F5A 12 30 DA           2315 	lcall	_cdr_phase_update
   2F5D D0 05              2316 	pop	ar5
   2F5F D0 03              2317 	pop	ar3
   2F61 D0 02              2318 	pop	ar2
                           2319 ;	../../shared/src/ph_ctrl.c:100: if(esm>=70) esm -= 128;
   2F63 C3                 2320 	clr	c
   2F64 ED                 2321 	mov	a,r5
   2F65 64 80              2322 	xrl	a,#0x80
   2F67 94 C6              2323 	subb	a,#0xc6
   2F69 40 06              2324 	jc	00123$
   2F6B ED                 2325 	mov	a,r5
   2F6C 24 80              2326 	add	a,#0x80
   2F6E FD                 2327 	mov	r5,a
   2F6F 80 0C              2328 	sjmp	00124$
   2F71                    2329 00123$:
                           2330 ;	../../shared/src/ph_ctrl.c:101: else if(esm < -70) esm += 128;
   2F71 C3                 2331 	clr	c
   2F72 ED                 2332 	mov	a,r5
   2F73 64 80              2333 	xrl	a,#0x80
   2F75 94 3A              2334 	subb	a,#0x3a
   2F77 50 04              2335 	jnc	00124$
   2F79 74 80              2336 	mov	a,#0x80
   2F7B 2D                 2337 	add	a,r5
   2F7C FD                 2338 	mov	r5,a
   2F7D                    2339 00124$:
                           2340 ;	../../shared/src/ph_ctrl.c:102: move_eom_phase(esm);
   2F7D ED                 2341 	mov	a,r5
   2F7E FC                 2342 	mov	r4,a
   2F7F 33                 2343 	rlc	a
   2F80 95 E0              2344 	subb	a,acc
   2F82 FD                 2345 	mov	r5,a
   2F83 8C 82              2346 	mov	dpl,r4
   2F85 8D 83              2347 	mov	dph,r5
   2F87 C0 02              2348 	push	ar2
   2F89 C0 03              2349 	push	ar3
   2F8B 12 31 96           2350 	lcall	_move_eom_phase
   2F8E D0 03              2351 	pop	ar3
   2F90 D0 02              2352 	pop	ar2
                           2353 ;	../../shared/src/ph_ctrl.c:105: set_edge_dly(ph_dat, ph_esm);
   2F92 C0 03              2354 	push	ar3
   2F94 8A 82              2355 	mov	dpl,r2
   2F96 12 2F A8           2356 	lcall	_set_edge_dly
   2F99 15 81              2357 	dec	sp
                           2358 ;	../../shared/src/ph_ctrl.c:112: lnx_DLL_VDDA_TRACKING_ON_LANE = 1; 
   2F9B 90 60 0A           2359 	mov	dptr,#(_CAL_CTRL3_LANE + 0x0002)
   2F9E E0                 2360 	movx	a,@dptr
   2F9F 44 20              2361 	orl	a,#0x20
   2FA1 F0                 2362 	movx	@dptr,a
   2FA2                    2363 00125$:
   2FA2 85 18 81           2364 	mov	sp,_bp
   2FA5 D0 18              2365 	pop	_bp
   2FA7 22                 2366 	ret
                           2367 ;------------------------------------------------------------
                           ...
                           2377 ;	-----------------------------------------
   2FA8                    2378 _set_edge_dly:
   2FA8 C0 18              2379 	push	_bp
   2FAA 85 81 18           2380 	mov	_bp,sp
   2FAD AA 82              2381 	mov	r2,dpl
                           2382 ;	../../shared/src/ph_ctrl.c:148: switch(ph_control_mode)
   2FAF 90 66 F8           2383 	mov	dptr,#_ph_control_mode
   2FB2 E0                 2384 	movx	a,@dptr
   2FB3 FB                 2385 	mov	r3,a
   2FB4 74 03              2386 	mov	a,#0x03
   2FB6 B5 03 00           2387 	cjne	a,ar3,00137$
   2FB9                    2388 00137$:
   2FB9 50 03              2389 	jnc	00138$
   2FBB 02 30 D7           2390 	ljmp	00127$
   2FBE                    2391 00138$:
   2FBE EB                 2392 	mov	a,r3
   2FBF 2B                 2393 	add	a,r3
   2FC0 2B                 2394 	add	a,r3
   2FC1 90 2F C5           2395 	mov	dptr,#00139$
   2FC4 73                 2396 	jmp	@a+dptr
   2FC5                    2397 00139$:
   2FC5 02 2F D1           2398 	ljmp	00101$
   2FC8 02 2F D1           2399 	ljmp	00102$
   2FCB 02 2F FC           2400 	ljmp	00106$
   2FCE 02 30 68           2401 	ljmp	00116$
   ...
   2FD1 90 00 38           2407 	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_14
   2FD4 E0                 2408 	movx	a,@dptr
   2FD5 03                 2409 	rr	a
   2FD6 03                 2410 	rr	a
   2FD7 54 3F              2411 	anl	a,#0x3f
   2FD9 FB                 2412 	mov	r3,a
   2FDA C3                 2413 	clr	c
   2FDB 74 A2              2414 	mov	a,#(0x22 ^ 0x80)
   2FDD 8B F0              2415 	mov	b,r3
   2FDF 63 F0 80           2416 	xrl	b,#0x80
   2FE2 95 F0              2417 	subb	a,b
   2FE4 50 0A              2418 	jnc	00104$
                           2419 ;	../../shared/src/ph_ctrl.c:153: reg_SEL_EDGE_DLY_LANE_1_0 = 0;
   2FE6 90 02 24           2420 	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_137
   2FE9 E0                 2421 	movx	a,@dptr
   2FEA 54 F3              2422 	anl	a,#0xf3
   2FEC F0                 2423 	movx	@dptr,a
   2FED 02 30 D7           2424 	ljmp	00127$
   2FF0                    2425 00104$:
                           2426 ;	../../shared/src/ph_ctrl.c:155: reg_SEL_EDGE_DLY_LANE_1_0 = 1;  
   2FF0 90 02 24           2427 	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_137
   2FF3 E0                 2428 	movx	a,@dptr
   2FF4 54 F3              2429 	anl	a,#0xf3
   2FF6 44 04              2430 	orl	a,#0x04
   2FF8 F0                 2431 	movx	@dptr,a
                           2432 ;	../../shared/src/ph_ctrl.c:156: break;
   2FF9 02 30 D7           2433 	ljmp	00127$
                           2434 ;	../../shared/src/ph_ctrl.c:157: case 2: 
   2FFC                    2435 00106$:
                           2436 ;	../../shared/src/ph_ctrl.c:158: eom_ph_os = (int8_t)ph_dat + (int8_t)ph_esm;
   2FFC E5 18              2437 	mov	a,_bp
   2FFE 24 FD              2438 	add	a,#0xfd
   3000 F8                 2439 	mov	r0,a
   3001 E6                 2440 	mov	a,@r0
   3002 2A                 2441 	add	a,r2
   3003 FB                 2442 	mov	r3,a
                           2443 ;	../../shared/src/ph_ctrl.c:159: if( eom_ph_os < sel_sdge_dly_tb2[0])  reg_SEL_EDGE_DLY_LANE_1_0 = 0;
   3004 90 32 20           2444 	mov	dptr,#_sel_sdge_dly_tb2
   3007 E4                 2445 	clr	a
   3008 93                 2446 	movc	a,@a+dptr
   3009 FC                 2447 	mov	r4,a
   300A C3                 2448 	clr	c
   300B EB                 2449 	mov	a,r3
   300C 64 80              2450 	xrl	a,#0x80
   300E 8C F0              2451 	mov	b,r4
   3010 63 F0 80           2452 	xrl	b,#0x80
   3013 95 F0              2453 	subb	a,b
   3015 50 0A              2454 	jnc	00114$
   3017 90 02 24           2455 	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_137
   301A E0                 2456 	movx	a,@dptr
   301B 54 F3              2457 	anl	a,#0xf3
   301D F0                 2458 	movx	@dptr,a
   301E 02 30 D7           2459 	ljmp	00127$
   3021                    2460 00114$:
                           2461 ;	../../shared/src/ph_ctrl.c:160: else if(eom_ph_os < sel_sdge_dly_tb2[1])  reg_SEL_EDGE_DLY_LANE_1_0 = 1;
   3021 90 32 21           2462 	mov	dptr,#(_sel_sdge_dly_tb2 + 0x0001)
   3024 E4                 2463 	clr	a
   3025 93                 2464 	movc	a,@a+dptr
   3026 FC                 2465 	mov	r4,a
   3027 C3                 2466 	clr	c
   3028 EB                 2467 	mov	a,r3
   3029 64 80              2468 	xrl	a,#0x80
   302B 8C F0              2469 	mov	b,r4
   302D 63 F0 80           2470 	xrl	b,#0x80
   3030 95 F0              2471 	subb	a,b
   3032 50 0C              2472 	jnc	00111$
   3034 90 02 24           2473 	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_137
   3037 E0                 2474 	movx	a,@dptr
   3038 54 F3              2475 	anl	a,#0xf3
   303A 44 04              2476 	orl	a,#0x04
   303C F0                 2477 	movx	@dptr,a
   303D 02 30 D7           2478 	ljmp	00127$
   3040                    2479 00111$:
                           2480 ;	../../shared/src/ph_ctrl.c:161: else if(eom_ph_os < sel_sdge_dly_tb2[2])  reg_SEL_EDGE_DLY_LANE_1_0 = 2;
   3040 90 32 22           2481 	mov	dptr,#(_sel_sdge_dly_tb2 + 0x0002)
   3043 E4                 2482 	clr	a
   3044 93                 2483 	movc	a,@a+dptr
   3045 FC                 2484 	mov	r4,a
   3046 C3                 2485 	clr	c
   3047 EB                 2486 	mov	a,r3
   3048 64 80              2487 	xrl	a,#0x80
   304A 8C F0              2488 	mov	b,r4
   304C 63 F0 80           2489 	xrl	b,#0x80
   304F 95 F0              2490 	subb	a,b
   3051 50 0C              2491 	jnc	00108$
   3053 90 02 24           2492 	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_137
   3056 E0                 2493 	movx	a,@dptr
   3057 54 F3              2494 	anl	a,#0xf3
   3059 44 08              2495 	orl	a,#0x08
   305B F0                 2496 	movx	@dptr,a
   305C 02 30 D7           2497 	ljmp	00127$
   305F                    2498 00108$:
                           2499 ;	../../shared/src/ph_ctrl.c:162: else  reg_SEL_EDGE_DLY_LANE_1_0 = 3;
   305F 90 02 24           2500 	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_137
   3062 E0                 2501 	movx	a,@dptr
   3063 44 0C              2502 	orl	a,#0x0c
   3065 F0                 2503 	movx	@dptr,a
                           2504 ;	../../shared/src/ph_ctrl.c:163: break;
                           2505 ;	../../shared/src/ph_ctrl.c:164: case 3: 
   3066 80 6F              2506 	sjmp	00127$
   3068                    2507 00116$:
                           2508 ;	../../shared/src/ph_ctrl.c:165: eom_ph_os = tag_CDR_HALF_UI_PI_CODE + (int8_t)ph_dat + (int8_t)ph_esm;
   3068 90 67 94           2509 	mov	dptr,#_half_ui_code
   306B E0                 2510 	movx	a,@dptr
   306C FC                 2511 	mov	r4,a
   306D EA                 2512 	mov	a,r2
   306E 2C                 2513 	add	a,r4
   306F FA                 2514 	mov	r2,a
   3070 E5 18              2515 	mov	a,_bp
   3072 24 FD              2516 	add	a,#0xfd
   3074 F8                 2517 	mov	r0,a
   3075 E6                 2518 	mov	a,@r0
   3076 2A                 2519 	add	a,r2
   3077 FB                 2520 	mov	r3,a
                           2521 ;	../../shared/src/ph_ctrl.c:166: if( eom_ph_os < sel_sdge_dly_tb3[0])  reg_SEL_EDGE_DLY_LANE_1_0 = 0;
   3078 90 32 23           2522 	mov	dptr,#_sel_sdge_dly_tb3
   307B E4                 2523 	clr	a
   307C 93                 2524 	movc	a,@a+dptr
   307D FA                 2525 	mov	r2,a
   307E C3                 2526 	clr	c
   307F EB                 2527 	mov	a,r3
   3080 64 80              2528 	xrl	a,#0x80
   3082 8A F0              2529 	mov	b,r2
   3084 63 F0 80           2530 	xrl	b,#0x80
   3087 95 F0              2531 	subb	a,b
   3089 50 09              2532 	jnc	00124$
   308B 90 02 24           2533 	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_137
   308E E0                 2534 	movx	a,@dptr
   308F 54 F3              2535 	anl	a,#0xf3
   3091 F0                 2536 	movx	@dptr,a
   3092 80 43              2537 	sjmp	00127$
   3094                    2538 00124$:
                           2539 ;	../../shared/src/ph_ctrl.c:167: else if(eom_ph_os < sel_sdge_dly_tb3[1])  reg_SEL_EDGE_DLY_LANE_1_0 = 1;
   3094 90 32 24           2540 	mov	dptr,#(_sel_sdge_dly_tb3 + 0x0001)
   3097 E4                 2541 	clr	a
   3098 93                 2542 	movc	a,@a+dptr
   3099 FA                 2543 	mov	r2,a
   309A C3                 2544 	clr	c
   309B EB                 2545 	mov	a,r3
   309C 64 80              2546 	xrl	a,#0x80
   309E 8A F0              2547 	mov	b,r2
   30A0 63 F0 80           2548 	xrl	b,#0x80
   30A3 95 F0              2549 	subb	a,b
   30A5 50 0B              2550 	jnc	00121$
   30A7 90 02 24           2551 	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_137
   30AA E0                 2552 	movx	a,@dptr
   30AB 54 F3              2553 	anl	a,#0xf3
   30AD 44 04              2554 	orl	a,#0x04
   30AF F0                 2555 	movx	@dptr,a
   30B0 80 25              2556 	sjmp	00127$
   30B2                    2557 00121$:
                           2558 ;	../../shared/src/ph_ctrl.c:168: else if(eom_ph_os < sel_sdge_dly_tb3[2])  reg_SEL_EDGE_DLY_LANE_1_0 = 2;
   30B2 90 32 25           2559 	mov	dptr,#(_sel_sdge_dly_tb3 + 0x0002)
   30B5 E4                 2560 	clr	a
   30B6 93                 2561 	movc	a,@a+dptr
   30B7 FA                 2562 	mov	r2,a
   30B8 C3                 2563 	clr	c
   30B9 EB                 2564 	mov	a,r3
   30BA 64 80              2565 	xrl	a,#0x80
   30BC 8A F0              2566 	mov	b,r2
   30BE 63 F0 80           2567 	xrl	b,#0x80
   30C1 95 F0              2568 	subb	a,b
   30C3 50 0B              2569 	jnc	00118$
   30C5 90 02 24           2570 	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_137
   30C8 E0                 2571 	movx	a,@dptr
   30C9 54 F3              2572 	anl	a,#0xf3
   30CB 44 08              2573 	orl	a,#0x08
   30CD F0                 2574 	movx	@dptr,a
   30CE 80 07              2575 	sjmp	00127$
   30D0                    2576 00118$:
                           2577 ;	../../shared/src/ph_ctrl.c:169: else  reg_SEL_EDGE_DLY_LANE_1_0 = 3;
   30D0 90 02 24           2578 	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_137
   30D3 E0                 2579 	movx	a,@dptr
   30D4 44 0C              2580 	orl	a,#0x0c
   30D6 F0                 2581 	movx	@dptr,a
                           2582 ;	../../shared/src/ph_ctrl.c:171: }
   30D7                    2583 00127$:
   30D7 D0 18              2584 	pop	_bp
   30D9 22                 2585 	ret
                           2586 ;------------------------------------------------------------
                           ...
                           2596 ;	-----------------------------------------
   30DA                    2597 _cdr_phase_update:
   30DA C0 18              2598 	push	_bp
   30DC 85 81 18           2599 	mov	_bp,sp
   30DF 05 81              2600 	inc	sp
   30E1 05 81              2601 	inc	sp
   30E3 AA 82              2602 	mov	r2,dpl
                           2603 ;	../../shared/src/ph_ctrl.c:191: ph_os_tmp = (int8_t)reg_ALIGN90_REF_LANE_5_0;
   30E5 90 00 38           2604 	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_14
   30E8 E0                 2605 	movx	a,@dptr
   30E9 03                 2606 	rr	a
   30EA 03                 2607 	rr	a
   30EB 54 3F              2608 	anl	a,#0x3f
   30ED FB                 2609 	mov	r3,a
                           2610 ;	../../shared/src/ph_ctrl.c:192: new_phase_os = clamp( new_phase_os, tag_CDR_PHASE_MAX, tag_CDR_PHASE_MIN);
   30EE C0 03              2611 	push	ar3
   30F0 74 0C              2612 	mov	a,#0x0C
   30F2 C0 E0              2613 	push	acc
   30F4 74 3A              2614 	mov	a,#0x3A
   30F6 C0 E0              2615 	push	acc
   30F8 8A 82              2616 	mov	dpl,r2
   30FA 78 64              2617 	mov	r0,#_clamp
   30FC 79 C0              2618 	mov	r1,#(_clamp >> 8)
   30FE 7A 02              2619 	mov	r2,#(_clamp >> 16)
   3100 12 00 B3           2620 	lcall	__sdcc_banked_call
   3103 AA 82              2621 	mov	r2,dpl
   3105 15 81              2622 	dec	sp
   3107 15 81              2623 	dec	sp
   3109 D0 03              2624 	pop	ar3
                           2625 ;	../../shared/src/ph_ctrl.c:199: while( ph_os_tmp != new_phase_os ) 
   310B                    2626 00107$:
   310B EB                 2627 	mov	a,r3
   310C B5 02 03           2628 	cjne	a,ar2,00116$
   310F 02 31 90           2629 	ljmp	00110$
   3112                    2630 00116$:
                           2631 ;	../../shared/src/ph_ctrl.c:201: if(ph_os_tmp < (new_phase_os - tag_CDR_OS_PH_JMP_STEP))
   3112 EA                 2632 	mov	a,r2
   3113 FC                 2633 	mov	r4,a
   3114 33                 2634 	rlc	a
   3115 95 E0              2635 	subb	a,acc
   3117 FD                 2636 	mov	r5,a
   3118 EC                 2637 	mov	a,r4
   3119 24 FE              2638 	add	a,#0xfe
   311B FE                 2639 	mov	r6,a
   311C ED                 2640 	mov	a,r5
   311D 34 FF              2641 	addc	a,#0xff
   311F FF                 2642 	mov	r7,a
   3120 A8 18              2643 	mov	r0,_bp
   3122 08                 2644 	inc	r0
   3123 A6 03              2645 	mov	@r0,ar3
   3125 EB                 2646 	mov	a,r3
   3126 33                 2647 	rlc	a
   3127 95 E0              2648 	subb	a,acc
   3129 08                 2649 	inc	r0
   312A F6                 2650 	mov	@r0,a
   312B A8 18              2651 	mov	r0,_bp
   312D 08                 2652 	inc	r0
   312E C3                 2653 	clr	c
   312F E6                 2654 	mov	a,@r0
   3130 9E                 2655 	subb	a,r6
   3131 08                 2656 	inc	r0
   3132 E6                 2657 	mov	a,@r0
   3133 64 80              2658 	xrl	a,#0x80
   3135 8F F0              2659 	mov	b,r7
   3137 63 F0 80           2660 	xrl	b,#0x80
   313A 95 F0              2661 	subb	a,b
   313C 50 04              2662 	jnc	00105$
                           2663 ;	../../shared/src/ph_ctrl.c:202: ph_os_tmp += tag_CDR_OS_PH_JMP_STEP;
   313E 0B                 2664 	inc	r3
   313F 0B                 2665 	inc	r3
   3140 80 20              2666 	sjmp	00106$
   3142                    2667 00105$:
                           2668 ;	../../shared/src/ph_ctrl.c:203: else if(ph_os_tmp > (new_phase_os + tag_CDR_OS_PH_JMP_STEP))
   3142 74 02              2669 	mov	a,#0x02
   3144 2C                 2670 	add	a,r4
   3145 FC                 2671 	mov	r4,a
   3146 E4                 2672 	clr	a
   3147 3D                 2673 	addc	a,r5
   3148 FD                 2674 	mov	r5,a
   3149 A8 18              2675 	mov	r0,_bp
   314B 08                 2676 	inc	r0
   314C C3                 2677 	clr	c
   314D EC                 2678 	mov	a,r4
   314E 96                 2679 	subb	a,@r0
   314F ED                 2680 	mov	a,r5
   3150 64 80              2681 	xrl	a,#0x80
   3152 08                 2682 	inc	r0
   3153 86 F0              2683 	mov	b,@r0
   3155 63 F0 80           2684 	xrl	b,#0x80
   3158 95 F0              2685 	subb	a,b
   315A 50 04              2686 	jnc	00102$
                           2687 ;	../../shared/src/ph_ctrl.c:204: ph_os_tmp -= tag_CDR_OS_PH_JMP_STEP;
   315C 1B                 2688 	dec	r3
   315D 1B                 2689 	dec	r3
   315E 80 02              2690 	sjmp	00106$
   3160                    2691 00102$:
                           2692 ;	../../shared/src/ph_ctrl.c:206: ph_os_tmp = new_phase_os;
   3160 8A 03              2693 	mov	ar3,r2
   3162                    2694 00106$:
                           2695 ;	../../shared/src/ph_ctrl.c:208: reg_ALIGN90_REF_LANE_5_0 = (uint8_t)ph_os_tmp;		
   3162 90 00 38           2696 	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_14
   3165 EB                 2697 	mov	a,r3
   3166 2B                 2698 	add	a,r3
   3167 25 E0              2699 	add	a,acc
   3169 54 FC              2700 	anl	a,#0xfc
   316B F5 F0              2701 	mov	b,a
   316D E0                 2702 	movx	a,@dptr
   316E 54 03              2703 	anl	a,#0x03
   3170 45 F0              2704 	orl	a,b
   3172 F0                 2705 	movx	@dptr,a
                           2706 ;	../../shared/src/ph_ctrl.c:209: short_delay();//delay01(10);
   3173 C0 02              2707 	push	ar2
   3175 C0 03              2708 	push	ar3
   3177 78 05              2709 	mov	r0,#_short_delay
   3179 79 C0              2710 	mov	r1,#(_short_delay >> 8)
   317B 7A 02              2711 	mov	r2,#(_short_delay >> 16)
   317D 12 00 B3           2712 	lcall	__sdcc_banked_call
                           2713 ;	../../shared/src/ph_ctrl.c:216: find_align90_lock(); 
   3180 78 39              2714 	mov	r0,#_find_align90_lock
   3182 79 80              2715 	mov	r1,#(_find_align90_lock >> 8)
   3184 7A 01              2716 	mov	r2,#(_find_align90_lock >> 16)
   3186 12 00 B3           2717 	lcall	__sdcc_banked_call
   3189 D0 03              2718 	pop	ar3
   318B D0 02              2719 	pop	ar2
   318D 02 31 0B           2720 	ljmp	00107$
   3190                    2721 00110$:
   3190 85 18 81           2722 	mov	sp,_bp
   3193 D0 18              2723 	pop	_bp
   3195 22                 2724 	ret
                           2725 ;------------------------------------------------------------
                           ...
                           2734 ;	-----------------------------------------
   3196                    2735 _move_eom_phase:
   3196 AA 82              2736 	mov	r2,dpl
   3198 AB 83              2737 	mov	r3,dph
                           2738 ;	../../shared/src/ph_ctrl.c:238: while( update_ph != 0 ) 
   319A                    2739 00107$:
   319A EA                 2740 	mov	a,r2
   319B 4B                 2741 	orl	a,r3
   319C 70 01              2742 	jnz	00116$
   319E 22                 2743 	ret
   319F                    2744 00116$:
                           2745 ;	../../shared/src/ph_ctrl.c:240: ph_os_tmp = (int16_t)reg_EOM_DPHER_LANE_6_0;
   319F 90 00 28           2746 	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_10
   31A2 E0                 2747 	movx	a,@dptr
   31A3 03                 2748 	rr	a
   31A4 54 7F              2749 	anl	a,#0x7f
   31A6 FC                 2750 	mov	r4,a
   31A7 7D 00              2751 	mov	r5,#0x00
                           2752 ;	../../shared/src/ph_ctrl.c:242: if(update_ph >= tag_CDR_OS_PH_JMP_STEP) {
   31A9 C3                 2753 	clr	c
   31AA EA                 2754 	mov	a,r2
   31AB 94 02              2755 	subb	a,#0x02
   31AD EB                 2756 	mov	a,r3
   31AE 64 80              2757 	xrl	a,#0x80
   31B0 94 80              2758 	subb	a,#0x80
   31B2 40 11              2759 	jc	00105$
                           2760 ;	../../shared/src/ph_ctrl.c:243: update_ph -= tag_CDR_OS_PH_JMP_STEP;
   31B4 EA                 2761 	mov	a,r2
   31B5 24 FE              2762 	add	a,#0xfe
   31B7 FA                 2763 	mov	r2,a
   31B8 EB                 2764 	mov	a,r3
   31B9 34 FF              2765 	addc	a,#0xff
   31BB FB                 2766 	mov	r3,a
                           2767 ;	../../shared/src/ph_ctrl.c:244: ph_os_tmp += tag_CDR_OS_PH_JMP_STEP;
   31BC 74 02              2768 	mov	a,#0x02
   31BE 2C                 2769 	add	a,r4
   31BF FC                 2770 	mov	r4,a
   31C0 E4                 2771 	clr	a
   31C1 3D                 2772 	addc	a,r5
   31C2 FD                 2773 	mov	r5,a
   31C3 80 2A              2774 	sjmp	00106$
   31C5                    2775 00105$:
                           2776 ;	../../shared/src/ph_ctrl.c:246: else if(update_ph <= -tag_CDR_OS_PH_JMP_STEP) {
   31C5 C3                 2777 	clr	c
   31C6 74 FE              2778 	mov	a,#0xFE
   31C8 9A                 2779 	subb	a,r2
   31C9 74 7F              2780 	mov	a,#(0xFF ^ 0x80)
   31CB 8B F0              2781 	mov	b,r3
   31CD 63 F0 80           2782 	xrl	b,#0x80
   31D0 95 F0              2783 	subb	a,b
   31D2 40 11              2784 	jc	00102$
                           2785 ;	../../shared/src/ph_ctrl.c:247: update_ph += tag_CDR_OS_PH_JMP_STEP;
   31D4 74 02              2786 	mov	a,#0x02
   31D6 2A                 2787 	add	a,r2
   31D7 FA                 2788 	mov	r2,a
   31D8 E4                 2789 	clr	a
   31D9 3B                 2790 	addc	a,r3
   31DA FB                 2791 	mov	r3,a
                           2792 ;	../../shared/src/ph_ctrl.c:248: ph_os_tmp -= tag_CDR_OS_PH_JMP_STEP;	
   31DB EC                 2793 	mov	a,r4
   31DC 24 FE              2794 	add	a,#0xfe
   31DE FC                 2795 	mov	r4,a
   31DF ED                 2796 	mov	a,r5
   31E0 34 FF              2797 	addc	a,#0xff
   31E2 FD                 2798 	mov	r5,a
   31E3 80 0A              2799 	sjmp	00106$
   31E5                    2800 00102$:
                           2801 ;	../../shared/src/ph_ctrl.c:251: ph_os_tmp += update_ph;	
   31E5 EA                 2802 	mov	a,r2
   31E6 2C                 2803 	add	a,r4
   31E7 FC                 2804 	mov	r4,a
   31E8 EB                 2805 	mov	a,r3
   31E9 3D                 2806 	addc	a,r5
   31EA FD                 2807 	mov	r5,a
                           2808 ;	../../shared/src/ph_ctrl.c:252: update_ph = 0;
   31EB 7A 00              2809 	mov	r2,#0x00
   31ED 7B 00              2810 	mov	r3,#0x00
   31EF                    2811 00106$:
                           2812 ;	../../shared/src/ph_ctrl.c:255: reg_EOM_DPHER_LANE_6_0 = (uint8_t)ph_os_tmp & 0x7f;		
   31EF 53 04 7F           2813 	anl	ar4,#0x7F
   31F2 90 00 28           2814 	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_10
   31F5 EC                 2815 	mov	a,r4
   31F6 2C                 2816 	add	a,r4
   31F7 54 FE              2817 	anl	a,#0xfe
   31F9 F5 F0              2818 	mov	b,a
   31FB E0                 2819 	movx	a,@dptr
   31FC 54 01              2820 	anl	a,#0x01
   31FE 45 F0              2821 	orl	a,b
   3200 F0                 2822 	movx	@dptr,a
                           2823 ;	../../shared/src/ph_ctrl.c:256: short_delay(); //delay01(10);
   3201 C0 02              2824 	push	ar2
   3203 C0 03              2825 	push	ar3
   3205 78 05              2826 	mov	r0,#_short_delay
   3207 79 C0              2827 	mov	r1,#(_short_delay >> 8)
   3209 7A 02              2828 	mov	r2,#(_short_delay >> 16)
   320B 12 00 B3           2829 	lcall	__sdcc_banked_call
   320E D0 03              2830 	pop	ar3
   3210 D0 02              2831 	pop	ar2
                           2832 ;	../../shared/src/ph_ctrl.c:257: reg_EOM_DPHERCK_LANE = 1;
                           2833 ;	../../shared/src/ph_ctrl.c:258: reg_EOM_DPHERCK_LANE = 0;
   3212 90 00 28           2834 	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_10
   3215 E0                 2835 	movx	a,@dptr
   3216 44 01              2836 	orl	a,#0x01
   3218 F0                 2837 	movx	@dptr,a
   3219 E0                 2838 	movx	a,@dptr
   321A 54 FE              2839 	anl	a,#0xfe
   321C F0                 2840 	movx	@dptr,a
   321D 02 31 9A           2841 	ljmp	00107$
                           2842 	.area CSEG    (CODE)
                           2843 	.area CSEG    (CODE)
   3220                    2844 _sel_sdge_dly_tb2:
   3220 FD                 2845 	.db #0xFD	; -3
   3221 11                 2846 	.db #0x11	;  17
   3222 1E                 2847 	.db #0x1E	;  30
   3223                    2848 _sel_sdge_dly_tb3:
   3223 19                 2849 	.db #0x19	;  25
   3224 2D                 2850 	.db #0x2D	;  45
   3225 3A                 2851 	.db #0x3A	;  58
