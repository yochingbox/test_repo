...
; This file was generated Thu Oct 18 21:21:39 2018
;--------------------------------------------------------
	.module dcc_cal
...
;--------------------------------------------------------
	.globl _rxdcc_clk_toggle
	.globl _txdcc_clk_toggle
	.globl _TF2
	.globl _TI
	.globl _RI
	.globl _EX12
	...
	.globl _txdcc_cal
	.globl _txdcc_pdiv_cal
	.globl _rxdcc_dll_cal
	.globl _rxdcc_data_cal
	.globl _rxdcc_eom_cal
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area BANK2   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'txdcc_clk_toggle'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/dcc_cal.c:41: void txdcc_clk_toggle( void ) BANKING_CTRL {
;	-----------------------------------------
;	 function txdcc_clk_toggle
;	-----------------------------------------
_txdcc_clk_toggle:
	ar2 = 0x02
	ar3 = 0x03
	...
	ar0 = 0x00
	ar1 = 0x01
;	../../shared/src/dcc_cal.c:43: TXDCC_CLK = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_136
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:44: delay01(30);
	mov	dptr,#0x001E
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/dcc_cal.c:45: TXDCC_CLK = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_136
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:46: delay01(30);
	mov	dptr,#0x001E
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
...
;------------------------------------------------------------
;Allocation info for local variables in function 'txdcc_cal'
;------------------------------------------------------------
;dcc_cnt                   Allocated to stack - offset 1
;latched_TXDCC_DN          Allocated to registers r2 
;int_dn                    Allocated to stack - offset 2
;int_up                    Allocated to stack - offset 3
;dir                       Allocated to stack - offset 4
;time_out_cnt              Allocated to registers r5 
;in_cont_mode              Allocated to stack - offset 5
;in_power_on               Allocated to stack - offset 6
;ext_en                    Allocated to registers r4 
;saved_speed_div           Allocated to registers r4 
;hg_set                    Allocated to stack - offset 7
;sloc0                     Allocated to stack - offset 12
;------------------------------------------------------------
;	../../shared/src/dcc_cal.c:52: void txdcc_cal(void) BANKING_CTRL {
;	-----------------------------------------
;	 function txdcc_cal
;	-----------------------------------------
_txdcc_cal:
	...
	add	a,#0x07
	mov	sp,a
;	../../shared/src/dcc_cal.c:65: PHY_STATUS = ST_TXDCC_CAL;    
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x15
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:67: lnx_TXDCC_CAL_DONE_LANE = 0; 
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:69: in_cont_mode = 0;
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:70: in_power_on = 0;
	mov	a,_bp
	add	a,#0x06
	mov	r0,a
;	../../shared/src/dcc_cal.c:71: saved_speed_div = 0;
;	../../shared/src/dcc_cal.c:72: time_out_cnt = 0;
;	../../shared/src/dcc_cal.c:73: dir = 0;  
	clr	a
	mov	@r0,a
	mov	r4,a
	mov	r5,a
	...
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:74: hg_set = 0;
	mov	a,_bp
	add	a,#0x07
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:77: if (lnx_CAL_DONE_LANE == 0) {                        //power-on calibration
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jnb	acc.0,00187$
	ljmp	00112$
00187$:
;	../../shared/src/dcc_cal.c:78: ext_en = cmx_EXT_FORCE_CAL_DONE || cmx_TXDCC_CAL_EXT_EN;
	mov	dptr,#(_CONTROL_CONFIG0 + 0x0002)
	movx	a,@dptr
	jb	acc.1,00159$
	mov	dptr,#(_CONTROL_CONFIG1 + 0x0003)
	movx	a,@dptr
	jb	acc.1,00159$
	mov	r2,#0x00
	sjmp	00160$
...
00160$:
	push	ar4
	mov	ar4,r2
;	../../shared/src/dcc_cal.c:79: if (ext_en){                                     //use ext value for power-on, bypass calibration
	mov	a,r4
	pop	ar4
	jz	00102$
;	../../shared/src/dcc_cal.c:80: dcc_cnt = lnx_cal_txdcc[PWR][tx_pll_rate];
	push	ar4
	mov	c,_tx_pll_rate
	clr	a
	rlc	a
	add	a,#_lnx_cal_txdcc
	mov	dpl,a
	clr	a
	addc	a,#(_lnx_cal_txdcc >> 8)
	mov	dph,a
	movx	a,@dptr
	mov	r4,a
	mov	r0,_bp
	inc	r0
	mov	@r0,ar4
;	../../shared/src/dcc_cal.c:81: TXDCC_HG = lnx_cal_txdcc_hg[tx_pll_rate];      //load the HG setting. 
	mov	c,_tx_pll_rate
	clr	a
	rlc	a
	add	a,#_lnx_cal_txdcc_hg
	mov	dpl,a
	clr	a
	addc	a,#(_lnx_cal_txdcc_hg >> 8)
	mov	dph,a
	movx	a,@dptr
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_148
	rrc	a
	movx	a,@dptr
	mov	acc.7,c
	movx	@dptr,a
	...
	sjmp	00103$
00102$:
;	../../shared/src/dcc_cal.c:84: lnx_TXDCC_CAL_PASS_LANE = 0; 
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xef
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:85: TXDCCCAL_EN = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_147
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:86: TRXDCCIN_SEL = 4;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_17
	movx	a,@dptr
	anl	a,#0x1f
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:87: TXDCC_HG = 0; 
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_148
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:88: saved_speed_div = TX_SPEED_DIV;               //E2C clock DCC cal need to force SPEED_DIV to 0
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_150
	movx	a,@dptr
	anl	a,#0x07
	mov	r2,a
	mov	r4,a
;	../../shared/src/dcc_cal.c:89: in_power_on = 1;                              //flag the power-on calibration, so restore speed_div at the end
	mov	a,_bp
	add	a,#0x06
	mov	r0,a
	mov	@r0,#0x01
;	../../shared/src/dcc_cal.c:90: TX_SPEED_DIV = 0;                             //Before force SPEED_DIV to 0, save the original one 
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_150
	movx	a,@dptr
	anl	a,#0xf8
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:91: dcc_cnt = 0x20;
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x20
00103$:
;	../../shared/src/dcc_cal.c:93: TXDCC_EN = 1;                                  //enable TXDCC_EN during power-on, never deassert
	push	ar4
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_146
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:94: txdcc_step_cnt = TXDCC_CAL_STEP_SIZE;              //for power-on (inc. EXT_EN), reset fraction code to middle
	mov	dptr,#(_CON_CAL_STEP_SIZE3 + 0x0003)
	movx	a,@dptr
	mov	dptr,#_txdcc_step_cnt
	movx	@dptr,a
	pop	ar4
	ljmp	00149$
00112$:
;	../../shared/src/dcc_cal.c:96: else if (LOAD_CAL_ON) {                         //not power-on. Speed-change, load result for current rate
	mov	dptr,#_CAL_CTRL3_LANE
	movx	a,@dptr
	jz	00109$
;	../../shared/src/dcc_cal.c:98: dcc_cnt = lnx_cal_txdcc[PWR + cmx_TXDCC_CAL_CONT_CUR_LOAD_EN][tx_pll_rate];  
	push	ar4
	...
	inc	r0
	mov	@r0,ar2
;	../../shared/src/dcc_cal.c:99: txdcc_step_cnt = TXDCC_CAL_STEP_SIZE;             //when speed change, restore the fracition code to middle
	mov	dptr,#(_CON_CAL_STEP_SIZE3 + 0x0003)
	movx	a,@dptr
	mov	dptr,#_txdcc_step_cnt
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:100: TXDCC_HG = lnx_cal_txdcc_hg[tx_pll_rate];      //load the HG setting. 
	mov	c,_tx_pll_rate
	clr	a
	rlc	a
	add	a,#_lnx_cal_txdcc_hg
	...
	sjmp	00149$
00109$:
;	../../shared/src/dcc_cal.c:102: else if (cmx_TXDCC_CAL_CONT_EN && TX_SPEED_DIV == 0) {  //not power-on. Continious mode, only performed when SPEED_DIV = 0
	...
	anl	a,#0x07
	jnz	00105$
;	../../shared/src/dcc_cal.c:103: TXDCCCAL_EN = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_147
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:104: TRXDCCIN_SEL = 4;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_17
	movx	a,@dptr
	anl	a,#0x1f
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:105: dcc_cnt = lnx_cal_txdcc[CONT][tx_pll_rate];    //always load cont result
	mov	c,_tx_pll_rate
	clr	a
	rlc	a
	add	a,#(_lnx_cal_txdcc + 0x0002)
	mov	dpl,a
	clr	a
	addc	a,#((_lnx_cal_txdcc + 0x0002) >> 8)
	mov	dph,a
	movx	a,@dptr
	mov	r2,a
	mov	r0,_bp
	inc	r0
	mov	@r0,ar2
;	../../shared/src/dcc_cal.c:106: in_cont_mode = 1;                              //when continious mode, use fraction code
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
	mov	@r0,#0x01
	sjmp	00149$
00105$:
;	../../shared/src/dcc_cal.c:109: lnx_TXDCC_CAL_DONE_LANE = 1;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:110: return;
	ljmp	00156$
;	../../shared/src/dcc_cal.c:114: do {
00149$:
;	../../shared/src/dcc_cal.c:115: TXDCC_CNT = dcc_cnt;
	mov	r0,_bp
	inc	r0
	mov	ar2,@r0
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_147
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:116: txdcc_clk_toggle();
	push	ar4
	push	ar5
	mov	r0,#_txdcc_clk_toggle
	mov	r1,#(_txdcc_clk_toggle >> 8)
	mov	r2,#(_txdcc_clk_toggle >> 16)
	lcall	__sdcc_banked_call
	pop	ar5
	pop	ar4
;	../../shared/src/dcc_cal.c:118: time_out_cnt ++;
	inc	r5
;	../../shared/src/dcc_cal.c:119: if( TXDCCCAL_EN == 0 ) break;                                       //either LOAD, or EXT_EN in power-on
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_147
	movx	a,@dptr
	jb	acc.7,00194$
	ljmp	00151$
00194$:
;	../../shared/src/dcc_cal.c:120: if( lnx_CAL_DONE_LANE == 1 && time_out_cnt > 1) break;                   //continious mode, has ran 1 round
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0x01
	mov	r2,a
...
00198$:
00117$:
;	../../shared/src/dcc_cal.c:121: if( lnx_CAL_DONE_LANE == 0 && is_toggle_pat( dir, time_out_cnt - 1 ))  { lnx_TXDCC_CAL_PASS_LANE = 1;  break; }     //power-on, toggled
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00120$
	mov	a,r5
	...
	mov	r0,a
	mov	dpl,@r0
	mov	r0,#_is_toggle_pat
	mov	r1,#(_is_toggle_pat >> 8)
	mov	r2,#(_is_toggle_pat >> 16)
	lcall	__sdcc_banked_call
	dec	sp
	pop	ar5
	pop	ar4
	...
	ljmp	00151$
00120$:
;	../../shared/src/dcc_cal.c:122: if( lnx_CAL_DONE_LANE == 0 && time_out_cnt >= TXDCC_LOOP_MAX && cmx_TXDCC_CAL_TIMEOUT_DIS == 0) break;     //power-on, reached maximum rounds
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00123$
	cjne	r5,#0x40,00202$
00202$:
	jc	00123$
	mov	dptr,#_CAL_TIME_OUT_AND_DIS
	movx	a,@dptr
	jb	acc.4,00204$
	ljmp	00151$
00204$:
00123$:
;	../../shared/src/dcc_cal.c:124: latched_TXDCC_DN = TXDCC_DN;
	mov	dptr,#_TX_CALIBRATION_LANE
	movx	a,@dptr
	anl	a,#0x01
	mov	r2,a
;	../../shared/src/dcc_cal.c:125: int_up = 0;
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:126: int_dn = 0; 
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:128: if (in_cont_mode) { //continious calibration
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
	mov	a,@r0
	jz	00138$
;	../../shared/src/dcc_cal.c:129: if (latched_TXDCC_DN) {txdcc_step_cnt--;}
	mov	a,r2
	jz	00127$
	mov	dptr,#_txdcc_step_cnt
	movx	a,@dptr
	...
	sjmp	00128$
00127$:
;	../../shared/src/dcc_cal.c:130: else                  {txdcc_step_cnt++;}
	mov	dptr,#_txdcc_step_cnt
	movx	a,@dptr
	add	a,#0x01
	movx	@dptr,a
00128$:
;	../../shared/src/dcc_cal.c:132: if( txdcc_step_cnt == 0) {
	mov	dptr,#_txdcc_step_cnt
	movx	a,@dptr
	mov	r2,a
	jnz	00132$
;	../../shared/src/dcc_cal.c:133: int_up = 0;
	push	ar4
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:134: int_dn = 1; 
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x01
;	../../shared/src/dcc_cal.c:135: txdcc_step_cnt = TXDCC_CAL_STEP_SIZE;  //after up/dn triggered, reset fraction code to middle
	mov	dptr,#(_CON_CAL_STEP_SIZE3 + 0x0003)
	movx	a,@dptr
	mov	dptr,#_txdcc_step_cnt
	movx	@dptr,a
	...
	sjmp	00139$
00132$:
;	../../shared/src/dcc_cal.c:137: else if(txdcc_step_cnt>=(TXDCC_CAL_STEP_SIZE<<1)) {
	push	ar4
	mov	dptr,#(_CON_CAL_STEP_SIZE3 + 0x0003)
	movx	a,@dptr
	mov	r4,a
	...
	pop	ar4
	jc	00139$
;	../../shared/src/dcc_cal.c:138: int_up = 1;
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	@r0,#0x01
;	../../shared/src/dcc_cal.c:139: int_dn = 0; 
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:140: txdcc_step_cnt = TXDCC_CAL_STEP_SIZE;  //after up/dn triggered, reset fraction code to middle
	mov	dptr,#(_CON_CAL_STEP_SIZE3 + 0x0003)
	movx	a,@dptr
	mov	r3,a
	mov	dptr,#_txdcc_step_cnt
	...
	sjmp	00139$
00138$:
;	../../shared/src/dcc_cal.c:144: if (latched_TXDCC_DN) {int_up = 0; int_dn = 1;}
	mov	a,r2
	jz	00135$
	mov	a,_bp
	add	a,#0x03
	...
	sjmp	00139$
00135$:
;	../../shared/src/dcc_cal.c:145: else                  {int_up = 1; int_dn = 0;}
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	@r0,#0x01
	...
	mov	@r0,#0x00
00139$:
;	../../shared/src/dcc_cal.c:148: if (int_dn == 1) {
	mov	r0,_bp
	inc	r0
	inc	r0
	cjne	@r0,#0x01,00143$
;	../../shared/src/dcc_cal.c:149: dcc_cnt = sign_abs_dn(dcc_cnt);
	mov	r0,_bp
	inc	r0
	mov	dpl,@r0
	push	ar4
	push	ar5
	mov	r0,#_sign_abs_dn
	mov	r1,#(_sign_abs_dn >> 8)
	mov	r2,#(_sign_abs_dn >> 16)
	lcall	__sdcc_banked_call
	mov	r2,dpl
	pop	ar5
	pop	ar4
	...
	sjmp	00144$
00143$:
;	../../shared/src/dcc_cal.c:151: else if (int_up == 1) {
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	cjne	@r0,#0x01,00144$
;	../../shared/src/dcc_cal.c:152: dir |= 1;
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,@r0
	orl	a,#0x01
	mov	@r0,a
;	../../shared/src/dcc_cal.c:153: dcc_cnt = sign_abs_up(dcc_cnt);      
	mov	r0,_bp
	inc	r0
	mov	dpl,@r0
	push	ar4
	push	ar5
	mov	r0,#_sign_abs_up
	mov	r1,#(_sign_abs_up >> 8)
	mov	r2,#(_sign_abs_up >> 16)
	lcall	__sdcc_banked_call
	mov	r2,dpl
	pop	ar5
	pop	ar4
	...
	mov	@r0,ar2
00144$:
;	../../shared/src/dcc_cal.c:155: dir<<=1;
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,@r0
	add	a,acc
	mov	@r0,a
;	../../shared/src/dcc_cal.c:156: dir = dir & 0x3f;
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,@r0
	anl	a,#0x3F
	mov	@r0,a
;	../../shared/src/dcc_cal.c:160: if (in_power_on && ((dcc_cnt & 0x1f) == 24) && (hg_set == 0)){
	mov	a,_bp
	add	a,#0x06
	mov	r0,a
	mov	a,@r0
...
00216$:
	...
	ljmp	00149$
00217$:
;	../../shared/src/dcc_cal.c:161: reg_TXDCC_HG_LANE = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_148
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:162: hg_set = 1;
	mov	a,_bp
	add	a,#0x07
	mov	r0,a
	mov	@r0,#0x01
;	../../shared/src/dcc_cal.c:163: dcc_cnt = 0x20;
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x20
;	../../shared/src/dcc_cal.c:164: time_out_cnt = 0;
	mov	r5,#0x00
;	../../shared/src/dcc_cal.c:167: } while (1); 
	ljmp	00149$
00151$:
;	../../shared/src/dcc_cal.c:170: if (in_power_on == 1)
	mov	a,_bp
	add	a,#0x06
	mov	r0,a
	cjne	@r0,#0x01,00153$
;	../../shared/src/dcc_cal.c:171: TX_SPEED_DIV = saved_speed_div;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_150
	mov	a,r4
	anl	a,#0x07
	mov	b,a
	...
	movx	@dptr,a
00153$:
;	../../shared/src/dcc_cal.c:175: if (lnx_CAL_DONE_LANE == 0) {                        //if power-on calibration (including ext_en)
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00155$
;	../../shared/src/dcc_cal.c:176: lnx_cal_txdcc[PWR][tx_pll_rate] = dcc_cnt;      //save to power-on result
	mov	c,_tx_pll_rate
	clr	a
	rlc	a
	add	a,#_lnx_cal_txdcc
	...
	mov	a,@r0
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:177: lnx_cal_txdcc_hg[tx_pll_rate] = (reg_TXDCC_HG_LANE & 0x01) | 0x00;       //save the HG setting for current rate, will be loaded by continious mode
	mov	c,_tx_pll_rate
	clr	a
	rlc	a
	add	a,#_lnx_cal_txdcc_hg
	...
	movx	@dptr,a
00155$:
;	../../shared/src/dcc_cal.c:179: lnx_cal_txdcc[CONT][tx_pll_rate] = dcc_cnt;     //no matter power-on or LOAD or continious, need to save to [CONT]
	mov	c,_tx_pll_rate
	clr	a
	rlc	a
	mov	r2,a
	...
	mov	a,@r0
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:181: TXDCCCAL_EN = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_147
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:182: lnx_TXDCC_CAL_DONE_LANE = 1;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
00156$:
	...
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'txdcc_pdiv_cal'
;------------------------------------------------------------
;dcc_cnt                   Allocated to registers r6 
;latched_TXDCC_DN          Allocated to registers r7 
;int_dn                    Allocated to stack - offset 1
;int_up                    Allocated to stack - offset 2
;dir                       Allocated to stack - offset 3
;time_out_cnt              Allocated to stack - offset 4
;in_cont_mode              Allocated to stack - offset 5
;in_power_on               Allocated to stack - offset 6
;ext_en                    Allocated to registers r6 
;saved_speed_div           Allocated to registers r4 
;sloc0                     Allocated to stack - offset 11
;------------------------------------------------------------
;	../../shared/src/dcc_cal.c:189: void txdcc_pdiv_cal(void) BANKING_CTRL {
;	-----------------------------------------
;	 function txdcc_pdiv_cal
;	-----------------------------------------
_txdcc_pdiv_cal:
	push	_bp
	mov	a,sp
	...
	add	a,#0x06
	mov	sp,a
;	../../shared/src/dcc_cal.c:201: PHY_STATUS = ST_TXDCC_PDIV_CAL;    //xbi
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x39
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:203: lnx_TXDCC_PDIV_CAL_DONE_LANE = 0; 
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:206: if (TX_SPEED_DIV == 0) {
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_150
	movx	a,@dptr
	anl	a,#0x07
	jnz	00102$
;	../../shared/src/dcc_cal.c:207: lnx_TXDCC_PDIV_CAL_DONE_LANE = 1;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:208: return;
	ljmp	00159$
00102$:
;	../../shared/src/dcc_cal.c:211: in_cont_mode = 0;
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:212: in_power_on = 0;
	mov	a,_bp
	add	a,#0x06
	mov	r0,a
;	../../shared/src/dcc_cal.c:213: saved_speed_div = 0;
;	../../shared/src/dcc_cal.c:215: dir = 0;  
	clr	a
	mov	@r0,a
	mov	r4,a
	mov	a,_bp
	...
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:218: if (lnx_CAL_DONE_LANE == 0) {     //power-on calibration, only performed when speed_div != 0
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00113$
;	../../shared/src/dcc_cal.c:219: ext_en = cmx_EXT_FORCE_CAL_DONE || cmx_TXDCC_PDIV_CAL_EXT_EN;
	mov	dptr,#(_CONTROL_CONFIG0 + 0x0002)
	movx	a,@dptr
	jb	acc.1,00162$
	mov	dptr,#(_CONTROL_CONFIG1 + 0x0003)
...
00162$:
	mov	r6,#0x01
00163$:
;	../../shared/src/dcc_cal.c:220: if (ext_en)                                     //use ext value for power-on (stored into PWR), bypass calibration
	mov	a,r6
	jz	00104$
;	../../shared/src/dcc_cal.c:221: dcc_cnt = lnx_cal_txdcc_pdiv[PWR][tx_pll_rate];
	mov	c,_tx_pll_rate
	clr	a
	rlc	a
	...
	sjmp	00105$
00104$:
;	../../shared/src/dcc_cal.c:223: lnx_TXDCC_PDIV_CAL_PASS_LANE = 0; 
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:224: TXDCCCAL_PDIV_EN = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_151
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:225: TXDCCCAL_EN = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_147
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:226: TRXDCCIN_SEL = 4;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_17
	movx	a,@dptr
	anl	a,#0x1f
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:227: saved_speed_div = TX_SPEED_DIV;               //PDIV clock DCC cal need to force SPEED_DIV to 1
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_150
	movx	a,@dptr
	anl	a,#0x07
	mov	r7,a
	mov	r4,a
;	../../shared/src/dcc_cal.c:228: in_power_on = 1;
	mov	a,_bp
	add	a,#0x06
	mov	r0,a
	mov	@r0,#0x01
;	../../shared/src/dcc_cal.c:229: TX_SPEED_DIV = 1;                             //Before force SPEED_DIV to 1, save the original one 
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_150
	movx	a,@dptr
	anl	a,#0xf8
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:230: dcc_cnt = 32;
	mov	r6,#0x20
00105$:
;	../../shared/src/dcc_cal.c:232: TXDCC_EN = 1;                                  //enable TXDCC_EN during power-on, never deassert
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_146
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:233: txdcc_pdiv_step_cnt = TXDCC_PDIV_CAL_STEP_SIZE;         //during power-on (inc. EXT_EN), reset fraction code to middle
	...
	sjmp	00186$
00113$:
;	../../shared/src/dcc_cal.c:235: else if (LOAD_CAL_ON) {                         //not power-on. Speed-change, load result for current rate
	mov	dptr,#_CAL_CTRL3_LANE
	movx	a,@dptr
	jz	00110$
;	../../shared/src/dcc_cal.c:237: dcc_cnt = lnx_cal_txdcc_pdiv[PWR + cmx_TXDCC_PDIV_CAL_CONT_CUR_LOAD_EN][tx_pll_rate];  
	push	ar4
	mov	dptr,#(_CONTROL_CONFIG9 + 0x0002)
	movx	a,@dptr
	rl	a
	...
	movx	a,@dptr
	mov	r6,a
;	../../shared/src/dcc_cal.c:238: txdcc_pdiv_step_cnt = TXDCC_PDIV_CAL_STEP_SIZE;             //when speed change, restore the fracition code to middle
	mov	dptr,#(_CON_CAL_STEP_SIZE3 + 0x0002)
	movx	a,@dptr
	mov	r3,a
	mov	dptr,#_txdcc_pdiv_step_cnt
	...
	sjmp	00186$
00110$:
;	../../shared/src/dcc_cal.c:240: else if (cmx_TXDCC_PDIV_CAL_CONT_EN) {               //not power-on. Continious mode.
	mov	dptr,#(_CONTROL_CONFIG2 + 0x0002)
	movx	a,@dptr
	jnb	acc.6,00107$
;	../../shared/src/dcc_cal.c:241: TXDCCCAL_PDIV_EN = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_151
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:242: TXDCCCAL_EN = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_147
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:243: TRXDCCIN_SEL = 4;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_17
	movx	a,@dptr
	anl	a,#0x1f
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:244: dcc_cnt = lnx_cal_txdcc_pdiv[CONT][tx_pll_rate];    //always load cont result
	mov	c,_tx_pll_rate
	clr	a
	rlc	a
	add	a,#(_lnx_cal_txdcc_pdiv + 0x0002)
	mov	dpl,a
	clr	a
	addc	a,#((_lnx_cal_txdcc_pdiv + 0x0002) >> 8)
	mov	dph,a
	movx	a,@dptr
	mov	r3,a
	mov	r6,a
;	../../shared/src/dcc_cal.c:245: in_cont_mode = 1;                              //when continious mode, use fraction code
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
	mov	@r0,#0x01
	sjmp	00186$
00107$:
;	../../shared/src/dcc_cal.c:248: lnx_TXDCC_PDIV_CAL_DONE_LANE = 1;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:249: return;
	ljmp	00159$
;	../../shared/src/dcc_cal.c:253: do {
00186$:
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	@r0,#0x00
00152$:
;	../../shared/src/dcc_cal.c:254: TXDCC_PDIV_CNT = dcc_cnt;
	mov	ar7,r6
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_151
	mov	a,r7
	add	a,r7
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:255: txdcc_clk_toggle();
	push	ar4
	push	ar6
	mov	r0,#_txdcc_clk_toggle
	mov	r1,#(_txdcc_clk_toggle >> 8)
	...
	pop	ar6
	pop	ar4
;	../../shared/src/dcc_cal.c:257: time_out_cnt ++;
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	inc	@r0
;	../../shared/src/dcc_cal.c:258: if( TXDCCCAL_PDIV_EN == 0 ) break;                                       //either LOAD, or EXT_EN in power-on
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_151
	movx	a,@dptr
	jb	acc.1,00196$
	ljmp	00154$
00196$:
;	../../shared/src/dcc_cal.c:259: if( lnx_CAL_DONE_LANE == 1 && time_out_cnt > 1) break;                   //continious mode, has ran 1 round
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0x01
	mov	r7,a
...
00199$:
00118$:
;	../../shared/src/dcc_cal.c:260: if( lnx_CAL_DONE_LANE == 0 && is_toggle_pat( dir, time_out_cnt - 1 ))  { lnx_TXDCC_PDIV_CAL_PASS_LANE = 1;  break; }     //power-on, toggled
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00121$
	mov	a,_bp
	...
	ljmp	00154$
00121$:
;	../../shared/src/dcc_cal.c:261: if( lnx_CAL_DONE_LANE == 0 && time_out_cnt >= TXDCC_PDIV_LOOP_MAX && cmx_TXDCC_PDIV_CAL_TIMEOUT_DIS == 0) break;     //power-on, reached maximum rounds
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00124$
	mov	a,_bp
...
00205$:
00124$:
;	../../shared/src/dcc_cal.c:263: latched_TXDCC_DN = TXDCC_DN;
	mov	dptr,#_TX_CALIBRATION_LANE
	movx	a,@dptr
	anl	a,#0x01
	mov	r7,a
;	../../shared/src/dcc_cal.c:264: int_up = 0;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:265: int_dn = 0; 
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:267: if (in_cont_mode) { //continious calibration
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
	mov	a,@r0
	jz	00139$
;	../../shared/src/dcc_cal.c:268: if (latched_TXDCC_DN) {txdcc_pdiv_step_cnt--;}
	mov	a,r7
	jz	00128$
	mov	dptr,#_txdcc_pdiv_step_cnt
	movx	a,@dptr
	...
	sjmp	00129$
00128$:
;	../../shared/src/dcc_cal.c:269: else                  {txdcc_pdiv_step_cnt++;}
	mov	dptr,#_txdcc_pdiv_step_cnt
	movx	a,@dptr
	add	a,#0x01
	movx	@dptr,a
00129$:
;	../../shared/src/dcc_cal.c:271: if( txdcc_pdiv_step_cnt == 0) {
	mov	dptr,#_txdcc_pdiv_step_cnt
	movx	a,@dptr
	mov	r3,a
	jnz	00133$
;	../../shared/src/dcc_cal.c:272: int_up = 0;
	push	ar4
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:273: int_dn = 1; 
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x01
;	../../shared/src/dcc_cal.c:274: txdcc_pdiv_step_cnt = TXDCC_CAL_STEP_SIZE;  //after up/dn triggered, reset fraction code to middle
	mov	dptr,#(_CON_CAL_STEP_SIZE3 + 0x0003)
	movx	a,@dptr
	mov	dptr,#_txdcc_pdiv_step_cnt
	movx	@dptr,a
	...
	sjmp	00140$
00133$:
;	../../shared/src/dcc_cal.c:276: else if(txdcc_pdiv_step_cnt>=(TXDCC_CAL_STEP_SIZE<<1)) {
	push	ar4
	mov	dptr,#(_CON_CAL_STEP_SIZE3 + 0x0003)
	movx	a,@dptr
	mov	r4,a
	...
	pop	ar4
	jc	00140$
;	../../shared/src/dcc_cal.c:277: int_up = 1;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x01
;	../../shared/src/dcc_cal.c:278: int_dn = 0; 
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:279: txdcc_pdiv_step_cnt = TXDCC_CAL_STEP_SIZE;  //after up/dn triggered, reset fraction code to middle
	mov	dptr,#(_CON_CAL_STEP_SIZE3 + 0x0003)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_txdcc_pdiv_step_cnt
	...
	sjmp	00140$
00139$:
;	../../shared/src/dcc_cal.c:283: if (latched_TXDCC_DN) {int_up = 0; int_dn = 1;}
	mov	a,r7
	jz	00136$
	mov	r0,_bp
	inc	r0
	...
	sjmp	00140$
00136$:
;	../../shared/src/dcc_cal.c:284: else                  {int_up = 1; int_dn = 0;}
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x01
	...
	mov	@r0,#0x00
00140$:
;	../../shared/src/dcc_cal.c:287: if (int_dn == 1) {
	mov	r0,_bp
	inc	r0
	cjne	@r0,#0x01,00150$
;	../../shared/src/dcc_cal.c:288: if (dcc_cnt == 0) {dcc_cnt = 0;}
	mov	a,r6
	jnz	00142$
	mov	r6,a
	sjmp	00151$
00142$:
;	../../shared/src/dcc_cal.c:289: else              {dcc_cnt--;}
	dec	r6
	sjmp	00151$
00150$:
;	../../shared/src/dcc_cal.c:291: else if (int_up == 1) {
	mov	r0,_bp
	inc	r0
	inc	r0
	cjne	@r0,#0x01,00151$
;	../../shared/src/dcc_cal.c:292: dir |= 1;
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	a,@r0
	orl	a,#0x01
	mov	@r0,a
;	../../shared/src/dcc_cal.c:293: if (dcc_cnt == 63) {dcc_cnt = 63;}
	cjne	r6,#0x3F,00145$
	mov	r6,#0x3F
	sjmp	00151$
00145$:
;	../../shared/src/dcc_cal.c:294: else               {dcc_cnt++;}
	inc	r6
00151$:
;	../../shared/src/dcc_cal.c:296: dir<<=1;
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	a,@r0
	add	a,acc
	mov	@r0,a
;	../../shared/src/dcc_cal.c:297: dir = dir & 0x3f;
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	a,@r0
	anl	a,#0x3F
	mov	@r0,a
;	../../shared/src/dcc_cal.c:299: } while (1); 
	ljmp	00152$
00154$:
;	../../shared/src/dcc_cal.c:302: if (in_power_on)
	mov	a,_bp
	add	a,#0x06
	mov	r0,a
	mov	a,@r0
	jz	00156$
;	../../shared/src/dcc_cal.c:303: TX_SPEED_DIV = saved_speed_div;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_150
	mov	a,r4
	anl	a,#0x07
	mov	b,a
	...
	movx	@dptr,a
00156$:
;	../../shared/src/dcc_cal.c:306: if (lnx_CAL_DONE_LANE == 0) {                        //if power-on calibration
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00158$
;	../../shared/src/dcc_cal.c:307: lnx_cal_txdcc_pdiv[PWR][tx_pll_rate] = dcc_cnt;      //save to power-on result
	mov	c,_tx_pll_rate
	clr	a
	rlc	a
	mov	r2,a
	...
	movx	@dptr,a
00158$:
;	../../shared/src/dcc_cal.c:309: lnx_cal_txdcc_pdiv[CONT][tx_pll_rate] = dcc_cnt;     //no matter power-on or LOAD or continious, need to save to [CONT]
	mov	c,_tx_pll_rate
	clr	a
	rlc	a
	mov	r2,a
	...
	mov	a,r6
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:311: TXDCCCAL_PDIV_EN = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_151
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:312: TXDCCCAL_EN = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_147
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:313: lnx_TXDCC_PDIV_CAL_DONE_LANE = 1;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
00159$:
	...
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'rxdcc_clk_toggle'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/dcc_cal.c:319: void rxdcc_clk_toggle(void) BANKING_CTRL {
;	-----------------------------------------
;	 function rxdcc_clk_toggle
;	-----------------------------------------
_rxdcc_clk_toggle:
;	../../shared/src/dcc_cal.c:320: delay01(5);
	mov	dptr,#0x0005
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/dcc_cal.c:321: RXDCC_DAC_SYNC_CLK = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_17
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:322: delay01(5);
	mov	dptr,#0x0005
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/dcc_cal.c:323: RXDCC_DCLKMP_CLK = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_136
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:324: delay01(25);
	mov	dptr,#0x0019
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/dcc_cal.c:325: RXDCC_DAC_SYNC_CLK = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_17
	movx	a,@dptr
	anl	a,#0xef
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:326: delay01(5);
	mov	dptr,#0x0005
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/dcc_cal.c:327: RXDCC_DCLKMP_CLK = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_136
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:328: delay01(25);
	mov	dptr,#0x0019
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	...
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'rxdcc_dll_cal'
;------------------------------------------------------------
;dcc_cnt                   Allocated to registers r7 
;latched_RXDCC_DN          Allocated to registers r2 
;int_dn                    Allocated to stack - offset 1
;int_up                    Allocated to stack - offset 2
;dir                       Allocated to stack - offset 3
;time_out_cnt              Allocated to stack - offset 4
;in_cont_mode              Allocated to stack - offset 5
;in_power_on               Allocated to stack - offset 6
;ext_en                    Allocated to registers r7 
;hg_set                    Allocated to registers r6 
;------------------------------------------------------------
;	../../shared/src/dcc_cal.c:331: void rxdcc_dll_cal(void) BANKING_CTRL {
;	-----------------------------------------
;	 function rxdcc_dll_cal
;	-----------------------------------------
_rxdcc_dll_cal:
	push	_bp
	mov	a,sp
	...
	add	a,#0x06
	mov	sp,a
;	../../shared/src/dcc_cal.c:343: PHY_STATUS = ST_RXDCC_DLL_CAL;    
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x08
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:345: lnx_RXDCC_DLL_CAL_DONE_LANE = 0; 
	mov	dptr,#_CAL_CTRL1_LANE
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:347: in_cont_mode = 0;
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:348: in_power_on = 0;
	mov	a,_bp
	add	a,#0x06
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:349: time_out_cnt = 0;
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:350: dir = 0;  
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:351: hg_set = 0;
	mov	r6,#0x00
;	../../shared/src/dcc_cal.c:354: if (lnx_CAL_DONE_LANE == 0) {                        //power-on calibration
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jnb	acc.0,00182$
	ljmp	00111$
00182$:
;	../../shared/src/dcc_cal.c:355: ext_en = cmx_EXT_FORCE_CAL_DONE || cmx_RXDCC_DLL_CAL_EXT_EN;
	mov	dptr,#(_CONTROL_CONFIG0 + 0x0002)
	movx	a,@dptr
	jb	acc.1,00156$
...
00156$:
	mov	r7,#0x01
00157$:
;	../../shared/src/dcc_cal.c:356: if (ext_en) {                                     //use ext value for power-on, bypass calibration
	mov	a,r7
	jz	00102$
;	../../shared/src/dcc_cal.c:357: dcc_cnt = lnx_cal_rxdcc_dll[PWR][rx_pll_rate];
	push	ar6
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	add	a,#_lnx_cal_rxdcc_dll
	mov	dpl,a
	clr	a
	addc	a,#(_lnx_cal_rxdcc_dll >> 8)
	mov	dph,a
	movx	a,@dptr
	mov	r7,a
;	../../shared/src/dcc_cal.c:358: RXDCC_HG_DLLCLK = lnx_cal_rxdcc_dll_hg[rx_pll_rate];          //load the HG setting. 
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	add	a,#_lnx_cal_rxdcc_dll_hg
	mov	dpl,a
	clr	a
	addc	a,#(_lnx_cal_rxdcc_dll_hg >> 8)
	mov	dph,a
	movx	a,@dptr
	...
	sjmp	00103$
00102$:
;	../../shared/src/dcc_cal.c:361: lnx_RXDCC_DLL_CAL_PASS_LANE = 0; 
	mov	dptr,#_CAL_CTRL2_LANE
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:362: RXDCC_CAL_EN = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_16
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:363: TRXDCCIN_SEL = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_17
	movx	a,@dptr
	anl	a,#0x1f
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:364: RXDCC_HG_DLLCLK = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_135
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:365: dcc_cnt = 0x20;
	mov	r7,#0x20
;	../../shared/src/dcc_cal.c:366: in_power_on = 1;
	mov	a,_bp
	add	a,#0x06
	mov	r0,a
	mov	@r0,#0x01
00103$:
;	../../shared/src/dcc_cal.c:368: RXDCC_EN_DLLCLK = 1;                           //enable RXDCC_EN during power-on, never deassert
	push	ar6
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_134
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:369: rxdcc_dll_step_cnt = RXDCC_DLL_CAL_STEP_SIZE;      //for power-on (inc. EXT_EN), reset fraction code to middle
	mov	dptr,#(_CON_CAL_STEP_SIZE5 + 0x0003)
	movx	a,@dptr
	mov	dptr,#_rxdcc_dll_step_cnt
	movx	@dptr,a
	pop	ar6
	ljmp	00148$
00111$:
;	../../shared/src/dcc_cal.c:371: else if (LOAD_CAL_ON) {                         //not power-on. Speed-change, load result for current rate
	mov	dptr,#_CAL_CTRL3_LANE
	movx	a,@dptr
	jz	00108$
;	../../shared/src/dcc_cal.c:373: dcc_cnt = lnx_cal_rxdcc_dll[PWR + cmx_RXDCC_DLL_CAL_CONT_CUR_LOAD_EN][rx_pll_rate];  
	push	ar6
	mov	dptr,#(_CONTROL_CONFIG9 + 0x0001)
	movx	a,@dptr
	rl	a
	anl	a,#0x01
	add	a,acc
	...
	movx	a,@dptr
	mov	r7,a
;	../../shared/src/dcc_cal.c:374: rxdcc_dll_step_cnt = RXDCC_DLL_CAL_STEP_SIZE;     //when speed change, restore the fracition code to middle
	mov	dptr,#(_CON_CAL_STEP_SIZE5 + 0x0003)
	movx	a,@dptr
	mov	dptr,#_rxdcc_dll_step_cnt
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:375: RXDCC_HG_DLLCLK = lnx_cal_rxdcc_dll_hg[rx_pll_rate];          //load the HG setting. 
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	add	a,#_lnx_cal_rxdcc_dll_hg
	...
	sjmp	00148$
00108$:
;	../../shared/src/dcc_cal.c:377: else if (cmx_RXDCC_DLL_CAL_CONT_EN) {  //not power-on. Continious mode, only performed when SPEED_DIV = 0
	mov	dptr,#(_CONTROL_CONFIG2 + 0x0001)
	movx	a,@dptr
	jnb	acc.7,00105$
;	../../shared/src/dcc_cal.c:378: RXDCC_CAL_EN = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_16
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:379: TRXDCCIN_SEL = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_17
	movx	a,@dptr
	anl	a,#0x1f
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:380: dcc_cnt = lnx_cal_rxdcc_dll[CONT][rx_pll_rate];    //always load cont result
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	add	a,#(_lnx_cal_rxdcc_dll + 0x0002)
	mov	dpl,a
	clr	a
	addc	a,#((_lnx_cal_rxdcc_dll + 0x0002) >> 8)
	mov	dph,a
	movx	a,@dptr
	mov	r2,a
	mov	r7,a
;	../../shared/src/dcc_cal.c:381: in_cont_mode = 1;                                  //when continious mode, use fraction code
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
	mov	@r0,#0x01
	sjmp	00148$
00105$:
;	../../shared/src/dcc_cal.c:384: lnx_RXDCC_DLL_CAL_DONE_LANE = 1;
	mov	dptr,#_CAL_CTRL1_LANE
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:385: return;
	ljmp	00153$
;	../../shared/src/dcc_cal.c:389: do {
00148$:
;	../../shared/src/dcc_cal.c:390: RXDCC_DLLCLK = dcc_cnt;
	mov	ar2,r7
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_135
	mov	a,r2
	add	a,r2
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:391: rxdcc_clk_toggle();
	push	ar6
	push	ar7
	mov	r0,#_rxdcc_clk_toggle
	mov	r1,#(_rxdcc_clk_toggle >> 8)
	mov	r2,#(_rxdcc_clk_toggle >> 16)
	lcall	__sdcc_banked_call
	pop	ar7
	pop	ar6
;	../../shared/src/dcc_cal.c:393: time_out_cnt ++;
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	inc	@r0
;	../../shared/src/dcc_cal.c:394: if( RXDCC_CAL_EN == 0 ) break;                                      //either LOAD, or EXT_EN in power-on
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_16
	movx	a,@dptr
	jb	acc.0,00188$
	ljmp	00150$
00188$:
;	../../shared/src/dcc_cal.c:395: if( lnx_CAL_DONE_LANE == 1 && time_out_cnt > 1) break;                   //continious mode, has ran 1 round
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0x01
	mov	r2,a
...
00191$:
00116$:
;	../../shared/src/dcc_cal.c:396: if( lnx_CAL_DONE_LANE == 0 && is_toggle_pat( dir, time_out_cnt - 1 ))  { lnx_RXDCC_DLL_CAL_PASS_LANE = 1;  break; }     //power-on, toggled
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00119$
	mov	a,_bp
	...
	ljmp	00150$
00119$:
;	../../shared/src/dcc_cal.c:397: if( lnx_CAL_DONE_LANE == 0 && time_out_cnt >= RXDCC_DLL_LOOP_MAX && cmx_RXDCC_DLL_CAL_TIMEOUT_DIS == 0) break; //power-on, reached maximum rounds
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00122$
	mov	a,_bp
...
00197$:
00122$:
;	../../shared/src/dcc_cal.c:399: latched_RXDCC_DN = TXDCC_DN;   //RXDCC shares TXDCC up/dn
	mov	dptr,#_TX_CALIBRATION_LANE
	movx	a,@dptr
	anl	a,#0x01
	mov	r2,a
;	../../shared/src/dcc_cal.c:400: int_up = 0;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:401: int_dn = 0; 
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:403: if (in_cont_mode) { //continious calibration
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
	mov	a,@r0
	jz	00137$
;	../../shared/src/dcc_cal.c:404: if (latched_RXDCC_DN) {rxdcc_dll_step_cnt--;}
	mov	a,r2
	jz	00126$
	mov	dptr,#_rxdcc_dll_step_cnt
	movx	a,@dptr
	...
	sjmp	00127$
00126$:
;	../../shared/src/dcc_cal.c:405: else                  {rxdcc_dll_step_cnt++;}
	mov	dptr,#_rxdcc_dll_step_cnt
	movx	a,@dptr
	add	a,#0x01
	movx	@dptr,a
00127$:
;	../../shared/src/dcc_cal.c:407: if( rxdcc_dll_step_cnt == 0) {
	mov	dptr,#_rxdcc_dll_step_cnt
	movx	a,@dptr
	mov	r3,a
	jnz	00131$
;	../../shared/src/dcc_cal.c:408: int_up = 0;
	push	ar6
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:409: int_dn = 1; 
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x01
;	../../shared/src/dcc_cal.c:410: rxdcc_dll_step_cnt = RXDCC_DLL_CAL_STEP_SIZE;  //after up/dn triggered, reset fraction code to middle
	mov	dptr,#(_CON_CAL_STEP_SIZE5 + 0x0003)
	movx	a,@dptr
	mov	dptr,#_rxdcc_dll_step_cnt
	movx	@dptr,a
	...
	sjmp	00138$
00131$:
;	../../shared/src/dcc_cal.c:412: else if(rxdcc_dll_step_cnt>=(RXDCC_DLL_CAL_STEP_SIZE<<1)) {
	push	ar6
	mov	dptr,#(_CON_CAL_STEP_SIZE5 + 0x0003)
	movx	a,@dptr
	mov	r6,a
	...
	pop	ar6
	jc	00138$
;	../../shared/src/dcc_cal.c:413: int_up = 1;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x01
;	../../shared/src/dcc_cal.c:414: int_dn = 0; 
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:415: rxdcc_dll_step_cnt = RXDCC_DLL_CAL_STEP_SIZE;  //after up/dn triggered, reset fraction code to middle
	mov	dptr,#(_CON_CAL_STEP_SIZE5 + 0x0003)
	movx	a,@dptr
	mov	r3,a
	mov	dptr,#_rxdcc_dll_step_cnt
	...
	sjmp	00138$
00137$:
;	../../shared/src/dcc_cal.c:419: if (latched_RXDCC_DN) {int_up = 0; int_dn = 1;}
	mov	a,r2
	jz	00134$
	mov	r0,_bp
	inc	r0
	...
	sjmp	00138$
00134$:
;	../../shared/src/dcc_cal.c:420: else                  {int_up = 1; int_dn = 0;}
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x01
	...
	mov	@r0,#0x00
00138$:
;	../../shared/src/dcc_cal.c:423: if (int_dn == 1) {
	mov	r0,_bp
	inc	r0
	cjne	@r0,#0x01,00142$
;	../../shared/src/dcc_cal.c:424: dcc_cnt = sign_abs_dn(dcc_cnt);
	mov	dpl,r7
	push	ar6
	mov	r0,#_sign_abs_dn
	mov	r1,#(_sign_abs_dn >> 8)
	...
	sjmp	00143$
00142$:
;	../../shared/src/dcc_cal.c:426: else if (int_up == 1) {
	mov	r0,_bp
	inc	r0
	inc	r0
	cjne	@r0,#0x01,00143$
;	../../shared/src/dcc_cal.c:427: dir |= 1;
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	a,@r0
	orl	a,#0x01
	mov	@r0,a
;	../../shared/src/dcc_cal.c:428: dcc_cnt = sign_abs_up(dcc_cnt);      
	mov	dpl,r7
	push	ar6
	mov	r0,#_sign_abs_up
	mov	r1,#(_sign_abs_up >> 8)
	...
	mov	ar7,r2
00143$:
;	../../shared/src/dcc_cal.c:430: dir<<=1;
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	a,@r0
	add	a,acc
	mov	@r0,a
;	../../shared/src/dcc_cal.c:431: dir = dir & 0x3f;
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	a,@r0
	anl	a,#0x3F
	mov	@r0,a
;	../../shared/src/dcc_cal.c:436: if (in_power_on && ((dcc_cnt & 0x1f) == 24) && (hg_set == 0)){
	mov	a,_bp
	add	a,#0x06
	mov	r0,a
	mov	a,@r0
...
00209$:
	...
	ljmp	00148$
00210$:
;	../../shared/src/dcc_cal.c:437: reg_RXDCC_HG_DLLCLK_LANE = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_135
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:438: hg_set = 1;
	mov	r6,#0x01
;	../../shared/src/dcc_cal.c:439: dcc_cnt = 0x20;
	mov	r7,#0x20
;	../../shared/src/dcc_cal.c:440: time_out_cnt = 0;
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:443: } while (1); 
	ljmp	00148$
00150$:
;	../../shared/src/dcc_cal.c:446: if (lnx_CAL_DONE_LANE == 0) {                            //if power-on calibration
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00152$
;	../../shared/src/dcc_cal.c:447: lnx_cal_rxdcc_dll[PWR][rx_pll_rate] = dcc_cnt;       //save to power-on result
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	add	a,#_lnx_cal_rxdcc_dll
	...
	mov	a,r7
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:448: lnx_cal_rxdcc_dll_hg[rx_pll_rate] = (reg_RXDCC_HG_DLLCLK_LANE & 0x01) | 0x00; //save the HG setting for current rate, will be loaded by continious mode
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	add	a,#_lnx_cal_rxdcc_dll_hg
	...
	movx	@dptr,a
00152$:
;	../../shared/src/dcc_cal.c:450: lnx_cal_rxdcc_dll[CONT][rx_pll_rate] = dcc_cnt;     //no matter power-on or LOAD or continious, need to save to [CONT]
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	mov	r2,a
	...
	mov	a,r7
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:452: RXDCC_CAL_EN = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_16
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:453: lnx_RXDCC_DLL_CAL_DONE_LANE = 1;
	mov	dptr,#_CAL_CTRL1_LANE
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
00153$:
	...
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'rxdcc_data_cal'
;------------------------------------------------------------
;dcc_cnt                   Allocated to registers r7 
;latched_RXDCC_DN          Allocated to registers r2 
;int_dn                    Allocated to stack - offset 1
;int_up                    Allocated to stack - offset 2
;dir                       Allocated to stack - offset 3
;gen                       Allocated to stack - offset 4
;time_out_cnt              Allocated to registers r4 
;in_power_on               Allocated to registers r3 
;in_cont_mode              Allocated to stack - offset 5
;ext_en                    Allocated to registers r7 
;hg_set                    Allocated to stack - offset 6
;------------------------------------------------------------
;	../../shared/src/dcc_cal.c:459: void rxdcc_data_cal(void) BANKING_CTRL {
;	-----------------------------------------
;	 function rxdcc_data_cal
;	-----------------------------------------
_rxdcc_data_cal:
	push	_bp
	mov	a,sp
	...
	add	a,#0x06
	mov	sp,a
;	../../shared/src/dcc_cal.c:471: PHY_STATUS = ST_RXDCC_DATA_CAL;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x0E
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:473: lnx_RXDCC_DATA_CAL_DONE_LANE = 0;
	mov	dptr,#_CAL_CTRL1_LANE
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:475: in_cont_mode = 0;
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
;	../../shared/src/dcc_cal.c:476: in_power_on = 0;
;	../../shared/src/dcc_cal.c:477: time_out_cnt = 0;
;	../../shared/src/dcc_cal.c:478: dir = 0;
	clr	a
	mov	@r0,a
	mov	r3,a
	mov	r4,a
	...
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:479: gen = gen_rx;
	mov	dptr,#_gen_rx
	movx	a,@dptr
	mov	r6,a
	mov	a,_bp
	...
	mov	r0,a
	mov	@r0,ar6
;	../../shared/src/dcc_cal.c:480: if(phy_mode == SERDES) gen = 0;
	...
	mov	@r0,#0x00
00102$:
;	../../shared/src/dcc_cal.c:483: if (lnx_CAL_DONE_LANE == 0) {                        //power-on calibration
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jnb	acc.0,00193$
	ljmp	00114$
00193$:
;	../../shared/src/dcc_cal.c:484: ext_en = cmx_EXT_FORCE_CAL_DONE || cmx_RXDCC_DATA_CAL_EXT_EN;
	mov	dptr,#(_CONTROL_CONFIG0 + 0x0002)
	movx	a,@dptr
	jb	acc.1,00162$
	mov	dptr,#(_CONTROL_CONFIG1 + 0x0002)
	movx	a,@dptr
	jb	acc.0,00162$
	mov	r7,#0x00
	sjmp	00163$
00162$:
	mov	r7,#0x01
00163$:
;	../../shared/src/dcc_cal.c:485: if (ext_en) {                                     //use ext value for power-on, bypass calibration
	mov	a,r7
	jz	00104$
;	../../shared/src/dcc_cal.c:486: dcc_cnt = lnx_cal_rxdcc_data[PWR][gen];
	push	ar3
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,@r0
	add	a,#_lnx_cal_rxdcc_data
	mov	dpl,a
	clr	a
	addc	a,#(_lnx_cal_rxdcc_data >> 8)
	mov	dph,a
	movx	a,@dptr
	mov	r7,a
;	../../shared/src/dcc_cal.c:487: RXDCC_HG_DATACLK = lnx_cal_rxdcc_data_hg[gen];          //load the HG setting.
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,@r0
	add	a,#_lnx_cal_rxdcc_data_hg
	mov	dpl,a
	clr	a
	addc	a,#(_lnx_cal_rxdcc_data_hg >> 8)
	mov	dph,a
	movx	a,@dptr
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_136
	rrc	a
	...
	sjmp	00105$
00104$:
;	../../shared/src/dcc_cal.c:490: lnx_RXDCC_DATA_CAL_PASS_LANE = 0;
	mov	dptr,#_CAL_CTRL2_LANE
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:491: RXDCC_CAL_EN = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_16
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:492: TRXDCCIN_SEL = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_17
	movx	a,@dptr
	anl	a,#0x1f
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:493: RXDCC_HG_DATACLK = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_136
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:494: dcc_cnt = 0x20;
	mov	r7,#0x20
;	../../shared/src/dcc_cal.c:495: in_power_on = 1;
	mov	r3,#0x01
00105$:
;	../../shared/src/dcc_cal.c:497: RXDCC_EN_DATACLK = 1;                           //enable RXDCC_EN during power-on, never deassert
	push	ar3
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_135
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:498: rxdcc_data_step_cnt = RXDCC_DATA_CAL_STEP_SIZE;      //for power-on (inc. EXT_EN), reset fraction code to middle
	mov	dptr,#(_CON_CAL_STEP_SIZE2 + 0x0001)
	movx	a,@dptr
	mov	dptr,#_rxdcc_data_step_cnt
	movx	@dptr,a
	pop	ar3
	ljmp	00115$
00114$:
;	../../shared/src/dcc_cal.c:500: else if (LOAD_CAL_ON) {                         //not power-on. Speed-change, load result for current rate
	mov	dptr,#_CAL_CTRL3_LANE
	movx	a,@dptr
	jz	00111$
;	../../shared/src/dcc_cal.c:502: dcc_cnt = lnx_cal_rxdcc_data[PWR + cmx_RXDCC_DATA_CAL_CONT_CUR_LOAD_EN][gen];
	push	ar3
	mov	dptr,#(_CONTROL_CONFIG9 + 0x0003)
	movx	a,@dptr
	rr	a
	anl	a,#0x01
	mov	b,#0x05
	...
	movx	a,@dptr
	mov	r7,a
;	../../shared/src/dcc_cal.c:503: rxdcc_data_step_cnt = RXDCC_DATA_CAL_STEP_SIZE;     //when speed change, restore the fracition code to middle
	mov	dptr,#(_CON_CAL_STEP_SIZE2 + 0x0001)
	movx	a,@dptr
	mov	dptr,#_rxdcc_data_step_cnt
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:504: RXDCC_HG_DATACLK = lnx_cal_rxdcc_data_hg[gen];          //load the HG setting.
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,@r0
	...
	sjmp	00115$
00111$:
;	../../shared/src/dcc_cal.c:506: else if (cmx_RXDCC_DATA_CAL_CONT_EN && RX_SPEED_DIV < 4 ) {  //not power-on. Continious mode, only performed when SPEED_DIV = 0
	mov	dptr,#(_CONTROL_CONFIG2 + 0x0003)
	movx	a,@dptr
	jnb	acc.1,00107$
	...
	subb	a,#0x84
	jnc	00107$
;	../../shared/src/dcc_cal.c:507: RXDCC_CAL_EN = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_16
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:508: TRXDCCIN_SEL = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_17
	movx	a,@dptr
	anl	a,#0x1f
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:509: dcc_cnt = lnx_cal_rxdcc_data[CONT][gen];    //always load cont result
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,@r0
	add	a,#(_lnx_cal_rxdcc_data + 0x0005)
	mov	dpl,a
	clr	a
	addc	a,#((_lnx_cal_rxdcc_data + 0x0005) >> 8)
	mov	dph,a
	movx	a,@dptr
	mov	r7,a
;	../../shared/src/dcc_cal.c:510: RXDCC_HG_DATACLK = lnx_cal_rxdcc_data_hg[gen];          //load the HG setting.
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,@r0
	...
	mov	acc.1,c
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:511: in_cont_mode = 1;                                  //when continious mode, use fraction code
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
	mov	@r0,#0x01
	sjmp	00115$
00107$:
;	../../shared/src/dcc_cal.c:514: lnx_RXDCC_DATA_CAL_DONE_LANE = 1;
	mov	dptr,#_CAL_CTRL1_LANE
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:515: return;
	ljmp	00159$
00115$:
;	../../shared/src/dcc_cal.c:518: hg_set = RXDCC_HG_DATACLK;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_136
	movx	a,@dptr
	rr	a
	anl	a,#0x01
	...
	mov	r0,a
	mov	@r0,ar2
;	../../shared/src/dcc_cal.c:520: do {
00154$:
;	../../shared/src/dcc_cal.c:521: RXDCC_DATACLK = dcc_cnt;
	mov	ar2,r7
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_136
	mov	a,r2
	add	a,r2
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:522: rxdcc_clk_toggle();
	push	ar3
	push	ar4
	push	ar7
	mov	r0,#_rxdcc_clk_toggle
	...
	pop	ar4
	pop	ar3
;	../../shared/src/dcc_cal.c:524: time_out_cnt ++;
	inc	r4
;	../../shared/src/dcc_cal.c:525: if( RXDCC_CAL_EN == 0 ) break;                                      //either LOAD, or EXT_EN in power-on
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_16
	movx	a,@dptr
	jb	acc.0,00200$
	ljmp	00156$
00200$:
;	../../shared/src/dcc_cal.c:526: if( lnx_CAL_DONE_LANE == 0 && RX_SPEED_DIV > 3 ) break;                  //power-on, but SPEED_DIV = 1xx, skip and keep using init code (0x20)
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00119$
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_138
...
00202$:
00119$:
;	../../shared/src/dcc_cal.c:527: if( lnx_CAL_DONE_LANE == 1 && time_out_cnt > 1) break;                   //continious mode, has ran 1 round
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0x01
	mov	r2,a
...
00206$:
00122$:
;	../../shared/src/dcc_cal.c:528: if( lnx_CAL_DONE_LANE == 0 && is_toggle_pat( dir, time_out_cnt - 1 ))  { lnx_RXDCC_DATA_CAL_PASS_LANE = 1;  break; }     //power-on, toggled
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00125$
	mov	a,r4
	...
	ljmp	00156$
00125$:
;	../../shared/src/dcc_cal.c:529: if( lnx_CAL_DONE_LANE == 0 && time_out_cnt >= RXDCC_DATA_LOOP_MAX && cmx_RXDCC_DATA_CAL_TIMEOUT_DIS == 0) break; //power-on, reached maximum rounds
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00128$
	cjne	r4,#0x40,00210$
...
00212$:
00128$:
;	../../shared/src/dcc_cal.c:531: latched_RXDCC_DN = TXDCC_DN;   //RXDCC shares TXDCC up/dn
	mov	dptr,#_TX_CALIBRATION_LANE
	movx	a,@dptr
	anl	a,#0x01
	mov	r2,a
;	../../shared/src/dcc_cal.c:532: int_up = 0;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:533: int_dn = 0;
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:535: if (in_cont_mode) { //continious calibration
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
	mov	a,@r0
	jz	00143$
;	../../shared/src/dcc_cal.c:536: if (latched_RXDCC_DN) {rxdcc_data_step_cnt--;}
	mov	a,r2
	jz	00132$
	mov	dptr,#_rxdcc_data_step_cnt
	movx	a,@dptr
	...
	sjmp	00133$
00132$:
;	../../shared/src/dcc_cal.c:537: else                  {rxdcc_data_step_cnt++;}
	mov	dptr,#_rxdcc_data_step_cnt
	movx	a,@dptr
	add	a,#0x01
	movx	@dptr,a
00133$:
;	../../shared/src/dcc_cal.c:539: if( rxdcc_data_step_cnt == 0) {
	mov	dptr,#_rxdcc_data_step_cnt
	movx	a,@dptr
	mov	r2,a
	jnz	00137$
;	../../shared/src/dcc_cal.c:540: int_up = 0;
	push	ar3
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:541: int_dn = 1;
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x01
;	../../shared/src/dcc_cal.c:542: rxdcc_data_step_cnt = RXDCC_DATA_CAL_STEP_SIZE;  //after up/dn triggered, reset fraction code to middle
	mov	dptr,#(_CON_CAL_STEP_SIZE2 + 0x0001)
	movx	a,@dptr
	mov	dptr,#_rxdcc_data_step_cnt
	movx	@dptr,a
	...
	sjmp	00144$
00137$:
;	../../shared/src/dcc_cal.c:544: else if(rxdcc_data_step_cnt>=(RXDCC_DATA_CAL_STEP_SIZE<<1)) {
	push	ar3
	mov	dptr,#(_CON_CAL_STEP_SIZE2 + 0x0001)
	movx	a,@dptr
	mov	r3,a
	...
	pop	ar3
	jc	00144$
;	../../shared/src/dcc_cal.c:545: int_up = 1;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x01
;	../../shared/src/dcc_cal.c:546: int_dn = 0;
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:547: rxdcc_data_step_cnt = RXDCC_DATA_CAL_STEP_SIZE;  //after up/dn triggered, reset fraction code to middle
	mov	dptr,#(_CON_CAL_STEP_SIZE2 + 0x0001)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_rxdcc_data_step_cnt
	...
	sjmp	00144$
00143$:
;	../../shared/src/dcc_cal.c:551: if (latched_RXDCC_DN) {int_up = 0; int_dn = 1;}
	mov	a,r2
	jz	00140$
	mov	r0,_bp
	inc	r0
	...
	sjmp	00144$
00140$:
;	../../shared/src/dcc_cal.c:552: else                  {int_up = 1; int_dn = 0;}
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x01
	...
	mov	@r0,#0x00
00144$:
;	../../shared/src/dcc_cal.c:555: if (int_dn == 1) {
	mov	r0,_bp
	inc	r0
	cjne	@r0,#0x01,00148$
;	../../shared/src/dcc_cal.c:556: dcc_cnt = sign_abs_dn(dcc_cnt);
	mov	dpl,r7
	push	ar3
	push	ar4
	mov	r0,#_sign_abs_dn
	...
	sjmp	00149$
00148$:
;	../../shared/src/dcc_cal.c:558: else if (int_up == 1) {
	mov	r0,_bp
	inc	r0
	inc	r0
	cjne	@r0,#0x01,00149$
;	../../shared/src/dcc_cal.c:559: dir |= 1;
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	a,@r0
	orl	a,#0x01
	mov	@r0,a
;	../../shared/src/dcc_cal.c:560: dcc_cnt = sign_abs_up(dcc_cnt);
	mov	dpl,r7
	push	ar3
	push	ar4
	mov	r0,#_sign_abs_up
	...
	mov	ar7,r2
00149$:
;	../../shared/src/dcc_cal.c:562: dir<<=1;
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	a,@r0
	add	a,acc
	mov	@r0,a
;	../../shared/src/dcc_cal.c:563: dir = dir & 0x3f;
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	a,@r0
	anl	a,#0x3F
	mov	@r0,a
;	../../shared/src/dcc_cal.c:568: if (in_power_on && ( ( dcc_cnt & 0x1f ) == 24) && (hg_set == 0)){
	mov	a,r3
	jnz	00222$
	ljmp	00154$
00222$:
...
00224$:
	...
	ljmp	00154$
00225$:
;	../../shared/src/dcc_cal.c:569: RXDCC_HG_DATACLK = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_136
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:570: hg_set = 1;
	mov	a,_bp
	add	a,#0x06
	mov	r0,a
	mov	@r0,#0x01
;	../../shared/src/dcc_cal.c:571: dcc_cnt = 0x20;
	mov	r7,#0x20
;	../../shared/src/dcc_cal.c:572: time_out_cnt = 0;
	mov	r4,#0x00
;	../../shared/src/dcc_cal.c:574: } while (1);
	ljmp	00154$
00156$:
;	../../shared/src/dcc_cal.c:577: if (lnx_CAL_DONE_LANE == 0) {                            //if power-on calibration
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00158$
;	../../shared/src/dcc_cal.c:578: lnx_cal_rxdcc_data[PWR][gen] = dcc_cnt;       //save to power-on result
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,@r0
	...
	mov	a,r7
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:579: lnx_cal_rxdcc_data_hg[gen] = (RXDCC_HG_DATACLK & 0x01) | 0x0; //save the HG setting for current rate, will be loaded by continious mode
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,@r0
	...
	movx	@dptr,a
00158$:
;	../../shared/src/dcc_cal.c:582: lnx_cal_rxdcc_data[CONT][gen] = dcc_cnt;     //no matter power-on or LOAD or continious, need to save to [CONT]
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,@r0
	...
	mov	a,r7
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:584: RXDCC_CAL_EN = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_16
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:585: lnx_RXDCC_DATA_CAL_DONE_LANE = 1;
	mov	dptr,#_CAL_CTRL1_LANE
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
00159$:
	...
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'rxdcc_eom_cal'
;------------------------------------------------------------
;dcc_cnt                   Allocated to registers r3 
;latched_RXDCC_DN          Allocated to registers r2 
;int_dn                    Allocated to stack - offset 1
;int_up                    Allocated to stack - offset 2
;dir                       Allocated to stack - offset 3
;gen                       Allocated to stack - offset 4
;time_out_cnt              Allocated to registers r4 
;in_power_on               Allocated to stack - offset 5
;in_cont_mode              Allocated to stack - offset 6
;ext_en                    Allocated to registers r3 
;saved_eom_clk_en          Allocated to registers r5 
;hg_set                    Allocated to stack - offset 7
;sloc0                     Allocated to stack - offset 13
;------------------------------------------------------------
;	../../shared/src/dcc_cal.c:590: void rxdcc_eom_cal(void) BANKING_CTRL {
;	-----------------------------------------
;	 function rxdcc_eom_cal
;	-----------------------------------------
_rxdcc_eom_cal:
	push	_bp
	mov	a,sp
	...
	add	a,#0x07
	mov	sp,a
;	../../shared/src/dcc_cal.c:603: PHY_STATUS = ST_RXDCC_EOM_CAL;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x11
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:605: lnx_RXDCC_EOM_CAL_DONE_LANE = 0;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:608: in_cont_mode = 0;
	mov	a,_bp
	add	a,#0x06
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:609: in_power_on = 0;
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:610: time_out_cnt = 0;
	mov	r4,#0x00
;	../../shared/src/dcc_cal.c:611: saved_eom_clk_en = 1;
	mov	r5,#0x01
;	../../shared/src/dcc_cal.c:612: dir = 0;
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:614: gen = gen_rx;
	mov	dptr,#_gen_rx
	movx	a,@dptr
	mov	r7,a
	mov	a,_bp
	...
	mov	r0,a
	mov	@r0,ar7
;	../../shared/src/dcc_cal.c:615: if(phy_mode == SERDES) gen = 0;
	mov	dptr,#(_SYSTEM + 0x0002)
	movx	a,@dptr
	anl	a,#0x07
	mov	r3,a
	...
	mov	@r0,#0x00
00102$:
;	../../shared/src/dcc_cal.c:618: if (lnx_CAL_DONE_LANE == 0) {                        //power-on calibration
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jnb	acc.0,00198$
	ljmp	00115$
00198$:
;	../../shared/src/dcc_cal.c:619: ext_en = cmx_EXT_FORCE_CAL_DONE || cmx_RXDCC_EOM_CAL_EXT_EN;
	mov	dptr,#(_CONTROL_CONFIG0 + 0x0002)
	movx	a,@dptr
	jb	acc.1,00165$
	mov	dptr,#(_CONTROL_CONFIG1 + 0x0002)
...
00165$:
	mov	r3,#0x01
00166$:
;	../../shared/src/dcc_cal.c:620: if (ext_en){                                     //use ext value for power-on, bypass calibration
	mov	a,r3
	jz	00104$
;	../../shared/src/dcc_cal.c:621: dcc_cnt = lnx_cal_rxdcc_eom[PWR][gen];
	push	ar5
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,@r0
	add	a,#_lnx_cal_rxdcc_eom
	mov	dpl,a
	clr	a
	addc	a,#(_lnx_cal_rxdcc_eom >> 8)
	mov	dph,a
	movx	a,@dptr
	mov	r3,a
;	../../shared/src/dcc_cal.c:622: RXDCC_HG_EOMCLK = lnx_cal_rxdcc_eom_hg[gen];          //load the HG setting.
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,@r0
	add	a,#_lnx_cal_rxdcc_eom_hg
	mov	dpl,a
	clr	a
	addc	a,#(_lnx_cal_rxdcc_eom_hg >> 8)
	mov	dph,a
	movx	a,@dptr
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_16
	rrc	a
	...
	sjmp	00105$
00104$:
;	../../shared/src/dcc_cal.c:625: lnx_RXDCC_EOM_CAL_PASS_LANE = 0; // clear pass flag for normal power-on cal
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:626: saved_eom_clk_en = EOM_CLK_EN;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_134
	movx	a,@dptr
	rr	a
	rr	a
	...
	mov	r2,a
	mov	r5,a
;	../../shared/src/dcc_cal.c:627: EOM_CLK_EN = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_134
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:628: RXDCC_CAL_EN = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_16
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:629: TRXDCCIN_SEL = 2;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_17
	movx	a,@dptr
	anl	a,#0x1f
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:630: RXDCC_HG_EOMCLK = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_16
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:631: dcc_cnt = 0x20;
	mov	r3,#0x20
;	../../shared/src/dcc_cal.c:632: in_power_on = 1;
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
	mov	@r0,#0x01
00105$:
;	../../shared/src/dcc_cal.c:634: RXDCC_EN_EOMCLK = 1;                           //enable RXDCC_EN during power-on, never deassert
	push	ar5
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_15
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:635: rxdcc_eom_step_cnt = RXDCC_EOM_CAL_STEP_SIZE;      //for power-on (inc. EXT_EN), reset fraction code to middle
	mov	dptr,#_CON_CAL_STEP_SIZE2
	movx	a,@dptr
	mov	dptr,#_rxdcc_eom_step_cnt
	movx	@dptr,a
	pop	ar5
	ljmp	00116$
00115$:
;	../../shared/src/dcc_cal.c:637: else if (LOAD_CAL_ON) {                         //not power-on. Speed-change, load result for current rate
	mov	dptr,#_CAL_CTRL3_LANE
	movx	a,@dptr
	jz	00112$
;	../../shared/src/dcc_cal.c:639: dcc_cnt = lnx_cal_rxdcc_eom[PWR + cmx_RXDCC_EOM_CAL_CONT_CUR_LOAD_EN][gen];
	push	ar5
	mov	dptr,#(_CONTROL_CONFIG9 + 0x0003)
	movx	a,@dptr
	anl	a,#0x01
	...
	movx	a,@dptr
	mov	r3,a
;	../../shared/src/dcc_cal.c:640: rxdcc_eom_step_cnt = RXDCC_EOM_CAL_STEP_SIZE;     //when speed change, restore the fracition code to middle
	mov	dptr,#_CON_CAL_STEP_SIZE2
	movx	a,@dptr
	mov	dptr,#_rxdcc_eom_step_cnt
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:641: RXDCC_HG_EOMCLK = lnx_cal_rxdcc_eom_hg[gen];          //load the HG setting.
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,@r0
	...
	sjmp	00116$
00112$:
;	../../shared/src/dcc_cal.c:643: else if (cmx_RXDCC_EOM_CAL_CONT_EN && EOM_CLK_EN == 1 && RX_SPEED_DIV < 4 ) {  //not power-on. Continious mode, only performed when EOM_CLK_EN == 1 and RX_SPEED_DIV[2]==0
	mov	dptr,#(_CONTROL_CONFIG2 + 0x0003)
	movx	a,@dptr
	jnb	acc.0,00107$
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_134
	...
	subb	a,#0x84
	jnc	00107$
;	../../shared/src/dcc_cal.c:644: RXDCC_CAL_EN = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_16
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:645: TRXDCCIN_SEL = 2; // Fixed from 0 in ROM code function
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_17
	movx	a,@dptr
	anl	a,#0x1f
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:646: dcc_cnt = lnx_cal_rxdcc_eom[CONT][gen];    //always load cont result
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,@r0
	add	a,#(_lnx_cal_rxdcc_eom + 0x0005)
	mov	dpl,a
	clr	a
	addc	a,#((_lnx_cal_rxdcc_eom + 0x0005) >> 8)
	mov	dph,a
	movx	a,@dptr
	mov	r3,a
;	../../shared/src/dcc_cal.c:647: RXDCC_HG_EOMCLK = lnx_cal_rxdcc_eom_hg[gen];    //load the HG setting.
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,@r0
	...
	mov	acc.1,c
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:648: in_cont_mode = 1;                                  //when continious mode, use fraction code
	mov	a,_bp
	add	a,#0x06
	mov	r0,a
	mov	@r0,#0x01
	sjmp	00116$
00107$:
;	../../shared/src/dcc_cal.c:651: lnx_RXDCC_EOM_CAL_DONE_LANE = 1;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:652: return;
	ljmp	00162$
00116$:
;	../../shared/src/dcc_cal.c:655: hg_set = RXDCC_HG_EOMCLK;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_16
	movx	a,@dptr
	rr	a
	anl	a,#0x01
	...
	mov	r0,a
	mov	@r0,ar2
;	../../shared/src/dcc_cal.c:657: do {
00155$:
;	../../shared/src/dcc_cal.c:658: RXDCC_EOMCLK = dcc_cnt;
	push	ar5
	mov	ar5,r3
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_16
	mov	a,r5
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:659: rxdcc_clk_toggle();
	push	ar3
	push	ar4
	push	ar5
	mov	r0,#_rxdcc_clk_toggle
	...
	pop	ar4
	pop	ar3
;	../../shared/src/dcc_cal.c:661: time_out_cnt ++;
	inc	r4
;	../../shared/src/dcc_cal.c:662: if( RXDCC_CAL_EN == 0 ) break;                                      //either LOAD, or EXT_EN in power-on
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_16
	movx	a,@dptr
	pop	ar5
	jb	acc.0,00207$
	ljmp	00157$
00207$:
;	../../shared/src/dcc_cal.c:663: if( lnx_CAL_DONE_LANE == 0 && RX_SPEED_DIV > 3 ) break;                  //power-on, but SPEED_DIV = 1xx, skip and keep using init code (0x20)
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00120$
	push	ar5
...
00209$:
00120$:
;	../../shared/src/dcc_cal.c:664: if( lnx_CAL_DONE_LANE == 1 && time_out_cnt > 1) break;                   //continious mode, has ran 1 round
	push	ar5
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0x01
...
00213$:
00123$:
;	../../shared/src/dcc_cal.c:665: if( lnx_CAL_DONE_LANE == 0 && is_num_toggle_pat( dir, time_out_cnt - 1, 2 ))  { lnx_RXDCC_EOM_CAL_PASS_LANE = 1;  break; }     //power-on, toggled
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00126$
	push	ar5
	...
	mov	r0,a
	mov	dpl,@r0
	mov	r0,#_is_num_toggle_pat
	mov	r1,#(_is_num_toggle_pat >> 8)
	mov	r2,#(_is_num_toggle_pat >> 16)
	lcall	__sdcc_banked_call
	dec	sp
	dec	sp
	pop	ar5
	...
	ljmp	00157$
00126$:
;	../../shared/src/dcc_cal.c:666: if( lnx_CAL_DONE_LANE == 0 && time_out_cnt >= RXDCC_EOM_LOOP_MAX && cmx_RXDCC_EOM_CAL_TIMEOUT_DIS == 0) break; //power-on, reached maximum rounds
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00129$
	cjne	r4,#0x40,00217$
...
00219$:
00129$:
;	../../shared/src/dcc_cal.c:668: latched_RXDCC_DN = TXDCC_DN;   //RXDCC shares TXDCC up/dn
	push	ar5
	mov	dptr,#_TX_CALIBRATION_LANE
	movx	a,@dptr
	anl	a,#0x01
	mov	r2,a
;	../../shared/src/dcc_cal.c:669: int_up = 0;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:670: int_dn = 0;
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:672: if (in_cont_mode) { //continious calibration
	pop	ar5
	mov	a,_bp
	add	a,#0x06
	mov	r0,a
	mov	a,@r0
	jz	00144$
;	../../shared/src/dcc_cal.c:673: if (latched_RXDCC_DN) {rxdcc_eom_step_cnt--;}
	mov	a,r2
	jz	00133$
	mov	dptr,#_rxdcc_eom_step_cnt
	movx	a,@dptr
	...
	sjmp	00134$
00133$:
;	../../shared/src/dcc_cal.c:674: else                  {rxdcc_eom_step_cnt++;}
	mov	dptr,#_rxdcc_eom_step_cnt
	movx	a,@dptr
	add	a,#0x01
	movx	@dptr,a
00134$:
;	../../shared/src/dcc_cal.c:676: if( rxdcc_eom_step_cnt == 0) {
	mov	dptr,#_rxdcc_eom_step_cnt
	movx	a,@dptr
	mov	r6,a
	jnz	00138$
;	../../shared/src/dcc_cal.c:677: int_up = 0;
	push	ar5
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:678: int_dn = 1;
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x01
;	../../shared/src/dcc_cal.c:679: rxdcc_eom_step_cnt = RXDCC_EOM_CAL_STEP_SIZE;  //after up/dn triggered, reset fraction code to middle
	mov	dptr,#_CON_CAL_STEP_SIZE2
	movx	a,@dptr
	mov	dptr,#_rxdcc_eom_step_cnt
	movx	@dptr,a
	...
	sjmp	00145$
00138$:
;	../../shared/src/dcc_cal.c:681: else if(rxdcc_eom_step_cnt>=(RXDCC_EOM_CAL_STEP_SIZE<<1)) {
	push	ar5
	mov	dptr,#_CON_CAL_STEP_SIZE2
	movx	a,@dptr
	mov	r5,a
	...
	pop	ar5
	jc	00145$
;	../../shared/src/dcc_cal.c:682: int_up = 1;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x01
;	../../shared/src/dcc_cal.c:683: int_dn = 0;
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/dcc_cal.c:684: rxdcc_eom_step_cnt = RXDCC_EOM_CAL_STEP_SIZE;  //after up/dn triggered, reset fraction code to middle
	mov	dptr,#_CON_CAL_STEP_SIZE2
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_rxdcc_eom_step_cnt
	...
	sjmp	00145$
00144$:
;	../../shared/src/dcc_cal.c:688: if (latched_RXDCC_DN) {int_up = 0; int_dn = 1;}
	mov	a,r2
	jz	00141$
	mov	r0,_bp
	inc	r0
	...
	sjmp	00145$
00141$:
;	../../shared/src/dcc_cal.c:689: else                  {int_up = 1; int_dn = 0;}
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x01
	...
	mov	@r0,#0x00
00145$:
;	../../shared/src/dcc_cal.c:692: if (int_dn == 1) {
	mov	r0,_bp
	inc	r0
	cjne	@r0,#0x01,00149$
;	../../shared/src/dcc_cal.c:693: dcc_cnt = sign_abs_dn(dcc_cnt);
	mov	dpl,r3
	push	ar4
	push	ar5
	mov	r0,#_sign_abs_dn
	...
	sjmp	00150$
00149$:
;	../../shared/src/dcc_cal.c:695: else if (int_up == 1) {
	mov	r0,_bp
	inc	r0
	inc	r0
	cjne	@r0,#0x01,00150$
;	../../shared/src/dcc_cal.c:696: dir |= 1;
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	a,@r0
	orl	a,#0x01
	mov	@r0,a
;	../../shared/src/dcc_cal.c:697: dcc_cnt = sign_abs_up(dcc_cnt);
	mov	dpl,r3
	push	ar4
	push	ar5
	mov	r0,#_sign_abs_up
	...
	mov	ar3,r2
00150$:
;	../../shared/src/dcc_cal.c:699: dir<<=1;
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	a,@r0
	add	a,acc
	mov	@r0,a
;	../../shared/src/dcc_cal.c:700: dir = dir & 0x3f;
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	a,@r0
	anl	a,#0x3F
	mov	@r0,a
;	../../shared/src/dcc_cal.c:704: if (in_power_on && ( ( dcc_cnt & 0x1f ) == 24) && (hg_set == 0)){
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
	mov	a,@r0
...
00231$:
	...
	ljmp	00155$
00232$:
;	../../shared/src/dcc_cal.c:706: RXDCC_HG_EOMCLK = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_16
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:707: hg_set = 1;
	mov	a,_bp
	add	a,#0x07
	mov	r0,a
	mov	@r0,#0x01
;	../../shared/src/dcc_cal.c:708: dcc_cnt = 0x20;
	mov	r3,#0x20
;	../../shared/src/dcc_cal.c:709: time_out_cnt = 0;
	mov	r4,#0x00
;	../../shared/src/dcc_cal.c:712: } while (1);
	ljmp	00155$
00157$:
;	../../shared/src/dcc_cal.c:715: if (lnx_CAL_DONE_LANE == 0) {                            //if power-on calibration
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00159$
;	../../shared/src/dcc_cal.c:716: lnx_cal_rxdcc_eom[PWR][gen] = dcc_cnt;       //save to power-on result
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,@r0
	...
	mov	a,r3
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:717: lnx_cal_rxdcc_eom_hg[gen] = (RXDCC_HG_EOMCLK & 0x01) | 0x0; //save the HG setting for current rate, will be loaded by continious mode
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,@r0
	...
	movx	@dptr,a
00159$:
;	../../shared/src/dcc_cal.c:719: lnx_cal_rxdcc_eom[CONT][gen] = dcc_cnt;     //no matter power-on or LOAD or continuous, need to save to [CONT]
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,@r0
	...
	mov	a,r3
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:722: if (saved_eom_clk_en == 0) {   //set EOM_CLK_EN back to 0 if it was 0 before power-on calibration
	mov	a,r5
	jnz	00161$
;	../../shared/src/dcc_cal.c:723: EOM_CLK_EN = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_134
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
00161$:
;	../../shared/src/dcc_cal.c:725: RXDCC_CAL_EN = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_16
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/dcc_cal.c:726: lnx_RXDCC_EOM_CAL_DONE_LANE = 1;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
