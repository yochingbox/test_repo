...
; This file was generated Thu Oct 18 21:21:43 2018
;--------------------------------------------------------
	.module phase_adaptation
	.optsdcc -mmcs51 --model-small
	
;--------------------------------------------------------
; Public variables in this module
;--------------------------------------------------------
	.globl _get_offset_number
	.globl _TF2
	.globl _TI
	.globl _RI
	.globl _EX12
	...
	.globl _DPL
	.globl _P0
	.globl _EOM_CLK_OFFSET
	.globl _Align90_CLK_OFFSET
	...
	.globl _Phase_Adaptation
	.globl _Init_Phase_Adapt
	.globl _EOM_Clock_Alignment
	.globl _Data_EOM_Align90_Adapt_EyeWidthMode
	.globl _Data_Path_DFE_Adapt
	.globl _EOM_clock_DFE_Adapt
	.globl _F0d_measurement
	.globl _EOM_clock_analog_align
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area BANK1   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'get_offset_number'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/phase_adaptation.c:44: void get_offset_number(void) 
;	-----------------------------------------
;	 function get_offset_number
;	-----------------------------------------
_get_offset_number:
	ar2 = 0x02
	ar3 = 0x03
	...
	ar0 = 0x00
	ar1 = 0x01
;	../../shared/src/phase_adaptation.c:46: Align90_CLK_OFFSET  = (int8_t)lnx_DATA_CLK_OFFSET_2C_LANE_7_0;
	mov	dptr,#_RPTA_CONFIG_1
	movx	a,@dptr
	mov	dptr,#_Align90_CLK_OFFSET
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:47: EOM_CLK_OFFSET = (int8_t)lnx_EOM_CLK_OFFSET_2C_LANE_7_0;
	mov	dptr,#(_RPTA_CONFIG_0 + 0x0003)
	movx	a,@dptr
	mov	dptr,#_EOM_CLK_OFFSET
	movx	@dptr,a
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'Phase_Adaptation'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/phase_adaptation.c:54: void Phase_Adaptation(void) BANKING_CTRL {
;	-----------------------------------------
;	 function Phase_Adaptation
;	-----------------------------------------
_Phase_Adaptation:
;	../../shared/src/phase_adaptation.c:56: if(eom_ext_mode==1 || dfe_dis == 1) return;
...
00101$:
	ljmp	00116$
00102$:
;	../../shared/src/phase_adaptation.c:58: if( do_phase_adapt ){
	mov	dptr,#_do_phase_adapt
	movx	a,@dptr
	mov	r2,a
	jz	00110$
;	../../shared/src/phase_adaptation.c:59: if( lnx_PHASE_ADAPT_ENABLE_LANE == 0 ) {	//requested stop
	mov	dptr,#_DFE_CONTROL_5
	movx	a,@dptr
	jb	acc.5,00111$
;	../../shared/src/phase_adaptation.c:60: lnx_RD_DFE_F0D_LANE_7_0 = train.eo_slicer;
	...
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:61: Data_Path_DFE_Adapt();		
	mov	r0,#_Data_Path_DFE_Adapt
	mov	r1,#(_Data_Path_DFE_Adapt >> 8)
	mov	r2,#(_Data_Path_DFE_Adapt >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_adaptation.c:62: do_phase_adapt = 0;  
	mov	dptr,#_do_phase_adapt
;	../../shared/src/phase_adaptation.c:63: PH_CONV_CNT = 0;
;	../../shared/src/phase_adaptation.c:64: EOM_CONV_CNT = 0;
;	../../shared/src/phase_adaptation.c:65: ph_conv_dir= 0;
	clr	a
	movx	@dptr,a
	mov	dptr,#_PH_CONV_CNT
	movx	@dptr,a
	mov	dptr,#_EOM_CONV_CNT
	movx	@dptr,a
	mov	dptr,#_ph_conv_dir
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:66: eom_conv_dir = 0;
	mov	dptr,#_eom_conv_dir
	clr	a
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:67: f1_ofst_adjustment_en = 0;		
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0002)
	movx	a,@dptr
	anl	a,#0xef
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:68: dfe_hardware_cont_run();
	mov	r0,#_dfe_hardware_cont_run
	mov	r1,#(_dfe_hardware_cont_run >> 8)
	mov	r2,#(_dfe_hardware_cont_run >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_adaptation.c:69: cal_half_code();
	mov	r0,#_cal_half_code
	mov	r1,#(_cal_half_code >> 8)
	mov	r2,#(_cal_half_code >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_adaptation.c:76: return;
	sjmp	00116$
00110$:
;	../../shared/src/phase_adaptation.c:80: if( lnx_PHASE_ADAPT_ENABLE_LANE  == 1 ) {
	mov	dptr,#_DFE_CONTROL_5
	movx	a,@dptr
	swap	a
	rr	a
	...
	mov	r2,a
	cjne	r2,#0x01,00107$
;	../../shared/src/phase_adaptation.c:81: do_phase_adapt = 1; Phase_Adapt_Inited = 0; //start
	mov	dptr,#_do_phase_adapt
	mov	a,#0x01
	movx	@dptr,a
	mov	dptr,#_Phase_Adapt_Inited
	clr	a
	movx	@dptr,a
	sjmp	00111$
00107$:
;	../../shared/src/phase_adaptation.c:83: else return; //idle mode
	sjmp	00116$
00111$:
;	../../shared/src/phase_adaptation.c:86: if(Phase_Adapt_Inited == 0)
	mov	dptr,#_Phase_Adapt_Inited
	movx	a,@dptr
	mov	r2,a
	jnz	00113$
;	../../shared/src/phase_adaptation.c:87: Init_Phase_Adapt();
	mov	r0,#_Init_Phase_Adapt
	mov	r1,#(_Init_Phase_Adapt >> 8)
	mov	r2,#(_Init_Phase_Adapt >> 16)
	lcall	__sdcc_banked_call
00113$:
;	../../shared/src/phase_adaptation.c:89: train.phase_offset_esm = adapt_eom_phase_save; 
	mov	dptr,#_adapt_eom_phase_save
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#(_train + 0x0022)
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:91: if(lnx_F1_ALIGN_SKIP_LANE==0) { 
	mov	dptr,#_DFE_CONTROL_5
	movx	a,@dptr
	jb	acc.7,00115$
;	../../shared/src/phase_adaptation.c:92: EOM_Clock_Alignment();
	mov	r0,#_EOM_Clock_Alignment
	mov	r1,#(_EOM_Clock_Alignment >> 8)
	mov	r2,#(_EOM_Clock_Alignment >> 16)
	lcall	__sdcc_banked_call
00115$:
;	../../shared/src/phase_adaptation.c:98: Data_EOM_Align90_Adapt_EyeWidthMode(); 
	lcall	_Data_EOM_Align90_Adapt_EyeWidthMode
00116$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'Init_Phase_Adapt'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/phase_adaptation.c:122: void Init_Phase_Adapt(void) BANKING_CTRL {
;	-----------------------------------------
;	 function Init_Phase_Adapt
;	-----------------------------------------
_Init_Phase_Adapt:
;	../../shared/src/phase_adaptation.c:126: dfe_hardware_cont_stop();	
	mov	r0,#_dfe_hardware_cont_stop
	mov	r1,#(_dfe_hardware_cont_stop >> 8)
	mov	r2,#(_dfe_hardware_cont_stop >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_adaptation.c:130: if(lnx_FORCE_INI_PHASE_OFFSET_EN_LANE) {
	mov	dptr,#(_DFE_CONTROL_7 + 0x0002)
	movx	a,@dptr
	jnb	acc.1,00102$
;	../../shared/src/phase_adaptation.c:131: train.phase_offset_data = (int8_t)lnx_INI_PHASE_ADAPT_OFFSET_2C_LANE_7_0;
	mov	dptr,#(_DFE_CONTROL_8 + 0x0001)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#(_train + 0x0021)
	movx	@dptr,a
00102$:
;	../../shared/src/phase_adaptation.c:134: get_offset_number();
	lcall	_get_offset_number
;	../../shared/src/phase_adaptation.c:135: train.phase_offset_data = train.phase_offset_data + Align90_CLK_OFFSET; // cal or train result
	mov	dptr,#(_train + 0x0021)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_Align90_CLK_OFFSET
	...
	mov	dptr,#(_train + 0x0021)
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:136: train.phase_offset_esm = train.phase_offset_esm + EOM_CLK_OFFSET;
	mov	dptr,#(_train + 0x0022)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_EOM_CLK_OFFSET
	...
	mov	dptr,#(_train + 0x0022)
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:139: if(tag_F1_VOFF_ADJUST_EN) {
	mov	dptr,#_DFE_CONTROL_10
	movx	a,@dptr
	jnb	acc.3,00104$
;	../../shared/src/phase_adaptation.c:140: f1_ofst_adjustment_en = 1;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0002)
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
00104$:
;	../../shared/src/phase_adaptation.c:142: Data_Path_DFE_Adapt();          	
	mov	r0,#_Data_Path_DFE_Adapt
	mov	r1,#(_Data_Path_DFE_Adapt >> 8)
	mov	r2,#(_Data_Path_DFE_Adapt >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_adaptation.c:144: adapt_data_en = 0;
	clr	_adapt_data_en
;	../../shared/src/phase_adaptation.c:145: adapt_slicer_en = 1;
	setb	_adapt_slicer_en
;	../../shared/src/phase_adaptation.c:146: ph_control_mode = 1;
	mov	dptr,#_ph_control_mode
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:147: set_ph_mode();
	mov	r0,#_set_ph_mode
	mov	r1,#(_set_ph_mode >> 8)
	mov	r2,#(_set_ph_mode >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_adaptation.c:148: phase_control_func();
	lcall	_phase_control_func
;	../../shared/src/phase_adaptation.c:150: phase_offset = 10;
	mov	dptr,#_phase_offset
	mov	a,#0x0A
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:151: eom_vote_acc = 0;
	mov	dptr,#_eom_vote_acc
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:152: phase_vote_acc = 0;
	mov	dptr,#_phase_vote_acc
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:154: f0d_c_pre = 0;
	mov	dptr,#_f0d_c_pre
;	../../shared/src/phase_adaptation.c:155: f0d_l_pre = 0;
;	../../shared/src/phase_adaptation.c:156: f0d_r_pre = 0;
;	../../shared/src/phase_adaptation.c:157: phase_l_offset = 0;
	clr	a
	movx	@dptr,a
	mov	dptr,#_f0d_l_pre
	movx	@dptr,a
	mov	dptr,#_f0d_r_pre
	movx	@dptr,a
	mov	dptr,#_phase_l_offset
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:158: phase_r_offset = 0;
	mov	dptr,#_phase_r_offset
;	../../shared/src/phase_adaptation.c:159: norm_eom_ph_os_l = 0; norm_eom_ph_os_c = 0; norm_eom_ph_os_r = 0;
	clr	a
	movx	@dptr,a
	mov	dptr,#_norm_eom_ph_os_l
	movx	@dptr,a
	mov	dptr,#_norm_eom_ph_os_c
	movx	@dptr,a
	mov	dptr,#_norm_eom_ph_os_r
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:161: PH_CONV_CNT = 0;
	mov	dptr,#_PH_CONV_CNT
;	../../shared/src/phase_adaptation.c:162: EOM_CONV_CNT = 0;
;	../../shared/src/phase_adaptation.c:163: ph_conv_dir= 0;
;	../../shared/src/phase_adaptation.c:164: eom_conv_dir = 0;
	clr	a
	movx	@dptr,a
	mov	dptr,#_EOM_CONV_CNT
	movx	@dptr,a
	...
	mov	dptr,#_eom_conv_dir
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:168: adapt_eom_phase_save = train.phase_offset_esm;
	mov	dptr,#(_train + 0x0022)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_adapt_eom_phase_save
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:175: lnx_F1_ALIGN_SKIP_LANE = 0;
	mov	dptr,#_DFE_CONTROL_5
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:176: lnx_PHASE_ADAPT_UI_ALIGN_SKIP_LANE = 0;
	mov	dptr,#(_DFE_CONTROL_5 + 0x0002)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:178: detect_sat = 0;
	mov	dptr,#_detect_sat
	clr	a
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:179: Phase_Adapt_Inited = 1;		
	mov	dptr,#_Phase_Adapt_Inited
	mov	a,#0x01
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'EOM_Clock_Alignment'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/phase_adaptation.c:183: void EOM_Clock_Alignment(void) BANKING_CTRL {
;	-----------------------------------------
;	 function EOM_Clock_Alignment
;	-----------------------------------------
_EOM_Clock_Alignment:
;	../../shared/src/phase_adaptation.c:187: rpta_loop_cnt = 0;
	mov	dptr,#_rpta_loop_cnt
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:188: rpta_vote = 0;
	mov	dptr,#_rpta_vote
	clr	a
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:194: do {	
00128$:
;	../../shared/src/phase_adaptation.c:196: adapt_data_en = 0;
	clr	_adapt_data_en
;	../../shared/src/phase_adaptation.c:197: adapt_slicer_en = 1;
	setb	_adapt_slicer_en
;	../../shared/src/phase_adaptation.c:198: ph_control_mode = 1;
	mov	dptr,#_ph_control_mode
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:199: set_ph_mode();
	mov	r0,#_set_ph_mode
	mov	r1,#(_set_ph_mode >> 8)
	mov	r2,#(_set_ph_mode >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_adaptation.c:200: phase_control_func();
	lcall	_phase_control_func
;	../../shared/src/phase_adaptation.c:201: lnx_EOM_PHASE_UI_ALIGN_FAILED_LANE =	_EXIT_SUCCESS; 
	mov	dptr,#(_DFE_CONTROL_5 + 0x0002)
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:203: if(lnx_PHASE_ADAPT_UI_ALIGN_SKIP_LANE==0) 
	mov	dptr,#(_DFE_CONTROL_5 + 0x0002)
	movx	a,@dptr
	jb	acc.3,00102$
;	../../shared/src/phase_adaptation.c:204: EOM_clock_analog_align();		
	mov	r0,#_EOM_clock_analog_align
	mov	r1,#(_EOM_clock_analog_align >> 8)
	mov	r2,#(_EOM_clock_analog_align >> 16)
	lcall	__sdcc_banked_call
00102$:
;	../../shared/src/phase_adaptation.c:205: if( lnx_EOM_PHASE_UI_ALIGN_FAILED_LANE == _EXIT_SUCCESS ) {
	mov	dptr,#(_DFE_CONTROL_5 + 0x0002)
	movx	a,@dptr
	jnb	acc.5,00147$
	ljmp	00119$
00147$:
;	../../shared/src/phase_adaptation.c:206: EOM_clock_DFE_Adapt();
	mov	r0,#_EOM_clock_DFE_Adapt
	mov	r1,#(_EOM_clock_DFE_Adapt >> 8)
	mov	r2,#(_EOM_clock_DFE_Adapt >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_adaptation.c:213: if( norm_ofst > train_ofst_save )
	mov	dptr,#_norm_ofst
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_train_ofst_save
	movx	a,@dptr
	mov	r3,a
	clr	c
	xrl	a,#0x80
	...
	subb	a,b
	jnc	00106$
;	../../shared/src/phase_adaptation.c:214: eom_vote_acc += 1;
	mov	dptr,#_eom_vote_acc
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	sjmp	00107$
00106$:
;	../../shared/src/phase_adaptation.c:215: else if ( norm_ofst < train_ofst_save )
	clr	c
	mov	a,r2
	xrl	a,#0x80
	mov	b,r3
	...
	subb	a,b
	jnc	00107$
;	../../shared/src/phase_adaptation.c:216: eom_vote_acc -= 1;
	mov	dptr,#_eom_vote_acc
	movx	a,@dptr
	mov	r2,a
	inc	dptr
...
00150$:
	...
	movx	@dptr,a
00107$:
;	../../shared/src/phase_adaptation.c:217: if(abs(norm_ofst-train_ofst_save)<=1)  eom_data_align_success=1;
	mov	dptr,#_train_ofst_save
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_norm_ofst
	...
	subb	a,b
	jc	00109$
	mov	dptr,#_eom_data_align_success
	mov	a,#0x01
	movx	@dptr,a
	sjmp	00110$
00109$:
;	../../shared/src/phase_adaptation.c:218: else eom_data_align_success=0;
	mov	dptr,#_eom_data_align_success
	clr	a
	movx	@dptr,a
00110$:
;	../../shared/src/phase_adaptation.c:229: if(eom_vote_acc>0)
	mov	dptr,#_eom_vote_acc
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	subb	a,b
	jnc	00114$
;	../../shared/src/phase_adaptation.c:230: rpta_vote = eom_vote_acc>>EOM_ADAPT_STEP_SIZE;
	mov	dptr,#(_RPTA_CONFIG_0 + 0x0002)
	movx	a,@dptr
	mov	r4,a
	mov	b,r4
	inc	b
...
00154$:
	...
	sjmp	00115$
00114$:
;	../../shared/src/phase_adaptation.c:231: else if(eom_vote_acc<0)
	mov	a,r3
	jnb	acc.7,00115$
;	../../shared/src/phase_adaptation.c:232: rpta_vote = -( (~eom_vote_acc)>>EOM_ADAPT_STEP_SIZE);
	mov	a,r2
	cpl	a
	mov	r2,a
	mov	a,r3
...
00157$:
	...
	movx	@dptr,a
00115$:
;	../../shared/src/phase_adaptation.c:238: if(rpta_vote!=0) {
	mov	dptr,#_rpta_vote
	movx	a,@dptr
	mov	r2,a
	jz	00119$
;	../../shared/src/phase_adaptation.c:250: train.phase_offset_esm += rpta_vote;
	mov	dptr,#(_train + 0x0022)
	movx	a,@dptr
	mov	r3,a
	mov	a,r2
	...
	mov	dptr,#(_train + 0x0022)
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:259: ph_control_mode = 1;
	mov	dptr,#_ph_control_mode
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:260: set_ph_mode();
	mov	r0,#_set_ph_mode
	mov	r1,#(_set_ph_mode >> 8)
	mov	r2,#(_set_ph_mode >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_adaptation.c:261: phase_control_func();
	lcall	_phase_control_func
;	../../shared/src/phase_adaptation.c:262: eom_vote_acc = 0;
	mov	dptr,#_eom_vote_acc
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:263: rpta_vote = 0;
	mov	dptr,#_rpta_vote
	clr	a
	movx	@dptr,a
00119$:
;	../../shared/src/phase_adaptation.c:277: if( (abs(train.f1) > tag_DFE_F1_SAT_THRES) || (train.f0a >= tag_DFE_F0_SAT_THRES) || ofst_sat ) {
...
00161$:
	...
	jz	00123$
00122$:
;	../../shared/src/phase_adaptation.c:279: if(lnx_PHASE_ADAPT_SAT_DETECT_LANE==0) {
	mov	dptr,#(_DFE_CONTROL_1 + 0x0002)
	movx	a,@dptr
	jb	acc.4,00129$
;	../../shared/src/phase_adaptation.c:280: lnx_PHASE_ADAPT_SAT_DETECT_LANE = 1;
	mov	dptr,#(_DFE_CONTROL_1 + 0x0002)
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:284: break;	
	sjmp	00131$
00123$:
;	../../shared/src/phase_adaptation.c:287: else lnx_PHASE_ADAPT_SAT_DETECT_LANE = 0;
	mov	dptr,#(_DFE_CONTROL_1 + 0x0002)
	movx	a,@dptr
	anl	a,#0xef
	movx	@dptr,a
00129$:
;	../../shared/src/phase_adaptation.c:295: } while((rpta_loop_cnt++ < EOM_CONV_NUM) && lnx_PHASE_ADAPT_ENABLE_LANE);		
	mov	dptr,#_rpta_loop_cnt
	movx	a,@dptr
	mov	r2,a
	inc	dptr
...
00131$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'Data_EOM_Align90_Adapt_EyeWidthMode'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/phase_adaptation.c:454: void Data_EOM_Align90_Adapt_EyeWidthMode(void) BANKING_CTRL {
;	-----------------------------------------
;	 function Data_EOM_Align90_Adapt_EyeWidthMode
;	-----------------------------------------
_Data_EOM_Align90_Adapt_EyeWidthMode:
;	../../shared/src/phase_adaptation.c:455: rpta_loop_cnt = 0;
	mov	dptr,#_rpta_loop_cnt
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:456: rpta_vote = 0;
	mov	dptr,#_rpta_vote
	clr	a
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:462: do 	{	
00138$:
;	../../shared/src/phase_adaptation.c:464: adapt_data_en = 0;
	clr	_adapt_data_en
;	../../shared/src/phase_adaptation.c:465: adapt_slicer_en = 1;
	setb	_adapt_slicer_en
;	../../shared/src/phase_adaptation.c:466: ph_control_mode = 1;
	mov	dptr,#_ph_control_mode
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:467: phase_control_func();
	lcall	_phase_control_func
;	../../shared/src/phase_adaptation.c:468: lnx_EOM_PHASE_UI_ALIGN_FAILED_LANE = _EXIT_SUCCESS; 
	mov	dptr,#(_DFE_CONTROL_5 + 0x0002)
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:470: if(lnx_PHASE_ADAPT_UI_ALIGN_SKIP_LANE==0) 
	mov	dptr,#(_DFE_CONTROL_5 + 0x0002)
	movx	a,@dptr
	jb	acc.3,00102$
;	../../shared/src/phase_adaptation.c:471: EOM_clock_analog_align();		
	mov	r0,#_EOM_clock_analog_align
	mov	r1,#(_EOM_clock_analog_align >> 8)
	mov	r2,#(_EOM_clock_analog_align >> 16)
	lcall	__sdcc_banked_call
00102$:
;	../../shared/src/phase_adaptation.c:473: if( lnx_EOM_PHASE_UI_ALIGN_FAILED_LANE == _EXIT_SUCCESS ) 		
	mov	dptr,#(_DFE_CONTROL_5 + 0x0002)
	movx	a,@dptr
	jnb	acc.5,00162$
	ljmp	00129$
00162$:
;	../../shared/src/phase_adaptation.c:476: norm_eom_ph_os_c = train.phase_offset_esm;
	mov	dptr,#(_train + 0x0022)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_norm_eom_ph_os_c
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:477: norm_eom_ph_os_l = train.phase_offset_esm + phase_l_offset;
	mov	dptr,#_phase_l_offset
	movx	a,@dptr
	mov	dptr,#_norm_eom_ph_os_l
	add	a,r2
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:478: norm_eom_ph_os_r = train.phase_offset_esm + phase_r_offset;
	mov	dptr,#_phase_r_offset
	movx	a,@dptr
	mov	dptr,#_norm_eom_ph_os_r
	add	a,r2
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:480: F0d_measurement();
	mov	r0,#_F0d_measurement
	mov	r1,#(_F0d_measurement >> 8)
	mov	r2,#(_F0d_measurement >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_adaptation.c:492: if( train.f0d_slicer_left > MAX_F0D ) //2
	...
	subb	a,b
	jnc	00106$
;	../../shared/src/phase_adaptation.c:493: phase_l_offset -= STEP_SIZE; //1
	mov	dptr,#_phase_l_offset
	movx	a,@dptr
	mov	r3,a
	dec	a
	...
	sjmp	00107$
00106$:
;	../../shared/src/phase_adaptation.c:494: else if(train.f0d_slicer_left < MIN_F0D ) //1
	mov	dptr,#(_TRAIN_PARA_3 + 0x0003)
	movx	a,@dptr
	mov	r3,a
	mov	r4,#0x00
...
00164$:
	...
	subb	a,b
	jnc	00107$
;	../../shared/src/phase_adaptation.c:495: phase_l_offset += STEP_SIZE;
	mov	dptr,#_phase_l_offset
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_phase_l_offset
	...
	movx	@dptr,a
00107$:
;	../../shared/src/phase_adaptation.c:496: phase_l_offset = clamp( phase_l_offset, +half_ui_code, -half_ui_code);	
	...
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:498: if( train.f0d_slicer_right > MAX_F0D )
	...
	subb	a,b
	jnc	00111$
;	../../shared/src/phase_adaptation.c:499: phase_r_offset += STEP_SIZE;
	mov	dptr,#_phase_r_offset
	movx	a,@dptr
	mov	r3,a
	mov	dptr,#_phase_r_offset
	...
	sjmp	00112$
00111$:
;	../../shared/src/phase_adaptation.c:500: else if( train.f0d_slicer_right < MIN_F0D ) 
	mov	dptr,#(_TRAIN_PARA_3 + 0x0003)
	movx	a,@dptr
	mov	r3,a
	mov	r4,#0x00
...
00167$:
	...
	subb	a,b
	jnc	00112$
;	../../shared/src/phase_adaptation.c:501: phase_r_offset -= STEP_SIZE;	
	mov	dptr,#_phase_r_offset
	movx	a,@dptr
	mov	r2,a
	dec	a
	...
	movx	@dptr,a
00112$:
;	../../shared/src/phase_adaptation.c:502: phase_r_offset = clamp( phase_r_offset, +half_ui_code, -half_ui_code);				
	mov	dptr,#_half_ui_code
	movx	a,@dptr
	mov	r2,a
	clr	c
	...
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:505: if((phase_l_offset+phase_r_offset) < -MAX_OFF) //1
	mov	dptr,#_phase_l_offset
	movx	a,@dptr
	mov	r3,a
	rlc	a
	...
	subb	a,#0x7f
	jnc	00114$
;	../../shared/src/phase_adaptation.c:506: phase_vote_acc--;
	mov	dptr,#_phase_vote_acc
	movx	a,@dptr
	add	a,#0xff
	mov	r6,a
	...
	movx	@dptr,a
00114$:
;	../../shared/src/phase_adaptation.c:507: if((phase_l_offset+phase_r_offset) > MAX_OFF)
	mov	a,r2
	add	a,r3
	mov	r3,a
	mov	a,r5
	...
	subb	a,b
	jnc	00116$
;	../../shared/src/phase_adaptation.c:508: phase_vote_acc++;
	mov	dptr,#_phase_vote_acc
	movx	a,@dptr
	add	a,#0x01
	movx	@dptr,a
	...
	movx	@dptr,a
00116$:
;	../../shared/src/phase_adaptation.c:510: if(phase_vote_acc > 0)
	mov	dptr,#_phase_vote_acc
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	subb	a,b
	jnc	00120$
;	../../shared/src/phase_adaptation.c:511: rpta_vote = phase_vote_acc>>PH_ADAPT_STEP_SIZE;
	mov	dptr,#(_RPTA_CONFIG_1 + 0x0002)
	movx	a,@dptr
	mov	r4,a
	mov	b,r4
	inc	b
...
00173$:
	...
	sjmp	00121$
00120$:
;	../../shared/src/phase_adaptation.c:512: else if(phase_vote_acc < 0) 
	mov	a,r3
	jnb	acc.7,00121$
;	../../shared/src/phase_adaptation.c:513: rpta_vote = -((~phase_vote_acc)>>PH_ADAPT_STEP_SIZE);
	mov	a,r2
	cpl	a
	mov	r2,a
	mov	a,r3
...
00176$:
	...
	movx	@dptr,a
00121$:
;	../../shared/src/phase_adaptation.c:520: if(rpta_vote!=0) 
	mov	dptr,#_rpta_vote
	movx	a,@dptr
	mov	r2,a
	jz	00129$
;	../../shared/src/phase_adaptation.c:529: if( ((cal_phase - train.phase_offset_data + rpta_vote) == tag_CDR_PHASE_MAX) || 
	...
	sjmp	00124$
00178$:
;	../../shared/src/phase_adaptation.c:530: ((cal_phase - train.phase_offset_data + rpta_vote) == tag_CDR_PHASE_MIN) ) {
	mov	dptr,#(_DFE_CONTROL_3 + 0x0002)
	movx	a,@dptr
	mov	r3,a
	mov	r4,#0x00
	...
	sjmp	00124$
00179$:
;	../../shared/src/phase_adaptation.c:548: train.phase_offset_data += rpta_vote;
	mov	a,r2
	add	a,r5
	mov	r2,a
	mov	dptr,#(_train + 0x0021)
	movx	@dptr,a
00124$:
;	../../shared/src/phase_adaptation.c:552: lnx_EYE_LEFT_RTPA_2C_LANE_7_0 = norm_eom_ph_os_l;
	mov	dptr,#_norm_eom_ph_os_l
	movx	a,@dptr
	mov	dptr,#(_DFE_CONTROL_9 + 0x0003)
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:553: lnx_EYE_RIGHT_RTPA_2C_LANE_7_0 = norm_eom_ph_os_r;
	mov	dptr,#_norm_eom_ph_os_r
	movx	a,@dptr
	mov	dptr,#(_DFE_CONTROL_9 + 0x0002)
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:554: lnx_EYE_MID_RTPA_2C_LANE_7_0 = train.phase_offset_esm; //norm_eom_ph_os_c;		
	mov	dptr,#(_train + 0x0022)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#(_DFE_CONTROL_9 + 0x0001)
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:565: phase_vote_acc = 0;
	mov	dptr,#_phase_vote_acc
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:566: rpta_vote = 0;
	mov	dptr,#_rpta_vote
	clr	a
	movx	@dptr,a
00129$:
;	../../shared/src/phase_adaptation.c:578: Data_Path_DFE_Adapt();		
	mov	r0,#_Data_Path_DFE_Adapt
	mov	r1,#(_Data_Path_DFE_Adapt >> 8)
	mov	r2,#(_Data_Path_DFE_Adapt >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_adaptation.c:580: if( (abs(train.f1) > tag_DFE_F1_SAT_THRES) || train.f0a >= tag_DFE_F0_SAT_THRES || ofst_sat ) {
	mov	dptr,#(_train + 0x0006)
	movx	a,@dptr
	mov	dpl,a
	mov	r0,#_abs
...
00182$:
	...
	jz	00133$
00132$:
;	../../shared/src/phase_adaptation.c:582: if(lnx_PHASE_ADAPT_SAT_DETECT_LANE==0) {
	mov	dptr,#(_DFE_CONTROL_1 + 0x0002)
	movx	a,@dptr
	jb	acc.4,00139$
;	../../shared/src/phase_adaptation.c:583: lnx_PHASE_ADAPT_SAT_DETECT_LANE = 1;
	mov	dptr,#(_DFE_CONTROL_1 + 0x0002)
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:587: break;	
	sjmp	00141$
00133$:
;	../../shared/src/phase_adaptation.c:590: else lnx_PHASE_ADAPT_SAT_DETECT_LANE = 0;
	mov	dptr,#(_DFE_CONTROL_1 + 0x0002)
	movx	a,@dptr
	anl	a,#0xef
	movx	@dptr,a
00139$:
;	../../shared/src/phase_adaptation.c:593: } while( rpta_loop_cnt++ < PH_CONV_NUM && lnx_PHASE_ADAPT_ENABLE_LANE) ;
	mov	dptr,#_rpta_loop_cnt
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	inc	dptr
	movx	@dptr,a
	mov	dptr,#(_RPTA_CONFIG_1 + 0x0003)
	movx	a,@dptr
	mov	r4,a
	mov	r5,#0x00
	clr	c
...
00141$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'Data_Path_DFE_Adapt'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/phase_adaptation.c:605: void Data_Path_DFE_Adapt(void) BANKING_CTRL {
;	-----------------------------------------
;	 function Data_Path_DFE_Adapt
;	-----------------------------------------
_Data_Path_DFE_Adapt:
;	../../shared/src/phase_adaptation.c:606: if(lnx_FORCE_PHASE_OFFSET_DATA_EN_LANE) return;
	mov	dptr,#_DFE_CONTROL_3
	movx	a,@dptr
	jnb	acc.1,00102$
	sjmp	00103$
00102$:
;	../../shared/src/phase_adaptation.c:612: adapt_eom_phase_save = train.phase_offset_esm;
	mov	dptr,#(_train + 0x0022)
	movx	a,@dptr
	mov	dptr,#_adapt_eom_phase_save
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:613: adapt_data_en = 1;
	setb	_adapt_data_en
;	../../shared/src/phase_adaptation.c:614: adapt_slicer_en = 1;
	setb	_adapt_slicer_en
;	../../shared/src/phase_adaptation.c:615: ph_control_mode = 0;
	mov	dptr,#_ph_control_mode
	clr	a
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:616: set_ph_mode();
	mov	r0,#_set_ph_mode
	mov	r1,#(_set_ph_mode >> 8)
	mov	r2,#(_set_ph_mode >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_adaptation.c:617: phase_control_func_0(train.phase_offset_data, 0);
	mov	dptr,#(_train + 0x0021)
	movx	a,@dptr
	mov	r2,a
	clr	a
	push	acc
	mov	dpl,r2
	lcall	_phase_control_func_0
	dec	sp
;	../../shared/src/phase_adaptation.c:618: train.phase_offset_esm = adapt_eom_phase_save;
	mov	dptr,#_adapt_eom_phase_save
	movx	a,@dptr
	mov	dptr,#(_train + 0x0022)
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:620: cds_tb = cds_table[CDS_DFE_OFST];
	...
	mov	a,r3
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:621: dfe_adaptation(); 
	mov	r0,#_dfe_adaptation
	mov	r1,#(_dfe_adaptation >> 8)
	mov	r2,#(_dfe_adaptation >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_adaptation.c:625: train_ofst_save = train.ofst_slicer;
...
00103$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'EOM_clock_DFE_Adapt'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/phase_adaptation.c:632: void EOM_clock_DFE_Adapt(void) BANKING_CTRL {
;	-----------------------------------------
;	 function EOM_clock_DFE_Adapt
;	-----------------------------------------
_EOM_clock_DFE_Adapt:
;	../../shared/src/phase_adaptation.c:633: adapt_data_en = 0;
	clr	_adapt_data_en
;	../../shared/src/phase_adaptation.c:634: adapt_slicer_en = 1;
	setb	_adapt_slicer_en
;	../../shared/src/phase_adaptation.c:635: ph_control_mode = 1;
	mov	dptr,#_ph_control_mode
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:636: set_ph_mode();
	mov	r0,#_set_ph_mode
	mov	r1,#(_set_ph_mode >> 8)
	mov	r2,#(_set_ph_mode >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_adaptation.c:637: phase_control_func();
	lcall	_phase_control_func
;	../../shared/src/phase_adaptation.c:639: cds_tb = cds_table[CDS_EOMADAPT];
	mov	dptr,#(_cds_table + 0x000c)
	clr	a
	movc	a,@a+dptr
	mov	r2,a
	inc	dptr
	...
	mov	a,r3
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:640: dfe_adaptation(); 	
	mov	r0,#_dfe_adaptation
	mov	r1,#(_dfe_adaptation >> 8)
	mov	r2,#(_dfe_adaptation >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_adaptation.c:641: norm_ofst = train.ofst_slicer;
	mov	dptr,#(_train + 0x0017)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_norm_ofst
	...
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'F0d_measurement'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/phase_adaptation.c:655: void F0d_measurement(void) BANKING_CTRL {
;	-----------------------------------------
;	 function F0d_measurement
;	-----------------------------------------
_F0d_measurement:
;	../../shared/src/phase_adaptation.c:657: adapt_data_en = 0;
	clr	_adapt_data_en
;	../../shared/src/phase_adaptation.c:658: adapt_slicer_en = 1;
	setb	_adapt_slicer_en
;	../../shared/src/phase_adaptation.c:659: ph_control_mode = 1;
	mov	dptr,#_ph_control_mode
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:660: set_ph_mode();	
	mov	r0,#_set_ph_mode
	mov	r1,#(_set_ph_mode >> 8)
	mov	r2,#(_set_ph_mode >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_adaptation.c:661: phase_control_func();
	lcall	_phase_control_func
;	../../shared/src/phase_adaptation.c:663: cds_tb = cds_table[CDS_F0D]; 
	...
	mov	a,r3
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:664: lnx_VH_EO_MODE_LANE = 1;
	mov	dptr,#_CDS_CTRL_REG0
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:665: dfe_adaptation(); 
	mov	r0,#_dfe_adaptation
	mov	r1,#(_dfe_adaptation >> 8)
	mov	r2,#(_dfe_adaptation >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_adaptation.c:666: lnx_VH_EO_MODE_LANE = 0;
	mov	dptr,#_CDS_CTRL_REG0
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'EOM_clock_analog_align'
;------------------------------------------------------------
;dec_num                   Allocated to registers r2 
;i                         Allocated to registers r5 
;total_cnt                 Allocated to registers r3 r4 
;------------------------------------------------------------
;	../../shared/src/phase_adaptation.c:678: void EOM_clock_analog_align(void) BANKING_CTRL {
;	-----------------------------------------
;	 function EOM_clock_analog_align
;	-----------------------------------------
_EOM_clock_analog_align:
;	../../shared/src/phase_adaptation.c:687: set_slicer_data_sampler_adapt(SLICER_SMPL_ONLY);
	mov	dpl,#0x01
	mov	r0,#_set_slicer_data_sampler_adapt
	mov	r1,#(_set_slicer_data_sampler_adapt >> 8)
	mov	r2,#(_set_slicer_data_sampler_adapt >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phase_adaptation.c:688: data_slic_fb_mode = 0; 
	mov	dptr,#(_DFE_CTRL_REG1 + 0x0001)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:690: dec_num = cdr_ui_pi_code_num;
	mov	dptr,#_cdr_ui_pi_code_num
	movx	a,@dptr
	mov	r2,a
;	../../shared/src/phase_adaptation.c:692: do {
	mov	r3,#0x1C
	mov	r4,#0x02
00103$:
;	../../shared/src/phase_adaptation.c:693: cds_tb = cds_table[CDS_EYECHECK];  
	mov	dptr,#(_cds_table + 0x000a)
	clr	a
	movc	a,@a+dptr
	mov	r5,a
	inc	dptr
	...
	mov	a,r6
	movx	@dptr,a
;	../../shared/src/phase_adaptation.c:694: cdr_dfe_scheme();
	push	ar2
	push	ar3
	push	ar4
	...
	pop	ar3
	pop	ar2
;	../../shared/src/phase_adaptation.c:695: if(cds28.eye_check_pass) {
	mov	dptr,#(_cds28 + 0x0070)
	movx	a,@dptr
;	../../shared/src/phase_adaptation.c:701: for(i = 0; i < dec_num; ++ i) {		
	jnz	00105$
	mov	r5,a
00106$:
	mov	a,r5
...
00119$:
	jnc	00104$
;	../../shared/src/phase_adaptation.c:703: move_eom_phase(64); //move 1UI; 90'
	mov	dptr,#0x0040
	push	ar2
	push	ar3
	push	ar4
	push	ar5
	lcall	_move_eom_phase
	pop	ar5
	pop	ar4
	pop	ar3
	pop	ar2
;	../../shared/src/phase_adaptation.c:701: for(i = 0; i < dec_num; ++ i) {		
	...
	sjmp	00106$
00104$:
;	../../shared/src/phase_adaptation.c:706: } while (total_cnt-->0);
	mov	ar5,r3
	mov	ar6,r4
	dec	r3
	cjne	r3,#0xff,00121$
...
00121$:
	...
	jnz	00103$
00105$:
;	../../shared/src/phase_adaptation.c:708: lnx_EOM_PHASE_UI_ALIGN_FAILED_LANE = cds28.eye_check_pass==1? _EXIT_SUCCESS:_EXIT_FAIL;	
	mov	dptr,#(_cds28 + 0x0070)
	movx	a,@dptr
	mov	r2,a
	cjne	r2,#0x01,00123$
