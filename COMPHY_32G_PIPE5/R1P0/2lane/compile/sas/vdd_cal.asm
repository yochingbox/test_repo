...
; This file was generated Thu Oct 18 21:21:51 2018
;--------------------------------------------------------
	.module vdd_cal
...
;--------------------------------------------------------
	.globl _vdd_cal_set_pass
	.globl _vdd_cal_calen
	.globl _get_vdd_cal
	.globl _save_vdd_cal
	.globl _set_vdd_cal
	.globl _TF2
...
;--------------------------------------------------------
	.area BANK2   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'vdd_cal'
;------------------------------------------------------------
;sel                       Allocated to registers r2 
;------------------------------------------------------------
;	../../shared/src/vdd_cal.c:46: void vdd_cal( void ) BANKING_CTRL {
;	-----------------------------------------
;	 function vdd_cal
;	-----------------------------------------
_vdd_cal:
	...
	ar0 = 0x00
	ar1 = 0x01
;	../../shared/src/vdd_cal.c:48: set_test_pattern(0); //PRBS7
	mov	dpl,#0x00
	mov	r0,#_set_test_pattern
	mov	r1,#(_set_test_pattern >> 8)
	mov	r2,#(_set_test_pattern >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/vdd_cal.c:49: for(sel=0; sel<6; sel++) {
	mov	r2,#0x00
00101$:
	cjne	r2,#0x06,00110$
00110$:
	jnc	00104$
;	../../shared/src/vdd_cal.c:50: vdd_cal_sel(sel);
	mov	dpl,r2
	push	ar2
	mov	r0,#_vdd_cal_sel
...
;	../../shared/src/vdd_cal.c:49: for(sel=0; sel<6; sel++) {
	...
	sjmp	00101$
00104$:
;	../../shared/src/vdd_cal.c:52: recover_test_pattern();
...
;------------------------------------------------------------
;Allocation info for local variables in function 'set_vdd_cal'
;------------------------------------------------------------
;val                       Allocated to stack - offset -4
;sel                       Allocated to registers r2 
;------------------------------------------------------------
;	../../shared/src/vdd_cal.c:95: void set_vdd_cal( uint8_t sel, uint8_t val ) BANKING_CTRL {
;	-----------------------------------------
;	 function set_vdd_cal
;	-----------------------------------------
_set_vdd_cal:
	push	_bp
	mov	_bp,sp
	mov	r2,dpl
;	../../shared/src/vdd_cal.c:97: switch(mcuid) {
...
00133$:
	ljmp	00117$
;	../../shared/src/vdd_cal.c:98: case MCU_LANE0:
00101$:
;	../../shared/src/vdd_cal.c:99: switch(sel) {
	mov	a,#0x05
	cjne	a,ar2,00134$
00134$:
	jnc	00135$
...
00136$:
	...
	ljmp	00106$
	ljmp	00107$
;	../../shared/src/vdd_cal.c:100: case SELLV_TXCLK: 	 cmx_G_SELLV_TXCLK_CH0_7_0 = val;  break;
00102$:
	mov	dptr,#(_G_SELLV_TXCLK + 0x0003)
	mov	a,_bp
	add	a,#0xfc
	mov	r0,a
	mov	a,@r0
	movx	@dptr,a
	ljmp	00117$
;	../../shared/src/vdd_cal.c:101: case SELLV_TXDATA:   cmx_G_SELLV_TXDATA_CH0_7_0 = val; break;
00103$:
	mov	dptr,#(_G_SELLV_TXDATA + 0x0003)
	mov	a,_bp
	add	a,#0xfc
	mov	r0,a
	mov	a,@r0
	movx	@dptr,a
	ljmp	00117$
;	../../shared/src/vdd_cal.c:102: case SELLV_TXPRE:    cmx_G_SELLV_TXPRE_CH0_7_0 = val;  break;
00104$:
	mov	dptr,#(_G_SELLV_TXPRE + 0x0003)
	mov	a,_bp
	add	a,#0xfc
	mov	r0,a
	mov	a,@r0
	movx	@dptr,a
	ljmp	00117$
;	../../shared/src/vdd_cal.c:103: case SELLV_RXEOMCLK: cmx_G_SELLV_RXEOMCLK_CH0_7_0 = val; break;
00105$:
	mov	dptr,#(_G_SELLV_RXEOMCLK + 0x0003)
	mov	a,_bp
	add	a,#0xfc
	mov	r0,a
	mov	a,@r0
	movx	@dptr,a
	ljmp	00117$
;	../../shared/src/vdd_cal.c:104: case SELLV_RXDATACLK:cmx_G_SELLV_RXDATACLK_CH0_7_0 = val; break; 
00106$:
	mov	dptr,#(_G_SELLV_RXDATACLK + 0x0003)
	mov	a,_bp
	add	a,#0xfc
	mov	r0,a
	mov	a,@r0
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:105: case SELLV_RXSAMPLER:cmx_G_SELLV_RXSAMPELR_CH0_7_0 = val; break;
	sjmp	00117$
00107$:
	mov	dptr,#(_G_SELLV_RXSAMPLER + 0x0003)
	mov	a,_bp
	add	a,#0xfc
	mov	r0,a
	mov	a,@r0
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:107: break;	
;	../../shared/src/vdd_cal.c:108: case MCU_LANE1:
	sjmp	00117$
00109$:
;	../../shared/src/vdd_cal.c:109: switch(sel) {
	mov	a,#0x05
	cjne	a,ar2,00137$
00137$:
	jc	00117$
...
00139$:
	...
	ljmp	00114$
	ljmp	00115$
;	../../shared/src/vdd_cal.c:110: case SELLV_TXCLK: 	 cmx_G_SELLV_TXCLK_CH1_7_0 = val;  break;
00110$:
	mov	dptr,#(_G_SELLV_TXCLK + 0x0002)
	mov	a,_bp
	add	a,#0xfc
	mov	r0,a
	mov	a,@r0
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:111: case SELLV_TXDATA:   cmx_G_SELLV_TXDATA_CH1_7_0 = val; break;
	sjmp	00117$
00111$:
	mov	dptr,#(_G_SELLV_TXDATA + 0x0002)
	mov	a,_bp
	add	a,#0xfc
	mov	r0,a
	mov	a,@r0
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:112: case SELLV_TXPRE:    cmx_G_SELLV_TXPRE_CH1_7_0 = val;  break;
	sjmp	00117$
00112$:
	mov	dptr,#(_G_SELLV_TXPRE + 0x0002)
	mov	a,_bp
	add	a,#0xfc
	mov	r0,a
	mov	a,@r0
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:113: case SELLV_RXEOMCLK: cmx_G_SELLV_RXEOMCLK_CH1_7_0 = val; break;
	sjmp	00117$
00113$:
	mov	dptr,#(_G_SELLV_RXEOMCLK + 0x0002)
	mov	a,_bp
	add	a,#0xfc
	mov	r0,a
	mov	a,@r0
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:114: case SELLV_RXDATACLK:cmx_G_SELLV_RXDATACLK_CH1_7_0 = val; break; 
	sjmp	00117$
00114$:
	mov	dptr,#(_G_SELLV_RXDATACLK + 0x0002)
	mov	a,_bp
	add	a,#0xfc
	mov	r0,a
	mov	a,@r0
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:115: case SELLV_RXSAMPLER:cmx_G_SELLV_RXSAMPELR_CH1_7_0 = val; break;
	sjmp	00117$
00115$:
	mov	dptr,#(_G_SELLV_RXSAMPLER + 0x0002)
	mov	a,_bp
	add	a,#0xfc
	mov	r0,a
	mov	a,@r0
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:140: }
00117$:
;	../../shared/src/vdd_cal.c:142: switch(sel) {
	mov	a,#0x05
	cjne	a,ar2,00140$
00140$:
	jnc	00141$
...
00142$:
	...
	ljmp	00122$
	ljmp	00123$
;	../../shared/src/vdd_cal.c:143: case SELLV_TXCLK: 	 
00118$:
;	../../shared/src/vdd_cal.c:144: reg_SELLV_TXCLK_CH0_3_0 = cmx_G_SELLV_TXCLK_CH0_7_0;  
	mov	dptr,#(_G_SELLV_TXCLK + 0x0003)
	movx	a,@dptr
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_156
	swap	a
	anl	a,#(0xf0&0xf0)
	mov	b,a
	movx	a,@dptr
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:145: reg_SELLV_TXCLK_CH1_3_0 = cmx_G_SELLV_TXCLK_CH1_7_0;  
	mov	dptr,#(_G_SELLV_TXCLK + 0x0002)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_156
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:150: break;
	ljmp	00125$
;	../../shared/src/vdd_cal.c:151: case SELLV_TXDATA:   
00119$:
;	../../shared/src/vdd_cal.c:152: reg_SELLV_TXDATA_CH0_3_0 = cmx_G_SELLV_TXDATA_CH0_7_0;  
	mov	dptr,#(_G_SELLV_TXDATA + 0x0003)
	movx	a,@dptr
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_158
	swap	a
	anl	a,#(0xf0&0xf0)
	mov	b,a
	movx	a,@dptr
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:153: reg_SELLV_TXDATA_CH1_3_0 = cmx_G_SELLV_TXDATA_CH1_7_0;  
	mov	dptr,#(_G_SELLV_TXDATA + 0x0002)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_158
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:158: break;
	ljmp	00125$
;	../../shared/src/vdd_cal.c:159: case SELLV_TXPRE:    
00120$:
;	../../shared/src/vdd_cal.c:160: reg_SELLV_TXPRE_CH0_3_0 = cmx_G_SELLV_TXPRE_CH0_7_0;  
	mov	dptr,#(_G_SELLV_TXPRE + 0x0003)
	movx	a,@dptr
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_160
	swap	a
	anl	a,#(0xf0&0xf0)
	mov	b,a
	movx	a,@dptr
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:161: reg_SELLV_TXPRE_CH1_3_0 = cmx_G_SELLV_TXPRE_CH1_7_0;  
	mov	dptr,#(_G_SELLV_TXPRE + 0x0002)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_160
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:166: break;
;	../../shared/src/vdd_cal.c:167: case SELLV_RXEOMCLK: 
	sjmp	00125$
00121$:
;	../../shared/src/vdd_cal.c:168: reg_SELLV_RXEOMCLK_CH0_3_0 = cmx_G_SELLV_RXEOMCLK_CH0_7_0;  
	mov	dptr,#(_G_SELLV_RXEOMCLK + 0x0003)
	movx	a,@dptr
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_144
	swap	a
	anl	a,#(0xf0&0xf0)
	mov	b,a
	movx	a,@dptr
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:169: reg_SELLV_RXEOMCLK_CH1_3_0 = cmx_G_SELLV_RXEOMCLK_CH1_7_0;  
	mov	dptr,#(_G_SELLV_RXEOMCLK + 0x0002)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_144
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:174: break;
;	../../shared/src/vdd_cal.c:175: case SELLV_RXDATACLK:
	sjmp	00125$
00122$:
;	../../shared/src/vdd_cal.c:176: reg_SELLV_RXDATACLK_CH0_3_0 = cmx_G_SELLV_RXDATACLK_CH0_7_0;  
	mov	dptr,#(_G_SELLV_RXDATACLK + 0x0003)
	movx	a,@dptr
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_142
	swap	a
	anl	a,#(0xf0&0xf0)
	mov	b,a
	movx	a,@dptr
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:177: reg_SELLV_RXDATACLK_CH1_3_0 = cmx_G_SELLV_RXDATACLK_CH1_7_0;  
	mov	dptr,#(_G_SELLV_RXDATACLK + 0x0002)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_142
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:182: break; 
;	../../shared/src/vdd_cal.c:183: case SELLV_RXSAMPLER:
	sjmp	00125$
00123$:
;	../../shared/src/vdd_cal.c:184: reg_SELLV_RXSAMPELR_CH0_3_0 = cmx_G_SELLV_RXSAMPELR_CH0_7_0;  
	mov	dptr,#(_G_SELLV_RXSAMPLER + 0x0003)
	movx	a,@dptr
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_146
	swap	a
	anl	a,#(0xf0&0xf0)
	mov	b,a
	movx	a,@dptr
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:185: reg_SELLV_RXSAMPELR_CH1_3_0 = cmx_G_SELLV_RXSAMPELR_CH1_7_0;  
	mov	dptr,#(_G_SELLV_RXSAMPLER + 0x0002)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_146
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:191: }	
00125$:
	pop	_bp
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'save_vdd_cal'
;------------------------------------------------------------
;cont                      Allocated to stack - offset -4
;val                       Allocated to stack - offset -5
;sel                       Allocated to registers r2 
;i                         Allocated to registers r3 
;gen                       Allocated to registers r4 
;------------------------------------------------------------
;	../../shared/src/vdd_cal.c:244: void save_vdd_cal(uint8_t sel, uint8_t cont, uint8_t val) BANKING_CTRL {
;	-----------------------------------------
;	 function save_vdd_cal
;	-----------------------------------------
_save_vdd_cal:
	push	_bp
	mov	_bp,sp
	mov	r2,dpl
;	../../shared/src/vdd_cal.c:247: i = cont;
	mov	a,_bp
	add	a,#0xfc
	mov	r0,a
	mov	ar3,@r0
;	../../shared/src/vdd_cal.c:248: gen = gen_tx;
	mov	dptr,#_gen_tx
	movx	a,@dptr
	mov	r4,a
;	../../shared/src/vdd_cal.c:249: if(phy_mode == SERDES) gen = 0;
	...
	mov	r4,#0x00
00102$:
;	../../shared/src/vdd_cal.c:251: switch(sel) {
	mov	a,#0x05
	cjne	a,ar2,00116$
00116$:
	jnc	00117$
...
00118$:
	...
	ljmp	00107$
	ljmp	00108$
;	../../shared/src/vdd_cal.c:252: case SELLV_TXCLK:  lnx_cal_sellv_txclk[i][gen] = val;  break;
00103$:
	mov	a,r3
	mov	b,#0x05
	mul	ab
	add	a,#_lnx_cal_sellv_txclk
	mov	r2,a
	clr	a
	addc	a,#(_lnx_cal_sellv_txclk >> 8)
	mov	r5,a
	mov	a,r4
	add	a,r2
	mov	dpl,a
	...
	movx	@dptr,a
	ljmp	00110$
;	../../shared/src/vdd_cal.c:253: case SELLV_TXDATA: lnx_cal_sellv_txdata[i][gen] = val;  break;  
00104$:
	mov	a,r3
	mov	b,#0x05
	mul	ab
	add	a,#_lnx_cal_sellv_txdata
	mov	r2,a
	clr	a
	addc	a,#(_lnx_cal_sellv_txdata >> 8)
	mov	r5,a
	mov	a,r4
	add	a,r2
	mov	dpl,a
	...
	mov	a,@r0
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:254: case SELLV_TXPRE:  lnx_cal_sellv_txpre[i][gen] = val;  break;  
	sjmp	00110$
00105$:
	mov	a,r3
	mov	b,#0x05
	mul	ab
	add	a,#_lnx_cal_sellv_txpre
	mov	r2,a
	clr	a
	addc	a,#(_lnx_cal_sellv_txpre >> 8)
	mov	r5,a
	mov	a,r4
	add	a,r2
	mov	dpl,a
	...
	mov	a,@r0
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:255: case SELLV_RXEOMCLK:  lnx_cal_sellv_rxeomclk[i][gen] = val;  break;
	sjmp	00110$
00106$:
	mov	a,r3
	mov	b,#0x05
	mul	ab
	add	a,#_lnx_cal_sellv_rxeomclk
	mov	r2,a
	clr	a
	addc	a,#(_lnx_cal_sellv_rxeomclk >> 8)
	mov	r5,a
	mov	a,r4
	add	a,r2
	mov	dpl,a
	...
	mov	a,@r0
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:256: case SELLV_RXDATACLK: lnx_cal_sellv_rxdataclk[i][gen] = val;  break;
	sjmp	00110$
00107$:
	mov	a,r3
	mov	b,#0x05
	mul	ab
	add	a,#_lnx_cal_sellv_rxdataclk
	mov	r2,a
	clr	a
	addc	a,#(_lnx_cal_sellv_rxdataclk >> 8)
	mov	r5,a
	mov	a,r4
	add	a,r2
	mov	dpl,a
	...
	mov	a,@r0
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:257: case SELLV_RXSAMPLER: lnx_cal_sellv_rxsampler[i][gen] = val;  break;
	sjmp	00110$
00108$:
	mov	a,r3
	mov	b,#0x05
	mul	ab
	add	a,#_lnx_cal_sellv_rxsampler
	mov	r2,a
	clr	a
	addc	a,#(_lnx_cal_sellv_rxsampler >> 8)
	mov	r3,a
	mov	a,r4
	add	a,r2
	mov	dpl,a
	...
	mov	a,@r0
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:258: }	
00110$:
	pop	_bp
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'get_vdd_cal'
;------------------------------------------------------------
;sel                       Allocated to registers r2 
;i                         Allocated to registers r3 
;gen                       Allocated to registers r4 
;val                       Allocated to stack - offset 1
;------------------------------------------------------------
;	../../shared/src/vdd_cal.c:261: uint8_t get_vdd_cal(uint8_t sel) BANKING_CTRL {
;	-----------------------------------------
;	 function get_vdd_cal
;	-----------------------------------------
_get_vdd_cal:
	push	_bp
	mov	_bp,sp
	inc	sp
	mov	r2,dpl
;	../../shared/src/vdd_cal.c:264: i = cont_cal_on;
	mov	c,_cont_cal_on
	clr	a
	rlc	a
	mov	r3,a
;	../../shared/src/vdd_cal.c:265: gen = gen_tx;
	mov	dptr,#_gen_tx
	movx	a,@dptr
	mov	r4,a
;	../../shared/src/vdd_cal.c:266: if(phy_mode == SERDES) gen = 0;
	mov	dptr,#(_SYSTEM + 0x0002)
	movx	a,@dptr
	anl	a,#0x07
	mov	r5,a
	...
	mov	r4,#0x00
00102$:
;	../../shared/src/vdd_cal.c:268: switch(sel) {
	mov	a,#0x05
	cjne	a,ar2,00116$
00116$:
	jnc	00117$
...
00118$:
	...
	ljmp	00107$
	ljmp	00108$
;	../../shared/src/vdd_cal.c:269: case SELLV_TXCLK:  val = lnx_cal_sellv_txclk[i][gen];  break;
00103$:
	mov	a,r3
	mov	b,#0x05
	mul	ab
	...
	movx	a,@dptr
	mov	r2,a
;	../../shared/src/vdd_cal.c:270: case SELLV_TXDATA: val = lnx_cal_sellv_txdata[i][gen];  break;  
	sjmp	00109$
00104$:
	mov	a,r3
	mov	b,#0x05
	...
	mov	r5,a
	mov	r2,a
;	../../shared/src/vdd_cal.c:271: case SELLV_TXPRE:  val = lnx_cal_sellv_txpre[i][gen];  break;  
	sjmp	00109$
00105$:
	mov	a,r3
	mov	b,#0x05
	...
	mov	r5,a
	mov	r2,a
;	../../shared/src/vdd_cal.c:272: case SELLV_RXEOMCLK:  val = lnx_cal_sellv_rxeomclk[i][gen];  break;
	sjmp	00109$
00106$:
	mov	a,r3
	mov	b,#0x05
	...
	mov	r5,a
	mov	r2,a
;	../../shared/src/vdd_cal.c:273: case SELLV_RXDATACLK: val = lnx_cal_sellv_rxdataclk[i][gen];  break;
	sjmp	00109$
00107$:
	mov	a,r3
	mov	b,#0x05
	...
	mov	r5,a
	mov	r2,a
;	../../shared/src/vdd_cal.c:274: case SELLV_RXSAMPLER: val = lnx_cal_sellv_rxsampler[i][gen];  break;
	sjmp	00109$
00108$:
	mov	a,r3
	mov	b,#0x05
	...
	mov	r3,a
	mov	r2,a
;	../../shared/src/vdd_cal.c:275: }	
00109$:
;	../../shared/src/vdd_cal.c:277: return val;
	mov	dpl,r2
	mov	sp,_bp
	pop	_bp
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'vdd_cal_calen'
;------------------------------------------------------------
;val                       Allocated to stack - offset -4
;sel                       Allocated to registers r2 
;------------------------------------------------------------
;	../../shared/src/vdd_cal.c:280: void vdd_cal_calen(uint8_t sel, uint8_t val ) BANKING_CTRL {
;	-----------------------------------------
;	 function vdd_cal_calen
;	-----------------------------------------
_vdd_cal_calen:
	push	_bp
	mov	_bp,sp
	mov	r2,dpl
;	../../shared/src/vdd_cal.c:281: switch(sel) {
	mov	a,#0x05
	cjne	a,ar2,00111$
00111$:
	jnc	00112$
...
00113$:
	...
	ljmp	00105$
	ljmp	00106$
;	../../shared/src/vdd_cal.c:282: case SELLV_TXCLK:  reg_CALEN_VDDA_TXCLK_LANE = val;  break;
00101$:
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_143
	mov	a,_bp
	add	a,#0xfc
	mov	r0,a
	mov	a,@r0
	...
	mov	acc.5,c
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:283: case SELLV_TXDATA: reg_CALEN_VDDA_TXDATA_LANE = val;  break;
	sjmp	00108$
00102$:
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_143
	mov	a,_bp
	...
	mov	acc.4,c
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:284: case SELLV_TXPRE:  reg_CALEN_VDDA_TXPRE_LANE = val;  break;
	sjmp	00108$
00103$:
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_143
	mov	a,_bp
	...
	mov	acc.3,c
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:285: case SELLV_RXEOMCLK:  reg_CALEN_VDDA_RXEOMCLK_LANE = val; reg_VDDA_RXCLK_HALF_EN_LANE = val; break;
	sjmp	00108$
00104$:
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_143
	mov	a,_bp
	...
	mov	acc.2,c
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:286: case SELLV_RXDATACLK: reg_CALEN_VDDA_RXDATACLK_LANE = val; reg_VDDA_RXCLK_HALF_EN_LANE = val; break;
	sjmp	00108$
00105$:
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_143
	mov	a,_bp
	...
	mov	acc.2,c
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:287: case SELLV_RXSAMPLER: reg_CALEN_VDDA_RXSAMPLER_LANE = val; reg_VDDA_RXCLK_HALF_EN_LANE = val; break;
	sjmp	00108$
00106$:
	...
	mov	acc.2,c
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:288: }	
00108$:
	pop	_bp
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'vdd_cal_set_pass'
;------------------------------------------------------------
;val                       Allocated to stack - offset -4
;sel                       Allocated to registers r2 
;------------------------------------------------------------
;	../../shared/src/vdd_cal.c:291: void vdd_cal_set_pass(uint8_t sel, uint8_t val ) BANKING_CTRL {
;	-----------------------------------------
;	 function vdd_cal_set_pass
;	-----------------------------------------
_vdd_cal_set_pass:
	push	_bp
	mov	_bp,sp
	mov	r2,dpl
;	../../shared/src/vdd_cal.c:292: switch(sel) {
	mov	a,#0x05
	cjne	a,ar2,00111$
00111$:
	jnc	00112$
...
00113$:
	...
	ljmp	00105$
	ljmp	00106$
;	../../shared/src/vdd_cal.c:293: case SELLV_TXCLK:  lnx_SELLV_TXCLK_PASS_LANE = val;  break;
00101$:
	...
	mov	acc.6,c
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:294: case SELLV_TXDATA: lnx_SELLV_TXDATA_PASS_LANE = val;  break;
	sjmp	00108$
00102$:
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0002)
	mov	a,_bp
	...
	mov	acc.7,c
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:295: case SELLV_TXPRE:  lnx_SELLV_TXPRE_PASS_LANE = val;  break;
	sjmp	00108$
00103$:
	...
	mov	acc.0,c
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:296: case SELLV_RXEOMCLK:  lnx_SELLV_RXEOMCLK_PASS_LANE = val;  break;
	sjmp	00108$
00104$:
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0003)
	mov	a,_bp
	...
	mov	acc.3,c
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:297: case SELLV_RXDATACLK: lnx_SELLV_RXDATACLK_PASS_LANE = val;  break;
	sjmp	00108$
00105$:
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0003)
	mov	a,_bp
	...
	mov	acc.2,c
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:298: case SELLV_RXSAMPLER: lnx_SELLV_RXSAMPLER_PASS_LANE = val;  break;
	sjmp	00108$
00106$:
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0003)
	mov	a,_bp
	...
	mov	acc.4,c
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:299: }	
00108$:
	pop	_bp
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'vdd_cal_sel'
;------------------------------------------------------------
;sel                       Allocated to registers r2 
;cal_value                 Allocated to registers 
;pass                      Allocated to registers 
;------------------------------------------------------------
;	../../shared/src/vdd_cal.c:302: void vdd_cal_sel( uint8_t sel ) BANKING_CTRL {
;	-----------------------------------------
;	 function vdd_cal_sel
;	-----------------------------------------
_vdd_cal_sel:
	mov	r2,dpl
;	../../shared/src/vdd_cal.c:306: lnx_VDD_CAL_DONE_LANE = 0;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:308: if( cmx_VDD_CAL_EXT_EN ) {
	mov	dptr,#(_CONTROL_CONFIG1 + 0x0002)
	movx	a,@dptr
	jnb	acc.7,00102$
;	../../shared/src/vdd_cal.c:309: cal_value = get_vdd_cal(sel);
	mov	dpl,r2
	push	ar2
	mov	r0,#_get_vdd_cal
	mov	r1,#(_get_vdd_cal >> 8)
	mov	r2,#(_get_vdd_cal >> 16)
	lcall	__sdcc_banked_call
	mov	r3,dpl
	pop	ar2
;	../../shared/src/vdd_cal.c:310: set_vdd_cal(sel, cal_value);
	push	ar3
	mov	dpl,r2
	mov	r0,#_set_vdd_cal
	mov	r1,#(_set_vdd_cal >> 8)
	mov	r2,#(_set_vdd_cal >> 16)
	lcall	__sdcc_banked_call
	dec	sp
;	../../shared/src/vdd_cal.c:311: lnx_VDD_CAL_DONE_LANE = 1;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:312: return;
	ljmp	00111$
00102$:
;	../../shared/src/vdd_cal.c:316: if ( cont_cal_on == 1 ) {
	jnb	_cont_cal_on,00110$
;	../../shared/src/vdd_cal.c:317: if( sel<=SELLV_TXPRE && (/*PU_TX == 1 0 ||*/ ANA_IDLE == 1))
	mov	a,#0x02
	cjne	a,ar2,00121$
00121$:
	clr	a
	...
	mov	r4,a
	cjne	r4,#0x01,00104$
;	../../shared/src/vdd_cal.c:318: return;
	sjmp	00111$
00104$:
;	../../shared/src/vdd_cal.c:319: if( sel>SELLV_TXPRE && (/*PU_RX == 1 0 ||*/ SQ_OUT == 1))
	mov	a,r3
	jz	00110$
	...
	mov	r3,a
	cjne	r3,#0x01,00110$
;	../../shared/src/vdd_cal.c:320: return;
	sjmp	00111$
00110$:
;	../../shared/src/vdd_cal.c:323: PHY_STATUS = ST_VDD_CAL;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x07
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:328: TRXDCCIN_SEL = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_17
	movx	a,@dptr
	anl	a,#0x1f
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:329: vdd_cal_calen(sel,1);
	push	ar2
	mov	a,#0x01
	push	acc
	mov	dpl,r2
	mov	r0,#_vdd_cal_calen
	mov	r1,#(_vdd_cal_calen >> 8)
	mov	r2,#(_vdd_cal_calen >> 16)
	lcall	__sdcc_banked_call
	dec	sp
	pop	ar2
;	../../shared/src/vdd_cal.c:331: pass = vdd_cal_op(sel);
	mov	dpl,r2
	push	ar2
	mov	r0,#_vdd_cal_op
	mov	r1,#(_vdd_cal_op >> 8)
	mov	r2,#(_vdd_cal_op >> 16)
	lcall	__sdcc_banked_call
	mov	r3,dpl
	pop	ar2
;	../../shared/src/vdd_cal.c:333: vdd_cal_set_pass(sel, pass);
	push	ar2
	push	ar3
	mov	dpl,r2
	mov	r0,#_vdd_cal_set_pass
	mov	r1,#(_vdd_cal_set_pass >> 8)
	mov	r2,#(_vdd_cal_set_pass >> 16)
	lcall	__sdcc_banked_call
	dec	sp
	pop	ar2
;	../../shared/src/vdd_cal.c:334: vdd_cal_calen(sel,0);
	clr	a
	push	acc
	mov	dpl,r2
	mov	r0,#_vdd_cal_calen
	...
	lcall	__sdcc_banked_call
	dec	sp
;	../../shared/src/vdd_cal.c:337: lnx_VDD_CAL_DONE_LANE = 1;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
00111$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'vdd_cal_op'
;------------------------------------------------------------
;sel                       Allocated to registers r2 
;op_done                   Allocated to registers r3 
;done_ptn                  Allocated to registers r4 
;run_cnt                   Allocated to registers r6 
;cal_value                 Allocated to registers r5 
;------------------------------------------------------------
;	../../shared/src/vdd_cal.c:341: bool vdd_cal_op (uint8_t sel ) BANKING_CTRL
;	-----------------------------------------
;	 function vdd_cal_op
;	-----------------------------------------
_vdd_cal_op:
	mov	r2,dpl
;	../../shared/src/vdd_cal.c:346: delay01(10);
	mov	dptr,#0x000A
	push	ar2
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	...
	lcall	__sdcc_banked_call
	pop	ar2
;	../../shared/src/vdd_cal.c:348: op_done =	0;
	mov	r3,#0x00
;	../../shared/src/vdd_cal.c:349: done_ptn=	0;
	mov	r4,#0x00
;	../../shared/src/vdd_cal.c:351: if (!cont_cal_on) //one time
	jb	_cont_cal_on,00102$
;	../../shared/src/vdd_cal.c:353: cal_value = tag_sellv_xx_default;
	mov	r5,#0x08
;	../../shared/src/vdd_cal.c:354: set_vdd_cal(sel, tag_sellv_xx_default);
	push	ar2
	push	ar3
	push	ar4
	push	ar5
	...
	lcall	__sdcc_banked_call
	dec	sp
;	../../shared/src/vdd_cal.c:356: TXDCC_CLK = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_136
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:358: delay01(150);
	mov	dptr,#0x0096
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/vdd_cal.c:359: TXDCC_CLK = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_136
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:361: delay01(150);
	mov	dptr,#0x0096
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	...
	sjmp	00132$
00102$:
;	../../shared/src/vdd_cal.c:364: cal_value = get_vdd_cal(sel);
	mov	dpl,r2
	push	ar2
	push	ar3
	push	ar4
	...
	pop	ar2
	mov	ar5,r6
;	../../shared/src/vdd_cal.c:367: while (op_done == 0) {
00132$:
	mov	r6,#0x00
00117$:
;	../../shared/src/vdd_cal.c:369: done_ptn <<= 1;
	mov	a,r4
	add	a,r4
	mov	r4,a
;	../../shared/src/vdd_cal.c:370: set_vdd_cal(sel, cal_value);
	push	ar2
	push	ar3
	push	ar4
	push	ar5
	...
	lcall	__sdcc_banked_call
	dec	sp
;	../../shared/src/vdd_cal.c:372: TXDCC_CLK = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_136
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:374: delay01(150);
	mov	dptr,#0x0096
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/vdd_cal.c:375: TXDCC_CLK = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_136
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/vdd_cal.c:377: delay01(150);
	mov	dptr,#0x0096
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	...
	pop	ar3
	pop	ar2
;	../../shared/src/vdd_cal.c:379: if(HIVDDR == 1) {
	mov	dptr,#_TX_CALIBRATION_LANE
	movx	a,@dptr
	anl	a,#0x01
	mov	r7,a
	cjne	r7,#0x01,00109$
;	../../shared/src/vdd_cal.c:380: done_ptn |= 0x01;
	orl	ar4,#0x01
;	../../shared/src/vdd_cal.c:381: if (cal_value > tag_MIN_VALUE ) cal_value--;
	mov	a,r5
	jz	00110$
	dec	r5
	sjmp	00110$
00109$:
;	../../shared/src/vdd_cal.c:384: if (cal_value < tag_MAX_VALUE) cal_value++;
	cjne	r5,#0x0F,00138$
00138$:
	jnc	00110$
	inc	r5
00110$:
;	../../shared/src/vdd_cal.c:387: done_ptn &= 0x0f;
	anl	ar4,#0x0F
;	../../shared/src/vdd_cal.c:388: if ((done_ptn == 0xa) || (done_ptn == 0x5)) {op_done = 1; break;}
	cjne	r4,#0x0A,00140$
	sjmp	00111$
00140$:
	cjne	r4,#0x05,00112$
00111$:
	...
	sjmp	00119$
00112$:
;	../../shared/src/vdd_cal.c:389: if ((cont_cal_on) || (run_cnt >= tag_MAX_RUN)) {break;}
	jb	_cont_cal_on,00119$
	cjne	r6,#0x20,00144$
00144$:
	jnc	00119$
;	../../shared/src/vdd_cal.c:392: run_cnt++;
	inc	r6
	ljmp	00117$
00119$:
;	../../shared/src/vdd_cal.c:395: save_vdd_cal(sel, cont_cal_on, cal_value);
	push	ar2
	push	ar3
	push	ar5
	push	ar5
	...
	push	acc
	mov	dpl,r2
	mov	r0,#_save_vdd_cal
	mov	r1,#(_save_vdd_cal >> 8)
	mov	r2,#(_save_vdd_cal >> 16)
	lcall	__sdcc_banked_call
	dec	sp
	dec	sp
	pop	ar5
	pop	ar3
	pop	ar2
;	../../shared/src/vdd_cal.c:396: if(!cont_cal_on) save_vdd_cal(sel, 1, cal_value);
	jb	_cont_cal_on,00121$
	push	ar3
	push	ar5
	mov	a,#0x01
	push	acc
	...
	pop	ar3
00121$:
;	../../shared/src/vdd_cal.c:398: return op_done;
	mov	dpl,r3
	ljmp	__sdcc_banked_ret
	.area CSEG    (CODE)
	.area BANK2   (CODE)
