...
; This file was generated Thu Oct 18 21:21:47 2018
;--------------------------------------------------------
	.module ring_pll_cal
...
;--------------------------------------------------------
	...
	.globl _ring_pll_cal
	.globl _ring_pll_cont
	.globl _ring_pll_fast_cal
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area BANK1   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'ring_pll_cal'
;------------------------------------------------------------
;cnt_rdy                   Allocated to registers r7 
;save_FBDIV_h              Allocated to stack - offset 1
;save_FBDIV_l              Allocated to stack - offset 2
;save_FBCK_SEL             Allocated to stack - offset 3
;Fmea                      Allocated to stack - offset 4
;temp                      Allocated to stack - offset 6
;dac_fine_max              Allocated to registers r2 r3 
;dac_fine_min              Allocated to registers r4 r5 
;tmp                       Allocated to registers r2 r3 
;------------------------------------------------------------
;	../../shared/src/ring_pll_cal.c:101: void ring_pll_cal( void ) BANKING_CTRL {
;	-----------------------------------------
;	 function ring_pll_cal
;	-----------------------------------------
_ring_pll_cal:
	ar2 = 0x02
	ar3 = 0x03
	...
	add	a,#0x07
	mov	sp,a
;	../../shared/src/ring_pll_cal.c:107: PHY_STATUS =  ST_PLL_CAL_RING_CAL;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x36
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:110: if(phy_mode == SERDES) {
	mov	dptr,#(_SYSTEM + 0x0002)
	movx	a,@dptr
	anl	a,#0x07
	mov	r2,a
	cjne	r2,#0x04,00110$
;	../../shared/src/ring_pll_cal.c:111: while(1) {
00107$:
;	../../shared/src/ring_pll_cal.c:112: if(cmx_PLL_CAL_DONE==1) {
	mov	dptr,#(_CAL_STATUS_READ + 0x0002)
	movx	a,@dptr
	anl	a,#0x01
	mov	r2,a
	cjne	r2,#0x01,00107$
;	../../shared/src/ring_pll_cal.c:113: if(cmx_PLL_CAL_DONE==1 && reg_PLLCAL_EN==0) break; //wait for LCPLL calibration done
	mov	dptr,#(_CAL_STATUS_READ + 0x0002)
	movx	a,@dptr
	anl	a,#0x01
	mov	r2,a
	...
	jb	acc.7,00107$
00110$:
;	../../shared/src/ring_pll_cal.c:122: cmx_PLL_CAL_RING_DONE = 0;
	mov	dptr,#(_CAL_STATUS_READ + 0x0003)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:125: if( cmx_RING_PLL_CAL_EXT_EN /*|| (phy_mode==PCIE && cmx_PLL_CAL_RING_PASS)*/) { //PCIe Link enable/disable test patch
	mov	dptr,#(_CONTROL_CONFIG1 + 0x0001)
	movx	a,@dptr
	jnb	acc.0,00112$
;	../../shared/src/ring_pll_cal.c:126: ringpll_load(PWR);
	mov	dpl,#0x00
	mov	r0,#_ringpll_load
	mov	r1,#(_ringpll_load >> 8)
	mov	r2,#(_ringpll_load >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/ring_pll_cal.c:127: SLLP_DAC_VALID = 1;	SLLP_DAC_VALID = 0;
	...
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:128: goto exit_out;
	ljmp	00241$
00112$:
;	../../shared/src/ring_pll_cal.c:134: cmx_PLL_CAL_RING_PASS = 1;
	mov	dptr,#(_CAL_STATUS_READ + 0x0001)
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:137: timeout=0;
	clr	_timeout
;	../../shared/src/ring_pll_cal.c:138: if(cmx_RINGPLL_CAL_TIMEOUT_DIS==0) {
	mov	dptr,#(_CAL_TIME_OUT_AND_DIS + 0x0001)
	movx	a,@dptr
	jb	acc.2,00114$
;	../../shared/src/ring_pll_cal.c:139: timeout_start((uint16_t)RINGPLL_TIMEOUT_TIMER);
	mov	_TMR1,#0xF0
	mov	(_TMR1 >> 8),#0xD8
	setb	_TR1
	clr	_timeout
00114$:
;	../../shared/src/ring_pll_cal.c:143: tmp = read_tsen();
	mov	r0,#_read_tsen
	mov	r1,#(_read_tsen >> 8)
	...
	mov	r2,dpl
	mov	r3,dph
;	../../shared/src/ring_pll_cal.c:144: if(tmp > TEMP_85 ) ringpll_dac_fine = 1280;
	clr	c
	mov	a,#0x86
	subb	a,r2
	mov	a,#(0xFF ^ 0x80)
	...
	sjmp	00121$
00120$:
;	../../shared/src/ring_pll_cal.c:145: else if(tmp < TEMP_85 && tmp > TEMP_5 ) ringpll_dac_fine = 1024;
	clr	c
	mov	a,r2
	subb	a,#0x86
	mov	a,r3
	...
	sjmp	00121$
00116$:
;	../../shared/src/ring_pll_cal.c:146: else ringpll_dac_fine = 768; 
	mov	dptr,#_ringpll_dac_fine
	clr	a
	movx	@dptr,a
	inc	dptr
	...
	movx	@dptr,a
00121$:
;	../../shared/src/ring_pll_cal.c:147: dac_fine_min = ringpll_dac_fine-DAC_FINE_DELTA_RANGE;
	mov	dptr,#_ringpll_dac_fine
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	addc	a,#0xff
	mov	r5,a
;	../../shared/src/ring_pll_cal.c:148: dac_fine_max = ringpll_dac_fine+DAC_FINE_DELTA_RANGE;
	mov	a,#0x80
	add	a,r2
	mov	r2,a
	clr	a
	addc	a,r3
	mov	r3,a
;	../../shared/src/ring_pll_cal.c:150: PLL_SPEED_RING = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_192
	movx	a,@dptr
	anl	a,#0x07
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:151: SLLP_DAC_COARSE_RING = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_193
	movx	a,@dptr
	anl	a,#0xf0
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:152: ringpll_dac_fine_output();
	push	ar2
	push	ar3
	push	ar4
	push	ar5
	mov	r0,#_ringpll_dac_fine_output
	mov	r1,#(_ringpll_dac_fine_output >> 8)
	mov	r2,#(_ringpll_dac_fine_output >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/ring_pll_cal.c:153: PLL_SHRTR_RING = 1;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_196
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:159: delay01(100);
	mov	dptr,#0x0064
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	...
	pop	ar3
	pop	ar2
;	../../shared/src/ring_pll_cal.c:160: PLL_CAL_EN_RING = 1;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_196
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:161: temp = cmx_REFCLK_FREQ_7_0;
	...
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/ring_pll_cal.c:162: temp--;
	mov	a,_bp
	add	a,#0x06
	mov	r0,a
	dec	@r0
	...
	dec	@r0
00314$:
;	../../shared/src/ring_pll_cal.c:167: reg_FBC_CNT_TIMER_15_0_b0 = (uint8_t)temp;
	mov	a,_bp
	add	a,#0x06
	mov	r0,a
	mov	ar6,@r0
	...
	mov	a,r6
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:168: reg_FBC_CNT_TIMER_15_0_b1 = (uint8_t)(temp >> 8);
	mov	a,_bp
	add	a,#0x06
	mov	r0,a
	inc	r0
	...
	mov	a,r6
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:170: reg_FBC_PLLCAL_RING_EN = 1;
	mov	dptr,#(_PLLCAL_REG1 + 0x0001)
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:177: save_FBDIV_h = reg_PLL_FBDIV_RING_9_8;
	...
	inc	r0
	mov	@r0,ar6
;	../../shared/src/ring_pll_cal.c:178: save_FBDIV_l = reg_PLL_FBDIV_RING_7_0;
	...
	inc	r0
	mov	@r0,ar7
;	../../shared/src/ring_pll_cal.c:179: save_FBCK_SEL = reg_ANA_FBCK_SEL_RING;
	...
	mov	r0,a
	mov	@r0,ar7
;	../../shared/src/ring_pll_cal.c:182: ringloadSpdtbl_4_fcnt();
	push	ar2
	push	ar3
	push	ar4
	push	ar5
	lcall	_ringloadSpdtbl_4_fcnt
;	../../shared/src/ring_pll_cal.c:185: delay01(40);
	mov	dptr,#0x0028
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	...
	pop	ar3
	pop	ar2
;	../../shared/src/ring_pll_cal.c:187: do {
00128$:
;	../../shared/src/ring_pll_cal.c:188: if((PLL_VDDVCO_OVERTH_RING==1&&cmx_PLL_VDDVCO_POLARITY_INV==0) ||
	mov	dptr,#(_PLLCAL_REG1 + 0x0001)
	movx	a,@dptr
	swap	a
	rl	a
	...
	mov	r7,a
	cjne	r7,#0x01,00127$
	mov	dptr,#_CON_CAL_STEP_SIZE5
	movx	a,@dptr
	jnb	acc.0,00164$
00127$:
;	../../shared/src/ring_pll_cal.c:189: (PLL_VDDVCO_OVERTH_RING==0&&cmx_PLL_VDDVCO_POLARITY_INV==1)) break;
	mov	dptr,#(_PLLCAL_REG1 + 0x0001)
	movx	a,@dptr
	jb	acc.3,00123$
	mov	dptr,#_CON_CAL_STEP_SIZE5
...
00319$:
00123$:
;	../../shared/src/ring_pll_cal.c:190: else SLLP_DAC_COARSE_RING++;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_193
	movx	a,@dptr
	anl	a,#0x0f
	mov	r7,a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:191: SLLP_DAC_VALID = 1;	SLLP_DAC_VALID = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_193
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
	...
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:192: delay01(40);
	mov	dptr,#0x0028
	push	ar2
	push	ar3
	push	ar4
	...
	pop	ar3
	pop	ar2
;	../../shared/src/ring_pll_cal.c:193: } while(SLLP_DAC_COARSE_RING < DAC_COARSE_MAX);
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_193
	movx	a,@dptr
	anl	a,#0x0f
	mov	r7,a
	...
	subb	a,#0x8f
	jc	00128$
;	../../shared/src/ring_pll_cal.c:197: do {
00164$:
;	../../shared/src/ring_pll_cal.c:208: cnt_rdy = reg_FBC_PLLCAL_CNT_READY;
	mov	dptr,#_PLLCAL_REG1
	movx	a,@dptr
	rr	a
	anl	a,#0x01
	mov	r7,a
;	../../shared/src/ring_pll_cal.c:209: reg_FBC_CNT_START = 0;
;	../../shared/src/ring_pll_cal.c:210: reg_FBC_CNT_START = 1;
	mov	dptr,#_PLLCAL_REG1
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
	...
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:211: if( cnt_rdy ) while(reg_FBC_PLLCAL_CNT_READY && !timeout);
	mov	a,r7
	jz	00138$
00132$:
	mov	dptr,#_PLLCAL_REG1
	...
	jnb	acc.1,00138$
	jnb	_timeout,00132$
;	../../shared/src/ring_pll_cal.c:212: while(!reg_FBC_PLLCAL_CNT_READY && !timeout);
00138$:
	mov	dptr,#_PLLCAL_REG1
	movx	a,@dptr
	jb	acc.1,00140$
	jnb	_timeout,00138$
00140$:
;	../../shared/src/ring_pll_cal.c:213: reg_FBC_CNT_START = 0;
	mov	dptr,#_PLLCAL_REG1
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:214: if( timeout ) break;
	jnb	_timeout,00326$
	ljmp	00195$
00326$:
;	../../shared/src/ring_pll_cal.c:215: Fmea = reg_FBC_PLLCAL_CNT_15_0_b0;
	...
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/ring_pll_cal.c:218: if(Fmea >= Ftarget_ring ) break; 
	...
	ljmp	00195$
00327$:
;	../../shared/src/ring_pll_cal.c:221: if(PLL_SPEED_RING == PLL_SPEED_RING_MAX) {
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_192
	movx	a,@dptr
	swap	a
	rl	a
	...
	mov	r6,a
	cjne	r6,#0x17,00146$
;	../../shared/src/ring_pll_cal.c:222: if( SLLP_DAC_COARSE_RING!=DAC_COARSE_MAX) {
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_193
	movx	a,@dptr
	anl	a,#0x0f
	mov	r6,a
	...
	sjmp	00158$
00330$:
;	../../shared/src/ring_pll_cal.c:223: SLLP_DAC_COARSE_RING++;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_193
	movx	a,@dptr
	anl	a,#0x0f
	mov	r6,a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:224: SLLP_DAC_VALID = 1;	SLLP_DAC_VALID = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_193
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
	...
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:225: delay01(40);
	mov	dptr,#0x0028
	push	ar2
	push	ar3
	push	ar4
	...
	pop	ar3
	pop	ar2
;	../../shared/src/ring_pll_cal.c:226: continue;
	ljmp	00165$
00146$:
;	../../shared/src/ring_pll_cal.c:230: PLL_SPEED_RING++;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_192
	movx	a,@dptr
	swap	a
	rl	a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:231: delay01(20);
	mov	dptr,#0x0014
	push	ar2
	push	ar3
	push	ar4
	...
	pop	ar3
	pop	ar2
;	../../shared/src/ring_pll_cal.c:234: while(((SLLP_DAC_COARSE_RING<DAC_COARSE_MAX) && \
00158$:
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_193
	movx	a,@dptr
	anl	a,#0x0f
	...
	jnb	acc.0,00159$
00155$:
;	../../shared/src/ring_pll_cal.c:236: (PLL_VDDVCO_OVERTH_RING && cmx_PLL_VDDVCO_POLARITY_INV)))||(PLL_SPEED_RING == PLL_SPEED_RING_MAX)) {
	mov	dptr,#(_PLLCAL_REG1 + 0x0001)
	movx	a,@dptr
	jnb	acc.3,00157$
	mov	dptr,#_CON_CAL_STEP_SIZE5
...
00337$:
00159$:
;	../../shared/src/ring_pll_cal.c:238: SLLP_DAC_COARSE_RING++;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_193
	movx	a,@dptr
	anl	a,#0x0f
	mov	r6,a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:239: SLLP_DAC_VALID = 1;	SLLP_DAC_VALID = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_193
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
	...
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:240: delay01(40);
	mov	dptr,#0x0028
	push	ar2
	push	ar3
	push	ar4
	...
	pop	ar3
	pop	ar2
;	../../shared/src/ring_pll_cal.c:242: if( SLLP_DAC_COARSE_RING>=DAC_COARSE_MAX ) {
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_193
	movx	a,@dptr
	anl	a,#0x0f
	mov	r6,a
	...
	ljmp	00158$
00338$:
;	../../shared/src/ring_pll_cal.c:243: if( ringpll_dac_fine<dac_fine_max ){
	mov	dptr,#_ringpll_dac_fine
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	ljmp	00229$
00339$:
;	../../shared/src/ring_pll_cal.c:244: ringpll_dac_fine += PWR_FINE_STEP;
	mov	dptr,#_ringpll_dac_fine
	mov	a,#0x20
	add	a,r6
	movx	@dptr,a
	...
	inc	dptr
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:245: ringpll_dac_fine_output();
	push	ar2
	push	ar3
	push	ar4
	push	ar5
	...
	mov	r2,#(_ringpll_dac_fine_output >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/ring_pll_cal.c:247: delay01(40);
	mov	dptr,#0x0028
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	...
	pop	ar3
	pop	ar2
;	../../shared/src/ring_pll_cal.c:249: else goto adjust;
	ljmp	00158$
00163$:
;	../../shared/src/ring_pll_cal.c:254: delay01(20);
	mov	dptr,#0x0014
	push	ar2
	push	ar3
	push	ar4
	...
	pop	ar2
00165$:
;	../../shared/src/ring_pll_cal.c:256: } while(Fmea < Ftarget_ring);
	mov	dptr,#_CONTROL_CONFIG5
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	ljmp	00164$
00340$:
;	../../shared/src/ring_pll_cal.c:261: while ( ringpll_dac_fine != 0 ) {
00195$:
	mov	dptr,#_ringpll_dac_fine
	movx	a,@dptr
	mov	r6,a
	...
	ljmp	00229$
00341$:
;	../../shared/src/ring_pll_cal.c:262: if( timeout ) break;
	jnb	_timeout,00342$
	ljmp	00229$
00342$:
;	../../shared/src/ring_pll_cal.c:264: ringpll_dac_fine -= PWR_FINE_STEP;
	mov	a,r6
	add	a,#0xe0
	mov	r6,a
	mov	a,r7
	...
	mov	a,r7
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:266: if( SLLP_DAC_COARSE_RING>0 && SLLP_DAC_COARSE_RING<DAC_COARSE_MAX) {
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_193
	movx	a,@dptr
	anl	a,#0x0f
	jnz	00343$
...
00343$:
	...
	ljmp	00179$
00344$:
;	../../shared/src/ring_pll_cal.c:269: if(ringpll_dac_fine<dac_fine_min) { 
	mov	dptr,#_ringpll_dac_fine
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	subb	a,r5
	jnc	00176$
;	../../shared/src/ring_pll_cal.c:270: ringpll_dac_fine += 300; 
	mov	dptr,#_ringpll_dac_fine
	mov	a,#0x2C
	add	a,r6
	movx	@dptr,a
	...
	inc	dptr
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:271: if( SLLP_DAC_COARSE_RING > DAC_COARSE_MIN )
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_193
	movx	a,@dptr
	anl	a,#0x0f
	jz	00179$
;	../../shared/src/ring_pll_cal.c:272: SLLP_DAC_COARSE_RING--;
	push	ar4
	push	ar5
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_193
	movx	a,@dptr
	...
	sjmp	00179$
00176$:
;	../../shared/src/ring_pll_cal.c:274: else if(ringpll_dac_fine>dac_fine_max) { 
	clr	c
	mov	a,r2
	subb	a,r6
	mov	a,r3
	subb	a,r7
	jnc	00179$
;	../../shared/src/ring_pll_cal.c:275: ringpll_dac_fine -= 300; 
	mov	a,r6
	add	a,#0xd4
	mov	r6,a
	mov	a,r7
	...
	mov	a,r7
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:276: if( SLLP_DAC_COARSE_RING < DAC_COARSE_MAX )
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_193
	movx	a,@dptr
	anl	a,#0x0f
	mov	r6,a
	...
	subb	a,#0x8f
	jnc	00179$
;	../../shared/src/ring_pll_cal.c:277: SLLP_DAC_COARSE_RING++;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_193
	movx	a,@dptr
	anl	a,#0x0f
	mov	r6,a
	...
	movx	@dptr,a
00179$:
;	../../shared/src/ring_pll_cal.c:281: ringpll_dac_fine_output();
	push	ar2
	push	ar3
	push	ar4
	push	ar5
	...
	mov	r2,#(_ringpll_dac_fine_output >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/ring_pll_cal.c:282: delay01(40);
	mov	dptr,#0x0028
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	...
	pop	ar3
	pop	ar2
;	../../shared/src/ring_pll_cal.c:293: cnt_rdy = reg_FBC_PLLCAL_CNT_READY;
	mov	dptr,#_PLLCAL_REG1
	movx	a,@dptr
	rr	a
	anl	a,#0x01
	mov	r6,a
	mov	r7,a
;	../../shared/src/ring_pll_cal.c:294: reg_FBC_CNT_START = 1;
	mov	dptr,#_PLLCAL_REG1
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:295: if( cnt_rdy ) while(reg_FBC_PLLCAL_CNT_READY && !timeout);
	mov	a,r7
	jz	00188$
00182$:
	mov	dptr,#_PLLCAL_REG1
	...
	jnb	acc.1,00188$
	jnb	_timeout,00182$
;	../../shared/src/ring_pll_cal.c:296: while(!reg_FBC_PLLCAL_CNT_READY && !timeout );
00188$:
	mov	dptr,#_PLLCAL_REG1
	movx	a,@dptr
	jb	acc.1,00190$
	jnb	_timeout,00188$
00190$:
;	../../shared/src/ring_pll_cal.c:297: reg_FBC_CNT_START = 0;
	mov	dptr,#_PLLCAL_REG1
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:298: if(timeout) break;
	jb	_timeout,00229$
;	../../shared/src/ring_pll_cal.c:299: Fmea = reg_FBC_PLLCAL_CNT_15_0;
	mov	dptr,#(_PLLCAL_REG0 + 0x0002)
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	inc	r0
	mov	@r0,ar7
;	../../shared/src/ring_pll_cal.c:302: if(Fmea <= Ftarget_ring ) break;
	mov	dptr,#_CONTROL_CONFIG5
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	ljmp	00195$
00355$:
;	../../shared/src/ring_pll_cal.c:306: do {
00229$:
;	../../shared/src/ring_pll_cal.c:307: if( timeout ) break;
	jnb	_timeout,00356$
	ljmp	00231$
00356$:
;	../../shared/src/ring_pll_cal.c:318: cnt_rdy = reg_FBC_PLLCAL_CNT_READY;
	mov	dptr,#_PLLCAL_REG1
	movx	a,@dptr
	rr	a
	anl	a,#0x01
	mov	r6,a
	mov	r7,a
;	../../shared/src/ring_pll_cal.c:319: reg_FBC_CNT_START = 1;
	mov	dptr,#_PLLCAL_REG1
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:320: if( cnt_rdy ) while(reg_FBC_PLLCAL_CNT_READY && !timeout);
	mov	a,r7
	jz	00208$
00202$:
	mov	dptr,#_PLLCAL_REG1
	...
	jnb	acc.1,00208$
	jnb	_timeout,00202$
;	../../shared/src/ring_pll_cal.c:321: while(!reg_FBC_PLLCAL_CNT_READY && !timeout);
00208$:
	mov	dptr,#_PLLCAL_REG1
	movx	a,@dptr
	jb	acc.1,00210$
	jnb	_timeout,00208$
00210$:
;	../../shared/src/ring_pll_cal.c:322: reg_FBC_CNT_START = 0;
	mov	dptr,#_PLLCAL_REG1
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:323: if (timeout) break;
	jnb	_timeout,00362$
	ljmp	00231$
00362$:
;	../../shared/src/ring_pll_cal.c:324: Fmea = reg_FBC_PLLCAL_CNT_15_0;
	mov	dptr,#(_PLLCAL_REG0 + 0x0002)
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	inc	r0
	mov	@r0,ar7
;	../../shared/src/ring_pll_cal.c:327: if (Fmea == Ftarget_ring) break;
	mov	dptr,#_CONTROL_CONFIG5
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	ljmp	00231$
00363$:
;	../../shared/src/ring_pll_cal.c:328: else if ( Fmea > Ftarget_ring ) {
	mov	dptr,#_CONTROL_CONFIG5
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	subb	a,@r0
	jnc	00214$
;	../../shared/src/ring_pll_cal.c:329: ringpll_dac_fine-=PWR_FINE_STEP;
	mov	dptr,#_ringpll_dac_fine
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	sjmp	00218$
00214$:
;	../../shared/src/ring_pll_cal.c:332: ringpll_dac_fine+=PWR_FINE_STEP;
	mov	dptr,#_ringpll_dac_fine
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	movx	@dptr,a
00218$:
;	../../shared/src/ring_pll_cal.c:334: if(ringpll_dac_fine<dac_fine_min) { 
	mov	dptr,#_ringpll_dac_fine
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	subb	a,r5
	jnc	00226$
;	../../shared/src/ring_pll_cal.c:335: ringpll_dac_fine += 300; 
	mov	dptr,#_ringpll_dac_fine
	mov	a,#0x2C
	add	a,r6
	movx	@dptr,a
	...
	inc	dptr
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:336: if(SLLP_DAC_COARSE_RING>DAC_COARSE_MIN)	SLLP_DAC_COARSE_RING--;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_193
	movx	a,@dptr
	anl	a,#0x0f
	jz	00227$
	...
	sjmp	00227$
00226$:
;	../../shared/src/ring_pll_cal.c:338: else if(ringpll_dac_fine>dac_fine_max) { 
	clr	c
	mov	a,r2
	subb	a,r6
	mov	a,r3
	subb	a,r7
	jnc	00227$
;	../../shared/src/ring_pll_cal.c:339: ringpll_dac_fine -= 300; 
	mov	a,r6
	add	a,#0xd4
	mov	r6,a
	mov	a,r7
	...
	mov	a,r7
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:340: if(SLLP_DAC_COARSE_RING<DAC_COARSE_MAX) SLLP_DAC_COARSE_RING++;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_193
	movx	a,@dptr
	anl	a,#0x0f
	mov	r6,a
	...
	movx	@dptr,a
00227$:
;	../../shared/src/ring_pll_cal.c:343: ringpll_dac_fine_output();
	push	ar2
	push	ar3
	push	ar4
	push	ar5
	...
	mov	r2,#(_ringpll_dac_fine_output >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/ring_pll_cal.c:345: delay01(40);
	mov	dptr,#0x0028
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	...
	pop	ar3
	pop	ar2
;	../../shared/src/ring_pll_cal.c:347: } while ((ringpll_dac_fine>0) && (ringpll_dac_fine<dac_fine_max));
	mov	dptr,#_ringpll_dac_fine
	movx	a,@dptr
	mov	r6,a
	inc	dptr
...
00370$:
00231$:
;	../../shared/src/ring_pll_cal.c:354: reg_PLL_FBDIV_RING_9_8 = save_FBDIV_h;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_188
	mov	r0,_bp
	inc	r0
	mov	a,@r0
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:355: reg_PLL_FBDIV_RING_7_0 = save_FBDIV_l;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_189
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	a,@r0
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:356: reg_ANA_FBCK_SEL_RING = save_FBCK_SEL;
	mov	dptr,#_PM_CMN_REG1
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	...
	mov	acc.2,c
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:359: reg_FBC_PLLCAL_RING_EN = 0;
	mov	dptr,#(_PLLCAL_REG1 + 0x0001)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:360: PLL_SHRTR_RING = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_196
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:361: PLL_CAL_EN_RING = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_196
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:363: timeout=0;
	clr	_timeout
;	../../shared/src/ring_pll_cal.c:364: if(cmx_RINGPLL_CAL_TIMEOUT_DIS==0) {
	mov	dptr,#(_CAL_TIME_OUT_AND_DIS + 0x0001)
	movx	a,@dptr
	jb	acc.2,00235$
;	../../shared/src/ring_pll_cal.c:365: timeout_start((uint16_t)RINGPLL_TIMEOUT_TIMER);
	mov	_TMR1,#0xF0
	mov	(_TMR1 >> 8),#0xD8
	setb	_TR1
	clr	_timeout
;	../../shared/src/ring_pll_cal.c:370: while(!reg_ANA_PLL_LOCK_RING_RD && !timeout);
00235$:
	...
	jnb	_timeout,00235$
00237$:
;	../../shared/src/ring_pll_cal.c:373: if(timeout) {
	jnb	_timeout,00239$
;	../../shared/src/ring_pll_cal.c:377: cmx_PLL_CAL_RING_PASS = 0;
	mov	dptr,#(_CAL_STATUS_READ + 0x0001)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:379: ringpll_load(PWR);
	mov	dpl,#0x00
	mov	r0,#_ringpll_load
	mov	r1,#(_ringpll_load >> 8)
	mov	r2,#(_ringpll_load >> 16)
	...
	sjmp	00241$
00239$:
;	../../shared/src/ring_pll_cal.c:382: ringpll_save(PWR);
	mov	dpl,#0x00
	mov	r0,#_ringpll_save
	mov	r1,#(_ringpll_save >> 8)
	mov	r2,#(_ringpll_save >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/ring_pll_cal.c:385: exit_out:
00241$:
;	../../shared/src/ring_pll_cal.c:386: ringpll_save(CONT);
	mov	dpl,#0x01
	mov	r0,#_ringpll_save
	mov	r1,#(_ringpll_save >> 8)
	mov	r2,#(_ringpll_save >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/ring_pll_cal.c:387: ring_size_counter_mid = (RINGPLL_CAL_COUNTER_SIZE >> 1);   //register give max value, use mid point as start
	mov	dptr,#(_CON_CAL_STEP_SIZE5 + 0x0002)
	movx	a,@dptr
	clr	c
	rrc	a
	mov	r2,a
	mov	dptr,#_ring_size_counter_mid
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:388: ring_size_counter = ring_size_counter_mid;
	mov	dptr,#_ring_size_counter
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:392: cmx_PLL_CAL_RING_DONE = 1;
	mov	dptr,#(_CAL_STATUS_READ + 0x0003)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
...
;------------------------------------------------------------
;Allocation info for local variables in function 'ring_pll_cont'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/ring_pll_cal.c:397: void ring_pll_cont(void) BANKING_CTRL {
;	-----------------------------------------
;	 function ring_pll_cont
;	-----------------------------------------
_ring_pll_cont:
;	../../shared/src/ring_pll_cal.c:398: PHY_STATUS =  ST_RING_PLL_CONT;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x3A
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:407: EA = 0;
	clr	_EA
;	../../shared/src/ring_pll_cal.c:408: ringpll_dac_fine = cmx_cal_sllp_dac_fine_ring[CONT][rate]; 
	mov	dptr,#(_CONTROL_CONFIG6 + 0x0003)
	movx	a,@dptr
	add	a,acc
	add	a,#(_cmx_cal_sllp_dac_fine_ring + 0x0004)
	mov	dpl,a
	clr	a
	addc	a,#((_cmx_cal_sllp_dac_fine_ring + 0x0004) >> 8)
	mov	dph,a
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	mov	a,r3
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:409: SLLP_DAC_FINE_RING_10_8 = (uint8_t)(ringpll_dac_fine>>8); 
	mov	ar4,r3
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:410: SLLP_DAC_FINE_RING_7_0 = (uint8_t)ringpll_dac_fine;
	mov	ar4,r2
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_195
	mov	a,r4
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:411: EA = 1;
	setb	_EA
;	../../shared/src/ring_pll_cal.c:413: if ((PLL_VCON_OVERTH_RING==0&&cmx_PLL_VCON_POLARITY_INV==0) || (PLL_VCON_OVERTH_RING&&cmx_PLL_VCON_POLARITY_INV) )
	mov	dptr,#(_PLLCAL_REG1 + 0x0001)
	movx	a,@dptr
	jb	acc.2,00106$
	mov	dptr,#_CON_CAL_STEP_SIZE5
...
00106$:
	...
	jnb	acc.1,00102$
00101$:
;	../../shared/src/ring_pll_cal.c:414: ring_size_counter ++;
	mov	dptr,#_ring_size_counter
	movx	a,@dptr
	add	a,#0x01
	movx	@dptr,a
	sjmp	00103$
00102$:
;	../../shared/src/ring_pll_cal.c:416: ring_size_counter --;
	mov	dptr,#_ring_size_counter
	movx	a,@dptr
	dec	a
	mov	dptr,#_ring_size_counter
	movx	@dptr,a
00103$:
;	../../shared/src/ring_pll_cal.c:422: if (ring_size_counter >= RINGPLL_CAL_COUNTER_SIZE) {
	mov	dptr,#(_CON_CAL_STEP_SIZE5 + 0x0002)
	movx	a,@dptr
	mov	r4,a
	mov	dptr,#_ring_size_counter
...
00132$:
	jc	00117$
;	../../shared/src/ring_pll_cal.c:423: ring_size_counter = ring_size_counter_mid;
	mov	dptr,#_ring_size_counter_mid
	movx	a,@dptr
	mov	dptr,#_ring_size_counter
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:424: if ( ringpll_dac_fine < (dac_fine_max_value - RINGPLL_CAL_FINE_STEP))
	...
	subb	a,r6
	jnc	00120$
;	../../shared/src/ring_pll_cal.c:425: ringpll_dac_fine += RINGPLL_CAL_FINE_STEP;
	mov	dptr,#(_CON_CAL_STEP_SIZE5 + 0x0001)
	movx	a,@dptr
	mov	r4,a
	mov	r6,#0x00
	...
	inc	dptr
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:427: goto ringpll_cont_ext0;
	sjmp	00118$
00117$:
;	../../shared/src/ring_pll_cal.c:429: else if (ring_size_counter == 0) {
	mov	a,r5
	jnz	00120$
;	../../shared/src/ring_pll_cal.c:430: ring_size_counter = ring_size_counter_mid;
	mov	dptr,#_ring_size_counter_mid
	movx	a,@dptr
	mov	dptr,#_ring_size_counter
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:431: if ( ringpll_dac_fine > RINGPLL_CAL_FINE_STEP )
	mov	dptr,#(_CON_CAL_STEP_SIZE5 + 0x0001)
	movx	a,@dptr
	mov	r4,a
	mov	r5,#0x00
	...
	subb	a,r3
	jnc	00120$
;	../../shared/src/ring_pll_cal.c:432: ringpll_dac_fine -= RINGPLL_CAL_FINE_STEP;
	mov	dptr,#(_CON_CAL_STEP_SIZE5 + 0x0001)
	movx	a,@dptr
	mov	r4,a
	mov	r5,#0x00
	...
	inc	dptr
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:437: goto ringpll_cont_ext0;
00118$:
;	../../shared/src/ring_pll_cal.c:439: ringpll_dac_fine_output();
	mov	r0,#_ringpll_dac_fine_output
	mov	r1,#(_ringpll_dac_fine_output >> 8)
	mov	r2,#(_ringpll_dac_fine_output >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/ring_pll_cal.c:444: ringpll_save(CONT);
	mov	dpl,#0x01
	mov	r0,#_ringpll_save
	mov	r1,#(_ringpll_save >> 8)
	mov	r2,#(_ringpll_save >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/ring_pll_cal.c:446: ringpll_cont_ext0:
00120$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'ring_pll_fast_cal'
;------------------------------------------------------------
;i                         Allocated to stack - offset 1
;cnt_rdy                   Allocated to registers r6 
;save_FBDIV_h              Allocated to registers r6 
;save_FBDIV_l              Allocated to stack - offset 2
;save_FBCK_SEL             Allocated to stack - offset 3
;first_op_ring             Allocated to stack - offset 4
;Fmea                      Allocated to stack - offset 5
;Fmea_prev                 Allocated to stack - offset 7
;Fdiff                     Allocated to stack - offset 9
;delta_code                Allocated to stack - offset 11
;delta_code_first          Allocated to registers r4 r5 
;delta_code_nom            Allocated to registers r2 r3 
;sloc0                     Allocated to stack - offset 13
;------------------------------------------------------------
;	../../shared/src/ring_pll_cal.c:455: void ring_pll_fast_cal(void) BANKING_CTRL {
;	-----------------------------------------
;	 function ring_pll_fast_cal
;	-----------------------------------------
_ring_pll_fast_cal:
	push	_bp
	mov	a,sp
	...
	add	a,#0x0d
	mov	sp,a
;	../../shared/src/ring_pll_cal.c:461: Fmea_prev = 0;
	mov	a,_bp
	add	a,#0x07
	mov	r0,a
	mov	@r0,#0x00
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/ring_pll_cal.c:463: delta_code_first = 0;
	mov	r4,#0x00
	mov	r5,#0x00
;	../../shared/src/ring_pll_cal.c:471: timeout=0;
	clr	_timeout
;	../../shared/src/ring_pll_cal.c:472: if(cmx_RINGPLL_CAL_TIMEOUT_DIS==0) {
	mov	dptr,#(_CAL_TIME_OUT_AND_DIS + 0x0001)
	movx	a,@dptr
	jb	acc.2,00102$
;	../../shared/src/ring_pll_cal.c:473: timeout_start((uint16_t)RINGPLL_TIMEOUT_TIMER);
	mov	_TMR1,#0xF0
	mov	(_TMR1 >> 8),#0xD8
	setb	_TR1
	clr	_timeout
00102$:
;	../../shared/src/ring_pll_cal.c:487: if(reg_ANA_PU_PLL_DLY_RING==0) {
	mov	dptr,#(_PM_CMN_REG2 + 0x0001)
	movx	a,@dptr
	jb	acc.2,00104$
;	../../shared/src/ring_pll_cal.c:488: reg_ANA_PU_PLL_RING = 1;
	mov	dptr,#_INPUT_CMN_PIN_REG2
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:489: delay01(5);
	mov	dptr,#0x0005
	push	ar4
	push	ar5
	mov	r0,#_delay01
	...
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/ring_pll_cal.c:490: reg_ANA_PU_PLL_DLY_RING = 1;
	mov	dptr,#(_PM_CMN_REG2 + 0x0001)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:491: delay01(5);
	mov	dptr,#0x0005
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	...
	pop	ar5
	pop	ar4
;	../../shared/src/ring_pll_cal.c:492: reg_RESET_ANA_RING = 0;
	mov	dptr,#(_PLLCAL_REG1 + 0x0003)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
00104$:
;	../../shared/src/ring_pll_cal.c:496: PLL_SHRTR_RING = 1;
	push	ar4
	push	ar5
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_196
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:497: PLL_CAL_EN_RING = 1;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_196
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:498: reg_FBC_CNT_START = 0;
	mov	dptr,#_PLLCAL_REG1
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:505: save_FBDIV_h = reg_PLL_FBDIV_RING_9_8;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_188
	movx	a,@dptr
	rr	a
	anl	a,#0x03
	mov	r6,a
;	../../shared/src/ring_pll_cal.c:506: save_FBDIV_l = reg_PLL_FBDIV_RING_7_0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_189
	movx	a,@dptr
	mov	r7,a
	mov	r0,_bp
	...
	inc	r0
	mov	@r0,ar7
;	../../shared/src/ring_pll_cal.c:507: save_FBCK_SEL = reg_ANA_FBCK_SEL_RING;
	mov	dptr,#_PM_CMN_REG1
	movx	a,@dptr
	rr	a
	rr	a
	...
	mov	r0,a
	mov	@r0,ar4
;	../../shared/src/ring_pll_cal.c:509: ringloadSpdtbl_4_fcnt();
	push	ar4
	push	ar5
	push	ar6
	lcall	_ringloadSpdtbl_4_fcnt
;	../../shared/src/ring_pll_cal.c:511: ringpll_load(CONT);
	mov	dpl,#0x01
	mov	r0,#_ringpll_load
	mov	r1,#(_ringpll_load >> 8)
	mov	r2,#(_ringpll_load >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/ring_pll_cal.c:512: SLLP_DAC_VALID = 1;  SLLP_DAC_VALID = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_193
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
	...
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:514: delay01(40); //first DAC_VALID need 8uS settling time from next new DAC value
	mov	dptr,#0x0028
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	...
	pop	ar5
	pop	ar4
;	../../shared/src/ring_pll_cal.c:516: reg_FBC_PLLCAL_RING_EN = 1;
	mov	dptr,#(_PLLCAL_REG1 + 0x0001)
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:518: i = 0;
	mov	a,_bp
	add	a,#0x0d
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/ring_pll_cal.c:519: first_op_ring = 0;
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/ring_pll_cal.c:662: pll_clk_ready_ring_1();
	pop	ar5
	pop	ar4
;	../../shared/src/ring_pll_cal.c:521: do {
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x00
00142$:
;	../../shared/src/ring_pll_cal.c:529: cnt_rdy = reg_FBC_PLLCAL_CNT_READY;
	push	ar6
	mov	dptr,#_PLLCAL_REG1
	movx	a,@dptr
	rr	a
	anl	a,#0x01
	mov	r6,a
;	../../shared/src/ring_pll_cal.c:530: reg_FBC_CNT_START = 1;
	mov	dptr,#_PLLCAL_REG1
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:531: if( cnt_rdy ) while(reg_FBC_PLLCAL_CNT_READY && !timeout);
	mov	a,r6
	pop	ar6
	jz	00112$
00106$:
	...
	jnb	acc.1,00112$
	jnb	_timeout,00106$
;	../../shared/src/ring_pll_cal.c:532: while(!reg_FBC_PLLCAL_CNT_READY && !timeout);
00112$:
	mov	dptr,#_PLLCAL_REG1
	movx	a,@dptr
	jb	acc.1,00114$
	jnb	_timeout,00112$
00114$:
;	../../shared/src/ring_pll_cal.c:533: reg_FBC_CNT_START = 0;
	mov	dptr,#_PLLCAL_REG1
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:535: if(timeout) {
	jnb	_timeout,00184$
	ljmp	00144$
00184$:
;	../../shared/src/ring_pll_cal.c:544: Fmea = reg_FBC_PLLCAL_CNT_15_0;
	push	ar6
	mov	dptr,#(_PLLCAL_REG0 + 0x0002)
	movx	a,@dptr
	mov	r6,a
	...
	inc	r0
	mov	@r0,ar2
;	../../shared/src/ring_pll_cal.c:556: if((Fmea >= (Ftarget_ring-TARGET_RANGE)) && (Fmea <= (Ftarget_ring+TARGET_RANGE))) {
	mov	dptr,#_CONTROL_CONFIG5
	movx	a,@dptr
	mov	r2,a
	inc	dptr
...
00187$:
	...
	subb	a,@r0
	jc	00139$
;	../../shared/src/ring_pll_cal.c:557: if (i == 0)	first_op_ring = 1;
	mov	r0,_bp
	inc	r0
	mov	a,@r0
	jnz	00118$
	...
	mov	@r0,#0x01
00118$:
;	../../shared/src/ring_pll_cal.c:558: if (i >= min_step_number) {
	mov	r0,_bp
	inc	r0
	cjne	@r0,#0x01,00190$
00190$:
	...
	ljmp	00140$
00191$:
;	../../shared/src/ring_pll_cal.c:562: break;  //1
	ljmp	00144$
00139$:
;	../../shared/src/ring_pll_cal.c:567: if((i == 0)||(first_op_ring == 1)) {
	mov	r0,_bp
	inc	r0
	mov	a,@r0
	jz	00124$
	...
	cjne	@r0,#0x01,00125$
00124$:
;	../../shared/src/ring_pll_cal.c:568: first_op_ring = 0;
	push	ar6
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/ring_pll_cal.c:569: delta_code = (Ftarget_ring - Fmea)<<code_ratio; //5; // * code_ratio;
	mov	dptr,#_CONTROL_CONFIG5
	movx	a,@dptr
	mov	r2,a
	inc	dptr
...
00196$:
	...
	inc	r0
	mov	@r0,ar3
;	../../shared/src/ring_pll_cal.c:570: delta_code_first = delta_code;
	mov	a,_bp
	add	a,#0x0b
	mov	r0,a
	mov	ar4,@r0
	...
	ljmp	00126$
00125$:
;	../../shared/src/ring_pll_cal.c:573: Fdiff = Fmea - Fmea_prev;
	push	ar6
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
	...
	inc	r0
	mov	@r0,ar3
;	../../shared/src/ring_pll_cal.c:574: delta_code_nom = (Ftarget_ring - Fmea) * delta_code_first;
	mov	dptr,#_CONTROL_CONFIG5
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	dec	sp
	pop	ar6
;	../../shared/src/ring_pll_cal.c:575: if (Fdiff == 0)
	pop	ar6
	mov	a,_bp
	add	a,#0x09
	mov	r0,a
	...
	orl	a,@r0
	jnz	00122$
;	../../shared/src/ring_pll_cal.c:576: delta_code = (Ftarget_ring - Fmea) * fdiff_0;
	mov	dptr,#_CONTROL_CONFIG5
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	sjmp	00123$
00122$:
;	../../shared/src/ring_pll_cal.c:578: delta_code = delta_code_nom / Fdiff;
	push	ar6
	mov	a,_bp
	add	a,#0x09
	mov	r0,a
	...
	mov	@r0,ar3
00123$:
;	../../shared/src/ring_pll_cal.c:579: delta_code_first = delta_code;
	mov	a,_bp
	add	a,#0x0b
	mov	r0,a
	mov	ar4,@r0
	...
	mov	ar5,@r0
00126$:
;	../../shared/src/ring_pll_cal.c:582: ringpll_dac_fine = ringpll_dac_fine + delta_code;
	mov	dptr,#_ringpll_dac_fine
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	inc	dptr
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:584: if (ringpll_dac_fine >= dac_fine_max_value) 
	mov	dptr,#_ringpll_dac_fine
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	subb	a,#0x07
	jc	00131$
;	../../shared/src/ring_pll_cal.c:585: ringpll_dac_fine = dac_fine_max_value;
	mov	dptr,#_ringpll_dac_fine
	mov	a,#0xFF
	movx	@dptr,a
	inc	dptr
	...
	sjmp	00132$
00131$:
;	../../shared/src/ring_pll_cal.c:586: else if (ringpll_dac_fine <= 0)
	mov	a,r2
	orl	a,r3
	jnz	00132$
;	../../shared/src/ring_pll_cal.c:587: ringpll_dac_fine = 0;
	mov	dptr,#_ringpll_dac_fine
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
00132$:
;	../../shared/src/ring_pll_cal.c:589: if ((ringpll_dac_fine == dac_fine_max_value) || (ringpll_dac_fine == 0)) {
	mov	dptr,#_ringpll_dac_fine
	movx	a,@dptr
	mov	r2,a
	inc	dptr
...
00200$:
	...
	jnz	00136$
00135$:
;	../../shared/src/ring_pll_cal.c:590: if (i >= min_step_number) {
	mov	r0,_bp
	inc	r0
	cjne	@r0,#0x01,00202$
00202$:
	jc	00136$
;	../../shared/src/ring_pll_cal.c:594: cmx_PLL_CAL_RING_PASS = 0;
	mov	dptr,#(_CAL_STATUS_READ + 0x0001)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:599: break;
	sjmp	00144$
00136$:
;	../../shared/src/ring_pll_cal.c:603: Fmea_prev = Fmea;
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
	mov	a,_bp
	...
	mov	a,@r0
	mov	@r1,a
;	../../shared/src/ring_pll_cal.c:604: ringpll_dac_fine_output();
	push	ar4
	push	ar5
	push	ar6
	mov	r0,#_ringpll_dac_fine_output
	...
	mov	r2,#(_ringpll_dac_fine_output >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/ring_pll_cal.c:616: delay01(30); //6uSec settling time required after from second DAC_VALID toggle to new DAC value or SHRTR=0 
	mov	dptr,#0x001E
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	...
	pop	ar4
00140$:
;	../../shared/src/ring_pll_cal.c:618: i++;
	mov	r0,_bp
	inc	r0
	inc	@r0
	mov	r0,_bp
	...
	mov	a,@r0
	mov	@r1,a
;	../../shared/src/ring_pll_cal.c:620: } while (i < max_step_number);
...
00205$:
00144$:
;	../../shared/src/ring_pll_cal.c:621: reg_MCU_DEBUGF_LANE_7_0 = i; //test
	mov	dptr,#(_MCU_DEBUG3_LANE + 0x0003)
	mov	a,_bp
	add	a,#0x0d
	mov	r0,a
	mov	a,@r0
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:622: reg_FBC_PLLCAL_RING_EN = 0;
	mov	dptr,#(_PLLCAL_REG1 + 0x0001)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:623: ringpll_save(CONT);
	mov	dpl,#0x01
	push	ar6
	mov	r0,#_ringpll_save
	mov	r1,#(_ringpll_save >> 8)
	...
	lcall	__sdcc_banked_call
	pop	ar6
;	../../shared/src/ring_pll_cal.c:630: reg_PLL_FBDIV_RING_9_8 = save_FBDIV_h;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_188
	mov	a,r6
	add	a,r6
	anl	a,#0x06
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:631: reg_PLL_FBDIV_RING_7_0 = save_FBDIV_l;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_189
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	a,@r0
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:632: reg_ANA_FBCK_SEL_RING = save_FBCK_SEL;
	mov	dptr,#_PM_CMN_REG1
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	...
	mov	acc.2,c
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:635: ring_size_counter = ring_size_counter_mid;
	mov	dptr,#_ring_size_counter_mid
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_ring_size_counter
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:637: PLL_CAL_EN_RING = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_196
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:638: PLL_SHRTR_RING = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_196
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/ring_pll_cal.c:643: while(!reg_ANA_PLL_LOCK_RING_RD && !timeout);
00146$:
	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
	movx	a,@dptr
	jb	acc.7,00148$
	jnb	_timeout,00146$
00148$:
;	../../shared/src/ring_pll_cal.c:649: if(timeout) cmx_PLL_CAL_RING_PASS = 0;
	jnb	_timeout,00150$
	mov	dptr,#(_CAL_STATUS_READ + 0x0001)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
00150$:
;	../../shared/src/ring_pll_cal.c:658: if(PHY_STATUS != ST_SPDCHG) {
	mov	dptr,#_MCU_STATUS0_LANE
	movx	a,@dptr
	mov	r2,a
	cjne	r2,#0x19,00209$
	sjmp	00152$
00209$:
;	../../shared/src/ring_pll_cal.c:659: delay01(200);	//delay 20usec for glitch
	mov	dptr,#0x00C8
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
