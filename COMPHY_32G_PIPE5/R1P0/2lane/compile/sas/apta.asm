...
;--------------------------------------------------------
	.globl _apta_local_ctrl_sim_tb
	.globl _apta_local_ctrl_tb
	.globl _apta_l_r_error_check
	.globl _TF2
	.globl _TI
	.globl _RI
	.globl _EX12
...
;--------------------------------------------------------
	.area BANK1   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'apta_l_r_error_check'
;------------------------------------------------------------
;error_flag                Allocated to stack - offset 1
;ctrl                      Allocated to registers r3 
;status                    Allocated to registers r4 
;c1                        Allocated to stack - offset 2
;c0                        Allocated to stack - offset 3
;cn1                       Allocated to stack - offset 4
;g1                        Allocated to registers r7 
;g0                        Allocated to registers r2 
;gn1                       Allocated to registers r3 
;------------------------------------------------------------
;	../../shared/src/apta.c:18: uint8_t apta_l_r_error_check(void) BANKING_CTRL {
;	-----------------------------------------
;	 function apta_l_r_error_check
;	-----------------------------------------
_apta_l_r_error_check:
	ar2 = 0x02
	ar3 = 0x03
	ar4 = 0x04
	ar5 = 0x05
	...
	add	a,#0x04
	mov	sp,a
;	../../shared/src/apta.c:23: error_flag = 0;
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/apta.c:24: ctrl = reg_LOCAL_CTRL_FIELD_LANE_15_0 & 0x3f;	
	...
	movx	a,@dptr
	anl	ar3,#0x3F
;	../../shared/src/apta.c:25: status = reg_REMOTE_STATUS_FIELD_RD_LANE_15_0_b0 & 0x3f;
	mov	dptr,#_TX_TRAIN_IF_REG6
	movx	a,@dptr
	mov	r4,a
	anl	ar4,#0x3F
;	../../shared/src/apta.c:26: c1 = ctrl & 0x30;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	a,#0x30
	anl	a,r3
	mov	@r0,a
;	../../shared/src/apta.c:27: c0 = ctrl & 0x0c;
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	a,#0x0C
	anl	a,r3
	mov	@r0,a
;	../../shared/src/apta.c:28: cn1 = ctrl & 0x03;
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,#0x03
	anl	a,r3
	mov	@r0,a
;	../../shared/src/apta.c:29: g1 = status & 0x30;
	mov	a,#0x30
	anl	a,r4
	mov	r7,a
;	../../shared/src/apta.c:30: g0 = status & 0x0c;
	mov	a,#0x0C
	anl	a,r4
	mov	r2,a
;	../../shared/src/apta.c:31: gn1 = status & 0x03;
	mov	a,#0x03
	anl	a,r4
	mov	r3,a
;	../../shared/src/apta.c:33: switch (reg_LOCAL_CTRL_FIELD_LANE_15_0) {
	mov	dptr,#(_DME_ENC_REG1 + 0x0002)
	movx	a,@dptr
	mov	r6,a
	inc	dptr
...
00166$:
	...
	sjmp	00106$
00167$:
;	../../shared/src/apta.c:34: case 0x0400: //APTA_START:	
	cjne	r6,#0x00,00109$
	cjne	r5,#0x0C,00109$
	sjmp	00106$
00101$:
;	../../shared/src/apta.c:35: if(((status)!= 0) ||
	mov	a,r4
	jnz	00102$
;	../../shared/src/apta.c:36: ((reg_REMOTE_STATUS_FIELD_RD_LANE_15_0_b1&0x3f)!= 0)) error_flag = 1;
...
00102$:
	...
	inc	r0
	mov	@r0,#0x01
;	../../shared/src/apta.c:37: break;
	ljmp	00141$
;	../../shared/src/apta.c:39: case 0x0c00: //APTA_TERM:
00106$:
;	../../shared/src/apta.c:40: if(status!= 0x15) error_flag = 1;
	cjne	r4,#0x15,00171$
	ljmp	00141$
00171$:
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x01
;	../../shared/src/apta.c:41: break;
	ljmp	00141$
;	../../shared/src/apta.c:42: default:	
00109$:
;	../../shared/src/apta.c:43: if((reg_REMOTE_STATUS_FIELD_RD_LANE_15_0_b1&0x0c)!= 0) error_flag = 1;
	mov	dptr,#(_TX_TRAIN_IF_REG6 + 0x0001)
	movx	a,@dptr
	mov	r5,a
	anl	a,#0x0C
	...
	mov	@r0,#0x01
00111$:
;	../../shared/src/apta.c:44: if(status == 0) error_flag = 1;
	mov	a,r4
	jnz	00113$
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x01
00113$:
;	../../shared/src/apta.c:46: if(((cn1 == 0x01) && (gn1==0x02 || gn1==0x00)) || //inc
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	cjne	@r0,#0x01,00120$
...
00176$:
	...
	jz	00114$
00120$:
;	../../shared/src/apta.c:47: ((cn1 == 0x02) && (gn1==0x03 || gn1==0x00)) || //dec
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	cjne	@r0,#0x02,00122$
...
00180$:
	...
	jz	00114$
00122$:
;	../../shared/src/apta.c:48: ((cn1 == 0x00) && (gn1!=0x00)) ){ 
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,@r0
	...
	jz	00115$
00114$:
;	../../shared/src/apta.c:49: error_flag = 1;
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x01
00115$:
;	../../shared/src/apta.c:52: if(((c0 == 0x04) && (g0==0x08 || g0==0x00)) || //inc
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	cjne	@r0,#0x04,00129$
...
00186$:
	...
	jz	00123$
00129$:
;	../../shared/src/apta.c:53: ((c0 == 0x08) && (g0==0x0c || g0==0x00)) ||  //dec
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	cjne	@r0,#0x08,00131$
...
00190$:
	...
	jz	00123$
00131$:
;	../../shared/src/apta.c:54: ((c0 == 0x0) && (g0!=0x00)) ){
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	a,@r0
	...
	jz	00124$
00123$:
;	../../shared/src/apta.c:55: error_flag = 1; 
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x01
00124$:
;	../../shared/src/apta.c:58: if(((c1 == 0x10) && (g1==0x20 || g1==0x00)) || //inc
	mov	r0,_bp
	inc	r0
	inc	r0
	cjne	@r0,#0x10,00138$
...
00196$:
	...
	jz	00132$
00138$:
;	../../shared/src/apta.c:59: ((c1 == 0x20) && (g1==0x30 || g1==0x00)) || //dec
	mov	r0,_bp
	inc	r0
	inc	r0
	cjne	@r0,#0x20,00140$
...
00200$:
	...
	jz	00132$
00140$:
;	../../shared/src/apta.c:60: ((c1 == 0) && ( g1!=0x00)) ) {
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	a,@r0
	...
	jz	00141$
00132$:
;	../../shared/src/apta.c:61: error_flag = 1; 
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x01
;	../../shared/src/apta.c:64: }	
00141$:
;	../../shared/src/apta.c:66: return error_flag;
	mov	r0,_bp
	inc	r0
	mov	dpl,@r0
	mov	sp,_bp
...
;------------------------------------------------------------
;Allocation info for local variables in function 'apta_txtrain'
;------------------------------------------------------------
;ctrl_inx                  Allocated to registers r3 
;cmd_if_on                 Allocated to registers r2 
;local_ctrl_field          Allocated to registers r3 r4 
;------------------------------------------------------------
;	../../shared/src/apta.c:115: void apta_txtrain(void) BANKING_CTRL{
;	-----------------------------------------
;	 function apta_txtrain
;	-----------------------------------------
_apta_txtrain:
;	../../shared/src/apta.c:122: reg_MCU_DEBUG0_LANE_7_0 = 3;
	mov	dptr,#_MCU_DEBUG0_LANE
	mov	a,#0x03
	movx	@dptr,a
;	../../shared/src/apta.c:123: cmd_if_on = 0;
	mov	r2,#0x00
;	../../shared/src/apta.c:124: if( reg_PIN_PAPTA_TRAIN_ENABLE_RD_LANE && reg_PIN_LOCAL_CTRL_FIELD_READY_RD_LANE) { //Xu: When Remote enable LOCAL_CTRL_FIELD_READY=1, Remote have to wait LOCAL_CTRL_VALID toggle.
...
00152$:
	...
	ljmp	00128$
00153$:
;	../../shared/src/apta.c:126: if(cmx_APTA_TRAIN_CMD_IF_EN && PHY_MCU_REMOTE_REQ_LANE && lnx_PHY_MCU_LOCAL_ACK_LANE==0) {
	...
	movx	a,@dptr
	jb	acc.0,00113$
;	../../shared/src/apta.c:127: reg_PHY_MCU_REMOTE_REQ_ISR_CLEAR_LANE = 1; 
;	../../shared/src/apta.c:128: reg_PHY_MCU_REMOTE_REQ_ISR_CLEAR_LANE = 0;
	...
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/apta.c:129: if(lnx_PHY_REMOTE_CTRL_COMMAND_TYPE_LANE_7_0==0x60 ){ //CMD_IF
	mov	dptr,#(_PHY_REMOTE_CTRL_COMMAND_LANE + 0x0003)
	movx	a,@dptr
	mov	r3,a
	cjne	r3,#0x60,00104$
;	../../shared/src/apta.c:130: ctrl_inx = (uint8_t)lnx_PHY_REMOTE_CTRL_COMMAND_CODE_LANE_15_0;				
	...
	movx	a,@dptr
	mov	r4,a
;	../../shared/src/apta.c:131: reg_MCU_DEBUG0_LANE_7_0 = 1;		
	mov	dptr,#_MCU_DEBUG0_LANE
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/apta.c:132: if(ctrl_inx>=APTA_ZERO)  {
	cjne	r3,#0x0D,00159$
00159$:
	jc	00102$
;	../../shared/src/apta.c:133: cmd_if_on = 2;					
	mov	r2,#0x02
;	../../shared/src/apta.c:134: goto cmd_if_exit; 
	ljmp	00128$
00102$:
;	../../shared/src/apta.c:136: cmd_if_on = 1;
	mov	r2,#0x01
	sjmp	00114$
00104$:
;	../../shared/src/apta.c:139: cmd_if_on = 2;
	mov	r2,#0x02
;	../../shared/src/apta.c:140: goto cmd_if_exit;
	ljmp	00128$
00113$:
;	../../shared/src/apta.c:143: else if(cmx_APTA_TRAIN_SIM_EN) {
	mov	dptr,#(_CONTROL_CONFIG0 + 0x0003)
	movx	a,@dptr
	jb	acc.5,00161$
	ljmp	00134$
00161$:
;	../../shared/src/apta.c:144: reg_MCU_DEBUG0_LANE_7_0 = 4;
	mov	dptr,#_MCU_DEBUG0_LANE
	mov	a,#0x04
	movx	@dptr,a
;	../../shared/src/apta.c:145: ctrl_inx = apta_local_ctrl_sim_tb[apta_sim_state];
	mov	dptr,#_apta_sim_state
	movx	a,@dptr
	mov	r4,a
	mov	dptr,#_apta_local_ctrl_sim_tb
	movc	a,@a+dptr
	mov	r5,a
	mov	r3,a
;	../../shared/src/apta.c:147: apta_sim_state++;
	mov	dptr,#_apta_sim_state
	mov	a,r4
	inc	a
	movx	@dptr,a
;	../../shared/src/apta.c:148: if((apta_local_ctrl_sim_tb[apta_sim_state] == 0xff) ||	
	mov	dptr,#_apta_sim_state
	movx	a,@dptr
	mov	dptr,#_apta_local_ctrl_sim_tb
	movc	a,@a+dptr
	...
	sjmp	00106$
00162$:
;	../../shared/src/apta.c:149: (apta_local_ctrl_sim_tb[apta_sim_state] == APTA_TERM)) apta_sim_state = 0;					
	cjne	r4,#0x0C,00114$
00106$:
	mov	dptr,#_apta_sim_state
	clr	a
	movx	@dptr,a
;	../../shared/src/apta.c:151: else goto stop_exit;
00114$:
;	../../shared/src/apta.c:153: local_ctrl_field = apta_local_ctrl_tb[ctrl_inx];
	mov	a,r3
	add	a,r3
	mov	r3,a
	mov	dptr,#_apta_local_ctrl_tb
	movc	a,@a+dptr
	xch	a,r3
	inc	dptr
	movc	a,@a+dptr
	mov	r4,a
;	../../shared/src/apta.c:155: reg_REMOTE_STATUS_VALID_ISR_CLEAR_LANE = 1;
;	../../shared/src/apta.c:156: reg_REMOTE_STATUS_VALID_ISR_CLEAR_LANE = 0;
	...
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/apta.c:157: request_local_ctrl(local_ctrl_field); //	LOCAL_CTRL_FIELD_LANE[11:10]=01
	mov	dpl,r3
	mov	dph,r4
	push	ar2
	...
	pop	ar2
;	../../shared/src/apta.c:177: while(reg_REMOTE_STATUS_VALID_ISR_LANE==0); 
00117$:
	mov	dptr,#(_TRX_TRAIN_IF_INTERRUPT_LANE + 0x0001)
	movx	a,@dptr
	jnb	acc.0,00117$
;	../../shared/src/apta.c:180: if((reg_REMOTE_STATUS_FIELD_RD_LANE_15_0_b0&0x3f) == 0x3f) { //terminate
	mov	dptr,#_TX_TRAIN_IF_REG6
	movx	a,@dptr
	mov	r3,a
	anl	ar3,#0x3F
	cjne	r3,#0x3F,00123$
;	../../shared/src/apta.c:181: apta_sim_state = 0;
	mov	dptr,#_apta_sim_state
	clr	a
	movx	@dptr,a
	sjmp	00128$
00123$:
;	../../shared/src/apta.c:184: if(apta_l_r_error_check()) {
	push	ar2
	mov	r0,#_apta_l_r_error_check
	mov	r1,#(_apta_l_r_error_check >> 8)
	mov	r2,#(_apta_l_r_error_check >> 16)
	lcall	__sdcc_banked_call
	mov	a,dpl
	pop	ar2
	jz	00128$
;	../../shared/src/apta.c:185: apta_sim_state = 6; //APTA_TERM
	mov	dptr,#_apta_sim_state
	mov	a,#0x06
	movx	@dptr,a
;	../../shared/src/apta.c:186: lnx_APTA_TERMINATE_REASON_LANE_7_0 = 0x03; //received wrong status
	mov	dptr,#(_CAL_CTRL3_LANE + 0x0001)
	mov	a,#0x03
	movx	@dptr,a
;	../../shared/src/apta.c:191: cmd_if_exit:	
00128$:
;	../../shared/src/apta.c:192: if(	cmd_if_on > 0) {
	mov	a,r2
	jz	00134$
;	../../shared/src/apta.c:193: if(cmd_if_on==2) lnx_PHY_LOCAL_STATUS_LANE_7_0 = 1; //invalid command
	cjne	r2,#0x02,00130$
	...
	sjmp	00131$
00130$:
;	../../shared/src/apta.c:194: else lnx_PHY_LOCAL_STATUS_LANE_7_0 = 0; //complete
	mov	dptr,#(_TRX_TRAIN_IF_TIMERS2_LANE + 0x0002)
	clr	a
	movx	@dptr,a
00131$:
;	../../shared/src/apta.c:196: lnx_PHY_MCU_LOCAL_ACK_LANE = 1;		
	mov	dptr,#(_TRX_TRAIN_IF_TIMERS_ENABLE_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/apta.c:198: stop_exit:
00134$:
;	../../shared/src/apta.c:203: reg_MCU_DEBUG0_LANE_7_0 = 2;		
	mov	dptr,#_MCU_DEBUG0_LANE
	mov	a,#0x02
	movx	@dptr,a
;	../../shared/src/apta.c:204: PHY_STATUS = ST_NORMAL; 
