...
;	../../shared/src/cpu.c:44: IEN2  = 0x3e; //EX12|11|10|9|8=1
	mov	_IEN2,#0x3E
;	../../shared/src/cpu.c:54: do_wake = 0;
	clr	_do_wake
;	../../shared/src/cpu.c:55: do_train = 0;
	clr	_do_train
;	../../shared/src/cpu.c:56: do_rxtrain = 0;
	clr	_do_rxtrain
;	../../shared/src/cpu.c:57: do_rxinit = 0;
	clr	_do_rxinit
;	../../shared/src/cpu.c:59: train_comp = 0; 
	mov	dptr,#_train_comp
	clr	a
	movx	@dptr,a
;	../../shared/src/cpu.c:60: do_rx_apta = 0; do_tx_apta = 0;
	clr	_do_rx_apta
	clr	_do_tx_apta
;	../../shared/src/cpu.c:61: timeout = 1;
	setb	_timeout
;	../../shared/src/cpu.c:62: timeout2 = 1;
	setb	_timeout2
;	../../shared/src/cpu.c:63: tx_remote_ctrl_on = 0;
	clr	_tx_remote_ctrl_on
;	../../shared/src/cpu.c:65: ctrl_cdr_phase_on = 0;
	clr	_ctrl_cdr_phase_on
;	../../shared/src/cpu.c:66: g_fw_flags = 0;
