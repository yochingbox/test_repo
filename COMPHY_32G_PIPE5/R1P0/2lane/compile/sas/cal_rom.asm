...
; This file was generated Thu Oct 18 21:21:37 2018
;--------------------------------------------------------
	.module cal_rom
...
;--------------------------------------------------------
	...
	.globl _load_cal_data_all
	.globl _load_cal_data_dll
	.globl _ringpll_save
	.globl _ringpll_load
	.globl _ringpll_dac_fine_output
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area BANK2   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'load_cal_data_all'
;------------------------------------------------------------
;val                       Allocated to registers r2 
;gen                       Allocated to registers r2 
;div2                      Allocated to registers r2 
;------------------------------------------------------------
;	../../shared/src/cal_rom.c:16: void load_cal_data_all(void) BANKING_CTRL {
;	-----------------------------------------
;	 function load_cal_data_all
;	-----------------------------------------
_load_cal_data_all:
	ar2 = 0x02
	ar3 = 0x03
	...
	ar0 = 0x00
	ar1 = 0x01
;	../../shared/src/cal_rom.c:19: LOAD_CAL_ON = 1;
	mov	dptr,#_CAL_CTRL3_LANE
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/cal_rom.c:21: if(mcuid==master_mcu && slave_phy_on==0) {
	...
	mov	r2,a
	jnz	00105$
;	../../shared/src/cal_rom.c:24: if(reg_LCPLLCLK_DIV2_SEL==0) {
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_207
	movx	a,@dptr
	jb	acc.1,00102$
;	../../shared/src/cal_rom.c:25: reg_LCPLL_DCC_5_0 = 0x20;
	...
	sjmp	00103$
00102$:
;	../../shared/src/cal_rom.c:30: val = cmx_cal_plldcc[PWR + cmx_PLLDCC_CAL_CONT_CUR_LOAD_EN][PLL_RATE_SEL];
	mov	dptr,#(_CONTROL_CONFIG9 + 0x0002)
	movx	a,@dptr
	swap	a
	anl	a,#0x01
	add	a,acc
	add	a,#_cmx_cal_plldcc
	mov	r2,a
	clr	a
	addc	a,#(_cmx_cal_plldcc >> 8)
	mov	r3,a
	...
	movx	a,@dptr
	mov	r2,a
;	../../shared/src/cal_rom.c:31: plldcc_step_cnt = PLLDCC_CAL_STEP_SIZE;  //when speed change, restore the fracition code to middle
	mov	dptr,#_CON_CAL_STEP_SIZE3
	movx	a,@dptr
	mov	r3,a
	mov	dptr,#_plldcc_step_cnt
	movx	@dptr,a
;	../../shared/src/cal_rom.c:32: reg_LCPLL_DCC_5_0 = val;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_182
	mov	a,r2
	add	a,r2
	add	a,acc
	...
	movx	@dptr,a
00103$:
;	../../shared/src/cal_rom.c:34: reg_LCPLL_DCC_CLK = 1;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_182
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/cal_rom.c:35: reg_TRX_IMPCAL_CLK = 1;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_139
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/cal_rom.c:36: reg_LCPLL_DCC_CLK = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_182
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/cal_rom.c:37: reg_TRX_IMPCAL_CLK = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_139
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
00105$:
;	../../shared/src/cal_rom.c:41: reg_DLL_GMSEL_LANE_2_0 = lnx_cal_dll_gmsel[rx_pll_rate];	
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/cal_rom.c:44: val = lnx_cal_vdda_dll_sel[PWR + cmx_RXDLL_CAL_CONT_CUR_LOAD_EN][rx_pll_rate];		
	mov	dptr,#(_CONTROL_CONFIG9 + 0x0002)
	movx	a,@dptr
	rr	a
	anl	a,#0x01
	...
	mov	dph,a
	movx	a,@dptr
;	../../shared/src/cal_rom.c:45: set_sellv_rxdll_ch(val);		
	mov	dpl,a
	mov	r0,#_set_sellv_rxdll_ch
	mov	r1,#(_set_sellv_rxdll_ch >> 8)
	mov	r2,#(_set_sellv_rxdll_ch >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cal_rom.c:48: reg_EOM_DLL_GMSEL_LANE_2_0 = lnx_cal_dll_eom_gmsel[rx_pll_rate];
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/cal_rom.c:51: val = lnx_cal_vdda_dll_eom_sel[PWR + cmx_EOM_DLL_CAL_CONT_CUR_LOAD_EN][rx_pll_rate];		
	mov	dptr,#(_CONTROL_CONFIG9 + 0x0002)
	movx	a,@dptr
	rr	a
	rr	a
	...
	mov	dph,a
	movx	a,@dptr
;	../../shared/src/cal_rom.c:52: set_sellv_rxeomdll_ch(val);		
	mov	dpl,a
	mov	r0,#_set_sellv_rxeomdll_ch
	mov	r1,#(_set_sellv_rxeomdll_ch >> 8)
	mov	r2,#(_set_sellv_rxeomdll_ch >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cal_rom.c:55: reg_ALIGN90_REF_LANE_5_0 = 0x1e;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_14
	movx	a,@dptr
	anl	a,#0x03
	orl	a,#0x78
	movx	@dptr,a
;	../../shared/src/cal_rom.c:56: div2 = (reg_RX_SPEED_DIV_LANE_2_0&0x04)==0;
...
00122$:
	mov	r2,a
;	../../shared/src/cal_rom.c:57: reg_ALIGN90_DAC_LANE_5_0 = lnx_cal_align90_dac[PWR][rx_pll_rate][div2];
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	add	a,acc
	add	a,#_lnx_cal_align90_dac
	mov	r3,a
	clr	a
	addc	a,#(_lnx_cal_align90_dac >> 8)
	mov	r4,a
	mov	a,r2
	add	a,r3
	mov	dpl,a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/cal_rom.c:58: reg_ALIGN90_GM_LANE_2_0 = lnx_cal_align90_gm[PWR][rx_pll_rate][div2];
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	add	a,acc
	add	a,#_lnx_cal_align90_gm
	mov	r3,a
	clr	a
	addc	a,#(_lnx_cal_align90_gm >> 8)
	mov	r4,a
	mov	a,r2
	add	a,r3
	mov	dpl,a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/cal_rom.c:59: reg_ALIGN90_DUMMY_CLK_LANE = lnx_cal_align90_dummy_clk[PWR][rx_pll_rate][div2];		
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	add	a,acc
	add	a,#_lnx_cal_align90_dummy_clk
	mov	r3,a
	clr	a
	addc	a,#(_lnx_cal_align90_dummy_clk >> 8)
	mov	r4,a
	mov	a,r2
	add	a,r3
	mov	dpl,a
	...
	mov	acc.1,c
	movx	@dptr,a
;	../../shared/src/cal_rom.c:60: reg_ALIGN90_SYN_CLK_LANE	= 1;
;	../../shared/src/cal_rom.c:61: reg_ALIGN90_SYN_CLK_LANE	= 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_13
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
	...
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/cal_rom.c:64: reg_RXDCC_DLLCLK_LANE_5_0 = lnx_cal_rxdcc_dll[PWR + cmx_RXDCC_DLL_CAL_CONT_CUR_LOAD_EN][rx_pll_rate];  
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/cal_rom.c:65: rxdcc_dll_step_cnt = RXDCC_DLL_CAL_STEP_SIZE;     //when speed change, restore the fracition code to middle
	mov	dptr,#(_CON_CAL_STEP_SIZE5 + 0x0003)
	movx	a,@dptr
	mov	dptr,#_rxdcc_dll_step_cnt
	movx	@dptr,a
;	../../shared/src/cal_rom.c:66: reg_RXDCC_HG_DLLCLK_LANE = lnx_cal_rxdcc_dll_hg[rx_pll_rate];          //load the HG setting. 
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	...
	mov	acc.1,c
	movx	@dptr,a
;	../../shared/src/cal_rom.c:67: reg_RXDCC_DAC_SYNC_CLK_LANE = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_17
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/cal_rom.c:68: reg_TRXDCC_CAL_CLK100KHZ_LANE = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_136
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/cal_rom.c:69: reg_RXDCC_DAC_SYNC_CLK_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_17
	movx	a,@dptr
	anl	a,#0xef
	movx	@dptr,a
;	../../shared/src/cal_rom.c:70: reg_TRXDCC_CAL_CLK100KHZ_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_136
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/cal_rom.c:72: gen = gen_rx;
	mov	dptr,#_gen_rx
	movx	a,@dptr
	mov	r2,a
;	../../shared/src/cal_rom.c:73: if(phy_mode == SERDES) gen = 0;
	...
	mov	r2,#0x00
00108$:
;	../../shared/src/cal_rom.c:76: reg_RXDCC_DATACLK_LANE_5_0 = lnx_cal_rxdcc_data[PWR + cmx_RXDCC_DATA_CAL_CONT_CUR_LOAD_EN][gen];
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/cal_rom.c:77: rxdcc_data_step_cnt = RXDCC_DATA_CAL_STEP_SIZE;     //when speed change, restore the fracition code to middle
	mov	dptr,#(_CON_CAL_STEP_SIZE2 + 0x0001)
	movx	a,@dptr
	mov	dptr,#_rxdcc_data_step_cnt
	movx	@dptr,a
;	../../shared/src/cal_rom.c:78: reg_RXDCC_HG_DATACLK_LANE = lnx_cal_rxdcc_data_hg[gen];          //load the HG setting.
	mov	a,r2
	...
	mov	acc.1,c
	movx	@dptr,a
;	../../shared/src/cal_rom.c:79: reg_RXDCC_DAC_SYNC_CLK_LANE = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_17
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/cal_rom.c:80: reg_TRXDCC_CAL_CLK100KHZ_LANE = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_136
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/cal_rom.c:81: reg_RXDCC_DAC_SYNC_CLK_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_17
	movx	a,@dptr
	anl	a,#0xef
	movx	@dptr,a
;	../../shared/src/cal_rom.c:82: reg_TRXDCC_CAL_CLK100KHZ_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_136
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/cal_rom.c:85: reg_RXDCC_EOMCLK_LANE_5_0 = lnx_cal_rxdcc_eom[PWR + cmx_RXDCC_EOM_CAL_CONT_CUR_LOAD_EN][gen];
	mov	dptr,#(_CONTROL_CONFIG9 + 0x0003)
	movx	a,@dptr
	anl	a,#0x01
	mov	b,#0x05
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/cal_rom.c:86: rxdcc_eom_step_cnt = RXDCC_EOM_CAL_STEP_SIZE;     //when speed change, restore the fracition code to middle
	mov	dptr,#_CON_CAL_STEP_SIZE2
	movx	a,@dptr
	mov	dptr,#_rxdcc_eom_step_cnt
	movx	@dptr,a
;	../../shared/src/cal_rom.c:87: reg_RXDCC_HG_EOMCLK_LANE = lnx_cal_rxdcc_eom_hg[gen];          //load the HG setting.
	mov	a,r2
	...
	mov	acc.1,c
	movx	@dptr,a
;	../../shared/src/cal_rom.c:88: reg_RXDCC_DAC_SYNC_CLK_LANE = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_17
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/cal_rom.c:89: reg_TRXDCC_CAL_CLK100KHZ_LANE = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_136
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/cal_rom.c:90: reg_RXDCC_DAC_SYNC_CLK_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_17
	movx	a,@dptr
	anl	a,#0xef
	movx	@dptr,a
;	../../shared/src/cal_rom.c:91: reg_TRXDCC_CAL_CLK100KHZ_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_136
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/cal_rom.c:94: reg_TXDCC_CNT_LANE_5_0 = lnx_cal_txdcc[PWR + cmx_TXDCC_CAL_CONT_CUR_LOAD_EN][tx_pll_rate];  
	mov	dptr,#(_CONTROL_CONFIG9 + 0x0002)
	movx	a,@dptr
	rl	a
	anl	a,#0x01
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/cal_rom.c:95: txdcc_step_cnt = TXDCC_CAL_STEP_SIZE;             //when speed change, restore the fracition code to middle
	mov	dptr,#(_CON_CAL_STEP_SIZE3 + 0x0003)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_txdcc_step_cnt
	movx	@dptr,a
;	../../shared/src/cal_rom.c:96: reg_TRXDCC_CAL_CLK100KHZ_LANE = 1;
;	../../shared/src/cal_rom.c:97: reg_TRXDCC_CAL_CLK100KHZ_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_136
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
	...
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/cal_rom.c:100: if (reg_TX_SPEED_DIV_LANE_2_0 != 0) {
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_150
	movx	a,@dptr
	anl	a,#0x07
	jz	00110$
;	../../shared/src/cal_rom.c:101: reg_TXDCCCAL_PDIV_CNT_LANE_5_0 = lnx_cal_txdcc_pdiv[PWR + cmx_TXDCC_PDIV_CAL_CONT_CUR_LOAD_EN][tx_pll_rate];  
	mov	dptr,#(_CONTROL_CONFIG9 + 0x0002)
	movx	a,@dptr
	rl	a
	rl	a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/cal_rom.c:102: txdcc_pdiv_step_cnt = TXDCC_PDIV_CAL_STEP_SIZE;             //when speed change, restore the fracition code to middle	
	mov	dptr,#(_CON_CAL_STEP_SIZE3 + 0x0002)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_txdcc_pdiv_step_cnt
	movx	@dptr,a
;	../../shared/src/cal_rom.c:103: reg_TRXDCC_CAL_CLK100KHZ_LANE = 1;
;	../../shared/src/cal_rom.c:104: reg_TRXDCC_CAL_CLK100KHZ_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_136
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
	...
	movx	@dptr,a
00110$:
;	../../shared/src/cal_rom.c:107: LOAD_CAL_ON = 0;
	mov	dptr,#_CAL_CTRL3_LANE
	clr	a
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'load_cal_data_dll'
;------------------------------------------------------------
;val                       Allocated to registers r2 
;div2                      Allocated to registers r2 
;------------------------------------------------------------
;	../../shared/src/cal_rom.c:111: void load_cal_data_dll(void) BANKING_CTRL{
;	-----------------------------------------
;	 function load_cal_data_dll
;	-----------------------------------------
_load_cal_data_dll:
;	../../shared/src/cal_rom.c:115: LOAD_CAL_ON = 1;
	mov	dptr,#_CAL_CTRL3_LANE
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/cal_rom.c:117: reg_DLL_GMSEL_LANE_2_0 = lnx_cal_dll_gmsel[rx_pll_rate];	
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	add	a,#_lnx_cal_dll_gmsel
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/cal_rom.c:120: val = lnx_cal_vdda_dll_sel[PWR + cmx_RXDLL_CAL_CONT_CUR_LOAD_EN][rx_pll_rate];		
	mov	dptr,#(_CONTROL_CONFIG9 + 0x0002)
	movx	a,@dptr
	rr	a
	anl	a,#0x01
	...
	mov	dph,a
	movx	a,@dptr
;	../../shared/src/cal_rom.c:121: set_sellv_rxdll_ch(val);		
	mov	dpl,a
	mov	r0,#_set_sellv_rxdll_ch
	mov	r1,#(_set_sellv_rxdll_ch >> 8)
	mov	r2,#(_set_sellv_rxdll_ch >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cal_rom.c:124: reg_EOM_DLL_GMSEL_LANE_2_0 = lnx_cal_dll_eom_gmsel[rx_pll_rate];
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	add	a,#_lnx_cal_dll_eom_gmsel
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/cal_rom.c:127: val = lnx_cal_vdda_dll_eom_sel[PWR + cmx_EOM_DLL_CAL_CONT_CUR_LOAD_EN][rx_pll_rate];		
	mov	dptr,#(_CONTROL_CONFIG9 + 0x0002)
	movx	a,@dptr
	rr	a
	rr	a
	...
	mov	dph,a
	movx	a,@dptr
;	../../shared/src/cal_rom.c:128: set_sellv_rxeomdll_ch(val);		
	mov	dpl,a
	mov	r0,#_set_sellv_rxeomdll_ch
	mov	r1,#(_set_sellv_rxeomdll_ch >> 8)
	mov	r2,#(_set_sellv_rxeomdll_ch >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cal_rom.c:131: div2 = (reg_RX_SPEED_DIV_LANE_2_0&0x04)==0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_138
	movx	a,@dptr
	rr	a
	rr	a
...
00103$:
	mov	r2,a
;	../../shared/src/cal_rom.c:132: reg_ALIGN90_DAC_LANE_5_0 = lnx_cal_align90_dac[PWR][rx_pll_rate][div2];
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	add	a,acc
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/cal_rom.c:133: reg_ALIGN90_GM_LANE_2_0 = lnx_cal_align90_gm[PWR][rx_pll_rate][div2];
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	add	a,acc
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/cal_rom.c:134: reg_ALIGN90_DUMMY_CLK_LANE = lnx_cal_align90_dummy_clk[PWR][rx_pll_rate][div2];		
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	add	a,acc
	...
	mov	acc.1,c
	movx	@dptr,a
;	../../shared/src/cal_rom.c:135: reg_ALIGN90_SYN_CLK_LANE	= 1;
;	../../shared/src/cal_rom.c:136: reg_ALIGN90_SYN_CLK_LANE	= 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_13
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
	...
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/cal_rom.c:138: LOAD_CAL_ON = 0;
	mov	dptr,#_CAL_CTRL3_LANE
	clr	a
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'ringpll_save'
;------------------------------------------------------------
;no                        Allocated to registers r2 
;------------------------------------------------------------
;	../../shared/src/cal_rom.c:142: void ringpll_save(uint8_t no) BANKING_CTRL {
;	-----------------------------------------
;	 function ringpll_save
;	-----------------------------------------
_ringpll_save:
;	../../shared/src/cal_rom.c:147: cmx_cal_pll_speed_ring[no][PLL_RATE_SEL_RING] = (reg_PLL_SPEED_RING_4_0 & 0x1f) | 0x00;
	mov	a,dpl
	mov	r2,a
	add	a,acc
	mov	r3,a
	add	a,#_cmx_cal_pll_speed_ring
	mov	r4,a
	clr	a
	addc	a,#(_cmx_cal_pll_speed_ring >> 8)
	mov	r5,a
	...
	mov	a,r6
	movx	@dptr,a
;	../../shared/src/cal_rom.c:148: cmx_cal_pll_sllp_dac_coarse_ring[no][PLL_RATE_SEL_RING] = (reg_PLL_SLLP_DAC_COARSE_RING_3_0 & 0x0f) | 0x00;
	mov	a,r3
	add	a,#_cmx_cal_pll_sllp_dac_coarse_ring
	mov	r3,a
	clr	a
	addc	a,#(_cmx_cal_pll_sllp_dac_coarse_ring >> 8)
	mov	r4,a
	mov	dptr,#(_CONTROL_CONFIG6 + 0x0003)
	movx	a,@dptr
	add	a,r3
	...
	mov	a,r5
	movx	@dptr,a
;	../../shared/src/cal_rom.c:150: cmx_cal_sllp_dac_fine_ring[no][PLL_RATE_SEL_RING] = ringpll_dac_fine;
	mov	a,r2
	add	a,r2
	add	a,acc
	add	a,#_cmx_cal_sllp_dac_fine_ring
	mov	r2,a
	clr	a
	addc	a,#(_cmx_cal_sllp_dac_fine_ring >> 8)
	mov	r3,a
	mov	dptr,#(_CONTROL_CONFIG6 + 0x0003)
	movx	a,@dptr
	add	a,acc
	...
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'ringpll_load'
;------------------------------------------------------------
;no                        Allocated to registers r2 
;------------------------------------------------------------
;	../../shared/src/cal_rom.c:153: void ringpll_load(uint8_t no) BANKING_CTRL {
;	-----------------------------------------
;	 function ringpll_load
;	-----------------------------------------
_ringpll_load:
;	../../shared/src/cal_rom.c:158: reg_PLL_SPEED_RING_4_0 = cmx_cal_pll_speed_ring[no][PLL_RATE_SEL_RING];
	mov	a,dpl
	mov	r2,a
	add	a,acc
	mov	r3,a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/cal_rom.c:159: reg_PLL_SLLP_DAC_COARSE_RING_3_0 = cmx_cal_pll_sllp_dac_coarse_ring[no][PLL_RATE_SEL_RING];
	mov	a,r3
	add	a,#_cmx_cal_pll_sllp_dac_coarse_ring
	mov	r3,a
	clr	a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/cal_rom.c:162: ringpll_dac_fine = cmx_cal_sllp_dac_fine_ring[no][PLL_RATE_SEL_RING]; 
	mov	a,r2
	add	a,r2
	add	a,acc
	add	a,#_cmx_cal_sllp_dac_fine_ring
	...
	mov	a,r3
	movx	@dptr,a
;	../../shared/src/cal_rom.c:167: reg_PLL_SLLP_DAC_FINE_RING_10_8 = (uint8_t)(ringpll_dac_fine>>8); 
	mov	ar4,r3
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/cal_rom.c:168: reg_PLL_SLLP_DAC_FINE_RING_7_0 = (uint8_t)ringpll_dac_fine;  	
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_195
	mov	a,r2
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'ringpll_dac_fine_output'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/cal_rom.c:173: void ringpll_dac_fine_output(void) BANKING_CTRL {
;	-----------------------------------------
;	 function ringpll_dac_fine_output
;	-----------------------------------------
_ringpll_dac_fine_output:
;	../../shared/src/cal_rom.c:174: EA = 0;
	clr	_EA
;	../../shared/src/cal_rom.c:180: reg_PLL_SLLP_DAC_FINE_RING_10_8 = (uint8_t)(ringpll_dac_fine>>8); 
	mov	dptr,#_ringpll_dac_fine
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/cal_rom.c:181: reg_PLL_SLLP_DAC_FINE_RING_7_0 = (uint8_t)ringpll_dac_fine;  	
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_195
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/cal_rom.c:182: reg_PLL_SLLP_DAC_VALID_RING = 1;  reg_PLL_SLLP_DAC_VALID_RING = 0;	
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_193
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
