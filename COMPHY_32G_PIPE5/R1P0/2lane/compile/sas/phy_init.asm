...
;--------------------------------------------------------
	...
	.globl _init_irq
	.globl _init_reg
	.globl _reset_pwr_reg
	.globl _set_timer_cnt
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area BANK1   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'clear_xdata'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/phy_init.c:28: void clear_xdata(void) BANKING_CTRL {
;	-----------------------------------------
;	 function clear_xdata
;	-----------------------------------------
_clear_xdata:
	ar2 = 0x02
	ar3 = 0x03
	...
	ar0 = 0x00
	ar1 = 0x01
;	../../shared/src/phy_init.c:32: reg_MCU_DEBUG0_LANE_7_0 = lnx_END_XDAT_LANE_7_0;
	mov	dptr,#_END_XDAT_LANE
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_MCU_DEBUG0_LANE
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/phy_init.c:33: while(lnx_END_XDAT_LANE_7_0!=0xaa || cmx_END_XDAT_CMN_7_0!=0xaa);
00102$:
	mov	dptr,#_END_XDAT_LANE
	movx	a,@dptr
	mov	r2,a
	cjne	r2,#0xAA,00102$
	mov	dptr,#_END_XDAT_CMN
	movx	a,@dptr
	mov	r2,a
	cjne	r2,#0xAA,00102$
;	../../shared/src/phy_init.c:34: reg_MCU_DEBUG0_LANE_7_0 = lnx_END_XDAT_LANE_7_0;
	mov	dptr,#_END_XDAT_LANE
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_MCU_DEBUG0_LANE
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/phy_init.c:36: if(master_mcu > MAX_MCU_ID) master_mcu = MCU_LANE0;
...
00120$:
	...
	movx	@dptr,a
00106$:
;	../../shared/src/phy_init.c:66: sync_status_lane(IDLE);
	mov	dpl,#0x00
	mov	r0,#_sync_status_lane
	mov	r1,#(_sync_status_lane >> 8)
	mov	r2,#(_sync_status_lane >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phy_init.c:67: if(mcuid== master_mcu) {
	...
	mov	a,r2
	cjne	a,ar3,00108$
;	../../shared/src/phy_init.c:72: cmx_MCU_INIT_DONE = 1;  // Used in simulation
	mov	dptr,#(_CONTROL_CONFIG0 + 0x0001)
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
00108$:
;	../../shared/src/phy_init.c:76: sync_check = 0;
	clr	_sync_check
;	../../shared/src/phy_init.c:77: rx_pll_rate = 0;
	clr	_rx_pll_rate
;	../../shared/src/phy_init.c:78: tx_pll_rate = 0;
	clr	_tx_pll_rate
;	../../shared/src/phy_init.c:79: gen_pll_rate = 0;
	mov	dptr,#_gen_pll_rate
	clr	a
	movx	@dptr,a
;	../../shared/src/phy_init.c:80: pre_gen_pll_rate = 0xff;
	mov	dptr,#_pre_gen_pll_rate
	mov	a,#0xFF
	movx	@dptr,a
;	../../shared/src/phy_init.c:81: use_ring_pll = 0;
	clr	_use_ring_pll
;	../../shared/src/phy_init.c:82: ring_pll_enabled = 0;
	clr	_ring_pll_enabled
;	../../shared/src/phy_init.c:83: ring_use_250m = 0;
	clr	_ring_use_250m
;	../../shared/src/phy_init.c:84: force_exit_cal = 0;
	clr	_force_exit_cal
;	../../shared/src/phy_init.c:85: adapt_slicer_en = 0;
	clr	_adapt_slicer_en
;	../../shared/src/phy_init.c:86: adapt_data_en = 0;
	clr	_adapt_data_en
;	../../shared/src/phy_init.c:87: no_pllspdchg = 0;
	clr	_no_pllspdchg
;	../../shared/src/phy_init.c:88: lc_pll_used = 0;
	clr	_lc_pll_used
;	../../shared/src/phy_init.c:89: int_pu_rx = 0;
	clr	_int_pu_rx
;	../../shared/src/phy_init.c:90: int_pu_tx = 0;
	clr	_int_pu_tx
;	../../shared/src/phy_init.c:91: tx_status_pcie_mode = 0;
	clr	_tx_status_pcie_mode
;	../../shared/src/phy_init.c:92: tx_pipe4_en = 0;
	clr	_tx_pipe4_en
;	../../shared/src/phy_init.c:93: gain_train_with_c = 0;
	clr	_gain_train_with_c
;	../../shared/src/phy_init.c:94: tx_init_bit = 0;
	mov	dptr,#_tx_init_bit
	clr	a
	movx	@dptr,a
;	../../shared/src/phy_init.c:96: PLL_RATE_SEL = 0xff;
	mov	dptr,#(_CONTROL_CONFIG6 + 0x0002)
	mov	a,#0xFF
	movx	@dptr,a
;	../../shared/src/phy_init.c:97: PLL_RATE_SEL_RING = 0xff;	// TODO - should this be defined in xdat_lane.h?
	mov	dptr,#(_CONTROL_CONFIG6 + 0x0003)
	mov	a,#0xFF
	movx	@dptr,a
;	../../shared/src/phy_init.c:98: invalidate_pll_rate = 0;
	mov	dptr,#_invalidate_pll_rate
	clr	a
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'init_xdata'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/phy_init.c:115: void init_xdata(void) BANKING_CTRL {
;	-----------------------------------------
;	 function init_xdata
;	-----------------------------------------
_init_xdata:
;	../../shared/src/phy_init.c:117: if(master_mcu > MAX_MCU_ID) master_mcu = MCU_LANE0;
	mov	dptr,#_MCU_CONFIG
	movx	a,@dptr
	mov	r2,a
	mov	a,#0x01
...
00127$:
	...
	movx	@dptr,a
00102$:
;	../../shared/src/phy_init.c:121: pcie_usb_mode =  ( ( phy_mode == PCIE ) || ( phy_mode == USB ) ) ? 1 : 0;
...
00114$:
	mov	r2,#0x00
00115$:
	mov	dptr,#_pcie_usb_mode
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/phy_init.c:124: if(FAST_POWER_ON_EN) CONTROL_CONFIG0.BT.B2 |= 0x30; // bypass delay_time, bypass_poweron_delay 
	...
	movx	@dptr,a
00104$:
;	../../shared/src/phy_init.c:125: reg_SET_MCU_COMMAND_LANE0_31_0_b0 |= CONTROL_CONFIG0.BT.B2;
	mov	dptr,#_MCU_INFO_0
	movx	a,@dptr
	mov	r3,a
	mov	dptr,#(_CONTROL_CONFIG0 + 0x0002)
	movx	a,@dptr
	...
	mov	a,r3
	movx	@dptr,a
;	../../shared/src/phy_init.c:126: reg_SET_MCU_COMMAND_LANE1_31_0_b0 |= CONTROL_CONFIG0.BT.B2;
	mov	dptr,#_MCU_INFO_1
	movx	a,@dptr
	mov	r3,a
	mov	dptr,#(_CONTROL_CONFIG0 + 0x0002)
	movx	a,@dptr
	...
	mov	a,r3
	movx	@dptr,a
;	../../shared/src/phy_init.c:132: force_exit_cal = FORCE_EXIT_CAL | cmx_EXT_FORCE_CAL_DONE;
	mov	dptr,#(_CONTROL_CONFIG0 + 0x0002)
	movx	a,@dptr
	rr	a
	anl	a,#0x01
	...
	orl	a,r3
	add	a,#0xff
	mov	_force_exit_cal,c
;	../../shared/src/phy_init.c:135: if(mcuid== master_mcu) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r3,a
	mov	dptr,#_MCU_CONFIG
	...
	mov	a,r3
	cjne	a,ar4,00108$
;	../../shared/src/phy_init.c:136: pllcal_first_time = 1;
	mov	dptr,#_pllcal_first_time
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/phy_init.c:158: cmx_FW_MAJOR_VER_7_0 = MAJOR_VER;
	mov	dptr,#(_FW_REV + 0x0003)
	clr	a
	movx	@dptr,a
;	../../shared/src/phy_init.c:159: cmx_FW_MINOR_VER_7_0 = MINOR_VER;
	mov	dptr,#(_FW_REV + 0x0002)
	mov	a,#0x0C
	movx	@dptr,a
;	../../shared/src/phy_init.c:160: cmx_FW_PATCH_VER_7_0 = PATCH_VER;
	mov	dptr,#(_FW_REV + 0x0001)
	mov	a,#0x08
	movx	@dptr,a
;	../../shared/src/phy_init.c:161: cmx_FW_BUILD_VER_7_0 = BUILD_VER;
	mov	dptr,#_FW_REV
	mov	a,#0x26
	movx	@dptr,a
;	../../shared/src/phy_init.c:162: reg_MCU_DEBUG0_LANE_7_0 = 0x60;
	mov	dptr,#_MCU_DEBUG0_LANE
	mov	a,#0x60
	movx	@dptr,a
;	../../shared/src/phy_init.c:163: reg_MCU_DEBUG1_LANE_7_0 = MAJOR_VER;
	mov	dptr,#(_MCU_DEBUG0_LANE + 0x0001)
	clr	a
	movx	@dptr,a
;	../../shared/src/phy_init.c:164: reg_MCU_DEBUG2_LANE_7_0 = MINOR_VER;
	mov	dptr,#(_MCU_DEBUG0_LANE + 0x0002)
	mov	a,#0x0C
	movx	@dptr,a
;	../../shared/src/phy_init.c:165: reg_MCU_DEBUG3_LANE_7_0 = PATCH_VER;
	mov	dptr,#(_MCU_DEBUG0_LANE + 0x0003)
	mov	a,#0x08
	movx	@dptr,a
;	../../shared/src/phy_init.c:166: reg_MCU_DEBUG4_LANE_7_0 = BUILD_VER;
	mov	dptr,#_MCU_DEBUG1_LANE
	mov	a,#0x26
	movx	@dptr,a
;	../../shared/src/phy_init.c:173: if(phy_mode == SATA) {
	mov	dptr,#(_SYSTEM + 0x0002)
	movx	a,@dptr
	anl	a,#0x07
	jnz	00108$
;	../../shared/src/phy_init.c:193: CONTROL_CONFIG2.BT.B2 = 0x32;
	mov	dptr,#(_CONTROL_CONFIG2 + 0x0002)
	mov	a,#0x32
	movx	@dptr,a
;	../../shared/src/phy_init.c:194: CONTROL_CONFIG2.BT.B3 = 0;
	mov	dptr,#(_CONTROL_CONFIG2 + 0x0003)
	clr	a
	movx	@dptr,a
00108$:
;	../../shared/src/phy_init.c:203: lnx_TX_TRAIN_FRAME_DET_TIMER_ENABLE_LANE = 1;
	mov	dptr,#(_TRX_TRAIN_IF_TIMERS_ENABLE_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/phy_init.c:204: lnx_TX_TRAIN_TIMER_ENABLE_LANE = 1;
	mov	dptr,#(_TRX_TRAIN_IF_TIMERS_ENABLE_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/phy_init.c:205: lnx_RX_TRAIN_TIMER_ENABLE_LANE = 1;
	mov	dptr,#(_TRX_TRAIN_IF_TIMERS_ENABLE_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/phy_init.c:206: lnx_TX_TRAIN_STATUS_DET_TIMER_ENABLE_LANE = 1;
	mov	dptr,#(_TRX_TRAIN_IF_TIMERS_ENABLE_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/phy_init.c:229: cont_cal_on = 0;
	clr	_cont_cal_on
;	../../shared/src/phy_init.c:231: cal_start_on = 0;
	mov	dptr,#_cal_start_on
;	../../shared/src/phy_init.c:232: dfe_phase_save_en = 0;
	clr	a
	movx	@dptr,a
	mov	dptr,#_dfe_phase_save_en
	movx	@dptr,a
;	../../shared/src/phy_init.c:234: if(pcie_usb_mode)
	mov	a,r2
	jnz	00111$
;	../../shared/src/phy_init.c:245: tx_adapt_g0_en = 1;
	mov	dptr,#(_TRAIN_CONTROL_2 + 0x0002)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/phy_init.c:246: tx_adapt_gn1_en = 1;
;	../../shared/src/phy_init.c:247: tx_adapt_g1_en = 0;
	mov	dptr,#(_TRAIN_CONTROL_2 + 0x0002)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
	...
	movx	@dptr,a
00111$:
;	../../shared/src/phy_init.c:250: tx_sweep_preset_en = 0;
	mov	dptr,#_tx_sweep_preset_en
	clr	a
	movx	@dptr,a
;	../../shared/src/phy_init.c:254: pre_sq_rd = 1;
	mov	dptr,#_pre_sq_rd
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/phy_init.c:256: tx_train_p2p_hold = lnx_TX_TRAIN_P2P_HOLD_LANE;
	...
	movx	@dptr,a
;	../../shared/src/phy_init.c:260: cmx_PLL_CAL_DONE = 1;
	mov	dptr,#(_CAL_STATUS_READ + 0x0002)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/phy_init.c:264: cmx_PLL_CAL_RING_DONE = 1;
	mov	dptr,#(_CAL_STATUS_READ + 0x0003)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/phy_init.c:267: lnx_RPTA_F0D_OFFSET_LANE_7_0 = 6;
	mov	dptr,#(_TRAIN_PARA_3 + 0x0003)
	mov	a,#0x06
	movx	@dptr,a
;	../../shared/src/phy_init.c:270: tx_sel_bit = reg_TX_SEL_BITS_LANE;
	...
	movx	@dptr,a
;	../../shared/src/phy_init.c:271: rx_sel_bit = reg_RX_SEL_BITS_LANE;
	...
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'init_irq'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/phy_init.c:275: void init_irq(void) BANKING_CTRL {
;	-----------------------------------------
;	 function init_irq
;	-----------------------------------------
_init_irq:
;	../../shared/src/phy_init.c:278: reg_PIN_TX_TRAIN_ENABLE_ISR_LANE = 0;
	mov	dptr,#_TRX_TRAIN_IF_INTERRUPT_LANE
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/phy_init.c:279: reg_PIN_RX_TRAIN_ENABLE_ISR_LANE = 0;
	mov	dptr,#_TRX_TRAIN_IF_INTERRUPT_LANE
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/phy_init.c:280: reg_FRAME_LOCK_ISR_LANE = 0;
	mov	dptr,#(_RX_LANE_INTERRUPT + 0x0003)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/phy_init.c:281: reg_REMOTE_CTRL_VALID_ISR_LANE = 0;
	mov	dptr,#(_TRX_TRAIN_IF_INTERRUPT_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/phy_init.c:282: reg_INT_RX_INIT_RISE_ISR_LANE = 0;
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG1_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/phy_init.c:283: SPD_CTRL_INTERRUPT_REG1_LANE.BT.B3 = 0x0;
	mov	dptr,#(_SPD_CTRL_INTERRUPT_REG1_LANE + 0x0003)
;	../../shared/src/phy_init.c:284: PM_CTRL_INTERRUPT_REG1_LANE.BT.B3 = 0;
;	../../shared/src/phy_init.c:285: PM_CTRL_INTERRUPT_REG1_LANE.BT.B2 = 0;
;	../../shared/src/phy_init.c:286: MCU_IRQ_LANE.BT.B0 = 0;
	clr	a
	movx	@dptr,a
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG1_LANE + 0x0003)
	movx	@dptr,a
	...
	movx	@dptr,a
;	../../shared/src/phy_init.c:287: MEM_IRQ.BT.B0 = 0;
	mov	dptr,#_MEM_IRQ
	clr	a
	movx	@dptr,a
;	../../shared/src/phy_init.c:293: if((phy_mode == PCIE) || (phy_mode == USB)) 
	mov	dptr,#(_SYSTEM + 0x0002)
	movx	a,@dptr
	anl	a,#0x07
	mov	r2,a
...
00140$:
	...
	sjmp	00105$
00141$:
;	../../shared/src/phy_init.c:308: PM_CTRL_INTERRUPT_REG2.BT.B2 = 0xfc;
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG2 + 0x0002)
	mov	a,#0xFC
	movx	@dptr,a
;	../../shared/src/phy_init.c:309: PM_CTRL_INTERRUPT_REG2.BT.B3 = 0x11; // PU_RX|PU_TX|PU_PLL|rx_init|regclk_dis|PU_IVREF
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG2 + 0x0003)
	mov	a,#0x11
	movx	@dptr,a
;	../../shared/src/phy_init.c:310: if(mcuid== master_mcu) reg_INT_PU_PLL_OR_CHG_MASK_LANE = 0; //PU_PLL_OR
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_MCU_CONFIG
	...
	movx	@dptr,a
00102$:
;	../../shared/src/phy_init.c:311: reg_INT_TXDETRX_EN_CHG_MASK_LANE =1;
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG2 + 0x0002)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/phy_init.c:312: reg_INT_BEACON_TX_EN_CHG_MASK_LANE = 1;
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG2 + 0x0002)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
00105$:
;	../../shared/src/phy_init.c:320: reg_INT3_INT_REFCLK_DIS_CHG_INT_EN_LANE = 1;
	mov	dptr,#(_MCU_INT3_CONTROL + 0x0002)
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/phy_init.c:321: reg_INT3_INT_PU_IVREF_CHG_INT_EN_LANE = 1;
	mov	dptr,#(_MCU_INT3_CONTROL + 0x0002)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/phy_init.c:323: if((phy_mode == PCIE) || (phy_mode == USB))
	mov	dptr,#(_SYSTEM + 0x0002)
	movx	a,@dptr
	anl	a,#0x07
	mov	r2,a
...
00144$:
	...
	sjmp	00117$
00145$:
;	../../shared/src/phy_init.c:338: reg_INT9_PM_CHG_INT_EN_LANE = 1;
	mov	dptr,#_MCU_INT9_CONTROL
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/phy_init.c:339: if(serdes_ring_lane_en) {
	mov	dptr,#_serdes_ring_lane_en
	movx	a,@dptr
	mov	r2,a
	jz	00113$
;	../../shared/src/phy_init.c:343: if (tag_ringpll_ind_en==0 && mcuid==master_mcu)
	...
	mov	a,r2
	cjne	a,ar3,00114$
;	../../shared/src/phy_init.c:345: reg_INT9_INT_PU_PLL_OR_CHG_INT_EN_LANE = 1;
	mov	dptr,#(_MCU_INT9_CONTROL + 0x0003)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
	sjmp	00114$
00113$:
;	../../shared/src/phy_init.c:350: else if (mcuid == master_mcu)
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_MCU_CONFIG
	...
	mov	a,r2
	cjne	a,ar3,00114$
;	../../shared/src/phy_init.c:352: reg_INT9_INT_PU_PLL_OR_CHG_INT_EN_LANE = 1;
	mov	dptr,#(_MCU_INT9_CONTROL + 0x0003)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
00114$:
;	../../shared/src/phy_init.c:353: reg_INT1_INT_POWER_STATE_VALID_RISE_INT_EN_LANE = 0;
	mov	dptr,#(_MCU_INT1_CONTROL + 0x0002)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/phy_init.c:355: reg_INT8_PM_PCIE_FUNC_CHG_INT_EN_LANE = 0;
	mov	dptr,#(_MCU_INT8_CONTROL + 0x0001)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
00117$:
;	../../shared/src/phy_init.c:362: reg_INT2_SPD_INT_GEN_EN_LANE = 1;
	mov	dptr,#_MCU_INT2_CONTROL
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/phy_init.c:364: reg_INT11_PIN_RX_TRAIN_ENABLE_INT_EN_LANE = 1;
	mov	dptr,#(_MCU_INT11_CONTROL + 0x0001)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/phy_init.c:367: reg_INT5_PIN_TX_TRAIN_ENABLE_INT_EN_LANE = 1;
	mov	dptr,#(_MCU_INT5_CONTROL + 0x0001)
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/phy_init.c:370: reg_INT10_INT_RX_INIT_RISE_INT_EN_LANE = 1;
	mov	dptr,#(_MCU_INT10_CONTROL + 0x0002)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/phy_init.c:372: if(phy_mode != PCIE || reg_PHY_ISOLATE_MODE) {
	mov	dptr,#(_SYSTEM + 0x0002)
	movx	a,@dptr
	anl	a,#0x07
	mov	r2,a
	...
	jnb	acc.7,00120$
00119$:
;	../../shared/src/phy_init.c:374: reg_INT7_REMOTE_CTRL_VALID_INT_EN_LANE = 1;
	mov	dptr,#(_MCU_INT7_CONTROL + 0x0001)
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/phy_init.c:382: reg_INT6_PIN_PAPTA_TRAIN_ENABLE_INT_EN_LANE = 1;
	mov	dptr,#(_MCU_INT6_CONTROL + 0x0003)
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/phy_init.c:385: reg_INT12_PIN_PAPTA_TRAIN_DISABLE_INT_EN_LANE = 1;
	mov	dptr,#(_MCU_INT_CONTROL_13 + 0x0001)
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
00120$:
;	../../shared/src/phy_init.c:390: if(!reg_MASTER_PHY_EN)
	mov	dptr,#_SYSTEM
	movx	a,@dptr
	jb	acc.3,00123$
;	../../shared/src/phy_init.c:391: reg_INT1_DPHY_ANA_LANE_DISABLE_INT_EN_LANE = 1;
	mov	dptr,#(_MCU_INT1_CONTROL + 0x0003)
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
00123$:
;	../../shared/src/phy_init.c:396: if(mcuid== master_mcu) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_MCU_CONFIG
	...
	mov	a,r2
	cjne	a,ar3,00125$
;	../../shared/src/phy_init.c:397: reg_INT4_MCU_REMOTE_REQ_INT_EN_LANE = 1;
	mov	dptr,#(_MCU_INT4_CONTROL + 0x0003)
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
00125$:
;	../../shared/src/phy_init.c:400: reg_INT4_PHY_MCU_REMOTE_REQ_INT_EN_LANE = 1;
	mov	dptr,#(_MCU_INT4_CONTROL + 0x0003)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'init_reg'
;------------------------------------------------------------
;ana_pwr                   Allocated to registers r2 
;------------------------------------------------------------
;	../../shared/src/phy_init.c:406: void init_reg(void) BANKING_CTRL {
;	-----------------------------------------
;	 function init_reg
;	-----------------------------------------
_init_reg:
;	../../shared/src/phy_init.c:408: uint8_t ana_pwr = reg_ANA_ID_15_0_b0 & 0x03; // 2: 1.8V, 3: 1.2V
	mov	dptr,#_CID_REG1
	movx	a,@dptr
	mov	r2,a
	anl	ar2,#0x03
;	../../shared/src/phy_init.c:409: if(ana_pwr==0x02) reg_AVDDR12_SEL_MAST_REG = 1; //1.8V
	clr	a
	cjne	r2,#0x02,00141$
	inc	a
00141$:
	mov	r3,a
	jz	00104$
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_209
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
	sjmp	00105$
00104$:
;	../../shared/src/phy_init.c:410: else if(ana_pwr==0x03) reg_AVDDR12_SEL_MAST_REG = 0; //1.2V
	cjne	r2,#0x03,00105$
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_209
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
00105$:
;	../../shared/src/phy_init.c:413: if(phy_mode == SERDES ) {//Ethernet, 
	mov	dptr,#(_SYSTEM + 0x0002)
	movx	a,@dptr
	anl	a,#0x07
	mov	r2,a
	cjne	r2,#0x04,00107$
;	../../shared/src/phy_init.c:416: reg_TX_TRAIN_PAT_TWO_ZERO_LANE = 1;
;	../../shared/src/phy_init.c:417: reg_TX_TRAIN_PAT_MODE_LANE = 0;
	...
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/phy_init.c:420: reg_ETHERNET_MODE_LANE = 1;
	mov	dptr,#(_DME_ENC_REG0 + 0x0002)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
00107$:
;	../../shared/src/phy_init.c:427: if(cmx_PHY_GEN_MAX_3_0 < max_gen) 
	...
	subb	a,b
	jnc	00109$
;	../../shared/src/phy_init.c:428: max_gen = cmx_PHY_GEN_MAX_3_0;
	mov	dptr,#_CONTROL_CONFIG8
	movx	a,@dptr
	anl	a,#0x0f
	mov	r2,a
	...
	movx	@dptr,a
00109$:
;	../../shared/src/phy_init.c:456: if( phy_mode == PCIE || phy_mode == SATA) {
	mov	dptr,#(_SYSTEM + 0x0002)
	movx	a,@dptr
	anl	a,#0x07
	mov	r2,a
...
00149$:
	...
	jnz	00111$
00110$:
;	../../shared/src/phy_init.c:457: lnx_GAIN_TRAIN_END_EN_LANE = 0;
	mov	dptr,#(_DFE_CONTROL_1 + 0x0002)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/phy_init.c:458: lnx_ADJUST_FFE_R2_LANE = 0;
	mov	dptr,#(_DFE_CONTROL_7 + 0x0002)
	movx	a,@dptr
	anl	a,#0xef
	movx	@dptr,a
;	../../shared/src/phy_init.c:459: lnx_RX_CAP_FINAL_ADJUST_EN_LANE = 0;
	mov	dptr,#(_DFE_CONTROL_7 + 0x0002)
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/phy_init.c:460: lnx_RX_RXFFE_C_INI_LANE_3_0 = 12;
	mov	dptr,#(_DFE_CONTROL_7 + 0x0003)
	movx	a,@dptr
	anl	a,#0x0f
	orl	a,#0xc0
	movx	@dptr,a
;	../../shared/src/phy_init.c:461: lnx_DFE_ISI_RES_ADAPT_EN_LANE = 0;
	mov	dptr,#(_DFE_CONTROL_7 + 0x0002)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/phy_init.c:462: lnx_TRAIN_PH_CONTROL_MODE_LANE_1_0 = 0;
	mov	dptr,#_DFE_CONTROL_3
	movx	a,@dptr
	anl	a,#0xcf
	movx	@dptr,a
;	../../shared/src/phy_init.c:463: lnx_TRAIN_USE_D_LANE = 0;
;	../../shared/src/phy_init.c:464: lnx_TRAIN_USE_S_LANE = 1;
	mov	dptr,#_DFE_CONTROL_3
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
	...
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/phy_init.c:465: lnx_SUMFTAP_EN_1_LANE = 1;
	mov	dptr,#_DFE_TEST_5
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
00111$:
;	../../shared/src/phy_init.c:469: if(reg_RING_REF_DIV_SEL==1 && phy_mode<=SAS)
	...
	subb	a,b
	jc	00114$
;	../../shared/src/phy_init.c:473: reg_ANA_FBCK_SEL_RING = 1;
	mov	dptr,#_PM_CMN_REG1
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
00114$:
;	../../shared/src/phy_init.c:477: cal_phase = 0x1e;
	mov	dptr,#(_DFE_CONTROL_3 + 0x0002)
	mov	a,#0x1E
	movx	@dptr,a
;	../../shared/src/phy_init.c:480: reg_TEMPC_MUX_HOLD_SEL_3_0 = 7; //to cover large range
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_175
	movx	a,@dptr
	anl	a,#0xf0
	orl	a,#0x07
	movx	@dptr,a
;	../../shared/src/phy_init.c:481: reg_TEMPC_MUX_SEL_3_0 = 6;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_175
	movx	a,@dptr
	anl	a,#0x0f
	orl	a,#0x60
	movx	@dptr,a
;	../../shared/src/phy_init.c:483: set_accap_sel(ACCAP_REFCLK);
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_153
	movx	a,@dptr
	anl	a,#0xe7
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/phy_init.c:486: dfe_f0_res_sel = 3;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_20
	movx	a,@dptr
	orl	a,#0x18
	movx	@dptr,a
;	../../shared/src/phy_init.c:487: dfe_res_f1 = 3;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_20
	movx	a,@dptr
	orl	a,#0x06
	movx	@dptr,a
;	../../shared/src/phy_init.c:488: dfe_f234_res_sel = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_20
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/phy_init.c:489: dfe_f567_res_sel = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_21
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/phy_init.c:492: reg_DFE_STEP_COARSE_FFX_LANE_3_0 = 0x02; //4;
	mov	dptr,#(_DFE_STEP_REG0 + 0x0001)
	movx	a,@dptr
	anl	a,#0xf0
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/phy_init.c:493: reg_DFE_STEP_COARSE_FX_LANE_3_0  = 0x02; //4;
	mov	dptr,#(_DFE_STEP_REG0 + 0x0001)
	movx	a,@dptr
	anl	a,#0x0f
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/phy_init.c:494: reg_DFE_STEP_COARSE_F0_LANE_3_0  = 0x02; //4;
	mov	dptr,#(_DFE_STEP_REG0 + 0x0002)
	movx	a,@dptr
	anl	a,#0xf0
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/phy_init.c:495: reg_DFE_STEP_FINE_FFX_LANE_3_0 = 0x04; //5;
	mov	dptr,#(_DFE_STEP_REG1 + 0x0002)
	movx	a,@dptr
	anl	a,#0x0f
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/phy_init.c:496: reg_DFE_STEP_FINE_FX_LANE_3_0  = 0x04; //5;
	mov	dptr,#(_DFE_STEP_REG1 + 0x0003)
	movx	a,@dptr
	anl	a,#0xf0
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/phy_init.c:497: reg_DFE_STEP_FINE_F0_LANE_3_0  = 0x04; //5;
	mov	dptr,#(_DFE_STEP_REG1 + 0x0003)
	movx	a,@dptr
	anl	a,#0x0f
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/phy_init.c:498: reg_DFE_STEP_ACCU_FFX_LANE_3_0 = 0x06;
	mov	dptr,#_DFE_STEP_REG1
	movx	a,@dptr
	anl	a,#0xf0
	orl	a,#0x06
	movx	@dptr,a
;	../../shared/src/phy_init.c:499: reg_DFE_STEP_ACCU_FX_LANE_3_0  = 0xa; //??0x06
	mov	dptr,#_DFE_STEP_REG1
	movx	a,@dptr
	anl	a,#0x0f
	orl	a,#0xa0
	movx	@dptr,a
;	../../shared/src/phy_init.c:500: reg_DFE_STEP_ACCU_F0_LANE_3_0  = 0x06;
	mov	dptr,#(_DFE_STEP_REG1 + 0x0001)
	movx	a,@dptr
	anl	a,#0xf0
	orl	a,#0x06
	movx	@dptr,a
;	../../shared/src/phy_init.c:501: reg_DFE_STEP_FINE_F0B_LANE_3_0 = 0x05;
	mov	dptr,#(_DFE_ANA_REG1 + 0x0003)
	movx	a,@dptr
	anl	a,#0xf0
	orl	a,#0x05
	movx	@dptr,a
;	../../shared/src/phy_init.c:502: reg_DFE_STEP_ACCU_F0B_LANE_3_0 = 0x06;
	mov	dptr,#_DFE_ANA_REG1
	movx	a,@dptr
	anl	a,#0xf0
	orl	a,#0x06
	movx	@dptr,a
;	../../shared/src/phy_init.c:503: reg_DFE_STEP_COARSE_EO_DN_LANE_3_0 = 0;//1;//2; //512=1/2
	mov	dptr,#_DFE_STEP_REG0
	movx	a,@dptr
	anl	a,#0xf0
	movx	@dptr,a
;	../../shared/src/phy_init.c:504: reg_DFE_STEP_COARSE_EO_UP_LANE_3_0 = 7;//5;//5; //64=1/32
	mov	dptr,#_DFE_STEP_REG0
	movx	a,@dptr
	anl	a,#0x0f
	orl	a,#0x70
	movx	@dptr,a
;	../../shared/src/phy_init.c:505: reg_DFE_STEP_FINE_EO_DN_LANE_3_0 = 3; //1/8 =256
	mov	dptr,#(_DFE_STEP_REG1 + 0x0001)
	movx	a,@dptr
	anl	a,#0x0f
	orl	a,#0x30
	movx	@dptr,a
;	../../shared/src/phy_init.c:506: reg_DFE_STEP_FINE_EO_UP_LANE_3_0 = 5;//6; //1/32 =32
	mov	dptr,#(_DFE_STEP_REG1 + 0x0002)
	movx	a,@dptr
	anl	a,#0xf0
	orl	a,#0x05
	movx	@dptr,a
;	../../shared/src/phy_init.c:507: reg_DFE_EO_UP_THRE_COARSE_4_0 = 5; //10;//6;
	mov	dptr,#_DFE_STATIC_REG0
	movx	a,@dptr
	anl	a,#0xe0
	orl	a,#0x05
	movx	@dptr,a
;	../../shared/src/phy_init.c:508: reg_DFE_EO_UP_THRE_FINE_4_0_b0 = 7;// 7 //8
	mov	dptr,#_DFE_STATIC_REG0
	movx	a,@dptr
	orl	a,#0xe0
	movx	@dptr,a
;	../../shared/src/phy_init.c:509: reg_DFE_EO_UP_THRE_FINE_4_0_b1 = 0;
	mov	dptr,#(_DFE_STATIC_REG0 + 0x0001)
	movx	a,@dptr
	anl	a,#0xfc
	movx	@dptr,a
;	../../shared/src/phy_init.c:511: reg_DFE_DC_SIGN_XOR = 1; //to fix the rxdata wrong because DC adaptation diverged
	mov	dptr,#(_DFE_STATIC_REG3 + 0x0001)
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/phy_init.c:513: if(phy_mode==SATA) {
	mov	dptr,#(_SYSTEM + 0x0002)
	movx	a,@dptr
	anl	a,#0x07
	jnz	00117$
;	../../shared/src/phy_init.c:514: reg_TXDATA_LATENCY_REDUCE_EN_LANE = 1;
	mov	dptr,#(_TX_SPEED_CONVERT_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/phy_init.c:515: reg_RXDATA_LATENCY_REDUCE_EN_LANE = 1;
	mov	dptr,#(_RX_DATA_PATH_REG + 0x0003)
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
00117$:
;	../../shared/src/phy_init.c:521: reg_SSC_DSPREAD_TX_RING = reg_SSC_DSPREAD_TX;
	...
	mov	acc.6,c
	movx	@dptr,a
;	../../shared/src/phy_init.c:524: reg_CLK_DIRECTION_RINGPLL_LANE = 1; //ringpll direction control: ringpll->1->0, ringpll->2->3
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_150
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/phy_init.c:528: reg_PLL_PWEXP_DIS_RING = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_193
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/phy_init.c:531: reg_VREF_VDDACAL_SEL_2_0 = 6; //for vdd rxsampler cal
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_137
	movx	a,@dptr
	anl	a,#0xe3
	orl	a,#0x18
	movx	@dptr,a
;	../../shared/src/phy_init.c:534: if(cmx_VCON_FORCE_DISABLE==0) {
	mov	dptr,#(_CONTROL_CONFIG3 + 0x0003)
	movx	a,@dptr
	jb	acc.1,00122$
;	../../shared/src/phy_init.c:535: reg_VCON_REF_SEL_2_0 = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_172
	movx	a,@dptr
	anl	a,#0x1f
	movx	@dptr,a
;	../../shared/src/phy_init.c:536: reg_VARAC_BIAS_SEL_2_0 = 7;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_180
	movx	a,@dptr
	orl	a,#0xe0
	movx	@dptr,a
;	../../shared/src/phy_init.c:537: reg_VREF_0P6V_LCVCO_SEL_1_0 = 3;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_135
	movx	a,@dptr
	orl	a,#0x18
	movx	@dptr,a
;	../../shared/src/phy_init.c:538: if ( ana_pwr==0x02 ) { //1.8V
	mov	a,r3
	jz	00119$
;	../../shared/src/phy_init.c:539: reg_VCON_MIN_SEL_2_0 = 4;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_179
	movx	a,@dptr
	anl	a,#0xe3
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/phy_init.c:540: reg_VCON_MAX_SEL_2_0 = 5;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_179
	movx	a,@dptr
	anl	a,#0x1f
	orl	a,#0xa0
	...
	sjmp	00120$
00119$:
;	../../shared/src/phy_init.c:543: reg_VCON_MIN_SEL_2_0 = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_179
	movx	a,@dptr
	anl	a,#0xe3
	movx	@dptr,a
;	../../shared/src/phy_init.c:544: reg_VCON_MAX_SEL_2_0 = 1;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_179
	movx	a,@dptr
	anl	a,#0x1f
	orl	a,#0x20
	movx	@dptr,a
00120$:
;	../../shared/src/phy_init.c:546: cmx_TEMPC_STEP_CTRL_2_0 = 3;
	...
	movx	@dptr,a
00122$:
;	../../shared/src/phy_init.c:549: if(phy_mode<=SAS)
	mov	dptr,#(_SYSTEM + 0x0002)
	movx	a,@dptr
	anl	a,#0x07
	mov	r2,a
	...
	subb	a,b
	jc	00124$
;	../../shared/src/phy_init.c:550: reg_LOCAL_STATUS_FIELD_INIT_LANE_15_0 = 0x4000; //tx_init=1
	...
	movx	@dptr,a
00124$:
;	../../shared/src/phy_init.c:553: MCU_WDT_LANE.VAL = 0x0020f424L; //500msec : after pass the time = mcu_clk * reg_mcu_wdt_cnt_lo[15:0] * reg_mcu_wdt_cnt_hi[14:0], mcu trigger PIN_MCU_WDT0/1 to SOC
	mov	dptr,#_MCU_WDT_LANE
	mov	a,#0x24
	movx	@dptr,a
	inc	dptr
	mov	a,#0xF4
	...
	clr	a
	movx	@dptr,a
;	../../shared/src/phy_init.c:554: reg_MCU_WDT_EN_LANE = 1;
	mov	dptr,#(_MCU_WDT_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/phy_init.c:559: reg_VTHVCOCAL_2_0 = 1;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_136
	movx	a,@dptr
	anl	a,#0xf1
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/phy_init.c:560: reg_VTHVCOPTAT_2_0 = 6;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_137
	movx	a,@dptr
	anl	a,#0x1f
	orl	a,#0xc0
	movx	@dptr,a
;	../../shared/src/phy_init.c:561: reg_CMN_IPP_SLLP_CUR_SEL_2_0 = 4;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_210
	movx	a,@dptr
	anl	a,#0xe3
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/phy_init.c:562: reg_SEL_IPP_IPTAT_SLLP_RING_1_0 = 2;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_197
	movx	a,@dptr
	anl	a,#0xcf
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/phy_init.c:566: reg_PLL_SLLP_DAC_RANGE_SHIFT_RING_1_0 = 1;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_193
	movx	a,@dptr
	anl	a,#0xcf
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/phy_init.c:568: reg_VCON_REF_SEL_RING_1_0 = 2;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_137
	movx	a,@dptr
	anl	a,#0xfc
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/phy_init.c:569: cmx_RINGPLL_DAC_FINE_CODE_RATIO_7_0 = 4;
	mov	dptr,#(_CONTROL_CONFIG5 + 0x0002)
	mov	a,#0x04
	movx	@dptr,a
;	../../shared/src/phy_init.c:570: cmx_RINGPLL_DAC_MAX_STEP_NUM_7_0 = 0x5;
	mov	dptr,#(_CONTROL_CONFIG5 + 0x0003)
	mov	a,#0x05
	movx	@dptr,a
;	../../shared/src/phy_init.c:571: cmx_RINGPLL_CAL_FINE_STEP_7_0 = 8;
	mov	dptr,#(_CON_CAL_STEP_SIZE5 + 0x0001)
	mov	a,#0x08
	movx	@dptr,a
;	../../shared/src/phy_init.c:572: cmx_RINGPLL_CAL_COUNTER_SIZE_7_0 = 0x20;
	mov	dptr,#(_CON_CAL_STEP_SIZE5 + 0x0002)
	mov	a,#0x20
	movx	@dptr,a
;	../../shared/src/phy_init.c:575: reg_VDDVCO_VTH_12NM_SEL = 1;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_210
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/phy_init.c:579: if (cmx_TX_TRAIN_MODE == 1) {
	...
	mov	r2,a
	cjne	r2,#0x01,00127$
;	../../shared/src/phy_init.c:580: reg_TRX_TRAIN_TIMEOUT_EN_LANE = 0; //TRX train timer Enable
	mov	dptr,#(_TX_TRAIN_IF_REG0 + 0x0001)
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/phy_init.c:581: reg_PATTERN_LOCK_LOST_TIMEOUT_EN_LANE = 0; //disable FRAME detection timer
	mov	dptr,#(_TX_TRAIN_IF_REG0 + 0x0003)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/phy_init.c:582: reg_REMOTE_RD_REQ_LANE = 1; //always on read out for remote control and status
	mov	dptr,#(_DME_DEC_REG0 + 0x0002)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/phy_init.c:583: reg_LOCAL_CTRL_FM_REG_EN_LANE = 1; //force local control to pin
	mov	dptr,#(_TX_TRAIN_IF_REG2 + 0x0001)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/phy_init.c:584: reg_LOCAL_STATUS_FM_REG_EN_LANE = 1; //force local status to pin
	mov	dptr,#(_TX_TRAIN_IF_REG2 + 0x0001)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/phy_init.c:585: reg_LOCAL_FIELD_FORCE_LANE = 1; //force local control and status to dme encoder
	mov	dptr,#(_DME_ENC_REG0 + 0x0003)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/phy_init.c:586: reg_LOCAL_BALANCE_CAL_EN_LANE = 1; //enable balance bit cal in force mode
;	../../shared/src/phy_init.c:587: reg_LOCAL_ERROR_EN_LANE = 0; //disable HW error handling
	...
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/phy_init.c:588: reg_TRAIN_PIN_FM_REG_EN_LANE = 0; //not force COMPLETE/FAILD/ERROR
;	../../shared/src/phy_init.c:589: reg_TRAIN_ERR_FM_REG_EN_LANE = 1; //force ERROR
;	../../shared/src/phy_init.c:590: reg_TRAIN_RDY_FM_REG_EN_LANE = 0; //not force READY
	...
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/phy_init.c:591: reg_REMOTE_INIT_FM_REG_EN_LANE = 1; //force remote tx init to aviod READY by HW
	mov	dptr,#(_TX_TRAIN_IF_REG3 + 0x0003)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
00127$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'reset_pwr_reg'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/phy_init.c:607: void reset_pwr_reg(void) BANKING_CTRL {
;	-----------------------------------------
;	 function reset_pwr_reg
;	-----------------------------------------
_reset_pwr_reg:
;	../../shared/src/phy_init.c:610: if((phy_mode == PCIE) || (phy_mode == USB))
	mov	dptr,#(_SYSTEM + 0x0002)
	movx	a,@dptr
	anl	a,#0x07
	mov	r2,a
...
00139$:
	...
	sjmp	00103$
00140$:
;	../../shared/src/phy_init.c:621: PM_CTRL_INTERRUPT_REG2.BT.B2 = 0;
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG2 + 0x0002)
;	../../shared/src/phy_init.c:622: PM_CTRL_INTERRUPT_REG2.BT.B3 = 0; // PU_RX|PU_TX|PU_PLL|rx_init|regclk_dis|PU_IVREF
	clr	a
	movx	@dptr,a
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG2 + 0x0003)
	movx	@dptr,a
00103$:
;	../../shared/src/phy_init.c:630: reg_INT3_INT_REFCLK_DIS_CHG_INT_EN_LANE = 0;
	mov	dptr,#(_MCU_INT3_CONTROL + 0x0002)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/phy_init.c:631: reg_INT3_INT_PU_IVREF_CHG_INT_EN_LANE = 0;
	mov	dptr,#(_MCU_INT3_CONTROL + 0x0002)
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/phy_init.c:633: if((phy_mode == PCIE) || (phy_mode == USB))
	mov	dptr,#(_SYSTEM + 0x0002)
	movx	a,@dptr
	anl	a,#0x07
	mov	r2,a
...
00141$:
	...
	sjmp	00115$
00142$:
;	../../shared/src/phy_init.c:648: reg_INT9_PM_CHG_INT_EN_LANE = 0;
	mov	dptr,#_MCU_INT9_CONTROL
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/phy_init.c:649: if(serdes_ring_lane_en) {
	mov	dptr,#_serdes_ring_lane_en
	movx	a,@dptr
	mov	r2,a
	jz	00111$
;	../../shared/src/phy_init.c:650: if(tag_ringpll_ind_en==0 && mcuid==master_mcu)
	mov	dptr,#_CONTROL_CONFIG0
	movx	a,@dptr
	jb	acc.6,00112$
	mov	dptr,#_MCU_CONTROL_LANE
	...
	mov	a,r2
	cjne	a,ar3,00112$
;	../../shared/src/phy_init.c:651: reg_INT9_INT_PU_PLL_OR_CHG_INT_EN_LANE = 0;
	mov	dptr,#(_MCU_INT9_CONTROL + 0x0003)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
	sjmp	00112$
00111$:
;	../../shared/src/phy_init.c:653: else if(mcuid==master_mcu )
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_MCU_CONFIG
	...
	mov	a,r2
	cjne	a,ar3,00112$
;	../../shared/src/phy_init.c:654: reg_INT9_INT_PU_PLL_OR_CHG_INT_EN_LANE = 0;
	mov	dptr,#(_MCU_INT9_CONTROL + 0x0003)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
00112$:
;	../../shared/src/phy_init.c:655: reg_INT1_INT_POWER_STATE_VALID_RISE_INT_EN_LANE = 0;
	mov	dptr,#(_MCU_INT1_CONTROL + 0x0002)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/phy_init.c:657: reg_INT8_PM_PCIE_FUNC_CHG_INT_EN_LANE = 0;
	mov	dptr,#(_MCU_INT8_CONTROL + 0x0001)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
00115$:
;	../../shared/src/phy_init.c:664: reg_INT2_SPD_INT_GEN_EN_LANE = 0;
	mov	dptr,#_MCU_INT2_CONTROL
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/phy_init.c:667: reg_INT11_PIN_RX_TRAIN_ENABLE_INT_EN_LANE = 0;
	mov	dptr,#(_MCU_INT11_CONTROL + 0x0001)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/phy_init.c:670: reg_INT5_PIN_TX_TRAIN_ENABLE_INT_EN_LANE = 0;
	mov	dptr,#(_MCU_INT5_CONTROL + 0x0001)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/phy_init.c:673: reg_INT10_INT_RX_INIT_RISE_INT_EN_LANE = 0;
	mov	dptr,#(_MCU_INT10_CONTROL + 0x0002)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/phy_init.c:675: if(phy_mode != PCIE) {
	mov	dptr,#(_SYSTEM + 0x0002)
	movx	a,@dptr
	anl	a,#0x07
	mov	r2,a
	...
	sjmp	00118$
00149$:
;	../../shared/src/phy_init.c:677: reg_INT7_REMOTE_CTRL_VALID_INT_EN_LANE = 0;
	mov	dptr,#(_MCU_INT7_CONTROL + 0x0001)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/phy_init.c:685: reg_INT6_PIN_PAPTA_TRAIN_ENABLE_INT_EN_LANE = 0;
	mov	dptr,#(_MCU_INT6_CONTROL + 0x0003)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/phy_init.c:688: reg_INT12_PIN_PAPTA_TRAIN_DISABLE_INT_EN_LANE = 0;
	mov	dptr,#(_MCU_INT_CONTROL_13 + 0x0001)
	movx	a,@dptr
	anl	a,#0xef
	movx	@dptr,a
00118$:
;	../../shared/src/phy_init.c:693: if(!reg_MASTER_PHY_EN)
	mov	dptr,#_SYSTEM
	movx	a,@dptr
	jb	acc.3,00120$
;	../../shared/src/phy_init.c:694: reg_INT1_DPHY_ANA_LANE_DISABLE_INT_EN_LANE = 0;
	mov	dptr,#(_MCU_INT1_CONTROL + 0x0003)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
00120$:
;	../../shared/src/phy_init.c:699: if(mcuid== master_mcu) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_MCU_CONFIG
	...
	mov	a,r2
	cjne	a,ar3,00122$
;	../../shared/src/phy_init.c:700: reg_INT4_MCU_REMOTE_REQ_INT_EN_LANE = 0;
	mov	dptr,#(_MCU_INT4_CONTROL + 0x0003)
	movx	a,@dptr
	anl	a,#0xef
	movx	@dptr,a
00122$:
;	../../shared/src/phy_init.c:703: reg_INT4_PHY_MCU_REMOTE_REQ_INT_EN_LANE = 0;
	mov	dptr,#(_MCU_INT4_CONTROL + 0x0003)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/phy_init.c:708: reg_RX_INIT_DONE_LANE = 0;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/phy_init.c:709: reg_PIN_PLL_READY_RX_LANE = 0;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/phy_init.c:710: reg_PIN_PLL_READY_TX_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/phy_init.c:712: short_delay();
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	mov	r2,#(_short_delay >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phy_init.c:713: short_delay();
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	mov	r2,#(_short_delay >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phy_init.c:715: if(mcuid== master_mcu) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_MCU_CONFIG
...
00153$:
	sjmp	00124$
00154$:
;	../../shared/src/phy_init.c:716: pll_clk_ready_all_0();
	mov	r0,#_pll_clk_ready_all_0
	mov	r1,#(_pll_clk_ready_all_0 >> 8)
	mov	r2,#(_pll_clk_ready_all_0 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/phy_init.c:717: reg_ANA_PU_IVREF = 1;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/phy_init.c:718: reg_ANA_PU_IVREF_DLY1 =	1;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/phy_init.c:719: reg_ANA_PU_IVREF_DLY2 =	1;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/phy_init.c:720: reg_ANA_PU_IVREF_DLY3 =	1;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/phy_init.c:721: reg_ANA_PU_PLL = 0;
	mov	dptr,#(_PM_CMN_REG1 + 0x0003)
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/phy_init.c:722: reg_ANA_PU_PLL_DLY	= 0;
	mov	dptr,#(_PM_CMN_REG1 + 0x0003)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/phy_init.c:723: reg_RESET_ANA = 1;
	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/phy_init.c:724: reg_REFCLK_DIS_FM_PM = 0;
	mov	dptr,#(_PM_CMN_REG1 + 0x0003)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/phy_init.c:726: reg_RESET_ANA_RING = 1;
	mov	dptr,#(_PLLCAL_REG1 + 0x0003)
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/phy_init.c:727: reg_ANA_PU_PLL_RING = 0;
	mov	dptr,#_INPUT_CMN_PIN_REG2
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/phy_init.c:728: reg_ANA_PU_PLL_DLY_RING = 0;
	mov	dptr,#(_PM_CMN_REG2 + 0x0001)
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/phy_init.c:729: reg_RESET_DTX_RING = 1;
	mov	dptr,#(_DTX_REG2 + 0x0001)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/phy_init.c:730: reg_DTX_CLK_OFF_RING = 1;
	mov	dptr,#_PM_CMN_REG1
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/phy_init.c:732: reg_DTX_CLK_OFF	= 1;
	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/phy_init.c:733: reg_RESET_DTX = 1;
	mov	dptr,#(_DTX_REG0 + 0x0002)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/phy_init.c:734: reg_TX_INTPRESET_EXT = 1;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_187
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
00124$:
;	../../shared/src/phy_init.c:744: reg_ANA_PU_RX_LANE	= 0;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/phy_init.c:745: reg_ANA_PU_RX_DLY_LANE	= 0;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/phy_init.c:746: reg_ANA_PU_TX_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/phy_init.c:747: reg_ANA_PU_SQ_LANE	= 0;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/phy_init.c:748: reg_DTL_FLOOP_FREEZE_LANE =	1;
	mov	dptr,#(_DTL_REG0 + 0x0003)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/phy_init.c:749: reg_REG_DTL_LOOP_FREEZE_LANE = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_141
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/phy_init.c:750: reg_DFE_CLK_OFF_LANE = 1;
	mov	dptr,#_RX_EQ_CLK_CTRL
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/phy_init.c:751: reg_RESET_DTL_LANE = 1;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/phy_init.c:752: reg_RESET_DFE_LANE = 1;
	mov	dptr,#_RX_EQ_CLK_CTRL
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/phy_init.c:753: reg_ANA_TX_LESS_CUR_IDLE_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/phy_init.c:754: reg_ANA_TX_IDLE_HIZ_EN_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/phy_init.c:755: reg_ANA_BEACON_EN_LANE = 0;
	mov	dptr,#_PM_CTRL_TX_LANE_REG1_LANE
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/phy_init.c:756: reg_ANA_TXDETRX_START_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/phy_init.c:757: reg_ANA_TXDETRX_EN_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/phy_init.c:758: reg_PIN_TXDETRX_VALID_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/phy_init.c:759: reg_EOM_RESET_INTP_EXT_LANE = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_9
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/phy_init.c:760: reg_RESET_INTP_EXT_LANE = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_134
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/phy_init.c:762: reg_TRXDCC_CAL_CLK100KHZ_LANE = 0; 
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_136
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/phy_init.c:763: reg_RXDCC_DAC_SYNC_CLK_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_17
	movx	a,@dptr
	anl	a,#0xef
	movx	@dptr,a
;	../../shared/src/phy_init.c:764: reg_TXDCCCAL_EN_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_147
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/phy_init.c:765: reg_RXDCC_CAL_EN_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_16
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/phy_init.c:766: reg_TEMPC_DAC_VALID = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_176
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/phy_init.c:767: reg_EOM_ALIGN_EN_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_14
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/phy_init.c:768: reg_TX_TDCAL_EN_LANE = 0;
	...
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'set_timer_cnt'
;------------------------------------------------------------
;temp                      Allocated to registers r2 r3 
;temp32                    Allocated to registers r2 r3 r4 r5 
;i                         Allocated to registers r2 
;------------------------------------------------------------
;	../../shared/src/phy_init.c:773: void set_timer_cnt() BANKING_CTRL {
;	-----------------------------------------
;	 function set_timer_cnt
;	-----------------------------------------
_set_timer_cnt:
;	../../shared/src/phy_init.c:778: if(cmx_MCU_FREQ_15_0==0) cmx_MCU_FREQ_15_0 = 400;
	mov	dptr,#_MCU_CONFIG1
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	movx	a,@dptr
	...
	movx	@dptr,a
00102$:
;	../../shared/src/phy_init.c:779: mcuclk_mc = (uint8_t)((cmx_MCU_FREQ_15_0+8)/15);
	mov	dptr,#_MCU_CONFIG1
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/phy_init.c:780: reg_MCU_DEBUG0_LANE_7_0 = mcuclk_mc;
	mov	dptr,#_MCU_DEBUG0_LANE
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/phy_init.c:782: i = reg_PIN_REF_FREF_SEL_RD_4_0;
	mov	dptr,#(_ANA_TSEN_CONTROL + 0x0003)
	movx	a,@dptr
	swap	a
	rl	a
	anl	a,#0x1f
;	../../shared/src/phy_init.c:783: cmx_REFCLK_FREQ_7_0 = refclk_tb[i];
	mov	dptr,#_refclk_tb
	movc	a,@a+dptr
	mov	r2,a
	...
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/phy_init.c:787: reg_TIMER_1_SEL_LANE_1_0 = 0x01;	//PWM1
	mov	dptr,#_MCU_TIMER_CTRL_1_LANE
	movx	a,@dptr
	anl	a,#0xf3
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/phy_init.c:788: reg_TIMER_2_SEL_LANE_1_0 = 0x01;	//PWM1
	mov	dptr,#_MCU_TIMER_CTRL_1_LANE
	movx	a,@dptr
	anl	a,#0xcf
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/phy_init.c:789: reg_PWM1_CLK_SEL_LANE_1_0 = 0; //refclk 
	mov	dptr,#_MCU_TIMER_CTRL_6_LANE
	movx	a,@dptr
	anl	a,#0xf3
	movx	@dptr,a
;	../../shared/src/phy_init.c:790: reg_PWM1_EN_LANE = 1;
	mov	dptr,#(_MCU_TIMER_CTRL_3_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/phy_init.c:791: temp = cmx_REFCLK_FREQ_7_0>>1;
	mov	dptr,#(_CONTROL_CONFIG8 + 0x0003)
	movx	a,@dptr
	clr	c
	rrc	a
	mov	r2,a
	mov	r3,#0x00
;	../../shared/src/phy_init.c:792: reg_PWM1_COUNTER_LANE_30_0_b0 = (uint8_t)temp;
	mov	ar4,r2
	mov	dptr,#_MCU_TIMER_CTRL_3_LANE
	mov	a,r4
	movx	@dptr,a
;	../../shared/src/phy_init.c:793: reg_PWM1_COUNTER_LANE_30_0_b1 = (uint8_t)(temp >> 8);
	mov	ar2,r3
	mov	dptr,#(_MCU_TIMER_CTRL_3_LANE + 0x0001)
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/phy_init.c:796: reg_PWM2_CLK_SEL_LANE_1_0 = 0; //refclk 
	mov	dptr,#_MCU_TIMER_CTRL_6_LANE
	movx	a,@dptr
	anl	a,#0xcf
	movx	@dptr,a
;	../../shared/src/phy_init.c:797: temp32 = cmx_REFCLK_FREQ_7_0*500L;
	mov	dptr,#(_CONTROL_CONFIG8 + 0x0003)
	movx	a,@dptr
	mov	r2,a
	mov	r3,#0x00
	...
	add	a,#0xfc
	mov	sp,a
;	../../shared/src/phy_init.c:798: reg_PWM2_COUNTER_LANE_30_0_b0 = (uint8_t)temp32;
	mov	ar6,r2
	mov	dptr,#_MCU_TIMER_CTRL_4_LANE
	mov	a,r6
	movx	@dptr,a
;	../../shared/src/phy_init.c:799: reg_PWM2_COUNTER_LANE_30_0_b1 = (uint8_t)(temp32 >> 8);
	mov	ar6,r3
	mov	dptr,#(_MCU_TIMER_CTRL_4_LANE + 0x0001)
	mov	a,r6
	movx	@dptr,a
;	../../shared/src/phy_init.c:800: reg_PWM2_COUNTER_LANE_30_0_b2 = (uint8_t)(temp32 >> 16);
	mov	ar2,r4
	mov	dptr,#(_MCU_TIMER_CTRL_4_LANE + 0x0002)
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/phy_init.c:803: reg_TIMER_3_EN_LANE = 0;
	mov	dptr,#_MCU_TIMER_CONTROL
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/phy_init.c:804: reg_TIMER3_CLK_SEL_LANE_1_0 = 0; //refclk
	mov	dptr,#_MCU_TIMER_CTRL_7_LANE
	movx	a,@dptr
	anl	a,#0x3f
	movx	@dptr,a
;	../../shared/src/phy_init.c:805: reg_TIMER3_HI_CNT_LANE_15_0 = 500;
	mov	dptr,#_MCU_TIMER3_CONTROL
	mov	a,#0xF4
	movx	@dptr,a
	inc	dptr
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/phy_init.c:806: reg_TIMER3_LO_CNT_LANE_15_0 = u16mul(cmx_REFCLK_FREQ_7_0, lnx_TX_TRAIN_FRAME_DET_TIMER_LANE_7_0+1);
	mov	dptr,#(_TRX_TRAIN_IF_TIMERS1_LANE + 0x0002)
	movx	a,@dptr
	mov	r2,a
	mov	r3,#0x00
	inc	r2
...
00107$:
	...
	dec	sp
	dec	sp
	mov	dptr,#(_MCU_TIMER3_CONTROL + 0x0002)
	mov	a,r2
	movx	@dptr,a
	inc	dptr
	mov	a,r3
