...
; This file was generated Thu Oct 18 21:21:46 2018
;--------------------------------------------------------
	.module power_rom
...
;--------------------------------------------------------
	...
	.globl _pu_ivref_on
	.globl _check_pu_ivref
	.globl _pu_rx_on
	.globl _pu_rx_off
	.globl _pu_ringpll_off
	.globl _pu_lcgpll_off
	.globl _master_pu_pll_off
	.globl _pll_clk_ready_1
	.globl _pll_clk_ready_0
	.globl _pll_clk_ready_ring_0
	.globl _pll_clk_ready_ring_1
	.globl _check_pll_clk_ready
	.globl _check_pll_clk_ready_pcie
	.globl _pll_clk_ready_all_0
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area BANK2   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'pu_ivref_on'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_rom.c:16: void pu_ivref_on(void) BANKING_CTRL {
;	-----------------------------------------
;	 function pu_ivref_on
;	-----------------------------------------
_pu_ivref_on:
	ar2 = 0x02
	ar3 = 0x03
	...
	ar0 = 0x00
	ar1 = 0x01
;	../../shared/src/power_rom.c:18: EA = 0;
	clr	_EA
;	../../shared/src/power_rom.c:19: reg_ANA_PU_IVREF = 1;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/power_rom.c:20: delay01(10); //1us
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_rom.c:21: reg_ANA_PU_IVREF_DLY1 = 1;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/power_rom.c:22: delay01(10); //1us
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_rom.c:23: reg_ANA_PU_IVREF_DLY2 = 1;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/power_rom.c:24: delay01(10); //1us
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_rom.c:25: reg_ANA_PU_IVREF_DLY3 = 1;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/power_rom.c:26: EA = 1;
	setb	_EA
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'check_pu_ivref'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_rom.c:30: void check_pu_ivref(void) BANKING_CTRL {
;	-----------------------------------------
;	 function check_pu_ivref
;	-----------------------------------------
_check_pu_ivref:
;	../../shared/src/power_rom.c:31: do {
00103$:
;	../../shared/src/power_rom.c:32: if(reg_ANA_PU_IVREF_DLY3 /*|| reg_PU_IVREF_FELL==0*/) break;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	jnb	acc.0,00103$
;	../../shared/src/power_rom.c:33: } while(1);
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'pu_rx_on'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_rom.c:36: void pu_rx_on(void) BANKING_CTRL {
;	-----------------------------------------
;	 function pu_rx_on
;	-----------------------------------------
_pu_rx_on:
;	../../shared/src/power_rom.c:38: EA = 0;
	clr	_EA
;	../../shared/src/power_rom.c:42: if(serdes_ring_lane_en && tag_ringpll_ind_en) {
	...
	movx	a,@dptr
	jnb	acc.6,00105$
;	../../shared/src/power_rom.c:43: if(ring_lane_sel) 
	mov	dptr,#_ring_lane_sel
	movx	a,@dptr
	mov	r2,a
	jz	00102$
;	../../shared/src/power_rom.c:47: reg_ANA_PU_PLL_RING = 1; 
	...
	sjmp	00106$
00102$:
;	../../shared/src/power_rom.c:50: reg_ANA_PU_PLL = 1; 
	...
	sjmp	00106$
00105$:
;	../../shared/src/power_rom.c:55: reg_ANA_PU_PLL = 1; 
	mov	dptr,#(_PM_CMN_REG1 + 0x0003)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
00106$:
;	../../shared/src/power_rom.c:62: reg_ANA_PU_RX_LANE = 1;	
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power_rom.c:63: delay01(5);
	mov	dptr,#0x0005
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_rom.c:64: reg_ANA_PU_RX_DLY_LANE = 1;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/power_rom.c:65: delay01(4);
	mov	dptr,#0x0004
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_rom.c:66: reg_FFE_PULSE_EN_LANE = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_131
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/power_rom.c:67: reg_ANA_RX_PU_DLY2_LANE = 1;
	mov	dptr,#_INPUT_RX_PIN_REG3_LANE
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/power_rom.c:68: EA =1;
	setb	_EA
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'pu_rx_off'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_rom.c:72: void pu_rx_off(void) BANKING_CTRL {
;	-----------------------------------------
;	 function pu_rx_off
;	-----------------------------------------
_pu_rx_off:
;	../../shared/src/power_rom.c:73: EA = 0;
	clr	_EA
;	../../shared/src/power_rom.c:74: reg_FFE_PULSE_EN_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_131
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/power_rom.c:75: reg_ANA_PU_RX_LANE = 0;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/power_rom.c:76: reg_ANA_PU_RX_DLY_LANE = 0;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/power_rom.c:77: reg_ANA_RX_PU_DLY2_LANE = 0;
	mov	dptr,#_INPUT_RX_PIN_REG3_LANE
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/power_rom.c:78: EA = 1;
	setb	_EA
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'pu_ringpll_off'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_rom.c:81: void pu_ringpll_off(void) BANKING_CTRL { 
;	-----------------------------------------
;	 function pu_ringpll_off
;	-----------------------------------------
_pu_ringpll_off:
;	../../shared/src/power_rom.c:86: reg_DTX_CLK_OFF_RING = 1;
	mov	dptr,#_PM_CMN_REG1
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/power_rom.c:87: reg_RESET_DTX_RING = 1;
	mov	dptr,#(_DTX_REG2 + 0x0001)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/power_rom.c:90: pll_clk_ready_ring_0();
	mov	r0,#_pll_clk_ready_ring_0
	mov	r1,#(_pll_clk_ready_ring_0 >> 8)
	mov	r2,#(_pll_clk_ready_ring_0 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_rom.c:92: delay01(10);
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_rom.c:98: reg_RESET_ANA_RING = 1;
	mov	dptr,#(_PLLCAL_REG1 + 0x0003)
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/power_rom.c:99: reg_ANA_PU_PLL_DLY_RING = 0;
	mov	dptr,#(_PM_CMN_REG2 + 0x0001)
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/power_rom.c:100: reg_ANA_PU_PLL_RING = 0;
	mov	dptr,#_INPUT_CMN_PIN_REG2
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'pu_lcgpll_off'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_rom.c:104: void pu_lcgpll_off(void) BANKING_CTRL { 
;	-----------------------------------------
;	 function pu_lcgpll_off
;	-----------------------------------------
_pu_lcgpll_off:
;	../../shared/src/power_rom.c:105: reg_DTX_CLK_OFF = 1;
	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/power_rom.c:106: reg_RESET_DTX = 1;
	mov	dptr,#(_DTX_REG0 + 0x0002)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/power_rom.c:108: pll_clk_ready_0();
	mov	r0,#_pll_clk_ready_0
	mov	r1,#(_pll_clk_ready_0 >> 8)
	mov	r2,#(_pll_clk_ready_0 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_rom.c:110: delay01(10);
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_rom.c:111: reg_RESET_ANA = 1;	
	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/power_rom.c:112: reg_ANA_PU_PLL_DLY = 0;
	mov	dptr,#(_PM_CMN_REG1 + 0x0003)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/power_rom.c:113: reg_ANA_PU_PLL = 0;		
	mov	dptr,#(_PM_CMN_REG1 + 0x0003)
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'master_pu_pll_off'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_rom.c:116: void master_pu_pll_off(void) BANKING_CTRL {			
;	-----------------------------------------
;	 function master_pu_pll_off
;	-----------------------------------------
_master_pu_pll_off:
;	../../shared/src/power_rom.c:121: reg_DTX_CLK_OFF = 1;	reg_DTX_CLK_OFF_RING = 1;
	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
	...
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/power_rom.c:122: reg_RESET_DTX	= 1; 	reg_RESET_DTX_RING = 1;
	mov	dptr,#(_DTX_REG0 + 0x0002)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
	...
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/power_rom.c:125: pll_clk_ready_all_0();
	mov	r0,#_pll_clk_ready_all_0
	mov	r1,#(_pll_clk_ready_all_0 >> 8)
	mov	r2,#(_pll_clk_ready_all_0 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_rom.c:127: delay01(10);
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_rom.c:133: reg_RESET_ANA = 1;	reg_RESET_ANA_RING = 1;
	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
	...
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/power_rom.c:134: reg_ANA_PU_PLL_DLY = 0; reg_ANA_PU_PLL_DLY_RING = 0;
	mov	dptr,#(_PM_CMN_REG1 + 0x0003)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
	...
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/power_rom.c:135: reg_ANA_PU_PLL = 0;	reg_ANA_PU_PLL_RING = 0;
	mov	dptr,#(_PM_CMN_REG1 + 0x0003)
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
	...
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'pll_clk_ready_1'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_rom.c:140: void pll_clk_ready_1(void) BANKING_CTRL { // //ana_pll_clk_ready**=1
;	-----------------------------------------
;	 function pll_clk_ready_1
;	-----------------------------------------
_pll_clk_ready_1:
;	../../shared/src/power_rom.c:142: reg_ANA_PLL_CLK_READY_PRE0 = 1;	
	mov	dptr,#(_PM_CMN_REG2 + 0x0003)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/power_rom.c:143: delay01(5);
	mov	dptr,#0x0005
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_rom.c:144: reg_ANA_PLL_CLK_READY_PRE1 = 1;	
	mov	dptr,#(_PM_CMN_REG2 + 0x0003)
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/power_rom.c:145: delay01(5);
	mov	dptr,#0x0005
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_rom.c:146: reg_ANA_PLL_CLK_READY = 1; 
	mov	dptr,#(_PM_CMN_REG2 + 0x0003)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'pll_clk_ready_0'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_rom.c:149: void pll_clk_ready_0(void) BANKING_CTRL { //ana_pll_clk_ready lc=0
;	-----------------------------------------
;	 function pll_clk_ready_0
;	-----------------------------------------
_pll_clk_ready_0:
;	../../shared/src/power_rom.c:150: reg_ANA_PLL_CLK_READY = 0; 
	mov	dptr,#(_PM_CMN_REG2 + 0x0003)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/power_rom.c:151: reg_ANA_PLL_CLK_READY_PRE1 =0;	
	mov	dptr,#(_PM_CMN_REG2 + 0x0003)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/power_rom.c:152: reg_ANA_PLL_CLK_READY_PRE0 = 0;
	mov	dptr,#(_PM_CMN_REG2 + 0x0003)
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'pll_clk_ready_ring_0'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_rom.c:155: void pll_clk_ready_ring_0(void) BANKING_CTRL {
;	-----------------------------------------
;	 function pll_clk_ready_ring_0
;	-----------------------------------------
_pll_clk_ready_ring_0:
;	../../shared/src/power_rom.c:161: reg_ANA_PLL_CLK_READY_RING = 0;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/power_rom.c:162: reg_ANA_PLL_CLK_READY_PRE1_RING =0;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/power_rom.c:163: reg_ANA_PLL_CLK_READY_PRE0_RING = 0;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'pll_clk_ready_ring_1'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_rom.c:167: void pll_clk_ready_ring_1(void) BANKING_CTRL {
;	-----------------------------------------
;	 function pll_clk_ready_ring_1
;	-----------------------------------------
_pll_clk_ready_ring_1:
;	../../shared/src/power_rom.c:175: reg_ANA_PLL_CLK_READY_PRE0_RING = 1;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/power_rom.c:176: delay01(5);
	mov	dptr,#0x0005
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_rom.c:177: reg_ANA_PLL_CLK_READY_PRE1_RING = 1;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power_rom.c:178: delay01(5);
	mov	dptr,#0x0005
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_rom.c:179: reg_ANA_PLL_CLK_READY_RING = 1;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'check_pll_clk_ready'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_rom.c:183: void check_pll_clk_ready(void) BANKING_CTRL {
;	-----------------------------------------
;	 function check_pll_clk_ready
;	-----------------------------------------
_check_pll_clk_ready:
;	../../shared/src/power_rom.c:184: do {
00110$:
;	../../shared/src/power_rom.c:188: if(ring_pll_enabled && reg_ANA_PLL_CLK_READY_RING) break;
	jnb	_ring_pll_enabled,00105$
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	jb	acc.5,00113$
00105$:
;	../../shared/src/power_rom.c:190: else if(ring_pll_enabled==0 && reg_ANA_PLL_CLK_READY) break;
	jb	_ring_pll_enabled,00106$
	mov	dptr,#(_PM_CMN_REG2 + 0x0003)
	movx	a,@dptr
	jb	acc.0,00113$
00106$:
;	../../shared/src/power_rom.c:191: if(PHY_NS!=ST_INIT) break;
	mov	dptr,#(_MCU_STATUS0_LANE + 0x0001)
	movx	a,@dptr
	jz	00110$
;	../../shared/src/power_rom.c:192: } while(1);
00113$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'check_pll_clk_ready_pcie'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_rom.c:195: void check_pll_clk_ready_pcie(void) BANKING_CTRL {
;	-----------------------------------------
;	 function check_pll_clk_ready_pcie
;	-----------------------------------------
_check_pll_clk_ready_pcie:
;	../../shared/src/power_rom.c:196: do {
00109$:
;	../../shared/src/power_rom.c:200: if(use_ring_pll && reg_ANA_PLL_CLK_READY_RING) break;
	jnb	_use_ring_pll,00104$
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	jb	acc.5,00112$
00104$:
;	../../shared/src/power_rom.c:202: else if(reg_ANA_PLL_CLK_READY) break;
	mov	dptr,#(_PM_CMN_REG2 + 0x0003)
	movx	a,@dptr
	jb	acc.0,00112$
;	../../shared/src/power_rom.c:203: if(PHY_NS!=ST_INIT) break;
	mov	dptr,#(_MCU_STATUS0_LANE + 0x0001)
	movx	a,@dptr
	jz	00109$
;	../../shared/src/power_rom.c:204: } while(1);
00112$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'pll_clk_ready_all_0'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_rom.c:207: void pll_clk_ready_all_0(void) BANKING_CTRL { //ana_pll_clk_ready**=0
;	-----------------------------------------
;	 function pll_clk_ready_all_0
;	-----------------------------------------
_pll_clk_ready_all_0:
;	../../shared/src/power_rom.c:208: reg_ANA_PLL_CLK_READY = 0; 
	mov	dptr,#(_PM_CMN_REG2 + 0x0003)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/power_rom.c:209: reg_ANA_PLL_CLK_READY_PRE1 =0;
	mov	dptr,#(_PM_CMN_REG2 + 0x0003)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/power_rom.c:210: reg_ANA_PLL_CLK_READY_PRE0 = 0;
	mov	dptr,#(_PM_CMN_REG2 + 0x0003)
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/power_rom.c:216: reg_ANA_PLL_CLK_READY_PRE0_RING = 0;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/power_rom.c:217: reg_ANA_PLL_CLK_READY_PRE1_RING =0;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/power_rom.c:218: reg_ANA_PLL_CLK_READY_RING = 0;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
