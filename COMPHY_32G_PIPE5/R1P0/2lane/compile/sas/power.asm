...
;--------------------------------------------------------
	...
	.globl _pu_pll_on
	.globl _pu_pll_off
	.globl _DTL_DTX_DFE_clkoff_reset_0
	.globl _DTL_DTX_DFE_clkoff_reset_1
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area BANK1   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'PowerUp_Seq'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power.c:116: void PowerUp_Seq(void) BANKING_CTRL {
;	-----------------------------------------
;	 function PowerUp_Seq
;	-----------------------------------------
_PowerUp_Seq:
	ar2 = 0x02
	ar3 = 0x03
	...
	ar0 = 0x00
	ar1 = 0x01
;	../../shared/src/power.c:118: reg_ANA_REG_SU_DLY_SEL_1_0 = 3;
	mov	dptr,#_ANA_IF_CMN_REG0
	movx	a,@dptr
	orl	a,#0x03
	movx	@dptr,a
;	../../shared/src/power.c:119: reg_ANA_REG_HD_DLY_SEL_1_0 = 3;
	mov	dptr,#_ANA_IF_CMN_REG0
	movx	a,@dptr
	orl	a,#0x0c
	movx	@dptr,a
;	../../shared/src/power.c:120: SYNC_SATUS_PLL_OR_PLL_OFF = 1;
	mov	dptr,#(_SYNC_INFO + 0x0001)
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/power.c:121: set_timer_cnt();
	mov	r0,#_set_timer_cnt
	mov	r1,#(_set_timer_cnt >> 8)
	mov	r2,#(_set_timer_cnt >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:122: PHY_STATUS_INT = IDLE;
	mov	dptr,#_MCU_STATUS2_LANE
;	../../shared/src/power.c:124: slave_phy_on = 0;
	clr	a
	movx	@dptr,a
	mov	dptr,#_slave_phy_on
	movx	@dptr,a
;	../../shared/src/power.c:144: reg_ANA_REFCLK_SEL = reg_PIN_REFCLK_SEL_RD; 
	...
	mov	acc.6,c
	movx	@dptr,a
;	../../shared/src/power.c:145: sync_status_lane_en(1);
	mov	dpl,#0x01
	mov	r0,#_sync_status_lane_en
	mov	r1,#(_sync_status_lane_en >> 8)
	mov	r2,#(_sync_status_lane_en >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:146: ring_use_250m = USE_RING_REFCLK_250M;
	mov	dptr,#_phy_mode_cmn_table
	movx	a,@dptr
	add	a,#0xff
;	../../shared/src/power.c:147: reg_CLK1G_REFCLK_SEL = ring_use_250m==0;
	mov  _ring_use_250m,c
	cpl	c
	mov  b0,c
	clr	a
	rlc	a
	...
	mov	acc.6,c
	movx	@dptr,a
;	../../shared/src/power.c:149: reg_REF_CLK_RING_SEL = ring_use_250m==0;
	mov	c,b0
	clr	a
	rlc	a
	...
	mov	acc.7,c
	movx	@dptr,a
;	../../shared/src/power.c:172: if(cmx_ETHERNET_CFG_1_0 > 0x01) {
	...
	subb	a,b
	jnc	00108$
;	../../shared/src/power.c:173: serdes_ring_lane_en = 1;
	mov	dptr,#_serdes_ring_lane_en
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/power.c:174: ring_pll_enabled = 1;
	setb	_ring_pll_enabled
;	../../shared/src/power.c:175: ring_lane_sel = 0;
	mov	dptr,#_ring_lane_sel
	clr	a
	movx	@dptr,a
;	../../shared/src/power.c:176: master_mcu = cmx_LCPLL_LANE_SEL;
	mov	dptr,#_CONTROL_CONFIG0
	movx	a,@dptr
	rr	a
	rr	a
	...
	movx	@dptr,a
;	../../shared/src/power.c:177: if(mcuid == (~master_mcu & 0x01)) {
	...
	mov	a,r5
	cjne	a,ar4,00109$
;	../../shared/src/power.c:178: ring_lane_sel = 1;
	mov	dptr,#_ring_lane_sel
	mov	a,#0x01
	movx	@dptr,a
	sjmp	00109$
00108$:
;	../../shared/src/power.c:184: if(phy_mode == SERDES) no_pllspdchg = 1;
	...
	setb	_no_pllspdchg
00104$:
;	../../shared/src/power.c:185: serdes_ring_lane_en = 0;
	mov	dptr,#_serdes_ring_lane_en
;	../../shared/src/power.c:189: ring_lane_sel = 0;
	clr	a
	movx	@dptr,a
	mov	dptr,#_ring_lane_sel
	movx	@dptr,a
;	../../shared/src/power.c:190: if(mcuid == master_mcu) ring_lane_sel = 1;
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_MCU_CONFIG
	...
	movx	@dptr,a
00109$:
;	../../shared/src/power.c:196: PHY_STATUS = ST_POSEQ;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x02
	movx	@dptr,a
;	../../shared/src/power.c:199: init_xdata();
	mov	r0,#_init_xdata
	mov	r1,#(_init_xdata >> 8)
	mov	r2,#(_init_xdata >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:200: init_reg();
	mov	r0,#_init_reg
	mov	r1,#(_init_reg >> 8)
	mov	r2,#(_init_reg >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:205: reg_DTL_LOOP_FREEZE_LANE = 1;  //analog deleted
	mov	dptr,#(_DTL_REG2 + 0x0002)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/power.c:209: reg_DTL_FLOOP_FREEZE_LANE = 1;
	mov	dptr,#(_DTL_REG0 + 0x0003)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power.c:210: reg_FFE_PULSE_EN_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_131
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/power.c:215: reg_RESET_ANA = 1;
	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/power.c:219: reg_RESET_ANA_RING = 1;
	mov	dptr,#(_PLLCAL_REG1 + 0x0003)
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/power.c:222: reg_EOM_RESET_INTP_EXT_LANE = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_9
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/power.c:223: reg_TX_INTPRESET_EXT = 1;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_187
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/power.c:224: reg_RESET_INTP_EXT_LANE = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_134
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power.c:225: reg_ANA_RX_PU_DLY2_LANE = 0;
	mov	dptr,#_INPUT_RX_PIN_REG3_LANE
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/power.c:228: pwrsq_on = 1;
	mov	dptr,#_pwrsq_on
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/power.c:229: lnx_CAL_DONE_LANE = 1;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/power.c:231: while( !reg_PIN_PU_IVREF_RD ){
00112$:
	mov	dptr,#(_PM_CMN_REG1 + 0x0003)
	movx	a,@dptr
	jb	acc.5,00114$
;	../../shared/src/power.c:233: if(reg_PHY_MCU_REMOTE_REQ_ISR_LANE)
	mov	dptr,#_MCU_IRQ_LANE
	movx	a,@dptr
	jnb	acc.5,00112$
;	../../shared/src/power.c:234: cmd_if();
	lcall	_cmd_if
	sjmp	00112$
00114$:
;	../../shared/src/power.c:238: if(mcuid==master_mcu) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_MCU_CONFIG
	...
	mov	a,r2
	cjne	a,ar3,00116$
;	../../shared/src/power.c:239: reg_PWRON_SEQ = 1;
	mov	dptr,#_PM_CMN_REG1
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/power.c:240: cmx_CAL_DONE = 1;
	mov	dptr,#(_CONTROL_CONFIG0 + 0x0001)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/power.c:241: delay01(200);
	mov	dptr,#0x00C8
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:244: PM_CMN_REG2.BT.B2 = 0x08;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	mov	a,#0x08
	movx	@dptr,a
;	../../shared/src/power.c:245: delay01(10); //1us
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:246: PM_CMN_REG2.BT.B2 = 0x0c;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	mov	a,#0x0C
	movx	@dptr,a
;	../../shared/src/power.c:247: delay01(10); //1us
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:248: PM_CMN_REG2.BT.B2 = 0x0e;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	mov	a,#0x0E
	movx	@dptr,a
;	../../shared/src/power.c:249: delay01(10); //1us
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:250: PM_CMN_REG2.BT.B2 = 0x0f;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	mov	a,#0x0F
	movx	@dptr,a
	sjmp	00117$
00116$:
;	../../shared/src/power.c:252: check_pu_ivref();
	mov	r0,#_check_pu_ivref
	mov	r1,#(_check_pu_ivref >> 8)
	mov	r2,#(_check_pu_ivref >> 16)
	lcall	__sdcc_banked_call
00117$:
;	../../shared/src/power.c:265: delay01(50); //5us delay after PU_IVREF=1
	mov	dptr,#0x0032
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:267: reg_ANA_PU_SQ_LANE = 1; 
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/power.c:268: delay01(150); // 20uS delay from PU_IVREF=1
	mov	dptr,#0x0096
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:270: if(serdes_ring_lane_en==0)
	mov	dptr,#_serdes_ring_lane_en
	movx	a,@dptr
	mov	r2,a
	jnz	00127$
;	../../shared/src/power.c:271: while(! (reg_PIN_PU_PLL_RD_LANE && reg_PIN_PU_TX_RD_LANE && reg_PIN_PU_RX_RD_LANE)) {
00122$:
	...
	jb	acc.2,00132$
00123$:
;	../../shared/src/power.c:273: if(reg_PHY_MCU_REMOTE_REQ_ISR_LANE)
	mov	dptr,#_MCU_IRQ_LANE
	movx	a,@dptr
	jnb	acc.5,00122$
;	../../shared/src/power.c:274: cmd_if();
	lcall	_cmd_if
;	../../shared/src/power.c:278: while(reg_PU_PLL_OR==0) {
	sjmp	00122$
00127$:
	mov	dptr,#(_PM_CMN_REG1 + 0x0002)
	movx	a,@dptr
	jb	acc.4,00132$
;	../../shared/src/power.c:280: if(reg_PHY_MCU_REMOTE_REQ_ISR_LANE)
	mov	dptr,#_MCU_IRQ_LANE
	movx	a,@dptr
	jnb	acc.5,00127$
;	../../shared/src/power.c:281: cmd_if();
	lcall	_cmd_if
	sjmp	00127$
00132$:
;	../../shared/src/power.c:285: if(mcuid== master_mcu) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_MCU_CONFIG
	...
	mov	a,r2
	cjne	a,ar3,00134$
;	../../shared/src/power.c:286: reg_ANA_PU_PLL = 1;
	mov	dptr,#(_PM_CMN_REG1 + 0x0003)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/power.c:287: delay01(5); //0.5us 
	mov	dptr,#0x0005
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:288: reg_ANA_PU_PLL_DLY = 1;
	mov	dptr,#(_PM_CMN_REG1 + 0x0003)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
00134$:
;	../../shared/src/power.c:292: if( serdes_ring_lane_en & ring_lane_sel ) {
	mov	dptr,#_serdes_ring_lane_en
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_ring_lane_sel
	...
	anl	a,r2
	jz	00136$
;	../../shared/src/power.c:298: reg_ANA_PU_PLL_RING = 1;
	mov	dptr,#_INPUT_CMN_PIN_REG2
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/power.c:299: delay01(5);
	mov	dptr,#0x0005
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:300: reg_ANA_PU_PLL_DLY_RING = 1;
	mov	dptr,#(_PM_CMN_REG2 + 0x0001)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
00136$:
;	../../shared/src/power.c:305: if(serdes_ring_lane_en==0)
	mov	dptr,#_serdes_ring_lane_en
	movx	a,@dptr
	mov	r2,a
	jnz	00142$
;	../../shared/src/power.c:306: while(reg_ANA_PU_PLL_DLY==0 || reg_ANA_PU_PLL==0);
00138$:
	mov	dptr,#(_PM_CMN_REG1 + 0x0003)
	movx	a,@dptr
	jnb	acc.0,00138$
	...
	jnb	acc.2,00138$
00142$:
;	../../shared/src/power.c:309: reg_ANA_PU_RX_LANE = 1;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power.c:310: delay01(5);
	mov	dptr,#0x0005
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:311: reg_ANA_PU_RX_DLY_LANE = 1;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/power.c:312: delay01(4);
	mov	dptr,#0x0004
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:313: reg_FFE_PULSE_EN_LANE = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_131
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/power.c:314: reg_ANA_RX_PU_DLY2_LANE = 1;
	mov	dptr,#_INPUT_RX_PIN_REG3_LANE
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/power.c:316: delay01(400);
	mov	dptr,#0x0190
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:317: reg_EOM_RESET_INTP_EXT_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_9
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/power.c:318: reg_TX_INTPRESET_EXT = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_187
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/power.c:319: reg_RESET_INTP_EXT_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_134
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/power.c:321: if(serdes_ring_lane_en==0)
	mov	dptr,#_serdes_ring_lane_en
	movx	a,@dptr
	mov	r2,a
	jnz	00148$
;	../../shared/src/power.c:322: while(! (reg_PIN_PU_PLL_RD_LANE && reg_PIN_PU_TX_RD_LANE));
00144$:
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	jnb	acc.5,00144$
	...
	jnb	acc.4,00144$
00148$:
;	../../shared/src/power.c:324: reg_ANA_PU_TX_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power.c:326: init_irq();
	mov	r0,#_init_irq
	mov	r1,#(_init_irq >> 8)
	mov	r2,#(_init_irq >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:328: EA = 1;
	setb	_EA
;	../../shared/src/power.c:331: PHY_STATUS = ST_CAL;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x03
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'pu_pll_on'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power.c:334: void pu_pll_on(void) BANKING_CTRL { // on - *pll_fast_cal, dtx_clk_off*, reset_dtx*
;	-----------------------------------------
;	 function pu_pll_on
;	-----------------------------------------
_pu_pll_on:
;	../../shared/src/power.c:337: if(serdes_ring_lane_en && tag_ringpll_ind_en) {
	mov	dptr,#_serdes_ring_lane_en
	movx	a,@dptr
	mov	r2,a
	jz	00119$
	...
	movx	a,@dptr
	jnb	acc.6,00119$
;	../../shared/src/power.c:338: if(ring_lane_sel) {
	mov	dptr,#_ring_lane_sel
	movx	a,@dptr
	mov	r2,a
	jz	00102$
;	../../shared/src/power.c:339: ring_pll_fast_cal();
	mov	r0,#_ring_pll_fast_cal
	mov	r1,#(_ring_pll_fast_cal >> 8)
	mov	r2,#(_ring_pll_fast_cal >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:345: reg_DTX_CLK_OFF_RING = 0;
	mov	dptr,#_PM_CMN_REG1
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/power.c:346: delay01(10);
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:347: reg_RESET_DTX_RING = 0;
	...
	ljmp	00122$
00102$:
;	../../shared/src/power.c:351: pll_fast_cal();	
	mov	r0,#_pll_fast_cal
	mov	r1,#(_pll_fast_cal >> 8)
	mov	r2,#(_pll_fast_cal >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:352: reg_DTX_CLK_OFF = 0;
	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/power.c:353: delay01(10);
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:354: reg_RESET_DTX	= 0;
	...
	ljmp	00122$
00119$:
;	../../shared/src/power.c:361: if(mcuid== master_mcu) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_MCU_CONFIG
	...
	mov	a,r2
	cjne	a,ar3,00107$
;	../../shared/src/power.c:362: pll_fast_cal();
	mov	r0,#_pll_fast_cal
	mov	r1,#(_pll_fast_cal >> 8)
	mov	r2,#(_pll_fast_cal >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:368: if(ring_pll_enabled) {
	jnb	_ring_pll_enabled,00107$
;	../../shared/src/power.c:369: ring_pll_fast_cal();
	mov	r0,#_ring_pll_fast_cal
	mov	r1,#(_ring_pll_fast_cal >> 8)
	mov	r2,#(_ring_pll_fast_cal >> 16)
	lcall	__sdcc_banked_call
00107$:
;	../../shared/src/power.c:374: if(mcuid== master_mcu) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_MCU_CONFIG
	...
	mov	a,r2
	cjne	a,ar3,00111$
;	../../shared/src/power.c:380: reg_DTX_CLK_OFF = 0;	reg_DTX_CLK_OFF_RING = 0;
	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
	...
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/power.c:381: delay01(10);
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:382: reg_RESET_DTX	= 0;	reg_RESET_DTX_RING = 0;
	mov	dptr,#(_DTX_REG0 + 0x0002)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
	...
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/power.c:385: SYNC_SATUS_PLL_OR_PLL_OFF = 0;
	mov	dptr,#(_SYNC_INFO + 0x0001)
	clr	a
	movx	@dptr,a
	sjmp	00115$
00111$:
;	../../shared/src/power.c:388: if(ring_pll_enabled) {
	jnb	_ring_pll_enabled,00115$
;	../../shared/src/power.c:394: reg_DTX_CLK_OFF_RING = 0;
	mov	dptr,#_PM_CMN_REG1
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/power.c:395: delay01(10);
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:396: reg_RESET_DTX_RING = 0;
	mov	dptr,#(_DTX_REG2 + 0x0001)
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/power.c:401: while( SYNC_SATUS_PLL_OR_PLL_OFF ) {
00115$:
	mov	dptr,#(_SYNC_INFO + 0x0001)
	movx	a,@dptr
	jz	00122$
;	../../shared/src/power.c:402: if(reg_PU_PLL_OR==0) break;
	mov	dptr,#(_PM_CMN_REG1 + 0x0002)
	movx	a,@dptr
	jb	acc.4,00115$
00122$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'pu_pll_off'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power.c:408: void pu_pll_off(void) BANKING_CTRL { //off - reset_ana*, ana_pu_pll_*,  pll_clk_ready_*, dtx_clk_off*, reset_dtx*
;	-----------------------------------------
;	 function pu_pll_off
;	-----------------------------------------
_pu_pll_off:
;	../../shared/src/power.c:411: if(serdes_ring_lane_en && tag_ringpll_ind_en) {
	mov	dptr,#_serdes_ring_lane_en
	movx	a,@dptr
	mov	r2,a
	jz	00112$
	...
	movx	a,@dptr
	jnb	acc.6,00112$
;	../../shared/src/power.c:412: if(ring_lane_sel) {
	mov	dptr,#_ring_lane_sel
	movx	a,@dptr
	mov	r2,a
	jz	00102$
;	../../shared/src/power.c:413: pu_ringpll_off();
	mov	r0,#_pu_ringpll_off
	mov	r1,#(_pu_ringpll_off >> 8)
	mov	r2,#(_pu_ringpll_off >> 16)
	lcall	__sdcc_banked_call
	ljmp	00115$
00102$:
;	../../shared/src/power.c:416: pu_lcgpll_off();
	mov	r0,#_pu_lcgpll_off
	mov	r1,#(_pu_lcgpll_off >> 8)
	mov	r2,#(_pu_lcgpll_off >> 16)
	lcall	__sdcc_banked_call
	ljmp	00115$
00112$:
;	../../shared/src/power.c:422: if(mcuid== master_mcu) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_MCU_CONFIG
	...
	mov	a,r2
	cjne	a,ar3,00108$
;	../../shared/src/power.c:424: pll_clk_ready_all_0();
	mov	r0,#_pll_clk_ready_all_0
	mov	r1,#(_pll_clk_ready_all_0 >> 8)
	mov	r2,#(_pll_clk_ready_all_0 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:433: reg_DTX_CLK_OFF = 1;    reg_DTX_CLK_OFF_RING = 1;
	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
	...
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/power.c:434: reg_RESET_DTX   = 1;    reg_RESET_DTX_RING = 1;
	mov	dptr,#(_DTX_REG0 + 0x0002)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
	...
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/power.c:435: delay01(5); 
	mov	dptr,#0x0005
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:436: reg_RESET_ANA = 1;      reg_RESET_ANA_RING = 1;
	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
	...
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/power.c:437: reg_ANA_PU_PLL_DLY = 0; reg_ANA_PU_PLL_DLY_RING = 0;
	mov	dptr,#(_PM_CMN_REG1 + 0x0003)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
	...
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/power.c:438: reg_ANA_PU_PLL = 0;     reg_ANA_PU_PLL_RING = 0;
	mov	dptr,#(_PM_CMN_REG1 + 0x0003)
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
	...
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/power.c:441: SYNC_SATUS_PLL_OR_PLL_OFF = 1;
	mov	dptr,#(_SYNC_INFO + 0x0001)
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/power.c:456: while( SYNC_SATUS_PLL_OR_PLL_OFF==0 ) {
00108$:
	mov	dptr,#(_SYNC_INFO + 0x0001)
	movx	a,@dptr
	jnz	00115$
;	../../shared/src/power.c:457: if(reg_PU_PLL_OR) break;
	mov	dptr,#(_PM_CMN_REG1 + 0x0002)
	movx	a,@dptr
	jnb	acc.4,00108$
00115$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'DTL_DTX_DFE_clkoff_reset_0'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power.c:463: void DTL_DTX_DFE_clkoff_reset_0(void) BANKING_CTRL {
;	-----------------------------------------
;	 function DTL_DTX_DFE_clkoff_reset_0
;	-----------------------------------------
_DTL_DTX_DFE_clkoff_reset_0:
;	../../shared/src/power.c:465: reg_DTL_CLK_OFF_LANE= 0; 
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xef
	movx	@dptr,a
;	../../shared/src/power.c:466: if(serdes_ring_lane_en) {
	mov	dptr,#_serdes_ring_lane_en
	movx	a,@dptr
	mov	r2,a
	jz	00109$
;	../../shared/src/power.c:470: if(ring_lane_sel) reg_DTX_CLK_OFF_RING = 0;
	mov	dptr,#_ring_lane_sel
	movx	a,@dptr
	mov	r2,a
	jz	00102$
	...
	sjmp	00110$
00102$:
;	../../shared/src/power.c:472: else reg_DTX_CLK_OFF = 0;
	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
	sjmp	00110$
00109$:
;	../../shared/src/power.c:475: if (mcuid == master_mcu) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_MCU_CONFIG
	...
	mov	a,r2
	cjne	a,ar3,00110$
;	../../shared/src/power.c:476: reg_DTX_CLK_OFF = 0;
	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/power.c:478: if (ring_pll_enabled)
	jnb	_ring_pll_enabled,00110$
;	../../shared/src/power.c:479: reg_DTX_CLK_OFF_RING = 0;
	mov	dptr,#_PM_CMN_REG1
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
00110$:
;	../../shared/src/power.c:487: reg_DFE_CLK_OFF_LANE = 0; 
	mov	dptr,#_RX_EQ_CLK_CTRL
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/power.c:489: delay01(10);	// spec required 1-2usec delay
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power.c:491: reg_RESET_DTL_LANE = 0;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/power.c:492: if(serdes_ring_lane_en) {
	mov	dptr,#_serdes_ring_lane_en
	movx	a,@dptr
	mov	r2,a
	jz	00119$
;	../../shared/src/power.c:496: if(ring_lane_sel) reg_RESET_DTX_RING = 0;
	mov	dptr,#_ring_lane_sel
	movx	a,@dptr
	mov	r2,a
	jz	00112$
	...
	sjmp	00120$
00112$:
;	../../shared/src/power.c:498: else reg_RESET_DTX = 0;
	mov	dptr,#(_DTX_REG0 + 0x0002)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
	sjmp	00120$
00119$:
;	../../shared/src/power.c:501: if (mcuid == master_mcu) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_MCU_CONFIG
	...
	mov	a,r2
	cjne	a,ar3,00120$
;	../../shared/src/power.c:502: reg_RESET_DTX = 0;
	mov	dptr,#(_DTX_REG0 + 0x0002)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/power.c:504: if (ring_pll_enabled)
	jnb	_ring_pll_enabled,00120$
;	../../shared/src/power.c:505: reg_RESET_DTX_RING = 0;
	mov	dptr,#(_DTX_REG2 + 0x0001)
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
00120$:
;	../../shared/src/power.c:513: reg_RESET_DFE_LANE = 0;
	mov	dptr,#_RX_EQ_CLK_CTRL
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'DTL_DTX_DFE_clkoff_reset_1'
;------------------------------------------------------------
;dtx_off                   Allocated to registers r2 
;------------------------------------------------------------
;	../../shared/src/power.c:519: void DTL_DTX_DFE_clkoff_reset_1(bool dtx_off) BANKING_CTRL {
;	-----------------------------------------
;	 function DTL_DTX_DFE_clkoff_reset_1
;	-----------------------------------------
_DTL_DTX_DFE_clkoff_reset_1:
	mov	r2,dpl
;	../../shared/src/power.c:521: dtx_off |= (reg_PHY_ALIGN_OFF==0);
	mov	dptr,#_SYSTEM
	movx	a,@dptr
	rr	a
	rr	a
...
00114$:
	orl	ar2,a
;	../../shared/src/power.c:522: reg_DTL_CLK_OFF_LANE= 1; 
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/power.c:523: if(serdes_ring_lane_en) {
	mov	dptr,#_serdes_ring_lane_en
	movx	a,@dptr
	mov	r3,a
	jz	00107$
;	../../shared/src/power.c:527: if(ring_lane_sel) { reg_DTX_CLK_OFF_RING = 1; reg_RESET_DTX_RING = 1; }
	mov	dptr,#_ring_lane_sel
	movx	a,@dptr
	mov	r3,a
	jz	00102$
	...
	sjmp	00108$
00102$:
;	../../shared/src/power.c:529: else { reg_DTX_CLK_OFF = 1; reg_RESET_DTX = 1; }
	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
	...
	sjmp	00108$
00107$:
;	../../shared/src/power.c:531: else if(dtx_off) { 
	mov	a,r2
	jz	00108$
;	../../shared/src/power.c:536: reg_DTX_CLK_OFF = 1; reg_DTX_CLK_OFF_RING = 1;
	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
	...
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/power.c:537: reg_RESET_DTX = 1; reg_RESET_DTX_RING = 1;
	mov	dptr,#(_DTX_REG0 + 0x0002)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
	...
	movx	@dptr,a
00108$:
;	../../shared/src/power.c:540: reg_DFE_CLK_OFF_LANE = 1; 
	mov	dptr,#_RX_EQ_CLK_CTRL
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/power.c:541: reg_RESET_DTL_LANE = 1;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/power.c:542: CKCON = 0x07 ;  //MCU WAIT time the slowest
	mov	_CKCON,#0x07
;	../../shared/src/power.c:543: reg_RESET_DFE_LANE = 1;
	mov	dptr,#_RX_EQ_CLK_CTRL
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/power.c:544: CKCON = 0x00 ; //MCU WAIT time setting back to normal.
	mov	_CKCON,#0x00
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'DTL_DFE_clkoff_reset_1'
;------------------------------------------------------------
;dtx_off                   Allocated to registers 
;------------------------------------------------------------
;	../../shared/src/power.c:547: void DTL_DFE_clkoff_reset_1(bool dtx_off) BANKING_CTRL {
;	-----------------------------------------
;	 function DTL_DFE_clkoff_reset_1
;	-----------------------------------------
_DTL_DFE_clkoff_reset_1:
;	../../shared/src/power.c:549: dtx_off |= (reg_PHY_ALIGN_OFF==0);
	mov	dptr,#_SYSTEM
	movx	a,@dptr
	rr	a
	rr	a
	anl	a,#0x01
;	../../shared/src/power.c:550: reg_DTL_CLK_OFF_LANE= 1; 
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/power.c:551: reg_DFE_CLK_OFF_LANE = 1; 
	mov	dptr,#_RX_EQ_CLK_CTRL
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/power.c:552: reg_RESET_DTL_LANE = 1;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/power.c:553: CKCON = 0x07 ;  //MCU WAIT time the slowest
	mov	_CKCON,#0x07
;	../../shared/src/power.c:554: reg_RESET_DFE_LANE = 1;
	mov	dptr,#_RX_EQ_CLK_CTRL
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/power.c:555: CKCON = 0x00 ; //MCU WAIT time setting back to normal.
	mov	_CKCON,#0x00
	ljmp	__sdcc_banked_ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
