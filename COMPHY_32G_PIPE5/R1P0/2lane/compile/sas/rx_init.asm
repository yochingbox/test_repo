...
;--------------------------------------------------------
	.area BANK1   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'RX_Init'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/rx_init.c:27: void RX_Init(void) BANKING_CTRL {
;	-----------------------------------------
;	 function RX_Init
;	-----------------------------------------
_RX_Init:
	...
	ar0 = 0x00
	ar1 = 0x01
;	../../shared/src/rx_init.c:29: reg_RX_INIT_DONE_LANE = 0; //??
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/rx_init.c:30: reg_INT_RX_INIT_RISE_ISR_LANE = 0;
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG1_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/rx_init.c:32: reg_DFE_ADAPT_CONT_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0001)
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/rx_init.c:33: reg_DFE_START_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0002)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/rx_init.c:38: reg_SEL_MU_F_LANE = 0; 
	mov	dptr,#(_DTL_REG0 + 0x0003)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/rx_init.c:39: reg_ANA_RX_SEL_MU_F_LANE = 0;
	mov	dptr,#_DFE_CTRL_REG3
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/rx_init.c:40: reg_RESET_DTL_SYNC_LANE = 1; 
;	../../shared/src/rx_init.c:41: reg_RESET_DTL_SYNC_LANE = 0; 	
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
	...
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/rx_init.c:43: if(rxinit_4_spdchg_en) {
	mov	dptr,#_rxinit_4_spdchg_en
	movx	a,@dptr
	mov	r2,a
	jz	00104$
;	../../shared/src/rx_init.c:44: reg_DFE_INIT_SEL_LANE = 0; //load from cal
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0003)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/rx_init.c:45: CKCON = 0x07 ; //MCU WAIT time the slowest
	mov	_CKCON,#0x07
;	../../shared/src/rx_init.c:46: reg_RESET_DFE_LANE = 1;
	mov	dptr,#_RX_EQ_CLK_CTRL
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/rx_init.c:47: CKCON = 0x00 ; //MCU WAIT time setting back to normal.
	mov	_CKCON,#0x00
;	../../shared/src/rx_init.c:48: reg_ANA_REG_DFEE_RST_LANE = 1;
	mov	dptr,#_ANA_IF_DFEE_REG0
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/rx_init.c:49: reg_ANA_REG_DFEO_RST_LANE = 1;
	mov	dptr,#_ANA_IF_DFEO_REG0
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/rx_init.c:50: reg_RESET_DFE_LANE = 0;
	mov	dptr,#_RX_EQ_CLK_CTRL
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/rx_init.c:51: reg_ANA_REG_DFEE_RST_LANE = 0;
	mov	dptr,#_ANA_IF_DFEE_REG0
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/rx_init.c:52: reg_ANA_REG_DFEO_RST_LANE = 0;	
	mov	dptr,#_ANA_IF_DFEO_REG0
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/rx_init.c:55: if(reg_INT_DFE_EN_LANE==0) {  
	mov	dptr,#(_RX_EQ_CLK_CTRL + 0x0001)
	movx	a,@dptr
	jb	acc.1,00102$
;	../../shared/src/rx_init.c:56: reg_DFE_EN_FM_REG_LANE = 1; reg_DFE_EN_LANE = 1; 
	mov	dptr,#(_RX_EQ_CLK_CTRL + 0x0003)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
	mov	dptr,#_RX_EQ_CLK_CTRL
	...
	movx	@dptr,a
00102$:
;	../../shared/src/rx_init.c:58: dc_load(0);
	mov	dpl,#0x00
	mov	r0,#_dc_load
	mov	r1,#(_dc_load >> 8)
	mov	r2,#(_dc_load >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/rx_init.c:59: reg_DFE_EN_FM_REG_LANE = 0; 		
	mov	dptr,#(_RX_EQ_CLK_CTRL + 0x0003)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
	sjmp	00105$
00104$:
;	../../shared/src/rx_init.c:65: delay01(20); 
	mov	dptr,#0x0014
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
00105$:
;	../../shared/src/rx_init.c:67: reg_SEL_MU_F_LANE = 1; 
	mov	dptr,#(_DTL_REG0 + 0x0003)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/rx_init.c:68: reg_ANA_RX_SEL_MU_F_LANE = 1;
	mov	dptr,#_DFE_CTRL_REG3
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/rx_init.c:71: TX_TRAIN_CTRL_LANE.VAL &= 0xa01fff02;
	...
	mov	a,r5
	movx	@dptr,a
;	../../shared/src/rx_init.c:72: reg_PHY_MCU_REMOTE_REQ_ISR_CLEAR_LANE = 1;
;	../../shared/src/rx_init.c:73: reg_PHY_MCU_REMOTE_REQ_ISR_CLEAR_LANE = 0;
	...
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/rx_init.c:74: TRX_TRAIN_IF_INTERRUPT_CLEAR_LANE.VAL = 0x0004030b;
	...
	movx	@dptr,a
	inc	dptr
;	../../shared/src/rx_init.c:75: TRX_TRAIN_IF_INTERRUPT_CLEAR_LANE.VAL = 0;
	clr	a
	movx	@dptr,a
	mov	dptr,#_TRX_TRAIN_IF_INTERRUPT_CLEAR_LANE
	movx	@dptr,a
	...
	inc	dptr
	movx	@dptr,a
;	../../shared/src/rx_init.c:76: RX_LANE_INTERRUPT_REG1.BT.B3 = 0x60;
;	../../shared/src/rx_init.c:77: RX_LANE_INTERRUPT_REG1.BT.B3 = 0;
	mov	dptr,#(_RX_LANE_INTERRUPT_REG1 + 0x0003)
	mov	a,#0x60
	movx	@dptr,a
	clr	a
	movx	@dptr,a
;	../../shared/src/rx_init.c:79: delay01(20); //30
	mov	dptr,#0x0014
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/rx_init.c:132: rxinit_4_spdchg_en = 0;
	mov	dptr,#_rxinit_4_spdchg_en
	clr	a
	movx	@dptr,a
;	../../shared/src/rx_init.c:133: do_rxinit = 0; //avoid duplicate
	clr	_do_rxinit
;	../../shared/src/rx_init.c:134: reg_RX_INIT_DONE_LANE = 1; //??
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/rx_init.c:137: pre_normal_process();	
	mov	r0,#_pre_normal_process
	mov	r1,#(_pre_normal_process >> 8)
	mov	r2,#(_pre_normal_process >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/rx_init.c:139: tempc_step_state = 0; //??	//reset tempc step state
	mov	dptr,#_tempc_step_state
	clr	a
	movx	@dptr,a
;	../../shared/src/rx_init.c:140: pllcal_first_time = 1;
	mov	dptr,#_pllcal_first_time
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/rx_init.c:144: PHY_STATUS = ST_NORMAL;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x2B
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'pre_normal_process'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/rx_init.c:148: void pre_normal_process(void) BANKING_CTRL {
;	-----------------------------------------
;	 function pre_normal_process
;	-----------------------------------------
_pre_normal_process:
;	../../shared/src/rx_init.c:150: reg_MCU_DEBUG0_LANE_7_0 = 0x21;
	mov	dptr,#_MCU_DEBUG0_LANE
	mov	a,#0x21
	movx	@dptr,a
;	../../shared/src/rx_init.c:153: timeout2 = 1;
	setb	_timeout2
;	../../shared/src/rx_init.c:154: timeout = 1; 
	setb	_timeout
;	../../shared/src/rx_init.c:155: reg_PWM2_EN_LANE = 0; 
	mov	dptr,#(_MCU_TIMER_CTRL_4_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/rx_init.c:156: reg_PWM1_EN_LANE = 0; //reset pwm_cnt to 1
;	../../shared/src/rx_init.c:157: reg_PWM1_EN_LANE = 1; 
	...
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/rx_init.c:158: reg_TIMER_2_SEL_LANE_1_0 = 0x01;	//use PWM1 1u unit timer
	mov	dptr,#_MCU_TIMER_CTRL_1_LANE
	movx	a,@dptr
	anl	a,#0xcf
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/rx_init.c:160: set_ctle_accap(1); //slow
	mov	dpl,#0x01
	mov	r0,#_set_ctle_accap
	mov	r1,#(_set_ctle_accap >> 8)
	mov	r2,#(_set_ctle_accap >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/rx_init.c:162: if(dfe_dis==0) {
	mov	dptr,#_dfe_dis
	movx	a,@dptr
	mov	r2,a
	jnz	00103$
;	../../shared/src/rx_init.c:163: cal_half_code();	
	mov	r0,#_cal_half_code
	mov	r1,#(_cal_half_code >> 8)
	mov	r2,#(_cal_half_code >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/rx_init.c:164: dfe_hardware_cont_run();		
	mov	r0,#_dfe_hardware_cont_run
	mov	r1,#(_dfe_hardware_cont_run >> 8)
	mov	r2,#(_dfe_hardware_cont_run >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/rx_init.c:166: save_sampler_edge();
	mov	r0,#_save_sampler_edge
	mov	r1,#(_save_sampler_edge >> 8)
	mov	r2,#(_save_sampler_edge >> 16)
	lcall	__sdcc_banked_call
00103$:
	ljmp	__sdcc_banked_ret
	.area CSEG    (CODE)
