...
;--------------------------------------------------------
	...
	.globl _dll_comp_cal
	.globl _dll_gm_cal
	.globl _dll_vdda_cal_loop
	.globl _set_sellv_rxdll_ch
	.globl _get_sellv_rxdll_ch
	.globl _dll_eom_gm_cal
	.globl _set_sellv_rxeomdll_ch
	.globl _get_sellv_rxeomdll_ch
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area BANK2   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'dll_comp_cal'
;------------------------------------------------------------
;dir                       Allocated to registers r2 
;cmpout                    Allocated to registers r3 
;------------------------------------------------------------
;	../../shared/src/dll_cal_rom.c:40: void dll_comp_cal( void ) BANKING_CTRL {
;	-----------------------------------------
;	 function dll_comp_cal
;	-----------------------------------------
_dll_comp_cal:
	ar2 = 0x02
	ar3 = 0x03
	...
	ar0 = 0x00
	ar1 = 0x01
;	../../shared/src/dll_cal_rom.c:44: lnx_DLL_COMP_CAL_DONE_LANE = 0;
	mov	dptr,#_CAL_CTRL1_LANE
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:46: if( LOAD_CAL_ON || cmx_RXDLL_CAL_EXT_EN) {	
	...
	jnb	acc.4,00102$
00101$:
;	../../shared/src/dll_cal_rom.c:47: DLL_CMP_OFFSET = lnx_CAL_DLL_CMP_OFFSET_LANE_7_0;	
	mov	dptr,#_CAL_SAVE_DATA1_LANE
	movx	a,@dptr
	mov	r2,a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:48: goto skip_out;
	ljmp	00115$
00102$:
;	../../shared/src/dll_cal_rom.c:51: PHY_STATUS = ST_DLL_COMP_CAL;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x09
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:53: lnx_DLL_COMP_CAL_PASS_LANE = 1;
	mov	dptr,#_CAL_CTRL2_LANE
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:55: DLL_CMP_CAL_EN = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_11
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:56: DLL_CMP_OFFSET = 0x08;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_8
	movx	a,@dptr
	anl	a,#0x0f
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:57: delay01(10);
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/dll_cal_rom.c:58: dir = DLL_CAL_CMP_OUT; cmpout = dir;
	...
	mov	r2,a
	mov	r3,a
;	../../shared/src/dll_cal_rom.c:60: do {
00112$:
;	../../shared/src/dll_cal_rom.c:62: if( cmpout == 0) DLL_CMP_OFFSET--; 
	mov	a,r3
	jnz	00105$
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_8
	movx	a,@dptr
	...
	sjmp	00106$
00105$:
;	../../shared/src/dll_cal_rom.c:63: else DLL_CMP_OFFSET++; 				
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_8
	movx	a,@dptr
	swap	a
	anl	a,#0x0f
	...
	movx	@dptr,a
00106$:
;	../../shared/src/dll_cal_rom.c:64: delay01(10);
	mov	dptr,#0x000A
	push	ar2
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	...
	lcall	__sdcc_banked_call
	pop	ar2
;	../../shared/src/dll_cal_rom.c:66: cmpout = DLL_CAL_CMP_OUT;
	mov	dptr,#_RX_CALIBRATION_REG
	movx	a,@dptr
	rr	a
	anl	a,#0x01
	mov	r4,a
	mov	r3,a
;	../../shared/src/dll_cal_rom.c:67: if(dir != cmpout) break;
	mov	a,r2
	cjne	a,ar3,00114$
;	../../shared/src/dll_cal_rom.c:69: if (DLL_CMP_OFFSET == 0x0f ||  DLL_CMP_OFFSET == 0 ) {
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_8
	movx	a,@dptr
	swap	a
	anl	a,#0x0f
...
00128$:
	...
	jnz	00112$
00109$:
;	../../shared/src/dll_cal_rom.c:70: lnx_DLL_COMP_CAL_PASS_LANE = 0;
	mov	dptr,#_CAL_CTRL2_LANE
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:74: } while(1);
00114$:
;	../../shared/src/dll_cal_rom.c:76: DLL_CMP_CAL_EN = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_11
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:77: lnx_CAL_DLL_CMP_OFFSET_LANE_7_0 = DLL_CMP_OFFSET; 
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_8
	movx	a,@dptr
	swap	a
	anl	a,#0x0f
	...
	mov	dptr,#_CAL_SAVE_DATA1_LANE
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:79: skip_out:
00115$:
;	../../shared/src/dll_cal_rom.c:80: lnx_DLL_COMP_CAL_DONE_LANE = 1;
	mov	dptr,#_CAL_CTRL1_LANE
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
...
;------------------------------------------------------------
;Allocation info for local variables in function 'dll_gm_cal'
;------------------------------------------------------------
;dir                       Allocated to registers r2 
;pre_dll_gmsel             Allocated to registers r5 
;loop_cnt                  Allocated to registers r4 
;cmpout                    Allocated to registers r3 
;------------------------------------------------------------
;	../../shared/src/dll_cal_rom.c:96: void dll_gm_cal( void ) BANKING_CTRL {
;	-----------------------------------------
;	 function dll_gm_cal
;	-----------------------------------------
_dll_gm_cal:
;	../../shared/src/dll_cal_rom.c:99: PHY_STATUS = ST_DLL_GM_CAL;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x0A
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:101: lnx_DLL_GM_CAL_DONE_LANE = 0;
	mov	dptr,#_CAL_CTRL1_LANE
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:103: if(cmx_RXDLL_CAL_EXT_EN || LOAD_CAL_ON) {	
	mov	dptr,#(_CONTROL_CONFIG1 + 0x0001)
	movx	a,@dptr
	jb	acc.4,00101$
	mov	dptr,#_CAL_CTRL3_LANE
	...
	jz	00102$
00101$:
;	../../shared/src/dll_cal_rom.c:104: DLL_GMSEL = lnx_cal_dll_gmsel[rate];	
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	add	a,#_lnx_cal_dll_gmsel
	mov	dpl,a
	clr	a
	addc	a,#(_lnx_cal_dll_gmsel >> 8)
	mov	dph,a
	movx	a,@dptr
	mov	r2,a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:105: lnx_DLL_GM_CAL_DONE_LANE = 1;
	mov	dptr,#_CAL_CTRL1_LANE
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:106: return;
	ljmp	00119$
00102$:
;	../../shared/src/dll_cal_rom.c:109: lnx_DLL_GM_CAL_PASS_LANE = 1;
	mov	dptr,#_CAL_CTRL2_LANE
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:111: DLL_PD_SEL = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_8
	movx	a,@dptr
	anl	a,#0xf3
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:113: DLL_GMSEL = 0x07;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_7
	movx	a,@dptr
	orl	a,#0x38
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:114: delay01(10);
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/dll_cal_rom.c:116: dir = DLL_CAL_CMP_OUT; cmpout = dir;
	mov	dptr,#_RX_CALIBRATION_REG
	movx	a,@dptr
	rr	a
	anl	a,#0x01
	mov	r2,a
	mov	r3,a
;	../../shared/src/dll_cal_rom.c:119: do {
	mov	r4,#0x08
00116$:
;	../../shared/src/dll_cal_rom.c:120: pre_dll_gmsel = DLL_GMSEL;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_7
	movx	a,@dptr
	swap	a
	rl	a
	anl	a,#0x07
	mov	r5,a
;	../../shared/src/dll_cal_rom.c:122: if( cmpout == 0 )  {
	mov	a,r3
	jnz	00109$
;	../../shared/src/dll_cal_rom.c:123: if(DLL_GMSEL>lnx_DLL_GMSEL_MIN_LANE_3_0) DLL_GMSEL--;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_7
	movx	a,@dptr
	swap	a
	rl	a
...
00131$:
	...
	sjmp	00110$
00109$:
;	../../shared/src/dll_cal_rom.c:126: if(DLL_GMSEL<7) DLL_GMSEL++;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_7
	movx	a,@dptr
	swap	a
	rl	a
	...
	movx	@dptr,a
00110$:
;	../../shared/src/dll_cal_rom.c:128: delay01(10);
	mov	dptr,#0x000A
	push	ar2
	push	ar4
	push	ar5
	...
	pop	ar4
	pop	ar2
;	../../shared/src/dll_cal_rom.c:130: cmpout = DLL_CAL_CMP_OUT;
	mov	dptr,#_RX_CALIBRATION_REG
	movx	a,@dptr
	rr	a
	anl	a,#0x01
	mov	r6,a
	mov	r3,a
;	../../shared/src/dll_cal_rom.c:131: if(dir != cmpout) {
	mov	a,r2
	cjne	a,ar3,00134$
	sjmp	00112$
00134$:
;	../../shared/src/dll_cal_rom.c:132: DLL_GMSEL = pre_dll_gmsel;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_7
	mov	a,r5
	swap	a
	rr	a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:133: break;
	sjmp	00118$
00112$:
;	../../shared/src/dll_cal_rom.c:136: if( DLL_GMSEL==0x07 || DLL_GMSEL==0x03 ) {
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_7
	movx	a,@dptr
	swap	a
	rl	a
...
00135$:
	...
	cjne	r5,#0x03,00117$
00113$:
;	../../shared/src/dll_cal_rom.c:137: lnx_DLL_GM_CAL_PASS_LANE = 0;
	mov	dptr,#_CAL_CTRL2_LANE
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:138: break;
	sjmp	00118$
00117$:
;	../../shared/src/dll_cal_rom.c:140: } while (loop_cnt-->0);
	mov	ar5,r4
	dec	r4
	mov	a,r5
	jz	00138$
...
00138$:
00118$:
;	../../shared/src/dll_cal_rom.c:142: lnx_DLL_GM_CAL_DONE_LANE = 1;
	mov	dptr,#_CAL_CTRL1_LANE
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:145: lnx_cal_dll_gmsel[rate] = (DLL_GMSEL & 0x7) | 0x00;;	
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	add	a,#_lnx_cal_dll_gmsel
...
00119$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'dll_vdda_cal_loop'
;------------------------------------------------------------
...
;------------------------------------------------------------
;	../../shared/src/dll_cal_rom.c:160: void dll_vdda_cal_loop( uint8_t mode ) BANKING_CTRL {
;	-----------------------------------------
;	 function dll_vdda_cal_loop
;	-----------------------------------------
_dll_vdda_cal_loop:
	push	_bp
	mov	_bp,sp
	...
	inc	sp
	mov	r2,dpl
;	../../shared/src/dll_cal_rom.c:165: delay01(10);
	mov	dptr,#0x000A
	push	ar2
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	...
	lcall	__sdcc_banked_call
	pop	ar2
;	../../shared/src/dll_cal_rom.c:167: if(mode == DLL_VDDA_STEP) {
	clr	a
	cjne	r2,#0x01,00147$
	inc	a
00147$:
	mov	r2,a
	jz	00111$
;	../../shared/src/dll_cal_rom.c:168: loopcnt = 128;	
	mov	r4,#0x80
;	../../shared/src/dll_cal_rom.c:169: cmp_out_dir = 1;  //1:dec, 0:inc
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x01
	inc	r0
	...
	sjmp	00112$
00111$:
;	../../shared/src/dll_cal_rom.c:172: if(lnx_DLL_SELLV_RXDLL_FINAL_STEP_NUM_SEL_LANE_1_0 == 0x0) loopcnt = 16;
	mov	dptr,#_DLL_CAL
	movx	a,@dptr
	anl	a,#0x0c
	jnz	00108$
	...
	sjmp	00109$
00108$:
;	../../shared/src/dll_cal_rom.c:173: else if(lnx_DLL_SELLV_RXDLL_FINAL_STEP_NUM_SEL_LANE_1_0 == 0x1) loopcnt = 24;
	mov	dptr,#_DLL_CAL
	movx	a,@dptr
	rr	a
	rr	a
	...
	sjmp	00109$
00105$:
;	../../shared/src/dll_cal_rom.c:174: else if(lnx_DLL_SELLV_RXDLL_FINAL_STEP_NUM_SEL_LANE_1_0 == 0x2) loopcnt = 32;
	mov	dptr,#_DLL_CAL
	movx	a,@dptr
	rr	a
	rr	a
	...
	sjmp	00109$
00102$:
;	../../shared/src/dll_cal_rom.c:175: else loopcnt = 48;
	mov	r4,#0x30
00109$:
;	../../shared/src/dll_cal_rom.c:176: cmp_out_dir = 0;  //0:dec, 1:inc
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x00
	inc	r0
	mov	@r0,#0x00
00112$:
;	../../shared/src/dll_cal_rom.c:179: val = get_sellv_rxdll_ch();
	push	ar2
	push	ar4
	mov	r0,#_get_sellv_rxdll_ch
	mov	r1,#(_get_sellv_rxdll_ch >> 8)
	mov	r2,#(_get_sellv_rxdll_ch >> 16)
	lcall	__sdcc_banked_call
	mov	r6,dpl
	pop	ar4
	pop	ar2
;	../../shared/src/dll_cal_rom.c:181: dir = DLL_CAL_CMP_OUT; cmpout = dir;
	mov	dptr,#_RX_CALIBRATION_REG
	movx	a,@dptr
	rr	a
	anl	a,#0x01
	mov	r7,a
	mov	r3,a
;	../../shared/src/dll_cal_rom.c:182: do {
	mov	ar5,r4
00128$:
;	../../shared/src/dll_cal_rom.c:184: if( cmpout == cmp_out_dir ) {
	push	ar7
	mov	ar7,r3
	mov	r4,#0x00
	mov	r0,_bp
...
00156$:
	pop	ar7
;	../../shared/src/dll_cal_rom.c:185: if( val>VDDA_MIN ) 	val--;
	mov	a,r6
	jz	00119$
	dec	r6
	sjmp	00119$
00118$:
;	../../shared/src/dll_cal_rom.c:188: if( val<VDDA_MAX ) 	val++;
	cjne	r6,#0x2B,00158$
00158$:
	jnc	00119$
	inc	r6
00119$:
;	../../shared/src/dll_cal_rom.c:190: set_sellv_rxdll_ch(val);
	mov	dpl,r6
	push	ar2
	push	ar5
	push	ar6
	...
	pop	ar5
	pop	ar2
;	../../shared/src/dll_cal_rom.c:192: if( val==VDDA_MIN || val==VDDA_MAX )
	mov	a,r6
	jz	00120$
	cjne	r6,#0x2B,00121$
00120$:
;	../../shared/src/dll_cal_rom.c:194: lnx_DLL_VDATA_CAL_PASS_LANE = 0;
	mov	dptr,#_CAL_CTRL2_LANE
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:195: break;
	sjmp	00130$
00121$:
;	../../shared/src/dll_cal_rom.c:198: if( lnx_DLL_VDDA_TRACKING_ON_LANE == 1 ) break;
	...
	sjmp	00130$
00163$:
;	../../shared/src/dll_cal_rom.c:200: delay01(10);
	mov	dptr,#0x000A
	push	ar2
	push	ar5
	push	ar6
	...
	pop	ar5
	pop	ar2
;	../../shared/src/dll_cal_rom.c:201: cmpout = DLL_CAL_CMP_OUT;
	mov	dptr,#_RX_CALIBRATION_REG
	movx	a,@dptr
	rr	a
	anl	a,#0x01
	mov	r4,a
	mov	r3,a
;	../../shared/src/dll_cal_rom.c:202: if(mode == DLL_VDDA_STEP && dir != cmpout) break;
	mov	a,r2
	jz	00129$
	mov	a,r7
	cjne	a,ar3,00130$
00129$:
;	../../shared/src/dll_cal_rom.c:204: } while (loopcnt-->0);
	mov	ar4,r5
	dec	r5
	mov	a,r4
	jz	00167$
...
00167$:
00130$:
;	../../shared/src/dll_cal_rom.c:206: if(lnx_DLL_VDDA_TRACKING_ON_LANE==0)
	mov	dptr,#(_CAL_CTRL3_LANE + 0x0002)
	movx	a,@dptr
	jb	acc.5,00132$
;	../../shared/src/dll_cal_rom.c:207: lnx_cal_vdda_dll_sel[PWR][rx_pll_rate] = val;
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	mov	r2,a
	...
	movx	@dptr,a
00132$:
;	../../shared/src/dll_cal_rom.c:208: lnx_cal_vdda_dll_sel[CONT][rx_pll_rate] = val;
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	mov	r2,a
	...
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'set_sellv_rxdll_ch'
;------------------------------------------------------------
;val                       Allocated to registers r2 
;------------------------------------------------------------
;	../../shared/src/dll_cal_rom.c:270: void set_sellv_rxdll_ch(uint8_t val) BANKING_CTRL {
;	-----------------------------------------
;	 function set_sellv_rxdll_ch
;	-----------------------------------------
_set_sellv_rxdll_ch:
	mov	r2,dpl
;	../../shared/src/dll_cal_rom.c:271: switch(mcuid) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r3,a
	jz	00101$
;	../../shared/src/dll_cal_rom.c:272: case MCU_LANE0:
	cjne	r3,#0x01,00104$
	sjmp	00102$
00101$:
;	../../shared/src/dll_cal_rom.c:273: reg_SELLV_RXDLL_CH0_5_0 = val; break;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_148
	mov	a,r2
	add	a,r2
	add	a,acc
	anl	a,#0xfc
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:274: case MCU_LANE1:
	sjmp	00104$
00102$:
;	../../shared/src/dll_cal_rom.c:275: reg_SELLV_RXDLL_CH1_5_0 = val; break;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_149
	mov	a,r2
	add	a,r2
	add	a,acc
	anl	a,#0xfc
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:276: }
00104$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'get_sellv_rxdll_ch'
;------------------------------------------------------------
;val                       Allocated to stack - offset 1
;------------------------------------------------------------
;	../../shared/src/dll_cal_rom.c:279: uint8_t get_sellv_rxdll_ch(void) BANKING_CTRL {
;	-----------------------------------------
;	 function get_sellv_rxdll_ch
;	-----------------------------------------
_get_sellv_rxdll_ch:
	push	_bp
	mov	_bp,sp
	inc	sp
;	../../shared/src/dll_cal_rom.c:281: switch(mcuid) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r2,a
	jz	00101$
;	../../shared/src/dll_cal_rom.c:282: case MCU_LANE0: 
	cjne	r2,#0x01,00103$
	sjmp	00102$
00101$:
;	../../shared/src/dll_cal_rom.c:283: val = reg_SELLV_RXDLL_CH0_5_0; break;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_148
	movx	a,@dptr
	rr	a
	rr	a
	anl	a,#0x3f
	mov	r2,a
;	../../shared/src/dll_cal_rom.c:284: case MCU_LANE1:
	sjmp	00103$
00102$:
;	../../shared/src/dll_cal_rom.c:285: val = reg_SELLV_RXDLL_CH1_5_0; break;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_149
	movx	a,@dptr
	rr	a
	rr	a
	...
	mov	r3,a
	mov	r2,a
;	../../shared/src/dll_cal_rom.c:286: }
00103$:
;	../../shared/src/dll_cal_rom.c:288: return val;
	mov	dpl,r2
	mov	sp,_bp
	pop	_bp
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'dll_eom_gm_cal'
;------------------------------------------------------------
;dir                       Allocated to registers r2 
;pre_dll_gmsel             Allocated to registers r5 
;loop_cnt                  Allocated to registers r4 
;cmpout                    Allocated to registers r3 
;------------------------------------------------------------
;	../../shared/src/dll_cal_rom.c:302: void dll_eom_gm_cal( void ) BANKING_CTRL {
;	-----------------------------------------
;	 function dll_eom_gm_cal
;	-----------------------------------------
_dll_eom_gm_cal:
;	../../shared/src/dll_cal_rom.c:305: lnx_DLL_EOM_GM_CAL_DONE_LANE = 0;
	mov	dptr,#_CAL_CTRL1_LANE
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:307: if(cmx_EOM_DLL_CAL_EXT_EN || LOAD_CAL_ON) {	
	mov	dptr,#(_CONTROL_CONFIG1 + 0x0001)
	movx	a,@dptr
	jb	acc.5,00101$
	mov	dptr,#_CAL_CTRL3_LANE
	...
	jz	00102$
00101$:
;	../../shared/src/dll_cal_rom.c:308: EOM_DLL_GMSEL = lnx_cal_dll_eom_gmsel[rate];	
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	add	a,#_lnx_cal_dll_eom_gmsel
	mov	dpl,a
	clr	a
	addc	a,#(_lnx_cal_dll_eom_gmsel >> 8)
	mov	dph,a
	movx	a,@dptr
	mov	r2,a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:309: lnx_DLL_EOM_GM_CAL_DONE_LANE = 1;
	mov	dptr,#_CAL_CTRL1_LANE
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:310: return;
	ljmp	00119$
00102$:
;	../../shared/src/dll_cal_rom.c:313: PHY_STATUS = ST_DLL_EOM_GM_CAL;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x0C
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:315: lnx_DLL_EOM_GM_CAL_PASS_LANE = 1;
	mov	dptr,#_CAL_CTRL2_LANE
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:317: DLL_PD_SEL = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_8
	movx	a,@dptr
	anl	a,#0xf3
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:321: EOM_DLL_GMSEL = 0x07;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_9
	movx	a,@dptr
	orl	a,#0xe0
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:322: delay01(10);
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/dll_cal_rom.c:324: dir = DLL_CAL_CMP_OUT; cmpout = dir;
	mov	dptr,#_RX_CALIBRATION_REG
	movx	a,@dptr
	rr	a
	anl	a,#0x01
	mov	r2,a
	mov	r3,a
;	../../shared/src/dll_cal_rom.c:326: do {
	mov	r4,#0x08
00116$:
;	../../shared/src/dll_cal_rom.c:327: pre_dll_gmsel = EOM_DLL_GMSEL;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_9
	movx	a,@dptr
	swap	a
	rr	a
	anl	a,#0x07
	mov	r5,a
;	../../shared/src/dll_cal_rom.c:329: if( cmpout == 0 )  {
	mov	a,r3
	jnz	00109$
;	../../shared/src/dll_cal_rom.c:330: if(EOM_DLL_GMSEL>lnx_DLL_EOM_GMSEL_MIN_LANE_3_0) EOM_DLL_GMSEL--;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_9
	movx	a,@dptr
	swap	a
	rr	a
...
00131$:
	...
	sjmp	00110$
00109$:
;	../../shared/src/dll_cal_rom.c:333: if(EOM_DLL_GMSEL<7) EOM_DLL_GMSEL++;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_9
	movx	a,@dptr
	swap	a
	rr	a
	...
	movx	@dptr,a
00110$:
;	../../shared/src/dll_cal_rom.c:336: delay01(10);
	mov	dptr,#0x000A
	push	ar2
	push	ar4
	push	ar5
	...
	pop	ar4
	pop	ar2
;	../../shared/src/dll_cal_rom.c:338: cmpout = DLL_CAL_CMP_OUT;
	mov	dptr,#_RX_CALIBRATION_REG
	movx	a,@dptr
	rr	a
	anl	a,#0x01
	mov	r6,a
	mov	r3,a
;	../../shared/src/dll_cal_rom.c:339: if(dir != cmpout) {
	mov	a,r2
	cjne	a,ar3,00134$
	sjmp	00112$
00134$:
;	../../shared/src/dll_cal_rom.c:340: EOM_DLL_GMSEL = pre_dll_gmsel;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_9
	mov	a,r5
	swap	a
	rl	a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:341: break;
	sjmp	00118$
00112$:
;	../../shared/src/dll_cal_rom.c:343: if( EOM_DLL_GMSEL==0x07 || EOM_DLL_GMSEL==0x03 ) {
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_9
	movx	a,@dptr
	swap	a
	rr	a
...
00135$:
	...
	cjne	r5,#0x03,00117$
00113$:
;	../../shared/src/dll_cal_rom.c:344: lnx_DLL_COMP_CAL_PASS_LANE = 0;
	mov	dptr,#_CAL_CTRL2_LANE
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:345: break;
	sjmp	00118$
00117$:
;	../../shared/src/dll_cal_rom.c:347: } while (loop_cnt-->0);
	mov	ar5,r4
	dec	r4
	mov	a,r5
	jz	00138$
...
00138$:
00118$:
;	../../shared/src/dll_cal_rom.c:349: lnx_DLL_EOM_GM_CAL_DONE_LANE = 1;
	mov	dptr,#_CAL_CTRL1_LANE
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:352: lnx_cal_dll_eom_gmsel[rate] = (EOM_DLL_GMSEL & 0x7) | 0x00;	
	mov	c,_rx_pll_rate
	clr	a
	rlc	a
	add	a,#_lnx_cal_dll_eom_gmsel
...
00119$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'set_sellv_rxeomdll_ch'
;------------------------------------------------------------
;val                       Allocated to registers r2 
;------------------------------------------------------------
;	../../shared/src/dll_cal_rom.c:384: void set_sellv_rxeomdll_ch(uint8_t val) BANKING_CTRL {
;	-----------------------------------------
;	 function set_sellv_rxeomdll_ch
;	-----------------------------------------
_set_sellv_rxeomdll_ch:
	mov	r2,dpl
;	../../shared/src/dll_cal_rom.c:385: switch(mcuid) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r3,a
	jz	00101$
;	../../shared/src/dll_cal_rom.c:386: case MCU_LANE0: 
	cjne	r3,#0x01,00104$
	sjmp	00102$
00101$:
;	../../shared/src/dll_cal_rom.c:387: reg_SELLV_RXEOMDLL_CH0_5_0 = val; break;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_152
	mov	a,r2
	add	a,r2
	add	a,acc
	anl	a,#0xfc
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:388: case MCU_LANE1:	
	sjmp	00104$
00102$:
;	../../shared/src/dll_cal_rom.c:389: reg_SELLV_RXEOMDLL_CH1_5_0 = val; break;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_153
	mov	a,r2
	add	a,r2
	add	a,acc
	anl	a,#0xfc
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/dll_cal_rom.c:390: }
00104$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'get_sellv_rxeomdll_ch'
;------------------------------------------------------------
;val                       Allocated to stack - offset 1
;------------------------------------------------------------
;	../../shared/src/dll_cal_rom.c:393: uint8_t get_sellv_rxeomdll_ch(void) BANKING_CTRL {
;	-----------------------------------------
;	 function get_sellv_rxeomdll_ch
;	-----------------------------------------
_get_sellv_rxeomdll_ch:
	push	_bp
	mov	_bp,sp
	inc	sp
;	../../shared/src/dll_cal_rom.c:395: switch(mcuid) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r2,a
	jz	00101$
;	../../shared/src/dll_cal_rom.c:396: case MCU_LANE0: 
	cjne	r2,#0x01,00103$
	sjmp	00102$
00101$:
;	../../shared/src/dll_cal_rom.c:397: val = reg_SELLV_RXEOMDLL_CH0_5_0; break;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_152
	movx	a,@dptr
	rr	a
	rr	a
	anl	a,#0x3f
	mov	r2,a
;	../../shared/src/dll_cal_rom.c:398: case MCU_LANE1:	
	sjmp	00103$
00102$:
;	../../shared/src/dll_cal_rom.c:399: val = reg_SELLV_RXEOMDLL_CH1_5_0; break;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_153
	movx	a,@dptr
	rr	a
	rr	a
	...
	mov	r3,a
	mov	r2,a
;	../../shared/src/dll_cal_rom.c:400: }
00103$:
;	../../shared/src/dll_cal_rom.c:402: return val;
	mov	dpl,r2
	mov	sp,_bp
	pop	_bp
	ljmp	__sdcc_banked_ret
