...
;dtx_off                   Allocated to stack - offset 4
;------------------------------------------------------------
...
;	../../shared/src/cal_top.c:908: TX_TRAIN_CTRL_LANE.VAL &= 0xa01f0002;
	...
	movx	@dptr,a
00102$:
;	../../shared/src/cal_top.c:927: if( reg_INT_POWER_STATE_VALID_RISE_ISR_LANE ) { //Need P0 to P2 time reduce for Lane Disable
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG1_LANE + 0x0003)
	movx	a,@dptr
	jnb	acc.4,00111$
;	../../shared/src/cal_top.c:928: if( reg_PIN_PU_PLL_RD_LANE==0 || reg_PIN_PU_TX_RD_LANE==0 ) {
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	jnb	acc.5,00106$
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	...
	jb	acc.4,00107$
00106$:
;	../../shared/src/cal_top.c:929: reg_PIN_PLL_READY_TX_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/cal_top.c:930: reg_PIN_PLL_READY_RX_LANE = 0;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/cal_top.c:931: PHY_STATUS = ST_P2;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x21
	movx	@dptr,a
	sjmp	00108$
00107$:
;	../../shared/src/cal_top.c:933: else if( reg_PIN_PU_RX_RD_LANE==0 ) {
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	jb	acc.2,00108$
;	../../shared/src/cal_top.c:934: reg_PIN_PLL_READY_RX_LANE = 0;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/cal_top.c:935: PHY_STATUS = ST_P1;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x22
	movx	@dptr,a
00108$:
;	../../shared/src/cal_top.c:937: PM_CTRL_INTERRUPT_ISR_REG1_LANE.BT.B3 = 0x13; // reg_INT_REFCLK_DIS_CHG_ISR_LANE, reg_INT_POWER_STATE_VALID_RISE_ISR_LANE, reg_INT_PU_PLL_OR_CHG_ISR_LANE
;	../../shared/src/cal_top.c:938: PM_CTRL_INTERRUPT_ISR_REG1_LANE.BT.B3 = 0;
	...
	movx	@dptr,a
00111$:
;	../../shared/src/cal_top.c:941: if(reg_DPHY_ANA_LANE_DISABLE_ISR_LANE) {
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG1_LANE + 0x0002)
	movx	a,@dptr
	jnb	acc.1,00119$
;	../../shared/src/cal_top.c:942: switch(mcuid) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r2,a
	jz	00112$
;	../../shared/src/cal_top.c:943: case MCU_LANE0:
	cjne	r2,#0x01,00114$
	sjmp	00113$
00112$:
;	../../shared/src/cal_top.c:944: cmx_LANE_DIS_LANE0_7_0 = reg_LANE_DISABLE_RD_LANE;
	...
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/cal_top.c:945: break;
;	../../shared/src/cal_top.c:946: case MCU_LANE1:
	sjmp	00114$
00113$:
;	../../shared/src/cal_top.c:947: cmx_LANE_DIS_LANE1_7_0 = reg_LANE_DISABLE_RD_LANE;
	mov	dptr,#_TX_SYSTEM_LANE
	movx	a,@dptr
	anl	a,#0x01
	mov	r2,a
	...
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/cal_top.c:957: }
00114$:
;	../../shared/src/cal_top.c:959: PM_CTRL_INTERRUPT_ISR_REG1_LANE.BT.B2 = 0x02; //reg_DPHY_ANA_LANE_DISABLE_ISR_CLEAR_LANE
;	../../shared/src/cal_top.c:960: PM_CTRL_INTERRUPT_ISR_REG1_LANE.BT.B2 = 0;
	mov	dptr,#(_PM_CTRL_INTERRUPT_ISR_REG1_LANE + 0x0002)
	mov	a,#0x02
	movx	@dptr,a
	clr	a
	movx	@dptr,a
;	../../shared/src/cal_top.c:962: if ( cmx_LANE_DIS_LANE0_7_0 && cmx_LANE_DIS_LANE1_7_0
	mov	dptr,#(_MCU_CONFIG + 0x0001)
	movx	a,@dptr
	jz	00119$
	mov	dptr,#(_MCU_CONFIG + 0x0002)
	movx	a,@dptr
	jz	00119$
;	../../shared/src/cal_top.c:967: reg_LANE_ALIGN_READY_OUT = 1; //control sequence to de-glitch
	mov	dptr,#(_SRIS_REG0 + 0x0003)
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/cal_top.c:968: reg_LANE_ALIGN_READY_OUT_FORCE = 1;
	mov	dptr,#(_SRIS_REG0 + 0x0003)
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/cal_top.c:969: reg_TXCLK_SYNC_START_OUT = 1;
