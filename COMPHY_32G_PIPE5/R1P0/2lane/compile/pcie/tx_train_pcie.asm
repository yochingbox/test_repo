...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'tx_train_PCIe'
;------------------------------------------------------------
;cnt                       Allocated to registers r3 
;i                         Allocated to registers r2 
;update                    Allocated to registers r2 
;fs                        Allocated to registers r2 
;------------------------------------------------------------
;	../../shared/src/tx_train_pcie.c:27: void tx_train_PCIe(void) {
;	-----------------------------------------
;	 function tx_train_PCIe
;	-----------------------------------------
_tx_train_PCIe:
	ar2 = 0x02
	ar3 = 0x03
	...
	ar0 = 0x00
	ar1 = 0x01
;	../../shared/src/tx_train_pcie.c:31: pcie_f0b_en = 1;
	mov	dptr,#_pcie_f0b_en
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/tx_train_pcie.c:57: fs = reg_REMOTE_FS_LANE_5_0;
	mov	dptr,#_LANE_EQ_CFG0_LANE
	movx	a,@dptr
	anl	a,#0x3f
	mov	r2,a
;	../../shared/src/tx_train_pcie.c:58: if( fs <= 31 ) cnt = 1;  //3
	mov	a,#0x1F
	cjne	a,ar2,00167$
00167$:
	jc	00111$
	...
	sjmp	00112$
00111$:
;	../../shared/src/tx_train_pcie.c:59: else if( fs <= 40 ) cnt = 2;  //4
	mov	a,#0x28
	cjne	a,ar2,00169$
00169$:
	jc	00108$
	...
	sjmp	00112$
00108$:
;	../../shared/src/tx_train_pcie.c:60: else if( fs <= 49 ) cnt = 3;  //5
	mov	a,#0x31
	cjne	a,ar2,00171$
00171$:
	jc	00105$
	...
	sjmp	00112$
00105$:
;	../../shared/src/tx_train_pcie.c:61: else if( fs <= 58 ) cnt = 4;  //6
	mov	a,#0x3A
	cjne	a,ar2,00173$
00173$:
	jc	00102$
	...
	sjmp	00112$
00102$:
;	../../shared/src/tx_train_pcie.c:62: else cnt = 5;  //7
	mov	r3,#0x05
00112$:
;	../../shared/src/tx_train_pcie.c:64: cnt++;
	inc	r3
;	../../shared/src/tx_train_pcie.c:65: while( cnt-->0 ) {
	mov	ar2,r3
00115$:
	mov	ar4,r2
	dec	r2
	...
	subb	a,b
	jnc	00117$
;	../../shared/src/tx_train_pcie.c:66: req_local_ctrl(CE_NORMAL, 0, tag_TX_TRAIN_P2P_HOLD, 2);
	...
	pop	ar2
;	../../shared/src/tx_train_pcie.c:67: train_gn1_index--;
	mov	dptr,#_train_gn1_index
	movx	a,@dptr
	dec	a
	mov	dptr,#_train_gn1_index
	movx	@dptr,a
;	../../shared/src/tx_train_pcie.c:68: train_g0_index -= tag_TX_TRAIN_P2P_HOLD;
	mov	dptr,#_tx_train_p2p_hold
	movx	a,@dptr
	mov	r4,a
	...
	subb	a,r4
	movx	@dptr,a
;	../../shared/src/tx_train_pcie.c:69: if(tx.gn1_is_min) break;
	mov	dptr,#(_tx + 0x0008)
	movx	a,@dptr
	jz	00115$
00117$:
;	../../shared/src/tx_train_pcie.c:72: dfe_cdr_phase_opt();
	lcall	_dfe_cdr_phase_opt
;	../../shared/src/tx_train_pcie.c:74: train2opt();
	lcall	_train2opt
;	../../shared/src/tx_train_pcie.c:76: reg_MCU_DEBUGC_LANE_7_0 = (uint8_t)train.fn1;
	mov	dptr,#(_train + 0x001d)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_MCU_DEBUG3_LANE
	movx	@dptr,a
;	../../shared/src/tx_train_pcie.c:77: reg_MCU_DEBUGF_LANE_7_0 = 0xaa;
	mov	dptr,#(_MCU_DEBUG3_LANE + 0x0003)
	mov	a,#0xAA
	movx	@dptr,a
;	../../shared/src/tx_train_pcie.c:79: if(train.fn1 <= tag_PCIE_GN1_FN1_THRE && !train.saturated) {
	mov	dptr,#(_DFE_CONTROL_8 + 0x0002)
	movx	a,@dptr
	mov	r4,a
	cjne	a,ar2,00177$
00177$:
	...
	movx	a,@dptr
	jnz	00156$
;	../../shared/src/tx_train_pcie.c:80: pcie_f0b_en = 0;
	mov	dptr,#_pcie_f0b_en
	clr	a
	movx	@dptr,a
;	../../shared/src/tx_train_pcie.c:81: return;
	ret
;	../../shared/src/tx_train_pcie.c:84: for(i=0; i<tag_PCIE_GN1_STEP_NUM; i++) {
00156$:
	mov	r2,#0x00
00126$:
	mov	dptr,#(_DFE_CONTROL_8 + 0x0003)
	movx	a,@dptr
	mov	r4,a
	mov	ar5,r2
	mov	a,r5
...
00180$:
	jnc	00129$
;	../../shared/src/tx_train_pcie.c:85: req_local_ctrl(CE_NORMAL, 0, tag_TX_TRAIN_P2P_HOLD, 2);
	mov	dptr,#_tx_train_p2p_hold
	movx	a,@dptr
	mov	r4,a
	clr	a
	...
	mov	r2,#(_Send_ctrl_to_tx >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/tx_train_pcie.c:86: train_gn1_index--;
	mov	dptr,#_train_gn1_index
	movx	a,@dptr
	dec	a
	mov	dptr,#_train_gn1_index
	movx	@dptr,a
;	../../shared/src/tx_train_pcie.c:87: train_g0_index -= tag_TX_TRAIN_P2P_HOLD;
	mov	dptr,#_tx_train_p2p_hold
	movx	a,@dptr
	mov	r4,a
	mov	dptr,#_train_g0_index
	...
	subb	a,r4
	movx	@dptr,a
;	../../shared/src/tx_train_pcie.c:88: dfe_cdr_phase_opt();
	lcall	_dfe_cdr_phase_opt
;	../../shared/src/tx_train_pcie.c:89: compare_g1n1(0);
	mov	dpl,#0x00
	lcall	_compare_g1n1
	pop	ar2
;	../../shared/src/tx_train_pcie.c:90: if(train.fn1 <= tag_PCIE_GN1_FN1_THRE && !train.saturated) break;
	mov	dptr,#(_train + 0x001d)
	movx	a,@dptr
	mov	r4,a
	mov	dptr,#(_DFE_CONTROL_8 + 0x0002)
...
00182$:
	...
	jz	00129$
00122$:
;	../../shared/src/tx_train_pcie.c:91: if(tx.gn1_is_min) break;
	mov	dptr,#(_tx + 0x0008)
	movx	a,@dptr
	jnz	00129$
;	../../shared/src/tx_train_pcie.c:84: for(i=0; i<tag_PCIE_GN1_STEP_NUM; i++) {
	...
	sjmp	00126$
00129$:
;	../../shared/src/tx_train_pcie.c:94: reg_MCU_DEBUGC_LANE_7_0 = (uint8_t)train.fn1;
	mov	dptr,#(_train + 0x001d)
	movx	a,@dptr
	mov	dptr,#_MCU_DEBUG3_LANE
	movx	@dptr,a
;	../../shared/src/tx_train_pcie.c:95: reg_MCU_DEBUGF_LANE_7_0 = i;
	mov	dptr,#(_MCU_DEBUG3_LANE + 0x0003)
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/tx_train_pcie.c:97: update = opt_gn1_index - train_gn1_index;
	mov	dptr,#_train_gn1_index
	movx	a,@dptr
	mov	r2,a
	...
	clr	c
	subb	a,r2
;	../../shared/src/tx_train_pcie.c:98: reg_MCU_DEBUGB_LANE_7_0 = (uint8_t)update;
	mov	r2,a
	mov	dptr,#(_MCU_DEBUG2_LANE + 0x0003)
	movx	@dptr,a
;	../../shared/src/tx_train_pcie.c:100: if( update!=0 ) {
	mov	a,r2
	jnz	00186$
	ljmp	00142$
00186$:
;	../../shared/src/tx_train_pcie.c:101: cnt = tag_PCIE_GN1_STEP_NUM;
	mov	dptr,#(_DFE_CONTROL_8 + 0x0003)
	movx	a,@dptr
	mov	r4,a
	mov	r3,a
;	../../shared/src/tx_train_pcie.c:102: while (cnt-->0) {
00138$:
	mov	ar4,r3
	dec	r3
	clr	c
	...
	ljmp	00142$
00187$:
;	../../shared/src/tx_train_pcie.c:103: if(update > 0 && tx.gn1_is_max==0) {
	clr	c
	mov	a,#(0x00 ^ 0x80)
	mov	b,r2
	xrl	b,#0x80
	...
	movx	a,@dptr
	jnz	00135$
;	../../shared/src/tx_train_pcie.c:104: req_local_ctrl(CE_NORMAL, 0, tag_TX_TRAIN_P2P_HOLD, 1);
	mov	dptr,#_tx_train_p2p_hold
	movx	a,@dptr
	mov	r4,a
	clr	a
	...
	pop	ar3
	pop	ar2
;	../../shared/src/tx_train_pcie.c:105: train_gn1_index ++;
	mov	dptr,#_train_gn1_index
	movx	a,@dptr
	add	a,#0x01
	movx	@dptr,a
;	../../shared/src/tx_train_pcie.c:106: train_g0_index += tag_TX_TRAIN_P2P_HOLD;
	mov	dptr,#_tx_train_p2p_hold
	movx	a,@dptr
	mov	r4,a
	mov	dptr,#_train_g0_index
	...
	add	a,r5
	movx	@dptr,a
;	../../shared/src/tx_train_pcie.c:107: update--;
	dec	r2
	sjmp	00138$
00135$:
;	../../shared/src/tx_train_pcie.c:109: else if(update < 0 && tx.gn1_is_min==0) {
	mov	a,r2
	jnb	acc.7,00142$
	mov	dptr,#(_tx + 0x0008)
	movx	a,@dptr
	jnz	00142$
;	../../shared/src/tx_train_pcie.c:110: req_local_ctrl(CE_NORMAL, 0, tag_TX_TRAIN_P2P_HOLD, 2);
	mov	dptr,#_tx_train_p2p_hold
	movx	a,@dptr
	mov	r4,a
	clr	a
	...
	pop	ar3
	pop	ar2
;	../../shared/src/tx_train_pcie.c:111: train_gn1_index--;
	mov	dptr,#_train_gn1_index
	movx	a,@dptr
	dec	a
	mov	dptr,#_train_gn1_index
	movx	@dptr,a
;	../../shared/src/tx_train_pcie.c:112: train_g0_index -= tag_TX_TRAIN_P2P_HOLD;
	mov	dptr,#_tx_train_p2p_hold
	movx	a,@dptr
	mov	r4,a
	mov	dptr,#_train_g0_index
	...
	subb	a,r4
	movx	@dptr,a
;	../../shared/src/tx_train_pcie.c:113: update++;
	inc	r2
;	../../shared/src/tx_train_pcie.c:115: else break;
	ljmp	00138$
00142$:
;	../../shared/src/tx_train_pcie.c:119: pcie_f0b_en = 0;
	mov	dptr,#_pcie_f0b_en
	clr	a
	movx	@dptr,a
	ret
