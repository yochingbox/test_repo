   ...
   A94D 78 4D              2045 	mov	r0,#_dll_comp_cal
   A94F 79 AA              2046 	mov	r1,#(_dll_comp_cal >> 8)
   A951 7A 02              2047 	mov	r2,#(_dll_comp_cal >> 16)
   A953 12 00 B3           2048 	lcall	__sdcc_banked_call
                           2049 ;	../../shared/src/dll_cal.c:82: dll_vdda_cal(DLL_VDDA_STEP);
   A956 75 82 01           2050 	mov	dpl,#0x01
   A959 78 EE              2051 	mov	r0,#_dll_vdda_cal
   A95B 79 AA              2052 	mov	r1,#(_dll_vdda_cal >> 8)
   A95D 7A 01              2053 	mov	r2,#(_dll_vdda_cal >> 16)
   A95F 12 00 B3           2054 	lcall	__sdcc_banked_call
                           2055 ;	../../shared/src/dll_cal.c:83: dll_gm_cal();
   A962 78 34              2056 	mov	r0,#_dll_gm_cal
   A964 79 AB              2057 	mov	r1,#(_dll_gm_cal >> 8)
   A966 7A 02              2058 	mov	r2,#(_dll_gm_cal >> 16)
   A968 12 00 B3           2059 	lcall	__sdcc_banked_call
                           2060 ;	../../shared/src/dll_cal.c:84: dll_vdda_cal(DLL_PHASE_STEP);
   A96B 75 82 00           2061 	mov	dpl,#0x00
   A96E 78 EE              2062 	mov	r0,#_dll_vdda_cal
   A970 79 AA              2063 	mov	r1,#(_dll_vdda_cal >> 8)
   A972 7A 01              2064 	mov	r2,#(_dll_vdda_cal >> 16)
   A974 12 00 B3           2065 	lcall	__sdcc_banked_call
                           2066 ;	../../shared/src/dll_cal.c:86: dll_eom_vdda_cal(DLL_VDDA_STEP);
   A977 75 82 01           2067 	mov	dpl,#0x01
   A97A 78 B3              2068 	mov	r0,#_dll_eom_vdda_cal
   A97C 79 AB              2069 	mov	r1,#(_dll_eom_vdda_cal >> 8)
   A97E 7A 01              2070 	mov	r2,#(_dll_eom_vdda_cal >> 16)
   A980 12 00 B3           2071 	lcall	__sdcc_banked_call
                           2072 ;	../../shared/src/dll_cal.c:87: dll_eom_gm_cal();
   A983 78 41              2073 	mov	r0,#_dll_eom_gm_cal
   A985 79 AE              2074 	mov	r1,#(_dll_eom_gm_cal >> 8)
   A987 7A 02              2075 	mov	r2,#(_dll_eom_gm_cal >> 16)
   A989 12 00 B3           2076 	lcall	__sdcc_banked_call
                           2077 ;	../../shared/src/dll_cal.c:88: dll_eom_vdda_cal(DLL_PHASE_STEP);
   A98C 75 82 00           2078 	mov	dpl,#0x00
   A98F 78 B3              2079 	mov	r0,#_dll_eom_vdda_cal
   A991 79 AB              2080 	mov	r1,#(_dll_eom_vdda_cal >> 8)
   A993 7A 01              2081 	mov	r2,#(_dll_eom_vdda_cal >> 16)
   A995 12 00 B3           2082 	lcall	__sdcc_banked_call
   A998 02 00 C5           2083 	ljmp	__sdcc_banked_ret
                           2084 ;------------------------------------------------------------
                           ...
                           2094 ;	-----------------------------------------
   A99B                    2095 _get_vref_rxdll_sel:
   A99B C0 18              2096 	push	_bp
   A99D E5 81              2097 	mov	a,sp
   A99F F5 18              2098 	mov	_bp,a
   A9A1 24 0C              2099 	add	a,#0x0c
   A9A3 F5 81              2100 	mov	sp,a
                           2101 ;	../../shared/src/dll_cal.c:111: temp_cel = (((int32_t)tsen_dat * 394) + 128900 + 500) / 1000;
   A9A5 90 66 17           2102 	mov	dptr,#_tsen_dat
   A9A8 E0                 2103 	movx	a,@dptr
   A9A9 FA                 2104 	mov	r2,a
   A9AA A3                 2105 	inc	dptr
   A9AB E0                 2106 	movx	a,@dptr
   A9AC FB                 2107 	mov	r3,a
   A9AD 33                 2108 	rlc	a
   A9AE 95 E0              2109 	subb	a,acc
   A9B0 FC                 2110 	mov	r4,a
   A9B1 FD                 2111 	mov	r5,a
   A9B2 C0 02              2112 	push	ar2
   A9B4 C0 03              2113 	push	ar3
   A9B6 C0 04              2114 	push	ar4
   A9B8 C0 05              2115 	push	ar5
   A9BA 90 01 8A           2116 	mov	dptr,#0x018A
   A9BD E4                 2117 	clr	a
   A9BE F5 F0              2118 	mov	b,a
   A9C0 12 79 50           2119 	lcall	__mullong
   A9C3 AA 82              2120 	mov	r2,dpl
   A9C5 AB 83              2121 	mov	r3,dph
   A9C7 AC F0              2122 	mov	r4,b
   A9C9 FD                 2123 	mov	r5,a
   A9CA E5 81              2124 	mov	a,sp
   A9CC 24 FC              2125 	add	a,#0xfc
   A9CE F5 81              2126 	mov	sp,a
   A9D0 74 78              2127 	mov	a,#0x78
   A9D2 2A                 2128 	add	a,r2
   A9D3 FA                 2129 	mov	r2,a
   A9D4 74 F9              2130 	mov	a,#0xF9
   A9D6 3B                 2131 	addc	a,r3
   A9D7 FB                 2132 	mov	r3,a
   A9D8 74 01              2133 	mov	a,#0x01
   A9DA 3C                 2134 	addc	a,r4
   A9DB FC                 2135 	mov	r4,a
   A9DC E4                 2136 	clr	a
   A9DD 3D                 2137 	addc	a,r5
   A9DE FD                 2138 	mov	r5,a
   A9DF 74 E8              2139 	mov	a,#0xE8
   A9E1 C0 E0              2140 	push	acc
   A9E3 74 03              2141 	mov	a,#0x03
   A9E5 C0 E0              2142 	push	acc
   A9E7 E4                 2143 	clr	a
   A9E8 C0 E0              2144 	push	acc
   A9EA C0 E0              2145 	push	acc
   A9EC 8A 82              2146 	mov	dpl,r2
   A9EE 8B 83              2147 	mov	dph,r3
   A9F0 8C F0              2148 	mov	b,r4
   A9F2 ED                 2149 	mov	a,r5
   A9F3 12 78 71           2150 	lcall	__divslong
   A9F6 A8 18              2151 	mov	r0,_bp
   A9F8 08                 2152 	inc	r0
   A9F9 A6 82              2153 	mov	@r0,dpl
   A9FB 08                 2154 	inc	r0
   A9FC A6 83              2155 	mov	@r0,dph
   A9FE 08                 2156 	inc	r0
   A9FF A6 F0              2157 	mov	@r0,b
   AA01 08                 2158 	inc	r0
   AA02 F6                 2159 	mov	@r0,a
   AA03 E5 81              2160 	mov	a,sp
   AA05 24 FC              2161 	add	a,#0xfc
   AA07 F5 81              2162 	mov	sp,a
                           2163 ;	../../shared/src/dll_cal.c:112: vref_from_temp = (int32_t)rxdll_temp_b_lane*250 + ((int32_t)rxdll_temp_a_lane * temp_cel);
   AA09 90 66 37           2164 	mov	dptr,#_rxdll_temp_b_lane
   AA0C E0                 2165 	movx	a,@dptr
   AA0D FE                 2166 	mov	r6,a
   AA0E 7F 00              2167 	mov	r7,#0x00
   AA10 7A 00              2168 	mov	r2,#0x00
   AA12 7B 00              2169 	mov	r3,#0x00
   AA14 C0 06              2170 	push	ar6
   AA16 C0 07              2171 	push	ar7
   AA18 C0 02              2172 	push	ar2
   AA1A C0 03              2173 	push	ar3
   AA1C 90 00 FA           2174 	mov	dptr,#(0xFA&0x00ff)
   AA1F E4                 2175 	clr	a
   AA20 F5 F0              2176 	mov	b,a
   AA22 12 79 50           2177 	lcall	__mullong
   AA25 C8                 2178 	xch	a,r0
   AA26 E5 18              2179 	mov	a,_bp
   AA28 24 09              2180 	add	a,#0x09
   AA2A C8                 2181 	xch	a,r0
   AA2B A6 82              2182 	mov	@r0,dpl
   AA2D 08                 2183 	inc	r0
   AA2E A6 83              2184 	mov	@r0,dph
   AA30 08                 2185 	inc	r0
   AA31 A6 F0              2186 	mov	@r0,b
   AA33 08                 2187 	inc	r0
   AA34 F6                 2188 	mov	@r0,a
   AA35 E5 81              2189 	mov	a,sp
   AA37 24 FC              2190 	add	a,#0xfc
   AA39 F5 81              2191 	mov	sp,a
   AA3B 90 66 36           2192 	mov	dptr,#_rxdll_temp_a_lane
   AA3E E0                 2193 	movx	a,@dptr
   AA3F FE                 2194 	mov	r6,a
   AA40 7F 00              2195 	mov	r7,#0x00
   AA42 7A 00              2196 	mov	r2,#0x00
   AA44 7B 00              2197 	mov	r3,#0x00
   AA46 A8 18              2198 	mov	r0,_bp
   AA48 08                 2199 	inc	r0
   AA49 E6                 2200 	mov	a,@r0
   AA4A C0 E0              2201 	push	acc
   AA4C 08                 2202 	inc	r0
   AA4D E6                 2203 	mov	a,@r0
   AA4E C0 E0              2204 	push	acc
   AA50 08                 2205 	inc	r0
   AA51 E6                 2206 	mov	a,@r0
   AA52 C0 E0              2207 	push	acc
   AA54 08                 2208 	inc	r0
   AA55 E6                 2209 	mov	a,@r0
   AA56 C0 E0              2210 	push	acc
   AA58 8E 82              2211 	mov	dpl,r6
   AA5A 8F 83              2212 	mov	dph,r7
   AA5C 8A F0              2213 	mov	b,r2
   AA5E EB                 2214 	mov	a,r3
   AA5F 12 79 50           2215 	lcall	__mullong
   AA62 AA 82              2216 	mov	r2,dpl
   AA64 AB 83              2217 	mov	r3,dph
   AA66 AC F0              2218 	mov	r4,b
   AA68 FD                 2219 	mov	r5,a
   AA69 E5 81              2220 	mov	a,sp
   AA6B 24 FC              2221 	add	a,#0xfc
   AA6D F5 81              2222 	mov	sp,a
   AA6F E5 18              2223 	mov	a,_bp
   AA71 24 09              2224 	add	a,#0x09
   AA73 F8                 2225 	mov	r0,a
   AA74 EA                 2226 	mov	a,r2
   AA75 26                 2227 	add	a,@r0
   AA76 FA                 2228 	mov	r2,a
   AA77 EB                 2229 	mov	a,r3
   AA78 08                 2230 	inc	r0
   AA79 36                 2231 	addc	a,@r0
   AA7A FB                 2232 	mov	r3,a
   AA7B EC                 2233 	mov	a,r4
   AA7C 08                 2234 	inc	r0
   AA7D 36                 2235 	addc	a,@r0
   AA7E FC                 2236 	mov	r4,a
   AA7F ED                 2237 	mov	a,r5
   AA80 08                 2238 	inc	r0
   AA81 36                 2239 	addc	a,@r0
   AA82 FD                 2240 	mov	r5,a
   AA83 E5 18              2241 	mov	a,_bp
   AA85 24 05              2242 	add	a,#0x05
   AA87 F8                 2243 	mov	r0,a
   AA88 A6 02              2244 	mov	@r0,ar2
   AA8A 08                 2245 	inc	r0
   AA8B A6 03              2246 	mov	@r0,ar3
   AA8D 08                 2247 	inc	r0
   AA8E A6 04              2248 	mov	@r0,ar4
   AA90 08                 2249 	inc	r0
   AA91 A6 05              2250 	mov	@r0,ar5
                           2251 ;	../../shared/src/dll_cal.c:113: vref_from_temp = (vref_from_temp - 36000)/1000;
   AA93 E5 18              2252 	mov	a,_bp
   AA95 24 05              2253 	add	a,#0x05
   AA97 F8                 2254 	mov	r0,a
   AA98 E6                 2255 	mov	a,@r0
   AA99 24 60              2256 	add	a,#0x60
   AA9B FE                 2257 	mov	r6,a
   AA9C 08                 2258 	inc	r0
   AA9D E6                 2259 	mov	a,@r0
   AA9E 34 73              2260 	addc	a,#0x73
   AAA0 FF                 2261 	mov	r7,a
   AAA1 08                 2262 	inc	r0
   AAA2 E6                 2263 	mov	a,@r0
   AAA3 34 FF              2264 	addc	a,#0xff
   AAA5 FA                 2265 	mov	r2,a
   AAA6 08                 2266 	inc	r0
   AAA7 E6                 2267 	mov	a,@r0
   AAA8 34 FF              2268 	addc	a,#0xff
   AAAA FB                 2269 	mov	r3,a
   AAAB 74 E8              2270 	mov	a,#0xE8
   AAAD C0 E0              2271 	push	acc
   AAAF 74 03              2272 	mov	a,#0x03
   AAB1 C0 E0              2273 	push	acc
   AAB3 E4                 2274 	clr	a
   AAB4 C0 E0              2275 	push	acc
   AAB6 C0 E0              2276 	push	acc
   AAB8 8E 82              2277 	mov	dpl,r6
   AABA 8F 83              2278 	mov	dph,r7
   AABC 8A F0              2279 	mov	b,r2
   AABE EB                 2280 	mov	a,r3
   AABF 12 78 71           2281 	lcall	__divslong
   AAC2 AA 82              2282 	mov	r2,dpl
   AAC4 AB 83              2283 	mov	r3,dph
   AAC6 AC F0              2284 	mov	r4,b
   AAC8 FD                 2285 	mov	r5,a
   AAC9 E5 81              2286 	mov	a,sp
   AACB 24 FC              2287 	add	a,#0xfc
   AACD F5 81              2288 	mov	sp,a
   AACF E5 18              2289 	mov	a,_bp
   AAD1 24 05              2290 	add	a,#0x05
   AAD3 F8                 2291 	mov	r0,a
   AAD4 A6 02              2292 	mov	@r0,ar2
   AAD6 08                 2293 	inc	r0
   AAD7 A6 03              2294 	mov	@r0,ar3
   AAD9 08                 2295 	inc	r0
   AADA A6 04              2296 	mov	@r0,ar4
   AADC 08                 2297 	inc	r0
   AADD A6 05              2298 	mov	@r0,ar5
                           2299 ;	../../shared/src/dll_cal.c:115: return (uint8_t)vref_from_temp;
   AADF E5 18              2300 	mov	a,_bp
   AAE1 24 05              2301 	add	a,#0x05
   AAE3 F8                 2302 	mov	r0,a
   AAE4 86 82              2303 	mov	dpl,@r0
   AAE6 85 18 81           2304 	mov	sp,_bp
   AAE9 D0 18              2305 	pop	_bp
   AAEB 02 00 C5           2306 	ljmp	__sdcc_banked_ret
                           2307 ;------------------------------------------------------------
                           ...
                           2318 ;	-----------------------------------------
   AAEE                    2319 _dll_vdda_cal:
   AAEE AA 82              2320 	mov	r2,dpl
                           2321 ;	../../shared/src/dll_cal.c:121: PHY_STATUS = ST_DLL_VDDA_CAL;
   AAF0 90 22 30           2322 	mov	dptr,#_MCU_STATUS0_LANE
   AAF3 74 0B              2323 	mov	a,#0x0B
   AAF5 F0                 2324 	movx	@dptr,a
                           2325 ;	../../shared/src/dll_cal.c:123: lnx_DLL_VDATA_CAL_DONE_LANE = 0;
   AAF6 90 60 00           2326 	mov	dptr,#_CAL_CTRL1_LANE
   AAF9 E0                 2327 	movx	a,@dptr
   AAFA 54 FB              2328 	anl	a,#0xfb
   AAFC F0                 2329 	movx	@dptr,a
                           2330 ;	../../shared/src/dll_cal.c:124: lnx_DLL_VDATA_CAL_PASS_LANE = 1;
   AAFD 90 60 04           2331 	mov	dptr,#_CAL_CTRL2_LANE
   AB00 E0                 2332 	movx	a,@dptr
   AB01 44 04              2333 	orl	a,#0x04
   AB03 F0                 2334 	movx	@dptr,a
                           2335 ;	../../shared/src/dll_cal.c:126: if( cmx_RXDLL_CAL_EXT_EN ) {
   AB04 90 E6 09           2336 	mov	dptr,#(_CONTROL_CONFIG1 + 0x0001)
   AB07 E0                 2337 	movx	a,@dptr
   AB08 30 E4 1C           2338 	jnb	acc.4,00102$
                           2339 ;	../../shared/src/dll_cal.c:127: val = lnx_cal_vdda_dll_sel[PWR][rx_pll_rate];
   AB0B A2 0E              2340 	mov	c,_rx_pll_rate
   AB0D E4                 2341 	clr	a
   AB0E 33                 2342 	rlc	a
   AB0F 24 06              2343 	add	a,#_lnx_cal_vdda_dll_sel
   AB11 F5 82              2344 	mov	dpl,a
   AB13 E4                 2345 	clr	a
   AB14 34 66              2346 	addc	a,#(_lnx_cal_vdda_dll_sel >> 8)
   AB16 F5 83              2347 	mov	dph,a
   AB18 E0                 2348 	movx	a,@dptr
                           2349 ;	../../shared/src/dll_cal.c:128: set_sellv_rxdll_ch(val);
   AB19 F5 82              2350 	mov	dpl,a
   AB1B 78 DA              2351 	mov	r0,#_set_sellv_rxdll_ch
   AB1D 79 AD              2352 	mov	r1,#(_set_sellv_rxdll_ch >> 8)
   AB1F 7A 02              2353 	mov	r2,#(_set_sellv_rxdll_ch >> 16)
   AB21 12 00 B3           2354 	lcall	__sdcc_banked_call
                           2355 ;	../../shared/src/dll_cal.c:129: goto skip_out; 
   AB24 02 AB A9           2356 	ljmp	00110$
   AB27                    2357 00102$:
                           2358 ;	../../shared/src/dll_cal.c:132: if( mode == DLL_VDDA_STEP ) {
   AB27 E4                 2359 	clr	a
   AB28 BA 01 01           2360 	cjne	r2,#0x01,00118$
   AB2B 04                 2361 	inc	a
   AB2C                    2362 00118$:
   AB2C FC                 2363 	mov	r4,a
   AB2D 60 0B              2364 	jz	00104$
                           2365 ;	../../shared/src/dll_cal.c:133: DLL_PD_SEL = 0x02;  
   AB2F 90 00 20           2366 	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_8
   AB32 E0                 2367 	movx	a,@dptr
   AB33 54 F3              2368 	anl	a,#0xf3
   AB35 44 08              2369 	orl	a,#0x08
   AB37 F0                 2370 	movx	@dptr,a
   AB38 80 07              2371 	sjmp	00105$
   AB3A                    2372 00104$:
                           2373 ;	../../shared/src/dll_cal.c:136: DLL_PD_SEL = 0x00;  
   AB3A 90 00 20           2374 	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_8
   AB3D E0                 2375 	movx	a,@dptr
   AB3E 54 F3              2376 	anl	a,#0xf3
   AB40 F0                 2377 	movx	@dptr,a
   AB41                    2378 00105$:
                           2379 ;	../../shared/src/dll_cal.c:139: if( lnx_DLL_VDDA_TRACKING_ON_LANE == 0 && mode == DLL_VDDA_STEP) { 		
   AB41 90 60 0A           2380 	mov	dptr,#(_CAL_CTRL3_LANE + 0x0002)
   AB44 E0                 2381 	movx	a,@dptr
   AB45 20 E5 39           2382 	jb	acc.5,00107$
   AB48 EC                 2383 	mov	a,r4
   AB49 60 36              2384 	jz	00107$
                           2385 ;	../../shared/src/dll_cal.c:160: VREF_RXDLL_SEL = get_vref_rxdll_sel();
   AB4B C0 02              2386 	push	ar2
   AB4D 78 9B              2387 	mov	r0,#_get_vref_rxdll_sel
   AB4F 79 A9              2388 	mov	r1,#(_get_vref_rxdll_sel >> 8)
   AB51 7A 01              2389 	mov	r2,#(_get_vref_rxdll_sel >> 16)
   AB53 12 00 B3           2390 	lcall	__sdcc_banked_call
   AB56 AC 82              2391 	mov	r4,dpl
   AB58 90 82 20           2392 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_136
   AB5B EC                 2393 	mov	a,r4
   AB5C C4                 2394 	swap	a
   AB5D 54 F0              2395 	anl	a,#(0xf0&0xf0)
   AB5F F5 F0              2396 	mov	b,a
   AB61 E0                 2397 	movx	a,@dptr
   AB62 54 0F              2398 	anl	a,#0x0f
   AB64 45 F0              2399 	orl	a,b
   AB66 F0                 2400 	movx	@dptr,a
                           2401 ;	../../shared/src/dll_cal.c:161: set_sellv_rxdll_ch(VREF_RXDLL_SEL*2 + 7);
   AB67 90 82 20           2402 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_136
   AB6A E0                 2403 	movx	a,@dptr
   AB6B C4                 2404 	swap	a
   AB6C 54 0F              2405 	anl	a,#0x0f
   AB6E 25 E0              2406 	add	a,acc
   AB70 24 07              2407 	add	a,#0x07
   AB72 F5 82              2408 	mov	dpl,a
   AB74 78 DA              2409 	mov	r0,#_set_sellv_rxdll_ch
   AB76 79 AD              2410 	mov	r1,#(_set_sellv_rxdll_ch >> 8)
   AB78 7A 02              2411 	mov	r2,#(_set_sellv_rxdll_ch >> 16)
   AB7A 12 00 B3           2412 	lcall	__sdcc_banked_call
   AB7D D0 02              2413 	pop	ar2
   AB7F 80 1D              2414 	sjmp	00108$
   AB81                    2415 00107$:
                           2416 ;	../../shared/src/dll_cal.c:166: val = lnx_cal_vdda_dll_sel[CONT][rx_pll_rate];
   AB81 A2 0E              2417 	mov	c,_rx_pll_rate
   AB83 E4                 2418 	clr	a
   AB84 33                 2419 	rlc	a
   AB85 24 08              2420 	add	a,#(_lnx_cal_vdda_dll_sel + 0x0002)
   AB87 F5 82              2421 	mov	dpl,a
   AB89 E4                 2422 	clr	a
   AB8A 34 66              2423 	addc	a,#((_lnx_cal_vdda_dll_sel + 0x0002) >> 8)
   AB8C F5 83              2424 	mov	dph,a
   AB8E E0                 2425 	movx	a,@dptr
                           2426 ;	../../shared/src/dll_cal.c:167: set_sellv_rxdll_ch(val);
   AB8F F5 82              2427 	mov	dpl,a
   AB91 C0 02              2428 	push	ar2
   AB93 78 DA              2429 	mov	r0,#_set_sellv_rxdll_ch
   AB95 79 AD              2430 	mov	r1,#(_set_sellv_rxdll_ch >> 8)
   AB97 7A 02              2431 	mov	r2,#(_set_sellv_rxdll_ch >> 16)
   AB99 12 00 B3           2432 	lcall	__sdcc_banked_call
   AB9C D0 02              2433 	pop	ar2
   AB9E                    2434 00108$:
                           2435 ;	../../shared/src/dll_cal.c:170: dll_vdda_cal_loop(mode);
   AB9E 8A 82              2436 	mov	dpl,r2
   ABA0 78 95              2437 	mov	r0,#_dll_vdda_cal_loop
   ABA2 79 AC              2438 	mov	r1,#(_dll_vdda_cal_loop >> 8)
   ABA4 7A 02              2439 	mov	r2,#(_dll_vdda_cal_loop >> 16)
   ABA6 12 00 B3           2440 	lcall	__sdcc_banked_call
                           2441 ;	../../shared/src/dll_cal.c:172: skip_out:
   ABA9                    2442 00110$:
                           2443 ;	../../shared/src/dll_cal.c:173: lnx_DLL_VDATA_CAL_DONE_LANE = 1;	
   ABA9 90 60 00           2444 	mov	dptr,#_CAL_CTRL1_LANE
   ABAC E0                 2445 	movx	a,@dptr
   ABAD 44 04              2446 	orl	a,#0x04
   ABAF F0                 2447 	movx	@dptr,a
   ABB0 02 00 C5           2448 	ljmp	__sdcc_banked_ret
                           2449 ;------------------------------------------------------------
                           ...
                           2466 ;	-----------------------------------------
   ABB3                    2467 _dll_eom_vdda_cal:
   ABB3 C0 18              2468 	push	_bp
   ABB5 85 81 18           2469 	mov	_bp,sp
   ABB8 05 81              2470 	inc	sp
   ABBA 05 81              2471 	inc	sp
   ABBC AA 82              2472 	mov	r2,dpl
                           2473 ;	../../shared/src/dll_cal.c:196: PHY_STATUS = ST_DLL_EOM_VDDA_CAL;
   ABBE 90 22 30           2474 	mov	dptr,#_MCU_STATUS0_LANE
   ABC1 74 0D              2475 	mov	a,#0x0D
   ABC3 F0                 2476 	movx	@dptr,a
                           2477 ;	../../shared/src/dll_cal.c:198: lnx_DLL_EOM_VDATA_CAL_DONE_LANE = 0;
   ABC4 90 60 00           2478 	mov	dptr,#_CAL_CTRL1_LANE
   ABC7 E0                 2479 	movx	a,@dptr
   ABC8 54 EF              2480 	anl	a,#0xef
   ABCA F0                 2481 	movx	@dptr,a
                           2482 ;	../../shared/src/dll_cal.c:199: lnx_DLL_EOM_VDATA_CAL_PASS_LANE = 1;
   ABCB 90 60 04           2483 	mov	dptr,#_CAL_CTRL2_LANE
   ABCE E0                 2484 	movx	a,@dptr
   ABCF 44 10              2485 	orl	a,#0x10
   ABD1 F0                 2486 	movx	@dptr,a
                           2487 ;	../../shared/src/dll_cal.c:201: if( cmx_EOM_DLL_CAL_EXT_EN ) {
   ABD2 90 E6 09           2488 	mov	dptr,#(_CONTROL_CONFIG1 + 0x0001)
   ABD5 E0                 2489 	movx	a,@dptr
   ABD6 30 E5 1C           2490 	jnb	acc.5,00102$
                           2491 ;	../../shared/src/dll_cal.c:202: val = lnx_cal_vdda_dll_eom_sel[PWR][rx_pll_rate];
   ABD9 A2 0E              2492 	mov	c,_rx_pll_rate
   ABDB E4                 2493 	clr	a
   ABDC 33                 2494 	rlc	a
   ABDD 24 0C              2495 	add	a,#_lnx_cal_vdda_dll_eom_sel
   ABDF F5 82              2496 	mov	dpl,a
   ABE1 E4                 2497 	clr	a
   ABE2 34 66              2498 	addc	a,#(_lnx_cal_vdda_dll_eom_sel >> 8)
   ABE4 F5 83              2499 	mov	dph,a
   ABE6 E0                 2500 	movx	a,@dptr
                           2501 ;	../../shared/src/dll_cal.c:203: set_sellv_rxeomdll_ch(val);
   ABE7 F5 82              2502 	mov	dpl,a
   ABE9 78 A5              2503 	mov	r0,#_set_sellv_rxeomdll_ch
   ABEB 79 AF              2504 	mov	r1,#(_set_sellv_rxeomdll_ch >> 8)
   ABED 7A 02              2505 	mov	r2,#(_set_sellv_rxeomdll_ch >> 16)
   ABEF 12 00 B3           2506 	lcall	__sdcc_banked_call
                           2507 ;	../../shared/src/dll_cal.c:204: goto skip_out; 
   ABF2 02 AD A0           2508 	ljmp	00139$
   ABF5                    2509 00102$:
                           2510 ;	../../shared/src/dll_cal.c:207: if( mode == DLL_VDDA_STEP ) {
   ABF5 E4                 2511 	clr	a
   ABF6 BA 01 01           2512 	cjne	r2,#0x01,00158$
   ABF9 04                 2513 	inc	a
   ABFA                    2514 00158$:
   ABFA FA                 2515 	mov	r2,a
   ABFB 60 11              2516 	jz	00104$
                           2517 ;	../../shared/src/dll_cal.c:208: DLL_PD_SEL = 0x03;  
   ABFD 90 00 20           2518 	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_8
   AC00 E0                 2519 	movx	a,@dptr
   AC01 44 0C              2520 	orl	a,#0x0c
   AC03 F0                 2521 	movx	@dptr,a
                           2522 ;	../../shared/src/dll_cal.c:209: cmp_out_dir = 1;  //1:dec, 0:inc
   AC04 A8 18              2523 	mov	r0,_bp
   AC06 08                 2524 	inc	r0
   AC07 76 01              2525 	mov	@r0,#0x01
   AC09 08                 2526 	inc	r0
   AC0A 76 00              2527 	mov	@r0,#0x00
   AC0C 80 11              2528 	sjmp	00105$
   AC0E                    2529 00104$:
                           2530 ;	../../shared/src/dll_cal.c:212: DLL_PD_SEL = 0x01;  
   AC0E 90 00 20           2531 	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_8
   AC11 E0                 2532 	movx	a,@dptr
   AC12 54 F3              2533 	anl	a,#0xf3
   AC14 44 04              2534 	orl	a,#0x04
   AC16 F0                 2535 	movx	@dptr,a
                           2536 ;	../../shared/src/dll_cal.c:213: cmp_out_dir = 0;  //0:dec, 1:inc
   AC17 A8 18              2537 	mov	r0,_bp
   AC19 08                 2538 	inc	r0
   AC1A 76 00              2539 	mov	@r0,#0x00
   AC1C 08                 2540 	inc	r0
   AC1D 76 00              2541 	mov	@r0,#0x00
   AC1F                    2542 00105$:
                           2543 ;	../../shared/src/dll_cal.c:216: if(lnx_DLL_SELLV_RXEOMDLL_FINAL_STEP_NUM_SEL_LANE_1_0 == 0x0) cnt_num = 16;
   AC1F 90 60 64           2544 	mov	dptr,#_DLL_CAL
   AC22 E0                 2545 	movx	a,@dptr
   AC23 54 03              2546 	anl	a,#0x03
   AC25 70 04              2547 	jnz	00113$
   AC27 7E 10              2548 	mov	r6,#0x10
   AC29 80 1E              2549 	sjmp	00114$
   AC2B                    2550 00113$:
                           2551 ;	../../shared/src/dll_cal.c:217: else if(lnx_DLL_SELLV_RXEOMDLL_FINAL_STEP_NUM_SEL_LANE_1_0 == 0x1) cnt_num = 24;
   AC2B 90 60 64           2552 	mov	dptr,#_DLL_CAL
   AC2E E0                 2553 	movx	a,@dptr
   AC2F 54 03              2554 	anl	a,#0x03
   AC31 FF                 2555 	mov	r7,a
   AC32 BF 01 04           2556 	cjne	r7,#0x01,00110$
   AC35 7E 18              2557 	mov	r6,#0x18
   AC37 80 10              2558 	sjmp	00114$
   AC39                    2559 00110$:
                           2560 ;	../../shared/src/dll_cal.c:218: else if(lnx_DLL_SELLV_RXEOMDLL_FINAL_STEP_NUM_SEL_LANE_1_0 == 0x2) cnt_num = 32;
   AC39 90 60 64           2561 	mov	dptr,#_DLL_CAL
   AC3C E0                 2562 	movx	a,@dptr
   AC3D 54 03              2563 	anl	a,#0x03
   AC3F FF                 2564 	mov	r7,a
   AC40 BF 02 04           2565 	cjne	r7,#0x02,00107$
   AC43 7E 20              2566 	mov	r6,#0x20
   AC45 80 02              2567 	sjmp	00114$
   AC47                    2568 00107$:
                           2569 ;	../../shared/src/dll_cal.c:219: else cnt_num = 48;
   AC47 7E 30              2570 	mov	r6,#0x30
   AC49                    2571 00114$:
                           2572 ;	../../shared/src/dll_cal.c:221: if( lnx_DLL_VDDA_TRACKING_ON_LANE==0 && mode == DLL_VDDA_STEP) { 
   AC49 90 60 0A           2573 	mov	dptr,#(_CAL_CTRL3_LANE + 0x0002)
   AC4C E0                 2574 	movx	a,@dptr
   AC4D 20 E5 47           2575 	jb	acc.5,00116$
   AC50 EA                 2576 	mov	a,r2
   AC51 60 44              2577 	jz	00116$
                           2578 ;	../../shared/src/dll_cal.c:242: VREF_RXDLL_SEL = get_vref_rxdll_sel(); 
   AC53 C0 02              2579 	push	ar2
   AC55 78 9B              2580 	mov	r0,#_get_vref_rxdll_sel
   AC57 79 A9              2581 	mov	r1,#(_get_vref_rxdll_sel >> 8)
   AC59 7A 01              2582 	mov	r2,#(_get_vref_rxdll_sel >> 16)
   AC5B 12 00 B3           2583 	lcall	__sdcc_banked_call
   AC5E AF 82              2584 	mov	r7,dpl
   AC60 90 82 20           2585 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_136
   AC63 EF                 2586 	mov	a,r7
   AC64 C4                 2587 	swap	a
   AC65 54 F0              2588 	anl	a,#(0xf0&0xf0)
   AC67 F5 F0              2589 	mov	b,a
   AC69 E0                 2590 	movx	a,@dptr
   AC6A 54 0F              2591 	anl	a,#0x0f
   AC6C 45 F0              2592 	orl	a,b
   AC6E F0                 2593 	movx	@dptr,a
                           2594 ;	../../shared/src/dll_cal.c:243: set_sellv_rxeomdll_ch(VREF_RXDLL_SEL*2 + 7);
   AC6F 90 82 20           2595 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_136
   AC72 E0                 2596 	movx	a,@dptr
   AC73 C4                 2597 	swap	a
   AC74 54 0F              2598 	anl	a,#0x0f
   AC76 25 E0              2599 	add	a,acc
   AC78 24 07              2600 	add	a,#0x07
   AC7A F5 82              2601 	mov	dpl,a
   AC7C 78 A5              2602 	mov	r0,#_set_sellv_rxeomdll_ch
   AC7E 79 AF              2603 	mov	r1,#(_set_sellv_rxeomdll_ch >> 8)
   AC80 7A 02              2604 	mov	r2,#(_set_sellv_rxeomdll_ch >> 16)
   AC82 12 00 B3           2605 	lcall	__sdcc_banked_call
                           2606 ;	../../shared/src/dll_cal.c:245: delay01(10);
   AC85 90 00 0A           2607 	mov	dptr,#0x000A
   AC88 78 16              2608 	mov	r0,#_delay01
   AC8A 79 BC              2609 	mov	r1,#(_delay01 >> 8)
   AC8C 7A 02              2610 	mov	r2,#(_delay01 >> 16)
   AC8E 12 00 B3           2611 	lcall	__sdcc_banked_call
   AC91 D0 02              2612 	pop	ar2
                           2613 ;	../../shared/src/dll_cal.c:246: loopcnt = 128;
   AC93 7C 80              2614 	mov	r4,#0x80
   AC95 80 2F              2615 	sjmp	00117$
   AC97                    2616 00116$:
                           2617 ;	../../shared/src/dll_cal.c:249: val = lnx_cal_vdda_dll_eom_sel[CONT][rx_pll_rate];
   AC97 A2 0E              2618 	mov	c,_rx_pll_rate
   AC99 E4                 2619 	clr	a
   AC9A 33                 2620 	rlc	a
   AC9B 24 0E              2621 	add	a,#(_lnx_cal_vdda_dll_eom_sel + 0x0002)
   AC9D F5 82              2622 	mov	dpl,a
   AC9F E4                 2623 	clr	a
   ACA0 34 66              2624 	addc	a,#((_lnx_cal_vdda_dll_eom_sel + 0x0002) >> 8)
   ACA2 F5 83              2625 	mov	dph,a
   ACA4 E0                 2626 	movx	a,@dptr
                           2627 ;	../../shared/src/dll_cal.c:250: set_sellv_rxeomdll_ch(val);
   ACA5 F5 82              2628 	mov	dpl,a
   ACA7 C0 02              2629 	push	ar2
   ACA9 C0 06              2630 	push	ar6
   ACAB 78 A5              2631 	mov	r0,#_set_sellv_rxeomdll_ch
   ACAD 79 AF              2632 	mov	r1,#(_set_sellv_rxeomdll_ch >> 8)
   ACAF 7A 02              2633 	mov	r2,#(_set_sellv_rxeomdll_ch >> 16)
   ACB1 12 00 B3           2634 	lcall	__sdcc_banked_call
                           2635 ;	../../shared/src/dll_cal.c:251: delay01(10);
   ACB4 90 00 0A           2636 	mov	dptr,#0x000A
   ACB7 78 16              2637 	mov	r0,#_delay01
   ACB9 79 BC              2638 	mov	r1,#(_delay01 >> 8)
   ACBB 7A 02              2639 	mov	r2,#(_delay01 >> 16)
   ACBD 12 00 B3           2640 	lcall	__sdcc_banked_call
   ACC0 D0 06              2641 	pop	ar6
   ACC2 D0 02              2642 	pop	ar2
                           2643 ;	../../shared/src/dll_cal.c:252: loopcnt = cnt_num;
   ACC4 8E 04              2644 	mov	ar4,r6
   ...
   ACC6 C0 02              2649 	push	ar2
   ACC8 C0 04              2650 	push	ar4
   ACCA 78 DA              2651 	mov	r0,#_get_sellv_rxeomdll_ch
   ACCC 79 AF              2652 	mov	r1,#(_get_sellv_rxeomdll_ch >> 8)
   ACCE 7A 02              2653 	mov	r2,#(_get_sellv_rxeomdll_ch >> 16)
   ACD0 12 00 B3           2654 	lcall	__sdcc_banked_call
   ACD3 AE 82              2655 	mov	r6,dpl
   ACD5 D0 04              2656 	pop	ar4
   ACD7 D0 02              2657 	pop	ar2
   ACD9 8E 03              2658 	mov	ar3,r6
                           2659 ;	../../shared/src/dll_cal.c:257: dir = DLL_CAL_CMP_OUT; cmpout = dir;
   ACDB 90 21 50           2660 	mov	dptr,#_RX_CALIBRATION_REG
   ACDE E0                 2661 	movx	a,@dptr
   ACDF 03                 2662 	rr	a
   ACE0 54 01              2663 	anl	a,#0x01
   ACE2 FE                 2664 	mov	r6,a
   ACE3 FF                 2665 	mov	r7,a
                           2666 ;	../../shared/src/dll_cal.c:258: do {
   ACE4 8C 05              2667 	mov	ar5,r4
   ACE6                    2668 00134$:
                           2669 ;	../../shared/src/dll_cal.c:260: if( cmpout == cmp_out_dir ) {
   ACE6 C0 06              2670 	push	ar6
   ACE8 8F 06              2671 	mov	ar6,r7
   ACEA 7C 00              2672 	mov	r4,#0x00
   ACEC A8 18              2673 	mov	r0,_bp
   ACEE 08                 2674 	inc	r0
   ACEF E6                 2675 	mov	a,@r0
   ACF0 B5 06 07           2676 	cjne	a,ar6,00168$
   ACF3 08                 2677 	inc	r0
   ACF4 E6                 2678 	mov	a,@r0
   ACF5 B5 04 02           2679 	cjne	a,ar4,00168$
   ACF8 80 04              2680 	sjmp	00169$
   ACFA                    2681 00168$:
   ACFA D0 06              2682 	pop	ar6
   ACFC 80 08              2683 	sjmp	00124$
   ACFE                    2684 00169$:
   ACFE D0 06              2685 	pop	ar6
                           2686 ;	../../shared/src/dll_cal.c:261: if( val>VDDA_EOM_MIN ) 	val--;
   AD00 EB                 2687 	mov	a,r3
   AD01 60 09              2688 	jz	00125$
   AD03 1B                 2689 	dec	r3
   AD04 80 06              2690 	sjmp	00125$
   AD06                    2691 00124$:
                           2692 ;	../../shared/src/dll_cal.c:264: if( val<VDDA_EOM_MAX ) 	val++;
   AD06 BB 2B 00           2693 	cjne	r3,#0x2B,00171$
   AD09                    2694 00171$:
   AD09 50 01              2695 	jnc	00125$
   AD0B 0B                 2696 	inc	r3
   AD0C                    2697 00125$:
                           2698 ;	../../shared/src/dll_cal.c:266: set_sellv_rxeomdll_ch(val);
   AD0C 8B 82              2699 	mov	dpl,r3
   AD0E C0 02              2700 	push	ar2
   AD10 C0 03              2701 	push	ar3
   AD12 C0 05              2702 	push	ar5
   AD14 C0 06              2703 	push	ar6
   AD16 78 A5              2704 	mov	r0,#_set_sellv_rxeomdll_ch
   AD18 79 AF              2705 	mov	r1,#(_set_sellv_rxeomdll_ch >> 8)
   AD1A 7A 02              2706 	mov	r2,#(_set_sellv_rxeomdll_ch >> 16)
   AD1C 12 00 B3           2707 	lcall	__sdcc_banked_call
   AD1F D0 06              2708 	pop	ar6
   AD21 D0 05              2709 	pop	ar5
   AD23 D0 03              2710 	pop	ar3
   AD25 D0 02              2711 	pop	ar2
                           2712 ;	../../shared/src/dll_cal.c:268: if( val==VDDA_EOM_MIN || val==VDDA_EOM_MAX )
   AD27 EB                 2713 	mov	a,r3
   AD28 60 03              2714 	jz	00126$
   AD2A BB 2B 09           2715 	cjne	r3,#0x2B,00127$
   AD2D                    2716 00126$:
                           2717 ;	../../shared/src/dll_cal.c:270: lnx_DLL_EOM_VDATA_CAL_PASS_LANE = 0;
   AD2D 90 60 04           2718 	mov	dptr,#_CAL_CTRL2_LANE
   AD30 E0                 2719 	movx	a,@dptr
   AD31 54 EF              2720 	anl	a,#0xef
   AD33 F0                 2721 	movx	@dptr,a
                           2722 ;	../../shared/src/dll_cal.c:271: break;
   AD34 80 43              2723 	sjmp	00136$
   AD36                    2724 00127$:
                           2725 ;	../../shared/src/dll_cal.c:274: if( lnx_DLL_VDDA_TRACKING_ON_LANE == 1 ) break;
   AD36 90 60 0A           2726 	mov	dptr,#(_CAL_CTRL3_LANE + 0x0002)
   AD39 E0                 2727 	movx	a,@dptr
   AD3A C4                 2728 	swap	a
   AD3B 03                 2729 	rr	a
   AD3C 54 01              2730 	anl	a,#0x01
   AD3E FC                 2731 	mov	r4,a
   AD3F BC 01 02           2732 	cjne	r4,#0x01,00176$
   AD42 80 35              2733 	sjmp	00136$
   AD44                    2734 00176$:
                           2735 ;	../../shared/src/dll_cal.c:276: delay01(10);
   AD44 90 00 0A           2736 	mov	dptr,#0x000A
   AD47 C0 02              2737 	push	ar2
   AD49 C0 03              2738 	push	ar3
   AD4B C0 05              2739 	push	ar5
   AD4D C0 06              2740 	push	ar6
   AD4F 78 16              2741 	mov	r0,#_delay01
   AD51 79 BC              2742 	mov	r1,#(_delay01 >> 8)
   AD53 7A 02              2743 	mov	r2,#(_delay01 >> 16)
   AD55 12 00 B3           2744 	lcall	__sdcc_banked_call
   AD58 D0 06              2745 	pop	ar6
   AD5A D0 05              2746 	pop	ar5
   AD5C D0 03              2747 	pop	ar3
   AD5E D0 02              2748 	pop	ar2
                           2749 ;	../../shared/src/dll_cal.c:277: cmpout = DLL_CAL_CMP_OUT;
   AD60 90 21 50           2750 	mov	dptr,#_RX_CALIBRATION_REG
   AD63 E0                 2751 	movx	a,@dptr
   AD64 03                 2752 	rr	a
   AD65 54 01              2753 	anl	a,#0x01
   AD67 FC                 2754 	mov	r4,a
   AD68 FF                 2755 	mov	r7,a
                           2756 ;	../../shared/src/dll_cal.c:278: if(mode == DLL_VDDA_STEP && dir != cmpout) break;
   AD69 EA                 2757 	mov	a,r2
   AD6A 60 04              2758 	jz	00135$
   AD6C EE                 2759 	mov	a,r6
   AD6D B5 07 09           2760 	cjne	a,ar7,00136$
   AD70                    2761 00135$:
                           2762 ;	../../shared/src/dll_cal.c:280: } while (loopcnt-->0);
   AD70 8D 04              2763 	mov	ar4,r5
   AD72 1D                 2764 	dec	r5
   AD73 EC                 2765 	mov	a,r4
   AD74 60 03              2766 	jz	00180$
   AD76 02 AC E6           2767 	ljmp	00134$
   AD79                    2768 00180$:
   AD79                    2769 00136$:
                           2770 ;	../../shared/src/dll_cal.c:282: if(lnx_DLL_VDDA_TRACKING_ON_LANE==0)
   AD79 90 60 0A           2771 	mov	dptr,#(_CAL_CTRL3_LANE + 0x0002)
   AD7C E0                 2772 	movx	a,@dptr
   AD7D 20 E5 10           2773 	jb	acc.5,00138$
                           2774 ;	../../shared/src/dll_cal.c:283: lnx_cal_vdda_dll_eom_sel[PWR][rx_pll_rate] = val;
   AD80 A2 0E              2775 	mov	c,_rx_pll_rate
   AD82 E4                 2776 	clr	a
   AD83 33                 2777 	rlc	a
   AD84 FA                 2778 	mov	r2,a
   AD85 24 0C              2779 	add	a,#_lnx_cal_vdda_dll_eom_sel
   AD87 F5 82              2780 	mov	dpl,a
   AD89 E4                 2781 	clr	a
   AD8A 34 66              2782 	addc	a,#(_lnx_cal_vdda_dll_eom_sel >> 8)
   AD8C F5 83              2783 	mov	dph,a
   AD8E EB                 2784 	mov	a,r3
   AD8F F0                 2785 	movx	@dptr,a
   AD90                    2786 00138$:
                           2787 ;	../../shared/src/dll_cal.c:284: lnx_cal_vdda_dll_eom_sel[CONT][rx_pll_rate] = val;
   AD90 A2 0E              2788 	mov	c,_rx_pll_rate
   AD92 E4                 2789 	clr	a
   AD93 33                 2790 	rlc	a
   AD94 FA                 2791 	mov	r2,a
   AD95 24 0E              2792 	add	a,#(_lnx_cal_vdda_dll_eom_sel + 0x0002)
   AD97 F5 82              2793 	mov	dpl,a
   AD99 E4                 2794 	clr	a
   AD9A 34 66              2795 	addc	a,#((_lnx_cal_vdda_dll_eom_sel + 0x0002) >> 8)
   AD9C F5 83              2796 	mov	dph,a
   AD9E EB                 2797 	mov	a,r3
   AD9F F0                 2798 	movx	@dptr,a
                           2799 ;	../../shared/src/dll_cal.c:287: skip_out:	
   ADA0                    2800 00139$:
                           2801 ;	../../shared/src/dll_cal.c:288: lnx_DLL_EOM_VDATA_CAL_DONE_LANE = 1;	
   ADA0 90 60 00           2802 	mov	dptr,#_CAL_CTRL1_LANE
   ADA3 E0                 2803 	movx	a,@dptr
   ADA4 44 10              2804 	orl	a,#0x10
   ADA6 F0                 2805 	movx	@dptr,a
   ADA7 85 18 81           2806 	mov	sp,_bp
   ADAA D0 18              2807 	pop	_bp
   ADAC 02 00 C5           2808 	ljmp	__sdcc_banked_ret
                           2809 	.area CSEG    (CODE)
