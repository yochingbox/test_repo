   ...
   0000                    1115 	.ds 8
                    ...
                    607C   1990 _sq_thrs_ratio_tb	=	0x607c
                           ...
                           2023 	.area CSEG    (CODE)
                           2024 ;------------------------------------------------------------
                           2025 ;Allocation info for local variables in function 'tx_train_PCIe'
                           2026 ;------------------------------------------------------------
                           2027 ;cnt                       Allocated to registers r3 
                           2028 ;i                         Allocated to registers r2 
                           2029 ;update                    Allocated to registers r2 
                           2030 ;fs                        Allocated to registers r2 
                           2031 ;------------------------------------------------------------
                           2032 ;	../../shared/src/tx_train_pcie.c:27: void tx_train_PCIe(void) {
                           2033 ;	-----------------------------------------
                           2034 ;	 function tx_train_PCIe
                           2035 ;	-----------------------------------------
   75EF                    2036 _tx_train_PCIe:
                    0002   2037 	ar2 = 0x02
                    0003   2038 	ar3 = 0x03
                    0004   2039 	ar4 = 0x04
                    0005   2040 	ar5 = 0x05
                    ...
                    0000   2043 	ar0 = 0x00
                    0001   2044 	ar1 = 0x01
                           2045 ;	../../shared/src/tx_train_pcie.c:31: pcie_f0b_en = 1;
   75EF 90 67 B2           2046 	mov	dptr,#_pcie_f0b_en
   75F2 74 01              2047 	mov	a,#0x01
   75F4 F0                 2048 	movx	@dptr,a
                           2049 ;	../../shared/src/tx_train_pcie.c:57: fs = reg_REMOTE_FS_LANE_5_0;
   75F5 90 40 24           2050 	mov	dptr,#_LANE_EQ_CFG0_LANE
   75F8 E0                 2051 	movx	a,@dptr
   75F9 54 3F              2052 	anl	a,#0x3f
   75FB FA                 2053 	mov	r2,a
                           2054 ;	../../shared/src/tx_train_pcie.c:58: if( fs <= 31 ) cnt = 1;  //3
   75FC 74 1F              2055 	mov	a,#0x1F
   75FE B5 02 00           2056 	cjne	a,ar2,00167$
   7601                    2057 00167$:
   7601 40 04              2058 	jc	00111$
   7603 7B 01              2059 	mov	r3,#0x01
   7605 80 23              2060 	sjmp	00112$
   7607                    2061 00111$:
                           2062 ;	../../shared/src/tx_train_pcie.c:59: else if( fs <= 40 ) cnt = 2;  //4
   7607 74 28              2063 	mov	a,#0x28
   7609 B5 02 00           2064 	cjne	a,ar2,00169$
   760C                    2065 00169$:
   760C 40 04              2066 	jc	00108$
   760E 7B 02              2067 	mov	r3,#0x02
   7610 80 18              2068 	sjmp	00112$
   7612                    2069 00108$:
                           2070 ;	../../shared/src/tx_train_pcie.c:60: else if( fs <= 49 ) cnt = 3;  //5
   7612 74 31              2071 	mov	a,#0x31
   7614 B5 02 00           2072 	cjne	a,ar2,00171$
   7617                    2073 00171$:
   7617 40 04              2074 	jc	00105$
   7619 7B 03              2075 	mov	r3,#0x03
   761B 80 0D              2076 	sjmp	00112$
   761D                    2077 00105$:
                           2078 ;	../../shared/src/tx_train_pcie.c:61: else if( fs <= 58 ) cnt = 4;  //6
   761D 74 3A              2079 	mov	a,#0x3A
   761F B5 02 00           2080 	cjne	a,ar2,00173$
   7622                    2081 00173$:
   7622 40 04              2082 	jc	00102$
   7624 7B 04              2083 	mov	r3,#0x04
   7626 80 02              2084 	sjmp	00112$
   7628                    2085 00102$:
                           2086 ;	../../shared/src/tx_train_pcie.c:62: else cnt = 5;  //7
   7628 7B 05              2087 	mov	r3,#0x05
   762A                    2088 00112$:
                           2089 ;	../../shared/src/tx_train_pcie.c:64: cnt++;
   762A 0B                 2090 	inc	r3
                           2091 ;	../../shared/src/tx_train_pcie.c:65: while( cnt-->0 ) {
   762B 8B 02              2092 	mov	ar2,r3
   762D                    2093 00115$:
   762D 8A 04              2094 	mov	ar4,r2
   762F 1A                 2095 	dec	r2
   7630 C3                 2096 	clr	c
   7631 74 80              2097 	mov	a,#(0x00 ^ 0x80)
   7633 8C F0              2098 	mov	b,r4
   7635 63 F0 80           2099 	xrl	b,#0x80
   7638 95 F0              2100 	subb	a,b
   763A 50 44              2101 	jnc	00117$
                           2102 ;	../../shared/src/tx_train_pcie.c:66: req_local_ctrl(CE_NORMAL, 0, tag_TX_TRAIN_P2P_HOLD, 2);
   763C 90 67 A0           2103 	mov	dptr,#_tx_train_p2p_hold
   763F E0                 2104 	movx	a,@dptr
   7640 FC                 2105 	mov	r4,a
   7641 E4                 2106 	clr	a
   7642 CC                 2107 	xch	a,r4
   7643 25 E0              2108 	add	a,acc
   7645 CC                 2109 	xch	a,r4
   7646 33                 2110 	rlc	a
   7647 CC                 2111 	xch	a,r4
   7648 25 E0              2112 	add	a,acc
   764A CC                 2113 	xch	a,r4
   764B 33                 2114 	rlc	a
   764C FD                 2115 	mov	r5,a
   764D 74 02              2116 	mov	a,#0x02
   764F 4C                 2117 	orl	a,r4
   7650 F5 82              2118 	mov	dpl,a
   7652 8D 83              2119 	mov	dph,r5
   7654 C0 02              2120 	push	ar2
   7656 78 74              2121 	mov	r0,#_Send_ctrl_to_tx
   7658 79 E5              2122 	mov	r1,#(_Send_ctrl_to_tx >> 8)
   765A 7A 01              2123 	mov	r2,#(_Send_ctrl_to_tx >> 16)
   765C 12 00 B3           2124 	lcall	__sdcc_banked_call
   765F D0 02              2125 	pop	ar2
                           2126 ;	../../shared/src/tx_train_pcie.c:67: train_gn1_index--;
   7661 90 60 30           2127 	mov	dptr,#_train_gn1_index
   7664 E0                 2128 	movx	a,@dptr
   7665 14                 2129 	dec	a
   7666 90 60 30           2130 	mov	dptr,#_train_gn1_index
   7669 F0                 2131 	movx	@dptr,a
                           2132 ;	../../shared/src/tx_train_pcie.c:68: train_g0_index -= tag_TX_TRAIN_P2P_HOLD;
   766A 90 67 A0           2133 	mov	dptr,#_tx_train_p2p_hold
   766D E0                 2134 	movx	a,@dptr
   766E FC                 2135 	mov	r4,a
   766F 90 60 32           2136 	mov	dptr,#_train_g0_index
   7672 E0                 2137 	movx	a,@dptr
   7673 FD                 2138 	mov	r5,a
   7674 90 60 32           2139 	mov	dptr,#_train_g0_index
   7677 C3                 2140 	clr	c
   7678 9C                 2141 	subb	a,r4
   7679 F0                 2142 	movx	@dptr,a
                           2143 ;	../../shared/src/tx_train_pcie.c:69: if(tx.gn1_is_min) break;
   767A 90 66 A6           2144 	mov	dptr,#(_tx + 0x0008)
   767D E0                 2145 	movx	a,@dptr
   767E 60 AD              2146 	jz	00115$
   7680                    2147 00117$:
                           2148 ;	../../shared/src/tx_train_pcie.c:72: dfe_cdr_phase_opt();
   7680 12 59 ED           2149 	lcall	_dfe_cdr_phase_opt
                           2150 ;	../../shared/src/tx_train_pcie.c:74: train2opt();
   7683 12 5C 2F           2151 	lcall	_train2opt
                           2152 ;	../../shared/src/tx_train_pcie.c:76: reg_MCU_DEBUGC_LANE_7_0 = (uint8_t)train.fn1;
   7686 90 66 5D           2153 	mov	dptr,#(_train + 0x001d)
   7689 E0                 2154 	movx	a,@dptr
   768A FA                 2155 	mov	r2,a
   768B 90 22 C0           2156 	mov	dptr,#_MCU_DEBUG3_LANE
   768E F0                 2157 	movx	@dptr,a
                           2158 ;	../../shared/src/tx_train_pcie.c:77: reg_MCU_DEBUGF_LANE_7_0 = 0xaa;
   768F 90 22 C3           2159 	mov	dptr,#(_MCU_DEBUG3_LANE + 0x0003)
   7692 74 AA              2160 	mov	a,#0xAA
   7694 F0                 2161 	movx	@dptr,a
                           2162 ;	../../shared/src/tx_train_pcie.c:79: if(train.fn1 <= tag_PCIE_GN1_FN1_THRE && !train.saturated) {
   7695 90 60 92           2163 	mov	dptr,#(_DFE_CONTROL_8 + 0x0002)
   7698 E0                 2164 	movx	a,@dptr
   7699 FC                 2165 	mov	r4,a
   769A B5 02 00           2166 	cjne	a,ar2,00177$
   769D                    2167 00177$:
   769D 40 0C              2168 	jc	00156$
   769F 90 66 68           2169 	mov	dptr,#(_train + 0x0028)
   76A2 E0                 2170 	movx	a,@dptr
   76A3 70 06              2171 	jnz	00156$
                           2172 ;	../../shared/src/tx_train_pcie.c:80: pcie_f0b_en = 0;
   76A5 90 67 B2           2173 	mov	dptr,#_pcie_f0b_en
   76A8 E4                 2174 	clr	a
   76A9 F0                 2175 	movx	@dptr,a
                           2176 ;	../../shared/src/tx_train_pcie.c:81: return;
   76AA 22                 2177 	ret
                           2178 ;	../../shared/src/tx_train_pcie.c:84: for(i=0; i<tag_PCIE_GN1_STEP_NUM; i++) {
   76AB                    2179 00156$:
   76AB 7A 00              2180 	mov	r2,#0x00
   76AD                    2181 00126$:
   76AD 90 60 93           2182 	mov	dptr,#(_DFE_CONTROL_8 + 0x0003)
   76B0 E0                 2183 	movx	a,@dptr
   76B1 FC                 2184 	mov	r4,a
   76B2 8A 05              2185 	mov	ar5,r2
   76B4 ED                 2186 	mov	a,r5
   76B5 B5 04 00           2187 	cjne	a,ar4,00180$
   76B8                    2188 00180$:
   76B8 50 64              2189 	jnc	00129$
                           2190 ;	../../shared/src/tx_train_pcie.c:85: req_local_ctrl(CE_NORMAL, 0, tag_TX_TRAIN_P2P_HOLD, 2);
   76BA 90 67 A0           2191 	mov	dptr,#_tx_train_p2p_hold
   76BD E0                 2192 	movx	a,@dptr
   76BE FC                 2193 	mov	r4,a
   76BF E4                 2194 	clr	a
   76C0 CC                 2195 	xch	a,r4
   76C1 25 E0              2196 	add	a,acc
   76C3 CC                 2197 	xch	a,r4
   76C4 33                 2198 	rlc	a
   76C5 CC                 2199 	xch	a,r4
   76C6 25 E0              2200 	add	a,acc
   76C8 CC                 2201 	xch	a,r4
   76C9 33                 2202 	rlc	a
   76CA FD                 2203 	mov	r5,a
   76CB 74 02              2204 	mov	a,#0x02
   76CD 4C                 2205 	orl	a,r4
   76CE F5 82              2206 	mov	dpl,a
   76D0 8D 83              2207 	mov	dph,r5
   76D2 C0 02              2208 	push	ar2
   76D4 78 74              2209 	mov	r0,#_Send_ctrl_to_tx
   76D6 79 E5              2210 	mov	r1,#(_Send_ctrl_to_tx >> 8)
   76D8 7A 01              2211 	mov	r2,#(_Send_ctrl_to_tx >> 16)
   76DA 12 00 B3           2212 	lcall	__sdcc_banked_call
                           2213 ;	../../shared/src/tx_train_pcie.c:86: train_gn1_index--;
   76DD 90 60 30           2214 	mov	dptr,#_train_gn1_index
   76E0 E0                 2215 	movx	a,@dptr
   76E1 14                 2216 	dec	a
   76E2 90 60 30           2217 	mov	dptr,#_train_gn1_index
   76E5 F0                 2218 	movx	@dptr,a
                           2219 ;	../../shared/src/tx_train_pcie.c:87: train_g0_index -= tag_TX_TRAIN_P2P_HOLD;
   76E6 90 67 A0           2220 	mov	dptr,#_tx_train_p2p_hold
   76E9 E0                 2221 	movx	a,@dptr
   76EA FC                 2222 	mov	r4,a
   76EB 90 60 32           2223 	mov	dptr,#_train_g0_index
   76EE E0                 2224 	movx	a,@dptr
   76EF 90 60 32           2225 	mov	dptr,#_train_g0_index
   76F2 C3                 2226 	clr	c
   76F3 9C                 2227 	subb	a,r4
   76F4 F0                 2228 	movx	@dptr,a
                           2229 ;	../../shared/src/tx_train_pcie.c:88: dfe_cdr_phase_opt();
   76F5 12 59 ED           2230 	lcall	_dfe_cdr_phase_opt
                           2231 ;	../../shared/src/tx_train_pcie.c:89: compare_g1n1(0);
   76F8 75 82 00           2232 	mov	dpl,#0x00
   76FB 12 6D A6           2233 	lcall	_compare_g1n1
   76FE D0 02              2234 	pop	ar2
                           2235 ;	../../shared/src/tx_train_pcie.c:90: if(train.fn1 <= tag_PCIE_GN1_FN1_THRE && !train.saturated) break;
   7700 90 66 5D           2236 	mov	dptr,#(_train + 0x001d)
   7703 E0                 2237 	movx	a,@dptr
   7704 FC                 2238 	mov	r4,a
   7705 90 60 92           2239 	mov	dptr,#(_DFE_CONTROL_8 + 0x0002)
   7708 E0                 2240 	movx	a,@dptr
   7709 FD                 2241 	mov	r5,a
   770A B5 04 00           2242 	cjne	a,ar4,00182$
   770D                    2243 00182$:
   770D 40 06              2244 	jc	00122$
   770F 90 66 68           2245 	mov	dptr,#(_train + 0x0028)
   7712 E0                 2246 	movx	a,@dptr
   7713 60 09              2247 	jz	00129$
   7715                    2248 00122$:
                           2249 ;	../../shared/src/tx_train_pcie.c:91: if(tx.gn1_is_min) break;
   7715 90 66 A6           2250 	mov	dptr,#(_tx + 0x0008)
   7718 E0                 2251 	movx	a,@dptr
   7719 70 03              2252 	jnz	00129$
                           2253 ;	../../shared/src/tx_train_pcie.c:84: for(i=0; i<tag_PCIE_GN1_STEP_NUM; i++) {
   771B 0A                 2254 	inc	r2
   771C 80 8F              2255 	sjmp	00126$
   771E                    2256 00129$:
                           2257 ;	../../shared/src/tx_train_pcie.c:94: reg_MCU_DEBUGC_LANE_7_0 = (uint8_t)train.fn1;
   771E 90 66 5D           2258 	mov	dptr,#(_train + 0x001d)
   7721 E0                 2259 	movx	a,@dptr
   7722 90 22 C0           2260 	mov	dptr,#_MCU_DEBUG3_LANE
   7725 F0                 2261 	movx	@dptr,a
                           2262 ;	../../shared/src/tx_train_pcie.c:95: reg_MCU_DEBUGF_LANE_7_0 = i;
   7726 90 22 C3           2263 	mov	dptr,#(_MCU_DEBUG3_LANE + 0x0003)
   7729 EA                 2264 	mov	a,r2
   772A F0                 2265 	movx	@dptr,a
                           2266 ;	../../shared/src/tx_train_pcie.c:97: update = opt_gn1_index - train_gn1_index;
   772B 90 60 30           2267 	mov	dptr,#_train_gn1_index
   772E E0                 2268 	movx	a,@dptr
   772F FA                 2269 	mov	r2,a
   7730 90 67 B4           2270 	mov	dptr,#_opt_gn1_index
   7733 E0                 2271 	movx	a,@dptr
   7734 FC                 2272 	mov	r4,a
   7735 C3                 2273 	clr	c
   7736 9A                 2274 	subb	a,r2
                           2275 ;	../../shared/src/tx_train_pcie.c:98: reg_MCU_DEBUGB_LANE_7_0 = (uint8_t)update;
   7737 FA                 2276 	mov	r2,a
   7738 90 22 BF           2277 	mov	dptr,#(_MCU_DEBUG2_LANE + 0x0003)
   773B F0                 2278 	movx	@dptr,a
                           2279 ;	../../shared/src/tx_train_pcie.c:100: if( update!=0 ) {
   773C EA                 2280 	mov	a,r2
   773D 70 03              2281 	jnz	00186$
   773F 02 77 FF           2282 	ljmp	00142$
   7742                    2283 00186$:
                           2284 ;	../../shared/src/tx_train_pcie.c:101: cnt = tag_PCIE_GN1_STEP_NUM;
   7742 90 60 93           2285 	mov	dptr,#(_DFE_CONTROL_8 + 0x0003)
   7745 E0                 2286 	movx	a,@dptr
   7746 FC                 2287 	mov	r4,a
   7747 FB                 2288 	mov	r3,a
                           2289 ;	../../shared/src/tx_train_pcie.c:102: while (cnt-->0) {
   7748                    2290 00138$:
   7748 8B 04              2291 	mov	ar4,r3
   774A 1B                 2292 	dec	r3
   774B C3                 2293 	clr	c
   774C 74 80              2294 	mov	a,#(0x00 ^ 0x80)
   774E 8C F0              2295 	mov	b,r4
   7750 63 F0 80           2296 	xrl	b,#0x80
   7753 95 F0              2297 	subb	a,b
   7755 40 03              2298 	jc	00187$
   7757 02 77 FF           2299 	ljmp	00142$
   775A                    2300 00187$:
                           2301 ;	../../shared/src/tx_train_pcie.c:103: if(update > 0 && tx.gn1_is_max==0) {
   775A C3                 2302 	clr	c
   775B 74 80              2303 	mov	a,#(0x00 ^ 0x80)
   775D 8A F0              2304 	mov	b,r2
   775F 63 F0 80           2305 	xrl	b,#0x80
   7762 95 F0              2306 	subb	a,b
   7764 50 49              2307 	jnc	00135$
   7766 90 66 A5           2308 	mov	dptr,#(_tx + 0x0007)
   7769 E0                 2309 	movx	a,@dptr
   776A 70 43              2310 	jnz	00135$
                           2311 ;	../../shared/src/tx_train_pcie.c:104: req_local_ctrl(CE_NORMAL, 0, tag_TX_TRAIN_P2P_HOLD, 1);
   776C 90 67 A0           2312 	mov	dptr,#_tx_train_p2p_hold
   776F E0                 2313 	movx	a,@dptr
   7770 FC                 2314 	mov	r4,a
   7771 E4                 2315 	clr	a
   7772 CC                 2316 	xch	a,r4
   7773 25 E0              2317 	add	a,acc
   7775 CC                 2318 	xch	a,r4
   7776 33                 2319 	rlc	a
   7777 CC                 2320 	xch	a,r4
   7778 25 E0              2321 	add	a,acc
   777A CC                 2322 	xch	a,r4
   777B 33                 2323 	rlc	a
   777C FD                 2324 	mov	r5,a
   777D 74 01              2325 	mov	a,#0x01
   777F 4C                 2326 	orl	a,r4
   7780 F5 82              2327 	mov	dpl,a
   7782 8D 83              2328 	mov	dph,r5
   7784 C0 02              2329 	push	ar2
   7786 C0 03              2330 	push	ar3
   7788 78 74              2331 	mov	r0,#_Send_ctrl_to_tx
   778A 79 E5              2332 	mov	r1,#(_Send_ctrl_to_tx >> 8)
   778C 7A 01              2333 	mov	r2,#(_Send_ctrl_to_tx >> 16)
   778E 12 00 B3           2334 	lcall	__sdcc_banked_call
   7791 D0 03              2335 	pop	ar3
   7793 D0 02              2336 	pop	ar2
                           2337 ;	../../shared/src/tx_train_pcie.c:105: train_gn1_index ++;
   7795 90 60 30           2338 	mov	dptr,#_train_gn1_index
   7798 E0                 2339 	movx	a,@dptr
   7799 24 01              2340 	add	a,#0x01
   779B F0                 2341 	movx	@dptr,a
                           2342 ;	../../shared/src/tx_train_pcie.c:106: train_g0_index += tag_TX_TRAIN_P2P_HOLD;
   779C 90 67 A0           2343 	mov	dptr,#_tx_train_p2p_hold
   779F E0                 2344 	movx	a,@dptr
   77A0 FC                 2345 	mov	r4,a
   77A1 90 60 32           2346 	mov	dptr,#_train_g0_index
   77A4 E0                 2347 	movx	a,@dptr
   77A5 FD                 2348 	mov	r5,a
   77A6 90 60 32           2349 	mov	dptr,#_train_g0_index
   77A9 EC                 2350 	mov	a,r4
   77AA 2D                 2351 	add	a,r5
   77AB F0                 2352 	movx	@dptr,a
                           2353 ;	../../shared/src/tx_train_pcie.c:107: update--;
   77AC 1A                 2354 	dec	r2
   77AD 80 99              2355 	sjmp	00138$
   77AF                    2356 00135$:
                           2357 ;	../../shared/src/tx_train_pcie.c:109: else if(update < 0 && tx.gn1_is_min==0) {
   77AF EA                 2358 	mov	a,r2
   77B0 30 E7 4C           2359 	jnb	acc.7,00142$
   77B3 90 66 A6           2360 	mov	dptr,#(_tx + 0x0008)
   77B6 E0                 2361 	movx	a,@dptr
   77B7 70 46              2362 	jnz	00142$
                           2363 ;	../../shared/src/tx_train_pcie.c:110: req_local_ctrl(CE_NORMAL, 0, tag_TX_TRAIN_P2P_HOLD, 2);
   77B9 90 67 A0           2364 	mov	dptr,#_tx_train_p2p_hold
   77BC E0                 2365 	movx	a,@dptr
   77BD FC                 2366 	mov	r4,a
   77BE E4                 2367 	clr	a
   77BF CC                 2368 	xch	a,r4
   77C0 25 E0              2369 	add	a,acc
   77C2 CC                 2370 	xch	a,r4
   77C3 33                 2371 	rlc	a
   77C4 CC                 2372 	xch	a,r4
   77C5 25 E0              2373 	add	a,acc
   77C7 CC                 2374 	xch	a,r4
   77C8 33                 2375 	rlc	a
   77C9 FD                 2376 	mov	r5,a
   77CA 74 02              2377 	mov	a,#0x02
   77CC 4C                 2378 	orl	a,r4
   77CD F5 82              2379 	mov	dpl,a
   77CF 8D 83              2380 	mov	dph,r5
   77D1 C0 02              2381 	push	ar2
   77D3 C0 03              2382 	push	ar3
   77D5 78 74              2383 	mov	r0,#_Send_ctrl_to_tx
   77D7 79 E5              2384 	mov	r1,#(_Send_ctrl_to_tx >> 8)
   77D9 7A 01              2385 	mov	r2,#(_Send_ctrl_to_tx >> 16)
   77DB 12 00 B3           2386 	lcall	__sdcc_banked_call
   77DE D0 03              2387 	pop	ar3
   77E0 D0 02              2388 	pop	ar2
                           2389 ;	../../shared/src/tx_train_pcie.c:111: train_gn1_index--;
   77E2 90 60 30           2390 	mov	dptr,#_train_gn1_index
   77E5 E0                 2391 	movx	a,@dptr
   77E6 14                 2392 	dec	a
   77E7 90 60 30           2393 	mov	dptr,#_train_gn1_index
   77EA F0                 2394 	movx	@dptr,a
                           2395 ;	../../shared/src/tx_train_pcie.c:112: train_g0_index -= tag_TX_TRAIN_P2P_HOLD;
   77EB 90 67 A0           2396 	mov	dptr,#_tx_train_p2p_hold
   77EE E0                 2397 	movx	a,@dptr
   77EF FC                 2398 	mov	r4,a
   77F0 90 60 32           2399 	mov	dptr,#_train_g0_index
   77F3 E0                 2400 	movx	a,@dptr
   77F4 FD                 2401 	mov	r5,a
   77F5 90 60 32           2402 	mov	dptr,#_train_g0_index
   77F8 C3                 2403 	clr	c
   77F9 9C                 2404 	subb	a,r4
   77FA F0                 2405 	movx	@dptr,a
                           2406 ;	../../shared/src/tx_train_pcie.c:113: update++;
   77FB 0A                 2407 	inc	r2
                           2408 ;	../../shared/src/tx_train_pcie.c:115: else break;
   77FC 02 77 48           2409 	ljmp	00138$
   77FF                    2410 00142$:
                           2411 ;	../../shared/src/tx_train_pcie.c:119: pcie_f0b_en = 0;
   77FF 90 67 B2           2412 	mov	dptr,#_pcie_f0b_en
   7802 E4                 2413 	clr	a
   7803 F0                 2414 	movx	@dptr,a
   7804 22                 2415 	ret
                           2416 	.area CSEG    (CODE)
                           2417 	.area CONST   (CODE)
                           2418 	.area CABS    (ABS,CODE)
