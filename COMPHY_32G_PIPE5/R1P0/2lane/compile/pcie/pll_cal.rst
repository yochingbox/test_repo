   ...
   C061 90 22 30           2047 	mov	dptr,#_MCU_STATUS0_LANE
   C064 74 05              2048 	mov	a,#0x05
   C066 F0                 2049 	movx	@dptr,a
                           2050 ;	../../shared/src/pll_cal.c:114: cmx_PLL_CAL_DONE = 0;
   C067 90 E6 4E           2051 	mov	dptr,#(_CAL_STATUS_READ + 0x0002)
   C06A E0                 2052 	movx	a,@dptr
   C06B 54 FE              2053 	anl	a,#0xfe
   C06D F0                 2054 	movx	@dptr,a
                           2055 ;	../../shared/src/pll_cal.c:116: if( cmx_PLL_CAL_EXT_EN /*|| (phy_mode==PCIE && cmx_PLL_CAL_PASS)*/) { //PCIe Link enable/disable test patch
   C06E 90 E6 09           2056 	mov	dptr,#(_CONTROL_CONFIG1 + 0x0001)
   C071 E0                 2057 	movx	a,@dptr
   C072 30 E2 0F           2058 	jnb	acc.2,00104$
                           2059 ;	../../shared/src/pll_cal.c:117: pllcal_load(PWR);		
   C075 75 82 00           2060 	mov	dpl,#0x00
   C078 78 BD              2061 	mov	r0,#_pllcal_load
   C07A 79 C7              2062 	mov	r1,#(_pllcal_load >> 8)
   C07C 7A 02              2063 	mov	r2,#(_pllcal_load >> 16)
   C07E 12 00 B3           2064 	lcall	__sdcc_banked_call
   C081 02 C1 19           2065 	ljmp	00105$
   C084                    2066 00104$:
                           2067 ;	../../shared/src/pll_cal.c:120: save_FBDIV_h = reg_FBDIV_9_8;
   C084 90 82 A0           2068 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_168
   C087 E0                 2069 	movx	a,@dptr
   C088 C4                 2070 	swap	a
   C089 54 03              2071 	anl	a,#0x03
   C08B FA                 2072 	mov	r2,a
                           2073 ;	../../shared/src/pll_cal.c:121: save_FBDIV_l = reg_FBDIV_7_0;
   C08C 90 82 A4           2074 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_169
   C08F E0                 2075 	movx	a,@dptr
   C090 FB                 2076 	mov	r3,a
                           2077 ;	../../shared/src/pll_cal.c:122: save_FBCK_SEL = reg_ANA_FBCK_SEL;
   C091 90 A3 19           2078 	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
   C094 E0                 2079 	movx	a,@dptr
   C095 03                 2080 	rr	a
   C096 54 01              2081 	anl	a,#0x01
   C098 FC                 2082 	mov	r4,a
                           2083 ;	../../shared/src/pll_cal.c:124: PLLCAL_EN = 1;	
   C099 90 82 A0           2084 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_168
   C09C E0                 2085 	movx	a,@dptr
   C09D 44 80              2086 	orl	a,#0x80
   C09F F0                 2087 	movx	@dptr,a
                           2088 ;	../../shared/src/pll_cal.c:125: reg_FBC_CNT_START = 0;
   C0A0 90 A3 30           2089 	mov	dptr,#_PLLCAL_REG1
   C0A3 E0                 2090 	movx	a,@dptr
   C0A4 54 FE              2091 	anl	a,#0xfe
   C0A6 F0                 2092 	movx	@dptr,a
                           2093 ;	../../shared/src/pll_cal.c:126: loadSpdtbl_4_fcnt();
   C0A7 C0 02              2094 	push	ar2
   C0A9 C0 03              2095 	push	ar3
   C0AB C0 04              2096 	push	ar4
   C0AD 12 4D 79           2097 	lcall	_loadSpdtbl_4_fcnt
                           2098 ;	../../shared/src/pll_cal.c:128: pll_cal_loop();
   C0B0 78 81              2099 	mov	r0,#_pll_cal_loop
   C0B2 79 C2              2100 	mov	r1,#(_pll_cal_loop >> 8)
   C0B4 7A 02              2101 	mov	r2,#(_pll_cal_loop >> 16)
   C0B6 12 00 B3           2102 	lcall	__sdcc_banked_call
   C0B9 D0 04              2103 	pop	ar4
   C0BB D0 03              2104 	pop	ar3
   C0BD D0 02              2105 	pop	ar2
                           2106 ;	../../shared/src/pll_cal.c:130: reg_FBDIV_9_8 = save_FBDIV_h;
   C0BF 90 82 A0           2107 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_168
   C0C2 EA                 2108 	mov	a,r2
   C0C3 C4                 2109 	swap	a
   C0C4 54 30              2110 	anl	a,#(0xf0&0x30)
   C0C6 F5 F0              2111 	mov	b,a
   C0C8 E0                 2112 	movx	a,@dptr
   C0C9 54 CF              2113 	anl	a,#0xcf
   C0CB 45 F0              2114 	orl	a,b
   C0CD F0                 2115 	movx	@dptr,a
                           2116 ;	../../shared/src/pll_cal.c:131: reg_FBDIV_7_0 = save_FBDIV_l;
   C0CE 90 82 A4           2117 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_169
   C0D1 EB                 2118 	mov	a,r3
   C0D2 F0                 2119 	movx	@dptr,a
                           2120 ;	../../shared/src/pll_cal.c:132: reg_ANA_FBCK_SEL = save_FBCK_SEL;
   C0D3 90 A3 19           2121 	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
   C0D6 EC                 2122 	mov	a,r4
   C0D7 13                 2123 	rrc	a
   C0D8 E0                 2124 	movx	a,@dptr
   C0D9 92 E1              2125 	mov	acc.1,c
   C0DB F0                 2126 	movx	@dptr,a
                           2127 ;	../../shared/src/pll_cal.c:134: VCOAMP_VTH_SEL = TH_NORMAL;
   C0DC 90 E6 15           2128 	mov	dptr,#(_CONTROL_CONFIG4 + 0x0001)
   C0DF E0                 2129 	movx	a,@dptr
   C0E0 FA                 2130 	mov	r2,a
   C0E1 90 82 C8           2131 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_178
   C0E4 54 0F              2132 	anl	a,#0x0f
   C0E6 F5 F0              2133 	mov	b,a
   C0E8 E0                 2134 	movx	a,@dptr
   C0E9 54 F0              2135 	anl	a,#0xf0
   C0EB 45 F0              2136 	orl	a,b
   C0ED F0                 2137 	movx	@dptr,a
                           2138 ;	../../shared/src/pll_cal.c:135: PLLCAL_EN = 0;
   C0EE 90 82 A0           2139 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_168
   C0F1 E0                 2140 	movx	a,@dptr
   C0F2 54 7F              2141 	anl	a,#0x7f
   C0F4 F0                 2142 	movx	@dptr,a
                           2143 ;	../../shared/src/pll_cal.c:136: PLLAMPCAL_EN = 0;
   C0F5 90 82 A0           2144 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_168
   C0F8 E0                 2145 	movx	a,@dptr
   C0F9 54 BF              2146 	anl	a,#0xbf
   C0FB F0                 2147 	movx	@dptr,a
                           2148 ;	../../shared/src/pll_cal.c:137: reg_LCVCOCAL_BUF_EN = 0;
   C0FC 90 82 D0           2149 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_180
   C0FF E0                 2150 	movx	a,@dptr
   C100 54 FD              2151 	anl	a,#0xfd
   C102 F0                 2152 	movx	@dptr,a
                           2153 ;	../../shared/src/pll_cal.c:141: if(timeout) {
   C103 30 03 13           2154 	jnb	_timeout,00105$
                           2155 ;	../../shared/src/pll_cal.c:142: cmx_PLL_CAL_PASS = 0;
   C106 90 E6 4C           2156 	mov	dptr,#_CAL_STATUS_READ
   C109 E0                 2157 	movx	a,@dptr
   C10A 54 BF              2158 	anl	a,#0xbf
   C10C F0                 2159 	movx	@dptr,a
                           2160 ;	../../shared/src/pll_cal.c:143: pllcal_load(PWR);
   C10D 75 82 00           2161 	mov	dpl,#0x00
   C110 78 BD              2162 	mov	r0,#_pllcal_load
   C112 79 C7              2163 	mov	r1,#(_pllcal_load >> 8)
   C114 7A 02              2164 	mov	r2,#(_pllcal_load >> 16)
   C116 12 00 B3           2165 	lcall	__sdcc_banked_call
   C119                    2166 00105$:
                           2167 ;	../../shared/src/pll_cal.c:147: cmx_PLL_CAL_TIMEOUT_DIS = pll_cal_timeout_dis_save;
   C119 90 67 B6           2168 	mov	dptr,#_pll_cal_timeout_dis_save
   C11C E0                 2169 	movx	a,@dptr
   C11D 90 E6 49           2170 	mov	dptr,#(_CAL_TIME_OUT_AND_DIS + 0x0001)
   C120 13                 2171 	rrc	a
   C121 E0                 2172 	movx	a,@dptr
   C122 92 E1              2173 	mov	acc.1,c
   C124 F0                 2174 	movx	@dptr,a
                           2175 ;	../../shared/src/pll_cal.c:148: pllamp_step_cnt = cmx_PLLAMP_CAL_STEP_SIZE_7_0;
   C125 90 E6 3D           2176 	mov	dptr,#(_CON_CAL_STEP_SIZE3 + 0x0001)
   C128 E0                 2177 	movx	a,@dptr
   C129 90 66 0E           2178 	mov	dptr,#_pllamp_step_cnt
   C12C F0                 2179 	movx	@dptr,a
                           2180 ;	../../shared/src/pll_cal.c:149: pllcal_save(CONT);
   C12D 75 82 01           2181 	mov	dpl,#0x01
   C130 78 9D              2182 	mov	r0,#_pllcal_save
   C132 79 C8              2183 	mov	r1,#(_pllcal_save >> 8)
   C134 7A 02              2184 	mov	r2,#(_pllcal_save >> 16)
   C136 12 00 B3           2185 	lcall	__sdcc_banked_call
                           2186 ;	../../shared/src/pll_cal.c:150: cmx_PLL_CAL_DONE = 1;
   C139 90 E6 4E           2187 	mov	dptr,#(_CAL_STATUS_READ + 0x0002)
   C13C E0                 2188 	movx	a,@dptr
   C13D 44 01              2189 	orl	a,#0x01
   C13F F0                 2190 	movx	@dptr,a
   C140 02 00 C5           2191 	ljmp	__sdcc_banked_ret
                           2192 ;------------------------------------------------------------
                           2193 ;Allocation info for local variables in function 'pll_fast_cal'
                           2194 ;------------------------------------------------------------
                           2195 ;------------------------------------------------------------
                           2196 ;	../../shared/src/pll_cal.c:236: void pll_fast_cal(void) BANKING_CTRL {
                           2197 ;	-----------------------------------------
                           2198 ;	 function pll_fast_cal
                           2199 ;	-----------------------------------------
   C143                    2200 _pll_fast_cal:
                           2201 ;	../../shared/src/pll_cal.c:246: pllcal_load(CONT);
   C143 75 82 01           2202 	mov	dpl,#0x01
   C146 78 BD              2203 	mov	r0,#_pllcal_load
   C148 79 C7              2204 	mov	r1,#(_pllcal_load >> 8)
   C14A 7A 02              2205 	mov	r2,#(_pllcal_load >> 16)
   C14C 12 00 B3           2206 	lcall	__sdcc_banked_call
                           2207 ;	../../shared/src/pll_cal.c:248: reg_ANA_PU_PLL  = 1;
   C14F 90 A3 1B           2208 	mov	dptr,#(_PM_CMN_REG1 + 0x0003)
   C152 E0                 2209 	movx	a,@dptr
   C153 44 04              2210 	orl	a,#0x04
   C155 F0                 2211 	movx	@dptr,a
                           2212 ;	../../shared/src/pll_cal.c:250: PULUP = 1;
   C156 90 82 2C           2213 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_139
   C159 E0                 2214 	movx	a,@dptr
   C15A 44 20              2215 	orl	a,#0x20
   C15C F0                 2216 	movx	@dptr,a
                           2217 ;	../../shared/src/pll_cal.c:251: LD_CAL_DATA = 1;
   C15D 90 A3 19           2218 	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
   C160 E0                 2219 	movx	a,@dptr
   C161 44 04              2220 	orl	a,#0x04
   C163 F0                 2221 	movx	@dptr,a
                           2222 ;	../../shared/src/pll_cal.c:252: reg_LCVCOCAL_BUF_EN = 1; //need to align with SHRTR. Mengjie requested.
   C164 90 82 D0           2223 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_180
   C167 E0                 2224 	movx	a,@dptr
   C168 44 02              2225 	orl	a,#0x02
   C16A F0                 2226 	movx	@dptr,a
                           2227 ;	../../shared/src/pll_cal.c:253: SHRTR = 1;	
   C16B 90 82 2C           2228 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_139
   C16E E0                 2229 	movx	a,@dptr
   C16F 44 10              2230 	orl	a,#0x10
   C171 F0                 2231 	movx	@dptr,a
                           2232 ;	../../shared/src/pll_cal.c:255: delay01(5);
   C172 90 00 05           2233 	mov	dptr,#0x0005
   C175 78 16              2234 	mov	r0,#_delay01
   C177 79 BC              2235 	mov	r1,#(_delay01 >> 8)
   C179 7A 02              2236 	mov	r2,#(_delay01 >> 16)
   C17B 12 00 B3           2237 	lcall	__sdcc_banked_call
                           2238 ;	../../shared/src/pll_cal.c:256: reg_ANA_PU_PLL_DLY = 1;
   C17E 90 A3 1B           2239 	mov	dptr,#(_PM_CMN_REG1 + 0x0003)
   C181 E0                 2240 	movx	a,@dptr
   C182 44 01              2241 	orl	a,#0x01
   C184 F0                 2242 	movx	@dptr,a
                           2243 ;	../../shared/src/pll_cal.c:257: reg_RESET_ANA = 0;
   C185 90 A3 19           2244 	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
   C188 E0                 2245 	movx	a,@dptr
   C189 54 EF              2246 	anl	a,#0xef
   C18B F0                 2247 	movx	@dptr,a
                           2248 ;	../../shared/src/pll_cal.c:259: delay01(Tpulup);
   C18C 90 E6 6B           2249 	mov	dptr,#(_TIMER_SEL3 + 0x0003)
   C18F E0                 2250 	movx	a,@dptr
   C190 FA                 2251 	mov	r2,a
   C191 7B 00              2252 	mov	r3,#0x00
   C193 8A 82              2253 	mov	dpl,r2
   C195 8B 83              2254 	mov	dph,r3
   C197 78 16              2255 	mov	r0,#_delay01
   C199 79 BC              2256 	mov	r1,#(_delay01 >> 8)
   C19B 7A 02              2257 	mov	r2,#(_delay01 >> 16)
   C19D 12 00 B3           2258 	lcall	__sdcc_banked_call
                           2259 ;	../../shared/src/pll_cal.c:260: PULUP = 0;
   C1A0 90 82 2C           2260 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_139
   C1A3 E0                 2261 	movx	a,@dptr
   C1A4 54 DF              2262 	anl	a,#0xdf
   C1A6 F0                 2263 	movx	@dptr,a
                           2264 ;	../../shared/src/pll_cal.c:262: delay01(Tshrtr);
   C1A7 90 E6 10           2265 	mov	dptr,#_CONTROL_CONFIG3
   C1AA E0                 2266 	movx	a,@dptr
   C1AB FA                 2267 	mov	r2,a
   C1AC 7B 00              2268 	mov	r3,#0x00
   C1AE 8A 82              2269 	mov	dpl,r2
   C1B0 8B 83              2270 	mov	dph,r3
   C1B2 78 16              2271 	mov	r0,#_delay01
   C1B4 79 BC              2272 	mov	r1,#(_delay01 >> 8)
   C1B6 7A 02              2273 	mov	r2,#(_delay01 >> 16)
   C1B8 12 00 B3           2274 	lcall	__sdcc_banked_call
                           2275 ;	../../shared/src/pll_cal.c:263: SHRTR = 0;
   C1BB 90 82 2C           2276 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_139
   C1BE E0                 2277 	movx	a,@dptr
   C1BF 54 EF              2278 	anl	a,#0xef
   C1C1 F0                 2279 	movx	@dptr,a
                           2280 ;	../../shared/src/pll_cal.c:264: reg_LCVCOCAL_BUF_EN = 0;
   C1C2 90 82 D0           2281 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_180
   C1C5 E0                 2282 	movx	a,@dptr
   C1C6 54 FD              2283 	anl	a,#0xfd
   C1C8 F0                 2284 	movx	@dptr,a
                           2285 ;	../../shared/src/pll_cal.c:265: LD_CAL_DATA = 0;
   C1C9 90 A3 19           2286 	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
   C1CC E0                 2287 	movx	a,@dptr
   C1CD 54 FB              2288 	anl	a,#0xfb
   C1CF F0                 2289 	movx	@dptr,a
                           2290 ;	../../shared/src/pll_cal.c:268: pll_tempc_speed_adj();
   C1D0 78 F1              2291 	mov	r0,#_pll_tempc_speed_adj
   C1D2 79 CC              2292 	mov	r1,#(_pll_tempc_speed_adj >> 8)
   C1D4 7A 02              2293 	mov	r2,#(_pll_tempc_speed_adj >> 16)
   C1D6 12 00 B3           2294 	lcall	__sdcc_banked_call
                           2295 ;	../../shared/src/pll_cal.c:282: pll_clk_ready_1();
   C1D9 78 47              2296 	mov	r0,#_pll_clk_ready_1
   C1DB 79 D4              2297 	mov	r1,#(_pll_clk_ready_1 >> 8)
   C1DD 7A 02              2298 	mov	r2,#(_pll_clk_ready_1 >> 16)
   C1DF 12 00 B3           2299 	lcall	__sdcc_banked_call
   C1E2 02 00 C5           2300 	ljmp	__sdcc_banked_ret
                           2301 ;------------------------------------------------------------
                           2302 ;Allocation info for local variables in function 'spdchg_pll_fast_cal'
                           2303 ;------------------------------------------------------------
                           2304 ;------------------------------------------------------------
                           2305 ;	../../shared/src/pll_cal.c:286: void spdchg_pll_fast_cal(void) BANKING_CTRL {
                           2306 ;	-----------------------------------------
                           2307 ;	 function spdchg_pll_fast_cal
                           2308 ;	-----------------------------------------
   C1E5                    2309 _spdchg_pll_fast_cal:
                           2310 ;	../../shared/src/pll_cal.c:295: pllcal_load(CONT);
   C1E5 75 82 01           2311 	mov	dpl,#0x01
   C1E8 78 BD              2312 	mov	r0,#_pllcal_load
   C1EA 79 C7              2313 	mov	r1,#(_pllcal_load >> 8)
   C1EC 7A 02              2314 	mov	r2,#(_pllcal_load >> 16)
   C1EE 12 00 B3           2315 	lcall	__sdcc_banked_call
                           2316 ;	../../shared/src/pll_cal.c:297: LD_CAL_DATA = 1;
   C1F1 90 A3 19           2317 	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
   C1F4 E0                 2318 	movx	a,@dptr
   C1F5 44 04              2319 	orl	a,#0x04
   C1F7 F0                 2320 	movx	@dptr,a
                           2321 ;	../../shared/src/pll_cal.c:298: reg_LCVCOCAL_BUF_EN = 1;
   C1F8 90 82 D0           2322 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_180
   C1FB E0                 2323 	movx	a,@dptr
   C1FC 44 02              2324 	orl	a,#0x02
   C1FE F0                 2325 	movx	@dptr,a
                           2326 ;	../../shared/src/pll_cal.c:299: SHRTR = 1;	
   C1FF 90 82 2C           2327 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_139
   C202 E0                 2328 	movx	a,@dptr
   C203 44 10              2329 	orl	a,#0x10
   C205 F0                 2330 	movx	@dptr,a
                           2331 ;	../../shared/src/pll_cal.c:300: delay01(Tshrtr); 
   C206 90 E6 10           2332 	mov	dptr,#_CONTROL_CONFIG3
   C209 E0                 2333 	movx	a,@dptr
   C20A FA                 2334 	mov	r2,a
   C20B 7B 00              2335 	mov	r3,#0x00
   C20D 8A 82              2336 	mov	dpl,r2
   C20F 8B 83              2337 	mov	dph,r3
   C211 78 16              2338 	mov	r0,#_delay01
   C213 79 BC              2339 	mov	r1,#(_delay01 >> 8)
   C215 7A 02              2340 	mov	r2,#(_delay01 >> 16)
   C217 12 00 B3           2341 	lcall	__sdcc_banked_call
                           2342 ;	../../shared/src/pll_cal.c:301: SHRTR = 0;
   C21A 90 82 2C           2343 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_139
   C21D E0                 2344 	movx	a,@dptr
   C21E 54 EF              2345 	anl	a,#0xef
   C220 F0                 2346 	movx	@dptr,a
                           2347 ;	../../shared/src/pll_cal.c:302: reg_LCVCOCAL_BUF_EN = 0;
   C221 90 82 D0           2348 	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_180
   C224 E0                 2349 	movx	a,@dptr
   C225 54 FD              2350 	anl	a,#0xfd
   C227 F0                 2351 	movx	@dptr,a
                           2352 ;	../../shared/src/pll_cal.c:303: LD_CAL_DATA = 0;
   C228 90 A3 19           2353 	mov	dptr,#(_PM_CMN_REG1 + 0x0001)
   C22B E0                 2354 	movx	a,@dptr
   C22C 54 FB              2355 	anl	a,#0xfb
   C22E F0                 2356 	movx	@dptr,a
                           2357 ;	../../shared/src/pll_cal.c:311: pll_tempc_speed_adj();	
   C22F 78 F1              2358 	mov	r0,#_pll_tempc_speed_adj
   C231 79 CC              2359 	mov	r1,#(_pll_tempc_speed_adj >> 8)
   C233 7A 02              2360 	mov	r2,#(_pll_tempc_speed_adj >> 16)
   C235 12 00 B3           2361 	lcall	__sdcc_banked_call
                           2362 ;	../../shared/src/pll_cal.c:345: pll_clk_ready_1();
   C238 78 47              2363 	mov	r0,#_pll_clk_ready_1
   C23A 79 D4              2364 	mov	r1,#(_pll_clk_ready_1 >> 8)
   C23C 7A 02              2365 	mov	r2,#(_pll_clk_ready_1 >> 16)
   C23E 12 00 B3           2366 	lcall	__sdcc_banked_call
   C241 02 00 C5           2367 	ljmp	__sdcc_banked_ret
                           2368 	.area CSEG    (CODE)
                           2369 	.area BANK1   (CODE)
                           2370 	.area CABS    (ABS,CODE)
