...
;	../../shared/src/power.c:124: slave_phy_on = 0;
	...
	movx	@dptr,a
;	../../shared/src/power.c:126: if(mcuid==master_mcu) {
	...
	mov	a,r2
	cjne	a,ar3,00107$
;	../../shared/src/power.c:127: if(reg_PHY_CONFIG_1_0==0x2) {
	mov	dptr,#_SYSTEM
	movx	a,@dptr
	rl	a
	rl	a
	...
	mov	r2,a
	cjne	r2,#0x02,00104$
;	../../shared/src/power.c:128: reg_ANA_CMN_PHY_X2_MASTER_EN_1_0 = 0x03;
	mov	dptr,#(_SYSTEM + 0x0001)
	movx	a,@dptr
	orl	a,#0x03
	movx	@dptr,a
	sjmp	00107$
00104$:
;	../../shared/src/power.c:130: else if(reg_PHY_CONFIG_1_0==0x3) {
	mov	dptr,#_SYSTEM
	movx	a,@dptr
	rl	a
	rl	a
	...
	mov	r2,a
	cjne	r2,#0x03,00107$
;	../../shared/src/power.c:131: slave_phy_on = 1; 
	mov	dptr,#_slave_phy_on
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/power.c:132: reg_ANA_CMN_PHY_X2_MASTER_EN_1_0 = 0x01;
	mov	dptr,#(_SYSTEM + 0x0001)
	movx	a,@dptr
	anl	a,#0xfc
	orl	a,#0x01
	movx	@dptr,a
00107$:
;	../../shared/src/power.c:136: if (phy_mode == PCIE) {
	mov	dptr,#(_SYSTEM + 0x0002)
	movx	a,@dptr
	anl	a,#0x07
	mov	r2,a
	cjne	r2,#0x03,00114$
;	../../shared/src/power.c:137: while(! (reg_PIN_PU_PLL_RD_LANE)){
00110$:
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.5,00114$
;	../../shared/src/power.c:138: if(reg_PIN_TXDETRX_EN_RD_LANE) 
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	jnb	acc.0,00110$
;	../../shared/src/power.c:139: P0Off_TXDETRX();
	mov	r0,#_P0Off_TXDETRX
	mov	r1,#(_P0Off_TXDETRX >> 8)
	mov	r2,#(_P0Off_TXDETRX >> 16)
	lcall	__sdcc_banked_call
	sjmp	00110$
00114$:
