...
;--------------------------------------------------------
	...
	.globl _find_align90_lock
	.globl _rxalign90_cal
	.globl _align90_update
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area BANK1   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'check_lock'
;------------------------------------------------------------
;val                       Allocated to registers r2 r3 
;i                         Allocated to registers r4 
;------------------------------------------------------------
;	../../shared/src/align90_cal.c:198: inline static bool check_lock(uint16_t val) {
;	-----------------------------------------
;	 function check_lock
;	-----------------------------------------
_check_lock:
	...
	mov	r2,dpl
	mov	r3,dph
;	../../shared/src/align90_cal.c:200: for(i=0; i<8; i++) {
	mov	r4,#0x00
00103$:
	cjne	r4,#0x08,00112$
00112$:
	jnc	00106$
;	../../shared/src/align90_cal.c:201: if(pattern_tb[i] == (val&pattern_tb_mask[i])) return 1;
	mov	a,r4
	add	a,r4
	mov	r5,a
	mov	r6,a
	mov	dptr,#_pattern_tb
	movc	a,@a+dptr
	xch	a,r6
	inc	dptr
	movc	a,@a+dptr
...
;	../../shared/src/align90_cal.c:200: for(i=0; i<8; i++) {
	...
	sjmp	00103$
00106$:
;	../../shared/src/align90_cal.c:203: return 0;
	mov	dpl,#0x00
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'find_align90_lock'
;------------------------------------------------------------
;pd                        Allocated to registers r5 
;pre_pd                    Allocated to stack - offset 1
;step_size                 Allocated to registers r6 
;cnt                       Allocated to stack - offset 4
;loop_cnt                  Allocated to stack - offset 2
;dir                       Allocated to stack - offset 4
;locked                    Allocated to stack - offset 6
;hit_boundary              Allocated to registers r2 
;__00022402                Allocated to registers r2 
;__00032403                Allocated to registers 
;val                       Allocated to stack - offset 7
;i                         Allocated to registers r4 
;------------------------------------------------------------
;	../../shared/src/align90_cal.c:206: bool find_align90_lock(void) BANKING_CTRL {
;	-----------------------------------------
;	 function find_align90_lock
;	-----------------------------------------
_find_align90_lock:
	push	_bp
	mov	a,sp
	...
	add	a,#0x08
	mov	sp,a
;	../../shared/src/align90_cal.c:212: dir = 0; loop_cnt = 700; locked = 0;	
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	@r0,#0x00
	...
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/align90_cal.c:213: gm_bin = gray2bi[reg_ALIGN90_GM_LANE_2_0];	
	...
	mov	dptr,#_gm_bin
	movx	@dptr,a
;	../../shared/src/align90_cal.c:214: dac = reg_ALIGN90_DAC_LANE_5_0;
	...
	mov	dptr,#_dac
	movx	@dptr,a
;	../../shared/src/align90_cal.c:215: dm = reg_ALIGN90_DUMMY_CLK_LANE;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_13
	movx	a,@dptr
	rr	a
	anl	a,#0x01
	mov	dptr,#_dm
	movx	@dptr,a
;	../../shared/src/align90_cal.c:217: pd = align90_read_pd();
	mov	r0,#_align90_read_pd
	mov	r1,#(_align90_read_pd >> 8)
	mov	r2,#(_align90_read_pd >> 16)
	lcall	__sdcc_banked_call
	mov	r5,dpl
;	../../shared/src/align90_cal.c:218: reg_MCU_DEBUG2_LANE_7_0 = pd; //for testbench
	mov	dptr,#(_MCU_DEBUG0_LANE + 0x0002)
	mov	a,r5
	movx	@dptr,a
;	../../shared/src/align90_cal.c:220: if( LOAD_CAL_ON == 1) step_size = 8;
	...
	sjmp	00161$
00102$:
;	../../shared/src/align90_cal.c:221: else step_size = 1;
	mov	r6,#0x01
;	../../shared/src/align90_cal.c:228: do {
00161$:
	mov	r0,_bp
	inc	r0
	inc	r0
	...
	mov	@r0,#0x02
00133$:
;	../../shared/src/align90_cal.c:229: align90_step = step_size;
	mov	dptr,#(_MCU_DEBUG0_LANE + 0x0001)
	mov	a,r6
	movx	@dptr,a
;	../../shared/src/align90_cal.c:230: if(cont_cal_on) {
	jnb	_cont_cal_on,00114$
;	../../shared/src/align90_cal.c:231: if(pd) align90_step_cnt++;
	mov	a,r5
	jz	00105$
	mov	dptr,#_align90_step_cnt
	movx	a,@dptr
	add	a,#0x01
	movx	@dptr,a
	sjmp	00106$
00105$:
;	../../shared/src/align90_cal.c:232: else align90_step_cnt--;	
	mov	dptr,#_align90_step_cnt
	movx	a,@dptr
	dec	a
	mov	dptr,#_align90_step_cnt
	movx	@dptr,a
00106$:
;	../../shared/src/align90_cal.c:238: if( align90_step_cnt == 0) {
	mov	dptr,#_align90_step_cnt
	movx	a,@dptr
	mov	r4,a
;	../../shared/src/align90_cal.c:239: pd = 0;
	jnz	00111$
	mov	r5,a
;	../../shared/src/align90_cal.c:240: align90_step_cnt = ALIGN90_CAL_STEP_SIZE;
	mov	dptr,#(_CON_CAL_STEP_SIZE4 + 0x0003)
	movx	a,@dptr
	mov	r7,a
	mov	dptr,#_align90_step_cnt
	movx	@dptr,a
	sjmp	00114$
00111$:
;	../../shared/src/align90_cal.c:241: } else if( align90_step_cnt	>= (ALIGN90_CAL_STEP_SIZE<<1)) {
	push	ar6
	mov	dptr,#(_CON_CAL_STEP_SIZE4 + 0x0003)
	movx	a,@dptr
	mov	r7,a
	...
	pop	ar6
	jc	00108$
;	../../shared/src/align90_cal.c:242: pd = 1;
	mov	r5,#0x01
;	../../shared/src/align90_cal.c:243: align90_step_cnt = ALIGN90_CAL_STEP_SIZE;
	mov	dptr,#(_CON_CAL_STEP_SIZE4 + 0x0003)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_align90_step_cnt
	...
	sjmp	00114$
00108$:
;	../../shared/src/align90_cal.c:245: else return 1;		
	mov	dpl,#0x01
	ljmp	00143$
00114$:
;	../../shared/src/align90_cal.c:249: if(pd == 1) { //inc DAC
	cjne	r5,#0x01,00116$
;	../../shared/src/align90_cal.c:250: hit_boundary = get_dac_inc(); 
	push	ar6
	mov	r0,#_get_dac_inc
	mov	r1,#(_get_dac_inc >> 8)
	mov	r2,#(_get_dac_inc >> 16)
	lcall	__sdcc_banked_call
	mov	r2,dpl
	pop	ar6
	sjmp	00117$
00116$:
;	../../shared/src/align90_cal.c:253: hit_boundary = get_dac_dec(); 
	push	ar6
	mov	r0,#_get_dac_dec
	mov	r1,#(_get_dac_dec >> 8)
	mov	r2,#(_get_dac_dec >> 16)
	lcall	__sdcc_banked_call
	mov	r3,dpl
	pop	ar6
	mov	ar2,r3
00117$:
;	../../shared/src/align90_cal.c:256: if( hit_boundary ) break;
	mov	a,r2
	jz	00170$
	ljmp	00135$
00170$:
;	../../shared/src/align90_cal.c:258: align90_update();
	push	ar6
	mov	r0,#_align90_update
	mov	r1,#(_align90_update >> 8)
	mov	r2,#(_align90_update >> 16)
	lcall	__sdcc_banked_call
	pop	ar6
;	../../shared/src/align90_cal.c:260: if( cont_cal_on ) {
	jnb	_cont_cal_on,00121$
;	../../shared/src/align90_cal.c:261: locked = 1;
	mov	a,_bp
	add	a,#0x06
	mov	r0,a
	mov	@r0,#0x01
;	../../shared/src/align90_cal.c:262: break;
	ljmp	00135$
00121$:
;	../../shared/src/align90_cal.c:265: pd = align90_read_pd();
	push	ar6
	mov	r0,#_align90_read_pd
	mov	r1,#(_align90_read_pd >> 8)
	mov	r2,#(_align90_read_pd >> 16)
	...
	pop	ar6
	mov	ar5,r2
;	../../shared/src/align90_cal.c:266: reg_MCU_DEBUG2_LANE_7_0 = pd; //for testbench
	mov	dptr,#(_MCU_DEBUG0_LANE + 0x0002)
	mov	a,r5
	movx	@dptr,a
;	../../shared/src/align90_cal.c:268: if( pd != pre_pd) {
	mov	r0,_bp
	inc	r0
	mov	a,@r0
	cjne	a,ar5,00172$
	sjmp	00128$
00172$:
;	../../shared/src/align90_cal.c:269: pre_pd = pd;
	mov	r0,_bp
	inc	r0
	mov	@r0,ar5
;	../../shared/src/align90_cal.c:270: if(step_size == 8) step_size = 2; 
	cjne	r6,#0x08,00125$
	mov	r6,#0x02
	sjmp	00128$
00125$:
;	../../shared/src/align90_cal.c:271: else if(step_size == 2) step_size = 1;
	cjne	r6,#0x02,00128$
	mov	r6,#0x01
00128$:
;	../../shared/src/align90_cal.c:283: dir<<=1;
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	inc	r0
	...
	inc	r0
	mov	@r0,a
;	../../shared/src/align90_cal.c:284: dir |= pd;
	mov	ar2,r5
	mov	r3,#0x00
	mov	a,_bp
	add	a,#0x04
	...
	orl	a,@r0
	mov	@r0,a
;	../../shared/src/align90_cal.c:291: if( check_lock(dir)) { 
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,_bp
...
00138$:
	mov	a,r2
	jz	00130$
;	../../shared/src/align90_cal.c:292: locked = 1;
	mov	a,_bp
	add	a,#0x06
	mov	r0,a
	mov	@r0,#0x01
;	../../shared/src/align90_cal.c:293: lnx_ALIGN90_TRACKING_PASS_LANE = 1;
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/align90_cal.c:294: break;
	sjmp	00135$
00130$:
;	../../shared/src/align90_cal.c:297: if(cmx_ALIGN90_CAL_TIMEOUT_DIS == 0)
	mov	dptr,#(_CAL_TIME_OUT_AND_DIS + 0x0001)
	movx	a,@dptr
	jb	acc.0,00134$
;	../../shared/src/align90_cal.c:298: loop_cnt--;
	mov	r0,_bp
	inc	r0
	inc	r0
	dec	@r0
...
00183$:
00134$:
;	../../shared/src/align90_cal.c:300: } while(loop_cnt > 0);
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	a,@r0
...
00184$:
00135$:
;	../../shared/src/align90_cal.c:307: return locked;
	mov	a,_bp
	add	a,#0x06
	mov	r0,a
	mov	dpl,@r0
...
;------------------------------------------------------------
;Allocation info for local variables in function 'rxalign90_cal'
;------------------------------------------------------------
;div2                      Allocated to registers r3 
;rate                      Allocated to registers r2 
;i                         Allocated to registers r4 
;------------------------------------------------------------
;	../../shared/src/align90_cal.c:310: void rxalign90_cal(void) BANKING_CTRL {
;	-----------------------------------------
;	 function rxalign90_cal
;	-----------------------------------------
_rxalign90_cal:
;	../../shared/src/align90_cal.c:316: if(phy_mode==PCIE) rate = rx_pll_rate_x;
	mov	dptr,#(_SYSTEM + 0x0002)
	movx	a,@dptr
	anl	a,#0x07
	mov	r2,a
	cjne	r2,#0x03,00105$
	mov	dptr,#_rx_pll_rate_x
	movx	a,@dptr
	mov	r2,a
	sjmp	00106$
00105$:
;	../../shared/src/align90_cal.c:317: else if(rx_pll_rate_x>1) rate = 0;
	mov	dptr,#_rx_pll_rate_x
	movx	a,@dptr
	mov	r3,a
	mov	a,#0x01
...
00123$:
	...
	sjmp	00106$
00102$:
;	../../shared/src/align90_cal.c:318: else rate = rx_pll_rate_x;
	mov	ar2,r3
00106$:
;	../../shared/src/align90_cal.c:320: PHY_STATUS = ST_RXALIGN90_CAL;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x0F
	movx	@dptr,a
;	../../shared/src/align90_cal.c:322: div2 = (reg_RX_SPEED_DIV_LANE_2_0&0x04)==0;		
...
00125$:
	mov	r3,a
;	../../shared/src/align90_cal.c:324: lnx_ALIGN90_TRACKING_PASS_LANE = 0;
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/align90_cal.c:325: lnx_RXALIGN90_CAL_DONE_LANE = 0;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/align90_cal.c:327: if( (cmx_RXALIGN90_CAL_EXT_EN==1) || (lnx_CAL_DONE_LANE==1)) {
...
00127$:
	...
	cjne	r4,#0x01,00108$
00107$:
;	../../shared/src/align90_cal.c:333: dac = lnx_calx_align90_dac[PWR][rate][div2];
	mov	a,r2
	add	a,r2
	mov	r4,a
	add	a,#_lnx_calx_align90_dac
	mov	r5,a
	clr	a
	addc	a,#(_lnx_calx_align90_dac >> 8)
	mov	r6,a
	mov	a,r3
	add	a,r5
	mov	dpl,a
	...
	mov	dptr,#_dac
	movx	@dptr,a
;	../../shared/src/align90_cal.c:334: gm = lnx_calx_align90_gm[PWR][rate][div2];
	mov	a,r4
	add	a,#_lnx_calx_align90_gm
	mov	r5,a
	clr	a
	addc	a,#(_lnx_calx_align90_gm >> 8)
	mov	r6,a
	mov	a,r3
	add	a,r5
	mov	dpl,a
	...
	mov	dptr,#_gm
	movx	@dptr,a
;	../../shared/src/align90_cal.c:335: dm = lnx_calx_align90_dummy_clk[PWR][rate][div2];
	mov	a,r4
	add	a,#_lnx_calx_align90_dummy_clk
	mov	r4,a
	clr	a
	addc	a,#(_lnx_calx_align90_dummy_clk >> 8)
	mov	r5,a
	mov	a,r3
	add	a,r4
	mov	dpl,a
	...
	sjmp	00109$
00108$:
;	../../shared/src/align90_cal.c:340: dac = 0x31; gm = 5; dm  = 1;	
	mov	dptr,#_dac
	mov	a,#0x31
	movx	@dptr,a
	mov	dptr,#_gm
	...
	movx	@dptr,a
00109$:
;	../../shared/src/align90_cal.c:342: gm_bin = gray2bi[gm];	
	mov	dptr,#_gm
	movx	a,@dptr
	mov	dptr,#_gray2bi
	movc	a,@a+dptr
	mov	dptr,#_gm_bin
	movx	@dptr,a
;	../../shared/src/align90_cal.c:344: align90_update();
	push	ar2
	push	ar3
	mov	r0,#_align90_update
	mov	r1,#(_align90_update >> 8)
	...
	pop	ar3
	pop	ar2
;	../../shared/src/align90_cal.c:346: if( LOAD_CAL_ON==0 && (cmx_RXALIGN90_CAL_EXT_EN==0) ) {
	mov	dptr,#_CAL_CTRL3_LANE
	movx	a,@dptr
	jz	00130$
	ljmp	00112$
00130$:
	...
	ljmp	00112$
00131$:
;	../../shared/src/align90_cal.c:347: lnx_RXALIGN90_CAL_PASS_LANE = find_align90_lock();
	push	ar2
	push	ar3
	...
	mov	acc.1,c
	movx	@dptr,a
;	../../shared/src/align90_cal.c:348: i = reg_ALIGN90_GM_LANE_2_0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_12
	movx	a,@dptr
	rr	a
	anl	a,#0x07
	mov	r4,a
;	../../shared/src/align90_cal.c:349: cal_align90_gm_bin[rate] = gray2bi[i];
	mov	a,r2
	add	a,#_cal_align90_gm_bin
	mov	r5,a
	clr	a
	addc	a,#(_cal_align90_gm_bin >> 8)
	mov	r6,a
	mov	a,r4
	mov	dptr,#_gray2bi
	movc	a,@a+dptr
	...
	mov	dph,r6
	movx	@dptr,a
;	../../shared/src/align90_cal.c:355: lnx_calx_align90_dac[PWR][rate][div2] = dac;
	mov	a,r2
	add	a,r2
	mov	r2,a
	add	a,#_lnx_calx_align90_dac
	...
	mov	dph,r5
	movx	@dptr,a
;	../../shared/src/align90_cal.c:356: lnx_calx_align90_gm[PWR][rate][div2] = gm;
	mov	a,r2
	add	a,#_lnx_calx_align90_gm
	mov	r4,a
	clr	a
	...
	mov	dph,r5
	movx	@dptr,a
;	../../shared/src/align90_cal.c:357: lnx_calx_align90_dummy_clk[PWR][rate][div2] = dm;
	mov	a,r2
	add	a,#_lnx_calx_align90_dummy_clk
	mov	r2,a
	clr	a
	...
	movx	@dptr,a
00112$:
;	../../shared/src/align90_cal.c:366: lnx_RXALIGN90_CAL_DONE_LANE = 1;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/align90_cal.c:368: align90_step_cnt = ALIGN90_CAL_STEP_SIZE;
	mov	dptr,#(_CON_CAL_STEP_SIZE4 + 0x0003)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_align90_step_cnt
	...
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'align90_update'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/align90_cal.c:372: void align90_update(void) BANKING_CTRL {
;	-----------------------------------------
;	 function align90_update
;	-----------------------------------------
_align90_update:
;	../../shared/src/align90_cal.c:373: reg_ALIGN90_DAC_LANE_5_0 = dac;
	mov	dptr,#_dac
	movx	a,@dptr
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_13
	add	a,acc
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/align90_cal.c:374: reg_ALIGN90_DUMMY_CLK_LANE = dm;
	mov	dptr,#_dm
	movx	a,@dptr
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_13
	rrc	a
	...
	mov	acc.1,c
	movx	@dptr,a
;	../../shared/src/align90_cal.c:375: gm = gm_bin ^ (gm_bin>>1);
	mov	dptr,#_gm_bin
	movx	a,@dptr
	mov	r2,a
	clr	c
	...
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/align90_cal.c:376: reg_ALIGN90_GM_LANE_2_0 = gm;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_12
	mov	a,r2
	add	a,r2
	anl	a,#0x0e
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/align90_cal.c:377: ALIGN90_SYN_CLK	= 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_13
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/align90_cal.c:378: short_delay();
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	mov	r2,#(_short_delay >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/align90_cal.c:379: ALIGN90_SYN_CLK	= 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_13
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
