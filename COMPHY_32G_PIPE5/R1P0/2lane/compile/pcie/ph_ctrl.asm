...
;--------------------------------------------------------
	.globl _sel_sdge_dly_tb3
	.globl _sel_sdge_dly_tb2
	.globl _TF2
	.globl _TI
	.globl _RI
	.globl _EX12
	...
	.globl _phase_control_func
	.globl _phase_control_func_0
	.globl _set_edge_dly
	.globl _cdr_phase_update
	.globl _move_eom_phase
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'phase_control_func'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/ph_ctrl.c:22: void phase_control_func(void) {
;	-----------------------------------------
;	 function phase_control_func
;	-----------------------------------------
_phase_control_func:
	ar2 = 0x02
	ar3 = 0x03
	...
	ar0 = 0x00
	ar1 = 0x01
;	../../shared/src/ph_ctrl.c:23: phase_control_func_0(train.phase_offset_data, train.phase_offset_esm);
	...
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'phase_control_func_0'
;------------------------------------------------------------
;ph_esm                    Allocated to stack - offset -3
;ph_dat                    Allocated to registers r2 
;dat                       Allocated to stack - offset 1
;esm                       Allocated to stack - offset 2
;------------------------------------------------------------
;	../../shared/src/ph_ctrl.c:26: void phase_control_func_0(int8_t ph_dat, int8_t ph_esm) {
;	-----------------------------------------
;	 function phase_control_func_0
;	-----------------------------------------
_phase_control_func_0:
	push	_bp
	mov	_bp,sp
	inc	sp
	inc	sp
	mov	r2,dpl
;	../../shared/src/ph_ctrl.c:30: if(lnx_FAST_DFE_TIMER_EN_LANE) return;
	mov	dptr,#(_DFE_CONTROL_5 + 0x0003)
	movx	a,@dptr
	jnb	acc.7,00102$
	ljmp	00125$
00102$:
;	../../shared/src/ph_ctrl.c:32: cur_phase_offset_data = ph_dat;
	mov	dptr,#_cur_phase_offset_data
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/ph_ctrl.c:33: cur_phase_offset_esm = ph_esm;
	mov	a,_bp
	add	a,#0xfd
	mov	r0,a
	mov	ar3,@r0
	mov	dptr,#_cur_phase_offset_esm
	mov	a,r3
	movx	@dptr,a
;	../../shared/src/ph_ctrl.c:39: lnx_DLL_VDDA_TRACKING_ON_LANE = 0; 
	mov	dptr,#(_CAL_CTRL3_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/ph_ctrl.c:41: if(ph_control_mode==0 ) {			
	mov	dptr,#_ph_control_mode
	movx	a,@dptr
	mov	r4,a
	jnz	00116$
;	../../shared/src/ph_ctrl.c:43: dat = cal_phase - ph_dat - ph_esm;
	...
	inc	r0
	mov	@r0,ar5
;	../../shared/src/ph_ctrl.c:48: esm = (int16_t)cal_eom_dpher - (int16_t)reg_EOM_DPHER_LANE_6_0;		
	...
	ljmp	00117$
00116$:
;	../../shared/src/ph_ctrl.c:50: else if( ph_control_mode==1 ) {
	cjne	r4,#0x01,00113$
;	../../shared/src/ph_ctrl.c:53: if ( ( 0 == ( g_fw_flags & 1 ) ) && ( EOM_EN_D!=EOM_EN_S ) && ( do_phase_adapt==0 ) )
...
00144$:
	...
	mov	r6,a
	jnz	00104$
;	../../shared/src/ph_ctrl.c:54: eom_ui_align();
	push	ar2
	push	ar3
	...
	pop	ar2
00104$:
;	../../shared/src/ph_ctrl.c:56: dat = cal_phase - ph_dat;
	mov	dptr,#(_DFE_CONTROL_3 + 0x0002)
	movx	a,@dptr
	clr	c
	subb	a,r2
	...
	inc	r0
	mov	@r0,ar6
;	../../shared/src/ph_ctrl.c:66: esm = (int16_t)(cal_eom_dpher - ph_esm) - (int16_t)reg_EOM_DPHER_LANE_6_0;
	mov	dptr,#(_DFE_CONTROL_3 + 0x0001)
	movx	a,@dptr
	mov	r6,a
	push	ar2
	...
	ljmp	00117$
00113$:
;	../../shared/src/ph_ctrl.c:70: else if( ph_control_mode==2 ) {
	cjne	r4,#0x02,00110$
;	../../shared/src/ph_ctrl.c:77: dat = cal_phase;
	mov	dptr,#(_DFE_CONTROL_3 + 0x0002)
	movx	a,@dptr
	mov	r6,a
	mov	r0,_bp
	inc	r0
	mov	@r0,ar6
;	../../shared/src/ph_ctrl.c:83: esm =  (int16_t)(cal_eom_dpher - ph_dat - ph_esm) - (int16_t)reg_EOM_DPHER_LANE_6_0;
	mov	dptr,#(_DFE_CONTROL_3 + 0x0001)
	movx	a,@dptr
	mov	r6,a
	mov	a,r2
	...
	sjmp	00117$
00110$:
;	../../shared/src/ph_ctrl.c:86: else if( ph_control_mode==3 ){				
	cjne	r4,#0x03,00117$
;	../../shared/src/ph_ctrl.c:88: dat = cal_phase;
	mov	dptr,#(_DFE_CONTROL_3 + 0x0002)
	movx	a,@dptr
	mov	r4,a
	mov	r0,_bp
	inc	r0
	mov	@r0,ar4
;	../../shared/src/ph_ctrl.c:94: esm = (int16_t)(cal_eom_dpher +(half_ui_code + ph_dat + ph_esm))- (int16_t)reg_EOM_DPHER_LANE_6_0;
	mov	dptr,#(_DFE_CONTROL_3 + 0x0001)
	movx	a,@dptr
	mov	r4,a
	...
	mov	r5,a
00117$:
;	../../shared/src/ph_ctrl.c:98: if(dat>=64) dat-=64;
	mov	r0,_bp
	inc	r0
	clr	c
	mov	a,@r0
	...
	mov	@r0,a
00119$:
;	../../shared/src/ph_ctrl.c:99: cdr_phase_update(dat);
	mov	r0,_bp
	inc	r0
	mov	dpl,@r0
	push	ar2
	push	ar3
	push	ar5
	lcall	_cdr_phase_update
	pop	ar5
	pop	ar3
	pop	ar2
;	../../shared/src/ph_ctrl.c:100: if(esm>=70) esm -= 128;
	clr	c
	mov	a,r5
	xrl	a,#0x80
	subb	a,#0xc6
	...
	sjmp	00124$
00123$:
;	../../shared/src/ph_ctrl.c:101: else if(esm < -70) esm += 128;
	clr	c
	mov	a,r5
	xrl	a,#0x80
	subb	a,#0x3a
	...
	mov	r5,a
00124$:
;	../../shared/src/ph_ctrl.c:102: move_eom_phase(esm);
	mov	a,r5
	mov	r4,a
	rlc	a
	subb	a,acc
	...
	pop	ar3
	pop	ar2
;	../../shared/src/ph_ctrl.c:105: set_edge_dly(ph_dat, ph_esm);
	push	ar3
	mov	dpl,r2
	lcall	_set_edge_dly
	dec	sp
;	../../shared/src/ph_ctrl.c:112: lnx_DLL_VDDA_TRACKING_ON_LANE = 1; 
	mov	dptr,#(_CAL_CTRL3_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
00125$:
	...
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'set_edge_dly'
;------------------------------------------------------------
;ph_esm                    Allocated to stack - offset -3
;ph_dat                    Allocated to registers r2 
;eom_ph_os                 Allocated to registers r3 
;------------------------------------------------------------
;	../../shared/src/ph_ctrl.c:145: void set_edge_dly(int8_t ph_dat, int8_t ph_esm)  {
;	-----------------------------------------
;	 function set_edge_dly
;	-----------------------------------------
_set_edge_dly:
	push	_bp
	mov	_bp,sp
	mov	r2,dpl
;	../../shared/src/ph_ctrl.c:148: switch(ph_control_mode)
	mov	dptr,#_ph_control_mode
	movx	a,@dptr
	mov	r3,a
	mov	a,#0x03
...
00139$:
	...
	ljmp	00106$
	ljmp	00116$
;	../../shared/src/ph_ctrl.c:150: case 0: 
00101$:
;	../../shared/src/ph_ctrl.c:151: case 1: 
00102$:
;	../../shared/src/ph_ctrl.c:152: if( reg_ALIGN90_REF_LANE_5_0 > 34 )
	...
	subb	a,b
	jnc	00104$
;	../../shared/src/ph_ctrl.c:153: reg_SEL_EDGE_DLY_LANE_1_0 = 0;
	...
	ljmp	00127$
00104$:
;	../../shared/src/ph_ctrl.c:155: reg_SEL_EDGE_DLY_LANE_1_0 = 1;  
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_137
	movx	a,@dptr
	anl	a,#0xf3
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/ph_ctrl.c:156: break;
	ljmp	00127$
;	../../shared/src/ph_ctrl.c:157: case 2: 
00106$:
;	../../shared/src/ph_ctrl.c:158: eom_ph_os = (int8_t)ph_dat + (int8_t)ph_esm;
	mov	a,_bp
	add	a,#0xfd
	mov	r0,a
	mov	a,@r0
	add	a,r2
	mov	r3,a
;	../../shared/src/ph_ctrl.c:159: if( eom_ph_os < sel_sdge_dly_tb2[0])  reg_SEL_EDGE_DLY_LANE_1_0 = 0;
	mov	dptr,#_sel_sdge_dly_tb2
	clr	a
	movc	a,@a+dptr
	mov	r4,a
	clr	c
	...
	ljmp	00127$
00114$:
;	../../shared/src/ph_ctrl.c:160: else if(eom_ph_os < sel_sdge_dly_tb2[1])  reg_SEL_EDGE_DLY_LANE_1_0 = 1;
	mov	dptr,#(_sel_sdge_dly_tb2 + 0x0001)
	clr	a
	movc	a,@a+dptr
	mov	r4,a
	clr	c
	...
	ljmp	00127$
00111$:
;	../../shared/src/ph_ctrl.c:161: else if(eom_ph_os < sel_sdge_dly_tb2[2])  reg_SEL_EDGE_DLY_LANE_1_0 = 2;
	mov	dptr,#(_sel_sdge_dly_tb2 + 0x0002)
	clr	a
	movc	a,@a+dptr
	mov	r4,a
	clr	c
	...
	ljmp	00127$
00108$:
;	../../shared/src/ph_ctrl.c:162: else  reg_SEL_EDGE_DLY_LANE_1_0 = 3;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_137
	movx	a,@dptr
	orl	a,#0x0c
	movx	@dptr,a
;	../../shared/src/ph_ctrl.c:163: break;
;	../../shared/src/ph_ctrl.c:164: case 3: 
	sjmp	00127$
00116$:
;	../../shared/src/ph_ctrl.c:165: eom_ph_os = tag_CDR_HALF_UI_PI_CODE + (int8_t)ph_dat + (int8_t)ph_esm;
	mov	dptr,#_half_ui_code
	movx	a,@dptr
	mov	r4,a
	mov	a,r2
	...
	add	a,r2
	mov	r3,a
;	../../shared/src/ph_ctrl.c:166: if( eom_ph_os < sel_sdge_dly_tb3[0])  reg_SEL_EDGE_DLY_LANE_1_0 = 0;
	mov	dptr,#_sel_sdge_dly_tb3
	clr	a
	movc	a,@a+dptr
	mov	r2,a
	clr	c
	...
	sjmp	00127$
00124$:
;	../../shared/src/ph_ctrl.c:167: else if(eom_ph_os < sel_sdge_dly_tb3[1])  reg_SEL_EDGE_DLY_LANE_1_0 = 1;
	mov	dptr,#(_sel_sdge_dly_tb3 + 0x0001)
	clr	a
	movc	a,@a+dptr
	mov	r2,a
	clr	c
	...
	sjmp	00127$
00121$:
;	../../shared/src/ph_ctrl.c:168: else if(eom_ph_os < sel_sdge_dly_tb3[2])  reg_SEL_EDGE_DLY_LANE_1_0 = 2;
	mov	dptr,#(_sel_sdge_dly_tb3 + 0x0002)
	clr	a
	movc	a,@a+dptr
	mov	r2,a
	clr	c
	...
	sjmp	00127$
00118$:
;	../../shared/src/ph_ctrl.c:169: else  reg_SEL_EDGE_DLY_LANE_1_0 = 3;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_137
	movx	a,@dptr
	orl	a,#0x0c
	movx	@dptr,a
;	../../shared/src/ph_ctrl.c:171: }
00127$:
	pop	_bp
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'cdr_phase_update'
;------------------------------------------------------------
;new_phase_os              Allocated to registers r2 
;ph_os_tmp                 Allocated to registers r3 
;sloc0                     Allocated to stack - offset 1
;------------------------------------------------------------
;	../../shared/src/ph_ctrl.c:188: void cdr_phase_update(int8_t new_phase_os)  {
;	-----------------------------------------
;	 function cdr_phase_update
;	-----------------------------------------
_cdr_phase_update:
	push	_bp
	mov	_bp,sp
	...
	inc	sp
	mov	r2,dpl
;	../../shared/src/ph_ctrl.c:191: ph_os_tmp = (int8_t)reg_ALIGN90_REF_LANE_5_0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_14
	movx	a,@dptr
	rr	a
	rr	a
	anl	a,#0x3f
	mov	r3,a
;	../../shared/src/ph_ctrl.c:192: new_phase_os = clamp( new_phase_os, tag_CDR_PHASE_MAX, tag_CDR_PHASE_MIN);
	push	ar3
	mov	a,#0x0C
	push	acc
	mov	a,#0x3A
	...
	dec	sp
	pop	ar3
;	../../shared/src/ph_ctrl.c:199: while( ph_os_tmp != new_phase_os ) 
00107$:
	mov	a,r3
	cjne	a,ar2,00116$
	ljmp	00110$
00116$:
;	../../shared/src/ph_ctrl.c:201: if(ph_os_tmp < (new_phase_os - tag_CDR_OS_PH_JMP_STEP))
	mov	a,r2
	mov	r4,a
	rlc	a
	subb	a,acc
	...
	subb	a,b
	jnc	00105$
;	../../shared/src/ph_ctrl.c:202: ph_os_tmp += tag_CDR_OS_PH_JMP_STEP;
	inc	r3
	inc	r3
	sjmp	00106$
00105$:
;	../../shared/src/ph_ctrl.c:203: else if(ph_os_tmp > (new_phase_os + tag_CDR_OS_PH_JMP_STEP))
	mov	a,#0x02
	add	a,r4
	mov	r4,a
	clr	a
	...
	subb	a,b
	jnc	00102$
;	../../shared/src/ph_ctrl.c:204: ph_os_tmp -= tag_CDR_OS_PH_JMP_STEP;
	dec	r3
	dec	r3
	sjmp	00106$
00102$:
;	../../shared/src/ph_ctrl.c:206: ph_os_tmp = new_phase_os;
	mov	ar3,r2
00106$:
;	../../shared/src/ph_ctrl.c:208: reg_ALIGN90_REF_LANE_5_0 = (uint8_t)ph_os_tmp;		
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_14
	mov	a,r3
	add	a,r3
	add	a,acc
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/ph_ctrl.c:209: short_delay();//delay01(10);
	push	ar2
	push	ar3
	mov	r0,#_short_delay
	...
	lcall	__sdcc_banked_call
;	../../shared/src/ph_ctrl.c:216: find_align90_lock(); 
...
00110$:
	...
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'move_eom_phase'
;------------------------------------------------------------
;update_ph                 Allocated to registers r2 r3 
;ph_os_tmp                 Allocated to registers r4 r5 
;------------------------------------------------------------
;	../../shared/src/ph_ctrl.c:231: void move_eom_phase(int16_t update_ph)  {
;	-----------------------------------------
;	 function move_eom_phase
;	-----------------------------------------
_move_eom_phase:
	mov	r2,dpl
	mov	r3,dph
;	../../shared/src/ph_ctrl.c:238: while( update_ph != 0 ) 
00107$:
	mov	a,r2
	orl	a,r3
	jnz	00116$
	ret
00116$:
;	../../shared/src/ph_ctrl.c:240: ph_os_tmp = (int16_t)reg_EOM_DPHER_LANE_6_0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_10
	movx	a,@dptr
	rr	a
	anl	a,#0x7f
	mov	r4,a
	mov	r5,#0x00
;	../../shared/src/ph_ctrl.c:242: if(update_ph >= tag_CDR_OS_PH_JMP_STEP) {
	clr	c
	mov	a,r2
	subb	a,#0x02
	mov	a,r3
	...
	subb	a,#0x80
	jc	00105$
;	../../shared/src/ph_ctrl.c:243: update_ph -= tag_CDR_OS_PH_JMP_STEP;
	mov	a,r2
	add	a,#0xfe
	mov	r2,a
	mov	a,r3
	addc	a,#0xff
	mov	r3,a
;	../../shared/src/ph_ctrl.c:244: ph_os_tmp += tag_CDR_OS_PH_JMP_STEP;
	mov	a,#0x02
	add	a,r4
	mov	r4,a
	clr	a
	...
	sjmp	00106$
00105$:
;	../../shared/src/ph_ctrl.c:246: else if(update_ph <= -tag_CDR_OS_PH_JMP_STEP) {
	clr	c
	mov	a,#0xFE
	subb	a,r2
	mov	a,#(0xFF ^ 0x80)
	...
	subb	a,b
	jc	00102$
;	../../shared/src/ph_ctrl.c:247: update_ph += tag_CDR_OS_PH_JMP_STEP;
	mov	a,#0x02
	add	a,r2
	mov	r2,a
	clr	a
	addc	a,r3
	mov	r3,a
;	../../shared/src/ph_ctrl.c:248: ph_os_tmp -= tag_CDR_OS_PH_JMP_STEP;	
	mov	a,r4
	add	a,#0xfe
	mov	r4,a
	mov	a,r5
	...
	sjmp	00106$
00102$:
;	../../shared/src/ph_ctrl.c:251: ph_os_tmp += update_ph;	
	mov	a,r2
	add	a,r4
	mov	r4,a
	mov	a,r3
	addc	a,r5
	mov	r5,a
;	../../shared/src/ph_ctrl.c:252: update_ph = 0;
	mov	r2,#0x00
	mov	r3,#0x00
00106$:
;	../../shared/src/ph_ctrl.c:255: reg_EOM_DPHER_LANE_6_0 = (uint8_t)ph_os_tmp & 0x7f;		
	anl	ar4,#0x7F
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_10
	mov	a,r4
	add	a,r4
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/ph_ctrl.c:256: short_delay(); //delay01(10);
	push	ar2
	push	ar3
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	...
	pop	ar3
	pop	ar2
;	../../shared/src/ph_ctrl.c:257: reg_EOM_DPHERCK_LANE = 1;
;	../../shared/src/ph_ctrl.c:258: reg_EOM_DPHERCK_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_10
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
