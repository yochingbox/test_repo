...
;--------------------------------------------------------
	.area BANK2   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'plldcc_clk_toggle'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/pll_dcc_cal.c:37: void plldcc_clk_toggle (void) BANKING_CTRL {
;	-----------------------------------------
;	 function plldcc_clk_toggle
;	-----------------------------------------
_plldcc_clk_toggle:
	ar2 = 0x02
	ar3 = 0x03
	...
	ar0 = 0x00
	ar1 = 0x01
;	../../shared/src/pll_dcc_cal.c:38: delay01(10);
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/pll_dcc_cal.c:39: PLLDCC_CLK = 1;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_182
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/pll_dcc_cal.c:40: TXRXIMP_CKCAL = 1;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_139
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/pll_dcc_cal.c:41: delay01(10);
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/pll_dcc_cal.c:42: PLLDCC_CLK = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_182
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/pll_dcc_cal.c:43: TXRXIMP_CKCAL = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_139
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
...
;------------------------------------------------------------
;Allocation info for local variables in function 'plldcc_cal'
;------------------------------------------------------------
;dcc_cnt                   Allocated to stack - offset 1
;latched_PLLDCC_DN         Allocated to registers r6 
...
;in_cont_mode              Allocated to registers r2 
;ext_en                    Allocated to registers r4 
;------------------------------------------------------------
;	../../shared/src/pll_dcc_cal.c:46: void plldcc_cal(void) BANKING_CTRL {
;	-----------------------------------------
;	 function plldcc_cal
;	-----------------------------------------
_plldcc_cal:
	...
	add	a,#0x04
	mov	sp,a
;	../../shared/src/pll_dcc_cal.c:56: PHY_STATUS = ST_PLLDCC_CAL;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x06
	movx	@dptr,a
;	../../shared/src/pll_dcc_cal.c:58: cmx_PLLDCC_CAL_DONE = 0;
	mov	dptr,#_CAL_STATUS_READ
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/pll_dcc_cal.c:60: in_cont_mode = 0;
	mov	r2,#0x00
;	../../shared/src/pll_dcc_cal.c:62: dir = 0;
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/pll_dcc_cal.c:63: reg_ANA_CMN_IMPCAL_OUT_REQ = 1;
	mov	dptr,#_CMN_CALIBRATION
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/pll_dcc_cal.c:66: if (lnx_CAL_DONE_LANE == 0) {                        //power-on calibration
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00111$
;	../../shared/src/pll_dcc_cal.c:67: ext_en = cmx_PLLDCC_CAL_EXT_EN;
	mov	dptr,#(_CONTROL_CONFIG1 + 0x0001)
	movx	a,@dptr
	rr	a
	anl	a,#0x01
;	../../shared/src/pll_dcc_cal.c:68: if (ext_en)                                     //use ext value for power-on, bypass calibration
	mov	r4,a
	jz	00102$
;	../../shared/src/pll_dcc_cal.c:69: dcc_cnt = cmx_cal_plldcc[PWR][PLL_RATE_SEL];
	...
	sjmp	00103$
00102$:
;	../../shared/src/pll_dcc_cal.c:71: cmx_PLLDCC_CAL_PASS = 0;
	mov	dptr,#(_CAL_STATUS_READ + 0x0001)
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/pll_dcc_cal.c:72: PLLDCCCAL_EN = 1;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_183
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/pll_dcc_cal.c:73: dcc_cnt = 0;
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x00
00103$:
;	../../shared/src/pll_dcc_cal.c:75: PLLDCC_EN = 1;                                  //enable PLLDCC_EN during power-on, never deassert
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_181
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/pll_dcc_cal.c:76: plldcc_step_cnt = PLLDCC_CAL_STEP_SIZE;             //for power-on (inc. EXT_EN), reset fraction code to middle
	...
	sjmp	00167$
00111$:
;	../../shared/src/pll_dcc_cal.c:78: else if (LOAD_CAL_ON) {                         //not power-on. Speed-change, load result for current rate
	mov	dptr,#_CAL_CTRL3_LANE
	movx	a,@dptr
	jz	00108$
;	../../shared/src/pll_dcc_cal.c:80: dcc_cnt = cmx_cal_plldcc[PWR + cmx_PLLDCC_CAL_CONT_CUR_LOAD_EN][PLL_RATE_SEL];
	...
	inc	r0
	mov	@r0,ar5
;	../../shared/src/pll_dcc_cal.c:81: plldcc_step_cnt = PLLDCC_CAL_STEP_SIZE;             //when speed change, restore the fracition code to middle
	mov	dptr,#_CON_CAL_STEP_SIZE3
	movx	a,@dptr
	mov	r5,a
	mov	dptr,#_plldcc_step_cnt
	...
	sjmp	00167$
00108$:
;	../../shared/src/pll_dcc_cal.c:83: else if (cmx_PLLDCC_CAL_CONT_EN) {              //not power-on. Continious mode.
	mov	dptr,#(_CONTROL_CONFIG2 + 0x0002)
	movx	a,@dptr
	jnb	acc.4,00105$
;	../../shared/src/pll_dcc_cal.c:84: PLLDCCCAL_EN = 1;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_183
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/pll_dcc_cal.c:85: dcc_cnt = cmx_cal_plldcc[CONT][PLL_RATE_SEL];    //always load cont result
	mov	dptr,#(_CONTROL_CONFIG6 + 0x0002)
	movx	a,@dptr
	add	a,#(_cmx_cal_plldcc + 0x0002)
	mov	dpl,a
	clr	a
	addc	a,#((_cmx_cal_plldcc + 0x0002) >> 8)
	mov	dph,a
	movx	a,@dptr
	mov	r5,a
	mov	r0,_bp
	inc	r0
	mov	@r0,ar5
;	../../shared/src/pll_dcc_cal.c:86: in_cont_mode = 1;
	mov	r2,#0x01
	sjmp	00167$
00105$:
;	../../shared/src/pll_dcc_cal.c:89: cmx_PLLDCC_CAL_DONE = 1;
	mov	dptr,#_CAL_STATUS_READ
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/pll_dcc_cal.c:90: return;
	ljmp	00149$
;	../../shared/src/pll_dcc_cal.c:94: do {
00167$:
	mov	r5,#0x00
00144$:
;	../../shared/src/pll_dcc_cal.c:95: PLLDCC_CNT = dcc_cnt;
	mov	r0,_bp
	inc	r0
	mov	ar6,@r0
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_182
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/pll_dcc_cal.c:96: plldcc_clk_toggle();
	push	ar2
	push	ar5
	mov	r0,#_plldcc_clk_toggle
	mov	r1,#(_plldcc_clk_toggle >> 8)
	mov	r2,#(_plldcc_clk_toggle >> 16)
	lcall	__sdcc_banked_call
	pop	ar5
	pop	ar2
;	../../shared/src/pll_dcc_cal.c:98: time_out_cnt ++;
	inc	r5
;	../../shared/src/pll_dcc_cal.c:99: if( PLLDCCCAL_EN == 0 ) break;                                       //either LOAD, or EXT_EN in power-on
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_183
	movx	a,@dptr
	jb	acc.7,00174$
	ljmp	00146$
00174$:
;	../../shared/src/pll_dcc_cal.c:100: if( lnx_CAL_DONE_LANE == 1 && time_out_cnt > 1) break;                    //continious mode, has ran 1 round
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0x01
	mov	r6,a
...
00178$:
00116$:
;	../../shared/src/pll_dcc_cal.c:101: if( lnx_CAL_DONE_LANE == 0 && is_toggle_pat( dir, time_out_cnt - 1 ) ) { cmx_PLLDCC_CAL_PASS = 1;  break; }     //power-on, toggled
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00119$
	mov	a,r5
	...
	ljmp	00146$
00119$:
;	../../shared/src/pll_dcc_cal.c:102: if( lnx_CAL_DONE_LANE == 0 && time_out_cnt >= PLLDCC_LOOP_MAX && cmx_PLLDCC_CAL_TIMEOUT_DIS == 0) break;     //power-on, reached maximum rounds
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00122$
	cjne	r5,#0x40,00182$
...
00184$:
00122$:
;	../../shared/src/pll_dcc_cal.c:104: latched_PLLDCC_DN = PLLDCC_DN;
	mov	dptr,#_CMN_CALIBRATION
	movx	a,@dptr
	swap	a
	rl	a
	anl	a,#0x01
	mov	r6,a
;	../../shared/src/pll_dcc_cal.c:105: reg_MCU_DEBUG_CMN_2_7_0 = latched_PLLDCC_DN; //for testbench
	mov	dptr,#(_MCU_DEBUG0 + 0x0002)
	mov	a,r6
	movx	@dptr,a
;	../../shared/src/pll_dcc_cal.c:106: int_up = 0;
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/pll_dcc_cal.c:107: int_dn = 0;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/pll_dcc_cal.c:109: if (in_cont_mode) { //continious calibration
	mov	a,r2
	jz	00137$
;	../../shared/src/pll_dcc_cal.c:110: if (latched_PLLDCC_DN) {plldcc_step_cnt--;}
	mov	a,r6
	jz	00126$
	mov	dptr,#_plldcc_step_cnt
	movx	a,@dptr
	...
	sjmp	00127$
00126$:
;	../../shared/src/pll_dcc_cal.c:111: else                   {plldcc_step_cnt++;}
	mov	dptr,#_plldcc_step_cnt
	movx	a,@dptr
	add	a,#0x01
	movx	@dptr,a
00127$:
;	../../shared/src/pll_dcc_cal.c:113: if( plldcc_step_cnt == 0) {
	mov	dptr,#_plldcc_step_cnt
	movx	a,@dptr
	mov	r7,a
	jnz	00131$
;	../../shared/src/pll_dcc_cal.c:114: int_up = 0;
	push	ar2
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/pll_dcc_cal.c:115: int_dn = 1;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x01
;	../../shared/src/pll_dcc_cal.c:116: plldcc_step_cnt = PLLDCC_CAL_STEP_SIZE;  //after up/dn triggered, reset fraction code to middle
	mov	dptr,#_CON_CAL_STEP_SIZE3
	movx	a,@dptr
	mov	dptr,#_plldcc_step_cnt
	movx	@dptr,a
	...
	sjmp	00138$
00131$:
;	../../shared/src/pll_dcc_cal.c:118: else if(plldcc_step_cnt>=(PLLDCC_CAL_STEP_SIZE<<1)) {
	push	ar2
	mov	dptr,#_CON_CAL_STEP_SIZE3
	movx	a,@dptr
	mov	r2,a
	...
	pop	ar2
	jc	00138$
;	../../shared/src/pll_dcc_cal.c:119: int_up = 1;
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	@r0,#0x01
;	../../shared/src/pll_dcc_cal.c:120: int_dn = 0;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/pll_dcc_cal.c:121: plldcc_step_cnt = PLLDCC_CAL_STEP_SIZE;  //after up/dn triggered, reset fraction code to middle
	mov	dptr,#_CON_CAL_STEP_SIZE3
	movx	a,@dptr
	mov	r3,a
	mov	dptr,#_plldcc_step_cnt
	...
	sjmp	00138$
00137$:
;	../../shared/src/pll_dcc_cal.c:125: if (latched_PLLDCC_DN) {int_up = 0; int_dn = 1;}
	mov	a,r6
	jz	00134$
	mov	a,_bp
	add	a,#0x03
	...
	sjmp	00138$
00134$:
;	../../shared/src/pll_dcc_cal.c:126: else                   {int_up = 1; int_dn = 0;}
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	@r0,#0x01
	...
	mov	@r0,#0x00
00138$:
;	../../shared/src/pll_dcc_cal.c:129: dir<<=1;
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,@r0
	add	a,acc
	mov	@r0,a
;	../../shared/src/pll_dcc_cal.c:130: if (int_dn == 1) {
	mov	r0,_bp
	inc	r0
	inc	r0
	cjne	@r0,#0x01,00142$
;	../../shared/src/pll_dcc_cal.c:131: dcc_cnt = sign_abs_dn(dcc_cnt);
	mov	r0,_bp
	inc	r0
	mov	dpl,@r0
	push	ar2
	...
	ljmp	00144$
00142$:
;	../../shared/src/pll_dcc_cal.c:133: else if (int_up == 1) {
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	cjne	@r0,#0x01,00192$
...
00192$:
	ljmp	00144$
00193$:
;	../../shared/src/pll_dcc_cal.c:134: dir |= 1;
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,@r0
	orl	a,#0x01
	mov	@r0,a
;	../../shared/src/pll_dcc_cal.c:135: dcc_cnt = sign_abs_up(dcc_cnt);
	mov	r0,_bp
	inc	r0
	mov	dpl,@r0
	push	ar2
	...
	inc	r0
	mov	@r0,ar3
;	../../shared/src/pll_dcc_cal.c:138: } while (1);
	ljmp	00144$
00146$:
;	../../shared/src/pll_dcc_cal.c:141: if (lnx_CAL_DONE_LANE == 0) {                        //if power-on calibration
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00148$
;	../../shared/src/pll_dcc_cal.c:142: cmx_cal_plldcc[PWR][PLL_RATE_SEL] = dcc_cnt;   //save to power-on result
	mov	dptr,#(_CONTROL_CONFIG6 + 0x0002)
	movx	a,@dptr
	mov	r2,a
	add	a,#_cmx_cal_plldcc
	...
	movx	@dptr,a
00148$:
;	../../shared/src/pll_dcc_cal.c:144: cmx_cal_plldcc[CONT][PLL_RATE_SEL] = dcc_cnt;    //no matter power-on or LOAD or continious, need to save to [CONT]
	mov	dptr,#(_CONTROL_CONFIG6 + 0x0002)
	movx	a,@dptr
	mov	r2,a
	add	a,#(_cmx_cal_plldcc + 0x0002)
	...
	mov	a,@r0
	movx	@dptr,a
;	../../shared/src/pll_dcc_cal.c:146: PLLDCCCAL_EN = 0;
	mov	dptr,#_UPHY14_CMN_ANAREG_TOP_183
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/pll_dcc_cal.c:147: cmx_PLLDCC_CAL_DONE = 1;
	mov	dptr,#_CAL_STATUS_READ
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
