...
;	../../shared/src/train_if.c:294: reg_REMOTE_STATUS_VALID_ISR_CLEAR_LANE = 0;
	...
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/train_if.c:312: if( tx_pipe4_en && reg_EYE_OPEN_EN_RD_LANE ) {
	jnb	_tx_pipe4_en,00104$
	mov	dptr,#(_TX_TRAIN_CTRL_LANE + 0x0003)
	movx	a,@dptr
	jnb	acc.6,00104$
;	../../shared/src/train_if.c:313: reg_EYE_OPEN_LANE_5_0 = train.eo;
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/train_if.c:314: reg_LOCAL_CTRL_FIELD_VALID_LANE = 1; 
;	../../shared/src/train_if.c:315: reg_LOCAL_CTRL_FIELD_VALID_LANE = 0;
	mov	dptr,#(_TX_TRAIN_CTRL_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
