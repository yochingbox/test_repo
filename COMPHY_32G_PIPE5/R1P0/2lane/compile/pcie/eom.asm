...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'Check_EOM_Stage_fmExt'
;------------------------------------------------------------
;checked_val               Allocated to registers r2 
;i                         Allocated to stack - offset 1
;new_esm_ph                Allocated to registers r2 r3 
;dec_ratio                 Allocated to registers r2 
;eom_pop_cnt_p_shifted     Allocated to stack - offset 2
;sloc0                     Allocated to stack - offset 10
;sloc1                     Allocated to stack - offset 6
;------------------------------------------------------------
;	../../shared/src/eom.c:13: void Check_EOM_Stage_fmExt(void)
;	-----------------------------------------
;	 function Check_EOM_Stage_fmExt
;	-----------------------------------------
_Check_EOM_Stage_fmExt:
	ar2 = 0x02
	ar3 = 0x03
	ar4 = 0x04
	ar5 = 0x05
	...
	add	a,#0x07
	mov	sp,a
;	../../shared/src/eom.c:22: dec_ratio = reg_RX_SPEED_DIV_LANE_2_0&0x03;
	...
	mov	r2,a
	anl	ar2,#0x03
;	../../shared/src/eom.c:24: if(lnx_ESM_EN_LANE==1 && lnx_EOM_READY_LANE==0)
...
00165$:
	...
	ljmp	00116$
00166$:
;	../../shared/src/eom.c:26: dfe_hardware_cont_stop();
	push	ar2
	...
	pop	ar2
;	../../shared/src/eom.c:30: save_pu_f1p_s_o = reg_PU_F1P_S_O_LANE; 
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_24
	movx	a,@dptr
	swap	a
	rr	a
	anl	a,#0x01
	mov	dptr,#_save_pu_f1p_s_o
	movx	@dptr,a
;	../../shared/src/eom.c:31: save_pu_f1p_s_e = reg_PU_F1P_S_E_LANE; 
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_23
	movx	a,@dptr
	rr	a
	anl	a,#0x01
	mov	dptr,#_save_pu_f1p_s_e
	movx	@dptr,a
;	../../shared/src/eom.c:32: save_dfe_adapt_splr = reg_DFE_ADAPT_SPLR_EN_LANE_3_0; 
	...
	movx	@dptr,a
;	../../shared/src/eom.c:35: save_eom_en_s = reg_EOM_EN_S_LANE;
	...
	movx	@dptr,a
;	../../shared/src/eom.c:36: save_eom_en_d = reg_EOM_EN_D_LANE;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_22
	movx	a,@dptr
	swap	a
	rr	a
	...
	movx	@dptr,a
;	../../shared/src/eom.c:37: save_dfe_en = reg_DFE_EN_LANE;
	...
	movx	@dptr,a
;	../../shared/src/eom.c:39: save_dfe_dis = dfe_dis;
	mov	dptr,#_dfe_dis
	movx	a,@dptr
	mov	r3,a
	mov	dptr,#_save_dfe_dis
	movx	@dptr,a
;	../../shared/src/eom.c:41: dfe_dis = 0;
	mov	dptr,#_dfe_dis
	clr	a
	movx	@dptr,a
;	../../shared/src/eom.c:45: if( dec_ratio == 0x3) {
	cjne	r2,#0x03,00104$
;	../../shared/src/eom.c:46: reg_PU_F1P_S_O_LANE = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_24
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
	sjmp	00105$
00104$:
;	../../shared/src/eom.c:50: else if( dec_ratio == 0x2) {
	cjne	r2,#0x02,00105$
;	../../shared/src/eom.c:51: reg_PU_F1P_S_E_LANE = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_23
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
00105$:
;	../../shared/src/eom.c:64: if(lnx_ESM_PATH_SEL_LANE) { 
	mov	dptr,#(_TRAIN_CONTROL_2 + 0x0002)
	movx	a,@dptr
	jnb	acc.0,00113$
;	../../shared/src/eom.c:67: adapt_slicer_en = 1; adapt_data_en = 0;
	setb	_adapt_slicer_en
	clr	_adapt_data_en
;	../../shared/src/eom.c:68: if(dec_ratio == 0)
	mov	a,r2
	jnz	00107$
;	../../shared/src/eom.c:69: reg_DFE_ADAPT_SPLR_EN_LANE_3_0 = 0xc; 
	mov	dptr,#_DFE_CTRL_REG0
	movx	a,@dptr
	anl	a,#0x0f
	orl	a,#0xc0
	...
	sjmp	00114$
00107$:
;	../../shared/src/eom.c:71: reg_DFE_ADAPT_SPLR_EN_LANE_3_0 = 0x8; 
	mov	dptr,#_DFE_CTRL_REG0
	movx	a,@dptr
	anl	a,#0x0f
	orl	a,#0x80
	...
	sjmp	00114$
00113$:
;	../../shared/src/eom.c:75: adapt_slicer_en = 0; adapt_data_en = 1;
	clr	_adapt_slicer_en
	setb	_adapt_data_en
;	../../shared/src/eom.c:76: if(dec_ratio == 0)
	mov	a,r2
	jnz	00110$
;	../../shared/src/eom.c:77: reg_DFE_ADAPT_SPLR_EN_LANE_3_0 = 0x3; 
	mov	dptr,#_DFE_CTRL_REG0
	movx	a,@dptr
	anl	a,#0x0f
	orl	a,#0x30
	...
	sjmp	00114$
00110$:
;	../../shared/src/eom.c:79: reg_DFE_ADAPT_SPLR_EN_LANE_3_0 = 0x2; 
	mov	dptr,#_DFE_CTRL_REG0
	movx	a,@dptr
	anl	a,#0x0f
	orl	a,#0x20
	movx	@dptr,a
00114$:
;	../../shared/src/eom.c:82: reg_DFE_UPDATE_EN_LANE_15_0 = 0;
	mov	dptr,#_DFE_CTRL_REG2
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	../../shared/src/eom.c:83: reg_DFE_UPDATE_F_EN_LANE_5_0 = 0;
	mov	dptr,#(_DFE_CTRL_REG2 + 0x0002)
	movx	a,@dptr
	anl	a,#0xc0
	movx	@dptr,a
;	../../shared/src/eom.c:84: reg_DFE_UPDATE_DC_EN_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG2 + 0x0002)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/eom.c:85: pol_table_loop_num_1_0 = 2; pol_table_loop_num_9_2 = 2; //10
	...
	mov	a,#0x02
	movx	@dptr,a
;	../../shared/src/eom.c:86: dfe_adapt_lpnum_3_0 = 5; dfe_adapt_lpnum_9_4 = 0; //5
	...
	anl	a,#0xc0
	movx	@dptr,a
;	../../shared/src/eom.c:89: dfe_save(); //save f0
	mov	r0,#_dfe_save
	mov	r1,#(_dfe_save >> 8)
	mov	r2,#(_dfe_save >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/eom.c:102: eom_align_cal(); 
	mov	r0,#_eom_align_cal
	mov	r1,#(_eom_align_cal >> 8)
	mov	r2,#(_eom_align_cal >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/eom.c:107: cal_eom_dpher = reg_EOM_DPHER_LANE_6_0;
	...
	movx	@dptr,a
;	../../shared/src/eom.c:108: PHY_STATUS = ST_NORMAL; 
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x2B
	movx	@dptr,a
;	../../shared/src/eom.c:112: EOM_EN_D = adapt_data_en==1? 1: tag_EOM_DRIVE_DATA_EN_MODE1; //0
	...
	mov	acc.5,c
	movx	@dptr,a
;	../../shared/src/eom.c:113: EOM_EN_S = adapt_slicer_en==1? 1: tag_EOM_DRIVE_DATA_EN_MODE1; 
	...
	mov	acc.6,c
	movx	@dptr,a
;	../../shared/src/eom.c:114: EOM_EN_E = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_22
	movx	a,@dptr
	anl	a,#0xef
	movx	@dptr,a
;	../../shared/src/eom.c:116: EOM_clock_analog_align();
	mov	r0,#_EOM_clock_analog_align
	mov	r1,#(_EOM_clock_analog_align >> 8)
	mov	r2,#(_EOM_clock_analog_align >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/eom.c:123: eye_check_en = 1;		
	mov	dptr,#_EOM_REG0
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/eom.c:125: lnx_ESM_PHASE_LANE_9_0_b1 = 0; lnx_ESM_PHASE_LANE_9_0_b0 = 0;  cur_esm_phase = 0;
	mov	dptr,#(_TRAIN_CONTROL_2 + 0x0001)
	movx	a,@dptr
	anl	a,#0xfc
	movx	@dptr,a
	mov	dptr,#_TRAIN_CONTROL_2
	clr	a
	movx	@dptr,a
	mov	dptr,#_cur_esm_phase
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	../../shared/src/eom.c:127: eom_ext_mode = 1;
	mov	dptr,#_eom_ext_mode
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/eom.c:128: lnx_EOM_READY_LANE = 1;  //release
	mov	dptr,#_DFE_CONTROL_1
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/eom.c:133: return;
	ljmp	00137$
00116$:
;	../../shared/src/eom.c:136: if(lnx_ESM_EN_LANE==1 && lnx_EOM_READY_LANE==1 && lnx_EOM_DFE_CALL_LANE==1)
	mov	dptr,#(_TRAIN_CONTROL_2 + 0x0002)
	movx	a,@dptr
	rr	a
	rr	a
...
00178$:
	ljmp	00125$
00179$:
;	../../shared/src/eom.c:138: if(lnx_ESM_PHASE_LANE_9_0_b1 & 0x02) {
	mov	dptr,#(_TRAIN_CONTROL_2 + 0x0001)
	movx	a,@dptr
	anl	a,#0x03
	mov	r2,a
	jnb	acc.1,00119$
;	../../shared/src/eom.c:139: new_esm_ph = 0xfc00 |  (lnx_ESM_PHASE_LANE_9_0_b1<<8) | lnx_ESM_PHASE_LANE_9_0_b0; 
	mov	dptr,#(_TRAIN_CONTROL_2 + 0x0001)
	movx	a,@dptr
	anl	a,#0x03
	mov	r3,a
	...
	sjmp	00120$
00119$:
;	../../shared/src/eom.c:142: new_esm_ph = (lnx_ESM_PHASE_LANE_9_0_b1<<8) | lnx_ESM_PHASE_LANE_9_0_b0;
	mov	dptr,#(_TRAIN_CONTROL_2 + 0x0001)
	movx	a,@dptr
	anl	a,#0x03
	mov	r5,a
	...
	mov	ar3,r5
00120$:
;	../../shared/src/eom.c:149: move_eom_phase(new_esm_ph - cur_esm_phase);
	mov	dptr,#_cur_esm_phase
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	pop	ar3
	pop	ar2
;	../../shared/src/eom.c:150: cur_esm_phase = new_esm_ph;
	mov	dptr,#_cur_esm_phase
	mov	a,r2
	movx	@dptr,a
	inc	dptr
	mov	a,r3
	movx	@dptr,a
;	../../shared/src/eom.c:156: lnx_EOM_ERR_P_CNT_LANE_39_32 = 0;
	mov	dptr,#_ESM_ERR_POP_CNT_HIGH_LANE
;	../../shared/src/eom.c:157: ESM_ERR_P_CNT_LOW_LANE.VAL = 0;
	clr	a
	movx	@dptr,a
	mov	dptr,#_ESM_ERR_P_CNT_LOW_LANE
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
	inc	dptr
	...
	inc	dptr
	movx	@dptr,a
;	../../shared/src/eom.c:158: lnx_EOM_POP_P_CNT_LANE_39_32 = 0;
	mov	dptr,#(_ESM_ERR_POP_CNT_HIGH_LANE + 0x0002)
;	../../shared/src/eom.c:159: ESM_POP_P_CNT_LOW_LANE.VAL = 0;
	clr	a
	movx	@dptr,a
	mov	dptr,#_ESM_POP_P_CNT_LOW_LANE
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
	inc	dptr
	...
	inc	dptr
	movx	@dptr,a
;	../../shared/src/eom.c:161: lnx_EOM_ERR_N_CNT_LANE_39_32 = 0;
	mov	dptr,#(_ESM_ERR_POP_CNT_HIGH_LANE + 0x0001)
;	../../shared/src/eom.c:162: ESM_ERR_N_CNT_LOW_LANE.VAL = 0;
	clr	a
	movx	@dptr,a
	mov	dptr,#_ESM_ERR_N_CNT_LOW_LANE
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
	inc	dptr
	...
	inc	dptr
	movx	@dptr,a
;	../../shared/src/eom.c:163: lnx_EOM_POP_N_CNT_LANE_39_32 = 0;
	mov	dptr,#(_ESM_ERR_POP_CNT_HIGH_LANE + 0x0003)
;	../../shared/src/eom.c:164: ESM_POP_N_CNT_LOW_LANE.VAL = 0;
	clr	a
	movx	@dptr,a
	mov	dptr,#_ESM_POP_N_CNT_LOW_LANE
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
	inc	dptr
	...
	inc	dptr
	movx	@dptr,a
;	../../shared/src/eom.c:166: checked_val = lnx_EOM_BER_LANE_3_0;
	mov	dptr,#(_CDS_CTRL_REG1 + 0x0001)
	movx	a,@dptr
	anl	a,#0x0f
	mov	r2,a
;	../../shared/src/eom.c:168: checked_val = ( checked_val < 3 ) ? 3 : ( ( checked_val > 0xc ) ? 0xC : checked_val );
	cjne	r2,#0x03,00181$
00181$:
	jnc	00139$
	mov	r3,#0x03
...
;	../../shared/src/eom.c:169: do{
	...
	add	a,r2
	add	a,acc
	add	a,#_eom_pop_threhold
	mov	r2,a
	clr	a
	addc	a,#(_eom_pop_threhold >> 8)
	mov	r3,a
00121$:
;	../../shared/src/eom.c:170: cds_tb = cds_table[CDS_EYECHECK];
	...
	mov	a,r5
	movx	@dptr,a
;	../../shared/src/eom.c:171: cdr_dfe_scheme();
	push	ar2
	push	ar3
	...
	pop	ar3
	pop	ar2
;	../../shared/src/eom.c:173: for (i =0; i<2; i++)
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x00
00133$:
...
00185$:
	...
	ljmp	00136$
00186$:
;	../../shared/src/eom.c:176: lnx_EOM_ERR_P_CNT_LANE_39_32 = lnx_EOM_ERR_P_CNT_LANE_39_32 + sum_32((uint32_t*)&ESM_ERR_P_CNT_LOW_LANE, (uint32_t*)((&EOM_ERR_REG0)+i*2));
	push	ar2
	push	ar3
	mov	dptr,#_ESM_ERR_POP_CNT_HIGH_LANE
	movx	a,@dptr
	...
	mov	dptr,#_ESM_ERR_POP_CNT_HIGH_LANE
	movx	@dptr,a
;	../../shared/src/eom.c:177: lnx_EOM_POP_P_CNT_LANE_39_32 = lnx_EOM_POP_P_CNT_LANE_39_32 + sum_32((uint32_t*)&ESM_POP_P_CNT_LOW_LANE, (uint32_t*)((&EOM_VLD_REG0)+i*2));
	mov	dptr,#(_ESM_ERR_POP_CNT_HIGH_LANE + 0x0002)
	movx	a,@dptr
	mov	r2,a
	mov	a,r6
	...
	mov	a,r3
	add	a,r2
;	../../shared/src/eom.c:178: lnx_EOM_POP_P_CNT_LANE_39_32 = lnx_EOM_POP_P_CNT_LANE_39_32 + *((uint8_t*)((&EOM_VLD_REG4) + i + 1));
	mov	dptr,#(_ESM_ERR_POP_CNT_HIGH_LANE + 0x0002)
	movx	@dptr,a
	movx	a,@dptr
	mov	r4,a
	...
	mov	dptr,#(_ESM_ERR_POP_CNT_HIGH_LANE + 0x0002)
	movx	@dptr,a
;	../../shared/src/eom.c:181: lnx_EOM_ERR_N_CNT_LANE_39_32 = lnx_EOM_ERR_N_CNT_LANE_39_32 + sum_32((uint32_t*)&ESM_ERR_N_CNT_LOW_LANE, (uint32_t*)((&EOM_ERR_REG1)+i*2));
	mov	dptr,#(_ESM_ERR_POP_CNT_HIGH_LANE + 0x0001)
	movx	a,@dptr
	mov	r4,a
	mov	a,r6
	...
	mov	dptr,#(_ESM_ERR_POP_CNT_HIGH_LANE + 0x0001)
	movx	@dptr,a
;	../../shared/src/eom.c:182: lnx_EOM_POP_N_CNT_LANE_39_32 = lnx_EOM_POP_N_CNT_LANE_39_32 + sum_32((uint32_t*)&ESM_POP_N_CNT_LOW_LANE, (uint32_t*)((&EOM_VLD_REG1)+i*2));
	mov	dptr,#(_ESM_ERR_POP_CNT_HIGH_LANE + 0x0003)
	movx	a,@dptr
	mov	r2,a
	mov	a,r6
	...
	mov	a,r3
	add	a,r2
;	../../shared/src/eom.c:183: lnx_EOM_POP_N_CNT_LANE_39_32 = lnx_EOM_POP_N_CNT_LANE_39_32 + *((uint8_t*)((&EOM_VLD_REG4) + i));
	mov	dptr,#(_ESM_ERR_POP_CNT_HIGH_LANE + 0x0003)
	movx	@dptr,a
	movx	a,@dptr
	mov	r2,a
...
;	../../shared/src/eom.c:173: for (i =0; i<2; i++)
	...
	ljmp	00133$
00136$:
;	../../shared/src/eom.c:186: eom_pop_cnt_p_shifted = (uint32_t)lnx_EOM_POP_P_CNT_LANE_39_32;
	mov	dptr,#(_ESM_ERR_POP_CNT_HIGH_LANE + 0x0002)
	movx	a,@dptr
	mov	r4,a
	mov	r0,_bp
	...
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/eom.c:187: eom_pop_cnt_p_shifted = eom_pop_cnt_p_shifted << 24;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	a,@r0
	...
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/eom.c:188: eom_pop_cnt_p_shifted = eom_pop_cnt_p_shifted | (ESM_POP_P_CNT_LOW_LANE.VAL >> 8);
	mov	dptr,#_ESM_POP_P_CNT_LOW_LANE
	movx	a,@dptr
	inc	dptr
	movx	a,@dptr
	...
	orl	a,@r0
	mov	@r0,a
;	../../shared/src/eom.c:195: }while(eom_pop_cnt_p_shifted < eom_pop_threhold[ checked_val - 3 ]);// || eom_pop_cnt_n_shifted < eom_pop_threhold[ checked_val - 3 ]); // to save code size only use p cnt
	mov	dpl,r2
	mov	dph,r3
	clr	a
	movc	a,@a+dptr
	...
	ljmp	00121$
00187$:
;	../../shared/src/eom.c:196: lnx_EOM_DFE_CALL_LANE = 0;
	mov	dptr,#_DFE_CONTROL_1
	movx	a,@dptr
	anl	a,#0xef
	movx	@dptr,a
;	../../shared/src/eom.c:204: return;
	ljmp	00137$
00125$:
;	../../shared/src/eom.c:207: if( eom_ext_mode==1 && lnx_ESM_EN_LANE==0 )
	mov	dptr,#_eom_ext_mode
	movx	a,@dptr
	mov	r2,a
	cjne	r2,#0x01,00188$
...
00189$:
	...
	ljmp	00137$
00190$:
;	../../shared/src/eom.c:210: eye_check_en = 0;
	mov	dptr,#_EOM_REG0
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/eom.c:211: lnx_EOM_READY_LANE = 0;
	mov	dptr,#_DFE_CONTROL_1
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/eom.c:212: lnx_EOM_DFE_CALL_LANE = 0;
	mov	dptr,#_DFE_CONTROL_1
	movx	a,@dptr
	anl	a,#0xef
	movx	@dptr,a
;	../../shared/src/eom.c:213: eom_ext_mode = 0;
	mov	dptr,#_eom_ext_mode
	clr	a
	movx	@dptr,a
;	../../shared/src/eom.c:216: reg_EOM_EN_S_LANE = save_eom_en_s;
	mov	dptr,#_save_eom_en_s
	movx	a,@dptr
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_22
	rrc	a
	...
	mov	acc.6,c
	movx	@dptr,a
;	../../shared/src/eom.c:217: reg_EOM_EN_D_LANE = save_eom_en_d;
	mov	dptr,#_save_eom_en_d
	movx	a,@dptr
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_22
	rrc	a
	...
	mov	acc.5,c
	movx	@dptr,a
;	../../shared/src/eom.c:220: eom_align_cal(); 
	mov	r0,#_eom_align_cal
	mov	r1,#(_eom_align_cal >> 8)
	mov	r2,#(_eom_align_cal >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/eom.c:225: reg_PU_F1P_S_O_LANE = save_pu_f1p_s_o; 
	mov	dptr,#_save_pu_f1p_s_o
	movx	a,@dptr
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_24
	rrc	a
	...
	mov	acc.5,c
	movx	@dptr,a
;	../../shared/src/eom.c:226: reg_PU_F1P_S_E_LANE = save_pu_f1p_s_e;
	mov	dptr,#_save_pu_f1p_s_e
	movx	a,@dptr
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_23
	rrc	a
	...
	mov	acc.1,c
	movx	@dptr,a
;	../../shared/src/eom.c:227: reg_DFE_ADAPT_SPLR_EN_LANE_3_0 = save_dfe_adapt_splr; 
	mov	dptr,#_save_dfe_adapt_splr
	movx	a,@dptr
	mov	dptr,#_DFE_CTRL_REG0
	swap	a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/eom.c:230: reg_DFE_EN_LANE = save_dfe_en;
	mov	dptr,#_save_dfe_en
	movx	a,@dptr
	mov	dptr,#_RX_EQ_CLK_CTRL
	rrc	a
	...
	mov	acc.4,c
	movx	@dptr,a
;	../../shared/src/eom.c:231: dfe_dis = save_dfe_dis;
	mov	dptr,#_save_dfe_dis
	movx	a,@dptr
	mov	dptr,#_dfe_dis
	movx	@dptr,a
;	../../shared/src/eom.c:236: dfe_load_type(2);
	mov	dpl,#0x02
	mov	r0,#_dfe_load_type
	mov	r1,#(_dfe_load_type >> 8)
	mov	r2,#(_dfe_load_type >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/eom.c:239: if(lnx_PHASE_ADAPT_ENABLE_LANE==0) 
	mov	dptr,#_DFE_CONTROL_5
	movx	a,@dptr
	jb	acc.5,00137$
;	../../shared/src/eom.c:240: dfe_hardware_cont_run();
...
00137$:
	...
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'sum_32'
;------------------------------------------------------------
;cnt                       Allocated to stack - offset -5
;accumulator               Allocated to stack - offset 1
;sloc0                     Allocated to stack - offset 4
;sloc1                     Allocated to stack - offset 8
;------------------------------------------------------------
;	../../shared/src/eom.c:245: uint8_t sum_32(uint32_t * accumulator, uint32_t * cnt) {
;	-----------------------------------------
;	 function sum_32
;	-----------------------------------------
_sum_32:
	...
	add	a,#0x0b
	mov	sp,a
;	../../shared/src/eom.c:246: *accumulator = *accumulator + *cnt;
	mov	r0,_bp
	inc	r0
	mov	dpl,@r0
	inc	r0
	...
	mov	a,r3
	lcall	__gptrput
;	../../shared/src/eom.c:247: if (*accumulator < *cnt)    //overflow
	mov	a,_bp
	add	a,#0x08
	mov	r0,a
	clr	c
	...
	subb	a,@r0
	jnc	00102$
;	../../shared/src/eom.c:248: return 1;
	mov	dpl,#0x01
	sjmp	00104$
00102$:
;	../../shared/src/eom.c:250: return 0;
	mov	dpl,#0x00
00104$:
	mov	sp,_bp
	pop	_bp
...
_eom_pop_threhold:
	...
	.byte #0x87,#0x01,#0x00,#0x00	; 391
	.byte #0x43,#0x0F,#0x00,#0x00	; 3907
	.byte #0x96,#0x98,#0x00,#0x00	; 39062
	.byte #0xE2,#0xF5,#0x05,#0x00	; 390626
	.byte #0xCB,#0x9A,#0x3B,#0x00	; 3906251
	.byte #0xE5,#0x0B,#0x54,#0x02	; 39062501
	.byte #0xE8,#0x76,#0x48,#0x17	; 390625000
	.byte #0x11,#0xA5,#0xD4,#0xE8	; 3906250001
	.area CABS    (ABS,CODE)
