...
; This file was generated Thu Oct 18 21:21:30 2018
;--------------------------------------------------------
	.module power_pcie
...
;--------------------------------------------------------
	...
	.globl _Power_P1_P0
	.globl _Power_P2_P0
	.globl _Power_P1CLKREQ_P1
	.globl _P0Off_TXDETRX
	.globl _Power_P0_TXDETRX
	.globl _Power_P1_TXDETRX
	.globl _Power_P2_TXDETRX
	.globl _Power_P2_BEACON
	.globl _txloz2hiz
	.globl _txhiz2loz
	.globl _txloz2hiz_quick
	.globl _txdetrx
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area BANK1   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'Power_P0s_P1'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_pcie.c:29: void Power_P0s_P1( void ) BANKING_CTRL {
;	-----------------------------------------
;	 function Power_P0s_P1
;	-----------------------------------------
_Power_P0s_P1:
	ar2 = 0x02
	ar3 = 0x03
	...
	ar0 = 0x00
	ar1 = 0x01
;	../../shared/src/power_pcie.c:39: reg_PIN_PLL_READY_RX_LANE = 0;
;	../../shared/src/power_pcie.c:41: reg_DTL_CLK_OFF_LANE = 1;
	...
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/power_pcie.c:42: reg_DFE_CLK_OFF_LANE = 1;
	mov	dptr,#_RX_EQ_CLK_CTRL
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/power_pcie.c:43: reg_RESET_DTL_LANE = 1;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/power_pcie.c:44: CKCON = 0x07 ;  //MCU WAIT time the slowest
	mov	_CKCON,#0x07
;	../../shared/src/power_pcie.c:45: reg_RESET_DFE_LANE = 1;
	mov	dptr,#_RX_EQ_CLK_CTRL
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/power_pcie.c:46: CKCON = 0x00 ; //MCU WAIT time setting back to normal.
	mov	_CKCON,#0x00
;	../../shared/src/power_pcie.c:49: if(reg_PIN_TX_IDLE_HIZ_RD_LANE) {
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	jnb	acc.3,00102$
;	../../shared/src/power_pcie.c:50: reg_ANA_TX_LESS_CUR_IDLE_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power_pcie.c:51: short_delay(); //delay01(1);
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	mov	r2,#(_short_delay >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:52: reg_ANA_TX_IDLE_HIZ_EN_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
00102$:
;	../../shared/src/power_pcie.c:56: reg_FFE_PULSE_EN_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_131
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/power_pcie.c:57: reg_ANA_PU_RX_LANE = 0;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/power_pcie.c:58: reg_ANA_PU_RX_DLY_LANE = 0;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/power_pcie.c:59: reg_ANA_RX_PU_DLY2_LANE = 0;
	mov	dptr,#_INPUT_RX_PIN_REG3_LANE
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/power_pcie.c:61: if( reg_PIN_PU_PLL_RD_LANE == 0) {
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.5,00109$
;	../../shared/src/power_pcie.c:62: PHY_STATUS = ST_P2;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x21
	movx	@dptr,a
;	../../shared/src/power_pcie.c:63: sync_status_lane_en(0);
	mov	dpl,#0x00
	mov	r0,#_sync_status_lane_en
	mov	r1,#(_sync_status_lane_en >> 8)
	mov	r2,#(_sync_status_lane_en >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:64: reg_PIN_PLL_READY_TX_LANE = 0;
	...
	sjmp	00111$
00109$:
;	../../shared/src/power_pcie.c:67: PHY_STATUS = ST_P1_WK;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x23
	movx	@dptr,a
;	../../shared/src/power_pcie.c:68: sync_status_lane_en(1);
	mov	dpl,#0x01
	mov	r0,#_sync_status_lane_en
	mov	r1,#(_sync_status_lane_en >> 8)
	mov	r2,#(_sync_status_lane_en >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:70: if(reg_PIN_PU_RX_RD_LANE==1) { //corner case
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	rr	a
	rr	a
	...
	mov	r2,a
	cjne	r2,#0x01,00106$
;	../../shared/src/power_pcie.c:71: do_wake = 1;
	setb	_do_wake
	sjmp	00107$
00106$:
;	../../shared/src/power_pcie.c:73: else if( SYNC_SATUS_P2_2_P1_ON ) {
	mov	dptr,#(_SYNC_INFO + 0x0002)
	movx	a,@dptr
	jz	00107$
;	../../shared/src/power_pcie.c:74: txlane_align();
	mov	r0,#_txlane_align
	mov	r1,#(_txlane_align >> 8)
	mov	r2,#(_txlane_align >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:75: SYNC_SATUS_P2_2_P1_ON = 0;
	mov	dptr,#(_SYNC_INFO + 0x0002)
	clr	a
	movx	@dptr,a
00107$:
;	../../shared/src/power_pcie.c:77: reg_PIN_PLL_READY_TX_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
...
;------------------------------------------------------------
;Allocation info for local variables in function 'Power_P1_P2'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_pcie.c:92: void Power_P1_P2( void ) BANKING_CTRL {
;	-----------------------------------------
;	 function Power_P1_P2
;	-----------------------------------------
_Power_P1_P2:
;	../../shared/src/power_pcie.c:94: if(reg_ANA_RX_PU_DLY2_LANE) {
	mov	dptr,#_INPUT_RX_PIN_REG3_LANE
	movx	a,@dptr
	jnb	acc.0,00104$
;	../../shared/src/power_pcie.c:96: if(reg_PIN_TX_IDLE_HIZ_RD_LANE) {
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	jnb	acc.3,00102$
;	../../shared/src/power_pcie.c:97: reg_ANA_TX_LESS_CUR_IDLE_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power_pcie.c:98: short_delay();  //delay01(1);
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	mov	r2,#(_short_delay >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:99: reg_ANA_TX_IDLE_HIZ_EN_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
00102$:
;	../../shared/src/power_pcie.c:101: reg_DTL_CLK_OFF_LANE = 1;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/power_pcie.c:102: reg_DFE_CLK_OFF_LANE = 1;
	mov	dptr,#_RX_EQ_CLK_CTRL
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/power_pcie.c:103: reg_RESET_DTL_LANE = 1;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/power_pcie.c:104: CKCON = 0x07 ;  //MCU WAIT time the slowest
	mov	_CKCON,#0x07
;	../../shared/src/power_pcie.c:105: reg_RESET_DFE_LANE = 1;
	mov	dptr,#_RX_EQ_CLK_CTRL
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/power_pcie.c:106: CKCON = 0x00 ; //MCU WAIT time setting back to normal.
	mov	_CKCON,#0x00
;	../../shared/src/power_pcie.c:107: pu_rx_off();
	mov	r0,#_pu_rx_off
	mov	r1,#(_pu_rx_off >> 8)
	mov	r2,#(_pu_rx_off >> 16)
	lcall	__sdcc_banked_call
00104$:
;	../../shared/src/power_pcie.c:110: reg_ANA_TXDETRX_START_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/power_pcie.c:111: reg_ANA_TXDETRX_EN_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/power_pcie.c:112: reg_PIN_TXDETRX_VALID_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/power_pcie.c:114: short_delay(); // need for tc t_pcie_lane_reduce_p1_g3 to pass
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	mov	r2,#(_short_delay >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:116: if( reg_PU_PLL_OR==0 ) {
	mov	dptr,#(_PM_CMN_REG1 + 0x0002)
	movx	a,@dptr
	jb	acc.4,00109$
;	../../shared/src/power_pcie.c:117: pu_pll_off();
	mov	r0,#_pu_pll_off
	mov	r1,#(_pu_pll_off >> 8)
	mov	r2,#(_pu_pll_off >> 16)
	lcall	__sdcc_banked_call
	sjmp	00110$
00109$:
;	../../shared/src/power_pcie.c:119: else if( reg_PU_PLL_OR==1 && SYNC_SATUS_PLL_OR_PLL_OFF_READ ) {
	mov	dptr,#(_PM_CMN_REG1 + 0x0002)
	movx	a,@dptr
	swap	a
	anl	a,#0x01
	...
	movx	a,@dptr
	jz	00110$
;	../../shared/src/power_pcie.c:120: pu_pll_on();
	mov	r0,#_pu_pll_on
	mov	r1,#(_pu_pll_on >> 8)
	mov	r2,#(_pu_pll_on >> 16)
	lcall	__sdcc_banked_call
00110$:
;	../../shared/src/power_pcie.c:123: PHY_STATUS = ST_P2_WK;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x1B
	movx	@dptr,a
;	../../shared/src/power_pcie.c:125: if(reg_PIN_REFCLK_DIS_RD && reg_PU_PLL_OR==0) {
	mov	dptr,#(_PM_CMN_REG1 + 0x0002)
	movx	a,@dptr
	jnb	acc.0,00117$
	mov	dptr,#(_PM_CMN_REG1 + 0x0002)
	movx	a,@dptr
	jb	acc.4,00117$
;	../../shared/src/power_pcie.c:126: if(reg_P2_STATE_LANE == 1) {
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0001)
	movx	a,@dptr
	rr	a
	anl	a,#0x01
	mov	r2,a
	cjne	r2,#0x01,00112$
;	../../shared/src/power_pcie.c:127: reg_REFCLK_DIS_FM_PM = 1;
	...
	sjmp	00118$
00112$:
;	../../shared/src/power_pcie.c:130: PHY_STATUS = ST_P1CLKREQ_WK;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x26
	movx	@dptr,a
	sjmp	00118$
00117$:
;	../../shared/src/power_pcie.c:134: else if(reg_INT_TXDETRX_EN_CHG_ISR_LANE ) {
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG1_LANE + 0x0002)
	movx	a,@dptr
	jnb	acc.7,00118$
;	../../shared/src/power_pcie.c:135: PHY_STATUS = ST_P2_TXDETRX;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x20
	movx	@dptr,a
00118$:
;	../../shared/src/power_pcie.c:138: reg_ANA_PU_TX_LANE = 0;	
	...
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'Power_P2_P1'
;------------------------------------------------------------
;pll_already_on            Allocated to registers r2 
;------------------------------------------------------------
;	../../shared/src/power_pcie.c:157: void Power_P2_P1(void) BANKING_CTRL {
;	-----------------------------------------
;	 function Power_P2_P1
;	-----------------------------------------
_Power_P2_P1:
;	../../shared/src/power_pcie.c:159: bool pll_already_on = 0;
	mov	r2,#0x00
;	../../shared/src/power_pcie.c:161: do {
00113$:
;	../../shared/src/power_pcie.c:162: if(reg_PIN_REFCLK_DIS_RD  && reg_PU_PLL_OR==0) {
	mov	dptr,#(_PM_CMN_REG1 + 0x0002)
	movx	a,@dptr
	jnb	acc.0,00105$
	mov	dptr,#(_PM_CMN_REG1 + 0x0002)
	movx	a,@dptr
	jb	acc.4,00105$
;	../../shared/src/power_pcie.c:163: if(reg_P2_STATE_LANE == 1) {
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0001)
	movx	a,@dptr
	rr	a
	anl	a,#0x01
	mov	r3,a
	cjne	r3,#0x01,00102$
;	../../shared/src/power_pcie.c:164: reg_REFCLK_DIS_FM_PM = 1;
	mov	dptr,#(_PM_CMN_REG1 + 0x0003)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
	sjmp	00105$
00102$:
;	../../shared/src/power_pcie.c:167: PHY_STATUS = ST_P1CLKREQ_WK;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x26
	movx	@dptr,a
;	../../shared/src/power_pcie.c:169: return;
	ljmp	00131$
00105$:
;	../../shared/src/power_pcie.c:172: if(reg_INT_TXDETRX_EN_CHG_ISR_LANE ) {
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG1_LANE + 0x0002)
	movx	a,@dptr
	jnb	acc.7,00108$
;	../../shared/src/power_pcie.c:173: PHY_STATUS = ST_P2_TXDETRX;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x20
	movx	@dptr,a
;	../../shared/src/power_pcie.c:174: return;
	ljmp	00131$
00108$:
;	../../shared/src/power_pcie.c:176: if( reg_PIN_TX_ACJTAG_EN_RD_LANE==1 ) {
	...
	mov	r3,a
	cjne	r3,#0x01,00110$
;	../../shared/src/power_pcie.c:177: PHY_STATUS = ST_P2_BEACON;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x1E
	movx	@dptr,a
;	../../shared/src/power_pcie.c:178: return;
	ljmp	00131$
00110$:
;	../../shared/src/power_pcie.c:180: if ( 1 == reg_PIN_PU_PLL_RD_LANE )
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	swap	a
	rr	a
	...
	mov	r3,a
	cjne	r3,#0x01,00114$
;	../../shared/src/power_pcie.c:181: do_wake = 1; // handles the case that PIN_PU_PLL went high, but the interrupt is cleared by mcu_reset call
	setb	_do_wake
00114$:
;	../../shared/src/power_pcie.c:182: } while(!do_wake);
	jnb	_do_wake,00113$
;	../../shared/src/power_pcie.c:184: sync_status_lane_en(1);
	mov	dpl,#0x01
	push	ar2
	mov	r0,#_sync_status_lane_en
	mov	r1,#(_sync_status_lane_en >> 8)
	...
	lcall	__sdcc_banked_call
	pop	ar2
;	../../shared/src/power_pcie.c:186: if(reg_PIN_PU_TX_RD_LANE==1 && reg_PIN_PU_RX_RD_LANE == 1) {
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	swap	a
	anl	a,#0x01
	...
	mov	r3,a
	cjne	r3,#0x01,00117$
;	../../shared/src/power_pcie.c:187: PHY_STATUS = ST_P2_P0;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x32
	movx	@dptr,a
;	../../shared/src/power_pcie.c:188: return;
	ljmp	00131$
00117$:
;	../../shared/src/power_pcie.c:191: reg_REFCLK_DIS_FM_PM = 0;
	mov	dptr,#(_PM_CMN_REG1 + 0x0003)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/power_pcie.c:193: reg_ANA_PU_TX_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power_pcie.c:195: if(reg_PU_PLL_OR && SYNC_SATUS_PLL_OR_PLL_OFF_READ) {
	mov	dptr,#(_PM_CMN_REG1 + 0x0002)
	movx	a,@dptr
	jnb	acc.4,00120$
	mov	dptr,#(_SYNC_INFO + 0x0001)
	movx	a,@dptr
	jz	00120$
;	../../shared/src/power_pcie.c:196: pu_pll_on();
	push	ar2
	mov	r0,#_pu_pll_on
	mov	r1,#(_pu_pll_on >> 8)
	mov	r2,#(_pu_pll_on >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:197: delay01(50);
	mov	dptr,#0x0032
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	...
	sjmp	00121$
00120$:
;	../../shared/src/power_pcie.c:199: else pll_already_on = 1;
	mov	r2,#0x01
00121$:
;	../../shared/src/power_pcie.c:201: txlane_align();
	push	ar2
	mov	r0,#_txlane_align
	mov	r1,#(_txlane_align >> 8)
	mov	r2,#(_txlane_align >> 16)
	lcall	__sdcc_banked_call
	pop	ar2
;	../../shared/src/power_pcie.c:202: SYNC_SATUS_P2_2_P1_ON = 0;
	mov	dptr,#(_SYNC_INFO + 0x0002)
	clr	a
	movx	@dptr,a
;	../../shared/src/power_pcie.c:210: if (pll_already_on==0 &&
	mov	a,r2
	jnz	00124$
;	../../shared/src/power_pcie.c:211: (reg_INIT_TXFOFFS_9_0_b0 || reg_INIT_TXFOFFS_9_0_b1 ||
	mov	dptr,#_DTX_REG0
	movx	a,@dptr
	jnz	00123$
	...
	anl	a,#0x03
	jnz	00123$
;	../../shared/src/power_pcie.c:212: reg_INIT_TXFOFFS_RING_9_0_b0 || reg_INIT_TXFOFFS_RING_9_0_b1)) {
	mov	dptr,#_DTX_REG2
	movx	a,@dptr
	jnz	00123$
	...
	jz	00124$
00123$:
;	../../shared/src/power_pcie.c:214: delay01(50);
	mov	dptr,#0x0032
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
00124$:
;	../../shared/src/power_pcie.c:218: if( reg_PIN_PU_RX_RD_LANE == 0 )
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	jb	acc.2,00130$
;	../../shared/src/power_pcie.c:219: do_wake = 0;
	clr	_do_wake
00130$:
;	../../shared/src/power_pcie.c:220: PHY_STATUS = ST_P1_WK;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x23
	movx	@dptr,a
;	../../shared/src/power_pcie.c:222: reg_PIN_PLL_READY_TX_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
00131$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'Power_P1_P0'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_pcie.c:236: void Power_P1_P0(void) BANKING_CTRL {
;	-----------------------------------------
;	 function Power_P1_P0
;	-----------------------------------------
_Power_P1_P0:
;	../../shared/src/power_pcie.c:237: if(reg_INT_TXDETRX_EN_CHG_ISR_LANE ) {
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG1_LANE + 0x0002)
	movx	a,@dptr
	jnb	acc.7,00101$
;	../../shared/src/power_pcie.c:238: PHY_STATUS = ST_P1_TXDETRX;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x33
	movx	@dptr,a
;	../../shared/src/power_pcie.c:239: return;	
;	../../shared/src/power_pcie.c:241: else while(!do_wake); 
	sjmp	00110$
00101$:
	jnb	_do_wake,00101$
;	../../shared/src/power_pcie.c:243: pu_rx_on();
	mov	r0,#_pu_rx_on
	mov	r1,#(_pu_rx_on >> 8)
	mov	r2,#(_pu_rx_on >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:245: txhiz2loz();
	mov	r0,#_txhiz2loz
	mov	r1,#(_txhiz2loz >> 8)
	mov	r2,#(_txhiz2loz >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:247: load_cal_data_dll();
	mov	r0,#_load_cal_data_dll
	mov	r1,#(_load_cal_data_dll >> 8)
	mov	r2,#(_load_cal_data_dll >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:249: delay01(20); // 2us-5us 
	mov	dptr,#0x0014
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:251: DTL_DTX_DFE_clkoff_reset_0();
	mov	r0,#_DTL_DTX_DFE_clkoff_reset_0
	mov	r1,#(_DTL_DTX_DFE_clkoff_reset_0 >> 8)
	mov	r2,#(_DTL_DTX_DFE_clkoff_reset_0 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:260: if(cmx_AUTO_RX_INIT_EN == 0)
	mov	dptr,#(_CONTROL_CONFIG8 + 0x0002)
	movx	a,@dptr
	jb	acc.0,00108$
;	../../shared/src/power_pcie.c:261: PHY_STATUS = ST_PLLREADY; 
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x27
	movx	@dptr,a
	sjmp	00109$
00108$:
;	../../shared/src/power_pcie.c:263: PHY_STATUS = ST_DTL;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x2C
	movx	@dptr,a
00109$:
;	../../shared/src/power_pcie.c:265: reg_PIN_PLL_READY_RX_LANE = 1;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
00110$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'Power_P2_P0'
;------------------------------------------------------------
;pll_already_on            Allocated to registers 
;------------------------------------------------------------
;	../../shared/src/power_pcie.c:268: void Power_P2_P0(void) BANKING_CTRL {
;	-----------------------------------------
;	 function Power_P2_P0
;	-----------------------------------------
_Power_P2_P0:
;	../../shared/src/power_pcie.c:270: reg_REFCLK_DIS_FM_PM = 0; 	
	mov	dptr,#(_PM_CMN_REG1 + 0x0003)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/power_pcie.c:272: reg_ANA_PU_TX_LANE = 1;	
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power_pcie.c:273: pu_rx_on();
	mov	r0,#_pu_rx_on
	mov	r1,#(_pu_rx_on >> 8)
	mov	r2,#(_pu_rx_on >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:275: if( SYNC_SATUS_PLL_OR_PLL_OFF==1 ) {
	mov	dptr,#(_SYNC_INFO + 0x0001)
	movx	a,@dptr
	mov	r2,a
	cjne	r2,#0x01,00115$
;	../../shared/src/power_pcie.c:276: if (slave_phy_on==0 && mcuid== master_mcu) {
	...
	mov	a,r2
	cjne	a,ar3,00107$
;	../../shared/src/power_pcie.c:279: if(lc_pll_used || ring_use_250m) //LCPLL always on
	jb	_lc_pll_used,00101$
	jnb	_ring_use_250m,00102$
00101$:
;	../../shared/src/power_pcie.c:281: pll_fast_cal(); 
	mov	r0,#_pll_fast_cal
	mov	r1,#(_pll_fast_cal >> 8)
	mov	r2,#(_pll_fast_cal >> 16)
	lcall	__sdcc_banked_call
00102$:
;	../../shared/src/power_pcie.c:282: if(ring_pll_enabled) {
	jnb	_ring_pll_enabled,00105$
;	../../shared/src/power_pcie.c:283: ring_pll_fast_cal();
	mov	r0,#_ring_pll_fast_cal
	mov	r1,#(_ring_pll_fast_cal >> 8)
	mov	r2,#(_ring_pll_fast_cal >> 16)
	lcall	__sdcc_banked_call
00105$:
;	../../shared/src/power_pcie.c:286: SYNC_SATUS_PLL_OR_PLL_OFF = 0;
	mov	dptr,#(_SYNC_INFO + 0x0001)
	clr	a
	movx	@dptr,a
00107$:
;	../../shared/src/power_pcie.c:296: if(slave_phy_on) {
	mov	dptr,#_slave_phy_on
	movx	a,@dptr
	mov	r2,a
	jz	00112$
;	../../shared/src/power_pcie.c:297: check_master_phy_status(CHECK_MP_PLL_CLK_READY_ON);
	mov	dpl,#0x03
	mov	r0,#_check_master_phy_status
	mov	r1,#(_check_master_phy_status >> 8)
	mov	r2,#(_check_master_phy_status >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:298: pll_clk_ready_1();
	mov	r0,#_pll_clk_ready_1
	mov	r1,#(_pll_clk_ready_1 >> 8)
	mov	r2,#(_pll_clk_ready_1 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:299: if(ring_pll_enabled) {
	jnb	_ring_pll_enabled,00112$
;	../../shared/src/power_pcie.c:300: check_master_phy_status(CHECK_MP_PLL_CLK_READY_RING_ON);
	mov	dpl,#0x05
	mov	r0,#_check_master_phy_status
	mov	r1,#(_check_master_phy_status >> 8)
	mov	r2,#(_check_master_phy_status >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:301: pll_clk_ready_ring_1();
	mov	r0,#_pll_clk_ready_ring_1
	mov	r1,#(_pll_clk_ready_ring_1 >> 8)
	mov	r2,#(_pll_clk_ready_ring_1 >> 16)
	lcall	__sdcc_banked_call
00112$:
;	../../shared/src/power_pcie.c:305: check_pll_clk_ready_pcie();
	mov	r0,#_check_pll_clk_ready_pcie
	mov	r1,#(_check_pll_clk_ready_pcie >> 8)
	mov	r2,#(_check_pll_clk_ready_pcie >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:308: pll_already_on = 1;
00115$:
;	../../shared/src/power_pcie.c:311: txhiz2loz();
	mov	r0,#_txhiz2loz
	mov	r1,#(_txhiz2loz >> 8)
	mov	r2,#(_txhiz2loz >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:313: load_cal_data_dll();
	mov	r0,#_load_cal_data_dll
	mov	r1,#(_load_cal_data_dll >> 8)
	mov	r2,#(_load_cal_data_dll >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:315: txlane_align();
	mov	r0,#_txlane_align
	mov	r1,#(_txlane_align >> 8)
	mov	r2,#(_txlane_align >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:316: SYNC_SATUS_P2_2_P1_ON = 0;
	mov	dptr,#(_SYNC_INFO + 0x0002)
	clr	a
	movx	@dptr,a
;	../../shared/src/power_pcie.c:318: DTL_DTX_DFE_clkoff_reset_0();
	mov	r0,#_DTL_DTX_DFE_clkoff_reset_0
	mov	r1,#(_DTL_DTX_DFE_clkoff_reset_0 >> 8)
	mov	r2,#(_DTL_DTX_DFE_clkoff_reset_0 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:319: delay01(100);
	mov	dptr,#0x0064
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:321: if(cmx_AUTO_RX_INIT_EN == 0)
	mov	dptr,#(_CONTROL_CONFIG8 + 0x0002)
	movx	a,@dptr
	jb	acc.0,00117$
;	../../shared/src/power_pcie.c:322: PHY_STATUS = ST_PLLREADY; 
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x27
	movx	@dptr,a
	sjmp	00118$
00117$:
;	../../shared/src/power_pcie.c:324: PHY_STATUS = ST_DTL;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x2C
	movx	@dptr,a
00118$:
;	../../shared/src/power_pcie.c:326: reg_PIN_PLL_READY_TX_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/power_pcie.c:327: reg_PIN_PLL_READY_RX_LANE = 1;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'Power_P1CLKREQ_P1'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_pcie.c:342: void Power_P1CLKREQ_P1(void) BANKING_CTRL {
;	-----------------------------------------
;	 function Power_P1CLKREQ_P1
;	-----------------------------------------
_Power_P1CLKREQ_P1:
;	../../shared/src/power_pcie.c:344: TCON  = 0x04; //EX0=LVL 
	mov	_TCON,#0x04
;	../../shared/src/power_pcie.c:345: reg_INT_REFCLK_DIS_CHG_ISR_LANE = 0;
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG1_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/power_pcie.c:346: reg_INT0_REFCLK_DIS_EN_INT_EN_LANE = 1;
	mov	dptr,#(_MCU_INT0_CONTROL + 0x0002)
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/power_pcie.c:347: PCON = 0x8a; //mcu stop 
	mov	_PCON,#0x8A
;	../../shared/src/power_pcie.c:350: TCON  = 0x05; //EX0=FALL
	mov	_TCON,#0x05
;	../../shared/src/power_pcie.c:351: reg_INT0_REFCLK_DIS_EN_INT_EN_LANE = 0;
	mov	dptr,#(_MCU_INT0_CONTROL + 0x0002)
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/power_pcie.c:352: reg_REFCLK_DIS_FM_PM = 0; 
	mov	dptr,#(_PM_CMN_REG1 + 0x0003)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/power_pcie.c:353: reg_INT_REFCLK_DIS_CHG_ISR_LANE = 0;
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG1_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/power_pcie.c:355: txloz2hiz();
	mov	r0,#_txloz2hiz
	mov	r1,#(_txloz2hiz >> 8)
	mov	r2,#(_txloz2hiz >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:357: if( reg_PU_IVREF_FELL == 1 ) {
...
00140$:
	ljmp	00114$
00141$:
;	../../shared/src/power_pcie.c:358: if( reg_PU_BG_FELL == 1)
	mov	dptr,#_PM_CMN_REG1
	movx	a,@dptr
	swap	a
	rl	a
	...
	mov	r2,a
	cjne	r2,#0x01,00102$
;	../../shared/src/power_pcie.c:359: PHY_STATUS = ST_P1OFF_WK;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x24
	movx	@dptr,a
	sjmp	00103$
00102$:
;	../../shared/src/power_pcie.c:360: else PHY_STATUS = ST_P1SNOOZE_WK;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x25
	movx	@dptr,a
00103$:
;	../../shared/src/power_pcie.c:362: reg_ANA_PU_SQ_LANE = 0;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/power_pcie.c:363: PM_CMN_REG2.BT.B2 = 0;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	clr	a
	movx	@dptr,a
;	../../shared/src/power_pcie.c:365: if(mcuid== master_mcu) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_MCU_CONFIG
	...
	mov	a,r2
	cjne	a,ar3,00107$
;	../../shared/src/power_pcie.c:368: if( reg_PU_BG_FELL == 1) //will be cleared by hardware when ANA_PU_IVREF=1
	mov	dptr,#_PM_CMN_REG1
	movx	a,@dptr
	swap	a
	rl	a
	...
	mov	r2,a
	cjne	r2,#0x01,00105$
;	../../shared/src/power_pcie.c:369: delay01(200);
	mov	dptr,#0x00C8
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
00105$:
;	../../shared/src/power_pcie.c:371: pu_ivref_on();
	mov	r0,#_pu_ivref_on
	mov	r1,#(_pu_ivref_on >> 8)
	mov	r2,#(_pu_ivref_on >> 16)
	lcall	__sdcc_banked_call
	sjmp	00108$
00107$:
;	../../shared/src/power_pcie.c:376: check_pu_ivref();
	mov	r0,#_check_pu_ivref
	mov	r1,#(_check_pu_ivref >> 8)
	mov	r2,#(_check_pu_ivref >> 16)
	lcall	__sdcc_banked_call
00108$:
;	../../shared/src/power_pcie.c:378: delay01(20);
	mov	dptr,#0x0014
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:381: while(reg_PIN_PU_PLL_RD_LANE==0 || reg_PIN_PU_TX_RD_LANE==0){
00114$:
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	jnb	acc.5,00115$
	...
	jb	acc.4,00116$
00115$:
;	../../shared/src/power_pcie.c:382: if(reg_PIN_REFCLK_DIS_RD) {
	mov	dptr,#(_PM_CMN_REG1 + 0x0002)
	movx	a,@dptr
	jnb	acc.0,00114$
;	../../shared/src/power_pcie.c:383: PHY_STATUS = ST_P1CLKREQ_WK;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x26
	movx	@dptr,a
;	../../shared/src/power_pcie.c:384: reg_ANA_PU_SQ_LANE = 1;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/power_pcie.c:385: return;
	ljmp	00126$
00116$:
;	../../shared/src/power_pcie.c:389: reg_ANA_PU_TX_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power_pcie.c:390: pu_pll_on();
	mov	r0,#_pu_pll_on
	mov	r1,#(_pu_pll_on >> 8)
	mov	r2,#(_pu_pll_on >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:391: reg_ANA_PU_SQ_LANE = 1;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/power_pcie.c:393: delay01(50);
	mov	dptr,#0x0032
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:394: txlane_align();
	mov	r0,#_txlane_align
	mov	r1,#(_txlane_align >> 8)
	mov	r2,#(_txlane_align >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:396: if( PHY_STATUS == ST_P1OFF_WK ) { 
	mov	dptr,#_MCU_STATUS0_LANE
	movx	a,@dptr
	mov	r2,a
	cjne	r2,#0x24,00118$
;	../../shared/src/power_pcie.c:397: reg_ANA_TX_IDLE_HIZ_EN_LANE = 0; //LOZ idle time
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/power_pcie.c:398: reg_ANA_TX_LESS_CUR_IDLE_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/power_pcie.c:399: reg_ANA_TX_LESS_CUR_IDLE_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/power_pcie.c:400: reg_ANA_TX_LESS_CUR_IDLE_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/power_pcie.c:401: delay01(400);
	mov	dptr,#0x0190
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:402: reg_ANA_TX_LESS_CUR_IDLE_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power_pcie.c:403: reg_ANA_TX_IDLE_HIZ_EN_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
00118$:
;	../../shared/src/power_pcie.c:411: if (reg_INIT_TXFOFFS_9_0_b0 || reg_INIT_TXFOFFS_9_0_b1 ||
	mov	dptr,#_DTX_REG0
	movx	a,@dptr
	jnz	00119$
	mov	dptr,#(_DTX_REG0 + 0x0001)
	...
	anl	a,#0x03
	jnz	00119$
;	../../shared/src/power_pcie.c:412: reg_INIT_TXFOFFS_RING_9_0_b0 || reg_INIT_TXFOFFS_RING_9_0_b1) {
	mov	dptr,#_DTX_REG2
	movx	a,@dptr
	jnz	00119$
	mov	dptr,#(_DTX_REG2 + 0x0001)
	...
	jz	00120$
00119$:
;	../../shared/src/power_pcie.c:414: delay01(50);
	mov	dptr,#0x0032
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
00120$:
;	../../shared/src/power_pcie.c:417: if( reg_PIN_PU_RX_RD_LANE == 0 )
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	jb	acc.2,00125$
;	../../shared/src/power_pcie.c:418: do_wake = 0;
	clr	_do_wake
00125$:
;	../../shared/src/power_pcie.c:420: PHY_STATUS = ST_P1_WK;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x23
	movx	@dptr,a
;	../../shared/src/power_pcie.c:423: reg_PIN_PLL_READY_TX_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
00126$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'P0Off_TXDETRX'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_pcie.c:437: void P0Off_TXDETRX(void) BANKING_CTRL {
;	-----------------------------------------
;	 function P0Off_TXDETRX
;	-----------------------------------------
_P0Off_TXDETRX:
;	../../shared/src/power_pcie.c:438: PHY_STATUS = ST_POFF_TXDETRX;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x2E
	movx	@dptr,a
;	../../shared/src/power_pcie.c:440: delay01(200);
	mov	dptr,#0x00C8
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:442: if( cmx_TX_LANE_ALIGN_OFF==0 ) {
	mov	dptr,#_CONTROL_CONFIG0
	movx	a,@dptr
	jb	acc.4,00107$
;	../../shared/src/power_pcie.c:443: if(mcuid== master_mcu) {	
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_MCU_CONFIG
	...
	mov	a,r2
	cjne	a,ar3,00102$
;	../../shared/src/power_pcie.c:445: pu_ivref_on();	
	mov	r0,#_pu_ivref_on
	mov	r1,#(_pu_ivref_on >> 8)
	mov	r2,#(_pu_ivref_on >> 16)
	lcall	__sdcc_banked_call
	sjmp	00108$
00102$:
;	../../shared/src/power_pcie.c:449: check_pu_ivref();
	mov	r0,#_check_pu_ivref
	mov	r1,#(_check_pu_ivref >> 8)
	mov	r2,#(_check_pu_ivref >> 16)
	lcall	__sdcc_banked_call
	sjmp	00108$
00107$:
;	../../shared/src/power_pcie.c:453: if(reg_ANA_PU_IVREF_DLY3==0) {
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	jb	acc.0,00108$
;	../../shared/src/power_pcie.c:455: PM_CMN_REG2.BT.B2 = PM_CMN_REG2.BT.B2 | 0x08;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	mov	r2,a
	orl	ar2,#0x08
	...
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/power_pcie.c:456: delay01(10); //1us
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:457: PM_CMN_REG2.BT.B2 = PM_CMN_REG2.BT.B2 | 0x0c;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	mov	r2,a
	orl	ar2,#0x0C
	...
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/power_pcie.c:458: delay01(10); //1us
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:459: PM_CMN_REG2.BT.B2 = PM_CMN_REG2.BT.B2 | 0x0e;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	mov	r2,a
	orl	ar2,#0x0E
	...
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/power_pcie.c:460: delay01(10); //1us
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:461: PM_CMN_REG2.BT.B2 = PM_CMN_REG2.BT.B2 | 0x0f;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	mov	r2,a
	orl	ar2,#0x0F
	...
	movx	@dptr,a
00108$:
;	../../shared/src/power_pcie.c:465: delay01(200);
	mov	dptr,#0x00C8
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:466: reg_ANA_PU_TX_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power_pcie.c:467: short_delay();
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	mov	r2,#(_short_delay >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:468: reg_ANA_TXDETRX_EN_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/power_pcie.c:469: delay01(200);
	mov	dptr,#0x00C8
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:471: txdetrx();
	mov	r0,#_txdetrx
	mov	r1,#(_txdetrx >> 8)
	mov	r2,#(_txdetrx >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:489: reg_PIN_TXDETRX_VALID_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power_pcie.c:491: reg_ANA_PU_TX_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/power_pcie.c:493: if(reg_PIN_PU_IVREF_RD==0) {
	mov	dptr,#(_PM_CMN_REG1 + 0x0003)
	movx	a,@dptr
	jb	acc.5,00111$
;	../../shared/src/power_pcie.c:496: PM_CMN_REG2.BT.B2 = 0; //pu_ivref**=0
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	clr	a
	movx	@dptr,a
;	../../shared/src/power_pcie.c:501: while(reg_PIN_TXDETRX_EN_RD_LANE);
00111$:
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00111$
;	../../shared/src/power_pcie.c:503: reg_PIN_TXDETRX_VALID_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'Power_P0_TXDETRX'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_pcie.c:517: void Power_P0_TXDETRX(void) BANKING_CTRL {
;	-----------------------------------------
;	 function Power_P0_TXDETRX
;	-----------------------------------------
_Power_P0_TXDETRX:
;	../../shared/src/power_pcie.c:519: reg_ANA_TXDETRX_EN_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/power_pcie.c:521: txdetrx();
	mov	r0,#_txdetrx
	mov	r1,#(_txdetrx >> 8)
	mov	r2,#(_txdetrx >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:539: delay01(200);
	mov	dptr,#0x00C8
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:540: reg_PIN_TXDETRX_VALID_LANE = 1;	
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power_pcie.c:542: while(reg_PIN_TXDETRX_EN_RD_LANE);
00101$:
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00101$
;	../../shared/src/power_pcie.c:544: reg_PIN_TXDETRX_VALID_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/power_pcie.c:546: if(cmx_AUTO_RX_INIT_EN == 0)
	mov	dptr,#(_CONTROL_CONFIG8 + 0x0002)
	movx	a,@dptr
	jb	acc.0,00105$
;	../../shared/src/power_pcie.c:547: PHY_STATUS = ST_PLLREADY; 
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x27
	movx	@dptr,a
	sjmp	00107$
00105$:
;	../../shared/src/power_pcie.c:549: PHY_STATUS = ST_DTL;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x2C
	movx	@dptr,a
00107$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'Power_P1_TXDETRX'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_pcie.c:563: void Power_P1_TXDETRX(void) BANKING_CTRL {
;	-----------------------------------------
;	 function Power_P1_TXDETRX
;	-----------------------------------------
_Power_P1_TXDETRX:
;	../../shared/src/power_pcie.c:565: reg_INT_TXDETRX_EN_CHG_ISR_LANE = 0;
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG1_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/power_pcie.c:568: if(cmx_VIRTUAL_TDR_SIM_EN) {
	mov	dptr,#(_CONTROL_CONFIG0 + 0x0003)
	movx	a,@dptr
	jnb	acc.7,00105$
;	../../shared/src/power_pcie.c:569: if(reg_ANA_DPHY_SQ_DETECTED_LANE)  //lane reduce test by sq_detect
	mov	dptr,#_LANE_CFG_STATUS2_LANE
	movx	a,@dptr
	jnb	acc.1,00102$
;	../../shared/src/power_pcie.c:570: reg_TRX_VIRTUAL_CTRL_LANE = 1; //3fc[0]
	mov	dptr,#_UPHY_ANAREG_REV_0
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
	sjmp	00105$
00102$:
;	../../shared/src/power_pcie.c:572: reg_TRX_VIRTUAL_CTRL_LANE = 0;
	mov	dptr,#_UPHY_ANAREG_REV_0
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
00105$:
;	../../shared/src/power_pcie.c:575: short_delay();
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	mov	r2,#(_short_delay >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:576: txloz2hiz_quick();
	mov	r0,#_txloz2hiz_quick
	mov	r1,#(_txloz2hiz_quick >> 8)
	mov	r2,#(_txloz2hiz_quick >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:578: reg_ANA_TXDETRX_EN_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/power_pcie.c:580: reg_ANA_TXDETRX_START_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/power_pcie.c:582: while(!reg_TXDETRX_SAMPLE_DONE_LANE);
00106$:
	mov	dptr,#_PM_CTRL_TX_LANE_REG1_LANE
	movx	a,@dptr
	jnb	acc.1,00106$
;	../../shared/src/power_pcie.c:584: short_delay();
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	mov	r2,#(_short_delay >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:585: reg_ANA_TXDETRX_START_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/power_pcie.c:586: short_delay();
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	mov	r2,#(_short_delay >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:587: reg_ANA_TXDETRX_EN_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/power_pcie.c:589: txloz2hiz_quick();
	mov	r0,#_txloz2hiz_quick
	mov	r1,#(_txloz2hiz_quick >> 8)
	mov	r2,#(_txloz2hiz_quick >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:591: reg_PIN_TXDETRX_VALID_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power_pcie.c:593: while(reg_PIN_TXDETRX_EN_RD_LANE);
00109$:
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00109$
;	../../shared/src/power_pcie.c:595: reg_PIN_TXDETRX_VALID_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/power_pcie.c:598: PHY_STATUS = ST_P1_WK ; 
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x23
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'Power_P2_TXDETRX'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_pcie.c:612: void Power_P2_TXDETRX(void) BANKING_CTRL {
;	-----------------------------------------
;	 function Power_P2_TXDETRX
;	-----------------------------------------
_Power_P2_TXDETRX:
;	../../shared/src/power_pcie.c:613: reg_INT_TXDETRX_EN_CHG_ISR_LANE = 0;
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG1_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/power_pcie.c:614: reg_ANA_PU_TX_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power_pcie.c:616: short_delay();
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	mov	r2,#(_short_delay >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:617: txloz2hiz_quick();
	mov	r0,#_txloz2hiz_quick
	mov	r1,#(_txloz2hiz_quick >> 8)
	mov	r2,#(_txloz2hiz_quick >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:619: reg_ANA_TXDETRX_EN_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/power_pcie.c:620: short_delay();
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	mov	r2,#(_short_delay >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:621: reg_ANA_TXDETRX_START_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/power_pcie.c:623: while(!reg_TXDETRX_SAMPLE_DONE_LANE);
00101$:
	mov	dptr,#_PM_CTRL_TX_LANE_REG1_LANE
	movx	a,@dptr
	jnb	acc.1,00101$
;	../../shared/src/power_pcie.c:625: short_delay();
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	mov	r2,#(_short_delay >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:626: reg_ANA_TXDETRX_START_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/power_pcie.c:627: reg_ANA_TXDETRX_EN_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/power_pcie.c:629: txloz2hiz_quick();
	mov	r0,#_txloz2hiz_quick
	mov	r1,#(_txloz2hiz_quick >> 8)
	mov	r2,#(_txloz2hiz_quick >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:631: reg_ANA_PU_TX_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/power_pcie.c:633: reg_PIN_TXDETRX_VALID_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power_pcie.c:635: while(reg_PIN_TXDETRX_EN_RD_LANE);
00104$:
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.0,00104$
;	../../shared/src/power_pcie.c:637: reg_PIN_TXDETRX_VALID_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/power_pcie.c:640: PHY_STATUS = ST_P2_WK ; 
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x1B
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'Power_P2_BEACON'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_pcie.c:654: void Power_P2_BEACON(void) BANKING_CTRL {
;	-----------------------------------------
;	 function Power_P2_BEACON
;	-----------------------------------------
_Power_P2_BEACON:
;	../../shared/src/power_pcie.c:680: reg_ANA_PU_TX_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power_pcie.c:681: short_delay();  //delay01(4);
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	mov	r2,#(_short_delay >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:682: reg_ANA_TX_IDLE_HIZ_EN_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/power_pcie.c:683: delay01(5);
	mov	dptr,#0x0005
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:684: reg_ANA_TX_LESS_CUR_IDLE_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/power_pcie.c:686: reg_ANA_BEACON_EN_LANE = 1;
	mov	dptr,#_PM_CTRL_TX_LANE_REG1_LANE
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power_pcie.c:688: while(!do_wake);
00101$:
	jnb	_do_wake,00101$
;	../../shared/src/power_pcie.c:690: reg_ANA_TX_LESS_CUR_IDLE_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power_pcie.c:691: short_delay();
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	mov	r2,#(_short_delay >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:692: reg_ANA_TX_IDLE_HIZ_EN_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/power_pcie.c:693: short_delay();
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	mov	r2,#(_short_delay >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:694: reg_ANA_PU_TX_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/power_pcie.c:696: PHY_STATUS = ST_P2_WK; 
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x1B
	movx	@dptr,a
;	../../shared/src/power_pcie.c:698: do_wake = 0;
	clr	_do_wake
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'txloz2hiz'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_pcie.c:702: void txloz2hiz(void) BANKING_CTRL {
;	-----------------------------------------
;	 function txloz2hiz
;	-----------------------------------------
_txloz2hiz:
;	../../shared/src/power_pcie.c:703: if(reg_PIN_TX_IDLE_HIZ_RD_LANE) {
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	jnb	acc.3,00103$
;	../../shared/src/power_pcie.c:704: reg_ANA_TX_LESS_CUR_IDLE_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power_pcie.c:705: short_delay();  //delay01(1);
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	mov	r2,#(_short_delay >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:706: reg_ANA_TX_IDLE_HIZ_EN_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
00103$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'txhiz2loz'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_pcie.c:710: void txhiz2loz(void) BANKING_CTRL {
;	-----------------------------------------
;	 function txhiz2loz
;	-----------------------------------------
_txhiz2loz:
;	../../shared/src/power_pcie.c:711: if(!reg_PIN_TX_IDLE_HIZ_RD_LANE) {
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	jb	acc.3,00103$
;	../../shared/src/power_pcie.c:712: reg_ANA_TX_IDLE_HIZ_EN_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/power_pcie.c:713: short_delay();  //delay01(1);
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	mov	r2,#(_short_delay >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:714: reg_ANA_TX_LESS_CUR_IDLE_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
00103$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'txloz2hiz_quick'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_pcie.c:718: void txloz2hiz_quick(void) BANKING_CTRL {
;	-----------------------------------------
;	 function txloz2hiz_quick
;	-----------------------------------------
_txloz2hiz_quick:
;	../../shared/src/power_pcie.c:719: reg_ANA_TX_IDLE_HIZ_EN_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/power_pcie.c:720: reg_ANA_TX_LESS_CUR_IDLE_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/power_pcie.c:721: delay01(200);
	mov	dptr,#0x00C8
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:722: reg_ANA_TX_LESS_CUR_IDLE_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power_pcie.c:723: reg_ANA_TX_IDLE_HIZ_EN_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'txdetrx'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_pcie.c:726: void txdetrx(void) BANKING_CTRL {
;	-----------------------------------------
;	 function txdetrx
;	-----------------------------------------
_txdetrx:
;	../../shared/src/power_pcie.c:727: short_delay();  //delay01(1);
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	mov	r2,#(_short_delay >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:728: reg_ANA_TX_LESS_CUR_IDLE_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power_pcie.c:729: short_delay();  //delay01(1);
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	mov	r2,#(_short_delay >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:730: reg_ANA_TX_IDLE_HIZ_EN_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/power_pcie.c:731: reg_ANA_TXDETRX_START_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/power_pcie.c:733: while(!reg_TXDETRX_SAMPLE_DONE_LANE);
00101$:
	mov	dptr,#_PM_CTRL_TX_LANE_REG1_LANE
	movx	a,@dptr
	jnb	acc.1,00101$
;	../../shared/src/power_pcie.c:734: short_delay();  //delay01(1);
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	mov	r2,#(_short_delay >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:736: reg_ANA_TXDETRX_START_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/power_pcie.c:737: short_delay();  //delay01(1);
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	mov	r2,#(_short_delay >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:738: reg_ANA_TX_IDLE_HIZ_EN_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/power_pcie.c:739: short_delay();  //delay01(1);
	mov	r0,#_short_delay
	mov	r1,#(_short_delay >> 8)
	mov	r2,#(_short_delay >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_pcie.c:740: reg_ANA_TX_LESS_CUR_IDLE_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/power_pcie.c:741: reg_ANA_TXDETRX_EN_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
