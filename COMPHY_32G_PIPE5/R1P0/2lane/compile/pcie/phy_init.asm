...
; This file was generated Thu Oct 18 21:21:28 2018
;--------------------------------------------------------
	.module phy_init
...
;	../../shared/src/phy_init.c:166: reg_MCU_DEBUG4_LANE_7_0 = BUILD_VER;
	...
	mov	a,#0x26
	movx	@dptr,a
;	../../shared/src/phy_init.c:169: if(phy_mode == PCIE) PIPE4_EN = 1;	//set default for PCIe mode
	mov	dptr,#(_SYSTEM + 0x0002)
	movx	a,@dptr
	anl	a,#0x07
	mov	r3,a
...
;	../../shared/src/phy_init.c:234: if(pcie_usb_mode)
	mov	a,r2
	jz	00110$
;	../../shared/src/phy_init.c:237: tx_adapt_g0_en = 0;
;	../../shared/src/phy_init.c:238: tx_adapt_gn1_en = 1;
	...
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/phy_init.c:239: tx_adapt_g1_en = 1;
	mov	dptr,#(_TRAIN_CONTROL_2 + 0x0002)
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/phy_init.c:240: lnx_TRX_TRAIN_TIMER_LANE_15_0 = 23;
...
00121$:
	...
	cjne	r2,#0x05,00102$
00101$:
;	../../shared/src/phy_init.c:296: reg_DET_BYPASS_LANE = 1;
	mov	dptr,#(_RX_DATA_PATH_REG + 0x0003)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/phy_init.c:299: PM_CTRL_INTERRUPT_REG2.BT.B2 = 0x3c; //txdetrx_en_chg|beacon_tx_en_chg
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG2 + 0x0002)
	mov	a,#0x3C
	movx	@dptr,a
;	../../shared/src/phy_init.c:300: PM_CTRL_INTERRUPT_REG2.BT.B3 = 0xe5; //power_state_valid|rx_int|regclk_dis
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG2 + 0x0003)
	mov	a,#0xE5
	movx	@dptr,a
;	../../shared/src/phy_init.c:301: reg_INT_TXDETRX_EN_CHG_MASK_LANE =0;
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG2 + 0x0002)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/phy_init.c:302: reg_INT_BEACON_TX_EN_CHG_MASK_LANE = 0;
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG2 + 0x0002)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
...
00124$:
	...
	cjne	r2,#0x05,00105$
00104$:
;	../../shared/src/phy_init.c:327: reg_INT9_PM_CHG_INT_EN_LANE = 0;
	mov	dptr,#_MCU_INT9_CONTROL
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/phy_init.c:328: reg_INT1_INT_POWER_STATE_VALID_RISE_INT_EN_LANE = 1;
	mov	dptr,#(_MCU_INT1_CONTROL + 0x0002)
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/phy_init.c:329: reg_INT1_INT_PU_PLL_OR_CHG_INT_EN_LANE = 1;
	mov	dptr,#(_MCU_INT1_CONTROL + 0x0003)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/phy_init.c:331: reg_INT8_PM_PCIE_FUNC_CHG_INT_EN_LANE = 1;
...
;	../../shared/src/phy_init.c:428: max_gen = cmx_PHY_GEN_MAX_3_0;
	...
	movx	@dptr,a
00107$:
;	../../shared/src/phy_init.c:431: if(phy_mode==USB)
	mov	dptr,#(_SYSTEM + 0x0002)
	movx	a,@dptr
	anl	a,#0x07
	mov	r2,a
	cjne	r2,#0x05,00109$
;	../../shared/src/phy_init.c:432: no_pllspdchg = 1;
	setb	_no_pllspdchg
00109$:
;	../../shared/src/phy_init.c:434: if( phy_mode == PCIE) {
	mov	dptr,#(_SYSTEM + 0x0002)
	movx	a,@dptr
	anl	a,#0x07
	mov	r2,a
	cjne	r2,#0x03,00113$
;	../../shared/src/phy_init.c:435: tx_pipe4_en = 1; //should be always 1 //PIPE4_EN;
	setb	_tx_pipe4_en
;	../../shared/src/phy_init.c:436: tx_status_pcie_mode = 1;
	setb	_tx_status_pcie_mode
;	../../shared/src/phy_init.c:438: lnx_GAIN_TRAIN_INIT_EN_LANE = 1;
	mov	dptr,#(_DFE_CONTROL_1 + 0x0002)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/phy_init.c:440: lnx_CDRPHASE_OPT_EN_LANE = 1; //0
	mov	dptr,#(_DFE_CONTROL_5 + 0x0001)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/phy_init.c:444: if (cmx_TX_TRAIN_MODE == 1)
	mov	dptr,#_TRAIN_IF_CONFIG
	movx	a,@dptr
	rr	a
	anl	a,#0x01
	mov	r2,a
	cjne	r2,#0x01,00111$
;	../../shared/src/phy_init.c:445: reg_ANA_TX_EM_PO_EN_LANE = 1;
	mov	dptr,#(_LINK_TRAIN_MODE0 + 0x0002)
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
00111$:
;	../../shared/src/phy_init.c:449: reg_ANA_PU_TX_FORCE_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/phy_init.c:450: reg_ANA_PU_RX_FORCE_LANE = 1;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/phy_init.c:452: reg_EBUF_THRESHOLD_WIDE_LANE = 1;
	mov	dptr,#(_LANE_CFG2_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
00113$:
...
00123$:
	...
	cjne	r2,#0x05,00102$
00101$:
;	../../shared/src/phy_init.c:614: PM_CTRL_INTERRUPT_REG2.BT.B2 = 0; //txdetrx_en_chg|beacon_tx_en_chg
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG2 + 0x0002)
;	../../shared/src/phy_init.c:615: PM_CTRL_INTERRUPT_REG2.BT.B3 = 0; //power_state_valid|rx_int|regclk_dis
	clr	a
	movx	@dptr,a
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG2 + 0x0003)
	movx	@dptr,a
...
00126$:
	...
	cjne	r2,#0x05,00105$
00104$:
;	../../shared/src/phy_init.c:637: reg_INT9_PM_CHG_INT_EN_LANE = 0;
	mov	dptr,#_MCU_INT9_CONTROL
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/phy_init.c:638: reg_INT1_INT_POWER_STATE_VALID_RISE_INT_EN_LANE = 0;
	mov	dptr,#(_MCU_INT1_CONTROL + 0x0002)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/phy_init.c:639: reg_INT1_INT_PU_PLL_OR_CHG_INT_EN_LANE = 0;
	mov	dptr,#(_MCU_INT1_CONTROL + 0x0003)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/phy_init.c:641: reg_INT8_PM_PCIE_FUNC_CHG_INT_EN_LANE = 0;
	mov	dptr,#(_MCU_INT8_CONTROL + 0x0001)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
