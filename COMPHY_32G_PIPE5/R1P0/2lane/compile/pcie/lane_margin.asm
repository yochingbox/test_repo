...
;--------------------------------------------------------
	...
	.globl _lane_margin_start
	.globl _lane_margin_dfe_run
	.globl _cfg_dfe_fm_lane_en
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area BANK1   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'lane_margin_start'
;------------------------------------------------------------
;save_dfe_cont_mode        Allocated to registers r2 
;save_eom_en               Allocated to registers r3 
;save_fast_dfe_timer_en    Allocated to registers r4 
;save_eom_clk_en           Allocated to registers r5 
;save_eye_check_bypass     Allocated to registers r6 
;save_f0_sp_o              Allocated to stack - offset 1
;save_f0_sp_e              Allocated to stack - offset 2
;save_f0_sn_o              Allocated to stack - offset 3
;save_f0_sn_e              Allocated to registers r7 
;------------------------------------------------------------
;	../../shared/src/lane_margin.c:26: void lane_margin_start(void) BANKING_CTRL {
;	-----------------------------------------
;	 function lane_margin_start
;	-----------------------------------------
_lane_margin_start:
	ar2 = 0x02
	ar3 = 0x03
	...
	inc	sp
	inc	sp
;	../../shared/src/lane_margin.c:38: save_dfe_cont_mode = reg_DFE_ADAPT_CONT_LANE;
	...
	anl	a,#0x01
	mov	r2,a
;	../../shared/src/lane_margin.c:39: save_dfe_adapt_splr = reg_DFE_ADAPT_SPLR_EN_LANE_3_0; 
	mov	dptr,#_DFE_CTRL_REG0
	movx	a,@dptr
	swap	a
	anl	a,#0x0f
	mov	dptr,#_save_dfe_adapt_splr
	movx	@dptr,a
;	../../shared/src/lane_margin.c:40: save_dfe_adapt_e_en = reg_DFE_ADAPT_EVEN_EN_LANE;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0002)
	movx	a,@dptr
	rl	a
	anl	a,#0x01
	mov	dptr,#_save_dfe_adapt_e_en
	movx	@dptr,a
;	../../shared/src/lane_margin.c:41: save_dfe_adapt_o_en = reg_DFE_ADAPT_ODD_EN_LANE;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0002)
	movx	a,@dptr
	rl	a
	rl	a
	anl	a,#0x01
	mov	dptr,#_save_dfe_adapt_o_en
	movx	@dptr,a
;	../../shared/src/lane_margin.c:42: save_eom_en_s = reg_EOM_EN_S_LANE;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_22
	movx	a,@dptr
	rl	a
	rl	a
	anl	a,#0x01
	mov	dptr,#_save_eom_en_s
	movx	@dptr,a
;	../../shared/src/lane_margin.c:43: save_eom_en_d = reg_EOM_EN_D_LANE;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_22
	movx	a,@dptr
	swap	a
	rr	a
	anl	a,#0x01
	mov	dptr,#_save_eom_en_d
	movx	@dptr,a
;	../../shared/src/lane_margin.c:44: save_dfe_en = reg_DFE_EN_LANE;
	mov	dptr,#_RX_EQ_CLK_CTRL
	movx	a,@dptr
	swap	a
	anl	a,#0x01
	mov	dptr,#_save_dfe_en
	movx	@dptr,a
;	../../shared/src/lane_margin.c:45: save_eom_en = reg_EOM_EN_LANE;
	mov	dptr,#_EOM_REG0
	movx	a,@dptr
	anl	a,#0x01
	mov	r3,a
;	../../shared/src/lane_margin.c:46: save_fast_dfe_timer_en = lnx_FAST_DFE_TIMER_EN_LANE;
	mov	dptr,#(_DFE_CONTROL_5 + 0x0003)
	movx	a,@dptr
	rl	a
	anl	a,#0x01
	mov	r4,a
;	../../shared/src/lane_margin.c:47: save_eom_clk_en = reg_EOM_CLK_EN_LANE;
	...
	anl	a,#0x01
	mov	r5,a
;	../../shared/src/lane_margin.c:48: save_eye_check_bypass = lnx_EYE_CHECK_BYPASS_LANE;
	mov	dptr,#(_DFE_CONTROL_5 + 0x0003)
	movx	a,@dptr
	rl	a
	rl	a
	anl	a,#0x01
	mov	r6,a
;	../../shared/src/lane_margin.c:49: save_f0_sp_o = reg_DFE_F0_S_P_O_SM_LANE_5_0;
	mov	dptr,#(_DFE_READ_ODD_SM_REG0 + 0x0002)
	movx	a,@dptr
	anl	a,#0x3f
	mov	r7,a
	mov	r0,_bp
	inc	r0
	mov	@r0,ar7
;	../../shared/src/lane_margin.c:50: save_f0_sp_e = reg_DFE_F0_S_P_E_SM_LANE_5_0;
	mov	dptr,#(_DFE_READ_EVEN_SM_REG0 + 0x0002)
	movx	a,@dptr
	anl	a,#0x3f
	mov	r7,a
	mov	r0,_bp
	...
	inc	r0
	mov	@r0,ar7
;	../../shared/src/lane_margin.c:51: save_f0_sn_o = reg_DFE_F0_S_N_O_SM_LANE_5_0;
	mov	dptr,#(_DFE_READ_ODD_SM_REG0 + 0x0003)
	movx	a,@dptr
	anl	a,#0x3f
	mov	r7,a
	mov	a,_bp
	...
	mov	r0,a
	mov	@r0,ar7
;	../../shared/src/lane_margin.c:52: save_f0_sn_e = reg_DFE_F0_S_N_E_SM_LANE_5_0;
	mov	dptr,#(_DFE_READ_EVEN_SM_REG0 + 0x0003)
	movx	a,@dptr
	anl	a,#0x3f
	mov	r7,a
;	../../shared/src/lane_margin.c:57: if (save_dfe_cont_mode) {
	mov	a,r2
	jz	00105$
;	../../shared/src/lane_margin.c:58: reg_DFE_ADAPT_ABORT_LANE = 1;
;	../../shared/src/lane_margin.c:59: reg_DFE_ADAPT_CONT_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0001)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
	...
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/lane_margin.c:60: while(!reg_DFE_DONE_LANE);
00101$:
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0002)
	movx	a,@dptr
	jnb	acc.1,00101$
;	../../shared/src/lane_margin.c:61: reg_DFE_START_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0002)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
00105$:
;	../../shared/src/lane_margin.c:65: reg_EOM_CNT_AUTO_CLR_LANE = 0;
	push	ar7
	mov	dptr,#_EOM_REG0
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/lane_margin.c:66: dfe_adapt_lpnum_3_0 = 0;//(uint8_t)(loop_num&0x0f); //0x16
	mov	dptr,#(_DFE_CTRL_REG1 + 0x0001)
	movx	a,@dptr
	anl	a,#0x0f
	movx	@dptr,a
;	../../shared/src/lane_margin.c:67: dfe_adapt_lpnum_9_4 = 0;//((uint8_t)(loop_num>>4)&0x3f);			
	mov	dptr,#(_DFE_CTRL_REG1 + 0x0002)
	movx	a,@dptr
	anl	a,#0xc0
	movx	@dptr,a
;	../../shared/src/lane_margin.c:68: reg_EOM_CLK_EN_LANE = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_134
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/lane_margin.c:69: lnx_EYE_CHECK_BYPASS_LANE = 0;
	mov	dptr,#(_DFE_CONTROL_5 + 0x0003)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/lane_margin.c:70: cmx_EOM_ALIGN_CAL_EXT_EN = 0; // This is for simulation. In real case, this register is already 0.
	mov	dptr,#(_CONTROL_CONFIG1 + 0x0002)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/lane_margin.c:72: eom_align_cal(); 
	push	ar2
	push	ar3
	push	ar4
	push	ar5
...
;	../../shared/src/lane_margin.c:76: EOM_EN_D = 0; 
;	../../shared/src/lane_margin.c:77: EOM_EN_S = 1; 
;	../../shared/src/lane_margin.c:78: EOM_EN_E = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_22
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
	...
	anl	a,#0xef
	movx	@dptr,a
;	../../shared/src/lane_margin.c:79: EOM_clock_analog_align();
	mov	r0,#_EOM_clock_analog_align
	mov	r1,#(_EOM_clock_analog_align >> 8)
	mov	r2,#(_EOM_clock_analog_align >> 16)
	lcall	__sdcc_banked_call
	pop	ar7
;	../../shared/src/lane_margin.c:80: g_fw_flags |= 0x01; // SW flag [0], set to 1 to bypass the eom_ui_align call in phase_control_func_0
	mov	dptr,#_g_fw_flags
	movx	a,@dptr
	mov	r7,a
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/lane_margin.c:81: PHY_STATUS = ST_LANE_MARGIN_EN;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x3B
	movx	@dptr,a
;	../../shared/src/lane_margin.c:82: reg_EOM_CNT_AUTO_CLR_LANE = 1;
	mov	dptr,#_EOM_REG0
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/lane_margin.c:85: lane_margin_dfe_run();
	push	ar7
	mov	r0,#_lane_margin_dfe_run
	mov	r1,#(_lane_margin_dfe_run >> 8)
	mov	r2,#(_lane_margin_dfe_run >> 16)
	lcall	__sdcc_banked_call
	pop	ar7
	pop	ar6
	pop	ar5
	...
	pop	ar3
	pop	ar2
;	../../shared/src/lane_margin.c:144: PHY_STATUS = ST_NORMAL;
	pop	ar7
;	../../shared/src/lane_margin.c:87: while (reg_DFE_MARGIN_EN_LANE) {
00111$:
	mov	dptr,#(_LANE_MARGIN_REG0 + 0x0001)
	movx	a,@dptr
	jnb	acc.0,00113$
;	../../shared/src/lane_margin.c:88: if (reg_DFE_MARGIN_CHG_LANE) {
	mov	dptr,#(_LANE_MARGIN_REG0 + 0x0001)
	movx	a,@dptr
	jnb	acc.4,00111$
;	../../shared/src/lane_margin.c:90: reg_DFE_ADAPT_ABORT_LANE = 1;
;	../../shared/src/lane_margin.c:91: reg_DFE_ADAPT_CONT_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0001)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
	...
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/lane_margin.c:92: while(!reg_DFE_DONE_LANE);
00106$:
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0002)
	movx	a,@dptr
	jnb	acc.1,00106$
;	../../shared/src/lane_margin.c:93: reg_DFE_START_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0002)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/lane_margin.c:94: lane_margin_dfe_run();
	push	ar2
	push	ar3
	push	ar4
	push	ar5
	...
	sjmp	00111$
00113$:
;	../../shared/src/lane_margin.c:98: if ( reg_DFE_MARGIN_TYPE_LANE ) {
	mov	dptr,#_LANE_MARGIN_REG0
	movx	a,@dptr
	jnb	acc.7,00115$
;	../../shared/src/lane_margin.c:99: train.phase_offset_esm = 0;
	mov	dptr,#(_train + 0x0022)
	clr	a
	movx	@dptr,a
;	../../shared/src/lane_margin.c:100: ph_control_mode = 1;
	mov	dptr,#_ph_control_mode
	mov	a,#0x01
	movx	@dptr,a
00115$:
;	../../shared/src/lane_margin.c:102: DFE_FEN_EVEN_REG.BT.B0 = 0x0c;
	mov	dptr,#_DFE_FEN_EVEN_REG
	mov	a,#0x0C
	movx	@dptr,a
;	../../shared/src/lane_margin.c:103: DFE_FEN_ODD_REG.BT.B0 = 0x0c;
	mov	dptr,#_DFE_FEN_ODD_REG
	mov	a,#0x0C
	movx	@dptr,a
;	../../shared/src/lane_margin.c:104: reg_DFE_FEN0_S_N_E_LANE = save_f0_sn_e;
	mov	dptr,#_DFE_FEN_EVEN_REG
	mov	a,r7
	rrc	a
	movx	a,@dptr
	mov	acc.3,c
	movx	@dptr,a
;	../../shared/src/lane_margin.c:105: reg_DFE_FEN0_S_P_E_LANE = save_f0_sp_e;
	mov	dptr,#_DFE_FEN_EVEN_REG
	mov	r0,_bp
	inc	r0
	inc	r0
	...
	mov	acc.2,c
	movx	@dptr,a
;	../../shared/src/lane_margin.c:106: reg_DFE_FEN0_S_N_O_LANE = save_f0_sn_o;
	mov	dptr,#_DFE_FEN_ODD_REG
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	...
	mov	acc.3,c
	movx	@dptr,a
;	../../shared/src/lane_margin.c:107: reg_DFE_FEN0_S_P_O_LANE = save_f0_sp_o;
	mov	dptr,#_DFE_FEN_ODD_REG
	mov	r0,_bp
	inc	r0
	mov	a,@r0
	...
	mov	acc.2,c
	movx	@dptr,a
;	../../shared/src/lane_margin.c:108: DFE_FEN_EVEN_REG.BT.B0 = 0x00;
	mov	dptr,#_DFE_FEN_EVEN_REG
;	../../shared/src/lane_margin.c:109: DFE_FEN_ODD_REG.BT.B0 = 0x00;
	clr	a
	movx	@dptr,a
	mov	dptr,#_DFE_FEN_ODD_REG
	movx	@dptr,a
;	../../shared/src/lane_margin.c:111: reg_DFE_ADAPT_CONT_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0001)
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/lane_margin.c:112: while(!reg_DFE_DONE_LANE);
00116$:
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0002)
	movx	a,@dptr
	jnb	acc.1,00116$
;	../../shared/src/lane_margin.c:113: reg_DFE_START_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0002)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/lane_margin.c:116: reg_DFE_ADAPT_CONT_LANE = save_dfe_cont_mode;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0001)
	mov	a,r2
	rrc	a
	movx	a,@dptr
	mov	acc.5,c
	movx	@dptr,a
;	../../shared/src/lane_margin.c:117: reg_EOM_EN_S_LANE = save_eom_en_s;
	mov	dptr,#_save_eom_en_s
	movx	a,@dptr
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_22
	rrc	a
	...
	mov	acc.6,c
	movx	@dptr,a
;	../../shared/src/lane_margin.c:118: reg_EOM_EN_D_LANE = save_eom_en_d;
	mov	dptr,#_save_eom_en_d
	movx	a,@dptr
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_22
	rrc	a
	...
	mov	acc.5,c
	movx	@dptr,a
;	../../shared/src/lane_margin.c:119: reg_DFE_ADAPT_SPLR_EN_LANE_3_0 = save_dfe_adapt_splr; 
	mov	dptr,#_save_dfe_adapt_splr
	movx	a,@dptr
	mov	dptr,#_DFE_CTRL_REG0
	swap	a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/lane_margin.c:120: reg_DFE_ADAPT_EVEN_EN_LANE = save_dfe_adapt_e_en; 
	mov	dptr,#_save_dfe_adapt_e_en
	movx	a,@dptr
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0002)
	rrc	a
	...
	mov	acc.7,c
	movx	@dptr,a
;	../../shared/src/lane_margin.c:121: reg_DFE_ADAPT_ODD_EN_LANE = save_dfe_adapt_o_en; 
	mov	dptr,#_save_dfe_adapt_o_en
	movx	a,@dptr
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0002)
	rrc	a
	...
	mov	acc.6,c
	movx	@dptr,a
;	../../shared/src/lane_margin.c:122: reg_DFE_EN_LANE = save_dfe_en;
	mov	dptr,#_save_dfe_en
	movx	a,@dptr
	mov	dptr,#_RX_EQ_CLK_CTRL
	rrc	a
	...
	mov	acc.4,c
	movx	@dptr,a
;	../../shared/src/lane_margin.c:123: reg_EOM_EN_LANE = save_eom_en;
	mov	dptr,#_EOM_REG0
	mov	a,r3
	rrc	a
	movx	a,@dptr
	mov	acc.0,c
	movx	@dptr,a
;	../../shared/src/lane_margin.c:124: lnx_FAST_DFE_TIMER_EN_LANE = save_fast_dfe_timer_en;
	mov	dptr,#(_DFE_CONTROL_5 + 0x0003)
	mov	a,r4
	rrc	a
	movx	a,@dptr
	mov	acc.7,c
	movx	@dptr,a
;	../../shared/src/lane_margin.c:125: reg_EOM_CLK_EN_LANE = save_eom_clk_en;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_134
	mov	a,r5
	rrc	a
	movx	a,@dptr
	mov	acc.2,c
	movx	@dptr,a
;	../../shared/src/lane_margin.c:126: lnx_EYE_CHECK_BYPASS_LANE = save_eye_check_bypass;
	mov	dptr,#(_DFE_CONTROL_5 + 0x0003)
	mov	a,r6
	rrc	a
	movx	a,@dptr
	mov	acc.6,c
	movx	@dptr,a
;	../../shared/src/lane_margin.c:128: train.phase_offset_esm = 0;
;	../../shared/src/lane_margin.c:129: phase_control_func_0(train.phase_offset_data, train.phase_offset_esm); //set_ph_esm(0);
	mov	dptr,#(_train + 0x0022)
	clr	a
	movx	@dptr,a
	movx	a,@dptr
	...
	dec	sp
	pop	ar2
;	../../shared/src/lane_margin.c:132: reg_DFE_MARGIN_READY_LANE = 1;
	mov	dptr,#(_LANE_MARGIN_REG0 + 0x0001)
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/lane_margin.c:133: while(!reg_DFE_MARGIN_ACK_LANE);
00119$:
	mov	dptr,#(_LANE_MARGIN_REG0 + 0x0001)
	movx	a,@dptr
	jnb	acc.2,00119$
;	../../shared/src/lane_margin.c:134: reg_DFE_MARGIN_READY_LANE = 0;
	mov	dptr,#(_LANE_MARGIN_REG0 + 0x0001)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/lane_margin.c:137: if (save_dfe_cont_mode) {
	mov	a,r2
	jz	00123$
;	../../shared/src/lane_margin.c:138: reg_DFE_ADAPT_CONT_LANE = 1;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0001)
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/lane_margin.c:139: reg_DFE_START_LANE = 0;
;	../../shared/src/lane_margin.c:140: reg_DFE_START_LANE = 1;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0002)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
	...
	movx	@dptr,a
00123$:
;	../../shared/src/lane_margin.c:143: g_fw_flags &= 0xFE; // clear the SW flag [0]
	mov	dptr,#_g_fw_flags
	movx	a,@dptr
	mov	r2,a
	anl	a,#0xFE
...
;------------------------------------------------------------
;Allocation info for local variables in function 'lane_margin_dfe_run'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/lane_margin.c:147: void lane_margin_dfe_run(void) BANKING_CTRL {
;	-----------------------------------------
;	 function lane_margin_dfe_run
;	-----------------------------------------
_lane_margin_dfe_run:
;	../../shared/src/lane_margin.c:151: cfg_dfe_fm_lane_en();
	mov	r0,#_cfg_dfe_fm_lane_en
	mov	r1,#(_cfg_dfe_fm_lane_en >> 8)
	mov	r2,#(_cfg_dfe_fm_lane_en >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/lane_margin.c:154: reg_DFE_ADAPT_ABORT_LANE = 0;
;	../../shared/src/lane_margin.c:155: reg_DFE_ADAPT_CONT_LANE = 1;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0001)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
	...
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/lane_margin.c:156: reg_DFE_START_LANE = 0;
;	../../shared/src/lane_margin.c:157: reg_DFE_START_LANE = 1;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0002)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
	...
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/lane_margin.c:158: reg_DFE_MARGIN_READY_LANE = 1;
	mov	dptr,#(_LANE_MARGIN_REG0 + 0x0001)
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/lane_margin.c:161: while(!reg_DFE_MARGIN_ACK_LANE);
00101$:
	mov	dptr,#(_LANE_MARGIN_REG0 + 0x0001)
	movx	a,@dptr
	jnb	acc.2,00101$
;	../../shared/src/lane_margin.c:162: reg_DFE_MARGIN_READY_LANE = 0;
	mov	dptr,#(_LANE_MARGIN_REG0 + 0x0001)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'cfg_dfe_fm_lane_en'
;------------------------------------------------------------
;quad_margin_offset        Allocated to registers r2 
;------------------------------------------------------------
;	../../shared/src/lane_margin.c:166: void cfg_dfe_fm_lane_en(void) BANKING_CTRL {
;	-----------------------------------------
;	 function cfg_dfe_fm_lane_en
;	-----------------------------------------
_cfg_dfe_fm_lane_en:
;	../../shared/src/lane_margin.c:169: adapt_data_en = 0;
	clr	_adapt_data_en
;	../../shared/src/lane_margin.c:170: adapt_slicer_en = 1;
	setb	_adapt_slicer_en
;	../../shared/src/lane_margin.c:172: if ( reg_DFE_MARGIN_TYPE_LANE ) {
	mov	dptr,#_LANE_MARGIN_REG0
	movx	a,@dptr
	jnb	acc.7,00105$
;	../../shared/src/lane_margin.c:173: DFE_FEN_EVEN_REG.BT.B0 = 0x0c;
	mov	dptr,#_DFE_FEN_EVEN_REG
	mov	a,#0x0C
	movx	@dptr,a
;	../../shared/src/lane_margin.c:174: DFE_FEN_ODD_REG.BT.B0 = 0x0c;
	mov	dptr,#_DFE_FEN_ODD_REG
	mov	a,#0x0C
	movx	@dptr,a
;	../../shared/src/lane_margin.c:177: reg_DFE_FEXT0_S_N_E_LANE_5_0 = 0;
	mov	dptr,#(_DFE_FEXT_EVEN_REG0 + 0x0003)
	movx	a,@dptr
	anl	a,#0xc0
	movx	@dptr,a
;	../../shared/src/lane_margin.c:178: reg_DFE_FEXT0_S_P_E_LANE_5_0 = 0;
	mov	dptr,#(_DFE_FEXT_EVEN_REG0 + 0x0002)
	movx	a,@dptr
	anl	a,#0xc0
	movx	@dptr,a
;	../../shared/src/lane_margin.c:179: reg_DFE_FEXT0_S_N_O_LANE_5_0 = 0;
	mov	dptr,#(_DFE_FEXT_ODD_REG0 + 0x0003)
	movx	a,@dptr
	anl	a,#0xc0
	movx	@dptr,a
;	../../shared/src/lane_margin.c:180: reg_DFE_FEXT0_S_P_O_LANE_5_0 = 0;
	mov	dptr,#(_DFE_FEXT_ODD_REG0 + 0x0002)
	movx	a,@dptr
	anl	a,#0xc0
	movx	@dptr,a
;	../../shared/src/lane_margin.c:181: DFE_FEN_EVEN_REG.BT.B0 = 0x00;
	mov	dptr,#_DFE_FEN_EVEN_REG
;	../../shared/src/lane_margin.c:182: DFE_FEN_ODD_REG.BT.B0 = 0x00;
	clr	a
	movx	@dptr,a
	mov	dptr,#_DFE_FEN_ODD_REG
	movx	@dptr,a
;	../../shared/src/lane_margin.c:183: ph_control_mode = 1;
	mov	dptr,#_ph_control_mode
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/lane_margin.c:185: if ( reg_DFE_MARGIN_DIR_LANE ) {
	mov	dptr,#(_LANE_MARGIN_REG0 + 0x0001)
	movx	a,@dptr
	jnb	acc.1,00102$
;	../../shared/src/lane_margin.c:187: train.phase_offset_esm = reg_DFE_MARGIN_OFFSET_LANE_6_0;
	mov	dptr,#_LANE_MARGIN_REG0
	movx	a,@dptr
	anl	a,#0x7f
	mov	r2,a
	...
	sjmp	00103$
00102$:
;	../../shared/src/lane_margin.c:189: train.phase_offset_esm = -reg_DFE_MARGIN_OFFSET_LANE_6_0;
	mov	dptr,#_LANE_MARGIN_REG0
	movx	a,@dptr
	anl	a,#0x7f
	mov	r2,a
	...
	movx	@dptr,a
00103$:
;	../../shared/src/lane_margin.c:191: phase_control_func();
	lcall	_phase_control_func
	sjmp	00106$
00105$:
;	../../shared/src/lane_margin.c:197: DFE_FEN_EVEN_REG.BT.B0 = 0x0c;
	mov	dptr,#_DFE_FEN_EVEN_REG
	mov	a,#0x0C
	movx	@dptr,a
;	../../shared/src/lane_margin.c:198: DFE_FEN_ODD_REG.BT.B0 = 0x0c;
	mov	dptr,#_DFE_FEN_ODD_REG
	mov	a,#0x0C
	movx	@dptr,a
;	../../shared/src/lane_margin.c:200: quad_margin_offset = (int8_t)(reg_DFE_MARGIN_OFFSET_LANE_6_0>>2);
	mov	dptr,#_LANE_MARGIN_REG0
	movx	a,@dptr
	anl	a,#0x7f
	rr	a
	rr	a
	anl	a,#0x3f
;	../../shared/src/lane_margin.c:202: reg_DFE_FEXT0_S_N_E_LANE_5_0 = quad_margin_offset;
	mov	r2,a
	mov	dptr,#(_DFE_FEXT_EVEN_REG0 + 0x0003)
	anl	a,#0x3f
	mov	b,a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/lane_margin.c:203: reg_DFE_FEXT0_S_P_E_LANE_5_0 = quad_margin_offset;
	mov	dptr,#(_DFE_FEXT_EVEN_REG0 + 0x0002)
	mov	a,r2
	anl	a,#0x3f
	mov	b,a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/lane_margin.c:204: reg_DFE_FEXT0_S_N_O_LANE_5_0 = quad_margin_offset;
	mov	dptr,#(_DFE_FEXT_ODD_REG0 + 0x0003)
	mov	a,r2
	anl	a,#0x3f
	mov	b,a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/lane_margin.c:205: reg_DFE_FEXT0_S_P_O_LANE_5_0 = quad_margin_offset;
	mov	dptr,#(_DFE_FEXT_ODD_REG0 + 0x0002)
	mov	a,r2
	anl	a,#0x3f
	mov	b,a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/lane_margin.c:206: DFE_FEN_EVEN_REG.BT.B0 = 0x00;
	mov	dptr,#_DFE_FEN_EVEN_REG
;	../../shared/src/lane_margin.c:207: DFE_FEN_ODD_REG.BT.B0 = 0x00;
	clr	a
	movx	@dptr,a
	mov	dptr,#_DFE_FEN_ODD_REG
	movx	@dptr,a
00106$:
;	../../shared/src/lane_margin.c:210: reg_DFE_ADAPT_SPLR_EN_LANE_3_0 = 0xc; 
	mov	dptr,#_DFE_CTRL_REG0
	movx	a,@dptr
	anl	a,#0x0f
	orl	a,#0xc0
	movx	@dptr,a
;	../../shared/src/lane_margin.c:212: reg_DFE_UPDATE_EN_LANE_15_0 = 0;
	mov	dptr,#_DFE_CTRL_REG2
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	../../shared/src/lane_margin.c:213: reg_DFE_UPDATE_F_EN_LANE_5_0 = 0;
	mov	dptr,#(_DFE_CTRL_REG2 + 0x0002)
	movx	a,@dptr
	anl	a,#0xc0
	movx	@dptr,a
;	../../shared/src/lane_margin.c:214: reg_DFE_UPDATE_DC_EN_LANE = 0;
	mov	dptr,#(_DFE_CTRL_REG2 + 0x0002)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/lane_margin.c:215: reg_EOM_EN_LANE = 1;
	mov	dptr,#_EOM_REG0
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
