                            ...
                            979 	.globl _EOM_clock_analog_align
                            980 ;--------------------------------------------------------
   ...
   0025                    1121 	.ds 1
                    ...
                    607C   2004 _sq_thrs_ratio_tb	=	0x607c
                           ...
                           2038 ;------------------------------------------------------------
                           2039 ;Allocation info for local variables in function 'EOM_clock_analog_align'
                           2040 ;------------------------------------------------------------
                           2041 ;dec_num                   Allocated to registers r2 
                           2042 ;i                         Allocated to registers r5 
                           2043 ;total_cnt                 Allocated to registers r3 r4 
                           2044 ;------------------------------------------------------------
                           2045 ;	../../shared/src/phase_adaptation.c:678: void EOM_clock_analog_align(void) BANKING_CTRL {
                           2046 ;	-----------------------------------------
                           2047 ;	 function EOM_clock_analog_align
                           2048 ;	-----------------------------------------
   B325                    2049 _EOM_clock_analog_align:
                    0002   2050 	ar2 = 0x02
                    0003   2051 	ar3 = 0x03
                    0004   2052 	ar4 = 0x04
                    0005   2053 	ar5 = 0x05
                    ...
                    0000   2056 	ar0 = 0x00
                    0001   2057 	ar1 = 0x01
                           2058 ;	../../shared/src/phase_adaptation.c:687: set_slicer_data_sampler_adapt(SLICER_SMPL_ONLY);
   B325 75 82 01           2059 	mov	dpl,#0x01
   B328 78 44              2060 	mov	r0,#_set_slicer_data_sampler_adapt
   B32A 79 92              2061 	mov	r1,#(_set_slicer_data_sampler_adapt >> 8)
   B32C 7A 02              2062 	mov	r2,#(_set_slicer_data_sampler_adapt >> 16)
   B32E 12 00 B3           2063 	lcall	__sdcc_banked_call
                           2064 ;	../../shared/src/phase_adaptation.c:688: data_slic_fb_mode = 0; 
   B331 90 24 05           2065 	mov	dptr,#(_DFE_CTRL_REG1 + 0x0001)
   B334 E0                 2066 	movx	a,@dptr
   B335 54 FD              2067 	anl	a,#0xfd
   B337 F0                 2068 	movx	@dptr,a
                           2069 ;	../../shared/src/phase_adaptation.c:690: dec_num = cdr_ui_pi_code_num;
   B338 90 67 93           2070 	mov	dptr,#_cdr_ui_pi_code_num
   B33B E0                 2071 	movx	a,@dptr
   B33C FA                 2072 	mov	r2,a
                           2073 ;	../../shared/src/phase_adaptation.c:692: do {
   B33D 7B 1C              2074 	mov	r3,#0x1C
   B33F 7C 02              2075 	mov	r4,#0x02
   B341                    2076 00103$:
                           2077 ;	../../shared/src/phase_adaptation.c:693: cds_tb = cds_table[CDS_EYECHECK];  
   B341 90 00 E8           2078 	mov	dptr,#(_cds_table + 0x000a)
   B344 E4                 2079 	clr	a
   B345 93                 2080 	movc	a,@a+dptr
   B346 FD                 2081 	mov	r5,a
   B347 A3                 2082 	inc	dptr
   B348 E4                 2083 	clr	a
   B349 93                 2084 	movc	a,@a+dptr
   B34A FE                 2085 	mov	r6,a
   B34B 90 61 74           2086 	mov	dptr,#_CDS_READ_MISC1
   B34E ED                 2087 	mov	a,r5
   B34F F0                 2088 	movx	@dptr,a
   B350 A3                 2089 	inc	dptr
   B351 EE                 2090 	mov	a,r6
   B352 F0                 2091 	movx	@dptr,a
                           2092 ;	../../shared/src/phase_adaptation.c:694: cdr_dfe_scheme();
   B353 C0 02              2093 	push	ar2
   B355 C0 03              2094 	push	ar3
   B357 C0 04              2095 	push	ar4
   B359 78 96              2096 	mov	r0,#_cdr_dfe_scheme
   B35B 79 92              2097 	mov	r1,#(_cdr_dfe_scheme >> 8)
   B35D 7A 01              2098 	mov	r2,#(_cdr_dfe_scheme >> 16)
   B35F 12 00 B3           2099 	lcall	__sdcc_banked_call
   B362 D0 04              2100 	pop	ar4
   B364 D0 03              2101 	pop	ar3
   B366 D0 02              2102 	pop	ar2
                           2103 ;	../../shared/src/phase_adaptation.c:695: if(cds28.eye_check_pass) {
   B368 90 61 70           2104 	mov	dptr,#(_cds28 + 0x0070)
   B36B E0                 2105 	movx	a,@dptr
                           2106 ;	../../shared/src/phase_adaptation.c:701: for(i = 0; i < dec_num; ++ i) {		
   B36C 70 2D              2107 	jnz	00105$
   B36E FD                 2108 	mov	r5,a
   B36F                    2109 00106$:
   B36F ED                 2110 	mov	a,r5
   B370 B5 02 00           2111 	cjne	a,ar2,00119$
   B373                    2112 00119$:
   B373 50 19              2113 	jnc	00104$
                           2114 ;	../../shared/src/phase_adaptation.c:703: move_eom_phase(64); //move 1UI; 90'
   B375 90 00 40           2115 	mov	dptr,#0x0040
   B378 C0 02              2116 	push	ar2
   B37A C0 03              2117 	push	ar3
   B37C C0 04              2118 	push	ar4
   B37E C0 05              2119 	push	ar5
   B380 12 2F BA           2120 	lcall	_move_eom_phase
   B383 D0 05              2121 	pop	ar5
   B385 D0 04              2122 	pop	ar4
   B387 D0 03              2123 	pop	ar3
   B389 D0 02              2124 	pop	ar2
                           2125 ;	../../shared/src/phase_adaptation.c:701: for(i = 0; i < dec_num; ++ i) {		
   B38B 0D                 2126 	inc	r5
   B38C 80 E1              2127 	sjmp	00106$
   B38E                    2128 00104$:
                           2129 ;	../../shared/src/phase_adaptation.c:706: } while (total_cnt-->0);
   B38E 8B 05              2130 	mov	ar5,r3
   B390 8C 06              2131 	mov	ar6,r4
   B392 1B                 2132 	dec	r3
   B393 BB FF 01           2133 	cjne	r3,#0xff,00121$
   B396 1C                 2134 	dec	r4
   B397                    2135 00121$:
   B397 ED                 2136 	mov	a,r5
   B398 4E                 2137 	orl	a,r6
   B399 70 A6              2138 	jnz	00103$
   B39B                    2139 00105$:
                           2140 ;	../../shared/src/phase_adaptation.c:708: lnx_EOM_PHASE_UI_ALIGN_FAILED_LANE = cds28.eye_check_pass==1? _EXIT_SUCCESS:_EXIT_FAIL;	
   B39B 90 61 70           2141 	mov	dptr,#(_cds28 + 0x0070)
   B39E E0                 2142 	movx	a,@dptr
   B39F FA                 2143 	mov	r2,a
   B3A0 BA 01 03           2144 	cjne	r2,#0x01,00123$
   B3A3 D3                 2145 	setb	c
   B3A4 80 01              2146 	sjmp	00124$
   B3A6                    2147 00123$:
   B3A6 C3                 2148 	clr	c
   B3A7                    2149 00124$:
   B3A7 B3                 2150 	cpl	c
   B3A8 92 28              2151 	mov	b0,c
   B3AA E4                 2152 	clr	a
   B3AB 33                 2153 	rlc	a
   B3AC FA                 2154 	mov	r2,a
   B3AD 90 60 4E           2155 	mov	dptr,#(_DFE_CONTROL_5 + 0x0002)
   B3B0 13                 2156 	rrc	a
   B3B1 E0                 2157 	movx	a,@dptr
   B3B2 92 E5              2158 	mov	acc.5,c
   B3B4 F0                 2159 	movx	@dptr,a
   B3B5 02 00 C5           2160 	ljmp	__sdcc_banked_ret
                           2161 	.area CSEG    (CODE)
                           2162 	.area CSEG    (CODE)
