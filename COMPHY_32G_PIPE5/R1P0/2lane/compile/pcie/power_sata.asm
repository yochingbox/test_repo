...
;--------------------------------------------------------
	...
	.globl _Power_Slumber
	.globl _Power_Slumber_Wakeup
	.globl _Power_Patial_Slumber
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area BANK1   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'Power_Slumber'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_sata.c:29: void Power_Slumber( void ) BANKING_CTRL {
;	-----------------------------------------
;	 function Power_Slumber
;	-----------------------------------------
_Power_Slumber:
	ar2 = 0x02
	ar3 = 0x03
	...
	ar0 = 0x00
	ar1 = 0x01
;	../../shared/src/power_sata.c:38: if(phy_mode==SAS && gen_tx==4) {
	...
	mov	r2,a
	cjne	r2,#0x04,00102$
;	../../shared/src/power_sata.c:39: reg_RST_FRAME_SYNC_DET_CLK_LANE = 1;
;	../../shared/src/power_sata.c:40: reg_RST_FRAME_SYNC_DET_CLK_LANE = 0;	
	...
	movx	@dptr,a
00102$:
;	../../shared/src/power_sata.c:43: reg_DFE_CLK_OFF_LANE = 1; //DFE_FREEZE = 1; 
	mov	dptr,#_RX_EQ_CLK_CTRL
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/power_sata.c:44: PM_CTRL_RX_LANE_REG1_LANE.BT.B2 = 0x38; //DTL_CLK_OFF,RESET_DTL=1, RX_INIT_DONE=1
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	mov	a,#0x38
	movx	@dptr,a
;	../../shared/src/power_sata.c:45: CKCON = 0x07 ;  //MCU WAIT time the slowest
	mov	_CKCON,#0x07
;	../../shared/src/power_sata.c:46: reg_RESET_DFE_LANE = 1;
	mov	dptr,#_RX_EQ_CLK_CTRL
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/power_sata.c:47: CKCON = 0x00 ; //MCU WAIT time setting back to normal.
	mov	_CKCON,#0x00
;	../../shared/src/power_sata.c:50: if(	reg_PU_PLL_OR==0 || (serdes_ring_lane_en && tag_ringpll_ind_en)) 	
	...
	jnb	acc.6,00108$
00107$:
;	../../shared/src/power_sata.c:51: pu_pll_off();
	mov	r0,#_pu_pll_off
	...
	sjmp	00109$
00108$:
;	../../shared/src/power_sata.c:52: else if( reg_PU_PLL_OR==1 && (SYNC_SATUS_PLL_OR_PLL_OFF_READ) ) {
	mov	dptr,#(_PM_CMN_REG1 + 0x0002)
	movx	a,@dptr
	swap	a
	anl	a,#0x01
	...
	movx	a,@dptr
	jz	00109$
;	../../shared/src/power_sata.c:53: pu_pll_on();
	mov	r0,#_pu_pll_on
	mov	r1,#(_pu_pll_on >> 8)
	mov	r2,#(_pu_pll_on >> 16)
	lcall	__sdcc_banked_call
00109$:
;	../../shared/src/power_sata.c:56: pu_rx_off();
	mov	r0,#_pu_rx_off
	mov	r1,#(_pu_rx_off >> 8)
	mov	r2,#(_pu_rx_off >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_sata.c:58: reg_ANA_PU_TX_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/power_sata.c:63: PHY_STATUS = ST_SLUMBER_WK;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x2F
	movx	@dptr,a
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'Power_Slumber_Wakeup'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_sata.c:77: void Power_Slumber_Wakeup( void ) BANKING_CTRL {
;	-----------------------------------------
;	 function Power_Slumber_Wakeup
;	-----------------------------------------
_Power_Slumber_Wakeup:
;	../../shared/src/power_sata.c:79: do {
00105$:
;	../../shared/src/power_sata.c:80: if( reg_PIN_REFCLK_DIS_RD == 1 ) {
	mov	dptr,#(_PM_CMN_REG1 + 0x0002)
	movx	a,@dptr
	anl	a,#0x01
	mov	r2,a
	cjne	r2,#0x01,00106$
;	../../shared/src/power_sata.c:81: PHY_STATUS = ST_SLUMBER_CLK;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x30
	movx	@dptr,a
;	../../shared/src/power_sata.c:82: TCON  = 0x04; //EX0=LVL 
	mov	_TCON,#0x04
;	../../shared/src/power_sata.c:83: reg_INT_REFCLK_DIS_CHG_ISR_LANE = 0; //??
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG1_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/power_sata.c:84: reg_INT0_REFCLK_DIS_EN_INT_EN_LANE = 1;
	mov	dptr,#(_MCU_INT0_CONTROL + 0x0002)
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/power_sata.c:85: PCON = 0x8a; //mcu stop 
	mov	_PCON,#0x8A
;	../../shared/src/power_sata.c:89: TCON  = 0x05; //EX0=FALL
	mov	_TCON,#0x05
;	../../shared/src/power_sata.c:90: reg_INT0_REFCLK_DIS_EN_INT_EN_LANE = 0;
	mov	dptr,#(_MCU_INT0_CONTROL + 0x0002)
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/power_sata.c:91: reg_INT_REFCLK_DIS_CHG_ISR_LANE = 0;
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG1_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/power_sata.c:93: if(reg_PIN_PU_PLL_RD_LANE)	
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	jnb	acc.5,00106$
;	../../shared/src/power_sata.c:94: do_wake = 1;
	setb	_do_wake
00106$:
;	../../shared/src/power_sata.c:96: } while(!do_wake) ;	
	jnb	_do_wake,00105$
;	../../shared/src/power_sata.c:98: if( reg_PU_IVREF_FELL == 1 ) {
...
00164$:
	ljmp	00121$
00165$:
;	../../shared/src/power_sata.c:100: reg_ANA_PU_SQ_LANE = 0; //sequence: checked!
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/power_sata.c:101: PM_CMN_REG2.BT.B2 = 0; //pu_ivref**=0
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	clr	a
	movx	@dptr,a
;	../../shared/src/power_sata.c:103: if( reg_PU_BG_FELL == 1) 
	mov	dptr,#_PM_CMN_REG1
	movx	a,@dptr
	swap	a
	rl	a
	...
	mov	r2,a
	cjne	r2,#0x01,00109$
;	../../shared/src/power_sata.c:104: delay01(200);
	mov	dptr,#0x00C8
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
00109$:
;	../../shared/src/power_sata.c:106: if (mcuid== master_mcu || 
	...
	sjmp	00110$
00168$:
;	../../shared/src/power_sata.c:107: (mcuid!= master_mcu && ((master_mcu==MCU_LANE0 && SYNC_STATUS_LANE0_EN_READ==0) || 
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_MCU_CONFIG
...
00169$:
	...
	jz	00110$
00114$:
;	../../shared/src/power_sata.c:108: (master_mcu==MCU_LANE1 && SYNC_STATUS_LANE1_EN_READ==0))))
	mov	dptr,#_MCU_CONFIG
	movx	a,@dptr
	mov	r2,a
	cjne	r2,#0x01,00117$
	...
	jnz	00117$
00110$:
;	../../shared/src/power_sata.c:113: PM_CMN_REG2.BT.B2 = 0x08;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	mov	a,#0x08
	movx	@dptr,a
;	../../shared/src/power_sata.c:114: delay01(10); //1us
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_sata.c:115: PM_CMN_REG2.BT.B2 = 0x0c;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	mov	a,#0x0C
	movx	@dptr,a
;	../../shared/src/power_sata.c:116: delay01(10); //1us
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_sata.c:117: PM_CMN_REG2.BT.B2 = 0x0e;
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	mov	a,#0x0E
	movx	@dptr,a
;	../../shared/src/power_sata.c:118: delay01(10); //1us
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_sata.c:119: PM_CMN_REG2.BT.B2 = 0x0f;			
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	mov	a,#0x0F
	movx	@dptr,a
;	../../shared/src/power_sata.c:124: while(reg_ANA_PU_IVREF_DLY3==0);
00117$:
	mov	dptr,#(_PM_CMN_REG2 + 0x0002)
	movx	a,@dptr
	jnb	acc.0,00117$
;	../../shared/src/power_sata.c:126: delay01(50);
	mov	dptr,#0x0032
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_sata.c:127: reg_ANA_PU_SQ_LANE=1;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/power_sata.c:128: delay01(150); // 20usec -> 5us + 15us
	mov	dptr,#0x0096
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
00121$:
;	../../shared/src/power_sata.c:133: delay01(5);
	mov	dptr,#0x0005
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_sata.c:134: reg_ANA_PU_TX_LANE = reg_PIN_PU_TX_RD_LANE;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	swap	a
	anl	a,#0x01
	...
	mov	acc.6,c
	movx	@dptr,a
;	../../shared/src/power_sata.c:136: if(reg_PIN_PU_RX_RD_LANE | cmx_FORCE_PARTIAL_PU_RX_ON) pu_rx_on();		
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	rr	a
	rr	a
	...
	sjmp	00124$
00123$:
;	../../shared/src/power_sata.c:137: else pu_rx_off();
	mov	r0,#_pu_rx_off
	mov	r1,#(_pu_rx_off >> 8)
	mov	r2,#(_pu_rx_off >> 16)
	lcall	__sdcc_banked_call
00124$:
;	../../shared/src/power_sata.c:139: if ((reg_PU_PLL_OR==1 && SYNC_SATUS_PLL_OR_PLL_OFF_READ) || (serdes_ring_lane_en && tag_ringpll_ind_en))
	mov	dptr,#(_PM_CMN_REG1 + 0x0002)
	movx	a,@dptr
	swap	a
	anl	a,#0x01
...
00129$:
	...
	jnb	acc.6,00126$
00125$:
;	../../shared/src/power_sata.c:140: pu_pll_on();	
	mov	r0,#_pu_pll_on
	mov	r1,#(_pu_pll_on >> 8)
	mov	r2,#(_pu_pll_on >> 16)
	lcall	__sdcc_banked_call
00126$:
;	../../shared/src/power_sata.c:142: if( reg_PIN_PU_TX_RD_LANE==1 && (reg_PIN_PU_RX_RD_LANE==1|cmx_FORCE_PARTIAL_PU_RX_ON)) 
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0003)
	movx	a,@dptr
	swap	a
	anl	a,#0x01
...
00184$:
	...
	orl	a,r2
	jz	00136$
;	../../shared/src/power_sata.c:144: DTL_DTX_DFE_clkoff_reset_0();
	mov	r0,#_DTL_DTX_DFE_clkoff_reset_0
	mov	r1,#(_DTL_DTX_DFE_clkoff_reset_0 >> 8)
	mov	r2,#(_DTL_DTX_DFE_clkoff_reset_0 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_sata.c:146: delay01(100);		
	mov	dptr,#0x0064
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_sata.c:151: reg_PIN_PLL_READY_TX_LANE    = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/power_sata.c:152: reg_PIN_PLL_READY_RX_LANE    = 1;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power_sata.c:154: if(cmx_AUTO_RX_INIT_EN == 0)
	mov	dptr,#(_CONTROL_CONFIG8 + 0x0002)
	movx	a,@dptr
	jb	acc.0,00131$
;	../../shared/src/power_sata.c:155: PHY_STATUS = ST_PLLREADY; 
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x27
	movx	@dptr,a
	sjmp	00139$
00131$:
;	../../shared/src/power_sata.c:157: PHY_STATUS = ST_DTL;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x2C
	movx	@dptr,a
	sjmp	00139$
00136$:
;	../../shared/src/power_sata.c:160: do_wake = 0;
	clr	_do_wake
;	../../shared/src/power_sata.c:163: if( reg_PIN_PU_RX_RD_LANE==0 & cmx_FORCE_PARTIAL_PU_RX_ON==0) PHY_STATUS = ST_PSLUMBER_RX;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	rr	a
	rr	a
...
00139$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'Power_Patial_Slumber'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/power_sata.c:180: void Power_Patial_Slumber( void ) BANKING_CTRL { //Partial Rx Only
;	-----------------------------------------
;	 function Power_Patial_Slumber
;	-----------------------------------------
_Power_Patial_Slumber:
;	../../shared/src/power_sata.c:182: if(phy_mode==SAS && gen_tx==4) {
	mov	dptr,#(_SYSTEM + 0x0002)
	movx	a,@dptr
	anl	a,#0x07
	mov	r2,a
	...
	mov	r2,a
	cjne	r2,#0x04,00102$
;	../../shared/src/power_sata.c:183: reg_RST_FRAME_SYNC_DET_CLK_LANE = 1;
;	../../shared/src/power_sata.c:184: reg_RST_FRAME_SYNC_DET_CLK_LANE = 0;	
	mov	dptr,#(_CLKGEN_RX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
	...
	movx	@dptr,a
00102$:
;	../../shared/src/power_sata.c:193: if(cmx_FORCE_PARTIAL_PU_RX_ON==0)  {
	mov	dptr,#_CONTROL_CONFIG0
	movx	a,@dptr
	jb	acc.7,00106$
;	../../shared/src/power_sata.c:194: pu_rx_off();
	mov	r0,#_pu_rx_off
	mov	r1,#(_pu_rx_off >> 8)
	mov	r2,#(_pu_rx_off >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_sata.c:196: reg_RESET_DTL_LANE   = 1;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/power_sata.c:197: CKCON = 0x07 ;  //MCU WAIT time the slowest
	mov	_CKCON,#0x07
;	../../shared/src/power_sata.c:198: reg_RESET_DFE_LANE = 1;
	mov	dptr,#_RX_EQ_CLK_CTRL
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/power_sata.c:199: CKCON = 0x00 ; //MCU WAIT time setting back to normal.
	mov	_CKCON,#0x00
;	../../shared/src/power_sata.c:200: reg_DFE_CLK_OFF_LANE = 1; //DFE_FREEZE
	mov	dptr,#_RX_EQ_CLK_CTRL
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/power_sata.c:201: reg_DTL_CLK_OFF_LANE = 1;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/power_sata.c:204: while(!do_wake);
00106$:
	jnb	_do_wake,00106$
;	../../shared/src/power_sata.c:206: if(cmx_FORCE_PARTIAL_PU_RX_ON==0)  {
	mov	dptr,#_CONTROL_CONFIG0
	movx	a,@dptr
	jb	acc.7,00110$
;	../../shared/src/power_sata.c:207: pu_rx_on();
	mov	r0,#_pu_rx_on
	mov	r1,#(_pu_rx_on >> 8)
	mov	r2,#(_pu_rx_on >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_sata.c:209: load_cal_data_dll(); //load dll, load align90
	mov	r0,#_load_cal_data_dll
	mov	r1,#(_load_cal_data_dll >> 8)
	mov	r2,#(_load_cal_data_dll >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_sata.c:211: delay01(20); //2usec
	mov	dptr,#0x0014
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_sata.c:214: reg_DTL_CLK_OFF_LANE= 0;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xef
	movx	@dptr,a
;	../../shared/src/power_sata.c:215: reg_DFE_CLK_OFF_LANE = 0;
	mov	dptr,#_RX_EQ_CLK_CTRL
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/power_sata.c:216: delay01(10); //1~2us
	mov	dptr,#0x000A
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	mov	r2,#(_delay01 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/power_sata.c:217: reg_RESET_DTL_LANE = 0;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/power_sata.c:218: CKCON = 0x07 ;  //MCU WAIT time the slowest
	mov	_CKCON,#0x07
;	../../shared/src/power_sata.c:219: reg_RESET_DFE_LANE = 0;
	mov	dptr,#_RX_EQ_CLK_CTRL
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/power_sata.c:220: CKCON = 0x00 ; //MCU WAIT time setting back to normal.
	mov	_CKCON,#0x00
00110$:
;	../../shared/src/power_sata.c:223: reg_PIN_PLL_READY_RX_LANE = 1;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/power_sata.c:225: if(cmx_AUTO_RX_INIT_EN == 0)
	mov	dptr,#(_CONTROL_CONFIG8 + 0x0002)
	movx	a,@dptr
	jb	acc.0,00112$
;	../../shared/src/power_sata.c:226: PHY_STATUS = ST_PLLREADY;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x27
	movx	@dptr,a
	sjmp	00114$
00112$:
;	../../shared/src/power_sata.c:228: PHY_STATUS = ST_DTL;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x2C
	movx	@dptr,a
00114$:
