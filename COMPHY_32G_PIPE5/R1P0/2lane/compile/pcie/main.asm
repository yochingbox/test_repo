...
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/main.c:46: _sdcc_external_startup() {
;	-----------------------------------------
...
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/main.c:59: void main(){
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
;	../../shared/src/main.c:60: CKCON = 0x00; 
	mov	_CKCON,#0x00
;	../../shared/src/main.c:62: EA = 0;
	clr	_EA
;	../../shared/src/main.c:78: if (mcuid != MCU_CMN) {
	...
	ljmp	00176$
00224$:
;	../../shared/src/main.c:79: cpu_init();
	lcall	_cpu_init
;	../../shared/src/main.c:81: pll_cal_timeout_dis_save = cmx_PLL_CAL_TIMEOUT_DIS;
	mov	dptr,#(_CAL_TIME_OUT_AND_DIS + 0x0001)
	movx	a,@dptr
	rr	a
	anl	a,#0x01
	mov	r2,a
	mov	dptr,#_pll_cal_timeout_dis_save
	movx	@dptr,a
;	../../shared/src/main.c:99: if (reg_PHY_FM_RST_LANE || reg_PHY_FM_RST) {
	mov	dptr,#_LANE_SYSTEM0
	movx	a,@dptr
	jb	acc.2,00105$
	mov	dptr,#_INPUT_CMN_PIN_REG1
	movx	a,@dptr
	jnb	acc.6,00106$
00105$:
;	../../shared/src/main.c:100: if (PHY_STATUS != 0) {
	mov	dptr,#_MCU_STATUS0_LANE
	movx	a,@dptr
	jz	00102$
;	../../shared/src/main.c:102: pwrsq_on = 1;
	mov	dptr,#_pwrsq_on
	mov	a,#0x01
	movx	@dptr,a
;	../../shared/src/main.c:104: reset_pwr_reg();
	mov	r0,#_reset_pwr_reg
	mov	r1,#(_reset_pwr_reg >> 8)
	mov	r2,#(_reset_pwr_reg >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/main.c:105: cmx_PLL_CAL_TIMEOUT_DIS = 1;
	mov	dptr,#(_CAL_TIME_OUT_AND_DIS + 0x0001)
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
00102$:
;	../../shared/src/main.c:109: reg_CLEAR_PHY_FM_RST_LANE = 0;
;	../../shared/src/main.c:110: reg_CLEAR_PHY_FM_RST_LANE = 1;
	mov	dptr,#_LANE_SYSTEM0
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
	...
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/main.c:111: if(mcuid== master_mcu) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r2,a
	...
	mov	a,r2
	cjne	a,ar3,00104$
;	../../shared/src/main.c:112: reg_CLEAR_PHY_FM_RST = 1;
;	../../shared/src/main.c:113: reg_CLEAR_PHY_FM_RST = 0;
	mov	dptr,#_INPUT_CMN_PIN_REG1
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
	...
	movx	@dptr,a
00104$:
;	../../shared/src/main.c:116: PHY_STATUS = ST_INIT;
	mov	dptr,#_MCU_STATUS0_LANE
	clr	a
	movx	@dptr,a
00106$:
;	../../shared/src/main.c:119: if (PHY_STATUS != ST_INIT)
	mov	dptr,#_MCU_STATUS0_LANE
	movx	a,@dptr
	jz	00109$
;	../../shared/src/main.c:120: PHY_STATUS = PHY_NS;
	...
	movx	@dptr,a
00109$:
;	../../shared/src/main.c:122: PHY_NS = ST_INIT;
	mov	dptr,#(_MCU_STATUS0_LANE + 0x0001)
	clr	a
	movx	@dptr,a
;	../../shared/src/main.c:124: sync_status_lane(IDLE);
	mov	dpl,#0x00
	mov	r0,#_sync_status_lane
	mov	r1,#(_sync_status_lane >> 8)
	mov	r2,#(_sync_status_lane >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/main.c:125: MCU_INIT_ST |= MCU_INIT;
	mov	dptr,#_MCU_STATUS3_LANE
	movx	a,@dptr
	mov	r2,a
	orl	ar2,#0x01
	mov	dptr,#_MCU_STATUS3_LANE
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/main.c:127: if( PHY_STATUS == ST_INIT) {
	mov	dptr,#_MCU_STATUS0_LANE
	movx	a,@dptr
	jnz	00111$
;	../../shared/src/main.c:128: clear_xdata(); 
	mov	r0,#_clear_xdata
	mov	r1,#(_clear_xdata >> 8)
	mov	r2,#(_clear_xdata >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/main.c:135: PowerUp_Seq();
	mov	r0,#_PowerUp_Seq
	mov	r1,#(_PowerUp_Seq >> 8)
	mov	r2,#(_PowerUp_Seq >> 16)
	lcall	__sdcc_banked_call
	sjmp	00112$
00111$:
;	../../shared/src/main.c:139: clear_normal_mode_cal_en();
	mov	r0,#_clear_normal_mode_cal_en
	mov	r1,#(_clear_normal_mode_cal_en >> 8)
	mov	r2,#(_clear_normal_mode_cal_en >> 16)
	lcall	__sdcc_banked_call
00112$:
;	../../shared/src/main.c:142: reg_INT_ENABLE_ALL_LANE = 1; 
	mov	dptr,#(_CACHE_DEBUG0 + 0x0003)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/main.c:143: EA = 1;
	setb	_EA
;	../../shared/src/main.c:151: while(1){
00176$:
;	../../shared/src/main.c:153: if (mcuid != MCU_CMN) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r2,a
	cjne	r2,#0xC0,00232$
	sjmp	00176$
00232$:
;	../../shared/src/main.c:162: switch(PHY_STATUS){
	mov	dptr,#_MCU_STATUS0_LANE
	movx	a,@dptr
	mov	r2,a
	cjne	r2,#0x03,00233$
...
00251$:
	ljmp	00136$
;	../../shared/src/main.c:163: case ST_SPDCHG: SpeedChange();		break;
00115$:
	lcall	_SpeedChange
	ljmp	00136$
;	../../shared/src/main.c:165: case ST_P1:     Power_P0s_P1();		break;
00116$:
	mov	r0,#_Power_P0s_P1
	mov	r1,#(_Power_P0s_P1 >> 8)
	mov	r2,#(_Power_P0s_P1 >> 16)
	lcall	__sdcc_banked_call
	ljmp	00136$
;	../../shared/src/main.c:166: case ST_P1_WK:  Power_P1_P0();		break;
00117$:
	mov	r0,#_Power_P1_P0
	mov	r1,#(_Power_P1_P0 >> 8)
	mov	r2,#(_Power_P1_P0 >> 16)
	lcall	__sdcc_banked_call
	ljmp	00136$
;	../../shared/src/main.c:167: case ST_P2_P0:	Power_P2_P0();		break;
00118$:
	mov	r0,#_Power_P2_P0
	mov	r1,#(_Power_P2_P0 >> 8)
	mov	r2,#(_Power_P2_P0 >> 16)
	lcall	__sdcc_banked_call
	ljmp	00136$
;	../../shared/src/main.c:168: case ST_P2: 	Power_P1_P2();	 	break;
00119$:
	mov	r0,#_Power_P1_P2
	mov	r1,#(_Power_P1_P2 >> 8)
	mov	r2,#(_Power_P1_P2 >> 16)
	lcall	__sdcc_banked_call
	ljmp	00136$
;	../../shared/src/main.c:169: case ST_P2_WK: 	Power_P2_P1();	 	break;
00120$:
	mov	r0,#_Power_P2_P1
	mov	r1,#(_Power_P2_P1 >> 8)
	mov	r2,#(_Power_P2_P1 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/main.c:170: case ST_P2_BEACON:	Power_P2_BEACON();	break;
	sjmp	00136$
00121$:
	mov	r0,#_Power_P2_BEACON
	mov	r1,#(_Power_P2_BEACON >> 8)
	mov	r2,#(_Power_P2_BEACON >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/main.c:171: case ST_TXDETRX: Power_P0_TXDETRX();	break;
	sjmp	00136$
00122$:
	mov	r0,#_Power_P0_TXDETRX
	mov	r1,#(_Power_P0_TXDETRX >> 8)
	mov	r2,#(_Power_P0_TXDETRX >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/main.c:172: case ST_P1_TXDETRX: Power_P1_TXDETRX(); break;
	sjmp	00136$
00123$:
	mov	r0,#_Power_P1_TXDETRX
	mov	r1,#(_Power_P1_TXDETRX >> 8)
	mov	r2,#(_Power_P1_TXDETRX >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/main.c:173: case ST_P2_TXDETRX: Power_P2_TXDETRX(); break;
	sjmp	00136$
00124$:
	mov	r0,#_Power_P2_TXDETRX
	mov	r1,#(_Power_P2_TXDETRX >> 8)
	mov	r2,#(_Power_P2_TXDETRX >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/main.c:174: case ST_P1CLKREQ_WK:	Power_P1CLKREQ_P1();	break;
	sjmp	00136$
00125$:
	mov	r0,#_Power_P1CLKREQ_P1
	mov	r1,#(_Power_P1CLKREQ_P1 >> 8)
	mov	r2,#(_Power_P1CLKREQ_P1 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/main.c:184: case ST_TRXTRAIN: TRX_Train();  	break;
	sjmp	00136$
00128$:
	lcall	_TRX_Train
;	../../shared/src/main.c:185: case ST_DTL:	  RX_Init();		break;
	sjmp	00136$
00129$:
	mov	r0,#_RX_Init
	mov	r1,#(_RX_Init >> 8)
	mov	r2,#(_RX_Init >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/main.c:192: case ST_CAL:	  Calibration(); 		break;
	sjmp	00136$
00131$:
	mov	r0,#_Calibration
	mov	r1,#(_Calibration >> 8)
	mov	r2,#(_Calibration >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/main.c:194: case ST_LANE_MARGIN_EN:  lane_margin_start(); 		break;
	sjmp	00136$
00132$:
	mov	r0,#_lane_margin_start
	mov	r1,#(_lane_margin_start >> 8)
	mov	r2,#(_lane_margin_start >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/main.c:196: case ST_NORMAL: 
	sjmp	00136$
00133$:
;	../../shared/src/main.c:197: Cal_Cont();
	mov	r0,#_Cal_Cont
	mov	r1,#(_Cal_Cont >> 8)
	mov	r2,#(_Cal_Cont >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/main.c:198: if(PHY_NS != ST_INIT) break;
	mov	dptr,#(_MCU_STATUS0_LANE + 0x0001)
	movx	a,@dptr
	jnz	00136$
;	../../shared/src/main.c:201: RxFFE_ACCap(); //dfe cont run
	mov	r0,#_RxFFE_ACCap
	mov	r1,#(_RxFFE_ACCap >> 8)
	mov	r2,#(_RxFFE_ACCap >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/main.c:206: PHY_STATUS = ST_NORMAL;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x2B
	movx	@dptr,a
;	../../shared/src/main.c:209: }
00136$:
;	../../shared/src/main.c:212: if(do_rxinit || reg_INT_RX_INIT_RISE_ISR_LANE) {
	jb	_do_rxinit,00157$
	mov	dptr,#(_PM_CTRL_INTERRUPT_REG1_LANE + 0x0003)
	movx	a,@dptr
	jnb	acc.3,00158$
00157$:
;	../../shared/src/main.c:213: if(SKIP_RX_INIT) {
	mov	dptr,#(_MCU_STATUS2_LANE + 0x0002)
	movx	a,@dptr
	jz	00138$
;	../../shared/src/main.c:214: reg_RX_INIT_DONE_LANE = 0; 
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/main.c:215: reg_INT_RX_INIT_RISE_ISR_CLEAR_LANE = 1;
;	../../shared/src/main.c:216: reg_INT_RX_INIT_RISE_ISR_CLEAR_LANE = 0;
	...
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/main.c:217: SKIP_RX_INIT = 0;
	mov	dptr,#(_MCU_STATUS2_LANE + 0x0002)
	clr	a
	movx	@dptr,a
;	../../shared/src/main.c:218: do_rxinit = 0;
	clr	_do_rxinit
;	../../shared/src/main.c:219: reg_RX_INIT_DONE_LANE = 1; 
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
	ljmp	00159$
00138$:
;	../../shared/src/main.c:221: else PHY_STATUS = ST_DTL; 
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x2C
	movx	@dptr,a
	ljmp	00159$
00158$:
;	../../shared/src/main.c:223: else if(do_train | do_rxtrain)  { PHY_STATUS = ST_TRXTRAIN; }
	mov	c,_do_train
	orl	c,_do_rxtrain
	jnc	00155$
	mov	dptr,#_MCU_STATUS0_LANE
	...
	sjmp	00159$
00155$:
;	../../shared/src/main.c:224: else if(do_train==0 && reg_PIN_TX_TRAIN_ENABLE_MUX_RD_LANE) {
	jb	_do_train,00151$
	mov	dptr,#(_TX_TRAIN_CTRL_LANE + 0x0001)
	movx	a,@dptr
	jnb	acc.6,00151$
;	../../shared/src/main.c:225: reg_MCU_DEBUG0_LANE_7_0 = 0x98;
	mov	dptr,#_MCU_DEBUG0_LANE
	mov	a,#0x98
	movx	@dptr,a
;	../../shared/src/main.c:226: txtrain_force_restart();
	mov	r0,#_txtrain_force_restart
	mov	r1,#(_txtrain_force_restart >> 8)
	mov	r2,#(_txtrain_force_restart >> 16)
	lcall	__sdcc_banked_call
	sjmp	00159$
00151$:
;	../../shared/src/main.c:228: else if(do_rxtrain==0 && reg_PIN_RX_TRAIN_ENABLE_RD_LANE) {
	jb	_do_rxtrain,00147$
	mov	dptr,#(_TX_TRAIN_CTRL_LANE + 0x0001)
	movx	a,@dptr
	jnb	acc.5,00147$
;	../../shared/src/main.c:229: reg_MCU_DEBUG0_LANE_7_0 = 0x99;
	mov	dptr,#_MCU_DEBUG0_LANE
	mov	a,#0x99
	movx	@dptr,a
;	../../shared/src/main.c:230: EA = 0;
	clr	_EA
;	../../shared/src/main.c:231: TRX_TRAIN_IF_INTERRUPT_CLEAR_LANE.BT.B0 = 0x01;
;	../../shared/src/main.c:232: TRX_TRAIN_IF_INTERRUPT_CLEAR_LANE.BT.B0 = 0;
	mov	dptr,#_TRX_TRAIN_IF_INTERRUPT_CLEAR_LANE
	mov	a,#0x01
	movx	@dptr,a
	clr	a
	movx	@dptr,a
;	../../shared/src/main.c:234: PHY_STATUS = ST_TRXTRAIN; reg_RX_TRAIN_ON_LANE = 1; do_rxtrain = 1;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x28
	movx	@dptr,a
	...
	movx	@dptr,a
	setb	_do_rxtrain
;	../../shared/src/main.c:235: EA = 1;
	setb	_EA
	sjmp	00159$
00147$:
;	../../shared/src/main.c:240: else if(reg_DFE_MARGIN_EN_LANE && pcie_usb_mode)  { PHY_STATUS = ST_LANE_MARGIN_EN; }
	...
	sjmp	00159$
00143$:
;	../../shared/src/main.c:241: else if(cmx_CAL_START)  { PHY_STATUS = ST_CAL; cal_start_on = 1; }
	...
	movx	@dptr,a
00159$:
;	../../shared/src/main.c:243: if(PHY_MCU_REMOTE_REQ_LANE && lnx_PHY_MCU_LOCAL_ACK_LANE==0)
	...
	movx	a,@dptr
	jb	acc.0,00164$
;	../../shared/src/main.c:244: cmd_if();
	lcall	_cmd_if
	sjmp	00165$
00164$:
;	../../shared/src/main.c:246: else if(PHY_MCU_REMOTE_REQ_LANE==0)
	mov	dptr,#_MCU_COMMAND0
	movx	a,@dptr
	jb	acc.0,00165$
;	../../shared/src/main.c:247: lnx_PHY_MCU_LOCAL_ACK_LANE = 0;
	mov	dptr,#(_TRX_TRAIN_IF_TIMERS_ENABLE_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
00165$:
;	../../shared/src/main.c:257: if(lnx_SQ_AUTO_TRAIN_LANE==1) {
	...
	mov	r2,a
	cjne	r2,#0x01,00168$
;	../../shared/src/main.c:258: sq_auto_train_enable();
	lcall	_sq_auto_train_enable
00168$:
;	../../shared/src/main.c:261: if(PHY_NS != ST_INIT) {
	mov	dptr,#(_MCU_STATUS0_LANE + 0x0001)
	movx	a,@dptr
	jz	00170$
;	../../shared/src/main.c:262: PHY_STATUS = PHY_NS;
	mov	dptr,#(_MCU_STATUS0_LANE + 0x0001)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_MCU_STATUS0_LANE
	movx	@dptr,a
;	../../shared/src/main.c:263: PHY_NS = ST_INIT;
	mov	dptr,#(_MCU_STATUS0_LANE + 0x0001)
	clr	a
	movx	@dptr,a
;	../../shared/src/main.c:264: do_wake = 0;
	clr	_do_wake
;	../../shared/src/main.c:265: continue;
	ljmp	00176$
00170$:
;	../../shared/src/main.c:269: Check_EOM_Stage_fmExt();
	lcall	_Check_EOM_Stage_fmExt
;	../../shared/src/main.c:273: Check_F0d();
	mov	r0,#_Check_F0d
	mov	r1,#(_Check_F0d >> 8)
	mov	r2,#(_Check_F0d >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/main.c:277: if( lnx_CLI_START_LANE == 1 ) cli_monitor();
	...
	lcall	_cli_monitor
00172$:
;	../../shared/src/main.c:281: reg_MCU_WDT_RESET_LANE = !reg_MCU_WDT_RESET_LANE;
	mov	dptr,#(_MCU_MEM_REG2_LANE + 0x0003)
	movx	a,@dptr
	rl	a
	anl	a,#0x01
	mov	r2,a
