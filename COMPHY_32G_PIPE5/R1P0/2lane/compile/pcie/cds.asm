...
;--------------------------------------------------------
	.area BANK1   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'cdr_dfe_init'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/cds.c:125: void cdr_dfe_init(void) BANKING_CTRL {
;	-----------------------------------------
;	 function cdr_dfe_init
;	-----------------------------------------
_cdr_dfe_init:
	ar2 = 0x02
	ar3 = 0x03
	...
	ar0 = 0x00
	ar1 = 0x01
;	../../shared/src/cds.c:135: f1_ofst_adjustment_en = 0; //1 //hardware has bug
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0002)
	movx	a,@dptr
	anl	a,#0xef
	movx	@dptr,a
;	../../shared/src/cds.c:147: dfe_f0_en	  = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_21
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/cds.c:148: dfe_f1to3_en  = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_21
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/cds.c:149: dfe_f4to7_en  = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_21
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/cds.c:150: dfe_f8to15_en = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_21
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/cds.c:151: dfe_ffloat_en = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_22
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/cds.c:155: reg_DFE_MMSE_MODE_LANE = MMSE_ADAPT_MODE;
	mov	dptr,#(_DFE_CTRL_REG0 + 0x0001)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/cds.c:157: data_slicer_path_switch_eve = 0;
	mov	dptr,#_DFE_ANA_REG0
	movx	a,@dptr
	anl	a,#0xef
	movx	@dptr,a
;	../../shared/src/cds.c:158: data_slicer_path_switch_odd = 0;
	mov	dptr,#_DFE_ANA_REG0
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/cds.c:160: f1p_f1n_fb_mode = 0;
	mov	dptr,#(_DFE_CTRL_REG1 + 0x0001)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/cds.c:161: f0_fb_mode = 0;
	mov	dptr,#(_DFE_CTRL_REG1 + 0x0001)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/cds.c:163: if(tx_status_pcie_mode) {
	jnb	_tx_status_pcie_mode,00103$
;	../../shared/src/cds.c:164: set_slicer_data_sampler_adapt_PCIe();	
	mov	dptr,#_DFE_CTRL_REG0
	movx	a,@dptr
	anl	a,#0x0f
	orl	a,#0xc0
	movx	@dptr,a
;	../../shared/src/cds.c:165: set_PCIe_fb_mode();		
	mov	dptr,#(_DFE_CTRL_REG1 + 0x0001)
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
...
;------------------------------------------------------------
;Allocation info for local variables in function 'DFE_Oncewhile_Adapt'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/cds.c:174: void DFE_Oncewhile_Adapt(void) BANKING_CTRL {
;	-----------------------------------------
;	 function DFE_Oncewhile_Adapt
;	-----------------------------------------
_DFE_Oncewhile_Adapt:
;	../../shared/src/cds.c:175: if(tag_DFE_ADAPT_NORMAL_SOFT_CONT_EN==0) return;
	mov	dptr,#_DFE_CONTROL_5
	movx	a,@dptr
	jb	acc.4,00102$
	ljmp	00110$
00102$:
;	../../shared/src/cds.c:176: if(lnx_DFE_ADAPT_NORMAL_FORCE_SKIP_LANE == 0 && lnx_PHASE_ADAPT_ENABLE_LANE==0 && dfe_dis == 0 &&  eom_ext_mode==0) 
	mov	dptr,#_DFE_CONTROL_5
	movx	a,@dptr
	jnb	acc.3,00119$
	ljmp	00110$
...
00121$:
	...
	ljmp	00110$
00122$:
;	../../shared/src/cds.c:178: dfe_norm_cnt++;
	mov	dptr,#_dfe_norm_cnt
	movx	a,@dptr
	add	a,#0x01
	movx	@dptr,a
;	../../shared/src/cds.c:179: if(dfe_norm_cnt>3) { //100) { 
	mov	dptr,#_dfe_norm_cnt
	movx	a,@dptr
	mov	r2,a
	mov	a,#0x03
...
00123$:
	...
	ljmp	00110$
00124$:
;	../../shared/src/cds.c:180: dfe_norm_cnt = 0;
	mov	dptr,#_dfe_norm_cnt
	clr	a
	movx	@dptr,a
;	../../shared/src/cds.c:181: dfe_load_type(1); 	
	mov	dpl,#0x01
	mov	r0,#_dfe_load_type
	mov	r1,#(_dfe_load_type >> 8)
	mov	r2,#(_dfe_load_type >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cds.c:182: enable_all_tap_adapt();	
	mov	r0,#_enable_all_tap_adapt
	mov	r1,#(_enable_all_tap_adapt >> 8)
	mov	r2,#(_enable_all_tap_adapt >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cds.c:183: reg_DFE_UPDATE_EN_LANE_15_0_b1 = 0;	//for f0/f2/f3/ofst
	mov	dptr,#(_DFE_CTRL_REG2 + 0x0001)
	clr	a
	movx	@dptr,a
;	../../shared/src/cds.c:184: reg_DFE_UPDATE_EN_LANE_15_0_b0 &= 0x0d;
	...
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/cds.c:185: ofst_en = 1; 
	mov	dptr,#(_DFE_CTRL_REG2 + 0x0002)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/cds.c:187: data_slic_fb_mode = 0;
	mov	dptr,#(_DFE_CTRL_REG1 + 0x0001)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/cds.c:188: f1p_f1n_fb_mode = 0;
	mov	dptr,#(_DFE_CTRL_REG1 + 0x0001)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/cds.c:189: f0_fb_mode = 0;
	mov	dptr,#(_DFE_CTRL_REG1 + 0x0001)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/cds.c:190: reg_DFE_ADAPT_SPLR_EN_LANE_3_0 = 0x0f; //[3]f1p_slic_samp_adapt_en = true;
	mov	dptr,#_DFE_CTRL_REG0
	movx	a,@dptr
	orl	a,#0xf0
	movx	@dptr,a
;	../../shared/src/cds.c:198: dfe_fsm(0x1010, 4);
	mov	a,#0x04
	push	acc
	mov	dptr,#0x1010
	mov	r0,#_dfe_fsm
	...
	lcall	__sdcc_banked_call
	dec	sp
;	../../shared/src/cds.c:201: enable_all_tap_adapt();
	mov	r0,#_enable_all_tap_adapt
	mov	r1,#(_enable_all_tap_adapt >> 8)
	mov	r2,#(_enable_all_tap_adapt >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cds.c:202: reg_DFE_UPDATE_EN_LANE_15_0_b0 &= 0xf0;
	mov	dptr,#_DFE_CTRL_REG2
	movx	a,@dptr
	mov	r2,a
	anl	ar2,#0xF0
	...
	mov	a,r2
	movx	@dptr,a
;	../../shared/src/cds.c:203: ofst_en = 0; 
	mov	dptr,#(_DFE_CTRL_REG2 + 0x0002)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/cds.c:207: dfe_fsm(0x1001, 4);
	mov	a,#0x04
	push	acc
	mov	dptr,#0x1001
	mov	r0,#_dfe_fsm
...
00110$:
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
;Allocation info for local variables in function 'RxFFE_ACCap'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/cds.c:215: void RxFFE_ACCap(void) BANKING_CTRL {
;	-----------------------------------------
;	 function RxFFE_ACCap
;	-----------------------------------------
_RxFFE_ACCap:
;	../../shared/src/cds.c:216: if( lnx_CKFW_EN_LANE) {
	mov	dptr,#_DFE_CONTROL_5
	movx	a,@dptr
	jnb	acc.0,00105$
;	../../shared/src/cds.c:217: if(reg_RX_PULSE_CKFW_LANE) {
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_153
	movx	a,@dptr
	jnb	acc.2,00102$
;	../../shared/src/cds.c:218: reg_RX_PULSE_CKFW_LANE = 0;	
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_153
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
	sjmp	00107$
00102$:
;	../../shared/src/cds.c:222: reg_RX_PULSE_CKFW_LANE = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_153
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/cds.c:225: DFE_Oncewhile_Adapt();	
	mov	r0,#_DFE_Oncewhile_Adapt
	mov	r1,#(_DFE_Oncewhile_Adapt >> 8)
	mov	r2,#(_DFE_Oncewhile_Adapt >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cds.c:226: Edge_Sampler_Update();					
	mov	r0,#_Edge_Sampler_Update
	mov	r1,#(_Edge_Sampler_Update >> 8)
	mov	r2,#(_Edge_Sampler_Update >> 16)
	lcall	__sdcc_banked_call
	sjmp	00107$
00105$:
;	../../shared/src/cds.c:233: DFE_Oncewhile_Adapt();	
	mov	r0,#_DFE_Oncewhile_Adapt
	mov	r1,#(_DFE_Oncewhile_Adapt >> 8)
	mov	r2,#(_DFE_Oncewhile_Adapt >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/cds.c:234: Edge_Sampler_Update();
	mov	r0,#_Edge_Sampler_Update
	mov	r1,#(_Edge_Sampler_Update >> 8)
	mov	r2,#(_Edge_Sampler_Update >> 16)
	lcall	__sdcc_banked_call
