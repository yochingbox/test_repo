...
;--------------------------------------------------------
	.globl _set_remote_tx
	.globl _set_remote_tx_pam2
	.globl _set_train_comp
	.globl _train_if_init
	.globl _TF2
	.globl _TI
	.globl _RI
	.globl _EX12
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'train_if_init'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/tx_train_if.c:5: void train_if_init() {
;	-----------------------------------------
;	 function train_if_init
;	-----------------------------------------
_train_if_init:
	ar2 = 0x02
	ar3 = 0x03
	...
	ar0 = 0x00
	ar1 = 0x01
;	../../shared/src/tx_train_if.c:8: reg_INT_TX_TRAIN_COMPLETE_LANE = 0;
	mov	dptr,#(_TX_TRAIN_CTRL_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xef
	movx	@dptr,a
;	../../shared/src/tx_train_if.c:9: reg_INT_TX_TRAIN_FAILED_LANE = 0;
	mov	dptr,#(_TX_TRAIN_CTRL_LANE + 0x0003)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
;	../../shared/src/tx_train_if.c:10: reg_INT_LOCAL_CTRL_REQ_LANE = 0;
	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/tx_train_if.c:11: reg_INT_LOCAL_CTRL_RESET_LANE = 0;
	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/tx_train_if.c:12: reg_INT_TX_PRESET_INDEX_LANE_3_0 = 0;
	mov	dptr,#_TX_TRAIN_IF_REG7
	movx	a,@dptr
	anl	a,#0x0f
	movx	@dptr,a
;	../../shared/src/tx_train_if.c:13: reg_INT_LOCAL_CTRL_G0_LANE_1_0 = 0;
	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
	movx	a,@dptr
	anl	a,#0xf9
	movx	@dptr,a
;	../../shared/src/tx_train_if.c:14: reg_INT_LOCAL_CTRL_G1_LANE_1_0 = 0;
	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
	movx	a,@dptr
	anl	a,#0xe7
	movx	@dptr,a
;	../../shared/src/tx_train_if.c:15: reg_INT_LOCAL_CTRL_GN1_LANE_1_0 = 0;
	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
	movx	a,@dptr
	anl	a,#0x9f
	movx	@dptr,a
;	../../shared/src/tx_train_if.c:19: reg_STATUS_DET_TIMEOUT_ISR_CLEAR_LANE = 0;
	mov	dptr,#(_TRX_TRAIN_IF_INTERRUPT_CLEAR_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/tx_train_if.c:20: drv_TXTRAIN_STATUS_C0 = 0;
	mov	dptr,#(_TXTRAIN_IF_REG0 + 0x0003)
	movx	a,@dptr
	anl	a,#0xf8
	movx	@dptr,a
;	../../shared/src/tx_train_if.c:21: drv_TXTRAIN_STATUS_C1 = 0;
	mov	dptr,#(_TXTRAIN_IF_REG0 + 0x0003)
	movx	a,@dptr
	anl	a,#0xc7
	movx	@dptr,a
;	../../shared/src/tx_train_if.c:22: drv_TXTRAIN_STATUS_CN1 = 0;
	mov	dptr,#(_TXTRAIN_IF_REG0 + 0x0002)
	movx	a,@dptr
	anl	a,#0xc7
	movx	@dptr,a
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'set_train_comp'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/tx_train_if.c:27: void set_train_comp() {
;	-----------------------------------------
;	 function set_train_comp
;	-----------------------------------------
_set_train_comp:
;	../../shared/src/tx_train_if.c:30: if(drv_TXTRAIN_FAIL) {
	mov	dptr,#(_TXTRAIN_IF_REG0 + 0x0001)
	movx	a,@dptr
	jnb	acc.6,00102$
;	../../shared/src/tx_train_if.c:31: reg_INT_TX_TRAIN_FAILED_LANE = 1;
	mov	dptr,#(_TX_TRAIN_CTRL_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
00102$:
;	../../shared/src/tx_train_if.c:33: reg_INT_TX_TRAIN_COMPLETE_LANE = 1;
	mov	dptr,#(_TX_TRAIN_CTRL_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'set_remote_tx_pam2'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/tx_train_if.c:38: void set_remote_tx_pam2() {
;	-----------------------------------------
;	 function set_remote_tx_pam2
;	-----------------------------------------
_set_remote_tx_pam2:
;	../../shared/src/tx_train_if.c:41: if(drv_TXTRAIN_CTRL_PRESET) {
	mov	dptr,#(_TXTRAIN_IF_REG0 + 0x0001)
	movx	a,@dptr
	anl	a,#0x3c
	jz	00102$
;	../../shared/src/tx_train_if.c:42: reg_INT_LOCAL_CTRL_RESET_LANE = 1;
	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
	movx	a,@dptr
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/tx_train_if.c:43: reg_INT_TX_PRESET_INDEX_LANE_3_0 = drv_TXTRAIN_CTRL_PRESET;
	mov	dptr,#(_TXTRAIN_IF_REG0 + 0x0001)
	movx	a,@dptr
	rr	a
	rr	a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/tx_train_if.c:44: reg_INT_LOCAL_CTRL_G0_LANE_1_0 = 0;
	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
	movx	a,@dptr
	anl	a,#0xf9
	movx	@dptr,a
;	../../shared/src/tx_train_if.c:45: reg_INT_LOCAL_CTRL_G1_LANE_1_0 = 0;
	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
	movx	a,@dptr
	anl	a,#0xe7
	movx	@dptr,a
;	../../shared/src/tx_train_if.c:46: reg_INT_LOCAL_CTRL_GN1_LANE_1_0 = 0;
	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
	movx	a,@dptr
	anl	a,#0x9f
	movx	@dptr,a
	sjmp	00103$
00102$:
;	../../shared/src/tx_train_if.c:48: reg_INT_LOCAL_CTRL_RESET_LANE = 0;
	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/tx_train_if.c:49: reg_INT_TX_PRESET_INDEX_LANE_3_0 = 0;
	mov	dptr,#_TX_TRAIN_IF_REG7
	movx	a,@dptr
	anl	a,#0x0f
	movx	@dptr,a
;	../../shared/src/tx_train_if.c:50: reg_INT_LOCAL_CTRL_G0_LANE_1_0 = drv_TXTRAIN_CTRL_C0;
	mov	dptr,#_TXTRAIN_IF_REG0
	movx	a,@dptr
	rl	a
	rl	a
	anl	a,#0x03
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/tx_train_if.c:51: reg_INT_LOCAL_CTRL_G1_LANE_1_0 = drv_TXTRAIN_CTRL_C1;
	mov	dptr,#(_TXTRAIN_IF_REG0 + 0x0001)
	movx	a,@dptr
	anl	a,#0x03
	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/tx_train_if.c:52: reg_INT_LOCAL_CTRL_GN1_LANE_1_0 = drv_TXTRAIN_CTRL_CN1;
	mov	dptr,#_TXTRAIN_IF_REG0
	movx	a,@dptr
	swap	a
	anl	a,#0x03
	...
	movx	@dptr,a
00103$:
;	../../shared/src/tx_train_if.c:55: reg_INT_LOCAL_CTRL_REQ_LANE = 1;
	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/tx_train_if.c:58: while(!reg_INT_REMOTE_STATUS_ACK_LANE && !reg_TX_TRAIN_FAILED_LANE && reg_TX_TRAIN_ENABLE_RD_LANE);
00106$:
	...
	jb	acc.6,00106$
00108$:
;	../../shared/src/tx_train_if.c:60: drv_TXTRAIN_STATUS_C0 = reg_INT_REMOTE_STATUS_G0_LANE_1_0;
	mov	dptr,#_TX_TRAIN_IF_REG5
	movx	a,@dptr
	rr	a
	anl	a,#0x03
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/tx_train_if.c:61: drv_TXTRAIN_STATUS_C1 = reg_INT_REMOTE_STATUS_G1_LANE_1_0;
	mov	dptr,#_TX_TRAIN_IF_REG5
	movx	a,@dptr
	swap	a
	rl	a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/tx_train_if.c:62: drv_TXTRAIN_STATUS_CN1 = reg_INT_REMOTE_STATUS_GN1_LANE_1_0;
	mov	dptr,#_TX_TRAIN_IF_REG5
	movx	a,@dptr
	swap	a
	rr	a
	...
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'set_remote_tx'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../shared/src/tx_train_if.c:129: void set_remote_tx() {
;	-----------------------------------------
;	 function set_remote_tx
;	-----------------------------------------
_set_remote_tx:
;	../../shared/src/tx_train_if.c:132: while(reg_INT_REMOTE_STATUS_ACK_LANE);
00101$:
	mov	dptr,#_TX_TRAIN_IF_REG5
	movx	a,@dptr
	jb	acc.0,00101$
;	../../shared/src/tx_train_if.c:137: set_remote_tx_pam2();
	lcall	_set_remote_tx_pam2
;	../../shared/src/tx_train_if.c:141: reg_INT_LOCAL_CTRL_REQ_LANE = 0;
	mov	dptr,#(_TX_TRAIN_IF_REG7 + 0x0002)
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/tx_train_if.c:144: reg_STATUS_DET_TIMEOUT_ISR_CLEAR_LANE = 0;
	mov	dptr,#(_TRX_TRAIN_IF_INTERRUPT_CLEAR_LANE + 0x0001)
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/tx_train_if.c:147: if(reg_STATUS_DET_TIMEOUT_ISR_LANE || reg_TX_TRAIN_FAILED_LANE) {
	...
	jnb	acc.3,00105$
00104$:
;	../../shared/src/tx_train_if.c:148: drv_TXTRAIN_STATUS_VALID = 0;
	mov	dptr,#(_TXTRAIN_IF_REG0 + 0x0003)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
	sjmp	00106$
00105$:
;	../../shared/src/tx_train_if.c:150: drv_TXTRAIN_STATUS_VALID = 1;
	mov	dptr,#(_TXTRAIN_IF_REG0 + 0x0003)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
00106$:
;	../../shared/src/tx_train_if.c:153: reg_STATUS_DET_TIMEOUT_ISR_CLEAR_LANE = 1;
	mov	dptr,#(_TRX_TRAIN_IF_INTERRUPT_CLEAR_LANE + 0x0001)
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
