...
;--------------------------------------------------------
	.area BANK2   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'squelch_cal'
;------------------------------------------------------------
;dir                       Allocated to registers r5 
;sq_cnt                    Allocated to registers r6 
;thr_sel                   Allocated to registers r4 
;thr_cnt                   Allocated to stack - offset 1
;up                        Allocated to registers r2 
;loop_cnt                  Allocated to registers r3 
;thr1                      Allocated to stack - offset 2
;thr2                      Allocated to stack - offset 3
;final_offset              Allocated to stack - offset 4
;offset2                   Allocated to registers r3 
;over_loop_cnt             Allocated to registers b0 
;output_cnt                Allocated to stack - offset 5
;------------------------------------------------------------
;	../../shared/src/squelch_cal.c:43: void squelch_cal() BANKING_CTRL {
;	-----------------------------------------
;	 function squelch_cal
;	-----------------------------------------
_squelch_cal:
	ar2 = 0x02
	ar3 = 0x03
	...
	add	a,#0x05
	mov	sp,a
;	../../shared/src/squelch_cal.c:52: BIT over_loop_cnt = 0;	// Indicating if the loop is exited when loop count is over the limit
	clr	b0
;	../../shared/src/squelch_cal.c:55: lnx_SQ_CAL_DONE_LANE = 0;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:57: if( cmx_SQ_CAL_EXT_EN ) {
	mov	dptr,#(_CONTROL_CONFIG1 + 0x0003)
	movx	a,@dptr
	jnb	acc.3,00102$
;	../../shared/src/squelch_cal.c:58: SQ_OFFSET = lnx_CAL_SQ_OFFSET_LANE_7_0;
	mov	dptr,#(_CAL_SAVE_DATA1_LANE + 0x0002)
	movx	a,@dptr
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_3
	swap	a
	rr	a
	anl	a,#(0xf8&0xf8)
	mov	b,a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:59: SQ_THRESH = lnx_CAL_SQ_THRESH_LANE_7_0;
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:60: lnx_SQ_CAL_DONE_LANE = 1;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:61: return;
	ljmp	00143$
00102$:
;	../../shared/src/squelch_cal.c:64: PHY_STATUS = ST_SQ_CAL;
	mov	dptr,#_MCU_STATUS0_LANE
	mov	a,#0x14
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:66: lnx_SQ_CAL_PASS_LANE = 0;
	mov	dptr,#(_CAL_CTRL2_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xdf
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:70: final_offset = 0;
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	@r0,#0x00
;	../../shared/src/squelch_cal.c:72: SQ_CAL_PU = 1;
	mov	dptr,#(_PM_CTRL_RX_LANE_REG1_LANE + 0x0003)
	movx	a,@dptr
	orl	a,#0x20
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:73: delay01(10);
	mov	dptr,#0x000A
	push	bits
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	...
	pop	bits
;	../../shared/src/squelch_cal.c:74: SQ_CAL_EN = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_131
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:75: delay01(10);
	mov	dptr,#0x000A
	push	bits
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	...
	lcall	__sdcc_banked_call
	pop	bits
;	../../shared/src/squelch_cal.c:76: SQ_OFFSET_CAL_EN = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_2
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:78: SQ_THRESH = 0x20;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_4
	movx	a,@dptr
	anl	a,#0x03
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:79: SQ_OFFSET = 0x10;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_3
	movx	a,@dptr
	anl	a,#0x07
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:81: OFFSETCAL_SEL = 0x3;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_4
	movx	a,@dptr
	orl	a,#0x03
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:82: delay01(10);
	mov	dptr,#0x000A
	push	bits
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	...
	lcall	__sdcc_banked_call
	pop	bits
;	../../shared/src/squelch_cal.c:86: do {
	mov	r0,_bp
	inc	r0
	mov	@r0,#0x00
;	../../shared/src/squelch_cal.c:88: do {
00179$:
	mov	r4,#0x01
00116$:
;	../../shared/src/squelch_cal.c:89: OFFSETCAL_SEL = thr_sel;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_4
	mov	a,r4
	anl	a,#0x03
	mov	b,a
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:91: dir    = 0;
	mov	r5,#0x00
;	../../shared/src/squelch_cal.c:92: sq_cnt = 0;        
	mov	r6,#0x00
;	../../shared/src/squelch_cal.c:95: while ( ( loop_cnt < 64 ) && ( sq_cnt != 32 ) && ( sq_cnt != -32 ) ) {
	mov	r7,#0x00
	mov	r3,#0x00
00108$:
	clr	c
...
00211$:
	...
	ljmp	00110$
00212$:
;	../../shared/src/squelch_cal.c:96: SQ_THRESH = ( sq_cnt < 0 ) ? -sq_cnt : ( sq_cnt + 0x20 );	// Bit[6] is sign bit, 1 = pos
	mov	a,r6
	jnb	acc.7,00145$
	clr	c
	clr	a
...
00146$:
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:97: delay01(5);
	mov	dptr,#0x0005
	push	ar3
	push	ar4
	push	ar5
	...
	pop	ar4
	pop	ar3
;	../../shared/src/squelch_cal.c:98: up = SQ_OUT;
	mov	dptr,#_RX_CALIBRATION_REG
	movx	a,@dptr
	swap	a
	anl	a,#0x01
	mov	r2,a
;	../../shared/src/squelch_cal.c:99: dir = (dir << 1 ) | up;
	mov	a,r5
	add	a,r5
	mov	r4,a
	mov	a,r2
	orl	ar4,a
	mov	ar5,r4
;	../../shared/src/squelch_cal.c:100: ++output_cnt;
	inc	r7
;	../../shared/src/squelch_cal.c:101: if ( is_toggle_pat( dir, output_cnt ) )
	push	ar2
	push	ar3
	push	ar4
	push	ar5
	...
	pop	ar4
	jb	b1,00110$
;	../../shared/src/squelch_cal.c:104: up ? --sq_cnt : ++sq_cnt;
	mov	a,r2
	jz	00147$
	dec	r6
	sjmp	00105$
00147$:
	inc	r6
00105$:
;	../../shared/src/squelch_cal.c:105: loop_cnt ++;        
	inc	r3
	ljmp	00108$
00110$:
;	../../shared/src/squelch_cal.c:107: if ( loop_cnt >= 64 )
	clr	c
	mov	a,r3
	xrl	a,#0x80
	subb	a,#0xc0
	jc	00112$
;	../../shared/src/squelch_cal.c:108: over_loop_cnt = 1;
	setb	b0
00112$:
;	../../shared/src/squelch_cal.c:109: if ( thr_sel == 0x1 )
	cjne	r4,#0x01,00114$
;	../../shared/src/squelch_cal.c:110: thr1 = sq_cnt;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,ar6
	sjmp	00117$
00114$:
;	../../shared/src/squelch_cal.c:112: thr2 = sq_cnt;
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	@r0,ar6
00117$:
;	../../shared/src/squelch_cal.c:113: } while ( thr_sel++ < 2 );	
	mov	ar3,r4
	inc	r4
	cjne	r3,#0x02,00219$
00219$:
	...
	ljmp	00116$
00220$:
;	../../shared/src/squelch_cal.c:115: if ( thr_cnt == 0 ) {
	mov	r0,_bp
	inc	r0
	mov	a,@r0
	jnz	00120$
;	../../shared/src/squelch_cal.c:120: final_offset = thr1 - thr2;	// This is offset1
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	a,_bp
	...
	mov	r0,a
	mov	@r0,ar3
;	../../shared/src/squelch_cal.c:122: final_offset = final_offset > 15 ? 15 : ( final_offset < - 15 ? -15 : final_offset );
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	clr	c
...
00150$:
	...
	sjmp	00121$
00120$:
;	../../shared/src/squelch_cal.c:126: offset2 = thr2 - thr1;
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	r1,_bp
	...
	subb	a,@r1
	mov	r3,a
;	../../shared/src/squelch_cal.c:128: offset2 = offset2 > 15 ? 15 : ( offset2 < - 15 ? -15 : offset2 );
	clr	c
	mov	a,#(0x0F ^ 0x80)
	mov	b,r3
	xrl	b,#0x80
...
00156$:
	mov	ar4,r7
00154$:
;	../../shared/src/squelch_cal.c:133: final_offset = final_offset - offset2; // Final offset
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,@r0
	...
	subb	a,r4
	mov	@r0,a
;	../../shared/src/squelch_cal.c:135: final_offset = final_offset > 15 ? 15 : ( final_offset < - 15 ? -15 : final_offset );
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	clr	c
...
00158$:
	...
	mov	@r0,ar3
00121$:
;	../../shared/src/squelch_cal.c:138: if ( final_offset > 0 )
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	clr	c
	...
	subb	a,b
	jnc	00123$
;	../../shared/src/squelch_cal.c:139: SQ_OFFSET = ( final_offset & 0x0F ) | 0x10;
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,#0x0F
	...
	sjmp	00126$
00123$:
;	../../shared/src/squelch_cal.c:141: SQ_OFFSET = ( -final_offset ) & 0x0F;
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	clr	c
	...
	movx	@dptr,a
00126$:
;	../../shared/src/squelch_cal.c:142: } while ( thr_cnt++ < 1 );
	mov	r0,_bp
	inc	r0
	mov	ar3,@r0
	mov	r0,_bp
...
00229$:
	...
	ljmp	00179$
00230$:
;	../../shared/src/squelch_cal.c:145: OFFSETCAL_SEL = 0x03;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_4
	movx	a,@dptr
	orl	a,#0x03
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:146: SQ_THRESH = 0x20;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_4
	movx	a,@dptr
	anl	a,#0x03
	orl	a,#0x80
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:147: SQ_OFFSET_CAL_EN = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_2
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:148: delay01(10);
	mov	dptr,#0x000A
	push	bits
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	...
	lcall	__sdcc_banked_call
	pop	bits
;	../../shared/src/squelch_cal.c:149: SQ_THRESH_CAL_EN = 1;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_133
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:150: delay01(10);
	mov	dptr,#0x000A
	push	bits
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	...
	lcall	__sdcc_banked_call
	pop	bits
;	../../shared/src/squelch_cal.c:153: do {
	mov	r3,#0x00
00140$:
;	../../shared/src/squelch_cal.c:154: sq_cnt = 0;
	mov	r6,#0x00
;	../../shared/src/squelch_cal.c:156: dir    = 0;
	mov	r5,#0x00
;	../../shared/src/squelch_cal.c:158: SQ_REFTHR = ( 0 == thr_cnt ) ? 0x07 : 0x17;	// SQ_REFTHR = 00111b and then 10111b
	cjne	r3,#0x00,00161$
	mov	r4,#0x07
	sjmp	00162$
00161$:
...
00162$:
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:159: while ( ( loop_cnt < 64 ) && ( sq_cnt != 32 ) && ( sq_cnt != -32 ) ) {
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
	mov	@r0,#0x00
...
00234$:
	...
	ljmp	00134$
00235$:
;	../../shared/src/squelch_cal.c:160: SQ_THRESH = ( sq_cnt < 0 ) ? -sq_cnt : ( sq_cnt + 0x20 );	// Bit[6] is sign bit, 1 = pos
	mov	a,r6
	jnb	acc.7,00163$
	clr	c
	clr	a
...
00164$:
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:161: delay01(5);
	mov	dptr,#0x0005
	push	ar3
	push	ar5
	push	ar6
	...
	pop	ar5
	pop	ar3
;	../../shared/src/squelch_cal.c:162: up = SQ_OUT;
	mov	dptr,#_RX_CALIBRATION_REG
	movx	a,@dptr
	swap	a
	anl	a,#0x01
	mov	r2,a
;	../../shared/src/squelch_cal.c:163: dir = ( dir << 1 ) | up;
	mov	a,r5
	add	a,r5
	mov	r4,a
	mov	a,r2
	orl	ar4,a
	mov	ar5,r4
;	../../shared/src/squelch_cal.c:164: ++output_cnt;
	mov	a,_bp
	add	a,#0x05
	mov	r0,a
	inc	@r0
;	../../shared/src/squelch_cal.c:165: if ( is_toggle_pat( dir, output_cnt ) )
	push	ar2
	push	ar3
	push	ar5
	push	ar6
	...
	mov	b1,c
	jc	00134$
;	../../shared/src/squelch_cal.c:167: up ? --sq_cnt : ++sq_cnt;
	mov	a,r2
	jz	00165$
	dec	r6
	sjmp	00166$
00165$:
	inc	r6
00166$:
;	../../shared/src/squelch_cal.c:168: loop_cnt ++;
	inc	r7
	ljmp	00132$
00134$:
;	../../shared/src/squelch_cal.c:170: if ( loop_cnt >= 64 )
	clr	c
	mov	a,r7
	xrl	a,#0x80
	subb	a,#0xc0
	jc	00136$
;	../../shared/src/squelch_cal.c:171: over_loop_cnt = 1;
	setb	b0
00136$:
;	../../shared/src/squelch_cal.c:172: if ( thr_cnt == 0 )
	mov	a,r3
	jnz	00138$
;	../../shared/src/squelch_cal.c:173: thr1 = sq_cnt;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	@r0,ar6
	sjmp	00141$
00138$:
;	../../shared/src/squelch_cal.c:175: thr2 = sq_cnt;
	mov	a,_bp
	add	a,#0x03
	mov	r0,a
	mov	@r0,ar6
00141$:
;	../../shared/src/squelch_cal.c:176: }  while( thr_cnt++ < 1 );
	mov	ar2,r3
	inc	r3
	cjne	r2,#0x01,00241$
00241$:
	...
	ljmp	00140$
00242$:
;	../../shared/src/squelch_cal.c:177: sq_cnt = ( thr1 + thr2 ) >> 1;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	ar2,@r0
	...
	mov	r3,a
	mov	ar6,r2
;	../../shared/src/squelch_cal.c:178: SQ_THRESH = ( sq_cnt < 0 ) ? -sq_cnt : ( sq_cnt + 0x20 );
	mov	a,r6
	jnb	acc.7,00167$
	clr	c
	clr	a
...
00168$:
	...
	orl	a,b
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:180: SQ_THRESH_CAL_EN = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_133
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:181: delay01(10);
	mov	dptr,#0x000A
	push	bits
	mov	r0,#_delay01
	mov	r1,#(_delay01 >> 8)
	...
	lcall	__sdcc_banked_call
	pop	bits
;	../../shared/src/squelch_cal.c:182: SQ_CAL_EN = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_131
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:183: OFFSETCAL_SEL  = 0x3;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_4
	movx	a,@dptr
	orl	a,#0x03
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:185: lnx_CAL_SQ_OFFSET_LANE_7_0 = SQ_OFFSET;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_3
	movx	a,@dptr
	swap	a
	rl	a
	...
	mov	dptr,#(_CAL_SAVE_DATA1_LANE + 0x0002)
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:186: lnx_CAL_SQ_THRESH_LANE_7_0 = SQ_THRESH;
	mov	dptr,#_UPHY14_TRX_ANAREG_BOT_4
	movx	a,@dptr
	rr	a
	rr	a
	...
	mov	dptr,#(_CAL_SAVE_DATA1_LANE + 0x0003)
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:188: lnx_SQ_CAL_DONE_LANE = 1;
	mov	dptr,#(_CAL_CTRL1_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/squelch_cal.c:189: lnx_SQ_CAL_PASS_LANE = ( 0 == over_loop_cnt );  // Pass = 1 indicates no timeout (toggled or reached boundaries)
	mov	c,b0
	clr	a
	rlc	a
	mov	r2,a
