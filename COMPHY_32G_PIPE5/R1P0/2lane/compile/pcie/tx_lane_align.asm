...
;--------------------------------------------------------
	.area BANK1   (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'txlane_align'
;------------------------------------------------------------
;save_txdcc_en             Allocated to registers r2 
;save_txdcccal_en          Allocated to registers r3 
;save_txdcccal_pdiv_en     Allocated to registers r4 
;------------------------------------------------------------
;	../../shared/src/tx_lane_align.c:18: void txlane_align(void) BANKING_CTRL {
;	-----------------------------------------
;	 function txlane_align
;	-----------------------------------------
_txlane_align:
	ar2 = 0x02
	ar3 = 0x03
	...
	ar0 = 0x00
	ar1 = 0x01
;	../../shared/src/tx_lane_align.c:21: reg_MCU_DEBUG0_LANE_7_0 = 0x89;
	mov	dptr,#_MCU_DEBUG0_LANE
	mov	a,#0x89
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:23: if( phy_mode!=PCIE ) return;
...
00205$:
	ljmp	00171$
00102$:
;	../../shared/src/tx_lane_align.c:24: if( cmx_TX_LANE_ALIGN_OFF ) return;
	mov	dptr,#_CONTROL_CONFIG0
	movx	a,@dptr
	jnb	acc.4,00104$
	ljmp	00171$
00104$:
;	../../shared/src/tx_lane_align.c:25: if(reg_LANE_DISABLE_RD_LANE) return;
	mov	dptr,#_TX_SYSTEM_LANE
	movx	a,@dptr
	jnb	acc.0,00106$
	ljmp	00171$
00106$:
;	../../shared/src/tx_lane_align.c:28: save_txdcc_en = reg_TXDCC_EN_LANE;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_146
	movx	a,@dptr
	anl	a,#0x01
	mov	r2,a
;	../../shared/src/tx_lane_align.c:29: save_txdcccal_en = reg_TXDCCCAL_EN_LANE;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_147
	movx	a,@dptr
	rl	a
	anl	a,#0x01
	mov	r3,a
;	../../shared/src/tx_lane_align.c:30: save_txdcccal_pdiv_en = reg_TXDCCCAL_PDIV_EN_LANE; 
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_151
	movx	a,@dptr
	rr	a
	anl	a,#0x01
	mov	r4,a
;	../../shared/src/tx_lane_align.c:32: if(!reg_PHY_ALIGN_OFF) {
	mov	dptr,#_SYSTEM
	movx	a,@dptr
	jnb	acc.2,00208$
	ljmp	00169$
00208$:
;	../../shared/src/tx_lane_align.c:41: mcu_align_0(0x50);
	mov	dpl,#0x50
	push	ar2
	push	ar3
	push	ar4
	...
	pop	ar3
	pop	ar2
;	../../shared/src/tx_lane_align.c:42: reg_MCU_DEBUG0_LANE_7_0 = 0x8a;
	mov	dptr,#_MCU_DEBUG0_LANE
	mov	a,#0x8A
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:45: if(!reg_MASTER_PHY_EN) {
	mov	dptr,#_SYSTEM
	movx	a,@dptr
	jb	acc.3,00109$
;	../../shared/src/tx_lane_align.c:47: if(mcuid==master_mcu) {
	...
	mov	a,r5
	cjne	a,ar6,00117$
;	../../shared/src/tx_lane_align.c:48: reg_TXCLK_SYNC_START_OUT = 1;
	mov	dptr,#(_INPUT_CMN_PIN_REG2 + 0x0003)
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:49: reg_TXCLK_SYNC_EN_OUT = 1;	
	mov	dptr,#(_INPUT_CMN_PIN_REG2 + 0x0003)
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:54: while(reg_TXCLK_SYNC_START_IN_RD==0);
	sjmp	00117$
00109$:
	mov	dptr,#(_INPUT_CMN_PIN_REG2 + 0x0003)
	movx	a,@dptr
	jnb	acc.0,00109$
;	../../shared/src/tx_lane_align.c:55: if(mcuid==master_mcu) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r5,a
	mov	dptr,#_MCU_CONFIG
	...
	mov	a,r5
	cjne	a,ar6,00117$
;	../../shared/src/tx_lane_align.c:56: reg_TXCLK_SYNC_EN_PLL_OUT = 1;
	mov	dptr,#(_INPUT_CMN_PIN_REG2 + 0x0003)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:60: while(reg_TXCLK_SYNC_EN_PLL_IN_RD==0);
00117$:
	mov	dptr,#(_INPUT_CMN_PIN_REG2 + 0x0002)
	movx	a,@dptr
	jnb	acc.7,00117$
;	../../shared/src/tx_lane_align.c:61: reg_ANA_TX_TXCLK_SYNC_EN_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:62: reg_TXDCC_EN_LANE = 0; 
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_146
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:63: reg_TXDCCCAL_EN_LANE = 0; 
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_147
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:64: reg_TXDCCCAL_PDIV_EN_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_151
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:65: delay01(5);
	mov	dptr,#0x0005
	push	ar2
	push	ar3
	push	ar4
	...
	pop	ar3
	pop	ar2
;	../../shared/src/tx_lane_align.c:66: reg_ANA_TX_TXCLK_SYNC_EN_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:68: if(!reg_MASTER_PHY_EN) {
	mov	dptr,#_SYSTEM
	movx	a,@dptr
	jb	acc.3,00125$
;	../../shared/src/tx_lane_align.c:69: while(reg_TXCLK_SYNC_EN_IN_RD == 1);
00120$:
	mov	dptr,#(_INPUT_CMN_PIN_REG2 + 0x0002)
	movx	a,@dptr
	rl	a
	...
	sjmp	00120$
00217$:
;	../../shared/src/tx_lane_align.c:70: if(mcuid==master_mcu) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r5,a
	mov	dptr,#_MCU_CONFIG
	...
	mov	a,r5
	cjne	a,ar6,00135$
;	../../shared/src/tx_lane_align.c:71: reg_TXCLK_SYNC_EN_OUT = 0;	
	mov	dptr,#(_INPUT_CMN_PIN_REG2 + 0x0003)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:76: while(reg_TXCLK_SYNC_EN_IN_RD == 1);
	sjmp	00135$
00125$:
	mov	dptr,#(_INPUT_CMN_PIN_REG2 + 0x0002)
	movx	a,@dptr
	...
	sjmp	00125$
00220$:
;	../../shared/src/tx_lane_align.c:77: if(mcuid==master_mcu) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r5,a
	mov	dptr,#_MCU_CONFIG
	...
	mov	a,r5
	cjne	a,ar6,00129$
;	../../shared/src/tx_lane_align.c:78: reg_TXCLK_SYNC_EN_OUT = 0;	
	mov	dptr,#(_INPUT_CMN_PIN_REG2 + 0x0003)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
00129$:
;	../../shared/src/tx_lane_align.c:80: if(mcuid==master_mcu) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r5,a
	mov	dptr,#_MCU_CONFIG
	...
	mov	a,r5
	cjne	a,ar6,00135$
;	../../shared/src/tx_lane_align.c:81: reg_TXCLK_SYNC_EN_PLL_OUT = 0;	
	mov	dptr,#(_INPUT_CMN_PIN_REG2 + 0x0003)
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:85: while(reg_TXCLK_SYNC_EN_PLL_IN_RD == 1);
00135$:
	mov	dptr,#(_INPUT_CMN_PIN_REG2 + 0x0002)
	movx	a,@dptr
	rl	a
	...
	sjmp	00135$
00225$:
;	../../shared/src/tx_lane_align.c:86: if(mcuid==master_mcu) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r5,a
	mov	dptr,#_MCU_CONFIG
	...
	mov	a,r5
	cjne	a,ar6,00139$
;	../../shared/src/tx_lane_align.c:87: reg_TXCLK_SYNC_START_OUT = 0;
	mov	dptr,#(_INPUT_CMN_PIN_REG2 + 0x0003)
	movx	a,@dptr
	anl	a,#0xf7
	movx	@dptr,a
00139$:
;	../../shared/src/tx_lane_align.c:89: reg_TXDCC_EN_LANE = save_txdcc_en; 
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_146
	mov	a,r2
	rrc	a
	movx	a,@dptr
	mov	acc.0,c
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:90: reg_TXDCCCAL_EN_LANE = save_txdcccal_en;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_147
	mov	a,r3
	rrc	a
	movx	a,@dptr
	mov	acc.7,c
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:91: reg_TXDCCCAL_PDIV_EN_LANE = save_txdcccal_pdiv_en;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_151
	mov	a,r4
	rrc	a
	movx	a,@dptr
	...
	ljmp	00170$
00169$:
;	../../shared/src/tx_lane_align.c:101: mcu_align_0(0x51);
	mov	dpl,#0x51
	push	ar2
	push	ar3
	push	ar4
	...
	pop	ar3
	pop	ar2
;	../../shared/src/tx_lane_align.c:107: if(mcuid==master_mcu) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r5,a
	mov	dptr,#_MCU_CONFIG
	...
	mov	a,r5
	cjne	a,ar6,00147$
;	../../shared/src/tx_lane_align.c:109: reg_ANA_TXCLK_SYNC_EN_PLL_RING_FORCE = 1;
	mov	dptr,#_PM_CMN_REG2
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:110: reg_ANA_TXCLK_SYNC_EN_PLL_RING = 1;
	mov	dptr,#(_PM_CMN_REG1 + 0x0002)
	movx	a,@dptr
	orl	a,#0x04
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:112: reg_ANA_TXCLK_SYNC_EN_PLL_FORCE = 1;
	mov	dptr,#_PM_CMN_REG2
	movx	a,@dptr
	orl	a,#0x01
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:113: reg_ANA_TXCLK_SYNC_EN_PLL = 1;
	mov	dptr,#_PM_CMN_REG1
	movx	a,@dptr
	orl	a,#0x10
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:114: reg_TXCLK_SYNC_EN_OUT = 1;
	mov	dptr,#(_INPUT_CMN_PIN_REG2 + 0x0003)
	movx	a,@dptr
	orl	a,#0x02
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:117: while(reg_TXCLK_SYNC_EN_OUT == 0) {
	sjmp	00152$
00147$:
	mov	dptr,#(_INPUT_CMN_PIN_REG2 + 0x0003)
	movx	a,@dptr
	jb	acc.1,00152$
;	../../shared/src/tx_lane_align.c:118: if(master_mcu==MCU_LANE0 && SYNC_STATUS_LANE0_EN_READ==0) break;
	mov	dptr,#_MCU_CONFIG
	movx	a,@dptr
	jnz	00144$
	...
	jz	00152$
00144$:
;	../../shared/src/tx_lane_align.c:119: else if(master_mcu==MCU_LANE1 && SYNC_STATUS_LANE1_EN_READ==0) break;
	mov	dptr,#_MCU_CONFIG
	movx	a,@dptr
	mov	r5,a
	cjne	r5,#0x01,00147$
	...
	jnz	00147$
00152$:
;	../../shared/src/tx_lane_align.c:122: reg_ANA_TX_TXCLK_SYNC_EN_LANE = 1;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0002)
	movx	a,@dptr
	orl	a,#0x40
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:123: reg_TXDCC_EN_LANE = 0; 
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_146
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:124: reg_TXDCCCAL_EN_LANE = 0; 
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_147
	movx	a,@dptr
	anl	a,#0x7f
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:125: reg_TXDCCCAL_PDIV_EN_LANE = 0;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_151
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:126: delay01(5);
	mov	dptr,#0x0005
	push	ar2
	push	ar3
	push	ar4
	...
	pop	ar3
	pop	ar2
;	../../shared/src/tx_lane_align.c:127: reg_ANA_TX_TXCLK_SYNC_EN_LANE = 0;
	mov	dptr,#(_PM_CTRL_TX_LANE_REG2_LANE + 0x0002)
	movx	a,@dptr
	anl	a,#0xbf
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:128: if(mcuid==master_mcu) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r5,a
	mov	dptr,#_MCU_CONFIG
	...
	mov	a,r5
	cjne	a,ar6,00160$
;	../../shared/src/tx_lane_align.c:129: reg_TXCLK_SYNC_EN_OUT = 0;  // this is used here indicating finish
	mov	dptr,#(_INPUT_CMN_PIN_REG2 + 0x0003)
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:132: while(reg_TXCLK_SYNC_EN_OUT == 1) {
	sjmp	00165$
00160$:
	mov	dptr,#(_INPUT_CMN_PIN_REG2 + 0x0003)
	movx	a,@dptr
	...
	mov	r5,a
	cjne	r5,#0x01,00165$
;	../../shared/src/tx_lane_align.c:133: if(master_mcu==MCU_LANE0 && SYNC_STATUS_LANE0_EN_READ==0) break;
	mov	dptr,#_MCU_CONFIG
	movx	a,@dptr
	jnz	00157$
	mov	dptr,#(_MCU_INFO_12 + 0x0002)
	...
	jz	00165$
00157$:
;	../../shared/src/tx_lane_align.c:134: else if(master_mcu==MCU_LANE1 && SYNC_STATUS_LANE1_EN_READ==0) break;
	mov	dptr,#_MCU_CONFIG
	movx	a,@dptr
	mov	r5,a
	cjne	r5,#0x01,00160$
	...
	jnz	00160$
00165$:
;	../../shared/src/tx_lane_align.c:138: mcu_align_0(0x52);
	mov	dpl,#0x52
	push	ar2
	push	ar3
	push	ar4
	...
	mov	r2,#(_mcu_align_0 >> 16)
	lcall	__sdcc_banked_call
;	../../shared/src/tx_lane_align.c:140: short_delay();	// spec requires delay between 100ns-550ns
	mov	r0,#_short_delay
	...
	pop	ar3
	pop	ar2
;	../../shared/src/tx_lane_align.c:146: if(mcuid==master_mcu) {
	mov	dptr,#_MCU_CONTROL_LANE
	movx	a,@dptr
	mov	r5,a
	mov	dptr,#_MCU_CONFIG
	...
	mov	a,r5
	cjne	a,ar6,00167$
;	../../shared/src/tx_lane_align.c:148: reg_ANA_TXCLK_SYNC_EN_PLL_RING_FORCE = 0;
	mov	dptr,#_PM_CMN_REG2
	movx	a,@dptr
	anl	a,#0xfd
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:149: reg_ANA_TXCLK_SYNC_EN_PLL_RING = 0;
	mov	dptr,#(_PM_CMN_REG1 + 0x0002)
	movx	a,@dptr
	anl	a,#0xfb
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:151: reg_ANA_TXCLK_SYNC_EN_PLL_FORCE = 0;
	mov	dptr,#_PM_CMN_REG2
	movx	a,@dptr
	anl	a,#0xfe
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:152: reg_ANA_TXCLK_SYNC_EN_PLL = 0;
	mov	dptr,#_PM_CMN_REG1
	movx	a,@dptr
	anl	a,#0xef
	movx	@dptr,a
00167$:
;	../../shared/src/tx_lane_align.c:154: reg_TXDCC_EN_LANE = save_txdcc_en; 
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_146
	mov	a,r2
	rrc	a
	movx	a,@dptr
	mov	acc.0,c
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:155: reg_TXDCCCAL_EN_LANE = save_txdcccal_en;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_147
	mov	a,r3
	rrc	a
	movx	a,@dptr
	mov	acc.7,c
	movx	@dptr,a
;	../../shared/src/tx_lane_align.c:156: reg_TXDCCCAL_PDIV_EN_LANE = save_txdcccal_pdiv_en;
	mov	dptr,#_UPHY14_TRX_ANAREG_TOP_151
	mov	a,r4
	rrc	a
	movx	a,@dptr
	...
	movx	@dptr,a
00170$:
;	../../shared/src/tx_lane_align.c:159: reg_MCU_DEBUG0_LANE_7_0 = 0x90;
	mov	dptr,#_MCU_DEBUG0_LANE
	mov	a,#0x90
	movx	@dptr,a
00171$:
