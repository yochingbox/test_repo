...
#else
void pll_cal( void ) {
	uint8_t state, flag, lccap_msb_index, save_FBDIV_h, save_FBDIV_l;
	uint16_t Fmea, temp;
...
void pll_cal_init( void ) {
	...
	if( cmx_PLLAMP_CAL_SPEEDUP_DISABLE == 0)  reg_LCVCOCAL_BUF_EN_LANE = 1;		//need to work: lane based register
