...
// ! Some settings are in other functions !
// spd_ctrl.c:
// reg_CDR_MODE_LANE_2_0
// reg_REG_SELMUPF_LANE_3_0 reg_RX_SELMUFF_LANE_3_0
// ANA_RSVD
...
/*	reg_CTLE_RL1_SEL_PRE_LANE_3_0 = 0x0;*/
    // John's request on analog tuning
	reg_EN_CTLE_MID_FREQ_LANE = 0x1;
	reg_CTLE_RS1_MID_LANE_1_0 = 0x3;
	reg_CTLE_CS1_MID_LANE_1_0 = 0x3;
	reg_CTLE_IPTAT_1ST_GM_LANE_1_0 = 0x1;
	reg_CTLE_IPTAT_2ND_P1_LANE_1_0 = 0x1;
	reg_CTLE_IPTAT_2ND_P2_LANE_1_0 = 0x1;
	reg_CTLE_IPTAT_2ND_P3_LANE_1_0 = 0x1;
	reg_CTLE_IPTAT_2ND_P4_LANE_1_0 = 0x1;
	reg_CTLE_IPTAT_1ST_TIA_LANE_1_0 = 0x1;
#endif
...
///	reg_DTL_SQ_DET_EN_LANE = 0x0;
	...
	// 20200413 Xinyu
	reg_DTL_CLAMPING_SEL_LANE_2_0 = 0x7;
...
/*	cds_init();*/
	...
	// 20200709 SoC does not want
//	reg_TRX_TRAIN_TIMEOUT_EN_LANE = 1;
	// IPCE_COMPHY-1564 20200106
	reg_CKP1_DA_TUNE_CODE_LANE_4_0 = 0x0;
	reg_CKP2_DA_TUNE_CODE_LANE_4_0 = 0x0;
	reg_CKP3_DA_TUNE_CODE_LANE_4_0 = 0x0;
	reg_CKP4_DA_TUNE_CODE_LANE_4_0 = 0x0;
	reg_CKP1_ER_TUNE_CODE_LANE_4_0 = 0x0;
	reg_CKP2_ER_TUNE_CODE_LANE_4_0 = 0x0;
	reg_CKP3_ER_TUNE_CODE_LANE_4_0 = 0x0;
	reg_CKP4_ER_TUNE_CODE_LANE_4_0 = 0x0;
	
	//Added 106G init script based on the following JIRA:
	////https://essjira.marvell.com/browse/IPCE_COMPHY-1564
//	This is for duplicate comment
...
//		lnx_TRAIN_USE_S_LANE = 0x1;
		// Required timer > supported timer 8.191s
//		reg_TRX_TRAIN_TIMEOUT_EN_LANE = 0;
		// IPCE_COMPHY-1564 20200106
		// 20200226 John: 7,c,a,f
		reg_CKP1_DA_TUNE_CODE_LANE_4_0 = 0x7;//0xf;
		reg_CKP2_DA_TUNE_CODE_LANE_4_0 = 0xc;//0xd;
		reg_CKP3_DA_TUNE_CODE_LANE_4_0 = 0xa;//0xa;
		reg_CKP4_DA_TUNE_CODE_LANE_4_0 = 0xf;//0xb;
	} 
	
	// GLC5616-529
	if(no_tx_fir_reset_at_rx_init_rd==0)
		init_tx_fir();
...
check_pause_state(PAUSE_ST_CAL_START);
	...
	// Have to update force_calibration to not missing a following speed_change
	if(gen_tx!=new_gen_tx) force_calibration=0;
...
//		reg_PIN_PLL_READY_TX_LANE = 0;
		...
		reg_ANA_TX_TXCLK_SYNC_EN_FORCE_LANE = 0;
		reg_ANA_TRX_PLL_TXCLK_SYNC_EN_LANE = 0;
		reg_ANA_TRX_PLL_TXCLK_SYNC_EN_FORCE_LANE = 0;
...
check_pause_state(PAUSE_ST_PLL_CAL);
	...
	if( mcuid != MCU_CMN ) {
		...
		if(cmx_RXIMP_CAL_EXT_EN == 0){
			// issue request
			mcu_request_lane[mcuid] |= 1;
			// waiting for mcu_cmn to clear status
			mcu_response_delay();
			// re-check and wait for lower number lanes
			// then start cal
			// release flag
			while((mcu_response_status[mcuid]&0x1)==0);
			rximp_cal_ram();
			mcu_request_lane[mcuid] &= ~1;
		}
