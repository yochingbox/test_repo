...
// For all mode and all version, emph0=pre1, emph1=pst1, emph2=pre2, emph3=pre3
		...
		// 20200715 Xu: Spec requirement
		reg_TX_TRAIN_PAT_CODING_SEL_LANE_1_0 = 1;
...
// For all mode and all version, emph0=pre1, emph1=pst1, emph2=pre2, emph3=pre3
...
#if 0 // Debug custom preset
		reg_TX_AMP_DEFAULT2_LANE_6_0 = 51;
		reg_TX_EMPH0_DEFAULT2_LANE_4_0 = 0xa;
		reg_TX_EMPH1_DEFAULT2_LANE_4_0 = 0x0;
		reg_TX_EMPH2_DEFAULT2_LANE_4_0 = 0x2;		
#endif		
		...
		// 20200715 Xu: Spec requirement
		reg_TX_TRAIN_PAT_CODING_SEL_LANE_1_0 = 0;
	}
#ifdef _12FFC_COMPHY_112G_X4_R1P2
	// TODO Midas fix
	reg_TX_EMPH3_DEFAULT2_LANE_4_0 = 0x0;
#endif	
	...
	// 20200715 Xu: Spec req
	reg_LOCAL_TX_PRESET_INDEX_LANE_3_0 = 1;
}
...
void txclk_nt_config() BANKING_CTRL {
	...
	switch(reg_PIN_TXDCLK_NT_SEL_RD_LANE_2_0) {
		...
		case 4: ANA_PLL25.BT.B0 = (ANA_PLL25.BT.B0&0x04)|0x40; reg_TXCLK_NT_FIX_DIV_EN_LANE = 1; break;
		// Xu: 16.5T
		case 5: ANA_PLL25.BT.B0 = (ANA_PLL25.BT.B0&0x04)|0x29; reg_TXCLK_NT_FIX_DIV_EN_LANE = 0; break;
	}
