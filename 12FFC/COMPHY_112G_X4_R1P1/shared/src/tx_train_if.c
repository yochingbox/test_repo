...
void set_remote_tx_pam2() {
	...
	while(!reg_INT_REMOTE_STATUS_ACK_LANE && reg_TX_TRAIN_ENABLE_RD_LANE && !reg_TRX_TRAIN_STOP_ISR_LANE);
...
void set_remote_tx() {
	...
	if(reg_STATUS_DET_TIMEOUT_ISR_LANE || !reg_TX_TRAIN_ENABLE_RD_LANE || reg_TRX_TRAIN_STOP_ISR_LANE) {
