...
#define reg_SET_INT_ISR_LANE0  MCU_CONTROL_1.BF.SET_INT_ISR_LANE0
...
typedef union {
	struct {
		uint8_t SET_INT_ISR_LANE1                        : 1;	/*      0     r/w   0*/
		uint8_t RESERVED_1                               : 7;	/*  [7:1]     r/w   0*/
...
#define reg_SET_INT_ISR_LANE3  MCU_CONTROL_4.BF.SET_INT_ISR_LANE3
...
__xdata __at( 0xa2dc ) volatile MCU_SYNC1_t MCU_SYNC1;
...
__xdata __at( 0xa2e0 ) volatile MCU_SYNC2_t MCU_SYNC2;
...
typedef union {
	struct {
		uint8_t ANA_REG_SU_DLY_SEL_2_0                   : 3;	/*  [2:0]     r/w 3'h0*/
...
#define reg_ANA_REG_SU_DLY_SEL_2_0  ANA_IF_CMN_REG0.BF.ANA_REG_SU_DLY_SEL_2_0
...
typedef union {
	struct {
		...
		uint8_t RESERVED_1                               : 7;	/* [28:1]     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [28:1]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/* [28:1]     r/w   0*/
		uint8_t RESERVED_24                              : 5;	/* [28:1]     r/w   0*/
		uint8_t ANA_REG_HD_DLY_SEL_2_0                   : 3;	/*[31:29]     r/w 3'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} APB_CONTROL_REG_t;
...
#define reg_ANA_REG_HD_DLY_SEL_2_0  APB_CONTROL_REG.BF.ANA_REG_HD_DLY_SEL_2_0
