...
//#define RING_SIZE 36
//#define GEN_SIZE 80
#define PLL_TBL_MAX		8
#define RINGPLL_TBL_MAX		4
#define GEN_TBL_MAX		14 // now 12 rates and 2 speed holders 
...
#define PHY_CHECK_LANE2			cmx_MCU_STATUS0_LANE2_31_0_b2
#define PHY_CHECK_LANE3			cmx_MCU_STATUS0_LANE3_31_0_b2
#define PHY_CHECK_LANE0_READ		cmx_MCU_STATUS0_LANE0_31_0_b2
#define PHY_CHECK_LANE1_READ		cmx_MCU_STATUS0_LANE1_31_0_b2
#define PHY_CHECK_LANE2_READ		cmx_MCU_STATUS0_LANE2_31_0_b2
#define PHY_CHECK_LANE3_READ		cmx_MCU_STATUS0_LANE3_31_0_b2
...
#define POWERUP_SIMPLE			cmx_POWER_UP_SIMPLE_EN  //(reg_MCU_COMMAND0_LANE_31_0_b0 & 0x01)
...
#define mcu_en0  reg_MCU_EN_LANE0  //SYNC_STATUS_LANE0_EN_READ
#define mcu_en1  reg_MCU_EN_LANE1  //SYNC_STATUS_LANE1_EN_READ
#define mcu_en2  reg_MCU_EN_LANE2  //SYNC_STATUS_LANE2_EN_READ
#define mcu_en3  reg_MCU_EN_LANE3  //SYNC_STATUS_LANE3_EN_READ
#define mcu_en_cmn  reg_MCU_EN_CMN
...
#define PowerUp_Seq_Simple() PowerUp_Seq_Test()
	...
	uint8_t cmd_tx_preset_index(uint8_t cmd_code) CMD_BANK;
	...
	void cli_monitor(void);
        ...
        // misc
        void memcpy_sw(uint8_t *des, uint8_t *src, int n) BANKING_CTRL;
        void memset0_sw(uint8_t *dest, int n) BANKING_CTRL;
