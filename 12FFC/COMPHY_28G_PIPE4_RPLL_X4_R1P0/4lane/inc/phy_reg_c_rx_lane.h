...
typedef union {
	struct {
		...
		uint8_t ANA_PU_DFE_LANE                          : 1;	/*     14     r/w   1*/
		uint8_t ANA_PU_RX_DLY_LANE                       : 1;	/*     15     r/w   0*/
		uint8_t RESERVED_16                              : 1;	/*     16     r/w   0*/
		uint8_t PIN_PU_SQ_RD_LANE                        : 1;	/*     17       r   0*/
...
#define reg_ANA_PU_DFE_LANE  PM_CTRL_RX_LANE_REG1_LANE.BF.ANA_PU_DFE_LANE
...
typedef union {
	struct {
		uint8_t PHY_GEN_RX_LANE_4_0                      : 5;	/*  [4:0]     r/w 5'h0*/
		uint8_t RESERVED_5                               : 3;	/* [30:5]     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [30:5]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/* [30:5]     r/w   0*/
		uint8_t RESERVED_24                              : 7;	/* [30:5]     r/w   0*/
...
#define reg_PHY_GEN_RX_LANE_4_0  RX_SYSTEM_LANE.BF.PHY_GEN_RX_LANE_4_0
...
#define reg_RX_PRESET_HINT_FM_REG_LANE  INPUT_RX_PIN_REG0_LANE.BF.RX_PRESET_HINT_FM_REG_LANE
#define reg_RX_PRESET_HINT_LANE_3_0  INPUT_RX_PIN_REG0_LANE.BF.RX_PRESET_HINT_LANE_3_0
...
#define reg_PU_RX_FM_REG_LANE  INPUT_RX_PIN_REG2_LANE.BF.PU_RX_FM_REG_LANE
#define reg_PU_RX_LANE  INPUT_RX_PIN_REG2_LANE.BF.PU_RX_LANE
...
typedef union {
	struct {
		...
		uint8_t RESERVED_25                              : 1;	/*     25     r/w   0*/
		uint8_t RESERVED_26                              : 1;	/*     26     r/w   0*/
		uint8_t PIN_PHY_GEN_RX_RD_LANE_4_0               : 5;	/*[31:27]       r 5'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
...
#define reg_PIN_RESERVED_INPUT_RX_RD_LANE_15_0_b0  SPD_CTRL_RX_LANE_REG1_LANE.BF.PIN_RESERVED_INPUT_RX_RD_LANE_15_0_b0
#define reg_PIN_RESERVED_INPUT_RX_RD_LANE_15_0_b1  SPD_CTRL_RX_LANE_REG1_LANE.BF.PIN_RESERVED_INPUT_RX_RD_LANE_15_0_b1
#define reg_PIN_PHY_GEN_RX_RD_LANE_4_0  SPD_CTRL_RX_LANE_REG1_LANE.BF.PIN_PHY_GEN_RX_RD_LANE_4_0
#define reg_PIN_RESERVED_INPUT_RX_RD_LANE_15_0  SPD_CTRL_RX_LANE_REG1_LANE.WT.W0
...
typedef union {
	struct {
		...
		uint8_t RST_CDR_LOCK_DET_CLK_LANE                : 1;	/*     19     r/w   0*/
		...
		uint8_t RESERVED_23                              : 1;	/*     23     r/w   0*/
		uint8_t CDR_LOCK_DET_CLK_EN_LANE                 : 1;	/*     24     r/w   0*/
		...
		uint8_t CDR_LOCK_DET_EN_LANE                     : 1;	/*     31     r/w   1*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_RST_CDR_LOCK_DET_CLK_LANE  CLKGEN_RX_LANE_REG1_LANE.BF.RST_CDR_LOCK_DET_CLK_LANE
...
#define reg_CDR_LOCK_DET_CLK_EN_LANE  CLKGEN_RX_LANE_REG1_LANE.BF.CDR_LOCK_DET_CLK_EN_LANE
...
#define reg_CDR_LOCK_DET_EN_LANE  CLKGEN_RX_LANE_REG1_LANE.BF.CDR_LOCK_DET_EN_LANE
...
typedef union {
	struct {
		...
		uint8_t RESERVED_1                               : 1;	/*      1     r/w   0*/
		uint8_t RESERVED_2                               : 1;	/*      2     r/w   0*/
		uint8_t FRAME_LOCK_SEL_LANE                      : 1;	/*      3     r/w   0*/
		uint8_t FRAME_DET_SIDE_LEVEL_LANE_1_0            : 2;	/*  [5:4]     r/w 2'h3*/
		uint8_t FRAME_DET_MIDD_LEVEL_LANE_1_0            : 2;	/*  [7:6]     r/w 2'h3*/
		...
		uint8_t SYNC_DET_EN_LANE                         : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_SYNC_REALIGN_MODE_LANE  FRAME_SYNC_DET_REG0.BF.SYNC_REALIGN_MODE_LANE
#define reg_SYNC_MASK_LANE_9_0_b0  FRAME_SYNC_DET_REG0.BF.SYNC_MASK_LANE_9_0_b0
#define reg_SYNC_MASK_LANE_9_0_b1  FRAME_SYNC_DET_REG0.BF.SYNC_MASK_LANE_9_0_b1
#define reg_SYNC_CHAR_LANE_9_0_b0  FRAME_SYNC_DET_REG0.BF.SYNC_CHAR_LANE_9_0_b0
#define reg_SYNC_CHAR_LANE_9_0_b1  FRAME_SYNC_DET_REG0.BF.SYNC_CHAR_LANE_9_0_b1
#define reg_SYNC_POL_LANE  FRAME_SYNC_DET_REG0.BF.SYNC_POL_LANE
#define reg_SYNC_DET_AFTER_PHY_RDY_LANE  FRAME_SYNC_DET_REG0.BF.SYNC_DET_AFTER_PHY_RDY_LANE
#define reg_SYNC_DET_EN_LANE  FRAME_SYNC_DET_REG0.BF.SYNC_DET_EN_LANE

// 0x0024	FRAME_SYNC_DET_REG1		Frame Sync Detection Reg1
typedef union {
	struct {
		uint8_t TRAIN_PAT_NUM_LANE_8_0_b0                : 8;	/*  [8:0]     r/w 9'h42*/
		uint8_t TRAIN_PAT_NUM_LANE_8_0_b1                : 1;	/*  [8:0]     r/w 9'h42*/
		uint8_t RESERVED_9                               : 1;	/*      9     r/w   0*/
		uint8_t RESERVED_10                              : 1;	/*     10     r/w   0*/
		uint8_t RESERVED_11                              : 1;	/*     11     r/w   0*/
		uint8_t RESERVED_12                              : 1;	/*     12     r/w   0*/
		uint8_t PACKET_SYNC_CHAR_SEL_LANE_1_0            : 2;	/*[14:13]     r/w   0*/
		uint8_t PACKET_SYNC_DIS_LANE                     : 1;	/*     15     r/w   1*/
		uint8_t SYNC_DET_DIS_LANE                        : 1;	/*     16     r/w   0*/
		uint8_t PACKET_FOUND_LANE                        : 1;	/*     17       r   0*/
		uint8_t FRAME_LOCK_LANE                          : 1;	/*     18       r   0*/
		uint8_t FRAME_FOUND_LANE                         : 1;	/*     19       r   0*/
		uint8_t SYNC_FOUND_LANE                          : 1;	/*     20       r   0*/
		uint8_t WORD_FOUND_LANE                          : 1;	/*     21       r   0*/
		uint8_t ALIGN_STAT_RD_REQ_LANE                   : 1;	/*     22     r/w   0*/
		uint8_t FRAME_DET_MODE_LANE                      : 1;	/*     23     r/w   0*/
		uint8_t FRAME_REALIGN_MODE_LANE                  : 1;	/*     24     r/w   1*/
		uint8_t FRAME_END_SEL_LANE                       : 1;	/*     25     r/w   1*/
		uint8_t BAD_MARKER_NUM_LANE_2_0                  : 3;	/*[28:26]     r/w 3'h4*/
		uint8_t GOOD_MARKER_NUM_LANE_2_0                 : 3;	/*[31:29]     r/w 3'h1*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} FRAME_SYNC_DET_REG1_t;
__xdata __at( 0x2124 ) volatile FRAME_SYNC_DET_REG1_t FRAME_SYNC_DET_REG1;
#define reg_TRAIN_PAT_NUM_LANE_8_0_b0  FRAME_SYNC_DET_REG1.BF.TRAIN_PAT_NUM_LANE_8_0_b0
#define reg_TRAIN_PAT_NUM_LANE_8_0_b1  FRAME_SYNC_DET_REG1.BF.TRAIN_PAT_NUM_LANE_8_0_b1
#define reg_PACKET_SYNC_CHAR_SEL_LANE_1_0  FRAME_SYNC_DET_REG1.BF.PACKET_SYNC_CHAR_SEL_LANE_1_0
#define reg_PACKET_SYNC_DIS_LANE  FRAME_SYNC_DET_REG1.BF.PACKET_SYNC_DIS_LANE
#define reg_SYNC_DET_DIS_LANE  FRAME_SYNC_DET_REG1.BF.SYNC_DET_DIS_LANE
#define reg_PACKET_FOUND_LANE  FRAME_SYNC_DET_REG1.BF.PACKET_FOUND_LANE
#define reg_FRAME_LOCK_LANE  FRAME_SYNC_DET_REG1.BF.FRAME_LOCK_LANE
#define reg_FRAME_FOUND_LANE  FRAME_SYNC_DET_REG1.BF.FRAME_FOUND_LANE
#define reg_SYNC_FOUND_LANE  FRAME_SYNC_DET_REG1.BF.SYNC_FOUND_LANE
#define reg_WORD_FOUND_LANE  FRAME_SYNC_DET_REG1.BF.WORD_FOUND_LANE
#define reg_ALIGN_STAT_RD_REQ_LANE  FRAME_SYNC_DET_REG1.BF.ALIGN_STAT_RD_REQ_LANE
#define reg_FRAME_DET_MODE_LANE  FRAME_SYNC_DET_REG1.BF.FRAME_DET_MODE_LANE
#define reg_FRAME_REALIGN_MODE_LANE  FRAME_SYNC_DET_REG1.BF.FRAME_REALIGN_MODE_LANE
#define reg_FRAME_END_SEL_LANE  FRAME_SYNC_DET_REG1.BF.FRAME_END_SEL_LANE
#define reg_BAD_MARKER_NUM_LANE_2_0  FRAME_SYNC_DET_REG1.BF.BAD_MARKER_NUM_LANE_2_0
#define reg_GOOD_MARKER_NUM_LANE_2_0  FRAME_SYNC_DET_REG1.BF.GOOD_MARKER_NUM_LANE_2_0
...
#define reg_FRAME_ALIGN_LEVEL_LANE_15_0_b0  FRAME_SYNC_DET_REG2.BF.FRAME_ALIGN_LEVEL_LANE_15_0_b0
#define reg_FRAME_ALIGN_LEVEL_LANE_15_0_b1  FRAME_SYNC_DET_REG2.BF.FRAME_ALIGN_LEVEL_LANE_15_0_b1
#define reg_FRAME_ALIGN_LEVEL_LANE_15_0  FRAME_SYNC_DET_REG2.WT.W1
...
typedef union {
	struct {
		...
		uint8_t RESERVED_10                              : 1;	/*     10     r/w   0*/
		uint8_t RESERVED_11                              : 1;	/*     11     r/w   0*/
		uint8_t ALIGN_POS_LANE_39_20_b0                  : 4;	/*[31:12]       r   0*/
		uint8_t ALIGN_POS_LANE_39_20_b1                  : 8;	/*[31:12]       r   0*/
		uint8_t ALIGN_POS_LANE_39_20_b2                  : 8;	/*[31:12]       r   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} FRAME_SYNC_DET_REG3_t;
__xdata __at( 0x212c ) volatile FRAME_SYNC_DET_REG3_t FRAME_SYNC_DET_REG3;
#define reg_ALIGN_POS_LANE_39_20_b0  FRAME_SYNC_DET_REG3.BF.ALIGN_POS_LANE_39_20_b0
#define reg_ALIGN_POS_LANE_39_20_b1  FRAME_SYNC_DET_REG3.BF.ALIGN_POS_LANE_39_20_b1
#define reg_ALIGN_POS_LANE_39_20_b2  FRAME_SYNC_DET_REG3.BF.ALIGN_POS_LANE_39_20_b2
...
typedef union {
	struct {
		...
		uint8_t RESERVED_10                              : 1;	/*     10     r/w   0*/
		uint8_t RESERVED_11                              : 1;	/*     11     r/w   0*/
		uint8_t ALIGN_POS_LANE_19_0_b0                   : 4;	/*[31:12]       r   0*/
		uint8_t ALIGN_POS_LANE_19_0_b1                   : 8;	/*[31:12]       r   0*/
		uint8_t ALIGN_POS_LANE_19_0_b2                   : 8;	/*[31:12]       r   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} FRAME_SYNC_DET_REG4_t;
__xdata __at( 0x2130 ) volatile FRAME_SYNC_DET_REG4_t FRAME_SYNC_DET_REG4;
#define reg_ALIGN_POS_LANE_19_0_b0  FRAME_SYNC_DET_REG4.BF.ALIGN_POS_LANE_19_0_b0
#define reg_ALIGN_POS_LANE_19_0_b1  FRAME_SYNC_DET_REG4.BF.ALIGN_POS_LANE_19_0_b1
#define reg_ALIGN_POS_LANE_19_0_b2  FRAME_SYNC_DET_REG4.BF.ALIGN_POS_LANE_19_0_b2
...
#define reg_PACKET_SYNC_CHAR1_LANE_29_0_b0  FRAME_SYNC_DET_REG5.BF.PACKET_SYNC_CHAR1_LANE_29_0_b0
#define reg_PACKET_SYNC_CHAR1_LANE_29_0_b1  FRAME_SYNC_DET_REG5.BF.PACKET_SYNC_CHAR1_LANE_29_0_b1
#define reg_PACKET_SYNC_CHAR1_LANE_29_0_b2  FRAME_SYNC_DET_REG5.BF.PACKET_SYNC_CHAR1_LANE_29_0_b2
#define reg_PACKET_SYNC_CHAR1_LANE_29_0_b3  FRAME_SYNC_DET_REG5.BF.PACKET_SYNC_CHAR1_LANE_29_0_b3
...
#define reg_PACKET_SYNC_CHAR2_LANE_29_0_b0  FRAME_SYNC_DET_REG6.BF.PACKET_SYNC_CHAR2_LANE_29_0_b0
#define reg_PACKET_SYNC_CHAR2_LANE_29_0_b1  FRAME_SYNC_DET_REG6.BF.PACKET_SYNC_CHAR2_LANE_29_0_b1
#define reg_PACKET_SYNC_CHAR2_LANE_29_0_b2  FRAME_SYNC_DET_REG6.BF.PACKET_SYNC_CHAR2_LANE_29_0_b2
#define reg_PACKET_SYNC_CHAR2_LANE_29_0_b3  FRAME_SYNC_DET_REG6.BF.PACKET_SYNC_CHAR2_LANE_29_0_b3

// 0x003c	CDR_LOCK_REG		CDR Lock Detection
typedef union {
	struct {
		uint8_t RESERVED_0                               : 1;	/*      0     r/w   0*/
		uint8_t RESERVED_1                               : 1;	/*      1     r/w   0*/
		...
		uint8_t CDR_LOCK_LANE                            : 1;	/*     30       r   0*/
		uint8_t CDR_LOCK_MODE_LANE                       : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CDR_LOCK_REG_t;
__xdata __at( 0x213c ) volatile CDR_LOCK_REG_t CDR_LOCK_REG;
#define reg_CDR_LOCK_LANE  CDR_LOCK_REG.BF.CDR_LOCK_LANE
#define reg_CDR_LOCK_MODE_LANE  CDR_LOCK_REG.BF.CDR_LOCK_MODE_LANE
...
typedef union {
	struct {
		...
		uint8_t RESERVED_26                              : 1;	/*     26     r/w   0*/
		uint8_t RESERVED_27                              : 1;	/*     27     r/w   0*/
		uint8_t LANE_MARGIN_EN_ISR_LANE                  : 1;	/*     28     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t RESERVED_26                              : 1;	/*     26     r/w   0*/
		uint8_t RESERVED_27                              : 1;	/*     27     r/w   0*/
		uint8_t LANE_MARGIN_EN_MASK_LANE                 : 1;	/*     28     r/w   1*/
...
typedef union {
	struct {
		...
		uint8_t RESERVED_25                              : 1;	/*     25     r/w   0*/
		uint8_t RESERVED_26                              : 1;	/*     26     r/w   0*/
		uint8_t SQ_GATE_RXDATA_LANE                      : 1;	/*     27     r/w   0*/
...
#define reg_SQ_GATE_RXDATA_LANE  RX_DATA_PATH_REG.BF.SQ_GATE_RXDATA_LANE
...
// 0x004c	INPUT_RX_PIN_REG3_LANE		Input Interface Register For Rx Lane3
typedef union {
	struct {
		uint8_t ANA_RX_PU_DLY2_LANE                      : 1;	/*      0     r/w   1*/
		uint8_t RESERVED_1                               : 1;	/*      1     r/w   0*/
		uint8_t RESERVED_2                               : 1;	/*      2     r/w   0*/
		uint8_t RESERVED_3                               : 1;	/*      3     r/w   0*/
		uint8_t RESERVED_4                               : 1;	/*      4     r/w   0*/
...
__xdata __at( 0x214c ) volatile INPUT_RX_PIN_REG3_LANE_t INPUT_RX_PIN_REG3_LANE;
#define reg_ANA_RX_PU_DLY2_LANE  INPUT_RX_PIN_REG3_LANE.BF.ANA_RX_PU_DLY2_LANE
...
typedef union {
	struct {
		...
		uint8_t RESERVED_26                              : 1;	/*     26     r/w   0*/
		uint8_t RESERVED_27                              : 1;	/*     27     r/w   0*/
		uint8_t LANE_MARGIN_EN_ISR_CLEAR_LANE            : 1;	/*     28     r/w   0*/
		uint8_t FRAME_UNLOCK_ISR_CLEAR_LANE              : 1;	/*     29     r/w   0*/
		uint8_t FRAME_LOCK_ISR_CLEAR_LANE                : 1;	/*     30     r/w   0*/
		uint8_t RESERVED_31                              : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
typedef union {
	struct {
		...
		uint8_t DTL_LOOP_FREEZE_LANE                     : 1;	/*     18     r/w   0*/
...
#define reg_DTL_LOOP_FREEZE_LANE  DTL_REG2.BF.DTL_LOOP_FREEZE_LANE
...
// 0x0074	RX_RESERVED_REG		RX Reserved Register
typedef union {
	struct {
		uint8_t PIN_RESERVED_OUTPUT_RX_LANE_14_0_b0      : 8;	/* [14:0]     r/w   0*/
		uint8_t PIN_RESERVED_OUTPUT_RX_LANE_14_0_b1      : 7;	/* [14:0]     r/w   0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
		uint8_t RESERVED_16                              : 1;	/*     16     r/w   0*/
		uint8_t RESERVED_17                              : 1;	/*     17     r/w   0*/
		uint8_t RESERVED_18                              : 1;	/*     18     r/w   0*/
...
__xdata __at( 0x2174 ) volatile RX_RESERVED_REG_t RX_RESERVED_REG;
#define reg_PIN_RESERVED_OUTPUT_RX_LANE_14_0_b0  RX_RESERVED_REG.BF.PIN_RESERVED_OUTPUT_RX_LANE_14_0_b0
#define reg_PIN_RESERVED_OUTPUT_RX_LANE_14_0_b1  RX_RESERVED_REG.BF.PIN_RESERVED_OUTPUT_RX_LANE_14_0_b1
