...
typedef union {
	struct {
		uint8_t ETHERNET_CFG_2_0                         : 3;	/*  [2:0]     r/w 3'h0*/
		uint8_t LCPLL_LANE_SEL                           : 1;	/*      3     r/w   0*/
		uint8_t RESERVED_4                               : 1;	/*      4     r/w   0*/
		uint8_t TX_LANE_ALIGN_OFF                        : 1;	/*      5     r/w   0*/
		uint8_t APTA_LIMITED_STATUS_DIS                  : 1;	/*      6     r/w   0*/
		uint8_t RINGPLL_IND_EN                           : 1;	/*      7     r/w   1*/
		uint8_t FORCE_PARTIAL_PU_RX_ON                   : 1;	/*      8     r/w   0*/
		uint8_t CAL_DONE                                 : 1;	/*      9       r   0*/
		uint8_t MCU_INIT_DONE                            : 1;	/*     10       r   0*/
...
#define cmx_ETHERNET_CFG_2_0  CONTROL_CONFIG0.BF.ETHERNET_CFG_2_0
...
typedef union {
	struct {
		uint8_t LANE_DIS_LANE0_7_0                       : 8;	/*  [7:0]       r 8'h0*/
		uint8_t LANE_DIS_LANE1_7_0                       : 8;	/* [15:8]       r 8'h0*/
		uint8_t LANE_DIS_LANE2_7_0                       : 8;	/*[23:16]       r 8'h0*/
		uint8_t LANE_DIS_LANE3_7_0                       : 8;	/*[31:24]       r 8'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} MCU_CONFIG_t;
...
#define cmx_LANE_DIS_LANE2_7_0  MCU_CONFIG.BF.LANE_DIS_LANE2_7_0
#define cmx_LANE_DIS_LANE3_7_0  MCU_CONFIG.BF.LANE_DIS_LANE3_7_0
...
// 0x06b0	SYNC_INFO		MCU sync info
typedef union {
	struct {
...
__xdata __at( 0xe6b0 ) volatile SYNC_INFO_t SYNC_INFO;
...
// 0x06b4	MCU_INFO_4		MCU Information Register 4
typedef union {
	struct {
...
__xdata __at( 0xe6b4 ) volatile MCU_INFO_4_t MCU_INFO_4;
...
// 0x06b8	MCU_INFO_5		MCU Information Register 5
typedef union {
	struct {
...
__xdata __at( 0xe6b8 ) volatile MCU_INFO_5_t MCU_INFO_5;
...
// 0x06bc	MCU_INFO_6		MCU Information Register 6
typedef union {
	struct {
...
__xdata __at( 0xe6bc ) volatile MCU_INFO_6_t MCU_INFO_6;
#define cmx_MCU_STATUS0_LANE2_31_0_b0  MCU_INFO_6.BF.MCU_STATUS0_LANE2_31_0_b0
#define cmx_MCU_STATUS0_LANE2_31_0_b1  MCU_INFO_6.BF.MCU_STATUS0_LANE2_31_0_b1
#define cmx_MCU_STATUS0_LANE2_31_0_b2  MCU_INFO_6.BF.MCU_STATUS0_LANE2_31_0_b2
#define cmx_MCU_STATUS0_LANE2_31_0_b3  MCU_INFO_6.BF.MCU_STATUS0_LANE2_31_0_b3

// 0x06c0	MCU_INFO_7		MCU Information Register 7
typedef union {
	struct {
...
__xdata __at( 0xe6c0 ) volatile MCU_INFO_7_t MCU_INFO_7;
#define cmx_MCU_STATUS0_LANE3_31_0_b0  MCU_INFO_7.BF.MCU_STATUS0_LANE3_31_0_b0
#define cmx_MCU_STATUS0_LANE3_31_0_b1  MCU_INFO_7.BF.MCU_STATUS0_LANE3_31_0_b1
#define cmx_MCU_STATUS0_LANE3_31_0_b2  MCU_INFO_7.BF.MCU_STATUS0_LANE3_31_0_b2
#define cmx_MCU_STATUS0_LANE3_31_0_b3  MCU_INFO_7.BF.MCU_STATUS0_LANE3_31_0_b3

// 0x06c4	MCU_INFO_12		MCU Information Register 12
typedef union {
	struct {
...
__xdata __at( 0xe6c4 ) volatile MCU_INFO_12_t MCU_INFO_12;
...
// 0x06c8	MCU_INFO_13		MCU Information Register 13
typedef union {
	struct {
...
__xdata __at( 0xe6c8 ) volatile MCU_INFO_13_t MCU_INFO_13;
...
// 0x06cc	MCU_INFO_14		MCU Information Register 14
typedef union {
	struct {
...
__xdata __at( 0xe6cc ) volatile MCU_INFO_14_t MCU_INFO_14;
#define cmx_MCU_STATUS1_LANE2_31_0_b0  MCU_INFO_14.BF.MCU_STATUS1_LANE2_31_0_b0
#define cmx_MCU_STATUS1_LANE2_31_0_b1  MCU_INFO_14.BF.MCU_STATUS1_LANE2_31_0_b1
#define cmx_MCU_STATUS1_LANE2_31_0_b2  MCU_INFO_14.BF.MCU_STATUS1_LANE2_31_0_b2
#define cmx_MCU_STATUS1_LANE2_31_0_b3  MCU_INFO_14.BF.MCU_STATUS1_LANE2_31_0_b3

// 0x06d0	MCU_INFO_15		MCU Information Register 15
typedef union {
	struct {
...
__xdata __at( 0xe6d0 ) volatile MCU_INFO_15_t MCU_INFO_15;
#define cmx_MCU_STATUS1_LANE3_31_0_b0  MCU_INFO_15.BF.MCU_STATUS1_LANE3_31_0_b0
#define cmx_MCU_STATUS1_LANE3_31_0_b1  MCU_INFO_15.BF.MCU_STATUS1_LANE3_31_0_b1
#define cmx_MCU_STATUS1_LANE3_31_0_b2  MCU_INFO_15.BF.MCU_STATUS1_LANE3_31_0_b2
#define cmx_MCU_STATUS1_LANE3_31_0_b3  MCU_INFO_15.BF.MCU_STATUS1_LANE3_31_0_b3

// 0x06d4	MCU_INFO_16		MCU Information Register 16
typedef union {
	struct {
		uint8_t LANE3_LCPLL_SEL_7_0                      : 8;	/*  [7:0]     r/w 8'h0*/
		uint8_t LANE2_LCPLL_SEL_7_0                      : 8;	/* [15:8]     r/w 8'h0*/
		uint8_t LANE1_LCPLL_SEL_7_0                      : 8;	/*[23:16]     r/w 8'h0*/
		uint8_t LANE0_LCPLL_SEL_7_0                      : 8;	/*[31:24]     r/w 8'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} MCU_INFO_16_t;
__xdata __at( 0xe6d4 ) volatile MCU_INFO_16_t MCU_INFO_16;
#define cmx_LANE3_LCPLL_SEL_7_0  MCU_INFO_16.BF.LANE3_LCPLL_SEL_7_0
#define cmx_LANE2_LCPLL_SEL_7_0  MCU_INFO_16.BF.LANE2_LCPLL_SEL_7_0
#define cmx_LANE1_LCPLL_SEL_7_0  MCU_INFO_16.BF.LANE1_LCPLL_SEL_7_0
#define cmx_LANE0_LCPLL_SEL_7_0  MCU_INFO_16.BF.LANE0_LCPLL_SEL_7_0

// 0x06d8	MCU_SEL		MCU Selection
typedef union {
	struct {
...
__xdata __at( 0xe6d8 ) volatile MCU_SEL_t MCU_SEL;
#define cmx_MASTER_MCU_SEL_7_0  MCU_SEL.BF.MASTER_MCU_SEL_7_0

// 0x06dc	LANE0_LCPLL_SPDCHG		Lane 0 LC PLL speed change
typedef union {
	struct {
		uint8_t RESERVED_0                               : 8;	/*  [7:0]     r/w   0*/
		uint8_t LANE0_VDD_CAL_REQ                        : 1;	/*      8     r/w   0*/
		uint8_t LANE0_VDD_CAL_LOCK                       : 1;	/*      9     r/w   1*/
		uint8_t LANE0_TXDETECT_CAL_REQ                   : 1;	/*     10     r/w   0*/
		uint8_t LANE0_TXDETECT_CAL_LOCK                  : 1;	/*     11     r/w   1*/
		uint8_t LANE0_RXIMP_CAL_REQ                      : 1;	/*     12     r/w   0*/
		uint8_t LANE0_RXIMP_CAL_LOCK                     : 1;	/*     13     r/w   1*/
		uint8_t LANE0_TXIMP_CAL_REQ                      : 1;	/*     14     r/w   0*/
		uint8_t LANE0_TXIMP_CAL_LOCK                     : 1;	/*     15     r/w   1*/
		uint8_t RESERVED_16                              : 6;	/*[21:16]     r/w   0*/
		uint8_t LANE0_LCPLL_RATECHG_DONE                 : 1;	/*     22     r/w   0*/
		uint8_t LANE0_LCPLL_RATEREQ_ON                   : 1;	/*     23     r/w   0*/
		uint8_t LANE0_PLL_RATE_SEL_REQ_7_0               : 8;	/*[31:24]     r/w 8'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} LANE0_LCPLL_SPDCHG_t;
__xdata __at( 0xe6dc ) volatile LANE0_LCPLL_SPDCHG_t LANE0_LCPLL_SPDCHG;
#define cmx_LANE0_VDD_CAL_REQ  LANE0_LCPLL_SPDCHG.BF.LANE0_VDD_CAL_REQ
#define cmx_LANE0_VDD_CAL_LOCK  LANE0_LCPLL_SPDCHG.BF.LANE0_VDD_CAL_LOCK
#define cmx_LANE0_TXDETECT_CAL_REQ  LANE0_LCPLL_SPDCHG.BF.LANE0_TXDETECT_CAL_REQ
#define cmx_LANE0_TXDETECT_CAL_LOCK  LANE0_LCPLL_SPDCHG.BF.LANE0_TXDETECT_CAL_LOCK
#define cmx_LANE0_RXIMP_CAL_REQ  LANE0_LCPLL_SPDCHG.BF.LANE0_RXIMP_CAL_REQ
#define cmx_LANE0_RXIMP_CAL_LOCK  LANE0_LCPLL_SPDCHG.BF.LANE0_RXIMP_CAL_LOCK
#define cmx_LANE0_TXIMP_CAL_REQ  LANE0_LCPLL_SPDCHG.BF.LANE0_TXIMP_CAL_REQ
#define cmx_LANE0_TXIMP_CAL_LOCK  LANE0_LCPLL_SPDCHG.BF.LANE0_TXIMP_CAL_LOCK
#define cmx_LANE0_LCPLL_RATECHG_DONE  LANE0_LCPLL_SPDCHG.BF.LANE0_LCPLL_RATECHG_DONE
#define cmx_LANE0_LCPLL_RATEREQ_ON  LANE0_LCPLL_SPDCHG.BF.LANE0_LCPLL_RATEREQ_ON
#define cmx_LANE0_PLL_RATE_SEL_REQ_7_0  LANE0_LCPLL_SPDCHG.BF.LANE0_PLL_RATE_SEL_REQ_7_0

// 0x06e0	LANE1_LCPLL_SPDCHG		Lane 1 LC PLL speed change
typedef union {
	struct {
		uint8_t RESERVED_0                               : 8;	/*  [7:0]     r/w   0*/
		uint8_t LANE1_VDD_CAL_REQ                        : 1;	/*      8     r/w   0*/
		uint8_t LANE1_VDD_CAL_LOCK                       : 1;	/*      9     r/w   1*/
		uint8_t LANE1_TXDETECT_CAL_REQ                   : 1;	/*     10     r/w   0*/
		uint8_t LANE1_TXDETECT_CAL_LOCK                  : 1;	/*     11     r/w   1*/
		uint8_t LANE1_RXIMP_CAL_REQ                      : 1;	/*     12     r/w   0*/
		uint8_t LANE1_RXIMP_CAL_LOCK                     : 1;	/*     13     r/w   1*/
		uint8_t LANE1_TXIMP_CAL_REQ                      : 1;	/*     14     r/w   0*/
		uint8_t LANE1_TXIMP_CAL_LOCK                     : 1;	/*     15     r/w   1*/
		uint8_t RESERVED_16                              : 6;	/*[21:16]     r/w   0*/
		uint8_t LANE1_LCPLL_RATECHG_DONE                 : 1;	/*     22     r/w   0*/
		uint8_t LANE1_LCPLL_RATEREQ_ON                   : 1;	/*     23     r/w   0*/
		uint8_t LANE1_PLL_RATE_SEL_REQ_7_0               : 8;	/*[31:24]     r/w 8'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} LANE1_LCPLL_SPDCHG_t;
__xdata __at( 0xe6e0 ) volatile LANE1_LCPLL_SPDCHG_t LANE1_LCPLL_SPDCHG;
#define cmx_LANE1_VDD_CAL_REQ  LANE1_LCPLL_SPDCHG.BF.LANE1_VDD_CAL_REQ
#define cmx_LANE1_VDD_CAL_LOCK  LANE1_LCPLL_SPDCHG.BF.LANE1_VDD_CAL_LOCK
#define cmx_LANE1_TXDETECT_CAL_REQ  LANE1_LCPLL_SPDCHG.BF.LANE1_TXDETECT_CAL_REQ
#define cmx_LANE1_TXDETECT_CAL_LOCK  LANE1_LCPLL_SPDCHG.BF.LANE1_TXDETECT_CAL_LOCK
#define cmx_LANE1_RXIMP_CAL_REQ  LANE1_LCPLL_SPDCHG.BF.LANE1_RXIMP_CAL_REQ
#define cmx_LANE1_RXIMP_CAL_LOCK  LANE1_LCPLL_SPDCHG.BF.LANE1_RXIMP_CAL_LOCK
#define cmx_LANE1_TXIMP_CAL_REQ  LANE1_LCPLL_SPDCHG.BF.LANE1_TXIMP_CAL_REQ
#define cmx_LANE1_TXIMP_CAL_LOCK  LANE1_LCPLL_SPDCHG.BF.LANE1_TXIMP_CAL_LOCK
#define cmx_LANE1_LCPLL_RATECHG_DONE  LANE1_LCPLL_SPDCHG.BF.LANE1_LCPLL_RATECHG_DONE
#define cmx_LANE1_LCPLL_RATEREQ_ON  LANE1_LCPLL_SPDCHG.BF.LANE1_LCPLL_RATEREQ_ON
#define cmx_LANE1_PLL_RATE_SEL_REQ_7_0  LANE1_LCPLL_SPDCHG.BF.LANE1_PLL_RATE_SEL_REQ_7_0

// 0x06e4	LANE2_LCPLL_SPDCHG		Lane 0 LC PLL speed change
typedef union {
	struct {
		uint8_t RESERVED_0                               : 8;	/*  [7:0]     r/w   0*/
		uint8_t LANE2_VDD_CAL_REQ                        : 1;	/*      8     r/w   0*/
		uint8_t LANE2_VDD_CAL_LOCK                       : 1;	/*      9     r/w   1*/
		uint8_t LANE2_TXDETECT_CAL_REQ                   : 1;	/*     10     r/w   0*/
		uint8_t LANE2_TXDETECT_CAL_LOCK                  : 1;	/*     11     r/w   1*/
		uint8_t LANE2_RXIMP_CAL_REQ                      : 1;	/*     12     r/w   0*/
		uint8_t LANE2_RXIMP_CAL_LOCK                     : 1;	/*     13     r/w   1*/
		uint8_t LANE2_TXIMP_CAL_REQ                      : 1;	/*     14     r/w   0*/
		uint8_t LANE2_TXIMP_CAL_LOCK                     : 1;	/*     15     r/w   1*/
		uint8_t RESERVED_16                              : 6;	/*[21:16]     r/w   0*/
		uint8_t LANE2_LCPLL_RATECHG_DONE                 : 1;	/*     22     r/w   0*/
		uint8_t LANE2_LCPLL_RATEREQ_ON                   : 1;	/*     23     r/w   0*/
		uint8_t LANE2_PLL_RATE_SEL_REQ_7_0               : 8;	/*[31:24]     r/w 8'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} LANE2_LCPLL_SPDCHG_t;
__xdata __at( 0xe6e4 ) volatile LANE2_LCPLL_SPDCHG_t LANE2_LCPLL_SPDCHG;
#define cmx_LANE2_VDD_CAL_REQ  LANE2_LCPLL_SPDCHG.BF.LANE2_VDD_CAL_REQ
#define cmx_LANE2_VDD_CAL_LOCK  LANE2_LCPLL_SPDCHG.BF.LANE2_VDD_CAL_LOCK
#define cmx_LANE2_TXDETECT_CAL_REQ  LANE2_LCPLL_SPDCHG.BF.LANE2_TXDETECT_CAL_REQ
#define cmx_LANE2_TXDETECT_CAL_LOCK  LANE2_LCPLL_SPDCHG.BF.LANE2_TXDETECT_CAL_LOCK
#define cmx_LANE2_RXIMP_CAL_REQ  LANE2_LCPLL_SPDCHG.BF.LANE2_RXIMP_CAL_REQ
#define cmx_LANE2_RXIMP_CAL_LOCK  LANE2_LCPLL_SPDCHG.BF.LANE2_RXIMP_CAL_LOCK
#define cmx_LANE2_TXIMP_CAL_REQ  LANE2_LCPLL_SPDCHG.BF.LANE2_TXIMP_CAL_REQ
#define cmx_LANE2_TXIMP_CAL_LOCK  LANE2_LCPLL_SPDCHG.BF.LANE2_TXIMP_CAL_LOCK
#define cmx_LANE2_LCPLL_RATECHG_DONE  LANE2_LCPLL_SPDCHG.BF.LANE2_LCPLL_RATECHG_DONE
#define cmx_LANE2_LCPLL_RATEREQ_ON  LANE2_LCPLL_SPDCHG.BF.LANE2_LCPLL_RATEREQ_ON
#define cmx_LANE2_PLL_RATE_SEL_REQ_7_0  LANE2_LCPLL_SPDCHG.BF.LANE2_PLL_RATE_SEL_REQ_7_0

// 0x06e8	LANE3_LCPLL_SPDCHG		Lane 0 LC PLL speed change
typedef union {
	struct {
		uint8_t RESERVED_0                               : 8;	/*  [7:0]     r/w   0*/
		uint8_t LANE3_VDD_CAL_REQ                        : 1;	/*      8     r/w   0*/
		uint8_t LANE3_VDD_CAL_LOCK                       : 1;	/*      9     r/w   1*/
		uint8_t LANE3_TXDETECT_CAL_REQ                   : 1;	/*     10     r/w   0*/
		uint8_t LANE3_TXDETECT_CAL_LOCK                  : 1;	/*     11     r/w   1*/
		uint8_t LANE3_RXIMP_CAL_REQ                      : 1;	/*     12     r/w   0*/
		uint8_t LANE3_RXIMP_CAL_LOCK                     : 1;	/*     13     r/w   1*/
		uint8_t LANE3_TXIMP_CAL_REQ                      : 1;	/*     14     r/w   0*/
		uint8_t LANE3_TXIMP_CAL_LOCK                     : 1;	/*     15     r/w   1*/
		uint8_t RESERVED_16                              : 6;	/*[21:16]     r/w   0*/
		uint8_t LANE3_LCPLL_RATECHG_DONE                 : 1;	/*     22     r/w   0*/
		uint8_t LANE3_LCPLL_RATEREQ_ON                   : 1;	/*     23     r/w   0*/
		uint8_t LANE3_PLL_RATE_SEL_REQ_7_0               : 8;	/*[31:24]     r/w 8'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} LANE3_LCPLL_SPDCHG_t;
__xdata __at( 0xe6e8 ) volatile LANE3_LCPLL_SPDCHG_t LANE3_LCPLL_SPDCHG;
#define cmx_LANE3_VDD_CAL_REQ  LANE3_LCPLL_SPDCHG.BF.LANE3_VDD_CAL_REQ
#define cmx_LANE3_VDD_CAL_LOCK  LANE3_LCPLL_SPDCHG.BF.LANE3_VDD_CAL_LOCK
#define cmx_LANE3_TXDETECT_CAL_REQ  LANE3_LCPLL_SPDCHG.BF.LANE3_TXDETECT_CAL_REQ
#define cmx_LANE3_TXDETECT_CAL_LOCK  LANE3_LCPLL_SPDCHG.BF.LANE3_TXDETECT_CAL_LOCK
#define cmx_LANE3_RXIMP_CAL_REQ  LANE3_LCPLL_SPDCHG.BF.LANE3_RXIMP_CAL_REQ
#define cmx_LANE3_RXIMP_CAL_LOCK  LANE3_LCPLL_SPDCHG.BF.LANE3_RXIMP_CAL_LOCK
#define cmx_LANE3_TXIMP_CAL_REQ  LANE3_LCPLL_SPDCHG.BF.LANE3_TXIMP_CAL_REQ
#define cmx_LANE3_TXIMP_CAL_LOCK  LANE3_LCPLL_SPDCHG.BF.LANE3_TXIMP_CAL_LOCK
#define cmx_LANE3_LCPLL_RATECHG_DONE  LANE3_LCPLL_SPDCHG.BF.LANE3_LCPLL_RATECHG_DONE
#define cmx_LANE3_LCPLL_RATEREQ_ON  LANE3_LCPLL_SPDCHG.BF.LANE3_LCPLL_RATEREQ_ON
#define cmx_LANE3_PLL_RATE_SEL_REQ_7_0  LANE3_LCPLL_SPDCHG.BF.LANE3_PLL_RATE_SEL_REQ_7_0
...
__xdata __at( 0xe6ec ) volatile END_XDAT_CMN_t END_XDAT_CMN;
