...
__xdata bool pre_sq_rd, save_pu_f1p_s_o, save_pu_f1p_s_e, save_dfe_adapt_e_en, save_dfe_adapt_o_en; //eom save
...
__xdata bool tx_align_on/*, spdchg_on*/, llpnum, rx_init_done, bypass_ctle_train_on;
__xdata uint8_t dfe_stop;
__xdata uint8_t cont_cal_inx, P1_cont_cal, dfe_sm_dc_e_e, dfe_sm_dc_e_o;
