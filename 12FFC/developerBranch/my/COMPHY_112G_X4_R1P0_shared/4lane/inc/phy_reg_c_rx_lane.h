...
typedef union {
	struct {
		uint8_t RX_SELMUFI_LANE_3_0                      : 4;	/*  [3:0]     r/w 4'h1*/
		uint8_t RX_SELMUFF_LANE_3_0                      : 4;	/*  [7:4]     r/w 4'h2*/
...
typedef union {
	struct {
		...
		uint8_t AN_RX_SEL_BITS_LANE                      : 1;	/*     27     r/w   0*/
		uint8_t TRAIN_RX_SEL_BITS_LANE                   : 1;	/*     28     r/w   1*/
		uint8_t RX_PAM2_EN_LANE                          : 1;	/*     29     r/w   0*/
		uint8_t RX_HALFRATE_EN_LANE                      : 1;	/*     30     r/w   0*/
...
#define reg_AN_RX_SEL_BITS_LANE  RX_SYSTEM_LANE.BF.AN_RX_SEL_BITS_LANE
...
#define reg_RX_HALFRATE_EN_LANE  RX_SYSTEM_LANE.BF.RX_HALFRATE_EN_LANE
...
typedef union {
	struct {
		...
		uint8_t RX_ACJTAG_HYST_FM_REG_LANE               : 1;	/*      5     r/w   0*/
		uint8_t RX_ACJTAG_HYST_LANE_2_0_b0               : 2;	/*  [8:6]     r/w 3'h0*/
		uint8_t RX_ACJTAG_HYST_LANE_2_0_b1               : 1;	/*  [8:6]     r/w 3'h0*/
		uint8_t RESERVED_9                               : 1;	/*      9     r/w   0*/
		uint8_t RESERVED_10                              : 6;	/*[25:10]     r/w 16'h0*/
		uint8_t RESERVED_16                              : 8;	/*[25:10]     r/w 16'h0*/
		uint8_t RESERVED_24                              : 2;	/*[25:10]     r/w 16'h0*/
		uint8_t PHY_GEN_RX_FM_REG_LANE                   : 1;	/*     26     r/w   0*/
		uint8_t PHY_GEN_RX_LANE_4_0                      : 5;	/*[31:27]     r/w 5'h9*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
...
#define reg_PHY_GEN_RX_LANE_4_0  INPUT_RX_PIN_REG0_LANE.BF.PHY_GEN_RX_LANE_4_0
...
typedef union {
	struct {
		...
		uint8_t ANA_RX_UP2FLOOP_P1P3_FM_REG_LANE         : 1;	/*     14     r/w   0*/
		uint8_t ANA_RX_UP2FLOOP_P1P3_LANE_3_0_b0         : 1;	/*[18:15]     r/w 4'h0*/
		uint8_t ANA_RX_UP2FLOOP_P1P3_LANE_3_0_b1         : 3;	/*[18:15]     r/w 4'h0*/
		uint8_t ANA_RX_DN2FLOOP_P1P3_FM_REG_LANE         : 1;	/*     19     r/w   0*/
		uint8_t ANA_RX_DN2FLOOP_P1P3_LANE_3_0            : 4;	/*[23:20]     r/w 4'h0*/
...
#define reg_ANA_RX_UP2FLOOP_P1P3_FM_REG_LANE  INPUT_RX_PIN_REG1_LANE.BF.ANA_RX_UP2FLOOP_P1P3_FM_REG_LANE
#define reg_ANA_RX_UP2FLOOP_P1P3_LANE_3_0_b0  INPUT_RX_PIN_REG1_LANE.BF.ANA_RX_UP2FLOOP_P1P3_LANE_3_0_b0
#define reg_ANA_RX_UP2FLOOP_P1P3_LANE_3_0_b1  INPUT_RX_PIN_REG1_LANE.BF.ANA_RX_UP2FLOOP_P1P3_LANE_3_0_b1
#define reg_ANA_RX_DN2FLOOP_P1P3_FM_REG_LANE  INPUT_RX_PIN_REG1_LANE.BF.ANA_RX_DN2FLOOP_P1P3_FM_REG_LANE
#define reg_ANA_RX_DN2FLOOP_P1P3_LANE_3_0  INPUT_RX_PIN_REG1_LANE.BF.ANA_RX_DN2FLOOP_P1P3_LANE_3_0
...
typedef union {
	struct {
		...
		uint8_t RESERVED_11                              : 1;	/*     11     r/w   0*/
		uint8_t RESERVED_12                              : 1;	/*     12     r/w   0*/
		uint8_t RESERVED_13                              : 3;	/*[18:13]     r/w   0*/
		uint8_t RESERVED_16                              : 3;	/*[18:13]     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t RESERVED_22                              : 1;	/*     22     r/w   0*/
		uint8_t RESERVED_23                              : 1;	/*     23     r/w   0*/
		uint8_t PIN_RXDCLK_NT_SEL_RD_LANE_2_0            : 3;	/*[26:24]       r   0*/
...
#define reg_RXDCLK_25M_EN_LANE  SPD_CTRL_RX_LANE_REG1_LANE.BF.RXDCLK_25M_EN_LANE
...
typedef union {
	struct {
		uint8_t ANA_RX_UP2FLOOP_P2P4_FM_REG_LANE         : 1;	/*      0     r/w   0*/
		uint8_t ANA_RX_UP2FLOOP_P2P4_LANE_3_0            : 4;	/*  [4:1]     r/w 4'h0*/
		uint8_t RESERVED_5                               : 1;	/*      5     r/w   0*/
		uint8_t RESERVED_6                               : 1;	/*      6     r/w   0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
		uint8_t ANA_RX_DN2FLOOP_P2P4_FM_REG_LANE         : 1;	/*      8     r/w   0*/
		uint8_t ANA_RX_DN2FLOOP_P2P4_LANE_3_0            : 4;	/* [12:9]     r/w 4'h0*/
		uint8_t RESERVED_13                              : 1;	/*     13     r/w   0*/
		uint8_t RESERVED_14                              : 1;	/*     14     r/w   0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
...
#define reg_ANA_RX_UP2FLOOP_P2P4_FM_REG_LANE  CLKGEN_RX_LANE_REG1_LANE.BF.ANA_RX_UP2FLOOP_P2P4_FM_REG_LANE
#define reg_ANA_RX_UP2FLOOP_P2P4_LANE_3_0  CLKGEN_RX_LANE_REG1_LANE.BF.ANA_RX_UP2FLOOP_P2P4_LANE_3_0
#define reg_ANA_RX_DN2FLOOP_P2P4_FM_REG_LANE  CLKGEN_RX_LANE_REG1_LANE.BF.ANA_RX_DN2FLOOP_P2P4_FM_REG_LANE
#define reg_ANA_RX_DN2FLOOP_P2P4_LANE_3_0  CLKGEN_RX_LANE_REG1_LANE.BF.ANA_RX_DN2FLOOP_P2P4_LANE_3_0
...
typedef union {
	struct {
		...
		uint8_t RESERVED_14                              : 1;	/*     14     r/w   0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
		uint8_t ALIGN90EE_ACC_CYCLE_CNT_LANE_15_0_b0     : 8;	/*[31:16]     r/w 16'h400*/
		uint8_t ALIGN90EE_ACC_CYCLE_CNT_LANE_15_0_b1     : 8;	/*[31:16]     r/w 16'h400*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
} DTL_REG4_t;
__xdata __at( 0x215c ) volatile DTL_REG4_t DTL_REG4;
...
#define reg_ALIGN90EE_ACC_CYCLE_CNT_LANE_15_0_b0  DTL_REG4.BF.ALIGN90EE_ACC_CYCLE_CNT_LANE_15_0_b0
#define reg_ALIGN90EE_ACC_CYCLE_CNT_LANE_15_0_b1  DTL_REG4.BF.ALIGN90EE_ACC_CYCLE_CNT_LANE_15_0_b1
#define reg_ALIGN90EE_ACC_CYCLE_CNT_LANE_15_0  DTL_REG4.WT.W1
...
typedef union {
	struct {
		...
		uint8_t RX_SSC_FOUND_LANE                        : 1;	/*     14       r   0*/
		uint8_t DTL_CLAMPING_TRIGGERED_LANE              : 1;	/*     15       r   0*/
...
typedef union {
	struct {
		...
		uint8_t ALIGN90EE_ACC_START_LANE                 : 1;	/*     13     r/w   0*/
		uint8_t ALIGN90EE_ACC_DONE_LANE                  : 1;	/*     14       r   0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
		uint8_t ALIGN90EE_ACC_LANE_15_0_b0               : 8;	/*[31:16]       r   0*/
		uint8_t ALIGN90EE_ACC_LANE_15_0_b1               : 8;	/*[31:16]       r   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
...
#define reg_ALIGN90EE_ACC_START_LANE  DTL_REG3.BF.ALIGN90EE_ACC_START_LANE
#define reg_ALIGN90EE_ACC_DONE_LANE  DTL_REG3.BF.ALIGN90EE_ACC_DONE_LANE
#define reg_ALIGN90EE_ACC_LANE_15_0_b0  DTL_REG3.BF.ALIGN90EE_ACC_LANE_15_0_b0
#define reg_ALIGN90EE_ACC_LANE_15_0_b1  DTL_REG3.BF.ALIGN90EE_ACC_LANE_15_0_b1
#define reg_ALIGN90EE_ACC_LANE_15_0  DTL_REG3.WT.W1
