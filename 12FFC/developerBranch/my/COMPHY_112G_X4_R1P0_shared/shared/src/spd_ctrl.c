...
void turn_off_cont_cal(void) BANKING_CTRL
{
	...
	while(!reg_PLL_DCC_TOP_CONT_DONE_LANE || !reg_PLL_AMP_TOP_CONT_DONE_LANE || !reg_RX_EOM_TOP_CONT_DONE_LANE || \
			!reg_TX_ALIGN90_DCC_TOP_CONT_DONE_LANE || !reg_DLL_TOP_CONT_DONE_LANE || !reg_RX_CLK_TOP_CONT_DONE_LANE || !reg_LCPLL_TEMPC_CAL_DONE_LANE);
}
