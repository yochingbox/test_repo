...
void clear_xdata(void) BANKING_CTRL {
	...
	// For sync interface
	switch(mcuid){
		case MCU_LANE0: mcu_request_lane0 = 0;break;
		case MCU_LANE1: mcu_request_lane1 = 0;break;
		case MCU_LANE2: mcu_request_lane2 = 0;break;
		case MCU_LANE3: mcu_request_lane3 = 0;break;
