...
/*			PHY_STATUS = ST_CAL;*/
    	...
    	if(!(mcu_request_lane0&0x1))
    		reg_MCU_DEBUG_CMN_0_7_0 &= ~1;
    	if(!(mcu_request_lane1&0x1))
    		reg_MCU_DEBUG_CMN_0_7_0 &= ~2;
    	if(!(mcu_request_lane2&0x1))
    		reg_MCU_DEBUG_CMN_0_7_0 &= ~4;
    	if(!(mcu_request_lane3&0x1))
    		reg_MCU_DEBUG_CMN_0_7_0 &= ~8;
    	
    	if(reg_MCU_DEBUG_CMN_0_7_0==0){
    		if(mcu_request_lane0&0x1)
    			reg_MCU_DEBUG_CMN_0_7_0 = 1;
    		else if(mcu_request_lane1&0x1)
    			reg_MCU_DEBUG_CMN_0_7_0 = 2;
    		else if(mcu_request_lane2&0x1)
    			reg_MCU_DEBUG_CMN_0_7_0 = 4;
    		else if(mcu_request_lane3&0x1)
    			reg_MCU_DEBUG_CMN_0_7_0 = 8;
    	}
