...
void dll_init_cont_ram(void)
{
	...
	EOM_DLL_GM_CAL_BYPASS_EN=1; //Disable EOM continuous calibration since EOM clock is shut off
	//EOM_DLL_GM_CAL_SINGLE_EN=1;
	EOM_DLL_GM_CAL_DIR_INV=0;
	DLL_VDDA_CAL_BYPASS_EN=0;
	//DLL_VDDA_CAL_SINGLE_EN=1;
	...
	DLL_VDDA_CAL_DIR_INV=0;
	EOM_DLL_VDDA_CAL_BYPASS_EN=1; //Disable EOM continuous calibration since EOM clock is shut off
	//EOM_DLL_VDDA_CAL_SINGLE_EN=1;
