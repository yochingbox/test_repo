...
__xdata volatile uint8_t dsp_debug[49];
...
__xdata uint8_t __at(0xe700) mcu_request_lane0;
__xdata uint8_t __at(0xe701) mcu_request_lane1;
__xdata uint8_t __at(0xe702) mcu_request_lane2;
__xdata uint8_t __at(0xe703) mcu_request_lane3;
