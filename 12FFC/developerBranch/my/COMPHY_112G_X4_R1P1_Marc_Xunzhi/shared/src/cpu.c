...
void cpu_init(void) {
	...
	#ifdef _LAB
	if(BYPASS_DELAY==0 && BYPASS_POWERON_DELAY==0)
		lnx_UART_EN_LANE = 1; //TODO: Remove
	...
	//S0RELL = 0xf3;
	//S0RELL = 0x93;
	//S0RELL = 0xe5; //for 400MHz MCU, 460800 baud
	S0RELL = 0xeb; //for 312.5MHz MCU, 460800 baud
	}
	#endif
	...
	T2CON = 0x60;//x60; //EX2/EX3:RISE, (Timer2)
