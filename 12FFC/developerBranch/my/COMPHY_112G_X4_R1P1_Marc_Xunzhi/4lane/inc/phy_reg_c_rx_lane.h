...
typedef union {
	struct {
		...
		uint8_t ANA_RX_DN2FLOOP_P1P3_FM_REG_LANE         : 1;	/*     15     r/w   0*/
		uint8_t ANA_RX_UP2FLOOP_P1P3_LANE_3_0            : 4;	/*[19:16]     r/w 4'h0*/
...
#define reg_ANA_RX_UP2FLOOP_P1P3_LANE_3_0  INPUT_RX_PIN_REG1_LANE.BF.ANA_RX_UP2FLOOP_P1P3_LANE_3_0
...
typedef union {
	struct {
		...
		uint8_t DTL_HALFRATE_EN_GATE_BYPASS_LANE         : 1;	/*      8     r/w   0*/
...
#define reg_DTL_HALFRATE_EN_GATE_BYPASS_LANE  DTL_REG0.BF.DTL_HALFRATE_EN_GATE_BYPASS_LANE
