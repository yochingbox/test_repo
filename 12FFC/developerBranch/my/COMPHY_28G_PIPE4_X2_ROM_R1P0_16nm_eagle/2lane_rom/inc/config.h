...
// PHY MODE OPTIONS
#define _PCIE_USB
// #define _SATA_SERDES // X2_ROM: OFF
...
//#define SUPPORT_REALTIME_PHASE_ADAPT // X2_ROM: OFF
#define SUPPORT_EOM
...
#define SPD_TBL_IN_PMEM	// define when speed table is stored in program memory
#define SUPPORT_CMD_IF
#define SUPPORT_CHECK_NORMAL_F0D

//#define SUPPORT_SHRTR_PATCH
//debug 
//#define SUPPORT_EN_DFE_CTRL
//#define SUPPORT_DFE_TAP_REWRITE
//#define SUPPORT_TRAIN_HIS_LOG
//#define SUPPORT_DFE_UPDATE_EN_DEBUG
//#define SUPPORT_CAL_MEMORY_OPT
