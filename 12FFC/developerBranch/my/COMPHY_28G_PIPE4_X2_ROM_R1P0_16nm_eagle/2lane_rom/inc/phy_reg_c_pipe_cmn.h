...
typedef union {
	struct {
		...
		uint8_t CFG_CLK_SRC_MASK                         : 1;	/*     30     r/w   1*/
		uint8_t CFG_USE_ASYNC_CLKREQN                    : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} GLOB_CLK_SRC_LO_t;
__xdata __at( 0xc004 ) volatile GLOB_CLK_SRC_LO_t GLOB_CLK_SRC_LO;
...
__xdata __at( 0xc008 ) volatile GLOB_CLK_SRC_HI_t GLOB_CLK_SRC_HI;
...
__xdata __at( 0xc00c ) volatile GLOB_MISC_CTRL_t GLOB_MISC_CTRL;
...
__xdata __at( 0xc010 ) volatile GLOB_DP_SAL_CFG_t GLOB_DP_SAL_CFG;
...
__xdata __at( 0xc014 ) volatile GLOB_DP_SAL_CFG1_t GLOB_DP_SAL_CFG1;
...
__xdata __at( 0xc018 ) volatile GLOB_DP_SAL_CFG3_t GLOB_DP_SAL_CFG3;
...
__xdata __at( 0xc01c ) volatile GLOB_DP_SAL_CFG5_t GLOB_DP_SAL_CFG5;
...
__xdata __at( 0xc020 ) volatile GLOB_PM_CFG0_t GLOB_PM_CFG0;
...
__xdata __at( 0xc024 ) volatile GLOB_COUNTER_CTRL_t GLOB_COUNTER_CTRL;
...
__xdata __at( 0xc028 ) volatile GLOB_COUNTER_HI_t GLOB_COUNTER_HI;
...
__xdata __at( 0xc02c ) volatile GLOB_PM_DP_CTRL_t GLOB_PM_DP_CTRL;
...
__xdata __at( 0xc030 ) volatile GLOB_DP_BAL_CFG0_t GLOB_DP_BAL_CFG0;
...
__xdata __at( 0xc034 ) volatile GLOB_DP_BAL_CFG2_t GLOB_DP_BAL_CFG2;
...
__xdata __at( 0xc038 ) volatile GLOB_DP_BAL_CFG4_t GLOB_DP_BAL_CFG4;
...
__xdata __at( 0xc03c ) volatile GLOB_BIST_CTRL_t GLOB_BIST_CTRL;
...
__xdata __at( 0xc040 ) volatile GLOB_BIST_LANE_TYPE_t GLOB_BIST_LANE_TYPE;
...
__xdata __at( 0xc044 ) volatile GLOB_BIST_START_t GLOB_BIST_START;
...
__xdata __at( 0xc048 ) volatile GLOB_BIST_MASK_t GLOB_BIST_MASK;
...
__xdata __at( 0xc04c ) volatile GLOB_BIST_RESULT_t GLOB_BIST_RESULT;
...
__xdata __at( 0xc050 ) volatile GLOB_BIST_SEQR_CFG_t GLOB_BIST_SEQR_CFG;
...
__xdata __at( 0xc054 ) volatile GLOB_BIST_DATA_HI_t GLOB_BIST_DATA_HI;
...
__xdata __at( 0xc058 ) volatile GLOB_PIPE_REVISION_t GLOB_PIPE_REVISION;
