...
//---	reg_TX_EMPH1_DEFAULT3_LANE_4_0			= speedtable[gen][spdoft_tx_emph1_default3_lane];
	...
	switch(gen){
	case 0: reg_CTLE_RES1_SEL_LANE_3_0 = 12;break;
	case 1: reg_CTLE_RES1_SEL_LANE_3_0 = 13;break;
	case 2: reg_CTLE_RES1_SEL_LANE_3_0 = 12;break;
	}
	reg_CTLE_CAP1_SEL_LANE_5_0 = 21;
	
	// Temp change before speed table change
	//reg_RX_SELMUFF_LANE_3_0 				= speedtable[gen][spdoft_selmuff_lane];
	//reg_REG_SELMUPF_LANE_3_0 				= speedtable[gen][spdoft_selmupf_lane];
	switch(gen){
	case 0: 
	case 1: reg_REG_SELMUPF_LANE_3_0 = 1;break;
	case 2: 
	case 3: reg_REG_SELMUPF_LANE_3_0 = 2;break;
	case 4: reg_REG_SELMUPF_LANE_3_0 = 3;break;
	case 7:
	case 0xa: reg_REG_SELMUPF_LANE_3_0 = 4;reg_RX_SELMUFF_LANE_3_0 = 4;break;
	}
...
/*	reg_LCPLL_TEMPC_CAL_EN_LANE = 0;*/
	...
	//while((wtag=0xA0)&&!reg_PLL_DCC_TOP_CONT_DONE_LANE || !reg_PLL_AMP_TOP_CONT_DONE_LANE || !reg_RX_EOM_TOP_CONT_DONE_LANE || !reg_TX_ALIGN90_DCC_TOP_CONT_DONE_LANE || !reg_DLL_TOP_CONT_DONE_LANE || !reg_RX_CLK_TOP_CONT_DONE_LANE || !reg_LCPLL_TEMPC_CAL_DONE_LANE);
}
