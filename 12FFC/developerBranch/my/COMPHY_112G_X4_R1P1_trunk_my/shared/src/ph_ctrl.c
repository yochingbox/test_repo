...
void align90_phase_update(uint8_t align90_ref_tgt)
{
    ...
    uint8_t align90_ref_cur;
    uint8_t \ 
    reg_RX_ALIGN90_DD_CAL_BYPASS_EN_LANE_saved,\
    reg_RX_ALIGN90_EE_CAL_BYPASS_EN_LANE_saved,\
          reg_RX_DCC1_CAL_BYPASS_EN_LANE_saved,\
          reg_RX_DCC2_CAL_BYPASS_EN_LANE_saved,\
          reg_RX_DCC3_CAL_BYPASS_EN_LANE_saved,\
          reg_RX_DCC4_CAL_BYPASS_EN_LANE_saved,\
          reg_RX_DCC5_CAL_BYPASS_EN_LANE_saved;

	if(reg_RX_CLK_TOP_CONT_START_LANE){
		reg_RX_CLK_TOP_CONT_START_LANE = 0;
		while((wtag=0x42)&&!reg_RX_CLK_TOP_CONT_DONE_LANE);
    }else{
    	lnx_PHASE_DEBUG1_LANE_7_0++;
    }
//10/23/2019
//help Xu to add code to save and restore these regs
    reg_RX_ALIGN90_DD_CAL_BYPASS_EN_LANE_saved = reg_RX_ALIGN90_DD_CAL_BYPASS_EN_LANE;
    reg_RX_ALIGN90_EE_CAL_BYPASS_EN_LANE_saved = reg_RX_ALIGN90_EE_CAL_BYPASS_EN_LANE;
          reg_RX_DCC1_CAL_BYPASS_EN_LANE_saved =       reg_RX_DCC1_CAL_BYPASS_EN_LANE;
          reg_RX_DCC2_CAL_BYPASS_EN_LANE_saved =       reg_RX_DCC2_CAL_BYPASS_EN_LANE;
          reg_RX_DCC3_CAL_BYPASS_EN_LANE_saved =       reg_RX_DCC3_CAL_BYPASS_EN_LANE;
          reg_RX_DCC4_CAL_BYPASS_EN_LANE_saved =       reg_RX_DCC4_CAL_BYPASS_EN_LANE;
          reg_RX_DCC5_CAL_BYPASS_EN_LANE_saved =       reg_RX_DCC5_CAL_BYPASS_EN_LANE;
//end help Xu to add code to save and restore these regs
    ...
    while((wtag=0x43)&& align90_ref_cur != align90_ref_tgt )
    {
        ...
        delay_ram(Tus);
        while((wtag=0x44)&&!reg_RX_CLK_TOP_DONE_LANE);
...
//help Xu to add code to save and restore these regs
    ...
    reg_RX_ALIGN90_DD_CAL_BYPASS_EN_LANE = reg_RX_ALIGN90_DD_CAL_BYPASS_EN_LANE_saved;
    reg_RX_ALIGN90_EE_CAL_BYPASS_EN_LANE = reg_RX_ALIGN90_EE_CAL_BYPASS_EN_LANE_saved;
          reg_RX_DCC1_CAL_BYPASS_EN_LANE =       reg_RX_DCC1_CAL_BYPASS_EN_LANE_saved;
          reg_RX_DCC2_CAL_BYPASS_EN_LANE =       reg_RX_DCC2_CAL_BYPASS_EN_LANE_saved;
          reg_RX_DCC3_CAL_BYPASS_EN_LANE =       reg_RX_DCC3_CAL_BYPASS_EN_LANE_saved;
          reg_RX_DCC4_CAL_BYPASS_EN_LANE =       reg_RX_DCC4_CAL_BYPASS_EN_LANE_saved;
          reg_RX_DCC5_CAL_BYPASS_EN_LANE =       reg_RX_DCC5_CAL_BYPASS_EN_LANE_saved;
//end help Xu to add code to save and restore these regs
...
//uint8_t save_top_cont_start = reg_RX_EOM_TOP_CONT_START_LANE;
    ...
    //while((wtag=0x45)&&!reg_RX_EOM_TOP_CONT_DONE_LANE);
    reg_RX_EOM_COMN_EXT_EN_LANE = 1;

    while((wtag=0x46)&& update_ph != 0 ) {       
