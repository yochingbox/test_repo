...
void save_rx_align90_de() BANKING_CTRL 
{
    ph_train_opt.rx_align90_de_ref_7_0 = convert_rx_align90_de_reg_to_code();
    DBG_Printf(",saving rx_align90_de_code: %d ", ph_train_opt.rx_align90_de_ref_7_0);
}
...
void save_rx_align90_dd() BANKING_CTRL
{
    ph_train_opt.rx_align90_dd_ref_7_0 = convert_rx_align90_dd_reg_to_code();
    DBG_Printf(",saving rx_align90_dd_code: %d ", ph_train_opt.rx_align90_dd_ref_7_0);
}
...
void save_rx_dcc(uint8_t x) BANKING_CTRL 
{
    if (x == 1){ // dcc1
        ph_train_opt.rx_dcc_p2p4_ref_7_0 = convert_rx_dcc_reg_to_code(x);
        DBG_Printf(",saving dcc1: %d ", ph_train_opt.rx_dcc_p2p4_ref_7_0);

    } else if (x == 4){ // dcc4
        ph_train_opt.rx_dcc_p1p3_ref_7_0 = convert_rx_dcc_reg_to_code(x);
        DBG_Printf(",saving dcc4: %d ", ph_train_opt.rx_dcc_p1p3_ref_7_0);
    }
}        
...
void save_ckpx_tune(uint8_t x) BANKING_CTRL 
{
    if (x == 1){
        ph_train_opt.ckp1_tune_code_lane_4_0 = convert_ckpx_tune_reg_to_code(1);
        DBG_Printf(",saving ckp1_tune_code: %d ", ph_train_opt.ckp1_tune_code_lane_4_0);
    } else if (x == 2){
        ph_train_opt.ckp2_tune_code_lane_4_0 = convert_ckpx_tune_reg_to_code(2);
        DBG_Printf(",saving ckp2_tune_code: %d ", ph_train_opt.ckp2_tune_code_lane_4_0);
    } else if (x == 3){
        ph_train_opt.ckp3_tune_code_lane_4_0 = convert_ckpx_tune_reg_to_code(3);
        DBG_Printf(",saving ckp3_tune_code: %d ", ph_train_opt.ckp3_tune_code_lane_4_0);
    } else if (x == 4){
        ph_train_opt.ckp4_tune_code_lane_4_0 = convert_ckpx_tune_reg_to_code(4);
        DBG_Printf(",saving ckp4_tune_code: %d ", ph_train_opt.ckp4_tune_code_lane_4_0);        
    }
}
...
void save_to_ph_train_adv() BANKING_CTRL 
{
    uint8_t x;
...
void optimize_ckpx_tune(uint8_t x, PH_TRAIN_MODE_t train_mode, PH_TRAIN_PATH_SEL_t path_sel) BANKING_CTRL
{
    ...
    uint8_t start = convert_ckpx_tune_reg_to_code(x);
    uint8_t setting;
...
void adv_rx_phase_opt(PH_TRAIN_MODE_t train_mode, PH_TRAIN_PATH_SEL_t path_sel) BANKING_CTRL 
{
    ...
    save_to_ph_train_adv(); // save initial register state
