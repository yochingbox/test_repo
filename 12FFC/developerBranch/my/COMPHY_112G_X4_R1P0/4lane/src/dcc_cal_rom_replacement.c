...
void rx_eom_cal_init_ram(void) BANKING_CTRL {
	...
	{
		RX_EOM_DCC_CAL_BYPASS_EN = 1;//0;//1;
//if(lnx_ESM_EN_LANE)RX_EOM_DCC_CAL_BYPASS_EN = 0;
		...
		reg_RX_EOM_ALIGN90_CAL_BYPASS_EN_LANE = 1;//0;//1;
//if(lnx_ESM_EN_LANE)reg_RX_EOM_ALIGN90_CAL_BYPASS_EN_LANE = 0;
	...
	else if (reg_RX_HALFRATE_EN_LANE == 1)
	{
		...
		reg_RX_EOM_ALIGN90_CAL_BYPASS_EN_LANE = 0;//1;
		reg_RX_EOM_ALIGN90_CAL_SINGLE_EN_LANE = 1;
		reg_RX_EOM_ALIGN90_CAL_CONT_EN_LANE = 0;
		reg_RX_EOM_ALIGN90_CAL_SINGLE_MODE_STEPSIZE_LANE_2_0 = 0;
		reg_RX_EOM_ALIGN90_CAL_CONT_MODE_STEPSIZE_LANE_2_0 = 1;
	}
