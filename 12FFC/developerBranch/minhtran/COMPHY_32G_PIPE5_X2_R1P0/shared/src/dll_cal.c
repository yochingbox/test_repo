...
void dll_gm_vdda_cal(void) BANKING_CTRL {
	...
	// Save results
	lnx_cal_dll_gmsel[rx_pll_rate] = reg_DLL_GM_CAL_RESULT_RD_LANE_2_0;
	lnx_cal_vdda_dll_sel[PWR + cmx_RXDLL_CAL_CONT_CUR_LOAD_EN][rx_pll_rate] = reg_DLL_VDDA_CAL_RESULT_RD_LANE_5_0;
	if( !cmx_EOM_DLL_CAL_EXT_EN ) {
		lnx_cal_dll_eom_gmsel[rx_pll_rate] = reg_EOM_DLL_GM_CAL_RESULT_RD_LANE_2_0;
		lnx_cal_vdda_dll_eom_sel[PWR + cmx_EOM_DLL_CAL_CONT_CUR_LOAD_EN][rx_pll_rate] = reg_EOM_DLL_VDDA_CAL_RESULT_RD_LANE_5_0;
	}
