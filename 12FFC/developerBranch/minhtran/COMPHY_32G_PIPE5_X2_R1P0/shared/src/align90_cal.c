...
void align90_cal(void) BANKING_CTRL {
	...
	// save results
	//lnx_cal_align90_dac[PWR][rate][div2] = reg_ALIGN90_CAL_RESULT_LSB_RD_LANE_5_0;
	//lnx_cal_align90_gm[PWR][rate][div2] = reg_ALIGN90_CAL_RESULT_MSB_RD_LANE_2_0;
	//lnx_cal_align90_dummy_clk[PWR][rate][div2] = reg_ALIGN90_CAL_DUMMY_CLK_RD_LANE;
...
void align90_cal_cont(void) BANKING_CTRL {
	...
	// TODO - Check align90 calibration condition
	reg_ALIGN90_CMP_OFFSET_CAL_BYPASS_EN_LANE = 1;
	reg_ALIGN90_CAL_BYPASS_EN_LANE = 0;
	reg_ALIGN90_CAL_SINGLE_EN_LANE = 0;
	reg_ALIGN90_CAL_CONT_EN_LANE = 1;
