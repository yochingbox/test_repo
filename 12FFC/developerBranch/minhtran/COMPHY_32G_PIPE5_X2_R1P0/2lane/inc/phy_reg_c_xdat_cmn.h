...
typedef union {
	struct {
		...
		uint8_t RXINIT_DONE_DELAY_15_0_b0                : 8;	/*[31:16]     r/w   0*/
		uint8_t RXINIT_DONE_DELAY_15_0_b1                : 8;	/*[31:16]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
...
// 0x06cc	RXINIT_DELAY_0		
typedef union {
	struct {
		uint8_t RXINIT_DELAY_ENTER_15_0_b0               : 8;	/* [15:0]     r/w 16'h1f4*/
		uint8_t RXINIT_DELAY_ENTER_15_0_b1               : 8;	/* [15:0]     r/w 16'h1f4*/
...
__xdata __at( 0xe6cc ) volatile RXINIT_DELAY_0_t RXINIT_DELAY_0;
...
// 0x06d0	SYNC_INFO		MCU sync info
typedef union {
	struct {
...
__xdata __at( 0xe6d0 ) volatile SYNC_INFO_t SYNC_INFO;
...
// 0x06d4	MCU_INFO_4		MCU Information Register 4
typedef union {
	struct {
...
__xdata __at( 0xe6d4 ) volatile MCU_INFO_4_t MCU_INFO_4;
...
// 0x06d8	MCU_INFO_5		MCU Information Register 5
typedef union {
	struct {
...
__xdata __at( 0xe6d8 ) volatile MCU_INFO_5_t MCU_INFO_5;
...
// 0x06dc	MCU_INFO_12		MCU Information Register 12
typedef union {
	struct {
...
__xdata __at( 0xe6dc ) volatile MCU_INFO_12_t MCU_INFO_12;
...
// 0x06e0	MCU_INFO_13		MCU Information Register 13
typedef union {
	struct {
...
__xdata __at( 0xe6e0 ) volatile MCU_INFO_13_t MCU_INFO_13;
...
__xdata __at( 0xe6e4 ) volatile END_XDAT_CMN_t END_XDAT_CMN;
