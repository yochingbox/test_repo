...
typedef union {
	struct {
		...
		uint8_t CLK_DIRECTION_RINGPLL_LANE               : 1;	/*      5     r/w   1*/
...
typedef union {
	struct {
		...
		uint8_t RXCLK_NT_FIX_DIV_EN_LANE                 : 1;	/*      3     r/w 1'b0*/
		uint8_t CLK_BKWD2_DIRECTION_LCPLL_LANE           : 1;	/*      4     r/w 1'b1*/
		uint8_t RXCLK_25M_FIX_DIV_EN_LANE                : 1;	/*      5     r/w 1'b0*/
		uint8_t UNUSED_1_LANE                            : 1;	/*      6     r/w 1'b0*/
		uint8_t DEMUX2_CLK_DLY_EN_LANE                   : 1;	/*      7     r/w 1'b1*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} UPHY14_TRX_ANAREG_TOP_152_t;
__xdata __at( 0x260 ) volatile UPHY14_TRX_ANAREG_TOP_152_t UPHY14_TRX_ANAREG_TOP_152;
#define reg_RXCLK_25M_DIV1P5_EN_LANE  UPHY14_TRX_ANAREG_TOP_152.BF.RXCLK_25M_DIV1P5_EN_LANE
#define reg_RXCLK_25M_CTRL_LANE_1_0  UPHY14_TRX_ANAREG_TOP_152.BF.RXCLK_25M_CTRL_LANE_1_0
#define reg_RXCLK_NT_FIX_DIV_EN_LANE  UPHY14_TRX_ANAREG_TOP_152.BF.RXCLK_NT_FIX_DIV_EN_LANE
#define reg_CLK_BKWD2_DIRECTION_LCPLL_LANE  UPHY14_TRX_ANAREG_TOP_152.BF.CLK_BKWD2_DIRECTION_LCPLL_LANE
#define reg_RXCLK_25M_FIX_DIV_EN_LANE  UPHY14_TRX_ANAREG_TOP_152.BF.RXCLK_25M_FIX_DIV_EN_LANE
#define reg_UNUSED_1_LANE  UPHY14_TRX_ANAREG_TOP_152.BF.UNUSED_1_LANE
#define reg_DEMUX2_CLK_DLY_EN_LANE  UPHY14_TRX_ANAREG_TOP_152.BF.DEMUX2_CLK_DLY_EN_LANE

// 0x99	UPHY14_TRX_ANAREG_TOP_153		Analog Register 153
typedef union {
	struct {
		uint8_t RXCLK_2X_EN_LANE                         : 1;	/*      0     r/w 1'b0*/
		uint8_t RXCLK_NT_DIV_RESET_LANE                  : 1;	/*      1     r/w 1'b0*/
		...
		uint8_t RXCLK_25M_DIV_RESET_LANE                 : 1;	/*      6     r/w 1'h0*/
		uint8_t CLK_FWD2_DIRECTION_LCPLL_LANE            : 1;	/*      7     r/w 1'h1*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_RXCLK_NT_DIV_RESET_LANE  UPHY14_TRX_ANAREG_TOP_153.BF.RXCLK_NT_DIV_RESET_LANE
...
#define reg_RXCLK_25M_DIV_RESET_LANE  UPHY14_TRX_ANAREG_TOP_153.BF.RXCLK_25M_DIV_RESET_LANE
#define reg_CLK_FWD2_DIRECTION_LCPLL_LANE  UPHY14_TRX_ANAREG_TOP_153.BF.CLK_FWD2_DIRECTION_LCPLL_LANE
...
#define reg_RXCLK_25M_DIV_LANE_7_0  UPHY14_TRX_ANAREG_TOP_154.BF.RXCLK_25M_DIV_LANE_7_0
...
#define reg_RXCLK_NT_CTRL_LANE_1_0  UPHY14_TRX_ANAREG_TOP_155.BF.RXCLK_NT_CTRL_LANE_1_0
#define reg_TXCLK_NT_DIV_RESET_LANE  UPHY14_TRX_ANAREG_TOP_155.BF.TXCLK_NT_DIV_RESET_LANE
#define reg_RXCLK_NT_DIV_LANE_4_0  UPHY14_TRX_ANAREG_TOP_155.BF.RXCLK_NT_DIV_LANE_4_0

// 0x9c	UPHY14_TRX_ANAREG_TOP_156		Analog Register 156
typedef union {
	struct {
		uint8_t ANA_RSVDA_LANE_7_0                       : 8;	/*  [7:0]     r/w 8'hf0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} UPHY14_TRX_ANAREG_TOP_156_t;
__xdata __at( 0x270 ) volatile UPHY14_TRX_ANAREG_TOP_156_t UPHY14_TRX_ANAREG_TOP_156;
#define reg_ANA_RSVDA_LANE_7_0  UPHY14_TRX_ANAREG_TOP_156.BF.ANA_RSVDA_LANE_7_0

// 0x9d	UPHY14_TRX_ANAREG_TOP_157		Analog Register 157
typedef union {
	struct {
		uint8_t ANA_RSVDB_LANE_7_0                       : 8;	/*  [7:0]     r/w 8'hf0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} UPHY14_TRX_ANAREG_TOP_157_t;
__xdata __at( 0x274 ) volatile UPHY14_TRX_ANAREG_TOP_157_t UPHY14_TRX_ANAREG_TOP_157;
#define reg_ANA_RSVDB_LANE_7_0  UPHY14_TRX_ANAREG_TOP_157.BF.ANA_RSVDB_LANE_7_0

// 0x9e	UPHY14_TRX_ANAREG_TOP_158		Analog Register 158
typedef union {
	struct {
	...
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} UPHY14_TRX_ANAREG_TOP_158_t;
__xdata __at( 0x278 ) volatile UPHY14_TRX_ANAREG_TOP_158_t UPHY14_TRX_ANAREG_TOP_158;
#define reg_TRX_DIG_CAL2M_DIV_TOP_LANE_7_0  UPHY14_TRX_ANAREG_TOP_158.BF.TRX_DIG_CAL2M_DIV_TOP_LANE_7_0

// 0x9f	UPHY14_TRX_ANAREG_TOP_159		Analog Register 159
typedef union {
	struct {
		uint8_t TRX_DIG_TESTBUS_SEL_TOP_LANE_3_0         : 4;	/*  [3:0]     r/w   0*/
		uint8_t TRX_DIG_CAL_CLK_EN_TOP_LANE              : 1;	/*      4     r/w   1*/
		uint8_t TRX_DIG_CAL_CLK_RST_TOP_LANE             : 1;	/*      5     r/w   0*/
		uint8_t RESERVED_6                               : 1;	/*      6     r/w   0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} UPHY14_TRX_ANAREG_TOP_159_t;
__xdata __at( 0x27c ) volatile UPHY14_TRX_ANAREG_TOP_159_t UPHY14_TRX_ANAREG_TOP_159;
#define reg_TRX_DIG_TESTBUS_SEL_TOP_LANE_3_0  UPHY14_TRX_ANAREG_TOP_159.BF.TRX_DIG_TESTBUS_SEL_TOP_LANE_3_0
#define reg_TRX_DIG_CAL_CLK_EN_TOP_LANE  UPHY14_TRX_ANAREG_TOP_159.BF.TRX_DIG_CAL_CLK_EN_TOP_LANE
#define reg_TRX_DIG_CAL_CLK_RST_TOP_LANE  UPHY14_TRX_ANAREG_TOP_159.BF.TRX_DIG_CAL_CLK_RST_TOP_LANE
