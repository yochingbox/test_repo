...
// 0x24	ALIGN90_CMP_OFFSET_CAL_0		TBD
typedef union {
	struct {
...
// 0x25	ALIGN90_CMP_OFFSET_CAL_1		TBD
typedef union {
	struct {
...
// 0x26	ALIGN90_CMP_OFFSET_CAL_2		TBD
typedef union {
	struct {
...
// 0x27	ALIGN90_CMP_OFFSET_CAL_3		TBD
typedef union {
	struct {
...
// 0x28	ALIGN90_CMP_OFFSET_CAL_4		TBD
typedef union {
	struct {
...
// 0x29	ALIGN90_CMP_OFFSET_CAL_5		TBD
typedef union {
	struct {
		uint8_t RESERVED_0                               : 3;	/*  [2:0]     r/w   0*/
...
// 0x2a	ALIGN90_CMP_OFFSET_CAL_6		TBD
typedef union {
	struct {
		uint8_t RESERVED_0                               : 4;	/*  [3:0]     r/w   0*/
