...
BIT use_ring_pll, lc_pll_used, ring_pll_enabled, ring_use_250m, force_exit_cal, no_pllspdchg; 
BIT cont_cal_on;
BIT tx_amp_is_max;
BIT tx_amp_is_min;
BIT tx_emph0_is_max;
...
__xdata	uint8_t save_dfe_adapt_splr;
...
__xdata uint8_t rx_pll_rate, tx_pll_rate, rx_pll_rate_x, tx_pll_rate_x;
...
// Please add new variable here
 ...
 __xdata bool tx_align_on, rx_init_done, bypass_ctle_train_on;
