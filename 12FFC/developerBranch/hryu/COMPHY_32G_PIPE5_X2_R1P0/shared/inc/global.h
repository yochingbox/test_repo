...
extern BIT use_ring_pll, lc_pll_used, ring_pll_enabled, ring_use_250m, force_exit_cal, no_pllspdchg; 
...
extern BIT tx_status_pcie_mode;
//------------------------------------
...
extern __xdata	uint8_t save_dfe_adapt_splr;
...
extern __xdata uint8_t rx_pll_rate, tx_pll_rate, rx_pll_rate_x, tx_pll_rate_x;
...
extern __xdata bool tx_align_on, rx_init_done, bypass_ctle_train_on;
...
//phy_mode_lane
__xdata __at(PHY_MODE_LANE_BASE + caloft_txdcc_pdiv_rate0_lane)          uint8_t lnx_cal_txdcc_pdiv[2][3];
//__xdata __at(PHY_MODE_LANE_BASE + caloft_txdcc_pdiv_hg_rate0_lane)       uint8_t lnx_cal_txdcc_pdiv_hg[3];
__xdata __at(PHY_MODE_LANE_BASE + caloft_dll_cmp_offset_rate0_lane)       uint8_t lnx_cal_dll_cmp_offset[3];
__xdata __at(PHY_MODE_LANE_BASE + caloft_txdcc_rate0_lane)               uint8_t lnx_cal_txdcc[2][3];
__xdata __at(PHY_MODE_LANE_BASE + caloft_txdcc_hg_rate0_lane)            uint8_t lnx_cal_txdcc_hg[3];
__xdata __at(PHY_MODE_LANE_BASE + caloft_rxdcc_dll_rate0_lane)           uint8_t lnx_cal_rxdcc_dll[2][3];
__xdata __at(PHY_MODE_LANE_BASE + caloft_rxdcc_dll_hg_rate0_lane)        uint8_t lnx_cal_rxdcc_dll_hg[3];
...
__xdata __at(PHY_MODE_LANE_BASE + caloft_dll_gmsel_rate0_lane)           uint8_t lnx_cal_dll_gmsel[3];
__xdata __at(PHY_MODE_LANE_BASE + caloft_vdda_dll_sel_rate0_lane)        uint8_t lnx_cal_vdda_dll_sel[2][3];
__xdata __at(PHY_MODE_LANE_BASE + caloft_dll_eom_gmsel_rate0_lane)       uint8_t lnx_cal_dll_eom_gmsel[3];
__xdata __at(PHY_MODE_LANE_BASE + caloft_vdda_dll_eom_sel_rate0_lane)    uint8_t lnx_cal_vdda_dll_eom_sel[2][3];
__xdata __at(PHY_MODE_LANE_BASE + caloft_eom_dpher_rate0_lane)           uint8_t lnx_cal_eom_dpher[3];
__xdata __at(PHY_MODE_LANE_BASE + caloft_align90_cmp_offset_rate0_div0_lane)   uint8_t lnx_cal_align90_cmp_offset[2][3][2];
__xdata __at(PHY_MODE_LANE_BASE + caloft_align90_dummy_clk_rate0_div0_lane)   uint8_t lnx_cal_align90_dummy_clk[2][3][2];
__xdata __at(PHY_MODE_LANE_BASE + caloft_align90_dac_rate0_div0_lane)         uint8_t lnx_cal_align90_dac[2][3][2];
__xdata __at(PHY_MODE_LANE_BASE + caloft_align90_gm_rate0_div0_lane)          uint8_t lnx_cal_align90_gm[2][3][2];
...
typedef struct {
	...
	uint8_t f1_ofst_adj_en							: 1;
	uint8_t dfe_adapt_even_en_lane					: 1;
	uint8_t dfe_adapt_odd_en_lane					: 1;
	uint8_t dfe_even_odd_sim_adapt_lane				: 1;
	uint8_t dfe_stop_en								: 1;
	uint8_t dfe_sat_en_back							: 1;
	uint8_t rsv12									: 1;
	...
	uint8_t res2_e									: 4;	
	//uint8_t rsv1            						: 8;
	//uint8_t ssc_step            					: 11; //28G X4 R2P1 Only
	//uint8_t rsv3									: 5;	
} train_save_tb_t; 
