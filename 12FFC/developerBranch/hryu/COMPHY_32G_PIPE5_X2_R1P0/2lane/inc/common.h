...
// phy register list
//#include "phy_reg_c_ana_trx_top_rpll_lane.h"
...
#define PHY_CHECK_LANE0			cmx_MCU_STATUS0_LANE0_31_0_b2
#define PHY_CHECK_LANE1			cmx_MCU_STATUS0_LANE1_31_0_b2
#define PHY_CHECK_LANE0_READ		cmx_MCU_STATUS0_LANE0_31_0_b2
#define PHY_CHECK_LANE1_READ		cmx_MCU_STATUS0_LANE1_31_0_b2
...
#define FAST_POWER_ON_EN		cmx_FAST_POWER_ON_EN 
...
//#define SIMENV_ON			(cmx_BYPASS_DELAY_2_0 || cmx_BYPASS_POWER_ON_DELAY || cmx_BYPASS_XDAT_INIT || cmx_BYPASS_SPEED_TABLE_LOAD || cmx_EXT_FORCE_CAL_DONE)
#define SIMENV_ON			(BYPASS_DELAY || BYPASS_POWERON_DELAY || BYPASS_XDAT_INIT || BYPASS_SPDTBL_LOAD || FORCE_EXIT_CAL)
...
// --
//master control
#define SYNC_REQUEST_LANE		cmx_MCU_COMMAND_ALL0_LANE_31_0_b0  //reg_SET_MCU_COMMAND_ALL0_LANE_31_0_b0
#define SYNC_STATUS_LANE0_READ		cmx_MCU_STATUS1_LANE0_31_0_b0
#define SYNC_STATUS_LANE1_READ		cmx_MCU_STATUS1_LANE1_31_0_b0
#define SYNC_STATUS_LANE2_READ		cmx_MCU_STATUS1_LANE2_31_0_b0
#define SYNC_STATUS_LANE3_READ		cmx_MCU_STATUS1_LANE3_31_0_b0
#define SYNC_STATUS_AND			reg_MCU_STATUS1_AND_31_0_b0
#define SYNC_STATUS_OR			reg_MCU_STATUS1_OR_31_0_b0
#define SYNC_STATUS_LANE0_EN_READ	cmx_MCU_STATUS1_LANE0_31_0_b2
#define SYNC_STATUS_LANE1_EN_READ	cmx_MCU_STATUS1_LANE1_31_0_b2
#define SYNC_STATUS_LANE2_EN_READ	cmx_MCU_STATUS1_LANE2_31_0_b2
#define SYNC_STATUS_LANE3_EN_READ	cmx_MCU_STATUS1_LANE3_31_0_b2
#define SYNC_SATUS_PLL_OR_PLL_OFF	cmx_MCU_COMMAND_ALL0_LANE_31_0_b1  //reg_SET_MCU_COMMAND_ALL0_LANE_31_0_b1
#define SYNC_SATUS_P2_2_P1_ON  		cmx_MCU_COMMAND_ALL0_LANE_31_0_b2  //reg_SET_MCU_COMMAND_ALL0_LANE_31_0_b2

//slave control
#define SYNC_STATUS_LANE		reg_MCU_STATUS1_LANE_31_0_b0
#define SYNC_STATUS_LANE0		cmx_MCU_STATUS1_LANE0_31_0_b0
#define SYNC_STATUS_LANE1		cmx_MCU_STATUS1_LANE1_31_0_b0
#define SYNC_STATUS_LANE2		cmx_MCU_STATUS1_LANE2_31_0_b0
#define SYNC_STATUS_LANE3		cmx_MCU_STATUS1_LANE3_31_0_b0

#define SYNC_REQEST_LANE_READ		cmx_MCU_COMMAND_ALL0_LANE_31_0_b0  //reg_MCU_COMMAND_ALL0_LANE_31_0_b0

#define SYNC_STATUS_LANE_EN		reg_MCU_STATUS1_LANE_31_0_b2
#define SYNC_STATUS_LANE0_EN		cmx_MCU_STATUS1_LANE0_31_0_b2
#define SYNC_STATUS_LANE1_EN		cmx_MCU_STATUS1_LANE1_31_0_b2
#define SYNC_STATUS_LANE2_EN		cmx_MCU_STATUS1_LANE2_31_0_b2
#define SYNC_STATUS_LANE3_EN		cmx_MCU_STATUS1_LANE3_31_0_b2

#define SYNC_SATUS_PLL_OR_PLL_OFF_READ  cmx_MCU_COMMAND_ALL0_LANE_31_0_b1
#define SYNC_SATUS_P2_2_P1_ON_READ	cmx_MCU_COMMAND_ALL0_LANE_31_0_b2  //reg_MCU_COMMAND_ALL0_LANE_31_0_b2
...
*****************************************/
	...
	void delay01_rom(int16_t t) BANKING_CTRL;
	void delay(int16_t a) BANKING_CTRL;
	void short_delay(void) BANKING_CTRL;
	void short_delay_ram(void) BANKING_CTRL;
	void short_delay_0(void) BANKING_CTRL;
	void short_delay_0_ram(void) BANKING_CTRL;
...
#define timeout_stop2    { T2CON=0x60; TF2=0; }
	...
	int8_t clamp_ram(int8_t a, int8_t ub, int8_t db) BANKING_CTRL;
	uint8_t clamp_u8(uint8_t a, uint8_t ub, uint8_t db) BANKING_CTRL;
	uint8_t clamp_u8_ram(uint8_t a, uint8_t ub, uint8_t db) BANKING_CTRL;
	int16_t clamp16(int16_t a, int16_t ub, int16_t db) BANKING_CTRL;
	int16_t clamp16_ram(int16_t a, int16_t ub, int16_t db) BANKING_CTRL;
	int8_t abs(int8_t a) BANKING_CTRL;
	int8_t abs_ram(int8_t a) BANKING_CTRL;
	int16_t abs16(int16_t a) BANKING_CTRL;
	int16_t abs16_ram(int16_t a) BANKING_CTRL;
	void memcpy(uint8_t *des, uint8_t *src, int n) BANKING_CTRL;
	void memcpy_ram(uint8_t *des, uint8_t *src, int n) BANKING_CTRL;
	void memcpy_prom_to_xdat(uint32_t des, uint32_t src, uint16_t n) BANKING_CTRL;
	void memcpy_prom_to_xdat_ram(uint32_t des, uint32_t src, uint16_t n) BANKING_CTRL;
	void memset0(uint8_t *dest, int n) BANKING_CTRL;
	void memset0_ram(uint8_t *dest, int n) BANKING_CTRL;
	uint8_t sign_abs_up(uint8_t dcc_cnt) BANKING_CTRL;
	uint8_t sign_abs_up_ram(uint8_t dcc_cnt) BANKING_CTRL;
	uint8_t sign_abs_dn(uint8_t dcc_cnt) BANKING_CTRL;
	uint8_t sign_abs_dn_ram(uint8_t dcc_cnt) BANKING_CTRL;
	...
	BIT is_num_toggle_pat_ram( uint8_t val, uint8_t output_cnt, uint8_t target_toggles ) BANKING_CTRL;
	...
	BIT is_toggle_pat_ram( uint8_t val, uint8_t output_cnt ) BANKING_CTRL;
	...
	uint8_t conv_thermo_2_bi_ram(uint8_t val) BANKING_CTRL;
...
#define PowerUp_Seq_Simple() PowerUp_Seq_Test()
	...
	void pll_tempc_speed_adj_ram(void); // external RAM workaround
	...
	void plldcc_cal_ram(void); // external RAM workaround
	void plldcc_clk_toggle(void) BANKING_CTRL;
	//void plldcc_clk_toggle_ram(void) BANKING_CTRL;
	void plldcc_clk_toggle_ram(void);  // external RAM workaround
	void pll_cal(void) BANKING_CTRL;
	void do_fast_cal(uint8_t lccap_msb_index) BANKING_CTRL;
	...
	void pll_temp_force_idle_ram(void);  // external RAM workaround
	void pll_temp_jump_idle(void) BANKING_CTRL;
	//void pll_temp_jump_idle_ram(void) BANKING_CTRL;
	void pll_temp_jump_idle_ram(void); // external RAM workaround
	void pll_temp_cal(void) BANKING_CTRL;
	//void pll_temp_cal_ram(void) BANKING_CTRL;
	void pll_temp_cal_ram(void); // external RAM workaround
	...
	//void eom_align_cal_ram(void) BANKING_CTRL;
	void eom_align_cal_ram(void); // external RAM workaround
	...
	void dll_gm_vdda_cal(void) BANKING_CTRL;
	...
	// TODO - need to cleanup dcc calibration
	...
	void set_sampler_ram(int8_t val) BANKING_CTRL;
	int8_t get_sampler(void) BANKING_CTRL;
	int8_t get_sampler_ram(void) BANKING_CTRL;
	void sampler_sel(uint8_t sw) BANKING_CTRL;
	void sampler_sel_ram(uint8_t sw) BANKING_CTRL;
	void sampler_cal(void) BANKING_CTRL;
	void sampler_cal_ram(void) BANKING_CTRL;
	void sampler_cal_sel(uint8_t sw) BANKING_CTRL;
	void sampler_cal_sel_ram(uint8_t sw) BANKING_CTRL;
	...
	uint8_t toggle_impcal_out_req_ram(void); // external RAM workaround
	void tximp_cal(void) BANKING_CTRL;
	//void tximp_cal_ram(void) BANKING_CTRL;
	void tximp_cal_ram(void); // external RAM workaround
	void rximp_cal(void) BANKING_CTRL;
	//void rximp_cal_ram(void) BANKING_CTRL;
	void rximp_cal_ram(void); // external RAM workaround
	...
	//void proc_cal_ram(void); // external RAM workaround
	void squelch_cal(void) BANKING_CTRL;
	//void squelch_cal_ram(void) BANKING_CTRL;
	void squelch_cal_ram(void); // external RAM workaround
	bool vdd_cal_op (uint8_t sel) BANKING_CTRL;
	void all_cal_ext(void) BANKING_CTRL;
	void pu_ringpll_off(void) BANKING_CTRL;
	void pu_ringpll_off_ram(void) BANKING_CTRL;
	void pu_lcpll_off(void) BANKING_CTRL;
	void pu_lcpll_off_ram(void) BANKING_CTRL;
	void master_pu_pll_off(void) BANKING_CTRL;
	void master_pu_pll_off_ram(void) BANKING_CTRL;
	void pll_clk_ready_1(void) BANKING_CTRL;
	void pll_clk_ready_1_ram(void) BANKING_CTRL;
	void pll_clk_ready_ring_1(void) BANKING_CTRL;
	void pll_clk_ready_ring_1_ram(void) BANKING_CTRL;
	...
	void Edge_Sampler_Update_ram(void) BANKING_CTRL;
	void  save_sampler_edge(void) BANKING_CTRL;
	void  save_sampler_edge_ram(void) BANKING_CTRL;
	...
	//bool eom_comp_out_rd_ram(void) BANKING_CTRL;
	bool eom_comp_out_rd_ram(void); // external RAM workaround
	...
	void load_init_temp_table_ram(void); // external RAM workaround
	...
	void dfe_save_ram(void); // external RAM workaround
	void dfe_hardware_cont_run(void) BANKING_CTRL;
	//void dfe_hardware_cont_run_ram(void) BANKING_CTRL;
	void dfe_hardware_cont_run_ram(void);  // external RAM workaround
	void dfe_hardware_cont_stop(void) BANKING_CTRL;
	//void dfe_hardware_cont_stop_ram(void) BANKING_CTRL;
	void dfe_hardware_cont_stop_ram(void);  // external RAM workaround
	...
	void enable_all_tap_adapt_ram(void);  // external RAM workaround
	...
	void set_slicer_data_sampler_adapt_ram(bool flag);  // external RAM workaround
	...
	void dfe_load_type_ram(uint8_t type); // external RAM workaround
	...
	void dfe_fsm_ram(uint16_t lpnum, uint8_t tap_en); // external RAM workaround
	void set_ph_mode(void) BANKING_CTRL;
	//void set_ph_mode_ram(void) BANKING_CTRL;
	void set_ph_mode_ram(void); // external RAM workaround
	...
	void set_ctle_accap_ram(uint8_t mode);  // external RAM workaround
	void cds_load_f0(uint8_t type) BANKING_CTRL;
	//void cds_load_f0_ram(uint8_t type) BANKING_CTRL;
	void cds_load_f0_ram(uint8_t type); // external RAM workaround
	uint8_t ofst_2ctosm(int8_t ofst) BANKING_CTRL;
	//uint8_t ofst_2ctosm_ram(int8_t ofst) BANKING_CTRL;
	uint8_t ofst_2ctosm_ram(int8_t ofst);  // external RAM workaround
	void dc_load(uint8_t type) BANKING_CTRL;
	//void dc_load_ram(uint8_t type) BANKING_CTRL;
	void dc_load_ram(uint8_t type);  // external RAM workaround
	void set_esm_voltage(uint8_t v) BANKING_CTRL;
	//void set_esm_voltage_ram(uint8_t v) BANKING_CTRL;
	void set_esm_voltage_ram(uint8_t v); // external RAM workaround
	uint8_t get_ec_voltage(void) BANKING_CTRL;
	bool check_eye(void) BANKING_CTRL;
	//bool check_eye_ram(void) BANKING_CTRL;
	bool check_eye_ram(void); // external RAM workaround
	...
	uint32_t maxu32_ram(uint32_t a, uint32_t b); // external RAM workaround

	void cds_save(uint8_t type) BANKING_CTRL;
	//void cds_save_ram(uint8_t type) BANKING_CTRL;
	void cds_save_ram(uint8_t type); // external RAM workaround
	void set_dfe_fbmd(uint8_t type) BANKING_CTRL;
	//void set_dfe_fbmd_ram(uint8_t type) BANKING_CTRL;
	void set_dfe_fbmd_ram(uint8_t type);  // external RAM workaround
	...
	void cdr_phase_opt_end(void) BANKING_CTRL;
	void cdr_phase_maxf0p(void) BANKING_CTRL;
	void check_cdr_status(void) BANKING_CTRL;
	...
	void cal_half_code_ram(void);  // external RAM workaround
	void opt2train(void);
	void train2opt(void);
	void update_opt_trx_ffe(void);
	void trx_train_init(void);
	void trx_train_control(void);
	void update_dfe_res(void);
	void trx_train_end(void);
	...
	void RX_FFE_Comparision(void);
	void set_train(void);
	void ffe_res_temp_adjust(void);
	void ffe_res_short_channel_adjust(void);
	...
	//void compare_gn1(void);
	//void compare_g1(void);
	void compare_g1n1(uint8_t X);
	void compare_tx_preset(void);
	...
	void run_tx_ffe_preset( uint8_t inx) BANKING_CTRL;
	...
	uint8_t remote_error_check(void) BANKING_CTRL;

	// -- tx train if
	void train_if_init(void);
	void set_train_comp(void);
	void set_remote_tx_pam2(void);
	void set_remote_tx(void);
	...
	uint8_t cmd_bypass_ctle_train(uint8_t cmd_code) CMD_BANK;
