...
typedef union {
	struct {
		...
		uint8_t RX_SEL_BITS_FORCE_LANE                   : 1;	/*     30     r/w   0*/
...
#define reg_RX_SEL_BITS_FORCE_LANE  RX_SYSTEM_LANE.BF.RX_SEL_BITS_FORCE_LANE
...
typedef union {
	struct {
		...
		uint8_t RX_PRESET_HINT_FM_REG_LANE               : 1;	/*      2     r/w   0*/
		uint8_t RX_PRESET_HINT_LANE_2_0                  : 3;	/*  [5:3]     r/w 3'h0*/
...
#define reg_RX_PRESET_HINT_LANE_2_0  INPUT_RX_PIN_REG0_LANE.BF.RX_PRESET_HINT_LANE_2_0
...
typedef union {
	struct {
		...
		uint8_t RESERVED_2                               : 1;	/*      2     r/w   0*/
		uint8_t RESERVED_3                               : 1;	/*      3     r/w   0*/
		uint8_t PACKET_SYNC_CHAR_SEL_LANE_1_0            : 2;	/*  [5:4]     r/w   0*/
		uint8_t PACKET_SYNC_DIS_LANE                     : 1;	/*      6     r/w   1*/
		uint8_t SYNC_DET_DIS_LANE                        : 1;	/*      7     r/w   0*/
		uint8_t PACKET_FOUND_LANE                        : 1;	/*      8       r   0*/
		uint8_t FRAME_LOCK_LANE                          : 1;	/*      9       r   0*/
		uint8_t FRAME_FOUND_LANE                         : 1;	/*     10       r   0*/
		uint8_t SYNC_FOUND_LANE                          : 1;	/*     11       r   0*/
		uint8_t WORD_FOUND_LANE                          : 1;	/*     12       r   0*/
		uint8_t ALIGN_STAT_RD_REQ_LANE                   : 1;	/*     13     r/w   0*/
		uint8_t FRAME_DET_MODE_LANE                      : 1;	/*     14     r/w   0*/
		uint8_t FRAME_REALIGN_MODE_LANE                  : 1;	/*     15     r/w   1*/
		uint8_t FRAME_END_SEL_LANE                       : 1;	/*     16     r/w   1*/
		uint8_t TRAIN_PAT_NUM_LANE_8_0_b0                : 7;	/*[25:17]     r/w 9'h42*/
		uint8_t TRAIN_PAT_NUM_LANE_8_0_b1                : 2;	/*[25:17]     r/w 9'h42*/
...
typedef union {
	struct {
		...
		uint8_t DTL_CLAMPING_SEL_LANE_2_0                : 3;	/*[26:24]     r/w 3'h7*/
