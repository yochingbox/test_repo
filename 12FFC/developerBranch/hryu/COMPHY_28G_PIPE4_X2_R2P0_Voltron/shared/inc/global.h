...
extern __xdata bool pre_sq_rd, save_pu_f1p_s_o, save_pu_f1p_s_e, save_dfe_adapt_e_en, save_dfe_adapt_o_en; //eom save
...
extern __xdata uint16_t save_local_ctrl, save_local_status;
...
extern __xdata bool tx_align_on/*, spdchg_on*/, llpnum, rx_init_done, bypass_ctle_train_on;
extern __xdata uint8_t dfe_stop;
extern __xdata uint8_t cont_cal_inx, P1_cont_cal, dfe_sm_dc_e_e, dfe_sm_dc_e_o;
extern __xdata uint8_t pre_phy_gen;
...
__xdata __at(PHY_MODE_LANE_BASE + spdoft_tx_preset_index_lane)       	 uint8_t lnx_spdoft_tx_preset_index_lane;
