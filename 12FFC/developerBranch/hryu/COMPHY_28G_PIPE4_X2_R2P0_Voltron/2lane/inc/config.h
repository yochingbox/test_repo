...
//#define SUPPORT_CONT_CAL_L1 //for pcie
//#define SUPPORT_CONT_CAL_RXINIT //for pcie
//#define SUPPORT_L1EXT_W_DTX 
//#define SUPPORT_L1EXT_RXFOFFS
#endif 
...
//#define SUPPORT_RX_INIT_USE_CDS
	...
	#define SUPPORT_PHASE_TRAIN	
		...
		#define SUPPORT_SAS_LC_ONLY
	#else	
		#define SUPPORT_ETHERNET_SEL_BIT_CTRL	
		#define SUPPORT_X2_RING_LANE_2
		#define SUPPORT_RINGPLL_INITCAL_ONLY //replace ringpll_cal, not doing ring_pll_fast_cal
		//#define SUPPORT_CROSS_TALK_WA
	#endif
#endif	
//#define SUPPORT_CMD_IF
#define SUPPORT_CHECK_NORMAL_F0D
//#define SUPPORT_ERROR_TTIU_TEST
//#define LCPLL_DUMP_DEBUG
#define SUPPORT_TXDCC_PDIV_PATCH
