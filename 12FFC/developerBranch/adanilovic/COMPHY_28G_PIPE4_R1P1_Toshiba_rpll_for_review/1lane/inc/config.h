...
//#define SUPPORT_RX_INIT_USE_CDS
    ...
    #define SUPPORT_SAS_RPLL_ONLY
    #define SUPPORT_SAS_EOM_POWERSAVING	
    #define SUPPORT_DFE_POWERSAVING 1
	//#define SUPPORT_ANA_POWERSAVING 1 

    #if defined(SUPPORT_SAS_LC_ONLY) && defined(SUPPORT_SAS_RPLL_ONLY)
        #error "Only define SUPPORT_SAS_LC_ONLY or SUPPORT_SAS_RPLL_ONLY, not both"
    #endif
...
#ifdef SUPPORT_SAS_LC_ONLY
    #define LCPLL_ENABLED
#else
    #ifdef SUPPORT_SAS_RPLL_ONLY
        #define RPLL_ENABLED
    #else
        #define LCPLL_ENABLED
        #define RPLL_ENABLED
