...
//help Xu to add code to save and restore these regs
  uint8_t saved_bypass_en = reg_RX_ALIGN90_DD_CAL_BYPASS_EN_LANE|
	  reg_RX_ALIGN90_DE_CAL_BYPASS_EN_LANE<<1|
	  reg_RX_DCC1_CAL_BYPASS_EN_LANE<<2|
	  reg_RX_DCC2_CAL_BYPASS_EN_LANE<<3|
	  reg_RX_DCC3_CAL_BYPASS_EN_LANE<<4|
	  reg_RX_DCC4_CAL_BYPASS_EN_LANE<<5|
	  reg_RX_DCC5_CAL_BYPASS_EN_LANE<<6;
...
//wait for align90ee accumulating cycle finish and read result
  ...
  //reg_ALIGN90EE_ACC_CYCLE_CNT_LANE_15_0_b1 += 4; //remove workaround
...
//help Xu to add code to save and restore these regs
  ...
  reg_RX_DCC1_CAL_BYPASS_EN_LANE = saved_bypass_en>>2&0x1;
  reg_RX_DCC2_CAL_BYPASS_EN_LANE = saved_bypass_en>>3&0x1;
  reg_RX_DCC3_CAL_BYPASS_EN_LANE = saved_bypass_en>>4&0x1;
  reg_RX_DCC4_CAL_BYPASS_EN_LANE = saved_bypass_en>>5&0x1;
  reg_RX_DCC5_CAL_BYPASS_EN_LANE = saved_bypass_en>>6&0x1;
//end help Xu to add code to save and restore these regs
