...
BIT ctrl_rx_train_done, ctrl_tx_train_done, ctrl_trx_train_done_;
BIT gain_train_with_c, ctrl_trx_ffe_updated;
BIT tx_pipe4_en;
BIT train_short_mode;
//--------------------------------------
...
__xdata volatile uint32_t perf_test__a_32_bit_xdata;
__xdata volatile uint32_t perf_test__b_32_bit_xdata;
__xdata volatile uint32_t perf_test__c_32_bit_xdata;
__xdata volatile float    perf_test__a_float_xdata;
__xdata volatile float    perf_test__b_float_xdata;
__xdata volatile float    perf_test__c_float_xdata;
__xdata volatile uint8_t  perf_test__data_block1_xdata[8];
__xdata volatile uint8_t  perf_test__data_block2_xdata[8];
...
__xdata uint16_t pre_local_ctrl, save_local_status;
...
__xdata int8_t current_EOM_phase_offset = 0;
...
//==========================================================
// Please add new variable here

__xdata uint8_t rm_stat, error_code, c0, c1, cn1, ce, single_arg;
__xdata	volatile uint8_t remote_ctrl_h, remote_ctrl_l;
__xdata	volatile uint8_t remote_status_h, remote_status_l;
__xdata	volatile uint16_t remote_ctrl_16, remote_status_16;
__xdata volatile bool remote_status_in;

__xdata bool tx_align_on, llpnum, rx_init_done, bypass_ctle_train_on;
__xdata	uint16_t save_adapt_lpnum;
//__xdata uint8_t dfe_stop;
__xdata uint8_t cont_cal_inx, dfe_sm_dc_e_e, dfe_sm_dc_e_o;
bool co_valid; 


#if SUPPORT_DFE_POWERSAVING 
__xdata SAVE_REG_STATE_DFE_OFF_t SAVE_REG_STATE_DFE_OFF;
__xdata bool dfe_power_saving_dfe_off_flag=1;
__xdata bool dfe_power_saving_temp_change_flag=0;
__xdata uint16_t dfe_power_saving_counter=0;
__xdata uint16_t dfe_power_saving_temp_old=0;

//__xdata bool power_saving_timer_on = 0;
//__xdata bool power_saving_timeout = 0;
#endif
