...
extern __xdata volatile uint32_t perf_test__a_32_bit_xdata;
extern __xdata volatile uint32_t perf_test__b_32_bit_xdata;
extern __xdata volatile uint32_t perf_test__c_32_bit_xdata;
extern __xdata volatile float    perf_test__a_float_xdata;
extern __xdata volatile float    perf_test__b_float_xdata;
extern __xdata volatile float    perf_test__c_float_xdata;
extern __xdata volatile uint8_t  perf_test__data_block1_xdata[8];
extern __xdata volatile uint8_t  perf_test__data_block2_xdata[8];
