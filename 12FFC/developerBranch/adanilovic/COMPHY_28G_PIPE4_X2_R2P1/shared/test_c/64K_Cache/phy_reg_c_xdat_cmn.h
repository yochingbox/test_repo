...
typedef union {
	struct {
		uint8_t CAL_DONE                                 : 1;	/*      0     r/w   0*/
		uint8_t CAL_START                                : 1;	/*      1     r/w   0*/
		uint8_t PLL_CAL_DONE                             : 1;	/*      2     r/w   0*/
		uint8_t PLL_TEMP_CAL_DONE                        : 1;	/*      3     r/w   0*/
		uint8_t PLL_AMP_CAL_DONE                         : 1;	/*      4     r/w   0*/
		uint8_t PLL_CAL_PASS                             : 1;	/*      5     r/w   0*/
		uint8_t PLL_TEMP_CAL_PASS                        : 1;	/*      6     r/w   0*/
		uint8_t PLL_AMP_CAL_PASS                         : 1;	/*      7     r/w   0*/
		uint8_t PROCESS_CAL_PASS                         : 1;	/*      8     r/w   0*/
		uint8_t PROCESS_CAL_DONE                         : 1;	/*      9     r/w   0*/
		uint8_t PLLDCC_CAL_PASS                          : 1;	/*     10     r/w   0*/
		uint8_t PLLDCC_CAL_DONE                          : 1;	/*     11     r/w   0*/
		uint8_t PLL_CAL_RING_PASS                        : 1;	/*     12     r/w   0*/
		uint8_t PLL_CAL_RING_DONE                        : 1;	/*     13     r/w   0*/
		uint8_t RING_PLL_CAL_EN                          : 1;	/*     14     r/w   0*/
		uint8_t PLLDCC_CAL_EN                            : 1;	/*     15     r/w   0*/
		uint8_t PLL_CAL_EN                               : 1;	/*     16     r/w   0*/
		uint8_t PLL_TEMP_CAL_EN                          : 1;	/*     17     r/w   0*/
		uint8_t DLL_CAL_EN                               : 1;	/*     18     r/w   0*/
		uint8_t TXDETECT_CAL_EN                          : 1;	/*     19     r/w   0*/
		uint8_t RXDCC_DLL_CAL_EN                         : 1;	/*     20     r/w   0*/
		uint8_t RXDCC_C_CAL_EN                           : 1;	/*     21     r/w   0*/
		uint8_t RXDCC_EOM_CAL_EN                         : 1;	/*     22     r/w   0*/
		uint8_t RXALIGN90_CAL_EN                         : 1;	/*     23     r/w   0*/
		uint8_t EOM_ALIGN_CAL_EN                         : 1;	/*     24     r/w   0*/
		uint8_t SAMPLER_CAL_EN                           : 1;	/*     25     r/w   0*/
		uint8_t TXIMP_CAL_EN                             : 1;	/*     26     r/w   0*/
		uint8_t RXIMP_CAL_EN                             : 1;	/*     27     r/w   0*/
		uint8_t VDD_CAL_EN                               : 1;	/*     28     r/w   0*/
		uint8_t TXDCC_CAL_EN                             : 1;	/*     29     r/w   0*/
		uint8_t PROCESS_CAL_EN                           : 1;	/*     30     r/w   0*/
		uint8_t SQ_CAL_EN                                : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CONTROL_CONFIG1_t;
...
typedef union {
	struct {
		...
		uint8_t ALIGN90_SOFT_LOOKUP_EN                   : 1;	/*     27     r/w   0*/
		uint8_t FORCE_CONT_CAL_SKIP                      : 1;	/*     28     r/w   0*/
		uint8_t TXDCC_PDIV_CAL_EN                        : 1;	/*     29     r/w   0*/
...
#define cmx_ALIGN90_SOFT_LOOKUP_EN  CONTROL_CONFIG2.BF.ALIGN90_SOFT_LOOKUP_EN
...
typedef union {
	struct {
		...
		uint8_t VCOAMP_VTH_NORMAL_7_0                    : 8;	/* [15:8]     r/w 8'h0*/
		uint8_t VCOAMP_VTH_AMP_7_0                       : 8;	/*[23:16]     r/w 8'h0*/
		uint8_t VCOAMP_VTH_FREQ_7_0                      : 8;	/*[31:24]     r/w 8'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CONTROL_CONFIG3_t;
...
typedef union {
	struct {
		...
		uint8_t PLLDCC_CAL_CONT_EN                       : 1;	/*     29     r/w 1'h0*/
		uint8_t PLLAMP_CAL_CONT_EN                       : 1;	/*     30     r/w 1'h0*/
...
typedef union {
	struct {
		uint8_t CAL_PROC_TT2FF_7_0                       : 8;	/*  [7:0]     r/w 8'h0*/
		uint8_t CAL_PROC_SS2TT_7_0                       : 8;	/* [15:8]     r/w 8'h0*/
		uint8_t CAL_PROC_SUBSS_7_0                       : 8;	/*[23:16]     r/w 8'h0*/
		uint8_t CAL_SQ_THRESH_IN_7_0                     : 8;	/*[31:24]     r/w 8'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CONTROL_CONFIG7_t;
...
typedef union {
	struct {
		...
		uint8_t CAL_PROCESS_VALUE_7_0                    : 8;	/*[23:16]     r/w 8'h0*/
...
#define cmx_CAL_PROCESS_VALUE_7_0  CAL_DATA1.BF.CAL_PROCESS_VALUE_7_0
