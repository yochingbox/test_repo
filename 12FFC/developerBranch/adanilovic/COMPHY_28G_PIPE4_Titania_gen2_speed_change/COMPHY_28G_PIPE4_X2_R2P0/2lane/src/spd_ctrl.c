...
void SpeedChange(){
  ...
  if((new_gen_tx != gen_tx || new_gen_rx != gen_rx) && phy_mode!=SERDES ){
	...
	{	
        ...
        reg_MCU_DEBUG2_LANE_7_0 = lc_pll_used;          //1
        reg_MCU_DEBUG3_LANE_7_0 = gen_pll_rate;         //1
        reg_MCU_DEBUG4_LANE_7_0 = max_gen;              //3
        reg_MCU_DEBUG5_LANE_7_0 = ring_pll_enabled;     //1
        reg_MCU_DEBUG6_LANE_7_0 = use_ring_pll;         //1
        reg_MCU_DEBUG7_LANE_7_0 = tx_pll_rate;          //1
        reg_MCU_DEBUG8_LANE_7_0 = ring_lane_sel;        //1
        reg_MCU_DEBUG9_LANE_7_0 = serdes_ring_lane_en;  //0
        reg_MCU_DEBUGA_LANE_7_0 = master_mcu;           //0
        reg_MCU_DEBUGC_LANE_7_0 = gen_tx;               //0
