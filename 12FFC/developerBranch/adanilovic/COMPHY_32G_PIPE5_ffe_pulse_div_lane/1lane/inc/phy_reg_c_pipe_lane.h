...
typedef union {
	struct {
		...
		uint8_t MAC_PHY_TXCMN_MODE_DIS_LANE              : 1;	/*      9       r   0*/
		uint8_t MAC_PHY_RXEIDETECT_DIS_LANE              : 1;	/*     10       r   0*/
		uint8_t PIPE_CLK_ACK_N_LANE                      : 1;	/*     11       r   0*/
		uint8_t PIPE_CLK_REQ_N_LANE                      : 1;	/*     12       r   0*/
		uint8_t MAC_PHY_ASYNCPWRCHGACK_LANE              : 1;	/*     13       r   0*/
		uint8_t MAC_PHY_POWERDOWN_LANE_3_2               : 2;	/*[15:14]       r   0*/
...
#define reg_MAC_PHY_TXCMN_MODE_DIS_LANE  LANE_DP_PIE8_CFG0_LANE.BF.MAC_PHY_TXCMN_MODE_DIS_LANE
#define reg_MAC_PHY_RXEIDETECT_DIS_LANE  LANE_DP_PIE8_CFG0_LANE.BF.MAC_PHY_RXEIDETECT_DIS_LANE
...
__xdata __at( 0x40a8 ) volatile LANE_MARGIN_CTRL_STAT_LANE_t LANE_MARGIN_CTRL_STAT_LANE;
