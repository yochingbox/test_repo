...
void cdr_phase_opt(void)
{
	...
	//DBG_PS("\r\n++(cdr_phase_opt) ");
	#endif
lnx_TRAIN_DEBUG4_LANE_7_0 = 0x52;	
...
*/
	...
	cdr_phase_opt_init();
lnx_TRAIN_DEBUG4_LANE_7_0 = 0x53;
#if (tag_CDR_MAXF0P_EN)  //1
	cdr_phase_maxf0p(); 
#endif	
lnx_TRAIN_DEBUG4_LANE_7_0 = 0x54;
if (tag_CDR_MIDPOINT_EN)  //1
	cdr_phase_midpoint(); 
//#endif	
lnx_TRAIN_DEBUG4_LANE_7_0 = 0x55;
    cdr_phase_opt_final_processing();
	
lnx_TRAIN_DEBUG4_LANE_7_0 = 0x56;
}
