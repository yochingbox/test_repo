...
skip_out:
	...
	reg_EOM_CLK_EN_LANE = 0;	//hayabusa powersaving
#endif

}	

bool is_cal_cont_step_enabled(uint8_t step_enable) {
    return true;
}
...
void Cal_Cont(void) BANKING_CTRL {
	...
	//do {
        /*switch(cont_cal_inx) {*/
        /*case 0:*/
            /*if(is_cal_cont_step_enabled(cmx_READ_TSEN_EN)) {*/
                /*tsen_dat = read_tsen();*/
            /*}*/
                ...
                /*if( SYNC_LINE_HOLD_READ == SYNC_IDLE) {*/
                    ...
                    /*if( SYNC_LINE_HOLD_READ == mcuid ) {	*/
                        /*if(vdd_cnt==SELLV_TXDATA && cmx_TXDETECT_CAL_CONT_EN && reg_PIN_PLL_READY_TX_LANE)	*/
                            /*txdetect_cal();*/
                        /*else {*/
                            /*if((vdd_cnt<SELLV_RXEOMCLK && reg_PIN_PU_TX_RD_LANE) ||*/
                               /*(vdd_cnt>SELLV_TXPRE && reg_PIN_PLL_READY_RX_LANE)) { //Skip t/rx cal when pu_px=0*/
                    
                                /*if(is_cal_cont_step_enabled(cmx_VDD_CAL_SEL_EN)) {*/
                                    /*vdd_cal_sel(vdd_cnt);*/
                                /*}*/
                            /*}*/
                        /*}	*/
        ...
        /*case 4:	if( cmx_EOM_DLL_CAL_CONT_EN && rx_init_done) */
            /*{*/
                /*#ifdef SUPPORT_SAS_EOM_POWERSAVING*/
                /*reg_EOM_CLK_EN_LANE = 1;	//hayabusa powersaving*/
        ...
        /*case 5:		*/
            ...
            /*case 0:*/
                /*if(rx_init_done) {*/
                    /*if(is_cal_cont_step_enabled(cmx_RXDCC_DLL_CAL_EN)) {*/
                        /*rxdcc_dll_cal();*/
                    /*}*/
                /*}*/
            ...
            /*case 1:*/
                ...
                /*if(rx_init_done) {*/
                    /*if(is_cal_cont_step_enabled(cmx_RXDCC_DATA_CAL_EN)) {*/
                        /*rxdcc_data_cal();*/
                    /*}*/
                /*}*/
            ...
            /*case 2:*/
                ...
                /*if(rx_init_done) {*/
                    /*if(is_cal_cont_step_enabled(cmx_RXDCC_EOM_CAL_EN)) {*/
                        /*rxdcc_eom_cal();*/
                    /*}*/
                /*}*/
            ...
            /*case 3: if(reg_PIN_PU_TX_RD_LANE) {*/
                        /*if((reg_TX_SPEED_DIV_LANE_2_0==0)) {*/
                            /*if(is_cal_cont_step_enabled(cmx_TXDCC_CAL_EN)) {*/
                                /*txdcc_cal();*/
                            /*}*/
                        /*}*/
                        /*else {*/
                            /*if(is_cal_cont_step_enabled(cmx_TXDCC_PDIV_CAL_EN)) {*/
                                /*txdcc_pdiv_cal_ram();*/
                            /*}*/
                        /*}*/
                    /*}	*/
...
*/
    ...
    //AD - go back to normal mode if speed change occurs in the middle of cont cal, try setting to 0
    //Setting this to 1 fixes an analog bug
    //When set to 1, the HW txdcccal pdiv calibration module will be enabled
    reg_TXDCCCAL_PDIV_EN_LANE = 1;  
