...
typedef union {
	struct {
		...
		uint8_t RXDCC_DLL_CAL_EN                         : 1;	/*      1     r/w   0*/
		...
		uint8_t RXDCC_DATA_CAL_EN                        : 1;	/*     28     r/w   0*/
		uint8_t RXDCC_EOM_CAL_EN                         : 1;	/*     29     r/w   0*/
		uint8_t TXDCC_CAL_EN                             : 1;	/*     30     r/w   0*/
		uint8_t VDD_CAL_SEL_EN                           : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CONTROL_CONFIG1_t;
...
#define cmx_RXDCC_DATA_CAL_EN  CONTROL_CONFIG1.BF.RXDCC_DATA_CAL_EN
#define cmx_RXDCC_EOM_CAL_EN   CONTROL_CONFIG1.BF.RXDCC_EOM_CAL_EN 
#define cmx_TXDCC_CAL_EN       CONTROL_CONFIG1.BF.TXDCC_CAL_EN     
#define cmx_VDD_CAL_SEL_EN     CONTROL_CONFIG1.BF.VDD_CAL_SEL_EN     

// 0x060c	CONTROL_CONFIG2		Calibration Configuration 1
typedef union {
	struct {
		uint8_t TXDCC_PDIV_CAL_EN                        : 1;	/*      0     r/w   0*/
		uint8_t READ_TSEN_EN                             : 1;	/*      1     r/w   0*/
		uint8_t CALIBRATION_DISABLE_FLAG_ENABLE          : 1;	/*      2     r/w   0*/
...
#define cmx_READ_TSEN_EN  CONTROL_CONFIG2.BF.READ_TSEN_EN
#define cmx_CALIBRATION_DISABLE_FLAG_ENABLE  CONTROL_CONFIG2.BF.CALIBRATION_DISABLE_FLAG_ENABLE
