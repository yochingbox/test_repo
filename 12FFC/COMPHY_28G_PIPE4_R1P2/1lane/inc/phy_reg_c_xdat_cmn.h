...
typedef union {
	struct {
		...
		uint8_t BYPASS_PU_RX_P1                          : 1;	/*      3     r/w   0*/
		uint8_t TX_LANE_ALIGN_OFF                        : 1;	/*      4     r/w   0*/
		uint8_t APTA_LIMITED_STATUS_DIS                  : 1;	/*      5     r/w   0*/
...
#define cmx_BYPASS_PU_RX_P1  CONTROL_CONFIG0.BF.BYPASS_PU_RX_P1
#define cmx_TX_LANE_ALIGN_OFF  CONTROL_CONFIG0.BF.TX_LANE_ALIGN_OFF
#define cmx_APTA_LIMITED_STATUS_DIS  CONTROL_CONFIG0.BF.APTA_LIMITED_STATUS_DIS
...
typedef union {
	struct {
		uint8_t RINGPLL_USE_ONLY                         : 1;	/*      0     r/w   0*/
		uint8_t RESERVED_1                               : 1;	/*      1     r/w   0*/
...
#define cmx_RINGPLL_USE_ONLY  CONTROL_CONFIG2.BF.RINGPLL_USE_ONLY
...
typedef union {
	struct {
		...
		uint8_t TRAIN_SIM_ERR_MODE_1_0                   : 2;	/*[31:30]     r/w 2'b0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CONTROL_CONFIG3_t;
...
#define cmx_TRAIN_SIM_ERR_MODE_1_0  CONTROL_CONFIG3.BF.TRAIN_SIM_ERR_MODE_1_0
...
typedef union {
	struct {
		...
		uint8_t TX_EO_STOP_THRES_7_0                     : 8;	/*[23:16]     r/w 8'h8*/
		...
		uint8_t BYPASS_P4_JUMP_G1_TRAIN_GEN3             : 1;	/*     30     r/w   1*/
		uint8_t FFE_RES_R0_ADJ_EN                        : 1;	/*     31     r/w   1*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TRAIN_IF_CONFIG_t;
...
#define cmx_TX_EO_STOP_THRES_7_0  TRAIN_IF_CONFIG.BF.TX_EO_STOP_THRES_7_0
...
typedef union {
	struct {
		...
		uint8_t RESERVED_4                               : 1;	/*      4     r/w   0*/
		uint8_t RESERVED_5                               : 1;	/*      5     r/w   0*/
		uint8_t SUMF_BOOST_TARGET_K_FORCE_EN_PCIE_GEN3   : 1;	/*      6     r/w   0*/
		uint8_t SUMF_BOOST_TARGET_K_FORCE_EN_PCIE_GEN4   : 1;	/*      7     r/w   0*/
		uint8_t SUMF_BOOST_TARGET_C_FORCE_EN_PCIE_GEN3   : 1;	/*      8     r/w   0*/
		uint8_t SUMF_BOOST_TARGET_C_FORCE_EN_PCIE_GEN4   : 1;	/*      9     r/w   0*/
		uint8_t RESERVED_10                              : 1;	/*     10     r/w   0*/
		uint8_t EOM_ALG_MODE                             : 1;	/*     11     r/w   1*/
		uint8_t EOM_POWERSAVING_EN                       : 1;	/*     12     r/w   0*/
		uint8_t SKIP_LCPLL_LOCK_CHECK                    : 1;	/*     13     r/w   0*/
		uint8_t FORCE_LCPLL_SHRTR_1                      : 1;	/*     14     r/w   0*/
		uint8_t DFE_POWERSAVING_EN                       : 1;	/*     15     r/w   0*/
		uint8_t AUTO_RX_INIT_EN                          : 1;	/*     16     r/w   0*/
		uint8_t PCIE_G1_OPT_TRAIN_EN_GEN3                : 1;	/*     17     r/w   1*/
...
#define cmx_SUMF_BOOST_TARGET_K_FORCE_EN_PCIE_GEN3  CONTROL_CONFIG8.BF.SUMF_BOOST_TARGET_K_FORCE_EN_PCIE_GEN3
#define cmx_SUMF_BOOST_TARGET_K_FORCE_EN_PCIE_GEN4  CONTROL_CONFIG8.BF.SUMF_BOOST_TARGET_K_FORCE_EN_PCIE_GEN4
#define cmx_SUMF_BOOST_TARGET_C_FORCE_EN_PCIE_GEN3  CONTROL_CONFIG8.BF.SUMF_BOOST_TARGET_C_FORCE_EN_PCIE_GEN3
#define cmx_SUMF_BOOST_TARGET_C_FORCE_EN_PCIE_GEN4  CONTROL_CONFIG8.BF.SUMF_BOOST_TARGET_C_FORCE_EN_PCIE_GEN4
#define cmx_EOM_ALG_MODE  CONTROL_CONFIG8.BF.EOM_ALG_MODE
#define cmx_EOM_POWERSAVING_EN  CONTROL_CONFIG8.BF.EOM_POWERSAVING_EN
#define cmx_SKIP_LCPLL_LOCK_CHECK  CONTROL_CONFIG8.BF.SKIP_LCPLL_LOCK_CHECK
#define cmx_FORCE_LCPLL_SHRTR_1  CONTROL_CONFIG8.BF.FORCE_LCPLL_SHRTR_1
#define cmx_DFE_POWERSAVING_EN  CONTROL_CONFIG8.BF.DFE_POWERSAVING_EN
...
typedef union {
	struct {
		uint8_t MIDPOINT_USER_PHASE_OFFSET_7_0           : 8;	/*  [7:0]     r/w 8'h0*/
		uint8_t FORCE_FFE_PULSE_DIV_2_0                  : 3;	/* [10:8]     r/w 3'h0*/
		uint8_t FORCE_FFE_PULSE_DIV_EN                   : 1;	/*     11     r/w   0*/
		uint8_t RESERVED_12                              : 1;	/*     12     r/w   0*/
		uint8_t RESERVED_13                              : 1;	/*     13     r/w   0*/
		uint8_t RESERVED_14                              : 1;	/*     14     r/w   0*/
...
#define cmx_MIDPOINT_USER_PHASE_OFFSET_7_0  CONTROL_CONFIG9.BF.MIDPOINT_USER_PHASE_OFFSET_7_0
#define cmx_FORCE_FFE_PULSE_DIV_2_0  CONTROL_CONFIG9.BF.FORCE_FFE_PULSE_DIV_2_0
#define cmx_FORCE_FFE_PULSE_DIV_EN  CONTROL_CONFIG9.BF.FORCE_FFE_PULSE_DIV_EN
...
typedef union {
	struct {
		...
		uint8_t ETHERNET_TRAIN_32BIT_OUTPUT_DISABLE      : 1;	/*      2     r/w   0*/
		uint8_t TXALIGNMENT_EN_L1_EXIT                   : 1;	/*      3     r/w   0*/
		uint8_t PLL_CONT_CAL_EN_L1                       : 1;	/*      4     r/w   0*/
		uint8_t RXINIT_DONE_MODE                         : 1;	/*      5     r/w   0*/
		uint8_t GAIN_TRAIN_AFTER_TX_TRAIN_EN_PCIE        : 1;	/*      6     r/w   0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
		uint8_t RINGPLL_CAL_FINE_STEP_7_0                : 8;	/* [15:8]     r/w 8'h10*/
...
#define cmx_ETHERNET_TRAIN_32BIT_OUTPUT_DISABLE  CON_CAL_STEP_SIZE5.BF.ETHERNET_TRAIN_32BIT_OUTPUT_DISABLE
#define cmx_TXALIGNMENT_EN_L1_EXIT  CON_CAL_STEP_SIZE5.BF.TXALIGNMENT_EN_L1_EXIT
#define cmx_PLL_CONT_CAL_EN_L1  CON_CAL_STEP_SIZE5.BF.PLL_CONT_CAL_EN_L1
#define cmx_RXINIT_DONE_MODE  CON_CAL_STEP_SIZE5.BF.RXINIT_DONE_MODE
#define cmx_GAIN_TRAIN_AFTER_TX_TRAIN_EN_PCIE  CON_CAL_STEP_SIZE5.BF.GAIN_TRAIN_AFTER_TX_TRAIN_EN_PCIE
...
typedef union {
	struct {
		...
		uint8_t RESERVED_12                              : 1;	/*     12     r/w   0*/
		uint8_t RESERVED_13                              : 1;	/*     13     r/w   0*/
		uint8_t SAS_TTIU_MODE_SEL_C3                     : 1;	/*     14     r/w   0*/
		uint8_t SAS_TTIU_MODE_SEL_C1                     : 1;	/*     15     r/w   0*/
		uint8_t G_INTPI_LCPLL_7_0                        : 8;	/*[23:16]     r/w 8'h9*/
		uint8_t G_INTPI_RING_7_0                         : 8;	/*[31:24]     r/w 8'h9*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define cmx_SAS_TTIU_MODE_SEL_C3  CAL_TIME_OUT_AND_DIS.BF.SAS_TTIU_MODE_SEL_C3
#define cmx_SAS_TTIU_MODE_SEL_C1  CAL_TIME_OUT_AND_DIS.BF.SAS_TTIU_MODE_SEL_C1
#define cmx_G_INTPI_LCPLL_7_0  CAL_TIME_OUT_AND_DIS.BF.G_INTPI_LCPLL_7_0
#define cmx_G_INTPI_RING_7_0  CAL_TIME_OUT_AND_DIS.BF.G_INTPI_RING_7_0
...
typedef union {
	struct {
		...
		uint8_t PLL_CAL_RING_DONE                        : 1;	/*     24       r   0*/
...
typedef union {
	struct {
		...
		uint8_t LANE_DIS_LANE0_7_0                       : 8;	/* [15:8]       r 8'h0*/
		uint8_t LANE_DIS_LANE1_7_0                       : 8;	/*[23:16]       r 8'h0*/
		uint8_t TX_GN1_MIDPOINT_INDEX_OS_7_0             : 8;	/*[31:24]     r/w 8'hfc*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} MCU_CONFIG_t;
...
#define cmx_LANE_DIS_LANE0_7_0  MCU_CONFIG.BF.LANE_DIS_LANE0_7_0
#define cmx_LANE_DIS_LANE1_7_0  MCU_CONFIG.BF.LANE_DIS_LANE1_7_0
#define cmx_TX_GN1_MIDPOINT_INDEX_OS_7_0  MCU_CONFIG.BF.TX_GN1_MIDPOINT_INDEX_OS_7_0

// 0x0654	CAL_DATA1		Calibration Result 1
typedef union {
	struct {
		uint8_t CAL_PROCESS_VALUE_ULVT_7_0               : 8;	/*  [7:0]     r/w 8'h0*/
		uint8_t TX_G1N1_STOP_THRESHOLD_7_0               : 8;	/* [15:8]     r/w 8'ha*/
...
#define cmx_TX_G1N1_STOP_THRESHOLD_7_0  CAL_DATA1.BF.TX_G1N1_STOP_THRESHOLD_7_0
...
typedef union {
	struct {
		...
		uint8_t RXINIT_CONT_CAL_LOOP_CNT_7_0             : 8;	/* [15:8]     r/w 8'h0*/
...
#define cmx_RXINIT_CONT_CAL_LOOP_CNT_7_0  LOOP_CNTS.BF.RXINIT_CONT_CAL_LOOP_CNT_7_0
...
typedef union {
	struct {
		...
		uint8_t PT_OUT_TIME_TRAIN_COMP_15_0_b0           : 8;	/*[31:16]     r/w 16'h03e8*/
		uint8_t PT_OUT_TIME_TRAIN_COMP_15_0_b1           : 8;	/*[31:16]     r/w 16'h03e8*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
...
#define cmx_PT_OUT_TIME_TRAIN_COMP_15_0_b0  MCU_CONFIG1.BF.PT_OUT_TIME_TRAIN_COMP_15_0_b0
#define cmx_PT_OUT_TIME_TRAIN_COMP_15_0_b1  MCU_CONFIG1.BF.PT_OUT_TIME_TRAIN_COMP_15_0_b1
#define cmx_MCU_FREQ_15_0  MCU_CONFIG1.WT.W0
#define cmx_PT_OUT_TIME_TRAIN_COMP_15_0  MCU_CONFIG1.WT.W1
...
typedef union {
	struct {
		...
		uint8_t SHORT_TRAIN_MODE_EN_G0                   : 1;	/*      1     r/w   0*/
		uint8_t DFE_SAT_STOP_GEN3_EN                     : 1;	/*      2     r/w   1*/
		uint8_t DFE_SAT_STOP_GEN4_EN                     : 1;	/*      3     r/w   0*/
		uint8_t DFE_STOP_GEN3_EN                         : 1;	/*      4     r/w   1*/
		uint8_t DFE_STOP_GEN4_EN                         : 1;	/*      5     r/w   0*/
		uint8_t RESERVED_6                               : 2;	/*  [7:6]     r/w   0*/
		uint8_t TRAIN_FORCE_RXFFE_CAP1_SEL_G0_LANE_3_0   : 4;	/* [11:8]     r/w 4'hc*/
		uint8_t TRAIN_FORCE_RXFFE_RES1_SEL_G0_LANE_3_0   : 4;	/*[15:12]     r/w 4'h6*/
		uint8_t TRAIN_FORCE_RXFFE_CAP2_SEL_O_G0_LANE_3_0 : 4;	/*[19:16]     r/w 4'hf*/
		uint8_t TRAIN_FORCE_RXFFE_RES2_SEL_O_G0_LANE_3_0 : 4;	/*[23:20]     r/w 4'h0*/
		uint8_t TRAIN_FORCE_RXFFE_CAP2_SEL_E_G0_LANE_3_0 : 4;	/*[27:24]     r/w 4'hf*/
		uint8_t TRAIN_FORCE_RXFFE_RES2_SEL_E_G0_LANE_3_0 : 4;	/*[31:28]     r/w 4'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TX_SAVE_0_t;
...
#define cmx_SHORT_TRAIN_MODE_EN_G0  TX_SAVE_0.BF.SHORT_TRAIN_MODE_EN_G0
#define cmx_DFE_SAT_STOP_GEN3_EN  TX_SAVE_0.BF.DFE_SAT_STOP_GEN3_EN
#define cmx_DFE_SAT_STOP_GEN4_EN  TX_SAVE_0.BF.DFE_SAT_STOP_GEN4_EN
#define cmx_DFE_STOP_GEN3_EN  TX_SAVE_0.BF.DFE_STOP_GEN3_EN
#define cmx_DFE_STOP_GEN4_EN  TX_SAVE_0.BF.DFE_STOP_GEN4_EN
#define cmx_TRAIN_FORCE_RXFFE_CAP1_SEL_G0_LANE_3_0  TX_SAVE_0.BF.TRAIN_FORCE_RXFFE_CAP1_SEL_G0_LANE_3_0
#define cmx_TRAIN_FORCE_RXFFE_RES1_SEL_G0_LANE_3_0  TX_SAVE_0.BF.TRAIN_FORCE_RXFFE_RES1_SEL_G0_LANE_3_0
#define cmx_TRAIN_FORCE_RXFFE_CAP2_SEL_O_G0_LANE_3_0  TX_SAVE_0.BF.TRAIN_FORCE_RXFFE_CAP2_SEL_O_G0_LANE_3_0
#define cmx_TRAIN_FORCE_RXFFE_RES2_SEL_O_G0_LANE_3_0  TX_SAVE_0.BF.TRAIN_FORCE_RXFFE_RES2_SEL_O_G0_LANE_3_0
#define cmx_TRAIN_FORCE_RXFFE_CAP2_SEL_E_G0_LANE_3_0  TX_SAVE_0.BF.TRAIN_FORCE_RXFFE_CAP2_SEL_E_G0_LANE_3_0
#define cmx_TRAIN_FORCE_RXFFE_RES2_SEL_E_G0_LANE_3_0  TX_SAVE_0.BF.TRAIN_FORCE_RXFFE_RES2_SEL_E_G0_LANE_3_0

// 0x069c	TX_SAVE_1		
typedef union {
	struct {
		uint8_t TX_SSC_EN_G1                             : 1;	/*      0     r/w   0*/
		uint8_t SHORT_TRAIN_MODE_EN_G1                   : 1;	/*      1     r/w   0*/
		uint8_t RESERVED_2                               : 6;	/*  [7:2]     r/w   0*/
		uint8_t TRAIN_FORCE_RXFFE_CAP1_SEL_G1_LANE_3_0   : 4;	/* [11:8]     r/w 4'hc*/
		uint8_t TRAIN_FORCE_RXFFE_RES1_SEL_G1_LANE_3_0   : 4;	/*[15:12]     r/w 4'h6*/
		uint8_t TRAIN_FORCE_RXFFE_CAP2_SEL_O_G1_LANE_3_0 : 4;	/*[19:16]     r/w 4'hf*/
		uint8_t TRAIN_FORCE_RXFFE_RES2_SEL_O_G1_LANE_3_0 : 4;	/*[23:20]     r/w 4'h0*/
		uint8_t TRAIN_FORCE_RXFFE_CAP2_SEL_E_G1_LANE_3_0 : 4;	/*[27:24]     r/w 4'hf*/
		uint8_t TRAIN_FORCE_RXFFE_RES2_SEL_E_G1_LANE_3_0 : 4;	/*[31:28]     r/w 4'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TX_SAVE_1_t;
...
#define cmx_SHORT_TRAIN_MODE_EN_G1  TX_SAVE_1.BF.SHORT_TRAIN_MODE_EN_G1
#define cmx_TRAIN_FORCE_RXFFE_CAP1_SEL_G1_LANE_3_0  TX_SAVE_1.BF.TRAIN_FORCE_RXFFE_CAP1_SEL_G1_LANE_3_0
#define cmx_TRAIN_FORCE_RXFFE_RES1_SEL_G1_LANE_3_0  TX_SAVE_1.BF.TRAIN_FORCE_RXFFE_RES1_SEL_G1_LANE_3_0
#define cmx_TRAIN_FORCE_RXFFE_CAP2_SEL_O_G1_LANE_3_0  TX_SAVE_1.BF.TRAIN_FORCE_RXFFE_CAP2_SEL_O_G1_LANE_3_0
#define cmx_TRAIN_FORCE_RXFFE_RES2_SEL_O_G1_LANE_3_0  TX_SAVE_1.BF.TRAIN_FORCE_RXFFE_RES2_SEL_O_G1_LANE_3_0
#define cmx_TRAIN_FORCE_RXFFE_CAP2_SEL_E_G1_LANE_3_0  TX_SAVE_1.BF.TRAIN_FORCE_RXFFE_CAP2_SEL_E_G1_LANE_3_0
#define cmx_TRAIN_FORCE_RXFFE_RES2_SEL_E_G1_LANE_3_0  TX_SAVE_1.BF.TRAIN_FORCE_RXFFE_RES2_SEL_E_G1_LANE_3_0

// 0x06a0	TX_SAVE_2		
typedef union {
	struct {
		uint8_t TX_SSC_EN_G2                             : 1;	/*      0     r/w   0*/
		uint8_t SHORT_TRAIN_MODE_EN_G2                   : 1;	/*      1     r/w   1*/
		uint8_t RESERVED_2                               : 6;	/*  [7:2]     r/w   0*/
		uint8_t TRAIN_FORCE_RXFFE_CAP1_SEL_G2_LANE_3_0   : 4;	/* [11:8]     r/w 4'hc*/
		uint8_t TRAIN_FORCE_RXFFE_RES1_SEL_G2_LANE_3_0   : 4;	/*[15:12]     r/w 4'h6*/
		uint8_t TRAIN_FORCE_RXFFE_CAP2_SEL_O_G2_LANE_3_0 : 4;	/*[19:16]     r/w 4'hf*/
		uint8_t TRAIN_FORCE_RXFFE_RES2_SEL_O_G2_LANE_3_0 : 4;	/*[23:20]     r/w 4'h0*/
		uint8_t TRAIN_FORCE_RXFFE_CAP2_SEL_E_G2_LANE_3_0 : 4;	/*[27:24]     r/w 4'hf*/
		uint8_t TRAIN_FORCE_RXFFE_RES2_SEL_E_G2_LANE_3_0 : 4;	/*[31:28]     r/w 4'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TX_SAVE_2_t;
...
#define cmx_SHORT_TRAIN_MODE_EN_G2  TX_SAVE_2.BF.SHORT_TRAIN_MODE_EN_G2
#define cmx_TRAIN_FORCE_RXFFE_CAP1_SEL_G2_LANE_3_0  TX_SAVE_2.BF.TRAIN_FORCE_RXFFE_CAP1_SEL_G2_LANE_3_0
#define cmx_TRAIN_FORCE_RXFFE_RES1_SEL_G2_LANE_3_0  TX_SAVE_2.BF.TRAIN_FORCE_RXFFE_RES1_SEL_G2_LANE_3_0
#define cmx_TRAIN_FORCE_RXFFE_CAP2_SEL_O_G2_LANE_3_0  TX_SAVE_2.BF.TRAIN_FORCE_RXFFE_CAP2_SEL_O_G2_LANE_3_0
#define cmx_TRAIN_FORCE_RXFFE_RES2_SEL_O_G2_LANE_3_0  TX_SAVE_2.BF.TRAIN_FORCE_RXFFE_RES2_SEL_O_G2_LANE_3_0
#define cmx_TRAIN_FORCE_RXFFE_CAP2_SEL_E_G2_LANE_3_0  TX_SAVE_2.BF.TRAIN_FORCE_RXFFE_CAP2_SEL_E_G2_LANE_3_0
#define cmx_TRAIN_FORCE_RXFFE_RES2_SEL_E_G2_LANE_3_0  TX_SAVE_2.BF.TRAIN_FORCE_RXFFE_RES2_SEL_E_G2_LANE_3_0

// 0x06a4	TX_SAVE_3		
typedef union {
	struct {
		uint8_t TX_SSC_EN_G3                             : 1;	/*      0     r/w   0*/
		uint8_t SHORT_TRAIN_MODE_EN_G3                   : 1;	/*      1     r/w   1*/
		uint8_t RESERVED_2                               : 6;	/*  [7:2]     r/w   0*/
		uint8_t TRAIN_FORCE_RXFFE_CAP1_SEL_G3_LANE_3_0   : 4;	/* [11:8]     r/w 4'hf*/
		uint8_t TRAIN_FORCE_RXFFE_RES1_SEL_G3_LANE_3_0   : 4;	/*[15:12]     r/w 4'h2*/
		uint8_t TRAIN_FORCE_RXFFE_CAP2_SEL_O_G3_LANE_3_0 : 4;	/*[19:16]     r/w 4'h5*/
		uint8_t TRAIN_FORCE_RXFFE_RES2_SEL_O_G3_LANE_3_0 : 4;	/*[23:20]     r/w 4'h0*/
		uint8_t TRAIN_FORCE_RXFFE_CAP2_SEL_E_G3_LANE_3_0 : 4;	/*[27:24]     r/w 4'h5*/
		uint8_t TRAIN_FORCE_RXFFE_RES2_SEL_E_G3_LANE_3_0 : 4;	/*[31:28]     r/w 4'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TX_SAVE_3_t;
...
#define cmx_SHORT_TRAIN_MODE_EN_G3  TX_SAVE_3.BF.SHORT_TRAIN_MODE_EN_G3
#define cmx_TRAIN_FORCE_RXFFE_CAP1_SEL_G3_LANE_3_0  TX_SAVE_3.BF.TRAIN_FORCE_RXFFE_CAP1_SEL_G3_LANE_3_0
#define cmx_TRAIN_FORCE_RXFFE_RES1_SEL_G3_LANE_3_0  TX_SAVE_3.BF.TRAIN_FORCE_RXFFE_RES1_SEL_G3_LANE_3_0
#define cmx_TRAIN_FORCE_RXFFE_CAP2_SEL_O_G3_LANE_3_0  TX_SAVE_3.BF.TRAIN_FORCE_RXFFE_CAP2_SEL_O_G3_LANE_3_0
#define cmx_TRAIN_FORCE_RXFFE_RES2_SEL_O_G3_LANE_3_0  TX_SAVE_3.BF.TRAIN_FORCE_RXFFE_RES2_SEL_O_G3_LANE_3_0
#define cmx_TRAIN_FORCE_RXFFE_CAP2_SEL_E_G3_LANE_3_0  TX_SAVE_3.BF.TRAIN_FORCE_RXFFE_CAP2_SEL_E_G3_LANE_3_0
#define cmx_TRAIN_FORCE_RXFFE_RES2_SEL_E_G3_LANE_3_0  TX_SAVE_3.BF.TRAIN_FORCE_RXFFE_RES2_SEL_E_G3_LANE_3_0

// 0x06a8	TX_SAVE_4		
typedef union {
	struct {
		uint8_t TX_SSC_EN_G4                             : 1;	/*      0     r/w   0*/
		uint8_t SHORT_TRAIN_MODE_EN_G4                   : 1;	/*      1     r/w   1*/
		uint8_t RESERVED_2                               : 6;	/*  [7:2]     r/w   0*/
		uint8_t TRAIN_FORCE_RXFFE_CAP1_SEL_G4_LANE_3_0   : 4;	/* [11:8]     r/w 4'hc*/
		uint8_t TRAIN_FORCE_RXFFE_RES1_SEL_G4_LANE_3_0   : 4;	/*[15:12]     r/w 4'h6*/
		uint8_t TRAIN_FORCE_RXFFE_CAP2_SEL_O_G4_LANE_3_0 : 4;	/*[19:16]     r/w 4'hf*/
		uint8_t TRAIN_FORCE_RXFFE_RES2_SEL_O_G4_LANE_3_0 : 4;	/*[23:20]     r/w 4'h0*/
		uint8_t TRAIN_FORCE_RXFFE_CAP2_SEL_E_G4_LANE_3_0 : 4;	/*[27:24]     r/w 4'hf*/
		uint8_t TRAIN_FORCE_RXFFE_RES2_SEL_E_G4_LANE_3_0 : 4;	/*[31:28]     r/w 4'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TX_SAVE_4_t;
...
#define cmx_SHORT_TRAIN_MODE_EN_G4  TX_SAVE_4.BF.SHORT_TRAIN_MODE_EN_G4
#define cmx_TRAIN_FORCE_RXFFE_CAP1_SEL_G4_LANE_3_0  TX_SAVE_4.BF.TRAIN_FORCE_RXFFE_CAP1_SEL_G4_LANE_3_0
#define cmx_TRAIN_FORCE_RXFFE_RES1_SEL_G4_LANE_3_0  TX_SAVE_4.BF.TRAIN_FORCE_RXFFE_RES1_SEL_G4_LANE_3_0
#define cmx_TRAIN_FORCE_RXFFE_CAP2_SEL_O_G4_LANE_3_0  TX_SAVE_4.BF.TRAIN_FORCE_RXFFE_CAP2_SEL_O_G4_LANE_3_0
#define cmx_TRAIN_FORCE_RXFFE_RES2_SEL_O_G4_LANE_3_0  TX_SAVE_4.BF.TRAIN_FORCE_RXFFE_RES2_SEL_O_G4_LANE_3_0
#define cmx_TRAIN_FORCE_RXFFE_CAP2_SEL_E_G4_LANE_3_0  TX_SAVE_4.BF.TRAIN_FORCE_RXFFE_CAP2_SEL_E_G4_LANE_3_0
#define cmx_TRAIN_FORCE_RXFFE_RES2_SEL_E_G4_LANE_3_0  TX_SAVE_4.BF.TRAIN_FORCE_RXFFE_RES2_SEL_E_G4_LANE_3_0
...
typedef union {
	struct {
		uint8_t PLL_RATE_SEL_0_7_0                       : 8;	/*  [7:0]     r/w 8'hff*/
		uint8_t PLL_CLK_SEL_0_7_0                        : 8;	/* [15:8]     r/w 8'h0*/
		uint8_t RING_PLL_RATE_SEL_7_0                    : 8;	/*[23:16]     r/w 8'h0*/
		uint8_t LC_PLL_RATE_SEL_7_0                      : 8;	/*[31:24]     r/w 8'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} LANE_PLL_0_t;
__xdata __at( 0xe6bc ) volatile LANE_PLL_0_t LANE_PLL_0;
#define cmx_PLL_RATE_SEL_0_7_0  LANE_PLL_0.BF.PLL_RATE_SEL_0_7_0
#define cmx_PLL_CLK_SEL_0_7_0  LANE_PLL_0.BF.PLL_CLK_SEL_0_7_0
#define cmx_RING_PLL_RATE_SEL_7_0  LANE_PLL_0.BF.RING_PLL_RATE_SEL_7_0
#define cmx_LC_PLL_RATE_SEL_7_0  LANE_PLL_0.BF.LC_PLL_RATE_SEL_7_0

// 0x06c0	CDR_ADAPT_CFG		
typedef union {
	struct {
		uint8_t CDR_ADAPT_EN_PHASE2                      : 1;	/*      0     r/w   0*/
		uint8_t CDR_ADAPT_EN_PHASE0                      : 1;	/*      1     r/w   0*/
		uint8_t DFE_RES_ADAPT_DIS_PCIE_GEN4              : 1;	/*      2     r/w   0*/
		uint8_t DFE_DC_INTERVAL_EQ_EN                    : 1;	/*      3     r/w   0*/
		uint8_t CDR_ADAPT_FORCE_EN_ISO                   : 1;	/*      4     r/w   0*/
		uint8_t NORMAL_FFE_PULSE_DIV_GEN3_2_0            : 3;	/*  [7:5]     r/w 3'h3*/
		uint8_t DFE_RES_F0A_HIGH_THRES_INIT_GEN4_PHASE0_7_0 : 8;	/* [15:8]     r/w 8'h32*/
		uint8_t DFE_RES_F0A_HIGH_THRES_INIT_GEN3_PHASE2_7_0 : 8;	/*[23:16]     r/w 8'h32*/
		uint8_t DFE_RES_F0A_HIGH_THRES_INIT_GEN3_PHASE0_7_0 : 8;	/*[31:24]     r/w 8'h32*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CDR_ADAPT_CFG_t;
__xdata __at( 0xe6c0 ) volatile CDR_ADAPT_CFG_t CDR_ADAPT_CFG;
#define cmx_CDR_ADAPT_EN_PHASE2  CDR_ADAPT_CFG.BF.CDR_ADAPT_EN_PHASE2
#define cmx_CDR_ADAPT_EN_PHASE0  CDR_ADAPT_CFG.BF.CDR_ADAPT_EN_PHASE0
#define cmx_DFE_RES_ADAPT_DIS_PCIE_GEN4  CDR_ADAPT_CFG.BF.DFE_RES_ADAPT_DIS_PCIE_GEN4
#define cmx_DFE_DC_INTERVAL_EQ_EN  CDR_ADAPT_CFG.BF.DFE_DC_INTERVAL_EQ_EN
#define cmx_CDR_ADAPT_FORCE_EN_ISO  CDR_ADAPT_CFG.BF.CDR_ADAPT_FORCE_EN_ISO
#define cmx_NORMAL_FFE_PULSE_DIV_GEN3_2_0  CDR_ADAPT_CFG.BF.NORMAL_FFE_PULSE_DIV_GEN3_2_0
#define cmx_DFE_RES_F0A_HIGH_THRES_INIT_GEN4_PHASE0_7_0  CDR_ADAPT_CFG.BF.DFE_RES_F0A_HIGH_THRES_INIT_GEN4_PHASE0_7_0
#define cmx_DFE_RES_F0A_HIGH_THRES_INIT_GEN3_PHASE2_7_0  CDR_ADAPT_CFG.BF.DFE_RES_F0A_HIGH_THRES_INIT_GEN3_PHASE2_7_0
#define cmx_DFE_RES_F0A_HIGH_THRES_INIT_GEN3_PHASE0_7_0  CDR_ADAPT_CFG.BF.DFE_RES_F0A_HIGH_THRES_INIT_GEN3_PHASE0_7_0

// 0x06c4	LOCAL_TX_PRESET_TB4		
typedef union {
	struct {
		uint8_t PLL_RATE_SEL_0_VALID                     : 1;	/*      0     r/w   0*/
		uint8_t RESERVED_1                               : 3;	/*  [3:1]     r/w   0*/
		uint8_t RESERVED_4                               : 4;	/*  [7:4]     r/w 4'h0*/
		uint8_t DFE_RES_F0A_HIGH_THRES_INIT_GEN4_PHASE2_7_0 : 8;	/* [15:8]     r/w 8'h32*/
		uint8_t NORMAL_FFE_PULSE_DIV_GEN5_2_0            : 3;	/*[18:16]     r/w 3'h4*/
		uint8_t RESERVED_19                              : 1;	/*     19     r/w   0*/
		uint8_t NORMAL_FFE_PULSE_DIV_GEN4_2_0            : 3;	/*[22:20]     r/w 3'h3*/
		uint8_t RESERVED_23                              : 1;	/*     23     r/w   0*/
		uint8_t NORMAL_FFE_PULSE_DIV_2_0                 : 3;	/*[26:24]     r/w 3'h2*/
		uint8_t RESERVED_27                              : 1;	/*     27     r/w   0*/
		uint8_t TRAIN_FFE_PULSE_DIV_2_0                  : 3;	/*[30:28]     r/w 3'h2*/
		uint8_t RESERVED_31                              : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define cmx_PLL_RATE_SEL_0_VALID  LOCAL_TX_PRESET_TB4.BF.PLL_RATE_SEL_0_VALID
#define cmx_DFE_RES_F0A_HIGH_THRES_INIT_GEN4_PHASE2_7_0  LOCAL_TX_PRESET_TB4.BF.DFE_RES_F0A_HIGH_THRES_INIT_GEN4_PHASE2_7_0
#define cmx_NORMAL_FFE_PULSE_DIV_GEN5_2_0  LOCAL_TX_PRESET_TB4.BF.NORMAL_FFE_PULSE_DIV_GEN5_2_0
#define cmx_NORMAL_FFE_PULSE_DIV_GEN4_2_0  LOCAL_TX_PRESET_TB4.BF.NORMAL_FFE_PULSE_DIV_GEN4_2_0
#define cmx_NORMAL_FFE_PULSE_DIV_2_0  LOCAL_TX_PRESET_TB4.BF.NORMAL_FFE_PULSE_DIV_2_0
#define cmx_TRAIN_FFE_PULSE_DIV_2_0  LOCAL_TX_PRESET_TB4.BF.TRAIN_FFE_PULSE_DIV_2_0

// 0x06c8	LOCAL_TX_PRESET_TB5		
typedef union {
	struct {
		uint8_t PLL_RATE_SEL_1_VALID                     : 1;	/*      0     r/w   0*/
		uint8_t RESERVED_1                               : 3;	/*  [3:1]     r/w   0*/
		uint8_t FORCE_DFE_STEP_ACCU_FX_3_0               : 4;	/*  [7:4]     r/w 4'h0*/
		uint8_t FORCE_DFE_STEP_ACCU_FX_EN                : 1;	/*      8     r/w   0*/
		uint8_t RESERVED_9                               : 1;	/*      9     r/w   0*/
		uint8_t TX_ADAPT_G1_EN_PCIE_GEN4                 : 1;	/*     10     r/w 1'h1*/
		uint8_t TX_ADAPT_GN1_EN_PCIE_GEN4                : 1;	/*     11     r/w 1'h1*/
		uint8_t TX_ADAPT_G0_EN_PCIE_GEN4                 : 1;	/*     12     r/w 1'h0*/
		uint8_t TX_ADAPT_G1_EN_PCIE_GEN3                 : 1;	/*     13     r/w 1'h1*/
		uint8_t TX_ADAPT_GN1_EN_PCIE_GEN3                : 1;	/*     14     r/w 1'h1*/
		uint8_t TX_ADAPT_G0_EN_PCIE_GEN3                 : 1;	/*     15     r/w 1'h0*/
		uint8_t RXINIT_DONE_DELAY_15_0_b0                : 8;	/*[31:16]     r/w 16'h8*/
		uint8_t RXINIT_DONE_DELAY_15_0_b1                : 8;	/*[31:16]     r/w 16'h8*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
...
#define cmx_PLL_RATE_SEL_1_VALID  LOCAL_TX_PRESET_TB5.BF.PLL_RATE_SEL_1_VALID
#define cmx_FORCE_DFE_STEP_ACCU_FX_3_0  LOCAL_TX_PRESET_TB5.BF.FORCE_DFE_STEP_ACCU_FX_3_0
#define cmx_FORCE_DFE_STEP_ACCU_FX_EN  LOCAL_TX_PRESET_TB5.BF.FORCE_DFE_STEP_ACCU_FX_EN
#define cmx_TX_ADAPT_G1_EN_PCIE_GEN4  LOCAL_TX_PRESET_TB5.BF.TX_ADAPT_G1_EN_PCIE_GEN4
#define cmx_TX_ADAPT_GN1_EN_PCIE_GEN4  LOCAL_TX_PRESET_TB5.BF.TX_ADAPT_GN1_EN_PCIE_GEN4
#define cmx_TX_ADAPT_G0_EN_PCIE_GEN4  LOCAL_TX_PRESET_TB5.BF.TX_ADAPT_G0_EN_PCIE_GEN4
#define cmx_TX_ADAPT_G1_EN_PCIE_GEN3  LOCAL_TX_PRESET_TB5.BF.TX_ADAPT_G1_EN_PCIE_GEN3
#define cmx_TX_ADAPT_GN1_EN_PCIE_GEN3  LOCAL_TX_PRESET_TB5.BF.TX_ADAPT_GN1_EN_PCIE_GEN3
#define cmx_TX_ADAPT_G0_EN_PCIE_GEN3  LOCAL_TX_PRESET_TB5.BF.TX_ADAPT_G0_EN_PCIE_GEN3
#define cmx_RXINIT_DONE_DELAY_15_0_b0  LOCAL_TX_PRESET_TB5.BF.RXINIT_DONE_DELAY_15_0_b0
#define cmx_RXINIT_DONE_DELAY_15_0_b1  LOCAL_TX_PRESET_TB5.BF.RXINIT_DONE_DELAY_15_0_b1
#define cmx_RXINIT_DONE_DELAY_15_0  LOCAL_TX_PRESET_TB5.WT.W1

// 0x06cc	LANE_PLL_1		
typedef union {
	struct {
		uint8_t PLL_RATE_SEL_1_7_0                       : 8;	/*  [7:0]     r/w 8'hff*/
		uint8_t PLL_CLK_SEL_1_7_0                        : 8;	/* [15:8]     r/w 8'h0*/
		uint8_t TX_GN1_OVERBOOST_THRES_7_0               : 8;	/*[23:16]     r/w 8'h3*/
		uint8_t TX_G1_OVERBOOST_THRES_7_0                : 8;	/*[31:24]     r/w 8'h3*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} LANE_PLL_1_t;
__xdata __at( 0xe6cc ) volatile LANE_PLL_1_t LANE_PLL_1;
#define cmx_PLL_RATE_SEL_1_7_0  LANE_PLL_1.BF.PLL_RATE_SEL_1_7_0
#define cmx_PLL_CLK_SEL_1_7_0  LANE_PLL_1.BF.PLL_CLK_SEL_1_7_0
#define cmx_TX_GN1_OVERBOOST_THRES_7_0  LANE_PLL_1.BF.TX_GN1_OVERBOOST_THRES_7_0
#define cmx_TX_G1_OVERBOOST_THRES_7_0  LANE_PLL_1.BF.TX_G1_OVERBOOST_THRES_7_0

// 0x06d0	RXINIT_DELAY_0		
typedef union {
	struct {
		uint8_t RXINIT_DELAY_ENTER_15_0_b0               : 8;	/* [15:0]     r/w   0*/
		uint8_t RXINIT_DELAY_ENTER_15_0_b1               : 8;	/* [15:0]     r/w   0*/
		uint8_t TX_PDIV_DCC_MIN_7_0                      : 8;	/*[23:16]     r/w 8'h0*/
		uint8_t TX_PDIV_DCC_MAX_7_0                      : 8;	/*[31:24]     r/w 8'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
} RXINIT_DELAY_0_t;
__xdata __at( 0xe6d0 ) volatile RXINIT_DELAY_0_t RXINIT_DELAY_0;
#define cmx_RXINIT_DELAY_ENTER_15_0_b0  RXINIT_DELAY_0.BF.RXINIT_DELAY_ENTER_15_0_b0
#define cmx_RXINIT_DELAY_ENTER_15_0_b1  RXINIT_DELAY_0.BF.RXINIT_DELAY_ENTER_15_0_b1
#define cmx_TX_PDIV_DCC_MIN_7_0  RXINIT_DELAY_0.BF.TX_PDIV_DCC_MIN_7_0
#define cmx_TX_PDIV_DCC_MAX_7_0  RXINIT_DELAY_0.BF.TX_PDIV_DCC_MAX_7_0
#define cmx_RXINIT_DELAY_ENTER_15_0  RXINIT_DELAY_0.WT.W0

// 0x06d4	TRAIN_PARAMETER_0		
typedef union {
	struct {
		uint8_t SUMF_BOOST_TARGET_C_PCIE_GEN4_7_0        : 8;	/*  [7:0]     r/w 8'h0*/
		uint8_t SUMF_BOOST_TARGET_K_PCIE_GEN4_7_0        : 8;	/* [15:8]     r/w 8'h0*/
		uint8_t SUMF_BOOST_TARGET_C_PCIE_GEN3_7_0        : 8;	/*[23:16]     r/w 8'h0*/
		uint8_t SUMF_BOOST_TARGET_K_PCIE_GEN3_7_0        : 8;	/*[31:24]     r/w 8'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TRAIN_PARAMETER_0_t;
__xdata __at( 0xe6d4 ) volatile TRAIN_PARAMETER_0_t TRAIN_PARAMETER_0;
#define cmx_SUMF_BOOST_TARGET_C_PCIE_GEN4_7_0  TRAIN_PARAMETER_0.BF.SUMF_BOOST_TARGET_C_PCIE_GEN4_7_0
#define cmx_SUMF_BOOST_TARGET_K_PCIE_GEN4_7_0  TRAIN_PARAMETER_0.BF.SUMF_BOOST_TARGET_K_PCIE_GEN4_7_0
#define cmx_SUMF_BOOST_TARGET_C_PCIE_GEN3_7_0  TRAIN_PARAMETER_0.BF.SUMF_BOOST_TARGET_C_PCIE_GEN3_7_0
#define cmx_SUMF_BOOST_TARGET_K_PCIE_GEN3_7_0  TRAIN_PARAMETER_0.BF.SUMF_BOOST_TARGET_K_PCIE_GEN3_7_0

// 0x06d8	TRAIN_PARAMETER_1		
typedef union {
	struct {
		uint8_t GAINTRAIN_C_INDEX_TB_SIZE_PCIE_GEN4_USR_7_0 : 8;	/*  [7:0]     r/w 8'h0*/
		uint8_t GAINTRAIN_C_INDEX_TB_SIZE_PCIE_GEN3_USR_7_0 : 8;	/* [15:8]     r/w 8'h0*/
		uint8_t RX_FFE_R_INDEX_TB_SIZE_PCIE_GEN4_USR_7_0 : 8;	/*[23:16]     r/w 8'h0*/
		uint8_t RX_FFE_R_INDEX_TB_SIZE_PCIE_GEN3_USR_7_0 : 8;	/*[31:24]     r/w 8'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TRAIN_PARAMETER_1_t;
__xdata __at( 0xe6d8 ) volatile TRAIN_PARAMETER_1_t TRAIN_PARAMETER_1;
#define cmx_GAINTRAIN_C_INDEX_TB_SIZE_PCIE_GEN4_USR_7_0  TRAIN_PARAMETER_1.BF.GAINTRAIN_C_INDEX_TB_SIZE_PCIE_GEN4_USR_7_0
#define cmx_GAINTRAIN_C_INDEX_TB_SIZE_PCIE_GEN3_USR_7_0  TRAIN_PARAMETER_1.BF.GAINTRAIN_C_INDEX_TB_SIZE_PCIE_GEN3_USR_7_0
#define cmx_RX_FFE_R_INDEX_TB_SIZE_PCIE_GEN4_USR_7_0  TRAIN_PARAMETER_1.BF.RX_FFE_R_INDEX_TB_SIZE_PCIE_GEN4_USR_7_0
#define cmx_RX_FFE_R_INDEX_TB_SIZE_PCIE_GEN3_USR_7_0  TRAIN_PARAMETER_1.BF.RX_FFE_R_INDEX_TB_SIZE_PCIE_GEN3_USR_7_0
...
__xdata __at( 0xe6dc ) volatile END_XDAT_CMN_t END_XDAT_CMN;
