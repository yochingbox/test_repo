...
// 0x0008	INT_ENABLE_ALL_LANE		Overall MCU INT Enable
typedef union {
	struct {
	...
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} INT_ENABLE_ALL_LANE_t;
__xdata __at( 0x2208 ) volatile INT_ENABLE_ALL_LANE_t INT_ENABLE_ALL_LANE;
#define reg_INT_ENABLE_ALL_LANE  INT_ENABLE_ALL_LANE.BF.INT_ENABLE_ALL_LANE
...
__xdata __at( 0x220c ) volatile RESERVED_t RESERVED;
