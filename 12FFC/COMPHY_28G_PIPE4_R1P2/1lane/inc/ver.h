...
*******************************************************************
===CHANGE LIST 0_14_2_0===
1. Add ECC patch for 2bit error
2. Increase lane speed table size : 2KB to 4KB
** Note: SAS_LANE.dat/bin file size is increased double.
===CHANGE LIST 0_14_1_0===
1. Apply TTIU handling issue WA
2. Add SATA DC-Idle WA 
3. Use New CDR phase algorithm
 0xe62c[11] EOM_ALG_MODE   1: use new algorithm (default:1 )	
...
7. Fix APTA interface corner case 
8. Changed ROM code to optimize PRAM size
9. Support Rx 3G Hardware Fix 
  0x6000[26] RX3G_FIX_EN_LANE 1: enable hardware fix to improve 2.5G, 2.578125G, 3G metastability, 0: disable hardware fix. (default:0 )
 ** Restriction: This release should be used new Analog behavior model for simualtion
===CHANGE LIST 0_14_0_0===
1. COMPHY_28G_X1_R1P2 
2. Fix APTA interface failure
...
1. Remove analog power saving (analog voltage regulator)
