...
typedef union {
	struct {
		...
		uint8_t RXIMPCAL_EN_COMMON                       : 1;	/*      2     r/w   0*/
...
#define reg_RXIMPCAL_EN_COMMON  UPHY14_CMN_ANAREG_TOP_128.BF.RXIMPCAL_EN_COMMON
...
typedef union {
	struct {
		...
		uint8_t SSC_CLK_EN_COMMON                        : 1;	/*      1     r/w 1'h1*/
		uint8_t CLK_DET_EN_COMMON                        : 1;	/*      2     r/w 1'h1*/
		uint8_t DPHERCK_DLY_SEL_COMMON_1_0               : 2;	/*  [4:3]     r/w 2'h1*/
...
#define reg_SSC_CLK_EN_COMMON  UPHY14_CMN_ANAREG_TOP_187.BF.SSC_CLK_EN_COMMON
#define reg_CLK_DET_EN_COMMON  UPHY14_CMN_ANAREG_TOP_187.BF.CLK_DET_EN_COMMON
#define reg_DPHERCK_DLY_SEL_COMMON_1_0  UPHY14_CMN_ANAREG_TOP_187.BF.DPHERCK_DLY_SEL_COMMON_1_0
...
typedef union {
	struct {
		uint8_t CLK_DIRECTION_REFCLK_COMMON              : 1;	/*      0     r/w   1*/
		uint8_t CLK_DIRECTION_RINGPLL_COMMON             : 1;	/*      1     r/w   1*/
		uint8_t CLK_DIRECTION_LCPLL_COMMON               : 1;	/*      2     r/w   1*/
...
#define reg_CLK_DIRECTION_REFCLK_COMMON  UPHY14_CMN_ANAREG_TOP_202.BF.CLK_DIRECTION_REFCLK_COMMON
#define reg_CLK_DIRECTION_RINGPLL_COMMON  UPHY14_CMN_ANAREG_TOP_202.BF.CLK_DIRECTION_RINGPLL_COMMON
#define reg_CLK_DIRECTION_LCPLL_COMMON  UPHY14_CMN_ANAREG_TOP_202.BF.CLK_DIRECTION_LCPLL_COMMON
...
typedef union {
	struct {
		uint8_t TEST_COMMON_7_0                          : 8;	/*  [7:0]     r/w 8'h00*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} UPHY14_CMN_ANAREG_TOP_203_t;
__xdata __at( 0x832c ) volatile UPHY14_CMN_ANAREG_TOP_203_t UPHY14_CMN_ANAREG_TOP_203;
#define reg_TEST_COMMON_7_0  UPHY14_CMN_ANAREG_TOP_203.BF.TEST_COMMON_7_0
...
typedef union {
	struct {
		...
		uint8_t RESERVED_4                               : 1;	/*      4     r/w   0*/
		uint8_t RESERVED_5                               : 1;	/*      5     r/w   0*/
		uint8_t AVDD1815_SEL_COMMON                      : 1;	/*      6     r/w   1*/
...
#define reg_AVDD1815_SEL_COMMON  UPHY14_CMN_ANAREG_TOP_204.BF.AVDD1815_SEL_COMMON
...
typedef union {
	struct {
		uint8_t CLK_BKWD_DIRECTION_RINGPLL_COMMON        : 1;	/*      0     r/w 1'b0*/
		uint8_t CLK_BKWD_DIRECTION_LCPLL_COMMON          : 1;	/*      1     r/w 1'b0*/
...
#define reg_CLK_BKWD_DIRECTION_RINGPLL_COMMON  UPHY14_CMN_ANAREG_TOP_206.BF.CLK_BKWD_DIRECTION_RINGPLL_COMMON
#define reg_CLK_BKWD_DIRECTION_LCPLL_COMMON  UPHY14_CMN_ANAREG_TOP_206.BF.CLK_BKWD_DIRECTION_LCPLL_COMMON
...
typedef union {
	struct {
		...
		uint8_t FORCE_CLK_DIRECTION_LCPLL_COMMON         : 1;	/*      3     r/w 1'b0*/
...
#define reg_FORCE_CLK_DIRECTION_LCPLL_COMMON  UPHY14_CMN_ANAREG_TOP_207.BF.FORCE_CLK_DIRECTION_LCPLL_COMMON
...
typedef union {
	struct {
		...
		uint8_t CLK_BKWD2_DIRECTION_LCPLL_COMMON         : 1;	/*      5     r/w 1'h1*/
		uint8_t CLK_FWD2_DIRECTION_LCPLL_COMMON          : 1;	/*      6     r/w 1'h1*/
...
#define reg_CLK_BKWD2_DIRECTION_LCPLL_COMMON  UPHY14_CMN_ANAREG_TOP_208.BF.CLK_BKWD2_DIRECTION_LCPLL_COMMON
#define reg_CLK_FWD2_DIRECTION_LCPLL_COMMON  UPHY14_CMN_ANAREG_TOP_208.BF.CLK_FWD2_DIRECTION_LCPLL_COMMON
...
// 0xd3	UPHY14_CMN_ANAREG_TOP_211		Analog Register 211
typedef union {
	struct {
		uint8_t ANA_RSVDA_COMMON_7_0                     : 8;	/*  [7:0]     r/w 8'hf0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} UPHY14_CMN_ANAREG_TOP_211_t;
__xdata __at( 0x834c ) volatile UPHY14_CMN_ANAREG_TOP_211_t UPHY14_CMN_ANAREG_TOP_211;
#define reg_ANA_RSVDA_COMMON_7_0  UPHY14_CMN_ANAREG_TOP_211.BF.ANA_RSVDA_COMMON_7_0

// 0xd4	UPHY14_CMN_ANAREG_TOP_212		Analog Register 212
typedef union {
	struct {
		uint8_t ANA_RSVDB_COMMON_7_0                     : 8;	/*  [7:0]     r/w 8'hf0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} UPHY14_CMN_ANAREG_TOP_212_t;
__xdata __at( 0x8350 ) volatile UPHY14_CMN_ANAREG_TOP_212_t UPHY14_CMN_ANAREG_TOP_212;
#define reg_ANA_RSVDB_COMMON_7_0  UPHY14_CMN_ANAREG_TOP_212.BF.ANA_RSVDB_COMMON_7_0

// 0xd5	UPHY14_CMN_ANAREG_TOP_213		Analog Register 213
typedef union {
	struct {
...
// 0xd6	UPHY14_CMN_ANAREG_TOP_214		Analog Register 214
typedef union {
	struct {
