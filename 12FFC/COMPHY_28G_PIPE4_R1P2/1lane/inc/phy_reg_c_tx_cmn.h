...
typedef union {
	struct {
		...
		uint8_t SSC_AMP_10_0_b0                          : 8;	/*[26:16]     r/w   0*/
		uint8_t SSC_AMP_10_0_b1                          : 3;	/*[26:16]     r/w   0*/
		uint8_t RESERVED_27                              : 3;	/*[29:27]     r/w   0*/
		uint8_t SSC_AMP_UNIT_SEL                         : 1;	/*     30     r/w   0*/
		uint8_t REPEAT_MODE_EN                           : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} DTX_REG2_t;
...
#define reg_SSC_AMP_10_0_b0  DTX_REG2.BF.SSC_AMP_10_0_b0
#define reg_SSC_AMP_10_0_b1  DTX_REG2.BF.SSC_AMP_10_0_b1
#define reg_SSC_AMP_UNIT_SEL  DTX_REG2.BF.SSC_AMP_UNIT_SEL
...
typedef union {
	struct {
		...
		uint8_t RESERVED_20                              : 1;	/*     20     r/w   0*/
		uint8_t SSC_AMP_RING_10_0_b0                     : 3;	/*[31:21]     r/w   0*/
		uint8_t SSC_AMP_RING_10_0_b1                     : 8;	/*[31:21]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} DTX_REG4_t;
...
#define reg_SSC_AMP_RING_10_0_b0  DTX_REG4.BF.SSC_AMP_RING_10_0_b0
#define reg_SSC_AMP_RING_10_0_b1  DTX_REG4.BF.SSC_AMP_RING_10_0_b1
...
// 0x0034	DTX_REG5		DTX Register 5
typedef union {
	struct {
...
__xdata __at( 0xa034 ) volatile DTX_REG5_t DTX_REG5;
#define reg_DTX_FLOOP_STEP_SIZE_1_0  DTX_REG5.BF.DTX_FLOOP_STEP_SIZE_1_0
#define reg_DTX_FLOOP_STEP_SIZE_RING_1_0  DTX_REG5.BF.DTX_FLOOP_STEP_SIZE_RING_1_0
#define reg_RX2TX_FOFFSET_RING_LANE_SEL_1_0  DTX_REG5.BF.RX2TX_FOFFSET_RING_LANE_SEL_1_0
#define reg_SSC_ACC_FACTOR_RING  DTX_REG5.BF.SSC_ACC_FACTOR_RING
#define reg_TX_FOFF_RING_INV_FORCE  DTX_REG5.BF.TX_FOFF_RING_INV_FORCE
#define reg_TX_FOFF_RING_INV  DTX_REG5.BF.TX_FOFF_RING_INV
#define reg_SSC_DSPREAD_TX_RING  DTX_REG5.BF.SSC_DSPREAD_TX_RING
#define reg_AUTO_TX_FOFFSET_RING  DTX_REG5.BF.AUTO_TX_FOFFSET_RING
