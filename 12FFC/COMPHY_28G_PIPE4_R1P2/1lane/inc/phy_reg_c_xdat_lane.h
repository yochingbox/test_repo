...
typedef union {
	struct {
		...
		uint8_t RX3G_FIX_EN_LANE                         : 1;	/*     26     r/w   0*/
...
#define lnx_RX3G_FIX_EN_LANE  CAL_CTRL1_LANE.BF.RX3G_FIX_EN_LANE
...
typedef union {
	struct {
		uint8_t CDR_OPT_FIRST_F0D_THRS_LANE_5_0          : 6;	/*  [5:0]     r/w 6'ha*/
		uint8_t CDR_PHASE_OPT_FIRST_TXTRAIN_EN_LANE      : 1;	/*      6     r/w   1*/
		uint8_t CDR_PHASE_OPT_FIRST_RXTRAIN_EN_LANE      : 1;	/*      7     r/w   0*/
...
#define lnx_CDR_OPT_FIRST_F0D_THRS_LANE_5_0  TRAIN_PARA_0.BF.CDR_OPT_FIRST_F0D_THRS_LANE_5_0
#define lnx_CDR_PHASE_OPT_FIRST_TXTRAIN_EN_LANE  TRAIN_PARA_0.BF.CDR_PHASE_OPT_FIRST_TXTRAIN_EN_LANE
#define lnx_CDR_PHASE_OPT_FIRST_RXTRAIN_EN_LANE  TRAIN_PARA_0.BF.CDR_PHASE_OPT_FIRST_RXTRAIN_EN_LANE
...
typedef union {
	struct {
		...
		uint8_t TX_TRAIN_START_WAIT_TIME_EN_LANE         : 1;	/*      5     r/w   1*/
...
#define lnx_TX_TRAIN_START_WAIT_TIME_EN_LANE  TRAIN_PARA_2.BF.TX_TRAIN_START_WAIT_TIME_EN_LANE
...
typedef union {
	struct {
		uint8_t DFE_F8TO15_EN_G0_LANE                    : 1;	/*      0     r/w   0*/
		uint8_t DFE_F8TO15_EN_G1_LANE                    : 1;	/*      1     r/w   0*/
		uint8_t DFE_F8TO15_EN_G2_LANE                    : 1;	/*      2     r/w   0*/
		uint8_t DFE_F8TO15_EN_G3_LANE                    : 1;	/*      3     r/w   0*/
		uint8_t DFE_F8TO15_EN_G4_LANE                    : 1;	/*      4     r/w   0*/
		uint8_t RESERVED_5                               : 3;	/*  [7:5]     r/w   0*/
		uint8_t TX_GN1_MAXF0T_GN1_INDEX_RESULT_LANE_7_0  : 8;	/* [15:8]       r 8'h0*/
		uint8_t TX_G1_MAXF0T_G1_INDEX_RESULT_LANE_7_0    : 8;	/*[23:16]       r 8'h0*/
...
#define lnx_DFE_F8TO15_EN_G0_LANE  TRAIN_CONTROL_13.BF.DFE_F8TO15_EN_G0_LANE
#define lnx_DFE_F8TO15_EN_G1_LANE  TRAIN_CONTROL_13.BF.DFE_F8TO15_EN_G1_LANE
#define lnx_DFE_F8TO15_EN_G2_LANE  TRAIN_CONTROL_13.BF.DFE_F8TO15_EN_G2_LANE
#define lnx_DFE_F8TO15_EN_G3_LANE  TRAIN_CONTROL_13.BF.DFE_F8TO15_EN_G3_LANE
#define lnx_DFE_F8TO15_EN_G4_LANE  TRAIN_CONTROL_13.BF.DFE_F8TO15_EN_G4_LANE
#define lnx_TX_GN1_MAXF0T_GN1_INDEX_RESULT_LANE_7_0  TRAIN_CONTROL_13.BF.TX_GN1_MAXF0T_GN1_INDEX_RESULT_LANE_7_0
#define lnx_TX_G1_MAXF0T_G1_INDEX_RESULT_LANE_7_0  TRAIN_CONTROL_13.BF.TX_G1_MAXF0T_G1_INDEX_RESULT_LANE_7_0
...
typedef union {
	struct {
		uint8_t TX_TRAIN_START_WAIT_TIME_LANE_7_0        : 8;	/*  [7:0]     r/w 8'h0*/
		uint8_t DFE_RES_F0A_HIGH_THRES_END_G4_LANE_7_0   : 8;	/* [15:8]     r/w 8'h28*/
		uint8_t DFE_RES_F0A_HIGH_THRES_INIT_G4_LANE_7_0  : 8;	/*[23:16]     r/w 8'h28*/
...
#define lnx_TX_TRAIN_START_WAIT_TIME_LANE_7_0  TRAIN_CONTROL_14.BF.TX_TRAIN_START_WAIT_TIME_LANE_7_0
#define lnx_DFE_RES_F0A_HIGH_THRES_END_G4_LANE_7_0  TRAIN_CONTROL_14.BF.DFE_RES_F0A_HIGH_THRES_END_G4_LANE_7_0
#define lnx_DFE_RES_F0A_HIGH_THRES_INIT_G4_LANE_7_0  TRAIN_CONTROL_14.BF.DFE_RES_F0A_HIGH_THRES_INIT_G4_LANE_7_0
