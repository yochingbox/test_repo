...
#define tag_EYE_CHK_THRESH_K    cmx_EYE_CHK_THRESH_K_3_0
#define tag_EYE_CHK_THRESH_C    cmx_EYE_CHK_THRESH_C_3_0
...
uint8_t get_ec_voltage() BANKING_CTRL {
    ...
    //else
    //{
    //    f0_min =            cds28.f0a.d_p_e;
    //    f0_min = min(f0_min,cds28.f0a.d_n_e);
    //    f0_min = min(f0_min,cds28.f0a.s_p_e);
    //    f0_min = min(f0_min,cds28.f0a.s_n_e);
    //    f0_min = min(f0_min,cds28.f0a.d_p_o);
    //    f0_min = min(f0_min,cds28.f0a.d_n_o);
    //    f0_min = min(f0_min,cds28.f0a.s_p_o);
    //    f0_min = min(f0_min,cds28.f0a.s_n_o);
    //}
...
void dc_load(uint8_t type) BANKING_CTRL
{
    ...
    if(type==1)
    {
		...
		//reg_DFE_FEXTDC_E_E_LANE_6_0   = dfe_sm_dc_e_e; //TODO
