...
void clear_xdata(void) BANKING_CTRL {
	...
	MEMORY_CONTROL_4.BT.B1 = 0x80;
	MEMORY_CONTROL_4.BT.B2 = 0x0f;
	...
	MCU_MEM_REG2_LANE.BT.B1 = 0xa0;
	//No need : reg_XDATA_ECC_1ERR_ENABLE = 1;
	//reg_XDATA_ECC_2ERR_ENABLE = 1;
	//No need : reg_PRAM_ECC_1ERR_ENABLE = 1;
	//reg_PRAM_ECC_2ERR_ENABLE = 1;
	//reg_ROM_PARITY_ERR_ENABLE = 1;
	MEMORY_CONTROL_4.BT.B1 = 0xf0; 
		
	//Step 1 : set these registers  back to 0
	...
	MEMORY_CONTROL_4.BT.B1 = 0x70;
	MEMORY_CONTROL_4.BT.B2 = 0x00;
...
*/	
    ...
    //cmx_FORCE_LCPLL_SHRTR_1 = 1; //HR: Default=0, FW workround for LCPLL unlock in 1.8V/1.5V design 
	...
	#ifdef _28G_X1 //Only Hayabusa want FW to set. Elnath set them in SOC FW.
	lnx_TX_GN1_STEP_NUM_LANE_4_0 = 6;
	lnx_TX_GN1_MIDPOINT_THRES_C_LANE_7_0 = 8;
	cmx_TX_GN1_MIDPOINT_INDEX_OS_7_0 = 2;
	
	if(cmx_RINGPLL_USE_ONLY) {
		speedtable[0][spdoft_tx_ck_sel_lane] = 1;
		speedtable[1][spdoft_tx_ck_sel_lane] = 1;
		speedtable[2][spdoft_tx_ck_sel_lane] = 1;
		speedtable[3][spdoft_tx_ck_sel_lane] = 1;
		speedtable[4][spdoft_tx_ck_sel_lane] = 1;
		speedtable[0][spdoft_rx_ck_sel_lane] = 1;
		speedtable[1][spdoft_rx_ck_sel_lane] = 1;
		speedtable[2][spdoft_rx_ck_sel_lane] = 1;
		speedtable[3][spdoft_rx_ck_sel_lane] = 1;
		speedtable[4][spdoft_rx_ck_sel_lane] = 1;
	}		
	#endif
	...
	//TODO
    //cmx_FORCE_LCPLL_SHRTR_1 = 1; //FW workround for LCPLL unlock in 1.8V 
	//cmx_SKIP_LCPLL_LOCK_CHECK = 1;
	...
	TRAIN_CONTROL_13.BT.B0 = 0x1f; //reg_EN_DFE_F8TO15_LANE control per gen, default=1

	TRAIN_CONTROL_9.BT.B1 &= 0x03; //clear train pass
	...
	#ifdef _28G_X2_B0
	cmx_TX_PDIV_DCC_MAX_7_0 = 60;
	cmx_TX_PDIV_DCC_MIN_7_0 = 3;
	#endif
}
...
void init_irq(void) BANKING_CTRL {
	...
	reg_INT8_PIN_PAPTA_TRAIN_DISABLE_INT_EN_LANE = 1;	
	#endif
	}
