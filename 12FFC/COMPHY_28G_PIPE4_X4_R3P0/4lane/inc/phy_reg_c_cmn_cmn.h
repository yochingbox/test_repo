...
typedef union {
	struct {
		...
		uint8_t RESERVED_4                               : 4;	/* [22:4]     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [22:4]     r/w   0*/
		uint8_t RESERVED_16                              : 7;	/* [22:4]     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t PIN_RESERVED_OUTPUT_15_0_b0              : 8;	/*[31:16]     r/w   0*/
		uint8_t PIN_RESERVED_OUTPUT_15_0_b1              : 8;	/*[31:16]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
...
#define reg_PIN_RESERVED_OUTPUT_15_0_b0  OUTPUT_CMN_PIN_REG0.BF.PIN_RESERVED_OUTPUT_15_0_b0
#define reg_PIN_RESERVED_OUTPUT_15_0_b1  OUTPUT_CMN_PIN_REG0.BF.PIN_RESERVED_OUTPUT_15_0_b1
#define reg_PIN_RESERVED_OUTPUT_15_0  OUTPUT_CMN_PIN_REG0.WT.W1
...
#define reg_PIN_RESERVED_INPUT_RD_15_0_b0  TEST5.BF.PIN_RESERVED_INPUT_RD_15_0_b0
#define reg_PIN_RESERVED_INPUT_RD_15_0_b1  TEST5.BF.PIN_RESERVED_INPUT_RD_15_0_b1
#define reg_TESTBUS_DBG_15_0_b0  TEST5.BF.TESTBUS_DBG_15_0_b0
#define reg_TESTBUS_DBG_15_0_b1  TEST5.BF.TESTBUS_DBG_15_0_b1
#define reg_PIN_RESERVED_INPUT_RD_15_0  TEST5.WT.W0
...
// 0x0064	ECC_ADDR_0		ECC Error Address Registers 0
typedef union {
	struct {
		uint8_t ROM_ERR_ADDR_15_0_b0                     : 8;	/* [15:0]       r   0*/
		uint8_t ROM_ERR_ADDR_15_0_b1                     : 8;	/* [15:0]       r   0*/
...
__xdata __at( 0xa364 ) volatile ECC_ADDR_0_t ECC_ADDR_0;
#define reg_ROM_ERR_ADDR_15_0_b0  ECC_ADDR_0.BF.ROM_ERR_ADDR_15_0_b0
#define reg_ROM_ERR_ADDR_15_0_b1  ECC_ADDR_0.BF.ROM_ERR_ADDR_15_0_b1
#define reg_PRAM_ECC_ERR_ADDR_15_0_b0  ECC_ADDR_0.BF.PRAM_ECC_ERR_ADDR_15_0_b0
#define reg_PRAM_ECC_ERR_ADDR_15_0_b1  ECC_ADDR_0.BF.PRAM_ECC_ERR_ADDR_15_0_b1
#define reg_ROM_ERR_ADDR_15_0  ECC_ADDR_0.WT.W0
#define reg_PRAM_ECC_ERR_ADDR_15_0  ECC_ADDR_0.WT.W1

// 0x0068	ECC_ADDR_1		ECC Error Address Registers 1
typedef union {
	struct {
...
__xdata __at( 0xa368 ) volatile ECC_ADDR_1_t ECC_ADDR_1;
#define reg_XDATA_ECC_ERR_ADDR_CMN_8_0_b0  ECC_ADDR_1.BF.XDATA_ECC_ERR_ADDR_CMN_8_0_b0
#define reg_XDATA_ECC_ERR_ADDR_CMN_8_0_b1  ECC_ADDR_1.BF.XDATA_ECC_ERR_ADDR_CMN_8_0_b1
