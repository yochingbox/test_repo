...
typedef union {
	struct {
		...
		uint8_t DFE_DC_INTERVAL_EQ_SLICE_ONLY            : 1;	/*     21     r/w   0*/
		uint8_t DFE_DC_INTERVAL_EQ_DURATION_SEL_1_0      : 2;	/*[23:22]     r/w 2'h0*/
...
#define cmx_DFE_DC_INTERVAL_EQ_SLICE_ONLY  CAL_STATUS_READ.BF.DFE_DC_INTERVAL_EQ_SLICE_ONLY
#define cmx_DFE_DC_INTERVAL_EQ_DURATION_SEL_1_0  CAL_STATUS_READ.BF.DFE_DC_INTERVAL_EQ_DURATION_SEL_1_0
...
// 0x06d8	RINGPLL_TIMER		
typedef union {
	struct {
		uint8_t RESERVED_0                               : 8;	/*  [7:0]     r/w 8'h0*/
		uint8_t RINGPLL_FDIFF_7_0                        : 8;	/* [15:8]     r/w 8'h0*/
		uint8_t RINGPLL_DAC_MIN_STEP_NUM_7_0             : 8;	/*[23:16]     r/w 8'h0*/
		uint8_t RINGPLL_TFINEDAC_7_0                     : 8;	/*[31:24]     r/w 8'h1e*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} RINGPLL_TIMER_t;
__xdata __at( 0xe6d8 ) volatile RINGPLL_TIMER_t RINGPLL_TIMER;
#define cmx_RINGPLL_FDIFF_7_0  RINGPLL_TIMER.BF.RINGPLL_FDIFF_7_0
#define cmx_RINGPLL_DAC_MIN_STEP_NUM_7_0  RINGPLL_TIMER.BF.RINGPLL_DAC_MIN_STEP_NUM_7_0
#define cmx_RINGPLL_TFINEDAC_7_0  RINGPLL_TIMER.BF.RINGPLL_TFINEDAC_7_0
