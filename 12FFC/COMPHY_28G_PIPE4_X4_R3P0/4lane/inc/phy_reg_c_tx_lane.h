...
typedef union {
	struct {
		...
		uint8_t RX_INIT_RD_LANE                          : 1;	/*     19       r   0*/
...
#define reg_PIN_RESERVED_INPUT_TX_RD_LANE_15_0_b0  PM_CTRL_TX_LANE_REG2_LANE.BF.PIN_RESERVED_INPUT_TX_RD_LANE_15_0_b0
#define reg_PIN_RESERVED_INPUT_TX_RD_LANE_15_0_b1  PM_CTRL_TX_LANE_REG2_LANE.BF.PIN_RESERVED_INPUT_TX_RD_LANE_15_0_b1
...
#define reg_PIN_RESERVED_INPUT_TX_RD_LANE_15_0  PM_CTRL_TX_LANE_REG2_LANE.WT.W0
...
typedef union {
	struct {
		...
		uint8_t PIN_RESERVED_OUTPUT_TX_LANE_15_0_b0      : 8;	/*[31:16]     r/w   0*/
		uint8_t PIN_RESERVED_OUTPUT_TX_LANE_15_0_b1      : 8;	/*[31:16]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
...
#define reg_PIN_RESERVED_OUTPUT_TX_LANE_15_0_b0  ANA_TX_RSVD_REG0.BF.PIN_RESERVED_OUTPUT_TX_LANE_15_0_b0
#define reg_PIN_RESERVED_OUTPUT_TX_LANE_15_0_b1  ANA_TX_RSVD_REG0.BF.PIN_RESERVED_OUTPUT_TX_LANE_15_0_b1
#define reg_ANA_TRX_ANA_RSVD_IN_LANE_15_0  ANA_TX_RSVD_REG0.WT.W0
#define reg_PIN_RESERVED_OUTPUT_TX_LANE_15_0  ANA_TX_RSVD_REG0.WT.W1
