...
*/	
	...
	cmx_RINGPLL_TFINEDAC_7_0 = 30;
	cmx_RINGPLL_DAC_MIN_STEP_NUM_7_0 = 1;
	cmx_RINGPLL_FDIFF_7_0 = 20;
...
void init_reg(void) BANKING_CTRL {
	...
	reg_DFE_STEP_ACCU_FX_LANE_3_0 = 0xa; //0x0a;
	reg_DFE_STEP_ACCU_DC_LANE_3_0 = 0x8; 
	reg_DFE_STEP_ACCU_F0_LANE_3_0  = 0x6; //0x06;
	//reg_DFE_STEP_ACCU_FX_LANE_3_0 = 4; //0x0a;
	//reg_DFE_STEP_ACCU_DC_LANE_3_0 = 4; 
	//reg_DFE_STEP_ACCU_F0_LANE_3_0  = 4; //0x06;
	...
	if(ENABLE_DFE_DC_WA) {
	reg_DFE_ANA_SETTLE_PATHOFF_3_0 = 15;
	reg_DFE_ANA_SETTLE_PATHSWITCH_3_0 = 15;
	reg_DFE_ANA_SETTLE_PATHON_3_0 = 15;
	}	
	#endif
