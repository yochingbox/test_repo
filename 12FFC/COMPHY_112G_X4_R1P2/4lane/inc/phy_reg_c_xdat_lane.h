...
typedef union {
	struct {
		...
		uint8_t TX_TRAIN_CODING_MODE_LANE                : 1;	/*     17     r/w   0*/
		uint8_t TX_READY_PATCH_EN_LANE                   : 1;	/*     18     r/w   0*/
		uint8_t RESERVED_19                              : 5;	/*[31:19]     r/w 13'h0*/
		uint8_t RESERVED_24                              : 8;	/*[31:19]     r/w 13'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
...
#define lnx_TX_READY_PATCH_EN_LANE  TRAIN_CONTROL_8.BF.TX_READY_PATCH_EN_LANE
