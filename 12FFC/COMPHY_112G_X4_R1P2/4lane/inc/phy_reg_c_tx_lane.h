...
typedef union {
	struct {
		...
		uint8_t RX_INIT_RD_LANE                          : 1;	/*     21       r   0*/
...
#define reg_RX_INIT_RD_LANE  PM_CTRL_TX_LANE_REG2_LANE.BF.RX_INIT_RD_LANE
...
typedef union {
	struct {
		...
		uint8_t PU_TX_LANE                               : 1;	/*      8     r/w   0*/
		uint8_t REMOTE_CTRL_FIELD_FM_REG_LANE            : 1;	/*      9     r/w   0*/
		uint8_t REMOTE_CTRL_FIELD_LANE_5_0               : 6;	/*[15:10]     r/w 6'h0*/
		uint8_t PU_PLL_FM_REG_LANE                       : 1;	/*     16     r/w   0*/
		uint8_t PU_PLL_LANE                              : 1;	/*     17     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t RESERVED_28                              : 1;	/*     28     r/w   0*/
		uint8_t COUPLE_MODE_EN_LANE                      : 1;	/*     29     r/w   0*/
		uint8_t COUPLE_MODE_EN_FM_REG_LANE               : 1;	/*     30     r/w   0*/
...
#define reg_COUPLE_MODE_EN_LANE  INPUT_TX_PIN_REG2_LANE.BF.COUPLE_MODE_EN_LANE
#define reg_COUPLE_MODE_EN_FM_REG_LANE  INPUT_TX_PIN_REG2_LANE.BF.COUPLE_MODE_EN_FM_REG_LANE
...
typedef union {
	struct {
		...
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
		uint8_t DIG_ID_LANE_7_0                          : 8;	/* [15:8]       r 8'h10*/
		uint8_t RESERVED_16                              : 1;	/*     16     r/w   0*/
...
#define reg_DIG_ID_LANE_7_0  INPUT_TX_PIN_REG3_LANE.BF.DIG_ID_LANE_7_0
...
typedef union {
	struct {
		...
		uint8_t RESERVED_6                               : 1;	/*      6     r/w   0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
		uint8_t RX2TX_W_FIFO_CNT_LANE_4_0                : 5;	/* [12:8]       r   0*/
		uint8_t RX2TX_FIFO_CNT_RD_REQ_LANE               : 1;	/*     13     r/w   1*/
		uint8_t TXDATA_PRE_CODE_MSB_LSB_SWAP_LANE        : 1;	/*     14     r/w   0*/
...
#define reg_RX2TX_W_FIFO_CNT_LANE_4_0  TX_SPEED_CONVERT_LANE.BF.RX2TX_W_FIFO_CNT_LANE_4_0
#define reg_RX2TX_FIFO_CNT_RD_REQ_LANE  TX_SPEED_CONVERT_LANE.BF.RX2TX_FIFO_CNT_RD_REQ_LANE
#define reg_TXDATA_PRE_CODE_MSB_LSB_SWAP_LANE  TX_SPEED_CONVERT_LANE.BF.TXDATA_PRE_CODE_MSB_LSB_SWAP_LANE
...
typedef union {
	struct {
		uint8_t TX_FIR_C2_LANE_5_0                       : 6;	/*  [5:0]     r/w 6'h3f*/
		uint8_t TX_FIR_C2_FORCE_LANE                     : 1;	/*      6     r/w   0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
		uint8_t TX_FIR_C1_FORCE_LANE                     : 1;	/*      8     r/w   0*/
		uint8_t TX_FIR_C1_LANE_5_0                       : 6;	/* [14:9]     r/w   0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
		uint8_t TX_FIR_C0_FORCE_LANE                     : 1;	/*     16     r/w   0*/
		uint8_t TX_FIR_C0_LANE_5_0                       : 6;	/*[22:17]     r/w   0*/
		uint8_t RESERVED_23                              : 1;	/*[27:23]     r/w   0*/
		uint8_t RESERVED_24                              : 4;	/*[27:23]     r/w   0*/
		uint8_t TX_VREF_TXDRV_SEL_FORCE_LANE             : 1;	/*     28     r/w   0*/
...
#define reg_TX_FIR_C2_LANE_5_0  TX_EMPHASIS_CONTROL0.BF.TX_FIR_C2_LANE_5_0
#define reg_TX_FIR_C2_FORCE_LANE  TX_EMPHASIS_CONTROL0.BF.TX_FIR_C2_FORCE_LANE
#define reg_TX_FIR_C1_FORCE_LANE  TX_EMPHASIS_CONTROL0.BF.TX_FIR_C1_FORCE_LANE
#define reg_TX_FIR_C1_LANE_5_0  TX_EMPHASIS_CONTROL0.BF.TX_FIR_C1_LANE_5_0
#define reg_TX_FIR_C0_FORCE_LANE  TX_EMPHASIS_CONTROL0.BF.TX_FIR_C0_FORCE_LANE
#define reg_TX_FIR_C0_LANE_5_0  TX_EMPHASIS_CONTROL0.BF.TX_FIR_C0_LANE_5_0
#define reg_TX_VREF_TXDRV_SEL_FORCE_LANE  TX_EMPHASIS_CONTROL0.BF.TX_VREF_TXDRV_SEL_FORCE_LANE
...
typedef union {
	struct {
		...
		uint8_t TX_FIR_C5_FORCE_LANE                     : 1;	/*      9     r/w   0*/
		uint8_t TX_FIR_C5_LANE_5_0                       : 6;	/*[15:10]     r/w   0*/
		uint8_t TX_FIR_C4_LANE_5_0                       : 6;	/*[21:16]     r/w   0*/
		uint8_t RESERVED_22                              : 2;	/*[23:22]     r/w   0*/
		uint8_t TX_FIR_C3_LANE_5_0                       : 6;	/*[29:24]     r/w   0*/
		uint8_t TX_FIR_C4_FORCE_LANE                     : 1;	/*     30     r/w   0*/
		uint8_t TX_FIR_C3_FORCE_LANE                     : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
#define reg_TX_FIR_C5_FORCE_LANE  TX_EMPHASIS_CONTROL1.BF.TX_FIR_C5_FORCE_LANE
#define reg_TX_FIR_C5_LANE_5_0  TX_EMPHASIS_CONTROL1.BF.TX_FIR_C5_LANE_5_0
#define reg_TX_FIR_C4_LANE_5_0  TX_EMPHASIS_CONTROL1.BF.TX_FIR_C4_LANE_5_0
#define reg_TX_FIR_C3_LANE_5_0  TX_EMPHASIS_CONTROL1.BF.TX_FIR_C3_LANE_5_0
#define reg_TX_FIR_C4_FORCE_LANE  TX_EMPHASIS_CONTROL1.BF.TX_FIR_C4_FORCE_LANE
#define reg_TX_FIR_C3_FORCE_LANE  TX_EMPHASIS_CONTROL1.BF.TX_FIR_C3_FORCE_LANE
...
typedef union {
	struct {
		...
		uint8_t RESERVED_6                               : 1;	/*      6     r/w   0*/
		uint8_t RESERVED_7                               : 1;	/*      7     r/w   0*/
		uint8_t SSC_AMP_LANE_6_0                         : 7;	/* [14:8]     r/w   0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
...
#define reg_SSC_AMP_LANE_6_0  DTX_REG1.BF.SSC_AMP_LANE_6_0
...
typedef union {
	struct {
		...
		uint8_t RESERVED_22                              : 1;	/*     22     r/w   0*/
		uint8_t RESERVED_23                              : 1;	/*     23     r/w   0*/
		uint8_t RX2TX_RATIO_LANE_2_0                     : 3;	/*[26:24]     r/w   0*/
		uint8_t RX2TX_RATIO_FORCE_LANE                   : 1;	/*     27     r/w   0*/
		uint8_t RESERVED_28                              : 1;	/*     28     r/w   0*/
		uint8_t RESERVED_29                              : 1;	/*     29     r/w   0*/
		uint8_t RESERVED_30                              : 1;	/*     30     r/w   0*/
		uint8_t RESERVED_31                              : 1;	/*     31     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t LCPLL_TEMPC_DAC_MAX_MIN_OVERWRITE_LANE   : 1;	/*     26     r/w   0*/
...
#define reg_LCPLL_TEMPC_DAC_MAX_MIN_OVERWRITE_LANE  LCPLL_TEMPC_CALL_REG0.BF.LCPLL_TEMPC_DAC_MAX_MIN_OVERWRITE_LANE
