...
typedef union {
	struct {
		...
		uint8_t DFE_CRO0_FIX_LANE                        : 1;	/*      7     r/w   1*/
...
typedef union {
	struct {
		...
		uint8_t DFE_F2_THRESH_TUNE_LANE_5_0              : 6;	/*[29:24]     r/w 6'h0*/
		uint8_t RESERVED_30                              : 2;	/*[31:30]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
...
typedef union {
	struct {
		...
		uint8_t DFE_ANA_SETTLE_PATHON_LANE_6_0_b0        : 4;	/*[26:20]     r/w 7'h8*/
		uint8_t DFE_ANA_SETTLE_PATHON_LANE_6_0_b1        : 3;	/*[26:20]     r/w 7'h8*/
		uint8_t DFE_ANA_SETTLE_PATHOFF_LANE_3_0          : 4;	/*[30:27]     r/w 4'h8*/
...
#define reg_DFE_ANA_SETTLE_PATHON_LANE_6_0_b0  DFE_STATIC_REG1.BF.DFE_ANA_SETTLE_PATHON_LANE_6_0_b0
#define reg_DFE_ANA_SETTLE_PATHON_LANE_6_0_b1  DFE_STATIC_REG1.BF.DFE_ANA_SETTLE_PATHON_LANE_6_0_b1
