...
typedef union {
	struct {
		...
		uint8_t MCU_INT0_EN_LANE                         : 1;	/*     13     r/w   1*/
		uint8_t MCU_INT1_EN_LANE                         : 1;	/*     14     r/w   1*/
		uint8_t MCU_INT2_EN_LANE                         : 1;	/*     15     r/w   1*/
		uint8_t MCU_INT3_EN_LANE                         : 1;	/*     16     r/w   1*/
		uint8_t MCU_INT4_EN_LANE                         : 1;	/*     17     r/w   1*/
		uint8_t MCU_INT5_EN_LANE                         : 1;	/*     18     r/w   1*/
		uint8_t MCU_INT6_EN_LANE                         : 1;	/*     19     r/w   1*/
		uint8_t MCU_INT7_EN_LANE                         : 1;	/*     20     r/w   1*/
		uint8_t MCU_INT8_EN_LANE                         : 1;	/*     21     r/w   1*/
		uint8_t MCU_INT9_EN_LANE                         : 1;	/*     22     r/w   1*/
		uint8_t MCU_INT10_EN_LANE                        : 1;	/*     23     r/w   1*/
		uint8_t MCU_INT11_EN_LANE                        : 1;	/*     24     r/w   1*/
		uint8_t MCU_INT12_EN_LANE                        : 1;	/*     25     r/w   1*/
		uint8_t PIN_PHY_INT_EN_LANE                      : 1;	/*     26     r/w   1*/
...
// 0x0014	MCU_SYNC1		MCU Sync 1
typedef union {
	struct {
		uint8_t MCU_LOCAL_COMMAND_LANE_7_0               : 8;	/*  [7:0]     r/w   0*/
		uint8_t MCU_LOCAL_REQ_LANE                       : 1;	/*      8     r/w   0*/
		uint8_t RESERVED_9                               : 7;	/* [15:9]     r/w   0*/
		uint8_t MCU_LOCAL_STATUS_LANE_7_0                : 8;	/*[23:16]     r/w   0*/
		uint8_t MCU_LOCAL_ACK_LANE                       : 1;	/*     24     r/w   0*/
		uint8_t RESERVED_25                              : 7;	/*[31:25]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} MCU_SYNC1_t;
__xdata __at( 0x2214 ) volatile MCU_SYNC1_t MCU_SYNC1;
#define reg_MCU_LOCAL_COMMAND_LANE_7_0  MCU_SYNC1.BF.MCU_LOCAL_COMMAND_LANE_7_0
#define reg_MCU_LOCAL_REQ_LANE  MCU_SYNC1.BF.MCU_LOCAL_REQ_LANE
#define reg_MCU_LOCAL_STATUS_LANE_7_0  MCU_SYNC1.BF.MCU_LOCAL_STATUS_LANE_7_0
#define reg_MCU_LOCAL_ACK_LANE  MCU_SYNC1.BF.MCU_LOCAL_ACK_LANE

// 0x0018	MCU_SYNC2		MCU Sync 2
typedef union {
	struct {
		uint8_t MCU_REMOTE_COMMAND_RD_LANE_7_0           : 8;	/*  [7:0]       r   0*/
		uint8_t MCU_REMOTE_REQ_RD_LANE                   : 1;	/*      8       r   0*/
		uint8_t RESERVED_9                               : 7;	/* [15:9]     r/w   0*/
		uint8_t MCU_REMOTE_STATUS_RD_LANE_7_0            : 8;	/*[23:16]       r   0*/
		uint8_t MCU_REMOTE_ACK_RD_LANE                   : 1;	/*     24       r   0*/
		uint8_t RESERVED_25                              : 7;	/*[31:25]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} MCU_SYNC2_t;
__xdata __at( 0x2218 ) volatile MCU_SYNC2_t MCU_SYNC2;
#define reg_MCU_REMOTE_COMMAND_RD_LANE_7_0  MCU_SYNC2.BF.MCU_REMOTE_COMMAND_RD_LANE_7_0
#define reg_MCU_REMOTE_REQ_RD_LANE  MCU_SYNC2.BF.MCU_REMOTE_REQ_RD_LANE
#define reg_MCU_REMOTE_STATUS_RD_LANE_7_0  MCU_SYNC2.BF.MCU_REMOTE_STATUS_RD_LANE_7_0
#define reg_MCU_REMOTE_ACK_RD_LANE  MCU_SYNC2.BF.MCU_REMOTE_ACK_RD_LANE

// 0x001c	MCU_SYNC3		MCU Sync 3
typedef union {
	struct {
		uint8_t MCU_REMOTE_COMMAND_LANE_7_0              : 8;	/*  [7:0]     r/w   0*/
		uint8_t MCU_REMOTE_REQ_LANE                      : 1;	/*      8     r/w   0*/
		uint8_t RESERVED_9                               : 7;	/* [15:9]     r/w   0*/
		uint8_t MCU_REMOTE_STATUS_LANE_7_0               : 8;	/*[23:16]     r/w   0*/
		uint8_t MCU_REMOTE_ACK_LANE                      : 1;	/*     24     r/w   0*/
		uint8_t MCU_REMOTE_ACK_FM_REG_LANE               : 1;	/*     25     r/w   0*/
		uint8_t MCU_REMOTE_COMMAND_FM_REG_LANE           : 1;	/*     26     r/w   0*/
		uint8_t MCU_REMOTE_REQ_FM_REG_LANE               : 1;	/*     27     r/w   0*/
		uint8_t MCU_REMOTE_STATUS_FM_REG_LANE            : 1;	/*     28     r/w   0*/
		uint8_t RESERVED_29                              : 3;	/*[31:29]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} MCU_SYNC3_t;
__xdata __at( 0x221c ) volatile MCU_SYNC3_t MCU_SYNC3;
#define reg_MCU_REMOTE_COMMAND_LANE_7_0  MCU_SYNC3.BF.MCU_REMOTE_COMMAND_LANE_7_0
#define reg_MCU_REMOTE_REQ_LANE  MCU_SYNC3.BF.MCU_REMOTE_REQ_LANE
#define reg_MCU_REMOTE_STATUS_LANE_7_0  MCU_SYNC3.BF.MCU_REMOTE_STATUS_LANE_7_0
#define reg_MCU_REMOTE_ACK_LANE  MCU_SYNC3.BF.MCU_REMOTE_ACK_LANE
#define reg_MCU_REMOTE_ACK_FM_REG_LANE  MCU_SYNC3.BF.MCU_REMOTE_ACK_FM_REG_LANE
#define reg_MCU_REMOTE_COMMAND_FM_REG_LANE  MCU_SYNC3.BF.MCU_REMOTE_COMMAND_FM_REG_LANE
#define reg_MCU_REMOTE_REQ_FM_REG_LANE  MCU_SYNC3.BF.MCU_REMOTE_REQ_FM_REG_LANE
#define reg_MCU_REMOTE_STATUS_FM_REG_LANE  MCU_SYNC3.BF.MCU_REMOTE_STATUS_FM_REG_LANE

// 0x0020	MCU_SYNC4		MCU Sync 4
typedef union {
	struct {
		uint8_t MCU_REMOTE_REQ_ISR_LANE                  : 1;	/*      0     r/w   0*/
		uint8_t MCU_REMOTE_ACK_ISR_LANE                  : 1;	/*      1     r/w   0*/
...
__xdata __at( 0x2220 ) volatile MCU_SYNC4_t MCU_SYNC4;
#define reg_MCU_REMOTE_REQ_ISR_LANE  MCU_SYNC4.BF.MCU_REMOTE_REQ_ISR_LANE
#define reg_MCU_REMOTE_ACK_ISR_LANE  MCU_SYNC4.BF.MCU_REMOTE_ACK_ISR_LANE

// 0x0024	MCU_SYNC5		MCU Sync 5
typedef union {
	struct {
		uint8_t MCU_REMOTE_REQ_MASK_LANE                 : 1;	/*      0     r/w   0*/
		uint8_t MCU_REMOTE_ACK_MASK_LANE                 : 1;	/*      1     r/w   0*/
		uint8_t RESERVED_2                               : 6;	/* [31:2]     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [31:2]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/* [31:2]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/* [31:2]     r/w   0*/
...
__xdata __at( 0x2224 ) volatile MCU_SYNC5_t MCU_SYNC5;
#define reg_MCU_REMOTE_REQ_MASK_LANE  MCU_SYNC5.BF.MCU_REMOTE_REQ_MASK_LANE
#define reg_MCU_REMOTE_ACK_MASK_LANE  MCU_SYNC5.BF.MCU_REMOTE_ACK_MASK_LANE

// 0x0028	MCU_SYNC6		MCU Sync 4
typedef union {
	struct {
		uint8_t MCU_REMOTE_REQ_ISR_CLEAR_LANE            : 1;	/*      0     r/w   0*/
		uint8_t MCU_REMOTE_ACK_ISR_CLEAR_LANE            : 1;	/*      1     r/w   0*/
		uint8_t RESERVED_2                               : 6;	/* [31:2]     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [31:2]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/* [31:2]     r/w   0*/
		uint8_t RESERVED_24                              : 8;	/* [31:2]     r/w   0*/
...
__xdata __at( 0x2228 ) volatile MCU_SYNC6_t MCU_SYNC6;
#define reg_MCU_REMOTE_REQ_ISR_CLEAR_LANE  MCU_SYNC6.BF.MCU_REMOTE_REQ_ISR_CLEAR_LANE
#define reg_MCU_REMOTE_ACK_ISR_CLEAR_LANE  MCU_SYNC6.BF.MCU_REMOTE_ACK_ISR_CLEAR_LANE
...
typedef union {
	struct {
		...
		uint8_t INT0_MCU_REMOTE_REQ_INT_EN_LANE          : 1;	/*     30     r/w   0*/
		uint8_t INT0_MCU_REMOTE_ACK_INT_EN_LANE          : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} MCU_INT0_CONTROL_t;
...
typedef union {
	struct {
		...
		uint8_t INT1_MCU_REMOTE_REQ_INT_EN_LANE          : 1;	/*     30     r/w   0*/
		uint8_t INT1_MCU_REMOTE_ACK_INT_EN_LANE          : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} MCU_INT1_CONTROL_t;
...
typedef union {
	struct {
		...
		uint8_t INT2_MCU_REMOTE_REQ_INT_EN_LANE          : 1;	/*     30     r/w   0*/
		uint8_t INT2_MCU_REMOTE_ACK_INT_EN_LANE          : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} MCU_INT2_CONTROL_t;
...
typedef union {
	struct {
		...
		uint8_t INT3_MCU_REMOTE_REQ_INT_EN_LANE          : 1;	/*     30     r/w   0*/
		uint8_t INT3_MCU_REMOTE_ACK_INT_EN_LANE          : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} MCU_INT3_CONTROL_t;
...
typedef union {
	struct {
		...
		uint8_t INT4_MCU_REMOTE_REQ_INT_EN_LANE          : 1;	/*     30     r/w   0*/
		uint8_t INT4_MCU_REMOTE_ACK_INT_EN_LANE          : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} MCU_INT4_CONTROL_t;
...
typedef union {
	struct {
		...
		uint8_t INT5_MCU_REMOTE_REQ_INT_EN_LANE          : 1;	/*     30     r/w   0*/
		uint8_t INT5_MCU_REMOTE_ACK_INT_EN_LANE          : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} MCU_INT5_CONTROL_t;
...
typedef union {
	struct {
		...
		uint8_t INT6_MCU_REMOTE_REQ_INT_EN_LANE          : 1;	/*     30     r/w   0*/
		uint8_t INT6_MCU_REMOTE_ACK_INT_EN_LANE          : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} MCU_INT6_CONTROL_t;
...
typedef union {
	struct {
		...
		uint8_t INT7_MCU_REMOTE_REQ_INT_EN_LANE          : 1;	/*     30     r/w   0*/
		uint8_t INT7_MCU_REMOTE_ACK_INT_EN_LANE          : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} MCU_INT7_CONTROL_t;
...
typedef union {
	struct {
		...
		uint8_t INT8_MCU_REMOTE_REQ_INT_EN_LANE          : 1;	/*     30     r/w   0*/
		uint8_t INT8_MCU_REMOTE_ACK_INT_EN_LANE          : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} MCU_INT8_CONTROL_t;
...
typedef union {
	struct {
		...
		uint8_t INT9_MCU_REMOTE_REQ_INT_EN_LANE          : 1;	/*     30     r/w   0*/
		uint8_t INT9_MCU_REMOTE_ACK_INT_EN_LANE          : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} MCU_INT9_CONTROL_t;
...
typedef union {
	struct {
		...
		uint8_t INT10_MCU_REMOTE_REQ_INT_EN_LANE         : 1;	/*     30     r/w   0*/
		uint8_t INT10_MCU_REMOTE_ACK_INT_EN_LANE         : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} MCU_INT10_CONTROL_t;
...
typedef union {
	struct {
		...
		uint8_t INT11_MCU_REMOTE_REQ_INT_EN_LANE         : 1;	/*     30     r/w   0*/
		uint8_t INT11_MCU_REMOTE_ACK_INT_EN_LANE         : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} MCU_INT11_CONTROL_t;
...
typedef union {
	struct {
		...
		uint8_t INT12_MCU_REMOTE_REQ_INT_EN_LANE         : 1;	/*     30     r/w   0*/
		uint8_t INT12_MCU_REMOTE_ACK_INT_EN_LANE         : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} MCU_INT12_CONTROL_t;
...
typedef union {
	struct {
		...
		uint8_t EXTINT_MCU_REMOTE_REQ_INT_EN_LANE        : 1;	/*     30     r/w   0*/
		uint8_t EXTINT_MCU_REMOTE_ACK_INT_EN_LANE        : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} EXT_INT_CONTROL_t;
