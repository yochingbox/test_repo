...
#define tag_PHASE_CONFIG_EN_HR (lnx_MCU_RESERVEDX10_LANE_7_0>>3&0x1)
#define tag_PHASE_F0B_HYST_LOW_HR	(tag_PHASE_CONFIG_EN_HR?(lnx_MCU_RESERVEDX08_LANE_7_0>>4&0xf):2)
#define tag_PHASE_F0B_HYST_HIGH_HR	(tag_PHASE_CONFIG_EN_HR?(lnx_MCU_RESERVEDX08_LANE_7_0&0xf):10)
#define tag_PHASE_F1_THRS3_HR		(tag_PHASE_CONFIG_EN_HR?(lnx_MCU_RESERVEDX09_LANE_7_0>>4&0xf):3)
#define tag_PHASE_F1_THRS1_HR		(tag_PHASE_CONFIG_EN_HR?(lnx_MCU_RESERVEDX09_LANE_7_0&0xf):1)
#define tag_PHASE_ADAPT_LPNUM_HR	(tag_PHASE_CONFIG_EN_HR?lnx_MCU_RESERVEDX0A_LANE_7_0:8)
#define tag_PHASE_TIMER_HR (tag_PHASE_CONFIG_EN?lnx_MCU_RESERVEDX0B_LANE_7_0:50) // ms

// 25G
#define tag_PHASE_EN_25G (lnx_MCU_RESERVEDX10_LANE_7_0>>6&0x1)
#define tag_PHASE_CONFIG_EN_25G (lnx_MCU_RESERVEDX10_LANE_7_0>>7&0x1)
#define tag_PHASE_F0B_HYST_LOW_25G	(tag_PHASE_CONFIG_EN_25G?(lnx_MCU_RESERVEDX0C_LANE_7_0>>4&0xf):2)
#define tag_PHASE_F0B_HYST_HIGH_25G	(tag_PHASE_CONFIG_EN_25G?(lnx_MCU_RESERVEDX0C_LANE_7_0&0xf):10)
#define tag_PHASE_F1_THRS3_25G		(tag_PHASE_CONFIG_EN_25G?(lnx_MCU_RESERVEDX0D_LANE_7_0>>4&0xf):3)
#define tag_PHASE_F1_THRS1_25G		(tag_PHASE_CONFIG_EN_25G?(lnx_MCU_RESERVEDX0D_LANE_7_0&0xf):1)
#define tag_PHASE_ADAPT_LPNUM_25G	(tag_PHASE_CONFIG_EN_25G?lnx_MCU_RESERVEDX0E_LANE_7_0:8)
#define tag_PHASE_TIMER_25G (tag_PHASE_CONFIG_EN_25G?lnx_MCU_RESERVEDX0F_LANE_7_0:50) // ms

#define tag_NEVER_CTLE_BYPASS1 (lnx_TRAIN_DEBUG3_LANE_7_0>>6&0x1)
#define tag_STOP_DFE_CONT_AFTER_TRAIN (lnx_TRAIN_DEBUG3_LANE_7_0>>5&0x1)
#define tag_SINGLE_RX_TRAIN_FOR_TX_TRAIN (lnx_TRAIN_DEBUG3_LANE_7_0>>4&0x1)
#define tag_NO_CONTROL_BITS_BY_TESTBUS (lnx_TRAIN_DEBUG3_LANE_7_0>>3&0x1)
...
#define lane_align_poffset_rate1 (lnx_MCU_RESERVEDX08_LANE_7_0&0x7f)
...
extern __xdata uint8_t __at(0xe700) mcu_request_lane[4];
//~e703
extern __xdata uint8_t __at(0xe704) mcu_response_status[4];
//~e707
extern __xdata uint16_t __at(0xe708) mcu_response_data[4];
//~e70f
extern __xdata uint8_t __at(0xe710) mcuclk_mc;
extern __xdata uint8_t __at(0xe714) tsen_state;
...
#define sweep_r_without_dfe_tap_mode_change_rd (cmx_MCU_DEBUG_CMN_22_7_0>>6&0x1)

// cmx_MCU_DEBUG_CMN_23_7_0 reserved for lower bits of TSEN_DAT

#define ber_indicator_factor_25g cmx_MCU_DEBUG_CMN_24_7_0
