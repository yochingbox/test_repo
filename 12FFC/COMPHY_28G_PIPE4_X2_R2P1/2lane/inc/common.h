...
#define TEMP_COMP_TBL_UPD_EN                          (reg_MCU_DEBUG_CMN_6_7_0 & 0x02)
...
#define PowerUp_Seq_Simple() PowerUp_Seq_Test()
	...
	void dfe_hardware_cont_run_ram(void) RXINIT_BANK ;
...
#if NEW_EOM_ALG 
	void cdr_phase_midpoint_new() BANKING_CTRL;
