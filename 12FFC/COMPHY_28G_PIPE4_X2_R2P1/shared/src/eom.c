	...
	{	
		...
		do{
			...
			for (i =0; i<2; i++)
			{
                ...
                lnx_EOM_POP_P_CNT_LANE_39_32 = lnx_EOM_POP_P_CNT_LANE_39_32 + (i==0? reg_EOM_VLD_CNT_MSB_P_E_LANE_7_0 : reg_EOM_VLD_CNT_MSB_P_O_LANE_7_0); //RMB: Fixed EOM fail after lane margin ??
                ...
                lnx_EOM_POP_N_CNT_LANE_39_32 = lnx_EOM_POP_N_CNT_LANE_39_32 + (i==0? reg_EOM_VLD_CNT_MSB_N_E_LANE_7_0 : reg_EOM_VLD_CNT_MSB_N_O_LANE_7_0); //RMB: Fixed EOM fail after lane margin ??
			}
