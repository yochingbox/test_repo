...
void pll_clk_ready_1_ram(void) BANKING_CTRL { // //ana_pll_clk_ready**=1
	//delay01(20);
...
void pll_clk_ready_0_ram(void) BANKING_CTRL { //ana_pll_clk_ready lc=0
...
void pll_clk_ready_all_0_ram(void) BANKING_CTRL { //ana_pll_clk_ready**=0
	reg_ANA_PLL_CLK_READY = 0; 
	reg_ANA_PLL_CLK_READY_PRE1 =0;
	reg_ANA_PLL_CLK_READY_PRE0 = 0;
	reg_ANA_PLL_CLK_READY_PRE0_RING = 0;
