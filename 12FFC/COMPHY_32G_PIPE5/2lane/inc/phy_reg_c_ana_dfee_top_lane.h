...
// 0x1e	ANA_DFEE_REG_1E		Analog_dfee_related_register_1e
typedef union {
	struct {
...
// 0x1f	ANA_DFEE_REG_1F		Analog_dfee_related_register_1f
typedef union {
	struct {
...
// 0x20	ANA_DFEE_REG_20		Analog_dfee_related_register_20
typedef union {
	struct {
...
// 0x21	ANA_DFEE_REG_21		Analog_dfee_related_register_21
typedef union {
	struct {
...
// 0x22	ANA_DFEE_REG_22		Analog_dfee_related_register_22
typedef union {
	struct {
...
// 0x23	ANA_DFEE_REG_23		Analog_dfee_related_register_23
typedef union {
	struct {
...
// 0x24	ANA_DFEE_REG_24		Analog_dfee_related_register_24
typedef union {
	struct {
...
// 0x25	ANA_DFEE_REG_25		Analog_dfee_related_register_25
typedef union {
	struct {
...
// 0x26	ANA_DFEE_REG_26		Analog_dfee_related_register_26
typedef union {
	struct {
...
// 0x27	ANA_DFEE_REG_27		Analog_dfee_related_register_27
typedef union {
	struct {
