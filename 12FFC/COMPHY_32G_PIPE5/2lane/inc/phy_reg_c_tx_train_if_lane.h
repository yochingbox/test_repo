...
typedef union {
	struct {
		...
		uint8_t STATUS_DETECT_TIMEOUT_LANE               : 1;	/*     11       r   0*/
		uint8_t RESERVED_12                              : 1;	/*     12     r/w   0*/
		uint8_t RESERVED_13                              : 1;	/*     13     r/w   0*/
		uint8_t RESERVED_14                              : 1;	/*     14     r/w   0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
...
// 0x0050	LINK_TRAIN_MODE0		Link Train Mode 0
typedef union {
	struct {
...
// 0x0078	TX_TRAIN_CTRL_LANE		Tx Train Control Lane
typedef union {
	struct {
		uint8_t PIN_PAPTA_TRAIN_ENABLE_RD_LANE           : 1;	/*      0       r   0*/
		uint8_t TX_TRAIN_COMP_WAIT_CNT_LOCAL_ONLY_LANE   : 1;	/*      1     r/w   0*/
		uint8_t REMOTE_TRAIN_COMP_LANE                   : 1;	/*      2     r/w   0*/
		uint8_t REMOTE_CTRL_FIELD_READY_LANE             : 1;	/*      3     r/w   0*/
		uint8_t TX_TRAIN_COMP_WAIT_FRAME_LANE_6_0_b0     : 4;	/* [10:4]     r/w 7'h3*/
		uint8_t TX_TRAIN_COMP_WAIT_FRAME_LANE_6_0_b1     : 3;	/* [10:4]     r/w 7'h3*/
		uint8_t TX_TRAIN_MAX_TIMER_FRAME_LOCK_LANE       : 1;	/*     11     r/w   0*/
		uint8_t FRAME_DET_TIMEOUT_EN_LANE                : 1;	/*     12     r/w   1*/
		...
		uint8_t FRAME_DET_LOCK_FIRST_EN_LANE             : 1;	/*     18     r/w   1*/
		uint8_t RESERVED_19                              : 2;	/*[20:19]     r/w   0*/
...
#define reg_TX_TRAIN_COMP_WAIT_CNT_LOCAL_ONLY_LANE  TX_TRAIN_CTRL_LANE.BF.TX_TRAIN_COMP_WAIT_CNT_LOCAL_ONLY_LANE
...
#define reg_TX_TRAIN_COMP_WAIT_FRAME_LANE_6_0_b0  TX_TRAIN_CTRL_LANE.BF.TX_TRAIN_COMP_WAIT_FRAME_LANE_6_0_b0
#define reg_TX_TRAIN_COMP_WAIT_FRAME_LANE_6_0_b1  TX_TRAIN_CTRL_LANE.BF.TX_TRAIN_COMP_WAIT_FRAME_LANE_6_0_b1
#define reg_TX_TRAIN_MAX_TIMER_FRAME_LOCK_LANE  TX_TRAIN_CTRL_LANE.BF.TX_TRAIN_MAX_TIMER_FRAME_LOCK_LANE
#define reg_FRAME_DET_TIMEOUT_EN_LANE  TX_TRAIN_CTRL_LANE.BF.FRAME_DET_TIMEOUT_EN_LANE
...
#define reg_FRAME_DET_LOCK_FIRST_EN_LANE  TX_TRAIN_CTRL_LANE.BF.FRAME_DET_LOCK_FIRST_EN_LANE
