...
// 0x0004	RX_SYSTEM_LANE		Rx System Lane
typedef union {
	struct {
...
#define reg_TRAIN_PAT_NUM_LANE_9_0_b0  FRAME_SYNC_DET_REG1.BF.TRAIN_PAT_NUM_LANE_9_0_b0
#define reg_TRAIN_PAT_NUM_LANE_9_0_b1  FRAME_SYNC_DET_REG1.BF.TRAIN_PAT_NUM_LANE_9_0_b1
...
// 0x0050	RX_CALIBRATION_REG		Rx Calibration
typedef union {
	struct {
		uint8_t RESERVED_0                               : 1;	/*      0     r/w   0*/
		uint8_t RESERVED_1                               : 1;	/*      1     r/w   0*/
