...
// 0x060c	CONTROL_CONFIG2		Calibration Configuration 2
typedef union {
	struct {
...
// 0x0610	CONTROL_CONFIG3		Calibration Configuration 3
typedef union {
	struct {
...
// 0x0614	CONTROL_CONFIG4		Calibration Configuration 4
typedef union {
	struct {
...
// 0x0618	CONTROL_CONFIG5		Calibration Configuration 5
typedef union {
	struct {
...
// 0x061c	CONTROL_CONFIG6		Calibration Configuration 6
typedef union {
	struct {
...
// 0x0620	CONTROL_CONFIG7		Calibration Configuration 7
typedef union {
	struct {
...
typedef union {
	struct {
		...
		uint8_t TX_TRAIN_MODE                            : 1;	/*      1     r/w   1*/
...
#define cmx_TX_TRAIN_MODE  TRAIN_IF_CONFIG.BF.TX_TRAIN_MODE
...
// 0x062c	CONTROL_CONFIG8		Calibration Configuration 8
typedef union {
	struct {
...
// 0x0630	CONTROL_CONFIG9		Calibration Configuration 9
typedef union {
	struct {
		uint8_t RESERVED_0                               : 1;	/*      0     r/w   0*/
		uint8_t RESERVED_1                               : 1;	/*      1     r/w   0*/
...
// 0x0634	CON_CAL_STEP_SIZE1		Continuous Calibration Step Size 1
typedef union {
	struct {
...
// 0x0638	CON_CAL_STEP_SIZE2		Continuous Calibration Step Size 2
typedef union {
	struct {
...
// 0x063c	CON_CAL_STEP_SIZE3		Continuous Calibration Step Size 3
typedef union {
	struct {
...
// 0x0640	CON_CAL_STEP_SIZE4		Continuous Calibration Step Size 4
typedef union {
	struct {
...
// 0x0644	CON_CAL_STEP_SIZE5		Continuous Calibration Step Size 5
typedef union {
	struct {
...
// 0x0648	CAL_TIME_OUT_AND_DIS		Calibration Timeout Disable
typedef union {
	struct {
...
// 0x0650	MCU_CONFIG		MCU Configuration 0
typedef union {
	struct {
...
// 0x0654	CAL_DATA1		Firmware Calibration Result 1
typedef union {
	struct {
...
// 0x065c	MCU_CONFIG1		MCU Configuration 1
typedef union {
	struct {
...
// 0x0660	TIMER_SEL1		Firmware Timer Select 1
typedef union {
	struct {
...
// 0x0664	TIMER_SEL2		Firmware Timer Select 2
typedef union {
	struct {
...
// 0x0668	TIMER_SEL3		Firmware Timer Select 3
typedef union {
	struct {
...
// 0x066c	G_SELLV_TXCLK		Firmware Voltage Reference For Clock
typedef union {
	struct {
...
// 0x0670	G_SELLV_TXDATA		Firmware Voltage Reference For Data
typedef union {
	struct {
...
// 0x0674	G_SELLV_TXPRE		Firmware Voltage Reference For Txpre
typedef union {
	struct {
...
// 0x0678	G_SELLV_RXEOMCLK		Firmware Voltage Reference For Rx EOM Clock
typedef union {
	struct {
...
// 0x067c	G_SELLV_RXDATACLK		Firmware Voltage Reference For Rx Data Clock
typedef union {
	struct {
...
// 0x0680	G_SELLV_RXSAMPLER		Firmware Voltage Reference For Rx Sampler
typedef union {
	struct {
...
// 0x0684	SAS_PRESET0_TB		SAS Preset 0
typedef union {
	struct {
...
// 0x0688	SAS_PRESET1_TB		SAS Preset 1
typedef union {
	struct {
...
// 0x068c	SAS_PRESET2_TB		SAS Preset 2
typedef union {
	struct {
...
// 0x0690	ETH_PRESET0_TB		Ethernet Preset 0
typedef union {
	struct {
...
// 0x0694	ETH_PRESET1_TB		Ethernet Preset 1
typedef union {
	struct {
...
// 0x0698	TX_SAVE_0		Firmware Tx Save 0
typedef union {
	struct {
...
// 0x069c	TX_SAVE_1		Firmware Tx Save 1
typedef union {
	struct {
...
// 0x06a0	TX_SAVE_2		Firmware Tx Save 2
typedef union {
	struct {
...
// 0x06a4	TX_SAVE_3		Firmware Tx Save 3
typedef union {
	struct {
...
// 0x06a8	TX_SAVE_4		Firmware Tx Save 4
typedef union {
	struct {
...
// 0x06ac	CDS_EYE_CLK_THR		CDS EYE Check Threshold
typedef union {
	struct {
...
// 0x06b0	LOCAL_TX_PRESET_TB0		Firmware Local Tx Preset 0
typedef union {
	struct {
...
// 0x06b4	LOCAL_TX_PRESET_TB1		Firmware Local Tx Preset 1
typedef union {
	struct {
		uint8_t RESERVED_0                               : 4;	/*  [3:0]     r/w   0*/
...
// 0x06b8	LOCAL_TX_PRESET_TB2		Firmware Local Tx Preset 2
typedef union {
	struct {
		uint8_t RESERVED_0                               : 4;	/*  [3:0]     r/w   0*/
...
// 0x06bc	LOCAL_TX_PRESET_TB3		Firmware Local Tx Preset 3
typedef union {
	struct {
		uint8_t RESERVED_0                               : 4;	/*  [3:0]     r/w   0*/
...
__xdata __at( 0xe6bc ) volatile LOCAL_TX_PRESET_TB3_t LOCAL_TX_PRESET_TB3;
...
// 0x06c0	LOCAL_TX_PRESET_TB4		Firmware Local Tx Preset 4
typedef union {
	struct {
		uint8_t RESERVED_0                               : 4;	/*  [3:0]     r/w   0*/
...
__xdata __at( 0xe6c0 ) volatile LOCAL_TX_PRESET_TB4_t LOCAL_TX_PRESET_TB4;
...
// 0x06c4	LOCAL_TX_PRESET_TB5		Firmware Local Tx Preset 5
typedef union {
	struct {
		uint8_t RESERVED_0                               : 4;	/*  [3:0]     r/w   0*/
...
__xdata __at( 0xe6c4 ) volatile LOCAL_TX_PRESET_TB5_t LOCAL_TX_PRESET_TB5;
...
// 0x06c8	RXINIT_DELAY_0		Firmware Rxinit Delay 0
typedef union {
	struct {
...
__xdata __at( 0xe6c8 ) volatile RXINIT_DELAY_0_t RXINIT_DELAY_0;
...
// 0x06cc	SYNC_INFO		MCU sync info
typedef union {
	struct {
		uint8_t MCU_COMMAND_ALL0_LANE_31_0_b0            : 8;	/* [31:0]     r/w 32'h0*/
		uint8_t MCU_COMMAND_ALL0_LANE_31_0_b1            : 8;	/* [31:0]     r/w 32'h0*/
		uint8_t MCU_COMMAND_ALL0_LANE_31_0_b2            : 8;	/* [31:0]     r/w 32'h0*/
		uint8_t MCU_COMMAND_ALL0_LANE_31_0_b3            : 8;	/* [31:0]     r/w 32'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} SYNC_INFO_t;
__xdata __at( 0xe6cc ) volatile SYNC_INFO_t SYNC_INFO;
#define cmx_MCU_COMMAND_ALL0_LANE_31_0_b0  SYNC_INFO.BF.MCU_COMMAND_ALL0_LANE_31_0_b0
#define cmx_MCU_COMMAND_ALL0_LANE_31_0_b1  SYNC_INFO.BF.MCU_COMMAND_ALL0_LANE_31_0_b1
#define cmx_MCU_COMMAND_ALL0_LANE_31_0_b2  SYNC_INFO.BF.MCU_COMMAND_ALL0_LANE_31_0_b2
#define cmx_MCU_COMMAND_ALL0_LANE_31_0_b3  SYNC_INFO.BF.MCU_COMMAND_ALL0_LANE_31_0_b3

// 0x06d0	MCU_INFO_4		MCU Information Register 4
typedef union {
	struct {
...
__xdata __at( 0xe6d0 ) volatile MCU_INFO_4_t MCU_INFO_4;
#define cmx_MCU_STATUS0_LANE0_31_0_b0  MCU_INFO_4.BF.MCU_STATUS0_LANE0_31_0_b0
#define cmx_MCU_STATUS0_LANE0_31_0_b1  MCU_INFO_4.BF.MCU_STATUS0_LANE0_31_0_b1
#define cmx_MCU_STATUS0_LANE0_31_0_b2  MCU_INFO_4.BF.MCU_STATUS0_LANE0_31_0_b2
#define cmx_MCU_STATUS0_LANE0_31_0_b3  MCU_INFO_4.BF.MCU_STATUS0_LANE0_31_0_b3

// 0x06d4	MCU_INFO_5		MCU Information Register 5
typedef union {
	struct {
...
__xdata __at( 0xe6d4 ) volatile MCU_INFO_5_t MCU_INFO_5;
#define cmx_MCU_STATUS0_LANE1_31_0_b0  MCU_INFO_5.BF.MCU_STATUS0_LANE1_31_0_b0
#define cmx_MCU_STATUS0_LANE1_31_0_b1  MCU_INFO_5.BF.MCU_STATUS0_LANE1_31_0_b1
#define cmx_MCU_STATUS0_LANE1_31_0_b2  MCU_INFO_5.BF.MCU_STATUS0_LANE1_31_0_b2
#define cmx_MCU_STATUS0_LANE1_31_0_b3  MCU_INFO_5.BF.MCU_STATUS0_LANE1_31_0_b3

// 0x06d8	MCU_INFO_12		MCU Information Register 12
typedef union {
	struct {
...
__xdata __at( 0xe6d8 ) volatile MCU_INFO_12_t MCU_INFO_12;
#define cmx_MCU_STATUS1_LANE0_31_0_b0  MCU_INFO_12.BF.MCU_STATUS1_LANE0_31_0_b0
#define cmx_MCU_STATUS1_LANE0_31_0_b1  MCU_INFO_12.BF.MCU_STATUS1_LANE0_31_0_b1
#define cmx_MCU_STATUS1_LANE0_31_0_b2  MCU_INFO_12.BF.MCU_STATUS1_LANE0_31_0_b2
#define cmx_MCU_STATUS1_LANE0_31_0_b3  MCU_INFO_12.BF.MCU_STATUS1_LANE0_31_0_b3

// 0x06dc	MCU_INFO_13		MCU Information Register 13
typedef union {
	struct {
...
__xdata __at( 0xe6dc ) volatile MCU_INFO_13_t MCU_INFO_13;
#define cmx_MCU_STATUS1_LANE1_31_0_b0  MCU_INFO_13.BF.MCU_STATUS1_LANE1_31_0_b0
#define cmx_MCU_STATUS1_LANE1_31_0_b1  MCU_INFO_13.BF.MCU_STATUS1_LANE1_31_0_b1
#define cmx_MCU_STATUS1_LANE1_31_0_b2  MCU_INFO_13.BF.MCU_STATUS1_LANE1_31_0_b2
#define cmx_MCU_STATUS1_LANE1_31_0_b3  MCU_INFO_13.BF.MCU_STATUS1_LANE1_31_0_b3

// 0x06e0	END_XDAT_CMN		End Of Xdata Common
typedef union {
	struct {
...
__xdata __at( 0xe6e0 ) volatile END_XDAT_CMN_t END_XDAT_CMN;
