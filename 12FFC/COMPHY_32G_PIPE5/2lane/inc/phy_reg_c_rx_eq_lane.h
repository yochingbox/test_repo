...
// 0x0000	DFE_CTRL_REG0		DFE Control 0
typedef union {
	struct {
...
// 0x0004	DFE_CTRL_REG1		DFE Control 1
typedef union {
	struct {
...
// 0x0008	DFE_CTRL_REG2		DFE Control 2
typedef union {
	struct {
...
// 0x000c	DFE_CTRL_REG3		DFE Control 3
typedef union {
	struct {
...
// 0x0020	DFE_STEP_REG0		DFE Step Size 0
typedef union {
	struct {
...
// 0x0024	DFE_STEP_REG1		DFE Step Size 1
typedef union {
	struct {
...
// 0x0044	DFE_FEXT_EVEN_REG1		DFE FEXT1 EVEN
typedef union {
	struct {
...
// 0x0048	DFE_FEXT_EVEN_REG2		DFE FEXT2 EVEN
typedef union {
	struct {
...
// 0x004c	DFE_FEXT_EVEN_REG3		DFE FEXT3 EVEN
typedef union {
	struct {
...
// 0x0050	DFE_FEXT_EVEN_REG4		DFE FEXT4 EVEN
typedef union {
	struct {
...
// 0x0054	DFE_FEXT_EVEN_REG5		DFE FEXT5 EVEN
typedef union {
	struct {
...
// 0x0058	DFE_FEXT_EVEN_REG6		DFE FEXT6 EVEN
typedef union {
	struct {
...
// 0x005c	DFE_FEXT_EVEN_REG7		DFE FEXT7 EVEN
typedef union {
	struct {
...
// 0x0064	DFE_FEXT_ODD_REG1		DFE FEXT1 ODD
typedef union {
	struct {
...
// 0x0068	DFE_FEXT_ODD_REG2		DFE FEXT2 ODD
typedef union {
	struct {
...
// 0x006c	DFE_FEXT_ODD_REG3		DFE FEXT3 ODD
typedef union {
	struct {
...
// 0x0070	DFE_FEXT_ODD_REG4		DFE FEXT4 ODD
typedef union {
	struct {
...
// 0x0074	DFE_FEXT_ODD_REG5		DFE FEXT5 ODD
typedef union {
	struct {
...
// 0x0078	DFE_FEXT_ODD_REG6		DFE FEXT6 ODD
typedef union {
	struct {
...
// 0x007c	DFE_FEXT_ODD_REG7		DFE FEXT7 ODD
typedef union {
	struct {
...
// 0x0080	DFE_READ_EVEN_SM_REG0		DFE TAP SIGN-MAGNITUDE READBACK EVEN 0
typedef union {
	struct {
...
// 0x0084	DFE_READ_EVEN_SM_REG1		DFE TAP SIGN-MAGNITUDE READBACK EVEN 1
typedef union {
	struct {
...
// 0x0088	DFE_READ_EVEN_SM_REG2		DFE TAP SIGN-MAGNITUDE READBACK EVEN 2
typedef union {
	struct {
...
// 0x008c	DFE_READ_EVEN_SM_REG3		DFE TAP SIGN-MAGNITUDE READBACK EVEN 3
typedef union {
	struct {
...
// 0x0090	DFE_READ_EVEN_SM_REG4		DFE TAP SIGN-MAGNITUDE READBACK EVEN 4
typedef union {
	struct {
...
// 0x0094	DFE_READ_EVEN_SM_REG5		DFE TAP SIGN-MAGNITUDE READBACK EVEN 5
typedef union {
	struct {
...
// 0x0098	DFE_READ_EVEN_SM_REG6		DFE TAP SIGN-MAGNITUDE READBACK EVEN 6
typedef union {
	struct {
...
// 0x009c	DFE_READ_EVEN_SM_REG7		DFE TAP SIGN-MAGNITUDE READBACK EVEN 7
typedef union {
	struct {
...
// 0x00a0	DFE_READ_ODD_SM_REG0		DFE TAP SIGN-MAGNITUDE READBACK ODD 0
typedef union {
	struct {
...
// 0x00a4	DFE_READ_ODD_SM_REG1		DFE TAP SIGN-MAGNITUDE READBACK ODD 1
typedef union {
	struct {
...
// 0x00a8	DFE_READ_ODD_SM_REG2		DFE TAP SIGN-MAGNITUDE READBACK ODD 2
typedef union {
	struct {
...
// 0x00ac	DFE_READ_ODD_SM_REG3		DFE TAP SIGN-MAGNITUDE READBACK ODD 3
typedef union {
	struct {
...
// 0x00b0	DFE_READ_ODD_SM_REG4		DFE TAP SIGN-MAGNITUDE READBACK ODD 4
typedef union {
	struct {
...
// 0x00b4	DFE_READ_ODD_SM_REG5		DFE TAP SIGN-MAGNITUDE READBACK ODD 5
typedef union {
	struct {
...
// 0x00b8	DFE_READ_ODD_SM_REG6		DFE TAP SIGN-MAGNITUDE READBACK ODD 6
typedef union {
	struct {
...
// 0x00bc	DFE_READ_ODD_SM_REG7		DFE TAP SIGN-MAGNITUDE READBACK ODD 7
typedef union {
	struct {
...
// 0x00c0	DFE_READ_EVEN_SM_REG8		DFE DC SIGN-MAGNITUDE READBACK EVEN
typedef union {
	struct {
...
// 0x00c4	DFE_READ_ODD_SM_REG8		DFE DC SIGN-MAGNITUDE READBACK ODD
typedef union {
	struct {
...
// 0x00d0	DFE_READ_EVEN_2C_REG0		DFE 2'S COMPLIMENT READBACK EVEN 0
typedef union {
	struct {
...
// 0x00d4	DFE_READ_EVEN_2C_REG1		DFE 2'S COMPLIMENT READBACK EVEN 1
typedef union {
	struct {
...
// 0x00d8	DFE_READ_EVEN_2C_REG2		DFE 2'S COMPLIMENT READBACK EVEN 2
typedef union {
	struct {
...
// 0x00dc	DFE_READ_EVEN_2C_REG3		DFE 2'S COMPLIMENT READBACK EVEN 3
typedef union {
	struct {
...
// 0x00e0	DFE_READ_EVEN_2C_REG4		DFE 2'S COMPLIMENT READBACK EVEN 4
typedef union {
	struct {
...
// 0x00e4	DFE_READ_EVEN_2C_REG5		DFE 2'S COMPLIMENT READBACK EVEN 5
typedef union {
	struct {
...
// 0x00e8	DFE_READ_EVEN_2C_REG6		DFE 2'S COMPLIMENT READBACK EVEN 6
typedef union {
	struct {
...
// 0x00ec	DFE_READ_EVEN_2C_REG7		DFE 2'S COMPLIMENT READBACK EVEN 7
typedef union {
	struct {
...
// 0x00f0	DFE_READ_ODD_2C_REG0		DFE 2'S COMPLIMENT READBACK ODD 0
typedef union {
	struct {
...
// 0x00f4	DFE_READ_ODD_2C_REG1		DFE 2'S COMPLIMENT READBACK ODD 1
typedef union {
	struct {
...
// 0x00f8	DFE_READ_ODD_2C_REG2		DFE 2'S COMPLIMENT READBACK ODD 2
typedef union {
	struct {
...
// 0x00fc	DFE_READ_ODD_2C_REG3		DFE 2'S COMPLIMENT READBACK ODD 3
typedef union {
	struct {
...
// 0x0100	DFE_READ_ODD_2C_REG4		DFE 2'S COMPLIMENT READBACK ODD 4
typedef union {
	struct {
...
// 0x0104	DFE_READ_ODD_2C_REG5		DFE 2'S COMPLIMENT READBACK ODD 5
typedef union {
	struct {
...
// 0x0108	DFE_READ_ODD_2C_REG6		DFE 2'S COMPLIMENT READBACK ODD 6
typedef union {
	struct {
...
// 0x010c	DFE_READ_ODD_2C_REG7		DFE 2'S COMPLIMENT READBACK ODD 7
typedef union {
	struct {
...
// 0x0110	DFE_READ_EVEN_2C_REG8		DFE DC EVEN 2'S COMPLIMENT READBACK
typedef union {
	struct {
...
// 0x0114	DFE_READ_ODD_2C_REG8		DFE DC ODD 2'S COMPLIMENT READBACK
typedef union {
	struct {
...
// 0x0118	CAL_OFST_REG0		OFFSET CALIBRATION RESULT 0
typedef union {
	struct {
...
// 0x011c	CAL_OFST_REG1		OFFSET CALIBRATION RESULT 1
typedef union {
	struct {
...
// 0x0120	CAL_OFST_REG2		OFFSET CALIBRATION RESULT 2
typedef union {
	struct {
...
// 0x0140	DFE_STATIC_LANE_REG0		DFE SETTLEMENT 0
typedef union {
	struct {
		...
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
		uint8_t DFE_ADAPT_ADJ_F1_DC_THRESH_2_LANE_5_0    : 6;	/*[21:16]     r/w 6'h12*/
		uint8_t RESERVED_22                              : 1;	/*     22     r/w   0*/
		uint8_t RESERVED_23                              : 1;	/*     23     r/w   0*/
		uint8_t DFE_ADAPT_ADJ_F1_DC_THRESH_1_LANE_4_0    : 5;	/*[28:24]     r/w 5'h6*/
		uint8_t DFE_SQ_EN_LANE                           : 1;	/*     29     r/w   1*/
		uint8_t DFE_SAT_EN_LANE                          : 1;	/*     30     r/w   1*/
		uint8_t DFE_SAT_HOLD_LANE                        : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} DFE_STATIC_LANE_REG0_t;
__xdata __at( 0x2540 ) volatile DFE_STATIC_LANE_REG0_t DFE_STATIC_LANE_REG0;
#define reg_DFE_EO_UP_THRE_COARSE_LANE_4_0  DFE_STATIC_LANE_REG0.BF.DFE_EO_UP_THRE_COARSE_LANE_4_0
#define reg_DFE_EO_UP_THRE_FINE_LANE_4_0  DFE_STATIC_LANE_REG0.BF.DFE_EO_UP_THRE_FINE_LANE_4_0
#define reg_DFE_ADAPT_ADJ_F1_DC_THRESH_2_LANE_5_0  DFE_STATIC_LANE_REG0.BF.DFE_ADAPT_ADJ_F1_DC_THRESH_2_LANE_5_0
#define reg_DFE_ADAPT_ADJ_F1_DC_THRESH_1_LANE_4_0  DFE_STATIC_LANE_REG0.BF.DFE_ADAPT_ADJ_F1_DC_THRESH_1_LANE_4_0
#define reg_DFE_SQ_EN_LANE  DFE_STATIC_LANE_REG0.BF.DFE_SQ_EN_LANE
#define reg_DFE_SAT_EN_LANE  DFE_STATIC_LANE_REG0.BF.DFE_SAT_EN_LANE
#define reg_DFE_SAT_HOLD_LANE  DFE_STATIC_LANE_REG0.BF.DFE_SAT_HOLD_LANE

// 0x0144	DFE_STATIC_LANE_REG1		DFE SETTLEMENT 1
typedef union {
	struct {
		uint8_t DFE_ANA_SETTLE_DC_LANE_1_0               : 2;	/*  [1:0]     r/w 2'h1*/
		uint8_t DFE_ANA_SETTLE_FF_LANE_1_0               : 2;	/*  [3:2]     r/w 2'h1*/
		uint8_t DFE_ANA_SETTLE_F4TO15_LANE_1_0           : 2;	/*  [5:4]     r/w 2'h1*/
		uint8_t DFE_ANA_SETTLE_F23_LANE_1_0              : 2;	/*  [7:6]     r/w 2'h1*/
		uint8_t RESERVED_8                               : 1;	/*      8     r/w   0*/
		uint8_t RESERVED_9                               : 1;	/*      9     r/w   0*/
		uint8_t RESERVED_10                              : 1;	/*     10     r/w   0*/
		uint8_t RESERVED_11                              : 1;	/*     11     r/w   0*/
		uint8_t DFE_ANA_SETTLE_F0_LANE_1_0               : 2;	/*[13:12]     r/w 2'h1*/
		uint8_t RESERVED_14                              : 1;	/*     14     r/w   0*/
		uint8_t RESERVED_15                              : 1;	/*     15     r/w   0*/
	...
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} DFE_STATIC_LANE_REG1_t;
__xdata __at( 0x2544 ) volatile DFE_STATIC_LANE_REG1_t DFE_STATIC_LANE_REG1;
#define reg_DFE_ANA_SETTLE_DC_LANE_1_0  DFE_STATIC_LANE_REG1.BF.DFE_ANA_SETTLE_DC_LANE_1_0
#define reg_DFE_ANA_SETTLE_FF_LANE_1_0  DFE_STATIC_LANE_REG1.BF.DFE_ANA_SETTLE_FF_LANE_1_0
#define reg_DFE_ANA_SETTLE_F4TO15_LANE_1_0  DFE_STATIC_LANE_REG1.BF.DFE_ANA_SETTLE_F4TO15_LANE_1_0
#define reg_DFE_ANA_SETTLE_F23_LANE_1_0  DFE_STATIC_LANE_REG1.BF.DFE_ANA_SETTLE_F23_LANE_1_0
#define reg_DFE_ANA_SETTLE_F0_LANE_1_0  DFE_STATIC_LANE_REG1.BF.DFE_ANA_SETTLE_F0_LANE_1_0
#define reg_DFE_ANA_SETTLE_PATHSWITCH_LANE_3_0  DFE_STATIC_LANE_REG1.BF.DFE_ANA_SETTLE_PATHSWITCH_LANE_3_0
#define reg_DFE_ANA_SETTLE_PATHOFF_LANE_3_0  DFE_STATIC_LANE_REG1.BF.DFE_ANA_SETTLE_PATHOFF_LANE_3_0
#define reg_DFE_ANA_SETTLE_PATHON_LANE_6_0  DFE_STATIC_LANE_REG1.BF.DFE_ANA_SETTLE_PATHON_LANE_6_0
#define reg_DFE_FAST_SETTLE_LANE  DFE_STATIC_LANE_REG1.BF.DFE_FAST_SETTLE_LANE

// 0x0148	DFE_STATIC_LANE_REG3		DFE SETTLEMENT 3
typedef union {
	struct {
		uint8_t ANA_RX_PATH_SEL_S_XOR_LANE               : 1;	/*      0     r/w   0*/
		uint8_t ANA_RX_PATH_SEL_D_XOR_LANE               : 1;	/*      1     r/w   0*/
		uint8_t ANA_RX_DATA_SLICER_PATH_SWITCH_O_XOR_LANE : 1;	/*      2     r/w   0*/
		uint8_t ANA_RX_DATA_SLICER_PATH_SWITCH_E_XOR_LANE : 1;	/*      3     r/w   0*/
		uint8_t ANA_RX_DFE_F3_POL_S_XOR_LANE             : 1;	/*      4     r/w   0*/
		uint8_t ANA_RX_DFE_F3_POL_D_XOR_LANE             : 1;	/*      5     r/w   0*/
		uint8_t ANA_RX_DFE_F2_POL_S_XOR_LANE             : 1;	/*      6     r/w   0*/
		uint8_t ANA_RX_DFE_F2_POL_D_XOR_LANE             : 1;	/*      7     r/w   0*/
		uint8_t ANA_RX_DFE_F1_POL_S_XOR_LANE             : 1;	/*      8     r/w   0*/
		uint8_t ANA_RX_DFE_F1_POL_D_XOR_LANE             : 1;	/*      9     r/w   0*/
		uint8_t ANA_RX_DFE_F0_POL_S_XOR_LANE             : 1;	/*     10     r/w   0*/
		uint8_t ANA_RX_DFE_F0_POL_D_XOR_LANE             : 1;	/*     11     r/w   0*/
		uint8_t DFE_DC_SIGN_XOR_LANE                     : 1;	/*     12     r/w   0*/
		uint8_t DFE_F1_SIGN_XOR_LANE                     : 1;	/*     13     r/w   0*/
	...
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} DFE_STATIC_LANE_REG3_t;
__xdata __at( 0x2548 ) volatile DFE_STATIC_LANE_REG3_t DFE_STATIC_LANE_REG3;
#define reg_ANA_RX_PATH_SEL_S_XOR_LANE  DFE_STATIC_LANE_REG3.BF.ANA_RX_PATH_SEL_S_XOR_LANE
#define reg_ANA_RX_PATH_SEL_D_XOR_LANE  DFE_STATIC_LANE_REG3.BF.ANA_RX_PATH_SEL_D_XOR_LANE
#define reg_ANA_RX_DATA_SLICER_PATH_SWITCH_O_XOR_LANE  DFE_STATIC_LANE_REG3.BF.ANA_RX_DATA_SLICER_PATH_SWITCH_O_XOR_LANE
#define reg_ANA_RX_DATA_SLICER_PATH_SWITCH_E_XOR_LANE  DFE_STATIC_LANE_REG3.BF.ANA_RX_DATA_SLICER_PATH_SWITCH_E_XOR_LANE
#define reg_ANA_RX_DFE_F3_POL_S_XOR_LANE  DFE_STATIC_LANE_REG3.BF.ANA_RX_DFE_F3_POL_S_XOR_LANE
#define reg_ANA_RX_DFE_F3_POL_D_XOR_LANE  DFE_STATIC_LANE_REG3.BF.ANA_RX_DFE_F3_POL_D_XOR_LANE
#define reg_ANA_RX_DFE_F2_POL_S_XOR_LANE  DFE_STATIC_LANE_REG3.BF.ANA_RX_DFE_F2_POL_S_XOR_LANE
#define reg_ANA_RX_DFE_F2_POL_D_XOR_LANE  DFE_STATIC_LANE_REG3.BF.ANA_RX_DFE_F2_POL_D_XOR_LANE
#define reg_ANA_RX_DFE_F1_POL_S_XOR_LANE  DFE_STATIC_LANE_REG3.BF.ANA_RX_DFE_F1_POL_S_XOR_LANE
#define reg_ANA_RX_DFE_F1_POL_D_XOR_LANE  DFE_STATIC_LANE_REG3.BF.ANA_RX_DFE_F1_POL_D_XOR_LANE
#define reg_ANA_RX_DFE_F0_POL_S_XOR_LANE  DFE_STATIC_LANE_REG3.BF.ANA_RX_DFE_F0_POL_S_XOR_LANE
#define reg_ANA_RX_DFE_F0_POL_D_XOR_LANE  DFE_STATIC_LANE_REG3.BF.ANA_RX_DFE_F0_POL_D_XOR_LANE
#define reg_DFE_DC_SIGN_XOR_LANE  DFE_STATIC_LANE_REG3.BF.DFE_DC_SIGN_XOR_LANE
#define reg_DFE_F1_SIGN_XOR_LANE  DFE_STATIC_LANE_REG3.BF.DFE_F1_SIGN_XOR_LANE

// 0x014c	DFE_STATIC_LANE_REG4		DFE tap dac settlement counter 0
typedef union {
	struct {
	...
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} DFE_STATIC_LANE_REG4_t;
__xdata __at( 0x254c ) volatile DFE_STATIC_LANE_REG4_t DFE_STATIC_LANE_REG4;
#define reg_DFE_ANA_SETTLE_5NS_LANE_7_0  DFE_STATIC_LANE_REG4.BF.DFE_ANA_SETTLE_5NS_LANE_7_0
#define reg_DFE_ANA_SETTLE_10NS_LANE_7_0  DFE_STATIC_LANE_REG4.BF.DFE_ANA_SETTLE_10NS_LANE_7_0
#define reg_DFE_ANA_SETTLE_15NS_LANE_7_0  DFE_STATIC_LANE_REG4.BF.DFE_ANA_SETTLE_15NS_LANE_7_0
#define reg_DFE_ANA_SETTLE_20NS_LANE_7_0  DFE_STATIC_LANE_REG4.BF.DFE_ANA_SETTLE_20NS_LANE_7_0

// 0x0150	DFE_STATIC_LANE_REG5		DFE tap dac settlement counter 1
typedef union {
	struct {
	...
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} DFE_STATIC_LANE_REG5_t;
__xdata __at( 0x2550 ) volatile DFE_STATIC_LANE_REG5_t DFE_STATIC_LANE_REG5;
#define reg_DFE_ANA_SETTLE_100NS_LANE_7_0  DFE_STATIC_LANE_REG5.BF.DFE_ANA_SETTLE_100NS_LANE_7_0
#define reg_DFE_ANA_SETTLE_200NS_LANE_7_0  DFE_STATIC_LANE_REG5.BF.DFE_ANA_SETTLE_200NS_LANE_7_0
#define reg_DFE_ANA_SETTLE_300NS_LANE_7_0  DFE_STATIC_LANE_REG5.BF.DFE_ANA_SETTLE_300NS_LANE_7_0
#define reg_DFE_ANA_SETTLE_400NS_LANE_7_0  DFE_STATIC_LANE_REG5.BF.DFE_ANA_SETTLE_400NS_LANE_7_0

// 0x0154	DFE_STATIC_LANE_REG6		DFE tap dac settlement counter 2
typedef union {
	struct {
		uint8_t DFE_ANA_SETTLE_F1_TRAIN_LANE_11_0_b0     : 8;	/* [11:0]     r/w 12'h47*/
		uint8_t DFE_ANA_SETTLE_F1_TRAIN_LANE_11_0_b1     : 4;	/* [11:0]     r/w 12'h47*/
		uint8_t RESERVED_12                              : 4;	/*[15:12]     r/w   0*/
		uint8_t DFE_ANA_SETTLE_F1_TRACK_LANE_11_0_b0     : 8;	/*[27:16]     r/w 12'hfff*/
		uint8_t DFE_ANA_SETTLE_F1_TRACK_LANE_11_0_b1     : 4;	/*[27:16]     r/w 12'hfff*/
		uint8_t RESERVED_28                              : 4;	/*[31:28]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} DFE_STATIC_LANE_REG6_t;
__xdata __at( 0x2554 ) volatile DFE_STATIC_LANE_REG6_t DFE_STATIC_LANE_REG6;
#define reg_DFE_ANA_SETTLE_F1_TRAIN_LANE_11_0_b0  DFE_STATIC_LANE_REG6.BF.DFE_ANA_SETTLE_F1_TRAIN_LANE_11_0_b0
#define reg_DFE_ANA_SETTLE_F1_TRAIN_LANE_11_0_b1  DFE_STATIC_LANE_REG6.BF.DFE_ANA_SETTLE_F1_TRAIN_LANE_11_0_b1
#define reg_DFE_ANA_SETTLE_F1_TRACK_LANE_11_0_b0  DFE_STATIC_LANE_REG6.BF.DFE_ANA_SETTLE_F1_TRACK_LANE_11_0_b0
#define reg_DFE_ANA_SETTLE_F1_TRACK_LANE_11_0_b1  DFE_STATIC_LANE_REG6.BF.DFE_ANA_SETTLE_F1_TRACK_LANE_11_0_b1

// 0x0160	EOM_VLD_REG0		EOM VALID COUNT LSB 0
typedef union {
	struct {
...
// 0x0164	EOM_VLD_REG1		EOM VALID COUNT LSB 1
typedef union {
	struct {
...
// 0x0168	EOM_VLD_REG2		EOM VALID COUNT LSB 2
typedef union {
	struct {
...
// 0x016c	EOM_VLD_REG3		EOM VALID COUNT LSB 3
typedef union {
	struct {
...
// 0x0170	EOM_ERR_REG0		EOM ERROR COUNT REG 0
typedef union {
	struct {
...
// 0x0174	EOM_ERR_REG1		EOM ERROR COUNT REG 1
typedef union {
	struct {
...
// 0x0178	EOM_ERR_REG2		EOM ERROR COUNT REG 2
typedef union {
	struct {
...
// 0x017c	EOM_ERR_REG3		EOM ERROR COUNT REG 3
typedef union {
	struct {
