...
typedef union {
	struct {
		...
		uint8_t MCU_SFT_RST_EN_CMN                       : 1;	/*     10     r/w   1*/
...
#define reg_MCU_SFT_RST_EN_CMN  MCU_CONTROL_0.BF.MCU_SFT_RST_EN_CMN
...
// 0x00ec	ANA_IF_CMN_REG0		Analog Interface Common Register 0
typedef union {
	struct {
...
typedef union {
	struct {
		...
		uint8_t RESERVED_1                               : 7;	/*  [7:1]     r/w   0*/
		uint8_t ANA_REG_SU_DLY_SEL_2_0                   : 3;	/* [10:8]     r/w 3'h3*/
		uint8_t ANA_REG_HD_DLY_SEL_2_0                   : 3;	/*[13:11]     r/w 3'h3*/
...
#define reg_ANA_REG_SU_DLY_SEL_2_0  APB_CONTROL_REG.BF.ANA_REG_SU_DLY_SEL_2_0
