...
typedef union {
	struct {
		...
		uint8_t ALIGN90_CAL_DONE_LANE                    : 1;	/*      9       r   0*/
		...
		uint8_t DCC_CAL_DONE_LANE                        : 1;	/*     26       r   0*/
		uint8_t DLL_CAL_DONE_LANE                        : 1;	/*     27       r   0*/
...
#define lnx_ALIGN90_CAL_DONE_LANE  CAL_CTRL1_LANE.BF.ALIGN90_CAL_DONE_LANE
...
#define lnx_DCC_CAL_DONE_LANE  CAL_CTRL1_LANE.BF.DCC_CAL_DONE_LANE
...
typedef union {
	struct {
		...
		uint8_t ALIGN90_CAL_PASS_LANE                    : 1;	/*      9       r   0*/
		...
		uint8_t DCC_CAL_PASS_LANE                        : 1;	/*     30       r   0*/
		uint8_t DLL_CAL_PASS_LANE                        : 1;	/*     31       r   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} CAL_CTRL2_LANE_t;
...
#define lnx_ALIGN90_CAL_PASS_LANE  CAL_CTRL2_LANE.BF.ALIGN90_CAL_PASS_LANE
...
#define lnx_DCC_CAL_PASS_LANE  CAL_CTRL2_LANE.BF.DCC_CAL_PASS_LANE
...
// 0x001c	PHY_REMOTE_CTRL_COMMAND_LANE		PHY Remote Control Command Lane
typedef union {
	struct {
...
// 0x0020	PHY_REMOTE_CTRL_VALUE_LANE		PHY Remote Control Value Lane
typedef union {
	struct {
...
// 0x0024	PHY_LOCAL_VALUE_LANE		PHY Local Value Lane
typedef union {
	struct {
...
// 0x0028	TRX_TRAIN_IF_TIMERS1_LANE		TRX Train Interface Timer Lane 1
typedef union {
	struct {
...
// 0x002c	TRX_TRAIN_IF_TIMERS2_LANE		TRX Train Interface Timer Lane 2
typedef union {
	struct {
		uint8_t RESERVED_0                               : 8;	/* [15:0]     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [15:0]     r/w   0*/
...
// 0x0030	TRX_TRAIN_IF_TIMERS_ENABLE_LANE		TRX Train Interface Timer Enable Lane
typedef union {
	struct {
...
// 0x0034	DFE_CONTROL_0		Firmware DFE Control 0
typedef union {
	struct {
...
// 0x0038	DFE_CONTROL_1		Firmware DFE Control 1
typedef union {
	struct {
...
// 0x0040	DFE_CONTROL_2		Firmware DFE Control 2
typedef union {
	struct {
...
// 0x0044	DFE_CONTROL_3		Firmware DFE Control 3
typedef union {
	struct {
...
// 0x0048	DFE_CONTROL_4		Firmware DFE Control 4
typedef union {
	struct {
...
// 0x004c	DFE_CONTROL_5		Firmware DFE Control 5
typedef union {
	struct {
...
// 0x0050	TRAIN_CONTROL_0		Firmware Train Control 0
typedef union {
	struct {
...
// 0x0054	TRAIN_CONTROL_1		Firmware Train Control 1
typedef union {
	struct {
...
// 0x0058	TRAIN_CONTROL_2		Firmware Train Control 2
typedef union {
	struct {
...
// 0x005c	RPTA_CONFIG_0		Firmware RPTA Configure 0
typedef union {
	struct {
...
// 0x0060	RPTA_CONFIG_1		Firmware RPTA Configure 1
typedef union {
	struct {
...
typedef union {
	struct {
		...
		uint8_t BYPASS_PCIE_GEN5_DFE_RES_TRAIN_LANE      : 1;	/*     22     r/w   0*/
...
#define lnx_BYPASS_PCIE_GEN5_DFE_RES_TRAIN_LANE  TRAIN_PARA_3.BF.BYPASS_PCIE_GEN5_DFE_RES_TRAIN_LANE
#define lnx_RPTA_F0D_OFFSET_LANE_7_0  TRAIN_PARA_3.BF.RPTA_F0D_OFFSET_LANE_7_0

// 0x0078	DFE_CONTROL_6		Firmware DFE Control 6
typedef union {
	struct {
...
// 0x007c	DFE_TEST_0		Firmware DFE Test 0
typedef union {
	struct {
...
// 0x0080	DFE_TEST_1		Firmware DFE Test 1
typedef union {
	struct {
...
// 0x0084	DFE_TEST_4		Firmware DFE Test 4
typedef union {
	struct {
...
// 0x0088	DFE_TEST_5		Firmware DFE Test 5
typedef union {
	struct {
...
// 0x008c	DFE_CONTROL_7		Firmware DFE Control 7
typedef union {
	struct {
...
// 0x0090	DFE_CONTROL_8		Firmware DFE Control 8
typedef union {
	struct {
...
// 0x0094	DFE_CONTROL_9		Firmware DFE Control 9
typedef union {
	struct {
...
// 0x0098	DFE_CONTROL_10		Firmware DFE Control 10
typedef union {
	struct {
...
// 0x009c	DFE_CONTROL_11		Firmware DFE Control 11
typedef union {
	struct {
...
// 0x00a0	CDS_CTRL_REG0		Firmware CDS Control 0
typedef union {
	struct {
...
// 0x00a4	CDS_CTRL_REG1		Firmware CDS Control 1
typedef union {
	struct {
...
// 0x00a8	ESM_POP_P_CNT_LOW_LANE		Firmware ESM pop_p Counter Low
typedef union {
	struct {
...
// 0x00ac	ESM_ERR_P_CNT_LOW_LANE		Firmware ESM err_p Counter Low
typedef union {
	struct {
...
// 0x00b0	ESM_ERR_POP_CNT_HIGH_LANE		Firmware ESM Counter High
typedef union {
	struct {
...
// 0x00b4	TRAIN_CONTROL_3		Firmware Train Control 3
typedef union {
	struct {
...
// 0x00b8	TRAIN_CONTROL_4		Firmware Train Control 4
typedef union {
	struct {
...
// 0x00bc	TRAIN_CONTROL_5		Firmware Train Control 5
typedef union {
	struct {
...
// 0x00c0	TRAIN_CONTROL_6		Firmware Train Control 6
typedef union {
	struct {
...
// 0x00c4	TRAIN_CONTROL_7		Firmware Train Control 7
typedef union {
	struct {
...
// 0x00c8	TRAIN_CONTROL_8		Firmware Train Control 8
typedef union {
	struct {
		...
		uint8_t G4_SPDCHG_COMP_LANE                      : 1;	/*     24       r   0*/
		uint8_t G4_RXINIT_DONE_LANE                      : 1;	/*     25       r   0*/
		uint8_t G4_RXTRAIN_TRIG_LANE                     : 1;	/*     26       r   0*/
		uint8_t G4_RXTRAIN_COMP_LANE                     : 1;	/*     27       r   0*/
		uint8_t G4_RXTRAIN_SUCCESS_LANE                  : 1;	/*     28       r   0*/
		uint8_t G4_TRXTRAIN_TRIG_LANE                    : 1;	/*     29       r   0*/
		uint8_t G4_TRXTRAIN_COMP_LANE                    : 1;	/*     30       r   0*/
		uint8_t G4_TRXTRAIN_SUCCESS_LANE                 : 1;	/*     31       r   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TRAIN_CONTROL_8_t;
...
#define lnx_G4_SPDCHG_COMP_LANE  TRAIN_CONTROL_8.BF.G4_SPDCHG_COMP_LANE
#define lnx_G4_RXINIT_DONE_LANE  TRAIN_CONTROL_8.BF.G4_RXINIT_DONE_LANE
#define lnx_G4_RXTRAIN_TRIG_LANE  TRAIN_CONTROL_8.BF.G4_RXTRAIN_TRIG_LANE
#define lnx_G4_RXTRAIN_COMP_LANE  TRAIN_CONTROL_8.BF.G4_RXTRAIN_COMP_LANE
#define lnx_G4_RXTRAIN_SUCCESS_LANE  TRAIN_CONTROL_8.BF.G4_RXTRAIN_SUCCESS_LANE
#define lnx_G4_TRXTRAIN_TRIG_LANE  TRAIN_CONTROL_8.BF.G4_TRXTRAIN_TRIG_LANE
#define lnx_G4_TRXTRAIN_COMP_LANE  TRAIN_CONTROL_8.BF.G4_TRXTRAIN_COMP_LANE
#define lnx_G4_TRXTRAIN_SUCCESS_LANE  TRAIN_CONTROL_8.BF.G4_TRXTRAIN_SUCCESS_LANE

// 0x00cc	TRAIN_CONTROL_9		Firmware Train Control 9
typedef union {
	struct {
...
// 0x00d0	TRAIN_CONTROL_10		Firmware Train Control 10
typedef union {
	struct {
...
// 0x00d4	TRAIN_CONTROL_11		Firmware Train Control 11
typedef union {
	struct {
...
// 0x00d8	TRAIN_CONTROL_12		Firmware Train Control 12
typedef union {
	struct {
...
// 0x00dc	ESM_POP_N_CNT_LOW_LANE		Firmware ESM pop_n Counter Low
typedef union {
	struct {
...
// 0x00e0	ESM_ERR_N_CNT_LOW_LANE		Firmware ESM err_n Counter Low
typedef union {
	struct {
...
// 0x00e4	TRAIN_CONTROL_13		Firmware Train Control 13
typedef union {
	struct {
...
// 0x00e8	TRAIN_CONTROL_14		Firmware Train Control 14
typedef union {
	struct {
...
// 0x00ec	TRAIN_CONTROL_15		Firmware Train Control 15
typedef union {
	struct {
...
// 0x00f0	TRAIN_CONTROL_16		Firmware Train Control 16
typedef union {
	struct {
...
// 0x00f4	TRAIN_CONTROL_17		Firmware Train Control 17
typedef union {
	struct {
...
// 0x00f8	END_XDAT_LANE		Firmware End Of Xdata Lane
typedef union {
	struct {
