...
// 0x0100	DFE_READ_EVEN_REG0		DFE TAP 2C READBACK EVEN 0
typedef union {
	struct {
...
// 0x0104	DFE_READ_EVEN_REG1		DFE TAP 2C READBACK EVEN 1
typedef union {
	struct {
...
// 0x0108	DFE_READ_EVEN_REG2		DFE TAP 2C READBACK EVEN 2
typedef union {
	struct {
...
// 0x010c	DFE_READ_EVEN_REG3		DFE TAP 2C READBACK EVEN 3
typedef union {
	struct {
...
// 0x0110	DFE_READ_EVEN_REG4		DFE TAP 2C READBACK EVEN 4
typedef union {
	struct {
...
// 0x0114	DFE_READ_EVEN_REG5		DFE TAP 2C READBACK EVEN 5
typedef union {
	struct {
...
// 0x0118	DFE_READ_EVEN_REG6		DFE TAP 2C READBACK EVEN 6
typedef union {
	struct {
...
// 0x011c	DFE_READ_EVEN_REG7		DFE TAP 2C READBACK EVEN 7
typedef union {
	struct {
...
// 0x0120	DFE_READ_ODD_REG0		DFE TAP 2C READBACK ODD 0
typedef union {
	struct {
...
// 0x0124	DFE_READ_ODD_REG1		DFE TAP 2C READBACK ODD 1
typedef union {
	struct {
...
// 0x0128	DFE_READ_ODD_REG2		DFE TAP 2C READBACK ODD 2
typedef union {
	struct {
...
// 0x012c	DFE_READ_ODD_REG3		DFE TAP 2C READBACK ODD 3
typedef union {
	struct {
...
// 0x0130	DFE_READ_ODD_REG4		DFE TAP 2C READBACK ODD 4
typedef union {
	struct {
...
// 0x0134	DFE_READ_ODD_REG5		DFE TAP 2C READBACK ODD 5
typedef union {
	struct {
...
// 0x0138	DFE_READ_ODD_REG6		DFE TAP 2C READBACK ODD 6
typedef union {
	struct {
...
// 0x013c	DFE_READ_ODD_REG7		DFE TAP 2C READBACK ODD 7
typedef union {
	struct {
...
// 0x0140	DFE_READ_EVEN_REG8		DFE DC 2C READBACK EVEN
typedef union {
	struct {
...
// 0x0144	DFE_READ_ODD_REG8		DFE DC 2C READBACK ODD
typedef union {
	struct {
...
// 0x0148	DFE_READ_F0A_EVEN		DFE READ F0A EVEN
typedef union {
	struct {
...
// 0x014c	DFE_READ_F0A_ODD		DFE READ F0A ODD
typedef union {
	struct {
...
// 0x0150	DFE_READ_F0B_EVEN		DFE READ F0B EVEN
typedef union {
	struct {
...
// 0x0154	DFE_READ_F0B_ODD		DFE READ F0B ODD
typedef union {
	struct {
...
// 0x0158	DFE_READ_F0D_EVEN		DFE READ F0D EVEN
typedef union {
	struct {
...
// 0x015c	DFE_READ_F0D_ODD		DFE READ F0D ODD
typedef union {
	struct {
...
// 0x0160	DFE_READ_F0D_LEFT_EVEN		DFE READ F0D LEFT EVEN
typedef union {
	struct {
...
// 0x0164	DFE_READ_F0D_LEFT_ODD		DFE READ F0D LEFT ODD
typedef union {
	struct {
...
// 0x0168	DFE_READ_F0D_RIGHT_EVEN		DFE READ F0D RIGHT EVEN
typedef union {
	struct {
...
// 0x016c	DFE_READ_F0D_RIGHT_ODD		DFE READ F0D RIGHT ODD
typedef union {
	struct {
...
// 0x0170	CDS_READ_MISC0		DFE READ MISC 0
typedef union {
	struct {
...
// 0x0174	CDS_READ_MISC1		DFE READ MISC 1
typedef union {
	struct {
...
// 0x0214	TXTRAIN_IF_REG0		Tx Training Interface 0
typedef union {
	struct {
