...
typedef union {
	struct {
		...
		uint8_t PHY_FM_RST_LANE0                         : 1;	/*      9       r   0*/
		uint8_t PHY_FM_RST_LANE1                         : 1;	/*     10       r   0*/
...
// 0x0028	ANA_TSEN_CONTROL		Analog Temperature Sensor Control
typedef union {
	struct {
...
// 0x003c	OUTPUT_CMN_PIN_REG0		Output Interface Common Register0
typedef union {
	struct {
...
// 0x0040	CMN_CALIBRATION		Common Calibration Register
typedef union {
	struct {
...
// 0x0048	INPUT_CMN_PIN_REG3		Input Interface Register3
typedef union {
	struct {
...
// 0x0054	TEST5		Common Test Register5
typedef union {
	struct {
...
// 0x00b0	CMN_ISR_CLEAR_1		MCU ISR Clear Register 1
typedef union {
	struct {
...
__xdata __at( 0xa3b0 ) volatile CMN_ISR_CLEAR_1_t CMN_ISR_CLEAR_1;
...
// 0x00b4	SET_LANE_ISR		MCU  INT Register 1
typedef union {
	struct {
...
__xdata __at( 0xa3b4 ) volatile SET_LANE_ISR_t SET_LANE_ISR;
...
typedef union {
	struct {
		...
		uint8_t CID1_7_0                                 : 8;	/*[23:16]       r 8'h20*/
...
typedef union {
	struct {
		...
		uint8_t PHY_LANE_NUM_2_0                         : 3;	/*[31:29]       r 3'h1*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
