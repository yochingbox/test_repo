...
typedef union {
	struct {
		...
		uint8_t RESERVED_18                              : 3;	/*[20:18]     r/w   0*/
	...
	uint32_t VAL;
} TX_TRAIN_CTRL_LANE0_t;
__xdata __at( 0x2600 ) volatile TX_TRAIN_CTRL_LANE0_t TX_TRAIN_CTRL_LANE0;
#define reg_PIN_PAPTA_TRAIN_ENABLE_RD_LANE  TX_TRAIN_CTRL_LANE0.BF.PIN_PAPTA_TRAIN_ENABLE_RD_LANE
#define reg_REMOTE_TX_TRAIN_COMPLETE_TYPE_LANE  TX_TRAIN_CTRL_LANE0.BF.REMOTE_TX_TRAIN_COMPLETE_TYPE_LANE
#define reg_REMOTE_TX_TRAIN_COMPLETE_LANE  TX_TRAIN_CTRL_LANE0.BF.REMOTE_TX_TRAIN_COMPLETE_LANE
#define reg_REMOTE_CTRL_FIELD_HIGH_LANE  TX_TRAIN_CTRL_LANE0.BF.REMOTE_CTRL_FIELD_HIGH_LANE
#define reg_PIN_LOCAL_CTRL_FIELD_READY_RD_LANE  TX_TRAIN_CTRL_LANE0.BF.PIN_LOCAL_CTRL_FIELD_READY_RD_LANE
#define reg_PIN_RX_TRAIN_COMPLETE_RD_LANE  TX_TRAIN_CTRL_LANE0.BF.PIN_RX_TRAIN_COMPLETE_RD_LANE
#define reg_PIN_RX_TRAIN_FAILED_RD_LANE  TX_TRAIN_CTRL_LANE0.BF.PIN_RX_TRAIN_FAILED_RD_LANE
#define reg_TX_TRAIN_ERROR_LANE_1_0_b0  TX_TRAIN_CTRL_LANE0.BF.TX_TRAIN_ERROR_LANE_1_0_b0
#define reg_TX_TRAIN_ERROR_LANE_1_0_b1  TX_TRAIN_CTRL_LANE0.BF.TX_TRAIN_ERROR_LANE_1_0_b1
#define reg_PIN_TX_TRAIN_ERROR_RD_LANE_1_0  TX_TRAIN_CTRL_LANE0.BF.PIN_TX_TRAIN_ERROR_RD_LANE_1_0
#define reg_PIN_TX_TRAIN_COMPLETE_RD_LANE  TX_TRAIN_CTRL_LANE0.BF.PIN_TX_TRAIN_COMPLETE_RD_LANE
#define reg_PIN_TX_TRAIN_FAILED_RD_LANE  TX_TRAIN_CTRL_LANE0.BF.PIN_TX_TRAIN_FAILED_RD_LANE
#define reg_PIN_RX_TRAIN_ENABLE_RD_LANE  TX_TRAIN_CTRL_LANE0.BF.PIN_RX_TRAIN_ENABLE_RD_LANE
#define reg_PIN_TX_TRAIN_ENABLE_MUX_RD_LANE  TX_TRAIN_CTRL_LANE0.BF.PIN_TX_TRAIN_ENABLE_MUX_RD_LANE
#define reg_TX_FFE_TRAIN_DONE_LANE  TX_TRAIN_CTRL_LANE0.BF.TX_FFE_TRAIN_DONE_LANE
#define reg_PIN_TX_TRAIN_ENABLE_SEL_LANE  TX_TRAIN_CTRL_LANE0.BF.PIN_TX_TRAIN_ENABLE_SEL_LANE
#define reg_LINK_TRAIN_MODE_LPBK_LANE  TX_TRAIN_CTRL_LANE0.BF.LINK_TRAIN_MODE_LPBK_LANE
#define reg_LOCAL_STATUS_FIELD_VALID_LANE  TX_TRAIN_CTRL_LANE0.BF.LOCAL_STATUS_FIELD_VALID_LANE
#define reg_LOCAL_CTRL_FIELD_VALID_LANE  TX_TRAIN_CTRL_LANE0.BF.LOCAL_CTRL_FIELD_VALID_LANE
#define reg_RX_TRAIN_FAILED_LANE  TX_TRAIN_CTRL_LANE0.BF.RX_TRAIN_FAILED_LANE
#define reg_RX_TRAIN_COMPLETE_LANE  TX_TRAIN_CTRL_LANE0.BF.RX_TRAIN_COMPLETE_LANE
#define reg_TX_TRAIN_ON_LANE  TX_TRAIN_CTRL_LANE0.BF.TX_TRAIN_ON_LANE
#define reg_RX_TRAIN_ON_LANE  TX_TRAIN_CTRL_LANE0.BF.RX_TRAIN_ON_LANE
#define reg_TX_TRAIN_FAILED_LANE  TX_TRAIN_CTRL_LANE0.BF.TX_TRAIN_FAILED_LANE
#define reg_LOCAL_TX_TRAIN_COMPLETE_LANE  TX_TRAIN_CTRL_LANE0.BF.LOCAL_TX_TRAIN_COMPLETE_LANE
#define reg_PIN_TRAIN_COMPLETE_TYPE_LANE  TX_TRAIN_CTRL_LANE0.BF.PIN_TRAIN_COMPLETE_TYPE_LANE
#define reg_EYE_OPEN_EN_RD_LANE  TX_TRAIN_CTRL_LANE0.BF.EYE_OPEN_EN_RD_LANE
#define reg_LINK_TRAIN_MODE_LANE  TX_TRAIN_CTRL_LANE0.BF.LINK_TRAIN_MODE_LANE
...
typedef union {
	struct {
		uint8_t PIN_RX_TRAIN_ENABLE_INT_SEL_LANE         : 1;	/*      0     r/w   0*/
		uint8_t PIN_TX_TRAIN_ENABLE_INT_SEL_LANE         : 1;	/*      1     r/w   0*/
		uint8_t RESERVED_2                               : 6;	/* [21:2]     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [21:2]     r/w   0*/
		uint8_t RESERVED_16                              : 6;	/* [21:2]     r/w   0*/
		uint8_t REMOTE_TRAIN_COMP_CHK3_LANE              : 1;	/*     22     r/w   1*/
...
#define reg_PIN_RX_TRAIN_ENABLE_INT_SEL_LANE  DME_DEC_LANE.BF.PIN_RX_TRAIN_ENABLE_INT_SEL_LANE
#define reg_PIN_TX_TRAIN_ENABLE_INT_SEL_LANE  DME_DEC_LANE.BF.PIN_TX_TRAIN_ENABLE_INT_SEL_LANE
#define reg_REMOTE_TRAIN_COMP_CHK3_LANE  DME_DEC_LANE.BF.REMOTE_TRAIN_COMP_CHK3_LANE
...
// 0x0018	TRX_TRAIN_IF_LOCAL_FIELD_INIT_LANE		
typedef union {
	struct {
		uint8_t LOCAL_STATUS_FIELD_INIT_LANE_15_0_b0     : 8;	/* [15:0]     r/w 16'h0*/
		uint8_t LOCAL_STATUS_FIELD_INIT_LANE_15_0_b1     : 8;	/* [15:0]     r/w 16'h0*/
		uint8_t LOCAL_CTRL_FIELD_INIT_LANE_15_0_b0       : 8;	/*[31:16]     r/w 16'h0*/
		uint8_t LOCAL_CTRL_FIELD_INIT_LANE_15_0_b1       : 8;	/*[31:16]     r/w 16'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
} TRX_TRAIN_IF_LOCAL_FIELD_INIT_LANE_t;
__xdata __at( 0x2618 ) volatile TRX_TRAIN_IF_LOCAL_FIELD_INIT_LANE_t TRX_TRAIN_IF_LOCAL_FIELD_INIT_LANE;
#define reg_LOCAL_STATUS_FIELD_INIT_LANE_15_0_b0  TRX_TRAIN_IF_LOCAL_FIELD_INIT_LANE.BF.LOCAL_STATUS_FIELD_INIT_LANE_15_0_b0
#define reg_LOCAL_STATUS_FIELD_INIT_LANE_15_0_b1  TRX_TRAIN_IF_LOCAL_FIELD_INIT_LANE.BF.LOCAL_STATUS_FIELD_INIT_LANE_15_0_b1
#define reg_LOCAL_CTRL_FIELD_INIT_LANE_15_0_b0  TRX_TRAIN_IF_LOCAL_FIELD_INIT_LANE.BF.LOCAL_CTRL_FIELD_INIT_LANE_15_0_b0
#define reg_LOCAL_CTRL_FIELD_INIT_LANE_15_0_b1  TRX_TRAIN_IF_LOCAL_FIELD_INIT_LANE.BF.LOCAL_CTRL_FIELD_INIT_LANE_15_0_b1
#define reg_LOCAL_STATUS_FIELD_INIT_LANE_15_0  TRX_TRAIN_IF_LOCAL_FIELD_INIT_LANE.WT.W0
#define reg_LOCAL_CTRL_FIELD_INIT_LANE_15_0  TRX_TRAIN_IF_LOCAL_FIELD_INIT_LANE.WT.W1
...
typedef union {
	struct {
		...
		uint8_t PIN_RX_TRAIN_DISABLE_ISR_LANE            : 1;	/*     10     r/w   0*/
		uint8_t PIN_TX_TRAIN_DISABLE_ISR_LANE            : 1;	/*     11     r/w   0*/
...
#define reg_PIN_RX_TRAIN_DISABLE_ISR_LANE  TRX_TRAIN_IF_INTERRUPT_LANE.BF.PIN_RX_TRAIN_DISABLE_ISR_LANE
#define reg_PIN_TX_TRAIN_DISABLE_ISR_LANE  TRX_TRAIN_IF_INTERRUPT_LANE.BF.PIN_TX_TRAIN_DISABLE_ISR_LANE
...
typedef union {
	struct {
		...
		uint8_t PIN_RX_TRAIN_DISABLE_MASK_LANE           : 1;	/*     10     r/w   0*/
		uint8_t PIN_TX_TRAIN_DISABLE_MASK_LANE           : 1;	/*     11     r/w   0*/
		uint8_t RESERVED_12                              : 4;	/*[15:12]     r/w   0*/
...
#define reg_PIN_RX_TRAIN_DISABLE_MASK_LANE  TRX_TRAIN_IF_INTERRUPT_MASK0_LANE.BF.PIN_RX_TRAIN_DISABLE_MASK_LANE
#define reg_PIN_TX_TRAIN_DISABLE_MASK_LANE  TRX_TRAIN_IF_INTERRUPT_MASK0_LANE.BF.PIN_TX_TRAIN_DISABLE_MASK_LANE
...
typedef union {
	struct {
		...
		uint8_t PIN_RX_TRAIN_DISABLE_ISR_CLEAR_LANE      : 1;	/*     10     r/w   0*/
		uint8_t PIN_TX_TRAIN_DISABLE_ISR_CLEAR_LANE      : 1;	/*     11     r/w   0*/
		uint8_t RESERVED_12                              : 4;	/*[15:12]     r/w   0*/
...
#define reg_PIN_RX_TRAIN_DISABLE_ISR_CLEAR_LANE  TRX_TRAIN_IF_INTERRUPT_CLEAR_LANE.BF.PIN_RX_TRAIN_DISABLE_ISR_CLEAR_LANE
#define reg_PIN_TX_TRAIN_DISABLE_ISR_CLEAR_LANE  TRX_TRAIN_IF_INTERRUPT_CLEAR_LANE.BF.PIN_TX_TRAIN_DISABLE_ISR_CLEAR_LANE
...
// 0x0048	TX_TRAIN_CTRL_LANE1		
typedef union {
	struct {
		uint8_t RESERVED_0                               : 8;	/* [23:0]     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [23:0]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/* [23:0]     r/w   0*/
		uint8_t TX_TRAIN_COMP_WAIT_FRAME_LANE_6_0        : 7;	/*[30:24]     r/w 7'h4*/
		uint8_t RESERVED_31                              : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} TX_TRAIN_CTRL_LANE1_t;
__xdata __at( 0x2648 ) volatile TX_TRAIN_CTRL_LANE1_t TX_TRAIN_CTRL_LANE1;
#define reg_TX_TRAIN_COMP_WAIT_FRAME_LANE_6_0  TX_TRAIN_CTRL_LANE1.BF.TX_TRAIN_COMP_WAIT_FRAME_LANE_6_0
