...
typedef union {
	struct {
		uint8_t PHY_GEN_TX_LANE_4_0                      : 5;	/*  [4:0]     r/w 5'h9*/
...
#define reg_PHY_GEN_TX_LANE_4_0  PM_CTRL_TX_LANE_REG2_LANE.BF.PHY_GEN_TX_LANE_4_0
...
typedef union {
	struct {
		...
		uint8_t REPEAT_MODE_DIS_LANE                     : 1;	/*     24     r/w   0*/
...
#define reg_REPEAT_MODE_DIS_LANE  INPUT_TX_PIN_REG3_LANE.BF.REPEAT_MODE_DIS_LANE
...
typedef union {
	struct {
		...
		uint8_t RESERVED_13                              : 1;	/*     13     r/w   0*/
		uint8_t RESERVED_14                              : 1;	/*     14     r/w   0*/
		uint8_t SFT_RST_CHG_FALLING_ISR_LANE             : 1;	/*     15     r/w   0*/
		uint8_t SFT_RST_CHG_RISING_ISR_LANE              : 1;	/*     16     r/w   0*/
...
#define reg_SFT_RST_CHG_FALLING_ISR_LANE  PM_CTRL_INTERRUPT_REG1_LANE.BF.SFT_RST_CHG_FALLING_ISR_LANE
#define reg_SFT_RST_CHG_RISING_ISR_LANE  PM_CTRL_INTERRUPT_REG1_LANE.BF.SFT_RST_CHG_RISING_ISR_LANE
...
typedef union {
	struct {
		...
		uint8_t RESERVED_13                              : 1;	/*     13     r/w   0*/
		uint8_t RESERVED_14                              : 1;	/*     14     r/w   0*/
		uint8_t SFT_RST_CHG_FALLING_MASK_LANE            : 1;	/*     15     r/w   0*/
		uint8_t SFT_RST_CHG_RISING_MASK_LANE             : 1;	/*     16     r/w   0*/
...
#define reg_SFT_RST_CHG_FALLING_MASK_LANE  PM_CTRL_INTERRUPT_REG2.BF.SFT_RST_CHG_FALLING_MASK_LANE
#define reg_SFT_RST_CHG_RISING_MASK_LANE  PM_CTRL_INTERRUPT_REG2.BF.SFT_RST_CHG_RISING_MASK_LANE
...
// 0x004c	ANALOG_TRX_ANA_RSVD_IN_LANE		analog_trx_ana_rsvd_in_lane
typedef union {
	struct {
	...
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
} ANALOG_TRX_ANA_RSVD_IN_LANE_t;
__xdata __at( 0x204c ) volatile ANALOG_TRX_ANA_RSVD_IN_LANE_t ANALOG_TRX_ANA_RSVD_IN_LANE;
#define reg_ANA_TRX_ANA_RSVD_IN_LANE_15_0_b0  ANALOG_TRX_ANA_RSVD_IN_LANE.BF.ANA_TRX_ANA_RSVD_IN_LANE_15_0_b0
#define reg_ANA_TRX_ANA_RSVD_IN_LANE_15_0_b1  ANALOG_TRX_ANA_RSVD_IN_LANE.BF.ANA_TRX_ANA_RSVD_IN_LANE_15_0_b1
#define reg_ANA_TRX_ANA_RSVD_IN_LANE_15_0  ANALOG_TRX_ANA_RSVD_IN_LANE.WT.W0
...
typedef union {
	struct {
		...
		uint8_t RESERVED_13                              : 1;	/*     13     r/w   0*/
		uint8_t RESERVED_14                              : 1;	/*     14     r/w   0*/
		uint8_t SFT_RST_CHG_FALLING_ISR_CLEAR_LANE       : 1;	/*     15     r/w   0*/
		uint8_t SFT_RST_CHG_RISING_ISR_CLEAR_LANE        : 1;	/*     16     r/w   0*/
...
#define reg_SFT_RST_CHG_FALLING_ISR_CLEAR_LANE  PM_CTRL_INTERRUPT_ISR_REG1_LANE.BF.SFT_RST_CHG_FALLING_ISR_CLEAR_LANE
#define reg_SFT_RST_CHG_RISING_ISR_CLEAR_LANE  PM_CTRL_INTERRUPT_ISR_REG1_LANE.BF.SFT_RST_CHG_RISING_ISR_CLEAR_LANE
...
// 0x0060	DTX_RING_LANE_REG0		Lane RING PLL Register0
typedef union {
	struct {
		uint8_t INIT_TXFOFFS_TX_RING_LANE_9_0_b0         : 8;	/*  [9:0]     r/w 10'h0*/
		uint8_t INIT_TXFOFFS_TX_RING_LANE_9_0_b1         : 2;	/*  [9:0]     r/w 10'h0*/
		uint8_t DTX_FLOOP_EN_TX_RING_LANE                : 1;	/*     10     r/w   0*/
		uint8_t TX_FOFF_INV_TX_RING_FORCE_LANE           : 1;	/*     11     r/w   0*/
		uint8_t DTX_CLK_OFF_TX_RING_LANE                 : 1;	/*     12     r/w   1*/
		uint8_t SSC_ACC_FACTOR_TX_RING_LANE              : 1;	/*     13     r/w   0*/
		uint8_t MAX_POFFSET_JUMP_TX_RING_LANE_5_0_b0     : 2;	/*[19:14]       r   0*/
		uint8_t MAX_POFFSET_JUMP_TX_RING_LANE_5_0_b1     : 4;	/*[19:14]       r   0*/
		uint8_t INT_LANE_READY_TX_RING_LANE              : 1;	/*     20       r   0*/
		uint8_t DTX_FLOOP_FOFFSET_TX_RING_LANE_10_0_b0   : 3;	/*[31:21]       r   0*/
		uint8_t DTX_FLOOP_FOFFSET_TX_RING_LANE_10_0_b1   : 8;	/*[31:21]       r   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} DTX_RING_LANE_REG0_t;
__xdata __at( 0x2060 ) volatile DTX_RING_LANE_REG0_t DTX_RING_LANE_REG0;
#define reg_INIT_TXFOFFS_TX_RING_LANE_9_0_b0  DTX_RING_LANE_REG0.BF.INIT_TXFOFFS_TX_RING_LANE_9_0_b0
#define reg_INIT_TXFOFFS_TX_RING_LANE_9_0_b1  DTX_RING_LANE_REG0.BF.INIT_TXFOFFS_TX_RING_LANE_9_0_b1
#define reg_DTX_FLOOP_EN_TX_RING_LANE  DTX_RING_LANE_REG0.BF.DTX_FLOOP_EN_TX_RING_LANE
#define reg_TX_FOFF_INV_TX_RING_FORCE_LANE  DTX_RING_LANE_REG0.BF.TX_FOFF_INV_TX_RING_FORCE_LANE
#define reg_DTX_CLK_OFF_TX_RING_LANE  DTX_RING_LANE_REG0.BF.DTX_CLK_OFF_TX_RING_LANE
#define reg_SSC_ACC_FACTOR_TX_RING_LANE  DTX_RING_LANE_REG0.BF.SSC_ACC_FACTOR_TX_RING_LANE
#define reg_MAX_POFFSET_JUMP_TX_RING_LANE_5_0_b0  DTX_RING_LANE_REG0.BF.MAX_POFFSET_JUMP_TX_RING_LANE_5_0_b0
#define reg_MAX_POFFSET_JUMP_TX_RING_LANE_5_0_b1  DTX_RING_LANE_REG0.BF.MAX_POFFSET_JUMP_TX_RING_LANE_5_0_b1
#define reg_INT_LANE_READY_TX_RING_LANE  DTX_RING_LANE_REG0.BF.INT_LANE_READY_TX_RING_LANE
#define reg_DTX_FLOOP_FOFFSET_TX_RING_LANE_10_0_b0  DTX_RING_LANE_REG0.BF.DTX_FLOOP_FOFFSET_TX_RING_LANE_10_0_b0
#define reg_DTX_FLOOP_FOFFSET_TX_RING_LANE_10_0_b1  DTX_RING_LANE_REG0.BF.DTX_FLOOP_FOFFSET_TX_RING_LANE_10_0_b1

// 0x0064	DTX_RING_LANE_REG1		Lane RING PLL Register1
typedef union {
	struct {
		uint8_t DTX_FLOOP_STEP_SIZE_TX_RING_LANE_1_0     : 2;	/*  [1:0]     r/w   0*/
		uint8_t DTX_FLOOP_FOFFSET_RD_REQ_TX_RING_LANE    : 1;	/*      2     r/w   1*/
		uint8_t LANE_ALIGN_POFFSET_TX_RING_FORCE_LANE    : 1;	/*      3     r/w   0*/
		uint8_t SSC_STEP_125PPM_TX_RING_LANE_3_0         : 4;	/*  [7:4]     r/w   0*/
		uint8_t RESERVED_8                               : 1;	/*      8     r/w   0*/
		uint8_t SSC_AMP_TX_RING_LANE_6_0                 : 7;	/* [15:9]     r/w   0*/
		uint8_t SSC_M_TX_RING_LANE_12_0_b0               : 8;	/*[28:16]     r/w 13'h05cf*/
		uint8_t SSC_M_TX_RING_LANE_12_0_b1               : 5;	/*[28:16]     r/w 13'h05cf*/
		uint8_t TX_FOFF_INV_TX_RING_LANE                 : 1;	/*     29     r/w   0*/
		uint8_t SSC_DSPREAD_TX_TX_RING_LANE              : 1;	/*     30     r/w   1*/
		uint8_t AUTO_TX_FOFFSET_TX_RING_LANE             : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} DTX_RING_LANE_REG1_t;
__xdata __at( 0x2064 ) volatile DTX_RING_LANE_REG1_t DTX_RING_LANE_REG1;
#define reg_DTX_FLOOP_STEP_SIZE_TX_RING_LANE_1_0  DTX_RING_LANE_REG1.BF.DTX_FLOOP_STEP_SIZE_TX_RING_LANE_1_0
#define reg_DTX_FLOOP_FOFFSET_RD_REQ_TX_RING_LANE  DTX_RING_LANE_REG1.BF.DTX_FLOOP_FOFFSET_RD_REQ_TX_RING_LANE
#define reg_LANE_ALIGN_POFFSET_TX_RING_FORCE_LANE  DTX_RING_LANE_REG1.BF.LANE_ALIGN_POFFSET_TX_RING_FORCE_LANE
#define reg_SSC_STEP_125PPM_TX_RING_LANE_3_0  DTX_RING_LANE_REG1.BF.SSC_STEP_125PPM_TX_RING_LANE_3_0
#define reg_SSC_AMP_TX_RING_LANE_6_0  DTX_RING_LANE_REG1.BF.SSC_AMP_TX_RING_LANE_6_0
#define reg_SSC_M_TX_RING_LANE_12_0_b0  DTX_RING_LANE_REG1.BF.SSC_M_TX_RING_LANE_12_0_b0
#define reg_SSC_M_TX_RING_LANE_12_0_b1  DTX_RING_LANE_REG1.BF.SSC_M_TX_RING_LANE_12_0_b1
#define reg_TX_FOFF_INV_TX_RING_LANE  DTX_RING_LANE_REG1.BF.TX_FOFF_INV_TX_RING_LANE
#define reg_SSC_DSPREAD_TX_TX_RING_LANE  DTX_RING_LANE_REG1.BF.SSC_DSPREAD_TX_TX_RING_LANE
#define reg_AUTO_TX_FOFFSET_TX_RING_LANE  DTX_RING_LANE_REG1.BF.AUTO_TX_FOFFSET_TX_RING_LANE

// 0x0068	DTX_RING_LANE_REG2		Lane RING PLL Register2
typedef union {
	struct {
		uint8_t RESET_DTX_TX_RING_LANE                   : 1;	/*      0     r/w   1*/
		uint8_t ALIGN_ACCURATE_EN_TX_RING_LANE           : 1;	/*      1     r/w   0*/
		uint8_t ALIGN_CMPSAT_EN_TX_RING_LANE             : 1;	/*      2     r/w   0*/
		uint8_t ALIGN_SETTLE_TIME_SEL_TX_RING_LANE_2_0   : 3;	/*  [5:3]     r/w 3'h1*/
		uint8_t DTX_CLAMPING_EN_TX_RING_LANE             : 1;	/*      6     r/w   1*/
		uint8_t DTX_CLAMPING_SEL_TX_RING_LANE_1_0_b0     : 1;	/*  [8:7]     r/w 2'h1*/
		uint8_t DTX_CLAMPING_SEL_TX_RING_LANE_1_0_b1     : 1;	/*  [8:7]     r/w 2'h1*/
		uint8_t INIT_TXFOFFS_EN_TX_RING_LANE             : 1;	/*      9     r/w   1*/
		uint8_t DTX_CLAMPING_TRIGGER_TX_RING_LANE        : 1;	/*     10       r   0*/
		uint8_t DTX_CLAMPING_TRIGGER_CLEAR_TX_RING_LANE  : 1;	/*     11     r/w   0*/
		uint8_t DPHER_CAL_MODE_TX_RING_LANE              : 1;	/*     12     r/w   1*/
		uint8_t SRIS_REALIGN_TIMER_TX_RING_LANE_2_0      : 3;	/*[15:13]     r/w 3'h4*/
		uint8_t SRIS_REALIGN_READY_TIMEOUT_EN_TX_RING_LANE : 1;	/*     16     r/w   0*/
		uint8_t SRIS_REALIGN_READY_MODE_TX_RING_LANE     : 1;	/*     17     r/w   0*/
		uint8_t LANE_ALIGN_READY_MODE_TX_RING_LANE       : 1;	/*     18     r/w   1*/
		uint8_t MAX_POFFSET_JUMP_RESET_TX_RING_LANE      : 1;	/*     19     r/w   0*/
		uint8_t LANE_ALIGN_READY_TIMER_TX_RING_LANE_2_0  : 3;	/*[22:20]     r/w 3'h2*/
		uint8_t LANE_ALIGN_READY_TIMEOUT_EN_TX_RING_LANE : 1;	/*     23     r/w   0*/
		uint8_t DTX_FOFFSET_SEL_TX_RING_LANE             : 1;	/*     24     r/w   0*/
		uint8_t LANE_ALIGN_POFFSET_TX_RING_LANE_6_0      : 7;	/*[31:25]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} DTX_RING_LANE_REG2_t;
__xdata __at( 0x2068 ) volatile DTX_RING_LANE_REG2_t DTX_RING_LANE_REG2;
#define reg_RESET_DTX_TX_RING_LANE  DTX_RING_LANE_REG2.BF.RESET_DTX_TX_RING_LANE
#define reg_ALIGN_ACCURATE_EN_TX_RING_LANE  DTX_RING_LANE_REG2.BF.ALIGN_ACCURATE_EN_TX_RING_LANE
#define reg_ALIGN_CMPSAT_EN_TX_RING_LANE  DTX_RING_LANE_REG2.BF.ALIGN_CMPSAT_EN_TX_RING_LANE
#define reg_ALIGN_SETTLE_TIME_SEL_TX_RING_LANE_2_0  DTX_RING_LANE_REG2.BF.ALIGN_SETTLE_TIME_SEL_TX_RING_LANE_2_0
#define reg_DTX_CLAMPING_EN_TX_RING_LANE  DTX_RING_LANE_REG2.BF.DTX_CLAMPING_EN_TX_RING_LANE
#define reg_DTX_CLAMPING_SEL_TX_RING_LANE_1_0_b0  DTX_RING_LANE_REG2.BF.DTX_CLAMPING_SEL_TX_RING_LANE_1_0_b0
#define reg_DTX_CLAMPING_SEL_TX_RING_LANE_1_0_b1  DTX_RING_LANE_REG2.BF.DTX_CLAMPING_SEL_TX_RING_LANE_1_0_b1
#define reg_INIT_TXFOFFS_EN_TX_RING_LANE  DTX_RING_LANE_REG2.BF.INIT_TXFOFFS_EN_TX_RING_LANE
#define reg_DTX_CLAMPING_TRIGGER_TX_RING_LANE  DTX_RING_LANE_REG2.BF.DTX_CLAMPING_TRIGGER_TX_RING_LANE
#define reg_DTX_CLAMPING_TRIGGER_CLEAR_TX_RING_LANE  DTX_RING_LANE_REG2.BF.DTX_CLAMPING_TRIGGER_CLEAR_TX_RING_LANE
#define reg_DPHER_CAL_MODE_TX_RING_LANE  DTX_RING_LANE_REG2.BF.DPHER_CAL_MODE_TX_RING_LANE
#define reg_SRIS_REALIGN_TIMER_TX_RING_LANE_2_0  DTX_RING_LANE_REG2.BF.SRIS_REALIGN_TIMER_TX_RING_LANE_2_0
#define reg_SRIS_REALIGN_READY_TIMEOUT_EN_TX_RING_LANE  DTX_RING_LANE_REG2.BF.SRIS_REALIGN_READY_TIMEOUT_EN_TX_RING_LANE
#define reg_SRIS_REALIGN_READY_MODE_TX_RING_LANE  DTX_RING_LANE_REG2.BF.SRIS_REALIGN_READY_MODE_TX_RING_LANE
#define reg_LANE_ALIGN_READY_MODE_TX_RING_LANE  DTX_RING_LANE_REG2.BF.LANE_ALIGN_READY_MODE_TX_RING_LANE
#define reg_MAX_POFFSET_JUMP_RESET_TX_RING_LANE  DTX_RING_LANE_REG2.BF.MAX_POFFSET_JUMP_RESET_TX_RING_LANE
#define reg_LANE_ALIGN_READY_TIMER_TX_RING_LANE_2_0  DTX_RING_LANE_REG2.BF.LANE_ALIGN_READY_TIMER_TX_RING_LANE_2_0
#define reg_LANE_ALIGN_READY_TIMEOUT_EN_TX_RING_LANE  DTX_RING_LANE_REG2.BF.LANE_ALIGN_READY_TIMEOUT_EN_TX_RING_LANE
#define reg_DTX_FOFFSET_SEL_TX_RING_LANE  DTX_RING_LANE_REG2.BF.DTX_FOFFSET_SEL_TX_RING_LANE
#define reg_LANE_ALIGN_POFFSET_TX_RING_LANE_6_0  DTX_RING_LANE_REG2.BF.LANE_ALIGN_POFFSET_TX_RING_LANE_6_0

// 0x006c	DTX_RING_LANE_REG3		Lane RING PLL Register3
typedef union {
	struct {
		uint8_t RINGPLL_SSC_DIS_LANE                     : 1;	/*      0     r/w   0*/
		uint8_t ALIGN_COARSE_TIMEOUT_EN_TX_RING_LANE     : 1;	/*      1     r/w   1*/
		uint8_t CNT1M_INI_TXCLK_TX_RING_FORCE_LANE       : 1;	/*      2     r/w   0*/
		uint8_t PHY_ALIGN_VALID_WIDTH_TX_RING_FORCE_LANE : 1;	/*      3     r/w   0*/
		uint8_t RESERVED_4                               : 1;	/*      4     r/w   0*/
		uint8_t RESERVED_5                               : 1;	/*      5     r/w   0*/
		uint8_t RESERVED_6                               : 1;	/*      6     r/w   0*/
		uint8_t CNT1M_INI_TXCLK_TX_RING_LANE_8_0_b0      : 1;	/* [15:7]     r/w 9'h7d*/
		uint8_t CNT1M_INI_TXCLK_TX_RING_LANE_8_0_b1      : 8;	/* [15:7]     r/w 9'h7d*/
		uint8_t PHY_ALIGN_VALID_WIDTH_TX_RING_LANE_1_0   : 2;	/*[17:16]     r/w   0*/
		uint8_t ALIGN_FINE_STEP_TX_RING_LANE_1_0         : 2;	/*[19:18]     r/w 2'h3*/
		uint8_t ALIGN_ACCURATE_STEP_TX_RING_LANE_1_0     : 2;	/*[21:20]     r/w   0*/
		uint8_t ALIGN_COARSE_STEP_TX_RING_LANE_2_0_b0    : 2;	/*[24:22]     r/w 3'h3*/
		uint8_t ALIGN_COARSE_STEP_TX_RING_LANE_2_0_b1    : 1;	/*[24:22]     r/w 3'h3*/
		uint8_t ALIGN_COMP_PHASE_TX_RING_LANE_6_0        : 7;	/*[31:25]     r/w 7'h0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} DTX_RING_LANE_REG3_t;
__xdata __at( 0x206c ) volatile DTX_RING_LANE_REG3_t DTX_RING_LANE_REG3;
#define reg_RINGPLL_SSC_DIS_LANE  DTX_RING_LANE_REG3.BF.RINGPLL_SSC_DIS_LANE
#define reg_ALIGN_COARSE_TIMEOUT_EN_TX_RING_LANE  DTX_RING_LANE_REG3.BF.ALIGN_COARSE_TIMEOUT_EN_TX_RING_LANE
#define reg_CNT1M_INI_TXCLK_TX_RING_FORCE_LANE  DTX_RING_LANE_REG3.BF.CNT1M_INI_TXCLK_TX_RING_FORCE_LANE
#define reg_PHY_ALIGN_VALID_WIDTH_TX_RING_FORCE_LANE  DTX_RING_LANE_REG3.BF.PHY_ALIGN_VALID_WIDTH_TX_RING_FORCE_LANE
#define reg_CNT1M_INI_TXCLK_TX_RING_LANE_8_0_b0  DTX_RING_LANE_REG3.BF.CNT1M_INI_TXCLK_TX_RING_LANE_8_0_b0
#define reg_CNT1M_INI_TXCLK_TX_RING_LANE_8_0_b1  DTX_RING_LANE_REG3.BF.CNT1M_INI_TXCLK_TX_RING_LANE_8_0_b1
#define reg_PHY_ALIGN_VALID_WIDTH_TX_RING_LANE_1_0  DTX_RING_LANE_REG3.BF.PHY_ALIGN_VALID_WIDTH_TX_RING_LANE_1_0
#define reg_ALIGN_FINE_STEP_TX_RING_LANE_1_0  DTX_RING_LANE_REG3.BF.ALIGN_FINE_STEP_TX_RING_LANE_1_0
#define reg_ALIGN_ACCURATE_STEP_TX_RING_LANE_1_0  DTX_RING_LANE_REG3.BF.ALIGN_ACCURATE_STEP_TX_RING_LANE_1_0
#define reg_ALIGN_COARSE_STEP_TX_RING_LANE_2_0_b0  DTX_RING_LANE_REG3.BF.ALIGN_COARSE_STEP_TX_RING_LANE_2_0_b0
#define reg_ALIGN_COARSE_STEP_TX_RING_LANE_2_0_b1  DTX_RING_LANE_REG3.BF.ALIGN_COARSE_STEP_TX_RING_LANE_2_0_b1
#define reg_ALIGN_COMP_PHASE_TX_RING_LANE_6_0  DTX_RING_LANE_REG3.BF.ALIGN_COMP_PHASE_TX_RING_LANE_6_0

// 0x0070	DTX_RING_LANE_REG4		Lane RING PLL Register4
typedef union {
	struct {
		uint8_t ONE_US_DTX_TX_RING_LANE_9_0_b0           : 8;	/*  [9:0]     r/w 10'h138*/
		uint8_t ONE_US_DTX_TX_RING_LANE_9_0_b1           : 2;	/*  [9:0]     r/w 10'h138*/
		uint8_t LANE_ALIGN_READY_IN_TX_RING_LANE         : 1;	/*     10     r/w   0*/
		uint8_t LANE_ALIGN_READY_IN_TX_RING_FORCE_LANE   : 1;	/*     11     r/w   0*/
		uint8_t SSC_RUN_OUT_TX_RING_LANE                 : 1;	/*     12     r/w   0*/
		uint8_t SSC_RUN_OUT_TX_RING_FORCE_LANE           : 1;	/*     13     r/w   0*/
		uint8_t SSC_RUN_IN_TX_RING_LANE                  : 1;	/*     14     r/w   0*/
		uint8_t SSC_RUN_IN_TX_RING_FORCE_LANE            : 1;	/*     15     r/w   0*/
		uint8_t SSC_RUN_IN_LOOP_TX_RING_LANE             : 1;	/*     16     r/w   0*/
		uint8_t SRIS_REFCLK_ALIGN_START_TIME1_TX_RING_LANE_1_0 : 2;	/*[18:17]     r/w 2'h2*/
		uint8_t SRIS_REFCLK_ALIGN_START_TIME2_TX_RING_LANE_2_0 : 3;	/*[21:19]     r/w 3'h6*/
		uint8_t SRIS_SSC_CYCLE_TX_RING_LANE_2_0_b0       : 2;	/*[24:22]     r/w 3'h4*/
		uint8_t SRIS_SSC_CYCLE_TX_RING_LANE_2_0_b1       : 1;	/*[24:22]     r/w 3'h4*/
		uint8_t SRIS_SSC_CYCLE_DISABLE_TX_RING_LANE      : 1;	/*     25     r/w   0*/
		uint8_t LANE_ALIGN_FAST_DONE_SEL_TX_RING_LANE_1_0 : 2;	/*[27:26]     r/w 2'h1*/
		uint8_t INT_SSC_RUN_OUT_TX_RING_LANE             : 1;	/*     28       r   0*/
		uint8_t INT_SSC_RUN_IN_TX_RING_LANE              : 1;	/*     29       r   0*/
		uint8_t INT_LANE_ALIGN_READY_OUT_TX_RING_LANE    : 1;	/*     30       r   0*/
		uint8_t INT_LANE_ALIGN_READY_IN_TX_RING_LANE     : 1;	/*     31       r   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} DTX_RING_LANE_REG4_t;
__xdata __at( 0x2070 ) volatile DTX_RING_LANE_REG4_t DTX_RING_LANE_REG4;
#define reg_ONE_US_DTX_TX_RING_LANE_9_0_b0  DTX_RING_LANE_REG4.BF.ONE_US_DTX_TX_RING_LANE_9_0_b0
#define reg_ONE_US_DTX_TX_RING_LANE_9_0_b1  DTX_RING_LANE_REG4.BF.ONE_US_DTX_TX_RING_LANE_9_0_b1
#define reg_LANE_ALIGN_READY_IN_TX_RING_LANE  DTX_RING_LANE_REG4.BF.LANE_ALIGN_READY_IN_TX_RING_LANE
#define reg_LANE_ALIGN_READY_IN_TX_RING_FORCE_LANE  DTX_RING_LANE_REG4.BF.LANE_ALIGN_READY_IN_TX_RING_FORCE_LANE
#define reg_SSC_RUN_OUT_TX_RING_LANE  DTX_RING_LANE_REG4.BF.SSC_RUN_OUT_TX_RING_LANE
#define reg_SSC_RUN_OUT_TX_RING_FORCE_LANE  DTX_RING_LANE_REG4.BF.SSC_RUN_OUT_TX_RING_FORCE_LANE
#define reg_SSC_RUN_IN_TX_RING_LANE  DTX_RING_LANE_REG4.BF.SSC_RUN_IN_TX_RING_LANE
#define reg_SSC_RUN_IN_TX_RING_FORCE_LANE  DTX_RING_LANE_REG4.BF.SSC_RUN_IN_TX_RING_FORCE_LANE
#define reg_SSC_RUN_IN_LOOP_TX_RING_LANE  DTX_RING_LANE_REG4.BF.SSC_RUN_IN_LOOP_TX_RING_LANE
#define reg_SRIS_REFCLK_ALIGN_START_TIME1_TX_RING_LANE_1_0  DTX_RING_LANE_REG4.BF.SRIS_REFCLK_ALIGN_START_TIME1_TX_RING_LANE_1_0
#define reg_SRIS_REFCLK_ALIGN_START_TIME2_TX_RING_LANE_2_0  DTX_RING_LANE_REG4.BF.SRIS_REFCLK_ALIGN_START_TIME2_TX_RING_LANE_2_0
#define reg_SRIS_SSC_CYCLE_TX_RING_LANE_2_0_b0  DTX_RING_LANE_REG4.BF.SRIS_SSC_CYCLE_TX_RING_LANE_2_0_b0
#define reg_SRIS_SSC_CYCLE_TX_RING_LANE_2_0_b1  DTX_RING_LANE_REG4.BF.SRIS_SSC_CYCLE_TX_RING_LANE_2_0_b1
#define reg_SRIS_SSC_CYCLE_DISABLE_TX_RING_LANE  DTX_RING_LANE_REG4.BF.SRIS_SSC_CYCLE_DISABLE_TX_RING_LANE
#define reg_LANE_ALIGN_FAST_DONE_SEL_TX_RING_LANE_1_0  DTX_RING_LANE_REG4.BF.LANE_ALIGN_FAST_DONE_SEL_TX_RING_LANE_1_0
#define reg_INT_SSC_RUN_OUT_TX_RING_LANE  DTX_RING_LANE_REG4.BF.INT_SSC_RUN_OUT_TX_RING_LANE
#define reg_INT_SSC_RUN_IN_TX_RING_LANE  DTX_RING_LANE_REG4.BF.INT_SSC_RUN_IN_TX_RING_LANE
#define reg_INT_LANE_ALIGN_READY_OUT_TX_RING_LANE  DTX_RING_LANE_REG4.BF.INT_LANE_ALIGN_READY_OUT_TX_RING_LANE
#define reg_INT_LANE_ALIGN_READY_IN_TX_RING_LANE  DTX_RING_LANE_REG4.BF.INT_LANE_ALIGN_READY_IN_TX_RING_LANE

// 0x0074	DTX_RING_LANE_REG5		Lane RING PLL Register5
typedef union {
	struct {
		uint8_t ANA_TX_RPLL_ANA_RSVD_OUT_FM_REG_LANE     : 1;	/*      0     r/w   0*/
		uint8_t ANA_TX_RPLL_ANA_RSVD_OUT_LANE_15_0_b0    : 7;	/* [16:1]     r/w 16'h0*/
		uint8_t ANA_TX_RPLL_ANA_RSVD_OUT_LANE_15_0_b1    : 8;	/* [16:1]     r/w 16'h0*/
		uint8_t ANA_TX_RPLL_ANA_RSVD_OUT_LANE_15_0_b2    : 1;	/* [16:1]     r/w 16'h0*/
		uint8_t ANA_TX_PLL_LOCK_RING_RD_LANE             : 1;	/*     17       r   0*/
		uint8_t SRIS_DIS_TX_RING_LANE                    : 1;	/*     18     r/w   1*/
		uint8_t SRIS_DIS_TX_RING_FORCE_LANE              : 1;	/*     19     r/w   0*/
		uint8_t LANE_ALIGN_OFF_TX_RING_LANE              : 1;	/*     20     r/w   1*/
		uint8_t ANA_FBCK_SEL_TX_RING_LANE                : 1;	/*     21     r/w   1*/
		uint8_t LANE_ALIGN_FREEZE_TX_RING_FORCE_LANE     : 1;	/*     22     r/w   0*/
		uint8_t POFF_FOFF_EN_TX_RING_LANE                : 1;	/*     23     r/w   1*/
		uint8_t RESERVED_24                              : 1;	/*     24     r/w   0*/
		uint8_t MASTER_PHY_EN_TX_RING_LANE               : 1;	/*     25     r/w   0*/
		uint8_t PHY_CONFIG_TX_RING_LANE_1_0              : 2;	/*[27:26]     r/w   0*/
		uint8_t ONE_US_DTX_TX_RING_FORCE_LANE            : 1;	/*     28     r/w   0*/
		uint8_t LANE_ALIGN_READY_OUT_TX_RING_LANE        : 1;	/*     29     r/w   0*/
		uint8_t LANE_ALIGN_READY_OUT_TX_RING_FORCE_LANE  : 1;	/*     30     r/w   0*/
		uint8_t LANE_ALIGN_FREEZE_TX_RING_LANE           : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
} DTX_RING_LANE_REG5_t;
__xdata __at( 0x2074 ) volatile DTX_RING_LANE_REG5_t DTX_RING_LANE_REG5;
#define reg_ANA_TX_RPLL_ANA_RSVD_OUT_FM_REG_LANE  DTX_RING_LANE_REG5.BF.ANA_TX_RPLL_ANA_RSVD_OUT_FM_REG_LANE
#define reg_ANA_TX_RPLL_ANA_RSVD_OUT_LANE_15_0_b0  DTX_RING_LANE_REG5.BF.ANA_TX_RPLL_ANA_RSVD_OUT_LANE_15_0_b0
#define reg_ANA_TX_RPLL_ANA_RSVD_OUT_LANE_15_0_b1  DTX_RING_LANE_REG5.BF.ANA_TX_RPLL_ANA_RSVD_OUT_LANE_15_0_b1
#define reg_ANA_TX_RPLL_ANA_RSVD_OUT_LANE_15_0_b2  DTX_RING_LANE_REG5.BF.ANA_TX_RPLL_ANA_RSVD_OUT_LANE_15_0_b2
#define reg_ANA_TX_PLL_LOCK_RING_RD_LANE  DTX_RING_LANE_REG5.BF.ANA_TX_PLL_LOCK_RING_RD_LANE
#define reg_SRIS_DIS_TX_RING_LANE  DTX_RING_LANE_REG5.BF.SRIS_DIS_TX_RING_LANE
#define reg_SRIS_DIS_TX_RING_FORCE_LANE  DTX_RING_LANE_REG5.BF.SRIS_DIS_TX_RING_FORCE_LANE
#define reg_LANE_ALIGN_OFF_TX_RING_LANE  DTX_RING_LANE_REG5.BF.LANE_ALIGN_OFF_TX_RING_LANE
#define reg_ANA_FBCK_SEL_TX_RING_LANE  DTX_RING_LANE_REG5.BF.ANA_FBCK_SEL_TX_RING_LANE
#define reg_LANE_ALIGN_FREEZE_TX_RING_FORCE_LANE  DTX_RING_LANE_REG5.BF.LANE_ALIGN_FREEZE_TX_RING_FORCE_LANE
#define reg_POFF_FOFF_EN_TX_RING_LANE  DTX_RING_LANE_REG5.BF.POFF_FOFF_EN_TX_RING_LANE
#define reg_MASTER_PHY_EN_TX_RING_LANE  DTX_RING_LANE_REG5.BF.MASTER_PHY_EN_TX_RING_LANE
#define reg_PHY_CONFIG_TX_RING_LANE_1_0  DTX_RING_LANE_REG5.BF.PHY_CONFIG_TX_RING_LANE_1_0
#define reg_ONE_US_DTX_TX_RING_FORCE_LANE  DTX_RING_LANE_REG5.BF.ONE_US_DTX_TX_RING_FORCE_LANE
#define reg_LANE_ALIGN_READY_OUT_TX_RING_LANE  DTX_RING_LANE_REG5.BF.LANE_ALIGN_READY_OUT_TX_RING_LANE
#define reg_LANE_ALIGN_READY_OUT_TX_RING_FORCE_LANE  DTX_RING_LANE_REG5.BF.LANE_ALIGN_READY_OUT_TX_RING_FORCE_LANE
#define reg_LANE_ALIGN_FREEZE_TX_RING_LANE  DTX_RING_LANE_REG5.BF.LANE_ALIGN_FREEZE_TX_RING_LANE
#define reg_ANA_TX_RPLL_ANA_RSVD_OUT_LANE_15_0  DTX_RING_LANE_REG5.WT.W1

// 0x0078	MON_TOP		Test Bus Control Register
typedef union {
	struct {
...
__xdata __at( 0x2078 ) volatile MON_TOP_t MON_TOP;
...
// 0x007c	TX_RING_CTRL		TX RING PLL Control
typedef union {
	struct {
		uint8_t ANA_TX_RPLL_ANA_RSVD_IN_LANE_15_0_b0     : 8;	/* [15:0]     r/w 16'hff00*/
		uint8_t ANA_TX_RPLL_ANA_RSVD_IN_LANE_15_0_b1     : 8;	/* [15:0]     r/w 16'hff00*/
		uint8_t ANA_TX_RESET_ANA_RPLL_LANE               : 1;	/*     16     r/w   1*/
		uint8_t ANA_TX_CLK_READY_RPLL_LANE               : 1;	/*     17     r/w   0*/
		uint8_t ANA_TX_CLK_READY_PRE1_RPLL_LANE          : 1;	/*     18     r/w   0*/
		uint8_t ANA_TX_CLK_READY_PRE0_RPLL_LANE          : 1;	/*     19     r/w   0*/
		uint8_t ANA_TX_PLL_LOCK_RING_FM_REG_LANE         : 1;	/*     20     r/w   0*/
		uint8_t ANA_TX_PLL_LOCK_RING_LANE                : 1;	/*     21     r/w   0*/
		uint8_t ANA_TX_PLL_VDDVCO_OVERTH_RING_FM_REG_LANE : 1;	/*     22     r/w   0*/
		uint8_t ANA_TX_PLL_VDDVCO_OVERTH_RING_LANE       : 1;	/*     23     r/w   0*/
		uint8_t ANA_TX_PLL_VCON_OVERTH_RING_FM_REG_LANE  : 1;	/*     24     r/w   0*/
		uint8_t ANA_TX_PLL_VCON_OVERTH_RING_LANE         : 1;	/*     25     r/w   0*/
		uint8_t ANA_VCON_OVERTH_RING_LANE                : 1;	/*     26       r   0*/
		uint8_t ANA_VDDVCO_OVERTH_RING_LANE              : 1;	/*     27       r   0*/
		uint8_t VCON_OVERTH_RING_REQ_LANE                : 1;	/*     28     r/w   1*/
		uint8_t VDDVCO_OVERTH_RING_REQ_LANE              : 1;	/*     29     r/w   1*/
		uint8_t REFCLK_DIS_ACK_LANE                      : 1;	/*     30     r/w   0*/
		uint8_t REFCLK_DIS_ACK_FORCE_LANE                : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
} TX_RING_CTRL_t;
__xdata __at( 0x207c ) volatile TX_RING_CTRL_t TX_RING_CTRL;
#define reg_ANA_TX_RPLL_ANA_RSVD_IN_LANE_15_0_b0  TX_RING_CTRL.BF.ANA_TX_RPLL_ANA_RSVD_IN_LANE_15_0_b0
#define reg_ANA_TX_RPLL_ANA_RSVD_IN_LANE_15_0_b1  TX_RING_CTRL.BF.ANA_TX_RPLL_ANA_RSVD_IN_LANE_15_0_b1
#define reg_ANA_TX_RESET_ANA_RPLL_LANE  TX_RING_CTRL.BF.ANA_TX_RESET_ANA_RPLL_LANE
#define reg_ANA_TX_CLK_READY_RPLL_LANE  TX_RING_CTRL.BF.ANA_TX_CLK_READY_RPLL_LANE
#define reg_ANA_TX_CLK_READY_PRE1_RPLL_LANE  TX_RING_CTRL.BF.ANA_TX_CLK_READY_PRE1_RPLL_LANE
#define reg_ANA_TX_CLK_READY_PRE0_RPLL_LANE  TX_RING_CTRL.BF.ANA_TX_CLK_READY_PRE0_RPLL_LANE
#define reg_ANA_TX_PLL_LOCK_RING_FM_REG_LANE  TX_RING_CTRL.BF.ANA_TX_PLL_LOCK_RING_FM_REG_LANE
#define reg_ANA_TX_PLL_LOCK_RING_LANE  TX_RING_CTRL.BF.ANA_TX_PLL_LOCK_RING_LANE
#define reg_ANA_TX_PLL_VDDVCO_OVERTH_RING_FM_REG_LANE  TX_RING_CTRL.BF.ANA_TX_PLL_VDDVCO_OVERTH_RING_FM_REG_LANE
#define reg_ANA_TX_PLL_VDDVCO_OVERTH_RING_LANE  TX_RING_CTRL.BF.ANA_TX_PLL_VDDVCO_OVERTH_RING_LANE
#define reg_ANA_TX_PLL_VCON_OVERTH_RING_FM_REG_LANE  TX_RING_CTRL.BF.ANA_TX_PLL_VCON_OVERTH_RING_FM_REG_LANE
#define reg_ANA_TX_PLL_VCON_OVERTH_RING_LANE  TX_RING_CTRL.BF.ANA_TX_PLL_VCON_OVERTH_RING_LANE
#define reg_ANA_VCON_OVERTH_RING_LANE  TX_RING_CTRL.BF.ANA_VCON_OVERTH_RING_LANE
#define reg_ANA_VDDVCO_OVERTH_RING_LANE  TX_RING_CTRL.BF.ANA_VDDVCO_OVERTH_RING_LANE
#define reg_VCON_OVERTH_RING_REQ_LANE  TX_RING_CTRL.BF.VCON_OVERTH_RING_REQ_LANE
#define reg_VDDVCO_OVERTH_RING_REQ_LANE  TX_RING_CTRL.BF.VDDVCO_OVERTH_RING_REQ_LANE
#define reg_REFCLK_DIS_ACK_LANE  TX_RING_CTRL.BF.REFCLK_DIS_ACK_LANE
#define reg_REFCLK_DIS_ACK_FORCE_LANE  TX_RING_CTRL.BF.REFCLK_DIS_ACK_FORCE_LANE
#define reg_ANA_TX_RPLL_ANA_RSVD_IN_LANE_15_0  TX_RING_CTRL.WT.W0

// 0x0080	TX_RING_CTRL1		TX RING PLL Control Register 1
typedef union {
	struct {
		uint8_t RPLL_FBC_PLLCAL_CNT_LANE_15_0_b0         : 8;	/* [15:0]       r   0*/
		uint8_t RPLL_FBC_PLLCAL_CNT_LANE_15_0_b1         : 8;	/* [15:0]       r   0*/
		uint8_t ANA_PU_RPLL_DLY_RING_LANE                : 1;	/*     16     r/w   0*/
		uint8_t ANA_PU_RPLL_RING_LANE                    : 1;	/*     17     r/w   0*/
		uint8_t RESERVED_18                              : 1;	/*     18     r/w   0*/
		uint8_t CNT_INI_LANE_7_0_b0                      : 5;	/*[26:19]     r/w 8'h95*/
		uint8_t CNT_INI_LANE_7_0_b1                      : 3;	/*[26:19]     r/w 8'h95*/
		uint8_t RPLL_FBC_PLLCAL_CNT_READY_LANE           : 1;	/*     27       r   0*/
		uint8_t TXCLK_SYNC_EN_RPLL_IN_RD_LANE            : 1;	/*     28       r   0*/
		uint8_t ANA_TXCLK_SYNC_EN_RPLL_LANE              : 1;	/*     29     r/w   0*/
		uint8_t ANA_TX_FBC_PLLCAL_RING_LANE              : 1;	/*     30     r/w   0*/
		uint8_t ANA_TX_FBC_PLLCAL_RING_FM_REG_LANE       : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
} TX_RING_CTRL1_t;
__xdata __at( 0x2080 ) volatile TX_RING_CTRL1_t TX_RING_CTRL1;
#define reg_RPLL_FBC_PLLCAL_CNT_LANE_15_0_b0  TX_RING_CTRL1.BF.RPLL_FBC_PLLCAL_CNT_LANE_15_0_b0
#define reg_RPLL_FBC_PLLCAL_CNT_LANE_15_0_b1  TX_RING_CTRL1.BF.RPLL_FBC_PLLCAL_CNT_LANE_15_0_b1
#define reg_ANA_PU_RPLL_DLY_RING_LANE  TX_RING_CTRL1.BF.ANA_PU_RPLL_DLY_RING_LANE
#define reg_ANA_PU_RPLL_RING_LANE  TX_RING_CTRL1.BF.ANA_PU_RPLL_RING_LANE
#define reg_CNT_INI_LANE_7_0_b0  TX_RING_CTRL1.BF.CNT_INI_LANE_7_0_b0
#define reg_CNT_INI_LANE_7_0_b1  TX_RING_CTRL1.BF.CNT_INI_LANE_7_0_b1
#define reg_RPLL_FBC_PLLCAL_CNT_READY_LANE  TX_RING_CTRL1.BF.RPLL_FBC_PLLCAL_CNT_READY_LANE
#define reg_TXCLK_SYNC_EN_RPLL_IN_RD_LANE  TX_RING_CTRL1.BF.TXCLK_SYNC_EN_RPLL_IN_RD_LANE
#define reg_ANA_TXCLK_SYNC_EN_RPLL_LANE  TX_RING_CTRL1.BF.ANA_TXCLK_SYNC_EN_RPLL_LANE
#define reg_ANA_TX_FBC_PLLCAL_RING_LANE  TX_RING_CTRL1.BF.ANA_TX_FBC_PLLCAL_RING_LANE
#define reg_ANA_TX_FBC_PLLCAL_RING_FM_REG_LANE  TX_RING_CTRL1.BF.ANA_TX_FBC_PLLCAL_RING_FM_REG_LANE
#define reg_RPLL_FBC_PLLCAL_CNT_LANE_15_0  TX_RING_CTRL1.WT.W0

// 0x0084	TX_RING_CTRL2		TX RING PLL Control Register 2
typedef union {
	struct {
		uint8_t RX_INIT_RD_LANE                          : 1;	/*      0       r   0*/
		uint8_t RESERVED_1                               : 3;	/*  [3:1]     r/w   0*/
		uint8_t TXCLK_SYNC_EN_RPLL_OUT_LANE              : 1;	/*      4     r/w   0*/
		uint8_t RESERVED_5                               : 1;	/*      5     r/w   0*/
		uint8_t RESERVED_6                               : 1;	/*      6     r/w   0*/
		uint8_t SFT_RST_NO_REG_LANE                      : 1;	/*      7     r/w   0*/
		uint8_t SFT_RST_NO_REG_FM_REG_LANE               : 1;	/*      8     r/w   0*/
		uint8_t RST_FBC_RPLLCAL_CLK_LANE                 : 1;	/*      9     r/w   0*/
		uint8_t RESET_CORE_FM_PIPE_LANE                  : 1;	/*     10     r/w   0*/
		uint8_t RESERVED_11                              : 1;	/*     11     r/w   0*/
		uint8_t RESERVED_12                              : 1;	/*     12     r/w   0*/
		uint8_t RPLL_FBC_CNT_TIMER_LANE_15_0_b0          : 3;	/*[28:13]     r/w 16'h4f*/
		uint8_t RPLL_FBC_CNT_TIMER_LANE_15_0_b1          : 8;	/*[28:13]     r/w 16'h4f*/
		uint8_t RPLL_FBC_CNT_TIMER_LANE_15_0_b2          : 5;	/*[28:13]     r/w 16'h4f*/
		uint8_t RPLL_FBC_CNT_START_LANE                  : 1;	/*     29     r/w   0*/
		uint8_t RESERVED_30                              : 1;	/*     30     r/w   0*/
		uint8_t ANA_TXCLK_SYNC_EN_RPLL_FORCE_LANE        : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	struct{uint16_t W0:16;uint16_t W1:16;}WT;
	uint32_t VAL;
} TX_RING_CTRL2_t;
__xdata __at( 0x2084 ) volatile TX_RING_CTRL2_t TX_RING_CTRL2;
#define reg_RX_INIT_RD_LANE  TX_RING_CTRL2.BF.RX_INIT_RD_LANE
#define reg_TXCLK_SYNC_EN_RPLL_OUT_LANE  TX_RING_CTRL2.BF.TXCLK_SYNC_EN_RPLL_OUT_LANE
#define reg_SFT_RST_NO_REG_LANE  TX_RING_CTRL2.BF.SFT_RST_NO_REG_LANE
#define reg_SFT_RST_NO_REG_FM_REG_LANE  TX_RING_CTRL2.BF.SFT_RST_NO_REG_FM_REG_LANE
#define reg_RST_FBC_RPLLCAL_CLK_LANE  TX_RING_CTRL2.BF.RST_FBC_RPLLCAL_CLK_LANE
#define reg_RESET_CORE_FM_PIPE_LANE  TX_RING_CTRL2.BF.RESET_CORE_FM_PIPE_LANE
#define reg_RPLL_FBC_CNT_TIMER_LANE_15_0_b0  TX_RING_CTRL2.BF.RPLL_FBC_CNT_TIMER_LANE_15_0_b0
#define reg_RPLL_FBC_CNT_TIMER_LANE_15_0_b1  TX_RING_CTRL2.BF.RPLL_FBC_CNT_TIMER_LANE_15_0_b1
#define reg_RPLL_FBC_CNT_TIMER_LANE_15_0_b2  TX_RING_CTRL2.BF.RPLL_FBC_CNT_TIMER_LANE_15_0_b2
#define reg_RPLL_FBC_CNT_START_LANE  TX_RING_CTRL2.BF.RPLL_FBC_CNT_START_LANE
#define reg_ANA_TXCLK_SYNC_EN_RPLL_FORCE_LANE  TX_RING_CTRL2.BF.ANA_TXCLK_SYNC_EN_RPLL_FORCE_LANE
#define reg_RPLL_FBC_CNT_TIMER_LANE_15_0  TX_RING_CTRL2.WT.W1

// 0x0088	TX_RESERVED_REG2		Tx Reserved Register 2
typedef union {
	struct {
...
__xdata __at( 0x2088 ) volatile TX_RESERVED_REG2_t TX_RESERVED_REG2;
...
#define reg_PIN_RESERVED_INPUT_TX_RD_LANE_15_0_b0  TX_RESERVED_REG2.BF.PIN_RESERVED_INPUT_TX_RD_LANE_15_0_b0
#define reg_PIN_RESERVED_INPUT_TX_RD_LANE_15_0_b1  TX_RESERVED_REG2.BF.PIN_RESERVED_INPUT_TX_RD_LANE_15_0_b1
#define reg_PIN_RESERVED_OUTPUT_TX_LANE_15_0  TX_RESERVED_REG2.WT.W0
#define reg_PIN_RESERVED_INPUT_TX_RD_LANE_15_0  TX_RESERVED_REG2.WT.W1
