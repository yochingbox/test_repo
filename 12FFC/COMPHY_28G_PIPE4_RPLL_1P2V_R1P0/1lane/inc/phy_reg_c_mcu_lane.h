...
typedef union {
	struct {
		...
		uint8_t INT0_INT_CMN_IRQ_EN_LANE                 : 1;	/*     20     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t INT1_INT_CMN_IRQ_EN_LANE                 : 1;	/*     20     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t INT2_INT_CMN_IRQ_EN_LANE                 : 1;	/*     20     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t INT3_INT_CMN_IRQ_EN_LANE                 : 1;	/*     20     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t INT5_INT_CMN_IRQ_EN_LANE                 : 1;	/*     20     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t INT6_INT_CMN_IRQ_EN_LANE                 : 1;	/*     20     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t INT7_INT_CMN_IRQ_EN_LANE                 : 1;	/*     20     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t INT8_INT_CMN_IRQ_EN_LANE                 : 1;	/*     20     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t INT9_INT_CMN_IRQ_EN_LANE                 : 1;	/*     20     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t INT10_INT_CMN_IRQ_EN_LANE                : 1;	/*     20     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t INT11_INT_CMN_IRQ_EN_LANE                : 1;	/*     20     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t INT12_INT_CMN_IRQ_EN_LANE                : 1;	/*     20     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t EXTINT_INT_CMN_IRQ_EN_LANE               : 1;	/*     20     r/w   0*/
...
typedef union {
	struct {
		...
		uint8_t RESERVED_2                               : 6;	/* [23:2]     r/w   0*/
		uint8_t RESERVED_8                               : 8;	/* [23:2]     r/w   0*/
		uint8_t RESERVED_16                              : 8;	/* [23:2]     r/w   0*/
		uint8_t DIG_ID_LANE_7_0                          : 8;	/*[31:24]       r 8'h10*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} MCU_COMMAND0_t;
...
#define reg_DIG_ID_LANE_7_0  MCU_COMMAND0.BF.DIG_ID_LANE_7_0

// 0x00e8	ANA_IF_RPLL_REG0		Analog Interface Register 0
typedef union {
	struct {
		uint8_t RESERVED_0                               : 4;	/*  [3:0]     r/w   0*/
		uint8_t ANA_REG_LANE_RPLL_FORCE_LANE             : 1;	/*      4     r/w   0*/
		uint8_t ANA_REG_LANE_RPLL_RE_LANE                : 1;	/*      5     r/w   0*/
		uint8_t ANA_REG_LANE_RPLL_WE_LANE                : 1;	/*      6     r/w   0*/
		uint8_t ANA_REG_LANE_RPLL_RST_LANE               : 1;	/*      7     r/w   0*/
		uint8_t ANA_REG_LANE_RPLL_RD_OUT_LANE_7_0        : 8;	/* [15:8]       r   0*/
		uint8_t ANA_REG_LANE_RPLL_WD_LANE_7_0            : 8;	/*[23:16]     r/w   0*/
		uint8_t ANA_REG_LANE_RPLL_ADDR_LANE_7_0          : 8;	/*[31:24]     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} ANA_IF_RPLL_REG0_t;
__xdata __at( 0x22e8 ) volatile ANA_IF_RPLL_REG0_t ANA_IF_RPLL_REG0;
#define reg_ANA_REG_LANE_RPLL_FORCE_LANE  ANA_IF_RPLL_REG0.BF.ANA_REG_LANE_RPLL_FORCE_LANE
#define reg_ANA_REG_LANE_RPLL_RE_LANE  ANA_IF_RPLL_REG0.BF.ANA_REG_LANE_RPLL_RE_LANE
#define reg_ANA_REG_LANE_RPLL_WE_LANE  ANA_IF_RPLL_REG0.BF.ANA_REG_LANE_RPLL_WE_LANE
#define reg_ANA_REG_LANE_RPLL_RST_LANE  ANA_IF_RPLL_REG0.BF.ANA_REG_LANE_RPLL_RST_LANE
#define reg_ANA_REG_LANE_RPLL_RD_OUT_LANE_7_0  ANA_IF_RPLL_REG0.BF.ANA_REG_LANE_RPLL_RD_OUT_LANE_7_0
#define reg_ANA_REG_LANE_RPLL_WD_LANE_7_0  ANA_IF_RPLL_REG0.BF.ANA_REG_LANE_RPLL_WD_LANE_7_0
#define reg_ANA_REG_LANE_RPLL_ADDR_LANE_7_0  ANA_IF_RPLL_REG0.BF.ANA_REG_LANE_RPLL_ADDR_LANE_7_0
...
// 0x00f0	SFT_RST_INT_EBABLE		MCU INT enable for sft_rst
typedef union {
	struct {
		uint8_t RESERVED_0                               : 4;	/*  [3:0]     r/w   0*/
		uint8_t EXTINT_SFT_RST_CHG_FALLING_INT_EN_LANE   : 1;	/*      4     r/w   0*/
		uint8_t EXTINT_SFT_RST_CHG_RISING_INT_EN_LANE    : 1;	/*      5     r/w   0*/
		uint8_t INT0_SFT_RST_CHG_FALLING_INT_EN_LANE     : 1;	/*      6     r/w   0*/
		uint8_t INT0_SFT_RST_CHG_RISING_INT_EN_LANE      : 1;	/*      7     r/w   0*/
		uint8_t INT1_SFT_RST_CHG_FALLING_INT_EN_LANE     : 1;	/*      8     r/w   0*/
		uint8_t INT1_SFT_RST_CHG_RISING_INT_EN_LANE      : 1;	/*      9     r/w   0*/
		uint8_t INT2_SFT_RST_CHG_FALLING_INT_EN_LANE     : 1;	/*     10     r/w   0*/
		uint8_t INT2_SFT_RST_CHG_RISING_INT_EN_LANE      : 1;	/*     11     r/w   0*/
		uint8_t INT3_SFT_RST_CHG_FALLING_INT_EN_LANE     : 1;	/*     12     r/w   0*/
		uint8_t INT3_SFT_RST_CHG_RISING_INT_EN_LANE      : 1;	/*     13     r/w   0*/
		uint8_t INT4_SFT_RST_CHG_FALLING_INT_EN_LANE     : 1;	/*     14     r/w   0*/
		uint8_t INT4_SFT_RST_CHG_RISING_INT_EN_LANE      : 1;	/*     15     r/w   0*/
		uint8_t INT5_SFT_RST_CHG_FALLING_INT_EN_LANE     : 1;	/*     16     r/w   0*/
		uint8_t INT5_SFT_RST_CHG_RISING_INT_EN_LANE      : 1;	/*     17     r/w   0*/
		uint8_t INT6_SFT_RST_CHG_FALLING_INT_EN_LANE     : 1;	/*     18     r/w   0*/
		uint8_t INT6_SFT_RST_CHG_RISING_INT_EN_LANE      : 1;	/*     19     r/w   0*/
		uint8_t INT7_SFT_RST_CHG_FALLING_INT_EN_LANE     : 1;	/*     20     r/w   0*/
		uint8_t INT7_SFT_RST_CHG_RISING_INT_EN_LANE      : 1;	/*     21     r/w   0*/
		uint8_t INT8_SFT_RST_CHG_FALLING_INT_EN_LANE     : 1;	/*     22     r/w   0*/
		uint8_t INT8_SFT_RST_CHG_RISING_INT_EN_LANE      : 1;	/*     23     r/w   0*/
		uint8_t INT9_SFT_RST_CHG_FALLING_INT_EN_LANE     : 1;	/*     24     r/w   0*/
		uint8_t INT9_SFT_RST_CHG_RISING_INT_EN_LANE      : 1;	/*     25     r/w   0*/
		uint8_t INT10_SFT_RST_CHG_FALLING_INT_EN_LANE    : 1;	/*     26     r/w   0*/
		uint8_t INT10_SFT_RST_CHG_RISING_INT_EN_LANE     : 1;	/*     27     r/w   0*/
		uint8_t INT11_SFT_RST_CHG_FALLING_INT_EN_LANE    : 1;	/*     28     r/w   0*/
		uint8_t INT11_SFT_RST_CHG_RISING_INT_EN_LANE     : 1;	/*     29     r/w   0*/
		uint8_t INT12_SFT_RST_CHG_FALLING_INT_EN_LANE    : 1;	/*     30     r/w   0*/
		uint8_t INT12_SFT_RST_CHG_RISING_INT_EN_LANE     : 1;	/*     31     r/w   0*/
	} BF;
	struct{uint8_t B0:8;uint8_t B1:8;uint8_t B2:8;uint8_t B3:8;}BT;
	uint32_t VAL;
} SFT_RST_INT_EBABLE_t;
__xdata __at( 0x22f0 ) volatile SFT_RST_INT_EBABLE_t SFT_RST_INT_EBABLE;
#define reg_EXTINT_SFT_RST_CHG_FALLING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.EXTINT_SFT_RST_CHG_FALLING_INT_EN_LANE
#define reg_EXTINT_SFT_RST_CHG_RISING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.EXTINT_SFT_RST_CHG_RISING_INT_EN_LANE
#define reg_INT0_SFT_RST_CHG_FALLING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT0_SFT_RST_CHG_FALLING_INT_EN_LANE
#define reg_INT0_SFT_RST_CHG_RISING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT0_SFT_RST_CHG_RISING_INT_EN_LANE
#define reg_INT1_SFT_RST_CHG_FALLING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT1_SFT_RST_CHG_FALLING_INT_EN_LANE
#define reg_INT1_SFT_RST_CHG_RISING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT1_SFT_RST_CHG_RISING_INT_EN_LANE
#define reg_INT2_SFT_RST_CHG_FALLING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT2_SFT_RST_CHG_FALLING_INT_EN_LANE
#define reg_INT2_SFT_RST_CHG_RISING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT2_SFT_RST_CHG_RISING_INT_EN_LANE
#define reg_INT3_SFT_RST_CHG_FALLING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT3_SFT_RST_CHG_FALLING_INT_EN_LANE
#define reg_INT3_SFT_RST_CHG_RISING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT3_SFT_RST_CHG_RISING_INT_EN_LANE
#define reg_INT4_SFT_RST_CHG_FALLING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT4_SFT_RST_CHG_FALLING_INT_EN_LANE
#define reg_INT4_SFT_RST_CHG_RISING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT4_SFT_RST_CHG_RISING_INT_EN_LANE
#define reg_INT5_SFT_RST_CHG_FALLING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT5_SFT_RST_CHG_FALLING_INT_EN_LANE
#define reg_INT5_SFT_RST_CHG_RISING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT5_SFT_RST_CHG_RISING_INT_EN_LANE
#define reg_INT6_SFT_RST_CHG_FALLING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT6_SFT_RST_CHG_FALLING_INT_EN_LANE
#define reg_INT6_SFT_RST_CHG_RISING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT6_SFT_RST_CHG_RISING_INT_EN_LANE
#define reg_INT7_SFT_RST_CHG_FALLING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT7_SFT_RST_CHG_FALLING_INT_EN_LANE
#define reg_INT7_SFT_RST_CHG_RISING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT7_SFT_RST_CHG_RISING_INT_EN_LANE
#define reg_INT8_SFT_RST_CHG_FALLING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT8_SFT_RST_CHG_FALLING_INT_EN_LANE
#define reg_INT8_SFT_RST_CHG_RISING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT8_SFT_RST_CHG_RISING_INT_EN_LANE
#define reg_INT9_SFT_RST_CHG_FALLING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT9_SFT_RST_CHG_FALLING_INT_EN_LANE
#define reg_INT9_SFT_RST_CHG_RISING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT9_SFT_RST_CHG_RISING_INT_EN_LANE
#define reg_INT10_SFT_RST_CHG_FALLING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT10_SFT_RST_CHG_FALLING_INT_EN_LANE
#define reg_INT10_SFT_RST_CHG_RISING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT10_SFT_RST_CHG_RISING_INT_EN_LANE
#define reg_INT11_SFT_RST_CHG_FALLING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT11_SFT_RST_CHG_FALLING_INT_EN_LANE
#define reg_INT11_SFT_RST_CHG_RISING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT11_SFT_RST_CHG_RISING_INT_EN_LANE
#define reg_INT12_SFT_RST_CHG_FALLING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT12_SFT_RST_CHG_FALLING_INT_EN_LANE
#define reg_INT12_SFT_RST_CHG_RISING_INT_EN_LANE  SFT_RST_INT_EBABLE.BF.INT12_SFT_RST_CHG_RISING_INT_EN_LANE
