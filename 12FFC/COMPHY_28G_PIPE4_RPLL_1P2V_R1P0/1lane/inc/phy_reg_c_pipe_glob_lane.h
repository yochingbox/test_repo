...
__xdata __at( 0x421c ) volatile GLOB_PROTOCOL_CFG0_t GLOB_PROTOCOL_CFG0;
...
#define reg_CFG_PCIE4_V7_SUPPORT_LANE  GLOB_PROTOCOL_CFG0.BF.CFG_PCIE4_V7_SUPPORT_LANE
...
// 0x005c	GLOB_L1_SUBSTATES_CFG		L1 Substates Configuration
typedef union {
	struct {
...
__xdata __at( 0x425c ) volatile GLOB_L1_SUBSTATES_CFG_t GLOB_L1_SUBSTATES_CFG;
