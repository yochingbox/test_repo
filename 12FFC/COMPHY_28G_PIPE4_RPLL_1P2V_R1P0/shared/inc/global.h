...
extern __xdata bool reset_ana_first_time;
extern __xdata bool rx_init_done;
extern __xdata uint8_t cont_cal_inx;
extern __xdata bool pre_use_ring_pll;
...
extern volatile __xdata uint32_t * __xdata comphyIntWrAddr;
extern volatile __xdata uint32_t comphyIntWrMask;
extern volatile __xdata uint32_t comphyIntWrData;
...
__xdata __at(PHY_MODE_LANE_BASE + caloft_pll_speed_ring_rate0_lane)		uint8_t lnx_cal_pll_speed_ring[2][2];
__xdata __at(PHY_MODE_LANE_BASE + caloft_pll_sllp_dac_coarse_ring_rate0_lane)	uint8_t lnx_cal_pll_sllp_dac_coarse_ring[2][2];
__xdata __at(PHY_MODE_LANE_BASE + caloft_sllp_dac_fine_ring_rate0_lane)		uint16_t lnx_cal_sllp_dac_fine_ring[2][2];
